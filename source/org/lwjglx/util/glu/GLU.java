...
public class GLU {
    ...
    public static void gluLookAt(float float0, float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8) {
        Project.gluLookAt(float0, float1, float2, float3, float4, float5, float6, float7, float8);
    }

    public static void gluOrtho2D(float float0, float float1, float float2, float float3) {
        gluOrtho2D(float0, float1, float2, float3);
    }

    public static void gluPerspective(float float0, float float1, float float2, float float3) {
    ...
    public static boolean gluProject(
        ...
        return Project.gluProject(float0, float1, float2, floatBuffer0, floatBuffer1, intBuffer, floatBuffer2);
    }

    public static boolean gluUnProject(
        float float0, float float1, float float2, FloatBuffer floatBuffer0, FloatBuffer floatBuffer1, IntBuffer intBuffer, FloatBuffer floatBuffer2
    ) {
        return Project.gluUnProject(float0, float1, float2, floatBuffer0, floatBuffer1, intBuffer, floatBuffer2);
    }

    public static void gluPickMatrix(float float0, float float1, float float2, float float3, IntBuffer intBuffer) {
    ...
    public static boolean gluCheckExtension(String string0, String string1) {
        return Registry.gluCheckExtension(string0, string1);
    }

    public static int gluBuild2DMipmaps(int int0, int int1, int int2, int int3, int int4, int int5, ByteBuffer byteBuffer) {
        return MipMap.gluBuild2DMipmaps(int0, int1, int2, int3, int4, int5, byteBuffer);
    }

    public static int gluScaleImage(int int0, int int1, int int2, int int3, ByteBuffer byteBuffer0, int int4, int int5, int int6, ByteBuffer byteBuffer1) {
        return MipMap.gluScaleImage(int0, int1, int2, int3, byteBuffer0, int4, int5, int6, byteBuffer1);
    }
