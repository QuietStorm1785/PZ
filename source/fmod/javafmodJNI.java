...
public class javafmodJNI {
    ...
    private static void loadLibrary(String string1) {
    ...
    public static final native int FMOD_System_Set3DListenerAttributes(
        int var0,
        float var1,
        float var2,
        float var3,
    ...
    public static final native long FMOD_System_CreateRecordSound(long var0, long var2, long var4, long var6, int var8);
    ...
    public static final native long FMOD_System_CreateDSPByType(long var0);
    ...
    public static final native int FMOD_Channel_SetMixLevelsOutput(
    ...
    public static final native int FMOD_Channel_GetNumDSPs(long var0);
    ...
    public static final native int FMOD_ChannelGroup_SetMixLevelsOutput(
        long var0, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9
    );
    ...
    public static final native int FMOD_ChannelGroup_GetNumDSPs(long var0);
    ...
    public static final native void FMOD_Studio_Listener3D(
        int var0,
        float var1,
        float var2,
        float var3,
