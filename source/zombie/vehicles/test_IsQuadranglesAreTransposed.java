...
public class test_IsQuadranglesAreTransposed extends Assert {
    ...
    public void testIsQuadranglesAreTransposed_12() {
        Vector2[] vectors0 = new Vector2[]{
            new Vector2(10860.373F, 9928.479F), new Vector2(10860.373F, 9926.521F), new Vector2(10865.627F, 9926.521F), new Vector2(10865.627F, 9928.479F)
        };
        Vector2[] vectors1 = new Vector2[]{
            new Vector2(10864.479F, 9929.127F), new Vector2(10862.521F, 9929.127F), new Vector2(10862.521F, 9923.873F), new Vector2(10864.479F, 9923.873F)
        };
        assertEquals(true, QuadranglesIntersection.IsQuadranglesAreIntersected(vectors0, vectors1));
    }
    ...
    public void testIsQuadranglesAreTransposed_14() {
        assertEquals(false, QuadranglesIntersection.IsQuadranglesAreIntersected(null, null));
    }
}
