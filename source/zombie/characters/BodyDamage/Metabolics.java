...
public enum Metabolics {
    ...
    private Metabolics(float float0) {
        this.met = float0;
    }
    ...
    public static float MetToWm2(float _met) {
        return 58.0F * _met;
    }

    public static float MetToW(float _met) {
        return MetToWm2(_met) * 1.8F;
    }

    public static float MetToBtuHr(float _met) {
        return 356.0F * _met;
    }
}
