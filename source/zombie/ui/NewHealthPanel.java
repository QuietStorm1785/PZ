...
public final class NewHealthPanel extends NewWindow {
    ...
    public void render() {
        if (this.isVisible()) {
            ...
            double double0 = 0.15;
            double double1 = 1.0;
            this.DrawTextureScaledColor(null, 130.0, 25.0, 18.0, 1.0, double0, double0, double0, double1);
            this.DrawTextureScaledColor(null, 130.0, 25.0, 1.0, 172.0, double0, double0, double0, double1);
            this.DrawTextureScaledColor(null, 147.0, 25.0, 1.0, 172.0, double0, double0, double0, double1);
            if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
                ...
                this.DrawTextureScaledColor(null, double2, double3, 1.0, (double)this.height, 1.0, 1.0, 1.0, 0.5);
                this.DrawTextureScaledColor(null, double2 + 1.0, double3, this.width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
                this.DrawTextureScaledColor(null, double2 + this.width - 1.0, double3, 1.0, (double)this.height, 1.0, 1.0, 1.0, 0.5);
                this.DrawTextureScaledColor(null, double2 + 1.0, double3 + this.height - 1.0, this.width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
            }
        }
    }
