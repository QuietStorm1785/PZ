...
public class NonBlockingHashtable<TypeK, TypeV> extends Dictionary<TypeK, TypeV> implements ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
    ...
    private static final NonBlockingHashtable.CHM chm(Object[] objects) {
    ...
    private final void print(Object[] objects0) {
        for (int int0 = 0; int0 < len(objects0); int0++) {
            ...
            if (object0 != null) {
                ...
                Object object2 = NonBlockingHashtable.Prime.unbox(object1);
    ...
    private static final Object get_impl(NonBlockingHashtable nonBlockingHashtable, Object[] objects0, Object object2, int int2) {
        ...
        while (true) {
            ...
            if (keyeq(object0, object2, ints, int1, int2)) {
                ...
                return get_impl(nonBlockingHashtable, chm.copy_slot_and_check(nonBlockingHashtable, objects0, int1, object2), object2, int2);
            }

            if (++int3 >= reprobe_limit(int0) || object2 == TOMBSTONE) {
                return objects1 == null ? null : get_impl(nonBlockingHashtable, nonBlockingHashtable.help_copy(objects1), object2, int2);
            }
    ...
    private static final Object putIfMatch(NonBlockingHashtable nonBlockingHashtable, Object[] objects0, Object object2, Object object0, Object object1) {
        assert object0 != null;
        ...
        while (true) {
            ...
            if (!keyeq(object3, object2, ints, int2, int0)) {
                ...
                return putIfMatch(nonBlockingHashtable, objects1, object2, object0, object1);
            }
            break;
        }
        ...
        if (object0 == object4) {
            ...
            if (objects1 == null && (object4 == null && chm.tableFull(int3, int1) || object4 instanceof NonBlockingHashtable.Prime)) {
                objects1 = chm.resize(nonBlockingHashtable, objects0);
            }

            if (objects1 != null) {
                return putIfMatch(nonBlockingHashtable, chm.copy_slot_and_check(nonBlockingHashtable, objects0, int2, object1), object2, object0, object1);
            } else {
    ...
    private static final class CHM<TypeK, TypeV> {
        ...
        private final Object[] resize(NonBlockingHashtable nonBlockingHashtable, Object[] objects0) {
        ...
        private final void help_copy_impl(NonBlockingHashtable nonBlockingHashtable, Object[] objects0, boolean boolean0) {
            assert NonBlockingHashtable.chm(objects0) == this;
        ...
        private final Object[] copy_slot_and_check(NonBlockingHashtable nonBlockingHashtable, Object[] objects0, int int0, Object object) {
            assert NonBlockingHashtable.chm(objects0) == this;
            ...
            return object == null ? objects1 : nonBlockingHashtable.help_copy(objects1);
        }

        private final void copy_check_and_promote(NonBlockingHashtable nonBlockingHashtable, Object[] objects, int int1) {
        ...
        private boolean copy_slot(NonBlockingHashtable nonBlockingHashtable, int int0, Object[] objects0, Object[] objects1) {
            Object object0;
            while ((object0 = NonBlockingHashtable.key(objects0, int0)) == null) {
                NonBlockingHashtable.CAS_key(objects0, int0, null, NonBlockingHashtable.TOMBSTONE);
            }
            ...
            for (object1 = NonBlockingHashtable.val(objects0, int0);
                ...
                NonBlockingHashtable.Prime prime = object1 != null && object1 != NonBlockingHashtable.TOMBSTONE
            ...
            if (object1 == NonBlockingHashtable.TOMBPRIME) {
                ...
                Object object2 = ((NonBlockingHashtable.Prime)object1)._V;

                assert object2 != NonBlockingHashtable.TOMBSTONE;

                boolean boolean0 = NonBlockingHashtable.putIfMatch(nonBlockingHashtable, objects1, object0, object2, null) == null;
