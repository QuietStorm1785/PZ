...
public class NonBlockingIdentityHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV> implements ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
    ...
    private static final NonBlockingIdentityHashMap.CHM chm(Object[] objects) {
    ...
    private final void print(Object[] objects0) {
        for (int int0 = 0; int0 < len(objects0); int0++) {
            ...
            if (object0 != null) {
                ...
                Object object2 = NonBlockingIdentityHashMap.Prime.unbox(object1);
    ...
    private static final Object get_impl(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects0, Object object2, int int2) {
        ...
        while (true) {
            ...
            if (object0 == object2) {
                ...
                return get_impl(nonBlockingIdentityHashMap, chm.copy_slot_and_check(nonBlockingIdentityHashMap, objects0, int1, object2), object2, int2);
            }

            if (++int3 >= reprobe_limit(int0) || object2 == TOMBSTONE) {
                return objects1 == null ? null : get_impl(nonBlockingIdentityHashMap, nonBlockingIdentityHashMap.help_copy(objects1), object2, int2);
            }
    ...
    private static final Object putIfMatch(
        ...
        while (true) {
            ...
            if (object3 != object2) {
                ...
                return putIfMatch(nonBlockingIdentityHashMap, objects1, object2, object0, object1);
            }
            break;
        }
        ...
        if (object0 == object4) {
            ...
            if (objects1 == null && (object4 == null && chm.tableFull(int3, int1) || object4 instanceof NonBlockingIdentityHashMap.Prime)) {
                objects1 = chm.resize(nonBlockingIdentityHashMap, objects0);
            }
        ...
        return new AbstractSet<Entry<TypeK, TypeV>>() {
            ...
            public boolean contains(Object object0) {
                if (!(object0 instanceof Entry entry)) {
                    ...
                    Object object1 = NonBlockingIdentityHashMap.this.get(entry.getKey());
    ...
    private static final class CHM<TypeK, TypeV> {
        ...
        private final Object[] resize(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects0) {
        ...
        private final void help_copy_impl(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects0, boolean boolean0) {
            assert NonBlockingIdentityHashMap.chm(objects0) == this;
        ...
        private final Object[] copy_slot_and_check(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects0, int int0, Object object) {
            assert NonBlockingIdentityHashMap.chm(objects0) == this;
            ...
            return object == null ? objects1 : nonBlockingIdentityHashMap.help_copy(objects1);
        }

        private final void copy_check_and_promote(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects, int int1) {
        ...
        private boolean copy_slot(NonBlockingIdentityHashMap nonBlockingIdentityHashMap, int int0, Object[] objects0, Object[] objects1) {
            Object object0;
            while ((object0 = NonBlockingIdentityHashMap.key(objects0, int0)) == null) {
                NonBlockingIdentityHashMap.CAS_key(objects0, int0, null, NonBlockingIdentityHashMap.TOMBSTONE);
            }
            ...
            for (object1 = NonBlockingIdentityHashMap.val(objects0, int0);
                ...
                NonBlockingIdentityHashMap.Prime prime = object1 != null && object1 != NonBlockingIdentityHashMap.TOMBSTONE
            ...
            if (object1 == NonBlockingIdentityHashMap.TOMBPRIME) {
                ...
                Object object2 = ((NonBlockingIdentityHashMap.Prime)object1)._V;

                assert object2 != NonBlockingIdentityHashMap.TOMBSTONE;

                boolean boolean0 = NonBlockingIdentityHashMap.putIfMatch(nonBlockingIdentityHashMap, objects1, object0, object2, null) == null;
