...
public final class ParameterZombieState extends FMODLocalParameter {
    ...
    public ParameterZombieState(IsoZombie _zombie) {
        super("ZombieState");
        this.zombie = _zombie;
    }
    ...
    public void setState(ParameterZombieState.State _state) {
        if (_state != this.state) {
            this.state = _state;
        }
    }

    public boolean isState(ParameterZombieState.State _state) {
