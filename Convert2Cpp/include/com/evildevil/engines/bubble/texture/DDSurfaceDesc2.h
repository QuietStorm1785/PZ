...
public:
    ...
    void setDDPixelFormat(DDPixelFormat var1) {
      if (var1 == nullptr) {
         throw new NullPointerException("DDPixelFormat can't be nullptr. DDSurfaceDesc2 needs a valid DDPixelFormat.");
      } else {
         this.pixelFormat = var1;
      }
   }

    DDPixelFormat getDDPixelformat() {
      return this.pixelFormat;
   }

    void setDDSCaps2(DDSCaps2 var1) {
      if (var1 == nullptr) {
         throw new NullPointerException("DDSCaps can't be nullptr. DDSurfaceDesc2 needs a valid DDSCaps2.");
      } else {
         this.caps2 = var1;
      }
   }

    DDSCaps2 getDDSCaps2() {
      return this.caps2;
   }
}
} // namespace texture
