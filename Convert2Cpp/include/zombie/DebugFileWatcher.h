...
public:
   private final HashMap<Path, String> m_watchedFiles = std::make_unique<HashMap<>>();
   private final HashMap<WatchKey, Path> m_watchkeyMapping = std::make_unique<HashMap<>>();
   private final ArrayList<PredicatedFileWatcher> m_predicateWatchers = std::make_unique<ArrayList<>>();
   private final ArrayList<PredicatedFileWatcher> m_predicateWatchersInvoking = std::make_unique<ArrayList<>>();
