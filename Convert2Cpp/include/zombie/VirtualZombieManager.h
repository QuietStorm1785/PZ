...
public:
   private final ArrayDeque<IsoZombie> ReusableZombies = std::make_unique<ArrayDeque<>>();
   ...
   private final ArrayList<IsoGridSquare> bestchoices = std::make_unique<ArrayList<>>();
    HandWeapon w = null;
    int BLOCKED_N = 1;
    int BLOCKED_S = 2;
    int BLOCKED_W = 4;
    ...
    bool var2 = var1.getCurrentSquare() != null;
   ...
   public ArrayList<IsoZombie> addZombiesToMap(int var1, RoomDef var2, boolean var3) {
    ...
    bool var5 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 1, 0, 1) && var4.nav[IsoDirections.N.index()] != null;
    bool var6 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 1, 2, 1) && var4.nav[IsoDirections.S.index()] != null;
    bool var7 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 0, 1, 1) && var4.nav[IsoDirections.W.index()] != null;
    bool var8 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 2, 1, 1) && var4.nav[IsoDirections.E.index()] != null;
