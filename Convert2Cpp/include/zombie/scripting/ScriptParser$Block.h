...
public:
    std::string type;
    std::string id;
   public final ArrayList<BlockElement> elements = std::make_unique<ArrayList<>>();
   public final ArrayList<Value> values = std::make_unique<ArrayList<>>();
   public final ArrayList<ScriptParser$Block> children = std::make_unique<ArrayList<>>();
