...
public:
   ...
   public SandboxOptions$EnumSandboxOption(SandboxOptions var1, String var2, int var3, int var4) {
    ...
    std::string var1 = Translator.getTextOrNull("Sandbox_" + (this.translation == null ? this.getShortName() : this.translation) + "_tooltip");
    std::string var2 = this.getValueTranslationByIndexOrNull(this.defaultValue);
    std::string var3 = var2 == null ? null : Translator.getText("Sandbox_Default", var2);
      if (var1 == nullptr) {
    return var3;
      } else {
