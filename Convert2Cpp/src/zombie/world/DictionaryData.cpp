...
void DictionaryData::getItemMods(List<String> var1) {
    // TODO: Implement getItemMods
}

void DictionaryData::getModuleList(List<String> var1) {
...
void DictionaryData::parseObjectNameLoadList(List<String> var1) {
