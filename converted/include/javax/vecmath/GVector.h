...
public:
 ...
 double getElement(int int0) {
 return this->values[int0];
 }

 void setElement(int int0, double double0) {
 ...
 void SVDBackSolve(GMatrix gMatrix1, GMatrix gMatrix0, GMatrix gMatrix2, GVector gVector0) {
