...
public:
 ...
 void invert(GMatrix gMatrix1) {
 this->invertGeneral(gMatrix1);
 }

 void copySubMatrix(int int5, int int4, int int1, int int3, int int7, int int6, GMatrix gMatrix1) {
 if (this != gMatrix1) {
 ...
 double getElement(int int1, int int0) {
 ...
 static bool luDecomposition(int int0, double[] doubles1, int[] ints1, int[] ints0) {
 double[] doubles0 = new double[int0];
 int int1 = 0;
 int int2 = 0;
 ints0[0] = 1;
 ...
 static void update_v(int int1, GMatrix gMatrix, double[] doubles1, double[] doubles0) {
 for (int int0 = 0; int0 < gMatrix.nRow; int0++) {
 ...
 static void chase_up(double[] doubles3, double[] doubles2, int int0, GMatrix gMatrix1) {
 double[] doubles0 = new double[1];
 double[] doubles1 = new double[1];
 GMatrix gMatrix0 = new GMatrix(gMatrix1.nRow, gMatrix1.nCol);
 GMatrix gMatrix2 = new GMatrix(gMatrix1.nRow, gMatrix1.nCol);
 ...
 static void chase_across(double[] doubles3, double[] doubles2, int int0, GMatrix gMatrix1) {
 double[] doubles0 = new double[1];
 double[] doubles1 = new double[1];
 GMatrix gMatrix0 = new GMatrix(gMatrix1.nRow, gMatrix1.nCol);
 GMatrix gMatrix2 = new GMatrix(gMatrix1.nRow, gMatrix1.nCol);
 ...
 static void update_v_split(int int1, int int2, GMatrix gMatrix0, double[] doubles1, double[] doubles0, GMatrix gMatrix2, GMatrix gMatrix1) {
 ...
 static void update_u_split(int int1, int int2, GMatrix gMatrix0, double[] doubles1, double[] doubles0, GMatrix gMatrix2, GMatrix gMatrix1) {
 ...
 static void update_u(int int1, GMatrix gMatrix, double[] doubles1, double[] doubles0) {
 ...
 static void print_svd(double[] doubles0, double[] doubles1, GMatrix gMatrix2, GMatrix gMatrix1) {
