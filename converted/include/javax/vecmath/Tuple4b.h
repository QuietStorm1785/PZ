...
public:
 ...
 public Tuple4b(uint8_t byte0, uint8_t byte1, uint8_t byte2, uint8_t byte3) {
 this->x = byte0;
 this->y = byte1;
 this->z = byte2;
 this->w = byte3;
