...
public:
 ...
 void setRow(int int0, float float0, float float1, float float2, float float3) {
 switch (int0) {
 case 0:
 this->m00 = float0;
 this->m01 = float1;
 ...
 void setColumn(int int0, float float0, float float1, float float2, float float3) {
 switch (int0) {
 case 0:
 this->m00 = float0;
 this->m10 = float1;
 ...
 void invert(Matrix4f matrix4f1) {
