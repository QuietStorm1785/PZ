...
public:
 ...
 static void registerPlayerZombieDescriptor(SharedDescriptors.Descriptor descriptor) {
 ...
 static void ApplyReanimatedPlayerOutfit(int int0, const std::string& var1, IsoGameCharacter character) {
 ...
 public static class Descriptor implements IHumanVisual {
 int ID = 0;
 ...
 private static class DescriptorList extends ArrayList<SharedDescriptors.Descriptor> {
 }
}
} // namespace zombie
