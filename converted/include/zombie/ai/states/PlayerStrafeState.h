...
public:
  static const PlayerStrafeState _instance = new PlayerStrafeState();

  static PlayerStrafeState instance() { return _instance; }

  void enter(IsoGameCharacter owner) {
    if (!"aim" == owner.getPreviousActionContextStateName())) {
