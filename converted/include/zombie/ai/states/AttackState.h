...
public:
 ...
 GameClient.sendHitCharacter(zombie0, character, nullptr, 0.0F, false, 1.0F, false, false, false);
 }
 }
 ...
 */
 ...
 void triggerPlayerReaction(const std::string& string1, IsoGameCharacter character0) {
 ...
 if ((!character1.isDead() || character1.getHitReaction() == "EndDeath")) && !character1.isOnFloor()) {
