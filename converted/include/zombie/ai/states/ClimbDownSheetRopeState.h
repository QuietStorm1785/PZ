...
public:
 ...
 static const ClimbDownSheetRopeState _instance = new ClimbDownSheetRopeState();
 ...
 IsoGridSquare square = cell.getGridSquare((double)owner.getX(), (double)owner.getY(), (double)int0);
 if ((square.Is(IsoFlagType.solidtrans) || square.TreatAsSolidFloor() || int0 == 0) && float7 <= int0) {
 owner.z = int0;
 hashMap.clear();
