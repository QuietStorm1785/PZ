...
public:
 ...
 if (owner.getAttackedBy() != nullptr && owner.getAttackedBy() instanceof IsoZombie) {
 ...
 GameClient.sendHitCharacter(owner.getAttackedBy(), owner, nullptr, 0.0F, false, 1.0F, false, false, false);
 }
 }
 ...
 DebugLog.log("PlayerHitReactionState.animEvent (" + event.m_EventName + ") zombie is nullptr");
 }
 }
}
} // namespace states
