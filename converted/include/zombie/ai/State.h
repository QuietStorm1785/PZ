...
public:
   ...
   */
  bool isAttacking(IsoGameCharacter owner) { return false; }

  /**
   * Return TRUE if the owner is currently moving.   Defaults to FALSE
   */
  bool isMoving(IsoGameCharacter owner) { return false; }
  ...
  std::string getName() { return this.getClass().getSimpleName(); }
