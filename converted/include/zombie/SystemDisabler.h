...
public:
 ...
 static void setDoCharacterStats(bool bDo) {
 doCharacterStats = bDo;
 }

 static void setDoZombieCreation(bool bDo) {
 doZombieCreation = bDo;
 }

 static void setDoSurvivorCreation(bool bDo) {
 doSurvivorCreation = bDo;
 }

 static void setDoPlayerCreation(bool bDo) {
 ...
 static void setVehiclesEverywhere(bool bDo) {
 doVehiclesEverywhere = bDo;
 }

 static void setWorldSyncEnable(bool bDo) {
