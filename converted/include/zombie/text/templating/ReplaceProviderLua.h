...
public:
private
  static final ConcurrentLinkedDeque<ReplaceSingle> pool_single =
      std::make_unique<ConcurrentLinkedDeque<>>();
private
  static final ConcurrentLinkedDeque<ReplaceList> pool_list =
      std::make_unique<ConcurrentLinkedDeque<>>();
private
  static final ConcurrentLinkedDeque<ReplaceProviderLua> pool =
      std::make_unique<ConcurrentLinkedDeque<>>();
