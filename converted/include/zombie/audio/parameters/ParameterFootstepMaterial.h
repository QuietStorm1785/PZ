...
public
  ParameterFootstepMaterial(IsoGameCharacter _character) {
...
private
  ParameterFootstepMaterial.FootstepMaterial getMaterial() {
  ...
  static enum FootstepMaterial {
    Upstairs(0), BrokenGlass(1), Concrete(2), Grass(3), Gravel(4), Puddle(5),
    Snow(6), Wood(7), Carpet(8), Dirt(9), Sand(10), Ceramic(11), Metal(12);

    const int label;

    private FootstepMaterial(int int1){this.label = int1;}
}
} // namespace parameters
} // namespace audio
} // namespace zombie
