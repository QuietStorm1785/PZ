...
public:
 ...
 int stopSoundByName(const std::string& name) {
 return 0;
 }
 ...
 void setParameterValue(long handle, FMOD_STUDIO_PARAMETER_DESCRIPTION parameterDescription, float value) {
 }
 ...
 long playSound(const std::string& file, int x, int y, int z) {
 return 0L;
 }

 long playSound(const std::string& file, IsoGridSquare square) {
 return 0L;
 }
 ...
 long playSoundImpl(const std::string& file, bool doWorldSound, IsoObject parent) {
 return 0L;
 }

 long playSound(const std::string& file, IsoObject parent) {
 return 0L;
 }
 ...
 long playAmbientSound(const std::string& name) {
 return 0L;
 }
 ...
 bool restart(long handle) {
 return false;
 }

 long playSoundLooped(const std::string& file) {
 return 0L;
 }

 long playSoundLoopedImpl(const std::string& file) {
 return 0L;
 }

 long playAmbientLoopedImpl(const std::string& file) {
 return 0L;
 }
}
} // namespace audio
