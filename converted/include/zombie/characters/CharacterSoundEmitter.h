...
public:
 ...
 long long1 = this->footsteps.playSoundImpl(file, false, nullptr);
 if (!boolean0) {
 ...
 void setParameterValue(long soundRef, FMOD_STUDIO_PARAMETER_DESCRIPTION parameterDescription, float value) {
