...
public:
 ...
 public AttachedModelName(const std::string& attachmentName, const std::string& _modelName, float _bloodLevel) {
 ...
 public AttachedModelName(const std::string& _attachmentNameSelf, const std::string& _attachmentNameParent, const std::string& _modelName, float _bloodLevel) {
