...
public:
 public static ArrayList<String> FemaleForenames = std::make_unique<ArrayList<>>();
 public static ArrayList<String> MaleForenames = std::make_unique<ArrayList<>>();
 public static ArrayList<String> Surnames = std::make_unique<ArrayList<>>();
 ...
 static SurvivorDesc CreateSurvivor(SurvivorFactory.SurvivorType survivorType, bool bFemale) {
 ...
 static void addSurname(const std::string& surName) {
