...
public:
 ...
 for (auto& long0 : longs) transform1 = networkCharacter.reconstruct((int)long0, transform1.position.x, transform1.position.y, transform1.rotation.x, transform1.rotation.y);
 System.out
 .print(
 "transform:("
