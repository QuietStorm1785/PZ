...
public:
 ...
 public ClothingWetness.ItemList[] clothing = new ClothingWetness.ItemList[BloodBodyPartType.MAX.index()];
 public int[] perspiringParts = new int[BloodBodyPartType.MAX.index()];
 bool changed = true;
 ...
 private static class ItemList extends ArrayList<InventoryItem> {
 }
}
} // namespace characters
} // namespace zombie
