...
public:
 ...
 static bool updateMovementFromInput(IsoPlayer player0, IsoPlayer.MoveVars moveVars) {
 ...
 static bool updateInputState(IsoPlayer player0, IsoPlayer.InputState inputState) {
