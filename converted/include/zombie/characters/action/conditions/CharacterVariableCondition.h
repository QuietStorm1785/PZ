...
public:
 ...
 static void* resolveValue(void* object, IAnimationVariableSource iAnimationVariableSource) {
 if (object instanceof CharacterVariableCondition.CharacterVariableLookup) {
 std::string string = iAnimationVariableSource.getVariableString(((CharacterVariableCondition.CharacterVariableLookup)object).variableName);
 ...
 bool boolean5 = this->lhsValue instanceof CharacterVariableCondition.CharacterVariableLookup;
 bool boolean6 = this->rhsValue instanceof CharacterVariableCondition.CharacterVariableLookup;
 ...
 public CharacterVariableLookup(const std::string& string) {
 ...
 return characterVariableCondition.load(element) ? characterVariableCondition : nullptr;
 }
 }
