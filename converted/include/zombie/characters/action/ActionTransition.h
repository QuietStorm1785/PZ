...
public:
 ...
 static bool parse(Element element, const std::string& string, List<ActionTransition> list) {
 ...
 static void parseTransitions(Element element, const std::string& string, List<ActionTransition> list) {
 list.clear();
