...
class PerkFactory {
public:
 public static ArrayList<PerkFactory.Perk> PerkList = std::make_unique<ArrayList<>>();
 private static HashMap<String, PerkFactory.Perk> PerkById = std::make_unique<HashMap<>>();
 private static HashMap<String, PerkFactory.Perk> PerkByName = std::make_unique<HashMap<>>();
 private static PerkFactory.Perk[] PerkByIndex = new PerkFactory.Perk[256];
 ...
 public Perk(const std::string& _id) {
 this->id = _id;
 ...
 public Perk(const std::string& _id, PerkFactory.Perk _parent) {
 this(_id);
 this->parent = _parent;
 }
 ...
 public static PerkFactory.Perk None = new PerkFactory.Perk("None");
 public static PerkFactory.Perk Agility = new PerkFactory.Perk("Agility");
 public static PerkFactory.Perk Cooking = new PerkFactory.Perk("Cooking");
 public static PerkFactory.Perk Melee = new PerkFactory.Perk("Melee");
 public static PerkFactory.Perk Crafting = new PerkFactory.Perk("Crafting");
 public static PerkFactory.Perk Fitness = new PerkFactory.Perk("Fitness");
 public static PerkFactory.Perk Strength = new PerkFactory.Perk("Strength");
 public static PerkFactory.Perk Blunt = new PerkFactory.Perk("Blunt");
 public static PerkFactory.Perk Axe = new PerkFactory.Perk("Axe");
 public static PerkFactory.Perk Sprinting = new PerkFactory.Perk("Sprinting");
 public static PerkFactory.Perk Lightfoot = new PerkFactory.Perk("Lightfoot");
 public static PerkFactory.Perk Nimble = new PerkFactory.Perk("Nimble");
 public static PerkFactory.Perk Sneak = new PerkFactory.Perk("Sneak");
 public static PerkFactory.Perk Woodwork = new PerkFactory.Perk("Woodwork");
 public static PerkFactory.Perk Aiming = new PerkFactory.Perk("Aiming");
 public static PerkFactory.Perk Reloading = new PerkFactory.Perk("Reloading");
 public static PerkFactory.Perk Farming = new PerkFactory.Perk("Farming");
 public static PerkFactory.Perk Survivalist = new PerkFactory.Perk("Survivalist");
 public static PerkFactory.Perk Fishing = new PerkFactory.Perk("Fishing");
 public static PerkFactory.Perk Trapping = new PerkFactory.Perk("Trapping");
 public static PerkFactory.Perk Passiv = new PerkFactory.Perk("Passiv");
 public static PerkFactory.Perk Firearm = new PerkFactory.Perk("Firearm");
 public static PerkFactory.Perk PlantScavenging = new PerkFactory.Perk("PlantScavenging");
 public static PerkFactory.Perk Doctor = new PerkFactory.Perk("Doctor");
 public static PerkFactory.Perk Electricity = new PerkFactory.Perk("Electricity");
 public static PerkFactory.Perk Blacksmith = new PerkFactory.Perk("Blacksmith");
 public static PerkFactory.Perk MetalWelding = new PerkFactory.Perk("MetalWelding");
 public static PerkFactory.Perk Melting = new PerkFactory.Perk("Melting");
 public static PerkFactory.Perk Mechanics = new PerkFactory.Perk("Mechanics");
 public static PerkFactory.Perk Spear = new PerkFactory.Perk("Spear");
 public static PerkFactory.Perk Maintenance = new PerkFactory.Perk("Maintenance");
 public static PerkFactory.Perk SmallBlade = new PerkFactory.Perk("SmallBlade");
 public static PerkFactory.Perk LongBlade = new PerkFactory.Perk("LongBlade");
 public static PerkFactory.Perk SmallBlunt = new PerkFactory.Perk("SmallBlunt");
 public static PerkFactory.Perk Combat = new PerkFactory.Perk("Combat");
 public static PerkFactory.Perk Tailoring = new PerkFactory.Perk("Tailoring");
 public static PerkFactory.Perk MAX = new PerkFactory.Perk("MAX");
 ...
 return value >= 0 && value <= PerkFactory.NextPerkID ? PerkFactory.PerkByIndex[value] : nullptr;
 }
