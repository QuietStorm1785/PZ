...
public:
 ...
 void setBandaged(bool Bandaged, float _bandageLife, bool isAlcoholic, const std::string& _bandageType) {
 if (Bandaged) {
 if (this->bleeding) {
 this->bleeding = false;
 }
 ...
 void damageFromFirearm(float damage) {
 ...
 void setBiteTime(float _biteTime) {
 ...
 void setHaveGlass(bool _haveGlass) {
 ...
 void setStitchTime(float _stitchTime) {
 ...
 void setGetStitchXp(bool _getStitchXp) {
 ...
 void setGetSplintXp(bool _getSplintXp) {
 ...
 void setBurnTime(float _burnTime) {
