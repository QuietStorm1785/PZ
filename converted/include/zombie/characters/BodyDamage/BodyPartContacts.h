...
public:
 private static BodyPartContacts.ContactNode root;
 private static BodyPartContacts.ContactNode[] nodes;
 ...
 static void initNodes(BodyPartContacts.ContactNode contactNode1, int int0, BodyPartContacts.ContactNode contactNode0) {
 ...
 if (contactNode.allContacts != nullptr && contactNode.allContacts.length > 0) {
