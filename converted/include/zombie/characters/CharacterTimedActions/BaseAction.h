...
public:
 ...
 public ArrayList<String> animVariables = std::make_unique<ArrayList<>>();
 bool loopAction = false;
 bool bStarted = false;
 bool forceStop = false;
 bool forceComplete = false;
 private static ArrayList<String> specificNetworkAnim = new ArrayList<>(
 ...
 void PlayLoopedSoundTillComplete(const std::string& name, int radius, float maxGain) {
 ...
 void setBlockMovementEtc(bool block) {
 ...
 void setOverrideHandModels(InventoryItem primaryHand, InventoryItem secondaryHand) {
 this->setOverrideHandModels(primaryHand, secondaryHand, true);
 }

 void setOverrideHandModels(InventoryItem primaryHand, InventoryItem secondaryHand, bool resetModel) {
 this->setOverrideHandModelsObject(primaryHand, secondaryHand, resetModel);
 }

 void setOverrideHandModelsString(const std::string& primaryHand, const std::string& secondaryHand) {
 this->setOverrideHandModelsString(primaryHand, secondaryHand, true);
 }

 void setOverrideHandModelsString(const std::string& primaryHand, const std::string& secondaryHand, bool resetModel) {
 this->setOverrideHandModelsObject(primaryHand, secondaryHand, resetModel);
 }

 void setOverrideHandModelsObject(void* primaryHand, void* secondaryHand, bool resetModel) {
 ...
 void setLoopedAction(bool looped) {
