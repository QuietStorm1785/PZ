...
public:
  static int getInt(IsoZombie zombie0, short short0) {
    ...
    case 4:
      float float0 =
          (Float)zombie0.getStateMachineParams(ZombieTurnAlerted.instance())
              .get(ZombieTurnAlerted.PARAM_TARGET_ANGLE);
      if (float0 == nullptr) {
        return 0;
      }
  ...
  static void setInt(IsoZombie zombie0, short short0, int int0) {
    ...
    case 3:
      ...
      break;
    case 4:
      zombie0.getStateMachineParams(ZombieTurnAlerted.instance())
          .put(ZombieTurnAlerted.PARAM_TARGET_ANGLE, (float)int0);
    }
  }
