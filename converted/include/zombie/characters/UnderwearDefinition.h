...
public:
 ...
 bool m_dirty = true;
 private static ArrayList<UnderwearDefinition.OutfitUnderwearDefinition> m_outfitDefinition = std::make_unique<ArrayList<>>();
 ...
 UnderwearDefinition.OutfitUnderwearDefinition outfitUnderwearDefinition1 = nullptr;
 int int3 = 0;
 ...
 if (Rand.Next(100) < 60 && itemVisual1 != nullptr && itemVisual0 != nullptr) {
 ...
 public static class OutfitUnderwearDefinition {
 ...
 public OutfitUnderwearDefinition(ArrayList<UnderwearDefinition.StringChance> arrayList, const std::string& string0, int int1, const std::string& string1) {
 this->top = arrayList;
 ...
 public StringChance(const std::string& string, float float0) {
 this->str = string;
 this->chance = float0;
 }
 }
