...
public
  abstract long playVocals(String file);

public
  abstract void playFootsteps(String file, float volume);

public
  abstract long playSound(String file);

public
  abstract long playSound(String file, IsoObject proxy);

public
  abstract long playSoundImpl(String file, IsoObject proxy);

public
  abstract void tick();

public
  abstract void set(float x, float y, float z);
...
public
  abstract int stopSoundByName(String soundName);
