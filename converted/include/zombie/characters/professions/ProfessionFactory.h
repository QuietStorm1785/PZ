...
public:
 public static LinkedHashMap<String, ProfessionFactory.Profession> ProfessionMap = std::make_unique<LinkedHashMap<>>();
 ...
 public Stack<String> FreeTraitStack = std::make_unique<Stack<>>();
 ...
 public Profession(const std::string& _type, const std::string& _name, const std::string& IconPathname, int _cost, const std::string& desc) {
 this->type = _type;
 this->name = _name;
