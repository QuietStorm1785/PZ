...
public:
 ...
 int minWorldAge;
 public ArrayList<HairOutfitDefinitions.HaircutDefinition> m_haircutDefinition = std::make_unique<ArrayList<>>();
 public ArrayList<HairOutfitDefinitions.HaircutOutfitDefinition> m_outfitDefinition = std::make_unique<ArrayList<>>();
 private ThreadLocal<ArrayList<HairStyle>> m_tempHairStyles = ThreadLocal.withInitial(ArrayList::new);
 ...
 void getValidHairStylesForOutfit(const std::string& string, ArrayList<HairStyle> arrayList1, ArrayList<HairStyle> arrayList0) {
 arrayList0.clear();
 ...
 std::string getRandomHaircut(const std::string& string0, ArrayList<HairStyle> arrayList1) {
 ...
 std::string getRandomBeard(const std::string& string1, ArrayList<BeardStyle> arrayList) {
 ...
 public static class HaircutDefinition {
 std::string hairStyle;
 int minWorldAge;
 public ArrayList<String> onlyFor;

 public HaircutDefinition(const std::string& string, int int0, ArrayList<String> arrayList) {
 ...
 public static class HaircutOutfitDefinition {
 std::string outfit;
