...
public:
 ...
 private void n_render(float var1, int var2, int var3, float var4, float var5, int var6, int var7);

 private void n_setWallFollowerStart(int var1, int var2);

 private void n_setWallFollowerEnd(int var1, int var2);

 private void n_wallFollowerMouseMove(int var1, int var2);

 private void n_setDebugOption(String var1, String var2);
 ...
 SpriteRenderer.instance.renderline(nullptr, int1, int2, int3, int4, r, g, b, a);
 double0 = double2;
 double1 = double3;
 }
 }
 ...
 void save() {
 std::string string = ZomboidFileSystem.instance.getCacheDir() + File.separator + "popman-options.ini";
