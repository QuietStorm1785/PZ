...
public:
 ...
 public PZXmlParserException(const std::string& string) {
 super(string);
 }

 public PZXmlParserException(const std::string& string, std::exception throwable) {
 super(string, throwable);
 }

 public PZXmlParserException(std::exception throwable) {
 super(throwable);
 }
