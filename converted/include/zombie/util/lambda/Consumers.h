...
public
  ...
  public
    static final class CallbackStackItem<E, T1>
        extends Consumers.Params1.StackItem<T1> implements Consumer<E> {
    private
      Consumers.Params1.ICallback<E, T1> consumer;
    private
      static final Pool<Consumers.Params1.CallbackStackItem<Object, Object>>
          s_pool = new Pool<>(Consumers.Params1.CallbackStackItem::new);

      void accept(E object) { this.consumer.accept((E)object, this.val1); }

    public
      static<E, T1> Consumers.Params1.CallbackStackItem<E, T1>
      alloc(T1 object, Consumers.Params1.ICallback<E, T1> iCallback) {
  ...
  public
    static final class CallbackStackItem<E, T1, T2>
        extends Consumers.Params2.StackItem<T1, T2> implements Consumer<E> {
    private
      Consumers.Params2.ICallback<E, T1, T2> consumer;
    private
      static final
          Pool<Consumers.Params2.CallbackStackItem<Object, Object, Object>>
              s_pool = new Pool<>(Consumers.Params2.CallbackStackItem::new);
    ...
    public
      static<E, T1, T2> Consumers.Params2.CallbackStackItem<E, T1, T2>
  ...
  public
    static final class CallbackStackItem<E, T1, T2, T3>
        extends Consumers.Params3.StackItem<T1, T2, T3> implements Consumer<E> {
    private
      Consumers.Params3.ICallback<E, T1, T2, T3> consumer;
    private
      static final Pool<
          Consumers.Params3.CallbackStackItem<Object, Object, Object, Object>>
          s_pool = new Pool<>(Consumers.Params3.CallbackStackItem::new);
    ...
    public
      static<E, T1, T2, T3> Consumers.Params3.CallbackStackItem<E, T1, T2, T3>
  ...
  public
    static final class CallbackStackItem<E, T1, T2, T3, T4>
        extends Consumers.Params4.StackItem<T1, T2, T3, T4> implements
            Consumer<E> {
    private
      Consumers.Params4.ICallback<E, T1, T2, T3, T4> consumer;
    private
      static final Pool<Consumers.Params4.CallbackStackItem<
          Object, Object, Object, Object, Object>>
          s_pool = new Pool<>(Consumers.Params4.CallbackStackItem::new);
    ...
    public
      static<E, T1, T2, T3, T4>
          Consumers.Params4.CallbackStackItem<E, T1, T2, T3, T4>
  ...
  public
    static final class CallbackStackItem<E, T1, T2, T3, T4, T5>
        extends Consumers.Params5.StackItem<T1, T2, T3, T4, T5> implements
            Consumer<E> {
    private
      Consumers.Params5.ICallback<E, T1, T2, T3, T4, T5> consumer;
    private
      static final Pool<Consumers.Params5.CallbackStackItem<
          Object, Object, Object, Object, Object, Object>>
          s_pool = new Pool<>(Consumers.Params5.CallbackStackItem::new);
    ...
    public
      static<E, T1, T2, T3, T4, T5>
          Consumers.Params5.CallbackStackItem<E, T1, T2, T3, T4, T5>
  ...
  private
    static class StackItem<T1, T2, T3, T4, T5> extends PooledObject {
      T1 val1;
      T2 val2;
      T3 val3;
      T4 val4;
