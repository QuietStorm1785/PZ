...
public:
 ...
 public static class CallbackStackItem<E, T1> extends Consumers.Params1.StackItem<T1> implements Consumer<E> {
 private Consumers.Params1.ICallback<E, T1> consumer;
 private static Pool<Consumers.Params1.CallbackStackItem<Object, Object>> s_pool = new Pool<>(Consumers.Params1.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<E, T1, T2> extends Consumers.Params2.StackItem<T1, T2> implements Consumer<E> {
 private Consumers.Params2.ICallback<E, T1, T2> consumer;
 private static Pool<Consumers.Params2.CallbackStackItem<Object, Object, Object>> s_pool = new Pool<>(Consumers.Params2.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<E, T1, T2, T3> extends Consumers.Params3.StackItem<T1, T2, T3> implements Consumer<E> {
 private Consumers.Params3.ICallback<E, T1, T2, T3> consumer;
 private static Pool<Consumers.Params3.CallbackStackItem<Object, Object, Object, Object>> s_pool = new Pool<>(
 ...
 public static class CallbackStackItem<E, T1, T2, T3, T4> extends Consumers.Params4.StackItem<T1, T2, T3, T4> implements Consumer<E> {
 private Consumers.Params4.ICallback<E, T1, T2, T3, T4> consumer;
 private static Pool<Consumers.Params4.CallbackStackItem<Object, Object, Object, Object, Object>> s_pool = new Pool<>(
 ...
 public static class CallbackStackItem<E, T1, T2, T3, T4, T5> extends Consumers.Params5.StackItem<T1, T2, T3, T4, T5> implements Consumer<E> {
 private Consumers.Params5.ICallback<E, T1, T2, T3, T4, T5> consumer;
 private static Pool<Consumers.Params5.CallbackStackItem<Object, Object, Object, Object, Object, Object>> s_pool = new Pool<>(
