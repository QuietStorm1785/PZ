...
class Stacks {
public:
 public static class GenericStack extends PooledObject {
 private List<IPooledObject> m_stackItems = std::make_unique<ArrayList<>>();
 ...
 public static class CallbackStackItem<T1> extends Stacks.Params1.StackItem<T1> {
 private Stacks.Params1.ICallback<T1> callback;
 private static Pool<Stacks.Params1.CallbackStackItem<Object>> s_pool = new Pool<>(Stacks.Params1.CallbackStackItem::new);
 ...
 private static class StackItem<T1> extends Stacks.GenericStack {
 T1 val1;
 }
 }

 public static class Params2 {
 public static class CallbackStackItem<T1, T2> extends Stacks.Params2.StackItem<T1, T2> {
 private Stacks.Params2.ICallback<T1, T2> callback;
 private static Pool<Stacks.Params2.CallbackStackItem<Object, Object>> s_pool = new Pool<>(Stacks.Params2.CallbackStackItem::new);
 ...
 private static class StackItem<T1, T2> extends Stacks.GenericStack {
 T1 val1;
 T2 val2;
 }
 }
 ...
 public static class CallbackStackItem<T1, T2, T3> extends Stacks.Params3.StackItem<T1, T2, T3> {
 private Stacks.Params3.ICallback<T1, T2, T3> callback;
 private static Pool<Stacks.Params3.CallbackStackItem<Object, Object, Object>> s_pool = new Pool<>(Stacks.Params3.CallbackStackItem::new);
 ...
 private static class StackItem<T1, T2, T3> extends Stacks.GenericStack {
 T1 val1;
 T2 val2;
 T3 val3;
 }
 ...
 public static class CallbackStackItem<T1, T2, T3, T4> extends Stacks.Params4.StackItem<T1, T2, T3, T4> {
 private Stacks.Params4.ICallback<T1, T2, T3, T4> callback;
 private static Pool<Stacks.Params4.CallbackStackItem<Object, Object, Object, Object>> s_pool = new Pool<>(
 ...
 private static class StackItem<T1, T2, T3, T4> extends Stacks.GenericStack {
 T1 val1;
 T2 val2;
 T3 val3;
 T4 val4;
 ...
 public static class Params5 {
 public static class CallbackStackItem<T1, T2, T3, T4, T5> extends Stacks.Params5.StackItem<T1, T2, T3, T4, T5> {
 private Stacks.Params5.ICallback<T1, T2, T3, T4, T5> callback;
 private static Pool<Stacks.Params5.CallbackStackItem<Object, Object, Object, Object, Object>> s_pool = new Pool<>(
 ...
 private static class StackItem<T1, T2, T3, T4, T5> extends Stacks.GenericStack {
 T1 val1;
 T2 val2;
 T3 val3;
 T4 val4;
 ...
 public static class Params6 {
 public static class CallbackStackItem<T1, T2, T3, T4, T5, T6> extends Stacks.Params6.StackItem<T1, T2, T3, T4, T5, T6> {
 private Stacks.Params6.ICallback<T1, T2, T3, T4, T5, T6> callback;
 private static Pool<Stacks.Params6.CallbackStackItem<Object, Object, Object, Object, Object, Object>> s_pool = new Pool<>(
 ...
 private static class StackItem<T1, T2, T3, T4, T5, T6> extends Stacks.GenericStack {
 T1 val1;
 T2 val2;
 T3 val3;
 T4 val4;
