...
public:
 ...
 public static class CallbackStackItem<E, T1> extends Predicates.Params1.StackItem<T1> implements Predicate<E> {
 private Predicates.Params1.ICallback<E, T1> predicate;
 private static Pool<Predicates.Params1.CallbackStackItem<Object, Object>> s_pool = new Pool<>(Predicates.Params1.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<E, T1, T2> extends Predicates.Params2.StackItem<T1, T2> implements Predicate<E> {
 private Predicates.Params2.ICallback<E, T1, T2> predicate;
 private static Pool<Predicates.Params2.CallbackStackItem<Object, Object, Object>> s_pool = new Pool<>(
 ...
 public static class CallbackStackItem<E, T1, T2, T3> extends Predicates.Params3.StackItem<T1, T2, T3> implements Predicate<E> {
 private Predicates.Params3.ICallback<E, T1, T2, T3> predicate;
 private static Pool<Predicates.Params3.CallbackStackItem<Object, Object, Object, Object>> s_pool = new Pool<>(
