...
public:
 ...
 public static class CallbackStackItem<T1> extends Invokers.Params1.StackItem<T1> implements Runnable {
 private Invokers.Params1.ICallback<T1> invoker;
 private static Pool<Invokers.Params1.CallbackStackItem<Object>> s_pool = new Pool<>(Invokers.Params1.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<T1, T2> extends Invokers.Params2.StackItem<T1, T2> implements Runnable {
 private Invokers.Params2.ICallback<T1, T2> invoker;
 private static Pool<Invokers.Params2.CallbackStackItem<Object, Object>> s_pool = new Pool<>(Invokers.Params2.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<T1, T2, T3> extends Invokers.Params3.StackItem<T1, T2, T3> implements Runnable {
 private Invokers.Params3.ICallback<T1, T2, T3> invoker;
 private static Pool<Invokers.Params3.CallbackStackItem<Object, Object, Object>> s_pool = new Pool<>(Invokers.Params3.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<T1, T2, T3, T4> extends Invokers.Params4.StackItem<T1, T2, T3, T4> implements Runnable {
 private Invokers.Params4.ICallback<T1, T2, T3, T4> invoker;
 private static Pool<Invokers.Params4.CallbackStackItem<Object, Object, Object, Object>> s_pool = new Pool<>(
