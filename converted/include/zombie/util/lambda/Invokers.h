...
public
  ...
  public
    static final class CallbackStackItem<T1>
        extends Invokers.Params1.StackItem<T1> implements Runnable {
    private
      Invokers.Params1.ICallback<T1> invoker;
    private
      static final Pool<Invokers.Params1.CallbackStackItem<Object>> s_pool =
  ...
  public
    static final class CallbackStackItem<T1, T2>
        extends Invokers.Params2.StackItem<T1, T2> implements Runnable {
    private
      Invokers.Params2.ICallback<T1, T2> invoker;
    private
      static final Pool<Invokers.Params2.CallbackStackItem<Object, Object>>
  ...
  public
    static final class CallbackStackItem<T1, T2, T3, T4>
