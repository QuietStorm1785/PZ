...
public:
 ...
 public static class CallbackStackItem<E, T1> extends Comparators.Params1.StackItem<T1> implements Comparator<E> {
 private Comparators.Params1.ICallback<E, T1> comparator;
 private static Pool<Comparators.Params1.CallbackStackItem<Object, Object>> s_pool = new Pool<>(Comparators.Params1.CallbackStackItem::new);
 ...
 public static class CallbackStackItem<E, T1, T2> extends Comparators.Params2.StackItem<T1, T2> implements Comparator<E> {
 private Comparators.Params2.ICallback<E, T1, T2> comparator;
 private static Pool<Comparators.Params2.CallbackStackItem<Object, Object, Object>> s_pool = new Pool<>(
