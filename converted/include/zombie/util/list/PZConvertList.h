...
public:
 ...
 public PZConvertList(List<S> list, T> function) {
 this(list, function, nullptr);
 }

 public PZConvertList(List<S> list, T> function0, S> function1) {
 ...
 T get(int int0) {
 return this->convertST(this->m_list.get(int0);
 }
