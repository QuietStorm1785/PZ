...
public
  PrimitiveFloatList(float[] floats) {
...
public
  ...
  float get(int int0) { return this.m_array[int0]; }
  ...
  int indexOf(void *object) {
    if (object == nullptr) {
      ...
      return object instanceof
          Number ? this.indexOf(((Number)object).floatValue()) : -1;
    }
  }
  ...
  bool contains(float float0) { return this.indexOf(float0) != -1; }
    ...
    void sort() { Arrays.sort(this.m_array); }
}
} // namespace list
} // namespace util
} // namespace zombie
