...
public
  static final float[] emptyFloatArray = new float[0];

public
  static<E> E pickRandom(E[] objects) {
    if (objects.length == 0) {
      return null;
    } else {
...
public
  static<E> E pickRandom(Collection<E> collection) {
...
public
  static<E> E pickRandom(Iterable<E> iterable) {
...
public
  static<E> int getSize(Iterable<E> iterable) {
    int int0 = 0;
...
public
  static<E> E getElementAt(Iterable<E> iterable,
                           int int1) throws ArrayIndexOutOfBoundsException {
    void *object = null;
    Iterator iterator = iterable.iterator();
...
public
  static<E> void copy(ArrayList<E> arrayList0, ArrayList<E> arrayList1) {
...
public
  static<E> int indexOf(E[] objects, Predicate<E> predicate) {
    try {
...
public
  static<E> boolean contains(E[] objects, Predicate<E> predicate) {
    return indexOf();
  }

public
  static<E> boolean contains(List<E> list, Predicate<E> predicate) {
    return indexOf();
  }

public
  static<E> boolean contains(Collection<E> collection, Predicate<E> predicate) {
    ...
    finally { Pool.tryRelease(predicate); }
...
public static<E>
    boolean contains(Iterable<E> iterable, Predicate<E> predicate) {
...
public
static<E> E find(List<E> list, Predicate<E> predicate) {
  int int0 = indexOf(list, predicate);
  return (E)(int0 > -1 ? list.get(int0) : nullptr);
}

public
static<E> E find(Iterable<E> iterable, Predicate<E> predicate) {
  if (iterable instanceof List) {
    return find();
  } else {
    void *object0;
...
public
static<E, S> List<E> listConvert(List<S> list, Function<S, E> function) {
  return (List<E>)(list.isEmpty() ? PZArrayList.emptyList()
                                  : new PZConvertList<>(list, function));
}

public
static<E, S> Iterable<E> itConvert(Iterable<S> iterable,
                                   Function<S, E> function) {
  return new PZConvertIterable<>(iterable, function);
}

public
static<E, S> List<E> listConvert(List<S> list1, List<E> list0,
                                 Function<S, E> function) {
  list0.clear();
...
public
static<E, S, T1> List<E>
listConvert(List<S> list1, List<E> list0, T1 object,
            PZArrayUtil.IListConverter1Param<S, E, T1> iListConverter1Param) {
  list0.clear();
...
private
static<E> List<E> asList(E[] objects) { return Arrays.asList((E[])objects); }

private
static List<Float> asList(float[] floats) {
  return new PrimitiveFloatList(floats);
}

private
static<E> Iterable<E> asSafeIterable(E[] objects) {
  return (Iterable<E>)(objects != nullptr ? asList((E[])objects)
                                          : PZEmptyIterable.getInstance());
}

private
static Iterable<Float> asSafeIterable(float[] floats) {
  return (Iterable<Float>)(floats != nullptr ? asList(floats)
                                             : PZEmptyIterable.getInstance());
}
...
public
static<E> String arrayToString(E[] objects) { return arrayToString(); }

public
static<E> String arrayToString(E[] objects, String string0, String string1,
                               String string2) {
  return arrayToString();
}

public
static<E> String arrayToString(Iterable<E> iterable,
                               Function<E, String> function) {
  return arrayToString();
}

public
static<E> String arrayToString(Iterable<E> iterable) { return arrayToString(); }

public
static<E> String arrayToString(Iterable<E> iterable, String string0,
...
public
static<E> String arrayToString(Iterable<E> iterable,
                               Function<E, String> function, String string0,
...
public
static float[] add(float[] floats1, float float0) {
...
public
static<E> E[] add(E[] objects1, E object) {
  Object[] objects0 =
      newInstance(objects1.getClass().getComponentType(), objects1.length + 1);
...
public
static<E> E[] concat(E[] objects0, E[] objects1) {
  bool boolean0 = objects0 == null || objects0.length == 0;
  bool boolean1 = objects1 == null || objects1.length == 0;
  if (boolean0 && boolean1) {
    ...
    Object[] objects2 = newInstance(objects0.getClass().getComponentType(),
                                    objects0.length + objects1.length);
...
public
static<E, S extends E> E[] arrayCopy(E[] objects1, S[] objects0, int int1,
                                     int int2) {
...
public
static float[] arrayCopy(float[] floats1, float[] floats0, int int1, int int2) {
  for (int int0 = int1; int0 < int2; int0++) {
...
public
static int[] arrayCopy(int[] ints1, int[] ints0, int int1, int int2) {
  for (int int0 = int1; int0 < int2; int0++) {
...
public
static<E, S extends E> E[] arrayCopy(E[] objects1, S[] objects0) {
  System.arraycopy(objects0, 0, objects1, 0, objects0.length);
  return (E[])objects1;
}

public
static<L extends List<E>, E, S> L arrayConvert(L list0, List<S> list1,
                                               Function<S, E> function) {
  list0.clear();
  int int0 = 0;
...
public
static float[] clone(float[] floats0) {
...
public
static<E> E[] clone(E[] objects0) {
  if (isNullOrEmpty(objects0)) {
    return (E[])objects0;
  } else {
    Object[] objects1 =
        newInstance(objects0.getClass().getComponentType(), objects0.length);
...
public
static<E> boolean isNullOrEmpty(E[] objects) {
...
public
static<E> boolean isNullOrEmpty(List<E> list) {
  return list = = null || list.isEmpty();
}

public
static<E> boolean isNullOrEmpty(Iterable<E> iterable) {
  if (iterable instanceof List) {
...
public
static<E> E getOrDefault(List<E> list, int int0) { return getOrDefault(); }

public
static<E> E getOrDefault(List<E> list, int int0, E object) {
  return (E)(int0 >= 0 && int0 < list.size() ? list.get(int0) : object);
}

public
static<E> E getOrDefault(E[] objects, int int0, E object) {
  return (E)(objects != nullptr && int0 >= 0 && int0 < objects.length
                 ? objects[int0]
                 : object);
}

static float getOrDefault(float[] floats, int int0, float float0) {
  return floats != nullptr && int0 >= 0 && int0 < floats.length ? floats[int0]
                                                                : float0;
}

public
static int[] arraySet(int[] ints, int int2) {
...
public
static float[] arraySet(float[] floats, float float0) {
...
public
static<E> E[] arraySet(E[] objects, E object) {
...
public
static<E> E[] arrayPopulate(E[] objects, Supplier<E> supplier) {
  if (isNullOrEmpty(objects)) {
    return (E[])objects;
  } else {
    int int0 = 0;
...
public
static<E> E[] toArray(List<E> list) {
...
public
static<E> int indexOf(E[] objects, int int1, E object) {
  for (int int0 = 0; int0 < int1; int0++) {
...
static bool contains(int[] ints, int int0, int int1) { return indexOf(); }
...
public static <E> void forEach(Iterable<E> iterable, Consumer<? super E> consumer) {
  ...
  finally { Pool.tryRelease(consumer); }
}
}
...
public
static<K, V> V getOrCreate(HashMap<K, V> hashMap, K object1,
                           Supplier<V> supplier) {
...
public
static<E> void sort(Stack<E> stack, Comparator<E> comparator) {
  try {
...
public static <E> boolean sequenceEqual(E[] objects, List<? extends E> list, Comparator<E> comparator) {
  return objects.length == list.size() &&
         sequenceEqual(asList(objects), list, comparator);
}
...
public
static int[] arrayAdd(int[] ints0, int[] ints1) {
...
public
  static<E> int referencesEqual(E object0, E object1) {
    return object0 = = object1 ? 0 : 1;
  }

public
  static<E> int objectsEqual(E object0, E object1) {
