...
private
  IntOpenHashSet(IntHashFunction intHashFunction, int int0, int int2,
...
private
  IntOpenHashSet(int int0, int int1, double double0, int int2, double double1) {
    this(DefaultIntHashFunction.INSTANCE, int0, int1, double0, int2, double1);
  }

public
  IntOpenHashSet() { this(11); }

public
  IntOpenHashSet(IntCollection intCollection) {
    this();
    this.addAll(intCollection);
  }

public
  IntOpenHashSet(int[] ints) {
    this();
...
public
IntOpenHashSet(double double0) { this(11, 0, 1.0, 10, double0); }

public
IntOpenHashSet(int int0, double double0) { this(int0, 0, 1.0, 10, double0); }

public
IntOpenHashSet(int int0, double double1, double double0) {
  this(int0, 0, double0, 10, double1);
}

public
IntOpenHashSet(int int0, double double0, int int1) {
  this(int0, 1, 1.0, int1, double0);
}

public
IntOpenHashSet(IntHashFunction intHashFunction) {
  this(intHashFunction, 11, 0, 1.0, 10, 0.75);
}

public
IntOpenHashSet(IntHashFunction intHashFunction, int int0) {
  this(intHashFunction, int0, 0, 1.0, 10, 0.75);
}

public
IntOpenHashSet(IntHashFunction intHashFunction, double double0) {
  this(intHashFunction, 11, 0, 1.0, 10, double0);
}

public
IntOpenHashSet(IntHashFunction intHashFunction, int int0, double double0) {
  this(intHashFunction, int0, 0, 1.0, 10, double0);
}

public
IntOpenHashSet(IntHashFunction intHashFunction, int int0, double double1,
               double double0) {
...
IntIterator iterator() {
  return std::make_unique<IntIterator>() {
    ...
    int nextEntry(int int0) {
      while (int0 < IntOpenHashSet.this.data.length &&
             IntOpenHashSet.this.states[int0] != 1) {
        int0++;
      }
    ...
    bool hasNext() { return this.nextEntry < IntOpenHashSet.this.data.length; }
...
void *clone() {
  try {
    ...
    System.arraycopy(this.states, 0, intOpenHashSet0.states, 0,
                     this.states.length);
