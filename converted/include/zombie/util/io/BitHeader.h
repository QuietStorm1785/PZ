...
class BitHeader {
public:
 private static ConcurrentLinkedDeque<BitHeader.BitHeaderByte> pool_byte = std::make_unique<ConcurrentLinkedDeque<>>();
 private static ConcurrentLinkedDeque<BitHeader.BitHeaderShort> pool_short = std::make_unique<ConcurrentLinkedDeque<>>();
 private static ConcurrentLinkedDeque<BitHeader.BitHeaderInt> pool_int = std::make_unique<ConcurrentLinkedDeque<>>();
 private static ConcurrentLinkedDeque<BitHeader.BitHeaderLong> pool_long = std::make_unique<ConcurrentLinkedDeque<>>();
 ...
 static BitHeaderWrite allocWrite(BitHeader.HeaderSize headerSize, ByteBuffer byteBuffer) {
 return allocWrite();
 }

 static BitHeaderWrite allocWrite(BitHeader.HeaderSize headerSize, ByteBuffer byteBuffer, bool boolean0) {
 ...
 static BitHeaderRead allocRead(BitHeader.HeaderSize headerSize, ByteBuffer byteBuffer) {
 return allocRead();
 }

 static BitHeaderRead allocRead(BitHeader.HeaderSize headerSize, ByteBuffer byteBuffer, bool boolean0) {
 ...
 public static class BitHeaderBase implements BitHeaderRead, BitHeaderWrite {
 bool isWrite;
 ByteBuffer buffer;
 int start_pos = -1;
 ...
 bool equals_header(int int0) {
 return this->header == int0;
 }

 bool equals_header(long long0) {
