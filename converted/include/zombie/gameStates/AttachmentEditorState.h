...
public:
 ...
 void updateScript(const std::string& string0, ArrayList<String> arrayList0, ModelScript modelScript) {
 string0 = ZomboidFileSystem.instance.getString(string0);
 ...
 std::string modelScriptToText(ModelScript modelScript, const std::string& string0) {
