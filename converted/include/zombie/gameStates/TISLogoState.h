...
public:
 ...
 private TISLogoState.LogoElement logoTIS = new TISLogoState.LogoElement("media/ui/TheIndieStoneLogo_Lineart_White.png");
 private TISLogoState.LogoElement logoFMOD = new TISLogoState.LogoElement("media/ui/FMODLogo.png");
 private TISLogoState.LogoElement logoGA = new TISLogoState.LogoElement("media/ui/GA-1280-white.png");
 private TISLogoState.LogoElement logoNW = new TISLogoState.LogoElement("media/ui/NW_Logo_Combined.png");
 ...
 std::string string = "Made with FMOD Studio by Firelight Technologies Pty Ltd.";
 ...
 private static class LogoElement {
 Texture m_texture;
 int m_x;
 int m_y;
 int m_width;
 ...
 SpriteRenderer.instance.renderi(this->m_texture, this->m_x, this->m_y, this->m_width, this->m_height, 1.0F, 1.0F, 1.0F, float0, nullptr);
 }
 }
 }
}
