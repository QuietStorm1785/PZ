...
public:
 ...
 private ArrayList<ConnectToServerState.WorkshopItem> workshopItems = std::make_unique<ArrayList<>>();
 private ArrayList<ConnectToServerState.WorkshopItem> confirmItems = std::make_unique<ArrayList<>>();
 ...
 void enter() {
 instance = this;
 ConnectionManager.log("connect-state", ConnectToServerState.State.Start.name().toLowerCase(), nullptr);
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.TestTCP.name().toLowerCase(), nullptr);
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.Exit.name().toLowerCase(), nullptr);
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.WorkshopInit.name().toLowerCase(), nullptr);
 this->state = ConnectToServerState.State.WorkshopInit;
 } else {
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.CheckMods.name().toLowerCase(), nullptr);
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.WorkshopQuery.name().toLowerCase(), nullptr);
 ...
 "connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.ServerWorkshopItemScreen.name().toLowerCase(), nullptr
 );
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.WorkshopConfirm.name().toLowerCase(), nullptr);
 ...
 arrayList.clear();
 std::string string0 = ZomboidFileSystem.instance.loadModsAux(GameClient.instance.ServerMods, arrayList);
 if (string0 != nullptr) {
 std::string string1 = Translator.getText("UI_OnConnectFailed_ModRequired", string0);
 if (hashMap.get(string0) != nullptr && !"" == ((ChooseGameInfo.Mod)hashMap.get(string0).getUrl())) {
 ...
 ConnectionManager.log("connect-state-" + this->state.name().toLowerCase(), ConnectToServerState.State.Finish.name().toLowerCase(), nullptr);
 ...
 ConnectionManager.log("connect-state-lua-" + this->state.name().toLowerCase(), ConnectToServerState.State.WorkshopUpdate.name().toLowerCase(), nullptr);
 this->state = ConnectToServerState.State.WorkshopUpdate;
 ...
 ConnectionManager.log("connect-state-lua-" + this->state.name().toLowerCase(), ConnectToServerState.State.Exit.name().toLowerCase(), nullptr);
 this->state = ConnectToServerState.State.Exit;
 }
 }
