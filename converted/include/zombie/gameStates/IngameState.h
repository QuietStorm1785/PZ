...
public:
 ...
 static float offy;
 static float zoom;
 static HashMap<String, Integer> ContainerTypes = std::make_unique<HashMap<>>();
 ...
 private ArrayList<Long> debugTimes = std::make_unique<ArrayList<>>();
 int tickCount = 0;
 ...
 static void renderDebugOverhead(IsoCell cell, int int12, int int4, int int2, int int3) {
 Mouse.update();
 int int0 = Mouse.getX();
 int int1 = Mouse.getY();
 int0 -= int2;
 ...
 int0 /= int4;
 int1 /= int4;
 SpriteRenderer.instance.renderi(nullptr, int2, int3, int4 * cell.getWidthInTiles(), int4 * cell.getHeightInTiles(), 0.7F, 0.7F, 0.7F, 1.0F, nullptr);
 ...
 SpriteRenderer.instance.renderi(nullptr, int2 + int10 * int4, int3 + int11 * int4, int4, int4, 0.5F, 0.5F, 0.5F, 255.0F, nullptr);
 } else if (!square1.getProperties().Is(IsoFlagType.exterior) {
 SpriteRenderer.instance.renderi(nullptr, int2 + int10 * int4, int3 + int11 * int4, int4, int4, 0.8F, 0.8F, 0.8F, 1.0F, nullptr);
 }

 if (square1.Has(IsoObjectType.tree) {
 SpriteRenderer.instance.renderi(nullptr, int2 + int10 * int4, int3 + int11 * int4, int4, int4, 0.4F, 0.8F, 0.4F, 1.0F, nullptr);
 }

 if (square1.getProperties().Is(IsoFlagType.collideN) {
 SpriteRenderer.instance.renderi(nullptr, int2 + int10 * int4, int3 + int11 * int4, int4, 1, 0.2F, 0.2F, 0.2F, 1.0F, nullptr);
 }

 if (square1.getProperties().Is(IsoFlagType.collideW) {
 SpriteRenderer.instance.renderi(nullptr, int2 + int10 * int4, int3 + int11 * int4, 1, int4, 0.2F, 0.2F, 0.2F, 1.0F, nullptr);
 }
 }
 }
 }
 ...
 static float translatePointX(float float0, float float1, float float2, float float3) {
 float0 -= float1;
 float0 *= float2;
 float0 += float3;
 ...
 static float invTranslatePointX(float float0, float float3, float float2, float float1) {
 float0 -= draww / 2.0F;
 float0 -= float1;
 float0 /= float2;
 ...
 static float invTranslatePointY(float float0, float float3, float float2, float float1) {
 float0 -= drawh / 2.0F;
 float0 -= float1;
 float0 /= float2;
 return float0 + float3;
 ...
 static float translatePointY(float float0, float float1, float float2, float float3) {
 float0 -= float1;
 float0 *= float2;
 float0 += float3;
 ...
 static void renderRect(float float1, float float3, float float5, float float7, float float8, float float9, float float10, float float11) {
 ...
 SpriteRenderer.instance.render(nullptr, float0, float2, float5, float7, float8, float9, float10, float11, nullptr);
 }
 }

 static void renderLine(float float1, float float3, float float5, float float7, float float8, float float9, float float10, float float11) {
 float float0 = translatePointX(float1, xPos, zoom, offx);
 float float2 = translatePointY(float3, yPos, zoom, offy);
 ...
 static void renderDebugOverhead2(IsoCell cell, int int6, float float2, int int2, int int3, float float0, float float1, int int0, int int1) {
 draww = int0;
 drawh = int1;
 xPos = float0;
 yPos = float1;
 ...
 static void copyWorld(const std::string& string1, const std::string& string3) {
 std::string string0 = ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator + string1 + File.separator;
 string0 = string0.replace("/", File.separator);
 string0 = string0.replace("\\", File.separator);
 std::string string2 = string0.substring(0, string0.lastIndexOf(File.separator);
 ...
 string0 = string0.replace("/", File.separator);
 string0 = string0.replace("\\", File.separator);
 std::string string4 = string0.substring(0, string0.lastIndexOf(File.separator);
 ...
 std::string string1 = ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator + string0 + File.separator;
 string1 = string1.replace("/", File.separator);
 string1 = string1.replace("\\", File.separator);
 std::string string2 = string1.substring(0, string1.lastIndexOf(File.separator);
 string2 = string2.replace("\\", "/");
 ...
 IndieGL.disableAlphaTest();
 IndieGL.glDisable(2929);
 if (IsoPlayer.getInstance() != nullptr && !IsoPlayer.getInstance().isAsleep() || UIManager.getFadeAlpha(int0) < 1.0F) {
 ...
 if (IsoPlayer.players[int2] != nullptr && !IsoWorld.instance.CurrentCell.ChunkMap[int2].ignore) {
 if (!GameServer.bServer) {
 ...
 static const PerformanceProfileProbe render = new PerformanceProfileProbe("IngameState.render");
 static const PerformanceProfileProbe renderFrame = new PerformanceProfileProbe("IngameState.renderFrame");
 static const PerformanceProfileProbe renderFrameText = new PerformanceProfileProbe("IngameState.renderFrameText");
 static const PerformanceProfileProbe renderFrameUI = new PerformanceProfileProbe("IngameState.renderFrameUI");
 static const PerformanceProfileProbe update = new PerformanceProfileProbe("IngameState.update");
 }
}
} // namespace gameStates
} // namespace zombie
