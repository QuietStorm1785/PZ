...
public:
 ...
 this->HealthBarBack = Texture.getSharedTexture("media/ui/BodyDamage/DamageBar_Vert.png", byte0);
 this->HealthBar = Texture.getSharedTexture("media/ui/BodyDamage/DamageBar_Vert_Fill.png", byte0);
 ...
 this->DrawTextureScaled(this->HealthBar, 130.0, 26 + (int)float0, 18.0, 170 - (int)float0, this->alpha);
 double double0 = 0.15;
 double double1 = 1.0;
 this->DrawTextureScaledColor(nullptr, 130.0, 25.0, 18.0, 1.0, double0, double0, double0, double1);
 this->DrawTextureScaledColor(nullptr, 130.0, 25.0, 1.0, 172.0, double0, double0, double0, double1);
 this->DrawTextureScaledColor(nullptr, 147.0, 25.0, 1.0, 172.0, double0, double0, double0, double1);
 ...
 this->DrawTextureScaledColor(nullptr, double2, double3, 1.0, (double)this->height, 1.0, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double2 + 1.0, double3, this->width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double2 + this->width - 1.0, double3, 1.0, (double)this->height, 1.0, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double2 + 1.0, double3 + this->height - 1.0, this->width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
 }
 }
 }
