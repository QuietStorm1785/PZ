...
public:
 ...
 public static class SCButton extends HUDButton {
 static const int BORDER = 3;

 public SCButton(const std::string& string0, float float1, float float0, const std::string& string1, const std::string& string2, UIElement uIElement) {
