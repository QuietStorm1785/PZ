...
public:
 ...
 public DialogButton(UIElement uIElement, float float0, float float1, const std::string& string1, const std::string& string0) {
 this->x = float0;
 this->y = float1;
 this->origX = float0;
 ...
 public DialogButton(UIEventHandler uIEventHandler, int int0, int int1, const std::string& string1, const std::string& string0) {
 this->x = int0;
 this->y = int1;
 this->origX = int0;
