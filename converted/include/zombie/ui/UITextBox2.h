...
public:
 ...
 public Stack<String> Lines = std::make_unique<Stack<>>();
 ...
 public UITextBox2(UIFont _font, int x, int y, int width, int height, const std::string& text, bool _HasFrame) {
 this->font = _font;
 this->x = x;
 this->y = y;
 this->SetText(text);
 ...
 this->DrawTextureScaledCol(nullptr, int1 - 1, int3, this->getWidth().intValue() - int1 * 2 + 2, int0, this->NuetralColour);
 } else if (this->HighlightLines[int4] == 2) {
 this->DrawTextureScaledCol(nullptr, int1 - 1, int3, this->getWidth().intValue() - int1 * 2 + 2, int0, this->NuetralColour2);
 } else if (this->HighlightLines[int4] == 3) {
 this->DrawTextureScaledCol(nullptr, int1 - 1, int3, this->getWidth().intValue() - int1 * 2 + 2, int0, this->BadColour);
 } else if (this->HighlightLines[int4] == 4) {
 this->DrawTextureScaledCol(nullptr, int1 - 1, int3, this->getWidth().intValue() - int1 * 2 + 2, int0, this->GoodColour);
 }
 }
 ...
 this->DrawTextureScaledCol(nullptr, -this->XOffset + int1 + int14, int1 + int11 * int0, int15 - int14, int0, this->TextEntryCursorColour2);
 }
 }
 }
 ...
 void setTextColor(ColorInfo newColor) {
 ...
 for (auto& string0 : strings) int int1 = 0;
 if (string0.length() == 0) {
 ...
 void setMultipleLine(bool multiple) {
 ...
 void setOnlyNumbers(bool _onlyNumbers) {
