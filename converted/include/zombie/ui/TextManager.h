...
public:
 ...
 public AngelCodeFont[] enumToFont = new AngelCodeFont[UIFont.values().length];
 static const TextManager instance = new TextManager();
 public ArrayList<TextManager.DeferedTextDraw> todoTextList = std::make_unique<ArrayList<>>();

 void DrawString(double x, double y, const std::string& str) {
 this->font.drawString((float)x, (float)y, str, 1.0F, 1.0F, 1.0F, 1.0F);
 }

 void DrawString(double x, double y, const std::string& str, double r, double g, double b, double a) {
 this->font.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 void DrawString(UIFont _font, double x, double y, double zoom, const std::string& str, double r, double g, double b, double a) {
 ...
 void DrawString(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 AngelCodeFont angelCodeFont = this->getFontFromEnum(_font);
 angelCodeFont.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 void DrawStringUntrimmed(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 AngelCodeFont angelCodeFont = this->getFontFromEnum(_font);
 angelCodeFont.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 void DrawStringCentre(double x, double y, const std::string& str, double r, double g, double b, double a) {
 x -= this->font.getWidth(str) / 2;
 this->font.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 void DrawStringCentre(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 AngelCodeFont angelCodeFont = this->getFontFromEnum(_font);
 x -= angelCodeFont.getWidth(str) / 2;
 angelCodeFont.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 void DrawStringCentreDefered(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 ...
 void DrawStringRight(double x, double y, const std::string& str, double r, double g, double b, double a) {
 x -= this->font.getWidth(str);
 this->font.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 TextDrawObject GetDrawTextObject(const std::string& str, int maxLineWidth, bool restrictImages) {
 ...
 void DrawStringBBcode(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 }
 ...
 void DrawStringRight(UIFont _font, double x, double y, const std::string& str, double r, double g, double b, double a) {
 AngelCodeFont angelCodeFont = this->getFontFromEnum(_font);
 x -= angelCodeFont.getWidth(str);
 angelCodeFont.drawString((float)x, (float)y, str, (float)r, (float)g, (float)b, (float)a);
 }

 std::string getFontFilePath(const std::string& string3, const std::string& string0, const std::string& string2) {
 if (string0 != nullptr) {
 std::string string1 = "media/fonts/" + string3 + "/" + string0 + "/" + string2;
 ...
 void Init() {
 std::string string0 = ZomboidFileSystem.instance.getString("media/fonts/EN/fonts.txt");
 ...
 std::string string6 = new File("").getAbsolutePath().replaceAll("\\\\", "/");
 ...
 public DeferedTextDraw(UIFont uIFont, double double0, double double1, const std::string& string, double double2, double double3, double double4, double double5) {
 this->font = uIFont;
 this->x = double0;
 this->y = double1;
 this->str = string;
