...
public:
 ...
 public ErosionObj(ErosionObjSprites erosionObjSprites, int int0, float float0, float float1, bool boolean0) {
 ...
 bool placeObject(IsoGridSquare square, int int0, bool boolean0, int int1, bool boolean1) {
 IsoObject object = this->createObject(square, int0, boolean0, int1);
 if (object != nullptr && this->setStageObject(int0, object, int1, boolean1) {
 object.doNotSync = true;
 if (!boolean0) {
 ...
 return object != nullptr ? this->setStageObject(int0, object, int1, boolean0) : false;
 }
