...
public:
 ...
 public ErosionObjSprites(int int0, const std::string& string, bool boolean0, bool boolean1, bool boolean2) {
 this->name = string;
 this->stages = int0;
 ...
 return this->sprites[int2] != nullptr && this->sprites[int2].sections[int1] != nullptr && this->sprites[int2].sections[int1].seasons[int0] != nullptr
 ...
 if (this->sprites[int1] != nullptr && this->sprites[int1].sections[int0] != nullptr) {
 ...
 public ArrayList<String> sprites = std::make_unique<ArrayList<>>();
 int index = -1;

 public Sprites(const std::string& string) {
 ...
 || !GameServer.bServer && sprite.CurrentAnim.Frames.get(0).getTexture(IsoDirections.N) == nullptr
 || sprite.ID < 10000) {
