...
public:
 ...
 public static ArrayList<ErosionRegions.Region> regions = std::make_unique<ArrayList<>>();
 ...
 addRegion(new ErosionRegions.Region(1, "blends_street", true, true, false).addCategory(0, std::make_unique<StreetCracks>()));
 addRegion(new ErosionRegions.Region(2, nullptr, false, false, true).addCategory(0, std::make_unique<WallVines>()).addCategory(1, std::make_unique<WallCracks>()));
 addRegion(new ErosionRegions.Region(3, nullptr, true, true, false).addCategory(0, std::make_unique<Flowerbed>()));
 ...
 bool isExterior;
 bool hasWall;
 public ArrayList<ErosionCategory> categories = std::make_unique<ArrayList<>>();

 public Region(int int0, const std::string& string, bool boolean0, bool boolean1, bool boolean2) {
 this->ID = int0;
