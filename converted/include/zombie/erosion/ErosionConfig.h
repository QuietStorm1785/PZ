...
class ErosionConfig {
public:
 public ErosionConfig.Seeds seeds = new ErosionConfig.Seeds();
 public ErosionConfig.Time time = new ErosionConfig.Time();
 public ErosionConfig.Debug debug = new ErosionConfig.Debug();
 public ErosionConfig.Season season = new ErosionConfig.Season();
