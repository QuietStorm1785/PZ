...
public:
 ...
 int m_changeX2 = 0;
 int m_changeY2 = 0;
 private int[] m_updateMinX = new int[4];
 private int[] m_updateMinY = new int[4];
 private int[] m_updateMaxX = new int[4];
 private int[] m_updateMaxY = new int[4];
 ...
 private WorldMapStyleLayer.RGBAf m_color = new WorldMapStyleLayer.RGBAf().init(0.85882354F, 0.84313726F, 0.7529412F, 1.0F);
 private WorldMapStyleLayer.RGBAf m_gridColor = new WorldMapStyleLayer.RGBAf()
 ...
 void render(float renderX, float renderY, int minX, int minY, int maxX, int maxY, float worldScale, bool blur) {
 if (!this->m_mainMenu) {
 ...
 bool hasFlags(int int0, int int1, int int2, int int3, int int13, bool boolean0) {
 int0 -= this->m_minX * 300;
 int1 -= this->m_minY * 300;
 int2 -= this->m_minX * 300;
 int3 -= this->m_minY * 300;
