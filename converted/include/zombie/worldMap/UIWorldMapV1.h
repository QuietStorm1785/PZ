...
public:
 ...
 WorldMapRenderer getRenderer() {
 return this->m_renderer;
 }

 WorldMapMarkers getMarkers() {
 return this->m_markers;
 }

 WorldMapStyle getStyle() {
 return this->m_style;
 }
 ...
 bool boolean0 = minX != this->m_worldMap.m_minX || minY != this->m_worldMap.m_minY || maxX != this->m_worldMap.m_maxX || maxY != this->m_worldMap.m_maxY;
 ...
 float worldToUIX(float float0, float float1, float float2, float float3, float float4, Matrix4f matrix4f0, Matrix4f matrix4f1) {
 return this->m_renderer.worldToUIX(float0, float1, float2, float3, float4, matrix4f0, matrix4f1);
 }

 float worldToUIY(float float0, float float1, float float2, float float3, float float4, Matrix4f matrix4f0, Matrix4f matrix4f1) {
