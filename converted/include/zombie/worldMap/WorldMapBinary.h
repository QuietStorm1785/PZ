...
public:
 ...
 int readByte(InputStream inputStream) {
 ...
 WorldMapFeature parseFeature(WorldMapCell worldMapCell, InputStream inputStream) {
 ...
 void parseFeatureProperties(InputStream inputStream, WorldMapFeature worldMapFeature) {
 this->m_properties.clear();
 int int0 = this->readByte(inputStream);

 for (int int1 = 0; int1 < int0; int1++) {
 std::string string0 = this->m_sharedStrings.get(this->readStringIndexed(inputStream);
 std::string string1 = this->m_sharedStrings.get(this->readStringIndexed(inputStream);
 ...
 WorldMapProperties getOrCreateProperties(WorldMapProperties worldMapProperties0) {
 ...
 void parseGeometryCoordinates(InputStream inputStream, WorldMapPoints worldMapPoints) {
 int int0 = this->readShort(inputStream);
