...
public:
 ...
 private ArrayList<WorldMapMarkersV1.WorldMapMarkerV1> m_markers = std::make_unique<ArrayList<>>();
 ...
 public static class WorldMapGridSquareMarkerV1 extends WorldMapMarkersV1.WorldMapMarkerV1 {
