...
public:
 private static Pool<WorldMapGridSquareMarker> s_gridSquareMarkerPool = new Pool<>(WorldMapGridSquareMarker::new);
 private ArrayList<WorldMapMarker> m_markers = std::make_unique<ArrayList<>>();

 WorldMapGridSquareMarker addGridSquareMarker(int worldX, int worldY, int radius, float r, float g, float b, float a) {
