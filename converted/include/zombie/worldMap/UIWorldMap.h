...
public:
 static ArrayList<WorldMapFeature> s_tempFeatures = std::make_unique<ArrayList<>>();
 ...
 protected WorldMapStyleLayer.RGBAf m_color = new WorldMapStyleLayer.RGBAf().init(0.85882354F, 0.84313726F, 0.7529412F, 1.0F);
 const UIWorldMapV1 m_APIv1 = new UIWorldMapV1(this);
 bool m_dataWasReady = false;
 private ArrayList<BuildingDef> m_buildingsWithoutFeatures = std::make_unique<ArrayList<>>();
 ...
 this->DrawTextureScaledColor(nullptr, 0.0, 0.0, 200.0, int0 * 4.0, 1.0, 1.0, 1.0, 1.0);
 ...
 this->DrawTextureScaledColor(nullptr, double4, double5, 1.0, (double)this->height, double6, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double4 + 1.0, double5, this->width - 2.0, 1.0, double6, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double4 + this->width - 1.0, double5, 1.0, (double)this->height, double6, 1.0, 1.0, 0.5);
 this->DrawTextureScaledColor(nullptr, double4 + 1.0, double5 + this->height - 1.0, this->width - 2.0, 1.0, double6, 1.0, 1.0, 0.5);
 }
 ...
 .renderline(nullptr, int4 + (int)float8, int5 + (int)float9, int4 + (int)float10, int5 + (int)float11, 1.0F, 0.0F, 0.0F, 1.0F);
 }
 }
 }
 ...
 bool isInSameFaction(IsoPlayer player, WorldMapRemotePlayer worldMapRemotePlayer) {
 ...
 bool isInSameSafehouse(IsoPlayer player, WorldMapRemotePlayer worldMapRemotePlayer) {
 ...
 this->DrawTextureScaledColor(nullptr, float3 - 3.0, float6 - 3.0, 6.0, 6.0, 1.0, 0.0, 0.0, 1.0);
 }
 ...
 this->DrawTextureScaledColor(nullptr, float3 - int0 / 2.0, float6 + 4.0, (double)int0, (double)int2, 0.5, 0.5, 0.5, 0.5);
 ...
 bool onMouseWheel(double delta) {
 ...
 void debugRenderBuilding(BuildingDef buildingDef, float float7, float float6, float float5, float float4) {
