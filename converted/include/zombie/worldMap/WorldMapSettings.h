...
public:
 ...
 DoubleConfigOption newOption(const std::string& string, double double0, double double1, double double2) {
 ...
 ConfigOption getOptionByIndex(int int0) {
 ...
 void save() {
 std::string string = ZomboidFileSystem.instance.getFileNameInCurrentSave("InGameMap.ini");
 ...
 BooleanConfigOption Isometric = WorldMapSettings.this->newOption("WorldMap.Isometric", true);
 BooleanConfigOption ShowSymbolsUI = WorldMapSettings.this->newOption("WorldMap.ShowSymbolsUI", true);
 }
}
} // namespace worldMap
} // namespace zombie
