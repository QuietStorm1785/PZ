...
public:
 ...
 void parseFeatureProperties(Element element, WorldMapFeature worldMapFeature) {
 ...
 std::string string1 = this->m_sharedStrings.get(elementx.getAttribute("name"));
 std::string string2 = this->m_sharedStrings.get(elementx.getAttribute("value"));
 ...
 void parseGeometryCoordinates(Element element, WorldMapPoints worldMapPoints) {
