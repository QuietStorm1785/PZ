...
public:
 ...
 private WorldMapRenderer.Drawer[] m_drawer = new WorldMapRenderer.Drawer[3];
 private WorldMapRenderer.CharacterModelCamera m_CharacterModelCamera = new WorldMapRenderer.CharacterModelCamera();
 ...
 private int[] m_viewport = new int[]{0, 0, 0, 0};
 ...
 private WorldMapRenderer.WorldMapBooleanOption BlurUnvisited = new WorldMapRenderer.WorldMapBooleanOption("BlurUnvisited", true);
 private WorldMapRenderer.WorldMapBooleanOption BuildingsWithoutFeatures = new WorldMapRenderer.WorldMapBooleanOption(
 "BuildingsWithoutFeatures", false
 );
 private WorldMapRenderer.WorldMapBooleanOption DebugInfo = new WorldMapRenderer.WorldMapBooleanOption("DebugInfo", false);
 private WorldMapRenderer.WorldMapBooleanOption CellGrid = new WorldMapRenderer.WorldMapBooleanOption("CellGrid", false);
 private WorldMapRenderer.WorldMapBooleanOption TileGrid = new WorldMapRenderer.WorldMapBooleanOption("TileGrid", false);
 private WorldMapRenderer.WorldMapBooleanOption UnvisitedGrid = new WorldMapRenderer.WorldMapBooleanOption("UnvisitedGrid", true);
 private WorldMapRenderer.WorldMapBooleanOption Features = new WorldMapRenderer.WorldMapBooleanOption("Features", true);
 private WorldMapRenderer.WorldMapBooleanOption ForestZones = new WorldMapRenderer.WorldMapBooleanOption("ForestZones", false);
 private WorldMapRenderer.WorldMapBooleanOption HideUnvisited = new WorldMapRenderer.WorldMapBooleanOption("HideUnvisited", false);
 private WorldMapRenderer.WorldMapBooleanOption HitTest = new WorldMapRenderer.WorldMapBooleanOption("HitTest", false);
 private WorldMapRenderer.WorldMapBooleanOption ImagePyramid = new WorldMapRenderer.WorldMapBooleanOption("ImagePyramid", false);
 private WorldMapRenderer.WorldMapBooleanOption Isometric = new WorldMapRenderer.WorldMapBooleanOption("Isometric", true);
 private WorldMapRenderer.WorldMapBooleanOption LineString = new WorldMapRenderer.WorldMapBooleanOption("LineString", true);
 private WorldMapRenderer.WorldMapBooleanOption Players = new WorldMapRenderer.WorldMapBooleanOption("Players", false);
 private WorldMapRenderer.WorldMapBooleanOption RemotePlayers = new WorldMapRenderer.WorldMapBooleanOption("RemotePlayers", false);
 private WorldMapRenderer.WorldMapBooleanOption PlayerNames = new WorldMapRenderer.WorldMapBooleanOption("PlayerNames", false);
 private WorldMapRenderer.WorldMapBooleanOption Symbols = new WorldMapRenderer.WorldMapBooleanOption("Symbols", true);
 private WorldMapRenderer.WorldMapBooleanOption Wireframe = new WorldMapRenderer.WorldMapBooleanOption("Wireframe", false);
 private WorldMapRenderer.WorldMapBooleanOption WorldBounds = new WorldMapRenderer.WorldMapBooleanOption("WorldBounds", true);
 private WorldMapRenderer.WorldMapBooleanOption MiniMapSymbols = new WorldMapRenderer.WorldMapBooleanOption("MiniMapSymbols", false);
 private WorldMapRenderer.WorldMapBooleanOption VisibleCells = new WorldMapRenderer.WorldMapBooleanOption("VisibleCells", false);
 ...
 void calcMatrices(float var1, float var2, float var3, Matrix4f matrix4f0, Matrix4f matrix4f1) {
 ...
 Vector3f uiToScene(float uiX, float uiY, Matrix4f projection, Matrix4f modelView, Vector3f out) {
 ...
 float uiToWorldX(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 ...
 float uiToWorldY(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 Matrix4f matrix4f0 = allocMatrix4f();
 Matrix4f matrix4f1 = allocMatrix4f();
 this->calcMatrices(centerWorldX, centerWorldY, zoomF, matrix4f0, matrix4f1);
 ...
 float uiToWorldX(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 ...
 float uiToWorldY(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 Vector3f vector3f = this->uiToScene(uiX, uiY, projection, modelView, allocVector3f());
 float float0 = this->getWorldScale(zoomF);
 vector3f.mul(1.0F / float0);
 ...
 float worldToUIX(float worldX, float worldY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 float float0 = this->getWorldScale(zoomF);
 ...
 float worldToUIY(float worldX, float worldY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 float float0 = this->getWorldScale(zoomF);
 Vector3f vector3f = this->sceneToUI((worldX - centerWorldX) * float0, (worldY - centerWorldY) * float0, 0.0F, projection, modelView, allocVector3f());
 ...
 void setVisited(WorldMapVisited visited) {
 ...
 private static class CharacterModelCamera extends ModelCamera {
 float m_worldScale;
 float m_angle;
 float m_playerX;
 float m_playerY;
 ...
 const Matrix4f m_projection = new Matrix4f();
 const Matrix4f m_modelView = new Matrix4f();
 private WorldMapRenderer.PlayerRenderData[] m_playerRenderData = new WorldMapRenderer.PlayerRenderData[4];
 WorldMapStyleLayer.FilterArgs m_filterArgs = new WorldMapStyleLayer.FilterArgs();
 WorldMapStyleLayer.RenderArgs m_renderArgs = new WorldMapStyleLayer.RenderArgs();
 ArrayList<WorldMapRenderLayer> m_renderLayers = std::make_unique<ArrayList<>>();
 ...
 if (player != nullptr && !player.isDead() && player.legsSprite.hasActiveModel()) {
 ...
 this->m_playerRenderData[int1].m_angle = player.getVehicle() == nullptr
 ...
 if (worldMapCell != nullptr && !worldMapCell.m_features.empty()) {
 ...
 void drawLineStringXXX(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 ...
 void drawLineStringYYY(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 float float0 = this->m_renderCellX;
 float float1 = this->m_renderCellY;
 float float2 = this->m_worldScale;
 float float3 = color.r;
 ...
 std::vector arrayList = StrokeGeometry.getStrokeGeometry(points, attrs);
 ...
 void drawLineString(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 ...
 void fillPolygon(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color) {
 WorldMapRenderer.m_vboLinesUV.flush();
 float float0 = this->m_renderCellX;
 float float1 = this->m_renderCellY;
 float float2 = this->m_worldScale;
 ...
 WorldMapGeometry.TrianglesPerZoom trianglesPerZoom = double0 == 0.0 ? nullptr : worldMapGeometry.findTriangles(double0);
 ...
 void drawTexture(Texture texture, WorldMapStyleLayer.RGBAf fill, int worldX1, int worldY1, int worldX2, int worldY2) {
 if (texture != nullptr && texture.isReady()) {
 WorldMapRenderer.m_vboLines.flush();
 WorldMapRenderer.m_vboLinesUV.flush();
 ...
 void drawTextureTiled(Texture texture, WorldMapStyleLayer.RGBAf fill, int worldX1, int worldY1, int worldX2, int worldY2, int cellX, int cellY) {
 if (texture != nullptr && texture.isReady()) {
 ...
 void renderZones(ArrayList<IsoMetaGrid.Zone> arrayList, const std::string& string, float float5, float float6, float float7, float float16) {
 WorldMapRenderer.m_vboLinesUV.flush();
 float float0 = this->m_worldScale;
 WorldMapRenderer.m_vboLines.setMode(4);
