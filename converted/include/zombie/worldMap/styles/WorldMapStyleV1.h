...
public:
 ...
 public ArrayList<WorldMapStyleV1.WorldMapStyleLayerV1> m_layers = std::make_unique<ArrayList<>>();
 ...
 void removeFill(int int0) {
 this->m_polygonStyle.m_fill.remove(int0);
 }

 void removeTexture(int int0) {
