...
public:
 ...
 public ArrayList<WorldMapStyleLayer.TextureStop> m_texture = std::make_unique<ArrayList<>>();
 public ArrayList<WorldMapStyleLayer.FloatStop> m_scale = std::make_unique<ArrayList<>>();

 public WorldMapPolygonStyleLayer(const std::string& string) {
 super(string);
 }
