...
public:
 ...
 public WorldMapStyleLayer(const std::string& id) {
 this->m_id = id;
 }
 ...
 float evalFloat(WorldMapStyleLayer.RenderArgs renderArgs, ArrayList<WorldMapStyleLayer.FloatStop> arrayList) {
 if (arrayList.empty()) {
 return 1.0F;
 } else {
 float float0 = renderArgs.drawer.m_zoomF;
 ...
 Texture evalTexture(WorldMapStyleLayer.RenderArgs renderArgs, ArrayList<WorldMapStyleLayer.TextureStop> arrayList) {
 if (arrayList.empty()) {
 return nullptr;
 } else {
 float float0 = renderArgs.drawer.m_zoomF;
 ...
 public static class RGBAf {
 float r;
 float g;
 float b;
 float a;
 public static ObjectPool<WorldMapStyleLayer.RGBAf> s_pool = new ObjectPool<>(WorldMapStyleLayer.RGBAf::new);
 ...
 public TextureStop(float float0, const std::string& string) {
 super(float0);
