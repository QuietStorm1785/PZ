...
class WorldMap {
public:
 public ArrayList<WorldMapData> m_data = std::make_unique<ArrayList<>>();
 public ArrayList<WorldMapImages> m_images = std::make_unique<ArrayList<>>();
 int m_minDataX;
 int m_minDataY;
 int m_maxDataX;
 int m_maxDataY;
 ...
 public ArrayList<WorldMapData> m_lastDataInDirectory = std::make_unique<ArrayList<>>();
 ...
 WorldMapData getDataByIndex(int index) {
 ...
 if (worldMapImages != nullptr && !this->m_images.contains(worldMapImages) {
