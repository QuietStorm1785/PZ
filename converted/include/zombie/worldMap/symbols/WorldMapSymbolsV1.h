...
public:
 private static Pool<WorldMapSymbolsV1.WorldMapTextSymbolV1> s_textPool = new Pool<>(WorldMapSymbolsV1.WorldMapTextSymbolV1::new);
 private static Pool<WorldMapSymbolsV1.WorldMapTextureSymbolV1> s_texturePool = new Pool<>(WorldMapSymbolsV1.WorldMapTextureSymbolV1::new);
 const UIWorldMap m_ui;
 const WorldMapSymbols m_uiSymbols;
 private ArrayList<WorldMapSymbolsV1.WorldMapBaseSymbolV1> m_symbols = std::make_unique<ArrayList<>>();
