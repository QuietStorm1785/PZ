...
public:
 ...
 private ArrayList<MapSymbolDefinitions.MapSymbolDefinition> m_symbolList = std::make_unique<ArrayList<>>();
 ...
 void addTexture(const std::string& string0, const std::string& string1, int int0, int int1) {
 ...
 public static class MapSymbolDefinition {
 std::string id;
