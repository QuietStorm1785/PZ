...
public:
 ...
 private ArrayList<WorldMapBaseSymbol> m_symbols = std::make_unique<ArrayList<>>();
 ...
 WorldMapTextSymbol addTranslatedText(const std::string& text, UIFont font, float x, float y, float r, float g, float b, float a) {
 return this->addText(text, true, font, x, y, 0.0F, 0.0F, WorldMapBaseSymbol.DEFAULT_SCALE, r, g, b, a);
 }

 WorldMapTextSymbol addUntranslatedText(const std::string& text, UIFont font, float x, float y, float r, float g, float b, float a) {
 ...
 WorldMapTextureSymbol addTexture(const std::string& symbolID, float x, float y, float r, float g, float b, float a) {
 return this->addTexture(symbolID, x, y, 0.0F, 0.0F, WorldMapBaseSymbol.DEFAULT_SCALE, r, g, b, a);
 }

 WorldMapTextureSymbol addTexture(const std::string& symbolID, float x, float y, float anchorX, float anchorY, float scale, float r, float g, float b, float a) {
 ...
 worldMapTextureSymbol.m_texture = GameServer.bServer ? nullptr : Texture.getSharedTexture(mapSymbolDefinition.getTexturePath());
 ...
 bool isSymbolVisible(UIWorldMap uIWorldMap, WorldMapBaseSymbol worldMapBaseSymbol) {
