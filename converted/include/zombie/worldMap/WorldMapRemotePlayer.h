...
public:
 ...
 void setFullData(short short0, const std::string& string0, const std::string& string1, const std::string& string2, const std::string& string3, float float0, float float1, bool boolean0) {
