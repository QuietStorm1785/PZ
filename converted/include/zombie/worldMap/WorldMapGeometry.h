...
public:
 ...
 public ArrayList<WorldMapPoints> m_points = std::make_unique<ArrayList<>>();
 int m_minX;
 int m_minY;
 int m_maxX;
 int m_maxY;
 public float[] m_triangles = nullptr;
 public ArrayList<WorldMapGeometry.TrianglesPerZoom> m_trianglesPerZoom = nullptr;
 int m_vboIndex1 = -1;
 int m_vboIndex2 = -1;
 int m_vboIndex3 = -1;
 int m_vboIndex4 = -1;
 ...
 return this->m_type == WorldMapGeometry.Type.Polygon && !this->m_points.empty()
 ...
 public static class TrianglesPerZoom {
