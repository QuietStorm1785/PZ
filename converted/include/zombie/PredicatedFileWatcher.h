...
private
  final PredicatedFileWatcher.IPredicatedFileWatcherCallback m_callback;
...
public
  ...
  private
    final Class<T> m_class;
  private
    final PredicatedFileWatcher.IPredicatedDataPacketFileWatcherCallback<T>
        m_callback;
