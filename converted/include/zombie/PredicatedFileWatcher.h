...
public:
 ...
 private PredicatedFileWatcher.IPredicatedFileWatcherCallback m_callback;
 ...
 public PredicatedFileWatcher(const std::string& path, PredicatedFileWatcher.IPredicatedFileWatcherCallback callback) {
 ...
 this(path, nullptr, new PredicatedFileWatcher.GenericPredicatedFileWatcherCallback(clazz, callback);
 }

 public PredicatedFileWatcher(const std::string& path, Predicate<String> predicate, PredicatedFileWatcher.IPredicatedFileWatcherCallback callback) {
 ...
 return string != nullptr ? ZomboidFileSystem.processFilePath(string, File.separatorChar) : nullptr;
 }
 ...
 private PredicatedFileWatcher.IPredicatedDataPacketFileWatcherCallback<T> m_callback;
