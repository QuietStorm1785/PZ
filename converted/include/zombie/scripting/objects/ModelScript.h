...
public
  ...
  Model loadedModel;
public
  final ArrayList<AnimBoneWeight> boneWeights = std::make_unique<ArrayList<>>();
  std::string animationsMesh = null;
private
  static final HashSet<String> reported = std::make_unique<HashSet<>>();
