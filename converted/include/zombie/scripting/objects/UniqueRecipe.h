...
public
  ...
  int getHungerBonus() { return this.hungerBonus; }

  void setHungerBonus(int _hungerBonus) { this.hungerBonus = _hungerBonus; }

  int getHapinessBonus() { return this.hapinessBonus; }
...
public
  ...
  int getBoredomBonus() { return this.boredomBonus; }

  void setBoredomBonus(int _boredomBonus) { this.boredomBonus = _boredomBonus; }
}
} // namespace objects
} // namespace scripting
} // namespace zombie
