...
public:
  ...
  std::string value;
public
  final HashMap<String, Item> ItemMap = std::make_unique<HashMap<>>();
public
  final HashMap<String, GameSoundScript> GameSoundMap =
      std::make_unique<HashMap<>>();
public
  final ArrayList<GameSoundScript> GameSoundList =
      std::make_unique<ArrayList<>>();
public
  final HashMap<String, AnimationsMesh> AnimationsMeshMap =
      std::make_unique<HashMap<>>();
public
  final HashMap<String, MannequinScript> MannequinScriptMap =
      std::make_unique<HashMap<>>();
public
  final TreeMap<String, ModelScript> ModelScriptMap =
      new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
public
  final HashMap<String, RuntimeAnimationScript> RuntimeAnimationScriptMap =
      std::make_unique<HashMap<>>();
public
  final HashMap<String, SoundTimelineScript> SoundTimelineMap =
      std::make_unique<HashMap<>>();
public
  final HashMap<String, VehicleScript> VehicleMap =
      std::make_unique<HashMap<>>();
public
  final HashMap<String, VehicleTemplate> VehicleTemplateMap =
      std::make_unique<HashMap<>>();
public
  final HashMap<String, VehicleEngineRPM> VehicleEngineRPMMap =
      std::make_unique<HashMap<>>();
public
  final ArrayList<Recipe> RecipeMap = std::make_unique<ArrayList<>>();
public
  final HashMap<String, Recipe> RecipeByName = std::make_unique<HashMap<>>();
public
  final HashMap<String, Recipe> RecipesWithDotInName =
      std::make_unique<HashMap<>>();
public
  final ArrayList<EvolvedRecipe> EvolvedRecipeMap =
      std::make_unique<ArrayList<>>();
public
  final ArrayList<UniqueRecipe> UniqueRecipeMap =
      std::make_unique<ArrayList<>>();
public
  final HashMap<String, Fixing> FixingMap = std::make_unique<HashMap<>>();
public
  final ArrayList<String> Imports = std::make_unique<ArrayList<>>();
  bool disabled = false;
