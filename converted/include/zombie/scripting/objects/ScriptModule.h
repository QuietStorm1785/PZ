...
public:
 std::string name;
 std::string value;
 public HashMap<String, Item> ItemMap = std::make_unique<HashMap<>>();
 public HashMap<String, GameSoundScript> GameSoundMap = std::make_unique<HashMap<>>();
 public ArrayList<GameSoundScript> GameSoundList = std::make_unique<ArrayList<>>();
 public HashMap<String, AnimationsMesh> AnimationsMeshMap = std::make_unique<HashMap<>>();
 public HashMap<String, MannequinScript> MannequinScriptMap = std::make_unique<HashMap<>>();
 public TreeMap<String, ModelScript> ModelScriptMap = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
 public HashMap<String, RuntimeAnimationScript> RuntimeAnimationScriptMap = std::make_unique<HashMap<>>();
 public HashMap<String, SoundTimelineScript> SoundTimelineMap = std::make_unique<HashMap<>>();
 public HashMap<String, VehicleScript> VehicleMap = std::make_unique<HashMap<>>();
 public HashMap<String, VehicleTemplate> VehicleTemplateMap = std::make_unique<HashMap<>>();
 public HashMap<String, VehicleEngineRPM> VehicleEngineRPMMap = std::make_unique<HashMap<>>();
 public ArrayList<Recipe> RecipeMap = std::make_unique<ArrayList<>>();
 public HashMap<String, Recipe> RecipeByName = std::make_unique<HashMap<>>();
 public HashMap<String, Recipe> RecipesWithDotInName = std::make_unique<HashMap<>>();
 public ArrayList<EvolvedRecipe> EvolvedRecipeMap = std::make_unique<ArrayList<>>();
 public ArrayList<UniqueRecipe> UniqueRecipeMap = std::make_unique<ArrayList<>>();
 public HashMap<String, Fixing> FixingMap = std::make_unique<HashMap<>>();
 public ArrayList<String> Imports = std::make_unique<ArrayList<>>();
 bool disabled = false;
 ...
 MultiStageBuilding.Stage stage = std::make_unique<MultiStageBuilding>().std::make_unique<Stage>();
