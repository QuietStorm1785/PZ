...
class DebugLog {
public:
 private static boolean[] m_enabledDebugTypes = new boolean[DebugType.values().length];
 private static HashMap<DebugType, LogSeverity> logLevels = std::make_unique<HashMap<>>();
 static bool s_initialized = false;
 static bool printServerTime = false;
 private static DebugLog.OutputStreamWrapper s_stdout = new DebugLog.OutputStreamWrapper(System.out);
 private static DebugLog.OutputStreamWrapper s_stderr = new DebugLog.OutputStreamWrapper(System.err);
 ...
 static const PrintStream GeneralErr = new DebugLogStream(m_originalErr, m_originalErr, m_originalErr, new GeneralErrorDebugLogFormatter());
 ...
 static LogSeverity getLogLevel(DebugType type) {
 ...
 static std::string formatString(DebugType type, LogSeverity logSeverity, const std::string& prefix, void* affix, const std::string& formatNoParams) {
 return isLogEnabled();
 }

 static std::string formatString(DebugType type, LogSeverity logSeverity, const std::string& prefix, void* affix, const std::string& format, void* param0) {
 return isLogEnabled();
 }

 static std::string formatString(DebugType type, LogSeverity logSeverity, const std::string& prefix, void* affix, const std::string& format, void* param0, void* param1) {
 return isLogEnabled();
 }
 ...
 static std::string formatStringVarArgs(DebugType type, LogSeverity logSeverity, const std::string& prefix, void* affix, const std::string& format, Object... params) {
 ...
 std::string string1 = prefix + StringUtils.leftJustify(type.toString(), 12) + ", " + string0 + "> " + affix + String.format(format, params);
 ...
 std::string string = formatString(type, LogSeverity.General, "LOG : ", "", "%s", str);
 if (string != nullptr) {
 ...
 std::string string = ZomboidFileSystem.instance.getCacheDir() + File.separator + "debuglog.ini";
 ...
 static void setStdOut(OutputStream out) {
 s_stdout.setStream(out);
 }

 static void setStdErr(OutputStream out) {
 ...
 void setStream(OutputStream arg0) {
 this->out = arg0;
 }
 }
}
