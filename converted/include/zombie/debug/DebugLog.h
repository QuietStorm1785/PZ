...
public:
private
  static final boolean[] m_enabledDebugTypes =
      new boolean[DebugType.values().length];
private
  static final HashMap<DebugType, LogSeverity> logLevels =
      std::make_unique<HashMap<>>();
  static bool s_initialized = false;
  static bool printServerTime = false;
private
  static final DebugLog.OutputStreamWrapper s_stdout =
      new DebugLog.OutputStreamWrapper(System.out);
private
  static final DebugLog.OutputStreamWrapper s_stderr =
...
private
  static final class OutputStreamWrapper extends FilterOutputStream {
  public
