...
private
  final ArrayList<BooleanDebugOption> options = std::make_unique<ArrayList<>>();
private
  final ArrayList<IDebugOption> m_options = std::make_unique<ArrayList<>>();
...
public
  final BooleanDebugOption[] ThreadCrash_GameThread = new BooleanDebugOption[]{
...
public
  final BooleanDebugOption[] ThreadCrash_GameLoadingThread =
      new BooleanDebugOption[]{
          this.newDebugOnlyOption("ThreadCrash.GameLoadingThread.0", false)};
public
  final BooleanDebugOption[] ThreadCrash_RenderThread =
      new BooleanDebugOption[]{
...
public
  final DebugOptions.Checks Checks =
...
public
  ...
  IDebugOptionGroup getParent() { return null; }
...
public
  static final class Checks extends OptionGroup {
