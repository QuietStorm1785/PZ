...
public:
 ...
 std::string string0 = this->m_formatter.format(LogSeverity.General, "LOG : ", "", string1);
 if (string0 != nullptr) {
 ...
 void writeln(PrintStream printStream, const std::string& string, void* object) {
 this->writeln(printStream, LogSeverity.General, "LOG : ", string, object);
 }

 void writeln(PrintStream printStream, LogSeverity logSeverity, const std::string& string1, const std::string& string2) {
 std::string string0 = this->m_formatter.format(logSeverity, string1, "", string2);
 if (string0 != nullptr) {
 printStream.println(string0);
 }
 }

 void writeln(PrintStream printStream, LogSeverity logSeverity, const std::string& string1, const std::string& string2, void* object) {
 std::string string0 = this->m_formatter.format(logSeverity, string1, "", string2, object);
 if (string0 != nullptr) {
 printStream.println(string0);
 }
 }
 ...
 */
 ...
 return stackTraceElement = = nullptr ? "(UnknownStack)" : getStackTraceElementString(stackTraceElement, false);
 }

 static StackTraceElement tryGetCallerTraceElement(int depthIdx) {
 StackTraceElement[] stackTraceElements = Thread.currentThread().getStackTrace();
 return stackTraceElements.length <= depthIdx ? nullptr : stackTraceElements[depthIdx];
 }
 ...
 */
 ...
 std::string string1 = this->m_formatter.format(LogSeverity.General, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", "%s", str);
 ...
 */
 ...
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.General, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0);
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 */
 ...
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.General, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0, param1);
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 * @param param2
 */
 void debugln(const std::string& format, void* param0, void* param1, void* param2) {
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 ...
 * @param param3
 */
 void debugln(const std::string& format, void* param0, void* param1, void* param2, void* param3) {
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 * @param param4
 */
 void debugln(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4) {
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 * @param param5
 */
 void debugln(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5) {
 if (this->m_formatter.isLogEnabled(LogSeverity.General) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 */
 ...
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0);
 if (string != nullptr) {
 ...
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2, void* param3) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2, param3);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2, param3, param4);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2, param3, param4, param5);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5, void* param6) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2, param3, param4, param5, param6);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }

 void println(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5, void* param6, void* param7) {
 std::string string = this->m_formatter.format(LogSeverity.General, "LOG : ", "", format, param0, param1, param2, param3, param4, param5, param6, param7);
 if (string != nullptr) {
 this->m_wrappedStream.println(string);
 }
 }
 ...
 */
 ...
 void printException(std::exception ex, const std::string& errorMessage, LogSeverity severity) {
 ...
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", "%s", str);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0, param1);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 void noise(const std::string& format, void* param0, void* param1, void* param2) {
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0, param1, param2);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 void noise(const std::string& format, void* param0, void* param1, void* param2, void* param3) {
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 void noise(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4) {
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 void noise(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5) {
 if (Core.bDebug && this->m_formatter.isLogSeverityEnabled(LogSeverity.Debug) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(string0, 36) + "> ", "%s", str);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0, param1);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 void trace(const std::string& format, void* param0, void* param1, void* param2) {
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 std::string string1 = this->m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(string0, 36) + "> ", format, param0, param1, param2);
 if (string1 != nullptr) {
 this->m_wrappedStream.println(string1);
 }
 }
 ...
 void trace(const std::string& format, void* param0, void* param1, void* param2, void* param3) {
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 void trace(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4) {
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
 ...
 void trace(const std::string& format, void* param0, void* param1, void* param2, void* param3, void* param4, void* param5) {
 if (this->m_formatter.isLogSeverityEnabled(LogSeverity.Trace) {
 std::string string0 = generateCallerPrefix();
 String string1 = this->m_formatter
