...
public:
 ...
 std::string format(LogSeverity logSeverity, const std::string& string0, const std::string& string1, const std::string& string2) {
 return DebugLog.formatString(this->debugType, logSeverity, string0, string1, string2);
 }

 std::string format(LogSeverity logSeverity, const std::string& string0, const std::string& string1, const std::string& string2, void* object) {
 return DebugLog.formatString(this->debugType, logSeverity, string0, string1, string2, object);
 }

 std::string format(LogSeverity logSeverity, const std::string& string0, const std::string& string1, const std::string& string2, void* object0, void* object1) {
 return DebugLog.formatString(this->debugType, logSeverity, string0, string1, string2, object0, object1);
 }

 std::string format(LogSeverity logSeverity, const std::string& string0, const std::string& string1, const std::string& string2, void* object0, void* object1, void* object2) {
