...
public
  ...
  static Texture mouseCursorTexture = null;

  static int getWheelState() { return wheelDelta; }

public
  static synchronized int getXA() { return x; }

public
  static synchronized int getYA() { return y; }
...
public
  static synchronized void setXY(int _x, int _y) {
