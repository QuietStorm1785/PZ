...
private
  final Controller[] m_controllers = new Controller[16];
private
  final GamepadState[] m_gamepadState = new GamepadState[16];
  ...
  Controller getController(int index) { return this.m_controllers[index]; }
