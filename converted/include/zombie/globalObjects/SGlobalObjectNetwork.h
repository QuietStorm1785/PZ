...
public:
 ...
 static const ByteBufferWriter BYTE_BUFFER_WRITER = new ByteBufferWriter(BYTE_BUFFER);
 ...
 static void writeServerCommand(const std::string& string0, const std::string& string1, KahluaTable table, ByteBufferWriter byteBufferWriter) {
