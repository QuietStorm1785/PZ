...
public:
 ...
 private static GlobalObjectLookup.Shared sharedServer = new GlobalObjectLookup.Shared();
 private static GlobalObjectLookup.Shared sharedClient = new GlobalObjectLookup.Shared();
 const GlobalObjectSystem system;
 private GlobalObjectLookup.Shared shared;
 private GlobalObjectLookup.Cell[] cells;
 ...
 return cell = = nullptr ? nullptr : cell.getChunkAt(int1 * 10, int0 * 10, boolean0);
 }
