...
public:
 ...
 public RadioLine(const std::string& txt, float red, float green, float blue) {
 this(txt, red, green, blue, nullptr);
 }

 public RadioLine(const std::string& txt, float red, float green, float blue, const std::string& fx) {
 ...
 void setAirTime(float _airTime) {
