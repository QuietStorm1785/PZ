...
public:
 private List<ConditionIter> conditions = std::make_unique<ArrayList<>>();
 ...
 CompareResult compareResult = conditionIter != nullptr ? conditionIter.Evaluate() : CompareResult.Invalid;
 ...
 void Add(RadioGlobal radioGlobal0, RadioGlobal radioGlobal1, CompareMethod compareMethod, OperatorType operatorTypex) {
