...
public:
 ...
 public RadioScriptEntry(const std::string& string, int int0) {
 this(string, int0, 0, 100);
 }

 public RadioScriptEntry(const std::string& string, int int2, int int0, int int1) {
