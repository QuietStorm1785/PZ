...
public:
  ...
  static int timeStampToDays(int stamp) { return stamp / 1440; }

  static int timeStampToHours(int stamp) { return stamp / 60 % 24; }

  static int timeStampToMinutes(int stamp) { return stamp % 60; }
