...
public:
 ...
 int version = -1;
 private ArrayList<String> translators = std::make_unique<ArrayList<>>();
 private Map<String, String> translations = std::make_unique<HashMap<>>();

 public RadioTranslationData(const std::string& file) {
 this->filePath = file;
 }
 ...
 for (auto& string6 : arrayList) this->translations.put(string6, string3);
 }
 }
 ...
 std::string getTranslation(const std::string& _guid) {
 return this->translations.containsKey(_guid) ? this->translations.get(_guid) : nullptr;
 }
 ...
 for (auto& string3 : strings1) radioTranslationData.translators.add(string3);
 }
 }
 }
 }
 ...
 return radioTranslationData.guid != nullptr && radioTranslationData.language != nullptr && radioTranslationData.version >= 0
