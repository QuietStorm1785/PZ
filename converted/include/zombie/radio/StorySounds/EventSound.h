...
public:
 ...
 protected ArrayList<DataPoint> dataPoints = std::make_unique<ArrayList<>>();
 protected ArrayList<StorySound> storySounds = std::make_unique<ArrayList<>>();

 public EventSound() {
 this("Unnamed");
 }

 public EventSound(const std::string& _name) {
 this->name = _name;
 }
