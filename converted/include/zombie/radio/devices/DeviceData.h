...
public:
 ...
 protected ArrayList<Long> soundIDs = std::make_unique<ArrayList<>>();
 short mediaIndex = -1;
 uint8_t mediaType = -1;
 ...
 std::unordered_map map0 = ZomboidRadio.getInstance().GetChannelList("Television");
 if (map0 != nullptr) {
 ...
 std::unordered_map map1 = ZomboidRadio.getInstance().GetChannelList("Emergency");
 if (map1 != nullptr) {
 ...
 void setParent(WaveSignalDevice p) {
 this->parent = p;
 }
 ...
 void setIsBatteryPowered(bool b) {
 ...
 void setHasBattery(bool b) {
 this->hasBattery = b;
 }

 void addBattery(DrainableComboItem bat) {
 if (!this->hasBattery && bat != nullptr && bat.getFullType() == "Base.Battery")) {
 ...
 if (this->headphoneType < 0 && (headphones.getFullType() == "Base.Headphones") || headphones.getFullType() == "Base.Earbuds"))) {
 ...
 void setBaseVolumeRange(float f) {
 ...
 long long0 = transmit ? this->emitter.playSound(soundname) : this->emitter.playSoundImpl(soundname, (IsoObject)nullptr);
 ...
 std::string string = !this->isTelevision ? "RadioStatic" : "TelevisionTestBeep";
 ...
 this->radioLoopSound = this->emitter.playSoundImpl(string, (IsoObject)nullptr);
 this->emitter.setVolume(this->radioLoopSound, this->deviceVolume * 0.4F);
 }
 ...
 return radio.getPlayer() != nullptr && radio.getPlayer().getSquare() != nullptr && radio.getPlayer().getSquare().getRoom() != nullptr
 ...
 return waveSignal.getSquare() != nullptr && waveSignal.getSquare().getRoom() != nullptr
 ...
 void transmitDeviceDataStateServer(short short0, UdpConnection udpConnection1) {
 if (GameServer.bServer) {
 try {
 ...
 if (radio.getEquipParent() != nullptr && radio.getEquipParent() instanceof IsoPlayer) {
 ...
 void receiveDeviceDataStatePacket(ByteBuffer bb, UdpConnection ignoreConnection) {
 ...
 if (boolean0) {
 this->transmitDeviceDataStateServer(short0, !boolean1 ? ignoreConnection : nullptr);
 }
 break;
 case 1:
 int int1 = bb.getInt();
 ...
 if (boolean0) {
 this->transmitDeviceDataStateServer((short)5, !boolean1 ? ignoreConnection : nullptr);
 }
 break;
 case 6:
 ...
 if (mediaData != nullptr && int0 >= 0 && int0 < mediaData.getLineCount()) {
 ...
 void setMediaIndex(short _mediaIndex) {
 ...
 void setMediaType(uint8_t _mediaType) {
 ...
 void setNoTransmit(bool _noTransmit) {
