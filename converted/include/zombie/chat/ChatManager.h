...
public:
  ...
  UdpConnection serverConnection = null;
private
  final HashMap<Integer, ChatBase> mpChats;
private
  final HashMap<String, WhisperChat> whisperChats;
private
  final HashMap<String, WhisperChatCreation> whisperChatCreation =
      std::make_unique<HashMap<>>();
private
  final HashMap<Short, ChatTab> tabs;
  ChatTab focusTab;
  IsoPlayer player;
  std::string myNickname;
  bool singlePlayerMode = false;
  GeneralChat generalChat = null;
  SayChat sayChat = null;
  ShoutChat shoutChat = null;
  FactionChat factionChat = null;
  SafehouseChat safehouseChat = null;
  RadioChat radioChat = null;
  AdminChat adminChat = null;
  ServerChat serverChat = null;
private
  ChatManager.Stage chatManagerStage = ChatManager.Stage.notStarted;
private
  static volatile ZLogger logger;
...
public
  synchronized void sendWhisperMessage(String string0, String string1) {
