...
public:
 ...
 private HashMap<Integer, ChatBase> mpChats;
 private HashMap<String, WhisperChat> whisperChats;
 private HashMap<String, WhisperChatCreation> whisperChatCreation = std::make_unique<HashMap<>>();
 private HashMap<Short, ChatTab> tabs;
 ChatTab focusTab;
 IsoPlayer player;
 ...
 void updateChatSettings(const std::string& string, bool boolean0, bool boolean1) {
 ...
 void sendMessageToChat(const std::string& string1, ChatType chatType, const std::string& string0) {
 ...
 void addMessage(int int0, const std::string& string1, const std::string& string0) {
 ChatBase chatBase = this->mpChats.get(int0);
