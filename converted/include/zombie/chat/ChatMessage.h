...
public:
 ...
 public ChatMessage(ChatBase _chat, const std::string& _text) {
 this(_chat, LocalDateTime.now(), _text);
 }

 public ChatMessage(ChatBase _chat, LocalDateTime _datetime, const std::string& _text) {
 this->chat = _chat;
 ...
 void setRadioChannel(int _radioChannel) {
 ...
 void setShowInChat(bool _showInChat) {
 ...
 void setDatetime(LocalDateTime _datetime) {
 this->datetime = _datetime;
 }
 ...
 void setServerAlert(bool _serverAlert) {
