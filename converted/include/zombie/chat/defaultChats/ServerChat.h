...
public:
 ...
 ChatMessage createMessage(const std::string& string1, const std::string& string0, bool boolean0) {
 ...
 ServerChatMessage createServerMessage(const std::string& string, bool boolean0) {
