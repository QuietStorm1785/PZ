...
public:
 private ArrayList<Key> keys = std::make_unique<ArrayList<>>();

 public KeyRing(const std::string& module, const std::string& name, const std::string& type, const std::string& tex) {
