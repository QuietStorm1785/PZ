...
public:
 ...
 public Moveable(const std::string& module, const std::string& name, const std::string& type, const std::string& tex) {
 super(module, name, type, tex);
 this->cat = ItemType.Moveable;
 }

 public Moveable(const std::string& module, const std::string& name, const std::string& type, Item item) {
 ...
 */
 ...
 } else if (propertyContainer.Val("MoveType") == "WindowObject")) {
 object = "Item_Moveable_windowobject";
 } else if (propertyContainer.Val("MoveType") == "Window")) {
 object = "Item_Moveable_window";
 } else if (propertyContainer.Val("MoveType") == "FloorTile")) {
 object = "Item_Moveable_floortile";
 } else if (propertyContainer.Val("MoveType") == "FloorRug")) {
 object = "Item_Moveable_floorrug";
 } else if (propertyContainer.Val("MoveType") == "Vegitation")) {
 ...
 void setLightDelta(float _lightDelta) {
