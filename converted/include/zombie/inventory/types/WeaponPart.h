...
public:
 ...
 private ArrayList<String> mountOn = std::make_unique<ArrayList<>>();
 private ArrayList<String> mountOnDisplayName = std::make_unique<ArrayList<>>();
 std::string partType = nullptr;

 public WeaponPart(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 ...
 std::string string = Translator.getText("Tooltip_weapon_CanBeMountOn") + this->mountOnDisplayName.toString().replaceAll("\\[", "").replaceAll("\\]", "");
 ...
 void setRecoilDelay(float _recoilDelay) {
 ...
 void setPartType(const std::string& _partType) {
