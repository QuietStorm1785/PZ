...
public:
 ...
 public InventoryContainer(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 ...
 void setItemContainer(ItemContainer cont) {
 this->container = cont;
 }
