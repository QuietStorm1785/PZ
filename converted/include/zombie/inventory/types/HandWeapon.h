...
public:
 ...
 private ArrayList<String> Categories = nullptr;
 ...
 public HandWeapon(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 super(module, name, itemType, texName);
 this->cat = ItemType.Weapon;
 }

 public HandWeapon(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 ...
 if (desc != nullptr && desc.getInstance().getThreatLevel() <= 2 && this->soundRadius > 5) {
 ...
 */
 ...
 layoutItem = layout.addItem();
 std::string string2 = this->isSpentRoundChambered() ? "Tooltip_weapon_SpentRoundChambered" : "Tooltip_weapon_NoRoundChambered";
 layoutItem.setLabel(
 ...
 std::string string3 = ((Double)object1).intValue() + " / " + ((Double)object2).intValue();
 ...
 */
 void setNoiseFactor(float _noiseFactor) {
 ...
 */
 void setOtherBoost(float _otherBoost) {
 ...
 */
 ...
 void setRecoilDelay(int recoilDelay) {
 ...
 void setSoundGain(float _soundGain) {
 ...
 void setScope(WeaponPart _scope) {
 this->scope = _scope;
 }
 ...
 void setCanon(WeaponPart _canon) {
 this->canon = _canon;
 }
 ...
 void setRecoilpad(WeaponPart _recoilpad) {
 ...
 void setSling(WeaponPart _sling) {
 this->sling = _sling;
 }
 ...
 void setAimingTime(int _aimingTime) {
 ...
 void setStock(WeaponPart _stock) {
 this->stock = _stock;
 }
 ...
 void setTreeDamage(int _treeDamage) {
 ...
 void addPartToList(const std::string& string, ArrayList<WeaponPart> arrayList) {
 ...
 void attachWeaponPart(WeaponPart part) {
 ...
 void setCanBePlaced(bool _canBePlaced) {
 ...
 void setCanBeReused(bool _canBeReused) {
 ...
 void setWeaponLength(float weaponLength) {
 ...
 void setAmmoBox(const std::string& _ammoBox) {
 ...
 bool isReloadable(IsoGameCharacter owner) {
 ...
 */
 ...
 return item != nullptr && item.getCurrentAmmoCount() != 0 ? item : nullptr;
 }
 }
 ...
 void setAmmoPerShoot(int _ammoPerShoot) {
 ...
 void setHaveChamber(bool _haveChamber) {
 ...
 void setFireMode(const std::string& _fireMode) {
