...
class AlarmClock : public InventoryItem {
public:
 int alarmHour = -1;
 int alarmMinutes = -1;
 bool alarmSet = false;
 ...
 public AlarmClock(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 ...
 public AlarmClock(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
