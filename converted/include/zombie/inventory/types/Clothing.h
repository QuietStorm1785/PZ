...
public:
 ...
 public Clothing(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName, const std::string& _palette, const std::string& _SpriteName) {
 ...
 public Clothing(const std::string& module, const std::string& name, const std::string& itemType, Item item, const std::string& _palette, const std::string& _SpriteName) {
 ...
 void Unwear() {
 if (this->container != nullptr && this->container.parent instanceof IsoGameCharacter character) {
 ...
 */
 ...
 string = string.trim();
 return string.empty() ? this->name : Translator.getText("IGUI_ClothingNaming", string, this->name);
 }
 ...
 return Clothing.WetDryState.Dryer;
 } else if (character.isAsleep() && character.getBed() != nullptr && "Tent" == character.getBed().getName())) {
 return Clothing.WetDryState.Dryer;
 } else {
 ...
 return combinationWasherDryer != nullptr && combinationWasherDryer.isActivated() ? Clothing.WetDryState.Invalid : Clothing.WetDryState.Dryer;
 }
 ...
 bool finishupdate() {
 return this->container != nullptr && this->container.parent instanceof IsoGameCharacter ? !this->isEquipped() : true;
 }
 ...
 */
 void setPalette(const std::string& _palette) {
 this->palette = _palette;
 }
 ...
 */
 ...
 void setInsulation(float _insulation) {
 ...
 void setStompPower(float _stompPower) {
 ...
 void setBiteDefense(float _biteDefense) {
 ...
 void setChanceToFall(int _chanceToFall) {
 ...
 */
 static int getBiteDefenseFromItem(IsoGameCharacter chr, InventoryItem fabric) {
 ...
 * Used from lua tooltip when repairing clothing
 */
 static int getScratchDefenseFromItem(IsoGameCharacter chr, InventoryItem fabric) {
 int int0 = Math.max(1, chr.getPerkLevel(PerkFactory.Perks.Tailoring);
 Clothing.ClothingPatchFabricType clothingPatchFabricType = Clothing.ClothingPatchFabricType.fromType(fabric.getFabricType());
 ...
 bool canFullyRestore(IsoGameCharacter chr, BloodBodyPartType part, InventoryItem fabric) {
 ...
 void addPatch(IsoGameCharacter chr, BloodBodyPartType part, InventoryItem fabric) {
 Clothing.ClothingPatchFabricType clothingPatchFabricType = Clothing.ClothingPatchFabricType.fromType(fabric.getFabricType());
 ...
 public ClothingPatch(int int0, int int1, bool boolean0) {
 this->tailorLvl = int0;
 ...
 private ClothingPatchFabricType(int int1, const std::string& string1, int int2, int int3) {
 this->index = int1;
 this->type = string1;
