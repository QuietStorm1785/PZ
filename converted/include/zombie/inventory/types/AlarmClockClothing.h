...
public:
 ...
 public AlarmClockClothing(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName, const std::string& palette, const std::string& SpriteName) {
 ...
 public AlarmClockClothing(const std::string& module, const std::string& name, const std::string& itemType, Item item, const std::string& palette, const std::string& SpriteName) {
 ...
 GameClient.instance.sendWorldSound(nullptr, square.x, square.y, square.z, this->getSoundRadius(), 3, false, 0.0F, 1.0F);
 }
 ...
 if (player != nullptr && !player.isDead() && player.getCurrentSquare() != nullptr && !player.Traits.Deaf.isSet()) {
