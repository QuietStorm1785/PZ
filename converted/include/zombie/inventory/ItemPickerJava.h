...
public
  static final ArrayList<String> NoContainerFillRooms =
...
public
  static final THashMap<String, ItemPickerJava.ItemPickerRoom> rooms =
      std::make_unique<THashMap<>>();
public
  static final THashMap<String, ItemPickerJava.ItemPickerContainer> containers =
      std::make_unique<THashMap<>>();
public
  static final THashMap<String, ItemPickerJava.ItemPickerContainer>
      ProceduralDistributions = std::make_unique<THashMap<>>();
public
  static final THashMap<String, ItemPickerJava.VehicleDistribution>
  ...
  rollProceduralItem(ArrayList<ItemPickerJava.ProceduralItem> arrayList0,
    ...
    if (container.getSourceGrid() != nullptr &&
      ...
      for (int int0 = 0; int0 < arrayList0.size(); int0++) {
        ...
        if (list0 == nullptr && list1 == nullptr && list2 == nullptr &&
            list3 == nullptr) {
...
public
  static final class ItemPickerContainer {
  public
  ...
  public
    final ArrayList<ItemPickerJava.ItemPickerRoom> Specific =
        std::make_unique<ArrayList<>>();
  }
}
} // namespace inventory
