...
public:
 ...
 protected ArrayList<IsoObject> Taken = std::make_unique<ArrayList<>>();
 ...
 ByteBuffer byteData;
 public ArrayList<String> extraItems = nullptr;
 ...
 bool favorite = false;
 protected ArrayList<String> requireInHandOrInventory = nullptr;
 ...
 private ArrayList<String> iconsForTexture = nullptr;
 private ArrayList<BloodClothingType> bloodClothingType = std::make_unique<ArrayList<>>();
 int stashChance = 80;
 ...
 private ArrayList<String> attachmentsProvided = nullptr;
 int attachedSlot = -1;
 ...
 public WorldItemAtlas.ItemTexture atlasTexture = nullptr;
 ...
 void setEquipParent(IsoGameCharacter parent) {
 ...
 void setJobType(const std::string& _type) {
 this->jobType = _type;
 }
 ...
 public InventoryItem(const std::string& _module, const std::string& _name, const std::string& _type, Item item) {
 this->col = Color.white;
 ...
 std::string string2 = InventoryItemFactory.CreateItem(this->getAmmoType()).getDisplayName();
 ...
 this->uses--;
 if (this->replaceOnUse != nullptr && !bInContainer && !bCrafting && this->container != nullptr) {
 ...
 * @return InventoryItem, or nullptr if the item failed loading or if Creating the item failed due to being obsolete etc.
 */
 static InventoryItem loadItem(ByteBuffer input, int WorldVersion, bool doSaveTypeCheck) {
 int int0 = input.getInt();
 if (int0 <= 0) {
 throw IOException("InventoryItem.loadItem() invalid item data length: " + int0);
 } else {
 ...
 if (doSaveTypeCheck && byte0 != -1 && item != nullptr && item.getSaveType() != byte0) {
 DebugLog.log(
 ...
 while (
 containerx.getContainingItem() != nullptr
 ...
 ItemContainer containerx = this->getOutermostContainer();
 return containerx = = nullptr ? false : containerx.getParent() instanceof IsoPlayer;
 }
 ...
 if (character.getPrimaryHandItem() == this && this->getItemReplacementPrimaryHand() != nullptr) {
 return "RightHand";
 }

 if (character.getSecondaryHandItem() == this && this->getItemReplacementSecondHand() != nullptr) {
 return "LeftHand";
 }
 }
 ...
 if (this instanceof Clothing && this->getBloodClothingType() != nullptr) {
 ...
 if ((clothingItem.m_BaseTextures.size() > 1 || itemVisual.m_TextureChoice > -1) && this->getIconsForTexture() != nullptr) {
 ...
 */
 void setContainerX(int _containerX) {
 ...
 */
 void setContainerY(int _containerY) {
 ...
 */
 void setOffAgeMax(int _OffAgeMax) {
 ...
 */
 ...
 && _Condition <= 0
 && doSound
 && this->getBreakSound() != nullptr
 && !this->getBreakSound().empty()
 ...
 */
 void setTaken(ArrayList<IsoObject> _Taken) {
 this->Taken = _Taken;
 }
 ...
 */
 void setPlaceDir(IsoDirections _placeDir) {
 ...
 */
 ...
 void setActivatedRemote(bool _activated) {
 this->activated = _activated;
 }
 ...
 void setTorchCone(bool _isTorchCone) {
 ...
 */
 ...
 void setCustomName(bool _customName) {
 ...
 void setCustomWeight(bool custom) {
 ...
 void setCanBeRemote(bool _canBeRemote) {
 ...
 void setRemoteRange(int _remoteRange) {
 ...
 void setColorRed(float _colorRed) {
 ...
 void setColorGreen(float _colorGreen) {
 ...
 void setColorBlue(float _colorBlue) {
 ...
 void setMetalValue(float _metalValue) {
 ...
 void setWorker(const std::string& _worker) {
 this->worker = _worker;
 }
 ...
 void setWetCooldown(float _wetCooldown) {
 ...
 void setFavorite(bool _favorite) {
 ...
 void setRequireInHandOrInventory(ArrayList<String> _requireInHandOrInventory) {
 ...
 void setCustomColor(bool _customColor) {
 ...
 void setStashMap(const std::string& _stashMap) {
 ...
 void setItemCapacity(float capacity) {
 ...
 void setBrakeForce(float _brakeForce) {
 ...
 */
 void setScriptItem(Item _ScriptItem) {
 ...
 */
 ...
 void setStashChance(int _stashChance) {
 ...
 void setMaxAmmo(int maxAmmoCount) {
 ...
 void setCurrentAmmoCount(int ammo) {
 ...
 void setGunType(const std::string& _gunType) {
 ...
 void setAttachedSlot(int _attachedSlot) {
 ...
 void setWorldZRotation(int rot) {
