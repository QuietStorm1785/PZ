...
public:
 ...
 int readBlock(const std::string& string0, int int1, ClothingItemsDotTxt.Block block1) {
 int int0;
 ...
 void LoadFile() {
 std::string string0 = ZomboidFileSystem.instance.getString("media/scripts/clothingItems.txt");
 ...
 std::string type;
 std::string id;
 public ArrayList<ClothingItemsDotTxt.BlockElement> elements = std::make_unique<ArrayList<>>();
 public ArrayList<String> values = std::make_unique<ArrayList<>>();
 public ArrayList<ClothingItemsDotTxt.Block> children = std::make_unique<ArrayList<>>();
