...
public:
 ...
 static InventoryItem fixItem(InventoryItem brokenItem, IsoGameCharacter chr, Fixing fixing, Fixing.Fixer fixer) {
 ...
 static void useFixer(IsoGameCharacter chr, Fixing.Fixer fixer, InventoryItem brokenItem) {
 ...
 int int5 = 0;
 if (weapon.getMagazineType() != nullptr && weapon.isContainsClip()) {
 ...
 static double getChanceOfFail(InventoryItem brokenItem, IsoGameCharacter chr, Fixing fixing, Fixing.Fixer fixer) {
 double double0 = 3.0;
 if (fixer.getFixerSkills() != nullptr) {
 for (int int0 = 0; int0 < fixer.getFixerSkills().size(); int0++) {
 ...
 * 5;
 ...
 static double getCondRepaired(InventoryItem brokenItem, IsoGameCharacter chr, Fixing fixing, Fixing.Fixer fixer) {
 double double0 = 0.0;
