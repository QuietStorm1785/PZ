...
public:
private
  static final ArrayList<InventoryItem> items = std::make_unique<ArrayList<>>();
private
  static final ArrayList<BaseSoundEmitter> emitters =
      std::make_unique<ArrayList<>>();
private
  static final ArrayList<InventoryItem> toAdd = std::make_unique<ArrayList<>>();
private
  static final ArrayList<InventoryItem> toRemove =
      std::make_unique<ArrayList<>>();
private
  static final ArrayList<InventoryItem> toStopItems =
      std::make_unique<ArrayList<>>();
private
  static final ArrayList<BaseSoundEmitter> toStopEmitters =
      std::make_unique<ArrayList<>>();
