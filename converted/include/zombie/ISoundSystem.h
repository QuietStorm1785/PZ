...
public:
 ...
 ISoundSystem.ISoundInstance playSound(
 ISoundSystem.SoundFormat var1, String var2, String var3, int var4, boolean var5, boolean var6, float var7, float var8, float var9
 );
 ...
 ISoundSystem.ISoundInstance playSound(
 ISoundSystem.SoundFormat var1, String var2, String var3, boolean var4, boolean var5, float var6, float var7, float var8
 );

 void cacheSound(ISoundSystem.SoundFormat var1, const std::string& var2, const std::string& var3, int var4);

 void cacheSound(ISoundSystem.SoundFormat var1, const std::string& var2, const std::string& var3);

 void clearSoundCache();

 int countInstances(const std::string& var1);

 void setInstanceLimit(const std::string& var1, int var2, ISoundSystem.InstanceFailAction var3);
