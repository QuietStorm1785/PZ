...
public:
 ...
 public int runAsync(FileTask task);
 ...
 public SubTexture(const std::string& packName, const std::string& pageName, TexturePackPage.SubTextureInfo info) {
 ...
 public static class TexturePackTextures extends HashMap<String, FileSystem.SubTexture> {
 }
}
} // namespace fileSystem
} // namespace zombie
