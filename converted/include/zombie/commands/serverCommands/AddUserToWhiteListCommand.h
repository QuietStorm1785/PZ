...
public:
 public AddUserToWhiteListCommand(const std::string& string0, const std::string& string1, const std::string& string2, UdpConnection udpConnection) {
 ...
 if (udpConnection.password != nullptr && !udpConnection.password == "")) {
