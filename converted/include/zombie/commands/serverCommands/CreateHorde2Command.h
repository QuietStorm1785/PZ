...
public:
 public CreateHorde2Command(const std::string& string0, const std::string& string1, const std::string& string2, UdpConnection udpConnection) {
 ...
 } else if (OutfitManager.instance.FindMaleOutfit(string0) == nullptr) {
