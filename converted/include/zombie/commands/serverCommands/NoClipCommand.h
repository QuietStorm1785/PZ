...
public:
 public NoClipCommand(const std::string& string0, const std::string& string1, const std::string& string2, UdpConnection udpConnection) {
 ...
 string0 = string1;
 if (this->connection.accessLevel == 2 && !string1 == this->getExecutorUsername())) {
