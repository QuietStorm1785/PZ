...
public:
 public PlayersCommand(const std::string& string0, const std::string& string1, const std::string& string2, UdpConnection udpConnection) {
 ...
 for (auto& string1 : arrayList) stringBuilder.append("-").append(string1).append(string0);
 }
