...
public:
 public SetAccessLevelCommand(const std::string& string0, const std::string& string1, const std::string& string2, UdpConnection udpConnection) {
 super(string0, string1, string2, udpConnection);
 }

 std::string Command() {
 std::string string0 = this->getCommandArg(0);
 std::string string1 = "none".equals(this->getCommandArg(1) ? "" : this->getCommandArg(1);
 return update();
 }
 ...
 if (udpConnection0 != nullptr && udpConnection0.accessLevel == 16 && byte0 == 32) {
