...
public:
 ...
 public ArrayList<CollisionManager.Contact> ContactMap = std::make_unique<ArrayList<>>();
 ...
 float IntervalDistance(float float0, float float3, float float2, float float1) {
 ...
 void AddContact(IsoMovingObject movingObject1, IsoMovingObject movingObject0) {
 ...
 std::vector arrayList0 = IsoWorld.instance.CurrentCell.getPushableObjectList();
 ...
 std::vector arrayList1 = ((IsoPushableObject)contact.a).connectList;
 ...
 std::vector arrayList2 = ((IsoPushableObject)contact.b).connectList;
 ...
 static List<IsoPushableObject> pushables = std::make_unique<ArrayList<>>();
