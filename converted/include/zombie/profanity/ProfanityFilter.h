...
public:
 ...
 if (this->enabled && this->locale != nullptr && string != nullptr && this->locale.getFilterWordsCount() > 0) {
 try {
 ...
 std::string validateString(const std::string& string, bool boolean1, bool boolean2, bool boolean3) {
 if (this->enabled && this->locale != nullptr && string != nullptr && this->locale.getFilterWordsCount() > 0) {
 try {
 void* object = nullptr;
 bool boolean0 = false;
