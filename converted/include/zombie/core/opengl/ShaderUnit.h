...
public:
 ...
 private ShaderUnit.Type m_unitType;
 int m_glID;
 bool m_isAttached;

 public ShaderUnit(ShaderProgram parent, const std::string& fileName, ShaderUnit.Type unitType) {
 ...
 std::string preProcessShaderFile(const std::string& string0, ArrayList<String> arrayList) {
 ...
 for (String string2 = bufferedReader.readLine(); string2 != nullptr; string2 = bufferedReader.readLine()) {
 ...
 bool processIncludeLine(const std::string& string3, StringBuilder stringBuilder1, const std::string& string1, const std::string& string9, ArrayList<String> arrayList1) {
 ...
 for (auto& string7 : arrayList0) if (stringBuilder0.length() > 0) {
