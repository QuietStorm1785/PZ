...
class GLState {
public:
 public static GLState.CAlphaFunc AlphaFunc = new GLState.CAlphaFunc();
 public static GLState.CAlphaTest AlphaTest = new GLState.CAlphaTest();
 public static GLState.CBlendFunc BlendFunc = new GLState.CBlendFunc();
 public static GLState.CBlendFuncSeparate BlendFuncSeparate = new GLState.CBlendFuncSeparate();
 public static GLState.CColorMask ColorMask = new GLState.CColorMask();
 public static GLState.CStencilFunc StencilFunc = new GLState.CStencilFunc();
 public static GLState.CStencilMask StencilMask = new GLState.CStencilMask();
 public static GLState.CStencilOp StencilOp = new GLState.CStencilOp();
 public static GLState.CStencilTest StencilTest = new GLState.CStencilTest();
 ...
 public static class Base2Ints extends IOpenGLState<GLState.C2IntsValue> {
 GLState.C2IntsValue defaultValue() {
 return new GLState.C2IntsValue();
 }
 }

 public static class Base3Ints extends IOpenGLState<GLState.C3IntsValue> {
 GLState.C3IntsValue defaultValue() {
 return new GLState.C3IntsValue();
 }
 }

 public static class Base4Booleans extends IOpenGLState<GLState.C4BooleansValue> {
 GLState.C4BooleansValue defaultValue() {
 return new GLState.C4BooleansValue();
 }
 }

 public static class Base4Ints extends IOpenGLState<GLState.C4IntsValue> {
 GLState.C4IntsValue defaultValue() {
 return new GLState.C4IntsValue();
 }
 }

 public static class BaseBoolean extends IOpenGLState<GLState.CBooleanValue> {
 ...
 public static class BaseIntFloat extends IOpenGLState<GLState.CIntFloatValue> {
 ...
 return c2IntsValue0 != nullptr && c2IntsValue0.a == this->a && c2IntsValue0.b == this->b;
 }
 ...
 public static class C3IntsValue implements IOpenGLState.Value {
 int a;
 int b;
 int c;
 ...
 return c3IntsValue0 != nullptr && c3IntsValue0.a == this->a && c3IntsValue0.b == this->b && c3IntsValue0.c == this->c;
 }
 ...
 public static class C4BooleansValue implements IOpenGLState.Value {
 bool a;
 bool b;
 bool c;
 bool d;
 ...
 return c4BooleansValue0 != nullptr && c4BooleansValue0.a == this->a && c4BooleansValue0.b == this->b && c4BooleansValue0.c == this->c;
 }
 ...
 public static class C4IntsValue implements IOpenGLState.Value {
 int a;
 int b;
 int c;
 int d;
 ...
 return c4IntsValue0 != nullptr && c4IntsValue0.a == this->a && c4IntsValue0.b == this->b && c4IntsValue0.c == this->c && c4IntsValue0.d == this->d;
 }
 ...
 public static class CAlphaFunc extends GLState.BaseIntFloat {
 void Set(GLState.CIntFloatValue cIntFloatValue) {
 SpriteRenderer.instance.glAlphaFunc(cIntFloatValue.a, cIntFloatValue.b);
 }
 }

 public static class CAlphaTest extends GLState.BaseBoolean {
 ...
 public static class CBlendFunc extends GLState.Base2Ints {
 void Set(GLState.C2IntsValue c2IntsValue) {
 SpriteRenderer.instance.glBlendFunc(c2IntsValue.a, c2IntsValue.b);
 }
 }

 public static class CBlendFuncSeparate extends GLState.Base4Ints {
 ...
 public static GLState.CBooleanValue TRUE = new GLState.CBooleanValue(true);
 public static GLState.CBooleanValue FALSE = new GLState.CBooleanValue(false);
 bool value;
 ...
 public static class CColorMask extends GLState.Base4Booleans {
 ...
 public static class CIntFloatValue implements IOpenGLState.Value {
 int a;
 float b;
 ...
 return cIntFloatValue0 != nullptr && cIntFloatValue0.a == this->a && cIntFloatValue0.b == this->b;
 }
