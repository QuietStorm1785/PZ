...
public:
 public static ArrayList<VoiceManagerData> data = std::make_unique<ArrayList<>>();
 long userplaychannel;
 long userplaysound;
 bool userplaymute;
 long voicetimeout;
 public ArrayList<VoiceManagerData.RadioData> radioData = std::make_unique<ArrayList<>>();
 bool isCanHearAll;
 short index;
