...
public:
 ...
 void fromString(const std::string& string, LanguageFileData languageFileData) {
 ...
 if (value1 != nullptr && !StringUtils.isNullOrWhitespace(value1.getValue())) {
 ScriptParser.Value value2 = block.getValue("charset");
 if (value2 != nullptr && !StringUtils.isNullOrWhitespace(value2.getValue())) {
 ...
 if (value3 != nullptr && !StringUtils.isNullOrWhitespace(value3.getValue())) {
