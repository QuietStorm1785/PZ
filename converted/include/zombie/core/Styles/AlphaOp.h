 ...
 */
enum class AlphaOp {
  PREMULTIPLY{int calc(ReadableColor readableColor, int int0){
      ...
      return (int)(readableColor.getRed() * float1) << 0 |
             ...
             (int)(readableColor.getBlue() * float1) << 16 | (int)float0 << 24;}
} // namespace Styles
, KEEP{int calc(ReadableColor readableColor, int var2){
      return readableColor.getRed() << 0 | readableColor.getGreen() << 8 |
             readableColor.getBlue() << 16 | readableColor.getAlpha() << 24;
} // namespace core
} // namespace zombie
, ZERO{int calc(ReadableColor readableColor, int int0){
      float float0 = readableColor.getAlpha() * int0 * 0.003921569F;
float float1 = float0 * 0.003921569F;
return (int)(readableColor.getRed() * float1) << 0 |
       (int)(readableColor.getGreen() * float1) << 8 |
...
protected
abstract int calc(ReadableColor var1, int var2);
}
} // namespace Styles
} // namespace core
} // namespace zombie
