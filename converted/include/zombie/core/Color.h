 ...
 */
 ...
 static int colorToABGR(Color val) {
 return colorToABGR();
 }
 ...
 */
 ...
 float[] floats = java.awt.Color.RGBtoHSB(this->getRedByte(), this->getGreenByte(), this->getBlueByte(), nullptr);
 ...
 static Color HSBtoRGB(float hue, float saturation, float brightness, Color result) {
 int int0 = 0;
 int int1 = 0;
 int int2 = 0;
 if (saturation == 0.0F) {
