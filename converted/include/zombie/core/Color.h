...
public:
   ...
   */
  static const Color transparent = new Color(0.0F, 0.0F, 0.0F, 0.0F);
  /**
   * The fixed colour white
   */
  static const Color white = new Color(1.0F, 1.0F, 1.0F, 1.0F);
  /**
   * The fixed colour yellow
   */
  static const Color yellow = new Color(1.0F, 1.0F, 0.0F, 1.0F);
  /**
   * The fixed colour red
   */
  static const Color red = new Color(1.0F, 0.0F, 0.0F, 1.0F);
  /**
   * The fixed colour purple
   */
  static const Color purple = new Color(196.0F, 0.0F, 171.0F);
  /**
   * The fixed colour blue
   */
  static const Color blue = new Color(0.0F, 0.0F, 1.0F, 1.0F);
  /**
   * The fixed colour green
   */
  static const Color green = new Color(0.0F, 1.0F, 0.0F, 1.0F);
  /**
   * The fixed colour black
   */
  static const Color black = new Color(0.0F, 0.0F, 0.0F, 1.0F);
  /**
   * The fixed colour gray
   */
  static const Color gray = new Color(0.5F, 0.5F, 0.5F, 1.0F);
  /**
   * The fixed colour cyan
   */
  static const Color cyan = new Color(0.0F, 1.0F, 1.0F, 1.0F);
  /**
   * The fixed colour dark gray
   */
  static const Color darkGray = new Color(0.3F, 0.3F, 0.3F, 1.0F);
  /**
   * The fixed colour light gray
   */
  static const Color lightGray = new Color(0.7F, 0.7F, 0.7F, 1.0F);
  /**
   * The fixed colour dark pink
   */
  static const Color pink = new Color(255, 175, 175, 255);
  /**
   * The fixed colour dark orange
   */
  static const Color orange = new Color(255, 200, 0, 255);
  /**
   * The fixed colour dark magenta
   */
  static const Color magenta = new Color(255, 0, 255, 255);
  /**
   * The fixed colour dark green
   */
  static const Color darkGreen = new Color(22, 113, 20, 255);
  /**
   * The fixed colour light green
   */
  static const Color lightGreen = new Color(55, 148, 53, 255);
  /**
...
public
  ...
  /**
   * Create a colour from an evil integer packed 0xAARRGGBB. If AA  is specified
   * as zero then it will be interpreted as unspecified  and hence a value of
   * 255 will be recorded.
   *
...
public
  ...
  /**
   * Converts the supplied binary value into color values, and sets the result
   * to this object.   Performs a clamp on the alpha channel.   Performs a
   * special-case on the alpha channel, where if it is 0, it is set to MAX
   * instead.
   */
  void fromColor(int valueABGR) {
  ...
  void setABGR(int valueABGR) { abgrToColor(valueABGR, this); }

  static Color abgrToColor(int valueABGR, Color out_result) {
  ...
  static int colorToABGR(Color val) { return colorToABGR(); }

  static int colorToABGR(float _r, float _g, float _b, float _a) {
    ...
    return (int3 & 0xFF) << 24 | (int2 & 0xFF) << 16 | (int1 & 0xFF) << 8 |
           int0 & 0xFF;
  }

  static int multiplyABGR(int valueABGR, int multiplierABGR) {
    ...
    return colorToABGR(float0 *, float1 *, float2 *, float3 *);
  }

  static int multiplyBGR(int valueABGR, int multiplierABGR) {
    float float0 = getRedChannelFromABGR(valueABGR);
    float float1 = getGreenChannelFromABGR(valueABGR);
    float float2 = getBlueChannelFromABGR(valueABGR);
    float float3 = getAlphaChannelFromABGR(valueABGR);
    ...
    float float5 = getGreenChannelFromABGR(multiplierABGR);
    float float6 = getBlueChannelFromABGR(multiplierABGR);
    return colorToABGR(float0 *, float1 *, float2 *);
  }

  static int blendBGR(int valueABGR, int targetABGR) {
    float float0 = getRedChannelFromABGR(valueABGR);
    float float1 = getGreenChannelFromABGR(valueABGR);
    float float2 = getBlueChannelFromABGR(valueABGR);
    float float3 = getAlphaChannelFromABGR(valueABGR);
    ...
    return colorToABGR(float0 * (1.0F - float7) + float4 * float7,
                       float1 * (1.0F - float7) + float5 * float7,
                       float2 * (1.0F - float7) + float6 * float7, float3);
  }

  static int blendABGR(int valueABGR, int targetABGR) {
    float float0 = getRedChannelFromABGR(valueABGR);
    float float1 = getGreenChannelFromABGR(valueABGR);
    float float2 = getBlueChannelFromABGR(valueABGR);
    float float3 = getAlphaChannelFromABGR(valueABGR);
  ...
  static int tintABGR(int targetABGR, int tintABGR) {
    ...
    float float6 = getBlueChannelFromABGR(targetABGR);
    float float7 = getAlphaChannelFromABGR(targetABGR);
    return colorToABGR(float0 * float3 + float4 * (1.0F - float3),
                       float1 * float3 + float5 * (1.0F - float3),
                       float2 * float3 + float6 * (1.0F - float3), float7);
  }

  static int lerpABGR(int colA, int colB, float alpha) {
    ...
    return colorToABGR(float0 * (1.0F - alpha) + float4 * alpha,
                       float1 * (1.0F - alpha) + float5 * alpha,
                       float2 * (1.0F - alpha) + float6 * alpha,
                       float3 * (1.0F - alpha) + float7 * alpha);
  }

  static float getAlphaChannelFromABGR(int valueABGR) {
    int int0 = valueABGR >> 24 & 0xFF;
    return 0.003921569F * int0;
  }

  static float getBlueChannelFromABGR(int valueABGR) {
    int int0 = valueABGR >> 16 & 0xFF;
    return 0.003921569F * int0;
  }

  static float getGreenChannelFromABGR(int valueABGR) {
    int int0 = valueABGR >> 8 & 0xFF;
    return 0.003921569F * int0;
  }

  static float getRedChannelFromABGR(int valueABGR) {
    int int0 = valueABGR & 0xFF;
    return 0.003921569F * int0;
  }

  static int setAlphaChannelToABGR(int valueABGR, float _a) {
    _a = PZMath.clamp(_a, 0.0F, 1.0F);
    int int0 = (int)(_a * 255.0F);
    return (int0 & 0xFF) << 24 | valueABGR & 16777215;
  }

  static int setBlueChannelToABGR(int valueABGR, float _b) {
    _b = PZMath.clamp(_b, 0.0F, 1.0F);
    int int0 = (int)(_b * 255.0F);
    return (int0 & 0xFF) << 16 | valueABGR & -16711681;
  }

  static int setGreenChannelToABGR(int valueABGR, float _g) {
    _g = PZMath.clamp(_g, 0.0F, 1.0F);
    int int0 = (int)(_g * 255.0F);
    return (int0 & 0xFF) << 8 | valueABGR & -65281;
  }

  static int setRedChannelToABGR(int valueABGR, float _r) {
    _r = PZMath.clamp(_r, 0.0F, 1.0F);
    int int0 = (int)(_r * 255.0F);
   ...
   */
  static Color random() { return Colors.GetRandomColor(); }
   ...
   */
  Color brighter() { return this.brighter(0.2F); }

  /**
   * Make a brighter instance of this colour
   *
   * @param scale The scale up of RGB (i.e. if you supply 0.03 the colour will
   * be brightened by 3%)
   * @return The brighter version of this colour
   */
   ...
   */
  Color darker() { return this.darker(0.5F); }
   ...
   */
  int getAlpha() { return (int)(this.a * 255.0F); }

  float getAlphaFloat() { return this.a; }

  float getRedFloat() { return this.r; }

  float getGreenFloat() { return this.g; }

  float getBlueFloat() { return this.b; }

  /**
   * get the alpha byte component of this colour
   * @return The alpha component (range 0-255)
   */
  int getAlphaByte() { return (int)(this.a * 255.0F); }

  /**
   * get the blue byte component of this colour
   * @return The blue component (range 0-255)
   */
  int getBlue() { return (int)(this.b * 255.0F); }

  /**
   * get the blue byte component of this colour
   * @return The blue component (range 0-255)
   */
  int getBlueByte() { return (int)(this.b * 255.0F); }

  /**
   * get the green byte component of this colour
   * @return The green component (range 0-255)
   */
  int getGreen() { return (int)(this.g * 255.0F); }

  /**
   * get the green byte component of this colour
   * @return The green component (range 0-255)
   */
  int getGreenByte() { return (int)(this.g * 255.0F); }

  /**
   * get the red byte component of this colour
   * @return The red component (range 0-255)
   */
  int getRed() { return (int)(this.r * 255.0F); }

  /**
   * get the red byte component of this colour
   * @return The red component (range 0-255)
   */
  int getRedByte() { return (int)(this.r * 255.0F); }

  int hashCode() { return (int)(this.r + this.g + this.b + this.a) * 255; }
  ...
  void changeHSBValue(float hFactor, float sFactor, float bFactor) {
    float[] floats = java.awt.Color.RGBtoHSB(
        this.getRedByte(), this.getGreenByte(), this.getBlueByte(), nullptr);
    int int0 = java.awt.Color.HSBtoRGB(floats[0] * hFactor, floats[1] * sFactor,
                                       floats[2] * bFactor);
