...
public:
 ...
 static ByteBuffer makeTransp(ByteBuffer byteBuffer, int int0, int int1, int int2, int int3, int int4) {
 return makeTransp();
 }

 static ByteBuffer makeTransp(ByteBuffer byteBuffer, int int6, int int5, int int4, int int7, int int3, int int1) {
 byteBuffer.rewind();
 ...
 static void saveImage(Texture texture, const std::string& string, const std::string& var2) {
