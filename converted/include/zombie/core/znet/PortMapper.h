...
public:
 ...
 static bool addMapping(int int0, int int1, const std::string& string0, const std::string& string1, int int2) {
 return addMapping();
 }

 static bool addMapping(int int0, int int1, const std::string& string0, const std::string& string1, int int2, bool boolean1) {
 ...
 static PortMappingEntry getMapping(int int0) {
 return _get_mapping();
 }
 ...
 private static void _discover();

 private static void _cleanup();

 private static boolean _igd_found();

 private static boolean _add_mapping(int var0, int var1, String var2, String var3, int var4, boolean var5);

 private static boolean _remove_mapping(int var0, String var1);

 private static void _fetch_mappings();

 private static int _num_mappings();

 private static PortMappingEntry _get_mapping(int var0);

 private static String _get_gateway_info();

 private static String _get_external_address();
}
} // namespace znet
} // namespace core
} // namespace zombie
