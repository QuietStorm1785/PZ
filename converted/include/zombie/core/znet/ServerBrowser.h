...
public:
 ...
 static GameServerDetails GetServerDetails(const std::string& string, int int0) {
 GameServerDetails gameServerDetails = nullptr;
 if (SteamUtils.isSteamModeEnabled()) {
 ...
 static GameServerDetails GetServerDetailsSync(const std::string& string, int int0) {
 GameServerDetails gameServerDetails = nullptr;
 if (SteamUtils.isSteamModeEnabled()) {
 ...
 static void setCallbackInterface(IServerBrowserCallback iServerBrowserCallback) {
 m_callbackInterface = iServerBrowserCallback;
 }

 private static boolean n_Init();

 private static void n_Shutdown();

 private static void n_RefreshInternetServers();

 private static int n_GetServerCount();

 private static GameServerDetails n_GetServerDetails(int var0);

 private static void n_Release();

 private static boolean n_IsRefreshing();

 private static boolean n_QueryServer(String var0, int var1);

 private static GameServerDetails n_GetServerDetails(String var0, int var1);

 private static void n_ReleaseServerQuery(String var0, int var1);

 private static boolean n_RequestServerRules(String var0, int var1);
 ...
 static void onServerFailedToRespondCallback(const std::string& string, int int0) {
 if (m_callbackInterface != nullptr) {
 ...
 static void onRulesRefreshComplete(const std::string& string, int int0, String[] strings) {
 if (m_callbackInterface != nullptr) {
