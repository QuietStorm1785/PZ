...
public:
  static const ImmutableColor transparent =
      new ImmutableColor(0.0F, 0.0F, 0.0F, 0.0F);
  static const ImmutableColor white =
      new ImmutableColor(1.0F, 1.0F, 1.0F, 1.0F);
  static const ImmutableColor yellow =
      new ImmutableColor(1.0F, 1.0F, 0.0F, 1.0F);
  ...
  static const ImmutableColor green =
      new ImmutableColor(0.0F, 1.0F, 0.0F, 1.0F);
  static const ImmutableColor black =
      new ImmutableColor(0.0F, 0.0F, 0.0F, 1.0F);
  ...
  static const ImmutableColor darkGray =
      new ImmutableColor(0.3F, 0.3F, 0.3F, 1.0F);
  static const ImmutableColor lightGray =
      new ImmutableColor(0.7F, 0.7F, 0.7F, 1.0F);
...
public
  ...
  Color toMutableColor() { return new Color(this.r, this.g, this.b, this.a); }

public
  ImmutableColor(float _r, float _g, float _b) {
...
public
  ImmutableColor(float _r, float _g, float _b, float _a) {
...
public
  ImmutableColor(Color A, Color B, float delta) {
...
public
  ImmutableColor(int _r, int _g, int _b) {
    this.r = _r / 255.0F;
    this.g = _g / 255.0F;
    this.b = _b / 255.0F;
    this.a = 1.0F;
...
public
  ImmutableColor(int _r, int _g, int _b, int _a) {
    this.r = _r / 255.0F;
    this.g = _g / 255.0F;
    this.b = _b / 255.0F;
    this.a = _a / 255.0F;
...
public
  ...
  ImmutableColor add(ImmutableColor c) {
    return new ImmutableColor(this.r + c.r, this.g + c.g, this.b + c.b,
                              this.a + c.a);
  }

  ImmutableColor brighter() { return this.brighter(0.2F); }

  ImmutableColor brighter(float scale) {
    return new ImmutableColor(this.r + scale, this.g + scale, this.b + scale);
  }

  ImmutableColor darker() { return this.darker(0.5F); }
  ...
  bool equals(void *other) {
    return !(other instanceof ImmutableColor immutableColor)
               ? false
               : immutableColor.r == this.r && immutableColor.g == this.g &&
                     immutableColor.b == this.b && immutableColor.a == this.a;
  }

  int getAlphaInt() { return (int)(this.a * 255.0F); }
  ...
  uint8_t getAlphaByte() { return (byte)((int)(this.a * 255.0F) & 0xFF); }

  int getBlueInt() { return (int)(this.b * 255.0F); }

  uint8_t getBlueByte() { return (byte)((int)(this.b * 255.0F) & 0xFF); }

  int getGreenInt() { return (int)(this.g * 255.0F); }

  uint8_t getGreenByte() { return (byte)((int)(this.g * 255.0F) & 0xFF); }

  int getRedInt() { return (int)(this.r * 255.0F); }

  uint8_t getRedByte() { return (byte)((int)(this.r * 255.0F) & 0xFF); }
  ...
  ImmutableColor scale(float value) {
    return new ImmutableColor(this.r * value, this.g * value, this.b * value,
                              this.a * value);
  }

  std::string toString() {
    return "ImmutableColor (" + this.r + "," + this.g + "," + this.b + "," +
           this.a + ")";
  }
  ...
  ImmutableColor interp(ImmutableColor to, float delta) {
    ...
    float2 *= delta;
    float3 *= delta;
    return new ImmutableColor(this.r + float0, this.g + float1, this.b + float2,
                              this.a + float3);
  }

public
  static Integer[] HSBtoRGB(float hue, float saturation, float brightness) {
    int int0 = 0;
    int int1 = 0;
    int int2 = 0;
    if (saturation == 0.0F) {
