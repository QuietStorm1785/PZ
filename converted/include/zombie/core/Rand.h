...
public:
 ...
 static long Next(long long0) {
 return Next();
 }

 static int Next(int int1, int int0, CellularAutomatonRNG cellularAutomatonRNG) {
 if (int0 == int1) {
 return int1;
 } else {
 if (int1 > int0) {
 ...
 static int Next(int int0, int int1) {
 return Next();
 }

 static long Next(long long1, long long0, CellularAutomatonRNG cellularAutomatonRNG) {
 if (long0 == long1) {
 return long1;
 } else {
 if (long1 > long0) {
 ...
 static long Next(long long0, long long1) {
 return Next();
 }

 static float Next(float float1, float float0, CellularAutomatonRNG cellularAutomatonRNG) {
 if (float0 == float1) {
 return float1;
 } else {
 if (float1 > float0) {
 ...
 static float Next(float float0, float float1) {
 return Next();
 }

 static bool NextBool(int int0) {
 return Next();
 }
 ...
 public static class PZSeedGenerator implements SeedGenerator {
 private static SeedGenerator[] GENERATORS = new SeedGenerator[]{std::make_unique<SecureRandomSeedGenerator>()};

 private PZSeedGenerator() {
 }

 public byte[] generateSeed(int int0) {
 for (auto& seedGenerator : GENERATORS) try {
