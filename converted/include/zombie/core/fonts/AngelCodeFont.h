 ...
 */
 ...
 private LinkedHashMap displayLists = new LinkedHashMap(200, 1.0F, true) {
 bool removeEldestEntry(Entry entry) {
 ...
 Texture fontImage;
 int lineHeight;
 private HashMap<Short, Texture> pages = std::make_unique<HashMap<>>();
 File fntFile;
 static int xoff = 0;
 static int yoff = 0;
 ...
 */
 public AngelCodeFont(const std::string& _fntFile, Texture image) {
 ...
 */
 public AngelCodeFont(const std::string& _fntFile, const std::string& imgFile) {
 ...
 */
 ...
 void drawString(float x, float y, float scale, const std::string& text, float r, float g, float b, float a) {
 ...
 */
 ...
 void drawString(float x, float y, const std::string& text, float r, float g, float b, float a, int startIndex, int endIndex) {
 this->drawString(x, y, 0.0F, text, r, g, b, a, startIndex, endIndex);
 }

 void drawString(float x, float y, float scale, const std::string& text, float r, float g, float b, float a, int startIndex, int endIndex) {
 xoff = (int)x;
 yoff = (int)y;
 curR = r;
 curG = g;
 ...
 */
 ...
 public CharDefTexture(TextureID textureID, const std::string& string) {
