...
public:
 ...
 std::string string0 = ZomboidFileSystem.instance.getCacheDir() + File.separator + "backups" + File.separator + "last_server_version.txt";
 ...
 static void makeBackupFile(const std::string& string2, ZipBackup.BackupTypes backupTypes) {
 std::string string0 = ZomboidFileSystem.instance.getCacheDir() + File.separator + "backups" + File.separator + backupTypes.name();
 ...
 ZipArchiveOutputStream zipArchiveOutputStream = nullptr;
 ...
 static void putTextFile(const std::string& string0, const std::string& string1) {
 try {
 ...
 static void zipTextFile(const std::string& string1, const std::string& string0) {
