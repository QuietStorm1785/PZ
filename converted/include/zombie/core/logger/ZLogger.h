...
public:
 ...
 private ZLogger.OutputStreams outputStreams = new ZLogger.OutputStreams();
 File file = nullptr;
 static const SimpleDateFormat s_fileNameSdf = new SimpleDateFormat("dd-MM-yy_HH-mm-ss");
 ...
 */
 public ZLogger(const std::string& _name, bool useConsole) {
 this->name = _name;
 ...
 void write(const std::string& string0, const std::string& string1, bool boolean0) {
 try {
