...
public:
 ...
 SpriteRenderer.instance.renderi(nullptr, int2, int3, byte0, int1, 0.8F, 0.0F, 0.0F, 1.0F, nullptr);
 SpriteRenderer.instance.renderi(nullptr, int2 + 1, int3 + 1, byte0 - 2, int0 - 1, 0.0F, 0.0F, 0.0F, 1.0F, nullptr);
