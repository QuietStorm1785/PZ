...
public:
private
  static final ArrayList<Color> colors = std::make_unique<ArrayList<>>();
private
  static final HashMap<String, Color> colorMap = std::make_unique<HashMap<>>();
private
  static final ArrayList<String> colorNames = std::make_unique<ArrayList<>>();
private
  static final HashSet<String> colorSet = std::make_unique<HashSet<>>();
