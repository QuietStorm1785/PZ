...
private
  static BooleanRectangleCollection.Point intersection =
      new BooleanRectangleCollection.Point();
  ...
  void doIt(ArrayList<Rectangle> arrayList1, Rectangle rectangle1) {
    ...
    for (auto &rectangle0 : arrayList1)
      std::vector arrayList2 = this.doIt(rectangle0, rectangle1);
...
public
ArrayList<Rectangle> doIt(Rectangle rectangle1, Rectangle rectangle3) {
  std::vector arrayList0 = new ArrayList();
  ...
  arrayList4.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(rectangle1.getX(),
                                           rectangle1.getY()),
      new BooleanRectangleCollection.Point(
  ...
  arrayList4.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(
          rectangle1.getX() + rectangle1.getWidth(), rectangle1.getY()),
      new BooleanRectangleCollection.Point(
          rectangle1.getX() + rectangle1.getWidth(),
          rectangle1.getY() + rectangle1.getHeight())));
  arrayList4.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(
          rectangle1.getX() + rectangle1.getWidth(),
          rectangle1.getY() + rectangle1.getHeight()),
  ...
  arrayList4.add(new BooleanRectangleCollection.Line(
      ...
      new BooleanRectangleCollection.Point(rectangle1.getX(),
                                           rectangle1.getY())));
  arrayList5.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(rectangle3.getX(),
                                           rectangle3.getY()),
      new BooleanRectangleCollection.Point(
          rectangle3.getX() + rectangle3.getWidth(), rectangle3.getY())));
  arrayList5.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(
          rectangle3.getX() + rectangle3.getWidth(), rectangle3.getY()),
      new BooleanRectangleCollection.Point(
          rectangle3.getX() + rectangle3.getWidth(),
          rectangle3.getY() + rectangle3.getHeight())));
  arrayList5.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(
          rectangle3.getX() + rectangle3.getWidth(),
          rectangle3.getY() + rectangle3.getHeight()),
      new BooleanRectangleCollection.Point(
          rectangle3.getX(), rectangle3.getY() + rectangle3.getHeight())));
  arrayList5.add(new BooleanRectangleCollection.Line(
      new BooleanRectangleCollection.Point(
          rectangle3.getX(), rectangle3.getY() + rectangle3.getHeight()),
      new BooleanRectangleCollection.Point(rectangle3.getX(),
  ...
  for (int int0 = 0; int0 < arrayList4.size(); int0++) {
    for (int int1 = 0; int1 < arrayList5.size(); int1++) {
      if (this.IntesectsLine(
              (BooleanRectangleCollection.Line)arrayList4.get(int0),
              (BooleanRectangleCollection.Line)arrayList5.get(int1)) != 0 &&
          this.IsPointInRect(intersection.X, intersection.Y, rectangle0)) {
        arrayList1.add(new BooleanRectangleCollection.Point(intersection.X,
                                                            intersection.Y));
      }
    }
  }
  ...
  if (this.IsPointInRect(rectangle3.getX(), rectangle3.getY(), rectangle0)) {
    arrayList1.add(new BooleanRectangleCollection.Point(rectangle3.getX(),
                                                        rectangle3.getY()));
  }

  if (this.IsPointInRect(rectangle3.getX() + rectangle3.getWidth(),
                         rectangle3.getY(), rectangle0)) {
    arrayList1.add(new BooleanRectangleCollection.Point(
        rectangle3.getX() + rectangle3.getWidth(), rectangle3.getY()));
  }
  ...
  if (this.IsPointInRect(rectangle3.getX(),
                         rectangle3.getY() + rectangle3.getHeight(),
                         rectangle0)) {
    arrayList1.add(new BooleanRectangleCollection.Point(
        rectangle3.getX(), rectangle3.getY() + rectangle3.getHeight()));
  ...
  arrayList1.add(new BooleanRectangleCollection.Point(rectangle0.getX(),
                                                      rectangle0.getY()));
  arrayList1.add(new BooleanRectangleCollection.Point(
      rectangle0.getX() + rectangle0.getWidth(), rectangle0.getY()));
  arrayList1.add(new BooleanRectangleCollection.Point(
      rectangle0.getX() + rectangle0.getWidth(),
      rectangle0.getY() + rectangle0.getHeight()));
  arrayList1.add(new BooleanRectangleCollection.Point(
      rectangle0.getX(), rectangle0.getY() + rectangle0.getHeight()));
...
int IntesectsLine(BooleanRectangleCollection.Line line0,
                  BooleanRectangleCollection.Line line1) {
  intersection.X = 0;
  intersection.Y = 0;
...
class Line {
public
  BooleanRectangleCollection.Point Start =
      new BooleanRectangleCollection.Point();
public
  BooleanRectangleCollection.Point End = new BooleanRectangleCollection.Point();

public
  Line(BooleanRectangleCollection.Point point0,
       BooleanRectangleCollection.Point point1) {
