...
private
  static final NonBlockingHashtable.Prime TOMBPRIME;
private
...
private
  static final NonBlockingHashtable.CHM chm(Object[] objects) {
...
private
  final AtomicReferenceFieldUpdater<NonBlockingHashtable.CHM, Object[]>
      _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
          NonBlockingHashtable.CHM.class, Object[].class, "_newkvs");
  volatile long _resizers;
private
  static final AtomicLongFieldUpdater<NonBlockingHashtable.CHM>
...
private
  final Object[] resize(NonBlockingHashtable nonBlockingHashtable,
                        Object[] objects0) {
...
private
  final Object[] copy_slot_and_check(NonBlockingHashtable nonBlockingHashtable,
    ...
    return object = =
               null ? objects1 : nonBlockingHashtable.help_copy(objects1);
  }
