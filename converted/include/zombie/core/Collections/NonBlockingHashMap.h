...
public:
 ...
 private static NonBlockingHashMap.Prime TOMBPRIME;
 ...
 private static NonBlockingHashMap.CHM chm(Object[] objects) {
 ...
 return object2 = = nullptr ? object0 == object2 : object2.equals(object0);
 }
 ...
 return object3 = = nullptr ? object0 == object3 : object3.equals(object0);
 }
 ...
 static void* get_impl(NonBlockingHashMap nonBlockingHashMap, Object[] objects0, void* object2, int int2) {
 ...
 return objects1 = = nullptr ? nullptr : get_impl(nonBlockingHashMap, nonBlockingHashMap.help_copy(objects1), object2, int2);
 }
 ...
 static void* putIfMatch(NonBlockingHashMap nonBlockingHashMap, Object[] objects0, void* object2, void* object0, void* object1) {
 ...
 if (objects1 == nullptr && (object4 == nullptr && chm.tableFull(int3, int1) || object4 instanceof NonBlockingHashMap.Prime) {
 objects1 = chm.resize(nonBlockingHashMap, objects0);
 }
 ...
 Object[] _newkvs;
 private AtomicReferenceFieldUpdater<NonBlockingHashMap.CHM, Object[]> _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
 NonBlockingHashMap.CHM.class, Object[].class, "_newkvs"
 );
 long _resizers;
 private static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _resizerUpdater = AtomicLongFieldUpdater.newUpdater(
 NonBlockingHashMap.CHM.class, "_resizers"
 );
 long _copyIdx = 0L;
 private static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(
 NonBlockingHashMap.CHM.class, "_copyIdx"
 );
 long _copyDone = 0L;
 private static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(
 ...
 private Object[] resize(NonBlockingHashMap nonBlockingHashMap, Object[] objects0) {
 ...
 void help_copy_impl(NonBlockingHashMap nonBlockingHashMap, Object[] objects0, bool boolean0) {
 assert NonBlockingHashMap.chm(objects0) == this;
 ...
 private Object[] copy_slot_and_check(NonBlockingHashMap nonBlockingHashMap, Object[] objects0, int int0, Object object) {
 assert NonBlockingHashMap.chm(objects0) == this;
 ...
 return object = = nullptr ? objects1 : nonBlockingHashMap.help_copy(objects1);
 }

 void copy_check_and_promote(NonBlockingHashMap nonBlockingHashMap, Object[] objects, int int1) {
 ...
 bool copy_slot(NonBlockingHashMap nonBlockingHashMap, int int0, Object[] objects0, Object[] objects1) {
 void* object0;
 while ((object0 = NonBlockingHashMap.key(objects0, int0) == nullptr) {
 NonBlockingHashMap.CAS_key(objects0, int0, nullptr, NonBlockingHashMap.TOMBSTONE);
 }
 ...
 NonBlockingHashMap.Prime prime = object1 != nullptr && object1 != NonBlockingHashMap.TOMBSTONE
 ...
 bool boolean0 = NonBlockingHashMap.putIfMatch(nonBlockingHashMap, objects1, object0, object2, nullptr) == nullptr;
 ...
 NonBlockingHashMap<TypeK, TypeV>.SnapshotV _ss = NonBlockingHashMap.this->std::make_unique<SnapshotV>();
 ...
 if (this->_nextK != nullptr && this->_nextK != NonBlockingHashMap.TOMBSTONE && (this->_nextV = NonBlockingHashMap.this->get(this->_nextK) != nullptr) {
 break;
 }
 }
