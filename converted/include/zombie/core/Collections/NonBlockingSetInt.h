...
public:
 ...
 private NonBlockingSetInt.NBSI _nbsi;
 ...
 this->_nbsi = new NonBlockingSetInt.NBSI(63, std::make_unique<Counter>(), this);
 }

 private NonBlockingSetInt(NonBlockingSetInt nonBlockingSetInt2, NonBlockingSetInt nonBlockingSetInt1) {
 this->_nbsi = new NonBlockingSetInt.NBSI(nonBlockingSetInt2._nbsi, nonBlockingSetInt1._nbsi, std::make_unique<Counter>(), this);
 }
 ...
 bool add(int int0) {
 if (int0 < 0) {
 throw IllegalArgumentException(int0 + "");
 } else {
 ...
 void clear() {
 NonBlockingSetInt.NBSI nbsi = new NonBlockingSetInt.NBSI(63, std::make_unique<Counter>(), this);
 ...
 this->_nbsi = new NonBlockingSetInt.NBSI(int0, std::make_unique<Counter>(), this);
 ...
 private AtomicInteger _copyIdx;
 private AtomicInteger _copyDone;
 private int _sum_bits_length;
 private NonBlockingSetInt.NBSI _nbsi64;
 ...
 return NonBlockingSetInt._unsafe.compareAndSwapObject(this, _new_offset, nullptr, nbsi1);
 }

 static long mask(int int0) {
 return 1L << (int0 & 63);
 }
 ...
 this->_nbsi64 = new NonBlockingSetInt.NBSI(nullptr, nbsi1._nbsi64, nullptr, nullptr);
 } else if (!has_bits(nbsi1) {
 this->_bits = new long[nbsi2._bits.length];
 this->_nbsi64 = new NonBlockingSetInt.NBSI(nullptr, nbsi2._nbsi64, nullptr, nullptr);
 } else {
 int int0 = nbsi2._bits.length > nbsi1._bits.length ? nbsi2._bits.length : nbsi1._bits.length;
 this->_bits = new long[int0];
 this->_nbsi64 = new NonBlockingSetInt.NBSI(nbsi2._nbsi64, nbsi1._nbsi64, nullptr, nullptr);
 }
 ...
 bool intersect(NonBlockingSetInt.NBSI nbsi2, NonBlockingSetInt.NBSI nbsi1, NonBlockingSetInt.NBSI nbsi0) {
 ...
 bool union(NonBlockingSetInt.NBSI nbsi2, NonBlockingSetInt.NBSI nbsi1, NonBlockingSetInt.NBSI nbsi0) {
 if (!has_bits(nbsi1) && !has_bits(nbsi0) {
 return true;
 } else {
 if (has_bits(nbsi1) || has_bits(nbsi0) {
 ...
 for (NonBlockingSetInt.NBSI nbsi0 = this; nbsi0 != nullptr; nbsi0 = nbsi0._nbsi64) {
