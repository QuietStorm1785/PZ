...
public:
 ...
 this->entryStore.add(new ZomboidHashMap.Entry<>(0, nullptr, nullptr, nullptr);
 }
 ...
 throw IllegalArgumentException("Illegal load factor: " + float0);
 }
 }
 }
 ...
 return this->getEntry(object) != nullptr;
 }
 ...
 ZomboidHashMap.Entry<K, V> removeMapping(Object object0) {
 ...
 void* clone() {
 ZomboidHashMap zomboidHashMap0 = nullptr;
 ...
 return collection != nullptr ? collection : (this->values = new ZomboidHashMap.Values());
 }
 ...
 return set != nullptr ? set : (this->entrySet = new ZomboidHashMap.EntrySet());
 }

 void writeObject(ObjectOutputStream objectOutputStream) {
 Iterator iterator = this->size > 0 ? this->entrySet0().iterator() : nullptr;
 ...
 if (object3 == object4 || object3 != nullptr && object3 == object4) {
 return true;
 }
 }
 ...
 while (this->index < entrys.length && (this->next = entrys[this->index++]) == nullptr) {
 }
 }
 }
 ...
 ZomboidHashMap.Entry<K, V> nextEntry() {
