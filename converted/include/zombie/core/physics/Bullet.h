...
public:
 ...
 private static void ToBullet(ByteBuffer var0);
 ...
 public static void initWorld(int var0, int var1, boolean var2);
 ...
 for (auto& player : arrayList) cmdBuf.putInt(player.OnlineID);
 ...
 static void beginUpdateChunk(IsoChunk chunk) {
 cmdBuf.clear();
 cmdBuf.put((byte)8);
