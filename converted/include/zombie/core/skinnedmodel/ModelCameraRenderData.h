...
public:
  ...
  bool m_bInVehicle;
public
  static final ObjectPool<ModelCameraRenderData> s_pool =
      new ObjectPool<>(ModelCameraRenderData::new);

  ModelCameraRenderData init(ModelCamera modelCamera,
  ...
  ModelCameraRenderData init(ModelCamera modelCamera, float float0,
                             bool boolean0, float float1, float float2,
                             float float3, bool boolean1) {
    this.m_camera = modelCamera;
    this.m_angle = float0;
  ...
  void postRender() { s_pool.release(this); }
}
} // namespace skinnedmodel
} // namespace core
} // namespace zombie
