...
public:
 ArrayList<CharacterTextures.CTAnimSet> m_animSets = std::make_unique<ArrayList<>>();
 ...
 private static class CTAnimSet {
 std::string m_name;
 ArrayList<CharacterTextures.CTState> m_states = std::make_unique<ArrayList<>>();
 ...
 private static class CTEntryList extends ArrayList<CharacterTextures.CTEntry> {
 }

 private static class CTState {
 std::string m_name;
 CharacterTextures.CTEntryList[] m_entries = new CharacterTextures.CTEntryList[IsoDirections.values().length];
