...
public:
private
  static final ObjectPool<WorldItemModelDrawer> s_modelDrawerPool =
      new ObjectPool<>(WorldItemModelDrawer::new);
private
  static final ObjectPool<WorldItemModelDrawer.WeaponPartParams>
      s_weaponPartParamPool =
          new ObjectPool<>(WorldItemModelDrawer.WeaponPartParams::new);
private
  static final ArrayList<WeaponPart> s_tempWeaponPartList =
