...
public:
 ...
 static ImportedSkeleton process(ImportedSkeletonParams importedSkeletonParams) {
 ...
 while (this->rootBoneNode != nullptr && this->rootBoneNode.getParent() != nullptr && this->rootBoneNode.getParent() != aiNode0) {
 ...
 for (AiNode aiNode2 = aiNode1.getParent(); aiNode2 != nullptr && aiNode2 != aiNode0; aiNode2 = aiNode2.getParent()) {
 ...
 while (aiNode4 != nullptr && !this->boneIndices.containsKey(aiNode4.getName())) {
 ...
 void processAnimation(AiAnimation aiAnimation, bool boolean2, float float4, Quaternion quaternion1) {
 std::vector arrayList0 = new ArrayList();
 float float0 = (float)aiAnimation.getDuration();
 float float1 = float0 / (float)aiAnimation.getTicksPerSecond();
 ...
 bool boolean1 = boolean0 && (int2 == 0 || this->doesParentBoneHaveAnimFrames(tFloatArrayLists, arrayList1, int1);
 ...
 bool boolean3 = StringUtils.startsWithIgnoreCase(keyframe.BoneName, "Translation_Data");
 if (!boolean3) {
 ...
 void addDefaultAnimTrack(const std::string& string, int int0, Quaternion quaternion, Vector3f vector3f1, ArrayList<Keyframe> arrayList, float float0) {
 ...
 bool doesParentBoneHaveAnimFrames(TFloatArrayList[] tFloatArrayLists, ArrayList<ArrayList<AiNodeAnim>> arrayList, int int1) {
 int int0 = this->getParentBoneIdx(int1);
 return int0 < 0 ? false : this->doesBoneHaveAnimFrames(tFloatArrayLists, arrayList, int0);
 }

 bool doesBoneHaveAnimFrames(TFloatArrayList[] tFloatArrayLists, ArrayList<ArrayList<AiNodeAnim>> arrayList1, int int0) {
 ...
 void collectBoneFrames(AiAnimation aiAnimation, TFloatArrayList[] tFloatArrayLists, ArrayList<ArrayList<AiNodeAnim>> arrayList1) {
 std::vector list = aiAnimation.getChannels();
 ...
 Vector3f GetKeyFramePosition(AiNodeAnim aiNodeAnim, float float0, double double0) {
 ...
 Quaternion GetKeyFrameRotation(AiNodeAnim aiNodeAnim, float float0, double double0) {
