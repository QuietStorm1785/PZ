...
public:
 ...
 static ProcessedAiScene process(ProcessedAiSceneParams processedAiSceneParams) {
 ...
 for (AiNode aiNode2 = aiNode1.getParent(); aiNode2 != nullptr; aiNode2 = aiNode2.getParent()) {
 ...
 void applyToMesh(ModelMesh modelMesh, JAssImpImporter.LoadMode var2, bool boolean0, SkinningData skinningData) {
