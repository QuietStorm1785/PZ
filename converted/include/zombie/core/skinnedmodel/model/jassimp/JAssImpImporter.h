...
public:
 private static TObjectIntHashMap<String> sharedStringCounts = std::make_unique<TObjectIntHashMap<>>();
 static const SharedStrings sharedStrings = new SharedStrings();
 private static HashMap<String, Integer> tempHashMap = std::make_unique<HashMap<>>();
 ...
 static void DumpMesh(VertexPositionNormalTangentTextureSkin[] vertexPositionNormalTangentTextureSkins) {
 StringBuilder stringBuilder = new StringBuilder();

 for (auto& vertexPositionNormalTangentTextureSkin : vertexPositionNormalTangentTextureSkins) stringBuilder.append(vertexPositionNormalTangentTextureSkin.Position.x())
 .append('\t')
 ...
 static std::string getSharedString(const std::string& string1, const std::string& string2) {
 ...
 static void takeOutTheTrash(VertexPositionNormalTangentTexture[] vertexPositionNormalTangentTextures) {
 ...
 static void takeOutTheTrash(VertexPositionNormalTangentTextureSkin[] vertexPositionNormalTangentTextureSkins) {
 ...
 static void takeOutTheTrash(VertexPositionNormalTangentTexture vertexPositionNormalTangentTexture) {
 ...
 static void takeOutTheTrash(VertexPositionNormalTangentTextureSkin vertexPositionNormalTangentTextureSkin) {
