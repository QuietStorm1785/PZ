...
public
  ImportedSkinnedMesh(ImportedSkeleton importedSkeleton, AiMesh aiMesh) {
  ...
  void processAiScene(AiMesh aiMesh) {
    ...
    VertexBufferObject.VertexFormat vertexFormat =
        new VertexBufferObject.VertexFormat(5 + int9);
    ...
    vertexFormat.setElement(3, VertexBufferObject.VertexType.BlendWeightArray,
                            16);
    vertexFormat.setElement(4, VertexBufferObject.VertexType.BlendIndexArray,
                            16);

    for (int int10 = 0; int10 < int9; int10++) {
      vertexFormat.setElement(
          5 + int10, VertexBufferObject.VertexType.TextureCoordArray, 8);
    }
    ...
    for (int int11 = 0; int11 < int0; int11++) {
      this.vertices.setElement(int11, 0, aiMesh.getPositionX(int11),
                               aiMesh.getPositionY(int11),
                               aiMesh.getPositionZ(int11));
      if (aiMesh.hasNormals()) {
        this.vertices.setElement(int11, 1, aiMesh.getNormalX(int11),
                                 aiMesh.getNormalY(int11),
                                 aiMesh.getNormalZ(int11));
      } else {
        this.vertices.setElement(int11, 1, 0.0F, 1.0F, 0.0F);
      }

      if (aiMesh.hasTangentsAndBitangents()) {
        this.vertices.setElement(int11, 2, aiMesh.getTangentX(int11),
                                 aiMesh.getTangentY(int11),
                                 aiMesh.getTangentZ(int11));
      } else {
        this.vertices.setElement(int11, 2, 0.0F, 0.0F, 1.0F);
      }

      this.vertices.setElement(int11, 3, floats[int11 * 4],
                               floats[int11 * 4 + 1], floats[int11 * 4 + 2],
                               floats[int11 * 4 + 3]);
      this.vertices.setElement(int11, 4, ints[int11 * 4], ints[int11 * 4 + 1],
                               ints[int11 * 4 + 2], ints[int11 * 4 + 3]);
      if (int9 > 0) {
        int int12 = 0;

        for (int int13 = 0; int13 < 8; int13++) {
          if (aiMesh.hasTexCoords(int13)) {
            this.vertices.setElement(int11, 5 + int12,
                                     aiMesh.getTexCoordU(int11, int13),
                                     1.0F - aiMesh.getTexCoordV(int11, int13));
            int12++;
          }
        }
      }
