...
class CharacterMask {
public:
 private boolean[] m_visibleFlags = createFlags(CharacterMask.Part.values().length, true);
 ...
 */
 ...
 private Part(int int1, bool boolean0) {
 this->value = int1;
 this->parent = nullptr;
