...
public:
 ...
 static void forEachDescendant(SkinningBone skinningBone0, Consumer<SkinningBone> consumer) {
 if (skinningBone0.Children != nullptr && skinningBone0.Children.length != 0) {
