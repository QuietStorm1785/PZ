...
public:
 ...
 private VertexBufferObject.VertexFormat m_vertexFormat;
 ...
 public VertexBufferObject(VertexPositionNormalTangentTextureSkin[] vertexPositionNormalTangentTextureSkins, int[] ints0, bool boolean0) {
 this->elements = ints0;
 if (boolean0) {
 ...
 public VertexBufferObject(VertexBufferObject.VertexArray vertexArray, int[] ints1, bool boolean0) {
 this->m_vertexFormat = vertexArray.m_format;
 if (boolean0) {
 ...
 static void Draw(VertexBufferObject.Vbo vbo, VertexBufferObject.VertexFormat vertexFormat, Shader shader, int int4) {
 if (vbo != nullptr) {
 ...
 public VertexBufferObject.VertexFormat m_format;
 ...
 void setElement(int vertex, int element, float v1, float v2, float v3, float v4) {
 int int0 = vertex * this->m_format.m_stride + this->m_format.m_elements[element].m_byteOffset;
 this->m_buffer.putFloat(int0, v1);
 int0 += 4;
 this->m_buffer.putFloat(int0, v2);
 ...
 VertexBufferObject.VertexElement[] m_elements;
 int m_stride;
 ...
 void setElement(int index, VertexBufferObject.VertexType type, int byteSize) {
