...
public:
 ...
 float0 *= 1.0F;
 float0++;
 VertexPositionNormalTangentTextureSkin vertexPositionNormalTangentTextureSkin0 = nullptr;
 vertexPositionNormalTangentTextureSkin0 = std::make_unique<VertexPositionNormalTangentTextureSkin>();
 vertexPositionNormalTangentTextureSkin0.Position = std::make_unique<Vector3>();
 vertexPositionNormalTangentTextureSkin0.Position.set(-int6, float0 * 30.0F, -int7);
 vertexPositionNormalTangentTextureSkin0.Normal = std::make_unique<Vector3>();
 ...
 vertexPositionNormalTangentTextureSkin0.TextureCoordinates = std::make_unique<Vector2>();
