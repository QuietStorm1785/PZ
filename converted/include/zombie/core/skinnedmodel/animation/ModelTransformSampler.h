...
public:
 ...
 private static Pool<ModelTransformSampler> s_pool = new Pool<>(ModelTransformSampler::new);
 ...
 static ModelTransformSampler alloc(AnimationPlayer animationPlayer, AnimationTrack animationTrack) {
 ...
 bool boolean0 = animationBoneBinding != nullptr && animationBoneBinding.getBone() != nullptr && animationBoneBinding.getBone().Index == int0;
 ...
 void getTrackTransform(int int0, AnimationTrack animationTrack, Vector3f vector3f0, Quaternion quaternion, Vector3f vector3f1) {
