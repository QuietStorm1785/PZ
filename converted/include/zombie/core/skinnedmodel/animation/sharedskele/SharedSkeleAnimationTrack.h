...
public:
 ...
 bool boolean0 = DebugOptions.instance.Animation.SharedSkeles.AllowLerping.getValue();
 ...
 void sampleBoneData(int int2, int int1, int int3, float float0, bool boolean0, Matrix4f matrix4f) {
 int int0 = int1 * 16;
