...
public:
 ...
 protected HashMap<String, Integer> m_nameIndices = std::make_unique<HashMap<>>();
 ...
 public GenericNameValueRecordingFrame(const std::string& string0, const std::string& string1) {
 ...
 static StringBuilder appendCell(StringBuilder stringBuilder, const std::string& string) {
 ...
 static StringBuilder appendCellQuot(StringBuilder stringBuilder, const std::string& string) {
