...
public:
 ...
 static const SimpleDateFormat s_fileNameSdf = new SimpleDateFormat("yy-MM-dd_HH-mm");
 ...
 static PrintStream openFileStream(const std::string& key, bool append, Consumer<String> fileNameConsumer) {
 ...
 void logAnimWeights(List<AnimationTrack> list, int[] ints, float[] floats, Vector2 vector) {
