...
public:
 private ArrayList<AnimationTrack> m_tracks = std::make_unique<ArrayList<>>();
 private static ArrayList<AnimationTrack> tempTracks = std::make_unique<ArrayList<>>();
 ...
 void removeTrackAt(int indexOf) {
 ...
 AnimationTrack getTrackAt(int i) {
