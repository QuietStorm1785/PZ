...
public:
 ...
 private HelperFunctions.TransformResult_QPS m_transformResult = new HelperFunctions.TransformResult_QPS(this->m_matrix);
 ...
 private static Pool<BoneTransform> s_pool = new Pool<>(BoneTransform::new);
