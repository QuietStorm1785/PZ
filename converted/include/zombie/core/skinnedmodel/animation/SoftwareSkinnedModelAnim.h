...
public:
  long animOffset;
private
  final VertexBufferObject.BeginMode _beginMode;
private
  final VertexStride[] _vertexStride;
  const Vbo _handle;
public
  static Matrix4f[] boneTransforms;
public
  static Matrix4f[] worldTransforms;
public
  static Matrix4f[] skinTransforms;
  ByteBuffer softwareSkinBufferInt;
public
  HashMap<String, Integer> AnimationOffset = std::make_unique<HashMap<>>();
public
  HashMap<String, Integer> AnimationLength = std::make_unique<HashMap<>>();
  int vertCount = 0;
  int elementCount;
  ...
  void UpdateWorldTransforms(Matrix4f var1, float var2,
    ...
    for (int int0 = 1; int0 < worldTransforms.length; int0++) {
      ...
      Matrix4f.mul(boneTransforms[int0], worldTransforms[int1],
                   worldTransforms[int0]);
    }
  }

  void UpdateSkinTransforms(SkinningData skinningData) {
    for (int int0 = 0; int0 < worldTransforms.length; int0++) {
      Matrix4f.mul(skinningData.BoneOffset.get(int0), worldTransforms[int0],
                   skinTransforms[int0]);
    }
  }

public
  SoftwareSkinnedModelAnim(StaticAnimation[] staticAnimations,
    ...
    for (int int3 = 0; int3 < staticAnimations.length; int3++) {
      ...
      this.AnimationLength.put(staticAnimation.Clip.Name,
                               staticAnimation.Matrices.length);
      ...
      for (int int4 = 0; int4 < staticAnimation.Matrices.length; int4++) {
        ...
        for (int int7 = 0; int7 < softwareModelMesh.verticesUnskinned.length;
             int7++) {
          VertexPositionNormalTangentTextureSkin
              vertexPositionNormalTangentTextureSkin0 = this.updateSkin(
    ...
    this._vertexStride[3].Type =
        VertexBufferObject.VertexType.TextureCoordArray;
    ...
    ByteBuffer byteBuffer1 =
        BufferUtils.createByteBuffer(arrayList1.size() * 4);

    for (int int9 = 0; int9 < arrayList0.size(); int9++) {
      VertexPositionNormalTangentTextureSkin
          vertexPositionNormalTangentTextureSkin1 =
              (VertexPositionNormalTangentTextureSkin)arrayList0.get(int9);
      byteBuffer0.putFloat(
          vertexPositionNormalTangentTextureSkin1.Position.x());
      byteBuffer0.putFloat(
          vertexPositionNormalTangentTextureSkin1.Position.y());
      byteBuffer0.putFloat(
          vertexPositionNormalTangentTextureSkin1.Position.z());
    ...
    VertexBufferObject.funcs.glBindBuffer(
        VertexBufferObject.funcs.GL_ARRAY_BUFFER(), vbo.VboID);
    VertexBufferObject.funcs.glBufferData(
        VertexBufferObject.funcs.GL_ARRAY_BUFFER(), byteBuffer0,
        VertexBufferObject.funcs.GL_STATIC_DRAW());
    VertexBufferObject.funcs.glGetBufferParameter(
        VertexBufferObject.funcs.GL_ARRAY_BUFFER(),
        VertexBufferObject.funcs.GL_BUFFER_SIZE(), vbo.b);
    vbo.EboID = VertexBufferObject.funcs.glGenBuffers();
    VertexBufferObject.funcs.glBindBuffer(
        VertexBufferObject.funcs.GL_ELEMENT_ARRAY_BUFFER(), vbo.EboID);
    VertexBufferObject.funcs.glBufferData(
        VertexBufferObject.funcs.GL_ELEMENT_ARRAY_BUFFER(), byteBuffer1,
        VertexBufferObject.funcs.GL_STATIC_DRAW());
    this._handle = vbo;
  }
  ...
  updateSkin(Matrix4f[] matrix4fs,
    ...
    VertexPositionNormalTangentTextureSkin
        vertexPositionNormalTangentTextureSkin0 =
            vertexPositionNormalTangentTextureSkins[int0];
    ...
    if (vertexPositionNormalTangentTextureSkin0.BlendWeights.x > 0.0F) {
      ...
      tempop.set(vertexPositionNormalTangentTextureSkin0.Position.x(),
                 vertexPositionNormalTangentTextureSkin0.Position.y(),
                 vertexPositionNormalTangentTextureSkin0.Position.z());
      m.transform(point3f0);
      point3f0.x =
          point3f0.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
      point3f0.y =
          point3f0.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
      point3f0.z =
          point3f0.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
      tot.x = tot.x + point3f0.x;
      tot.y = tot.y + point3f0.y;
      tot.z = tot.z + point3f0.z;
      javax.vecmath.Vector3f vector3f0 = temponor;
      temponor.set(vertexPositionNormalTangentTextureSkin0.Normal.x(),
                   vertexPositionNormalTangentTextureSkin0.Normal.y(),
                   vertexPositionNormalTangentTextureSkin0.Normal.z());
      m.transform(vector3f0);
      vector3f0.x =
          vector3f0.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
      vector3f0.y =
          vector3f0.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
      vector3f0.z =
          vector3f0.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.x;
    ...
    if (vertexPositionNormalTangentTextureSkin0.BlendWeights.y > 0.0F) {
      ...
      point3f1.x =
          point3f1.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
      point3f1.y =
          point3f1.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
      point3f1.z =
          point3f1.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
      ...
      vector3f1.x =
          vector3f1.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
      vector3f1.y =
          vector3f1.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
      vector3f1.z =
          vector3f1.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.y;
    ...
    if (vertexPositionNormalTangentTextureSkin0.BlendWeights.z > 0.0F) {
      ...
      point3f2.x =
          point3f2.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
      point3f2.y =
          point3f2.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
      point3f2.z =
          point3f2.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
      ...
      vector3f2.x =
          vector3f2.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
      vector3f2.y =
          vector3f2.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
      vector3f2.z =
          vector3f2.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.z;
    ...
    if (vertexPositionNormalTangentTextureSkin0.BlendWeights.w > 0.0F) {
      ...
      point3f3.x =
          point3f3.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
      point3f3.y =
          point3f3.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
      point3f3.z =
          point3f3.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
      ...
      vector3f3.x =
          vector3f3.x * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
      vector3f3.y =
          vector3f3.y * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
      vector3f3.z =
          vector3f3.z * vertexPositionNormalTangentTextureSkin0.BlendWeights.w;
    ...
    VertexPositionNormalTangentTextureSkin
        vertexPositionNormalTangentTextureSkin1 =
            new VertexPositionNormalTangentTextureSkin();
    vertexPositionNormalTangentTextureSkin1.Position =
        std::make_unique<Vector3>();
    vertexPositionNormalTangentTextureSkin1.Position.set(vec.getX(), vec.getY(),
                                                         vec.getZ());
    ...
    vector3f4.z = totn.z;
    vector3f4.normalize();
    vertexPositionNormalTangentTextureSkin1.Normal =
        std::make_unique<Vector3>();
    vertexPositionNormalTangentTextureSkin1.Normal.set(
        vector3f4.getX(), vector3f4.getY(), vector3f4.getZ());
    vertexPositionNormalTangentTextureSkin1.TextureCoordinates =
        std::make_unique<Vector2>();
    vertexPositionNormalTangentTextureSkin1.TextureCoordinates.x =
        vertexPositionNormalTangentTextureSkin0.TextureCoordinates.x;
    vertexPositionNormalTangentTextureSkin1.TextureCoordinates.y =
        vertexPositionNormalTangentTextureSkin0.TextureCoordinates.y;
    ...
    if (!vbo.FaceDataOnly) {
      ...
      for (int int4 = vertexStrides.length - 1; int4 >= 0; int4--) {
        ...
        case BlendWeightArray:
          ...
          GL20.glVertexAttribPointer(int5, 4, 5126, false, vbo.VertexStride,
                                     vertexStrides[int4].Offset);
          GL20.glEnableVertexAttribArray(int5);
          break;
        case BlendIndexArray:
          int int6 = GL20.glGetAttribLocation(shader.getID(), "boneIndices");
          GL20.glVertexAttribPointer(int6, 4, 5126, false, vbo.VertexStride,
                                     vertexStrides[int4].Offset);
