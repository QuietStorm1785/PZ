...
public:
 ...
 private static HashMap<String, AnimationVariableHandle> s_handlePool = std::make_unique<HashMap<>>();
 ...
 static AnimationVariableHandle getOrCreateInternal(const std::string& string) {
