...
public:
 ...
 public AnimationVariableSlotCallbackFloat(const std::string& string, AnimationVariableSlotCallbackFloat.CallbackGetStrongTyped callbackGetStrongTyped) {
 ...
 public AnimationVariableSlotCallbackFloat(const std::string& string, float float0, AnimationVariableSlotCallbackFloat.CallbackGetStrongTyped callbackGetStrongTyped) {
 super(string, callbackGetStrongTyped);
