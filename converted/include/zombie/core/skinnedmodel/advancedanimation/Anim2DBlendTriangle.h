...
public:
 ...
 static double sign(float float5, float float0, float float2, float float4, float float3, float float1) {
 return (float5 - float3) * (float4 - float1) - (float2 - float3) * (float0 - float1);
 }

 static bool PointInTriangle(float float0, float float1, float float2, float float3, float float4, float float5, float float6, float float7) {
 ...
 bool Contains(float float0, float float1) {
