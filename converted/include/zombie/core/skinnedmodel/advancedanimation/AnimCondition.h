...
public:
 ...
 switch (type) {
 case EQU:
 return iAnimationVariableSlot != nullptr && this->m_FloatValue == iAnimationVariableSlot.getValueFloat();
 case NEQ:
 return iAnimationVariableSlot != nullptr && this->m_FloatValue != iAnimationVariableSlot.getValueFloat();
 case LESS:
 return iAnimationVariableSlot != nullptr && iAnimationVariableSlot.getValueFloat() < this->m_FloatValue;
 case GTR:
 return iAnimationVariableSlot != nullptr && iAnimationVariableSlot.getValueFloat() > this->m_FloatValue;
 case BOOL:
 return (iAnimationVariableSlot != nullptr && iAnimationVariableSlot.getValueBool()) == this->m_BoolValue;
 case STRING:
 return this->m_StringValue.equalsIgnoreCase(iAnimationVariableSlot != nullptr ? iAnimationVariableSlot.getValueString() : "");
 case STRNEQ:
 return !this->m_StringValue.equalsIgnoreCase(iAnimationVariableSlot != nullptr ? iAnimationVariableSlot.getValueString() : "");
 case OR:
 return false;
 ...
 static bool pass(IAnimationVariableSource varSource, List<AnimCondition> conditions) {
 bool boolean0 = true;
