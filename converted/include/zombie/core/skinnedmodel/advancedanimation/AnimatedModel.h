...
public:
 ...
 float lightsOriginY;
 float lightsOriginZ;
 private IsoGridSquare.ResultLight[] lights = new IsoGridSquare.ResultLight[5];
 ...
 private AnimatedModel.StateInfo[] stateInfos = new AnimatedModel.StateInfo[3];
 bool bReady;
 private static ObjectPool<AnimatedModel.AnimatedModelInstanceRenderData> instDataPool = new ObjectPool<>(
 AnimatedModel.AnimatedModelInstanceRenderData::new
 );
 private AnimatedModel.UIModelCamera uiModelCamera = new AnimatedModel.UIModelCamera();
 private static AnimatedModel.WorldModelCamera worldModelCamera = new AnimatedModel.WorldModelCamera();
 ...
 void setVisual(HumanVisual _baseVisual) {
 ...
 this->modelInstance = ModelManager.instance.newInstance(model1, nullptr, this->getAnimationPlayer());
 ...
 void setLights(IsoGridSquare.ResultLight[] resultLights, float float0, float float1, float float2) {
 ...
 void setTrackTime(float _trackTime) {
 ...
 if (clothingItem0 != nullptr && clothingItem0.isReady() && !this->isItemModelHidden(this->itemVisuals, itemVisual0) {
 ...
 void addHeadHairItem(const std::string& string0, const std::string& string1, ImmutableColor immutableColor) {
 ...
 ModelInstance modelInstancex = ModelManager.instance.newAdditionalModelInstance(string0, string1, nullptr, this->modelInstance.AnimPlayer, nullptr);
 ...
 modelInstancex = ModelManager.instance.newAdditionalModelInstance(string0, string1, nullptr, this->modelInstance.AnimPlayer, string3);
 }
 ...
 void postProcessNewItemInstance(ModelInstance modelInstance1, ModelInstance modelInstance0, ImmutableColor immutableColor) {
 ...
 .addStatic(nullptr, attachedModelName0.modelName, attachedModelName0.attachmentNameSelf, attachedModelName0.attachmentNameParent);
 ...
 ModelInstance addStatic(const std::string& string1, const std::string& string4) {
 ...
 ModelInstance addStatic(const std::string& string0, const std::string& string1, const std::string& string3, const std::string& string2) {
 ...
 ModelInstance modelInstancex = ModelManager.instance.newInstance(model, nullptr, this->modelInstance.AnimPlayer);
 ...
 if (modelInstance0.model.Mesh.isReady() && modelInstance0.model.Mesh.vb != nullptr) {
 ...
 stateInfo.textureCreator = this->textureCreator != nullptr && !this->textureCreator.isRendered() ? this->textureCreator : nullptr;
 ...
 void release(ArrayList<AnimatedModel.AnimatedModelInstanceRenderData> arrayList) {
 ...
 if (animatedModelInstanceRenderData.modelInstance.getTextureInitializer() != nullptr) {
 ...
 this->bReady = true;
 ModelInstanceTextureCreator modelInstanceTextureCreator = stateInfo.textureCreator;
 if (modelInstanceTextureCreator != nullptr && !modelInstanceTextureCreator.isRendered()) {
 ...
 void DoRender(int x, int y, int w, int h, float sizeV, float animPlayerAngle) {
 GL11.glClear(256);
 ...
 void DrawChar(AnimatedModel.AnimatedModelInstanceRenderData animatedModelInstanceRenderData) {
 ...
 if (modelInstancex.tex != nullptr || modelInstancex.model.tex != nullptr) {
 GL11.glEnable(2884);
 ...
 private static class AnimatedModelInstanceRenderData {
 ModelInstance modelInstance;
 FloatBuffer matrixPalette;
 public org.joml.Matrix4f xfrm = new org.joml.Matrix4f();
 ...
 ModelInstance modelInstance;
 ModelInstanceTextureCreator textureCreator;
 ArrayList<AnimatedModel.AnimatedModelInstanceRenderData> instData = std::make_unique<ArrayList<>>();
 ArrayList<AnimatedModel.AnimatedModelInstanceRenderData> readyData = std::make_unique<ArrayList<>>();
 bool bModelsReady;
 bool bRendered;
