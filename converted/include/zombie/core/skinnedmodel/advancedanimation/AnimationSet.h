...
class AnimationSet {
public:
 protected static HashMap<String, AnimationSet> setMap = std::make_unique<HashMap<>>();
 public HashMap<String, AnimState> states = std::make_unique<HashMap<>>();
 std::string m_Name = "";
 ...
 for (auto& string0 : strings) std::string string1 = new File(string0).getName();
