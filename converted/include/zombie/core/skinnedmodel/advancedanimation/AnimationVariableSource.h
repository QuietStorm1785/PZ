...
public:
 private Map<String, IAnimationVariableSlot> m_GameVariables = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
 ...
 */
 ...
 /**
 * Returns the specified variable slot. Creates a new slot if not found. Returns NULL if key is nullptr, whitespace, or empty.
 */
 ...
 */
 void setVariable(const std::string& key, AnimationVariableSlotCallbackBool.CallbackGetStrongTyped callbackGet) {
 ...
 * Strong-typed utility function.
 */
 void setVariable(const std::string& key, AnimationVariableSlotCallbackString.CallbackGetStrongTyped callbackGet) {
 ...
 * Strong-typed utility function.
 */
 void setVariable(const std::string& key, AnimationVariableSlotCallbackFloat.CallbackGetStrongTyped callbackGet) {
 ...
 * Strong-typed utility function.
 */
 void setVariable(const std::string& key, AnimationVariableSlotCallbackInt.CallbackGetStrongTyped callbackGet) {
 ...
 */
 ...
 IAnimationVariableSlot iAnimationVariableSlot = this->getVariable(key);
 return iAnimationVariableSlot != nullptr ? iAnimationVariableSlot.getValueString() : "";
 }
 ...
 */
 ...
 IAnimationVariableSlot iAnimationVariableSlot = this->getVariable(key);
 return iAnimationVariableSlot != nullptr ? iAnimationVariableSlot.getValueFloat() : defaultVal;
 }
 ...
 */
 ...
 IAnimationVariableSlot iAnimationVariableSlot = this->getVariable(key);
 return iAnimationVariableSlot != nullptr && iAnimationVariableSlot.getValueBool();
 }
 ...
 */
 ...
 IAnimationVariableSlot iAnimationVariableSlot = this->getVariable(key);
 return iAnimationVariableSlot != nullptr ? iAnimationVariableSlot.getValueBool() : defaultVal;
 }
