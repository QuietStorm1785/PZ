...
public:
 static const PooledAnimBoneWeightArray s_empty = new PooledAnimBoneWeightArray();
 private static Pool<PooledAnimBoneWeightArray> s_pool = new Pool<>(PooledAnimBoneWeightArray::new);
