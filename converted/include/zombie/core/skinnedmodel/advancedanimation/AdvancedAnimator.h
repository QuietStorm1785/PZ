...
public
  final ArrayList<IAnimEventCallback> animCallbackHandlers =
      std::make_unique<ArrayList<>>();
  AnimLayer m_rootLayer = null;
private
  final List<AdvancedAnimator.SubLayerSlot> m_subLayers =
      std::make_unique<ArrayList<>>();
  ...
  std::string getCurrentStateName() {
    return this.m_rootLayer == nullptr ? nullptr
