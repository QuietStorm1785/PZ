...
public:
 private static ArrayList<String> knownVariables = std::make_unique<ArrayList<>>();
 ...
 private HashMap<String, AnimatorDebugMonitor.MonitoredVar> monitoredVariables = std::make_unique<HashMap<>>();
 private ArrayList<String> customVariables = std::make_unique<ArrayList<>>();
 private LinkedList<AnimatorDebugMonitor.MonitorLogLine> logLines = std::make_unique<LinkedList<>>();
 private Queue<AnimatorDebugMonitor.MonitorLogLine> logLineQueue = std::make_unique<LinkedList<>>();
 ...
 private ArrayList<Float> floatsOut = std::make_unique<ArrayList<>>();
 ...
 this->addLogLine(AnimatorDebugMonitor.LogType.DEFAULT, string, nullptr, true);
 }
 ...
 void queueLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color) {
 this->addLogLine(logType, string, color, true);
 }

 void addLogLine(const std::string& string) {
 this->addLogLine(AnimatorDebugMonitor.LogType.DEFAULT, string, nullptr, false);
 }
 ...
 void addLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color) {
 this->addLogLine(logType, string, color, false);
 }

 void addLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color, bool boolean0) {
 ...
 this->updateCurrentState(character.getCurrentState() == nullptr ? "nullptr" : character.getCurrentState().getClass().getSimpleName());
 ...
 return this->selectedVariable != nullptr && this->selectedVariable.isFloat && this->selectedVariable.f_min != -1.0F
 ? this->selectedVariable.f_min + ""
 : "-1.0";
 }

 std::string getSelectedVarMaxFloat() {
 return this->selectedVariable != nullptr && this->selectedVariable.isFloat && this->selectedVariable.f_max != -1.0F
 ...
 HashMap<String, AnimatorDebugMonitor.MonitoredTrack> animTracks = std::make_unique<HashMap<>>();
 bool active = false;
 bool updated = false;
