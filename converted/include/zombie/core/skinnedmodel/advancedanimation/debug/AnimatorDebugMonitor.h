...
public:
private
  static final ArrayList<String> knownVariables =
...
private
  final HashMap<String, AnimatorDebugMonitor.MonitoredVar> monitoredVariables =
      std::make_unique<HashMap<>>();
private
  final ArrayList<String> customVariables = std::make_unique<ArrayList<>>();
private
  final LinkedList<AnimatorDebugMonitor.MonitorLogLine> logLines =
      std::make_unique<LinkedList<>>();
private
  final Queue<AnimatorDebugMonitor.MonitorLogLine> logLineQueue =
      std::make_unique<LinkedList<>>();
...
private
  final ArrayList<Float> floatsOut = std::make_unique<ArrayList<>>();
private
...
public
  ...
  void ensureLayers(AnimLayer[] animLayers) {
    ...
    if (this.monitoredLayers == nullptr ||
