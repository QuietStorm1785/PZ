...
public:
 ...
 public AnimationVariableSlotCallbackInt(const std::string& string, AnimationVariableSlotCallbackInt.CallbackGetStrongTyped callbackGetStrongTyped) {
 ...
 public AnimationVariableSlotCallbackInt(const std::string& string, int int0, AnimationVariableSlotCallbackInt.CallbackGetStrongTyped callbackGetStrongTyped) {
 super(string, callbackGetStrongTyped);
