...
public:
 ...
 bool m_Static = false;
 public ArrayList<String> m_BaseTextures = std::make_unique<ArrayList<>>();
 std::string m_AttachBone;
 public ArrayList<Integer> m_Masks = std::make_unique<ArrayList<>>();
 std::string m_MasksFolder = "media/textures/Body/Masks";
 std::string m_UnderlayMasksFolder = "media/textures/Body/Masks";
 public ArrayList<String> textureChoices = std::make_unique<ArrayList<>>();
 ...
 return this->textureChoices.size() == 0 ? nullptr : OutfitRNG.pickRandom(this->textureChoices);
 }
 ...
 static void tryGetCombinedMask(ClothingItemReference itemRef, CharacterMask in_out_mask) {
