...
public:
 ...
 bool m_Top = true;
 bool m_Pants = true;
 public ArrayList<String> m_TopTextures = std::make_unique<ArrayList<>>();
 public ArrayList<String> m_PantsTextures = std::make_unique<ArrayList<>>();
 public ArrayList<ClothingItemReference> m_items = std::make_unique<ArrayList<>>();
 ...
 public Outfit.RandomData RandomData = new Outfit.RandomData();
 ...
 void AddItem(ClothingItemReference item) {
 ...
 throw RuntimeException("Outfit clone failed.", cloneNotSupportedException);
 }
 }
