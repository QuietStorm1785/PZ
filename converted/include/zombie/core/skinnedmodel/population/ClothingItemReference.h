...
public:
 ...
 std::string itemGUID;
 public ArrayList<ClothingItemReference> subItems = std::make_unique<ArrayList<>>();
 bool bRandomized = false;
 bool m_Immutable = false;
 public ClothingItemReference.RandomData RandomData = new ClothingItemReference.RandomData();
 ...
 throw RuntimeException("ClothingItemReference clone failed.", cloneNotSupportedException);
 }
 }
