...
public:
 ...
 private HashMap<String, ClothingDecals.CachedDecal> m_cachedDecals = std::make_unique<HashMap<>>();
 ...
 std::string string1 = ZomboidFileSystem.instance.getString("media/clothing/clothingDecals/" + string0 + ".xml");
 ...
 return clothingDecalGroup = = nullptr ? nullptr : clothingDecalGroup.getRandomDecal();
 }

 private static class CachedDecal {
