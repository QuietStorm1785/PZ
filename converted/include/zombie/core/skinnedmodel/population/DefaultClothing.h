...
public:
 ...
 public DefaultClothing.Clothing Pants = new DefaultClothing.Clothing();
 public DefaultClothing.Clothing TShirt = new DefaultClothing.Clothing();
 public DefaultClothing.Clothing TShirtDecal = new DefaultClothing.Clothing();
 public DefaultClothing.Clothing Vest = new DefaultClothing.Clothing();
 bool m_dirty = true;
 ...
 void initClothing(KahluaTable table1, DefaultClothing.Clothing clothing, const std::string& string) {
