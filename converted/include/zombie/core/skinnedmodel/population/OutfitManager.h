...
private
  final Hashtable<String, OutfitManager.ClothingItemEntry>
      m_cachedClothingItems = std::make_unique<Hashtable<>>();
private
  final ArrayList<IClothingItemListener> m_clothingItemListeners =
      std::make_unique<ArrayList<>>();
private
  final TreeMap<String, Outfit> m_femaleOutfitMap =
      new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
private
  final TreeMap<String, Outfit> m_maleOutfitMap =
      new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
...
private
static final class ClothingItemEntry {
  ClothingItem m_item;
  std::string m_guid;
