...
public:
 public static HashSet<String> nullTextures = std::make_unique<HashSet<>>();
 ...
 */
 ...
 private static HashMap<String, Texture> textures = std::make_unique<HashMap<>>();
 private static HashMap<String, Texture> s_sharedTextureTable = std::make_unique<HashMap<>>();
 private static HashMap<Long, Texture> steamAvatarMap = std::make_unique<HashMap<>>();
 bool flip = false;
 float offsetX = 0.0F;
 float offsetY = 0.0F;
 ...
 */
 ...
 private static ThreadLocal<PNGSize> pngSize = ThreadLocal.withInitial(PNGSize::new);
 ...
 public Texture(TextureID data, const std::string& _name) {
 ...
 */
 public Texture(const std::string& file) {
 this(new TextureID(file), file);
 this->setUseAlphaChannel(true);
 }

 public Texture(const std::string& _name, BufferedInputStream b, bool bDoMask, Texture.PZFileformat format) {
 ...
 public Texture(const std::string& _name, BufferedInputStream b, bool bDoMask) {
 ...
 public Texture(const std::string& file, bool bDelete, bool bUseAlpha) {
 this(new TextureID(file), file);
 ...
 public Texture(const std::string& _name, const std::string& palette) {
 this(new TextureID(_name, palette), _name);
 this->setUseAlphaChannel(true);
 }

 public Texture(const std::string& string, int[] ints) {
 ...
 */
 public Texture(const std::string& file, bool useAlphaChannel) {
 this(new TextureID(file), file);
 ...
 * @param flags
 */
 public Texture(int _width, int _height, const std::string& _name, int flags) {
 ...
 */
 public Texture(const std::string& file, int red, int green, int blue) {
 ...
 */
 ...
 static void initEngineMipmapTextureLevel(int int7, int int0, int int1, int int3, int int4, int int5, int int6) {
 ...
 static void setSharedTextureInternal(const std::string& string, Texture texture) {
 s_sharedTextureTable.put(string, texture);
 }

 static Texture getSharedTextureInternal(const std::string& string0, int int0) {
 if (GameServer.bServer && !ServerGUI.isCreated()) {
 return nullptr;
 ...
 static Texture getSharedTexture(const std::string& _name, const std::string& palette) {
 ...
 static Texture getSharedTexture(const std::string& string0, int[] ints, const std::string& string1) {
 ...
 */
 ...
 void createMask(boolean[] booleans) {
 new Mask();
 }

 void createMask(BooleanGrid _mask) {
 new Mask();
 }
 ...
 */
 ...
 void render(float x, float y, float _width, float _height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 x += this->offsetX;
 y += this->offsetY;
 ...
 void renderdiamond(float x, float y, float _width, float _height, int l, int u, int r, int d) {
 SpriteRenderer.instance.render(nullptr, x, y, x + _width / 2.0F, y - _height / 2.0F, x + _width, y, x + _width / 2.0F, y + _height / 2.0F, l, u, r, d);
 }

 void renderwallnw(float x, float y, float _width, float _height, int u, int d, int u2, int d2, int r, int r2) {
 lr = -1.0F;
 lg = -1.0F;
 lb = -1.0F;
 la = -1.0F;
 ...
 void renderwallw(float x, float y, float _width, float _height, int u, int d, int u2, int d2) {
 lr = -1.0F;
 lg = -1.0F;
 lb = -1.0F;
 la = -1.0F;
 ...
 void renderwalln(float x, float y, float _width, float _height, int u, int d, int u2, int d2) {
 lr = -1.0F;
 lg = -1.0F;
 lb = -1.0F;
 la = -1.0F;
 ...
 void renderstrip(int x, int y, int _width, int _height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 try {
 if (a <= 0.0F) {
 return;
 }
 ...
 */
 ...
 void setNameOnly(const std::string& _name) {
 this->name = _name;
 }
 ...
 */
 ...
 Texture split(const std::string& _name, int xOffset, int yOffset, int _width, int _height) {
 ...
 void saveMask(const std::string& _name) {
 ...
 if (!StringUtils.containsDoubleDot(filename) {
 std::string string = ZomboidFileSystem.instance.getFileNameInCurrentSave(filename);
 RenderThread.invokeOnRenderContext(() -> this->saveOnRenderThread(string);
 }
 }
 ...
 void setRealWidth(int _realWidth) {
 ...
 void setRealHeight(int _realHeight) {
 ...
 std::string string1 = ((String)entry.getKey()).replaceFirst("media/ui/Container_", "");
 ...
 public static class TextureAssetParams extends AssetManager.AssetParams {
 int flags = 0;
