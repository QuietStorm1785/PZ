...
public:
 ...
 public PNGDecoder(InputStream inputStream, bool boolean0) {
 ...
 void decodeFlipped(ByteBuffer byteBuffer, int int0, PNGDecoder.Format format) {
 if (int0 <= 0) {
 ...
 private Format(int int1, bool boolean0) {
