...
public:
  ...
  int GL_FRAMEBUFFER_UNDEFINED() { return 0; }

  int GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT() { return 36054; }

  int GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT() { return 36055; }

  int GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS() { return 36057; }

  int GL_FRAMEBUFFER_INCOMPLETE_FORMATS() { return 36058; }
  ...
  int GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE() { return 0; }
  ...
  void glFramebufferTexture2D(int int0, int int1, int int2, int int3,
                              int int4) {
    EXTFramebufferObject.glFramebufferTexture2DEXT(int0, int1, int2, int3,
                                                   int4);
  }
