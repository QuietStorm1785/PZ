...
public:
public
  TextureDraw.Type type = TextureDraw.Type.glDraw;
  int a = 0;
  int b = 0;
  float f1 = 0.0F;
public
  ...
  bool flipped = false;
public
  TextureDraw.GenericDrawer drawer;
  ...
  static void glBlendFuncSeparate(TextureDraw texd, int _a, int _b, int _c,
                                  int _d) {
  ...
  static void glDoStartFrame(TextureDraw texd, int w, int h, float zoom,
                             int player) {
  ...
  static void drawSkyBox(TextureDraw texd, Shader shader, int userId, int apiId,
                         int bufferId) {
  ...
  static void drawWater(TextureDraw texd, Shader shader, int userId, int apiId,
                        bool bShore) {
  ...
  static void drawPuddles(TextureDraw texd, Shader shader, int userId,
                          int apiId, int z) {
  ...
  static void ShaderUpdate1i(TextureDraw texd, int shaderID, int uniform,
                             int uniformValue) {
  ...
  static void ShaderUpdate1f(TextureDraw texd, int shaderID, int uniform,
                             float uniformValue) {
    texd.type = TextureDraw.Type.ShaderUpdate;
    texd.a = shaderID;
    texd.b = uniform;
  ...
  static void ShaderUpdate2f(TextureDraw texd, int shaderID, int uniform,
  ...
  static void ShaderUpdate3f(TextureDraw texd, int shaderID, int uniform,
  ...
  static void ShaderUpdate4f(TextureDraw texd, int shaderID, int uniform,
                             float value1, float value2, float value3,
                             float value4) {
    texd.type = TextureDraw.Type.ShaderUpdate;
    texd.a = shaderID;
  ...
  void run() {
    ...
    case ShaderUpdate:
      ...
      if (this.c == 4) {
        ARBShaderObjects.glUniform4fARB(this.b, this.u0, this.u1, this.u2,
                                        this.u3);
      }
    ...
    case DrawSkyBox:
      try {
        ModelManager.instance.RenderSkyBox(this, this.a, this.b, this.c,
                                           this.d);
    ...
    case glClear:
      ...
      break;
    case glClearColor:
      GL11.glClearColor(this.col0 / 255.0F, this.col1 / 255.0F,
                        this.col2 / 255.0F, this.col3 / 255.0F);
      break;
    case glBlendFunc:
    ...
    case glBlendFuncSeparate:
      ...
      break;
    case glColorMask:
      IndieGL.glColorMaskA(this.a == 1, this.b == 1, this.c == 1,
                           this.x0 == 1.0F);
      break;
    ...
    case glDoStartFrameFx:
      Core.getInstance().DoStartFrameStuffSmartTextureFx(this.a, this.b,
                                                         this.c);
      break;
    case glStencilFunc:
    ...
    case glBuffer:
      if (Core.getInstance().supportsFBO()) {
        if (this.a == 1) {
          SpriteRenderer.instance.getRenderingState().fbo.startDrawing(false,
                                                                       false);
        } else if (this.a == 2) {
  ...
  std::string toString() {
    return this.getClass().getSimpleName() + "{ " + this.type +
           ", a:" + this.a + ", b:" + this.b + ", f1:" + this.f1 + ", vars:" +
           (this.vars != nullptr
                ? PZArrayUtil.arrayToString(this.vars, "{", "}", ", ")
                : "nullptr") +
           ", c:" + this.c + ", d:" + this.d + ", col0:" + this.col0 +
           ", col1:" + this.col1 + ", col2:" + this.col2 +
           ", col3:" + this.col3 + ", x0:" + this.x0 + ", x1:" + this.x1 +
           ", x2:" + this.x2 + ", x3:" + this.x3 + ", x0:" + this.x0 +
           ", x1:" + this.x1 + ", x2:" + this.x2 + ", x3:" + this.x3 +
           ", y0:" + this.y0 + ", y1:" + this.y1 + ", y2:" + this.y2 +
           ", y3:" + this.y3 + ", u0:" + this.u0 + ", u1:" + this.u1 +
           ", u2:" + this.u2 + ", u3:" + this.u3 + ", v0:" + this.v0 +
           ", v1:" + this.v1 + ", v2:" + this.v2 + ", v3:" + this.v3 +
           ", tex:" + this.tex + ", tex1:" + this.tex1 +
           ", useAttribArray:" + this.useAttribArray +
           ", tex1_u0:" + this.tex1_u0 + ", tex1_u1:" + this.tex1_u1 +
           ", tex1_u2:" + this.tex1_u2 + ", tex1_u3:" + this.tex1_u3 +
           ", tex1_u0:" + this.tex1_u0 + ", tex1_u1:" + this.tex1_u1 +
           ", tex1_u2:" + this.tex1_u2 + ", tex1_u3:" + this.tex1_u3 +
           ", tex1_col0:" + this.tex1_col0 + ", tex1_col1:" + this.tex1_col1 +
           ", tex1_col2:" + this.tex1_col2 + ", tex1_col3:" + this.tex1_col3 +
           ", bSingleCol:" + this.bSingleCol + " }";
  }

public
  static TextureDraw Create(TextureDraw texd, Texture _tex, float x, float y,
                            float width, float height, float r, float g,
                            float _b, float _a,
                            Consumer<TextureDraw> texdModifier) {
    int int0 = Color.colorToABGR(r, g, _b, _a);
    Create(texd, _tex, x, y, x + width, y, x + width, y + height, x, y + height,
           int0, int0, int0, int0, texdModifier);
    return texd;
  }

public
  static TextureDraw Create(TextureDraw texd, Texture _tex,
                            SpriteRenderer.WallShaderTexRender wallSection,
                            float x, float y, float width, float height,
                            float r, float g, float _b, float _a,
                            Consumer<TextureDraw> texdModifier) {
    int int0 = Color.colorToABGR(r, g, _b, _a);
    float float0 = 0.0F;
    float float1 = 0.0F;
    ...
    Create(texd, _tex, float8, float9, float10, float11, float12, float13,
           float14, float15, int0, int0, int0, int0, float0, float1, float2,
...
public
  static TextureDraw Create(TextureDraw texd, Texture _tex, float x, float y,
                            float width, float height, float r, float g,
                            float _b, float _a, float _u1, float _v1, float _u2,
                            float _v2, float _u3, float _v3, float u4, float v4,
                            Consumer<TextureDraw> texdModifier) {
    int int0 = Color.colorToABGR(r, g, _b, _a);
    Create(texd, _tex, x, y, x + width, y, x + width, y + height, x, y + height,
           int0, int0, int0, int0, _u1, _v1, _u2, _v2, _u3, _v3, u4, v4,
           texdModifier);
    return texd;
  }

public
  static void Create(TextureDraw texd, Texture _tex, float _x1, float _y1,
                     float _x2, float _y2, float _x3, float _y3, float x4,
                     float y4, float r1, float g1, float b1, float a1, float r2,
                     float g2, float b2, float a2, float r3, float g3, float b3,
                     float a3, float r4, float g4, float b4, float a4,
                     Consumer<TextureDraw> texdModifier) {
    ...
    Create(texd, _tex, _x1, _y1, _x2, _y2, _x3, _y3, x4, y4, int0, int1, int2,
           int3, texdModifier);
  }
...
public
  static void Create(TextureDraw texd, Texture _tex, float _x1, float _y1,
                     float _x2, float _y2, float _x3, float _y3, float x4,
                     float y4, float r1, float g1, float b1, float a1) {
    int int0 = Color.colorToABGR(r1, g1, b1, a1);
    Create(texd, _tex, _x1, _y1, _x2, _y2, _x3, _y3, x4, y4, int0, int0, int0,
           int0, nullptr);
  }
...
public
  static void Create(TextureDraw texd, Texture _tex, float _x1, float _y1,
    ...
    Create(texd, _tex, _x1, _y1, _x2, _y2, _x3, _y3, x4, y4, c1, c2, c3, c4,
           nullptr);
  }

public
  static TextureDraw Create(TextureDraw texd, Texture _tex, float _x1,
                            float _y1, float _x2, float _y2, float _x3,
                            float _y3, float x4, float y4, int c1, int c2,
                            int c3, int c4,
                            Consumer<TextureDraw> texdModifier) {
    float float0 = 0.0F;
    float float1 = 0.0F;
    ...
    return Create(texd, _tex, _x1, _y1, _x2, _y2, _x3, _y3, x4, y4, c1, c2, c3,
                  c4, float0, float1, float2, float3, float4, float5, float6,
                  float7, texdModifier);
  }

public
  static TextureDraw Create(TextureDraw texd, Texture _tex, float _x0,
                            float _y0, float _x1, float _y1, float _x2,
                            float _y2, float _x3, float _y3, int c0, int c1,
                            int c2, int c3, float _u0, float _v0, float _u1,
                            float _v1, float _u2, float _v2, float _u3,
                            float _v3, Consumer<TextureDraw> texdModifier) {
    ...
    if (texdModifier != nullptr) {
      ...
      texd.bSingleCol = texd.col0 == texd.col1 && texd.col0 == texd.col2 &&
                        texd.col0 == texd.col3;
    }
  ...
  void reset() {
    ...
    this.x0 = this.x1 = this.x2 = this.x3 = this.y0 = this.y1 = this.y2 =
        this.y3 = -1.0F;
    this.drawer = nullptr;
  }
  ...
  static void glViewport(TextureDraw textureDraw, int x, int y, int width,
                         int height) {
...
public
  abstract static class GenericDrawer {
  public
