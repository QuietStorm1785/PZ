 ...
 */
 ...
 private static ThreadLocal<ImageData.L_generateMipMaps> TL_generateMipMaps = ThreadLocal.withInitial(ImageData.L_generateMipMaps::new);
 private static ThreadLocal<ImageData.L_performAlphaPadding> TL_performAlphaPadding = ThreadLocal.withInitial(ImageData.L_performAlphaPadding::new);
 ...
 public ImageData(const std::string& path) {
 ...
 */
 ...
 public ImageData(BufferedInputStream b, bool bDoMask, Texture.PZFileformat format) {
 ...
 public ImageData(InputStream b, bool bDoMask) {
 void* object = nullptr;
 ...
 */
 ...
 int[] ints = rasterData.getPixels(0, 0, this->width, this->height, (int[])nullptr);
 ByteBuffer byteBuffer = this->data.getBuffer();
 byteBuffer.rewind();
 int int0 = 0;
 ...
 void scaleMipLevelMaxAlpha(MipMapLevel mipMapLevel1, MipMapLevel mipMapLevel0, int int6) {
 ...
 void scaleMipLevelAverage(MipMapLevel mipMapLevel1, MipMapLevel mipMapLevel0, int int7) {
 ImageData.L_generateMipMaps l_generateMipMaps = TL_generateMipMaps.get();
 ByteBuffer byteBuffer0 = mipMapLevel0.getBuffer();
 byteBuffer0.rewind();
 int int0 = mipMapLevel1.width;
 ...
 int sampleNeighborPixelDiscard(ByteBuffer byteBuffer, int int3, int int1, int int2, int int0, int[] ints0, int[] ints1) {
 ...
 static int getPixelDiscard(ByteBuffer byteBuffer, int int3, int int1, int int2, int int0, int[] ints) {
 if (int2 >= 0 && int2 < int3 && int0 >= 0 && int0 < int1) {
 int int4 = (int2 + int0 * int3) * 4;
 ...
 static void setPixel(ByteBuffer byteBuffer, int int3, int var2, int int1, int int2, int[] ints) {
 ...
 private static class L_generateMipMaps {
 int[] pixelBytes = new int[4];
 int[] originalPixel = new int[4];
 int[] resultPixelBytes = new int[4];
 }

 static class L_performAlphaPadding {
 int[] pixelRGBA = new int[4];
 int[] newPixelRGBA = new int[4];
 int[] pixelRGBA_neighbor = new int[4];
 }
}
} // namespace textures
} // namespace core
