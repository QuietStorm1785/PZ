...
public:
 ...
 public static String[] MaskFiles = new String[]{
 "BloodMaskHandL",
 "BloodMaskHandR",
 "BloodMaskLArmL",
 "BloodMaskLArmR",
 ...
 public static String[] BasicPatchesMaskFiles = new String[]{
 ...
 public static String[] DenimPatchesMaskFiles = new String[]{
 ...
 public static String[] LeatherPatchesMaskFiles = new String[]{
 ...
 std::string string = "media/textures/BloodTextures/" + MaskFiles[bodyPart.index()] + ".png";
 ...
 float addBlood(BloodBodyPartType bodyPart, float intensity, IsoGameCharacter chr) {
 int int0 = DecalOverlayCategory + bodyPart.index();
 TextureCombinerCommand textureCombinerCommand = this->getFirstFromCategory(int0);
 ...
 float addDirt(BloodBodyPartType bodyPart, float intensity, IsoGameCharacter chr) {
 int int0 = DirtOverlayCategory + bodyPart.index();
 TextureCombinerCommand textureCombinerCommand = this->getFirstFromCategory(int0);
 if (bodyPart == BloodBodyPartType.Head && chr != nullptr) {
 if (chr.hair != nullptr) {
