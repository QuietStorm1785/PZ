...
public:
 ...
 public ItemSmartTexture(const std::string& tex) {
 if (tex != nullptr) {
 this->add(tex);
 this->m_texName = tex;
 }
 ...
 public ItemSmartTexture(const std::string& tex, float hue) {
 ...
 std::string string = "media/textures/patches/" + CharacterSmartTexture.DenimPatchesMaskFiles[bodyPart.index()] + ".png";
 ...
 std::string string = "media/textures/patches/" + CharacterSmartTexture.LeatherPatchesMaskFiles[bodyPart.index()] + ".png";
 int int0 = CharacterSmartTexture.DecalOverlayCategory + bodyPart.index();
 this->addOverlayPatches(string, "media/textures/patches/patchesmask.png", int0);
 }
 }
 ...
 std::string string = "media/textures/patches/" + CharacterSmartTexture.BasicPatchesMaskFiles[bodyPart.index()] + ".png";
 int int0 = CharacterSmartTexture.DecalOverlayCategory + bodyPart.index();
 this->addOverlayPatches(string, "media/textures/patches/patchesmask.png", int0);
 }
 }

 void setBlood(const std::string& tex, BloodBodyPartType bodyPart, float intensity) {
 std::string string = "media/textures/BloodTextures/" + CharacterSmartTexture.MaskFiles[bodyPart.index()] + ".png";
 int int0 = CharacterSmartTexture.DecalOverlayCategory + bodyPart.index();
 this->setBlood(tex, string, intensity, int0);
 }

 void setBlood(const std::string& tex, const std::string& mask, float intensity, int category) {
 ...
 float addBlood(const std::string& tex, BloodBodyPartType bodyPart, float intensity) {
 std::string string = "media/textures/BloodTextures/" + CharacterSmartTexture.MaskFiles[bodyPart.index()] + ".png";
 int int0 = CharacterSmartTexture.DecalOverlayCategory + bodyPart.index();
 return this->addBlood(tex, string, intensity, int0);
 }

 float addDirt(const std::string& tex, BloodBodyPartType bodyPart, float intensity) {
 std::string string = "media/textures/BloodTextures/" + CharacterSmartTexture.MaskFiles[bodyPart.index()] + ".png";
