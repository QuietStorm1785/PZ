...
public:
  ...
  void set(IsoGameCharacter character1) {
    ...
    this.characterFlags =
        (short)(this.characterFlags | (short)(character1.isDead() ? 1 : 0));
    this.characterFlags = (short)(this.characterFlags |
                                  (short)(character1.isCloseKilled() ? 2 : 0));
    this.characterFlags =
        (short)(this.characterFlags |
                (short)(character1.isHitFromBehind() ? 4 : 0));
    this.characterFlags = (short)(this.characterFlags |
                                  (short)(character1.isFallOnFront() ? 8 : 0));
    this.characterFlags = (short)(this.characterFlags |
                                  (short)(character1.isKnockedDown() ? 16 : 0));
    this.characterFlags =
        (short)(this.characterFlags | (short)(character1.isOnFloor() ? 32 : 0));
    ...
    this.characterReaction =
        Optional.ofNullable(character1.getHitReaction()).orElse("");
    this.playerReaction =
        Optional.ofNullable(character1.getVariableString("PlayerHitReaction"))
            .orElse("");
    this.zombieReaction =
        Optional.ofNullable(character1.getVariableString("ZombieHitReaction"))
            .orElse("");
  }
  ...
  std::string getDescription() {
    return super.getDescription() + "\n\tCharacter [ hit-reactions=( \"c=\"" +
           this.characterReaction + "\" ; p=\"" + this.playerReaction +
           "\" ; z=\"" + this.zombieReaction + "\" ) | " +
           this.getFlagsDescription() + " | pos=( " + this.positionX + " ; " +
           this.positionY + " ; " + this.positionZ + " ) | dir=( " +
           this.directionX + " ; " + this.directionY + " ) | health=" +
  ...
  std::string getFlagsDescription() {
    return " Flags [ isDead=" + ((this.characterFlags & 1) != 0) +
           " | isKnockedDown=" + ((this.characterFlags & 16) != 0) +
           " | isCloseKilled=" + ((this.characterFlags & 2) != 0) +
           " | isHitFromBehind=" + ((this.characterFlags & 4) != 0) +
           " | isFallOnFront=" + ((this.characterFlags & 8) != 0) +
           " | isOnFloor=" + ((this.characterFlags & 32) != 0) + " ]";
  }
  ...
  void process() {
    ...
    if (GameServer.bServer && (this.characterFlags & 32) == 0 &&
  ...
  float getX() { return this.positionX; }

  float getY() { return this.positionY; }
