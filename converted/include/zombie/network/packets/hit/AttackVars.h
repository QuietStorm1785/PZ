...
public:
 ...
 int recoilDelay;
 public ArrayList<HitInfo> targetsStanding = std::make_unique<ArrayList<>>();
 public ArrayList<HitInfo> targetsProne = std::make_unique<ArrayList<>>();
 ...
 return !this->isBareHeadsWeapon && livingCharacter.getUseHandWeapon() != nullptr ? livingCharacter.getUseHandWeapon() : livingCharacter.bareHands;
 }
