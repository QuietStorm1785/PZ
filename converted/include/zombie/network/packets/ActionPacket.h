...
public:
 ...
 std::string action;
 private HashMap<String, String> variables = std::make_unique<HashMap<>>();
 ...
 this->primary = baseAction.getPrimaryHandItem() == nullptr ? baseAction.getPrimaryHandMdl() : baseAction.getPrimaryHandItem().getStaticModel();
 this->secondary = baseAction.getSecondaryHandItem() == nullptr ? baseAction.getSecondaryHandMdl() : baseAction.getSecondaryHandItem().getStaticModel();
