...
public:
 ...
 PlayerItem bandage = new PlayerItem();

 void set(IsoGameCharacter character0, IsoGameCharacter character1, BodyPart bodyPartx, InventoryItem item) {
