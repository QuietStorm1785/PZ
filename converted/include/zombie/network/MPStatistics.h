...
public:
 ...
 private static ArrayList<Long> serverHandledPingHistory = std::make_unique<ArrayList<>>();
 private static HashSet<Long> serverHandledLossPingHistory = std::make_unique<HashSet<>>();
 ...
 static void countChunkRequests(int int0, int int1, int int2, int int3, int int4) {
 ...
 static void setVOIPSource(VoiceManagerData.VoiceDataSource voiceDataSource, int int0) {
