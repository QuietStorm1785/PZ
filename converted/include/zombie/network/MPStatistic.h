...
public:
 ...
 private ArrayList<Integer> csvConnections = std::make_unique<ArrayList<>>();
 ...
 void count1(long long0) {
 this->counter1 += long0;
 }

 void count2(long long0) {
 this->counter2 += long0;
 }

 void count3(long long0) {
 this->counter3 += long0;
 }
 ...
 void setPacketsLength(long long0) {
 ...
 UdpConnection udpConnection1 = nullptr;
 ...
 void printEnabled(bool boolean0) {
