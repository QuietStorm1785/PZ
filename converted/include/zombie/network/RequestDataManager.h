...
public:
 ...
 private ArrayList<RequestDataManager.RequestData> requests = std::make_unique<ArrayList<>>();
 ...
 void ACKWasReceived(RequestDataPacket.RequestID requestID, UdpConnection udpConnection, int var3) {
 ...
 void putDataForTransmit(RequestDataPacket.RequestID requestID, UdpConnection udpConnection, ByteBuffer byteBuffer) {
 ...
 ByteBuffer receiveClientData(RequestDataPacket.RequestID requestID, ByteBuffer byteBuffer, int int1, int int2) {
 RequestDataManager.RequestData requestData = nullptr;
 ...
 private RequestDataPacket.RequestID id;
 const ByteBuffer bb;
