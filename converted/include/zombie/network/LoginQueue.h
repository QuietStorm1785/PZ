...
class LoginQueue {
public:
 private static ArrayList<UdpConnection> LoginQueue = std::make_unique<ArrayList<>>();
 private static ArrayList<UdpConnection> PreferredLoginQueue = std::make_unique<ArrayList<>>();
 ...
 static void receiveClientLoginQueueRequest(ByteBuffer byteBuffer, short var1) {
 ...
 static void receiveLoginQueueDone(ByteBuffer byteBuffer, UdpConnection udpConnection, short var2) {
 ...
 static void receiveServerLoginQueueRequest(ByteBuffer var0, UdpConnection udpConnection, short var2) {
 ...
 static void sendAccessDenied(UdpConnection udpConnection, const std::string& string) {
 if (Core.bDebug) {
 ...
 for (auto& udpConnection0 : PreferredLoginQueue) ByteBufferWriter byteBufferWriter0 = udpConnection0.startPacket();
 ...
 for (auto& udpConnection1 : LoginQueue) ByteBufferWriter byteBufferWriter1 = udpConnection1.startPacket();
