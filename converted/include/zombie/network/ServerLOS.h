...
public:
 ...
 private ArrayList<ServerLOS.PlayerData> playersMain = std::make_unique<ArrayList<>>();
 private ArrayList<ServerLOS.PlayerData> playersLOS = std::make_unique<ArrayList<>>();
