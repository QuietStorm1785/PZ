...
public:
 ...
 for (auto& long0 : arrayList0) GameServerWorkshopItems.WorkshopItem workshopItem0 = new GameServerWorkshopItems.WorkshopItem(long0);
 ...
 static bool QueryItemDetails(ArrayList<GameServerWorkshopItems.WorkshopItem> arrayList) {
