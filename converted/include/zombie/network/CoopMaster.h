...
public:
 ...
 private List<CoopMaster.Pair<ICoopServerMessageListener, CoopMaster.ListenerOptions>> listeners;
 ...
 void launchServer(const std::string& string0, const std::string& string1, int int0) {
 this->launchServer(string0, string1, int0, false);
 }

 void softreset(const std::string& string0, const std::string& string1, int int0) {
 this->launchServer(string0, string1, int0, true);
 }

 void launchServer(const std::string& string3, const std::string& string1, int int0, bool boolean0) {
 std::string string0 = Paths.get(System.getProperty("java.home"), "bin", "java").toAbsolutePath().toString();
 ...
 for (auto& string : list) if ("-XX:+UseZGC" == string) {
 boolean0 = true;
 }
 ...
 void handleMessage(const std::string& string0, const std::string& string1, const std::string& string2) {
 ...
 void addListener(ICoopServerMessageListener iCoopServerMessageListener, CoopMaster.ListenerOptions listenerOptions) {
 ...
 void removeListener(ICoopServerMessageListener iCoopServerMessageListener) {
 synchronized (this->listeners) {
 int int0 = 0;
 ...
 void invokeListeners(const std::string& string0, const std::string& string1, const std::string& string2) {
 synchronized (this->listeners) {
 ...
 public ListenerOptions(const std::string& string0, const std::string& string1, bool boolean0) {
 this->tag = string0;
 this->cookie = string1;
 this->autoRemove = boolean0;
 }

 public ListenerOptions(const std::string& string0, const std::string& string1) {
 this(string0, string1, false);
 }

 public ListenerOptions(const std::string& string) {
