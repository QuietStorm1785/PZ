...
public:
 static const DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
 ...
 ResultSet resultSet1 = databaseMetaData.getColumns(nullptr, nullptr, string1, nullptr);
 ...
 std::string changeUsername(const std::string& string0, const std::string& string2) {
 PreparedStatement preparedStatement = this->conn.prepareStatement("SELECT * FROM whitelist WHERE username = ? AND world = ?");
 ...
 void updateDisplayName(const std::string& string0, const std::string& string1) {
 try {
 PreparedStatement preparedStatement = this->conn.prepareStatement("SELECT * FROM whitelist WHERE username = ? AND world = ?");
 preparedStatement.setString(1, string0);
 preparedStatement.setString(2, Core.GameSaveWorld);
 ...
 void removeUserLog(const std::string& string0, const std::string& string1, const std::string& string2) {
 try {
 ...
 DatabaseMetaData databaseMetaData = this->conn.getMetaData();
 ResultSet resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "admin");
 ...
 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "moderator");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'moderator' BOOLEAN NULL DEFAULT false");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "banned");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'banned' BOOLEAN NULL DEFAULT false");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "priority");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'priority' BOOLEAN NULL DEFAULT false");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "lastConnection");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'lastConnection' TEXT NULL");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "encryptedPwd");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'encryptedPwd' BOOLEAN NULL DEFAULT false");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "pwdEncryptType");
 if (!resultSet0.next()) {
 ...
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "steamid");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'steamid' TEXT NULL");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "ownerid");
 if (!resultSet0.next()) {
 ...
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "accesslevel");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'accesslevel' TEXT NULL");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "transactionID");
 if (!resultSet0.next()) {
 statement1.executeUpdate("ALTER TABLE 'whitelist' ADD 'transactionID' INTEGER NULL");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "displayName");
 if (!resultSet0.next()) {
 ...
 resultSet0 = databaseMetaData.getTables(nullptr, nullptr, "bannedip", nullptr);
 if (!resultSet0.next()) {
 statement1.executeUpdate("CREATE TABLE [bannedip] ([ip] TEXT NOT NULL,[username] TEXT NULL, [reason] TEXT NULL)");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getTables(nullptr, nullptr, "bannedid", nullptr);
 if (!resultSet0.next()) {
 statement1.executeUpdate("CREATE TABLE [bannedid] ([steamid] TEXT NOT NULL, [reason] TEXT NULL)");
 }

 resultSet0.close();
 resultSet0 = databaseMetaData.getTables(nullptr, nullptr, "userlog", nullptr);
 if (!resultSet0.next()) {
 statement1.executeUpdate(
 ...
 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "userlog", "lastUpdate");
 if (!resultSet0.next()) {
 ...
 resultSet0.close();
 resultSet0 = databaseMetaData.getColumns(nullptr, nullptr, "whitelist", "admin");
 if (resultSet0.next()) {
 resultSet0.close();
 ...
 resultSet0 = databaseMetaData.getTables(nullptr, nullptr, "tickets", nullptr);
 if (!resultSet0.next()) {
 statement1.executeUpdate(
 ...
 std::string string2 = PZcrypt.hash(encrypt(this->CommandLineAdminPassword);
 ...
 && (resultSet1.getString("encryptedPwd") == "false") || resultSet1.getString("encryptedPwd") == "N"))) {
 ...
 if (!isNullOrEmpty(resultSet1.getString("password")) && !resultSet1.getString("password") == string2) {
 logonResult.bAuthorized = false;
 ...
 std::string changePwd(const std::string& string0, const std::string& string1, const std::string& string2) {
 ...
 std::string setAccessLevel(const std::string& string1, const std::string& string0) {
 ...
 void addUserlog(const std::string& string1, Userlog.UserlogType userlogType, const std::string& string2, const std::string& string3, int int0) {
 try {
 bool boolean0 = true;
 ...
 preparedStatement0.close();
 if (string2 != nullptr && !string2.empty()) {
 ...
 std::string banIp(const std::string& string0, const std::string& string1, const std::string& string2, bool boolean0) {
 if (boolean0) {
 ...
 std::string banSteamID(const std::string& string0, const std::string& string1, bool boolean0) {
 if (boolean0) {
 ...
 std::string setUserSteamID(const std::string& string0, const std::string& string1) {
 try {
 ...
 void updateLastConnectionDate(const std::string& string0, const std::string& string1) {
 try {
 ...
 std::string addWarningPoint(const std::string& string0, const std::string& string1, int int0, const std::string& string2) {
 PreparedStatement preparedStatement = this->conn.prepareStatement("SELECT * FROM whitelist WHERE username = ? AND world = ?");
 preparedStatement.setString(1, string0);
 preparedStatement.setString(2, Core.GameSaveWorld);
 ResultSet resultSet = preparedStatement.executeQuery();
 ...
 void addTicket(const std::string& string0, const std::string& string1, int int0) {
 if (int0 > -1) {
 ...
 PreparedStatement preparedStatement = nullptr;
 if (string != nullptr) {
 preparedStatement = this->conn.prepareStatement("SELECT * FROM tickets WHERE author = ? and answeredID is nullptr");
 preparedStatement.setString(1, string);
 } else {
 preparedStatement = this->conn.prepareStatement("SELECT * FROM tickets where answeredID is nullptr");
 }
 ...
 ResultSet resultSet = preparedStatement.executeQuery();
 return resultSet.next() ? new DBTicket(resultSet.getString("author"), resultSet.getString("message"), resultSet.getInt("id")) : nullptr;
 }
 ...
 bool banned = false;
 bool priority = false;
 std::string bannedReason = nullptr;
 std::string dcReason = nullptr;
