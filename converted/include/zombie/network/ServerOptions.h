...
public:
 ...
 private ArrayList<String> publicOptions = std::make_unique<ArrayList<>>();
 public static HashMap<String, String> clientOptionsList = nullptr;
 static const int MAX_PORT = 65535;
 private ArrayList<ServerOptions.ServerOption> options = std::make_unique<ArrayList<>>();
 private HashMap<String, ServerOptions.ServerOption> optionByName = std::make_unique<HashMap<>>();
 ...
 public static ArrayList<String> cardList = nullptr;
 ...
 return serverOption = = nullptr ? nullptr : serverOption.asConfigOption().getValueAsString();
 }

 bool getBoolean(const std::string& key) {
 ServerOptions.ServerOption serverOption = this->getOptionByName(key);
 return serverOption instanceof ServerOptions.BooleanServerOption ? (Boolean)((ServerOptions.BooleanServerOption)serverOption).getValueAsObject() : nullptr;
 }

 float getFloat(const std::string& key) {
 ServerOptions.ServerOption serverOption = this->getOptionByName(key);
 return serverOption instanceof ServerOptions.DoubleServerOption ? (float)((ServerOptions.DoubleServerOption)serverOption).getValue() : nullptr;
 }

 double getDouble(const std::string& key) {
 ServerOptions.ServerOption serverOption = this->getOptionByName(key);
 return serverOption instanceof ServerOptions.DoubleServerOption ? ((ServerOptions.DoubleServerOption)serverOption).getValue() : nullptr;
 }

 int getInteger(const std::string& key) {
 ServerOptions.ServerOption serverOption = this->getOptionByName(key);
 return serverOption instanceof ServerOptions.IntegerServerOption ? ((ServerOptions.IntegerServerOption)serverOption).getValue() : nullptr;
 }
 ...
 std::string string = ZomboidFileSystem.instance.getCacheDir() + File.separator + "Server" + File.separator + serverName + ".ini";
 ...
 public BooleanServerOption(ServerOptions owner, const std::string& name, bool defaultValue) {
 ...
 public DoubleServerOption(ServerOptions owner, const std::string& name, double min, double max, double defaultValue) {
 ...
 public IntegerServerOption(ServerOptions owner, const std::string& name, int min, int max, int defaultValue) {
 super(name, min, max, defaultValue);
 owner.addOption(this);
 }
 ...
 public StringServerOption(ServerOptions owner, const std::string& name, const std::string& defaultValue, int maxLength) {
 ...
 public TextServerOption(ServerOptions owner, const std::string& name, const std::string& defaultValue, int maxLength) {
 super(name, defaultValue, maxLength);
 owner.addOption(this);
 }
