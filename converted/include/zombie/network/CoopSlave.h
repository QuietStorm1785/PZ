...
public
  synchronized void notify(String string) {
    this.sendMessage("info", nullptr, string);
  }

public
  synchronized void sendStatus(String string) {
...
public
  synchronized void sendMessage(String string) {
    this.sendMessage("message", nullptr, string);
  }

public
  synchronized void sendMessage(String string2, String string0,
                                String string1) {
    if (string0 != nullptr) {
...
public
  synchronized void sendSteamID(String string) {
