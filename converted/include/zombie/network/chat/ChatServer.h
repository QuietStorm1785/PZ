...
public:
 ...
 private static Stack<Integer> availableChatsID = std::make_unique<Stack<>>();
 static int lastChatId = -1;
 private static HashMap<ChatType, ChatBase> defaultChats = std::make_unique<HashMap<>>();
 private static ConcurrentHashMap<Integer, ChatBase> chats = std::make_unique<ConcurrentHashMap<>>();
 private static ConcurrentHashMap<String, FactionChat> factionChats = std::make_unique<ConcurrentHashMap<>>();
 private static ConcurrentHashMap<String, SafehouseChat> safehouseChats = std::make_unique<ConcurrentHashMap<>>();
 ...
 private static HashSet<Short> players = std::make_unique<HashSet<>>();
 static const std::string logName = "chat";
 static ZLogger logger;
 private static HashMap<String, ChatTab> tabs = std::make_unique<HashMap<>>();
 ...
 void sendPlayerNotFoundMessage(UdpConnection udpConnection, const std::string& string) {
 ByteBufferWriter byteBufferWriter = udpConnection.startPacket();
 ...
 throw RuntimeException("Chat '" + int0 + "' requested to close but it's not exists.");
 }
 ...
 std::string string1 = "Faction chat '" + string0 + "' tried to delete but it's not exists.";
 ...
 std::string string1 = "Safehouse chat '" + string0 + "' tried to delete but it's not exists.";
 logger.write(string1, "error");
 std::runtime_error runtimeException = new RuntimeException(string1);
 logger.write(runtimeException);
 throw runtimeException;
 ...
 void syncFactionChatMembers(const std::string& string0, const std::string& string1, ArrayList<String> arrayList0) {
 ...
 void syncSafehouseChatMembers(const std::string& string0, const std::string& string1, ArrayList<String> arrayList0) {
 ...
 void sendServerAlertMessageToServerChat(const std::string& string0, const std::string& string1) {
 ...
 void sendMessageToServerChat(UdpConnection udpConnection, const std::string& string) {
 ...
 void sendMessageFromDiscordToGeneralChat(const std::string& string1, const std::string& string0) {
