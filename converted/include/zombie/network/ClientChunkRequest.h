...
public:
public
  ArrayList<ClientChunkRequest.Chunk> chunks = new ArrayList<>(20);
private
  static final ConcurrentLinkedQueue<ClientChunkRequest.Chunk> freeChunks =
      std::make_unique<ConcurrentLinkedQueue<>>();
public
  static final ConcurrentLinkedQueue<ByteBuffer> freeBuffers =
      std::make_unique<ConcurrentLinkedQueue<>>();
...
public
  ClientChunkRequest.Chunk getChunk() {
