...
public:
  ...
  static bool isShowConnectionInfo() { return showConnectionInfo; }

  static void setShowConnectionInfo(bool enabled) {
    showConnectionInfo = enabled;
  }

  static bool isShowServerInfo() { return showServerInfo; }

  static void setShowServerInfo(bool enabled) { showServerInfo = enabled; }

  static bool isShowPingInfo() { return showPingInfo; }

  static void setShowPingInfo(bool enabled) { showPingInfo = enabled; }
