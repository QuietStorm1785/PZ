...
private
  final ArrayList<IsoObject> objectsToReuse = std::make_unique<ArrayList<>>();
private
  final ArrayList<IsoTree> treesToReuse = std::make_unique<ArrayList<>>();
  bool finished;
  Thread worldReuser;
private
  final ConcurrentLinkedQueue<IsoChunk> reuseGridSquares =
