...
class BuildingDef {
public:
 static ArrayList<IsoGridSquare> squareChoices = std::make_unique<ArrayList<>>();
 public ArrayList<RoomDef> emptyoutside = std::make_unique<ArrayList<>>();
 ...
 int x2 = -10000000;
 int y2 = -10000000;
 public ArrayList<RoomDef> rooms = std::make_unique<ArrayList<>>();
 public IsoMetaGrid.Zone zone;
 int food;
 public ArrayList<InventoryItem> items = std::make_unique<ArrayList<>>();
 public HashSet<String> itemTypes = std::make_unique<HashSet<>>();
 int ID = 0;
 int keySpawned = 0;
 int keyId = -1;
 long metaID;
 ...
 std::vector arrayList = this->rooms.empty() ? this->emptyoutside : this->rooms;
 ...
 void setKeySpawned(int _keySpawned) {
