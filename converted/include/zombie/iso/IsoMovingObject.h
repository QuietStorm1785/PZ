...
public:
 ...
 public boolean[] bOutline = new boolean[4];
 public ColorInfo[] outlineColor = new ColorInfo[4];
 private ArrayList<IsoZombie> eatingZombies = std::make_unique<ArrayList<>>();
 ...
 */
 ...
 return room = = nullptr ? nullptr : room.building;
 }
 }
 ...
 */
 ...
 float getWeight(float _x, float _y) {
 return this->weight;
 }
 ...
 */
 ...
 } else if (object0.getProperties() != nullptr && object0.getProperties().Is("Bush")) {
 object0.setRenderEffect(RenderEffectType.Vegetation_Rustle);
 }
 }
 }
 ...
 if (square != nullptr
 && square != this->current
 && (square.Has(IsoObjectType.tree) || square.getProperties() != nullptr && square.getProperties().Is("Bush"))) {
 if (bDoNoises) {
 this->doTreeNoises();
 }
 ...
 } else if (object1.getSprite() != nullptr && object1.getProperties().Is("Bush")) {
 object1.setRenderEffect(RenderEffectType.Vegetation_Rustle);
 }
 }
 }
 ...
 if (zombie0 != nullptr && GameServer.bServer && !zombie0.isCurrentState(ZombieIdleState.instance())) {
 bool boolean0 = false;
 }
 ...
 int int4 = (int)this->z;
 if (character.getCurrentState() == nullptr || !character.getCurrentState().isIgnoreCollide(character, int0, int1, int4, int2, int3, int4) {
 ...
 */
 ...
 if (!zombie0.isCrawling() || zombie0.getPath2() == nullptr && !zombie0.isMoving()) {
 ...
 if (square1 != nullptr && square1 != this->current && this->current != nullptr) {
 if (character != nullptr
 && character.getCurrentState() != nullptr
 ...
 } else if (object != nullptr && object.getThumpableFor(zombie0) != nullptr) {
 ...
 if (directions == IsoDirections.SE && square0 != nullptr && square0.Is(IsoFlagType.HoppableN) && square0.Is(IsoFlagType.HoppableW) {
 return false;
 } else {
 ...
 */
 void setCollidedE(bool _collidedE) {
 ...
 */
 void setCollidedN(bool _collidedN) {
 ...
 */
 void setCollidedS(bool _collidedS) {
 ...
 */
 void setCollidedW(bool _collidedW) {
 ...
 */
 void setCurrent(IsoGridSquare _current) {
 ...
 */
 void setFirstUpdate(bool _firstUpdate) {
 ...
 */
 void setHitDir(Vector2 _hitDir) {
 ...
 */
 void setImpulsex(float _impulsex) {
 ...
 */
 void setImpulsey(float _impulsey) {
 ...
 */
 void setLimpulsex(float _limpulsex) {
 ...
 */
 void setLimpulsey(float _limpulsey) {
 ...
 */
 void setHitForce(float _hitForce) {
 ...
 */
 void setLast(IsoGridSquare _last) {
 this->last = _last;
 }
 ...
 */
 void setbAltCollide(bool _bAltCollide) {
 ...
 */
 void setShootable(bool _shootable) {
 ...
 */
 void setScriptnx(float _scriptnx) {
 ...
 */
 void setScriptny(float _scriptny) {
 ...
 */
 void setFeelersize(float _feelersize) {
 ...
 */
 ...
 void setOnFloor(bool _bOnFloor) {
 ...
 void setCloseKilled(bool _closeKilled) {
 ...
 return other = = nullptr ? false : other.eatingZombies.contains(this);
 }
 ...
 void setZombiesDontAttack(bool b) {
 ...
 private static class L_slideAwayFromWalls {
 static const Vector2f vector2f = new Vector2f();
 ...
 private ArrayList<IsoGridSquare> squares = std::make_unique<ArrayList<>>();
