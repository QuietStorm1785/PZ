...
public:
 ...
 private ArrayList<IsoGameCharacter.Location> SpawnPoints = std::make_unique<ArrayList<>>();
 private ArrayList<BuildingDef> SpawnBuildings = std::make_unique<ArrayList<>>();
 private IsoGameCharacter.Location m_tempLocation = new IsoGameCharacter.Location(-1, -1, -1);
