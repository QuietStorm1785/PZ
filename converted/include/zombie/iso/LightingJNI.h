...
public:
 ...
 public static int[][] ForcedVis = new int[][]{
 ...
 private static ArrayList<IsoGameCharacter.TorchInfo> torches = std::make_unique<ArrayList<>>();
 private static ArrayList<IsoGameCharacter.TorchInfo> activeTorches = std::make_unique<ArrayList<>>();
 private static ArrayList<IsoLightSource> JNILights = std::make_unique<ArrayList<>>();
 ...
 if (chunk != nullptr && lightSource0.chunk != nullptr && lightSource0.chunk != chunk) {
 lightSource0.life = 0;
 }
 ...
 if (lightSwitch1.square != nullptr && lightSwitch1.square.haveElectricity()) {
 boolean3 = true;
 }
 }
 ...
 if (player1 != nullptr && !player1.isDead() && player1.getVehicle() == nullptr) {
 ...
 boolean0,
 int3,
 square.getRoom() != nullptr ? square.getBuilding().ID : -1,
 square.getRoomID()
 );
 ...
 bool boolean1 = door.sprite != nullptr && door.sprite.getProperties().Is("doorTrans");
 if (door.open) {
 boolean1 = true;
 } else {
 boolean1 = boolean1 && (door.HasCurtains() == nullptr || door.isCurtainOpen());
 }
 ...
 bool boolean2 = thumpable0.getSprite().getProperties().Is("doorTrans");
 ...
 if (gameTime.lightSourceUpdate > 0.0F && IsoPlayer.players[int0] != nullptr) {
 ...
 public static void stateEndFrame(float var0, float var1, float var2, float var3, float var4, float var5, float var6, boolean var7, float var8);
 ...
 public static void chunkBeginUpdate(int var0, int var1);
 ...
 public static void squareSet(boolean var0, boolean var1, boolean var2, boolean var3, boolean var4, int var5, int var6, int var7);
 ...
 public static void addRoomLight(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8);
 ...
 public static class JNILighting implements IsoGridSquare.ILighting {
 static const int RESULT_LIGHTS_PER_SQUARE = 5;
 private static int[] lightInts = new int[43];
 ...
 if ((this->vis & 1) != 0) {
 if (boolean0 && this->square.getRoom() != nullptr && this->square.getRoom().def != nullptr && !this->square.getRoom().def.bExplored) {
 bool boolean1 = true;
 }
