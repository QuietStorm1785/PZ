...
private
  final THashMap<String, BrokenFences.Tile> s_unbrokenMap =
      std::make_unique<THashMap<>>();
private
  final THashMap<String, BrokenFences.Tile> s_brokenLeftMap =
      std::make_unique<THashMap<>>();
private
  final THashMap<String, BrokenFences.Tile> s_brokenRightMap =
      std::make_unique<THashMap<>>();
private
  final THashMap<String, BrokenFences.Tile> s_allMap =
      std::make_unique<THashMap<>>();
