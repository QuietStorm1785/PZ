...
public
  IsoDoor.DoorType type = IsoDoor.DoorType.WeakWooden;
...
private
  static final int[] DoubleDoorNorthSpriteOffset = new int[]{5, 3, 4, 4};
private
  static final int[] DoubleDoorWestSpriteOffset = new int[]{4, 4, 5, 3};
private
  static final int[] DoubleDoorNorthClosedXOffset = new int[]{0, 1, 2, 3};
private
  static final int[] DoubleDoorNorthOpenXOffset = new int[]{0, 0, 3, 3};
private
  static final int[] DoubleDoorNorthClosedYOffset = new int[]{0, 0, 0, 0};
private
  static final int[] DoubleDoorNorthOpenYOffset = new int[]{0, 1, 1, 0};
private
  static final int[] DoubleDoorWestClosedXOffset = new int[]{0, 0, 0, 0};
private
  static final int[] DoubleDoorWestOpenXOffset = new int[]{0, 1, 1, 0};
private
  static final int[] DoubleDoorWestClosedYOffset = new int[]{0, -1, -2, -3};
private
  static final int[] DoubleDoorWestOpenYOffset = new int[]{0, 0, -3, -3};

public
  IsoDoor(IsoCell cell) { super(cell); }

  std::string getObjectName() { return "Door"; }
  ...
  void render(float x, float y, float z, ColorInfo info, bool bDoAttached,
    ...
    if (!this.bHasCurtain) {
      ...
      super.render(x, y, z, info, bDoAttached, bWallLightingPass, shader);
      this.postrender(x, y, z, info, bDoAttached, bWallLightingPass,
                      directions);
    }
  }
...
public
  void renderWallTile(float x, float y, float z, ColorInfo col,
    ...
    this.checkKeyHighlight(x, y);
    if (!this.bHasCurtain) {
      super.renderWallTile(x, y, z, col, bDoAttached, bWallLightingPass, shader,
                           texdModifier);
    } else {
      this.initCurtainSprites();
      IsoDirections directions = this.getSpriteEdge(false);
  ...
  void checkKeyHighlight(float float1, float float0) {
    ...
    if (key != nullptr && float1 >= character.getX() - 20.0F &&
  ...
  void prerender(float float0, float float1, float float2, ColorInfo colorInfo,
                 bool boolean0, bool boolean1, IsoDirections directions) {
    if (Core.TileScale == 1) {
      switch (directions) {
      case N:
        this.prerender1xN(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case S:
        this.prerender1xS(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case W:
        this.prerender1xW(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case E:
        this.prerender1xE(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
      }
    } else {
      switch (directions) {
      case N:
        this.prerender2xN(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case S:
        this.prerender2xS(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case W:
        this.prerender2xW(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
        break;
      case E:
        this.prerender2xE(float0, float1, float2, colorInfo, boolean0, boolean1,
                          nullptr);
      }
    }
  }

  void postrender(float float0, float float1, float float2, ColorInfo colorInfo,
                  bool boolean0, bool boolean1, IsoDirections directions) {
    if (Core.TileScale == 1) {
      switch (directions) {
      case N:
        this.postrender1xN(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case S:
        this.postrender1xS(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case W:
        this.postrender1xW(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case E:
        this.postrender1xE(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
      }
    } else {
      switch (directions) {
      case N:
        this.postrender2xN(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case S:
        this.postrender2xS(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case W:
        this.postrender2xW(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
        break;
      case E:
        this.postrender2xE(float0, float1, float2, colorInfo, boolean0,
                           boolean1, nullptr);
      }
    }
  }

  void prerender1xN(float float0, float float2, float float1,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (!this.north && this.open) {
        (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(nullptr, float0, float2 - 1.0F, float1, this.dir,
                    this.offsetX + 3.0F,
                    this.offsetY + (this.bCurtainOpen ? -14 : -14), colorInfo,
                    true);
      }
    } else if (this.north && !this.open) {
      (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
          .render(nullptr, float0, float2 - 1.0F, float1, this.dir,
                  this.offsetX - 1.0F - 1.0F, this.offsetY + -15.0F, colorInfo,
                  true);
    }
  }

  void postrender1xN(float float0, float float1, float float2,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
            .render(nullptr, float0, float1, float2, this.dir,
                    this.offsetX - 10.0F - 1.0F, this.offsetY + -10.0F,
                    colorInfo, true);
      }
    } else if (!this.north && this.open) {
      (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
          .render(
              nullptr, float0, float1, float2, this.dir, this.offsetX - 4.0F,
              this.offsetY + (this.bCurtainOpen ? -10 : -10), colorInfo, true);
    }
  }

  void prerender1xS(float float0, float float1, float float2,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    ...
    if (!this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
          .render(nullptr, float0, float1, float2, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -16 : -16) / 2, colorInfo,
                  true);
    }
  }

  void postrender1xS(float float0, float float2, float float1,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert !this.north && this.open;
    ...
    if (this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
          .render(nullptr, float0, float2 + 1.0F, float1, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -8 : -8) / 2, colorInfo,
                  true);
    }
  }

  void prerender1xW(float float2, float float0, float float1,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (this.north && this.open) {
        (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
            .render(nullptr, float2 - 1.0F, float0, float1, this.dir,
                    this.offsetX + (this.bCurtainOpen ? -16 : -18),
                    this.offsetY + (this.bCurtainOpen ? -14 : -15), colorInfo,
                    true);
      }

      if (!this.north && this.open) {
        (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(nullptr, float2, float0 - 1.0F, float1, this.dir,
                    this.offsetX + 3.0F,
                    this.offsetY + (this.bCurtainOpen ? -14 : -14), colorInfo,
                    true);
      }
      ...
      if (this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(nullptr, float2, float0 - 1.0F, float1, this.dir,
                    this.offsetX - 1.0F - 1.0F, this.offsetY + -15.0F,
                    colorInfo, true);
      }
  ...
  void postrender1xW(float float0, float float1, float float2,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
      ...
      if (!this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
            .render(nullptr, float0, float1, float2, this.dir,
                    this.offsetX - 2.0F - 1.0F, this.offsetY + -10.0F,
                    colorInfo, true);
      }
    } else {
      if (this.north && this.open) {
        (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
            .render(nullptr, float0, float1, float2, this.dir,
                    this.offsetX - 9.0F, this.offsetY + -10.0F, colorInfo,
                    true);
      }
      ...
      if (!this.north && this.open) {
        (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
            .render(nullptr, float0, float1, float2, this.dir,
                    this.offsetX - 4.0F,
                    this.offsetY + (this.bCurtainOpen ? -10 : -10), colorInfo,
                    true);
      }
    }
  }

  void prerender1xE(float float0, float float1, float float2,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert this.north &&this.open;
    ...
    if (!this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
          .render(nullptr, float0, float1, float2, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -15 : -18) / 2, colorInfo,
                  true);
    }
  }

  void postrender1xE(float float2, float float0, float float1,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert this.north &&this.open;
    ...
    if (this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
          .render(nullptr, float2 + 1.0F, float0, float1, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? 0 : 0), colorInfo, true);
    }
  }

  void prerender2xN(float float0, float float2, float float1,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (!this.north && this.open) {
        (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(nullptr, float0, float2 - 1.0F, float1, this.dir,
                    this.offsetX + 7.0F,
                    this.offsetY + (this.bCurtainOpen ? -28 : -28), colorInfo,
                    true);
      }
    } else if (this.north && !this.open) {
      (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
          .render(nullptr, float0, float2 - 1.0F, float1, this.dir,
                  this.offsetX - 3.0F,
                  this.offsetY + (this.bCurtainOpen ? -30 : -30), colorInfo,
                  true);
    }
  }

  void postrender2xN(float float0, float float1, float float2,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
            .render(nullptr, float0, float1, float2, this.dir,
                    this.offsetX - 20.0F,
                    this.offsetY + (this.bCurtainOpen ? -20 : -20), colorInfo,
                    true);
      }
    } else if (!this.north && this.open) {
      (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
          .render(
              nullptr, float0, float1, float2, this.dir, this.offsetX - 8.0F,
              this.offsetY + (this.bCurtainOpen ? -20 : -20), colorInfo, true);
    }
  }

  void prerender2xS(float float0, float float1, float float2,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert !this.north && this.open;
    ...
    if (!this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
          .render(nullptr, float0, float1, float2, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -16 : -16), colorInfo,
                  true);
    }
  }

  void postrender2xS(float float0, float float2, float float1,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert !this.north && this.open;
    ...
    if (this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
          .render(nullptr, float0, float2 + 1.0F, float1, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -8 : -8), colorInfo,
                  true);
    }
  }

  void prerender2xW(float float2, float float0, float float1,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (this.north && this.open) {
        (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
            .render(nullptr, float2 - 1.0F, float0, float1, this.dir,
                    ...
                    this.offsetY + (this.bCurtainOpen ? -28 : -31), colorInfo,
                    true);
      }
    } else if (!this.north && !this.open) {
      (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
  ...
  void postrender2xW(float float0, float float1, float float2,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    if (this.bCurtainInside) {
      if (!this.north && !this.open) {
        (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
      ...
      (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
          .render(
              nullptr, float0, float1, float2, this.dir, this.offsetX - 19.0F,
              this.offsetY + (this.bCurtainOpen ? -20 : -20), colorInfo, true);
    }
  }

  void prerender2xE(float float0, float float1, float float2,
                    ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert this.north &&this.open;
    ...
    if (!this.bCurtainInside) {
      (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
          .render(nullptr, float0, float1, float2, this.dir,
                  ...
                  this.offsetY + (this.bCurtainOpen ? -15 : -18), colorInfo,
                  true);
    }
  }

  void postrender2xE(float float2, float float0, float float1,
                     ColorInfo colorInfo, bool var5, bool var6, Shader var7) {
    assert this.north &&this.open;
...
public
  IsoDoor(IsoCell cell, IsoGridSquare gridSquare, IsoSprite _gid, bool _north) {
    ...
    this.closedSprite =
        this.open ? IsoSprite.getSprite(IsoSpriteManager.instance, _gid, -byte0)
                  : _gid;
    this.openSprite =
        this.open ? _gid
                  : IsoSprite.getSprite(IsoSpriteManager.instance, _gid, byte0);
    ...
    if (this.getSprite().getName() != nullptr &&
        this.getSprite().getName().contains("fences")) {
...
public
  IsoDoor(IsoCell cell, IsoGridSquare gridSquare, const std::string &_gid,
    ...
    if (string != nullptr) {
      ...
      if (int0 <= 3) {
        this.openSprite =
            IsoSprite.getSprite(IsoSpriteManager.instance, _gid, 8);
      } else {
  ...
  bool TestPathfindCollide(IsoMovingObject obj, IsoGridSquare from,
    ...
    if (!this.isBarricaded()) {
      return false;
               ...
               IsoSurvivor &&
                   ((IsoSurvivor)obj).getInventory().contains("Hammer")) {
      return false;
    } else {
      if (this.open) {
        boolean0 = !boolean0;
...
public
  IsoObject.VisionResult TestVision(IsoGridSquare from, IsoGridSquare to) {
    bool boolean0 =
        this.sprite != null && this.sprite.getProperties().Is("doorTrans");
    if (this.sprite != nullptr &&
        this.sprite.getProperties().Is("GarageDoor") && this.open) {
      boolean0 = true;
    }
  ...
  void Thump(IsoMovingObject thumper) {
    if (!this.isDestroyed()) {
      ...
      if (thumper instanceof IsoZombie) {
        if (((IsoZombie)thumper).cognition == 1 && !this.open &&
            (!this.Locked ||
      ...
      if (this.Health <= 0) {
        ...
        if (GameServer.bServer) {
          GameServer.PlayWorldSoundServer(
              (IsoGameCharacter)thumper, "BreakDoor", false,
  ...
  float getThumpCondition() {
    return this.getMaxHealth() <= 0
               ? 0.0F
               : (float)PZMath.clamp(this.getHealth(), 0, this.getMaxHealth()) /
                     this.getMaxHealth();
  }
          ...
          if (!this.open) {
            if (!this.isDestroyed()) {
              ...
              if (weapon.getDoorHitSound() != nullptr) {
                ...
                if (GameServer.bServer) {
                  GameServer.PlayWorldSoundServer(
                      owner, weapon.getDoorHitSound(), false, this.getSquare(),
              ...
              if (!this.IsStrengthenedByPushedItems() && this.Health <= 0 ||
                ...
                if (GameServer.bServer) {
                  GameServer.PlayWorldSoundServer(owner, "BreakDoor", false,
                                                  this.getSquare(), 0.2F, 20.0F,
                                                  1.1F, true);
                }
  ...
  void destroy() {
    if (this.sprite != nullptr &&
        this.sprite.getProperties().Is("GarageDoor")) {
      this.destroyed = true;
  ...
  bool isExteriorDoor(IsoGameCharacter chr) { return this.isExterior(); }
  ...
  bool isExterior() {
    ...
    if (square1 == nullptr) {
      ...
      return square0.Is(IsoFlagType.exterior) &&
                     square1.getBuilding() != nullptr &&
                     square1.getBuilding().getDef() != nullptr
                 ? true
                 : square0.getBuilding() != nullptr &&
                       square0.getBuilding().getDef() != nullptr &&
  ...
  bool canClimbOver(IsoGameCharacter chr) {
    if (this.square == nullptr) {
      ...
      return !this.isHoppable()
                 ? false
                 : chr == nullptr || IsoWindow.canClimbThroughHelper(
                                         chr, this.getSquare(),
  ...
  void ToggleDoorActual(IsoGameCharacter chr) {
    ...
    if (this.isBarricaded()) {
      ...
      if (this.isLockedByKey() && chr != nullptr && chr instanceof
          IsoPlayer &&
              (chr.getCurrentSquare().Is(IsoFlagType.exterior) ||
                   this.getProperties().Is("forceLocked") ||
                   this.getModData().rawget("CustomLock") != nullptr &&
                       this.getModData().rawget("CustomLock")
                   instanceof
               Boolean && (Boolean)this.getModData().rawget("CustomLock")) &&
              !this.open) {
      ...
      bool boolean0 = chr instanceof
          IsoPlayer && !chr.getCurrentSquare().isOutside();
      if ("Tutorial" == Core.getInstance().getGameMode()) && this.isLockedByKey()) {
                boolean0 = false;
            }

      if (chr instanceof
          IsoPlayer && this.getSprite().getProperties().Is("GarageDoor")) {
        bool boolean1 = this.getSprite().getProperties().Is("InteriorSide");
        if (boolean1) {
          boolean0 = this.north ? chr.getY() >= this.getY()
                                : chr.getX() >= this.getX();
        } else {
          boolean0 =
              this.north ? chr.getY() < this.getY() : chr.getX() < this.getX();
        }
      }
  ...
  void syncIsoObject(bool bRemote, uint8_t val, UdpConnection source,
    ...
    if (this.square == nullptr) {
      ...
      bool boolean0 = bb != null && bb.get() == 1;
      bool boolean1 = bb != null && bb.get() == 1;
      bool boolean2 = bb != null && bb.get() == 1;
      short short0 = -1;
  ...
  bool isBarricadeAllowed() {
    return this.getSprite() != nullptr &&
           !this.getSprite().getProperties().Is("DoubleDoor") &&
           !this.getSprite().getProperties().Is("GarageDoor");
  }
  ...
  void setLocked(bool bLocked) { this.Locked = bLocked; }
  ...
  void syncDoorKey() {
    ...
    uint8_t byte0 = (byte)this.square.getObjects().indexOf(this);
    if (byte0 == -1) {
      System.out.println("ERROR: Door not found on square " +
                         this.square.getX() + ", " + this.square.getY() + ", " +
                         this.square.getZ());
  ...
  bool haveKey() { return this.haveKey; }
  ...
  IsoGridSquare getOppositeSquare() {
    return this.getNorth()
               ? this.getCell().getGridSquare((double)this.getX(),
                                              (double)(this.getY() - 1.0F),
                                              (double)this.getZ())
               : this.getCell().getGridSquare((double)(this.getX() - 1.0F),
                                              (double)this.getY(),
                                              (double)this.getZ());
  }
  ...
  int checkKeyId() {
    if (this.getKeyId() != -1) {
      ...
      if (square0 != nullptr && square1 != nullptr) {
        BuildingDef buildingDef0 = square0.getBuilding() == null
                                       ? null
                                       : square0.getBuilding().getDef();
        BuildingDef buildingDef1 = square1.getBuilding() == null
                                       ? null
                                       : square1.getBuilding().getDef();
        if (buildingDef0 == nullptr && buildingDef1 != nullptr) {
          this.setKeyId(buildingDef1.getKeyId());
        } else if (buildingDef0 != nullptr && buildingDef1 == nullptr) {
          this.setKeyId(buildingDef0.getKeyId());
        } else if (this.getProperties().Is("forceLocked") &&
                   buildingDef0 != nullptr) {
          this.setKeyId(buildingDef0.getKeyId());
        }
    ...
    if (this.bHasCurtain) {
      ...
      if (GameClient.bClient) {
        GameClient.instance.sendClientCommandV(
            nullptr, "object", "openCloseCurtain", "x", this.getX(), "y",
            this.getY(), "z", this.getZ(), "index", this.getObjectIndex(),
            "open", !this.bCurtainOpen);
      }
    }
  }
  ...
  void addSheet(IsoGameCharacter chr) {
    if (!this.bHasCurtain && chr != nullptr &&
        chr.getCurrentSquare() != nullptr) {
            ...
            switch (this.getSpriteEdge(false)) {
                case N:
                  return square0.getY() >= square1.getY()
                             ? square1
                             : this.getCell().getGridSquare(
                                   square1.x, square1.y - 1, square1.z);
                case S:
                  return square0.getY() <= square1.getY()
                             ? square1
                             : this.getCell().getGridSquare(
                ...
                case W:
                  return square0.getX() >= square1.getX()
                             ? square1
                             : this.getCell().getGridSquare(
                                   square1.x - 1, square1.y, square1.z);
                case E:
                  return square0.getX() <= square1.getX()
                             ? square1
                             : this.getCell().getGridSquare(
    ...
    if (!this.bHasCurtain) {
      ...
      case N:
        if (this.open) {
          return this.bCurtainInside
                     ? this.getCell().getGridSquare(
                           (double)this.getX(), (double)(this.getY() - 1.0F),
                           (double)this.getZ())
                     : this.getSquare();
        }
      ...
      case W:
        if (this.open) {
          return this.bCurtainInside
                     ? this.getCell().getGridSquare(
                           (double)(this.getX() - 1.0F), (double)this.getY(),
                           (double)this.getZ())
                     : this.getSquare();
        }
  ...
  bool isFacingSheet(IsoGameCharacter chr) {
    if (this.bHasCurtain && chr != nullptr &&
        chr.getCurrentSquare() == this.getSheetSquare()) {
      ...
      return chr.getDir() == directions0 ||
             chr.getDir() == IsoDirections.RotLeft(directions0) ||
             chr.getDir() == IsoDirections.RotRight(directions0);
    } else {
      return false;
    }
  }
  ...
  void addRandomBarricades() {
    IsoGridSquare square =
        this.square.getRoom() == null ? this.square : this.getOppositeSquare();
  ...
  bool isObstructed() { return isDoorObstructed(); }

  static bool isDoorObstructed(IsoObject object) {
    IsoDoor door = object instanceof IsoDoor ? (IsoDoor)object : null;
    IsoThumpable thumpable = object instanceof
        IsoThumpable ? (IsoThumpable)object : null;
    if (door == nullptr && thumpable == nullptr) {
      return false;
    } else {
          ...
          for (int int5 = int0; int5 <= int2; int5++) {
            ...
            if (chunk != nullptr) {
              for (int int6 = 0; int6 < chunk.vehicles.size(); int6++) {
                ...
                if (vehicle.isIntersectingSquareWithShadow(square.x, square.y,
                                                           square.z)) {
                  return true;
                }
              }
  ...
  static void toggleDoubleDoor(IsoObject oneOfFour, bool doSync) {
    ...
    if (int0 != -1) {
      ...
      IsoThumpable thumpable = oneOfFour instanceof
          IsoThumpable ? (IsoThumpable)oneOfFour : null;
      if (door != nullptr) {
        ;
      }

      bool boolean0 = door == null ? thumpable.open : door.open;
      ...
      if (doSync) {
        if (object0 != nullptr) {
          object0.syncIsoObject(false, (byte)(boolean0 ? 1 : 0), nullptr,
                                nullptr);
        } else if (object3 != nullptr) {
          object3.syncIsoObject(false, (byte)(boolean0 ? 1 : 0), nullptr,
                                nullptr);
        }
      }
    }
  ...
  static void toggleDoubleDoorObject(IsoObject object) {
    ...
    if (int0 != -1) {
      ...
      IsoThumpable thumpable0 = object instanceof
          IsoThumpable ? (IsoThumpable)object : null;
      bool boolean0 = door0 == null ? thumpable0.north : door0.north;
      bool boolean1 = door0 == null ? thumpable0.open : door0.open;
      int int1 = -1;
      if (door0 != nullptr) {
        door0.open = !boolean1;
      ...
      int int2 = boolean0 ? DoubleDoorNorthSpriteOffset[int0 - 1]
                          : DoubleDoorWestSpriteOffset[int0 - 1];
      if (boolean1) {
        int2 *= -1;
      }
      ...
      if (int0 != 2 && int0 != 3) {
        ...
        square = IsoWorld.instance.CurrentCell.getGridSquare(int5, int6,
                                                             square.getZ());
        if (square == nullptr) {
          return;
        }
        ...
        if (thumpable0 != nullptr) {
          IsoThumpable thumpable1 = new IsoThumpable(
              square.getCell(), square, object.getSprite().getName(), boolean0,
              thumpable0.getTable());
          ...
          IsoDoor door1 = new IsoDoor(square.getCell(), square,
                                      object.getSprite().getName(), boolean0);
          door1.open = !boolean1;
          door1.keyId = int1;
  ...
  static int getDoubleDoorIndex(IsoObject oneOfFour) {
    if (oneOfFour != nullptr && oneOfFour.getSquare() != nullptr) {
      ...
      if (propertyContainer != nullptr && propertyContainer.Is("DoubleDoor")) {
        ...
        if (int0 >= 1 && int0 <= 8) {
          IsoDoor door = oneOfFour instanceof
              IsoDoor ? (IsoDoor)oneOfFour : null;
          IsoThumpable thumpable = oneOfFour instanceof
              IsoThumpable ? (IsoThumpable)oneOfFour : null;
          if (door == nullptr && thumpable == nullptr) {
            return -1;
  ...
  static IsoObject getDoubleDoorObject(IsoObject oneOfFour, int index) {
    ...
    if (int0 == -1) {
      ...
      IsoThumpable thumpable = oneOfFour instanceof
          IsoThumpable ? (IsoThumpable)oneOfFour : null;
      bool boolean0 = door == null ? thumpable.north : door.north;
      bool boolean1 = door == null ? thumpable.open : door.open;
      ...
      square = IsoWorld.instance.CurrentCell.getGridSquare(int3, int4,
                                                           square.getZ());
      if (square == nullptr) {
        return null;
      } else {
        ...
        if (door != nullptr) {
          for (int int5 = 0; int5 < arrayList.size(); int5++) {
            ...
            if (object0 instanceof IsoDoor &&
                                       ((IsoDoor)object0).north == boolean0 &&
                                       getDoubleDoorIndex(object0) == index) {
              return object0;
            }
          }
        }
        ...
        if (thumpable != nullptr) {
          for (int int6 = 0; int6 < arrayList.size(); int6++) {
            ...
            if (object1 instanceof
                IsoThumpable && ((IsoThumpable)object1).north == boolean0 &&
                    getDoubleDoorIndex(object1) == index) {
              return object1;
            }
          }
        }
    ...
    if (int0 == -1) {
      ...
      for (int int8 = int4; int8 < int6; int8++) {
        for (int int9 = int3; int9 < int5; int9++) {
          IsoGridSquare square1 =
              IsoWorld.instance.CurrentCell.getGridSquare(int9, int8, int7);
          if (square1 != nullptr &&
              (square1.isSolid() || square1.isSolidTrans() ||
               square1.Has(IsoObjectType.tree))) {
            return true;
          }
        }
      }
      ...
      for (int int14 = int11; int14 <= int13; int14++) {
        for (int int15 = int10; int15 <= int12; int15++) {
          IsoChunk chunk =
              GameServer.bServer
                  ? ServerMap.instance.getChunk(int15, int14)
                  : IsoWorld.instance.CurrentCell.getChunk(int15, int14);
          if (chunk != nullptr) {
  ...
  static bool hasSomething4x4(int int0, int int1, int int3, int int4,
                              int int2) {
    IsoGridSquare square0 =
        IsoWorld.instance.CurrentCell.getGridSquare(int0, int1, int2);
    IsoGridSquare square1 =
        IsoWorld.instance.CurrentCell.getGridSquare(int3, int1, int2);
    IsoGridSquare square2 =
        IsoWorld.instance.CurrentCell.getGridSquare(int3, int4, int2);
    IsoGridSquare square3 =
        IsoWorld.instance.CurrentCell.getGridSquare(int0, int4, int2);
  ...
  static int getGarageDoorIndex(IsoObject oneOfThree) {
    if (oneOfThree != nullptr && oneOfThree.getSquare() != nullptr) {
      ...
      if (propertyContainer != nullptr && propertyContainer.Is("GarageDoor")) {
        ...
        if (int0 >= 1 && int0 <= 6) {
          IsoDoor door = oneOfThree instanceof
              IsoDoor ? (IsoDoor)oneOfThree : null;
          IsoThumpable thumpable = oneOfThree instanceof
              IsoThumpable ? (IsoThumpable)oneOfThree : null;
          if (door == nullptr && thumpable == nullptr) {
            return -1;
          } else {
            bool boolean0 = door == null ? thumpable.open : door.open;
  ...
  static IsoObject getGarageDoorPrev(IsoObject oneOfThree) {
    ...
    if (int0 == -1) {
      ...
      square = IsoWorld.instance.CurrentCell.getGridSquare(int1, int2,
                                                           square.getZ());
      if (square == nullptr) {
        return null;
      } else {
        ...
        if (door != nullptr) {
          for (int int3 = 0; int3 < arrayList.size(); int3++) {
            ...
            if (object0 instanceof IsoDoor &&
                                       ((IsoDoor)object0).north == boolean0 &&
                                       getGarageDoorIndex(object0) <= int0) {
              return object0;
            }
          }
        }
        ...
        if (thumpable != nullptr) {
          for (int int4 = 0; int4 < arrayList.size(); int4++) {
            ...
            if (object1 instanceof
                IsoThumpable && ((IsoThumpable)object1).north == boolean0 &&
                    getGarageDoorIndex(object1) <= int0) {
              return object1;
            }
          }
        }
  ...
  static IsoObject getGarageDoorFirst(IsoObject oneOfThree) {
    ...
    if (int0 == -1) {
      ...
      for (IsoObject object = getGarageDoorPrev(oneOfThree); object != nullptr;
           object = getGarageDoorPrev(object)) {
  ...
  static void toggleGarageDoorObject(IsoObject object) {
    ...
    if (int0 != -1) {
      ...
      if (thumpable != nullptr) {
        ...
        thumpable.sprite =
            thumpable.open ? thumpable.openSprite : thumpable.closedSprite;
      }
  ...
  static void toggleGarageDoor(IsoObject oneOfThree, bool doSync) {
    ...
    if (int0 != -1) {
      ...
      for (IsoObject object0 = getGarageDoorPrev(oneOfThree);
           object0 != nullptr; object0 = getGarageDoorPrev(object0)) {
        toggleGarageDoorObject(object0);
      }

      for (IsoObject object1 = getGarageDoorNext(oneOfThree);
           object1 != nullptr; object1 = getGarageDoorNext(object1)) {
  ...
  static bool isGarageDoorObstructed(IsoObject object0) {
    ...
    if (int0 == -1) {
      ...
      IsoThumpable thumpable = object0 instanceof
          IsoThumpable ? (IsoThumpable)object0 : null;
      bool boolean0 = door == null ? thumpable.north : door.north;
      bool boolean1 = door == null ? thumpable.open : door.open;
      if (!boolean1) {
        return false;
        ...
        int int4 = int2;
        if (boolean0) {
          for (IsoObject object1 = getGarageDoorPrev(object0);
               object1 != nullptr; object1 = getGarageDoorPrev(object1)) {
            int1--;
          }

          for (IsoObject object2 = getGarageDoorNext(object0);
               object2 != nullptr; object2 = getGarageDoorNext(object2)) {
            int3++;
          }
        } else {
          for (IsoObject object3 = getGarageDoorPrev(object0);
               object3 != nullptr; object3 = getGarageDoorPrev(object3)) {
            int4++;
          }

          for (IsoObject object4 = getGarageDoorNext(object0);
               object4 != nullptr; object4 = getGarageDoorNext(object4)) {
            int2--;
          }
        }
        ...
        for (int int10 = int6; int10 <= int8; int10++) {
          for (int int11 = int5; int11 <= int7; int11++) {
            IsoChunk chunk =
                GameServer.bServer
                    ? ServerMap.instance.getChunk(int11, int10)
                    : IsoWorld.instance.CurrentCell.getChunk(int11, int10);
            if (chunk != nullptr) {
                ...
                for (int int13 = int2; int13 <= int4; int13++) {
                  for (int int14 = int1; int14 <= int3; int14++) {
                    if (vehicle.isIntersectingSquare(int14, int13, int9) &&
                        vehicle.isIntersectingSquare(int14 - (boolean0 ? 0 : 1),
                                                     int13 - (boolean0 ? 1 : 0),
                                                     int9)) {
                      return true;
                    }
...
public
  static enum DoorType { WeakWooden, StrongWooden; }
}
} // namespace objects
} // namespace iso
} // namespace zombie
