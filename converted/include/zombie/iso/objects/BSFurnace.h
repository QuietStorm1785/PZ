...
public:
 ...
 public BSFurnace(IsoCell cell, IsoGridSquare square, const std::string& string0, const std::string& string1) {
 ...
 DrainableComboItem drainableComboItem = nullptr;
 ...
 if (item0 != nullptr) {
 if (item0.getWorker() != nullptr && !item0.getWorker().empty()) {
 for (int int1 = 0; int1 < IsoPlayer.numPlayers; int1++) {
 IsoPlayer player = IsoPlayer.players[int1];
 if (player != nullptr && !player.isDead() && item0.getWorker() == player.getFullName())) {
 break;
 }
 }
 }
 ...
 if (item.getWorker() != nullptr && !item.getWorker().empty()) {
 for (int int0 = 0; int0 < IsoPlayer.numPlayers; int0++) {
 IsoPlayer player = IsoPlayer.players[int0];
 if (player != nullptr && !player.isDead() && item.getWorker() == player.getFullName())) {
 ...
 void setFuelDecrease(float float0) {
 ...
 void setHeatDecrease(float float0) {
 ...
 void setHeatIncrease(float float0) {
