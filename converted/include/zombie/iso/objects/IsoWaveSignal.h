...
public:
 ...
 protected static Map<String, DeviceData> deviceDataCache = std::make_unique<HashMap<>>();
 ...
 if (propertyContainer.Is("CustomItem") && propertyContainer.Val("CustomItem") != nullptr) {
 ...
 if (itemfull != nullptr) {
 if (deviceDataCache.containsKey(itemfull) && deviceDataCache.get(itemfull) != nullptr) {
 ...
 void AddDeviceText(const std::string& line, int r, int g, int b, const std::string& guid, const std::string& codes, int distance) {
 this->AddDeviceText(line, r / 255.0F, g / 255.0F, b / 255.0F, guid, codes, distance, true);
 }

 void AddDeviceText(const std::string& line, int r, int g, int b, const std::string& guid, const std::string& codes, int distance, bool attractZombies) {
 this->AddDeviceText(line, r / 255.0F, g / 255.0F, b / 255.0F, guid, codes, distance, attractZombies);
 }

 void AddDeviceText(const std::string& line, float r, float g, float b, const std::string& guid, const std::string& codes, int distance, bool attractZombies) {
