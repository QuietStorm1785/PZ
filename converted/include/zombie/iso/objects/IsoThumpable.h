...
public:
 ...
 void setModData(KahluaTable _modData) {
 ...
 */
 ...
 void setIsDismantable(bool _dismantable) {
 ...
 */
 void setThumpDmg(int pThumpDmg) {
 ...
 */
 ...
 void setIsDoor(bool pIsDoor) {
 this->isDoor = pIsDoor;
 }

 void setIsDoorFrame(bool pIsDoorFrame) {
 ...
 */
 public IsoThumpable(IsoCell cell, IsoGridSquare gridSquare, const std::string& _closedSprite, const std::string& _openSprite, bool _north, KahluaTable _table) {
 ...
 */
 public IsoThumpable(IsoCell cell, IsoGridSquare gridSquare, const std::string& sprite, bool _north, KahluaTable _table) {
 this->OutlineOnMouseover = true;
 this->PushedMaxStrength = this->PushedStrength = 2500;
 this->closedSprite = IsoSpriteManager.instance.getSprite(sprite);
 this->table = _table;
 ...
 bool boolean1 = this->sprite != nullptr && this->sprite.getProperties().Is("doorTrans");
 if (from == this->square) {
 if (boolean0 && to.getY() < from.getY()) {
 if (boolean1) {
 ...
 if (this->isLockedByKey() && chr instanceof IsoPlayer && chr.getInventory().haveThisKeyId(this->getKeyId()) != nullptr) {
 ...
 */
 ...
 void setPaintable(bool _paintable) {
 ...
 void setIsThumpable(bool thumpable) {
 this->isThumpable = thumpable;
 }

 void setIsHoppable(bool _isHoppable) {
 ...
 void setHoppable(bool _isHoppable) {
 ...
 void setLifeLeft(float _lifeLeft) {
 ...
 void setLifeDelta(float _lifeDelta) {
 ...
 void setHaveFuel(bool _haveFuel) {
 ...
 return string != nullptr && string.startsWith("carpentry_02_") ? square : this->square;
 }
 }
 }
 ...
 if (GameClient.bClient && chr instanceof IsoPlayer && !((IsoPlayer)chr).accessLevel == "")) {
 return false;
 } else {
 return this->getLockedByCode() > 0
 ? true
 : this->isLockedByPadlock() && (chr.getInventory() == nullptr || chr.getInventory().haveThisKeyId(this->getKeyId()) == nullptr);
 }
 }
 ...
 PropertyContainer propertyContainer = this->getProperties();
 if (propertyContainer != nullptr && propertyContainer.Is(IsoFlagType.attachedE) {
