...
public:
 ...
 public IsoFire(IsoCell cell, IsoGridSquare gridSquare, bool CanBurnAnywhere, int StartingEnergy, int SetLife, bool isSmoke) {
 this->square = gridSquare;
 this->DirtySlice();
 this->square.getProperties().Set(IsoFlagType.smoke);
 this->AttachAnim("Smoke", "03", 4, IsoFireManager.SmokeAnimDelay, 0, 12, true, 0, false, 0.7F, IsoFireManager.SmokeTintMod);
 ...
 public IsoFire(IsoCell cell, IsoGridSquare gridSquare, bool CanBurnAnywhere, int StartingEnergy, int SetLife) {
 this->square = gridSquare;
 this->DirtySlice();
 ...
 public IsoFire(IsoCell cell, IsoGridSquare gridSquare, bool CanBurnAnywhere, int StartingEnergy) {
 ...
 if (sprite != nullptr && sprite.CurrentAnim != nullptr && sprite.def != nullptr) {
 ...
 if (square.getFloor() != nullptr && square.getFloor().getSprite() != nullptr) {
 ...
 */
 void setSpreadDelay(int _SpreadDelay) {
