...
public:
 ...
 std::string string0 = !this->isMetal() && !this->isMetalBar() ? "HitBarricadePlank" : "HitBarricadeMetal";
 if (player != nullptr) {
 ...
 if (this->isDestroyed()) {
 if (owner != nullptr) {
 std::string string1 = string0 == "HitBarricadeMetal" ? "BreakBarricadeMetal" : "BreakBarricadePlank";
 ...
 void DamageBarricade(int amount) {
 this->Damage(amount);
 }
 ...
 if (barricadeAble != nullptr && this->square.lighting[int0].targetDarkMulti() <= barricadeAble.getSquare().lighting[int0].targetDarkMulti()) {
 ...
 static IsoBarricade GetBarricadeForCharacter(BarricadeAble obj, IsoGameCharacter chr) {
 ...
 static IsoBarricade GetBarricadeOppositeCharacter(BarricadeAble obj, IsoGameCharacter chr) {
 if (obj != nullptr && obj.getSquare() != nullptr) {
 if (chr != nullptr) {
 if (obj.getNorth()) {
 if (chr.getY() < obj.getSquare().getY()) {
