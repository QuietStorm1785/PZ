...
public:
 ...
 static bool isWindowFrame(IsoObject o) {
 return getDirection();
 }
 ...
 static bool addSheetRope(IsoObject o, IsoPlayer player, const std::string& itemType) {
 ...
 return square1 != nullptr && square1.getRoom() != nullptr ? square1 : nullptr;
 }
 }
 }
 ...
 return square = = nullptr ? nullptr : square.getCurtain(boolean0 ? IsoObjectType.curtainS : IsoObjectType.curtainE);
 }
 }
 }
