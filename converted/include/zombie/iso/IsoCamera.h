...
class IsoCamera {
public:
 public static PlayerCamera[] cameras = new PlayerCamera[4];
 ...
 public static IsoCamera.FrameState frameState;
 ...
 */
 static void setFakePos(Vector2 aFakePos) {
 FakePos = aFakePos;
 }
 ...
 */
 static void setFakePosVec(Vector2 aFakePosVec) {
 ...
 */
 static void setTargetTileX(int aTargetTileX) {
 ...
 */
 static void setTargetTileY(int aTargetTileY) {
