...
public:
 ...
 private static Map<Integer, File> chunkFileNames = std::make_unique<HashMap<>>();
 ...
 std::string string = cacheDir + "datachunk_" + chunkX + "_" + chunkY + ".bin";
 ...
 static void setDebugLoadAllChunks(bool b) {
 ...
 static void log(const std::string& str, Color col) {
 logger.log(str, col);
 }
 ...
 */
 static void squareChanged(IsoGridSquare gs) {
