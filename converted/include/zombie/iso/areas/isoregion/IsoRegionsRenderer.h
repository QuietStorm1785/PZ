...
public:
 private List<DataChunk> tempChunkList = std::make_unique<ArrayList<>>();
 private List<String> debugLines = std::make_unique<ArrayList<>>();
 float xPos;
 float yPos;
 float offx;
 float offy;
 ...
 int selectedY;
 int selectedZ;
 private HashSet<Integer> drawnCells = std::make_unique<HashSet<>>();
 bool editSquareInRange = false;
 int editSquareX;
 int editSquareY;
 private ArrayList<ConfigOption> editOptions = std::make_unique<ArrayList<>>();
 bool EditingEnabled = false;
 private IsoRegionsRenderer.BooleanDebugOption EditWallN = new IsoRegionsRenderer.BooleanDebugOption(this->editOptions, "Edit.WallN", false);
 private IsoRegionsRenderer.BooleanDebugOption EditWallW = new IsoRegionsRenderer.BooleanDebugOption(this->editOptions, "Edit.WallW", false);
 private IsoRegionsRenderer.BooleanDebugOption EditDoorN = new IsoRegionsRenderer.BooleanDebugOption(this->editOptions, "Edit.DoorN", false);
 private IsoRegionsRenderer.BooleanDebugOption EditDoorW = new IsoRegionsRenderer.BooleanDebugOption(this->editOptions, "Edit.DoorW", false);
 private IsoRegionsRenderer.BooleanDebugOption EditFloor = new IsoRegionsRenderer.BooleanDebugOption(this->editOptions, "Edit.Floor", false);
 private ArrayList<ConfigOption> zLevelOptions = std::make_unique<ArrayList<>>();
 private IsoRegionsRenderer.BooleanDebugOption zLevelPlayer = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.Player", true);
 private IsoRegionsRenderer.BooleanDebugOption zLevel0 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.0", false, 0);
 private IsoRegionsRenderer.BooleanDebugOption zLevel1 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.1", false, 1);
 private IsoRegionsRenderer.BooleanDebugOption zLevel2 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.2", false, 2);
 private IsoRegionsRenderer.BooleanDebugOption zLevel3 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.3", false, 3);
 private IsoRegionsRenderer.BooleanDebugOption zLevel4 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.4", false, 4);
 private IsoRegionsRenderer.BooleanDebugOption zLevel5 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.5", false, 5);
 private IsoRegionsRenderer.BooleanDebugOption zLevel6 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.6", false, 6);
 private IsoRegionsRenderer.BooleanDebugOption zLevel7 = new IsoRegionsRenderer.BooleanDebugOption(this->zLevelOptions, "zLevel.7", false, 7);
 static const int VERSION = 1;
 private ArrayList<ConfigOption> options = std::make_unique<ArrayList<>>();
 private IsoRegionsRenderer.BooleanDebugOption CellGrid = new IsoRegionsRenderer.BooleanDebugOption(this->options, "CellGrid", true);
 private IsoRegionsRenderer.BooleanDebugOption MetaGridBuildings = new IsoRegionsRenderer.BooleanDebugOption(this->options, "MetaGrid.Buildings", true);
 private IsoRegionsRenderer.BooleanDebugOption IsoRegionRender = new IsoRegionsRenderer.BooleanDebugOption(this->options, "IsoRegion.Render", true);
 private IsoRegionsRenderer.BooleanDebugOption IsoRegionRenderChunks = new IsoRegionsRenderer.BooleanDebugOption(
 this->options, "IsoRegion.RenderChunks", false
 );
 private IsoRegionsRenderer.BooleanDebugOption IsoRegionRenderChunksPlus = new IsoRegionsRenderer.BooleanDebugOption(
 ...
 void renderStringUI(float x, float y, const std::string& str, double r, double g, double b, double a) {
 ...
 void renderString(float x, float y, const std::string& str, double r, double g, double b, double a) {
 ...
 SpriteRenderer.instance.render(nullptr, float0, float1, w, h, r, g, b, a, nullptr);
 }
 }
 ...
 void outlineRect(float x, float y, float w, float h, float r, float g, float b, float a) {
 ...
 void renderCellInfo(int cellX, int cellY, int effectivePopulation, int targetPopulation, float lastRepopTime) {
 ...
 void renderEntity(float size, float x, float y, float r, float g, float b, float a) {
 ...
 void debugLine(const std::string& string) {
 ...
 std::vector arrayList = buildingDef.rooms.get(int10).getRects();
 ...
 float9 = 1.0F;
 if (chunkRegion0 != nullptr && chunkRegion1 != chunkRegion0) {
 float9 = 0.25F;
 }
 ...
 if (worldRegion1 != nullptr && worldRegion1.isEnclosed()) {
 float9 = 1.0F;
 Color color1;
 ...
 if (worldRegion0 != nullptr && worldRegion1 != worldRegion0) {
 float9 = 0.25F;
 }
 }
 ...
 thumpable1 = new IsoThumpable(IsoWorld.instance.getCell(), square, "walls_exterior_wooden_01_25", true, nullptr);
 } else {
 if (byte0 > 0 && Bits.hasFlags(byte0, 2) {
 return;
 }

 thumpable1 = new IsoThumpable(IsoWorld.instance.getCell(), square, "walls_exterior_wooden_01_24", true, nullptr);
 }
 ...
 thumpable0 = new IsoThumpable(IsoWorld.instance.getCell(), square, "walls_exterior_wooden_01_35", true, nullptr);
 } else {
 if (byte0 > 0 && Bits.hasFlags(byte0, 2) {
 return;
 }

 thumpable0 = new IsoThumpable(IsoWorld.instance.getCell(), square, "walls_exterior_wooden_01_34", true, nullptr);
 }
 ...
 void save() {
 std::string string = ZomboidFileSystem.instance.getCacheDir() + File.separator + "isoregions-options.ini";
 ...
 public BooleanDebugOption(ArrayList<ConfigOption> optionList, const std::string& name, bool defaultValue, int _zLevel) {
 ...
 public BooleanDebugOption(ArrayList<ConfigOption> optionList, const std::string& name, bool defaultValue) {
 super(name, defaultValue);
 this->index = optionList.size();
 optionList.add(this);
 }
