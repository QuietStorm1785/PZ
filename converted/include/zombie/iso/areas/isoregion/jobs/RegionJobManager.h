...
public:
private
  static final ConcurrentLinkedQueue<JobSquareUpdate> poolSquareUpdate =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  static final ConcurrentLinkedQueue<JobChunkUpdate> poolChunkUpdate =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  static final ConcurrentLinkedQueue<JobApplyChanges> poolApplyChanges =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  static final ConcurrentLinkedQueue<JobServerSendFullData>
      poolServerSendFullData = std::make_unique<ConcurrentLinkedQueue<>>();
private
  static final ConcurrentLinkedQueue<JobDebugResetAllData>
