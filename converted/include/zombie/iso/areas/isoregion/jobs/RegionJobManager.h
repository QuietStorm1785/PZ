...
public:
 private static ConcurrentLinkedQueue<JobSquareUpdate> poolSquareUpdate = std::make_unique<ConcurrentLinkedQueue<>>();
 private static ConcurrentLinkedQueue<JobChunkUpdate> poolChunkUpdate = std::make_unique<ConcurrentLinkedQueue<>>();
 private static ConcurrentLinkedQueue<JobApplyChanges> poolApplyChanges = std::make_unique<ConcurrentLinkedQueue<>>();
 private static ConcurrentLinkedQueue<JobServerSendFullData> poolServerSendFullData = std::make_unique<ConcurrentLinkedQueue<>>();
 private static ConcurrentLinkedQueue<JobDebugResetAllData> poolDebugResetAllData = std::make_unique<ConcurrentLinkedQueue<>>();
