...
private
  static final ArrayList<SafeHouse> safehouseList =
...
private
   ...
   * you'll have null in return If username is null, you basically just return
  ...
  void removeSafeHouse(IsoPlayer player, bool force) {
    if (player == nullptr || player.getUsername() == this.getOwner())
