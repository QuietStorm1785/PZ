...
class IsoRoom {
public:
 private static ArrayList<IsoGridSquare> tempSquares = std::make_unique<ArrayList<>>();
 public Vector<IsoGridSquare> Beds = std::make_unique<Vector<>>();
 Rectangle bounds;
 IsoBuilding building = nullptr;
 public ArrayList<ItemContainer> Containers = std::make_unique<ArrayList<>>();
 public ArrayList<IsoWindow> Windows = std::make_unique<ArrayList<>>();
 public Vector<IsoRoomExit> Exits = std::make_unique<Vector<>>();
 int layer;
 std::string RoomDef = "none";
 public Vector<IsoGridSquare> TileList = std::make_unique<Vector<>>();
 int transparentWalls = 0;
 public ArrayList<IsoLightSwitch> lightSwitches = std::make_unique<ArrayList<>>();
 public ArrayList<IsoRoomLight> roomLights = std::make_unique<ArrayList<>>();
 public ArrayList<IsoObject> WaterSources = std::make_unique<ArrayList<>>();
 int seen = 1000000000;
 int visited = 1000000000;
 RoomDef def;
 public ArrayList<RoomDef.RoomRect> rects = new ArrayList<>(1);
 public ArrayList<IsoGridSquare> Squares = std::make_unique<ArrayList<>>();
 ...
 */
 ...
 if (square != nullptr && square.getRoom() == this && square.isFree(true) {
 return square;
 }
