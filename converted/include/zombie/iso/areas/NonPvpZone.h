...
public:
 ...
 int size;
 std::string title;
 public static ArrayList<NonPvpZone> nonPvpZoneList = std::make_unique<ArrayList<>>();

 public NonPvpZone() {
 }

 public NonPvpZone(const std::string& _title, int _x, int _y, int _x2, int _y2) {
 if (_x > _x2) {
 int int0 = _x2;
 _x2 = _x;
 _x = int0;
 ...
 static NonPvpZone addNonPvpZone(const std::string& _title, int _x, int _y, int _x2, int _y2) {
