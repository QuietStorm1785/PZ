...
public:
  ...
  void test_ParticlesArray_time() {
    ...
    System.out.println("Add 1000000 elements = " + (long1 - long0) +
                       " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
    int int1 = 0;
    ...
    System.out.println("Delete " + int1 + " elements = " + (long1 - long0) +
                       " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
    long0 = System.currentTimeMillis();
    ...
    long1 = System.currentTimeMillis();
    System.out.println("Delete random " + int1 + " elements = " +
                       (long1 - long0) + " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
    long0 = System.currentTimeMillis();
    ...
    long1 = System.currentTimeMillis();
    System.out.println("Sort " + particlesArray.size() + " elements = " +
                       (long1 - long0) + " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
    int1 = 0;
    long0 = System.currentTimeMillis();
    ...
    particlesArray.defragmentParticle();
    long1 = System.currentTimeMillis();
    System.out.println("Defragment " + particlesArray.size() + " elements = " +
                       (long1 - long0) + " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
    long0 = System.currentTimeMillis();
    ...
    long1 = System.currentTimeMillis();
    System.out.println("Simple add " + int11 + " elements = " +
                       (long1 - long0) + " ms (size=" + particlesArray.size() +
                       ", count=" + particlesArray.getCount() + ")");
  }
}
