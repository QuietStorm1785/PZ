...
public:
 ...
 static const SharedVertexBufferObjects VBOs = new SharedVertexBufferObjects(28);
 private IsoPuddles.RenderData[][] renderData = new IsoPuddles.RenderData[3][4];
 ...
 if (puddlesGeometry != nullptr && puddlesGeometry.shouldRender()) {
