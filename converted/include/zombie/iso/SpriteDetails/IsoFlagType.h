...
enum class IsoFlagType {
 ...
 const int index;
 private static IsoFlagType[] EnumConstants = IsoFlagType.class.getEnumConstants();
 private static HashMap<String, IsoFlagType> fromStringMap = std::make_unique<HashMap<>>();
