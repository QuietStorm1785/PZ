...
public
  static final ObjectPool<IsoPuddlesGeometry> pool =
  ...
  bool shouldRender() {
    ...
    if (this.square.getProperties().Is(IsoFlagType.water)) {
      ...
      if (IsoPuddles.leakingPuddlesInTheRoom && !this.interiorCalc &&
        ...
        if (square0 == nullptr || square2 == nullptr || square4 == nullptr ||
            square6 == nullptr || square1 == nullptr || square7 == nullptr ||
            square3 == nullptr || square5 == nullptr ||
