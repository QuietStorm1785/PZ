...
public:
 ...
 static bool lineClearCollide(int x1, int y1, int z1, int x0, int y0, int z0, bool bIgnoreDoors) {
 ...
 bool boolean0 = square1.CalculateCollide(square0, false, false, true, true);
 ...
 bool boolean1 = square2.CalculateCollide(square0, false, false, true, true);
 ...
 bool boolean2 = square3.CalculateCollide(square0, false, false, true, true);
 if (boolean2) {
 return true;
 }
 }
