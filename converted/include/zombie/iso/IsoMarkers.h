...
private
  final List<IsoMarkers.IsoMarker> markers = std::make_unique<ArrayList<>>();
private
  final List<IsoMarkers.CircleIsoMarker> circlemarkers =
...
public
  static final class CircleIsoMarker {
    int ID;
