...
public:
 ...
 private List<IsoMarkers.IsoMarker> markers = std::make_unique<ArrayList<>>();
 private List<IsoMarkers.CircleIsoMarker> circlemarkers = std::make_unique<ArrayList<>>();
 ...
 void renderIsoMarkers(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 ...
 .render(texture, float0, float1, texture.getWidth(), texture.getHeight(), marker.r, marker.g, marker.b, marker.alpha, nullptr);
 }
 }
 }
 }
 ...
 void renderIsoMarkersDeferred(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 if (!GameServer.bServer && this->markers.size() != 0) {
 IsoPlayer player = IsoPlayer.players[playerIndex];
 if (player != nullptr) {
 for (int int0 = 0; int0 < this->markers.size(); int0++) {
 ...
 void renderIsoMarkersOnSquare(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 if (!GameServer.bServer && this->markers.size() != 0) {
 IsoPlayer player = IsoPlayer.players[playerIndex];
 if (player != nullptr) {
 for (int int0 = 0; int0 < this->markers.size(); int0++) {
 ...
 void renderCircleIsoMarkers(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 ...
 public static class CircleIsoMarker {
 int ID;
 ...
 void init(int _x, int _y, int _z, IsoGridSquare gs) {
 this->square = gs;
 }
 ...
 private ArrayList<Texture> overlayTextures = std::make_unique<ArrayList<>>();
 private ArrayList<IsoObject> tempObjects = std::make_unique<ArrayList<>>();
 IsoGridSquare square;
 float x;
 float y;
 float z;
 ...
 void init(KahluaTable textureTable, KahluaTable textureOverlayTable, int _x, int _y, int _z, IsoGridSquare gs) {
 this->square = gs;
 if (textureTable != nullptr) {
 int int0 = textureTable.len();

 for (int int1 = 1; int1 <= int0; int1++) {
 std::string string0 = Type.tryCastTo(textureTable.rawget(int1), String.class);
 ...
 std::string string1 = Type.tryCastTo(textureOverlayTable.rawget(int3), String.class);
 ...
 void init(KahluaTable textureTable, KahluaTable textureOverlayTable, int _x, int _y, int _z, IsoGridSquare gs, bool doTempIsoObject) {
 this->square = gs;
 if (doTempIsoObject) {
 if (textureTable != nullptr) {
 int int0 = textureTable.len();
 ...
 for (int int1 = 1; int1 <= int0; int1++) {
 std::string string = Type.tryCastTo(textureTable.rawget(int1), String.class);
 ...
 void init(const std::string& spriteName, int _x, int _y, int _z, IsoGridSquare gs, bool doTempIsoObject) {
 this->square = gs;
