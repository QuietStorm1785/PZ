...
public:
 ...
 private Stack<WeatherPeriod.WeatherStage> stagesPool = std::make_unique<Stack<>>();
 ...
 ClimateColorInfo cloudColorReddish = new ClimateColorInfo(0.66F, 0.12F, 0.12F, 0.4F);
 ClimateColorInfo cloudColorGreenish = new ClimateColorInfo(0.32F, 0.48F, 0.12F, 0.4F);
 ClimateColorInfo cloudColorBlueish = new ClimateColorInfo(0.16F, 0.48F, 0.48F, 0.4F);
 ClimateColorInfo cloudColorPurplish = new ClimateColorInfo(0.66F, 0.12F, 0.66F, 0.4F);
 ClimateColorInfo cloudColorTropical = new ClimateColorInfo(0.4F, 0.2F, 0.2F, 0.4F);
 ClimateColorInfo cloudColorBlizzard = new ClimateColorInfo(0.12F, 0.13F, 0.21F, 0.5F, 0.38F, 0.4F, 0.5F, 0.8F);
 ...
 private static HashMap<Integer, WeatherPeriod.StrLerpVal> cache = std::make_unique<HashMap<>>();
 ...
 void setCloudColor(ClimateColorInfo cloudcol) {
 ...
 void initSimulationDebug(ClimateManager.AirFront front, double hoursSinceStart) {
 GameTime gameTime = GameTime.getInstance();
 this->init(front, hoursSinceStart, gameTime.getYear(), gameTime.getMonth(), gameTime.getDayPlusOne(), -1, -1.0F);
 }

 void initSimulationDebug(ClimateManager.AirFront front, double hoursSinceStart, int doThisStageOnly, float singleStageDuration) {
 GameTime gameTime = GameTime.getInstance();
 ...
 void init(ClimateManager.AirFront airFront, double double0, int int0, int int1, int int2) {
 this->init(airFront, double0, int0, int1, int2, -1, -1.0F);
 }

 void init(ClimateManager.AirFront airFront, double double0, int int0, int int1, int int2, int int3, float float0) {
 ...
 this->climateManager.transmitClimatePacket(ClimateManager.ClimateNetAuth.ServerOnly, (byte)1, nullptr);
 }
 ...
 if (this->currentStage.stageID == 11 && boolean0 && thunderCloud != nullptr) {
 ...
 */
 ...
 WeatherPeriod.WeatherStage weatherStage = !this->stagesPool.empty() ? this->stagesPool.pop() : new WeatherPeriod.WeatherStage();
 ...
 void setTargetStrength(float t) {
 ...
 void setHasStartedCloud(bool b) {
 ...
 void lerpEntryTo(WeatherPeriod.StrLerpVal strLerpVal0, WeatherPeriod.StrLerpVal strLerpVal1) {
 if (!this->creationFinished) {
