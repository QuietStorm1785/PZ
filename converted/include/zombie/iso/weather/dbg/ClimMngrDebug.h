...
public:
 ...
 public ArrayList<ClimMngrDebug.RunInfo> runs = std::make_unique<ArrayList<>>();
 ...
 std::string string0 = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
 ...
 std::string string1 = ZomboidFileSystem.instance.getFileNameInCurrentSave("climate", string0 + ".txt");
 ...
 int durationDays;
 double durationHours;
 public ArrayList<ClimMngrDebug.RecordInfo> records = std::make_unique<ArrayList<>>();
 ...
 public ArrayList<Integer> exceedingPeriods = std::make_unique<ArrayList<>>();
 public ArrayList<Integer> exceedingEmpties = std::make_unique<ArrayList<>>();
 ...
 ClimMngrDebug.RecordInfo recordInfo = ClimMngrDebug.this->std::make_unique<RecordInfo>();
