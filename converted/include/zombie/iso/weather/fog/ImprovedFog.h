...
class ImprovedFog {
public:
 private static ImprovedFog.RectangleIterator rectangleIter = new ImprovedFog.RectangleIterator();
 ...
 static const SteppedUpdateFloat fogIntensity = new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 static int keyPause = 0;
 private static float[] offsets = new float[]{
 0.3F,
 0.8F,
 0.0F,
 0.6F,
 ...
 static void setMinXOffset(int _minXOffset) {
 ...
 static void setMaxXOffset(int _maxXOffset) {
 ...
 static void setMaxYOffset(int _maxYOffset) {
 ...
 static void setHighQuality(bool _highQuality) {
 ...
 static void setOctaves(float _octaves) {
 octaves = _octaves;
 }
 ...
 static void setColorR(float _colorR) {
 colorR = _colorR;
 }
 ...
 static void setColorG(float _colorG) {
 colorG = _colorG;
 }
 ...
 static void setColorB(float _colorB) {
 colorB = _colorB;
 }
 ...
 static void setScalingX(float _scalingX) {
 scalingX = _scalingX;
 }
 ...
 static void setScalingY(float _scalingY) {
 scalingY = _scalingY;
 }
 ...
 static void setBaseAlpha(float _baseAlpha) {
 ...
 bool boolean0 = true;
 if (square != nullptr && (!square.isExteriorCache || square.isInARoom())) {
 boolean0 = false;
 }
 ...
 if (tex != nullptr && !(subW <= 0.0) && !(subH <= 0.0) && !(w <= 0.0) && !(h <= 0.0) {
