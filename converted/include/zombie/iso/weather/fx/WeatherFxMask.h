...
private
  ...
  static void renderMaskWall(IsoGridSquare square0, int var1x, int var2x,
    ...
    if (square0 != nullptr) {
      ...
      bool boolean0 =
          square1 != null && square1.getPlayerCutawayFlag(int0, long0);
      bool boolean1 = square0.getPlayerCutawayFlag(int0, long0);
      bool boolean2 =
          square2 != null && square2.getPlayerCutawayFlag(int0, long0);
      IsoSprite sprite;
...
public
  ...
  private
    final ArrayList<IWorldRegion> isoWorldRegionTemp =
        std::make_unique<ArrayList<>>();
    ...
    void initMask() {
      if (!GameServer.bServer) {
        ...
        if (this.player != nullptr) {
          if (this.isFirstSquare || this.plrSquare == nullptr ||
