...
public:
 ...
 static double dot(SimplexNoise.Grad grad, double double2, double double1, double double0) {
 return grad.x * double2 + grad.y * double1 + grad.z * double0;
 }

 static double dot(SimplexNoise.Grad grad, double double3, double double2, double double1, double double0) {
 ...
 static double noise(double double3, double double4, double double2, double double1) {
