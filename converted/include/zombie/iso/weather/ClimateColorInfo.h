...
public:
 ...
 ClimateColorInfo interp(ClimateColorInfo to, float t, ClimateColorInfo result) {
 ...
 static ClimateColorInfo interp(ClimateColorInfo source, ClimateColorInfo target, float t, ClimateColorInfo resultColorInfo) {
 ...
 try {
 std::string string0 = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
 std::string string1 = "ClimateMain_" + string0;
 std::string string2 = ZomboidFileSystem.instance.getCacheDir() + File.separator + string1 + ".lua";
 ...
 static void writeSeasonColor(int int0, ClimateColorInfo climateColorInfo, const std::string& string2, const std::string& string0, const std::string& string1) {
