...
public:
 ...
 private ClimateManager.ClimateFloat[] climateFloats = new ClimateManager.ClimateFloat[13];
 static const int COLOR_GLOBAL_LIGHT = 0;
 static const int COLOR_NEW_FOG = 1;
 static const int COLOR_MAX = 2;
 private ClimateManager.ClimateColor[] climateColors = new ClimateManager.ClimateColor[2];
 static const int BOOL_IS_SNOW = 0;
 static const int BOOL_MAX = 1;
 private ClimateManager.ClimateBool[] climateBooleans = new ClimateManager.ClimateBool[1];
 ...
 ClimateColorInfo colFlare = new ClimateColorInfo(1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F);
 bool flareLaunched = false;
 SteppedUpdateFloat flareIntensity = new SteppedUpdateFloat(0.0F, 0.01F, 0.0F, 1.0F);
 float flareIntens;
 ...
 static float ToKph(float val) {
 return val * 120.0F;
 }

 static float ToMph(float val) {
 return val * 74.5645F;
 }
 ...
 static void setInstance(ClimateManager inst) {
 instance = inst;
 }
 ...
 void setDayLightStrength(float f) {
 ...
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ServerOnly, (byte)1, nullptr);
 }
 }
 }
 ...
 : this->getAirTemperatureForSquare(plr.square, nullptr, doWindChill);
 } else {
 ...
 float getAirTemperatureForSquare(IsoGridSquare square, BaseVehicle vehicle, bool doWindChill) {
 ...
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ServerOnly, (byte)0, nullptr);
 ...
 void setSeasonColorDawn(int _temperature, int _season, float r, float g, float b, float a, bool exterior) {
 if (exterior) {
 ...
 void setSeasonColorDay(int _temperature, int _season, float r, float g, float b, float a, bool exterior) {
 if (exterior) {
 ...
 void setSeasonColorDusk(int _temperature, int _season, float r, float g, float b, float a, bool exterior) {
 if (exterior) {
 ...
 return seasonColor != nullptr ? seasonColor.getColor(_temperature, _season) : nullptr;
 }
 ...
 */
 ...
 void setDayInfo(ClimateManager.DayInfo dayInfo, int int2, int int1, int int0, int int3) {
 ...
 void transmitClimatePacket(ClimateManager.ClimateNetAuth climateNetAuth, uint8_t byte0, UdpConnection udpConnection1) {
 if (GameClient.bClient || GameServer.bServer) {
 ...
 bool readPacketContents(ByteBuffer byteBuffer, uint8_t byte0, UdpConnection var3) {
 switch (byte0) {
 case 0:
 if (!GameClient.bClient) {
 return false;
 ...
 byteBuffer.get();
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ServerOnly, (byte)4, nullptr);
 return true;
 case 6:
 if (!GameServer.bServer) {
 return false;
 ...
 void transmitServerTriggerLightning(int x, int y, bool doStrike, bool doLightning, bool doRumble) {
 if (GameServer.bServer) {
 if (this->networkPrint) {
 ...
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ClientOnly, (byte)5, nullptr);
 }
 ...
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ClientOnly, (byte)6, nullptr);
 }
 ...
 this->transmitClimatePacket(ClimateManager.ClimateNetAuth.ClientOnly, (byte)7, nullptr);
 }
 ...
 float getTimeLerpHours(float float2, float float1, float float0, bool boolean0) {
 ...
 static float normalizeRange(float v, float n) {
 return clamp(v /);
 }
 ...
 void triggerKateBobIntroStorm(int centerX, int centerY, double duration, float strength, float initialProgress, float angle, float initialPuddles) {
 this->triggerKateBobIntroStorm(centerX, centerY, duration, strength, initialProgress, angle, initialPuddles, nullptr);
 }
 ...
 void setFrontWind(float float0) {
 ...
 void setEnableModded(bool b) {
 this->isModded = b;
 }

 void setModdedValue(bool b) {
 this->moddedValue = b;
 }
 ...
 void setAdminValue(float r, float g, float b, float a, float r1, float g1, float b1, float a1) {
 ...
 void setAdminValue(ClimateColorInfo targ) {
 ...
 void setModdedValue(ClimateColorInfo targ) {
 ...
 void setFinalValue(ClimateColorInfo targ) {
 ...
 */
 ...
 void setIgnoreNormal(bool arg0) {
 ...
 void setColorInterior(int arg0, int arg1, float arg2, float arg3, float arg4, float arg5) {
 ...
 void setColorExterior(int arg0, int arg1, float arg2, float arg3, float arg4, float arg5) {
