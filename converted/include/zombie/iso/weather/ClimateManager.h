...
private
  final ClimateManager.ClimateFloat[] climateFloats =
...
private
  final ClimateManager.ClimateColor[] climateColors =
      new ClimateManager.ClimateColor[2];
  static const int BOOL_IS_SNOW = 0;
  static const int BOOL_MAX = 1;
private
  final ClimateManager.ClimateBool[] climateBooleans =
...
public
  ...
  void updateDayInfo(int int2, int int1, int int0) {
    this.tickIsDayChange = false;
    if (this.currentDay == nullptr || this.currentDay.day != int2 ||
