...
public:
 ...
 static void applyPaddingBorder(TextureDraw textureDraw, float float5, float float8) {
 ...
 static void applyIsoPadding(TextureDraw textureDraw, SpritePadding.IsoPaddingSettings paddingSettings) {
