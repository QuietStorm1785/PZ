...
public:
 public static ObjectPool<IsoSpriteInstance> pool = new ObjectPool<>(IsoSpriteInstance::new);
 ...
 this->parentSprite.render(spriteInstance, nullptr, x, y, z, IsoDirections.N, 0.0F, -144.0F, IsoGridSquare.getDefColorInfo(), true);
 }
 }
