...
public:
 ...
 int Speed = 3;
 public SandboxOptions.EnumSandboxOption Zombies;
 public SandboxOptions.EnumSandboxOption Distribution;
 public SandboxOptions.EnumSandboxOption DayLength;
 public SandboxOptions.EnumSandboxOption StartYear;
 public SandboxOptions.EnumSandboxOption StartMonth;
 public SandboxOptions.EnumSandboxOption StartDay;
 public SandboxOptions.EnumSandboxOption StartTime;
 public SandboxOptions.EnumSandboxOption WaterShut;
 public SandboxOptions.EnumSandboxOption ElecShut;
 public SandboxOptions.IntegerSandboxOption WaterShutModifier;
 public SandboxOptions.IntegerSandboxOption ElecShutModifier;
 public SandboxOptions.EnumSandboxOption FoodLoot;
 public SandboxOptions.EnumSandboxOption LiteratureLoot;
 public SandboxOptions.EnumSandboxOption MedicalLoot;
 public SandboxOptions.EnumSandboxOption SurvivalGearsLoot;
 public SandboxOptions.EnumSandboxOption CannedFoodLoot;
 public SandboxOptions.EnumSandboxOption WeaponLoot;
 public SandboxOptions.EnumSandboxOption RangedWeaponLoot;
 public SandboxOptions.EnumSandboxOption AmmoLoot;
 public SandboxOptions.EnumSandboxOption MechanicsLoot;
 public SandboxOptions.EnumSandboxOption OtherLoot;
 public SandboxOptions.EnumSandboxOption Temperature;
 public SandboxOptions.EnumSandboxOption Rain;
 public SandboxOptions.EnumSandboxOption ErosionSpeed;
 public SandboxOptions.IntegerSandboxOption ErosionDays;
 public SandboxOptions.DoubleSandboxOption XpMultiplier;
 public SandboxOptions.BooleanSandboxOption XpMultiplierAffectsPassive;
 public SandboxOptions.EnumSandboxOption Farming;
 public SandboxOptions.EnumSandboxOption CompostTime;
 public SandboxOptions.EnumSandboxOption StatsDecrease;
 public SandboxOptions.EnumSandboxOption NatureAbundance;
 public SandboxOptions.EnumSandboxOption Alarm;
 public SandboxOptions.EnumSandboxOption LockedHouses;
 public SandboxOptions.BooleanSandboxOption StarterKit;
 public SandboxOptions.BooleanSandboxOption Nutrition;
 public SandboxOptions.EnumSandboxOption FoodRotSpeed;
 public SandboxOptions.EnumSandboxOption FridgeFactor;
 public SandboxOptions.EnumSandboxOption LootRespawn;
 public SandboxOptions.IntegerSandboxOption SeenHoursPreventLootRespawn;
 public SandboxOptions.StringSandboxOption WorldItemRemovalList;
 public SandboxOptions.DoubleSandboxOption HoursForWorldItemRemoval;
 public SandboxOptions.BooleanSandboxOption ItemRemovalListBlacklistToggle;
 public SandboxOptions.EnumSandboxOption TimeSinceApo;
 public SandboxOptions.EnumSandboxOption PlantResilience;
 public SandboxOptions.EnumSandboxOption PlantAbundance;
 public SandboxOptions.EnumSandboxOption EndRegen;
 public SandboxOptions.EnumSandboxOption Helicopter;
 public SandboxOptions.EnumSandboxOption MetaEvent;
 public SandboxOptions.EnumSandboxOption SleepingEvent;
 public SandboxOptions.DoubleSandboxOption GeneratorFuelConsumption;
 public SandboxOptions.EnumSandboxOption GeneratorSpawning;
 public SandboxOptions.EnumSandboxOption SurvivorHouseChance;
 public SandboxOptions.EnumSandboxOption AnnotatedMapChance;
 public SandboxOptions.IntegerSandboxOption CharacterFreePoints;
 public SandboxOptions.EnumSandboxOption ConstructionBonusPoints;
 public SandboxOptions.EnumSandboxOption NightDarkness;
 public SandboxOptions.EnumSandboxOption NightLength;
 public SandboxOptions.BooleanSandboxOption BoneFracture;
 public SandboxOptions.EnumSandboxOption InjurySeverity;
 public SandboxOptions.DoubleSandboxOption HoursForCorpseRemoval;
 public SandboxOptions.EnumSandboxOption DecayingCorpseHealthImpact;
 public SandboxOptions.EnumSandboxOption BloodLevel;
 public SandboxOptions.EnumSandboxOption ClothingDegradation;
 public SandboxOptions.BooleanSandboxOption FireSpread;
 public SandboxOptions.IntegerSandboxOption DaysForRottenFoodRemoval;
 public SandboxOptions.BooleanSandboxOption AllowExteriorGenerator;
 public SandboxOptions.EnumSandboxOption MaxFogIntensity;
 public SandboxOptions.EnumSandboxOption MaxRainFxIntensity;
 public SandboxOptions.BooleanSandboxOption EnableSnowOnGround;
 public SandboxOptions.BooleanSandboxOption AttackBlockMovements;
 public SandboxOptions.EnumSandboxOption VehicleStoryChance;
 public SandboxOptions.EnumSandboxOption ZoneStoryChance;
 public SandboxOptions.BooleanSandboxOption AllClothesUnlocked;
 public SandboxOptions.BooleanSandboxOption EnableTaintedWaterText;
 public SandboxOptions.BooleanSandboxOption EnableVehicles;
 public SandboxOptions.EnumSandboxOption CarSpawnRate;
 public SandboxOptions.DoubleSandboxOption ZombieAttractionMultiplier;
 public SandboxOptions.BooleanSandboxOption VehicleEasyUse;
 public SandboxOptions.EnumSandboxOption InitialGas;
 public SandboxOptions.EnumSandboxOption FuelStationGas;
 public SandboxOptions.EnumSandboxOption LockedCar;
 public SandboxOptions.DoubleSandboxOption CarGasConsumption;
 public SandboxOptions.EnumSandboxOption CarGeneralCondition;
 public SandboxOptions.EnumSandboxOption CarDamageOnImpact;
 public SandboxOptions.EnumSandboxOption DamageToPlayerFromHitByACar;
 public SandboxOptions.BooleanSandboxOption TrafficJam;
 public SandboxOptions.EnumSandboxOption CarAlarm;
 public SandboxOptions.BooleanSandboxOption PlayerDamageFromCrash;
 public SandboxOptions.DoubleSandboxOption SirenShutoffHours;
 public SandboxOptions.EnumSandboxOption ChanceHasGas;
 public SandboxOptions.EnumSandboxOption RecentlySurvivorVehicles;
 public SandboxOptions.BooleanSandboxOption MultiHitZombies;
 public SandboxOptions.EnumSandboxOption RearVulnerability;
 public SandboxOptions.EnumSandboxOption EnablePoisoning;
 public SandboxOptions.EnumSandboxOption MaggotSpawn;
 public SandboxOptions.DoubleSandboxOption LightBulbLifespan;
 protected ArrayList<SandboxOptions.SandboxOption> options = std::make_unique<ArrayList<>>();
 protected HashMap<String, SandboxOptions.SandboxOption> optionByName = std::make_unique<HashMap<>>();
 public SandboxOptions.Map Map = new SandboxOptions.Map();
 public SandboxOptions.ZombieLore Lore = new SandboxOptions.ZombieLore();
 public SandboxOptions.ZombieConfig zombieConfig = new SandboxOptions.ZombieConfig();
 const int FIRST_YEAR = 1993;
 const int SANDBOX_VERSION = 5;
 private ArrayList<SandboxOptions.SandboxOption> m_customOptions = std::make_unique<ArrayList<>>();
 ...
 static SandboxOptions getInstance() {
 return instance;
 }
 ...
 */
 ...
 std::unordered_set hashSet = nullptr;
 if (boolean0 && int0 == 1) {
 ...
 bool boolean0 = this->readLuaFile(ServerSettingsManager.instance.getNameInSettingsFolder(serverName + "_SandboxVars.lua"));
 ...
 if (!file.exists()) {
 throw RuntimeException("media/lua/shared/Sandbox/" + presetName + ".lua not found");
 } else {
 try {
 ...
 throw RuntimeException(file.getName() + " must return a SandboxVars table");
 } else {
 for (int int0 = 0; int0 < this->options.size(); int0++) {
 ...
 std::string string = ZomboidFileSystem.instance.getFileNameInCurrentSave("zombies.ini");
 ConfigFile configFile = new ConfigFile();
 ...
 std::string string = ServerSettingsManager.instance.getNameInSettingsFolder(GameServer.ServerName + "_zombies.ini");
 ...
 std::string string = ServerSettingsManager.instance.getNameInSettingsFolder(serverName + "_zombies.ini");
 ConfigFile configFile = new ConfigFile();
 if (configFile.read(string) {
 for (int int0 = 0; int0 < configFile.getOptions().size(); int0++) {
 ConfigOption configOption = configFile.getOptions().get(int0);
 ...
 hashMap.put(sandboxOption0.getTableName(), std::make_unique<ArrayList>());
 ...
 try {
 std::string string3 = enumSandboxOption.getValueTranslationByIndexOrNull(int0);
 if (string3 != nullptr) {
 ...
 for (auto& string4 : arrayList) fileWriter.write(" " + string4 + " = {" + string1);
 ...
 try {
 std::string string6 = ((SandboxOptions.EnumSandboxOption)sandboxOption2).getValueTranslationByIndexOrNull(int1);
 if (string6 != nullptr) {
 ...
 std::string upgradeOptionValue(const std::string& string0, const std::string& string1, int int0) {
 ...
 KahluaTable upgradeLuaTable(const std::string& object, KahluaTable table1, int int0) {
 ...
 std::string string0 = this->upgradeOptionName(object + kahluaTableIterator.getKey(), int0);
 std::string string1 = this->upgradeOptionValue(string0, kahluaTableIterator.getValue().toString(), int0);
 ...
 throw IllegalArgumentException("unhandled CustomSandboxOption " + customSandboxOption);
 }
 }
 }
 }
 ...
 void addCustomOption(SandboxOptions.SandboxOption sandboxOption, CustomSandboxOption customSandboxOption) {
 ...
 public BooleanSandboxOption(SandboxOptions owner, const std::string& name, bool defaultValue) {
 ...
 public DoubleSandboxOption(SandboxOptions owner, const std::string& name, double min, double max, double defaultValue) {
 ...
 public EnumSandboxOption(SandboxOptions owner, const std::string& name, int numValues, int defaultValue) {
 ...
 public IntegerSandboxOption(SandboxOptions owner, const std::string& name, int min, int max, int defaultValue) {
 super(name, min, max, defaultValue);
 String[] strings = SandboxOptions.parseName(name);
 this->tableName = strings[0];
 this->shortName = strings[1];
 ...
 public StringSandboxOption(SandboxOptions owner, const std::string& name, const std::string& defaultValue, int maxLength) {
 ...
 public SandboxOptions.DoubleSandboxOption PopulationStartMultiplier = SandboxOptions.this->newDoubleOption(
 "ZombieConfig.PopulationStartMultiplier", 0.0, 4.0, 1.0
 );
 public SandboxOptions.DoubleSandboxOption PopulationPeakMultiplier = SandboxOptions.this->newDoubleOption(
 "ZombieConfig.PopulationPeakMultiplier", 0.0, 4.0, 1.5
 );
 public SandboxOptions.IntegerSandboxOption PopulationPeakDay = SandboxOptions.this->newIntegerOption("ZombieConfig.PopulationPeakDay", 1, 365, 28);
 public SandboxOptions.DoubleSandboxOption RespawnHours = SandboxOptions.this->newDoubleOption("ZombieConfig.RespawnHours", 0.0, 8760.0, 72.0);
 public SandboxOptions.DoubleSandboxOption RespawnUnseenHours = SandboxOptions.this->newDoubleOption(
 "ZombieConfig.RespawnUnseenHours", 0.0, 8760.0, 16.0
 );
 public SandboxOptions.DoubleSandboxOption RespawnMultiplier = SandboxOptions.this->newDoubleOption("ZombieConfig.RespawnMultiplier", 0.0, 1.0, 0.1);
 public SandboxOptions.DoubleSandboxOption RedistributeHours = SandboxOptions.this->newDoubleOption(
 "ZombieConfig.RedistributeHours", 0.0, 8760.0, 12.0
 );
 public SandboxOptions.IntegerSandboxOption FollowSoundDistance = SandboxOptions.this->newIntegerOption(
 "ZombieConfig.FollowSoundDistance", 10, 1000, 100
 );
 public SandboxOptions.IntegerSandboxOption RallyGroupSize = SandboxOptions.this->newIntegerOption("ZombieConfig.RallyGroupSize", 0, 1000, 20);
 public SandboxOptions.IntegerSandboxOption RallyTravelDistance = SandboxOptions.this->newIntegerOption(
 "ZombieConfig.RallyTravelDistance", 5, 50, 20
 );
 public SandboxOptions.IntegerSandboxOption RallyGroupSeparation = SandboxOptions.this->newIntegerOption(
 "ZombieConfig.RallyGroupSeparation", 5, 25, 15
 );
 public SandboxOptions.IntegerSandboxOption RallyGroupRadius = SandboxOptions.this->newIntegerOption("ZombieConfig.RallyGroupRadius", 1, 10, 3);
 ...
 public SandboxOptions.EnumSandboxOption Toughness = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.Toughness", 4, 2
 )
 .setTranslation("ZToughness");
 public SandboxOptions.EnumSandboxOption Transmission = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.Transmission", 4, 1
 )
 .setTranslation("ZTransmission");
 public SandboxOptions.EnumSandboxOption Mortality = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.Mortality", 7, 5
 )
 .setTranslation("ZInfectionMortality");
 public SandboxOptions.EnumSandboxOption Reanimate = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.Reanimate", 6, 3
 )
 .setTranslation("ZReanimateTime");
 public SandboxOptions.EnumSandboxOption Cognition = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.Cognition", 4, 3
 )
 .setTranslation("ZCognition");
 public SandboxOptions.EnumSandboxOption CrawlUnderVehicle = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.CrawlUnderVehicle", 7, 5
 )
 .setTranslation("ZCrawlUnderVehicle");
 public SandboxOptions.EnumSandboxOption Memory = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption("ZombieLore.Memory", 5, 2)
 .setTranslation("ZMemory");
 public SandboxOptions.EnumSandboxOption Sight = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption("ZombieLore.Sight", 4, 2)
 .setTranslation("ZSight");
 public SandboxOptions.EnumSandboxOption Hearing = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption("ZombieLore.Hearing", 4, 2)
 .setTranslation("ZHearing");
 public SandboxOptions.BooleanSandboxOption ThumpNoChasing = SandboxOptions.this->newBooleanOption("ZombieLore.ThumpNoChasing", false);
 public SandboxOptions.BooleanSandboxOption ThumpOnConstruction = SandboxOptions.this->newBooleanOption("ZombieLore.ThumpOnConstruction", true);
 public SandboxOptions.EnumSandboxOption ActiveOnly = (SandboxOptions.EnumSandboxOption)SandboxOptions.this->newEnumOption(
 "ZombieLore.ActiveOnly", 3, 1
 )
 .setTranslation("ActiveOnly");
 public SandboxOptions.BooleanSandboxOption TriggerHouseAlarm = SandboxOptions.this->newBooleanOption("ZombieLore.TriggerHouseAlarm", false);
 public SandboxOptions.BooleanSandboxOption ZombiesDragDown = SandboxOptions.this->newBooleanOption("ZombieLore.ZombiesDragDown", true);
 public SandboxOptions.BooleanSandboxOption ZombiesFenceLunge = SandboxOptions.this->newBooleanOption("ZombieLore.ZombiesFenceLunge", true);
 public SandboxOptions.EnumSandboxOption DisableFakeDead = SandboxOptions.this->newEnumOption("ZombieLore.DisableFakeDead", 3, 1);
