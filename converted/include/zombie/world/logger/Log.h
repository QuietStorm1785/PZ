...
class Log {
public:
 public static class BaseItemLog extends Log.BaseLog {
 ...
 public Comment(const std::string& string) {
 ...
 public Info(const std::string& string0, const std::string& string1, int int0, List<String> list) {
 this->ignoreSaveCheck = true;
 ...
 public ModIDChangedItem(ItemInfo itemInfo, const std::string& string0, const std::string& string1) {
 super(itemInfo);
 ...
 public RegisterObject(const std::string& string, int int0) {
 ...
 public RemovedItem(ItemInfo itemInfo, bool boolean0) {
 super(itemInfo);
