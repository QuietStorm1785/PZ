...
public:
 ...
 if (Rand.NextBool(3) {
 this->addWorldItem(
 "Base.Spoon", this->table1.getSquare(), 0.3359F, 0.9765F, this->table1.getSurfaceOffsetNoTable() / 96.0F, Rand.Next(260, 275)
 );
 }
 ...
 if (Rand.Next(100) < 70) {
 this->addWorldItem(
 Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl",
 ...
 if (Rand.NextBool(3) {
 this->addWorldItem(
 "Base.Spoon", this->table2.getSquare(), 0.8468F, 0.8906F, this->table1.getSurfaceOffsetNoTable() / 96.0F, Rand.Next(260, 275)
 );
 }
 }
 ...
 this->addWorldItem(
 Rand.NextBool(2) ? "Base.PotOfSoup" : "Base.PotOfStew",
 this->table2.getSquare(),
 0.289F,
 0.585F,
 this->table1.getSurfaceOffsetNoTable() / 96.0F
