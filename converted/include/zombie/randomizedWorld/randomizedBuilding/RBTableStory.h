...
public:
 public static ArrayList<RBTableStory.StoryDef> allStories = std::make_unique<ArrayList<>>();
 float xOffset = 0.0F;
 float yOffset = 0.0F;
 ...
 arrayList1.add(new RBTableStory.StorySpawnItem(linkedHashMap, nullptr, 100);
 arrayList1.add(new RBTableStory.StorySpawnItem(nullptr, "Chocolate", 100);
 ...
 arrayList1.add(new RBTableStory.StorySpawnItem(nullptr, "EggCarton", 100);
 ...
 void doSpawnTable(ArrayList<RBTableStory.StorySpawnItem> arrayList, bool boolean0) {
 this->xOffset = 0.0F;
 this->yOffset = 0.0F;
 int int0 = 0;
 if (boolean0) {
 ...
 void increaseOffsets(bool boolean0, RBTableStory.StorySpawnItem storySpawnItem) {
 ...
 return nullptr;
 } else if (storySpawnItem.eitherObject != nullptr && !storySpawnItem.eitherObject.empty()) {
 ...
 public StorySpawnItem(Integer> linkedHashMap, const std::string& string, int integer) {
 this->eitherObject = linkedHashMap;
 this->object = string;
 this->chanceToSpawn = integer;
 }

 public StorySpawnItem(Integer> linkedHashMap, const std::string& string, int integer, float float0) {
 this->eitherObject = linkedHashMap;
 this->object = string;
 this->chanceToSpawn = integer;
