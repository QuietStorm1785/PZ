        ...
        for (int int2 = 0; int2 < 8; int2++) {
          ...
          if (square != nullptr) {
            for (int int3 = 0; int3 < square.getObjects().size(); int3++) {
              ...
              if (Rand.NextBool(2) &&
                  "location_restaurant_pizzawhirled_01_16" ==
                      object.getSprite().getName())) {
                  int int4 = Rand.Next(1, 4);

                  for (int int5 = 0; int5 < int4; int5++) {
                    square.AddWorldInventoryItem("Money", Rand.Next(0.0F, 0.5F),
                                                 Rand.Next(0.0F, 0.5F), 0.0F);
                  }
                  ...
                  for (int int7 = 0; int7 < int6; int7++) {
                    ...
                    case 1:
                      square.AddWorldInventoryItem(
                          boolean0 ? "Trousers" : "TightsFishnet_Ground",
                          Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                      arrayList.add(1);
                      break;
                    case 2:
                      square.AddWorldInventoryItem("Vest_DefaultTEXTURE_TINT",
                                                   Rand.Next(0.0F, 0.5F),
                                                   Rand.Next(0.0F, 0.5F), 0.0F);
                      arrayList.add(2);
                      break;
                    case 3:
                      square.AddWorldInventoryItem(
                          boolean0 ? "Jacket_Fireman" : "BunnySuitBlack",
                          Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                      arrayList.add(3);
                      break;
                    case 4:
                      square.AddWorldInventoryItem(
                          boolean0 ? "Hat_Cowboy" : "Garter",
                          Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                      arrayList.add(4);
                      break;
                    case 5:
                      if (!boolean0) {
                        square.AddWorldInventoryItem(
                            "StockingsBlack", Rand.Next(0.0F, 0.5F),
                            Rand.Next(0.0F, 0.5F), 0.0F);
                      }
              ...
              if ("furniture_tables_high_01_16" == object.getSprite().getName())
                                ...
                                || "furniture_tables_high_01_18" == object.getSprite().getName())) {
                                  ...
                                  if (Rand.NextBool(3)) {
                                    this.addWorldItem("Cigarettes", square,
                                                      object);
                                    if (Rand.NextBool(2)) {
                                      this.addWorldItem("Lighter", square,
                                                        object);
                                    }
                                  }
                                  ...
                                  case 0:
                                    square.AddWorldInventoryItem(
                                        "WhiskeyFull", Rand.Next(0.5F, 1.0F),
                                        Rand.Next(0.5F, 1.0F),
                                        object.getSurfaceOffsetNoTable() /
                                            96.0F);
                                    break;
                                  ...
                                  case 4:
                                    square.AddWorldInventoryItem(
                                        "BeerBottle", Rand.Next(0.5F, 1.0F),
                                        Rand.Next(0.5F, 1.0F),
                                        object.getSurfaceOffsetNoTable() /
                                            96.0F);
                                  }
