...
public:
 ...
 return square0 != nullptr && square1 != nullptr ? square0.getRoomID() == roomDef.ID != (square1.getRoomID() == roomDef.ID) : false;
 } else {
 return false;
 }
 }
 ...
 ((IsoGridSquare)object).getX(), ((IsoGridSquare)object).getY(), ((IsoGridSquare)object).getZ(), nullptr, Rand.Next(5, 10)
 );
 }
