...
/**
 * Create some zombies in sports outfits with crisps, alcohol & cigarettes lying
 * around
 */
class RDSFootballNight : public RandomizedDeadSurvivorBase {
public:
private
  final ArrayList<String> items = std::make_unique<ArrayList<>>();
private
  final ArrayList<String> otherItems = std::make_unique<ArrayList<>>();
