...
public:
 ...
 this->addZombiesOnSquare(1, "Swimmer", nullptr, this->getRandomFreeSquare(this, zone);
 }

 int9 = Rand.Next(1, 3);

 for (int int11 = 0; int11 < int9; int11++) {
 this->addZombiesOnSquare(1, "Tourist", nullptr, this->getRandomFreeSquare(this, zone);
 }
 }
}
} // namespace randomizedZoneStory
