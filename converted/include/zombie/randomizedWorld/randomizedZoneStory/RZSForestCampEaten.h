...
public:
 ...
 std::vector arrayList3 = this->addZombiesOnSquare(1, "Camper", nullptr, this->getRandomFreeSquare(this, zone);
 IsoZombie zombie0 = arrayList3.empty() ? nullptr : (IsoZombie)arrayList3.get(0);
 int int6 = Rand.Next(3, 7);
 void* object = nullptr;

 for (int int7 = 0; int7 < int6; int7++) {
 object = createRandomDeadBody(this->getRandomFreeSquare(this, zone), nullptr, Rand.Next(5, 10), 0, "Camper");
 if (object != nullptr) {
 this->addBloodSplat(((IsoDeadBody)object).getSquare(), 10);
 }
 }

 object = createRandomDeadBody(this->getSq(int0, int1 + 3, zone.z), nullptr, Rand.Next(5, 10), 0, "Camper");
 if (object != nullptr) {
 this->addBloodSplat(((IsoDeadBody)object).getSquare(), 10);
 if (zombie0 != nullptr) {
