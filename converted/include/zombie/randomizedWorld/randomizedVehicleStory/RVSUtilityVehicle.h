...
public:
 private ArrayList<String> tools = nullptr;
 private ArrayList<String> carpenterTools = nullptr;
 ...
 switch (int0) {
 case 0:
 this->doUtilityVehicle(zone, chunk, nullptr, "Base.PickUpTruck", "ConstructionWorker", 0, "ConstructionWorker", this->tools, Rand.Next(0, 3), true);
 break;
 case 1:
 this->doUtilityVehicle(zone, chunk, "police", nullptr, "Police", nullptr, nullptr, nullptr, 0, false);
 break;
 case 2:
 this->doUtilityVehicle(zone, chunk, "fire", nullptr, "Fireman", nullptr, nullptr, nullptr, 0, false);
 break;
 case 3:
 this->doUtilityVehicle(zone, chunk, "ranger", nullptr, "Ranger", nullptr, nullptr, nullptr, 0, true);
 break;
 case 4:
 this->doUtilityVehicle(zone, chunk, "mccoy", nullptr, "McCoys", 0, "Carpenter", this->carpenterTools, Rand.Next(2, 6), true);
 break;
 case 5:
 this->doUtilityVehicle(zone, chunk, "postal", nullptr, "Postal", nullptr, nullptr, nullptr, 0, false);
 break;
 case 6:
 this->doUtilityVehicle(zone, chunk, "fossoil", nullptr, "Fossoil", nullptr, nullptr, nullptr, 0, false);
 }
