...
public:
 ...
 zone, element.position.x, element.position.y, float0, element.direction, nullptr, "Base.VanAmbulance", nullptr, nullptr
 );
 if (vehicle1 != nullptr) {
 this->addZombiesOnVehicle(Rand.Next(1, 3), "AmbulanceDriver", nullptr, vehicle1);
 std::vector arrayList = this->addZombiesOnVehicle(Rand.Next(1, 3), "HospitalPatient", nullptr, vehicle1);
