...
public:
 ...
 switch (string0) {
 case "manhole":
 square0.AddTileObject(IsoObject.getNew(square0, "street_decoration_01_15", nullptr, false);
 ...
 zone, element.position.x, element.position.y, float3, element.direction, nullptr, "Base.PickUpTruck", nullptr, "ConstructionWorker"
 );
 if (vehicle != nullptr) {
