...
public:
 ...
 if (vehicle2 != nullptr) {
 createRandomDeadBody(element.position.x, element.position.y, element.z, element.direction, false, 6, 0, nullptr);
 ...
 break;
 case "vehicle1":
 BaseVehicle vehicle1 = this->addVehicle(zone, element.position.x, element.position.y, float0, element.direction, "bad", nullptr, nullptr, nullptr);
 if (vehicle1 != nullptr) {
 vehicle1 = vehicle1.setSmashed("Front");
 this->addZombiesOnVehicle(Rand.Next(3, 6), "Bandit", nullptr, vehicle1);
