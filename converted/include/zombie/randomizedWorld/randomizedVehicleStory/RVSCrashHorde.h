 ...
 */
class RVSCrashHorde : public RandomizedVehicleStoryBase {
public:
 ...
 zone, element.position.x, element.position.y, float0 + 0.25F, element.direction, boolean0 ? "normalburnt" : "bad", nullptr, nullptr, nullptr
 );
 if (vehicle != nullptr) {
 ...
 std::vector arrayList = this->addZombiesOnVehicle(Rand.Next(2, 4), nullptr, nullptr, vehicle);
 ...
 this->addZombiesOnVehicle(Rand.Next(12, 20), nullptr, nullptr, vehicle);
 }
 }
 }
 }
