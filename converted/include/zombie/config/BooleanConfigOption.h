...
public:
 ...
 public BooleanConfigOption(const std::string& name, bool _defaultValue) {
 super(name);
 ...
 return s != nullptr && (s.equalsIgnoreCase("true") || s.equalsIgnoreCase("false") || s.equalsIgnoreCase("1") || s.equalsIgnoreCase("0"));
 }
