...
public:
private
  final AssetManager.AssetTable m_assets = new AssetManager.AssetTable();
...
void reload(Asset asset) { this.reload(asset, nullptr); }
...
void onLoadingSucceeded(Asset asset) { asset.m_priv.onLoadingSucceeded(); }

void onLoadingFailed(Asset asset) { asset.m_priv.onLoadingFailed(); }
...
public
AssetManager.AssetTable getAssetTable() { return this.m_assets; }

AssetManagers getOwner() { return this.m_owner; }

protected
abstract Asset createAsset(AssetPath var1, AssetManager.AssetParams var2);

protected
abstract void destroyAsset(Asset var1);
