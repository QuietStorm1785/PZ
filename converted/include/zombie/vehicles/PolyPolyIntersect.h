...
public:
 ...
 static bool intersects(PolygonalMap2.VehiclePoly vehiclePoly1, PolygonalMap2.VehiclePoly vehiclePoly2) {
 ...
 static Vector2f getPoint(PolygonalMap2.VehiclePoly vehiclePoly, int int0, Vector2f vector2f) {
 if (int0 == 0) {
