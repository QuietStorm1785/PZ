...
private
  final ArrayList<PolygonalMap2.VehicleCluster> clusters =
      std::make_unique<ArrayList<>>();
private
  PolygonalMap2.ClosestPointOnEdge closestPointOnEdge =
      new PolygonalMap2.ClosestPointOnEdge();
private
  final TIntObjectHashMap<PolygonalMap2.Node> squareToNode =
      std::make_unique<TIntObjectHashMap<>>();
private
  final ArrayList<PolygonalMap2.Square> tempSquares =
      std::make_unique<ArrayList<>>();
  static const PolygonalMap2 instance = new PolygonalMap2();
private
  final ArrayList<PolygonalMap2.VisibilityGraph> graphs =
      std::make_unique<ArrayList<>>();
  Clipper clipperThread;
  const ByteBuffer xyBufferThread = ByteBuffer.allocateDirect(8192);
private
  final PolygonalMap2.AdjustStartEndNodeData adjustStartData =
      new PolygonalMap2.AdjustStartEndNodeData();
private
  final PolygonalMap2.AdjustStartEndNodeData adjustGoalData =
      new PolygonalMap2.AdjustStartEndNodeData();
private
  final PolygonalMap2.LineClearCollide lcc =
      new PolygonalMap2.LineClearCollide();
private
  final PolygonalMap2.VGAStar astar = new PolygonalMap2.VGAStar();
private
  final PolygonalMap2.TestRequest testRequest = new PolygonalMap2.TestRequest();
  int testZ = 0;
private
  final PathFindBehavior2.PointOnPath pointOnPath =
...
private
  final ConcurrentLinkedQueue<PolygonalMap2.IChunkTask> chunkTaskQueue =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  final ConcurrentLinkedQueue<PolygonalMap2.SquareUpdateTask> squareTaskQueue =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  final ConcurrentLinkedQueue<PolygonalMap2.IVehicleTask> vehicleTaskQueue =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  final ArrayList<PolygonalMap2.Vehicle> vehicles =
      std::make_unique<ArrayList<>>();
private
  final HashMap<BaseVehicle, PolygonalMap2.Vehicle> vehicleMap =
...
private
  final HashMap<BaseVehicle, PolygonalMap2.VehicleState> vehicleState =
      std::make_unique<HashMap<>>();
private
  final TObjectProcedure<PolygonalMap2.Node> releaseNodeProc =
...
bool rebuild;
private
final PolygonalMap2.Path shortestPath = new PolygonalMap2.Path();
private
final PolygonalMap2.Sync sync = new PolygonalMap2.Sync();
const void *renderLock = new Object();
private
PolygonalMap2.PMThread thread;
private
final PolygonalMap2.RequestQueue requests = new PolygonalMap2.RequestQueue();
private
final ConcurrentLinkedQueue<PolygonalMap2.PathFindRequest> requestToMain =
    std::make_unique<ConcurrentLinkedQueue<>>();
private
final ConcurrentLinkedQueue<PolygonalMap2.PathRequestTask> requestTaskQueue =
    std::make_unique<ConcurrentLinkedQueue<>>();
private
final HashMap<Mover, PolygonalMap2.PathFindRequest> requestMap =
    std::make_unique<HashMap<>>();
...
private
final PolygonalMap2.LineClearCollideMain lccMain =
    new PolygonalMap2.LineClearCollideMain();
private
final float[] tempFloats = new float[8];
...
PolygonalMap2.Node getPointOutsideObjects(PolygonalMap2.Square square1,
  ...
  if (float4 <= square1.x + 0.3F && float6 <= square1.y + 0.3F) {
    bool boolean0 =
        square2 != null && (square2.has(504) || square2.isReallySolid());
  ...
  if (float4 >= square1.x + 1 - 0.3F && float6 <= square1.y + 0.3F) {
    bool boolean1 = square4 != null && (square4.has(2) || square4.has(504) ||
  ...
  if (float4 <= square1.x + 0.3F && float6 >= square1.y + 1 - 0.3F) {
    bool boolean2 = square8 != null && (square8.has(4) || square8.has(504) ||
  ...
  if (float4 >= square1.x + 1 - 0.3F && float6 >= square1.y + 1 - 0.3F) {
    bool boolean3 =
        square6 != null && (square6.has(2) || square6.has(4) ||
...
void cleanPath(ArrayList<ISearchNode> arrayList,
  ...
  for (int int8 = 0; int8 < pathFindRequest.path.nodes.size(); int8++) {
    ...
    if (pathNode3.hasFlag(1)) {
      bool boolean3 = pathNode2 != null && pathNode2.hasFlag(2) ||
                      pathNode4 != null && pathNode4.hasFlag(2);
      if (!boolean3) {
        pathNode3.flags &= -4;
      }
    }
    ...
    if (boolean0) {
      ...
      for (int int5 = -1; int5 <= 1; int5++) {
        for (int int6 = -1; int6 <= 1; int6++) {
          ...
          if (square0 == nullptr || square0.isSolid() ||
      ...
      synchronized(this.renderLock) {
        ...
        if (this.findPath(pathFindRequest, boolean1) &&
          ...
          for (int int7 = 0; int7 < pathFindRequest.path.nodes.size() - 1;
            ...
            float float12 =
                square1 == null ? pathNode0.z : this.getApparentZ(square1);
            float float13 =
                square2 == null ? pathNode1.z : this.getApparentZ(square2);
            float float14 = 1.0F;
            float float15 = 1.0F;
            float float16 = 0.0F;
          ...
          float float17 =
              square3 == null ? pathNode2.z : this.getApparentZ(square3);
          float float18 =
              square4 == null ? pathNode3.z : this.getApparentZ(square4);
  ...
  while (!this.requests.isEmpty()) {
    ...
    if (pathFindRequest.cancel) {
      ...
      if (!pathFindRequest.targetXYZ.isEmpty()) {
        ...
        float float3 = this.shortestPath.isEmpty() ? Float.MAX_VALUE
...
private
static final class AdjustStartEndNodeData {
...
public
  ...
  static final ArrayDeque<PolygonalMap2.Cell> pool =
...
private static final class Chunk {
  ...
  static final ArrayDeque<PolygonalMap2.Chunk> pool =
      std::make_unique<ArrayDeque<>>();
...
public
  final ArrayList<PolygonalMap2.Obstacle> obstacles =
      std::make_unique<ArrayList<>>();
public
  final ArrayList<PolygonalMap2.Node> nodes = std::make_unique<ArrayList<>>();
  int z;
  static short EPOCH = 0;
  short epoch;
public
  static final ObjectPool<PolygonalMap2.ChunkDataZ> pool =
...
private static final class ChunkRemoveTask implements PolygonalMap2.IChunkTask {
  ...
  int wx;
  int wy;
  static final ArrayDeque<PolygonalMap2.ChunkRemoveTask> pool =
      std::make_unique<ArrayDeque<>>();
...
private
static final class ChunkUpdateTask implements PolygonalMap2.IChunkTask {
  PolygonalMap2 map;
  int wx;
  int wy;
  final int[][][] data = new int[10][10][8];
  final short[][][] cost = new short[10][10][8];
  static final ArrayDeque<PolygonalMap2.ChunkUpdateTask> pool =
      std::make_unique<ArrayDeque<>>();
...
private
static final class ClosestPointOnEdge {
...
private static final class ClusterOutline {
  ...
  bool innerCorner;
  bool start;
  static final ArrayDeque<PolygonalMap2.ClusterOutline> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class Connection {
  ...
  PolygonalMap2.Node node2;
  int flags;
  static final ArrayDeque<PolygonalMap2.Connection> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class Edge {
  ...
  final ArrayList<PolygonalMap2.Intersection> intersections =
      std::make_unique<ArrayList<>>();
  const Vector2 normal = new Vector2();
  static final ArrayDeque<PolygonalMap2.Edge> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class EdgeRing extends ArrayList<PolygonalMap2.Edge> {
  static final ArrayDeque<PolygonalMap2.EdgeRing> pool =
      std::make_unique<ArrayDeque<>>();
...
private
static final class ImmutableRectF {
  float x;
  float y;
  float w;
  float h;
  static final ArrayDeque<PolygonalMap2.ImmutableRectF> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class LineClearCollide {
  ...
  final ArrayList<PolygonalMap2.Point> pts = std::make_unique<ArrayList<>>();
    ...
    if (((int)float4 != (int)float2 || (int)float3 != (int)float1) &&
      ...
      for (int int4 = int1; int4 < int3; int4++) {
        for (int int5 = int0; int5 < int2; int5++) {
          ...
          if ((square == nullptr || square.isReallySolid() || boolean1 ||
               !square.has(512)) &&
              boolean0) {
            return false;
          }
...
private static final class Node {
  ...
  final ArrayList<PolygonalMap2.Edge> edges = std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Connection> visible =
      std::make_unique<ArrayList<>>();
  int flags = 0;
  static final ArrayList<PolygonalMap2.Obstacle> tempObstacles =
      std::make_unique<ArrayList<>>();
  static final ArrayDeque<PolygonalMap2.Node> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class ObjectOutline {
  ...
  static final ArrayDeque<PolygonalMap2.ObjectOutline> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class Obstacle {
  ...
  final ArrayList<PolygonalMap2.EdgeRing> inner =
      std::make_unique<ArrayList<>>();
  PolygonalMap2.ImmutableRectF bounds;
  PolygonalMap2.Node nodeCrawlFront;
  PolygonalMap2.Node nodeCrawlRear;
  final ArrayList<PolygonalMap2.Node> crawlNodes =
      std::make_unique<ArrayList<>>();
  static final ArrayDeque<PolygonalMap2.Obstacle> pool =
      std::make_unique<ArrayDeque<>>();
...
private final class PMThread extends Thread {
  ...
  bool shouldWait() {
    if (this.bStop) {
      ...
      return !PolygonalMap2.instance.requestTaskQueue.isEmpty()
                 ? false
                 : PolygonalMap2.instance.requests.isEmpty();
    }
  }
...
public static final class Path {
  final ArrayList<PolygonalMap2.PathNode> nodes =
      std::make_unique<ArrayList<>>();
  final ArrayDeque<PolygonalMap2.PathNode> nodePool =
      std::make_unique<ArrayDeque<>>();
  ...
  bool isEmpty() { return this.nodes.isEmpty(); }
  ...
  PolygonalMap2.PathNode addNode(float float0, float float1, float float2,
                                 int int0) {
    PolygonalMap2.PathNode pathNode = this.nodePool.isEmpty()
...
static final class PathFindRequest {
  ...
  bool cancel = false;
  static final ArrayDeque<PolygonalMap2.PathFindRequest> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class PathRequestTask {
  ...
  static final ArrayDeque<PolygonalMap2.PathRequestTask> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class PointPool {
  final ArrayDeque<PolygonalMap2.Point> pool = std::make_unique<ArrayDeque<>>();
...
private static final class RequestQueue {
  final ArrayDeque<PolygonalMap2.PathFindRequest> playerQ =
      std::make_unique<ArrayDeque<>>();
  final ArrayDeque<PolygonalMap2.PathFindRequest> aggroZombieQ =
      std::make_unique<ArrayDeque<>>();
  final ArrayDeque<PolygonalMap2.PathFindRequest> otherQ =
      std::make_unique<ArrayDeque<>>();

  bool isEmpty() {
    return this.playerQ.isEmpty() && this.aggroZombieQ.isEmpty() &&
           this.otherQ.isEmpty();
  }
  ...
  PolygonalMap2.PathFindRequest removeFirst() {
    if (!this.playerQ.isEmpty()) {
      ...
      return !this.aggroZombieQ.isEmpty() ? this.aggroZombieQ.removeFirst()
  ...
  PolygonalMap2.PathFindRequest removeLast() {
    if (!this.otherQ.isEmpty()) {
      ...
      return !this.aggroZombieQ.isEmpty() ? this.aggroZombieQ.removeLast()
...
private static final class SearchNode extends ASearchNode {
  ...
  static final ArrayDeque<PolygonalMap2.SearchNode> pool =
      std::make_unique<ArrayDeque<>>();
  ...
  double c(ISearchNode iSearchNode) {
    ...
    PolygonalMap2.Square square0 =
        this.square == nullptr ? PolygonalMap2.instance.getSquare(
    ...
    bool boolean2 = this.vgNode != null && this.vgNode.hasFlag(2);
    bool boolean3 = searchNode0.vgNode != null && searchNode0.vgNode.hasFlag(2);
  ...
  void getSuccessors(ArrayList<ISearchNode> arrayList1) {
    ...
    if (this.vgNode != nullptr) {
      ...
      for (int int1 = 0; int1 < this.vgNode.visible.size(); int1++) {
        ...
        if ((this.vgNode.square == nullptr || searchNode1.square == nullptr ||
  ...
  double dist(PolygonalMap2.SearchNode searchNode0) {
    if (this.square == nullptr || searchNode0.square == nullptr ||
...
private static final class Square {
  ...
  int bits;
  short cost;
  static final ArrayDeque<PolygonalMap2.Square> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class SquareUpdateTask {
  ...
  int bits;
  short cost;
  static final ArrayDeque<PolygonalMap2.SquareUpdateTask> pool =
      std::make_unique<ArrayDeque<>>();
...
private
static final class VGAStar extends AStar {
  ArrayList<PolygonalMap2.VisibilityGraph> graphs;
  final ArrayList<PolygonalMap2.SearchNode> searchNodes =
      std::make_unique<ArrayList<>>();
  final TIntObjectHashMap<PolygonalMap2.SearchNode> nodeMap =
      std::make_unique<TIntObjectHashMap<>>();
  final PolygonalMap2.GoalNode goalNode = new PolygonalMap2.GoalNode();
  final TIntObjectHashMap<PolygonalMap2.SearchNode> squareToNode =
      std::make_unique<TIntObjectHashMap<>>();
  Mover mover;
  bool bCanCrawl;
  bool bIgnoreCrawlCost;
...
private static final class Vehicle {
  ...
  float upVectorDot;
  static final ArrayDeque<PolygonalMap2.Vehicle> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class VehicleAddTask implements
  ...
  const TFloatArrayList crawlOffsets = new TFloatArrayList();
  float upVectorDot;
  static final ArrayDeque<PolygonalMap2.VehicleAddTask> pool =
      std::make_unique<ArrayDeque<>>();
...
private
static final class VehicleCluster {
  int z;
  final ArrayList<PolygonalMap2.VehicleRect> rects =
      std::make_unique<ArrayList<>>();
  static final ArrayDeque<PolygonalMap2.VehicleCluster> pool =
      std::make_unique<ArrayDeque<>>();
...
public static final class VehiclePoly {
  ...
  float z;
public
  final Vector2[] borders = new Vector2[4];
...
private static final class VehicleRect {
  ...
  int h;
  int z;
  static final ArrayDeque<PolygonalMap2.VehicleRect> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class VehicleRemoveTask implements
    PolygonalMap2.IVehicleTask {
  PolygonalMap2 map;
  BaseVehicle vehicle;
  static final ArrayDeque<PolygonalMap2.VehicleRemoveTask> pool =
      std::make_unique<ArrayDeque<>>();
  ...
  static PolygonalMap2.VehicleRemoveTask alloc() {
    synchronized(pool) {
      return pool.isEmpty() ? new PolygonalMap2.VehicleRemoveTask()
                            : pool.pop();
    }
  }
...
static final class VehicleState {
  ...
  final PolygonalMap2.VehiclePoly polyPlusRadius =
      new PolygonalMap2.VehiclePoly();
  static final ArrayDeque<PolygonalMap2.VehicleState> pool =
      std::make_unique<ArrayDeque<>>();
...
private static final class VehicleUpdateTask implements
    PolygonalMap2.IVehicleTask {
  PolygonalMap2 map;
  BaseVehicle vehicle;
  final PolygonalMap2.VehiclePoly poly = new PolygonalMap2.VehiclePoly();
  final PolygonalMap2.VehiclePoly polyPlusRadius =
      new PolygonalMap2.VehiclePoly();
  float upVectorDot;
  static final ArrayDeque<PolygonalMap2.VehicleUpdateTask> pool =
      std::make_unique<ArrayDeque<>>();
  ...
  static PolygonalMap2.VehicleUpdateTask alloc() {
    synchronized(pool) {
      return pool.isEmpty() ? new PolygonalMap2.VehicleUpdateTask()
                            : pool.pop();
    }
  }
...
private
static final class VisibilityGraph {
  bool created;
  PolygonalMap2.VehicleCluster cluster;
  final ArrayList<PolygonalMap2.Node> nodes = std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Edge> edges = std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Obstacle> obstacles =
      std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Node> intersectNodes =
      std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Node> perimeterNodes =
      std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Edge> perimeterEdges =
      std::make_unique<ArrayList<>>();
  final ArrayList<PolygonalMap2.Node> obstacleTraceNodes =
      std::make_unique<ArrayList<>>();
  const TIntArrayList splitXY = new TIntArrayList();
  static final PolygonalMap2.VisibilityGraph.CompareIntersection comparator =
      new PolygonalMap2.VisibilityGraph.CompareIntersection();
private
  static final PolygonalMap2.ClusterOutlineGrid clusterOutlineGrid =
      new PolygonalMap2.ClusterOutlineGrid();
private
  static final ArrayDeque<PolygonalMap2.VisibilityGraph> pool =
      std::make_unique<ArrayDeque<>>();
