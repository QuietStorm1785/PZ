...
public:
 ...
 GameClient.instance
 .sendClientCommandV(nullptr, "vehicle", "damageWindow", "vehicle", this->part.vehicle.getId(), "part", this->part.getId(), "amount", amount);
 } else {
 ...
 WorldSoundManager.instance.addSound(nullptr, square.getX(), square.getY(), square.getZ(), 10, 20, true, 4.0F, 15.0F);
 }
