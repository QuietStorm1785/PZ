...
public:
 ...
 public TestRule watchman = std::make_unique<TestWatcher>() {
 ...
 bool boolean0 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, long0 - 298L);
 if (int0 < 4) {
 ...
 bool boolean1 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, long0 - 298L + 50L);
 if (int0 < 4) {
 assertFalse(boolean0);
 } else {
 assertTrue(boolean0);
 ...
 bool boolean0 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, byte0 - 298);
 if (int0 < 4) {
 assertFalse(boolean0);
 } else {
 assertTrue(boolean0);
 ...
 bool boolean1 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, byte0 - 300 + 100 * int2 / 100);
 assertTrue(boolean1);
 ...
 bool boolean1 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, long0 - 300L + byte0 * int2 / 10);
 System.out
 .println(
 ...
 bool boolean0 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, int0 - 298);
 ...
 bool boolean1 = this->interpolation.interpolationDataGet(this->physics, this->engineSound, byte0 - 298);
