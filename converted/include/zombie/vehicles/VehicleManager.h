...
public:
 ...
 private ArrayList<BaseVehicle> sendReliable = std::make_unique<ArrayList<>>();
 private ArrayList<BaseVehicle> sendUnreliable = std::make_unique<ArrayList<>>();
 ...
 public static HashMap<Byte, String> vehiclePacketTypes = std::make_unique<HashMap<>>();
 public UdpConnection[] connected = new UdpConnection[512];
 private float[] tempFloats = new float[27];
 private float[] engineSound = new float[2];
 private VehicleManager.PosUpdateVars posUpdateVars = new VehicleManager.PosUpdateVars();
 const UpdateLimit vehiclesWaitUpdatesFrequency = new UpdateLimit(1000L);
 BaseVehicle tempVehicle;
 private ArrayList<BaseVehicle.ModelInfo> oldModels = std::make_unique<ArrayList<>>();
 private ArrayList<BaseVehicle.ModelInfo> curModels = std::make_unique<ArrayList<>>();
 ...
 if (this->connected[int0] != nullptr && !GameServer.udpEngine.connections.contains(this->connected[int0])) {
 ...
 if (((BaseVehicle)arrayList.get(int2).connectionState[int0] != nullptr) {
 ...
 void sendVehiclesInternal(UdpConnection udpConnection, ArrayList<BaseVehicle> arrayList, PacketTypes.PacketType packetType) {
 if (!arrayList.empty()) {
 ...
 void serverPacket(ByteBuffer byteBuffer, UdpConnection udpConnection0, short short1) {
 ...
 void clientUpdateVehiclePos(BaseVehicle vehicle, float float0, float float1, float var4, IsoGridSquare square) {
 vehicle.setX(float0);
 vehicle.setY(float1);
 vehicle.setZ(0.0F);
 ...
 void clientReceiveUpdateFull(ByteBuffer byteBuffer, short short2, float float1, float float0, float float2) {
 ...
 if (vehicle0.physics != nullptr && (vehicle0.getDriver() == nullptr || !vehicle0.getDriver().isLocal())) {
 ...
 if (player != nullptr && !player.isDead() && player.getVehicle() == nullptr) {
 ...
 void sendPassengerPosition(BaseVehicle vehicle, int int0, const std::string& string) {
 ByteBufferWriter byteBufferWriter = GameClient.connection.startPacket();
 PacketTypes.PacketType.Vehicles.doPacket(byteBufferWriter);
 ...
 void sendPassengerPosition(BaseVehicle vehicle, int int1, const std::string& string, UdpConnection udpConnection1) {
 for (int int0 = 0; int0 < GameServer.udpEngine.connections.size(); int0++) {
 ...
 if (player != nullptr && player.getVehicle() != nullptr && player.getVehicle().VehicleID == vehicle.VehicleID) {
 ...
 void sendSwitchSeat(UdpConnection udpConnection, BaseVehicle vehicle, IsoGameCharacter character, int int0, int int1) {
 ByteBufferWriter byteBufferWriter = udpConnection.startPacket();
 PacketTypes.PacketType.Vehicles.doPacket(byteBufferWriter);
 ...
 void sendSwitchSeat(BaseVehicle vehicle, IsoGameCharacter character, int int0, int int1) {
 ...
 void sendEnter(UdpConnection udpConnection, BaseVehicle vehicle, IsoGameCharacter character, int int0) {
 ByteBufferWriter byteBufferWriter = udpConnection.startPacket();
 PacketTypes.PacketType.Vehicles.doPacket(byteBufferWriter);
 ...
 void sendExit(UdpConnection udpConnection, BaseVehicle vehicle, IsoGameCharacter character, int int0) {
 ByteBufferWriter byteBufferWriter = udpConnection.startPacket();
 PacketTypes.PacketType.Vehicles.doPacket(byteBufferWriter);
 ...
 void sendTowing(UdpConnection udpConnection, BaseVehicle vehicle1, BaseVehicle vehicle0, const std::string& string0, const std::string& string1) {
 ...
 void sendTowing(BaseVehicle vehicle0, BaseVehicle vehicle1, const std::string& string0, const std::string& string1) {
 ...
 void sendDetachTowing(UdpConnection udpConnection, BaseVehicle vehicle0, BaseVehicle vehicle1) {
 ByteBufferWriter byteBufferWriter = udpConnection.startPacket();
 PacketTypes.PacketType.Vehicles.doPacket(byteBufferWriter);
 ...
 if (vehicle0 != nullptr && this->towedVehicleMap.containsKey(vehicle0.VehicleID) {
 this->towedVehicleMap.remove(vehicle0.VehicleID);
 }

 if (vehicle1 != nullptr && this->towedVehicleMap.containsKey(vehicle1.VehicleID) {
