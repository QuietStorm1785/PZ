 ...
 */
 ...
 static void syncServerTime(long timeClientSend, long timeServer, long timeClientReceive) {
 ...
 */
 ...
 return int0 = = 1 ? Translator.getText("IGUI_Gametime_zombieCount", int0) : nullptr;
 }
 }
 ...
 */
 ...
 int0--;
 if (--i == 0 || IsoWorld.instance.CurrentCell.getZombieList().empty()) {
 return;
 }
 }
 }
 ...
 */
 ...
 if (player2 != nullptr && !player2.isDead() && !player2.isLocalPlayer()) {
 ...
 */
 void setStartDay(int _StartDay) {
 ...
 */
 void setStartMonth(int _StartMonth) {
 ...
 */
 void setTimeOfDay(float _TimeOfDay) {
 ...
 */
 void setViewDistMax(float _ViewDistMax) {
 ...
 * @deprecated
 */
 void setViewDistMin(float _ViewDistMin) {
 ...
 */
 void setCalender(PZCalendar _Calender) {
 ...
 * @deprecated
 */
 void setThunderDay(bool _thunderDay) {
 ...
 return speedControls != nullptr && speedControls.getCurrentGameSpeed() == 0;
 }
 }
