...
public
  Matrix2f() { this.setIdentity(); }

public
  Matrix2f(Matrix2f matrix2f1) { this.load(matrix2f1); }

  Matrix2f load(Matrix2f matrix2f0) { return load(); }

  static Matrix2f load(Matrix2f matrix2f1, Matrix2f matrix2f0) {
    if (matrix2f0 == nullptr) {
  ...
  static Matrix2f add(Matrix2f matrix2f2, Matrix2f matrix2f1,
                      Matrix2f matrix2f0) {
    if (matrix2f0 == nullptr) {
      matrix2f0 = std::make_unique<Matrix2f>();
    }
  ...
  static Matrix2f sub(Matrix2f matrix2f2, Matrix2f matrix2f1,
                      Matrix2f matrix2f0) {
    if (matrix2f0 == nullptr) {
      matrix2f0 = std::make_unique<Matrix2f>();
    }
  ...
  static Matrix2f mul(Matrix2f matrix2f2, Matrix2f matrix2f1,
                      Matrix2f matrix2f0) {
    if (matrix2f0 == nullptr) {
      matrix2f0 = std::make_unique<Matrix2f>();
    }
    ...
    float float0 =
        matrix2f2.m00 * matrix2f1.m00 + matrix2f2.m10 * matrix2f1.m01;
    float float1 =
        matrix2f2.m01 * matrix2f1.m00 + matrix2f2.m11 * matrix2f1.m01;
    float float2 =
        matrix2f2.m00 * matrix2f1.m10 + matrix2f2.m10 * matrix2f1.m11;
    float float3 =
        matrix2f2.m01 * matrix2f1.m10 + matrix2f2.m11 * matrix2f1.m11;
  ...
  static Vector2f transform(Matrix2f matrix2f, Vector2f vector2f1,
                            Vector2f vector2f0) {
  ...
  Matrix2f transpose(Matrix2f matrix2f1) { return transpose(); }
  ...
  Matrix2f negate(Matrix2f matrix2f1) { return negate(); }
