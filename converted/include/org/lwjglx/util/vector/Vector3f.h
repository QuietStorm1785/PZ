...
public:
 ...
 static Vector3f add(Vector3f vector3f2, Vector3f vector3f1, Vector3f vector3f0) {
 if (vector3f0.empty()) {
 ...
 static Vector3f sub(Vector3f vector3f2, Vector3f vector3f1, Vector3f vector3f0) {
 if (vector3f0.empty()) {
 return new Vector3f(vector3f2.x - vector3f1.x, vector3f2.y - vector3f1.y, vector3f2.z - vector3f1.z);
 } else {
 vector3f0.set(vector3f2.x - vector3f1.x, vector3f2.y - vector3f1.y, vector3f2.z - vector3f1.z);
 ...
 static Vector3f cross(Vector3f vector3f2, Vector3f vector3f1, Vector3f vector3f0) {
 if (vector3f0.empty()) {
