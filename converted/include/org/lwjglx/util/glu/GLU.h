...
public:
 ...
 static void gluLookAt(float float0, float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8) {
 Project.gluLookAt(float0, float1, float2, float3, float4, float5, float6, float7, float8);
 }

 static void gluOrtho2D(float float0, float float1, float float2, float float3) {
 gluOrtho2D(float0, float1, float2, float3);
 }

 static void gluPerspective(float float0, float float1, float float2, float float3) {
 ...
 static void gluPickMatrix(float float0, float float1, float float2, float float3, IntBuffer intBuffer) {
 ...
 static bool gluCheckExtension(const std::string& string0, const std::string& string1) {
 return Registry.gluCheckExtension(string0, string1);
 }

 static int gluBuild2DMipmaps(int int0, int int1, int int2, int int3, int int4, int int5, ByteBuffer byteBuffer) {
 return MipMap.gluBuild2DMipmaps(int0, int1, int2, int3, int4, int5, byteBuffer);
 }

 static int gluScaleImage(int int0, int int1, int int2, int int3, ByteBuffer byteBuffer0, int int4, int int5, int int6, ByteBuffer byteBuffer1) {
