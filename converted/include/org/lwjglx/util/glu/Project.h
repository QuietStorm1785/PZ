...
public:
 ...
 private static float[] forward = new float[3];
 private static float[] side = new float[3];
 ...
 static void __gluMultMatrixVecf(FloatBuffer floatBuffer, float[] floats0, float[] floats1) {
 ...
 static bool __gluInvertMatrixf(FloatBuffer floatBuffer1, FloatBuffer floatBuffer2) {
 ...
 static void __gluMultMatricesf(FloatBuffer floatBuffer2, FloatBuffer floatBuffer1, FloatBuffer floatBuffer0) {
 for (int int0 = 0; int0 < 4; int0++) {
 for (int int1 = 0; int1 < 4; int1++) {
 floatBuffer0.put(
 ...
 static void gluPerspective(float float1, float float6, float float4, float float3) {
 ...
 static void gluLookAt(float float1, float float3, float float5, float float0, float float2, float float4, float float6, float float7, float float8) {
