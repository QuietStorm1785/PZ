...
public:
  void draw(float arg0, float arg1, float arg2, int arg3, int arg4) {
    float float0;
      ...
      if (super.drawStyle == 100012) {
        ...
        for (int int2 = 0; int2 < arg4; int2++) {
          ...
          for (int int3 = 0; int3 <= arg3; int3++) {
            ...
            if (float0 == 1.0F) {
              this.normal3f(float15 * float0, float16 * float0,
                            float4 * float0);
              ...
              GL11.glVertex3f(float15 * (float13 + float2),
                              float16 * (float13 + float2), float12 + float3);
            } else {
              this.normal3f(float15 * float0, float16 * float0,
                            float4 * float0);
              this.TXTR_COORD(float14, float11);
