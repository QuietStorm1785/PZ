...
public:
  static int gluBuild2DMipmaps(int int11, int int12, int int1, int int0,
                               int int3, int int4, ByteBuffer byteBuffer1) {
    if (int1 >= 1 && int0 >= 1) {
      ...
      if (int2 == 0) {
        ...
        if (int6 == int1 && int7 == int0) {
          ...
          int int9 = gluScaleImage(int3, int1, int0, int4, byteBuffer1, int6,
                                   int7, int4, byteBuffer0);
          if (int9 != 0) {
            int8 = int9;
            boolean0 = true;
          }
        ...
        for (int int10 = 0; !boolean0; int10++) {
          ...
          GL11.glTexImage2D(int11, int10, int12, int6, int7, 0, int3, int4,
                            byteBuffer0);
          if (int6 == 1 && int7 == 1) {
            break;
          }
          ...
          if (byteBuffer2 == nullptr) {
            byteBuffer4 = byteBuffer2 =
                BufferUtils.createByteBuffer((int13 + 4) * int14 * int2);
          ...
          int int15 = gluScaleImage(int3, int6, int7, int4, byteBuffer0, int13,
                                    int14, int4, byteBuffer4);
          if (int15 != 0) {
            int8 = int15;
            boolean0 = true;
          }
  ...
  static int gluScaleImage(int int1, int int2, int int3, int int6,
                           ByteBuffer byteBuffer0, int int4, int int5, int int7,
    ...
    if (int0 == -1) {
      ...
      if (byte0 >= pixelStoreState.unpackAlignment) {
        ...
        int9 = pixelStoreState.unpackAlignment / byte0 *
               ceil(int0 * int8 * byte0, pixelStoreState.unpackAlignment);
      }
      ...
      case 5121:
        ...
        for (int int15 = 0; int15 < int3; int15++) {
          int int16 = int15 * int9 + pixelStoreState.unpackSkipRows * int9 +
                      pixelStoreState.unpackSkipPixels * int0;
      ...
      case 5126:
        ...
        for (int int11 = 0; int11 < int3; int11++) {
          int int12 =
              4 * (int11 * int9 + pixelStoreState.unpackSkipRows * int9 +
                   pixelStoreState.unpackSkipPixels * int0);
      ...
      if (byte1 >= pixelStoreState.packAlignment) {
        ...
        int9 = pixelStoreState.packAlignment / byte1 *
               ceil(int0 * int8 * byte1, pixelStoreState.packAlignment);
      }
      ...
      case 5121:
        ...
        for (int int39 = 0; int39 < int5; int39++) {
          int int40 = int39 * int9 + pixelStoreState.packSkipRows * int9 +
                      pixelStoreState.packSkipPixels * int0;
      ...
      case 5126:
        ...
        for (int int35 = 0; int35 < int5; int35++) {
          int int36 =
              4 * (int35 * int9 + pixelStoreState.unpackSkipRows * int9 +
                   pixelStoreState.unpackSkipPixels * int0);
