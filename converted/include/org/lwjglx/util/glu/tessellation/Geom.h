...
public:
 ...
 static bool VertCCW(GLUvertex gLUvertex1, GLUvertex gLUvertex0, GLUvertex gLUvertex2) {
 ...
 static bool EdgeGoesLeft(GLUhalfEdge gLUhalfEdge) {
 return VertLeq();
 }

 static bool EdgeGoesRight(GLUhalfEdge gLUhalfEdge) {
 return VertLeq();
 }
