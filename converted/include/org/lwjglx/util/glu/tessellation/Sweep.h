...
public:
 ...
 static bool EdgeLeq(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion0, ActiveRegion activeRegion1) {
 ...
 static void CallCombine(GLUtessellatorImpl gLUtessellatorImpl, GLUvertex gLUvertex, Object[] objects1, float[] floats, bool boolean0) {
 ...
 static bool CheckForRightSplice(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1) {
 ...
 static bool CheckForLeftSplice(GLUtessellatorImpl var0, ActiveRegion activeRegion1) {
 ActiveRegion activeRegion0 = RegionBelow(activeRegion1);
 GLUhalfEdge gLUhalfEdge0 = activeRegion1.eUp;
 GLUhalfEdge gLUhalfEdge1 = activeRegion0.eUp;
 ...
 static bool CheckForIntersect(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1) {
 ActiveRegion activeRegion0 = RegionBelow(activeRegion1);
 GLUhalfEdge gLUhalfEdge0 = activeRegion1.eUp;
 GLUhalfEdge gLUhalfEdge1 = activeRegion0.eUp;
 ...
 gLUhalfEdge1 = FinishLeftRegions(gLUtessellatorImpl, activeRegion1, nullptr);
 ...
 gLUhalfEdge1 = FinishLeftRegions(gLUtessellatorImpl, activeRegion0, nullptr);
 boolean0 = true;
 }
 ...
 AddRightEdges(gLUtessellatorImpl, activeRegion1, gLUvertex.anEdge, gLUvertex.anEdge, nullptr, true);
 } else {
 GLUhalfEdge gLUhalfEdge2;
 ...
 ActiveRegion activeRegion1 = RegionBelow(activeRegion0);
 GLUhalfEdge gLUhalfEdge1 = activeRegion1.eUp;
 GLUhalfEdge gLUhalfEdge2 = FinishLeftRegions(gLUtessellatorImpl, activeRegion1, nullptr);
