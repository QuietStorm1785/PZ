...
private
  ...
  static GLUhalfEdge MakeEdge(GLUhalfEdge gLUhalfEdge2) {
    ...
    gLUhalfEdge0.Org = nullptr;
    gLUhalfEdge0.Lface = nullptr;
    gLUhalfEdge0.winding = 0;
    gLUhalfEdge0.activeRegion = nullptr;
    gLUhalfEdge1.Sym = gLUhalfEdge0;
    gLUhalfEdge1.Onext = gLUhalfEdge1;
    gLUhalfEdge1.Lnext = gLUhalfEdge0;
    gLUhalfEdge1.Org = nullptr;
    gLUhalfEdge1.Lface = nullptr;
    gLUhalfEdge1.winding = 0;
    gLUhalfEdge1.activeRegion = nullptr;
    return gLUhalfEdge0;
  }
  ...
  static void MakeVertex(GLUvertex gLUvertex1, GLUhalfEdge gLUhalfEdge0,
                         GLUvertex gLUvertex3) {
    GLUvertex gLUvertex0 = gLUvertex1;

    assert gLUvertex1 != nullptr;
  ...
  static void MakeFace(GLUface gLUface1, GLUhalfEdge gLUhalfEdge0,
                       GLUface gLUface3) {
    GLUface gLUface0 = gLUface1;

    assert gLUface1 != nullptr;
    ...
    gLUface1.data = nullptr;
    gLUface1.trail = nullptr;
  ...
  static GLUhalfEdge __gl_meshMakeEdge(GLUmesh gLUmesh) {
  ...
  static bool __gl_meshSplice(GLUhalfEdge gLUhalfEdge0,
  ...
  static bool __gl_meshDelete(GLUhalfEdge gLUhalfEdge1) {
    ...
    if (gLUhalfEdge1.Onext == gLUhalfEdge1) {
      KillVertex(gLUhalfEdge1.Org, nullptr);
    } else {
    ...
    if (gLUhalfEdge0.Onext == gLUhalfEdge0) {
      KillVertex(gLUhalfEdge0.Org, nullptr);
      KillFace(gLUhalfEdge0.Lface, nullptr);
    } else {
  ...
  static GLUhalfEdge __gl_meshSplitEdge(GLUhalfEdge gLUhalfEdge1) {
  ...
  static GLUhalfEdge __gl_meshConnect(GLUhalfEdge gLUhalfEdge1,
    ...
    do {
      ...
      if (gLUhalfEdge2.Sym.Lface == nullptr) {
        ...
        if (gLUhalfEdge3.Onext == gLUhalfEdge3) {
          KillVertex(gLUhalfEdge3.Org, nullptr);
        } else {
  ...
  static GLUmesh __gl_meshNewMesh() {
    ...
    gLUvertex.anEdge = nullptr;
    gLUvertex.data = nullptr;
    gLUface.next = gLUface.prev = gLUface;
    gLUface.anEdge = nullptr;
    gLUface.data = nullptr;
    gLUface.trail = nullptr;
    gLUface.marked = false;
    gLUface.inside = false;
    gLUhalfEdge0.next = gLUhalfEdge0;
    gLUhalfEdge0.Sym = gLUhalfEdge1;
    gLUhalfEdge0.Onext = nullptr;
    gLUhalfEdge0.Lnext = nullptr;
    gLUhalfEdge0.Org = nullptr;
    gLUhalfEdge0.Lface = nullptr;
    gLUhalfEdge0.winding = 0;
    gLUhalfEdge0.activeRegion = nullptr;
    ...
    gLUhalfEdge1.Sym = gLUhalfEdge0;
    gLUhalfEdge1.Onext = nullptr;
    gLUhalfEdge1.Lnext = nullptr;
    gLUhalfEdge1.Org = nullptr;
    gLUhalfEdge1.Lface = nullptr;
    gLUhalfEdge1.winding = 0;
    gLUhalfEdge1.activeRegion = nullptr;
  ...
  static void __gl_meshDeleteMesh(GLUmesh gLUmesh) {
  ...
  static void __gl_meshCheckMesh(GLUmesh gLUmesh) {
  ...
  label211:
    while (true) {
      ...
      if (gLUface1.next == gLUface0) {
        if ($assertionsDisabled || gLUface2.prev == gLUface1 &&
                                       gLUface2.anEdge == nullptr &&
                                       gLUface2.data == nullptr) {
        ...
        label185:
          while (true) {
            ...
            if (gLUvertex1.next == gLUvertex0) {
              if ($assertionsDisabled || gLUvertex2.prev == gLUvertex1 &&
                                             gLUvertex2.anEdge == nullptr &&
                                             gLUvertex2.data == nullptr) {
                GLUhalfEdge gLUhalfEdge1 = gLUhalfEdge0;
                ...
                while (true) {
                  ...
                  assert gLUhalfEdge2.Org != nullptr;

                  assert gLUhalfEdge2.Sym.Org != nullptr;
