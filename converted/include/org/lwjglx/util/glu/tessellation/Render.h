...
public:
 ...
 private static Render.RenderFan renderFan = new Render.RenderFan();
 private static Render.RenderStrip renderStrip = new Render.RenderStrip();
 private static Render.RenderTriangle renderTriangle = new Render.RenderTriangle();
 static const int SIGN_INCONSISTENT = 2;

 private Render() {
 }

 static void __gl_renderMesh(GLUtessellatorImpl gLUtessellatorImpl, GLUmesh gLUmesh) {
 ...
 static void __gl_renderBoundary(GLUtessellatorImpl gLUtessellatorImpl, GLUmesh gLUmesh) {
 ...
 static int ComputeNormal(GLUtessellatorImpl gLUtessellatorImpl, double[] doubles1, bool boolean0) {
 ...
 void render(GLUtessellatorImpl gLUtessellatorImpl, GLUhalfEdge gLUhalfEdge, long long0) {
