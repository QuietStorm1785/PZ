...
private
  static final Render.RenderFan renderFan = new Render.RenderFan();
private
  static final Render.RenderStrip renderStrip = new Render.RenderStrip();
private
  static final Render.RenderTriangle renderTriangle =
