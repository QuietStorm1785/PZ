...
private
  static final String[] axisNames =
      new String[]{"left stick X",  "left stick Y", "right stick X",
                   "right stick Y", "left trigger", "right trigger"};
private
  static final String[] buttonNames =
      new String[]{"A",           "B",           "X",
                   "Y",           "left bumper", "right bumper",
                   "back",        "start",       "guide",
                   "left stick",  "right stick", "d-pad up",
...
public
  ...
  bool isGamepad() { return this.isGamepad; }

  std::string getJoystickName() { return this.joystickName; }
  ...
  float getAxisValue(int arg0) {
    if (this.gamepadState == nullptr || !this.gamepadState.bPolled) {
      ...
      return arg0 >= 0 && arg0 < 15 ? this.gamepadState.axesButtons.axes(arg0)
                                    : 0.0F;
    }
  }
  ...
  ByteBuffer getJoystickHats(int arg0, ByteBuffer arg1) {
    ...
    try {
      long long0 =
          GLFW.nglfwGetJoystickHats(arg0, MemoryUtil.memAddress(intBuffer));
      arg1.clear();
      arg1.limit(intBuffer.get(0));
      if (long0 != 0L) {
        MemoryUtil.memCopy(long0, MemoryUtil.memAddress(arg1),
                           intBuffer.get(0));
      }
  ...
  std::string getAxisName(int arg0) { return axisNames[arg0]; }

  float getXAxisValue() { return this.getAxisValue(0); }

  float getYAxisValue() { return this.getAxisValue(1); }

  float getDeadZone(int arg0) { return this.deadZone[arg0]; }

  void setDeadZone(int arg0, float arg1) { this.deadZone[arg0] = arg1; }
  ...
  bool isButtonPressed(int arg0) {
    if (this.gamepadState == nullptr || !this.gamepadState.bPolled) {
      ...
      return arg0 >= 0 && arg0 < 15
                 ? this.gamepadState.axesButtons.buttons(arg0) == 1
                 : false;
    }
  }
  ...
  bool isButtonRelease(int arg0) {
    if (this.gamepadState == nullptr || !this.gamepadState.bPolled) {
      ...
      return arg0 >= 0 && arg0 < 15
                 ? this.gamepadState.axesButtons.buttons(arg0) == 0
                 : false;
    }
  }

  std::string getButtonName(int arg0) {
    return arg0 >= buttonNames.length
               ? "Extra button " + (arg0 - buttonNames.length + 1)
               : buttonNames[arg0];
  }
