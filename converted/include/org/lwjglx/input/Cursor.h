...
public:
 ...
 public Cursor(int arg0, int arg1, int arg2, int arg3, int arg4, IntBuffer arg5, IntBuffer arg6) {
 if (arg4 != 1) {
 ...
 static ByteBuffer convertARGBIntBuffertoRGBAByteBuffer(int int0, int int1, IntBuffer intBuffer) {
 ...
 static void flipImages(int int4, int int3, int int1, IntBuffer intBuffer0, IntBuffer intBuffer1) {
 ...
 static void flipImage(int int4, int int1, int int3, IntBuffer intBuffer0, IntBuffer intBuffer1) {
