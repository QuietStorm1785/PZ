...
public
  PixelFormat() { this(0, 8, 0); }

public
  PixelFormat(int int0, int int1, int int2) { this(int0, int1, int2, 0); }

public
  PixelFormat(int int0, int int1, int int2, int int3) {
    this(0, int0, int1, int2, int3);
  }

public
  PixelFormat(int int0, int int1, int int2, int int3, int int4) {
    this(int0, int1, int2, int3, int4, 0, 0, 0, false);
  }

public
  PixelFormat(int int0, int int1, int int2, int int3, int int4, int int5,
              int int6, int int7, bool boolean0) {
    this(int0, int1, int2, int3, int4, int5, int6, int7, boolean0, false);
  }

public
  PixelFormat(int int0, int int1, int int2, int int3, int int4, int int5,
              int int6, int int7, bool boolean0, bool boolean1) {
    this.bpp = int0;
    this.alpha = int1;
    this.depth = int2;
    this.stencil = int3;
...
private
  PixelFormat(PixelFormat pixelFormat1) {
  ...
  PixelFormat withBitsPerPixel(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of bits per pixel specified: " + int0);
    } else {
  ...
  int getAlphaBits() { return this.alpha; }

  PixelFormat withAlphaBits(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of alpha bits specified: " + int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  int getDepthBits() { return this.depth; }

  PixelFormat withDepthBits(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of depth bits specified: " + int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  int getStencilBits() { return this.stencil; }

  PixelFormat withStencilBits(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of stencil bits specified: " + int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  PixelFormat withSamples(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of samples specified: " + int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  PixelFormat withCoverageSamples(int int1, int int0) {
    if (int0 >= 0 && int1 >= 0 && (int0 != 0 || 0 >= int1) && int0 >= int1) {
      ...
      throw new IllegalArgumentException(
          "Invalid number of coverage samples specified: " + int0 + " - " +
          int1);
    }
  }

  int getAuxBuffers() { return this.num_aux_buffers; }

  PixelFormat withAuxBuffers(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException(
          "Invalid number of auxiliary buffers specified: " + int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  int getAccumulationBitsPerPixel() { return this.accum_bpp; }

  PixelFormat withAccumulationBitsPerPixel(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException("Invalid number of bits per pixel in "
                                         "the accumulation buffer specified: " +
                                         int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  int getAccumulationAlpha() { return this.accum_alpha; }

  PixelFormat withAccumulationAlpha(int int0) {
    if (int0 < 0) {
      throw new IllegalArgumentException("Invalid number of alpha bits in the "
                                         "accumulation buffer specified: " +
                                         int0);
    } else {
      PixelFormat pixelFormat0 = new PixelFormat(this);
  ...
  bool isFloatingPoint() { return this.floating_point; }
