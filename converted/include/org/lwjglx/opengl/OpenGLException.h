...
public:
 ...
 public OpenGLException(const std::string& string) {
 super(string);
 }

 public OpenGLException(const std::string& string, std::exception throwable) {
 super(string, throwable);
 }

 public OpenGLException(std::exception throwable) {
 super(throwable);
 }
}
} // namespace opengl
