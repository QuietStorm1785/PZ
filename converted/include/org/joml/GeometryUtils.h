...
class GeometryUtils {
public:
 static void perpendicular(float float4, float float1, float float2, Vector3f vector3f0, Vector3f vector3f1) {
 ...
 static void perpendicular(Vector3fc vector3fc, Vector3f vector3f0, Vector3f vector3f1) {
 perpendicular(vector3fc.x(), vector3fc.y(), vector3fc.z(), vector3f0, vector3f1);
 }

 static void normal(Vector3fc vector3fc2, Vector3fc vector3fc1, Vector3fc vector3fc0, Vector3f vector3f) {
 normal(
 vector3fc2.x(),
 vector3fc2.y(),
 vector3fc2.z(),
