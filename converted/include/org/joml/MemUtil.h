...
public:
 ...
 throw ConfigurationException("Cannot enable both -Djoml.nounsafe and -Djoml.forceUnsafe", nullptr);
 }
 ...
 throw ConfigurationException("Unsafe is not supported but its use was forced via -Djoml.forceUnsafe", throwable);
 }
 ...
 void put4x3Transposed(Matrix4f matrix4f, int int0, FloatBuffer floatBuffer) {
 floatBuffer.put(int0, matrix4f.m00())
 .put(int0 + 1, matrix4f.m10())
 .put(int0 + 2, matrix4f.m20())
 .put(int0 + 3, matrix4f.m30())
 ...
 void putTransposed(Matrix4x3f matrix4x3f, int int0, FloatBuffer floatBuffer) {
 floatBuffer.put(int0, matrix4x3f.m00())
 ...
 void put4x3Transposed(Matrix4d matrix4d, int int0, DoubleBuffer doubleBuffer) {
 doubleBuffer.put(int0, matrix4d.m00())
 .put(int0 + 1, matrix4d.m10())
 .put(int0 + 2, matrix4d.m20())
 .put(int0 + 3, matrix4d.m30())
 ...
 void putTransposed(Matrix4x3d matrix4x3d, int int0, DoubleBuffer doubleBuffer) {
 doubleBuffer.put(int0, matrix4x3d.m00())
 ...
 void putfTransposed(Matrix4x3d matrix4x3d, int int0, FloatBuffer floatBuffer) {
 floatBuffer.put(int0, (float)matrix4x3d.m00())
 ...
 void putfTransposed(Matrix4x3d matrix4x3d, int int0, ByteBuffer byteBuffer) {
 byteBuffer.putFloat(int0, (float)matrix4x3d.m00())
 ...
 void putMatrix3f(Quaternionf quaternionf, int int0, FloatBuffer floatBuffer) {
 float float0 = quaternionf.w * quaternionf.w;
 float float1 = quaternionf.x * quaternionf.x;
 float float2 = quaternionf.y * quaternionf.y;
 float float3 = quaternionf.z * quaternionf.z;
 ...
 void putMatrix4f(Quaternionf quaternionf, int int0, FloatBuffer floatBuffer) {
 float float0 = quaternionf.w * quaternionf.w;
 float float1 = quaternionf.x * quaternionf.x;
 float float2 = quaternionf.y * quaternionf.y;
 float float3 = quaternionf.z * quaternionf.z;
 ...
 void putMatrix4x3f(Quaternionf quaternionf, int int0, ByteBuffer byteBuffer) {
 float float0 = quaternionf.w * quaternionf.w;
 float float1 = quaternionf.x * quaternionf.x;
 float float2 = quaternionf.y * quaternionf.y;
 float float3 = quaternionf.z * quaternionf.z;
 ...
 void putMatrix4x3f(Quaternionf quaternionf, int int0, FloatBuffer floatBuffer) {
 float float0 = quaternionf.w * quaternionf.w;
 float float1 = quaternionf.x * quaternionf.x;
 float float2 = quaternionf.y * quaternionf.y;
 float float3 = quaternionf.z * quaternionf.z;
 ...
 throw UnsupportedOperationException("Unexpected Matrix4d element offset");
 }
 }
 ...
 long long1 = UNSAFE.objectFieldOffset(field);
 if (long1 != long0 + (int0 << 3) {
 throw UnsupportedOperationException("Unexpected Matrix3d element offset");
 }
 }
 ...
 long long1 = UNSAFE.objectFieldOffset(field);
 if (long1 != long0 + (int0 << 2) {
 throw UnsupportedOperationException("Unexpected Matrix2f element offset");
 }
 }
 ...
 long long1 = UNSAFE.objectFieldOffset(field);
 if (long1 != long0 + (int0 << 2) {
 throw UnsupportedOperationException("Unexpected Vector3f element offset");
 }
 }
 ...
 throw NoSuchFieldException(string + " does not exist in " + clazz1.getName() + " or any of its superclasses.");
 }
 ...
 for (int int0 = 0; int0 < 4; int0++) {
 UNSAFE.putLong(nullptr, long0 + (int0 << 4), UNSAFE.getLong(matrix4x3f, Matrix4x3f_m00 + 12 * int0);
 ...
 UNSAFE.putLong(nullptr, long0 + (int0 << 4), UNSAFE.getLong(matrix4x3f, Matrix4x3f_m00 + 12 * int0);
 UNSAFE.putFloat(nullptr, long0 + (int0 << 4) + 8L, UNSAFE.getFloat(matrix4x3f, Matrix4x3f_m00 + 8L + 12 * int0);
 ...
 Unsafe unsafe = UNSAFE;
 unsafe.putLong(nullptr, long0, unsafe.getLong(matrix3x2f, Matrix3x2f_m00);
 unsafe.putLong(nullptr, long0 + 8L, 0L);
 unsafe.putLong(nullptr, long0 + 16L, unsafe.getLong(matrix3x2f, Matrix3x2f_m00 + 8L);
 unsafe.putLong(nullptr, long0 + 24L, 0L);
 unsafe.putLong(nullptr, long0 + 32L, 0L);
 unsafe.putLong(nullptr, long0 + 40L, 1065353216L);
 unsafe.putLong(nullptr, long0 + 48L, unsafe.getLong(matrix3x2f, Matrix3x2f_m00 + 16L);
 ...
 unsafe.putLong(nullptr, long0 + 12L, unsafe.getLong(matrix3x2f, Matrix3x2f_m00 + 8L);
 unsafe.putInt(nullptr, long0 + 20L, 0);
 unsafe.putLong(nullptr, long0 + 24L, unsafe.getLong(matrix3x2f, Matrix3x2f_m00 + 16L);
 ...
 for (int int0 = 0; int0 < 3; int0++) {
 UNSAFE.putLong(nullptr, long0 + (int0 << 4), UNSAFE.getLong(matrix3f, Matrix3f_m00 + 12 * int0);
 UNSAFE.putFloat(nullptr, long0 + (int0 << 4) + 8L, UNSAFE.getFloat(matrix3f, Matrix3f_m00 + 8L + 12 * int0);
 ...
 UNSAFE.putLong(nullptr, long0 + 8L, UNSAFE.getLong(matrix2f, Matrix2f_m00 + 8L);
 }
 ...
 UNSAFE.putLong(nullptr, long0 + 8L, UNSAFE.getLong(vector4f, Vector4f_x + 8L);
 }

 static void put(Vector4i vector4i, long long0) {
 UNSAFE.putLong(nullptr, long0, UNSAFE.getLong(vector4i, Vector4i_x);
 UNSAFE.putLong(nullptr, long0 + 8L, UNSAFE.getLong(vector4i, Vector4i_x + 8L);
 }
 ...
 UNSAFE.putLong(matrix2f, Matrix2f_m00 + 8L, UNSAFE.getLong(nullptr, long0 + 8L);
 }
 ...
 unsafe.putFloat(nullptr, long0, 1.0F - float4 - float5);
 unsafe.putFloat(nullptr, long0 + 4L, float6 + float11);
 unsafe.putLong(nullptr, long0 + 8L, Float.floatToRawIntBits(float7 - float10) & 4294967295L);
 unsafe.putFloat(nullptr, long0 + 16L, float6 - float11);
 unsafe.putFloat(nullptr, long0 + 20L, 1.0F - float5 - float3);
 unsafe.putLong(nullptr, long0 + 24L, Float.floatToRawIntBits(float9 + float8) & 4294967295L);
 unsafe.putFloat(nullptr, long0 + 32L, float7 + float10);
 unsafe.putFloat(nullptr, long0 + 36L, float9 - float8);
 unsafe.putLong(nullptr, long0 + 40L, Float.floatToRawIntBits(1.0F - float4 - float3) & 4294967295L);
