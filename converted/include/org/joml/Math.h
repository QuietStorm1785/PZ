...
public:
 ...
 static const float pi2OverLookupSize = (float) (java.lang.Math.PI * 2) / lookupTableSize;
 static const float lookupSizeOverPi2 = lookupTableSize / (float) (java.lang.Math.PI * 2);
 ...
 static float sqrt(float float0) {
 return (float)java.lang.Math.sqrt(float0);
 }

 static double sqrt(double double0) {
 ...
 static float tan(float float0) {
 return (float)java.lang.Math.tan(float0);
 }

 static double tan(double double0) {
 return java.lang.Math.tan(double0);
 }

 static float acos(float float0) {
 return (float)java.lang.Math.acos(float0);
 }

 static double acos(double double0) {
 ...
 static float asin(float float0) {
 return (float)java.lang.Math.asin(float0);
 }

 static double asin(double double0) {
 ...
 static float abs(float float0) {
 return java.lang.Math.abs(float0);
 }

 static double abs(double double0) {
 ...
 static int abs(int int0) {
 return java.lang.Math.abs(int0);
 }

 static int max(int int0, int int1) {
 return java.lang.Math.max(int0, int1);
 }

 static int min(int int0, int int1) {
 ...
 static float clamp(float float0, float float1, float float2) {
 return max();
 }
 ...
 static int clamp(int int0, int int1, int int2) {
 return max();
 }
 ...
 static double floor(double double0) {
 ...
 static double ceil(double double0) {
 return java.lang.Math.ceil(double0);
 }

 static float ceil(float float0) {
 return (float)java.lang.Math.ceil(float0);
 }

 static long round(double double0) {
 return java.lang.Math.round(double0);
 }

 static int round(float float0) {
 return java.lang.Math.round(float0);
 }

 static double exp(double double0) {
 return java.lang.Math.exp(double0);
 }

 static bool isFinite(double double0) {
 return abs();
 }

 static bool isFinite(float float0) {
 return abs();
 }
 ...
 static float biLerp(float float1, float float2, float float5, float float6, float float3, float float7) {
 float float0 = lerp(float1, float2, float3);
 float float4 = lerp(float5, float6, float3);
 return lerp();
 }

 static double biLerp(double double1, double double2, double double5, double double6, double double3, double double7) {
 ...
 static float signum(float float0) {
 return java.lang.Math.signum(float0);
 }

 static int signum(int int0) {
 return Integer.signum(int0);
 }

 static int signum(long long0) {
