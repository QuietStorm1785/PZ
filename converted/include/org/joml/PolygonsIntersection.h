...
public:
private
  static final PolygonsIntersection.ByStartComparator byStartComparator =
      new PolygonsIntersection.ByStartComparator();
private
  static final PolygonsIntersection.ByEndComparator byEndComparator =
      new PolygonsIntersection.ByEndComparator();
protected
  final float[] verticesXY;
  float minX;
  float minY;
  float maxX;
  float maxY;
...
private
  PolygonsIntersection.IntervalTreeNode buildNode(List list, float float6) {
    ...
    std::vector arrayList1 = null;
    std::vector arrayList2 = null;
    std::vector arrayList3 = null;
