...
public:
 private static PolygonsIntersection.ByStartComparator byStartComparator = new PolygonsIntersection.ByStartComparator();
 private static PolygonsIntersection.ByEndComparator byEndComparator = new PolygonsIntersection.ByEndComparator();
 ...
 static bool computeEvenOdd(float[] floats, PolygonsIntersection.Interval interval, float float4, float float5, bool boolean1, BitSet bitSet) {
 ...
 bool traverse(float[] floats, float float1, float float0, bool boolean1, BitSet bitSet) {
 bool boolean0 = boolean1;
