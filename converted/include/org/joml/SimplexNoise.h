...
public:
private
  static final SimplexNoise.Vector3b[] grad3 =
      new SimplexNoise.Vector3b[]{new SimplexNoise.Vector3b(1, 1, 0),
                                  ...
                                  new SimplexNoise.Vector3b(0, -1, -1)};
private
  static final SimplexNoise.Vector4b[] grad4 =
...
private
  static final byte[] p = new byte[]{
      ...
      -41,  61,   -100, -76};
private
  static final byte[] perm = new byte[512];
private
  static final byte[] permMod12 = new byte[512];
