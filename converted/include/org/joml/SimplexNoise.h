...
class SimplexNoise {
public:
 private static SimplexNoise.Vector3b[] grad3 = new SimplexNoise.Vector3b[]{
 ...
 private static SimplexNoise.Vector4b[] grad4 = new SimplexNoise.Vector4b[]{
 ...
 static float dot(SimplexNoise.Vector3b vector3b, float float2, float float1, float float0) {
 return vector3b.x * float2 + vector3b.y * float1 + vector3b.z * float0;
 }

 static float dot(SimplexNoise.Vector4b vector4b, float float3, float float2, float float1, float float0) {
