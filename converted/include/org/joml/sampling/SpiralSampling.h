...
public:
 ...
 void createEquiAngle(float float2, int int2, int int1, Callback2d callback2d) {
 ...
 void createEquiAngle(float float1, int int0, int int2, float float4, Callback2d callback2d) {
