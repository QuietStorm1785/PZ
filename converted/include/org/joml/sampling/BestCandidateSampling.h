...
public
  ...
  public
    BestCandidateSampling.Cube seed(long long0) {
      this.seed = long0;
      return this;
    }

  public
    BestCandidateSampling.Cube numSamples(int int0) {
      this.numSamples = int0;
      return this;
    }

  public
    BestCandidateSampling.Cube numCandidates(int int0) {
      this.numCandidates = int0;
      return this;
    }

  public
    BestCandidateSampling.Cube generate(final float[] floats) {
      final BestCandidateSampling.IntHolder intHolder =
          new BestCandidateSampling.IntHolder();
...
public BestCandidateSampling.Cube
generate(final FloatBuffer floatBuffer) {
  final BestCandidateSampling.IntHolder intHolder =
      new BestCandidateSampling.IntHolder();
...
public
BestCandidateSampling.Cube generate(Callback3d callback3d) {
  BestCandidateSampling.Octree octree =
      new BestCandidateSampling.Octree(-1.0F, -1.0F, -1.0F, 2.0F);
  ...
  for (int int0 = 0; int0 < this.numSamples; int0++) {
    ...
    for (int int1 = 0; int1 < this.numCandidates; int1++) {
      ...
      float float7 = octree.nearest(float4, float5, float6, float3,
...
public
  BestCandidateSampling.Disk seed(long long0) {
    this.seed = long0;
    return this;
  }

public
  BestCandidateSampling.Disk numSamples(int int0) {
    this.numSamples = int0;
    return this;
  }

public
  BestCandidateSampling.Disk numCandidates(int int0) {
    this.numCandidates = int0;
    return this;
  }

public
  BestCandidateSampling.Disk generate(final float[] floats) {
    final BestCandidateSampling.IntHolder intHolder =
        new BestCandidateSampling.IntHolder();
    ...
    void onNewSample(float float0, float float1) {
          ...
          public
            BestCandidateSampling.Disk generate(final FloatBuffer floatBuffer) {
              final BestCandidateSampling.IntHolder intHolder =
                  new BestCandidateSampling.IntHolder();
              const int int0 = floatBuffer.position();
            return this.generate(std::make_unique<Callback2d>() {
    void onNewSample(float float0, float float1) {
          ...
          public
            BestCandidateSampling.Disk generate(Callback2d callback2d) {
              BestCandidateSampling.QuadTree quadTree =
                  new BestCandidateSampling.QuadTree(-1.0F, -1.0F, 2.0F);
              Random random = new Random(this.seed);
              ...
              for (int int0 = 0; int0 < this.numSamples; int0++) {
                ...
                for (int int1 = 0; int1 < this.numCandidates; int1++) {
                  ...
                  float float5 = quadTree.nearest(float3, float4, float2,
                                                  Float.POSITIVE_INFINITY);
                  if (float5 > float2) {
                    float2 = float5;
                    float0 = float3;
          ...
          private
            ...
            private static class Octree {
              ...
              std::vector objects;
            private
              BestCandidateSampling.Octree[] children;
              ...
              void split() {
                ...
                this.children[1] = new BestCandidateSampling.Octree(
                    this.minX, this.minY, this.minZ, this.hs);
                this.children[0] = new BestCandidateSampling.Octree(
                    this.minX + this.hs, this.minY, this.minZ, this.hs);
                this.children[2] = new BestCandidateSampling.Octree(
                    this.minX, this.minY + this.hs, this.minZ, this.hs);
                this.children[3] = new BestCandidateSampling.Octree(
                    this.minX + this.hs, this.minY + this.hs, this.minZ,
                    this.hs);
                this.children[5] = new BestCandidateSampling.Octree(
                    this.minX, this.minY, this.minZ + this.hs, this.hs);
                this.children[4] = new BestCandidateSampling.Octree(
                    this.minX + this.hs, this.minY, this.minZ + this.hs,
                    this.hs);
                this.children[6] = new BestCandidateSampling.Octree(
                    this.minX, this.minY + this.hs, this.minZ + this.hs,
                    this.hs);
                this.children[7] = new BestCandidateSampling.Octree(
                    this.minX + this.hs, this.minY + this.hs,
                    this.minZ + this.hs, this.hs);
              }

              void insertIntoChild(Vector3f vector3f) {
                this.children[this.octant(vector3f.x, vector3f.y, vector3f.z)]
                    .insert(vector3f);
              }
              ...
              float nearest(float float4, float float3, float float2,
                            float float6, float float1) {
                float float0 = float1;
                if (!(float4 < this.minX - float1) &&
                  ...
                  if (this.children != nullptr) {
                    ...
                    for (int int1 = 0; int1 < 8; int1++) {
                      float float5 = this.children[int0].nearest(
                          float4, float3, float2, float6, float0);
                    ...
                    for (int int2 = 0;
                         this.objects != nullptr && int2 < this.objects.size();
                         int2++) {
                      Vector3f vector3f = (Vector3f)this.objects.get(int2);
                      float float9 =
                          vector3f.distanceSquared(float4, float3, float2);
                      if (float9 <= float8) {
                        return float6;
                      }
            ...
            public
              BestCandidateSampling.Quad seed(long long0) {
                this.seed = long0;
                return this;
              }

            public
              BestCandidateSampling.Quad numSamples(int int0) {
                this.numSamples = int0;
                return this;
              }

            public
              BestCandidateSampling.Quad numCandidates(int int0) {
                this.numCandidates = int0;
                return this;
              }

            public
              BestCandidateSampling.Quad generate(final float[] floats) {
                final BestCandidateSampling.IntHolder intHolder =
                    new BestCandidateSampling.IntHolder();
            return this.generate(std::make_unique<Callback2d>() {
    void onNewSample(float float0, float float1) {
          ...
          public
            BestCandidateSampling.Quad generate(final FloatBuffer floatBuffer) {
              final BestCandidateSampling.IntHolder intHolder =
                  new BestCandidateSampling.IntHolder();
              const int int0 = floatBuffer.position();
            return this.generate(std::make_unique<Callback2d>() {
    void onNewSample(float float0, float float1) {
          ...
          public
            BestCandidateSampling.Quad generate(Callback2d callback2d) {
              BestCandidateSampling.QuadTree quadTree =
                  new BestCandidateSampling.QuadTree(-1.0F, -1.0F, 2.0F);
              Random random = new Random(this.seed);
          ...
          private
            static class QuadTree {
              ...
              std::vector objects;
            private
              BestCandidateSampling.QuadTree[] children;
              ...
              void split() {
                ...
                this.children[1] = new BestCandidateSampling.QuadTree(
                    this.minX, this.minY, this.hs);
                this.children[0] = new BestCandidateSampling.QuadTree(
                    this.minX + this.hs, this.minY, this.hs);
                this.children[2] = new BestCandidateSampling.QuadTree(
                    this.minX, this.minY + this.hs, this.hs);
                this.children[3] = new BestCandidateSampling.QuadTree(
                    this.minX + this.hs, this.minY + this.hs, this.hs);
              }

              void insertIntoChild(Vector2f vector2f) {
                this.children[this.quadrant(vector2f.x, vector2f.y)].insert(
                    vector2f);
              }
              ...
              float nearest(float float3, float float2, float float5,
                            float float1) {
                float float0 = float1;
                if (!(float3 < this.minX - float1) &&
                  ...
                  if (this.children != nullptr) {
                    ...
                    for (int int1 = 0; int1 < 4; int1++) {
                      float float4 = this.children[int0].nearest(
                          float3, float2, float5, float0);
            ...
            public
              BestCandidateSampling.Sphere generate(final float[] floats) {
                final BestCandidateSampling.IntHolder intHolder =
                    new BestCandidateSampling.IntHolder();
            return this.generate(std::make_unique<Callback3d>() {
    void onNewSample(float float0, float float1, float float2) {
    ...
    void onNewSample(float float0, float float1, float float2) {
          ...
          public
            BestCandidateSampling.Sphere seed(long long0) {
              this.seed = long0;
              return this;
            }

          public
            BestCandidateSampling.Sphere numSamples(int int0) {
              this.numSamples = int0;
              return this;
            }

          public
            BestCandidateSampling.Sphere numCandidates(int int0) {
              this.numCandidates = int0;
              return this;
            }

          public
            BestCandidateSampling.Sphere onHemisphere(boolean boolean0) {
              this.onHemisphere = boolean0;
              return this;
            }

          public
            BestCandidateSampling.Sphere generate(Callback3d callback3d) {
              Random random = new Random(this.seed);
              BestCandidateSampling.Sphere.Node node =
                  new BestCandidateSampling.Sphere.Node();
              ...
              for (int int0 = 0; int0 < this.numSamples; int0++) {
                ...
                for (int int1 = 0; int1 < this.numCandidates; int1++) {
                  ...
                  float float6 =
                      (float)Math.sqrt(1.0 - float4 * float4 - float5 * float5);
                  float float7 = 2.0F * float4 * float6;
                  float float8 = 2.0F * float5 * float6;
                  float float9 =
                      1.0F - 2.0F * (float4 * float4 + float5 * float5);
          ...
          private
            static final class Node {
              ...
              std::vector objects;
            private
              BestCandidateSampling.Sphere.Node[] children;

              Node() {
                this.children = new BestCandidateSampling.Sphere.Node[8];
                float float0 = 1.0F;
                this.arc = (float)(java.lang.Math.PI * 2);
                this.children[0] = new BestCandidateSampling.Sphere.Node(
                    -float0, 0.0F, 0.0F, 0.0F, 0.0F, float0, 0.0F, float0,
                    0.0F);
                this.children[1] = new BestCandidateSampling.Sphere.Node(
                    0.0F, 0.0F, float0, float0, 0.0F, 0.0F, 0.0F, float0, 0.0F);
                this.children[2] = new BestCandidateSampling.Sphere.Node(
                    float0, 0.0F, 0.0F, 0.0F, 0.0F, -float0, 0.0F, float0,
                    0.0F);
                this.children[3] = new BestCandidateSampling.Sphere.Node(
                    0.0F, 0.0F, -float0, -float0, 0.0F, 0.0F, 0.0F, float0,
                    0.0F);
                this.children[4] = new BestCandidateSampling.Sphere.Node(
                    -float0, 0.0F, 0.0F, 0.0F, -float0, 0.0F, 0.0F, 0.0F,
                    float0);
                this.children[5] = new BestCandidateSampling.Sphere.Node(
                    0.0F, 0.0F, float0, 0.0F, -float0, 0.0F, float0, 0.0F,
                    0.0F);
                this.children[6] = new BestCandidateSampling.Sphere.Node(
                    float0, 0.0F, 0.0F, 0.0F, -float0, 0.0F, 0.0F, 0.0F,
                    -float0);
                this.children[7] = new BestCandidateSampling.Sphere.Node(
                    0.0F, 0.0F, -float0, 0.0F, -float0, 0.0F, -float0, 0.0F,
                    0.0F);
              }

            private
              Node(float float0, float float1, float float2, float float3,
                ...
                float float9 = Math.invsqrt(
                    this.cx * this.cx + this.cy * this.cy + this.cz * this.cz);
                this.cx *= float9;
                this.cy *= float9;
                this.cz *= float9;
                float float10 = this.greatCircleDist(
                    this.cx, this.cy, this.cz, this.v0x, this.v0y, this.v0z);
                float float11 = this.greatCircleDist(
                    this.cx, this.cy, this.cz, this.v1x, this.v1y, this.v1z);
                float float12 = this.greatCircleDist(
                    this.cx, this.cy, this.cz, this.v2x, this.v2y, this.v2z);
              ...
              void split() {
                ...
                float float11 = Math.invsqrt(float8 * float8 + float9 * float9 +
                                             float10 * float10);
                float8 *= float11;
                float9 *= float11;
                float10 *= float11;
                ...
                this.children[0] = new BestCandidateSampling.Sphere.Node(
                    this.v0x, this.v0y, this.v0z, float8, float9, float10,
                    float4, float5, float6);
                this.children[1] = new BestCandidateSampling.Sphere.Node(
                    this.v1x, this.v1y, this.v1z, float0, float1, float2,
                    float8, float9, float10);
                this.children[2] = new BestCandidateSampling.Sphere.Node(
                    this.v2x, this.v2y, this.v2z, float4, float5, float6,
                    float0, float1, float2);
                this.children[3] = new BestCandidateSampling.Sphere.Node(
                    float0, float1, float2, float4, float5, float6, float8,
                    float9, float10);
              }
              ...
              void insertIntoChild(Vector3f vector3f) {
                for (int int0 = 0; int0 < this.children.length; int0++) {
                  ...
                  if (isPointOnSphericalTriangle(
                          vector3f.x, vector3f.y, vector3f.z, node1.v0x,
                          node1.v0y, node1.v0z, node1.v1x, node1.v1y, node1.v1z,
                          node1.v2x, node1.v2y, node1.v2z, 1.0E-6F)) {
            ...
            private
              static boolean isPointOnSphericalTriangle(
                  float float19, float float17, float float16, float float2,
                  float float5, float float8, float float1, float float4,
                  float float7, float float10, float float12, float float14,
                  float float22) {
                ...
                float float21 =
                    float0 * float15 + float3 * float18 + float6 * float20;
                if (float21 > -float22 && float21 < float22) {
                  ...
                  float float27 = (float23 * float15 + float24 * float18 +
                                   float25 * float20) *
                                  float26;
                  if (!(float27 < 0.0F) && !(float27 > 1.0F)) {
                    ...
                    float float31 = (float19 * float28 + float17 * float29 +
                                     float16 * float30) *
                                    float26;
                    if (!(float31 < 0.0F) && !(float27 + float31 > 1.0F)) {
                      float float32 = (float9 * float28 + float11 * float29 +
                                       float13 * float30) *
                                      float26;
              ...
              int child(float float0, float float1, float float2) {
                for (int int0 = 0; int0 < this.children.length; int0++) {
                  BestCandidateSampling.Sphere.Node node1 = this.children[int0];
                  if (isPointOnSphericalTriangle(
                          float0, float1, float2, node1.v0x, node1.v0y,
                          node1.v0z, node1.v1x, node1.v1y, node1.v1z, node1.v2x,
                          node1.v2y, node1.v2z, 1.0E-5F)) {
                    return int0;
                  }
                }
              ...
              float greatCircleDist(float float5, float float3, float float1,
                                    float float6, float float4, float float2) {
                float float0 =
                    float5 * float6 + float3 * float4 + float1 * float2;
                return (float)((-java.lang.Math.PI / 2) * float0 +
                               (java.lang.Math.PI / 2));
              }

              float nearest(float float0, float float1, float float2) {
                return this.nearest(float0, float1, float2,
                                    Float.POSITIVE_INFINITY);
              }

              float nearest(float float1, float float2, float float3,
                            float float4) {
                float float0 = this.greatCircleDist(float1, float2, float3,
                ...
                if (float0 - this.arc > float4) {
                  ...
                  if (this.children != nullptr) {
                    ...
                    for (int int3 = 0; int3 < int0; int3++) {
                      float float6 = this.children[int2].nearest(
                          float1, float2, float3, float5);
                    ...
                    for (int int4 = 0;
                         this.objects != nullptr && int4 < this.objects.size();
                         int4++) {
                      Vector3f vector3f = (Vector3f)this.objects.get(int4);
                      float float7 = this.greatCircleDist(
                          vector3f.x, vector3f.y, vector3f.z, float1, float2,
                          float3);
                      if (float7 < float5) {
                        float5 = float7;
                      }
