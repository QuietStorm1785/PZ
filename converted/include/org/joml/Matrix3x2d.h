...
public:
 ...
 Matrix3x2d set(double arg0, double arg1, double arg2, double arg3, double arg4, double arg5) {
 this->m00 = arg0;
 this->m01 = arg1;
 this->m10 = arg2;
 this->m11 = arg3;
 ...
 Matrix3x2d scaleAroundLocal(double arg0, double arg1, double arg2, double arg3, double arg4, double arg5) {
 ...
 Matrix3x2d scaling(double arg0) {
 ...
 Vector2d unproject(double double8, double double10, int[] ints, Vector2d vector2d) {
 double double0 = 1.0 / (this->m00 * this->m11 - this->m01 * this->m10);
 double double1 = this->m11 * double0;
 double double2 = -this->m01 * double0;
 double double3 = -this->m10 * double0;
 ...
 Vector2d unprojectInv(double double1, double double3, int[] ints, Vector2d vector2d) {
