...
public:
 ...
 Matrix3x2f set(float arg0, float arg1, float arg2, float arg3, float arg4, float arg5) {
 this->m00 = arg0;
 this->m01 = arg1;
 this->m10 = arg2;
 this->m11 = arg3;
 ...
 Matrix3x2f scaleAroundLocal(float arg0, float arg1, float arg2, float arg3, float arg4, float arg5) {
 ...
 Vector2f unproject(float float8, float float10, int[] ints, Vector2f vector2f) {
 float float0 = 1.0F / (this->m00 * this->m11 - this->m01 * this->m10);
 float float1 = this->m11 * float0;
 float float2 = -this->m01 * float0;
 float float3 = -this->m10 * float0;
 ...
 Vector2f unprojectInv(float float1, float float3, int[] ints, Vector2f vector2f) {
