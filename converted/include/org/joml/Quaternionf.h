...
public:
 ...
 static Quaternionfc slerp(Quaternionf[] quaternionfs, float[] floats, Quaternionf quaternionf) {
 ...
 static Quaternionfc nlerp(Quaternionfc[] quaternionfcs, float[] floats, Quaternionf quaternionf) {
 ...
 static Quaternionfc nlerpIterative(Quaternionf[] quaternionfs, float[] floats, float float3, Quaternionf quaternionf) {
 quaternionf.set(quaternionfs[0]);
 float float0 = floats[0];
 ...
 Quaternionf lookAlong(float arg0, float arg1, float arg2, float arg3, float arg4, float arg5) {
 ...
 Quaternionf rotateTo(float arg0, float arg1, float arg2, float arg3, float arg4, float arg5) {
