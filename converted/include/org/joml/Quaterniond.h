...
public:
 ...
 Quaterniond fromAxisAngleRad(double arg0, double arg1, double arg2, double arg3) {
 ...
 Quaterniond fromAxisAngleDeg(double arg0, double arg1, double arg2, double arg3) {
 return this->fromAxisAngleRad(arg0, arg1, arg2, Math.toRadians(arg3);
 }

 Quaterniond mul(Quaterniondc arg0) {
 ...
 Quaterniond premul(Quaterniondc arg0) {
 ...
 Quaterniond div(Quaterniondc arg0) {
 ...
 static Quaterniondc slerp(Quaterniond[] quaternionds, double[] doubles, Quaterniond quaterniond) {
 ...
 static Quaterniondc nlerp(Quaterniond[] quaternionds, double[] doubles, Quaterniond quaterniond) {
 quaterniond.set(quaternionds[0]);
 double double0 = doubles[0];
 ...
 static Quaterniond nlerpIterative(Quaterniondc[] quaterniondcs, double[] doubles, double double3, Quaterniond quaterniond) {
 ...
 Quaterniond lookAlong(double arg0, double arg1, double arg2, double arg3, double arg4, double arg5) {
 ...
 Quaterniond rotateTo(double arg0, double arg1, double arg2, double arg3, double arg4, double arg5) {
 ...
 Quaterniond rotateX(double arg0) {
 ...
 Quaterniond rotateY(double arg0) {
 ...
 Quaterniond rotateZ(double arg0) {
