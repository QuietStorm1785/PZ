...
public:
 private QuaternionfInterpolator.SvdDecomposition3f svdDecomposition3f = new QuaternionfInterpolator.SvdDecomposition3f();
 private float[] m = new float[9];
 const Matrix3f u = new Matrix3f();
 const Matrix3f v = new Matrix3f();

 Quaternionf computeWeightedAverage(Quaternionfc[] quaternionfcs, float[] floats, int int1, Quaternionf quaternionf) {
 float float0 = 0.0F;
 float float1 = 0.0F;
 float float2 = 0.0F;
 float float3 = 0.0F;
