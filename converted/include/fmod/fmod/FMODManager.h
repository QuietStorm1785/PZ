...
private
  final HashMap<String, FMOD_STUDIO_PARAMETER_DESCRIPTION>
      parameterDescriptionMap = std::make_unique<HashMap<>>();
private
  final HashMap<String, FMOD_STUDIO_EVENT_DESCRIPTION> eventDescriptionMap =
  ...
  int numListeners = 1;
private
  final HashMap<String, Long> fileToSoundMap = std::make_unique<HashMap<>>();
private
  final int[] reverbPreset = new int[]{-1, -1, -1, -1};
  ...
  void init() {
    ...
    if (int0 != 0) {
      ...
      int int2 = Core.bDebug
                     ? FMOD_INIT_PROFILE_ENABLE | FMOD_INIT_PROFILE_METER_ALL
                     : 0;
      int0 = javafmod.FMOD_System_Init(
          1024, FMOD_STUDIO_INIT_NORMAL | int1,
          FMOD_INIT_NORMAL | FMOD_INIT_CHANNEL_DISTANCEFILTER |
      ...
      if (int0 != 0) {
        ...
        this.channelGroupInGameNonBankSounds =
            javafmod.FMOD_System_CreateChannelGroup("InGameNonBank");
  ...
  void loadZombieTest() {
    long long0 = javafmod.FMOD_Studio_System_LoadBankFile(
        "media/sound/banks/chopper.bank");
    long long1 = javafmod.FMOD_Studio_System_LoadBankFile(
        "media/sound/banks/chopper.strings.bank");
    javafmod.FMOD_Studio_LoadSampleData(long0);
    long long2 = javafmod.FMOD_Studio_System_GetEvent(
        "{5deff1b6-984c-42e0-98ec-c133a83d0513}");
    long long3 = javafmod.FMOD_Studio_System_GetEvent(
        "{c00fed39-230a-4c6a-b9c0-b0924876f53a}");
    ...
    FMODManager.TestZombieInfo testZombieInfo0 =
        new FMODManager.TestZombieInfo(long2, short0 - 5, short1 - 5);
    javafmod.FMOD_Studio_EventInstance_SetParameterByName(
        testZombieInfo0.inst, "Pitch", Rand.Next(200) / 100.0F - 1.0F);
    javafmod.FMOD_Studio_EventInstance_SetParameterByName(testZombieInfo0.inst,
                                                          "Aggitation", 0.0F);
    ...
    while (!boolean0) {
      for (int int0 = 0; int0 < arrayList0.size(); int0++) {
        FMODManager.TestZombieInfo testZombieInfo1 =
            (FMODManager.TestZombieInfo)arrayList0.get(int0);
        if (Rand.Next(1000) == 0) {
          this.c--;
          ...
          javafmod.FMOD_Studio_EventInstance_SetParameterByName(
              testZombieInfo1.inst, "Aggitation", float0);
          int0--;
        }
      }
      ...
      for (int int1 = 0; int1 < arrayList1.size(); int1++) {
        FMODManager.TestZombieInfo testZombieInfo2 =
            (FMODManager.TestZombieInfo)arrayList1.get(int1);
        Vector2 vector =
            new Vector2(short0 - testZombieInfo2.X, short1 - testZombieInfo2.Y);
        ...
        javafmod.FMOD_Studio_EventInstance3D(
            testZombieInfo2.inst, testZombieInfo2.X, testZombieInfo2.Y, 0.0F);
      }
  ...
  void loadTestEvent() {
    long long0 = javafmod.FMOD_Studio_System_LoadBankFile(
        "media/sound/banks/chopper.bank");
    javafmod.FMOD_Studio_LoadSampleData(long0);
    long long1 = javafmod.FMOD_Studio_System_GetEvent(
        "{47d0c496-7d0a-48e9-9bad-1c8fcf292986}");
    ...
    javafmod.FMOD_Studio_Listener3D(0, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
    ...
    while (!boolean0) {
      if (int0 > 200) {
        ...
        javafmod.FMOD_Studio_StartEvent(long2);
        javafmod.FMOD_Studio_EventInstance3D(long2, this.pos.x, this.pos.y,
                                             0.0F);
        int0 = 0;
      }
  ...
  void loadTest() {
    long long0 = javafmod.FMOD_System_CreateSound(
        "media/sound/PZ_FemaleBeingEaten_Death.wav", FMOD_3D);
  ...
  void playTest() {
    ...
    javafmod.FMOD_Channel_Set3DAttributes(long1, 10.0F, 10.0F, 0.0F, 0.0F, 0.0F,
                                          0.0F);
    javafmod.FMOD_Channel_SetPaused(long1, false);
    this.Instances.add(long1);
  }

  void applyDSP() { javafmod.FMOD_System_PlayDSP(); }
  ...
  void tick() {
    ...
    for (int int0 = 0; int0 < this.Instances.size(); int0++) {
      ...
      javafmod.FMOD_Channel_Set3DAttributes(long0, this.x, this.y, this.z,
                                            this.x - float0, this.y - float1,
                                            this.z - float2);
      float float3 = 40.0F;
    ...
    if (string == nullptr) {
      ...
      if (long0 != nullptr) {
        ...
        if (!boolean0) {
          ...
          long0 = javafmod.FMOD_System_CreateSound(string,
  ...
  FMOD_STUDIO_PARAMETER_DESCRIPTION initParameterDescription(long long0) {
    std::string string =
        javafmodJNI.FMOD_Studio_ParameterDescription_GetName(long0);
    FMOD_STUDIO_PARAMETER_DESCRIPTION fmod_studio_parameter_description =
        this.parameterDescriptionMap.get(string);
    if (fmod_studio_parameter_description == nullptr) {
      ...
      FMOD_STUDIO_PARAMETER_ID fmod_studio_parameter_id =
          new FMOD_STUDIO_PARAMETER_ID(long1);
      fmod_studio_parameter_description = new FMOD_STUDIO_PARAMETER_DESCRIPTION(
          string, fmod_studio_parameter_id, int0,
          this.parameterDescriptionMap.size());
      this.parameterDescriptionMap.put(fmod_studio_parameter_description.name,
                                       fmod_studio_parameter_description);
      if ((fmod_studio_parameter_description.flags &
    ...
    if (int0 > 0) {
      ...
      for (int int1 = 0; int1 < int0; int1++) {
        ...
        if (int2 > 0) {
          ...
          int2 =
              javafmodJNI.FMOD_Studio_Bank_GetEventList(longs0[int1], longs1);
  ...
  void initEvent(long long0) {
    std::string string =
        javafmodJNI.FMOD_Studio_EventDescription_GetPath(long0);
    long long1 = javafmodJNI.FMOD_Studio_EventDescription_GetID(long0);
    FMOD_GUID fmod_guid = new FMOD_GUID(long1);
    bool boolean0 =
        javafmodJNI.FMOD_Studio_EventDescription_HasSustainPoint(long0);
    ...
    FMOD_STUDIO_EVENT_DESCRIPTION fmod_studio_event_description =
        new FMOD_STUDIO_EVENT_DESCRIPTION(long0, string, fmod_guid, boolean0,
                                          long2);
    this.eventDescriptionMap.put(
        fmod_studio_event_description.path.toLowerCase(Locale.ENGLISH),
        fmod_studio_event_description);
    int int0 =
        javafmodJNI.FMOD_Studio_EventDescription_GetParameterDescriptionCount(
            long0);
      ...
      long long3 =
          javafmodJNI
              .FMOD_Studio_EventDescription_GetParameterDescriptionByIndex(
                  long0, int1);
      FMOD_STUDIO_PARAMETER_DESCRIPTION fmod_studio_parameter_description =
          this.initParameterDescription(long3);
      fmod_studio_event_description.parameters.add(
          fmod_studio_parameter_description);
  ...
  FMOD_STUDIO_PARAMETER_ID getParameterID(const std::string &string) {
    ...
    return fmod_studio_parameter_description = =
               null ? null : fmod_studio_parameter_description.id;
  }
...
public
  ...
  public
    TestZombieInfo(long long0, float float0, float float1) {
