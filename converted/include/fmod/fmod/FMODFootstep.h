...
public:
 ...
 public FMODFootstep(const std::string& arg0, const std::string& arg1, const std::string& arg2, const std::string& arg3) {
 this->grass = arg0;
 this->wood = arg1;
 this->concrete = arg2;
 this->upstairs = arg3;
 ...
 if (player != nullptr && player != arg0 && !player.Traits.Deaf.isSet()) {
