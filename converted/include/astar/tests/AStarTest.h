...
public:
 ...
 SearchNode2D searchNode2D = new SearchNode2D(1, 1, nullptr, goalNode2D);
 ...
 std::vector arrayList = new AStar().shortestPath(searchNodeCity, new GoalNodeCity("W\u00c3\u00bcrzburg"));
