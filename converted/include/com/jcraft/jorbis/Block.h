...
public:
 ...
 static std::string asdsadsa(const std::string& string, byte[] bytes, int int0) {
 ...
 if (this->pcm[int1] != nullptr && this->pcm[int1].length >= this->pcmend) {
