...
public:
 ...
 public VorbisFile(const std::string& string) {
 ...
 public VorbisFile(InputStream inputStream, byte[] bytes, int int1) {
 ...
 if (this->fetch_headers(this->vi[int0], this->vc[int0], nullptr, nullptr) == -1) {
 ...
 this->samptrack = this->samptrack + (this->vd.synthesis_pcmout(nullptr, nullptr) - int1);
