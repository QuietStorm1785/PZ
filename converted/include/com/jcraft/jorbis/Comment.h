...
public:
 ...
 return this->comments <= int0 ? nullptr : new String(this->user_comments[int0], 0, this->user_comments[int0].length - 1);
 }
 ...
 std::string query(const std::string& string) {
 ...
 std::string toString() {
 std::string string = "Vendor: " + new String(this->vendor, 0, this->vendor.length - 1);
