...
private
  ...
  static int[] make_words(int[] ints2, int int0) {
    ...
    for (int int1 = 0; int1 < int0; int1++) {
      ...
      if (int2 > 0) {
        ...
        for (int int5 = int2 + 1; int5 < 33 && ints0[int5] >>> 1 == int3;
             int5++) {
          int3 = ints0[int5];
  ...
  static float dist(int int1, float[] floats1, int int3, float[] floats0,
                    int int2) {
    float float0 = 0.0F;
    ...
    if (this.dim > 8) {
      ...
      while (int0 < int1) {
        ...
        while (int4 < this.dim) {
          int int5 = int0++;
          floats[int6 + int5] =
              floats[int6 + int5] + this.valuelist[int3 + int4++];
        }
      }
    } else {
      int int7 = 0;
      ...
      while (int7 < int1) {
        ...
        case 8:
          int int11 = int7++;
          floats[int6 + int11] =
              floats[int6 + int11] + this.valuelist[int9 + int10++];
        case 7:
          int int12 = int7++;
          floats[int6 + int12] =
              floats[int6 + int12] + this.valuelist[int9 + int10++];
        case 6:
          int int13 = int7++;
          floats[int6 + int13] =
              floats[int6 + int13] + this.valuelist[int9 + int10++];
        case 5:
          int int14 = int7++;
          floats[int6 + int14] =
              floats[int6 + int14] + this.valuelist[int9 + int10++];
        case 4:
          int int15 = int7++;
          floats[int6 + int15] =
              floats[int6 + int15] + this.valuelist[int9 + int10++];
        case 3:
          int int16 = int7++;
          floats[int6 + int16] =
              floats[int6 + int16] + this.valuelist[int9 + int10++];
        case 2:
          int int17 = int7++;
          floats[int6 + int17] =
              floats[int6 + int17] + this.valuelist[int9 + int10++];
        case 1:
          int int18 = int7++;
          floats[int6 + int18] =
              floats[int6 + int18] + this.valuelist[int9 + int10++];
        }
      }
    }
  ...
  int decodevs(float[] floats, int int4, Buffer buffer, int int5, int int1) {
    ...
    if (int0 == -1) {
      ...
      case 0:
        ...
        while (int6 < this.dim) {
          floats[int4 + int7] =
              floats[int4 + int7] + this.valuelist[int0 * this.dim + int6];
          int6++;
          int7 += int5;
        }
        break;
      case 1:
        ...
        while (int2 < this.dim) {
          floats[int4 + int3] =
              floats[int4 + int3] * this.valuelist[int0 * this.dim + int2];
          int2++;
          int3 += int5;
        }
      }
  ...
  synchronized int decodevs_add(float[] floats, int int7, Buffer buffer,
                                int int1) {
    ...
    for (int int5 = 0; int4 < this.dim; int5 += int0) {
      for (int int6 = 0; int6 < int0; int6++) {
        floats[int7 + int5 + int6] =
            floats[int7 + int5 + int6] + this.valuelist[this.t[int6] + int4];
      }
  ...
  int decodevv_add(float[][] floats, int int2, int int3, Buffer buffer,
                   int int4) {
    int int0 = 0;
    int int1 = int2 / int3;
  ...
  CodeBook.DecodeAux make_decode_tree() {
    ...
    if (ints2 == nullptr) {
      ...
      for (int int6 = 0; int6 < int5; int6++) {
        ...
        for (int8 = 0; int8 < decodeAux.tabn && (int7 > 0 || int8 == 0);
             int8++) {
          if ((int6 & 1 << int8) != 0) {
            int7 = ints1[int7];
          } else {
