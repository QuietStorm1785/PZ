...
public:
 ...
 byte[] bytes0 = boolean0 ? nullptr : ((DataBufferByte)dataBuffer).getData();
 short[] shorts = boolean0 ? ((DataBufferUShort)dataBuffer).getData() : nullptr;
 ...
 static void readFully(InputStream inputStream, byte[] bytes, int int3, int int1) {
 int int0 = 0;
