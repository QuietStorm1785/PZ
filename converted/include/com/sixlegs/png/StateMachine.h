...
public:
 ...
 throw PngException("Corrupted chunk type: 0x" + Integer.toHexString(int2), true);
 }
 }

 if (PngConstants.isPrivate(int2) && !PngConstants.isAncillary(int2) {
 throw PngException("Private critical chunk encountered: " + PngConstants.getChunkName(int2), true);
 } else {
 switch (int3) {
 case 0:
 if (int2 == 1229472850) {
 ...
 case 1933723988:
 case 1934772034:
 throw PngException(PngConstants.getChunkName(int2) + " cannot appear after PLTE", true);
 default:
 return 3;
 }
 default:
 ...
 case 1934902610:
 case 1951551059:
 throw PngException(PngConstants.getChunkName(int2) + " cannot appear after IDAT", true);
 default:
 return 5;
 }
 }
