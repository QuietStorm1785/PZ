...
public:
 ...
 static OggPage create(RandomAccessFile randomAccessFile) {
 return create();
 }
 ...
 static OggPage create(InputStream inputStream) {
 return create();
 }
 ...
 static OggPage create(byte[] bytes) {
 return create();
 }

 static OggPage create(byte[] bytes, bool boolean0) {
 return create();
 }
