...
public:
 ...
 protected CodeBook(BitInputStream bitInputStream) {
 ...
 return;
 default:
 throw VorbisFormatException("Unsupported codebook lookup type: " + int5);
 }
 }
 }
 }
 ...
 void readVvAdd(float[][] floats0, BitInputStream bitInputStream, int int3, int int4) {
 int int0 = 0;
