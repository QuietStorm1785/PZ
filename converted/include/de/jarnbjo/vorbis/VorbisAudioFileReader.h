...
public:
 ...
 throw UnsupportedAudioFileException(oggFormatException.getMessage());
 }
 }
 ...
 throw UnsupportedAudioFileException(vorbisFormatException.getMessage());
 }
 }
 ...
 private static VorbisAudioFileReader.VorbisFormatType instance = new VorbisAudioFileReader.VorbisFormatType();
