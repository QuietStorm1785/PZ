...
public:
 ...
 public Object[] pcall(Object object, Object[] objects1) {
 this->lock();
 ...
 const BlockingKahluaThread blockingKahluaThread = new BlockingKahluaThread(j2SEPlatform, table);
 const LuaClosure luaClosure0 = LuaCompiler.loadstring("x = (x or 0) + 1", "", blockingKahluaThread.getEnvironment());
