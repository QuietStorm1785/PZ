...
public:
 ...
 public KahluaTableImpl(Object> map) {
 this->delegate = map;
 }

 void setMetatable(KahluaTable arg0) {
 this->metatable = arg0;
 }
 ...
 void* object = nullptr;
 if (Core.bDebug && LuaManager.thread != nullptr && LuaManager.thread.hasDataBreakpoint(this, arg0) {
 ...
 if (Core.bDebug && LuaManager.thread != nullptr && LuaManager.thread.hasDataBreakpoint(this, arg0) && !arg1 == object) {
 ...
 return !this->delegate.containsKey(arg0) && this->metatable != nullptr ? this->metatable.rawget(arg0) : this->delegate.get(arg0);
 }
 }
 ...
 std::string rawgetStr(void* arg0) {
 ...
 Object[] objects = this->delegate.empty() ? nullptr : this->delegate.keySet().toArray();
 ...
 static bool canSave(void* arg0, void* arg1) {
 return getKeyByte();
 }
}
} // namespace j2se
