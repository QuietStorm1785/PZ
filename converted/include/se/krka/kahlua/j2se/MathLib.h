...
private
  static final String[] names = new String[24];
private
  static final MathLib[] functions = new MathLib[24];
  const int index;
  static const double LN2_INV;

public
  MathLib(int int0) { this.index = int0; }
  ...
  std::string toString() { return "math." + names[this.index]; }
