...
public:
 ...
 private static String[] meta_ops = new String[38];
 static LuaCallFrame LastCallFrame = nullptr;
 ...
 int lastCallFrame;
 bool bReset = false;
 public ArrayList<KahluaThread.Entry> profileEntries = std::make_unique<ArrayList<>>();
 public HashMap<String, KahluaThread.Entry> profileEntryMap = std::make_unique<HashMap<>>();
 static int m_error_count = 0;
 public static ArrayList<String> m_errors_list = std::make_unique<ArrayList<>>();
 ...
 HashMap<String, ArrayList<Long>> BreakpointMap = std::make_unique<HashMap<>>();
 HashMap<KahluaTable, ArrayList<Object>> BreakpointDataMap = std::make_unique<HashMap<>>();
 HashMap<KahluaTable, ArrayList<Object>> BreakpointReadDataMap = std::make_unique<HashMap<>>();
 ...
 throw RuntimeException(exception.getClass().getName() + " " + exception.getMessage() + " in " + (JavaFunction)object);
 }

 if (!(object instanceof LuaClosure) {
 throw RuntimeException("tried to call a non-function");
 } else {
 LuaCallFrame luaCallFrame = this->currentCoroutine.pushNewCallFrame((LuaClosure)object, nullptr, int1 + 1, int1, arg0, false, false);
 luaCallFrame.init();
 this->luaMainloop();
 ...
 LuaCallFrame luaCallFrame = coroutine.pushNewCallFrame(nullptr, javaFunction, int0, int1, int2, false, false);
 ...
 std::string string2 = coroutine0.getThread().currentfile + " " + string1.substring(0, string1.indexOf(":"));
 string0 = string2;
 }
 ...
 std::vector arrayList = this->BreakpointMap.get(luaCallFrame1.closure.prototype.filename);
 ...
 bool boolean16 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int95;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string18 = luaCallFrame0.closure.prototype.locvars[int96];
 ...
 bool boolean3 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int34;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string4 = luaCallFrame0.closure.prototype.locvars[int35];
 if (string4 == "group")) {
 bool boolean4 = false;
 }
 ...
 bool boolean15 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int91;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string17 = luaCallFrame0.closure.prototype.locvars[int92];
 ...
 bool boolean13 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int87;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string16 = luaCallFrame0.closure.prototype.locvars[int88];
 if (string16 == "group")) {
 ...
 void* object39 = this->tableget(luaClosure0.env, prototype0.constants[int82]);
 if (Core.bDebug) {
 int int83 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc - 1];
 bool boolean11 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int83;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string15 = luaCallFrame0.closure.prototype.locvars[int84];
 if (string15 == "group")) {
 ...
 void* object37 = this->getRegisterOrConstant(luaCallFrame0, int78, prototype0);
 void* object38 = this->tableget(object36, object37);
 if (Core.bDebug) {
 int int79 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc - 1];
 bool boolean10 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int79;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string14 = luaCallFrame0.closure.prototype.locvars[int80];
 ...
 bool boolean9 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int74;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string13 = luaCallFrame0.closure.prototype.locvars[int75];
 ...
 void* object1 = this->getRegisterOrConstant(luaCallFrame0, int6, prototype0);
 void* object2 = this->getRegisterOrConstant(luaCallFrame0, int7, prototype0);
 ...
 bool boolean8 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int70;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string12 = luaCallFrame0.closure.prototype.locvars[int71];
 ...
 void* object3 = this->getRegisterOrConstant(luaCallFrame0, int10, prototype0);
 ...
 void* object30 = this->getRegisterOrConstant(luaCallFrame0, int65, prototype0);
 void* object31 = this->getRegisterOrConstant(luaCallFrame0, int66, prototype0);
 void* object32 = nullptr;
 void* object33 = nullptr;
 void* object34 = nullptr;
 if ((object32 = KahluaUtil.rawTonumber(object30) != nullptr && (object33 = KahluaUtil.rawTonumber(object31) != nullptr) {
 ...
 bool boolean7 = luaCallFrame0.closure.prototype.lines[luaCallFrame0.pc] != int67;
 if (this == LuaManager.thread && luaCallFrame0.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 std::string string11 = luaCallFrame0.closure.prototype.locvars[int68];
 ...
 KahluaUtil.luaAssert(object11 != nullptr, "__len not defined for operand");
 ...
 void* object22 = this->getRegisterOrConstant(luaCallFrame0, int53, prototype0);
 void* object23 = this->getRegisterOrConstant(luaCallFrame0, int54, prototype0);
 ...
 void* object26 = this->call(object24, object22, object23, nullptr);
 ...
 } else if (luaCallFrame0.getClosure().prototype != nullptr && luaCallFrame0.getClosure().prototype.name != nullptr) {
 ...
 .pushNewCallFrame((LuaClosure)object41, nullptr, int105, int106, int103, true, luaCallFrame0.canYield);
 luaCallFrame2.init();
 ...
 throw RuntimeException("Tried to call a non-function: " + object41);
 }
 ...
 if (this->bReset) {
 throw RuntimeException("lua was reset");
 }
 }
 ...
 return object2 = = object3 && object2 != nullptr ? object2 : nullptr;
 } else {
 return nullptr;
 }
 }
 ...
 void* getRegisterOrConstant(LuaCallFrame luaCallFrame, int int1, Prototype prototype) {
 int int0 = int1 - 256;
 return int0 < 0 ? luaCallFrame.get(int1) : prototype.constants[int0];
 }

 static int getA8(int int0) {
 return int0 >>> 6 & 0xFF;
 }

 static int getC9(int int0) {
 return int0 >>> 14 & 511;
 }

 static int getB9(int int0) {
 return int0 >>> 23 & 511;
 }

 static int getBx(int int0) {
 return int0 >>> 14;
 }

 static int getSBx(int int0) {
 ...
 throw RuntimeException("attempted index: " + arg1 + " of non-table: " + object0);
 }
 ...
 throw RuntimeException("loop in gettable");
 }
 ...
 KahluaUtil.luaAssert(object1 != nullptr, "attempted index of non-table");
 }
 ...
 throw RuntimeException("loop in settable");
 }
 ...
 return this->pcall(object, nullptr);
 }
