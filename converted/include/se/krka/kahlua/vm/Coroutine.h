...
public:
 ...
 private ArrayList<UpValue> liveUpvalues = std::make_unique<ArrayList<>>();
 ...
 this(arg0, arg1, nullptr);
 }

 LuaCallFrame pushNewCallFrame(LuaClosure arg0, JavaFunction arg1, int arg2, int arg3, int arg4, bool arg5, bool arg6) {
 ...
 if (Core.bDebug && luaCallFrame != nullptr && luaCallFrame.closure != nullptr && luaCallFrame.pc > 0) {
 for (int int0 = arg1; int0 < arg1 + arg2; int0++) {
 int int1 = luaCallFrame.closure.prototype.lines[luaCallFrame.pc - 1];
 bool boolean0 = luaCallFrame.closure.prototype.lines[luaCallFrame.pc] != int1;
 if (this->thread == LuaManager.thread && luaCallFrame.closure.prototype.locvarlines != nullptr) {
 while (
 ...
 void* getObjectFromStack(int arg0) {
 ...
 KahluaUtil.luaAssert(coroutine1 != nullptr, "Internal error, coroutine must be running");
