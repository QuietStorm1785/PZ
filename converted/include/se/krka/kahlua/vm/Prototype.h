...
public:
 ...
 static LuaClosure loadByteCode(DataInputStream arg0, KahluaTable arg1) {
 int int0 = arg0.read();
 ...
 Prototype prototype = new Prototype(arg0, boolean0, nullptr, int1);
 return new LuaClosure(prototype, arg1);
 }

 static void loadAssert(bool boolean0, const std::string& string) {
 if (!boolean0) {
 throw IOException("Could not load bytecode:" + string);
 }
 }

 static LuaClosure loadByteCode(InputStream arg0, KahluaTable arg1) {
