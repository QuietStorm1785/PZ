...
public:
 ...
 public ArrayList<String> LocalVarNames = std::make_unique<ArrayList<>>();
 ...
 return this->javaFunction != nullptr ? "Callframe at: " + this->javaFunction.toString() : super.toString();
 }
 }
 ...
 void setup(LuaClosure luaClosure, JavaFunction javaFunctionx, int int0, int int1, int int2, bool boolean0, bool boolean1) {
 this->localBase = int0;
 ...
 if (Core.bDebug && this != nullptr && this->closure != nullptr && this->getThread() == LuaManager.thread) {
