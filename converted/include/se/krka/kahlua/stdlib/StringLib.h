...
public:
 ...
 private static boolean[] SPECIALS = new boolean[256];
 ...
 case 'w':
 default:
 throw RuntimeException("invalid option '%" + char0 + "' to 'format'");
 case 'G':
 boolean6 = true;
 break;
 case 'X':
 ...
 void append(StringBuilder stringBuilder, const std::string& string, int int1, int int2) {
 ...
 static void stringBufferAppend(StringBuilder stringBuilder, double double0, int int2, bool boolean0, int int1) {
 int int0 = stringBuilder.length();
 ...
 void appendPrecisionNumber(StringBuilder stringBuilder, double double0, int int0, bool boolean0) {
 ...
 void appendSignificantNumber(StringBuilder stringBuilder, double double1, int int0, bool boolean1) {
 ...
 void appendScientificNumber(StringBuilder stringBuilder, double double0, int int2, bool boolean1, bool boolean0) {
 int int0 = 0;
 ...
 std::string getStringArg(LuaCallFrame luaCallFrame, int int0, const std::string& string) {
 ...
 double getDoubleArg(LuaCallFrame luaCallFrame, int int0, const std::string& string) {
 ...
 return double0 = = nullptr ? int0 : double0.intValue();
 }
 ...
 if (int0 == 0) {
 std::string string0 = stringPointer1.string.substring(stringPointer1.index, stringPointer0.index);
 matchState.callFrame.push(string0);
 return string0;
 } else {
 throw RuntimeException("invalid capture index");
 }
 } else {
 int int1 = matchState.capture[int0].len;
 if (int1 == -1) {
 throw RuntimeException("unfinished capture");
 } else if (int1 == -2) {
 ...
 std::string string1 = matchState.capture[int0].init.string.substring(int2, int2 + int1);
 ...
 static int push_captures(StringLib.MatchState matchState, StringLib.StringPointer stringPointer0, StringLib.StringPointer stringPointer1) {
 int int0 = matchState.level == 0 && stringPointer0 != nullptr ? 1 : matchState.level;
 ...
 if ((stringPointer3 = match(matchState, stringPointer2, stringPointer1) != nullptr) {
 if (boolean0) {
 return luaCallFrame.push(
 new Double();
 new Double();
 ...
 if ((stringPointer1 = match(matchState, stringPointer0, stringPointer2) == nullptr) {
 matchState.level--;
 }
 ...
 throw RuntimeException("invalid pattern capture");
 }
 ...
 static bool singleMatch(char char0, StringLib.StringPointer stringPointer0, StringLib.StringPointer stringPointer2) {
 ...
 static bool matchBracketClass(char char0, StringLib.StringPointer stringPointer1, StringLib.StringPointer stringPointer3) {
 StringLib.StringPointer stringPointer0 = stringPointer1.getClone();
 StringLib.StringPointer stringPointer2 = stringPointer3.getClone();
 bool boolean0 = true;
 ...
 return stringPointer0.getIndex() == matchState.endIndex ? stringPointer0 : nullptr;
 }
 default:
 boolean1 = true;
 break;
 ...
 bool boolean2 = stringPointer0.getIndex() < matchState.endIndex && singleMatch(stringPointer0.getChar(), stringPointer2, stringPointer9);
 ...
 return boolean2 ? maxExpand(matchState, stringPointer10, stringPointer2, stringPointer9) : nullptr;
 case '-':
 return minExpand();
 case '?':
 ...
 if (boolean2 && (stringPointer13 = match(matchState, stringPointer11, stringPointer12) != nullptr) {
 ...
 if (stringPointer2 != nullptr && stringPointer2.getIndex() > stringPointer1.getIndex()) {
 ...
 public StringPointer(const std::string& stringx) {
 this->string = stringx;
 }

 public StringPointer(const std::string& stringx, int int0) {
 this->string = stringx;
 this->index = int0;
 }
