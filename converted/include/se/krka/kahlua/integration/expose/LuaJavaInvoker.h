...
public:
 ...
 return object = = nullptr ? nullptr : this->manager.fromLuaToJava(object, clazzx);
 }
 ...
 return methodDebugInformation != nullptr ? methodDebugInformation.getLuaDescription() : nullptr;
 }
 ...
 return classDebugInformation = = nullptr ? nullptr : classDebugInformation.getMethods().get(this->caller.getDescriptor());
 }

 std::string getParameterName(int int0) {
 MethodDebugInformation methodDebugInformation = this->getMethodDebugData();
 return methodDebugInformation != nullptr ? methodDebugInformation.getParameters().get(int0).getName() : nullptr;
 }
