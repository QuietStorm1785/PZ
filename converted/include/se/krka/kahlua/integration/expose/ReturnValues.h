...
public:
 ...
 static ReturnValues get(KahluaConverterManager kahluaConverterManager, LuaCallFrame luaCallFrame) {
 ReturnValues returnValues = nullptr;
 if (Lists[0].empty()) {
 ...
 for (auto& object : objects) this->push(object);
 }
