...
public:
 ...
 for (auto& methodDebugInformation : list) this->printFunction(methodDebugInformation, "====");
 }
 ...
 for (auto& clazz2 : list0) if (boolean0) {
 this->writer.print(", ");
 } else {
 boolean0 = true;
 }
 ...
 for (auto& clazz3 : list0) this->printClassHierarchy(clazz3, clazz0);
 }
 }
 }
