...
public final class CarController {
   ...
   public void update() {
      if (this.vehicleObject.getVehicleTowedBy() == null) {
         ...
         if (var10 != null && var10.getDriver() == null && this.vehicleObject.getDriver() != null && !GameClient.bClient) {
            this.vehicleObject.addPointConstraint(null, var10, this.vehicleObject.getTowAttachmentSelf(), var10.getTowAttachmentSelf());
         }
         ...
         if (!GameServer.bServer) {
            ...
            if (this.EngineForce > 0.0F && this.vehicleObject.engineState == engineStateTypes.Idle && !this.engineStartingFromKeyboard) {
               ...
               if (GameClient.bClient) {
                  Boolean var14 = this.vehicleObject.getDriver().getInventory().haveThisKeyId(this.vehicleObject.getKeyId()) != null
                     ? Boolean.TRUE
                     : Boolean.FALSE;
   ...
   public void updateControls() {
      if (!GameServer.bServer) {
         if (this.vehicleObject.isKeyboardControlled()) {
            ...
            boolean var2 = GameKeyboard.isKeyDown(Core.getInstance().getKey("Right"));
            boolean var3 = GameKeyboard.isKeyDown(Core.getInstance().getKey("Forward"));
            boolean var4 = GameKeyboard.isKeyDown(Core.getInstance().getKey("Backward"));
            boolean var5 = GameKeyboard.isKeyDown(57);
            boolean var6 = GameKeyboard.isKeyDown(42);
         ...
         if (var8 != -1) {
            boolean var9 = JoypadManager.instance.isLeftPressed(var8);
            boolean var11 = JoypadManager.instance.isRightPressed(var8);
            boolean var12 = JoypadManager.instance.isRTPressed(var8);
            boolean var13 = JoypadManager.instance.isLTPressed(var8);
            boolean var14 = JoypadManager.instance.isBPressed(var8);
   ...
   public void debug() {
      if (Core.bDebug && DebugOptions.instance.VehicleRenderOutline.getValue()) {
         ...
         LineDrawer.addLine(var4.x1, var4.y1, 0.0F, var4.x2, var4.y2, 0.0F, 1.0F, 1.0F, 1.0F, null, true);
         LineDrawer.addLine(var4.x2, var4.y2, 0.0F, var4.x3, var4.y3, 0.0F, 1.0F, 1.0F, 1.0F, null, true);
         LineDrawer.addLine(var4.x3, var4.y3, 0.0F, var4.x4, var4.y4, 0.0F, 1.0F, 1.0F, 1.0F, null, true);
         LineDrawer.addLine(var4.x4, var4.y4, 0.0F, var4.x1, var4.y1, 0.0F, 1.0F, 1.0F, 1.0F, null, true);
         ...
         for (int var9 = 0; var9 < this.vehicleObject.getScript().getWheelCount(); var9++) {
            ...
            LineDrawer.addLine(var6, var7, 0.0F, var6 + this.tempVec3f.x, var7 + this.tempVec3f.z, 0.0F, 1.0F, 1.0F, 1.0F, null, true);
   ...
   public void drawRect(Vector3f var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      LineDrawer.addLine(var18, var24, 0.0F, var19, var25, 0.0F, var6, var7, var8, null, true);
      LineDrawer.addLine(var18, var24, 0.0F, var20, var22, 0.0F, var6, var7, var8, null, true);
      LineDrawer.addLine(var19, var25, 0.0F, var21, var23, 0.0F, var6, var7, var8, null, true);
      LineDrawer.addLine(var20, var22, 0.0F, var21, var23, 0.0F, var6, var7, var8, null, true);
