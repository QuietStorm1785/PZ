...
import zombie.core.skinnedmodel.model.WorldItemAtlas.WeaponPartParams;
...
final class WorldItemAtlas$RenderJob extends GenericDrawer {
         ...
         if (var1 != null && var1.Mesh != null && var1.Mesh.isReady()) {
            ...
            if (this.entryW > 0 && this.entryH > 0) {
               if (this.entryW <= 512 && this.entryH <= 512) {
                  ...
                  boolean var7 = this.renderModel(this.itemParams.m_model, null);
   ...
   boolean renderModel(Model var1, Matrix4f var2) {
      if (!var1.bStatic) {
         ...
         if (var3 == null || var1.Mesh == null || !var1.Mesh.isReady()) {
            return false;
         } else if (var1.tex != null && !var1.tex.isReady()) {
            return false;
         } else {
            ...
            for (int var6 = 0; var6 < 5; var6++) {
               var3.setLight(var6, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, Float.NaN, 0.0F, 0.0F, 0.0F, null);
            }
