...
import zombie.ai.StateMachine.SubstateSlot;
...
public final class StateMachine {
   ...
   public void revertToPreviousState(State var1) {
      if (this.isSubstate(var1)) {
         ...
         DebugLog.ActionSystem.warn("The sender $s is not an active state in this state machine.", new Object[]{String.valueOf(var1)});
      } else {
