...
public final class LightingJNI {
   ...
   private static void checkLights() {
      if (IsoWorld.instance.CurrentCell != null) {
               ...
               if (var3.bHydroPowered) {
                  if (var3.switches.isEmpty()) {
                     ...
                     if (!var0) {
                        ...
                        var23 = var29 != null && var29.haveElectricity();
                     }
                     ...
                     boolean var22 = var6.canSwitchLight();
               ...
               if (var3.ID == 0) {
                  ...
                  if (var3.life != -1) {
                     ...
                     addLight(
                        ...
                        var3.g,
                        var3.b,
                        var3.localToBuilding == null ? -1 : var3.localToBuilding.ID,
                        var3.bActive
                     );
                  }
               } else {
         ...
         ArrayList var9 = IsoWorld.instance.CurrentCell.roomLights;
         ...
         if (GameClient.bClient) {
            ...
            for (int var13 = 0; var13 < IsoPlayer.numPlayers; var13++) {
               ...
               if (var19 != null && !var19.isDead() && var19.getVehicle() == null) {
            ...
            for (int var3 = 0; var3 < 10; var3++) {
               ...
               if (var4 == null) {
                  ...
                  for (int var7 = 0; var7 < var4.getSpecialObjects().size(); var7++) {
                     ...
                     } else if (var8 instanceof IsoDoor var15) {
                        boolean var18 = var15.sprite != null && var15.sprite.getProperties().Is("doorTrans");
                        if (var15.open) {
                           var18 = true;
                        } else {
                           var18 = var18 && (var15.HasCurtains() == null || var15.isCurtainOpen());
                        }
                     ...
                     } else if (var8 instanceof IsoThumpable var16) {
                        boolean var20 = var16.getSprite().getProperties().Is("doorTrans");
                     ...
                     } else if (var8 instanceof IsoWindow var17) {
                        boolean var21 = false;
   ...
   public static void getTorches(ArrayList<TorchInfo> var0) {
      var0.addAll(torches);
   }
