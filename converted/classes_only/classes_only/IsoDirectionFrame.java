...
public final class IsoDirectionFrame {
   ...
   public void render(float var1, float var2, IsoDirections var3, ColorInfo var4, boolean var5, Consumer<TextureDraw> var6) {
   ...
   void render(float var1, float var2, float var3, float var4, IsoDirections var5, ColorInfo var6, boolean var7, Consumer<TextureDraw> var8) {
   ...
   public void renderexplicit(int var1, int var2, IsoDirections var3, float var4) {
      this.renderexplicit(var1, var2, var3, var4, null);
   }
   ...
   public void renderexplicit(int var1, int var2, IsoDirections var3, float var4, ColorInfo var5) {
      ...
      if (var6 != null) {
         ...
         var6.renderstrip(var1, var2, (int)(var6.getWidth() * var4), (int)(var6.getHeight() * var4), var8, var9, var10, var7, null);
      }
   }
}
