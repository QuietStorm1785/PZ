...
public final class PolygonalMap2$VehiclePoly {
   ...
   VehicleRect getAABB(VehicleRect var1) {
      ...
      return var1.init(null, (int)var2, (int)var3, (int)Math.ceil(var4) - (int)var2, (int)Math.ceil(var5) - (int)var3, (int)this.z);
   }
