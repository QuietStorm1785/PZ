...
public final class DataChunk {
   ...
   protected ArrayList<IsoChunkRegion> getChunkRegions(int var1) {
   ...
   private void recalculate(int var1) {
      ArrayList var2 = this.chunkRegions.get(var1);
   ...
   private IsoChunkRegion floodFill(int var1, int var2, int var3) {
      ...
      byte var5 = (byte)this.chunkRegions.get(var3).size();
      this.chunkRegions.get(var3).add(var4);
      ...
      DataSquarePos var6;
      while ((var6 = tmpSquares.poll()) != null) {
   ...
   private void resetEnclosedSide(int var1, byte var2) {
      ArrayList var3 = this.chunkRegions.get(var1);
   ...
   protected void interConnect() {
      for (int var4 = 0; var4 <= this.highestZ; var4++) {
         if (this.dirtyZLayers[var4] && this.activeZLayers[var4]) {
            ArrayList var3 = this.chunkRegions.get(var4);
                  ...
                  if (var1.getConnectedNeighbors().size() == 0) {
                     ...
                     if (var6 == null) {
                        ...
                        for (int var10 = 0; var10 < oldList.size(); var10++) {
                           ...
                           if (var11.getIsoWorldRegion() == null) {
   ...
   private void floodFillExpandWorldRegion(IsoChunkRegion var1, IsoWorldRegion var2) {
      ...
      IsoChunkRegion var3;
      while ((var3 = chunkQueue.poll()) != null) {
      ...
      if (this.highestZ >= 1) {
         ...
         for (int var5 = 0; var5 < 10; var5++) {
            for (int var6 = 0; var6 < 10; var6++) {
               byte var9 = this.getSquare(var6, var5, var8);
               boolean var11 = false;
               if (var9 > 0) {
