...
import zombie.characters.BodyDamage.Thermoregulator_tryouts.1;
import zombie.characters.BodyDamage.Thermoregulator_tryouts.Multiplier;
import zombie.characters.BodyDamage.Thermoregulator_tryouts.ThermalNode;
...
public class Thermoregulator_tryouts {
   ...
   private void initNodes() {
      ...
      for (int var2 = 0; var2 < this.bodyDamage.getBodyParts().size(); var2++) {
         ...
         ThermalNode var4 = null;
         switch (1.$SwitchMap$zombie$characters$BodyDamage$BodyPartType[var3.getType().ordinal()]) {
            case 1:
               var4 = new ThermalNode(this, true, 37.0F, var3, 0.25F);
               this.core = var4;
               break;
            case 2:
               var4 = new ThermalNode(this, 37.0F, var3, 1.0F);
               break;
            case 3:
               var4 = new ThermalNode(this, 37.0F, var3, 0.5F);
               break;
            case 4:
               var4 = new ThermalNode(this, 37.0F, var3, 0.25F);
               break;
            case 5:
               var4 = new ThermalNode(this, 37.0F, var3, 0.5F);
               break;
   ...
   public ThermalNode getNodeForType(BodyPartType var1) {
      for (int var2 = 0; var2 < this.nodes.length; var2++) {
   ...
   public ThermalNode getNodeForBloodType(BloodBodyPartType var1) {
      for (int var2 = 0; var2 < this.nodes.length; var2++) {
   ...
   // $VF: Unable to simplify switch on enum
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   private float getSimulationMultiplier(Multiplier var1) {
      float var2 = GameTime.instance.getMultiplier();
      switch (1.$SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[var1.ordinal()]) {
         case 1:
            var2 *= 0.001F;
            break;
         case 2:
   ...
   private void updateTest() {
      ...
      for (int var3 = 0; var3 < this.nodes.length; var3++) {
         ...
         var2.heatDelta = var2.heatDelta / (1.0F + var2.insulation);
      ...
      this.core.celcius = this.core.celcius + this.coreHeatDelta * var12;
   }
   ...
   private void updateTest_4() {
      ...
      for (int var3 = 0; var3 < this.nodes.length; var3++) {
         ThermalNode var2 = this.nodes[var3];
         var2.calculateInsulation();
         float var4 = 1.0F - var2.getDistToCore();
      ...
      this.core.celcius = this.core.celcius + this.coreHeatDelta * var14;
   }
   ...
   private void updateTest_3() {
      for (int var2 = 0; var2 < this.nodes.length; var2++) {
         ...
         var1.heatDelta = var1.heatDelta / (1.0F + var1.insulation);
         ...
         var1.skinCelcius = var1.skinCelcius + var9 * this.getSimulationMultiplier(Multiplier.SkinCelcius);
      }
   }
   ...
   private void updateTest_2() {
      for (int var2 = 0; var2 < this.nodes.length; var2++) {
         ...
         float var4 = var3 - 27.0F;
         var1.heatDelta = var4;
         var1.heatDelta = var1.heatDelta / (1.0F + var1.insulation);
         float var5 = 1.0F + (1.0F - var1.getDistToCore() * 0.8F);
         float var6 = this.metabolicRateReal * var5;
         ...
         var1.primaryDelta = var1.primaryDelta + var8 * this.getSimulationMultiplier(Multiplier.PrimaryDelta);
         var1.primaryDelta = PZMath.clamp(var1.primaryDelta, -1.0F, 1.0F);
      }

      for (int var10 = 0; var10 < this.nodes.length; var10++) {
         ThermalNode var9 = this.nodes[var10];
         float var11 = this.core.celcius - 20.0F;
         float var12 = this.core.celcius;
         if (var11 < this.airTemperature) {
            var11 = this.airTemperature;
         }

         float var13 = this.core.celcius - 4.0F;
         if (var9.primaryDelta < 0.0F) {
            var13 = 33.0F - 20.0F * PZMath.abs(var9.primaryDelta);
         } else {
            var13 = 33.0F + 20.0F * var9.primaryDelta;
         }

         var13 = PZMath.clamp(var13, var11, var12);
         float var17 = var13 - var9.skinCelcius;
         var9.skinCelcius = var9.skinCelcius + var17 * this.getSimulationMultiplier(Multiplier.SkinCelcius);
         var9.skinCelcius = var13;
      }
   }
   ...
   private void updateTest_OLD() {
      for (int var2 = 0; var2 < this.nodes.length; var2++) {
         ...
         float var4 = var3 - var1.skinCelcius;
         var1.heatDelta = var4;
         var1.heatDelta = var1.heatDelta / (1.0F + var1.insulation);
         float var5 = 1.0F + (1.0F - var1.getDistToCore() * 0.8F);
         float var6 = this.metabolicRateReal * var5;
      ...
      for (int var8 = 0; var8 < this.nodes.length; var8++) {
         ...
         float var9 = this.core.celcius - 20.0F;
         float var10 = this.core.celcius;
         if (var9 < this.airTemperature) {
            var9 = this.airTemperature;
         }

         float var11 = this.core.celcius - 4.0F;
         if (var7.primaryDelta < 0.0F) {
            var11 = 33.0F - 20.0F * PZMath.abs(var7.primaryDelta);
         } else {
            var11 = 33.0F + 20.0F * var7.primaryDelta;
         }

         var11 = PZMath.clamp(var11, var9, var10);
         float var15 = var11 - var7.skinCelcius;
         var7.skinCelcius = var7.skinCelcius + var15 * this.getSimulationMultiplier(Multiplier.SkinCelcius);
         var7.skinCelcius = var11;
      }
   }
   ...
   private void updateNodesHeatDelta() {
      ...
      for (int var8 = 0; var8 < this.nodes.length; var8++) {
         ...
         if (var7.primaryDelta > 0.0F) {
            ...
            float var11 = Metabolics.Default.getMet() * var7.primaryDelta * var7.skinSurface / var7.insulation;
         ...
         if (var7.secondaryDelta > 0.0F) {
            ...
            float var30 = Metabolics.MAX.getMet() * 0.75F * var7.secondaryDelta * var7.skinSurface / var7.insulation;
            var30 *= var40;
   ...
   private void updateNodesHeatDelta_OLD() {
      float var1 = (float)this.player.getNutrition().getWeight();
      ...
      float var6 = 1.0F;
      if (this.climate.getHumidity() > 0.5F) {
         float var7 = (this.climate.getHumidity() - 0.5F) * 2.0F;
         var6 -= var7;
      }

      float var17 = 1.0F;
      if (this.core.celcius < 37.0F) {
         var17 = (this.core.celcius - 20.0F) / 17.0F;
         var17 *= var17;
      }
      ...
      for (int var10 = 0; var10 < this.nodes.length; var10++) {
         ...
         if (this.airAndWindTemp < this.airTemperature) {
            float var12 = this.airTemperature - this.airAndWindTemp;
            var12 /= 1.0F + var9.windresist;
            var11 -= var12;
         }

         float var21 = 1.0F + var9.insulation;
         ...
         if (var9.primaryDelta > 0.0F) {
            float var15 = 0.2F + 0.8F * this.getBodyFluids();
            float var14 = Metabolics.Default.getMet() * 1.0F * var9.primaryDelta * var9.skinSurface / var21;
            ...
            float var43 = 0.2F + 0.8F * this.getEnergy();
            float var28 = Metabolics.Default.getMet() * 1.0F * PZMath.abs(var9.primaryDelta) * var9.skinSurface;
            var28 *= var43;
            var28 *= 1.0F + 0.2F * var3;
            var28 *= 1.0F + 0.2F * var4;
            var28 *= 0.25F + 0.75F * var17;
            var9.heatDelta += var28;
         }

         if (var9.secondaryDelta > 0.0F) {
            float var44 = 0.1F + 0.9F * this.getBodyFluids();
            float var33 = Metabolics.MAX.getMet() * 0.75F * var9.secondaryDelta * var9.skinSurface / var21;
            var33 *= var44;
            var33 *= 0.75F + 0.25F * var6;
            var33 *= 1.0F - 0.2F * var3;
            var33 *= 1.0F + 0.2F * var4;
            var9.heatDelta -= var33;
         } else {
            float var45 = 0.1F + 0.9F * this.getEnergy();
            float var38 = Metabolics.Default.getMet() * 1.0F * PZMath.abs(var9.secondaryDelta) * var9.skinSurface;
            var38 *= var45;
            var38 *= 1.0F + 0.2F * var3;
            var38 *= 1.0F + 0.2F * var4;
            var38 *= 0.25F + 0.75F * var17;
            var9.heatDelta += var38;
         }
   ...
   private void updateNodes() {
      ...
      for (int var4 = 0; var4 < this.nodes.length; var4++) {
         ...
         var1.skinCelcius = var1.skinCelcius + var22 * var24 * this.getSimulationMultiplier(Multiplier.SkinCelcius);
         if (var1 != this.core) {
   ...
   private void updateBodyMultipliers() {
      ...
      this.energyMultiplier = PZMath.clamp(var2 * var2, 1.0F, 5.0F);
      float var1 = PZMath.abs(this.primTotal);
      var1 *= var1;
      if (this.primTotal < 0.0F) {
         this.energyMultiplier += 0.75F * var1;
         this.fatigueMultiplier += 0.5F * var1;
      } else if (this.primTotal > 0.0F) {
         this.fluidsMultiplier += 0.75F * var1;
         this.fatigueMultiplier += 0.5F * var1;
      }
      ...
      if (this.secTotal < 0.0F) {
         this.energyMultiplier += 8.0F * var1;
         this.fatigueMultiplier += 3.5F * var1;
      } else if (this.secTotal > 0.0F) {
         this.fluidsMultiplier += 6.0F * var1;
         this.fatigueMultiplier += 3.5F * var1;
      }
   }
   ...
   private void updateClothing() {
      ...
      if (var1) {
         ...
         for (int var11 = 0; var11 < itemVisuals.size(); var11++) {
            ...
            if (var4 instanceof Clothing var5 && (var5.getInsulation() > 0.0F || var5.getWindresistance() > 0.0F)) {
               boolean var6 = false;
               ...
               if (!var6 && var5.getBodyLocation() != null) {
                  String var12 = var5.getBodyLocation().toLowerCase();
                  switch (var12) {
                     case "hat":
                     case "mask":
