...
import zombie.iso.objects.IsoDeadBody.1;
...
public final class IsoDeadBody extends IsoMovingObject implements Talker, IHumanVisual {
   ...
   private static final ThreadLocal<IsoZombie> tempZombie = new 1();
   private static ColorInfo inf = new ColorInfo();
   public BodyTexture atlasTex;
   ...
   public static boolean isDead(short var0) {
      ...
      for (IsoDeadBody var3 : Bodies) {
         if (var3.onlineID == var0 && var1 - var3.deathTime < 0.1F) {
            return true;
         }
      }
      ...
      if (var1.get() == 1) {
         ...
         try {
            ...
            for (int var16 = 0; var16 < var15; var16++) {
               ...
               if (var11 >= 0 && var11 < var6.size() && this.attachedItems.getGroup().getLocation(var17) != null) {
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (Core.bDebug && DebugOptions.instance.DeadBodyAtlasRender.getValue()) {
         ...
         LineDrawer.addLine(var17, var23, 0.0F, var18, var24, 0.0F, var25, var26, var27, null, true);
         LineDrawer.addLine(var17, var23, 0.0F, var19, var21, 0.0F, var25, var26, var27, null, true);
         LineDrawer.addLine(var18, var24, 0.0F, var20, var22, 0.0F, var25, var26, var27, null, true);
         LineDrawer.addLine(var19, var21, 0.0F, var20, var22, 0.0F, var25, var26, var27, null, true);
      }
      ...
      if (this.isFakeDead() && DebugOptions.instance.ZombieRenderFakeDead.getValue()) {
         ...
         TextManager.instance.DrawStringCentre(UIFont.Medium, var31, var35, String.format("FakeDead %.2f", var37), 1.0, 1.0, 1.0, 1.0);
      }
      ...
      if (Core.bDebug && DebugOptions.instance.MultiplayerShowZombieOwner.getValue()) {
         ...
         TextManager.instance
            .DrawStringCentre(
               ...
               var36,
               var39 + 10.0F,
               String.format("x=%09.3f ", var1) + String.format("y=%09.3f ", var2) + String.format("z=%d", (byte)var3),
               var32.r,
               var32.g,
               var32.b,
               var32.a
   ...
   public static void renderShadow(float var0, float var1, float var2, Vector3f var3, float var4, float var5, float var6, ColorInfo var7, float var8) {
      ...
      if (DebugOptions.instance.IsoSprite.DropShadowEdges.getValue()) {
         LineDrawer.addLine(var15, var21, var2, var16, var22, var2, 1, 1, 1, null);
         LineDrawer.addLine(var16, var22, var2, var18, var20, var2, 1, 1, 1, null);
         LineDrawer.addLine(var18, var20, var2, var17, var19, var2, 1, 1, 1, null);
         LineDrawer.addLine(var17, var19, var2, var15, var21, var2, 1, 1, 1, null);
      }
   }
   ...
   public void checkClothing(InventoryItem var1) {
      ...
      for (int var4 = 0; var4 < this.attachedItems.size(); var4++) {
         ...
         if (this.container == null || this.container.getItems().indexOf(var5) == -1) {
   ...
   public static void updateBodies() {
      if (!GameClient.bClient) {
         ...
         if (!(var1 <= 0.0F)) {
            ...
            for (IsoDeadBody var5 : tempBodies) {
                  ...
                  for (int var10 = 0; var10 < var7; var10++) {
                     if (this.wasZombie) {
                        if (Rand.Next(var9) == 0) {
                           ...
                           if (var11 != null && this.getContainer() != null) {
                        ...
                        if (Rand.Next(var9) == 0) {
                           ...
                           if (var13 != null && this.getContainer() != null) {
                        ...
                        if (Rand.Next(var9 * 2) == 0 && SandboxOptions.instance.MaggotSpawn.getValue() != 2) {
                           ...
                           if (var14 != null && this.getSquare() != null) {
   ...
   private boolean isPlayerNearby() {
      if (GameServer.bServer) {
         for (int var1 = 0; var1 < GameServer.Players.size(); var1++) {
            ...
            boolean var3 = this.square != null && ServerLOS.instance.isCouldSee(var2, this.square);
         ...
         for (int var6 = 0; var6 < IsoPlayer.numPlayers; var6++) {
            IsoPlayer var7 = IsoPlayer.players[var6];
            boolean var4 = var5 != null && var5.isCanSee(var6);
   ...
   public void Collision(Vector2 var1, IsoObject var2) {
      if (var2 instanceof BaseVehicle var3) {
         float var4 = 15.0F;
