...
import zombie.core.skinnedmodel.model.jassimp.JAssImpImporter.LibraryLoader;
...
public final class JAssImpImporter {
   ...
   static void CollectBoneNodes(ArrayList<AiNode> var0, AiNode var1) {
      var0.add(var1);
   ...
   static String DumpAiMatrix(AiMatrix4f var0) {
      ...
      return var1 + String.format("%1$.8f\n ", var0.get(3, 3));
   }
   ...
   static AiBone FindAiBone(String var0, List<AiBone> var1) {
      int var2 = var1.size();
   ...
   private static void DumpMesh(VertexPositionNormalTangentTextureSkin[] var0) {
      ...
      for (VertexPositionNormalTangentTextureSkin var5 : var0) {
   ...
   static void replaceHashMapKeys(HashMap<String, Integer> var0, String var1) {
      tempHashMap.clear();
   ...
   public static void takeOutTheTrash(AiScene var0) {
      ...
      AiNode var7 = (AiNode)var0.getSceneRoot(new AiBuiltInWrapperProvider());
