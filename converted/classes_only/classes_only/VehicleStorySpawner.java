...
import zombie.randomizedWorld.randomizedVehicleStory.VehicleStorySpawner.IElementSpawner;
...
public class VehicleStorySpawner {
   ...
   public Element addElement(String var1, float var2, float var3, float var4, float var5, float var6) {
   ...
   public boolean getParameterBoolean(String var1) {
      return this.getParameter(var1, Boolean.class);
   }
   ...
   public int getParameterInteger(String var1) {
      return this.getParameter(var1, Integer.class);
   }

   public String getParameterString(String var1) {
      return this.getParameter(var1, String.class);
   }

   public <E> E getParameter(String var1, Class<E> var2) {
      return (E)Type.tryCastTo(this.m_storyParams.get(var1), var2);
   }

   public void spawn(float var1, float var2, float var3, float var4, IElementSpawner var5) {
