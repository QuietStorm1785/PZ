...
import zombie.erosion.categories.ErosionCategory.SeasonDisplay;
...
public abstract class ErosionCategory {
   ...
   public ErosionCategory() {
      for (int var1 = 0; var1 < 6; var1++) {
         this.seasonDisp[var1] = new SeasonDisplay(this);
      }
   }

   protected Data getCatModData(Square var1) {
   ...
   protected Data setCatModData(Square var1) {
   ...
   public void updateObj(Square var1, Data var2, IsoGridSquare var3, ErosionObj var4, boolean var5, int var6, int var7, boolean var8) {
      if (!var2.hasSpawned) {
   ...
   protected void clearCatModData(Square var1) {
      for (int var2 = 0; var2 < var1.regions.size(); var2++) {
         Data var3 = (Data)var1.regions.get(var2);
         if (var3.regionID == this.region.ID && var3.categoryID == this.ID) {
   ...
   public static Data loadCategoryData(ByteBuffer var0, int var1) {
      byte var2 = var0.get();
      byte var3 = var0.get();
