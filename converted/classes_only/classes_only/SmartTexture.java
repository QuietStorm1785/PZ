...
public class SmartTexture extends Texture {
   ...
   public TextureCombinerCommand getFirstFromCategory(int var1) {
      return !this.categoryMap.containsKey(var1) ? null : this.commands.get(this.categoryMap.get(var1).get(0));
   }
   ...
   public void addOverlayPatches(String var1, String var2, int var3) {
      ...
      this.add(var1, blit, var2, var4, 770, 771);
   }
   ...
   public Texture addHole(BloodBodyPartType var1) {
      String var2 = "media/textures/HoleTextures/" + CharacterSmartTexture.MaskFiles[var1.index()] + ".png";
      if (addHole == null) {
         this.create();
      }
      ...
      this.clear();
      this.result = null;
      this.commands.add(TextureCombinerCommand.get().initSeparate(var3, addHole, addHoleParams, getTextureWithFlags(var2), 770, 0, 1, 771));
      this.dirty = true;
      return var3;
   }

   public void removeHole(String var1, BloodBodyPartType var2) {
      String var3 = "media/textures/HoleTextures/" + CharacterSmartTexture.MaskFiles[var2.index()] + ".png";
   ...
   public void add(String var1) {
      this.add(getTextureWithFlags(var1));
   }
   ...
   public void add(String var1, SmartShader var2, ArrayList<TextureCombinerShaderParam> var3) {
      this.add(getTextureWithFlags(var1), var2, var3);
   }

   public void add(Texture var1, SmartShader var2, ArrayList<TextureCombinerShaderParam> var3) {
   ...
   public void add(String var1, SmartShader var2, String var3, int var4, int var5) {
      this.add(getTextureWithFlags(var1), var2, getTextureWithFlags(var3), var4, var5);
   }
   ...
   public void add(String var1, SmartShader var2, String var3, ArrayList<TextureCombinerShaderParam> var4, int var5, int var6) {
      this.add(getTextureWithFlags(var1), var2, getTextureWithFlags(var3), var4, var5, var6);
   }

   public void add(Texture var1, SmartShader var2, Texture var3, ArrayList<TextureCombinerShaderParam> var4, int var5, int var6) {
      this.addSeparate(var1, var2, var3, var4, var5, var6, 1, 771);
   }

   public void addSeparate(String var1, SmartShader var2, String var3, ArrayList<TextureCombinerShaderParam> var4, int var5, int var6, int var7, int var8) {
      this.addSeparate(getTextureWithFlags(var1), var2, getTextureWithFlags(var3), var4, var5, var6, var7, var8);
   }

   public void addSeparate(Texture var1, SmartShader var2, Texture var3, ArrayList<TextureCombinerShaderParam> var4, int var5, int var6, int var7, int var8) {
      this.commands.add(TextureCombinerCommand.get().initSeparate(var1, var2, var4, var3, var5, var6, var7, var8));
      this.dirty = true;
   }
