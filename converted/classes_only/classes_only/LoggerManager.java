...
public final class LoggerManager {
   ...
   private static void backupOldLogFiles() {
      try {
         ...
         File var2 = new File(getLogsDir() + File.separator + var4);
         if (!var2.exists()) {
            var2.mkdir();
         }
         ...
         for (int var7 = 0; var7 < var1.length; var7++) {
            var4 = var1[var7];
            File var5 = new File(getLogsDir() + File.separator + var4);
            if (var5.isFile()) {
               var5.renameTo(new File(var2.getAbsolutePath() + File.separator + var5.getName()));
               var5.delete();
            }
         }
   ...
   private static Calendar getLogFileLastModifiedTime(String var0) {
      File var1 = new File(getLogsDir() + File.separator + var0);
