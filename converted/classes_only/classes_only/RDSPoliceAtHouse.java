...
public final class RDSPoliceAtHouse extends RandomizedDeadSurvivorBase {
   ...
   public void randomizeDeadSurvivor(BuildingDef var1) {
      ...
      this.addZombies(var1, Rand.Next(2, 4), null, 0, var2);
      ArrayList var3 = this.addZombies(var1, Rand.Next(1, 3), "Police", null, var2);
      ...
      if (var4 != null) {
         ...
         ArrayList var6 = this.addZombiesOnSquare(2, "Police", null, var5);
