...
import zombie.MapCollisionData.MCDThread;
import zombie.MapCollisionData.PathTask;
import zombie.MapCollisionData.Sync;
...
public final class MapCollisionData {
   ...
   public void updateMain() {
      if (!this.bClient) {
         for (PathTask var1 = this.pathResultQueue.poll(); var1 != null; var1 = this.pathResultQueue.poll()) {
