      ...
      if (this.alarmSet) {
         ...
         if (this.isRinging()) {
            ...
            if (var4 == null || this.ringSince + 0.5 < var2) {
               this.stopRinging();
            } else if (!GameClient.bClient && var4 != null) {
               WorldSoundManager.instance.addSoundRepeating(null, var4.getX(), var4.getY(), var4.getZ(), this.getSoundRadius(), 3, false);
            }
   ...
   public void updateSound(BaseSoundEmitter var1) {
      ...
      if (var2 != null) {
         ...
         if (GameClient.bClient && sendEvery.Check() && this.isInLocalPlayerInventory()) {
            GameClient.instance.sendWorldSound(null, var2.x, var2.y, var2.z, this.getSoundRadius(), 3, false, 0.0F, 1.0F);
         }
