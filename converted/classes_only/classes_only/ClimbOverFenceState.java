...
import zombie.ai.states.ClimbOverFenceState.1;
...
public final class ClimbOverFenceState extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (var1.getVariableBoolean("ClimbFenceStarted")
         && !"back".equals(var6)
         && !"fallback".equals(var6)
         && !"lunge".equalsIgnoreCase(var6)
         && !"obstacle".equals(var6)
         && !"obstacleEnd".equals(var6)) {
         float var9 = ((Integer)var2.get(PARAM_START_X)).intValue();
         float var8 = ((Integer)var2.get(PARAM_START_Y)).intValue();
   ...
   public void animEvent(IsoGameCharacter var1, AnimEvent var2) {
      ...
      if (var2.m_EventName.equalsIgnoreCase("PlayFenceSound")) {
         ...
         long var7 = var1.getEmitter().playSoundImpl(var2.m_ParameterValue, null);
      ...
      if (var2.m_EventName.equalsIgnoreCase("PlayTripSound")) {
         ...
         long var16 = var1.getEmitter().playSoundImpl(var2.m_ParameterValue, null);
   ...
   private boolean isMetalFence(IsoObject var1) {
      if (var1 != null && var1.getProperties() != null) {
         ...
         if ("MetalBars".equals(var3) || "MetalBars".equals(var4) || "MetalBars".equals(var5)) {
            return true;
         } else if (!"MetalWire".equals(var3) && !"MetalWire".equals(var4) && !"MetalWire".equals(var5)) {
