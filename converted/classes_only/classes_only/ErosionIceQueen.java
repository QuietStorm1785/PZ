...
import zombie.erosion.season.ErosionIceQueen.Sprite;
...
public final class ErosionIceQueen {
   ...
   public void addSprite(String var1, String var2) {
      ...
      if (var3 != null && var4 != null) {
         var3.setName(var1);
         this.sprites.add(new Sprite(var3, var1, var2));
      }
   }
   ...
   private void setRoofSnow() {
      ...
      for (int var7 = 128; var7 < 176; var7++) {
         ...
         String var9 = "roofs_0" + var6 + "_" + var7;
         String var10 = "e_roof_snow_1_" + var8;
