...
class NonBlockingIdentityHashMap$SnapshotV implements Iterator<TypeV>, Enumeration<TypeV> {
   final Object[] _sskvs;
   private int _idx;
   ...
   public TypeV next() {
      if (this._idx != 0 && this._nextV == null) {
         ...
         while (this._idx < this.length()) {
            ...
            if (this._nextK != null && this._nextK != NonBlockingIdentityHashMap.TOMBSTONE && (this._nextV = (TypeV)this.this$0.get(this._nextK)) != null) {
               break;
            }
         }
