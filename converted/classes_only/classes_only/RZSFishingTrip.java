...
public class RZSFishingTrip extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(Zone var1) {
      ...
      this.addVehicle(var1, this.getSq(var1.x, var1.y, var1.z), null, null, "Base.PickUpTruck", null, null, "Fisherman");
      ...
      for (int var8 = 0; var8 < var6; var8++) {
         var12.getItemContainer().AddItem((String)var3.get(Rand.Next(var3.size())));
      }
