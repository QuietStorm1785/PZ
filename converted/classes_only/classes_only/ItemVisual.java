...
public final class ItemVisual {
   ...
   public float getDenimPatch(BloodBodyPartType var1) {
      return this.denimPatches == null ? 0.0F : (this.denimPatches[var1.index()] & 255) / 255.0F;
   }
   ...
   public float getLeatherPatch(BloodBodyPartType var1) {
      return this.leatherPatches == null ? 0.0F : (this.leatherPatches[var1.index()] & 255) / 255.0F;
   }
   ...
   public float getBasicPatch(BloodBodyPartType var1) {
      return this.basicPatches == null ? 0.0F : (this.basicPatches[var1.index()] & 255) / 255.0F;
   }
   ...
   public float getHole(BloodBodyPartType var1) {
      return this.holes == null ? 0.0F : (this.holes[var1.index()] & 255) / 255.0F;
   }
   ...
   public float getBlood(BloodBodyPartType var1) {
      return this.blood == null ? 0.0F : (this.blood[var1.index()] & 255) / 255.0F;
   }

   public float getDirt(BloodBodyPartType var1) {
      return this.dirt == null ? 0.0F : (this.dirt[var1.index()] & 255) / 255.0F;
   }
