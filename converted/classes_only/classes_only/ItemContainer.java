...
import zombie.inventory.ItemContainer.Comparators;
...
import zombie.inventory.ItemContainer.InventoryItemListPool;
import zombie.inventory.ItemContainer.Predicates;
...
public final class ItemContainer {
   ...
   public boolean hasRoomFor(IsoGameCharacter var1, float var2) {
      return floatingPointCorrection(this.getCapacityWeight()) + var2 <= this.getEffectiveCapacity(var1);
   }
         ...
         if (var2 != null && !var2.equalsIgnoreCase(var1.getCategory())) {
            ...
            if (this.parent != null && !this.parent.isItemAllowedInContainer(this, var1)) {
               ...
               if (this.getParent() != null && this.getParent().getProperties() != null && this.getParent().getProperties().Val("GroupName") != null) {
                  boolean var6 = this.getParent().getProperties().Val("GroupName").equals("Coffee")
   ...
   public boolean isRemoveItemAllowed(InventoryItem var1) {
      return var1 == null ? false : this.parent == null || this.parent.isRemoveItemAllowedFromContainer(this, var1);
   }
   ...
   public boolean isInside(InventoryItem var1) {
      if (this.containingItem == null) {
         ...
         return this.containingItem == var1 ? true : this.containingItem.getContainer() != null && this.containingItem.getContainer().isInside(var1);
      }
   }
   ...
   public int getNumberOfItem(String var1, boolean var2, boolean var3) {
      ...
      for (int var5 = 0; var5 < this.Items.size(); var5++) {
         ...
         if (var6.getFullType().equals(var1) || var6.getType().equals(var1)) {
            var4++;
         } else if (var3 && var6 instanceof InventoryContainer) {
   ...
   public boolean containsWithModule(String var1, boolean var2) {
      ...
      for (int var5 = 0; var5 < this.Items.size(); var5++) {
         ...
         if (var6 == null) {
            ...
            var5--;
         } else if (var6.type.equals(var3.trim())
            && var4.equals(var6.getModule())
            && (!var2 || !(var6 instanceof DrainableComboItem) || !(((DrainableComboItem)var6).getUsedDelta() <= 0.0F))) {
            return true;
         }
      }
      ...
      if (var1.contains("Type:")) {
         ...
         for (int var13 = 0; var13 < this.Items.size(); var13++) {
            ...
            if (var16 == null) {
               ...
               if (var2 && var16 instanceof InventoryContainer && ((InventoryContainer)var16).getInventory() != null && !var4.contains(var16)) {
                  var4.add(var16);
               }
            }
         }
   ...
   private static boolean compareType(String var0, InventoryItem var1) {
      return var0 != null && var0.indexOf(46) == -1
   ...
   public InventoryItem FindAndReturnStack(InventoryItem var1) {
      ...
      for (int var3 = 0; var3 < this.Items.size(); var3++) {
         InventoryItem var4 = this.Items.get(var3);
         if ((var4.type == null ? var2 == null : var4.type.equals(var2)) && var4.CanStack(var1)) {
            return var4;
         }
      }
   ...
   public boolean RemoveOneOf(String var1, boolean var2) {
      ...
      if (var2) {
         for (int var5 = 0; var5 < this.Items.size(); var5++) {
            InventoryItem var6 = this.Items.get(var5);
            if (var6 instanceof InventoryContainer
               && ((InventoryContainer)var6).getItemContainer() != null
   ...
   private boolean isSquareInRoom(IsoGridSquare var1) {
      return var1 == null ? false : var1.getRoom() != null;
   }
   ...
   public float getTemprature() {
      if (this.customTemperature != 0.0F) {
         ...
         if ("barbecue".equals(this.type) && this.parent instanceof IsoBarbecue) {
            ...
            return ((IsoFireplace)this.parent).getTemperature();
         } else if ((this.type.equals("fridge") || this.type.equals("freezer") || var1)
   ...
   public ArrayList<InventoryItem> save(ByteBuffer var1, IsoGameCharacter var2) throws IOException {
      ...
      ArrayList var3 = CompressIdenticalItems.save(var1, this.Items, null);
   ...
   public InventoryItem getItemFromType(String var1, boolean var2, boolean var3) {
      return this.getItemFromType(var1, null, false, var2, var3);
   }
   ...
   public void sendContentsToRemoteContainer(UdpConnection var1) {
      ...
      try {
         CompressIdenticalItems.save(var2.bb, this.Items, null);
   ...
   public InventoryItem getItemWithIDRecursiv(int var1) {
      for (int var2 = 0; var2 < this.Items.size(); var2++) {
         ...
         if (var3 instanceof InventoryContainer
            && ((InventoryContainer)var3).getItemContainer() != null
            && !((InventoryContainer)var3).getItemContainer().getItems().isEmpty()) {
   ...
   public LinkedHashMap<String, InventoryItem> getItems4Admin() {
      ...
      for (int var2 = 0; var2 < this.getItems().size(); var2++) {
         ...
         if (var3.getCat() != ItemType.Drainable
            ...
            && var1.get(var3.getFullType()) != null
            && !(var3 instanceof InventoryContainer)) {
   ...
   public LinkedHashMap<String, InventoryItem> getAllItems(LinkedHashMap<String, InventoryItem> var1, boolean var2) {
      ...
      for (int var3 = 0; var3 < this.getItems().size(); var3++) {
         ...
         if (var4 instanceof InventoryContainer
            && ((InventoryContainer)var4).getItemContainer() != null
            && !((InventoryContainer)var4).getItemContainer().getItems().isEmpty()) {
