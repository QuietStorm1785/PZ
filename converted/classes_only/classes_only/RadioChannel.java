...
public class RadioChannel {
            ...
            if (var1 == null) {
               ...
               if (!ZomboidRadio.DISABLE_BROADCASTING) {
                  ...
                  if (this.louisvilleObfuscate && ZomboidRadio.LOUISVILLE_OBFUSCATION) {
                     var2 = ZomboidRadio.getInstance().scrambleString(var2, 85, true, null);
                     ZomboidRadio.getInstance().SendTransmission(0, 0, this.frequency, var2, null, "", 0.7F, 0.5F, 0.5F, -1, this.isTv);
                  } else {
                     ZomboidRadio.getInstance()
                        .SendTransmission(0, 0, this.frequency, var2, null, var1.getEffectsString(), var1.getR(), var1.getG(), var1.getB(), -1, this.isTv);
                  }
               }
   ...
   public RadioScript getRadioScript(String var1) {
      return var1 != null && this.scripts.containsKey(var1) ? this.scripts.get(var1) : null;
   }
