...
import zombie.core.skinnedmodel.advancedanimation.AnimatedModel.AnimatedModelInstanceRenderData;
import zombie.core.skinnedmodel.advancedanimation.AnimatedModel.StateInfo;
import zombie.core.skinnedmodel.advancedanimation.AnimatedModel.UIModelCamera;
import zombie.core.skinnedmodel.advancedanimation.AnimatedModel.WorldModelCamera;
...
public final class AnimatedModel extends AnimationVariableSource implements IAnimatable, IAnimEventCallback, IActionStateChanged, IHumanVisual {
   ...
   private final ResultLight[] lights = new ResultLight[5];
   ...
   public AnimatedModel() {
      ...
      for (int var2 = 0; var2 < this.stateInfos.length; var2++) {
         this.stateInfos[var2] = new StateInfo();
      }
   }
   ...
   public void setModelData(HumanVisual var1, ItemVisuals var2) {
      ...
      this.modelInstance = ModelManager.instance.newInstance(var5, null, this.getAnimationPlayer());
   ...
   public void setLights(ResultLight[] var1, float var2, float var3, float var4) {
   ...
   private void addHeadHair(ItemVisual var1) {
      ...
      if (this.isFemale()) {
         ...
         if (var7 != null && var1 != null && var1.getClothingItem() != null) {
   ...
   private void addHeadHairItem(String var1, String var2, ImmutableColor var3) {
      if (StringUtils.isNullOrWhitespace(var1)) {
         ...
         ModelInstance var4 = ModelManager.instance.newAdditionalModelInstance(var1, var2, null, this.modelInstance.AnimPlayer, null);
         if (var4 != null) {
   ...
   private void addClothingItem(ItemVisual var1, ClothingItem var2) {
      ...
      if (StringUtils.isNullOrWhitespace(var3)) {
         ...
         if (var6 != null && var6.length() > 0) {
            ...
            var8 = ModelManager.instance.newAdditionalModelInstance(var3, var4, null, this.modelInstance.AnimPlayer, var7);
         }
   ...
   private void DoCharacterModelEquipped() {
      ...
      for (int var8 = 0; var8 < this.attachedModelNames.size(); var8++) {
         ...
         ModelInstance var3 = ModelManager.instance.addStatic(null, var2.modelName, var2.attachmentNameSelf, var2.attachmentNameParent);
   ...
   private ModelInstance addStatic(String var1, String var2, String var3, String var4) {
      ...
      ModelInstance var6 = ModelManager.instance.newInstance(var5, null, this.modelInstance.AnimPlayer);
   ...
   public int renderMain() {
      ...
      if (this.modelInstance != null) {
         ...
         this.initRenderData(var1, null, this.modelInstance);
      }
                     ...
                     if (var2.tex != null || var2.model.tex != null) {
                        ...
                        if (Core.bDebug && DebugOptions.instance.ModelRenderBones.getValue()) {
                           ...
                           for (int var9 = 0; var9 < var2.AnimPlayer.modelTransforms.length; var9++) {
                              int var12 = (Integer)var2.AnimPlayer.getSkinningData().SkeletonHierarchy.get(var9);
                              if (var12 >= 0) {
