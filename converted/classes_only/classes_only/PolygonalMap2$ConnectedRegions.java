...
final class PolygonalMap2$ConnectedRegions {
   PolygonalMap2 map;
   ...
   boolean shouldVisit(int var1, int var2, int var3, int var4) {
      if (var3 >= this.MINX + this.WIDTH || var3 < this.MINX) {
         ...
         if (this.visited.getValue(this.gridX(var3), this.gridY(var4))) {
            ...
            return var5 != null && var6 != null ? !this.isBlocked(var5, var6, false) : false;
         }
      } else {
         return false;
      }
         ...
         if (var2.isReallySolid()) {
            ...
            if (!var8 && !var9 && !var10 && !var11) {
               ...
               if (var12) {
                  ...
                  if (var2.x == var1.x - 1 && var2.y == var1.y - 1 && var13 != null && var14 != null && var13.has(2048) && var14.has(4096)) {
                     return true;
                  }

                  if (var13 != null && this.isBlocked(var1, var13, true)) {
                     return true;
                  }

                  if (var14 != null && this.isBlocked(var1, var14, true)) {
                     return true;
                  }

                  if (var13 != null && this.isBlocked(var2, var13, true)) {
                     return true;
                  }

                  if (var14 != null && this.isBlocked(var2, var14, true)) {
                     return true;
                  }
               }
