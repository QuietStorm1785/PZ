...
final class PolygonalMap2$SquareUpdateTask {
   PolygonalMap2 map;
   int x;
   int y;
   int z;
   ...
   static boolean isWindowUnblocked(IsoGridSquare var0, boolean var1) {
      ...
      return IsoWindowFrame.canClimbThrough(var5, null);
   }
   ...
   static boolean hasWallThumpableN(IsoGridSquare var0) {
      ...
      if (var1 == null) {
         ...
         for (int var2 = 0; var2 < var0.getSpecialObjects().size(); var2++) {
            ...
            if (var3 != null
               && !var3.canClimbThrough(null)
               && !var3.canClimbOver(null)
               && var3.isThumpable()
               && !var3.isBlockAllTheSquare()
               && !var3.isDoor()
               && var3.TestCollide(null, var0, var1)) {
               return true;
            }
         }
