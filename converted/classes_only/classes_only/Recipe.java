...
public class Recipe extends BaseScriptObject {
   ...
   public void DoResult(String var1) {
      ...
      if (var1.contains(";")) {
         ...
         var1 = var4[0].trim();
         var2.drainableCount = Integer.parseInt(var4[1].trim());
      }
   ...
   public RequiredSkill getRequiredSkill(int var1) {
      return this.skillRequired != null && var1 >= 0 && var1 < this.skillRequired.size() ? this.skillRequired.get(var1) : null;
   }
   ...
   public void addRequiredSkill(Perk var1, int var2) {
      if (this.skillRequired == null) {
         this.skillRequired = new ArrayList<>();
      }
