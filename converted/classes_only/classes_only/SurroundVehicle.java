...
import zombie.vehicles.SurroundVehicle.1;
import zombie.vehicles.SurroundVehicle.Position;
...
public final class SurroundVehicle {
   ...
   private void addPositions(float var1, float var2, float var3, float var4, PositionSide var5) {
   ...
   private Position addPosition(float var1, float var2, PositionSide var3) {
   ...
   private Position getClosestPositionFor(IsoZombie var1) {
