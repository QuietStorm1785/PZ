...
public final class HumanVisual extends BaseVisual {
   ...
   public String getSkinTexture() {
      if (this.skinTextureName != null) {
         ...
         return (String)var2.get(this.skinTexture) + var1;
      }
   }
   ...
   public void setNaturalHairColor(ImmutableColor var1) {
   ...
   public void setNaturalBeardColor(ImmutableColor var1) {
   ...
   public void copyFrom(BaseVisual var1) {
      if (var1 == null) {
         ...
         if (var2 == null) {
            throw new IllegalArgumentException("expected HumanVisual, got " + var1);
         } else {
            var2.getHairColor();
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if ((var3 & 2) != 0) {
         ...
         this.beardColor = new ImmutableColor(var9, var15, var22);
      }
      ...
      if ((var3 & 8) != 0) {
         ...
         this.skinColor = new ImmutableColor(var10, var16, var23);
      }
      ...
      for (int var20 = 0; var20 < var11; var20++) {
         ItemVisual var27 = new ItemVisual();
         var27.load(var1, var2);
         this.bodyVisuals.add(var27);
      }
      ...
      if (var2 >= 187) {
         ...
         if ((var21 & 4) != 0) {
            ...
            this.naturalHairColor = new ImmutableColor(var28, var7, var8);
         }
         ...
         if ((var21 & 2) != 0) {
            ...
            this.naturalBeardColor = new ImmutableColor(var29, var30, var31);
         }
      }
   }
   ...
   private void dressInOutfit(Outfit var1, ItemVisuals var2) {
      ...
      if (var1.m_Pants) {
         String var3 = var1.m_AllowPantsHue
         ...
         this.addClothingItem(var2, itemVisualLocations, var3, null);
      }
      ...
      if (var1.m_Top && var1.RandomData.m_hasTop) {
         ...
         this.addClothingItem(var2, itemVisualLocations, var6, null);
      }
   ...
   public ItemVisual addBodyVisualFromClothingItemName(String var1) {
      if (StringUtils.isNullOrWhitespace(var1)) {
         return null;
      } else {
   ...
   public boolean hasBodyVisualFromItemType(String var1) {
      for (int var2 = 0; var2 < this.bodyVisuals.size(); var2++) {
         ItemVisual var3 = (ItemVisual)this.bodyVisuals.get(var2);
         if (var3.getItemType().equals(var1)) {
            return true;
   ...
   private void getItemVisualLocations(ItemVisuals var1, ArrayList<String> var2) {
      var2.clear();
   ...
   public ItemVisual addClothingItem(ItemVisuals var1, Item var2) {
      if (var2 == null) {
         ...
         if (var3 == null) {
            ...
            return this.addClothingItem(var1, itemVisualLocations, var3.m_Name, null);
         }
      }
   }

   private ItemVisual addClothingItem(ItemVisuals var1, ArrayList<String> var2, String var3, ClothingItemReference var4) {
                  ...
                  if (!var4.RandomData.m_Active) {
                     ...
                     if (var9 == null) {
                        ...
                        for (int var13 = 0; var13 < var1.size(); var13++) {
                           if (var8.isExclusive(var7, (String)var2.get(var13))) {
                              var1.remove(var13);
                              var2.remove(var13);
                              var13--;
                           }
                        ...
                        for (int var12 = 0; var12 < var1.size(); var12++) {
                           if (var8.indexOf((String)var2.get(var12)) > var14) {
                              var11 = var12;
                              break;
                           }
                        }

                        ItemVisual var15 = new ItemVisual();
                        var15.setItemType(var5.getFullName());
                        var15.synchWithOutfit(var4);
                        var1.add(var11, var15);
                        var2.add(var11, var7);
                        return var15;
                     }
                  }
   ...
   public void setForceModel(Model var1) {
      this.forceModel = var1;
   }

   public void setForceModelScript(String var1) {
   ...
   private static ImmutableColor colorFromString(String var0) {
      ...
      if (var1.length == 3) {
         try {
            ...
            return new ImmutableColor(var2 / 255.0F, var3 / 255.0F, var4 / 255.0F);
