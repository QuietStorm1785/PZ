...
public final class StashSystem {
   ...
   private static boolean checkSpecificSpawnProperties(Stash var0, InventoryItem var1) {
      return !var0.spawnOnlyOnZed || var1.getContainer() != null && var1.getContainer().getParent() instanceof IsoDeadBody
                           ...
                           for (int var7 = 0; var7 < 8; var7++) {
                              ...
                              if (var8 != null) {
                                 for (int var9 = 0; var9 < var8.getObjects().size(); var9++) {
                                    ...
                                    if (var10.getContainer() != null
                                       && var8.getRoom() != null
                                       && var8.getRoom().getBuilding().getDef() == var0
                                       && var8.getRoom().getName() != null
                                       ...
                                       ItemPickerJava.fillContainerType(var4, var10.getContainer(), "", null);
         ...
         for (int var3 = 0; var3 < var0.containers.size(); var3++) {
            ...
            if (var5 != null) {
               if (var4.containerItem != null && !var4.containerItem.isEmpty()) {
                  ...
                  ItemPickerJava.rollContainerItem((InventoryContainer)var22, null, var8);
                  var5.AddWorldInventoryItem(var22, 0.0F, 0.0F, 0.0F);
               } else {
                  IsoThumpable var18 = new IsoThumpable(var5.getCell(), var5, var4.containerSprite, false, null);
                  var18.setIsThumpable(false);
                  var18.container = new ItemContainer(var4.containerType, var5, var18);
         ...
         for (int var9 = var0.minTrapToSpawn; var9 < var0.maxTrapToSpawn; var9++) {
            ...
            if (var11 != null) {
               ...
               if (GameServer.bServer) {
                  ...
                  IsoTrap var15 = new IsoTrap(var13, var11.getCell(), var11);
      ...
      if (var0.zombies > -1) {
         for (int var10 = 0; var10 < var1.rooms.size(); var10++) {
            ...
            if (IsoWorld.getZombiesEnabled()) {
               ...
               ArrayList var21 = VirtualZombieManager.instance.addZombiesToMap(var16, var12, false);
