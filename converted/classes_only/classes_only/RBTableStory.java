...
import zombie.randomizedWorld.randomizedBuilding.RBTableStory.StoryDef;
...
public final class RBTableStory extends RandomizedBuildingBase {
   ...
   public void initStories() {
      if (allStories.isEmpty()) {
         ...
         var2.add(new StorySpawnItem(this, var3, null, 100));
         var2.add(new StorySpawnItem(this, null, "Chocolate", 100));
         var2.add(new StorySpawnItem(this, null, "Butter", 70));
         var2.add(new StorySpawnItem(this, null, "Flour", 70));
         var2.add(new StorySpawnItem(this, null, "Spoon", 100));
         var2.add(new StorySpawnItem(this, null, "EggCarton", 100));
         var2.add(new StorySpawnItem(this, null, "Egg", 100));
         allStories.add(new StoryDef(this, var2, var1));
      }
   }
   ...
   private String getItemFromSSI(StorySpawnItem var1) {
      if (Rand.Next(100) > var1.chanceToSpawn) {
         ...
         for (String var5 : var1.eitherObject.keySet()) {
