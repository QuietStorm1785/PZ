...
public final class WornItems {
   ...
   public void setItem(String var1, InventoryItem var2) {
      ...
      if (var2 != null) {
         ...
         WornItem var9 = new WornItem(var1, var2);
         this.items.add(var7, var9);
      }
   }
   ...
   public InventoryItem getItem(String var1) {
      ...
      return var2 == -1 ? null : this.items.get(var2).item;
   }

   public InventoryItem getItemByIndex(int var1) {
      return var1 >= 0 && var1 < this.items.size() ? this.items.get(var1).getItem() : null;
   }
   ...
   public String getLocation(InventoryItem var1) {
      int var2 = this.indexOf(var1);
      return var2 == -1 ? null : this.items.get(var2).getLocation();
   }
