...
public final class IsoGridSquare {
   ...
   public void DoCutawayShader(
      ...
      if (var11 != null && var11.getID() != -1) {
         ...
         var1.renderAttachedAndOverlaySprites(this.x, this.y, this.z, var12 ? var14 : defColorInfo, false, !var12, null, var10);
      }
   }
      ...
      if (var9 != null && var9.getID() != -1) {
         ...
         try {
            ...
            if (var1.name.contains("fencing_01_11")) {
               ...
               String var21 = var1.name.replaceAll("(.*)_", "");
               int var24 = Integer.parseInt(var21);
               switch (var24) {
                  case 45:
                  case 46:
                  case 47:
               ...
               String var16 = var1.name.replaceAll("(.*)_", "");
            ...
            if (var2 == IsoDirections.N || var2 == IsoDirections.NW) {
               ...
               IndieGL.bindShader(
                  ...
                  (var1x, var2x, var3x) -> var1x.render(
                     null, this.x, this.y, this.z, var2x, WeatherFxMask.offsetX, WeatherFxMask.offsetY, defColorInfo, false, var3x
                  )
               );
            }
   ...
   private int performDrawWall(IsoObject var1, int var2, int var3, boolean var4, Consumer<TextureDraw> var5, Shader var6) {
      ...
      if (Core.bDebug && DebugOptions.instance.DebugDraw_SkipWorldShading.getValue()) {
         var1.render(this.x, this.y, this.z, defColorInfo, true, !var4, null);
         return var2;
      } else {
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      BitHeaderRead var4 = BitHeader.allocRead(HeaderSize.Byte, var1);
      if (!var4.equals(0)) {
         if (var4.hasFlags(1)) {
            if (var3) {
            ...
            for (int var6 = 0; var6 < var19; var6++) {
               ...
               if (var12 == null) {
                  if (var3) {
                     ...
                     if (var32 - var7 != var8) {
                        DebugLog.log(
                           "***** Object loaded size " + (var32 - var7) + " != saved size " + var8 + ", reading obj size: " + var19 + ", Object == null"
                        );
                  ...
                  if (var12 instanceof IsoWorldInventoryObject) {
                     ...
                     String var34 = ((IsoWorldInventoryObject)var12).getItem().getFullType();
                     Item var14 = ScriptManager.instance.FindItem(var34);
                     if (var14 != null && var14.getObsolete()) {
                        continue;
                     }

                     String[] var15 = var34.split("_");
                  ...
                  if (!(var12 instanceof IsoWindow)
                     || var12.getSprite() == null
                     || !"walls_special_01_8".equals(var12.getSprite().getName()) && !"walls_special_01_9".equals(var12.getSprite().getName())) {
                        ...
                        if (Core.bDebug && !(var12 instanceof IsoWorldInventoryObject)) {
                           DebugLog.log(
                              "Bitflags = "
                                 ...
                                 + var12.getObjectName()
                                 + ", sprite = "
                                 + (var12.getSprite() != null ? var12.getSprite().getName() : "unknown")
                           );
                        }
         ...
         if (var4.hasFlags(64)) {
            BitHeaderRead var20 = BitHeader.allocRead(HeaderSize.Byte, var1);
            if (var20.hasFlags(1)) {
               if (var3) {
               ...
               for (int var25 = 0; var25 < var23; var25++) {
                  IsoMovingObject var27 = null;
                  if (var3) {
                     String var30 = GameWindow.ReadStringUTF(var1);
                     DebugLog.log(var30);
                  }
                  ...
                  if (var27 != null) {
                     ...
                     this.StaticMovingObjects.add(var27);
         ...
         if (var1 != null && ((IsoGridSquare)var1).Properties.Is(IsoFlagType.solidfloor)) {
            ...
            if (var1 != null && ((IsoGridSquare)var1).Properties.Is(IsoFlagType.solidfloor)) {
               ...
               if (var1 != null && ((IsoGridSquare)var1).Properties.Is(IsoFlagType.solidfloor)) {
                  ...
                  var1 = this.getCell().getGridSquare(this.getX(), this.getY() + 1, this.getZ());
                  return var1 != null && ((IsoGridSquare)var1).Properties.Is(IsoFlagType.solidfloor);
               }
            }
         }
      }
   ...
   public boolean hasFloor(boolean var1) {
      if (this.Properties.Is(IsoFlagType.solidfloor)) {
         ...
         return var2 != null && ((IsoGridSquare)var2).Properties.Is(IsoFlagType.solidfloor);
      }
   }
   ...
   public boolean removeSheetRopeFromBottom(IsoPlayer var1, boolean var2) {
      ...
      if (var2) {
         ...
         String var12 = "crafted_01_3";

         for (int var14 = 0; var14 < var6.getObjects().size(); var14++) {
            IsoObject var16 = (IsoObject)var6.getObjects().get(var14);
            if (var16.sprite != null && var16.sprite.getName() != null && var16.sprite.getName().equals(var12)) {
      ...
      IsoGridSquare var17;
      for (var17 = null; var6 != null; var15 = false) {
   ...
   public IsoObject addFloor(String var1) {
      ...
      for (int var8 = this.z - 1; var8 > 0; var8--) {
         ...
         if (var9 == null) {
            var9 = getNew(this.getCell(), null, this.x, this.y, var8);
   ...
   public IsoThumpable AddStairs(boolean var1, int var2, String var3, String var4, KahluaTable var5) {
      ...
      if (var2 == 2) {
         ...
         if (var12 == null) {
            var12 = new IsoGridSquare(this.getCell(), null, this.x, this.y, this.z + 1);
            this.getCell().ConnectNewSquare(var12, false);
         }
      }
   ...
   public boolean hasSupport() {
      ...
      return var1 != null && var1.Properties.Is(IsoFlagType.cutN) && !var1.Properties.Is(IsoFlagType.halfheight)
         ? true
         : var2 != null && var2.Properties.Is(IsoFlagType.cutW) && !var1.Properties.Is(IsoFlagType.halfheight);
   }
         ...
         if (!var5 && var1.Properties.Is(IsoFlagType.solid)) {
            ...
            if (!var4 && var1.Properties.Is(IsoFlagType.solidtrans)) {
               ...
               if (!var11) {
                  ...
                  if (var21 != null && (var21.Is(IsoFlagType.windowW) || var21.Is(IsoFlagType.WindowW))) {
                     var11 = true;
                  }
               }
            ...
            if (var1.x != this.x && var1.y != this.y && this.z != var1.z && var3) {
               ...
               if (var1.x > this.x && var1.z < this.z && var1.Has(IsoObjectType.stairsTW)) {
                  ...
                  if (var1.x == this.x || var1.z != this.z || !var1.Has(IsoObjectType.stairsTN) || var19 != null && var19.Has(IsoObjectType.stairsTN) && !var3) {
                     if (var1.y <= this.y
                        || var1.x != this.x
                        || var1.z != this.z
         ...
         if (var5 != null) {
            if (!var5.SpecialObjects.isEmpty()) {
               for (int var6 = 0; var6 < var5.SpecialObjects.size(); var6++) {
                  ...
                  if (var7.TestCollide(null, this, var5)) {
                     return true;
                  }
               }
            }
            ...
            if (!this.SpecialObjects.isEmpty()) {
               for (int var8 = 0; var8 < this.SpecialObjects.size(); var8++) {
                  ...
                  if (var9.TestCollide(null, this, var5)) {
                     return true;
                  }
               }
            }
   ...
   public TestResults testVisionAdjacent(int var1, int var2, int var3, boolean var4, boolean var5) {
      if (var1 >= -1 && var1 <= 1 && var2 >= -1 && var2 <= 1 && var3 >= -1 && var3 <= 1) {
         ...
         if (var3 == -1 && (var1 != 0 || var2 != 0)) {
            ...
            if (var12 != null && var12.HasElevatedFloor()) {
               ...
               if (!this.SpecialObjects.isEmpty()) {
                  for (int var9 = 0; var9 < this.SpecialObjects.size(); var9++) {
                     ...
                     if (var11 != VisionResult.NoEffect) {
                        if (var11 == VisionResult.Unblocked && var10 instanceof IsoDoor) {
                           var8 = ((IsoDoor)var10).IsOpen() ? TestResults.ClearThroughOpenDoor : TestResults.ClearThroughClosedDoor;
                        } else if (var11 == VisionResult.Unblocked && var10 instanceof IsoThumpable && ((IsoThumpable)var10).isDoor) {
                           var8 = TestResults.ClearThroughOpenDoor;
                        } else if (var11 == VisionResult.Unblocked && var10 instanceof IsoWindow) {
                           var8 = TestResults.ClearThroughWindow;
                        } else {
                           if (var11 == VisionResult.Blocked && var10 instanceof IsoDoor && !var5) {
                              return TestResults.Blocked;
                           }

                           if (var11 == VisionResult.Blocked && var10 instanceof IsoThumpable && ((IsoThumpable)var10).isDoor && !var5) {
                              return TestResults.Blocked;
                           }

                           if (var11 == VisionResult.Blocked && var10 instanceof IsoThumpable && ((IsoThumpable)var10).isWindow()) {
                              return TestResults.Blocked;
                           }

                           if (var11 == VisionResult.Blocked && var10 instanceof IsoCurtain) {
                              return TestResults.Blocked;
                           }

                           if (var11 == VisionResult.Blocked && var10 instanceof IsoWindow) {
                              return TestResults.Blocked;
                           }

                           if (var11 == VisionResult.Blocked && var10 instanceof IsoBarricade) {
                              return TestResults.Blocked;
                           }
                        }
                     }
               ...
               if (!var7.SpecialObjects.isEmpty()) {
                  for (int var16 = 0; var16 < var7.SpecialObjects.size(); var16++) {
                     ...
                     if (var18 != VisionResult.NoEffect) {
                        if (var18 == VisionResult.Unblocked && var17 instanceof IsoDoor) {
                           var8 = ((IsoDoor)var17).IsOpen() ? TestResults.ClearThroughOpenDoor : TestResults.ClearThroughClosedDoor;
                        } else if (var18 == VisionResult.Unblocked && var17 instanceof IsoThumpable && ((IsoThumpable)var17).isDoor) {
                           var8 = TestResults.ClearThroughOpenDoor;
                        } else if (var18 == VisionResult.Unblocked && var17 instanceof IsoWindow) {
                           var8 = TestResults.ClearThroughWindow;
                        } else {
                           if (var18 == VisionResult.Blocked && var17 instanceof IsoDoor && !var5) {
                              return TestResults.Blocked;
                           }

                           if (var18 == VisionResult.Blocked && var17 instanceof IsoThumpable && ((IsoThumpable)var17).isDoor && !var5) {
                              return TestResults.Blocked;
                           }

                           if (var18 == VisionResult.Blocked && var17 instanceof IsoThumpable && ((IsoThumpable)var17).isWindow()) {
                              return TestResults.Blocked;
                           }

                           if (var18 == VisionResult.Blocked && var17 instanceof IsoCurtain) {
                              return TestResults.Blocked;
                           }

                           if (var18 == VisionResult.Blocked && var17 instanceof IsoWindow) {
                              return TestResults.Blocked;
                           }

                           if (var18 == VisionResult.Blocked && var17 instanceof IsoBarricade) {
                              return TestResults.Blocked;
                           }
                        }
                     }
   ...
   private boolean isWindowOrWindowFrame(IsoObject var1, boolean var2) {
      if (var1 != null && var1.sprite != null) {
         if (var2 && var1.sprite.getProperties().Is(IsoFlagType.windowN)) {
            ...
            return var3 != null && var3.isWindow() ? var2 == var3.getNorth() : IsoWindowFrame.isWindowFrame(var1, var2);
         }
      } else {
         return false;
      }
   ...
   boolean renderMinusFloor(PZArrayList<IsoObject> var1, int var2, boolean var3, boolean var4, boolean var5, boolean var6, boolean var7, Shader var8) {
      if (!DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.RenderMinusFloor.getValue()) {
         ...
         for (int var48 = var23; var3 ? var48 >= var24 : var48 <= var24; var48 += var3 ? -1 : 1) {
            ...
            CircleStencil = false;
            if (var53.sprite != null && (var53.sprite.solidfloor || var53.sprite.renderLayer == 1)) {
               var32 = false;
            }
            ...
            if (this.z >= var2 && (var53.sprite == null || !var53.sprite.alwaysDraw)) {
               var32 = false;
            }
            ...
            if ((!var4 || var34 && this.bFlattenGrassEtc) && (var4 || !var34 || !this.bFlattenGrassEtc)) {
               ...
               if (var53.sprite != null && !var53.sprite.solidfloor && IsoPlayer.getInstance().isClimbing()) {
                  var32 = true;
               }
               ...
               if (var32) {
                  ...
                  if (var53.sprite == null || !var35 && !var36) {
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Objects.getValue()) {
                        ...
                        if (var33 != IsoObjectType.WestRoofB && var33 != IsoObjectType.WestRoofM && var33 != IsoObjectType.WestRoofT
                           ...
                           if (var11 != null && !var13 && this.getRoomID() != var47 && var14 < 0.5F) {
                        ...
                        if (var53 instanceof IsoWindow var55) {
                           if (var53.getTargetAlpha(var10) < 1.0E-4F) {
                              IsoGridSquare var57 = var55.getOppositeSquare();
                              if (var57 != null && var57 != this && var57.lighting[var10].bSeen()) {
                        ...
                        if (var56 != null) {
                           tempWorldInventoryObjects.add(var56);
                        }

                        var53.render(this.x, this.y, this.z, var12, true, false, null);
                     }
                  } else if (PerformanceSettings.LightingFrameSkip < 3) {
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.DoorsAndWalls.getValue()) {
                        CircleStencil = true;
                        if (var11 != null && this.getRoomID() != -1 && var47 == -1 && var15) {
                        ...
                        if (var53 instanceof IsoWindow && var53.getTargetAlpha(var10) < 1.0F) {
         ...
         for (int var49 = 0; var49 < tempWorldInventoryObjects.size(); var49++) {
            ...
            var54.render(this.x, this.y, this.z, var12, true, false, null);
         }
            ...
            if (var3.AttachedAnimSprite != null) {
               for (int var4 = 0; var4 < var3.AttachedAnimSprite.size(); var4++) {
                  ...
                  if (var5.name != null) {
                     ...
                     if (var5.name.equals("street_trafficlines_01_4")
                        || var5.name.equals("street_trafficlines_01_0")
                        || var5.name.equals("street_trafficlines_01_16")) {
