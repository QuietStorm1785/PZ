...
public final class RBBasic extends RandomizedBuildingBase {
   ...
   public void randomizeBuilding(BuildingDef var1) {
      ...
      String var4 = this.specificProfessionDistribution.get(Rand.Next(0, this.specificProfessionDistribution.size()));
            ...
            for (int var10 = 0; var10 < 8; var10++) {
               ...
               if (var11 != null) {
                  if (var7 && var11.getFloor() != null && this.plankStash.containsKey(var11.getFloor().getSprite().getName())) {
                     IsoThumpable var12 = new IsoThumpable(var11.getCell(), var11, this.plankStash.get(var11.getFloor().getSprite().getName()), false, null);
                  ...
                  for (int var18 = 0; var18 < var11.getObjects().size(); var18++) {
                     ...
                     if (Rand.Next(100) <= 65 && var13 instanceof IsoDoor && !((IsoDoor)var13).isExteriorDoor(null)) {
                        ((IsoDoor)var13).ToggleDoorSilent();
                        ((IsoDoor)var13).syncIsoObject(true, (byte)1, null, null);
                     }

                     if (var13 instanceof IsoWindow var14) {
                        if (Rand.NextBool(80)) {
                           var1.bAlarmed = false;
                           var14.ToggleWindow(null);
                        }
                     ...
                     if (var2
                        && Rand.Next(100) <= 70
                        && var13.getContainer() != null
                        && var11.getRoom() != null
                        && var11.getRoom().getName() != null
                     ...
                     if (!this.tablesDone.contains(var13) && var13.getProperties().isTable() && var13.getContainer() == null && !this.doneTable) {
      ...
      for (int var16 = 0; var16 < var3.size(); var16++) {
         ...
         ItemPickerJava.fillContainerType(var5, var17, "", null);
      ...
      for (int var4 = 0; var4 < var1.getObjects().size(); var4++) {
         ...
         if (!var2 && var5.getSprite().getName().contains("sink") && Rand.NextBool(4)) {
            ...
            for (int var7 = 0; var7 < var1.getObjects().size(); var7++) {
               ...
               if (var8.getSprite() != null && var8.getSprite().getName() != null && var8.getSprite().getName().contains("sink")
                  || var8 instanceof IsoStove
                  || var8 instanceof IsoRadio) {
                  var9 = false;
                  break;
               }
            }
   ...
   private void generateKitchenStoveClutter(IsoDirections var1, IsoObject var2, IsoGridSquare var3) {
      ...
      String var5 = kitchenStoveItems.get(Rand.Next(1, kitchenStoveItems.size()));
   ...
   private void generateCounterClutter(IsoDirections var1, IsoObject var2, IsoGridSquare var3, HashMap<Integer, String> var4) {
      ...
      for (int var14 = 0; var14 < var7.size(); var14++) {
         int var15 = (Integer)var7.get(var14);
