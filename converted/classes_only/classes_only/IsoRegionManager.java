...
public final class IsoRegionManager {
   ...
   public IsoWorldRegion allocIsoWorldRegion() {
      IsoWorldRegion var1 = !this.poolIsoWorldRegion.isEmpty() ? this.poolIsoWorldRegion.pop() : new IsoWorldRegion(this);
      int var2 = this.regionIdStack.isEmpty() ? this.nextID++ : this.regionIdStack.pop();
      var1.init(var2);
   ...
   public IsoChunkRegion allocIsoChunkRegion(int var1) {
      IsoChunkRegion var2 = !this.poolIsoChunkRegion.isEmpty() ? this.poolIsoChunkRegion.pop() : new IsoChunkRegion(this);
      int var3 = this.regionIdStack.isEmpty() ? this.nextID++ : this.regionIdStack.pop();
      var2.init(var3, var1);
