...
public abstract class GenericSpriteRenderState {
   ...
   private WallShaderTexRender wallShaderTexRender;
   ...
   public void renderRect(int var1, int var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      if (var8 != 0.0F) {
         ...
         this.sprite[this.numSprites].reset();
         TextureDraw.Create(this.sprite[this.numSprites], null, var1, var2, var3, var4, var5, var6, var7, var8, null);
         this.style[this.numSprites] = this.defaultStyle;
         this.numSprites++;
      }
   }
   ...
   public void renderPoly(
      ...
      this.sprite[this.numSprites].reset();
      TextureDraw.Create(this.sprite[this.numSprites], null, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12);
      this.style[this.numSprites] = this.defaultStyle;
      this.numSprites++;
   }
