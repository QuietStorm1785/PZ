...
public final class Radio extends Moveable implements Talker, IUpdater, WaveSignalDevice {
   ...
   public void AddDeviceText(String var1, float var2, float var3, float var4, String var5, String var6, int var7) {
      ...
      if (var8 != null && this.deviceData != null && this.deviceData.getDeviceVolume() > 0.0F && !var8.Traits.Deaf.isSet()) {
   ...
   public void AddDeviceText(ChatMessage var1, float var2, float var3, float var4, String var5, String var6, int var7) {
      if (!ZomboidRadio.isStaticSound(var1.getText())) {
         this.doReceiveSignal(var7);
      }

      IsoPlayer var8 = this.getPlayer();
      if (var8 != null && this.deviceData != null && this.deviceData.getDeviceVolume() > 0.0F) {
   ...
   public float getX() {
      ...
      return var1 == null ? 0.0F : var1.getX();
   }

   public float getY() {
      IsoGridSquare var1 = this.getSquare();
      return var1 == null ? 0.0F : var1.getY();
   }
      ...
      if (this.deviceData != null) {
         if (!GameServer.bServer && !GameClient.bClient || GameClient.bClient) {
            ...
            for (int var2 = 0; var2 < IsoPlayer.numPlayers; var2++) {
               ...
               if (var3 != null && var3.getEquipedRadio() == this) {
                  var1 = true;
                  break;
               }
            }
