...
import zombie.characters.AttachedItems.AttachedWeaponDefinitions.L_addRandomAttachedWeapon;
...
public final class AttachedWeaponDefinitions {
   ...
   public void addRandomAttachedWeapon(IsoZombie var1) {
      if (!"Tutorial".equals(Core.getInstance().getGameMode())) {
         ...
         if (!this.m_definitions.isEmpty()) {
            ArrayList var2 = L_addRandomAttachedWeapon.definitions;
            var2.clear();
            int var3 = 1;
            ...
            while (var3 > 0) {
               ...
               if (var4 != null && OutfitRNG.Next(100) >= var4.chance) {
                  return;
               }
            }
         }
   ...
   private AttachedWeaponDefinition pickRandomInList(ArrayList<AttachedWeaponDefinition> var1, IsoZombie var2) {
      AttachedWeaponDefinition var3 = null;
      int var4 = 0;
      ArrayList var5 = L_addRandomAttachedWeapon.possibilities;
      var5.clear();
   ...
   private void tableToArrayList(KahluaTable var1, String var2, ArrayList<String> var3) {
