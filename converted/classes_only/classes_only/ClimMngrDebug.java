...
import zombie.iso.weather.dbg.ClimMngrDebug.RecordInfo;
import zombie.iso.weather.dbg.ClimMngrDebug.RunInfo;
...
public class ClimMngrDebug extends ClimateManager {
   ...
   private RunInfo calculateTotal() {
      ...
      for (RunInfo var10 : this.runs) {
         ...
         for (int var16 = 0; var16 < var10.exceedingPeriods.size(); var16++) {
            var1.exceedingPeriods.add((Integer)var10.exceedingPeriods.get(var16));
         }

         for (int var17 = 0; var17 < var10.exceedingEmpties.size(); var17++) {
            var1.exceedingEmpties.add((Integer)var10.exceedingEmpties.get(var17));
         }
      ...
      if (this.runs.size() > 0) {
         try {
            ...
            if (var3.exists() && var3.isDirectory()) {
               ...
               try (FileWriter var6 = new FileWriter(var5, false)) {
                  this.writer = var6;
                  ...
                  if (var22.exceedingPeriods.size() > 0) {
                     for (Integer var11 : var22.exceedingPeriods) {
                  ...
                  if (var22.exceedingEmpties.size() > 0) {
                     for (Integer var29 : var22.exceedingEmpties) {
               ...
               try (FileWriter var26 = new FileWriter(var5, false)) {
                  this.writer = var26;
                  this.writeData();
                  this.writer = null;
               ...
               try (FileWriter var27 = new FileWriter(var5, false)) {
                  this.writer = var27;
                  this.writePatterns();
                  this.writer = null;
   ...
   private void writeRunInfo(RunInfo var1, int var2) throws Exception {
      this.write("===================================================================");
      ...
      if (var1.exceedingPeriods.size() > 0) {
         for (Integer var4 : var1.exceedingPeriods) {
      ...
      if (var1.exceedingEmpties.size() > 0) {
         for (Integer var6 : var1.exceedingEmpties) {
   ...
   private void writeDataExtremes() throws Exception {
      ...
      for (RunInfo var7 : this.runs) {
         ...
         if (var5 == null || var7.totalPeriodDuration > var5.totalPeriodDuration) {
            var5 = var7;
            var3 = var1;
         }
      }
      ...
      for (RunInfo var10 : this.runs) {
         ...
         for (RecordInfo var12 : var10.records) {
            ...
            if (var12.isWeather && var12.weatherType == 1) {
               var6 = new String(new char[var7]).replace("\u0000", var3);
            } else if (var12.isWeather && var12.weatherType == 2) {
               var6 = new String(new char[var7]).replace("\u0000", var4);
            } else if (var12.isWeather && var12.weatherType == 3) {
               var6 = new String(new char[var7]).replace("\u0000", var5);
            } else if (var8 == 0 && !var12.isWeather && var7 >= 2) {
               var6 = new String(new char[var7 - 1]).replace("\u0000", var1);
            } else {
               var6 = new String(new char[var7]).replace("\u0000", var12.isWeather ? var2 : var1);
            }
