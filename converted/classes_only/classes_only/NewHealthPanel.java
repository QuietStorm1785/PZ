...
public final class NewHealthPanel extends NewWindow {
   ...
   public void render() {
      if (this.isVisible()) {
         ...
         double var3 = 0.15;
         double var5 = 1.0;
         this.DrawTextureScaledColor(null, 130.0, 25.0, 18.0, 1.0, var3, var3, var3, var5);
         this.DrawTextureScaledColor(null, 130.0, 25.0, 1.0, 172.0, var3, var3, var3, var5);
         this.DrawTextureScaledColor(null, 147.0, 25.0, 1.0, 172.0, var3, var3, var3, var5);
         if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
            Double var7 = -this.getXScroll();
            Double var8 = -this.getYScroll();
            this.DrawTextureScaledColor(null, var7, var8, 1.0, (double)this.height, 1.0, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, var7 + 1.0, var8, this.width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, var7 + this.width - 1.0, var8, 1.0, (double)this.height, 1.0, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, var7 + 1.0, var8 + this.height - 1.0, this.width - 2.0, 1.0, 1.0, 1.0, 1.0, 0.5);
         }
      }
   }
