...
public class RandomizedBuildingBase extends RandomizedWorldBase {
   ...
   public ArrayList<IsoZombie> addZombies(BuildingDef var1, int var2, String var3, Integer var4, RoomDef var5) {
   ...
   public void spawnItemsInContainers(BuildingDef var1, String var2, int var3) {
               ...
               if (var10 != null) {
                  for (int var11 = 0; var11 < var10.getObjects().size(); var11++) {
                     ...
                     if (Rand.Next(100) <= var3
                        && var12.getContainer() != null
                        && var10.getRoom() != null
                        && var10.getRoom().getName() != null
      ...
      for (int var13 = 0; var13 < var4.size(); var13++) {
         ...
         ItemPickerJava.fillContainerType(var5, var14, "", null);
   ...
   public void addBarricade(IsoGridSquare var1, int var2) {
      for (int var3 = 0; var3 < var1.getObjects().size(); var3++) {
         ...
         if (var4 instanceof IsoDoor) {
            ...
            IsoGridSquare var5 = var1.getRoom() == null ? var1 : ((IsoDoor)var4).getOppositeSquare();
         ...
         if (var4 instanceof IsoWindow && ((IsoWindow)var4).isBarricadeAllowed()) {
            IsoGridSquare var9 = var1.getRoom() == null ? var1 : ((IsoWindow)var4).getOppositeSquare();
            boolean var10 = var9 != var1;
            IsoBarricade var11 = IsoBarricade.AddBarricadeToObject((IsoWindow)var4, var10);
            if (var11 != null) {
               for (int var12 = 0; var12 < var2; var12++) {
                  var11.addPlank(null, null);
               }
   ...
   public boolean isTableFor3DItems(IsoObject var1, IsoGridSquare var2) {
      return var1.getSurfaceOffsetNoTable() > 0.0F
         && var1.getContainer() == null
         && var2.getProperties().Val("waterAmount") == null
         && !var1.hasWater()
         && var1.getProperties().Val("BedType") == null;
   }
}
