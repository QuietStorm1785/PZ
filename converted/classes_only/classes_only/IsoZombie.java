...
import zombie.WorldSoundManager.ResultBiggestSound;
...
import zombie.audio.parameters.ParameterVehicleHitLocation.HitLocation;
...
import zombie.characters.IsoZombie.Aggro;
import zombie.characters.IsoZombie.FloodFill;
import zombie.characters.IsoZombie.s_performance;
...
public final class IsoZombie extends IsoGameCharacter implements IHumanVisual {
   ...
   public BodyTexture atlasTex = null;
   ...
   private final Location delayedSound = new Location(-1, -1, -1);
   ...
   protected Descriptor sharedDesc;
   ...
   private void registerVariableCallbacks() {
            ...
            if (this.target == null) {
               ...
               if (this.target instanceof IsoPlayer && ((IsoPlayer)this.target).isGhostMode()) {
                  ...
                  if (var2 != null && var2.isSomethingTo(var1) && this.getThumpTarget() != null) {
                     ...
                     return !(var3 > 3.5F) || var3 <= 4.0F && this.target instanceof IsoGameCharacter && ((IsoGameCharacter)this.target).getVehicle() != null
      ...
      this.setVariable("turndirection", () -> {
         if (this.getPath2() != null) {
            ...
            if (this.dir == var3) {
               ...
               boolean var4 = CrawlingZombieTurnState.calculateDir(this, var3);
            ...
            if (this.dir == var1) {
               ...
               boolean var2 = CrawlingZombieTurnState.calculateDir(this, var1);
      ...
      this.setVariable("bPathFindPrediction", () -> PredictionTypes.PathFind.equals(this.networkAI.predictionType));
   ...
   public void setTurnAlertedValues(int var1, int var2) {
      Vector2 var3 = new Vector2(this.getX() - (var1 + 0.5F), this.getY() - (var2 + 0.5F));
      float var4 = var3.getDirectionNeg();
      if (var4 < 0.0F) {
         var4 = Math.abs(var4);
      } else {
         var4 = new Float((Math.PI * 2) - var4);
      }

      double var5 = new Double(Math.toDegrees(var4));
      ...
      try {
         if (this.aggroList[0] == null) {
            ...
            for (int var5 = 0; var5 < this.aggroList.length; var5++) {
               if (this.aggroList[var5] == null) {
                  this.aggroList[var5] = new Aggro(var1, var2);
                  return;
               }
            }
         }
   ...
   public void spotted(IsoMovingObject var1, boolean var2) {
      if (GameClient.bClient && this.isRemoteZombie()) {
         ...
         if (var1.getCurrentSquare() != null) {
            if (this.getCurrentSquare().getProperties().Is(IsoFlagType.smoke) || this.isUseless()) {
            ...
            } else if (!(var1 instanceof IsoPlayer) || !((IsoPlayer)var1).isGhostMode()) {
               ...
               if (var3 != null && !var3.isDead()) {
                  ...
                  if (var1.getCurrentSquare().getRoom() != this.getCurrentSquare().getRoom()) {
                     var4 = 50.0F;
                     if (var1.getCurrentSquare().getRoom() != null && this.getCurrentSquare().getRoom() == null
                        || var1.getCurrentSquare().getRoom() == null && this.getCurrentSquare().getRoom() != null) {
                        var4 = 20.0F;
                  ...
                  if (!(tempo.getLength() > var44)) {
                     ...
                     if (var4 > 0.0F
                        && this.target instanceof IsoPlayer var13
                        && !GameServer.bServer
                        && var13.RemoteID == -1
                     ...
                     if (var3 != null) {
                        ...
                        if (this.getCurrentSquare() != var1.getCurrentSquare() && var1 instanceof IsoPlayer && ((IsoPlayer)var1).isSneaking()) {
                           ...
                           if (var47 != null && var1 instanceof IsoGameCharacter) {
                              float var21 = ((IsoGameCharacter)var1).checkIsNearWall();
                              if (var21 == 1.0F && var49 != null) {
                        ...
                        if (!GameClient.bClient && !GameServer.bServer || NetworkZombieManager.canSpotted(this) || var1 == this.target) {
                           if (!var50) {
                              if (var4 > 20.0F && var1 instanceof IsoPlayer && var44 < 15.0F) {
   ...
   public void MoveUnmodded(Vector2 var1) {
      ...
      if (this.isRemoteZombie()) {
         ...
         if (var6 > 1.0F) {
            Vector2 var7 = new Vector2(this.realx - this.x, this.realy - this.y);
            var7.normalize();
   ...
   public boolean isPushedByForSeparate(IsoMovingObject var1) {
      if (var1 instanceof IsoZombie && ((IsoZombie)var1).getCurrentState() == ZombieHitReactionState.instance() && !((IsoZombie)var1).collideWhileHit) {
         ...
         return GameClient.bClient && var1 instanceof IsoZombie && !NetworkZombieSimulator.getInstance().isZombieSimulated(this.getOnlineID())
            ? false
   ...
   private void updateInternal() {
      ...
      if (var1 != null) {
         if (this.target == null && var1.hasLightbar() && var1.lightbarSirenMode.get() > 0) {
            ...
            if (var2 != null && var2.getSquare().DistTo(this) < 0.7F) {
                  ...
                  for (int var2 = -10; var2 < 10; var2++) {
                     ...
                     if (var3 != null) {
                        ...
                        if (var4 != null
                           ...
                           && !PolygonalMap2.instance.lineClearCollide(this.getX(), this.getY(), var4.x, var4.y, (int)this.getZ(), null, false, true)) {
                           tempBodies.add(var4);
                        }
                     }
                  }
         ...
         if (!var2) {
            ...
            if (var3 != null && this.current != null) {
               ...
               if (var7 != null && var7.canClimbThrough(this)) {
                  ...
                  return true;
               } else if (var6 != null && var6.getThumpableFor(this) != null
                  || var7 != null && var7.getThumpableFor(this) != null
                  || var5 != null && var5.getThumpableFor(this) != null) {
      ...
      if (!this.isReanimatedPlayer() && !this.wasFakeDead()) {
         if (!GameServer.bServer || var1) {
            ...
            if (var7 != null && var7.getDef() != null && var7.getDef().getKeyId() != -1 && Rand.Next(4) == 0) {
               if (Rand.Next(10) != 1) {
                  String var8 = "Base.Key" + (Rand.Next(5) + 1);
                  ...
                  String var5 = "Base.Key" + (Rand.Next(5) + 1);
   ...
   public void hitConsequences(HandWeapon var1, IsoGameCharacter var2, boolean var3, float var4, boolean var5) {
      if (!this.isOnlyJawStab() || this.isCloseKilled()) {
         ...
         if (!GameServer.bServer && !GameClient.bClient
            || GameClient.bClient && var2 instanceof IsoPlayer && ((IsoPlayer)var2).isLocalPlayer() && !this.isRemoteZombie()) {
   ...
   public void useDescriptor(Descriptor var1) {
   ...
   public Descriptor getSharedDescriptor() {
   ...
   public boolean shouldGetUpFromCrawl() {
      if (this.isCurrentState(ZombieGetUpFromCrawlState.instance())) {
         ...
         if (this.isCurrentState(WalkTowardState.instance())) {
            ...
            if (this.DistToSquared(var1, var2) > 0.010000001F && PolygonalMap2.instance.lineClearCollide(this.x, this.y, var1, var2, (int)this.z, null)) {
               return false;
            }
         }

         return this.isCurrentState(ZombieGetDownState.instance()) ? false : PolygonalMap2.instance.canStandAt(this.x, this.y, (int)this.z, null, false, true);
      }
   }
   ...
   public boolean shouldDoFenceLunge() {
      if (!SandboxOptions.instance.Lore.ZombiesFenceLunge.getValue()) {
         ...
         if (var1 == null || (int)var1.getZ() != (int)this.getZ()) {
            ...
            return var1.getVehicle() != null ? false : this.DistTo(var1) < 3.9;
         }
      }
   }
         ...
         try {
            ...
            if (var6 == null) {
               ...
               for (int var7 = 0; var7 < var13; var7++) {
                  ...
                  if (PersistentOutfits.instance.isHatFallen(this.getPersistentOutfitID())
                     && var8.getItem().getScriptItem() != null
