...
public class StaticAnimation {
   ...
   public void Create() {
      ...
      for (Matrix4f var7 = new Matrix4f(); var6 < var1; var6++) {
   ...
   public Keyframe interpolate(List<Keyframe> var1, float var2) {
      int var3 = 0;
      Keyframe var4 = null;
      Object var5 = null;
   ...
   public void interpolate(List<Keyframe> var1) {
      if (!var1.isEmpty()) {
   ...
   public void doRootMotion(List<Keyframe> var1) {
