...
public final class VirtualZombieManager {
   ...
   public void update() {
      ...
      if (!GameClient.bClient && !GameServer.bServer) {
         for (int var6 = 0; var6 < IsoWorld.instance.CurrentCell.getZombieList().size(); var6++) {
            ...
            if (!var9.KeepItReal && var9.getCurrentSquare() == null) {
   ...
   private IsoGridSquare pickEatingZombieSquare(float var1, float var2, float var3, float var4, int var5) {
      ...
      if (var6 == null || !this.canSpawnAt(var6.x, var6.y, var6.z) || var6.HasStairs()) {
         ...
         return PolygonalMap2.instance.lineClearCollide(var1, var2, var3, var4, var5, null, false, true) ? null : var6;
      }
   }
   ...
   private void addIndoorZombies(int var1, RoomDef var2, boolean var3) {
      ...
      for (int var12 = 0; var12 < var1; var12++) {
         if (!this.choices.isEmpty()) {
            ...
            if (var15 != null && var15.getSquare() != null) {
         ...
         if (var6 > 0) {
            ...
            if (!this.choices.isEmpty()) {
               ...
               for (int var18 = 0; var18 < var6; var18++) {
                  ...
                  if (var19 != null && var19.getSquare() != null) {
                     if (!GameServer.bServer) {
   ...
   private boolean isBlockedInAllDirections(int var1, int var2, int var3) {
      ...
      if (var4 == null) {
         ...
         boolean var5 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 1, 0, 1) && var4.nav[IsoDirections.N.index()] != null;
         boolean var6 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 1, 2, 1) && var4.nav[IsoDirections.S.index()] != null;
         boolean var7 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 0, 1, 1) && var4.nav[IsoDirections.W.index()] != null;
         boolean var8 = IsoGridSquare.getMatrixBit(var4.pathMatrix, 2, 1, 1) && var4.nav[IsoDirections.E.index()] != null;
