   ...
   private static void respawnInChunk(IsoChunk var0) {
      ...
      for (int var5 = 0; var5 < 10; var5++) {
         for (int var6 = 0; var6 < 10; var6++) {
            ...
            if (var8 != null
               && ("TownZone".equals(var8.getType()) || "TownZones".equals(var8.getType()) || "TrailerPark".equals(var8.getType()))
   ...
   private static void respawnInContainer(IsoObject var0, ItemContainer var1) {
      if (var1 != null && var1.getItems() != null) {
         ...
         if (var2 < var3) {
            ...
            ItemPickerJava.fillContainer(var1, null);
               ...
               if (GameServer.bServer) {
                  for (int var10 = 0; var10 < GameServer.udpEngine.connections.size(); var10++) {
                     ...
                     if (var11.RelevantTo(var0.square.x, var0.square.y)) {
                        ...
                        try {
                           CompressIdenticalItems.save(var7.bb, newItems, null);
