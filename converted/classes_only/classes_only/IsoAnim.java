...
import zombie.iso.sprite.IsoAnim.1;
...
public final class IsoAnim {
   ...
   boolean looped = true;
   public int ID = 0;
   private static final ThreadLocal<StringBuilder> tlsStrBuf = new 1();
   ...
   void LoadExtraFrame(String var1, String var2, int var3) {
      ...
      IsoDirectionFrame var7 = new IsoDirectionFrame(
         Texture.getSharedTexture(var4 + "8" + var5 + var6.toString() + ".png"),
         Texture.getSharedTexture(var4 + "9" + var5 + var6.toString() + ".png"),
         Texture.getSharedTexture(var4 + "6" + var5 + var6.toString() + ".png"),
         Texture.getSharedTexture(var4 + "3" + var5 + var6.toString() + ".png"),
         Texture.getSharedTexture(var4 + "2" + var5 + var6.toString() + ".png")
      );
   ...
   public void LoadFramesReverseAltName(String var1, String var2, String var3, int var4) {
      this.name = var3;
      StringBuilder var5 = tlsStrBuf.get();
      var5.setLength(0);
      var5.append(var1);
      var5.append("_%_");
      var5.append(var2);
      ...
      if (var22 != null) {
         for (int var9 = 0; var9 < var4; var9++) {
            ...
            if (var22 == null) {
               ...
               var5.setCharAt(var7, '9');
               String var26 = var5.toString();
               var5.setCharAt(var7, '6');
               String var27 = var5.toString();
               var5.setCharAt(var7, '3');
               String var28 = var5.toString();
               var5.setCharAt(var7, '2');
               String var29 = var5.toString();
               var11 = new IsoDirectionFrame(
            ...
            this.Frames.add(0, (IsoDirectionFrame)var11);
         }
   ...
   public void LoadFrames(String var1, String var2, int var3) {
      this.name = var2;
      StringBuilder var4 = tlsStrBuf.get();
      var4.setLength(0);
      var4.append(var1);
      var4.append("_%_");
      var4.append(var2);
      ...
      if (var22 != null) {
         for (int var8 = 0; var8 < var3; var8++) {
            ...
            this.Frames.add((IsoDirectionFrame)var10);
         }
   ...
   public void LoadFramesUseOtherFrame(String var1, String var2, String var3, String var4, int var5, String var6) {
      ...
      for (int var10 = 0; var10 < 1; var10++) {
         ...
         IsoDirectionFrame var12 = new IsoDirectionFrame(
            Texture.getSharedTexture(var7 + "8" + var8 + var11.toString() + var9 + ".png"),
            Texture.getSharedTexture(var7 + "9" + var8 + var11.toString() + var9 + ".png"),
            Texture.getSharedTexture(var7 + "6" + var8 + var11.toString() + var9 + ".png"),
            Texture.getSharedTexture(var7 + "3" + var8 + var11.toString() + var9 + ".png"),
            Texture.getSharedTexture(var7 + "2" + var8 + var11.toString() + var9 + ".png")
         );
   ...
   public void LoadFramesBits(String var1, String var2, String var3, int var4) {
      ...
      for (int var7 = 0; var7 < var4; var7++) {
         ...
         IsoDirectionFrame var9 = new IsoDirectionFrame(
            Texture.getSharedTexture(var5 + "8" + var6 + var8.toString() + ".png"),
            Texture.getSharedTexture(var5 + "9" + var6 + var8.toString() + ".png"),
            Texture.getSharedTexture(var5 + "6" + var6 + var8.toString() + ".png"),
            Texture.getSharedTexture(var5 + "3" + var6 + var8.toString() + ".png"),
            Texture.getSharedTexture(var5 + "2" + var6 + var8.toString() + ".png")
         );
   ...
   public void LoadFramesBits(String var1, String var2, int var3) {
      ...
      for (int var6 = 0; var6 < var3; var6++) {
         ...
         IsoDirectionFrame var8 = new IsoDirectionFrame(
            Texture.getSharedTexture(var4 + "8" + var5 + var7.toString() + ".png"),
            Texture.getSharedTexture(var4 + "9" + var5 + var7.toString() + ".png"),
            Texture.getSharedTexture(var4 + "6" + var5 + var7.toString() + ".png"),
            Texture.getSharedTexture(var4 + "3" + var5 + var7.toString() + ".png"),
            Texture.getSharedTexture(var4 + "2" + var5 + var7.toString() + ".png")
         );
   ...
   public void LoadFramesBitRepeatFrame(String var1, String var2, int var3) {
      ...
      IsoDirectionFrame var9 = new IsoDirectionFrame(
         Texture.getSharedTexture(var2 + "8" + var5 + var8.toString() + var6 + ".png"),
   ...
   public void LoadFramesBitRepeatFrame(String var1, String var2, String var3, int var4, String var5) {
      ...
      IsoDirectionFrame var11 = new IsoDirectionFrame(
         Texture.getSharedTexture(var6 + "8" + var7 + var10.toString() + var8 + ".png"),
         Texture.getSharedTexture(var6 + "9" + var7 + var10.toString() + var8 + ".png"),
         Texture.getSharedTexture(var6 + "6" + var7 + var10.toString() + var8 + ".png"),
         Texture.getSharedTexture(var6 + "3" + var7 + var10.toString() + var8 + ".png"),
         Texture.getSharedTexture(var6 + "2" + var7 + var10.toString() + var8 + ".png")
      );
   ...
   public void LoadFramesPcx(String var1, String var2, int var3) {
      ...
      for (int var6 = 0; var6 < var3; var6++) {
         Integer var7 = new Integer(var6);
         IsoDirectionFrame var8 = new IsoDirectionFrame(
            Texture.getSharedTexture(var4 + "8" + var5 + var7.toString() + ".pcx"),
            Texture.getSharedTexture(var4 + "9" + var5 + var7.toString() + ".pcx"),
            Texture.getSharedTexture(var4 + "6" + var5 + var7.toString() + ".pcx"),
            Texture.getSharedTexture(var4 + "3" + var5 + var7.toString() + ".pcx"),
            Texture.getSharedTexture(var4 + "2" + var5 + var7.toString() + ".pcx")
         );
         this.Frames.add(var8);
      }
   ...
   void LoadFramesPalette(String var1, String var2, int var3, String var4) {
      ...
      for (int var7 = 0; var7 < var3; var7++) {
         Integer var8 = new Integer(var7);
         IsoDirectionFrame var9 = new IsoDirectionFrame(
            Texture.getSharedTexture(var5 + "8" + var6 + var8.toString() + "_" + var4),
            Texture.getSharedTexture(var5 + "9" + var6 + var8.toString() + "_" + var4),
            Texture.getSharedTexture(var5 + "6" + var6 + var8.toString() + "_" + var4),
            Texture.getSharedTexture(var5 + "3" + var6 + var8.toString() + "_" + var4),
            Texture.getSharedTexture(var5 + "2" + var6 + var8.toString() + "_" + var4)
         );
         this.Frames.add(var9);
      }
