...
import zombie.iso.objects.IsoDoor.1;
...
public class IsoDoor extends IsoObject implements BarricadeAble, Thumpable {
   ...
   private void prerender(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, IsoDirections var7) {
      if (Core.TileScale == 1) {
         switch (1.$SwitchMap$zombie$iso$IsoDirections[var7.ordinal()]) {
            case 1:
               this.prerender1xN(var1, var2, var3, var4, var5, var6, null);
               break;
            case 2:
               this.prerender1xS(var1, var2, var3, var4, var5, var6, null);
               break;
            case 3:
               this.prerender1xW(var1, var2, var3, var4, var5, var6, null);
               break;
            case 4:
               this.prerender1xE(var1, var2, var3, var4, var5, var6, null);
         }
      } else {
         switch (1.$SwitchMap$zombie$iso$IsoDirections[var7.ordinal()]) {
            case 1:
               this.prerender2xN(var1, var2, var3, var4, var5, var6, null);
               break;
            case 2:
               this.prerender2xS(var1, var2, var3, var4, var5, var6, null);
               break;
            case 3:
               this.prerender2xW(var1, var2, var3, var4, var5, var6, null);
               break;
            case 4:
               this.prerender2xE(var1, var2, var3, var4, var5, var6, null);
         }
      }
   }
   ...
   private void postrender(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, IsoDirections var7) {
      if (Core.TileScale == 1) {
         switch (1.$SwitchMap$zombie$iso$IsoDirections[var7.ordinal()]) {
            case 1:
               this.postrender1xN(var1, var2, var3, var4, var5, var6, null);
               break;
            case 2:
               this.postrender1xS(var1, var2, var3, var4, var5, var6, null);
               break;
            case 3:
               this.postrender1xW(var1, var2, var3, var4, var5, var6, null);
               break;
            case 4:
               this.postrender1xE(var1, var2, var3, var4, var5, var6, null);
         }
      } else {
         switch (1.$SwitchMap$zombie$iso$IsoDirections[var7.ordinal()]) {
            case 1:
               this.postrender2xN(var1, var2, var3, var4, var5, var6, null);
               break;
            case 2:
               this.postrender2xS(var1, var2, var3, var4, var5, var6, null);
               break;
            case 3:
               this.postrender2xW(var1, var2, var3, var4, var5, var6, null);
               break;
            case 4:
               this.postrender2xE(var1, var2, var3, var4, var5, var6, null);
         }
      }
   }
      ...
      if (this.bCurtainInside) {
         if (!this.north && this.open) {
            (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
               .render(null, var1, var2 - 1.0F, var3, this.dir, this.offsetX + 3.0F, this.offsetY + (this.bCurtainOpen ? -14 : -14), var4, true);
         }
      } else if (this.north && !this.open) {
         (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(null, var1, var2 - 1.0F, var3, this.dir, this.offsetX - 1.0F - 1.0F, this.offsetY + -15.0F, var4, true);
      }
   }
      ...
      if (this.bCurtainInside) {
         if (this.north && !this.open) {
            (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
               .render(null, var1, var2, var3, this.dir, this.offsetX - 10.0F - 1.0F, this.offsetY + -10.0F, var4, true);
         }
      } else if (!this.north && this.open) {
         (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
            .render(null, var1, var2, var3, this.dir, this.offsetX - 4.0F, this.offsetY + (this.bCurtainOpen ? -10 : -10), var4, true);
      }
   }
      ...
      if (this.bCurtainInside) {
         ...
         if (!this.north && !this.open) {
            (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
               .render(null, var1, var2, var3, this.dir, this.offsetX - 2.0F - 1.0F, this.offsetY + -10.0F, var4, true);
         }
      } else {
         if (this.north && this.open) {
            (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
               .render(null, var1, var2, var3, this.dir, this.offsetX - 9.0F, this.offsetY + -10.0F, var4, true);
         }
   ...
   private void postrender1xE(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (this.bCurtainInside) {
         (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
            .render(null, var1 + 1.0F, var2, var3, this.dir, this.offsetX + (this.bCurtainOpen ? 0 : 0), this.offsetY + (this.bCurtainOpen ? 0 : 0), var4, true);
      }
   }
   ...
   private void prerender2xN(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      if (this.bCurtainInside) {
         if (!this.north && this.open) {
            (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
               .render(null, var1, var2 - 1.0F, var3, this.dir, this.offsetX + 7.0F, this.offsetY + (this.bCurtainOpen ? -28 : -28), var4, true);
         }
      } else if (this.north && !this.open) {
         (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(null, var1, var2 - 1.0F, var3, this.dir, this.offsetX - 3.0F, this.offsetY + (this.bCurtainOpen ? -30 : -30), var4, true);
      }
   }
   ...
   private void postrender2xN(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      if (this.bCurtainInside) {
         if (this.north && !this.open) {
            (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
               .render(null, var1, var2, var3, this.dir, this.offsetX - 20.0F, this.offsetY + (this.bCurtainOpen ? -20 : -20), var4, true);
         }
      } else if (!this.north && this.open) {
         (this.bCurtainOpen ? this.curtainNopen : this.curtainN)
            .render(null, var1, var2, var3, this.dir, this.offsetX - 8.0F, this.offsetY + (this.bCurtainOpen ? -20 : -20), var4, true);
      }
   }
   ...
   private void prerender2xS(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (!this.bCurtainInside) {
         (this.bCurtainOpen ? this.curtainSopen : this.curtainS)
            .render(
               null, var1, var2, var3, this.dir, this.offsetX + (this.bCurtainOpen ? -14 : -14), this.offsetY + (this.bCurtainOpen ? -16 : -16), var4, true
            );
      }
   }
   ...
   private void postrender2xW(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      if (this.bCurtainInside) {
         if (!this.north && !this.open) {
            (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
               .render(null, var1, var2, var3, this.dir, this.offsetX - 5.0F, this.offsetY + (this.bCurtainOpen ? -20 : -20), var4, true);
         }
      } else if (this.north && this.open) {
         (this.bCurtainOpen ? this.curtainWopen : this.curtainW)
            .render(null, var1, var2, var3, this.dir, this.offsetX - 19.0F, this.offsetY + (this.bCurtainOpen ? -20 : -20), var4, true);
      }
   }
   ...
   private void prerender2xE(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (!this.bCurtainInside) {
         (this.bCurtainOpen ? this.curtainEopen : this.curtainE)
            .render(
               null, var1, var2, var3, this.dir, this.offsetX + (this.bCurtainOpen ? -13 : -18), this.offsetY + (this.bCurtainOpen ? -15 : -18), var4, true
            );
      }
   }
      ...
      if (!this.isDestroyed()) {
         ...
         if (var1 instanceof IsoZombie) {
            if (((IsoZombie)var1).cognition == 1
               && !this.open
               && (!this.Locked || var1.getCurrentSquare() != null && !var1.getCurrentSquare().Is(IsoFlagType.exterior))) {
   ...
   public boolean isExterior() {
      ...
      if (var2 == null) {
         ...
         return var1.Is(IsoFlagType.exterior) && var2.getBuilding() != null && var2.getBuilding().getDef() != null
            ? true
            : var1.getBuilding() != null && var1.getBuilding().getDef() != null && var2.Is(IsoFlagType.exterior);
      }
   }
   ...
   public boolean canClimbOver(IsoGameCharacter var1) {
      if (this.square == null) {
         ...
         return !this.isHoppable() ? false : var1 == null || IsoWindow.canClimbThroughHelper(var1, this.getSquare(), this.getOppositeSquare(), this.north);
      }
   }
   ...
   public void ToggleDoorActual(IsoGameCharacter var1) {
      ...
      if (this.isBarricaded()) {
         ...
         if (var1 instanceof IsoPlayer && this.getSprite().getProperties().Is("GarageDoor")) {
            boolean var3 = this.getSprite().getProperties().Is("InteriorSide");
            if (var3) {
         ...
         if (GameClient.bClient && !var1) {
            ...
            if (GameServer.bServer) {
               for (UdpConnection var10 : GameServer.udpEngine.connections) {
                  if (var3 != null && var10.getConnectedGUID() != var3.getConnectedGUID() || var3 == null) {
   ...
   public static void toggleDoubleDoor(IsoObject var0, boolean var1) {
      ...
      if (var2 != -1) {
         ...
         if (var1) {
            if (var7 != null) {
               var7.syncIsoObject(false, (byte)(var6 ? 1 : 0), null, null);
            } else if (var10 != null) {
               var10.syncIsoObject(false, (byte)(var6 ? 1 : 0), null, null);
            }
         }
      }
   }
      ...
      if (var1 != -1) {
         ...
         if (var1 != 2 && var1 != 3) {
            ...
            if (var3 != null) {
               ...
               IsoDoor var20 = new IsoDoor(var9.getCell(), var9, var0.getSprite().getName(), var4);
               var20.open = !var5;
               var20.keyId = var6;
               var9.getObjects().add(var20);
               var9.getSpecialObjects().add(var20);
         ...
         if (var7 == null) {
            ...
            if (var4 != null) {
               for (int var18 = 0; var18 < var14.size(); var18++) {
                  ...
                  if (var19 instanceof IsoThumpable && ((IsoThumpable)var19).north == var5 && getDoubleDoorIndex(var19) == var1) {
                     return var19;
                  }
               }
            }
   ...
   private static boolean hasSomething4x4(int var0, int var1, int var2, int var3, int var4) {
      ...
      if (isSomethingTo(var5, var6)) {
         ...
         return isSomethingTo(var5, var7) ? true : isSomethingTo(var5, var8);
      }
   }
         ...
         if (var5 == null) {
            ...
            if (var3 != null) {
               for (int var12 = 0; var12 < var8.size(); var12++) {
                  ...
                  if (var13 instanceof IsoThumpable && ((IsoThumpable)var13).north == var4 && getGarageDoorIndex(var13) <= var1) {
                     return var13;
                  }
               }
            }
   ...
   private static void toggleGarageDoorObject(IsoObject var0) {
      ...
      if (var1 != -1) {
         ...
         var0.getSquare().RecalcAllWithNeighbours(true);
         var0.syncIsoObject(false, (byte)(var4 ? 0 : 1), null, null);
         PolygonalMap2.instance.squareChanged(var0.getSquare());
      }
   }
   ...
   private static boolean isGarageDoorObstructed(IsoObject var0) {
      ...
      if (var1 == -1) {
         ...
         if (!var5) {
            ...
            int var9 = var7;
            if (var4) {
               for (IsoObject var10 = getGarageDoorPrev(var0); var10 != null; var10 = getGarageDoorPrev(var10)) {
                  var6--;
               }

               for (IsoObject var11 = getGarageDoorNext(var0); var11 != null; var11 = getGarageDoorNext(var11)) {
                  var8++;
               }
            } else {
               for (IsoObject var22 = getGarageDoorPrev(var0); var22 != null; var22 = getGarageDoorPrev(var22)) {
                  var9++;
               }

               for (IsoObject var24 = getGarageDoorNext(var0); var24 != null; var24 = getGarageDoorNext(var24)) {
                  var7--;
               }
            }
