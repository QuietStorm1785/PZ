...
import zombie.ZomboidFileSystem.1;
import zombie.ZomboidFileSystem.IWalkFilesVisitor;
...
public final class ZomboidFileSystem {
   ...
   private final Map<String, Mod> modDirToMod = new HashMap<>();
   ...
   public void init() throws IOException {
      ...
      for (int var1 = 0; var1 < this.loadList.size(); var1++) {
         String var2 = this.getRelativeFile(this.loadList.get(var1));
   ...
   public File getCanonicalFile(File var1, String var2) {
      if (!var1.isDirectory()) {
         ...
         return var3 != null && var3.length != 0 ? var3[0] : new File(var1, var2);
      }
   }
   ...
   public synchronized String getString(String var1) {
      if (this.IgnoreActiveFileMap.get()) {
         ...
         String var3 = this.RelativeMap.get(var2);
         if (var3 != null) {
            var2 = var3;
         } else {
            String var6 = this.getRelativeFile(var1);
            var2 = var6.toLowerCase(Locale.ENGLISH);
            this.RelativeMap.put(var2, var2);
         }

         String var7 = this.ActiveFileMap.get(var2);
   ...
   public Mod searchForModInfo(File var1, String var2, ArrayList<Mod> var3) {
      if (var1.isDirectory()) {
   ...
   public void loadMod(String var1) {
      if (this.getModDir(var1) != null) {
         ...
         for (int var4 = 0; var4 < this.loadList.size(); var4++) {
            String var5 = this.getRelativeFile(var3, this.loadList.get(var4));
   ...
   private boolean isTranslationMod(String var1) {
      ...
      if (var2 == null) {
         ...
         for (int var6 = 0; var6 < this.loadList.size(); var6++) {
            String var7 = this.getRelativeFile(var5, this.loadList.get(var6));
   ...
   public String loadModsAux(ArrayList<String> var1, ArrayList<String> var2) {
      for (String var4 : var1) {
         String var5 = this.loadModAndRequired(var4, var2);
         if (var5 != null) {
            return var5;
         }
      }
   ...
   public Mod getModInfoForDir(String var1) {
      ...
      if (this.m_modsChangedTime > 0L) {
         ...
         if (var1.endsWith("/mods/default.txt")) {
            ...
            for (int var2 = 0; var2 < this.modFolders.size(); var2++) {
               String var3 = this.modFolders.get(var2).toLowerCase().replace('\\', '/');
   ...
   public void resetDefaultModsForNewRelease(String var1) {
      ...
      String var2 = this.getCacheDirSub("mods") + File.separator + "reset-mods-" + var1 + ".txt";
      File var3 = new File(var2);
      if (!var3.exists()) {
         try (
