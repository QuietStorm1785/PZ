   ...
   public static void render() {
      if (!UIManager.useUIFBO || Core.getInstance().UIRenderThisFrame) {
         ...
         if (popupFrameMS > 0L) {
            ...
            SpriteRenderer.instance.renderi(null, var4, var5, var2, var3, 0.8F, 0.0F, 0.0F, 1.0F, null);
            SpriteRenderer.instance.renderi(null, var4 + 1, var5 + 1, var2 - 2, var1 - 1, 0.0F, 0.0F, 0.0F, 1.0F, null);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, var4 + var2 / 2, var5, "ERROR", 1.0, 0.0, 0.0, 1.0);
            TextManager.instance
               .DrawStringCentre(UIFont.DebugConsole, var4 + var2 / 2, var5 + var1, var0 ? "999" : Integer.toString(exceptionCount), 0.0, 0.0, 0.0, 1.0);
