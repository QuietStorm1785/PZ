...
public class VorbisFile {
   ...
   int open_nonseekable() {
      ...
      int[] var1 = new int[1];
      if (this.fetch_headers(this.vi[0], this.vc[0], var1, null) == -1) {
         return -1;
      } else {
   ...
   void prefetch_all_headers(Info var1, Comment var2, int var3) throws JOrbisException {
      ...
      for (int var6 = 0; var6 < this.links; var6++) {
         if (var1 != null && var2 != null && var6 == 0) {
            ...
            if (this.fetch_headers(this.vi[var6], this.vc[var6], null, null) == -1) {
         ...
         if (this.decode_ready) {
            ...
            if (var4 > 0) {
               ...
               if (this.vb.synthesis(var3) == 0) {
                  ...
                  this.samptrack = this.samptrack + (this.vd.synthesis_pcmout(null, null) - var7);
