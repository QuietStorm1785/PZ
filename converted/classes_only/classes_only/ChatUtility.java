...
public final class ChatUtility {
   ...
   public static boolean playerWithinBounds(float var0, float var1, IsoObject var2, float var3) {
      return var2 == null ? false : var2.getX() > var0 - var3 && var2.getX() < var0 + var3 && var2.getY() > var1 - var3 && var2.getY() < var1 + var3;
   }

   public static float getDistance(IsoObject var0, IsoPlayer var1) {
      return var1 == null ? -1.0F : (float)Math.sqrt(Math.pow(var0.getX() - var1.x, 2.0) + Math.pow(var0.getY() - var1.y, 2.0));
   }

   public static float getDistance(float var0, float var1, IsoPlayer var2) {
      return var2 == null ? -1.0F : (float)Math.sqrt(Math.pow(var0 - var2.x, 2.0) + Math.pow(var1 - var2.y, 2.0));
   }
               ...
               if (!var2) {
                  ...
                  if (var8 != null) {
                     ...
                     if (var4 < 10 && (var7.equalsIgnoreCase("music") || allowedChatIconsFull.containsKey(var7.toLowerCase()))) {
                        ...
                        String var9 = var7.equalsIgnoreCase("music") ? "Icon_music_notes" : allowedChatIconsFull.get(var7.toLowerCase());
