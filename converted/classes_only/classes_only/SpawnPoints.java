...
public final class SpawnPoints {
   ...
   private final ArrayList<Location> SpawnPoints = new ArrayList<>();
   private final ArrayList<BuildingDef> SpawnBuildings = new ArrayList<>();
   private final Location m_tempLocation = new Location(-1, -1, -1);
      ...
      if (!GameServer.bServer) {
         ...
         if (var1.length == 3) {
            try {
               ...
               if (var2 != 0 || var3 != 0) {
                  this.SpawnPoints.add(new Location(var2, var3, var4));
                  return true;
               }
   ...
   private void parsePoint(KahluaTable var1) {
      ...
      if (var2 != null && var3 != null && var4 != null && var5 != null) {
         ...
         if (!this.SpawnPoints.contains(this.m_tempLocation)) {
            Location var7 = new Location(this.m_tempLocation.x, this.m_tempLocation.y, this.m_tempLocation.z);
