...
import zombie.core.skinnedmodel.animation.AnimationTrack.DeferredMotionData;
import zombie.core.skinnedmodel.animation.AnimationTrack.KeyframeSpan;
import zombie.core.skinnedmodel.animation.AnimationTrack.L_updateDeferredValues;
import zombie.core.skinnedmodel.animation.AnimationTrack.s_performance;
...
public final class AnimationTrack extends PooledObject {
   ...
   public float getDeferredTwistRotation(Quaternion var1) {
      if (this.m_deferredBoneAxis == BoneAxis.Z) {
         ...
         DebugLog.Animation.error("BoneAxis unhandled: %s", new Object[]{String.valueOf(this.m_deferredBoneAxis)});
         return 0.0F;
      }
   }
