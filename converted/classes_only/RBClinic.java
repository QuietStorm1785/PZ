...
public final class RBClinic extends RandomizedBuildingBase {
               ...
               if (var6 != null && this.roomValid(var6)) {
                  for (int var7 = 0; var7 < var6.getObjects().size(); var7++) {
                     ...
                     if (Rand.NextBool(2)
                        ...
                        && var8.getContainer() == null
                        && var6.getProperties().Val("waterAmount") == null
                        && !var8.hasWater()) {
   ...
   public boolean roomValid(IsoGridSquare var1) {
      return var1.getRoom() != null
         && ("hospitalroom".equals(var1.getRoom().getName()) || "clinic".equals(var1.getRoom().getName()) || "medical".equals(var1.getRoom().getName()));
   }
