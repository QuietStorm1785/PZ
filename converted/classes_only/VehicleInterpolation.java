...
public class VehicleInterpolation {
   ...
   private void interpolationDataCurrentAdd(BaseVehicle var1) {
      VehicleInterpolationData var2 = pool.isEmpty() ? new VehicleInterpolationData() : pool.pop();
   ...
   public void interpolationDataAdd(BaseVehicle var1, VehicleInterpolationData var2) {
      VehicleInterpolationData var3 = pool.isEmpty() ? new VehicleInterpolationData() : pool.pop();
      var3.copy(var2);
      if (this.buffer.isEmpty()) {
   ...
   public void interpolationDataAdd(ByteBuffer var1, long var2, float var4, float var5, float var6, long var7) {
      VehicleInterpolationData var9 = pool.isEmpty() ? new VehicleInterpolationData() : pool.pop();
      var9.time = var2;
      var9.x = var4;
      var9.y = var5;
      var9.z = var6;
