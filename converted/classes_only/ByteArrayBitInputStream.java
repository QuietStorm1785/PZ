...
public class ByteArrayBitInputStream implements BitInputStream {
      ...
      if (var1 > 32) {
         ...
         if (this.endian == 0) {
            ...
            if (var1 <= this.bitIndex + 1) {
               ...
               if (var1 > 0) {
                  int var8 = this.source[this.byteIndex] & 255;
                  var2 |= var8 >> 8 - var1 & (1 << var1) - 1;
   ...
   public int getInt(HuffmanNode var1) throws IOException {
      while (var1.value == null) {
         ...
         var1 = (this.currentByte & 1 << this.bitIndex++) != 0 ? var1.o1 : var1.o0;
      }
   ...
   public int readSignedRice(int var1) throws IOException {
      ...
      if (this.endian == 0) {
         ...
         if (var1 <= this.bitIndex + 1) {
            int var7 = this.source[this.byteIndex] & 255;
            int var8 = 1 + this.bitIndex - var1;
            int var9 = (1 << var1) - 1 << var8;
            var3 = (var7 & var9) >> var8;
            this.bitIndex -= var1;
         } else {
            var3 = (this.source[this.byteIndex] & 255 & (1 << this.bitIndex + 1) - 1) << var1 - this.bitIndex - 1;
            int var6 = var1 - (this.bitIndex + 1);
            this.byteIndex++;

            while (var6 >= 8) {
               var6 -= 8;
               var3 |= (this.source[this.byteIndex] & 255) << var6;
               this.byteIndex++;
            }

            if (var6 > 0) {
               int var12 = this.source[this.byteIndex] & 255;
               var3 |= var12 >> 8 - var6 & (1 << var6) - 1;
         ...
         var4 = var2 << var1 | var3;
         return (var4 & 1) == 1 ? -(var4 >> 1) - 1 : var4 >> 1;
      }
   }
   ...
   public void readSignedRice(int var1, int[] var2, int var3, int var4) throws IOException {
      if (this.endian == 0) {
         ...
         for (int var5 = var3; var5 < var3 + var4; var5++) {
            ...
            if (var1 <= this.bitIndex + 1) {
               int var14 = this.source[this.byteIndex] & 255;
               int var11 = 1 + this.bitIndex - var1;
               int var12 = (1 << var1) - 1 << var11;
               var7 = (var14 & var12) >> var11;
               this.bitIndex -= var1;
            } else {
               var7 = (this.source[this.byteIndex] & 255 & (1 << this.bitIndex + 1) - 1) << var1 - this.bitIndex - 1;
               int var9 = var1 - (this.bitIndex + 1);
               this.byteIndex++;

               while (var9 >= 8) {
                  var9 -= 8;
                  var7 |= (this.source[this.byteIndex] & 255) << var9;
                  this.byteIndex++;
               }

               if (var9 > 0) {
                  int var10 = this.source[this.byteIndex] & 255;
                  var7 |= var10 >> 8 - var9 & (1 << var9) - 1;
            ...
            int var15 = var6 << var1 | var7;
            var2[var5] = (var15 & 1) == 1 ? -(var15 >> 1) - 1 : var15 >> 1;
         }
      }
   }
