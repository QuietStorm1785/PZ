...
import zombie.core.skinnedmodel.population.Outfit.RandomData;
...
public class Outfit implements Cloneable {
   ...
   public void randomizeItem(String var1) {
      ClothingItemReference var2 = (ClothingItemReference)PZArrayUtil.find(this.m_items, var1x -> var1x.itemGUID.equals(var1));
      if (var2 != null) {
         var2.randomize();
      } else {
