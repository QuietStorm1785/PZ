...
import zombie.iso.IsoCell.SnowGridTiles;
...
class IsoCell$SnowGrid {
   ...
   public IsoCell$SnowGrid init(int var1) {
      if (!this.this$0.hasSetupSnowGrid) {
         ...
         byte var2 = 0;
         this.this$0.snowGridTiles_Square = new SnowGridTiles(this.this$0, var2++);
         byte var3 = 40;

         for (int var4 = 0; var4 < 4; var4++) {
            this.this$0.snowGridTiles_Square.add(Texture.getSharedTexture("e_newsnow_ground_1_" + (var3 + var4)));
         }

         this.this$0.snowGridTiles_Enclosed = new SnowGridTiles(this.this$0, var2++);
         var3 = 0;

         for (int var18 = 0; var18 < 4; var18++) {
            this.this$0.snowGridTiles_Enclosed.add(Texture.getSharedTexture("e_newsnow_ground_1_" + (var3 + var18)));
         }

         this.this$0.snowGridTiles_Cove = new SnowGridTiles[4];

         for (int var19 = 0; var19 < 4; var19++) {
            this.this$0.snowGridTiles_Cove[var19] = new SnowGridTiles(this.this$0, var2++);
            if (var19 == 0) {
               var3 = 7;
            }
            ...
            for (int var5 = 0; var5 < 3; var5++) {
               this.this$0.snowGridTiles_Cove[var19].add(Texture.getSharedTexture("e_newsnow_ground_1_" + (var3 + var5 * 4)));
            }
         }
         ...
         for (int var20 = 0; var20 < 4; var20++) {
            this.this$0.snowGridTiles_Edge[var20] = new SnowGridTiles(this.this$0, var2++);
            if (var20 == 0) {
               var3 = 16;
            }
            ...
            for (int var24 = 0; var24 < 3; var24++) {
               this.this$0.snowGridTiles_Edge[var20].add(Texture.getSharedTexture("e_newsnow_ground_1_" + (var3 + var24 * 4)));
            }
         }
         ...
         for (int var21 = 0; var21 < 4; var21++) {
            this.this$0.snowGridTiles_Strip[var21] = new SnowGridTiles(this.this$0, var2++);
            if (var21 == 0) {
               var3 = 28;
            }
            ...
            for (int var25 = 0; var25 < 3; var25++) {
               this.this$0.snowGridTiles_Strip[var21].add(Texture.getSharedTexture("e_newsnow_ground_1_" + (var3 + var25 * 4)));
            }
         }
      ...
      for (int var16 = 0; var16 < this.h; var16++) {
         for (int var22 = 0; var22 < this.w; var22++) {
            for (int var26 = 0; var26 < 2; var26++) {
               this.grid[var22][var16][var26] = null;
      ...
      for (int var8 = 0; var8 < this.h; var8++) {
         for (int var9 = 0; var9 < this.w; var9++) {
            ...
            if (var10 == null) {
               boolean var23 = this.check(var9, var8 - 1);
               boolean var27 = this.check(var9, var8 + 1);
   ...
   public boolean checkAny(int var1, int var2) {
      ...
      if (var1 < 0 || var1 >= this.w) {
         ...
         return var2 >= 0 && var2 < this.h ? this.grid[var1][var2][0] != null : false;
      }
   }
