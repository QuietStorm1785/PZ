...
import zombie.iso.objects.IsoMannequin.Drawer;
import zombie.iso.objects.IsoMannequin.MannequinZone;
import zombie.iso.objects.IsoMannequin.PerPlayer;
import zombie.iso.objects.IsoMannequin.StaticPerPlayer;
...
public class IsoMannequin extends IsoObject implements IHumanVisual {
   ...
   public boolean isItemAllowedInContainer(ItemContainer var1, InventoryItem var2) {
      return var2 instanceof Clothing && !StringUtils.isNullOrWhitespace(((Clothing)var2).getBodyLocation())
         ? true
         : var2 instanceof InventoryContainer && !StringUtils.isNullOrWhitespace(((InventoryContainer)var2).canBeEquipped());
   }
   ...
   private void renderShadow(float var1, float var2, float var3) {
      ...
      SpriteRenderer.instance
         .render(var4, var8, var9, (float)var4.getWidth() * Core.TileScale, (float)var4.getHeight() * Core.TileScale, 1.0F, 1.0F, 1.0F, var6, null);
   }
   ...
   private void syncModel() {
      ...
      String var1 = this.modelScriptName;
      switch (var1) {
         case "FemaleBody":
      ...
      if (this.bAnimate) {
         if (this.animatedModel == null) {
            ...
            for (int var4 = 0; var4 < this.drawers.length; var4++) {
               this.drawers[var4] = new Drawer(this);
            }
         }
