...
import zombie.network.NetChecksum.1;
...
public final class NetChecksum$Comparer {
      ...
      if (GameServer.bServer) {
         ...
         switch (var3) {
            case 1:
               ...
               boolean var19 = var13.equals(GameServer.checksum);
               boolean var21 = var15.equals(ScriptManager.instance.getChecksum());
            ...
            case 4:
               String var4 = GameWindow.ReadStringUTF(var1);
               if (DebugLog.isLogEnabled(LogSeverity.Debug, DebugType.Checksum)) {
                  LoggerManager.getLogger("checksum-" + var2.idStr).write(var4, null, true);
               }
               break;
            default:
