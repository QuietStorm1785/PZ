...
public final class AttackVehicleState extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (var2.target instanceof IsoGameCharacter var3) {
         if (var3.isDead()) {
   ...
   public void animEvent(IsoGameCharacter var1, AnimEvent var2) {
      ...
      if (var3.target instanceof IsoGameCharacter var4) {
         BaseVehicle var5 = var4.getVehicle();
         if (var5 != null) {
            if (!var4.isDead()) {
               if (var2.m_EventName.equalsIgnoreCase("AttackCollisionCheck")) {
                  var4.getBodyDamage().AddRandomDamageFromZombie(var3, null);
   ...
   public boolean isPassengerExposed(IsoGameCharacter var1) {
      if (!(var1 instanceof IsoZombie var2)) {
         return false;
      } else if (!(var2.target instanceof IsoGameCharacter var3)) {
         return false;
      } else {
         BaseVehicle var4 = var3.getVehicle();
         if (var4 == null) {
