...
public class RZSBuryingCamp extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(Zone var1) {
      ...
      ArrayList var11 = this.addZombiesOnSquare(1, null, null, this.getRandomFreeSquare(this, var1));
      if (var11 != null && !var11.isEmpty()) {
         IsoZombie var9 = (IsoZombie)var11.get(0);
         IsoDeadBody var10 = createRandomDeadBody(this.getSq(var5, var6, var1.z), null, Rand.Next(7, 12), 0, null);
         if (var10 != null) {
