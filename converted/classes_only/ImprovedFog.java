...
import zombie.iso.weather.fog.ImprovedFog.FogRectangle;
import zombie.iso.weather.fog.ImprovedFog.RectangleIterator;
...
public class ImprovedFog {
   ...
   public static void DrawSubTextureRGBA(
      ...
      if (var0 != null && !(var5 <= 0.0) && !(var7 <= 0.0) && !(var13 <= 0.0) && !(var15 <= 0.0)) {
