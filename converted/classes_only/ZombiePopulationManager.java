...
import zombie.gameStates.ChooseGameInfo.SpawnOrigin;
...
public final class ZombiePopulationManager {
   ...
   public void init(IsoMetaGrid var1) {
      ...
      if (!this.bClient) {
         ...
         String[] var2 = PersistentOutfits.instance.getOutfitNames().toArray(new String[0]);
   ...
   public void registerSpawnOrigin(int var1, int var2, int var3, int var4, KahluaTable var5) {
      if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var4 >= 0) {
         this.spawnOrigins.add(new SpawnOrigin(var1, var2, var3, var4));
      }
   }
                  ...
                  for (int var4 = 0; var4 < 10; var4++) {
                     ...
                     if (var5 != null && !var5.getMovingObjects().isEmpty()) {
                        for (int var6 = 0; var6 < var5.getMovingObjects().size(); var6++) {
                           ...
                           if (var7 instanceof IsoZombie var8 && (!GameServer.bServer || !var8.bIndoorZombie) && !var8.isReanimatedPlayer()) {
   ...
   public void addWorldSound(WorldSound var1, boolean var2) {
      if (!this.bClient) {
         if (var1.radius >= 50) {
   ...
   private void addZombieStanding(float var1, float var2, float var3, IsoDirections var4, int var5, int var6) {
      ...
      if (var7 != null && (var7.SolidFloorCached ? var7.SolidFloor : var7.TreatAsSolidFloor())) {
      ...
      for (int var5 = -var4; var5 < var4; var5++) {
         for (int var6 = -var4; var6 < var4; var6++) {
            ...
            if (var7 != null && var7.isFree(true) && var7.getBuilding() == null) {
               ...
               if (var8 != 0 && !PolygonalMap2.instance.lineClearCollide(var1, var2, var7.x + 0.5F, var7.y + 0.5F, var7.z, null, false, true)) {
                  return var7;
               }
            }
         }
   ...
   private void addZombieMoving(float var1, float var2, float var3, IsoDirections var4, int var5, int var6, int var7, int var8) {
      ...
      if (var9 != null && (var9.SolidFloorCached ? var9.SolidFloor : var9.TreatAsSolidFloor())) {
