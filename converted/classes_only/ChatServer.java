...
public class ChatServer {
   ...
   public void initPlayer(short var1) {
      ...
      if (var3 != null && var11 != null) {
         ...
         logger.write((var3 == null ? "connection = null " : "") + (var11 == null ? "player = null" : ""), "error");
      }
   }
   ...
   public void processPlayerStartWhisperChatPacket(ByteBuffer var1) {
      ...
      if (!ChatUtility.chatStreamEnabled(ChatType.whisper)) {
         ...
         if (var4 == null) {
            ...
            WhisperChat var6 = new WhisperChat(this.getNextChatID(), tabs.get("main"), var2, var3);
   ...
   private void sendPlayerNotFoundMessage(UdpConnection var1, String var2) {
   ...
   public FactionChat createFactionChat(String var1) {
      ...
      if (factionChats.containsKey(var1)) {
         ...
         FactionChat var2 = new FactionChat(this.getNextChatID(), tabs.get("main"));
   ...
   public SafehouseChat createSafehouseChat(String var1) {
      ...
      if (safehouseChats.containsKey(var1)) {
         ...
         SafehouseChat var2 = new SafehouseChat(this.getNextChatID(), tabs.get("main"));
         chats.put(var2.getID(), var2);
   ...
   public void syncFactionChatMembers(String var1, String var2, ArrayList<String> var3) {
   ...
   public void syncSafehouseChatMembers(String var1, String var2, ArrayList<String> var3) {
