   ...
   public void randomizeBuilding(BuildingDef var1) {
      ...
      if (var2 != null) {
         ...
         for (int var8 = 0; var8 < var7; var8++) {
            this.addZombiesOnSquare(1, "Bandit", null, var2.getFreeSquare());
         }

         this.addZombiesOnSquare(2, "Police", null, var2.getFreeSquare());
         int var9 = Rand.Next(3, 8);

         for (int var5 = 0; var5 < var9; var5++) {
            IsoGridSquare var6 = getRandomSquareForCorpse(var2);
            createRandomDeadBody(var6, null, Rand.Next(5, 10), 5, null);
         }
      }
   }
