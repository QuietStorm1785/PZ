...
public final class PropertyContainer {
   ...
   public ArrayList<IsoFlagType> getFlagsList() {
      ...
      for (int var3 = 0; var3 < 64; var3++) {
         if ((this.SpriteFlags2 & 1L << var3) != 0L) {
            var1.add(IsoFlagType.fromIndex(64 + var3));
         }
      }
   ...
   public ArrayList<String> getPropertyNames() {
      ...
      var2.forEach(var1x -> {
         var1.add(((TileProperty)TilePropertyAliasMap.instance.Properties.get(var1x)).propertyName);
         return true;
      });
   ...
   private void initSurface() {
      if ((this.SurfaceFlags & 1) == 0) {
         ...
         this.Properties.forEachEntry((var1, var2) -> {
            ...
            } else if ("ItemHeight".equals(var4)) {
               try {
