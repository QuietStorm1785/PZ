...
class NonBlockingIdentityHashMap$SnapshotK implements Iterator<TypeK>, Enumeration<TypeK> {
   final NonBlockingIdentityHashMap<TypeK, TypeV>.SnapshotV _ss;

   public NonBlockingIdentityHashMap$SnapshotK(NonBlockingIdentityHashMap var1) {
      this.this$0 = var1;
