...
public final class ZombieThumpManager extends BaseZombieSoundManager {
   ...
   public void playSound(IsoZombie var1) {
      long var2 = 0L;
      if (var1.thumpFlag == 1) {
         var2 = var1.getEmitter().playSoundImpl("ZombieThumpGeneric", null);
      } else if (var1.thumpFlag == 2) {
         var1.getEmitter().playSoundImpl("ZombieThumpGeneric", null);
         var2 = var1.getEmitter().playSoundImpl("ZombieThumpWindow", null);
      } else if (var1.thumpFlag == 3) {
         var2 = var1.getEmitter().playSoundImpl("ZombieThumpWindow", null);
      } else if (var1.thumpFlag == 4) {
         var2 = var1.getEmitter().playSoundImpl("ZombieThumpMetal", null);
      } else if (var1.thumpFlag == 5) {
         var2 = var1.getEmitter().playSoundImpl("ZombieThumpGarageDoor", null);
      }
