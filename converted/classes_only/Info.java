...
public class Info {
   ...
   public void clear() {
      ...
      for (int var6 = 0; var6 < this.books; var6++) {
         if (this.book_param[var6] != null) {
            this.book_param[var6].clear();
            this.book_param[var6] = null;
         }
      }
   ...
   int unpack_books(Buffer var1) {
      ...
      for (int var5 = 0; var5 < this.residues; var5++) {
         ...
         if (this.residue_param[var5] == null) {
            this.clear();
            return -1;
         }
      }
      ...
      for (int var7 = 0; var7 < this.modes; var7++) {
         this.mode_param[var7] = new InfoMode();
