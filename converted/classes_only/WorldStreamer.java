...
import zombie.iso.WorldStreamer.ChunkComparator;
import zombie.iso.WorldStreamer.ChunkRequest;
...
public final class WorldStreamer {
   ...
   private void sendRequests() throws IOException {
      if (!this.chunkRequests1.isEmpty()) {
         if (!this.requestingLargeArea || this.pendingRequests1.size() <= 20) {
            ...
            ChunkRequest var3 = null;
            ChunkRequest var4 = null;
   ...
   public void updateMain() {
      ...
      for (ChunkRequest var2 = this.waitingToSendQ.poll(); var2 != null; var2 = this.waitingToSendQ.poll()) {
         while (var2 != null) {
      ...
      if (!this.tempRequests.isEmpty()) {
         ...
         for (int var10 = 0; var10 < this.tempRequests.size(); var10++) {
            ...
            this.sentRequests.add(var12);
         }
      }

      this.tempRequests.clear();

      for (ChunkRequest var7 = this.waitingToCancelQ.poll(); var7 != null; var7 = this.waitingToCancelQ.poll()) {
         this.tempRequests.add(var7);
      }
   ...
   private void threadLoop() throws DataFormatException, InterruptedException, IOException {
      if (GameClient.bClient && !SystemDisabler.doWorldSyncEnable) {
         ...
         for (IsoChunk var1 = this.chunkRequests0.poll(); var1 != null; var1 = this.chunkRequests0.poll()) {
            while (var1 != null) {
      ...
      for (IsoChunk var3 = this.jobQueue.poll(); var3 != null; var3 = this.jobQueue.poll()) {
      ...
      if (this.jobList.isEmpty()) {
         ...
         for (int var4 = this.jobList.size() - 1; var4 >= 0; var4--) {
            ...
            if (var6.refs.isEmpty()) {
               ...
               IsoChunkMap.chunkStore.add(var6);
            }
         }

         boolean var5 = !this.jobList.isEmpty();
         IsoChunk var7 = null;
         if (var5) {
            comp.init();
         ...
         if (var7 != null) {
            if (var7.refs.isEmpty()) {
               ...
               IsoChunkMap.chunkStore.add(var7);
            } else {
               this.DoChunk(var7, null);
            }
         }
   ...
   public void receiveChunkPart(ByteBuffer var1) {
      for (ChunkRequest var2 = this.sentRequests.poll(); var2 != null; var2 = this.sentRequests.poll()) {
   ...
   private void compare(ChunkRequest var1, ByteBuffer var2, File var3) throws IOException {
   ...
   private void compareSquares(IsoGridSquare var1, IsoGridSquare var2) {
      if (var1 != null && var2 != null) {
         try {
            this.bb1.clear();
            var1.save(this.bb1, null);
            this.bb1.flip();
            this.bb2.clear();
            var2.save(this.bb2, null);
            this.bb2.flip();
            if (this.bb1.compareTo(this.bb2) != 0) {
               ...
               if (var1.getObjects().size() == var2.getObjects().size()) {
                  for (int var10 = 0; var10 < var1.getObjects().size(); var10++) {
                     ...
                     this.bb2.flip();
                     if (this.bb1.compareTo(this.bb2) != 0) {
                        DebugLog.log("  1: " + var6.getClass().getName() + " " + var6.getName() + " " + (var6.sprite == null ? "no sprite" : var6.sprite.name));
                        DebugLog.log("  2: " + var7.getClass().getName() + " " + var7.getName() + " " + (var7.sprite == null ? "no sprite" : var7.sprite.name));
                     }
                  }
               } else {
                  for (int var11 = 0; var11 < var1.getObjects().size(); var11++) {
                     IsoObject var12 = (IsoObject)var1.getObjects().get(var11);
                     DebugLog.log("  " + var12.getClass().getName() + " " + var12.getName() + " " + (var12.sprite == null ? "no sprite" : var12.sprite.name));
                  }
               }
            }
