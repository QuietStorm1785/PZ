...
public final class SurvivorDesc implements IHumanVisual {
   ...
   private final HashMap<Perk, Integer> xpBoostMap = new HashMap<>();
   ...
   private final ArrayList<Observation> Observations = new ArrayList<>(0);
   private SurvivorType type = SurvivorType.Neutral;
   ...
   public void setProfessionSkills(Profession var1) {
   ...
   public boolean hasObservation(String var1) {
      for (int var2 = 0; var2 < this.Observations.size(); var2++) {
         if (var1.equals(this.Observations.get(var2).getTraitID())) {
            return true;
         }
      }
   ...
   public void save(ByteBuffer var1) throws IOException {
      ...
      if (!this.extra.isEmpty()) {
         ...
         for (int var2 = 0; var2 < this.extra.size(); var2++) {
            String var3 = this.extra.get(var2);
   ...
   public boolean isAggressive() {
      for (Observation var2 : this.Observations) {
         if ("Aggressive".equals(var2.getTraitID())) {
            return true;
         }
      }
   ...
   public boolean isFriendly() {
      for (Observation var2 : this.Observations) {
         if ("Friendly".equals(var2.getTraitID())) {
            return true;
         }
      }
   ...
   public void setType(SurvivorType var1) {
      this.type = var1;
   }
