   ...
   public void spawnElement(VehicleStorySpawner var1, Element var2) {
      ...
      if (var3 != null) {
         ...
         switch (var7) {
            case "corpse":
               if (var6 != null) {
                  createRandomDeadBody(var2.position.x, var2.position.y, var2.z, var2.direction, false, 35, 30, null);
                  this.addTrailOfBlood(var2.position.x, var2.position.y, var2.z, var2.direction, 15);
               }
               break;
            case "vehicle1":
               var6 = this.addVehicle(var5, var2.position.x, var2.position.y, var4, var2.direction, "bad", null, null, null);
               if (var6 != null) {
