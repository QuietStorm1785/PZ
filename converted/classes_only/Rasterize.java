...
import zombie.worldMap.Rasterize.Edge;
...
public final class Rasterize {
   ...
   void scanLine(int var1, int var2, int var3, BiConsumer<Integer, Integer> var4) {
      for (int var5 = var1; var5 < var2; var5++) {
         var4.accept(var5, var3);
      }
   }

   void scanSpan(Edge var1, Edge var2, int var3, int var4, BiConsumer<Integer, Integer> var5) {
