...
public class IsoGenerator extends IsoObject {
                     ...
                     if (var13 != null) {
                        ...
                        for (int var15 = 0; var15 < var13.getObjects().size(); var15++) {
                           ...
                           if (var16 != null && !(var16 instanceof IsoWorldInventoryObject)) {
                              ...
                              if (var16 instanceof IsoStackedWasherDryer var17) {
                                 float var18 = 0.0F;
                              ...
                              boolean var22 = var16.getContainerByType("fridge") != null;
                              boolean var23 = var16.getContainerByType("freezer") != null;
                              if (var22 && var23) {
   ...
   private void addPoweredItem(IsoObject var1, float var2) {
      ...
      for (String var7 : this.itemsPowered.keySet()) {
         if (var7.startsWith(var3)) {
            var9 = Integer.parseInt(var7.replaceAll("[\\D]", ""));
            var9++;
      ...
      this.itemsPowered.put(var3 + " x" + var9, String.format(" (%.2f L/h)", var2 * var9));
      if (var9 == 1) {
   ...
   public ArrayList<String> getItemsPowered() {
      ...
      for (String var3 : this.itemsPowered.keySet()) {
         var1.add(var3 + this.itemsPowered.get(var3));
      }
