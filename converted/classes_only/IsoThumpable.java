...
import zombie.iso.objects.IsoThumpable.1;
...
public class IsoThumpable extends IsoObject implements BarricadeAble, Thumpable {
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      BitHeaderRead var4 = BitHeader.allocRead(HeaderSize.Long, var1);
      this.OutlineOnMouseover = true;
      this.PushedMaxStrength = this.PushedStrength = 2500;
      if (!var4.equals(0)) {
   ...
   public void save(ByteBuffer var1, boolean var2) throws IOException {
      ...
      BitHeaderWrite var3 = BitHeader.allocWrite(HeaderSize.Long, var1);
      if (this.open) {
         var3.addFlags(1);
      }
   ...
   public void ToggleDoorActual(IsoGameCharacter var1) {
      if (this.isBarricaded()) {
         ...
         && var1.getInventory().haveThisKeyId(this.getKeyId()) == null) {
         ...
         if (!GameServer.bServer) {
            ...
            if (this.lightSource != null && this.lightSource.isActive()) {
               ...
               if (var7 != this.lightSource.x || var9 != this.lightSource.y) {
                  ...
                  this.setLightSource(new IsoLightSource(var7, var9, (int)this.getZ() + var5, 1.0F, 1.0F, 1.0F, this.lightSourceRadius, var11 > 0 ? var11 : -1));
                  this.lightSource.setActive(this.isLightSourceOn());
                  IsoWorld.instance.getCell().getLamppostPositions().add(this.getLightSource());
               }
            }
   ...
   public boolean isLockedToCharacter(IsoGameCharacter var1) {
      if (GameClient.bClient && var1 instanceof IsoPlayer && !((IsoPlayer)var1).accessLevel.equals("")) {
         ...
         return this.getLockedByCode() > 0
            ? true
            : this.isLockedByPadlock() && (var1.getInventory() == null || var1.getInventory().haveThisKeyId(this.getKeyId()) == null);
      }
   }
   ...
   public boolean canClimbThrough(IsoGameCharacter var1) {
      if (this.square == null) {
         ...
         return this.isBarricaded() ? false : var1 == null || IsoWindow.canClimbThroughHelper(var1, this.getSquare(), this.getOppositeSquare(), this.north);
      }
   }
