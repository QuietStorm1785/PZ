...
public LuaCallFrame::LuaCallFrame(Coroutine arg0) {
...
void LuaCallFrame::setup(LuaClosure luaClosure, JavaFunction javaFunctionx, int int0, int int1, int int2, bool boolean0, bool boolean1) {
