...
public LuaJavaClassExposer::LuaJavaClassExposer(KahluaConverterManager kahluaConverterManager, Platform platformx, KahluaTable table) {
 // TODO: Implement LuaJavaClassExposer
 return nullptr;
}

public LuaJavaClassExposer::LuaJavaClassExposer(KahluaConverterManager kahluaConverterManager, Platform platformx, KahluaTable table0, KahluaTable table1) {
 // TODO: Implement LuaJavaClassExposer
 return nullptr;
}
...
void LuaJavaClassExposer::exposeGlobalObjectFunction(KahluaTable table, void* object, Method method) {
 // TODO: Implement exposeGlobalObjectFunction
}

void LuaJavaClassExposer::exposeGlobalObjectFunction(KahluaTable table, void* object, Method method, const std::string& string) {
 // TODO: Implement exposeGlobalObjectFunction
}
...
void LuaJavaClassExposer::addInvoker(KahluaTable table, const std::string& string, LuaJavaInvoker luaJavaInvoker) {
...
KahluaTable LuaJavaClassExposer::createTableStructure(KahluaTable table, String[] strings) {
...
void LuaJavaClassExposer::exposeLikeJavaRecursively(Type type, KahluaTable table) {
 // TODO: Implement exposeLikeJavaRecursively
}

void LuaJavaClassExposer::exposeLikeJava(KahluaTable table, Set<Type> set, Type type) {
 // TODO: Implement exposeLikeJava
}

void LuaJavaClassExposer::exposeList(KahluaTable table, Set<Type> set, Type[] types) {
