...
BaseVehicle RandomizedWorldBase::addVehicle(IsoMetaGrid.Zone zone, IsoGridSquare sq, IsoChunk chunk, const std::string& zoneName, const std::string& scriptName, IsoDirections dir) {
...
IsoDeadBody RandomizedWorldBase::createRandomDeadBody(int x, int y, int z, IsoDirections dir, int blood) {
 // TODO: Implement createRandomDeadBody
 return nullptr;
}
...
IsoDeadBody RandomizedWorldBase::createRandomDeadBody(int x, int y, int z, IsoDirections dir, int blood, int crawlerChance) {
 // TODO: Implement createRandomDeadBody
 return nullptr;
}
...
IsoDeadBody RandomizedWorldBase::createRandomDeadBody(IsoGridSquare sq, IsoDirections dir, int blood, int crawlerChance, const std::string& outfit) {
 // TODO: Implement createRandomDeadBody
 return nullptr;
}

void RandomizedWorldBase::addTraitOfBlood(IsoDirections dir, int time, int x, int y, int z) {
...
void RandomizedWorldBase::addTrailOfBlood(float x, float y, float z, float direction, int count) {
...
void RandomizedWorldBase::setAttachedItem(IsoZombie zombie, const std::string& location, const std::string& item, const std::string& ensureItem) {
...
IsoGameCharacter RandomizedWorldBase::createRandomZombieForCorpse(RoomDef room) {
...
bool RandomizedWorldBase::isSquareClear(IsoGridSquare square1, IsoDirections directions) {
 // TODO: Implement isSquareClear
 return false;
}
...
void RandomizedWorldBase::alignCorpseToSquare(IsoGameCharacter chr, IsoGridSquare square) {
...
RoomDef RandomizedWorldBase::getRoom(BuildingDef bDef, const std::string& roomName) {
...
BaseVehicle RandomizedWorldBase::spawnCarOnNearestNav(const std::string& carName, BuildingDef def) {
 // TODO: Implement spawnCarOnNearestNav
 return nullptr;
}

BaseVehicle RandomizedWorldBase::spawnCar(const std::string& string, IsoGridSquare square) {
 // TODO: Implement spawnCar
 return nullptr;
}

InventoryItem RandomizedWorldBase::addItemOnGround(IsoGridSquare square, const std::string& type) {
 // TODO: Implement addItemOnGround
 return nullptr;
}

InventoryItem RandomizedWorldBase::addItemOnGround(IsoGridSquare square, InventoryItem item) {
 // TODO: Implement addItemOnGround
 return nullptr;
}

void RandomizedWorldBase::addRandomItemsOnGround(RoomDef room, const std::string& type, int count) {
 // TODO: Implement addRandomItemsOnGround
}

void RandomizedWorldBase::addRandomItemsOnGround(RoomDef room, ArrayList<String> types, int count) {
 // TODO: Implement addRandomItemsOnGround
}

InventoryItem RandomizedWorldBase::addRandomItemOnGround(IsoGridSquare square, ArrayList<String> types) {
 // TODO: Implement addRandomItemOnGround
 return nullptr;
}

HandWeapon RandomizedWorldBase::addWeapon(const std::string& type, bool addRandomBullets) {
...
IsoObject RandomizedWorldBase::addTileObject(int x, int y, int z, const std::string& spriteName) {
 // TODO: Implement addTileObject
 return nullptr;
}

IsoObject RandomizedWorldBase::addTileObject(IsoGridSquare sq, const std::string& spriteName) {
 // TODO: Implement addTileObject
 return nullptr;
}
...
BaseVehicle RandomizedWorldBase::addTrailer(BaseVehicle v, IsoMetaGrid.Zone zone, IsoChunk chunk, const std::string& zoneName, const std::string& vehicleDistrib, const std::string& trailerName) {
