...
HandWeapon RandomizedBuildingBase::addRandomRangedWeapon(ItemContainer container, bool addBulletsInGun, bool addBoxInContainer, bool attachPart) {
 // TODO: Implement addRandomRangedWeapon
 return nullptr;
}

void RandomizedBuildingBase::spawnItemsInContainers(BuildingDef def, const std::string& distribName, int _chance) {
...
InventoryItem RandomizedBuildingBase::addWorldItem(const std::string& item, IsoGridSquare sq, float xoffset, float yoffset, float zoffset) {
 // TODO: Implement addWorldItem
 return nullptr;
}

InventoryItem RandomizedBuildingBase::addWorldItem(const std::string& item, IsoGridSquare sq, float xoffset, float yoffset, float zoffset, int worldZ) {
 // TODO: Implement addWorldItem
 return nullptr;
}

InventoryItem RandomizedBuildingBase::addWorldItem(const std::string& item, IsoGridSquare sq, IsoObject obj) {
 // TODO: Implement addWorldItem
 return nullptr;
}

bool RandomizedBuildingBase::isTableFor3DItems(IsoObject obj, IsoGridSquare sq) {
 // TODO: Implement isTableFor3DItems
 return false;
}

public RandomizedBuildingBase::HumanCorpse(IsoCell cell, float float0, float float1, float float2) {
