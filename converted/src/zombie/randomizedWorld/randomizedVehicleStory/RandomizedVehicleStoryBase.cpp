...
void RandomizedVehicleStoryBase::initAllRVSMapChance(IsoMetaGrid.Zone zone, IsoChunk chunk) {
 // TODO: Implement initAllRVSMapChance
}

bool RandomizedVehicleStoryBase::doRandomStory(IsoMetaGrid.Zone zone, IsoChunk chunk, bool force) {
...
void RandomizedVehicleStoryBase::randomizeVehicleStory(IsoMetaGrid.Zone zone, IsoChunk chunk) {
 // TODO: Implement randomizeVehicleStory
}

IsoGridSquare RandomizedVehicleStoryBase::getCenterOfChunk(IsoMetaGrid.Zone zone, IsoChunk chunk) {
 // TODO: Implement getCenterOfChunk
 return nullptr;
}

bool RandomizedVehicleStoryBase::isValid(IsoMetaGrid.Zone zone, IsoChunk chunk, bool force) {
 // TODO: Implement isValid
 return false;
}

VehicleStorySpawnData RandomizedVehicleStoryBase::initSpawnDataForChunk(IsoMetaGrid.Zone zone, IsoChunk chunk) {
 // TODO: Implement initSpawnDataForChunk
 return nullptr;
}

bool RandomizedVehicleStoryBase::getSpawnPoint(IsoMetaGrid.Zone zone, IsoChunk chunk, float[] floats) {
 // TODO: Implement getSpawnPoint
 return false;
}

bool RandomizedVehicleStoryBase::getRectangleSpawnPoint(IsoMetaGrid.Zone zone, IsoChunk chunk, float[] floats) {
 // TODO: Implement getRectangleSpawnPoint
 return false;
}

bool RandomizedVehicleStoryBase::getPolylineSpawnPoint(IsoMetaGrid.Zone zone, IsoChunk chunk, float[] floats) {
 // TODO: Implement getPolylineSpawnPoint
 return false;
}

bool RandomizedVehicleStoryBase::isFullyStreamedIn(int x1, int y1, int x2, int y2) {
...
bool RandomizedVehicleStoryBase::initVehicleStorySpawner(IsoMetaGrid.Zone zone, IsoChunk chunk, bool debug) {
 // TODO: Implement initVehicleStorySpawner
 return false;
}

bool RandomizedVehicleStoryBase::callVehicleStorySpawner(IsoMetaGrid.Zone zone, IsoChunk chunk, float additionalRotationRadians) {
 // TODO: Implement callVehicleStorySpawner
 return false;
}

void RandomizedVehicleStoryBase::spawnElement(VehicleStorySpawner spawner, VehicleStorySpawner.Element element) {
