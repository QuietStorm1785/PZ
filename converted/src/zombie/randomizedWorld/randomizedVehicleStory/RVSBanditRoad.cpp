...
void RVSBanditRoad::randomizeVehicleStory(IsoMetaGrid.Zone zone,
                                          IsoChunk chunk) {
  // TODO: Implement randomizeVehicleStory
}

bool RVSBanditRoad::initVehicleStorySpawner(IsoMetaGrid.Zone zone,
                                            IsoChunk chunk, bool debug) {
  // TODO: Implement initVehicleStorySpawner
  return false;
}

void RVSBanditRoad::spawnElement(VehicleStorySpawner spawner,
