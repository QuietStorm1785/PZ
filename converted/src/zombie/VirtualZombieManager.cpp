...
IsoZombie VirtualZombieManager::createRealZombieAlways(int ZombieDir, bool bDead) {
 // TODO: Implement createRealZombieAlways
 return nullptr;
}

IsoZombie VirtualZombieManager::createRealZombieAlways(int descriptorID, int ZombieDir, bool bDead) {
 // TODO: Implement createRealZombieAlways
 return nullptr;
}

IsoZombie VirtualZombieManager::createRealZombieAlways(int ZombieDir, bool bDead, int outfitID) {
 // TODO: Implement createRealZombieAlways
 return nullptr;
}
...
IsoGridSquare VirtualZombieManager::pickEatingZombieSquare(float float2, float float3, float float1, float float0, int int0) {
...
void VirtualZombieManager::addIndoorZombies(int int4, RoomDef roomDef, bool boolean0) {
 // TODO: Implement addIndoorZombies
}

void VirtualZombieManager::addIndoorZombiesToChunk(IsoChunk chunk, IsoRoom room, int zombieCountForRoom, ArrayList<IsoZombie> zombies) {
 // TODO: Implement addIndoorZombiesToChunk
}

void VirtualZombieManager::addIndoorZombiesToChunk(IsoChunk chunk, IsoRoom room) {
 // TODO: Implement addIndoorZombiesToChunk
}
...
void VirtualZombieManager::createHordeFromTo(float spawnX, float spawnY, float targetX, float targetY, int count) {
...
bool VirtualZombieManager::isBlockedInAllDirections(int int0, int int1, int int2) {
