...
public UITextBox2::UITextBox2(UIFont _font, int x, int y, int width, int height, const std::string& text, bool _HasFrame) {
...
void UITextBox2::setMasked(bool b) {
...
void UITextBox2::setFrameAlpha(float alpha) {
 // TODO: Implement setFrameAlpha
}

void UITextBox2::setTextColor(ColorInfo newColor) {
...
void UITextBox2::setEditable(bool b) {
...
void UITextBox2::setSelectable(bool b) {
...
bool UITextBox2::onMouseUp(double x, double y) {
 // TODO: Implement onMouseUp
 return false;
}

void UITextBox2::onMouseUpOutside(double x, double y) {
 // TODO: Implement onMouseUpOutside
}

bool UITextBox2::onMouseMove(double dx, double dy) {
 // TODO: Implement onMouseMove
 return false;
}

void UITextBox2::onMouseMoveOutside(double dx, double dy) {
...
bool UITextBox2::onMouseDown(double x, double y) {
 // TODO: Implement onMouseDown
 return false;
}

int UITextBox2::getCursorPosFromX(int int0) {
...
void UITextBox2::SetText(const std::string& text) {
...
void UITextBox2::onOtherKey(int key) {
...
void UITextBox2::setMaxTextLength(int maxtextLength) {
...
void UITextBox2::setForceUpperCase(bool _forceUpperCase) {
 // TODO: Implement setForceUpperCase
}

void UITextBox2::setHasFrame(bool hasFrame) {
 // TODO: Implement setHasFrame
}

void UITextBox2::setClearButton(bool hasButton) {
 // TODO: Implement setClearButton
}

int UITextBox2::toDisplayLine(int textOffset) {
 // TODO: Implement toDisplayLine
 return 0;
}

void UITextBox2::setMultipleLine(bool multiple) {
...
void UITextBox2::setCursorLine(int line) {
...
void UITextBox2::setCursorPos(int charIndex) {
...
void UITextBox2::setMaxLines(int _maxLines) {
...
void UITextBox2::setOnlyNumbers(bool _onlyNumbers) {
