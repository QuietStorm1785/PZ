...
void ObjectTooltip::DrawText(UIFont _font, const std::string& text, double x, double y, double r, double g, double b, double _alpha) {
 // TODO: Implement DrawText
}

void ObjectTooltip::DrawTextCentre(UIFont _font, const std::string& text, double x, double y, double r, double g, double b, double _alpha) {
 // TODO: Implement DrawTextCentre
}

void ObjectTooltip::DrawTextRight(UIFont _font, const std::string& text, double x, double y, double r, double g, double b, double _alpha) {
...
void ObjectTooltip::DrawTextureScaled(Texture tex, double x, double y, double width, double height, double _alpha) {
 // TODO: Implement DrawTextureScaled
}

void ObjectTooltip::DrawTextureScaledAspect(Texture tex, double x, double y, double width, double height, double r, double g, double b, double _alpha) {
 // TODO: Implement DrawTextureScaledAspect
}

void ObjectTooltip::DrawProgressBar(int x, int y, int w, int h, float f, double r, double g, double b, double a) {
...
void ObjectTooltip::setLabel(const std::string& _label, float r, float g, float b, float a) {
 // TODO: Implement setLabel
}

void ObjectTooltip::setValue(const std::string& _label, float r, float g, float b, float a) {
...
void ObjectTooltip::setProgress(float fraction, float r, float g, float b, float a) {
