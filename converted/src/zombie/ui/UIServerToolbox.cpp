...
public UIServerToolbox::UIServerToolbox(int int0, int int1) {
 // TODO: Implement UIServerToolbox
 return nullptr;
}

new UIServerToolbox::ICoopServerMessageListener() {
 // TODO: Implement ICoopServerMessageListener
 return nullptr;
}

void UIServerToolbox::OnCoopServerMessage(const std::string& var1, const std::string& var2, const std::string& string0) {
 // TODO: Implement OnCoopServerMessage
}

void UIServerToolbox::OnCoopServerMessage(const std::string& var1, const std::string& var2, const std::string& string) {
 // TODO: Implement OnCoopServerMessage
}
...
void UIServerToolbox::PrintLine(const std::string& string) {
...
void UIServerToolbox::Selected(const std::string& string0, int var2, int var3) {
