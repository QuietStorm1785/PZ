...
public FileTask_LoadImageData::FileTask_LoadImageData(const std::string& string, FileSystem fileSystem, IFileTaskCallback iFileTaskCallback) {
 // TODO: Implement FileTask_LoadImageData
 return nullptr;
}
