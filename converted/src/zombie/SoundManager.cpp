...
void SoundManager::timelineMarker(long var1, const std::string& string, int int0) {
...
void SoundManager::startEvent(long eventInstance, GameSoundClip clip, BitSet parameterSet) {
...
void SoundManager::stopEvent(long eventInstance, GameSoundClip clip, BitSet parameterSet) {
...
void SoundManager::BlendVolume(Audio audio, float targetVolume, float blendSpeedAlpha) {
 // TODO: Implement BlendVolume
}

Audio SoundManager::BlendThenStart(Audio musicTrack, float f, const std::string& PrefMusic) {
...
void SoundManager::PlayAsMusic(const std::string& name, Audio musicTrack, float volume, bool bloop) {
...
void SoundManager::PlayAsMusic(const std::string& name, Audio musicTrack, bool loop, float volume) {
 // TODO: Implement PlayAsMusic
}
...
void SoundManager::setMusicWakeState(IsoPlayer player, const std::string& stateName) {
 // TODO: Implement setMusicWakeState
}

Audio SoundManager::PlayMusic(const std::string& n, const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlayMusic
 return nullptr;
}

Audio SoundManager::PlaySound(const std::string& name, bool loop, float maxGain, float pitchVar) {
...
Audio SoundManager::PlaySoundEvenSilent(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlaySoundEvenSilent
 return nullptr;
}

Audio SoundManager::PlayJukeboxSound(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlayJukeboxSound
 return nullptr;
}

Audio SoundManager::PlaySoundWav(const std::string& name, bool loop, float maxGain, float pitchVar) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}

Audio SoundManager::PlaySoundWav(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}

Audio SoundManager::PlaySoundWav(const std::string& name, int variations, bool loop, float maxGain) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}
...
Audio SoundManager::PlayWorldSound(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}

Audio SoundManager::PlayWorldSound(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}

Audio SoundManager::PlayWorldSoundImpl(const std::string& name, bool loop, int sx, int sy, int sz, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundImpl
 return nullptr;
}

Audio SoundManager::PlayWorldSound(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, int choices, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}

Audio SoundManager::PlayWorldSoundWav(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
 return nullptr;
}

Audio SoundManager::PlayWorldSoundWav(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
 return nullptr;
}

Audio SoundManager::PlayWorldSoundWavImpl(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWavImpl
 return nullptr;
}

void SoundManager::PlayWorldSoundWav(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, int choices, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
}
...
Audio SoundManager::Start(Audio musicTrack, float f, const std::string& PrefMusic) {
...
public SoundManager::AmbientSoundEffect(const std::string& _name) {
