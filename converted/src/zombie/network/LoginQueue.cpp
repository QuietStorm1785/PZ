...
void LoginQueue::receiveClientLoginQueueRequest(ByteBuffer byteBuffer,
                                                short var1) {
  // TODO: Implement receiveClientLoginQueueRequest
}

void LoginQueue::receiveLoginQueueDone(ByteBuffer byteBuffer,
                                       UdpConnection udpConnection,
                                       short var2) {
  // TODO: Implement receiveLoginQueueDone
}

void LoginQueue::receiveServerLoginQueueRequest(ByteBuffer var0,
                                                UdpConnection udpConnection,
                                                short var2) {
  // TODO: Implement receiveServerLoginQueueRequest
}

void LoginQueue::sendAccessDenied(UdpConnection udpConnection,
