...
public ReplayManager::ReplayManager(IsoPlayer playerx) {
...
bool ReplayManager::startRecordReplay(IsoPlayer playerx, const std::string& string) {
...
bool ReplayManager::startPlayReplay(IsoPlayer playerx, const std::string& string, UdpConnection udpConnection) {
