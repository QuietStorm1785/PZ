...
int ServerGUI::DoWallLightingN(IsoGridSquare square, IsoObject object, int int0) {
 // TODO: Implement DoWallLightingN
 return 0;
}

int ServerGUI::DoWallLightingW(IsoGridSquare square, IsoObject object, int int0) {
 // TODO: Implement DoWallLightingW
 return 0;
}

int ServerGUI::DoWallLightingNW(IsoGridSquare square, IsoObject object, int int0) {
 // TODO: Implement DoWallLightingNW
 return 0;
}

bool ServerGUI::renderMinusFloor(IsoGridSquare square0, bool boolean0, bool boolean4) {
