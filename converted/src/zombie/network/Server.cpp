...
void Server::setIp(const std::string &_ip) {
...
void Server::setLocalIP(const std::string &_ip) {
...
void Server::setServerPassword(const std::string &_pwd) {
...
void Server::setDescription(const std::string &_description) {
...
void Server::setUserName(const std::string &_userName) {
...
void Server::setPwd(const std::string &_pwd) {
...
void Server::setUseSteamRelay(bool boolean0) {
...
void Server::setLastUpdate(int _lastUpdate) {
...
void Server::setPlayers(const std::string &_players) {
...
void Server::setOpen(bool _open) {
...
void Server::setPublic(bool _bPublic) {
...
void Server::setVersion(const std::string &_version) {
...
void Server::setMaxPlayers(const std::string &_maxPlayers) {
...
void Server::setMods(const std::string &_mods) {
...
void Server::setName(const std::string &_name) {
...
void Server::setPing(const std::string &_ping) {
...
void Server::setPasswordProtected(bool pp) {
...
void Server::setSteamId(const std::string &_steamId) {
...
void Server::setHosted(bool _hosted) {
