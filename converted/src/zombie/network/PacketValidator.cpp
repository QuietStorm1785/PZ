...
public PacketValidator::PacketValidator(UdpConnection udpConnection) {
...
void PacketValidator::sendChecksum(bool boolean0, bool boolean1, bool boolean2) {
...
bool PacketValidator::checkPVP(UdpConnection udpConnection, char character1, char character0, const std::string& string) {
 // TODO: Implement checkPVP
 return false;
}

bool PacketValidator::checkSpeed(UdpConnection udpConnection, IMovable iMovable, const std::string& string) {
 // TODO: Implement checkSpeed
 return false;
}

bool PacketValidator::checkLongDistance(UdpConnection udpConnection, IPositional iPositional0, IPositional iPositional1, const std::string& string) {
 // TODO: Implement checkLongDistance
 return false;
}

bool PacketValidator::checkDamage(UdpConnection udpConnection, Hit hit, const std::string& string) {
 // TODO: Implement checkDamage
 return false;
}

bool PacketValidator::checkOwner(UdpConnection udpConnection1, Zombie zombie1, const std::string& string) {
 // TODO: Implement checkOwner
 return false;
}

bool PacketValidator::checkTarget(UdpConnection udpConnection, Player player1, const std::string& string) {
 // TODO: Implement checkTarget
 return false;
}

bool PacketValidator::checkSafehouseAuth(UdpConnection udpConnection, const std::string& string0, const std::string& string1) {
 // TODO: Implement checkSafehouseAuth
 return false;
}

bool PacketValidator::checkShortDistance(UdpConnection udpConnection, IPositional iPositional0, IPositional iPositional1, const std::string& string) {
...
void PacketValidator::doLogUser(UdpConnection udpConnection, Userlog.UserlogType userlogType, const std::string& string0, const std::string& string1) {
 // TODO: Implement doLogUser
}

void PacketValidator::doKickUser(UdpConnection udpConnection, const std::string& string0, const std::string& string1, const std::string& string2) {
 // TODO: Implement doKickUser
}

void PacketValidator::doBanUser(UdpConnection udpConnection, const std::string& string0, const std::string& string1) {
 // TODO: Implement doBanUser
}

bool PacketValidator::checkPVP(IsoGameCharacter character, IsoMovingObject movingObject) {
 // TODO: Implement checkPVP
 return false;
}
...
public PacketValidator::RecipeDetails(ByteBuffer byteBuffer) {
...
public PacketValidator::Skill(const std::string& string, int int0) {
