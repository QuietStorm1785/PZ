...
public PlayerDownloadServer::PlayerDownloadServer(UdpConnection _connection) {
...
bool PlayerDownloadServer::cancelDuplicateChunk(ClientChunkRequest clientChunkRequest, int int2, int int1) {
...
void PlayerDownloadServer::putCommand(PlayerDownloadServer.EThreadCommand eThreadCommand, ClientChunkRequest clientChunkRequest) {
...
void PlayerDownloadServer::sendNotRequired(ClientChunkRequest.Chunk chunk, bool boolean0) {
 // TODO: Implement sendNotRequired
}

void PlayerDownloadServer::sendLargeArea(ClientChunkRequest clientChunkRequest) {
