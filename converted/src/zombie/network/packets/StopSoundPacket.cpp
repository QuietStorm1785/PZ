...
void StopSoundPacket::set(IsoMovingObject movingObject, const std::string& string, bool boolean0) {
 // TODO: Implement set
}
...
void StopSoundPacket::parse(ByteBuffer byteBuffer, UdpConnection udpConnection) {
