...
void PlaySoundPacket::set(const std::string& string, bool boolean0, IsoMovingObject movingObject) {
 // TODO: Implement set
}
...
void PlaySoundPacket::parse(ByteBuffer byteBuffer, UdpConnection udpConnection) {
