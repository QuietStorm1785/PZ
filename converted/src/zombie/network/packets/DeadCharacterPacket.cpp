...
void DeadCharacterPacket::parseDeadBodyInventory(IsoDeadBody deadBody, ByteBuffer byteBuffer) {
 // TODO: Implement parseDeadBodyInventory
}

void DeadCharacterPacket::parseDeadBodyHumanVisuals(IsoDeadBody deadBody, ByteBuffer byteBuffer) {
...
void DeadCharacterPacket::writeCharacterInventory(ByteBufferWriter byteBufferWriter) {
 // TODO: Implement writeCharacterInventory
}

void DeadCharacterPacket::writeCharacterHumanVisuals(ByteBufferWriter byteBufferWriter) {
