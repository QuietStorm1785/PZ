...
void RequestDataPacket::setPartData(RequestDataPacket.RequestID requestID, ByteBuffer byteBuffer) {
...
void RequestDataPacket::sendConnectingDetails(UdpConnection udpConnection, ServerWorldDatabase.LogonResult logonResult) {
...
void RequestDataPacket::processServer(PacketTypes.PacketType var1, UdpConnection udpConnection) {
...
void RequestDataPacket::saveToFile(ByteBuffer byteBuffer, const std::string& string) {
