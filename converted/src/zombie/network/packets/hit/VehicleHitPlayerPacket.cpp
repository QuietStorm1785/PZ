...
void VehicleHitPlayerPacket::set(IsoPlayer player0, IsoPlayer player1, BaseVehicle vehicle, float float0, bool boolean1, int int0, float float1, bool boolean0) {
 // TODO: Implement set
}

void VehicleHitPlayerPacket::parse(ByteBuffer byteBuffer, UdpConnection udpConnection) {
