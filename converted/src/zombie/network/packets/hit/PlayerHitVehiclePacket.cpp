...
void PlayerHitVehiclePacket::set(IsoPlayer player, BaseVehicle vehiclex, HandWeapon weapon, bool boolean0) {
 // TODO: Implement set
}

void PlayerHitVehiclePacket::parse(ByteBuffer byteBuffer, UdpConnection udpConnection) {
