...
void PlayerHitSquarePacket::set(IsoPlayer player, HandWeapon weapon, bool boolean0) {
 // TODO: Implement set
}

void PlayerHitSquarePacket::parse(ByteBuffer byteBuffer, UdpConnection udpConnection) {
