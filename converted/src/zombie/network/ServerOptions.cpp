...
void ServerOptions::putSaveOption(const std::string& key, const std::string& value) {
 // TODO: Implement putSaveOption
}

std::string ServerOptions::changeOption(const std::string& key, const std::string& value) {
...
public ServerOptions::BooleanServerOption(ServerOptions owner, const std::string& name, bool defaultValue) {
...
public ServerOptions::DoubleServerOption(ServerOptions owner, const std::string& name, double min, double max, double defaultValue) {
...
public ServerOptions::IntegerServerOption(ServerOptions owner, const std::string& name, int min, int max, int defaultValue) {
...
public ServerOptions::StringServerOption(ServerOptions owner, const std::string& name, const std::string& defaultValue, int maxLength) {
...
public ServerOptions::TextServerOption(ServerOptions owner, const std::string& name, const std::string& defaultValue, int maxLength) {
