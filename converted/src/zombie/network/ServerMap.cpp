...
bool ServerMap::InsideThePlayerInfluence(ServerMap.ServerCell serverCell, short short0) {
...
void ServerMap::setGridSquare(int int1, int int3, int int10, IsoGridSquare square) {
...
int ServerMap::compare(ServerMap.ServerCell serverCell0, ServerMap.ServerCell serverCell1) {
 // TODO: Implement compare
 return 0;
}

float ServerMap::distToCell(float float1, float float3, ServerMap.ServerCell serverCell) {
