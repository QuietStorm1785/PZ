...
void FakeClientManager::WriteStringUTF(ByteBuffer byteBuffer, const std::string& string) {
...
private FakeClientManager::Client(FakeClientManager.Player playerx, FakeClientManager.Network networkx, int int0, int int1) {
...
void FakeClientManager::putUTF(ByteBuffer byteBuffer, const std::string& string) {
...
void FakeClientManager::sendPlayer(NetworkCharacter.Transform transform, int int0, Vector2 vector) {
...
void FakeClientManager::addChunkRequest(int int0, int int1, int var3, int var4) {
...
void FakeClientManager::sendEventPacket(short short0, int int0, int int1, int int2, uint8_t byte0, const std::string& string) {
 // TODO: Implement sendEventPacket
}

void FakeClientManager::sendWorldSound4Player(int int0, int int1, int int2, int int3, int int4) {
 // TODO: Implement sendWorldSound4Player
}

private FakeClientManager::Request(int int1, int int2, int int0) {
 // TODO: Implement Request
 return nullptr;
}

public FakeClientManager::HordeCreator(int int0, int int1, long long0) {
...
private FakeClientManager::Network(int int1, int int0) {
...
void FakeClientManager::disconnect(long long0, int int0, const std::string& string) {
 // TODO: Implement disconnect
}
...
private FakeClientManager::Player(FakeClientManager.Movement movementx, FakeClientManager.Network network, int int0, int int1) {
...
public FakeClientManager::PlayerManager(FakeClientManager.Player playerx) {
...
public FakeClientManager::RemotePlayer(short short0) {
 // TODO: Implement RemotePlayer
 return nullptr;
}

public FakeClientManager::SoundMaker(int int1, int int0, const std::string& string) {
...
void FakeClientManager::save(ByteBuffer byteBufferx, const std::string& string) {
 // TODO: Implement save
}
...
public FakeClientManager::Zombie(short short0) {
 // TODO: Implement Zombie
 return nullptr;
}

public FakeClientManager::ZombieSimulator(FakeClientManager.Player playerx) {
...
void FakeClientManager::writeHitInfoToZombie(ByteBuffer byteBuffer, short short0, float float0, float float1, float float2) {
 // TODO: Implement writeHitInfoToZombie
}

void FakeClientManager::sendHitCharacter(FakeClientManager.Zombie zombie0, float float0) {
