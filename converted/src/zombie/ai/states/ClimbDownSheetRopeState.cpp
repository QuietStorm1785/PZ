...
void ClimbDownSheetRopeState::exit(IsoGameCharacter owner) {
 // TODO: Implement exit
}

float ClimbDownSheetRopeState::getClimbDownSheetRopeSpeed(IsoGameCharacter owner) {
 // TODO: Implement getClimbDownSheetRopeSpeed
 return 0;
}
