...
bool WalkTowardState::isPathClear(IsoGameCharacter character, float float0, float float1, float float2) {
 // TODO: Implement isPathClear
 return false;
}

bool WalkTowardState::calculateTargetLocation(IsoZombie zomb, Vector2 location) {
