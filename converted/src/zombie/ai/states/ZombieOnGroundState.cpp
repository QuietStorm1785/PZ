...
bool ZombieOnGroundState::isCharacterStandingOnOther(
    IsoGameCharacter chrStanding, IsoGameCharacter chrProne) {
  // TODO: Implement isCharacterStandingOnOther
  return false;
}

int ZombieOnGroundState::DoCollisionBoneCheck(IsoGameCharacter character1,
