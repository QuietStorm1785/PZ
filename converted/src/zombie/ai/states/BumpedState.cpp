...
void BumpedState::setCharacterBlockMovement(IsoGameCharacter character, bool boolean0) {
...
void BumpedState::animEvent(IsoGameCharacter character, AnimEvent animEvent) {
