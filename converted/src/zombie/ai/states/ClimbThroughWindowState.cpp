...
void ClimbThroughWindowState::checkForFallingBack(IsoGridSquare square, IsoGameCharacter character) {
 // TODO: Implement checkForFallingBack
}

void ClimbThroughWindowState::checkForFallingFront(IsoGridSquare square, IsoGameCharacter character) {
...
void ClimbThroughWindowState::animEvent(IsoGameCharacter owner, AnimEvent event) {
 // TODO: Implement animEvent
}

bool ClimbThroughWindowState::isIgnoreCollide(IsoGameCharacter owner, int fromX, int fromY, int fromZ, int toX, int toY, int toZ) {
...
void ClimbThroughWindowState::getDeltaModifiers(IsoGameCharacter owner, MoveDeltaModifiers modifiers) {
...
IsoGridSquare ClimbThroughWindowState::getFreeSquareAfterObstacles(IsoGridSquare square1, IsoDirections directions) {
...
bool ClimbThroughWindowState::isPastInnerEdgeOfSquare(IsoGameCharacter owner, int x, int y, IsoDirections moveDir) {
 // TODO: Implement isPastInnerEdgeOfSquare
 return false;
}

bool ClimbThroughWindowState::isPastOuterEdgeOfSquare(IsoGameCharacter owner, int x, int y, IsoDirections moveDir) {
