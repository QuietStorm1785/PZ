...
void State::getDeltaModifiers(IsoGameCharacter owner, MoveDeltaModifiers modifiers) {
 // TODO: Implement getDeltaModifiers
}

bool State::isIgnoreCollide(IsoGameCharacter owner, int fromX, int fromY, int fromZ, int toX, int toY, int toZ) {
