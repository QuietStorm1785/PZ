...
void* DebugChunkState::fromLua2(const std::string& func, void* arg0, void* arg1) {
...
void DebugChunkState::DrawIsoLine(float float2, float float3, float float6, float float7, float float9, float float10, float float11, float float12, int int0) {
 // TODO: Implement DrawIsoLine
}

void DebugChunkState::DrawIsoRect(float float0, float float1, float float6, float float7, float float2, float float3, float float4, float float5, int int0) {
...
bool DebugChunkState::IsBehindStuffRecXY(int int0, int int1, int int2, int int3) {
...
void DebugChunkState::paintSquare(int int4, int int3, int int2, float float0, float float1, float float2, float float3) {
...
void DebugChunkState::DrawString(int int3, int int2, const std::string& string) {
...
public DebugChunkState::BooleanDebugOption(const std::string& string, bool boolean0) {
