...
public ConnectToServerState::ConnectToServerState(ByteBuffer bb) {
...
void ConnectToServerState::setState(ConnectToServerState.WorkshopItemState workshopItemState) {
