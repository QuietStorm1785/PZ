...
void ChooseGameInfo::readTitleDotTxt(ChooseGameInfo.Map map, const std::string& string1, Language language) {
 // TODO: Implement readTitleDotTxt
}

void ChooseGameInfo::readDescriptionDotTxt(ChooseGameInfo.Map map, const std::string& string1, Language language) {
...
public ChooseGameInfo::Mod(const std::string& _dir) {
 // TODO: Implement Mod
 return nullptr;
}
...
public ChooseGameInfo::PackFile(const std::string& string, int int0) {
 // TODO: Implement PackFile
 return nullptr;
}

public ChooseGameInfo::SpawnOrigin(int int0, int int1, int int2, int int3) {
 // TODO: Implement SpawnOrigin
 return nullptr;
}

public ChooseGameInfo::TileDef(const std::string& string, int int0) {
