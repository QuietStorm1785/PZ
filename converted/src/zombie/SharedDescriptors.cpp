...
void SharedDescriptors::registerPlayerZombieDescriptor(SharedDescriptors.Descriptor descriptor) {
 // TODO: Implement registerPlayerZombieDescriptor
}

void SharedDescriptors::ApplyReanimatedPlayerOutfit(int int0, const std::string& var1, IsoGameCharacter character) {
