...
void ZombiePopulationManager::processTriggerSpawnHorde(ZombieTriggerXmlFile zombieTriggerXmlFile) {
...
void ZombiePopulationManager::registerSpawnOrigin(int int3, int int2, int int1, int int0, KahluaTable var5) {
...
void ZombiePopulationManager::createHordeFromTo(int int0, int int1, int int4, int int3, int int2) {
 // TODO: Implement createHordeFromTo
}

void ZombiePopulationManager::createHordeInAreaTo(int int0, int int1, int int2, int int3, int int6, int int5, int int4) {
 // TODO: Implement createHordeInAreaTo
}

void ZombiePopulationManager::addWorldSound(WorldSoundManager.WorldSound worldSound, bool var2) {
...
void ZombiePopulationManager::addZombieStanding(float float2, float float1, float float0, IsoDirections directions, int int1, int int0) {
 // TODO: Implement addZombieStanding
}

IsoGridSquare ZombiePopulationManager::getSquareForSittingZombie(float float1, float float0, int int2) {
 // TODO: Implement getSquareForSittingZombie
 return nullptr;
}

void ZombiePopulationManager::sitAgainstWall(IsoZombie zombie0, IsoGridSquare square) {
 // TODO: Implement sitAgainstWall
}

void ZombiePopulationManager::addZombieMoving(float float2, float float1, float float0, IsoDirections directions, int int0, int int1, int int3, int int2) {
