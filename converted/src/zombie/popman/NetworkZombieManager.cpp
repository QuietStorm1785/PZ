...
int NetworkZombieManager::getAuthorizedZombieCount(UdpConnection udpConnection) {
...
void NetworkZombieManager::moveZombie(IsoZombie zombie0, UdpConnection udpConnection, IsoPlayer player) {
 // TODO: Implement moveZombie
}

void NetworkZombieManager::getZombieAuth(UdpConnection udpConnection, ByteBuffer byteBuffer) {
 // TODO: Implement getZombieAuth
}

void NetworkZombieManager::clearTargetAuth(UdpConnection udpConnection, IsoPlayer player) {
