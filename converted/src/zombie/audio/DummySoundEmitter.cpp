...
void DummySoundEmitter::setParameterValue(
    long handle, FMOD_STUDIO_PARAMETER_DESCRIPTION parameterDescription,
    float value) {
  // TODO: Implement setParameterValue
}

void DummySoundEmitter::setTimelinePosition(long handle,
...
long DummySoundEmitter::playSound(const std::string &file, int x, int y,
                                  int z) {
  // TODO: Implement playSound
  return 0;
}
...
long DummySoundEmitter::playSoundImpl(const std::string &file,
                                      IsoGridSquare square) {
...
long DummySoundEmitter::playSoundImpl(const std::string &file,
                                      bool doWorldSound, IsoObject parent) {
  // TODO: Implement playSoundImpl
  return 0;
}
