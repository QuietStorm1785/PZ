...
void DummySoundBank::addVoice(const std::string& alias, const std::string& sound, float priority) {
 // TODO: Implement addVoice
}

void DummySoundBank::addFootstep(const std::string& alias, const std::string& grass, const std::string& wood, const std::string& concrete, const std::string& upstairs) {
