...
public HandWeapon::HandWeapon(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 // TODO: Implement HandWeapon
 return nullptr;
}

public HandWeapon::HandWeapon(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 // TODO: Implement HandWeapon
 return nullptr;
}
...
void HandWeapon::DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
...
void HandWeapon::setMultipleHitConditionAffected(bool _MultipleHitConditionAffected) {
...
void HandWeapon::setCantAttackWithLowestEndurance(bool _CantAttackWithLowestEndurance) {
...
void HandWeapon::setAimingPerkHitChanceModifier(float aimingPerkHitChanceModifier) {
...
void HandWeapon::setAimingPerkMinAngleModifier(float aimingPerkMinAngleModifier) {
...
void HandWeapon::addPartToList(const std::string& string, ArrayList<WeaponPart> arrayList) {
...
void HandWeapon::setModelWeaponPart(ArrayList<ModelWeaponPart> _modelWeaponPart) {
...
void HandWeapon::setOriginalWeaponSprite(const std::string& _originalWeaponSprite) {
...
void HandWeapon::setFireModePossibilities(ArrayList<String> _fireModePossibilities) {
