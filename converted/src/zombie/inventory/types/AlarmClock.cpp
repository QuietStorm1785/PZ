...
public AlarmClock::AlarmClock(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 // TODO: Implement AlarmClock
 return nullptr;
}

public AlarmClock::AlarmClock(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 // TODO: Implement AlarmClock
 return nullptr;
}
...
void AlarmClock::DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
