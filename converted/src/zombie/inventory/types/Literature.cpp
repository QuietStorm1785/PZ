...
public Literature::Literature(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 // TODO: Implement Literature
 return nullptr;
}

public Literature::Literature(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 // TODO: Implement Literature
 return nullptr;
}
...
void Literature::DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
