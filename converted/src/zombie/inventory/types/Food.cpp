...
public Food::Food(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 // TODO: Implement Food
 return nullptr;
}

public Food::Food(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 // TODO: Implement Food
 return nullptr;
}
...
void Food::updateSound(BaseSoundEmitter emitter) {
...
void Food::setCookingParameter(BaseSoundEmitter baseSoundEmitter) {
...
void Food::updateRotting(ItemContainer container) {
...
void Food::updateFreezing(ItemContainer outermostContainer) {
...
bool Food::CanStack(InventoryItem item) {
 // TODO: Implement CanStack
 return false;
}

void Food::save(ByteBuffer output, bool net) {
 // TODO: Implement save
}

void Food::load(ByteBuffer input, int WorldVersion) {
 // TODO: Implement load
}
...
void Food::DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
...
void Food::setEnduranceChange(float _endChange) {
...
void Food::setBadCold(bool _bBadCold) {
...
void Food::setGoodHot(bool _bGoodHot) {
...
void Food::setCookedInMicrowave(bool b) {
...
void Food::setEndChange(float _endChange) {
...
void Food::setHungChange(float _hungChange) {
...
void Food::setUseOnConsume(const std::string& _useOnConsume) {
...
void Food::setRotten(bool _rotten) {
...
void Food::setbDangerousUncooked(bool _bDangerousUncooked) {
...
void Food::setLastCookMinute(int _LastCookMinute) {
...
void Food::setThirstChange(float _thirstChange) {
 // TODO: Implement setThirstChange
}

void Food::setReplaceOnCooked(List<String> replaceOnCooked) {
...
void Food::setBaseHunger(float _baseHunger) {
...
void Food::setSpice(bool _isSpice) {
...
void Food::setPoisonDetectionLevel(int _poisonDetectionLevel) {
...
void Food::setPoisonLevelForRecipe(int poisonLevelForRecipe) {
...
void Food::setUseForPoison(int useForPoison) {
...
void Food::setPoisonPower(int poisonPower) {
...
void Food::setFoodType(const std::string& foodType) {
...
void Food::setRemoveNegativeEffectOnCooked(bool removeNegativeEffectOnCooked) {
...
void Food::setCustomEatSound(const std::string& customEatSound) {
...
void Food::setChef(const std::string& chef) {
...
void Food::setOnCooked(const std::string& onCooked) {
...
void Food::setHerbalistType(const std::string& type) {
 // TODO: Implement setHerbalistType
}

void Food::setSpices(ArrayList<String> _spices) {
...
void Food::setReduceFoodSickness(int _ReduceFoodSickness) {
...
void Food::setFluReduction(int _fluReduction) {
...
void Food::setPainReduction(float _painReduction) {
...
void Food::setCarbohydrates(float _carbohydrates) {
...
void Food::setLipids(float _lipids) {
...
void Food::setProteins(float _proteins) {
...
void Food::setCalories(float _calories) {
...
void Food::setPackaged(bool _packaged) {
...
void Food::setFreezingTime(float _freezingTime) {
...
void Food::setFrozen(bool _frozen) {
...
void Food::setCanBeFrozen(bool _canBeFrozen) {
...
void Food::setReplaceOnRotten(const std::string& _replaceOnRotten) {
 // TODO: Implement setReplaceOnRotten
}

void Food::multiplyFoodValues(float percentage) {
...
void Food::setRottenTime(float time) {
...
void Food::setCompostTime(float _compostTime) {
...
void Food::setOnEat(const std::string& _onEat) {
...
void Food::setBadInMicrowave(bool _badInMicrowave) {
