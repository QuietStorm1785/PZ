...
public MapItem::MapItem(const std::string& module, const std::string& name, const std::string& type, const std::string& tex) {
 // TODO: Implement MapItem
 return nullptr;
}

public MapItem::MapItem(const std::string& module, const std::string& name, const std::string& type, Item item) {
 // TODO: Implement MapItem
 return nullptr;
}
