...
public AlarmClockClothing::AlarmClockClothing(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName, const std::string& palette, const std::string& SpriteName) {
 // TODO: Implement AlarmClockClothing
 return nullptr;
}

public AlarmClockClothing::AlarmClockClothing(const std::string& module, const std::string& name, const std::string& itemType, Item item, const std::string& palette, const std::string& SpriteName) {
 // TODO: Implement AlarmClockClothing
 return nullptr;
}
...
void AlarmClockClothing::DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
