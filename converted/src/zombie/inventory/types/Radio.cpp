...
public
Radio::Radio(const std::string &module, const std::string &name,
...
void Radio::AddDeviceText(const std::string &line, float r, float g, float b,
                          const std::string &guid, const std::string &codes,
                          int distance) {
  // TODO: Implement AddDeviceText
}

void Radio::AddDeviceText(ChatMessage msg, float r, float g, float b,
                          const std::string &guid, const std::string &codes,
                          int distance) {
  // TODO: Implement AddDeviceText
}
