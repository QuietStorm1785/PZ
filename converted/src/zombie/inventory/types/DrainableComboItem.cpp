...
public DrainableComboItem::DrainableComboItem(const std::string& module, const std::string& name, const std::string& itemType, const std::string& texName) {
 // TODO: Implement DrainableComboItem
 return nullptr;
}

public DrainableComboItem::DrainableComboItem(const std::string& module, const std::string& name, const std::string& itemType, Item item) {
 // TODO: Implement DrainableComboItem
 return nullptr;
}
...
void DrainableComboItem::setReplaceOnDeplete(const std::string& _ReplaceOnDeplete) {
