...
public Moveable::Moveable(const std::string& module, const std::string& name, const std::string& type, const std::string& tex) {
 // TODO: Implement Moveable
 return nullptr;
}

public Moveable::Moveable(const std::string& module, const std::string& name, const std::string& type, Item item) {
 // TODO: Implement Moveable
 return nullptr;
}
