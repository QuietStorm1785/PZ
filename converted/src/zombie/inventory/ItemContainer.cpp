...
public ItemContainer::ItemContainer(int _ID, const std::string& containerName, IsoGridSquare square, IsoObject _parent) {
 // TODO: Implement ItemContainer
 return nullptr;
}

public ItemContainer::ItemContainer(const std::string& containerName, IsoGridSquare square, IsoObject _parent) {
 // TODO: Implement ItemContainer
 return nullptr;
}

public ItemContainer::ItemContainer(int _ID) {
 // TODO: Implement ItemContainer
 return nullptr;
}
...
int ItemContainer::getNumberOfItem(const std::string& findItem, bool includeReplaceOnDeplete) {
...
int ItemContainer::getNumberOfItem(const std::string& findItem, bool includeReplaceOnDeplete, ArrayList<ItemContainer> containers) {
 // TODO: Implement getNumberOfItem
 return 0;
}

int ItemContainer::getNumberOfItem(const std::string& findItem, bool includeReplaceOnDeplete, bool insideInv) {
 // TODO: Implement getNumberOfItem
 return 0;
}
...
bool ItemContainer::containsWithModule(const std::string& moduleType, bool withDeltaLeft) {
 // TODO: Implement containsWithModule
 return false;
}
...
bool ItemContainer::contains(const std::string& _type, bool doInv, bool ignoreBroken) {
 // TODO: Implement contains
 return false;
}
...
InventoryItem ItemContainer::getBestOf(ItemContainer.InventoryItemList inventoryItemList, Comparator<InventoryItem> comparator) {
 // TODO: Implement getBestOf
 return nullptr;
}

InventoryItem ItemContainer::getBest(Predicate<InventoryItem> predicate, Comparator<InventoryItem> comparator) {
 // TODO: Implement getBest
 return nullptr;
}

InventoryItem ItemContainer::getBestRecurse(Predicate<InventoryItem> predicate, Comparator<InventoryItem> comparator) {
 // TODO: Implement getBestRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestType(const std::string& _type, Comparator<InventoryItem> comparator) {
 // TODO: Implement getBestType
 return nullptr;
}

InventoryItem ItemContainer::getBestTypeRecurse(const std::string& _type, Comparator<InventoryItem> comparator) {
 // TODO: Implement getBestTypeRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestEval(LuaClosure predicateObj, LuaClosure comparatorObj) {
 // TODO: Implement getBestEval
 return nullptr;
}

InventoryItem ItemContainer::getBestEvalRecurse(LuaClosure predicateObj, LuaClosure comparatorObj) {
 // TODO: Implement getBestEvalRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestEvalArg(LuaClosure predicateObj, LuaClosure comparatorObj, void* arg) {
 // TODO: Implement getBestEvalArg
 return nullptr;
}

InventoryItem ItemContainer::getBestEvalArgRecurse(LuaClosure predicateObj, LuaClosure comparatorObj, void* arg) {
 // TODO: Implement getBestEvalArgRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestTypeEval(const std::string& _type, LuaClosure comparatorObj) {
 // TODO: Implement getBestTypeEval
 return nullptr;
}

InventoryItem ItemContainer::getBestTypeEvalRecurse(const std::string& _type, LuaClosure comparatorObj) {
 // TODO: Implement getBestTypeEvalRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestTypeEvalArg(const std::string& _type, LuaClosure comparatorObj, void* arg) {
 // TODO: Implement getBestTypeEvalArg
 return nullptr;
}

InventoryItem ItemContainer::getBestTypeEvalArgRecurse(const std::string& _type, LuaClosure comparatorObj, void* arg) {
 // TODO: Implement getBestTypeEvalArgRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestCondition(Predicate<InventoryItem> predicate) {
 // TODO: Implement getBestCondition
 return nullptr;
}

InventoryItem ItemContainer::getBestConditionRecurse(Predicate<InventoryItem> predicate) {
...
InventoryItem ItemContainer::getBestConditionEvalRecurse(LuaClosure functionObj) {
 // TODO: Implement getBestConditionEvalRecurse
 return nullptr;
}

InventoryItem ItemContainer::getBestConditionEvalArg(LuaClosure functionObj, void* arg) {
 // TODO: Implement getBestConditionEvalArg
 return nullptr;
}

InventoryItem ItemContainer::getBestConditionEvalArgRecurse(LuaClosure functionObj, void* arg) {
...
InventoryItem ItemContainer::getFirstEvalArg(LuaClosure functionObj, void* arg) {
...
bool ItemContainer::containsTagEval(const std::string& tag, LuaClosure functionObj) {
...
bool ItemContainer::containsTagEvalRecurse(const std::string& tag, LuaClosure functionObj) {
 // TODO: Implement containsTagEvalRecurse
 return false;
}

bool ItemContainer::containsTagEvalArgRecurse(const std::string& tag, LuaClosure functionObj, void* arg) {
 // TODO: Implement containsTagEvalArgRecurse
 return false;
}

bool ItemContainer::containsTypeEvalRecurse(const std::string& _type, LuaClosure functionObj) {
 // TODO: Implement containsTypeEvalRecurse
 return false;
}

bool ItemContainer::containsTypeEvalArgRecurse(const std::string& _type, LuaClosure functionObj, void* arg) {
 // TODO: Implement containsTypeEvalArgRecurse
 return false;
}

bool ItemContainer::compareType(const std::string& string0, const std::string& string1) {
...
InventoryItem ItemContainer::getFirstRecurse(Predicate<InventoryItem> predicate) {
...
int ItemContainer::getCountTagEval(const std::string& tag, LuaClosure functionObj) {
 // TODO: Implement getCountTagEval
 return 0;
}

int ItemContainer::getCountTagEvalArg(const std::string& tag, LuaClosure functionObj, void* arg) {
...
int ItemContainer::getCountTagEvalRecurse(const std::string& tag, LuaClosure functionObj) {
 // TODO: Implement getCountTagEvalRecurse
 return 0;
}

int ItemContainer::getCountTagEvalArgRecurse(const std::string& tag, LuaClosure functionObj, void* arg) {
...
int ItemContainer::getCountTypeEval(const std::string& _type, LuaClosure functionObj) {
 // TODO: Implement getCountTypeEval
 return 0;
}

int ItemContainer::getCountTypeEvalArg(const std::string& _type, LuaClosure functionObj, void* arg) {
...
int ItemContainer::getCountTypeEvalRecurse(const std::string& _type, LuaClosure functionObj) {
 // TODO: Implement getCountTypeEvalRecurse
 return 0;
}

int ItemContainer::getCountTypeEvalArgRecurse(const std::string& _type, LuaClosure functionObj, void* arg) {
...
InventoryItem ItemContainer::getFirstCategoryRecurse(const std::string& category) {
...
InventoryItem ItemContainer::getFirstEvalArgRecurse(LuaClosure functionObj, void* arg) {
...
InventoryItem ItemContainer::getFirstTagEval(const std::string& tag, LuaClosure functionObj) {
 // TODO: Implement getFirstTagEval
 return nullptr;
}

InventoryItem ItemContainer::getFirstTagEvalRecurse(const std::string& tag, LuaClosure functionObj) {
 // TODO: Implement getFirstTagEvalRecurse
 return nullptr;
}

InventoryItem ItemContainer::getFirstTagEvalArgRecurse(const std::string& tag, LuaClosure functionObj, void* arg) {
...
InventoryItem ItemContainer::getFirstTypeEval(const std::string& _type, LuaClosure functionObj) {
 // TODO: Implement getFirstTypeEval
 return nullptr;
}

InventoryItem ItemContainer::getFirstTypeEvalRecurse(const std::string& _type, LuaClosure functionObj) {
 // TODO: Implement getFirstTypeEvalRecurse
 return nullptr;
}

InventoryItem ItemContainer::getFirstTypeEvalArgRecurse(const std::string& _type, LuaClosure functionObj, void* arg) {
 // TODO: Implement getFirstTypeEvalArgRecurse
 return nullptr;
}

InventoryItem ItemContainer::FindAndReturnCategory(const std::string& category) {
 // TODO: Implement FindAndReturnCategory
 return nullptr;
}

InventoryItem ItemContainer::FindAndReturn(const std::string& _type, ArrayList<InventoryItem> itemToCheck) {
...
InventoryItem ItemContainer::getItemFromType(const std::string& _type, IsoGameCharacter chr, bool notEquipped, bool ignoreBroken, bool includeInv) {
 // TODO: Implement getItemFromType
 return nullptr;
}

InventoryItem ItemContainer::getItemFromType(const std::string& _type, bool ignoreBroken, bool includeInv) {
 // TODO: Implement getItemFromType
 return nullptr;
}
...
void ItemContainer::setOnlyAcceptCategory(const std::string& onlyAcceptCategory) {
...
void ItemContainer::setContainerPosition(const std::string& _containerPosition) {
