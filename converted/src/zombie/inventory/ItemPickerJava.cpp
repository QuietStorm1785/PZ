...
void ItemPickerJava::fillContainerType(ItemPickerJava.ItemPickerRoom roomDist, ItemContainer container, const std::string& roomName, IsoGameCharacter character) {
 // TODO: Implement fillContainerType
}

InventoryItem ItemPickerJava::tryAddItemToContainer(ItemContainer container, const std::string& itemType, ItemPickerJava.ItemPickerContainer containerDist) {
...
void ItemPickerJava::checkStashItem(InventoryItem item, ItemPickerJava.ItemPickerContainer itemPickerContainer) {
 // TODO: Implement checkStashItem
}

void ItemPickerJava::rollContainerItem(InventoryContainer bag, IsoGameCharacter character, ItemPickerJava.ItemPickerContainer containerDist) {
