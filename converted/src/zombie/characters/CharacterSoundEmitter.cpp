...
public
CharacterSoundEmitter::CharacterSoundEmitter(IsoGameCharacter chr) {
...
void CharacterSoundEmitter::playFootsteps(const std::string &file,
                                          float volume) {
...
long CharacterSoundEmitter::playSoundImpl(const std::string &file,
                                          IsoObject proxy) {
...
void CharacterSoundEmitter::setParameterValue(
