...
public BaseAction::BaseAction(IsoGameCharacter _chr) {
...
void BaseAction::PlayLoopedSoundTillComplete(const std::string& name, int radius, float maxGain) {
...
void BaseAction::setAnimVariable(const std::string& key, const std::string& val) {
...
void BaseAction::setOverrideHandModels(InventoryItem primaryHand, InventoryItem secondaryHand) {
 // TODO: Implement setOverrideHandModels
}

void BaseAction::setOverrideHandModels(InventoryItem primaryHand, InventoryItem secondaryHand, bool resetModel) {
 // TODO: Implement setOverrideHandModels
}

void BaseAction::setOverrideHandModelsString(const std::string& primaryHand, const std::string& secondaryHand) {
 // TODO: Implement setOverrideHandModelsString
}

void BaseAction::setOverrideHandModelsString(const std::string& primaryHand, const std::string& secondaryHand, bool resetModel) {
 // TODO: Implement setOverrideHandModelsString
}

void BaseAction::setOverrideHandModelsObject(void* primaryHand, void* secondaryHand, bool resetModel) {
