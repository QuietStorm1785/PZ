...
public BodyLocationGroup::BodyLocationGroup(const std::string& _id) {
...
BodyLocation BodyLocationGroup::getLocationNotNull(const std::string& locationId) {
 // TODO: Implement getLocationNotNull
 return nullptr;
}

BodyLocation BodyLocationGroup::getOrCreateLocation(const std::string& locationId) {
...
void BodyLocationGroup::setExclusive(const std::string& firstId, const std::string& secondId) {
 // TODO: Implement setExclusive
}

bool BodyLocationGroup::isExclusive(const std::string& firstId, const std::string& secondId) {
 // TODO: Implement isExclusive
 return false;
}

void BodyLocationGroup::setHideModel(const std::string& firstId, const std::string& secondId) {
 // TODO: Implement setHideModel
}

bool BodyLocationGroup::isHideModel(const std::string& firstId, const std::string& secondId) {
...
void BodyLocationGroup::setMultiItem(const std::string& locationId, bool bMultiItem) {
