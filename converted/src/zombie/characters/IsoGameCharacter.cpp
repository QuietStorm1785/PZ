...
public IsoGameCharacter::IsoGameCharacter(IsoCell cell, float x, float y, float z) {
...
void IsoGameCharacter::onTrigger_setClothingToXmlTriggerFile(TriggerXmlFile triggerXmlFile) {
 // TODO: Implement onTrigger_setClothingToXmlTriggerFile
}

void IsoGameCharacter::onTrigger_setAnimStateToTriggerFile(AnimStateTriggerXmlFile animStateTriggerXmlFile) {
...
void IsoGameCharacter::onCullStateChanged(ModelManager modelManager, bool isCulled) {
...
void IsoGameCharacter::DoDeath(HandWeapon weapon, IsoGameCharacter wielder, bool bGory) {
 // TODO: Implement DoDeath
}
...
float IsoGameCharacter::getDotWithForwardDirection(float targetX, float targetY) {
 // TODO: Implement getDotWithForwardDirection
 return 0;
}
...
void IsoGameCharacter::setEquipParent(InventoryItem item0, InventoryItem item1) {
...
void IsoGameCharacter::setWornItem(const std::string& location, InventoryItem item) {
 // TODO: Implement setWornItem
}

void IsoGameCharacter::setWornItem(const std::string& location, InventoryItem item, bool forceDropTooHeavy) {
 // TODO: Implement setWornItem
}
...
void IsoGameCharacter::removeWornItem(InventoryItem item, bool forceDropTooHeavy) {
 // TODO: Implement removeWornItem
}
...
void IsoGameCharacter::setAttachedItem(const std::string& location, InventoryItem item) {
...
void IsoGameCharacter::setAttackTargetSquare(IsoGridSquare _attackTargetSquare) {
...
void IsoGameCharacter::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoGameCharacter::PlayAnimWithSpeed(const std::string& string, float framesSpeedPerFrame) {
...
float IsoGameCharacter::Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit, bool bIgnoreDamage, float modDelta) {
 // TODO: Implement Hit
 return 0;
}

float IsoGameCharacter::Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit, bool bIgnoreDamage, float modDelta, bool bRemote) {
 // TODO: Implement Hit
 return 0;
}

float IsoGameCharacter::processHitDamage(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit, bool bIgnoreDamage, float modDelta) {
 // TODO: Implement processHitDamage
 return 0;
}

void IsoGameCharacter::hitConsequences(HandWeapon weapon, IsoGameCharacter wielder, bool bIgnoreDamage, float damage, bool bRemote) {
...
bool IsoGameCharacter::IsAttackRange(HandWeapon we, IsoMovingObject obj, Vector3 bonePos, bool extraRange) {
 // TODO: Implement IsAttackRange
 return false;
}
...
void IsoGameCharacter::MoveForward(float dist, float x, float y, float soundDelta) {
...
void IsoGameCharacter::render(float x, float y, float z, ColorInfo col, bool bDoChild, bool bWallLightingPass, Shader shader) {
...
void IsoGameCharacter::renderObjectPicker(float x, float y, float z, ColorInfo _lightInfo) {
 // TODO: Implement renderObjectPicker
}

Vector2 IsoGameCharacter::closestpointonline(double double4, double double2, double double5, double double1, double double9, double double8, Vector2 vector) {
...
void IsoGameCharacter::setHaloNote(const std::string& str, int r, int g, int b, float dispTime) {
 // TODO: Implement setHaloNote
}
...
void IsoGameCharacter::Say(const std::string& line, float r, float g, float b, UIFont font, float baseRange, const std::string& customTag) {
 // TODO: Implement Say
}
...
void IsoGameCharacter::SayRadio(const std::string& line, float r, float g, float b, UIFont font, float baseRange, int channel, const std::string& customTag) {
 // TODO: Implement SayRadio
}

void IsoGameCharacter::ProcessSay(const std::string& string0, float float0, float float1, float float2, float float3, int int0, const std::string& string1) {
...
void IsoGameCharacter::addLineChatElement(const std::string& line, float r, float g, float b) {
 // TODO: Implement addLineChatElement
}

void IsoGameCharacter::addLineChatElement(const std::string& line, float r, float g, float b, UIFont font, float baseRange, const std::string& customTag) {
 // TODO: Implement addLineChatElement
}
...
void IsoGameCharacter::drawDirectionLine(Vector2 dir, float length, float r, float g, float b) {
...
void IsoGameCharacter::recursiveItemUpdater(InventoryContainer inventoryContainer) {
 // TODO: Implement recursiveItemUpdater
}
...
float IsoGameCharacter::calcRunSpeedModByBag(InventoryContainer inventoryContainer) {
...
void IsoGameCharacter::DoFloorSplat(IsoGridSquare sq, const std::string& id, bool bFlip, float offZ, float alpha) {
 // TODO: Implement DoFloorSplat
}

void IsoGameCharacter::DoSplat(IsoGridSquare square, const std::string& string, bool boolean0, IsoFlagType flagType, float float0, float float1, float float2) {
...
void IsoGameCharacter::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
void IsoGameCharacter::setAlreadyReadPages(const std::string& fullType, int pages) {
...
void IsoGameCharacter::addWorldSoundUnlessInvisible(int radius, int volume, bool bStressHumans) {
...
float IsoGameCharacter::Hit(BaseVehicle _vehicle, float speed, bool isHitFromBehind, float hitDirX, float hitDirY) {
 // TODO: Implement Hit
 return 0;
}
...
IAnimationVariableSlot IsoGameCharacter::getVariable(AnimationVariableHandle handle) {
...
IAnimationVariableSlot IsoGameCharacter::getOrCreateVariable(const std::string& key) {
...
void IsoGameCharacter::setVariable(const std::string& key, const std::string& value) {
 // TODO: Implement setVariable
}
...
void IsoGameCharacter::setVariable(const std::string& string, AnimationVariableSlotCallbackBool.CallbackGetStrongTyped callbackGetStrongTyped) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& string, AnimationVariableSlotCallbackString.CallbackGetStrongTyped callbackGetStrongTyped) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& string, AnimationVariableSlotCallbackFloat.CallbackGetStrongTyped callbackGetStrongTyped) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& string, AnimationVariableSlotCallbackInt.CallbackGetStrongTyped callbackGetStrongTyped) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& key, bool defaultVal, AnimationVariableSlotCallbackBool.CallbackGetStrongTyped callbackGet) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& key, const std::string& defaultVal, AnimationVariableSlotCallbackString.CallbackGetStrongTyped callbackGet) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& key, float defaultVal, AnimationVariableSlotCallbackFloat.CallbackGetStrongTyped callbackGet) {
 // TODO: Implement setVariable
}

void IsoGameCharacter::setVariable(const std::string& key, int defaultVal, AnimationVariableSlotCallbackInt.CallbackGetStrongTyped callbackGet) {
 // TODO: Implement setVariable
}
...
float IsoGameCharacter::getVariableFloat(const std::string& name, float defaultVal) {
...
bool IsoGameCharacter::getVariableBoolean(const std::string& key, bool defaultVal) {
 // TODO: Implement getVariableBoolean
 return false;
}

bool IsoGameCharacter::isVariable(const std::string& name, const std::string& val) {
...
void IsoGameCharacter::endPlaybackGameVariables(AnimationVariableSource playbackVars) {
 // TODO: Implement endPlaybackGameVariables
}

void IsoGameCharacter::playbackSetCurrentStateSnapshot(ActionStateSnapshot snapshot) {
...
void IsoGameCharacter::StartTimedActionAnim(const std::string& event, const std::string& type) {
 // TODO: Implement StartTimedActionAnim
}
...
void IsoGameCharacter::addDirt(BloodBodyPartType part, int nbr, bool allLayers) {
 // TODO: Implement addDirt
}

void IsoGameCharacter::addBlood(BloodBodyPartType part, bool scratched, bool bitten, bool allLayers) {
 // TODO: Implement addBlood
}

float IsoGameCharacter::getBodyPartClothingDefense(int part, bool bite, bool bullet) {
...
void IsoGameCharacter::setTextureCreator(ModelInstanceTextureCreator _textureCreator) {
...
ItemVisual IsoGameCharacter::addBodyVisualFromItemType(const std::string& string) {
 // TODO: Implement addBodyVisualFromItemType
 return nullptr;
}

ItemVisual IsoGameCharacter::addBodyVisualFromClothingItemName(const std::string& string1) {
...
bool IsoGameCharacter::addHoleFromZombieAttacks(BloodBodyPartType part, bool scratch) {
...
bool IsoGameCharacter::DoSwingCollisionBoneCheck(IsoGameCharacter zombie, int bone, float tempoLengthTest) {
...
void IsoGameCharacter::addActiveLightItem(InventoryItem item, ArrayList<InventoryItem> arrayList) {
...
void IsoGameCharacter::startEvent(long eventInstance, GameSoundClip clip, BitSet parameterSet) {
...
void IsoGameCharacter::stopEvent(long eventInstance, GameSoundClip clip, BitSet parameterSet) {
...
void IsoGameCharacter::doHitByVehicle(BaseVehicle baseVehicle, BaseVehicle.HitVars hitVars) {
...
float IsoGameCharacter::calcHitDir(IsoGameCharacter wielder, HandWeapon weapon, Vector2 out) {
...
void IsoGameCharacter::addBandageModel(IsoGameCharacter character, const std::string& string) {
 // TODO: Implement addBandageModel
}

void IsoGameCharacter::removeBandageModel(IsoGameCharacter character, const std::string& string) {
...
public IsoGameCharacter::Location(int _x, int _y, int _z) {
 // TODO: Implement Location
 return nullptr;
}
...
public IsoGameCharacter::XP(IsoGameCharacter character1) {
 // TODO: Implement XP
 return nullptr;
}
...
void IsoGameCharacter::addXpMultiplier(PerkFactory.Perk perks, float multiplier, int minLevel, int maxLevel) {
...
void IsoGameCharacter::AddXP(PerkFactory.Perk type, float amount, bool callLua, bool doXPBoost, bool remote) {
 // TODO: Implement AddXP
}

bool IsoGameCharacter::isSkillExcludedFromSpeedReduction(PerkFactory.Perk perk) {
