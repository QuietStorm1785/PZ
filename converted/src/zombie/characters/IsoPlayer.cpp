...
public IsoPlayer::IsoPlayer(IsoCell cell) {
 // TODO: Implement IsoPlayer
 return nullptr;
}

public IsoPlayer::IsoPlayer(IsoCell cell, SurvivorDesc desc, int x, int y, int z) {
 // TODO: Implement IsoPlayer
 return nullptr;
}
...
void IsoPlayer::render(float x, float y, float z, ColorInfo col, bool bDoChild, bool bWallLightingPass, Shader shader) {
...
int IsoPlayer::compare(IsoGameCharacter character0, IsoGameCharacter character1) {
 // TODO: Implement compare
 return 0;
}

void IsoPlayer::hitConsequences(HandWeapon weapon, IsoGameCharacter wielder, bool bIgnoreDamage, float damage, bool _bRemote) {
...
IsoObject IsoPlayer::getContextDoorOrWindowOrWindowFrame(IsoDirections assumedDir) {
 // TODO: Implement getContextDoorOrWindowOrWindowFrame
 return nullptr;
}

void IsoPlayer::doContextDoorOrWindowOrWindowFrame(IsoDirections directions, IsoObject object) {
...
bool IsoPlayer::DoAttack(float chargeDelta, bool forceShove, const std::string& clickSound) {
 // TODO: Implement DoAttack
 return false;
}
...
ByteBufferWriter IsoPlayer::createPlayerStats(ByteBufferWriter b, const std::string& adminUsername) {
 // TODO: Implement createPlayerStats
 return nullptr;
}

std::string IsoPlayer::setPlayerStats(ByteBuffer bb, const std::string& adminUsername) {
...
void IsoPlayer::addMechanicsItem(const std::string& itemid, VehiclePart part, long milli) {
...
void IsoPlayer::addWorldSoundUnlessInvisible(int radius, int volume, bool bStressHumans) {
...
float IsoPlayer::Hit(BaseVehicle vehicle, float speed, bool isHitFromBehind, float hitDirX, float hitDirY) {
 // TODO: Implement Hit
 return 0;
}
