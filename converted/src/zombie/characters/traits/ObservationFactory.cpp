...
void ObservationFactory::setMutualExclusive(const std::string& a, const std::string& b) {
 // TODO: Implement setMutualExclusive
}

void ObservationFactory::addObservation(const std::string& type, const std::string& name, const std::string& desc) {
 // TODO: Implement addObservation
}

public ObservationFactory::Observation(const std::string& tr, const std::string& _name, const std::string& desc) {
