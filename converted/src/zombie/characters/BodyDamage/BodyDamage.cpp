...
public BodyDamage::BodyDamage(IsoGameCharacter ParentCharacter) {
...
bool BodyDamage::AddRandomDamageFromZombie(IsoZombie zombie, const std::string& hitReaction) {
...
bool BodyDamage::doBodyPartsHaveInjuries(BodyPartType partA, BodyPartType partB) {
...
void BodyDamage::DrawUntexturedQuad(int X, int Y, int Width, int Height, float r, float g, float b, float a) {
...
void BodyDamage::SetBandaged(int BodyPartIndex, bool Bandaged, float bandageLife, bool isAlcoholic, const std::string& bandageType) {
...
void BodyDamage::SetBleedingStemmed(BodyPartType BodyPart, bool BleedingStemmed) {
...
void BodyDamage::setSeverlyReducedHealthAddition(float _SeverlyReducedHealthAddition) {
...
void BodyDamage::setHealthReductionFromSevereBadMoodles(float _HealthReductionFromSevereBadMoodles) {
...
void BodyDamage::setStandardHealthFromFoodTime(int _StandardHealthFromFoodTime) {
...
void BodyDamage::setBoredomDecreaseFromReading(float _BoredomDecreaseFromReading) {
...
void BodyDamage::setStandardPainReductionWhenWell(float _StandardPainReductionWhenWell) {
