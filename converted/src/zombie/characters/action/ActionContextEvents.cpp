...
bool ActionContextEvents::contains(const std::string& name, int layer, bool bAgnosticLayer) {
 // TODO: Implement contains
 return false;
}
...
void ActionContextEvents::releaseEvent(ActionContextEvents.Event event1, ActionContextEvents.Event event0) {
