...
bool ActionTransition::parse(Element element, const std::string& string, List<ActionTransition> list) {
 // TODO: Implement parse
 return false;
}

void ActionTransition::parseTransition(Element element, List<ActionTransition> list) {
 // TODO: Implement parseTransition
}

void ActionTransition::parseTransitions(Element element, const std::string& string, List<ActionTransition> list) {
