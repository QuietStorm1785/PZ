...
public NetworkCharacterAI::NetworkCharacterAI(IsoGameCharacter _character) {
...
void NetworkCharacterAI::setTeleportDebug(NetworkTeleport.NetworkTeleportDebug _teleportDebug) {
 // TODO: Implement setTeleportDebug
}

void NetworkCharacterAI::addTeleportData(int time, const std::string& prediction) {
...
void NetworkCharacterAI::setOverride(bool override, const std::string& primaryHandModel, const std::string& secondaryHandModel) {
...
bool NetworkCharacterAI::checkPosition(UdpConnection connection, IsoGameCharacter _character, float x, float y) {
