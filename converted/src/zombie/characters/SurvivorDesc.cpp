...
void SurvivorDesc::setWornItem(const std::string& bodyLocation, InventoryItem item) {
...
void SurvivorDesc::setProfessionSkills(ProfessionFactory.Profession profession) {
...
public SurvivorDesc::SurvivorDesc(bool bNew) {
 // TODO: Implement SurvivorDesc
 return nullptr;
}

public SurvivorDesc::SurvivorDesc(SurvivorDesc other) {
 // TODO: Implement SurvivorDesc
 return nullptr;
}
...
void SurvivorDesc::load(ByteBuffer input, int WorldVersion, IsoGameCharacter chr) {
 // TODO: Implement load
}
