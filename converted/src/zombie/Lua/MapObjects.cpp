...
void MapObjects::OnNewWithSprite(const std::string& spriteName, LuaClosure __function__, int priority) {
 // TODO: Implement OnNewWithSprite
}

void MapObjects::OnNewWithSprite(KahluaTable spriteNames, LuaClosure __function__, int priority) {
 // TODO: Implement OnNewWithSprite
}
...
void MapObjects::OnLoadWithSprite(const std::string& spriteName, LuaClosure __function__, int priority) {
 // TODO: Implement OnLoadWithSprite
}

void MapObjects::OnLoadWithSprite(KahluaTable spriteNames, LuaClosure __function__, int priority) {
 // TODO: Implement OnLoadWithSprite
}
