...
void ScriptManager::searchFolders(URI base, File fo, ArrayList<String> loadList) {
...
ScriptModule ScriptManager::getModule(const std::string& name, bool defaultToBase) {
 // TODO: Implement getModule
 return nullptr;
}
...
Item ScriptManager::FindItem(const std::string& name, bool moduleDefaultsToBase) {
 // TODO: Implement FindItem
 return nullptr;
}
...
SoundTimelineScript ScriptManager::getSoundTimeline(const std::string& eventName) {
...
int ScriptManager::compare(const std::string& string1, const std::string& string3) {
...
std::string ScriptManager::getItemTypeForClothingItem(const std::string& clothingItem) {
...
std::string ScriptManager::resolveItemType(ScriptModule module, const std::string& itemType) {
 // TODO: Implement resolveItemType
 return "";
}

std::string ScriptManager::resolveModelScript(ScriptModule module, const std::string& modelScriptName) {
