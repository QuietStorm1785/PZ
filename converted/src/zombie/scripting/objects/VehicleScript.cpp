...
void VehicleScript::Load(const std::string& _name, const std::string& totalFile) {
 // TODO: Implement Load
}
...
KahluaTable VehicleScript::LoadTable(ScriptParser.Block block0, KahluaTable table1) {
...
void VehicleScript::copyAreasFrom(VehicleScript other, const std::string& spec) {
 // TODO: Implement copyAreasFrom
}

void VehicleScript::copyPartsFrom(VehicleScript other, const std::string& spec) {
 // TODO: Implement copyPartsFrom
}

void VehicleScript::copyPassengersFrom(VehicleScript other, const std::string& spec) {
 // TODO: Implement copyPassengersFrom
}

void VehicleScript::copyWheelsFrom(VehicleScript other, const std::string& spec) {
...
ModelAttachment VehicleScript::addAttachmentAt(int index, ModelAttachment attach) {
...
bool VehicleScript::globMatch(const std::string& pattern, const std::string& str) {
