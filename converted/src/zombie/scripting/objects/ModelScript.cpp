...
ModelAttachment ModelScript::addAttachmentAt(int index, ModelAttachment attach) {
...
void ModelScript::checkMesh(const std::string& string2, const std::string& string0) {
 // TODO: Implement checkMesh
}

void ModelScript::checkTexture(const std::string& string2, const std::string& string0) {
 // TODO: Implement checkTexture
}

void ModelScript::check(const std::string& string0, const std::string& string1) {
 // TODO: Implement check
}

void ModelScript::check(const std::string& string1, const std::string& string0, const std::string& string2) {
 // TODO: Implement check
}
