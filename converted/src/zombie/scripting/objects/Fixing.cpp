...
InventoryItem Fixing::haveThisFixer(IsoGameCharacter chr, Fixing.Fixer fixer, InventoryItem brokenObject) {
 // TODO: Implement haveThisFixer
 return nullptr;
}

int Fixing::countUses(IsoGameCharacter chr, Fixing.Fixer fixer, InventoryItem brokenObject) {
...
public Fixing::Fixer(const std::string& name, LinkedList<Fixing.FixerSkill> _skills, int _numberOfUse) {
...
public Fixing::FixerSkill(const std::string& _skillName, int _skillLvl) {
