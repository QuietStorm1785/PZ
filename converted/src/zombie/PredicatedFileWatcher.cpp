...
public PredicatedFileWatcher::PredicatedFileWatcher(Predicate<String> predicate, PredicatedFileWatcher.IPredicatedFileWatcherCallback callback) {
 // TODO: Implement PredicatedFileWatcher
 return nullptr;
}

public PredicatedFileWatcher::PredicatedFileWatcher(const std::string& path, PredicatedFileWatcher.IPredicatedFileWatcherCallback callback) {
 // TODO: Implement PredicatedFileWatcher
 return nullptr;
}

public PredicatedFileWatcher::PredicatedFileWatcher(const std::string& path, Predicate<String> predicate, PredicatedFileWatcher.IPredicatedFileWatcherCallback callback) {
 // TODO: Implement PredicatedFileWatcher
 return nullptr;
}
