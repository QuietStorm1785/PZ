...
protected
TemplateTextBuilder::TemplateTextBuilder() {
...
std::string TemplateTextBuilder::Build(const std::string &string1,
                                       KahluaTableImpl kahluaTableImpl) {
  // TODO: Implement Build
  return "";
}

std::string TemplateTextBuilder::format(const std::string &string0,
                                        IReplaceProvider iReplaceProvider) {
  // TODO: Implement format
  return "";
}

void TemplateTextBuilder::RegisterKey(const std::string &string,
                                      KahluaTableImpl kahluaTableImpl) {
...
void TemplateTextBuilder::localRegisterKey(const std::string &string,
                                           IReplace iReplace) {
