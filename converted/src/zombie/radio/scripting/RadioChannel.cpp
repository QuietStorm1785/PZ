...
public RadioChannel::RadioChannel(const std::string& n, int freq, ChannelCategory c) {
 // TODO: Implement RadioChannel
 return nullptr;
}

public RadioChannel::RadioChannel(const std::string& n, int freq, ChannelCategory c, const std::string& guid) {
 // TODO: Implement RadioChannel
 return nullptr;
}
...
void RadioChannel::setActiveScript(const std::string& scriptName, int day, int loop, int maxloops) {
 // TODO: Implement setActiveScript
}
