...
public DeviceData::DeviceData(WaveSignalDevice _parent) {
 // TODO: Implement DeviceData
 return nullptr;
}
...
void DeviceData::playSoundSend(const std::string& soundname, bool useDeviceVolume) {
 // TODO: Implement playSoundSend
}

void DeviceData::playSoundLocal(const std::string& soundname, bool useDeviceVolume) {
 // TODO: Implement playSoundLocal
}

void DeviceData::playSound(const std::string& soundname, float volume, bool transmit) {
...
void DeviceData::transmitDeviceDataStateServer(short short0, UdpConnection udpConnection1) {
 // TODO: Implement transmitDeviceDataStateServer
}

void DeviceData::sendDeviceDataStatePacket(UdpConnection udpConnection, short short0) {
 // TODO: Implement sendDeviceDataStatePacket
}

void DeviceData::receiveDeviceDataStatePacket(ByteBuffer bb, UdpConnection ignoreConnection) {
