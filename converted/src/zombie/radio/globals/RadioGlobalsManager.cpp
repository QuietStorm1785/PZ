...
bool RadioGlobalsManager::addGlobal(const std::string& string, RadioGlobal radioGlobal) {
 // TODO: Implement addGlobal
 return false;
}

bool RadioGlobalsManager::addGlobalString(const std::string& string0, const std::string& string1) {
 // TODO: Implement addGlobalString
 return false;
}

bool RadioGlobalsManager::addGlobalBool(const std::string& string, bool boolean0) {
...
bool RadioGlobalsManager::addGlobalFloat(const std::string& string, float float0) {
...
RadioGlobalString RadioGlobalsManager::getGlobalString(const std::string& string) {
...
RadioGlobalFloat RadioGlobalsManager::getGlobalFloat(const std::string& string) {
...
bool RadioGlobalsManager::setGlobal(const std::string& string, RadioGlobal radioGlobal1, EditGlobalOps editGlobalOps) {
 // TODO: Implement setGlobal
 return false;
}

bool RadioGlobalsManager::setGlobal(const std::string& string1, const std::string& string0) {
 // TODO: Implement setGlobal
 return false;
}
...
CompareResult RadioGlobalsManager::compare(RadioGlobal radioGlobal0, RadioGlobal radioGlobal1, CompareMethod compareMethod) {
 // TODO: Implement compare
 return nullptr;
}

CompareResult RadioGlobalsManager::compare(const std::string& string1, const std::string& string0, CompareMethod compareMethod) {
 // TODO: Implement compare
 return nullptr;
}
