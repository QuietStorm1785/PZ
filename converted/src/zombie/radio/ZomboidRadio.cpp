...
void ZomboidRadio::addChannelName(const std::string& name, int frequency, const std::string& category) {
 // TODO: Implement addChannelName
}

void ZomboidRadio::addChannelName(const std::string& name, int frequency, const std::string& category, bool overwrite) {
 // TODO: Implement addChannelName
}
...
void ZomboidRadio::addFrequencyListEntry(bool boolean0, DeviceData deviceData, int int0, int int1) {
...
bool ZomboidRadio::DeviceInRange(int int3, int int1, int int4, int int2, int int0) {
...
std::string ZomboidRadio::doDeviceRangeDistortion(const std::string& string, int int0, int int1) {
...
std::string ZomboidRadio::applyWeatherInterference(const std::string& string, int int1) {
 // TODO: Implement applyWeatherInterference
 return "";
}

std::string ZomboidRadio::scrambleString(const std::string& string, int int0, bool boolean0) {
 // TODO: Implement scrambleString
 return "";
}

std::string ZomboidRadio::scrambleString(const std::string& msg, int intensity, bool ignoreBBcode, const std::string& customScramble) {
 // TODO: Implement scrambleString
 return "";
}

void ZomboidRadio::SendTransmission(int sourceX, int sourceY, ChatMessage msg, int signalStrength) {
 // TODO: Implement SendTransmission
}

void ZomboidRadio::PlayerListensChannel(int channel, bool listenmode, bool isTV) {
...
public ZomboidRadio::FreqListEntry(bool boolean0, DeviceData deviceDatax, int int0, int int1) {
