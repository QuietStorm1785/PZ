...
MediaData RecordedMedia::register(const std::string& category, const std::string& id, const std::string& itemDisplayName, int spawning) {
...
bool RecordedMedia::hasListenedToLine(IsoPlayer player, const std::string& guid) {
