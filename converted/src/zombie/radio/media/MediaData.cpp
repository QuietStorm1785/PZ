...
public MediaData::MediaData(const std::string& _id, const std::string& _itemDisplayName, int _spawning) {
 // TODO: Implement MediaData
 return nullptr;
}

void MediaData::addLine(const std::string& text, float r, float g, float b, const std::string& codes) {
...
public MediaData::MediaLineData(const std::string& _text, float r, float g, float b, const std::string& _codes) {
