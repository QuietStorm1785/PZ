...
void IGLFramebufferObject::glFramebufferTexture2D(int target, int attachment, int textarget, int texture, int level) {
...
void IGLFramebufferObject::glRenderbufferStorage(int target, int internalformat, int width, int height) {
 // TODO: Implement glRenderbufferStorage
}

void IGLFramebufferObject::glFramebufferRenderbuffer(int target, int attachment, int renderbuffertarget, int renderbuffer) {
