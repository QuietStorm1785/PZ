...
public ImageData::ImageData(TextureID texture, WrappedBuffer bb) {
 // TODO: Implement ImageData
 return nullptr;
}

public ImageData::ImageData(const std::string& path) {
 // TODO: Implement ImageData
 return nullptr;
}

public ImageData::ImageData(int _width, int _height) {
 // TODO: Implement ImageData
 return nullptr;
}

public ImageData::ImageData(int _width, int _height, WrappedBuffer _data) {
 // TODO: Implement ImageData
 return nullptr;
}

public ImageData::ImageData(BufferedInputStream b, bool bDoMask, Texture.PZFileformat format) {
 // TODO: Implement ImageData
 return nullptr;
}

public ImageData::ImageData(InputStream b, bool bDoMask) {
 // TODO: Implement ImageData
 return nullptr;
}
...
void ImageData::makeTransp(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha) {
 // TODO: Implement makeTransp
}
...
void ImageData::scaleMipLevelMaxAlpha(MipMapLevel mipMapLevel1, MipMapLevel mipMapLevel0, int int6) {
 // TODO: Implement scaleMipLevelMaxAlpha
}

void ImageData::scaleMipLevelAverage(MipMapLevel mipMapLevel1, MipMapLevel mipMapLevel0, int int7) {
...
int ImageData::sampleNeighborPixelDiscard(ByteBuffer byteBuffer, int int3, int int1, int int2, int int0, int[] ints0, int[] ints1) {
 // TODO: Implement sampleNeighborPixelDiscard
 return 0;
}

int ImageData::getPixelDiscard(ByteBuffer byteBuffer, int int3, int int1, int int2, int int0, int[] ints) {
 // TODO: Implement getPixelDiscard
 return 0;
}

void ImageData::setPixel(ByteBuffer byteBuffer, int int3, int var2, int int1, int int2, int[] ints) {
