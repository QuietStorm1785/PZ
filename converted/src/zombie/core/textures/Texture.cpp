...
public Texture::Texture(AssetPath path, AssetManager manager, Texture.TextureAssetParams params) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(TextureID data, const std::string& _name) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& file) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& _name, BufferedInputStream b, bool bDoMask, Texture.PZFileformat format) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& _name, BufferedInputStream b, bool bDoMask) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& file, bool bDelete, bool bUseAlpha) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& _name, const std::string& palette) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& string, int[] ints) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& file, bool useAlphaChannel) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(int _width, int _height, const std::string& _name, int flags) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(int _width, int _height, int flags) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(const std::string& file, int red, int green, int blue) {
 // TODO: Implement Texture
 return nullptr;
}

public Texture::Texture(Texture t) {
 // TODO: Implement Texture
 return nullptr;
}
...
void Texture::initEngineMipmapTextureLevel(int int7, int int0, int int1, int int3, int int4, int int5, int int6) {
...
void Texture::setSharedTextureInternal(const std::string& string, Texture texture) {
 // TODO: Implement setSharedTextureInternal
}

Texture Texture::getSharedTextureInternal(const std::string& string0, int int0) {
 // TODO: Implement getSharedTextureInternal
 return nullptr;
}

Texture Texture::getSharedTexture(const std::string& _name, const std::string& palette) {
 // TODO: Implement getSharedTexture
 return nullptr;
}

Texture Texture::getSharedTexture(const std::string& string0, int[] ints, const std::string& string1) {
 // TODO: Implement getSharedTexture
 return nullptr;
}
...
void Texture::copyMaskRegion(Texture from, int x, int y, int _width, int _height) {
...
void Texture::render(float x, float y, float _width, float _height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 // TODO: Implement render
}

void Texture::renderdiamond(float x, float y, float _width, float _height, int l, int u, int r, int d) {
 // TODO: Implement renderdiamond
}

void Texture::renderwallnw(float x, float y, float _width, float _height, int u, int d, int u2, int d2, int r, int r2) {
 // TODO: Implement renderwallnw
}

void Texture::renderwallw(float x, float y, float _width, float _height, int u, int d, int u2, int d2) {
 // TODO: Implement renderwallw
}

void Texture::renderwalln(float x, float y, float _width, float _height, int u, int d, int u2, int d2) {
 // TODO: Implement renderwalln
}

void Texture::renderstrip(int x, int y, int _width, int _height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
...
Texture Texture::split(const std::string& _name, int xOffset, int yOffset, int _width, int _height) {
 // TODO: Implement split
 return nullptr;
}
