...
public HumanVisual::HumanVisual(IHumanVisual _owner) {
...
void HumanVisual::dressInNamedOutfit(const std::string& outfitName, ItemVisuals itemVisuals) {
 // TODO: Implement dressInNamedOutfit
}

void HumanVisual::dressInClothingItem(const std::string& itemGUID, ItemVisuals itemVisuals) {
 // TODO: Implement dressInClothingItem
}

void HumanVisual::dressInClothingItem(const std::string& itemGUID, ItemVisuals itemVisuals, bool clearCurrentVisuals) {
 // TODO: Implement dressInClothingItem
}
...
ItemVisual HumanVisual::addBodyVisualFromClothingItemName(const std::string& clothingItemName) {
 // TODO: Implement addBodyVisualFromClothingItemName
 return nullptr;
}

ItemVisual HumanVisual::removeBodyVisualFromItemType(const std::string& itemType) {
...
void HumanVisual::getItemVisualLocations(ItemVisuals itemVisuals, ArrayList<String> arrayList) {
 // TODO: Implement getItemVisualLocations
}

ItemVisual HumanVisual::addClothingItem(ItemVisuals itemVisuals, Item scriptItem) {
 // TODO: Implement addClothingItem
 return nullptr;
}

ItemVisual HumanVisual::addClothingItem(ItemVisuals itemVisuals, ArrayList<String> arrayList, const std::string& string0, ClothingItemReference clothingItemReference) {
 // TODO: Implement addClothingItem
 return nullptr;
}
...
StringBuilder HumanVisual::toString(ImmutableColor immutableColor, StringBuilder stringBuilder) {
