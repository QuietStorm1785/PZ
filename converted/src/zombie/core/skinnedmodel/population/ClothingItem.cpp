...
public
ClothingItem::ClothingItem(AssetPath path, AssetManager assetManager) {
...
void ClothingItem::tryGetCombinedMask(ClothingItemReference itemRef,
                                      CharacterMask in_out_mask) {
  // TODO: Implement tryGetCombinedMask
}

void ClothingItem::tryGetCombinedMask(ClothingItem item,
                                      CharacterMask in_out_mask) {
  // TODO: Implement tryGetCombinedMask
}
