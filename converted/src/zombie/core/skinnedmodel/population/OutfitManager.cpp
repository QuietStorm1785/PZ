...
void OutfitManager::addClothingItemListener(IClothingItemListener iClothingItemListener) {
 // TODO: Implement addClothingItemListener
}

void OutfitManager::removeClothingItemListener(IClothingItemListener iClothingItemListener) {
...
Outfit OutfitManager::GetSpecificOutfit(bool boolean0, const std::string& string) {
 // TODO: Implement GetSpecificOutfit
 return nullptr;
}

OutfitManager OutfitManager::tryParse(const std::string& string0, const std::string& string1) {
...
OutfitManager OutfitManager::parse(const std::string& string0, const std::string& string1) {
 // TODO: Implement parse
 return nullptr;
}

void OutfitManager::tryWrite(OutfitManager outfitManager, const std::string& string) {
 // TODO: Implement tryWrite
}

void OutfitManager::write(OutfitManager outfitManager, const std::string& string) {
...
Outfit OutfitManager::FindOutfit(ArrayList<Outfit> arrayList, const std::string& string) {
...
void OutfitManager::onClothingItemFileChanged(OutfitManager.ClothingItemEntry clothingItemEntry) {
