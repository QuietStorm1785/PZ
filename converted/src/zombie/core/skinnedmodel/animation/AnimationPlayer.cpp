...
float AnimationPlayer::lerpBlendWeight(float from, float to,
                                       float fadeTimeTo1) {
...
void AnimationPlayer::addBoneReparent(const std::string &boneName,
...
int AnimationPlayer::getSkinningBoneIndex(const std::string &boneName,
                                          int defaultVal) {
...
AnimationTrack AnimationPlayer::startClip(AnimationClip animationClip,
                                          bool boolean0) {
...
void AnimationPlayer::updateAnimation_SharedSkeleTrack(
...
void AnimationPlayer::updateBoneAnimationTransform(
    int int0, AnimationBoneBindingPair animationBoneBindingPair) {
  // TODO: Implement updateBoneAnimationTransform
}

void AnimationPlayer::updateBoneAnimationTransform_Internal(
...
Matrix4f AnimationPlayer::getBoneModelTransform(int boneIdx,
                                                Matrix4f out_modelTransform) {
  // TODO: Implement getBoneModelTransform
  return nullptr;
}

Matrix4f AnimationPlayer::getBoneTransform(int boneIdx,
...
Matrix4f
AnimationPlayer::getUnweightedModelTransform(AnimationTrack track, int boneIdx,
                                             Matrix4f out_modelTransform) {
...
Matrix4f
AnimationPlayer::getUnweightedBoneTransform(AnimationTrack track, int boneIdx,
                                            Matrix4f out_boneTransform) {
