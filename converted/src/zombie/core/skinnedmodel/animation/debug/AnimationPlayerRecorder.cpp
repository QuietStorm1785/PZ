...
public AnimationPlayerRecorder::AnimationPlayerRecorder(IsoGameCharacter owner) {
...
PrintStream AnimationPlayerRecorder::openFileStream(const std::string& key, bool append, Consumer<String> fileNameConsumer) {
 // TODO: Implement openFileStream
 return nullptr;
}

std::string AnimationPlayerRecorder::getTimeStampedFilePath(const std::string& string) {
 // TODO: Implement getTimeStampedFilePath
 return "";
}

std::string AnimationPlayerRecorder::getTimeStampedFileName(const std::string& string) {
...
void AnimationPlayerRecorder::logAnimWeights(List<AnimationTrack> list, int[] ints, float[] floats, Vector2 vector) {
...
void AnimationPlayerRecorder::logActionState(ActionState state, List<ActionState> childStates) {
 // TODO: Implement logActionState
}

void AnimationPlayerRecorder::logAIState(State state, List<StateMachine.SubstateSlot> subStates) {
