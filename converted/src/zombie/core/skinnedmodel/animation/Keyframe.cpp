...
public Keyframe::Keyframe(Vector3f pos, Quaternion rotation, Vector3f scale) {
 // TODO: Implement Keyframe
 return nullptr;
}
...
void Keyframe::setIdentity(Vector3f out_pos, Quaternion out_rot, Vector3f out_scale) {
 // TODO: Implement setIdentity
}

Keyframe Keyframe::lerp(Keyframe a, Keyframe b, float time, Keyframe out_result) {
 // TODO: Implement lerp
 return nullptr;
}

void Keyframe::setIfNotNull(Vector3f to, Vector3f val, float default_x, float default_y, float default_z) {
...
void Keyframe::lerp(Keyframe a, Keyframe b, float time, Vector3f out_pos, Quaternion out_rot, Vector3f out_scale) {
 // TODO: Implement lerp
}
