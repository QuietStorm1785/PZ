...
void AnimationTrack::get(int bone, Vector3f out_pos, Quaternion out_rot,
                         Vector3f out_scale) {
  // TODO: Implement get
}

Keyframe AnimationTrack::getDeferredMovementFrameAt(int int0, float float0,
                                                    Keyframe keyframe) {
...
void AnimationTrack::appendDeferredValues(
    AnimationTrack.DeferredMotionData deferredMotionData, float float0,
    float float1) {
...
Vector2 AnimationTrack::getDeferredMovement(Vector3f bonePos,
                                            Vector2 out_deferredPos) {
  // TODO: Implement getDeferredMovement
  return nullptr;
}

Vector3f
AnimationTrack::getCurrentDeferredCounterPosition(Vector3f out_result) {
...
void AnimationTrack::initWeightBinding(SkinningData skinningData,
...
AnimationTrack AnimationTrack::createClone(AnimationTrack source,
...
void AnimationTrack::lerp(float float0, Vector3f vector3f0,
