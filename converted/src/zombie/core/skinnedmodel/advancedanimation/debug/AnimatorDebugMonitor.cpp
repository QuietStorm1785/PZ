...
public AnimatorDebugMonitor::AnimatorDebugMonitor(IsoGameCharacter chr) {
...
void AnimatorDebugMonitor::queueLogLine(const std::string& string, Color color) {
 // TODO: Implement queueLogLine
}

void AnimatorDebugMonitor::queueLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color) {
 // TODO: Implement queueLogLine
}
...
void AnimatorDebugMonitor::addLogLine(const std::string& string, Color color, bool boolean0) {
 // TODO: Implement addLogLine
}

void AnimatorDebugMonitor::addLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color) {
 // TODO: Implement addLogLine
}

void AnimatorDebugMonitor::addLogLine(AnimatorDebugMonitor.LogType logType, const std::string& string, Color color, bool boolean0) {
 // TODO: Implement addLogLine
}

void AnimatorDebugMonitor::log(AnimatorDebugMonitor.MonitorLogLine monitorLogLine) {
 // TODO: Implement log
}
...
void AnimatorDebugMonitor::update(IsoGameCharacter character, AnimLayer[] animLayers) {
...
void AnimatorDebugMonitor::updateActiveNode(AnimatorDebugMonitor.MonitoredLayer monitoredLayer, const std::string& string) {
 // TODO: Implement updateActiveNode
}

void AnimatorDebugMonitor::updateAnimTrack(AnimatorDebugMonitor.MonitoredLayer monitoredLayer, const std::string& string, float float0) {
 // TODO: Implement updateAnimTrack
}

void AnimatorDebugMonitor::updateVariable(const std::string& string0, const std::string& string1) {
...
private AnimatorDebugMonitor::LogType(int int1) {
...
public AnimatorDebugMonitor::MonitoredLayer(int arg1) {
