...
LiveAnimNode LiveAnimNode::alloc(AnimLayer animLayer, AnimNode sourceNode, int layerIdx) {
...
void LiveAnimNode::startTransitionIn(LiveAnimNode transitionFrom, AnimTransition transitionIn, AnimationTrack track) {
 // TODO: Implement startTransitionIn
}

void LiveAnimNode::startTransitionIn(AnimNode transitionFrom, AnimTransition transitionIn, AnimationTrack track) {
 // TODO: Implement startTransitionIn
}
...
float LiveAnimNode::incrementBlendTime(float float1, float float2, float float3) {
...
AnimTransition LiveAnimNode::findTransitionTo(IAnimationVariableSource varSource, const std::string& name) {
