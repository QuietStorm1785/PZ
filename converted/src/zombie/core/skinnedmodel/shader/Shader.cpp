...
public Shader::Shader(const std::string& _name, bool _bStatic) {
...
void Shader::setTexture(Texture tex, const std::string& unitName, int textureUnit) {
...
void Shader::startCharacter(ModelSlotRenderData slotData, ModelInstanceRenderData instData) {
...
void Shader::setReflectionParam(float timesOfDay, float refWindows, float refBody) {
...
void Shader::setLight(int index, float x, float y, float z, float r, float g, float b, float rad, float animPlayerAngle, ModelInstance inst) {
