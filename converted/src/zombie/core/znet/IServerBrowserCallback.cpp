...
void IServerBrowserCallback::OnServerResponded(const std::string& var1, int var2) {
 // TODO: Implement OnServerResponded
}

void IServerBrowserCallback::OnServerFailedToRespond(const std::string& var1, int var2) {
 // TODO: Implement OnServerFailedToRespond
}

void IServerBrowserCallback::OnSteamRulesRefreshComplete(const std::string& var1, int var2) {
