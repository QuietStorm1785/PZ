...
bool SteamWorkshop::SubscribeItem(long long0, ISteamWorkshopCallback iSteamWorkshopCallback) {
 // TODO: Implement SubscribeItem
 return false;
}

bool SteamWorkshop::DownloadItem(long long0, bool boolean0, ISteamWorkshopCallback iSteamWorkshopCallback) {
...
long SteamWorkshop::CreateQueryUGCDetailsRequest(long[] longs, ISteamWorkshopCallback iSteamWorkshopCallback) {
...
void SteamWorkshop::RemoveCallback(ISteamWorkshopCallback iSteamWorkshopCallback) {
 // TODO: Implement RemoveCallback
}

std::string SteamWorkshop::getIDFromItemInstallFolder(const std::string& string0) {
