...
Quaternion PZMath::slerp(Quaternion result, Quaternion from, Quaternion to, float alpha) {
...
void PZMath::logResult(float float2, float float1, float float0, const std::string& string0, const std::string& string1) {
