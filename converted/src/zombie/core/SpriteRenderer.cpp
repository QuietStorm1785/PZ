...
void SpriteRenderer::renderflipped(Texture tex, float x, float y, float width, float height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
...
void SpriteRenderer::drawSkyBox(Shader shader, int playerIndex, int apiId, int bufferId) {
 // TODO: Implement drawSkyBox
}

void SpriteRenderer::drawWater(Shader shader, int playerIndex, int apiId, bool bShore) {
 // TODO: Implement drawWater
}

void SpriteRenderer::drawPuddles(Shader shader, int playerIndex, int apiId, int z) {
...
void SpriteRenderer::renderline(Texture tex, int x1, int y1, int x2, int y2, float r, float g, float b, float a, int thickness) {
 // TODO: Implement renderline
}

void SpriteRenderer::renderline(Texture tex, int x1, int y1, int x2, int y2, float r, float g, float b, float a) {
 // TODO: Implement renderline
}
...
void SpriteRenderer::render(Texture tex, float x, float y, float width, float height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 // TODO: Implement render
}

void SpriteRenderer::renderi(Texture tex, int x, int y, int width, int height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 // TODO: Implement renderi
}

void SpriteRenderer::renderRect(int x, int y, int width, int height, float r, float g, float b, float a) {
 // TODO: Implement renderRect
}

void SpriteRenderer::renderPoly(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float r, float g, float b, float a) {
 // TODO: Implement renderPoly
}

void SpriteRenderer::renderPoly(Texture tex, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float r, float g, float b, float a) {
 // TODO: Implement renderPoly
}

void SpriteRenderer::buildDrawBuffer(TextureDraw[] textureDraws, Style[] styles, int int1, SpriteRenderer.RingBuffer ringBufferx) {
...
void SpriteRenderer::buildStateUIDrawBuffer(SpriteRenderState spriteRenderState) {
...
void SpriteRenderer::glDoStartFrame(int w, int h, float zoom, int player, bool isTextFrame) {
 // TODO: Implement glDoStartFrame
}
...
void SpriteRenderer::setCutawayTexture(Texture tex, int x, int y, int w, int h) {
...
void SpriteRenderer::setUseVertColorsArray(uint8_t whichShader, int c0, int c1, int c2, int c3) {
...
void SpriteRenderer::setExtraWallShaderParams(SpriteRenderer.WallShaderTexRender wallTexRender) {
 // TODO: Implement setExtraWallShaderParams
}

void SpriteRenderer::ShaderUpdate1i(int shaderID, int uniform, int uniformValue) {
 // TODO: Implement ShaderUpdate1i
}

void SpriteRenderer::ShaderUpdate1f(int shaderID, int uniform, float uniformValue) {
 // TODO: Implement ShaderUpdate1f
}

void SpriteRenderer::ShaderUpdate2f(int shaderID, int uniform, float value1, float value2) {
 // TODO: Implement ShaderUpdate2f
}

void SpriteRenderer::ShaderUpdate3f(int shaderID, int uniform, float value1, float value2, float value3) {
 // TODO: Implement ShaderUpdate3f
}

void SpriteRenderer::ShaderUpdate4f(int shaderID, int uniform, float value1, float value2, float value3, float value4) {
...
SpriteRenderState SpriteRenderer::acquireStateForRendering(BooleanSupplier waitCallback) {
...
bool SpriteRenderer::waitForReadyStateInternal(BooleanSupplier booleanSupplier) {
...
void SpriteRenderer::add(TextureDraw textureDraw0, TextureDraw textureDraw1, Style style) {
 // TODO: Implement add
}

bool SpriteRenderer::prepareCurrentRun(TextureDraw textureDraw0, TextureDraw textureDraw1, Style style) {
 // TODO: Implement prepareCurrentRun
 return false;
}

bool SpriteRenderer::isStateChanged(TextureDraw textureDraw0, TextureDraw textureDraw1, Style style, Texture texture0, Texture texture1, uint8_t byte0) {
