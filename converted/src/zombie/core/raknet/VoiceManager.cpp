...
void VoiceManager::VoiceInitServer(bool boolean0, int int1, int int0, int int2, int int3, double double1, double double0, bool boolean1) {
...
void VoiceManager::logFrame(IsoPlayer player1, IsoPlayer player0, float float0) {
