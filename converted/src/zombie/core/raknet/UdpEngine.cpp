...
public
UdpEngine::UdpEngine(int _port, int UDPPort, int _maxConnections,
...
void UdpEngine::endPacketBroadcastExcept(int priority, int reliability,
...
void UdpEngine::Connect(const std::string &string0, int int0,
                        const std::string &string1, bool boolean0) {
  // TODO: Implement Connect
}

void UdpEngine::forceDisconnect(long connectedGUID,
