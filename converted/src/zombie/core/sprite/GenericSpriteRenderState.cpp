...
protected GenericSpriteRenderState::GenericSpriteRenderState(int int0) {
...
void GenericSpriteRenderState::renderflipped(Texture tex, float x, float y, float width, float height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 // TODO: Implement renderflipped
}

void GenericSpriteRenderState::drawSkyBox(Shader shader, int playerIndex, int apiId, int bufferId) {
 // TODO: Implement drawSkyBox
}

void GenericSpriteRenderState::drawWater(Shader shader, int playerIndex, int apiId, bool bShore) {
 // TODO: Implement drawWater
}

void GenericSpriteRenderState::drawPuddles(Shader shader, int playerIndex, int apiId, int z) {
 // TODO: Implement drawPuddles
}

void GenericSpriteRenderState::drawParticles(int playerIndex, int var1, int var2) {
...
void GenericSpriteRenderState::setUseVertColorsArray(uint8_t whichShader, int c0, int c1, int c2, int c3) {
...
void GenericSpriteRenderState::renderline(Texture tex, float x1, float y1, float x2, float y2, float r, float g, float b, float a, int thickness) {
 // TODO: Implement renderline
}

void GenericSpriteRenderState::renderline(Texture tex, int x1, int y1, int x2, int y2, float r, float g, float b, float a) {
 // TODO: Implement renderline
}

void GenericSpriteRenderState::render(Texture tex, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, int c1, int c2, int c3, int c4) {
 // TODO: Implement render
}

void GenericSpriteRenderState::render(Texture tex, float x, float y, float width, float height, float r, float g, float b, float a, Consumer<TextureDraw> texdModifier) {
 // TODO: Implement render
}

void GenericSpriteRenderState::renderRect(int x, int y, int width, int height, float r, float g, float b, float a) {
 // TODO: Implement renderRect
}

void GenericSpriteRenderState::renderPoly(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float r, float g, float b, float a) {
 // TODO: Implement renderPoly
}

void GenericSpriteRenderState::renderPoly(Texture tex, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float r, float g, float b, float a) {
 // TODO: Implement renderPoly
}
...
void GenericSpriteRenderState::glDoStartFrame(int w, int h, float zoom, int player) {
 // TODO: Implement glDoStartFrame
}

void GenericSpriteRenderState::glDoStartFrame(int w, int h, float zoom, int player, bool isTextFrame) {
 // TODO: Implement glDoStartFrame
}
...
void GenericSpriteRenderState::setCutawayTexture(Texture tex, int x, int y, int w, int h) {
...
void GenericSpriteRenderState::setExtraWallShaderParams(SpriteRenderer.WallShaderTexRender wallTexRender) {
 // TODO: Implement setExtraWallShaderParams
}

void GenericSpriteRenderState::ShaderUpdate1i(int shaderID, int uniform, int uniformValue) {
 // TODO: Implement ShaderUpdate1i
}

void GenericSpriteRenderState::ShaderUpdate1f(int shaderID, int uniform, float uniformValue) {
 // TODO: Implement ShaderUpdate1f
}

void GenericSpriteRenderState::ShaderUpdate2f(int shaderID, int uniform, float value1, float value2) {
 // TODO: Implement ShaderUpdate2f
}

void GenericSpriteRenderState::ShaderUpdate3f(int shaderID, int uniform, float value1, float value2, float value3) {
 // TODO: Implement ShaderUpdate3f
}

void GenericSpriteRenderState::ShaderUpdate4f(int shaderID, int uniform, float value1, float value2, float value3, float value4) {
