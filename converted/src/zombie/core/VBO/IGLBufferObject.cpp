...
ByteBuffer IGLBufferObject::glMapBuffer(int target, int access, long length, ByteBuffer old_buffer) {
...
void IGLBufferObject::glGetBufferParameter(int target, int pname, IntBuffer params) {
