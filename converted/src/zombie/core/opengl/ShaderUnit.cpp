...
public ShaderUnit::ShaderUnit(ShaderProgram parent, const std::string& fileName, ShaderUnit.Type unitType) {
...
std::string ShaderUnit::loadShaderFile(const std::string& string1, ArrayList<String> arrayList) {
 // TODO: Implement loadShaderFile
 return "";
}

std::string ShaderUnit::preProcessShaderFile(const std::string& string0, ArrayList<String> arrayList) {
 // TODO: Implement preProcessShaderFile
 return "";
}

bool ShaderUnit::processIncludeLine(const std::string& string3, StringBuilder stringBuilder1, const std::string& string1, const std::string& string9, ArrayList<String> arrayList1) {
