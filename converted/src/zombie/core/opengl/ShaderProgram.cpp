...
private ShaderProgram::ShaderProgram(const std::string& string, bool boolean0) {
...
void ShaderProgram::registerFileWatcherInternal(const std::string& string, PredicatedFileWatcher.IPredicatedFileWatcherCallback iPredicatedFileWatcherCallback) {
...
ShaderUnit ShaderProgram::addShader(const std::string& fileName, ShaderUnit.Type unitType) {
 // TODO: Implement addShader
 return nullptr;
}

ShaderUnit ShaderProgram::findShader(const std::string& string, ShaderUnit.Type type) {
 // TODO: Implement findShader
 return nullptr;
}

ShaderProgram ShaderProgram::createShaderProgram(const std::string& name, bool isStatic, bool compile) {
...
void ShaderProgram::setVector2(const std::string& loc, float val_x, float val_y) {
 // TODO: Implement setVector2
}

void ShaderProgram::setVector3(const std::string& loc, float val_x, float val_y, float val_z) {
 // TODO: Implement setVector3
}

void ShaderProgram::setVector4(const std::string& loc, float val_x, float val_y, float val_z, float val_w) {
...
void ShaderProgram::setValue(const std::string& loc, Texture tex, int samplerUnit) {
 // TODO: Implement setValue
}
