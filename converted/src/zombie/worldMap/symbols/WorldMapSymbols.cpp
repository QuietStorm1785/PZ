...
WorldMapTextSymbol WorldMapSymbols::addTranslatedText(const std::string& text, UIFont font, float x, float y, float r, float g, float b, float a) {
 // TODO: Implement addTranslatedText
 return nullptr;
}

WorldMapTextSymbol WorldMapSymbols::addUntranslatedText(const std::string& text, UIFont font, float x, float y, float r, float g, float b, float a) {
 // TODO: Implement addUntranslatedText
 return nullptr;
}

WorldMapTextureSymbol WorldMapSymbols::addTexture(const std::string& symbolID, float x, float y, float r, float g, float b, float a) {
 // TODO: Implement addTexture
 return nullptr;
}

WorldMapTextureSymbol WorldMapSymbols::addTexture(const std::string& symbolID, float x, float y, float anchorX, float anchorY, float scale, float r, float g, float b, float a) {
 // TODO: Implement addTexture
 return nullptr;
}
...
bool WorldMapSymbols::isSymbolVisible(UIWorldMap uIWorldMap, WorldMapBaseSymbol worldMapBaseSymbol) {
 // TODO: Implement isSymbolVisible
 return false;
}

int WorldMapSymbols::hitTest(UIWorldMap uIWorldMap, float float0, float float1) {
...
private WorldMapSymbols::WorldMapSymbolType(int int1) {
