...
public WorldMapData::WorldMapData(AssetPath path, AssetManager manager) {
 // TODO: Implement WorldMapData
 return nullptr;
}

public WorldMapData::WorldMapData(AssetPath path, AssetManager manager, AssetManager.AssetParams params) {
 // TODO: Implement WorldMapData
 return nullptr;
}
...
void WorldMapData::hitTest(float x, float y, ArrayList<WorldMapFeature> features) {
