...
public UIWorldMapV1::UIWorldMapV1(UIWorldMap ui) {
...
float UIWorldMapV1::uiToWorldX(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 // TODO: Implement uiToWorldX
 return 0;
}

float UIWorldMapV1::uiToWorldY(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 // TODO: Implement uiToWorldY
 return 0;
}

float UIWorldMapV1::worldToUIX(float float0, float float1, float float2, float float3, float float4, Matrix4f matrix4f0, Matrix4f matrix4f1) {
 // TODO: Implement worldToUIX
 return 0;
}

float UIWorldMapV1::worldToUIY(float float0, float float1, float float2, float float3, float float4, Matrix4f matrix4f0, Matrix4f matrix4f1) {
