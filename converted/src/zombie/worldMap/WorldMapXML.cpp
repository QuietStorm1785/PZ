...
WorldMapFeature WorldMapXML::parseFeature(WorldMapCell worldMapCell, Element element) {
 // TODO: Implement parseFeature
 return nullptr;
}

void WorldMapXML::parseFeatureProperties(Element element, WorldMapFeature worldMapFeature) {
 // TODO: Implement parseFeatureProperties
}

WorldMapProperties WorldMapXML::getOrCreateProperties(WorldMapProperties worldMapProperties0) {
...
void WorldMapXML::parseGeometryCoordinates(Element element, WorldMapPoints worldMapPoints) {
 // TODO: Implement parseGeometryCoordinates
}

WorldMapPoint WorldMapXML::parsePoint(Element element, WorldMapPoint worldMapPoint) {
