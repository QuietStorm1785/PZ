...
bool WorldMapBinary::read(const std::string &string,
...
WorldMapFeature WorldMapBinary::parseFeature(WorldMapCell worldMapCell,
                                             InputStream inputStream) {
  // TODO: Implement parseFeature
  return nullptr;
}

void WorldMapBinary::parseFeatureProperties(InputStream inputStream,
                                            WorldMapFeature worldMapFeature) {
  // TODO: Implement parseFeatureProperties
}

WorldMapProperties
WorldMapBinary::getOrCreateProperties(WorldMapProperties worldMapProperties0) {
...
void WorldMapBinary::parseGeometryCoordinates(InputStream inputStream,
