...
void WorldMapRenderer::calcMatrices(float var1, float var2, float var3, Matrix4f matrix4f0, Matrix4f matrix4f1) {
 // TODO: Implement calcMatrices
}

Vector3f WorldMapRenderer::uiToScene(float uiX, float uiY, Matrix4f projection, Matrix4f modelView, Vector3f out) {
 // TODO: Implement uiToScene
 return nullptr;
}

Vector3f WorldMapRenderer::sceneToUI(float sceneX, float sceneY, float sceneZ, Matrix4f projection, Matrix4f modelView, Vector3f out) {
 // TODO: Implement sceneToUI
 return nullptr;
}

float WorldMapRenderer::uiToWorldX(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 // TODO: Implement uiToWorldX
 return 0;
}

float WorldMapRenderer::uiToWorldY(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY) {
 // TODO: Implement uiToWorldY
 return 0;
}

float WorldMapRenderer::uiToWorldX(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 // TODO: Implement uiToWorldX
 return 0;
}

float WorldMapRenderer::uiToWorldY(float uiX, float uiY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 // TODO: Implement uiToWorldY
 return 0;
}

float WorldMapRenderer::worldToUIX(float worldX, float worldY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
 // TODO: Implement worldToUIX
 return 0;
}

float WorldMapRenderer::worldToUIY(float worldX, float worldY, float zoomF, float centerWorldX, float centerWorldY, Matrix4f projection, Matrix4f modelView) {
...
void WorldMapRenderer::setMap(WorldMap worldMap, int x, int y, int width, int height) {
...
int WorldMapRenderer::intersect_ray_plane(UI3DScene.Plane plane, UI3DScene.Ray ray, Vector3f vector3f2) {
...
double WorldMapRenderer::getDouble(const std::string& name, double defaultValue) {
...
void WorldMapRenderer::init(WorldMapRenderer worldMapRenderer, UIWorldMap uIWorldMap) {
 // TODO: Implement init
}
...
void WorldMapRenderer::renderCell(int int0, int int1, ArrayList<WorldMapFeature> arrayList) {
 // TODO: Implement renderCell
}

void WorldMapRenderer::filterFeatures(ArrayList<WorldMapFeature> arrayList1, WorldMapStyleLayer.FilterArgs filterArgs, ArrayList<WorldMapRenderLayer> arrayList0) {
...
void WorldMapRenderer::drawLineStringXXX(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 // TODO: Implement drawLineStringXXX
}

void WorldMapRenderer::drawLineStringYYY(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 // TODO: Implement drawLineStringYYY
}

void WorldMapRenderer::drawLineString(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color, float lineWidth) {
 // TODO: Implement drawLineString
}

void WorldMapRenderer::fillPolygon(WorldMapStyleLayer.RenderArgs args, WorldMapFeature feature, WorldMapStyleLayer.RGBAf color) {
...
void WorldMapRenderer::outlineTriangles(WorldMapGeometry worldMapGeometry, float float12, float float10, float float11) {
 // TODO: Implement outlineTriangles
}

void WorldMapRenderer::outlinePolygon(WorldMapGeometry worldMapGeometry, float float6, float float4, float float5) {
 // TODO: Implement outlinePolygon
}

void WorldMapRenderer::drawTexture(Texture texture, WorldMapStyleLayer.RGBAf fill, int worldX1, int worldY1, int worldX2, int worldY2) {
 // TODO: Implement drawTexture
}

void WorldMapRenderer::drawTextureTiled(Texture texture, WorldMapStyleLayer.RGBAf fill, int worldX1, int worldY1, int worldX2, int worldY2, int cellX, int cellY) {
...
void WorldMapRenderer::renderZones(ArrayList<IsoMetaGrid.Zone> arrayList, const std::string& string, float float5, float float6, float float7, float float16) {
 // TODO: Implement renderZones
}
...
float WorldMapRenderer::triangleArea(float float4, float float2, float float3, float float1, float float7, float float6) {
 // TODO: Implement triangleArea
 return 0;
}

void WorldMapRenderer::paintAreasOutsideBounds(int int0, int int1, int int2, int int3, float float1) {
...
public WorldMapRenderer::WorldMapBooleanOption(const std::string& string, bool boolean0) {
 // TODO: Implement WorldMapBooleanOption
 return nullptr;
}

public WorldMapRenderer::WorldMapDoubleOption(const std::string& string, double double0, double double1, double double2) {
