...
public UIWorldMap::UIWorldMap(KahluaTable table) {
...
bool UIWorldMap::shouldShowRemotePlayer(WorldMapRemotePlayer worldMapRemotePlayer) {
...
bool UIWorldMap::isInSameFaction(IsoPlayer player, WorldMapRemotePlayer worldMapRemotePlayer) {
 // TODO: Implement isInSameFaction
 return false;
}

bool UIWorldMap::isInSameSafehouse(IsoPlayer player, WorldMapRemotePlayer worldMapRemotePlayer) {
...
void UIWorldMap::renderPlayerName(float float4, float float5, const std::string& string) {
...
void UIWorldMap::debugRenderBuilding(BuildingDef buildingDef, float float7, float float6, float float5, float float4) {
