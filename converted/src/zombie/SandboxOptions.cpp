...
std::string SandboxOptions::upgradeOptionName(const std::string &string,
                                              int var2) {
  // TODO: Implement upgradeOptionName
  return "";
}

std::string SandboxOptions::upgradeOptionValue(const std::string &string0,
...
KahluaTable SandboxOptions::upgradeLuaTable(const std::string &object,
                                            KahluaTable table1, int int0) {
...
void SandboxOptions::addCustomOption(SandboxOptions.SandboxOption sandboxOption,
...
public
SandboxOptions::BooleanSandboxOption(SandboxOptions owner,
...
public
SandboxOptions::DoubleSandboxOption(SandboxOptions owner,
...
public
SandboxOptions::EnumSandboxOption(SandboxOptions owner, const std::string &name,
...
public
SandboxOptions::IntegerSandboxOption(SandboxOptions owner,
...
public
SandboxOptions::StringSandboxOption(SandboxOptions owner,
                                    const std::string &name,
