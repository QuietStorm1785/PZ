...
void ChatManager::updateChatSettings(const std::string& string, bool boolean0, bool boolean1) {
...
void ChatManager::showInfoMessage(const std::string& string1, const std::string& string0) {
 // TODO: Implement showInfoMessage
}

void ChatManager::sendMessageToChat(const std::string& string1, ChatType chatType, const std::string& string0) {
 // TODO: Implement sendMessageToChat
}

void ChatManager::sendMessageToChat(ChatType chatType, const std::string& string) {
 // TODO: Implement sendMessageToChat
}
...
ChatMessage ChatManager::createRadiostationMessage(const std::string& string, int int0) {
...
void ChatManager::addMessage(int int0, const std::string& string1, const std::string& string0) {
 // TODO: Implement addMessage
}

void ChatManager::addMessage(const std::string& string0, const std::string& string1) {
 // TODO: Implement addMessage
}

void ChatManager::sendMessageToChat(ChatBase chatBase, ChatMessage chatMessage0) {
 // TODO: Implement sendMessageToChat
}
