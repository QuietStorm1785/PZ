...
public ChatMessage::ChatMessage(ChatBase _chat, const std::string& _text) {
 // TODO: Implement ChatMessage
 return nullptr;
}

public ChatMessage::ChatMessage(ChatBase _chat, LocalDateTime _datetime, const std::string& _text) {
 // TODO: Implement ChatMessage
 return nullptr;
}
