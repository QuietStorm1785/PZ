...
protected ChatBase::ChatBase(ChatType chatType) {
 // TODO: Implement ChatBase
 return nullptr;
}

public ChatBase::ChatBase(ByteBuffer bb, ChatType _type, ChatTab tab, IsoPlayer owner) {
 // TODO: Implement ChatBase
 return nullptr;
}

public ChatBase::ChatBase(int _id, ChatType _type, ChatTab tab) {
 // TODO: Implement ChatBase
 return nullptr;
}
...
ChatMessage ChatBase::createMessage(const std::string& string1, const std::string& string0) {
 // TODO: Implement createMessage
 return nullptr;
}
...
void ChatBase::sendChatMessageToPlayer(UdpConnection udpConnection, ChatMessage chatMessage) {
 // TODO: Implement sendChatMessageToPlayer
}

void ChatBase::sendChatMessageFromPlayer(UdpConnection udpConnection, ChatMessage chatMessage) {
