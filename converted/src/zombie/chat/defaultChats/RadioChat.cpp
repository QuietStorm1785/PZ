...
public RadioChat::RadioChat(ByteBuffer byteBuffer, ChatTab chatTab, IsoPlayer player) {
 // TODO: Implement RadioChat
 return nullptr;
}

public RadioChat::RadioChat(int int0, ChatTab chatTab) {
 // TODO: Implement RadioChat
 return nullptr;
}
...
ChatMessage RadioChat::createBroadcastingMessage(const std::string& string, int int0) {
...
void RadioChat::packMessage(ByteBufferWriter byteBufferWriter, ChatMessage chatMessage) {
