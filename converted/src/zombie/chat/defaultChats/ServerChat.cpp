...
public ServerChat::ServerChat(ByteBuffer byteBuffer, ChatTab chatTab, IsoPlayer player) {
 // TODO: Implement ServerChat
 return nullptr;
}

public ServerChat::ServerChat(int int0, ChatTab chatTab) {
 // TODO: Implement ServerChat
 return nullptr;
}
...
ChatMessage ServerChat::createMessage(const std::string& string1, const std::string& string0, bool boolean0) {
 // TODO: Implement createMessage
 return nullptr;
}

ServerChatMessage ServerChat::createServerMessage(const std::string& string, bool boolean0) {
...
void ServerChat::packMessage(ByteBufferWriter byteBufferWriter, ChatMessage chatMessage) {
