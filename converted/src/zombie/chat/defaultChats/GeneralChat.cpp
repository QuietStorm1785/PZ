...
public GeneralChat::GeneralChat(ByteBuffer byteBuffer, ChatTab chatTab, IsoPlayer player) {
 // TODO: Implement GeneralChat
 return nullptr;
}

public GeneralChat::GeneralChat(int int0, ChatTab chatTab, bool boolean0) {
 // TODO: Implement GeneralChat
 return nullptr;
}
...
void GeneralChat::packMessage(ByteBufferWriter byteBufferWriter, ChatMessage chatMessage) {
