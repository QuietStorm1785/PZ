...
public
ChatElement::ChatElement(ChatElementOwner chatowner, int numberoflines,
...
void ChatElement::addChatLine(const std::string &msg, float r, float g,
                              float b) {
  // TODO: Implement addChatLine
}
...
public
ChatElement::PlayerLines(int arg1) {
