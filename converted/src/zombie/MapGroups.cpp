...
std::string MapGroups::addMissingVanillaDirectories(const std::string& mapName) {
...
void MapGroups::createGroups(ActiveMods activeMods, bool includeVanilla, bool includeChallenges) {
 // TODO: Implement createGroups
}

void MapGroups::getDirsRecursively(MapGroups.MapDirectory mapDirectory0, ArrayList<MapGroups.MapDirectory> arrayList) {
...
void MapGroups::handleMapDirectory(const std::string& string1, const std::string& string0) {
...
public MapGroups::MapDirectory(const std::string& string0, const std::string& string1) {
 // TODO: Implement MapDirectory
 return nullptr;
}

public MapGroups::MapDirectory(const std::string& string0, const std::string& string1, ArrayList<String> arrayList) {
 // TODO: Implement MapDirectory
 return nullptr;
}
...
void MapGroups::addDirectory(const std::string& string0, const std::string& string1) {
 // TODO: Implement addDirectory
}

void MapGroups::addDirectory(const std::string& string0, const std::string& string1, ArrayList<String> arrayList) {
 // TODO: Implement addDirectory
}
...
bool MapGroups::hasAnyOfTheseDirectories(ArrayList<MapGroups.MapDirectory> arrayList) {
...
void MapGroups::getDirsRecursively(MapGroups.MapDirectory mapDirectory0, ArrayList<String> arrayList) {
 // TODO: Implement getDirsRecursively
}
