...
public
UI3DScene::UI3DScene(KahluaTable table) {
...
void *UI3DScene::fromLua3(const std::string &func, void *arg0, void *arg1,
                          void *arg2) {
  // TODO: Implement fromLua3
  return nullptr;
}

void *UI3DScene::fromLua4(const std::string &func, void *arg0, void *arg1,
                          void *arg2, void *arg3) {
  // TODO: Implement fromLua4
  return nullptr;
}

void *UI3DScene::fromLua6(const std::string &func, void *arg0, void *arg1,
                          void *arg2, void *arg3, void *arg4, void *arg5) {
  // TODO: Implement fromLua6
  return nullptr;
}

void *UI3DScene::fromLua9(const std::string &func, void *arg0, void *arg1,
                          void *arg2, void *arg3, void *arg4, void *arg5,
...
Vector3f UI3DScene::uiToScene(Matrix4f modelTransform, float uiX, float uiY,
                              float uiZ, Vector3f out) {
  // TODO: Implement uiToScene
  return nullptr;
}
...
void UI3DScene::renderAABB(float float6, float float7, float float8,
                           float float1, float float3, float float5,
                           float float10, float float11, float float12) {
  // TODO: Implement renderAABB
}

void UI3DScene::renderAABB(float float0, float float1, float float2,
                           Vector3f vector3f1, Vector3f vector3f0, float float4,
...
float UI3DScene::closest_distance_between_lines(UI3DScene.Ray ray0,
                                                UI3DScene.Ray ray1) {
  // TODO: Implement closest_distance_between_lines
  return 0;
}

Vector3f UI3DScene::project(Vector3f vector3f1, Vector3f vector3f0,
                            Vector3f vector3f2) {
  // TODO: Implement project
  return nullptr;
}

Vector3f UI3DScene::reject(Vector3f vector3f1, Vector3f vector3f2,
                           Vector3f vector3f3) {
  // TODO: Implement reject
  return nullptr;
}

int UI3DScene::intersect_ray_plane(UI3DScene.Plane Pn, UI3DScene.Ray S,
                                   Vector3f out) {
  // TODO: Implement intersect_ray_plane
  return 0;
}

float UI3DScene::distance_between_point_ray(Vector3f vector3f2,
                                            UI3DScene.Ray ray) {
  // TODO: Implement distance_between_point_ray
  return 0;
}

float UI3DScene::closest_distance_line_circle(UI3DScene.Ray ray,
...
void UI3DScene::init(UI3DScene.SceneCharacter sceneCharacter,
...
Vector3f UI3DScene::getPointOnAxis(float float1, float float0,
                                   UI3DScene.Axis axis, Matrix4f matrix4f,
                                   Vector3f vector3f) {
  // TODO: Implement getPointOnAxis
  return nullptr;
}

bool UI3DScene::hitTestRect(float float17, float float16, float float1,
                            float float2, float float3, float float6,
                            float float7, float float8) {
...
void UI3DScene::init(UI3DScene.SceneModel sceneModel,
...
public
UI3DScene::Plane(Vector3f _normal, Vector3f _point) {
  // TODO: Implement Plane
  return nullptr;
}
...
void UI3DScene::getCircleSegments(Vector3f vector3f4, float float0,
                                  Vector3f vector3f2, Vector3f vector3f3,
                                  ArrayList<Vector3f> arrayList) {
  // TODO: Implement getCircleSegments
}

float UI3DScene::hitTestCircle(UI3DScene.Ray ray1,
                               ArrayList<Vector3f> arrayList, Vector2 vector) {
  // TODO: Implement hitTestCircle
  return 0;
}

void UI3DScene::renderAxis(Vector3f vector3f0, float float0, Vector3f vector3f1,
                           Vector3f vector3f2, float float2, float float3,
                           float float4, UI3DScene.Ray ray) {
  // TODO: Implement renderAxis
}

Vector3f UI3DScene::getPointOnAxis(float float3, float float4,
                                   UI3DScene.Axis var3, UI3DScene.Circle circle,
                                   Matrix4f matrix4f, Vector3f vector3f) {
  // TODO: Implement getPointOnAxis
  return nullptr;
}

float UI3DScene::calculateRotation(Vector3f vector3f0, Vector3f vector3f1,
                                   UI3DScene.Circle circle) {
...
Matrix4f UI3DScene::getAttachmentTransform(const std::string &string,
                                           Matrix4f matrix4f0) {
  // TODO: Implement getAttachmentTransform
  return nullptr;
}

int UI3DScene::hitTestBone(int int1, UI3DScene.Ray ray0, UI3DScene.Ray ray1,
                           Matrix4f matrix4f1) {
...
Matrix4f UI3DScene::getBoneMatrix(const std::string &string,
                                  Matrix4f matrix4f) {
...
Matrix4f UI3DScene::getAttachmentTransform(const std::string &var1,
                                           Matrix4f matrix4f) {
  // TODO: Implement getAttachmentTransform
  return nullptr;
}
...
void UI3DScene::init(UI3DScene.SceneVehicle sceneVehicle,
...
void UI3DScene::initWheelModel(UI3DScene.SceneVehicle sceneVehicle,
