...
bool WorldMarkers::removePlayerHomingPoint(IsoPlayer player, WorldMarkers.PlayerHomingPoint point) {
...
bool WorldMarkers::removePlayerDirectionArrow(IsoPlayer player, WorldMarkers.DirectionArrow arrow) {
...
bool WorldMarkers::removeGridSquareMarker(WorldMarkers.GridSquareMarker marker) {
...
void WorldMarkers::renderGridSquareMarkers(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
...
bool WorldMarkers::intersectLineSegments(WorldMarkers.Line l1, WorldMarkers.Line l2, WorldMarkers.Point intersection) {
 // TODO: Implement intersectLineSegments
 return false;
}

public WorldMarkers::DirectionArrow(int var2) {
...
void WorldMarkers::init(const std::string& texid, const std::string& overlay, int _x, int _y, int _z, float _size) {
 // TODO: Implement init
}
...
public WorldMarkers::PlayerHomingPoint(int plrIndex) {
