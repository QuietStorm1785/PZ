...
public ThunderStorm::ThunderStorm(ClimateManager climmgr) {
...
void ThunderStorm::startThunderCloud(float str, float angle, float radius, float eventFreq, float thunderRatio, double duration, bool targetRandomPlayer) {
...
void ThunderStorm::applyLightningForPlayer(RenderSettings.PlayerRenderSettings renderSettings, int plrIndex, IsoPlayer player) {
...
void ThunderStorm::triggerThunderEvent(int x, int y, bool doStrike, bool doLightning, bool doRumble) {
...
void ThunderStorm::enqueueThunderEvent(int x, int y, bool doStrike, bool doLightning, bool doRumble) {
