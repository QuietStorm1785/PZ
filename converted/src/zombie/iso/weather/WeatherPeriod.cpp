...
public WeatherPeriod::WeatherPeriod(ClimateManager climmgr, ThunderStorm ts) {
...
void WeatherPeriod::initSimulationDebug(ClimateManager.AirFront front, double hoursSinceStart) {
 // TODO: Implement initSimulationDebug
}

void WeatherPeriod::initSimulationDebug(ClimateManager.AirFront front, double hoursSinceStart, int doThisStageOnly, float singleStageDuration) {
 // TODO: Implement initSimulationDebug
}

void WeatherPeriod::init(ClimateManager.AirFront airFront, double double0, int int0, int int1, int int2) {
 // TODO: Implement init
}

void WeatherPeriod::init(ClimateManager.AirFront airFront, double double0, int int0, int int1, int int2, int int3, float float0) {
 // TODO: Implement init
}
...
bool WeatherPeriod::startCreateModdedPeriod(bool warmFront, float strength, float angle) {
...
bool WeatherPeriod::startInit(ClimateManager.AirFront airFront, double double0) {
...
private WeatherPeriod::StrLerpVal(int int1) {
...
public WeatherPeriod::WeatherStage(int id) {
 // TODO: Implement WeatherStage
 return nullptr;
}
...
void WeatherPeriod::lerpEntryTo(WeatherPeriod.StrLerpVal strLerpVal0, WeatherPeriod.StrLerpVal strLerpVal1) {
 // TODO: Implement lerpEntryTo
}
