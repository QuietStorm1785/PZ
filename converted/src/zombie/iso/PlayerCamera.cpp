...
public PlayerCamera::PlayerCamera(int _playerIndex) {
...
float PlayerCamera::YToScreenExact(float objectX, float objectY, float objectZ, int screenZ) {
 // TODO: Implement YToScreenExact
 return 0;
}

float PlayerCamera::XToScreenExact(float objectX, float objectY, float objectZ, int screenZ) {
