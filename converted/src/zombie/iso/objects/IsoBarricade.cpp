...
public
IsoBarricade::IsoBarricade(IsoCell cell) {
  // TODO: Implement IsoBarricade
  return nullptr;
}

public
IsoBarricade::IsoBarricade(IsoCell cell, IsoGridSquare gridSquare,
                           IsoDirections dir) {
  // TODO: Implement IsoBarricade
  return nullptr;
}
...
bool IsoBarricade::TestCollide(IsoMovingObject obj, IsoGridSquare from,
                               IsoGridSquare to) {
...
void IsoBarricade::load(ByteBuffer input, int WorldVersion,
                        bool IS_DEBUG_SAVE) {
  // TODO: Implement load
}
...
void IsoBarricade::saveChange(const std::string &change, KahluaTable tbl,
                              ByteBuffer bb) {
...
void IsoBarricade::render(float x, float y, float z, ColorInfo col,
                          bool bDoAttached, bool bWallLightingPass,
                          Shader shader) {
  // TODO: Implement render
}

IsoBarricade IsoBarricade::GetBarricadeOnSquare(IsoGridSquare square,
                                                IsoDirections dir) {
  // TODO: Implement GetBarricadeOnSquare
  return nullptr;
}

IsoBarricade IsoBarricade::GetBarricadeForCharacter(BarricadeAble obj,
...
IsoBarricade IsoBarricade::GetBarricadeOppositeCharacter(BarricadeAble obj,
                                                         IsoGameCharacter chr) {
...
IsoBarricade IsoBarricade::AddBarricadeToObject(BarricadeAble to,
                                                bool addOpposite) {
