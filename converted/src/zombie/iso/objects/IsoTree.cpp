...
public IsoTree::IsoTree(IsoCell cell) {
 // TODO: Implement IsoTree
 return nullptr;
}
...
public IsoTree::IsoTree(IsoGridSquare sq, const std::string& gid) {
 // TODO: Implement IsoTree
 return nullptr;
}

public IsoTree::IsoTree(IsoGridSquare sq, IsoSprite gid) {
 // TODO: Implement IsoTree
 return nullptr;
}
...
void IsoTree::render(float x, float y, float z, ColorInfo col, bool bDoAttached, bool bWallLightingPass, Shader shader) {
 // TODO: Implement render
}

void IsoTree::renderInner(float float4, float float5, float float6, ColorInfo colorInfo, bool var5, bool boolean0) {
...
void IsoTree::setOutlineColor(float float0, float float1, float float2, float float3) {
