...
public IsoTrap::IsoTrap(IsoCell cell) {
 // TODO: Implement IsoTrap
 return nullptr;
}

public IsoTrap::IsoTrap(HandWeapon _weapon, IsoCell cell, IsoGridSquare sq) {
 // TODO: Implement IsoTrap
 return nullptr;
}
...
void IsoTrap::render(float x, float y, float z, ColorInfo col, bool bDoChild, bool bWallLightingPass, Shader shader) {
