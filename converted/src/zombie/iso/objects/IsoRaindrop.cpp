...
public IsoRaindrop::IsoRaindrop(IsoCell cell, IsoGridSquare gridSquare, bool CanSee) {
...
bool IsoRaindrop::TestCollide(IsoMovingObject obj, IsoGridSquare PassedObjectSquare) {
