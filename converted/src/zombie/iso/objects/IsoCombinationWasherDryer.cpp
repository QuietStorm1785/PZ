...
public IsoCombinationWasherDryer::IsoCombinationWasherDryer(IsoCell cell) {
 // TODO: Implement IsoCombinationWasherDryer
 return nullptr;
}

public IsoCombinationWasherDryer::IsoCombinationWasherDryer(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
 // TODO: Implement IsoCombinationWasherDryer
 return nullptr;
}
...
void IsoCombinationWasherDryer::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoCombinationWasherDryer::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
 // TODO: Implement saveChange
}

void IsoCombinationWasherDryer::loadChange(const std::string& change, ByteBuffer bb) {
 // TODO: Implement loadChange
}

bool IsoCombinationWasherDryer::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool IsoCombinationWasherDryer::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
