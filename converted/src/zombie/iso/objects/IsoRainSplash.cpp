...
public IsoRainSplash::IsoRainSplash(IsoCell cell, IsoGridSquare gridSquare) {
...
bool IsoRainSplash::TestCollide(IsoMovingObject obj, IsoGridSquare PassedObjectSquare) {
