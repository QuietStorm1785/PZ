...
public IsoClothingDryer::IsoClothingDryer(IsoCell cell) {
 // TODO: Implement IsoClothingDryer
 return nullptr;
}

public IsoClothingDryer::IsoClothingDryer(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
 // TODO: Implement IsoClothingDryer
 return nullptr;
}
...
void IsoClothingDryer::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoClothingDryer::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
bool IsoClothingDryer::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool IsoClothingDryer::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
