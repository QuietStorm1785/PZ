...
public
IsoFire::IsoFire(IsoCell cell) {
  // TODO: Implement IsoFire
  return nullptr;
}

public
IsoFire::IsoFire(IsoCell cell, IsoGridSquare gridSquare) {
  // TODO: Implement IsoFire
  return nullptr;
}
...
public
IsoFire::IsoFire(IsoCell cell, IsoGridSquare gridSquare, bool CanBurnAnywhere,
...
bool IsoFire::TestCollide(IsoMovingObject obj,
...
void IsoFire::render(float x, float y, float z, ColorInfo col, bool bDoChild,
...
void IsoFire::saveChange(const std::string &change, KahluaTable tbl,
                         ByteBuffer bb) {
