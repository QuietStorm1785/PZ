...
public IsoStackedWasherDryer::IsoStackedWasherDryer(IsoCell cell) {
 // TODO: Implement IsoStackedWasherDryer
 return nullptr;
}

public IsoStackedWasherDryer::IsoStackedWasherDryer(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
 // TODO: Implement IsoStackedWasherDryer
 return nullptr;
}
...
void IsoStackedWasherDryer::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoStackedWasherDryer::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
 // TODO: Implement saveChange
}

void IsoStackedWasherDryer::loadChange(const std::string& change, ByteBuffer bb) {
 // TODO: Implement loadChange
}

bool IsoStackedWasherDryer::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool IsoStackedWasherDryer::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
