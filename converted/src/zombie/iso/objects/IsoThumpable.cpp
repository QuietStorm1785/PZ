...
public IsoThumpable::IsoThumpable(IsoCell cell) {
...
public IsoThumpable::IsoThumpable(IsoCell cell, IsoGridSquare gridSquare, const std::string& _closedSprite, const std::string& _openSprite, bool _north, KahluaTable _table) {
 // TODO: Implement IsoThumpable
 return nullptr;
}

public IsoThumpable::IsoThumpable(IsoCell cell, IsoGridSquare gridSquare, const std::string& sprite, bool _north, KahluaTable _table) {
 // TODO: Implement IsoThumpable
 return nullptr;
}

void IsoThumpable::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
bool IsoThumpable::TestPathfindCollide(IsoMovingObject obj, IsoGridSquare from, IsoGridSquare to) {
 // TODO: Implement TestPathfindCollide
 return false;
}

bool IsoThumpable::TestCollide(IsoMovingObject obj, IsoGridSquare from, IsoGridSquare to) {
...
InventoryItem IsoThumpable::insertNewFuel(InventoryItem item, IsoGameCharacter chr) {
...
void IsoThumpable::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source, ByteBuffer bb) {
...
void IsoThumpable::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
void IsoThumpable::playDoorSound(BaseCharacterSoundEmitter baseCharacterSoundEmitter, const std::string& string) {
