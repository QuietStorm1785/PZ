...
public ClothingDryerLogic::ClothingDryerLogic(IsoObject object) {
...
void ClothingDryerLogic::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void ClothingDryerLogic::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
bool ClothingDryerLogic::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool ClothingDryerLogic::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
