...
public
IsoStove::IsoStove(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
...
public
IsoStove::IsoStove(IsoCell cell) {
  // TODO: Implement IsoStove
  return nullptr;
}
...
void IsoStove::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source,
                             ByteBuffer bb) {
