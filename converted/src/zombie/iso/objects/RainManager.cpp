...
void RainManager::SetPlayerLocation(int playerIndex, IsoGridSquare PlayerCurrentSquare) {
...
void RainManager::StartRaindrop(IsoCell cell, IsoGridSquare gridSquare, bool CanSee) {
 // TODO: Implement StartRaindrop
}

void RainManager::StartRainSplash(IsoCell cell, IsoGridSquare gridSquare, bool CanSee) {
