...
void IClothingWasherDryerLogic::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
 // TODO: Implement saveChange
}

void IClothingWasherDryerLogic::loadChange(const std::string& change, ByteBuffer bb) {
...
bool IClothingWasherDryerLogic::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool IClothingWasherDryerLogic::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
