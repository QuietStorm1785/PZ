...
public
IsoDeadBody::IsoDeadBody(IsoGameCharacter died) {
  // TODO: Implement IsoDeadBody
  return nullptr;
}

public
IsoDeadBody::IsoDeadBody(IsoGameCharacter died, bool wasCorpseAlready) {
  // TODO: Implement IsoDeadBody
  return nullptr;
}

public
IsoDeadBody::IsoDeadBody(IsoCell cell) {
  // TODO: Implement IsoDeadBody
  return nullptr;
}
...
void IsoDeadBody::saveChange(const std::string &change, KahluaTable tbl,
                             ByteBuffer bb) {
...
void IsoDeadBody::render(float x, float y, float z, ColorInfo col,
...
void IsoDeadBody::renderShadow(float x, float y, float z, Vector3f forward,
                               float w, float fm, float bm, ColorInfo lightInfo,
                               float alpha) {
  // TODO: Implement renderShadow
}

void IsoDeadBody::renderObjectPicker(float x, float y, float z,
                                     ColorInfo lightInfo) {
