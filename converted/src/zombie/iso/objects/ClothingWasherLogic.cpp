...
public ClothingWasherLogic::ClothingWasherLogic(IsoObject object) {
...
void ClothingWasherLogic::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void ClothingWasherLogic::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
bool ClothingWasherLogic::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool ClothingWasherLogic::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
