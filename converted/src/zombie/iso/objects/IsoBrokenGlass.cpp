...
public IsoBrokenGlass::IsoBrokenGlass(IsoCell cell) {
...
void IsoBrokenGlass::render(float x, float y, float z, ColorInfo col, bool bDoChild, bool bWallLightingPass, Shader shader) {
 // TODO: Implement render
}

void IsoBrokenGlass::renderObjectPicker(float x, float y, float z, ColorInfo lightInfo) {
