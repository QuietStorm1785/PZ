...
public IsoWaveSignal::IsoWaveSignal(IsoCell cell) {
 // TODO: Implement IsoWaveSignal
 return nullptr;
}

public IsoWaveSignal::IsoWaveSignal(IsoCell cell, IsoGridSquare sq, IsoSprite spr) {
 // TODO: Implement IsoWaveSignal
 return nullptr;
}
...
void IsoWaveSignal::AddDeviceText(const std::string& line, float r, float g, float b, const std::string& guid, const std::string& codes, int distance) {
 // TODO: Implement AddDeviceText
}

void IsoWaveSignal::AddDeviceText(const std::string& line, int r, int g, int b, const std::string& guid, const std::string& codes, int distance) {
 // TODO: Implement AddDeviceText
}

void IsoWaveSignal::AddDeviceText(const std::string& line, int r, int g, int b, const std::string& guid, const std::string& codes, int distance, bool attractZombies) {
 // TODO: Implement AddDeviceText
}

void IsoWaveSignal::AddDeviceText(const std::string& line, float r, float g, float b, const std::string& guid, const std::string& codes, int distance, bool attractZombies) {
 // TODO: Implement AddDeviceText
}
...
void IsoWaveSignal::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
