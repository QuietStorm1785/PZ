...
public IsoMolotovCocktail::IsoMolotovCocktail(IsoCell cell) {
 // TODO: Implement IsoMolotovCocktail
 return nullptr;
}

public IsoMolotovCocktail::IsoMolotovCocktail(IsoCell cell, float x, float y, float z, float xvel, float yvel, HandWeapon _weapon, IsoGameCharacter _character) {
 // TODO: Implement IsoMolotovCocktail
 return nullptr;
}
...
void IsoMolotovCocktail::render(float x, float y, float z, ColorInfo info, bool bDoAttached, bool bWallLightingPass, Shader shader) {
