...
public IsoCarBatteryCharger::IsoCarBatteryCharger(IsoCell cell) {
 // TODO: Implement IsoCarBatteryCharger
 return nullptr;
}

public IsoCarBatteryCharger::IsoCarBatteryCharger(InventoryItem _item, IsoCell cell, IsoGridSquare square) {
 // TODO: Implement IsoCarBatteryCharger
 return nullptr;
}
...
void IsoCarBatteryCharger::load(ByteBuffer bb, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoCarBatteryCharger::render(float x, float y, float z, ColorInfo col, bool bDoChild, bool bWallLightingPass, Shader shader) {
 // TODO: Implement render
}

void IsoCarBatteryCharger::renderObjectPicker(float x, float y, float z, ColorInfo lightInfo) {
 // TODO: Implement renderObjectPicker
}

IsoSprite IsoCarBatteryCharger::configureSprite(InventoryItem itemx, IsoSprite sprite) {
...
void IsoCarBatteryCharger::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source, ByteBuffer bb) {
