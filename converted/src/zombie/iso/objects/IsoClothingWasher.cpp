...
public IsoClothingWasher::IsoClothingWasher(IsoCell cell) {
 // TODO: Implement IsoClothingWasher
 return nullptr;
}

public IsoClothingWasher::IsoClothingWasher(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
 // TODO: Implement IsoClothingWasher
 return nullptr;
}
...
void IsoClothingWasher::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoClothingWasher::saveChange(const std::string& change, KahluaTable tbl, ByteBuffer bb) {
...
bool IsoClothingWasher::isItemAllowedInContainer(ItemContainer container, InventoryItem item) {
 // TODO: Implement isItemAllowedInContainer
 return false;
}

bool IsoClothingWasher::isRemoveItemAllowedFromContainer(ItemContainer container, InventoryItem item) {
