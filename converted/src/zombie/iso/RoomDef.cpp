...
public RoomDef::RoomDef(int _ID, const std::string& _name) {
...
public RoomDef::RoomRect(int _x, int _y, int _w, int _h) {
...
float RoomDef::getClosestPointOnEdge(float float3, float float1, float float2, float float0, float float5, float float4, float float6, Vector2f vector2f) {
