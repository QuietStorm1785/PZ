...
int IsoObjectPicker::compare(IsoObjectPicker.ClickObject clickObject0, IsoObjectPicker.ClickObject clickObject1) {
...
void IsoObjectPicker::Add(int x, int y, int width, int height, IsoGridSquare gridSquare, IsoObject tile, bool flip, float scaleX, float scaleY) {
 // TODO: Implement Add
}
...
IsoObject IsoObjectPicker::PickDoor(int screenX, int screenY, bool bTransparent) {
