...
bool IsoGridSquare::getMatrixBit(int matrix, uint8_t _x, uint8_t _y, uint8_t _z) {
 // TODO: Implement getMatrixBit
 return false;
}
...
int IsoGridSquare::setMatrixBit(int matrix, uint8_t _x, uint8_t _y, uint8_t _z, bool val) {
 // TODO: Implement setMatrixBit
 return 0;
}

void IsoGridSquare::setPlayerCutawayFlag(int playerIndex, bool bCutaway, long currentTimeMillis) {
 // TODO: Implement setPlayerCutawayFlag
}

bool IsoGridSquare::getPlayerCutawayFlag(int playerIndex, long currentTimeMillis) {
 // TODO: Implement getPlayerCutawayFlag
 return false;
}

void IsoGridSquare::setIsDissolved(int playerIndex, bool bDissolved, long currentTimeMillis) {
...
bool IsoGridSquare::validateUser(const std::string& string1, const std::string& string0) {
...
void IsoGridSquare::renderAttachedSpritesWithNoWallLighting(IsoObject object, ColorInfo colorInfo) {
 // TODO: Implement renderAttachedSpritesWithNoWallLighting
}

void IsoGridSquare::DoCutawayShaderSprite(IsoSprite sprite, IsoDirections dir, bool cutawaySW, bool cutawayNW, bool cutawayNE) {
 // TODO: Implement DoCutawayShaderSprite
}

int IsoGridSquare::performDrawWallOnly(IsoObject object, int int0, int int1, bool boolean0, Consumer<TextureDraw> consumer, Shader shader) {
 // TODO: Implement performDrawWallOnly
 return 0;
}

int IsoGridSquare::performDrawWall(IsoObject object, int int1, int int0, bool boolean0, Consumer<TextureDraw> consumer, Shader shader) {
 // TODO: Implement performDrawWall
 return 0;
}

void IsoGridSquare::calculateWallAlphaCommon(IsoObject object, bool boolean2, bool boolean3, bool boolean4, int int0, bool boolean0, bool boolean1) {
...
void IsoGridSquare::save(ByteBuffer output, ObjectOutputStream outputObj, bool IS_DEBUG_SAVE) {
 // TODO: Implement save
}
...
void IsoGridSquare::savematrix(boolean[][][] booleans, DataOutputStream dataOutputStream) {
...
bool IsoGridSquare::damageSpriteSheetRopeFromBottom(IsoPlayer player, bool north) {
...
void IsoGridSquare::getSquaresForThread(ArrayDeque<IsoGridSquare> isoGridSquareCacheDest, int count) {
 // TODO: Implement getSquaresForThread
}

IsoGridSquare IsoGridSquare::getNew(IsoCell cell, SliceY slice, int _x, int _y, int _z) {
 // TODO: Implement getNew
 return nullptr;
}

IsoGridSquare IsoGridSquare::getNew(ArrayDeque<IsoGridSquare> _isoGridSquareCache, IsoCell cell, SliceY slice, int _x, int _y, int _z) {
 // TODO: Implement getNew
 return nullptr;
}
...
public IsoGridSquare::IsoGridSquare(IsoCell cell, SliceY slice, int _x, int _y, int _z) {
...
IsoThumpable IsoGridSquare::AddStairs(bool north, int level, const std::string& sprite, const std::string& pillarSprite, KahluaTable _table) {
...
void IsoGridSquare::ReCalculateAll(IsoGridSquare square0, IsoGridSquare.GetSquare getSquare) {
 // TODO: Implement ReCalculateAll
}

void IsoGridSquare::ReCalculateAll(bool boolean0, IsoGridSquare square0, IsoGridSquare.GetSquare getSquare) {
 // TODO: Implement ReCalculateAll
}
...
void IsoGridSquare::RecalcAllWithNeighbours(bool bDoReverse, IsoGridSquare.GetSquare getter) {
 // TODO: Implement RecalcAllWithNeighbours
}
...
void IsoGridSquare::DoSplat(const std::string& id, bool bFlip, IsoFlagType prop, float offX, float offZ, float alpha) {
...
void IsoGridSquare::AddWorldInventoryItem(const std::string& String, float _x, float _y, float height, int nbr) {
 // TODO: Implement AddWorldInventoryItem
}

InventoryItem IsoGridSquare::AddWorldInventoryItem(const std::string& String, float _x, float _y, float height) {
 // TODO: Implement AddWorldInventoryItem
 return nullptr;
}

InventoryItem IsoGridSquare::AddWorldInventoryItem(InventoryItem item, float _x, float _y, float height) {
 // TODO: Implement AddWorldInventoryItem
 return nullptr;
}

InventoryItem IsoGridSquare::AddWorldInventoryItem(InventoryItem item, float _x, float _y, float height, bool transmit) {
 // TODO: Implement AddWorldInventoryItem
 return nullptr;
}
...
bool IsoGridSquare::CalculateCollide(IsoGridSquare gridSquare, bool bVision, bool bPathfind, bool bIgnoreSolidTrans) {
 // TODO: Implement CalculateCollide
 return false;
}

bool IsoGridSquare::CalculateCollide(IsoGridSquare gridSquare, bool bVision, bool bPathfind, bool bIgnoreSolidTrans, bool bIgnoreSolid) {
 // TODO: Implement CalculateCollide
 return false;
}
...
bool IsoGridSquare::CalculateVisionBlocked(IsoGridSquare gridSquare, IsoGridSquare.GetSquare getter) {
 // TODO: Implement CalculateVisionBlocked
 return false;
}

IsoGameCharacter IsoGridSquare::FindFriend(IsoGameCharacter g, int range, Stack<IsoGameCharacter> EnemyList) {
 // TODO: Implement FindFriend
 return nullptr;
}

IsoGameCharacter IsoGridSquare::FindEnemy(IsoGameCharacter g, int range, ArrayList<IsoMovingObject> EnemyList, IsoGameCharacter RangeTest, int TestRangeMax) {
 // TODO: Implement FindEnemy
 return nullptr;
}

IsoGameCharacter IsoGridSquare::FindEnemy(IsoGameCharacter g, int range, ArrayList<IsoMovingObject> EnemyList) {
 // TODO: Implement FindEnemy
 return nullptr;
}
...
void IsoGridSquare::ReCalculateCollide(IsoGridSquare square, IsoGridSquare.GetSquare getter) {
 // TODO: Implement ReCalculateCollide
}
...
void IsoGridSquare::ReCalculatePathFind(IsoGridSquare square, IsoGridSquare.GetSquare getter) {
 // TODO: Implement ReCalculatePathFind
}
...
void IsoGridSquare::ReCalculateVisionBlocked(IsoGridSquare square, IsoGridSquare.GetSquare getter) {
 // TODO: Implement ReCalculateVisionBlocked
}

bool IsoGridSquare::testCollideSpecialObjects(IsoMovingObject movingObject, IsoGridSquare square1, IsoGridSquare square0) {
 // TODO: Implement testCollideSpecialObjects
 return false;
}

bool IsoGridSquare::testCollideAdjacent(IsoMovingObject collideObject, int _x, int _y, int _z) {
...
bool IsoGridSquare::testCollideAdjacentAdvanced(int _x, int _y, int _z, bool ignoreDoors) {
...
bool IsoGridSquare::testPathFindAdjacent(IsoMovingObject mover, int _x, int _y, int _z) {
 // TODO: Implement testPathFindAdjacent
 return false;
}

bool IsoGridSquare::testPathFindAdjacent(IsoMovingObject mover, int _x, int _y, int _z, IsoGridSquare.GetSquare getter) {
 // TODO: Implement testPathFindAdjacent
 return false;
}
...
void IsoGridSquare::renderCharacters(int maxZ, bool deadRender, bool doBlendFunc) {
...
bool IsoGridSquare::RenderMinusFloorFxMask(int maxZ, bool doSE, bool vegitationRender) {
...
bool IsoGridSquare::renderMinusFloor(int int0, bool boolean1, bool boolean2, bool boolean3, bool boolean4, bool boolean5, Shader shader) {
...
IsoObject IsoGridSquare::getDoorOrWindowOrWindowFrame(IsoDirections dir, bool ignoreOpen) {
...
void IsoGridSquare::drawCircleExplosion(int radius, IsoTrap trap, IsoTrap.ExplosionMode explosionMode) {
