...
public IsoPushableObject::IsoPushableObject(IsoCell cell) {
 // TODO: Implement IsoPushableObject
 return nullptr;
}

public IsoPushableObject::IsoPushableObject(IsoCell cell, int x, int y, int z) {
 // TODO: Implement IsoPushableObject
 return nullptr;
}

public IsoPushableObject::IsoPushableObject(IsoCell cell, IsoGridSquare square, IsoSprite spr) {
 // TODO: Implement IsoPushableObject
 return nullptr;
}
...
void IsoPushableObject::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
