...
void IsoWorld::registerRoomTone(const std::string& name, const std::string& type, int _x, int _y, int z, int width, int height, KahluaTable properties) {
 // TODO: Implement registerRoomTone
}

void IsoWorld::registerSpawnOrigin(int _x, int _y, int width, int height, KahluaTable properties) {
...
void IsoWorld::registerWaterZone(float x1, float y1, float x2, float y2, float shore, float water_ground) {
...
void IsoWorld::onTrigger_setAnimationRecorderTriggerFile(TriggerSetAnimationRecorderFile triggerSetAnimationRecorderFile) {
...
void IsoWorld::LoadTileDefinitions(IsoSpriteManager sprMan, const std::string& filename, int fileNumber) {
...
void IsoWorld::LoadTileDefinitionsPropertyStrings(IsoSpriteManager sprMan, const std::string& filename, int fileNumber) {
...
void IsoWorld::setOpenDoorProperties(const std::string& string2, ArrayList<IsoSprite> arrayList) {
 // TODO: Implement setOpenDoorProperties
}

void IsoWorld::saveMovableStats(ArrayList<String>> map, int int0, int int1, int int2, int int3, int int4) {
 // TODO: Implement saveMovableStats
}

void IsoWorld::addJumboTreeTileset(IsoSpriteManager spriteManager, int int5, const std::string& string1, int int4, int int1, int int6) {
...
RandomizedVehicleStoryBase IsoWorld::getRandomizedVehicleStoryByName(const std::string& name) {
...
void IsoWorld::setTimeSinceLastSurvivorInHorde(int _timeSinceLastSurvivorInHorde) {
