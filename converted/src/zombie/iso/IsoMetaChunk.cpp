...
void IsoMetaChunk::getZonesIntersecting(int x, int y, int z, int w, int h, ArrayList<IsoMetaGrid.Zone> result) {
...
void IsoMetaChunk::getRoomsIntersecting(int x, int y, int w, int h, ArrayList<RoomDef> result) {
