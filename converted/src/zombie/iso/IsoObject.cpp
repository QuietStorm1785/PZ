...
public
IsoObject::IsoObject(IsoCell cell) {
...
public
IsoObject::IsoObject(IsoCell cell, IsoGridSquare _square, IsoSprite spr) {
  // TODO: Implement IsoObject
  return nullptr;
}

public
IsoObject::IsoObject(IsoCell cell, IsoGridSquare _square,
...
public
IsoObject::IsoObject(IsoGridSquare _square, const std::string &_tile,
...
IsoObject IsoObject::getNew(IsoGridSquare sq, const std::string &_spriteName,
                            const std::string &_name, bool bShareTilesWithMap) {
...
IsoObject IsoObject::factoryFromFileInput(IsoCell cell,
...
void IsoObject::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source,
                              ByteBuffer bb) {
...
void IsoObject::setAttachedAnimSprite(
...
void IsoObject::setChildSprites(
    ArrayList<IsoSpriteInstance> _AttachedAnimSprite) {
...
void IsoObject::AttachExistingAnim(IsoSprite spr, int OffsetX, int OffsetY,
...
void IsoObject::DoSpecialTooltip(ObjectTooltip tooltipUI,
...
void IsoObject::render(float x, float y, float z, ColorInfo col,
                       bool bDoAttached, bool bWallLightingPass,
                       Shader shader) {
  // TODO: Implement render
}

void IsoObject::debugRenderItemHeight(float float0, float float1,
                                      float float2) {
...
void IsoObject::renderWallTileOnly(float x, float y, float z, ColorInfo col,
                                   Shader shader,
...
void IsoObject::renderOverlaySprites(float float1, float float2, float float3,
...
void IsoObject::renderObjectPicker(float x, float y, float z,
                                   ColorInfo lightInfo) {
  // TODO: Implement renderObjectPicker
}

bool IsoObject::TestPathfindCollide(IsoMovingObject obj, IsoGridSquare from,
                                    IsoGridSquare to) {
  // TODO: Implement TestPathfindCollide
  return false;
}

bool IsoObject::TestCollide(IsoMovingObject obj, IsoGridSquare from,
                            IsoGridSquare to) {
...
void IsoObject::addObjectAmbientEmitter(
...
void IsoObject::saveChange(const std::string &change, KahluaTable tbl,
                           ByteBuffer bb) {
...
void IsoObject::setOverlaySprite(const std::string &_spriteName, float r,
                                 float g, float b, float a) {
  // TODO: Implement setOverlaySprite
}

bool IsoObject::setOverlaySprite(const std::string &_spriteName, float r,
                                 float g, float b, float a, bool bTransmit) {
  // TODO: Implement setOverlaySprite
  return false;
}
...
ItemContainer IsoObject::getContainerByEitherType(const std::string &type1,
...
bool IsoObject::isItemAllowedInContainer(ItemContainer _container,
                                         InventoryItem item) {
  // TODO: Implement isItemAllowedInContainer
  return false;
}

bool IsoObject::isRemoveItemAllowedFromContainer(ItemContainer _container,
                                                 InventoryItem item) {
...
void IsoObject::setOutlineHighlightCol(int playerIndex,
...
void IsoObject::setOutlineHighlightCol(int playerIndex, float r, float g,
                                       float b, float a) {
  // TODO: Implement setOutlineHighlightCol
}
...
void IsoObject::setOutlineHlAttached(int playerIndex,
                                     bool _isOutlineHlAttached) {
  // TODO: Implement setOutlineHlAttached
}
...
public
IsoObject::IsoObjectFactory(uint8_t _classID, const std::string &_objectName) {
...
void IsoObject::setOutlineColor(float float0, float float1, float float2,
                                float float3) {
