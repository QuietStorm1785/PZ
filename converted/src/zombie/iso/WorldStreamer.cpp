...
void WorldStreamer::addJobInstant(IsoChunk chunk, int var2, int var3, int int0, int int1) {
 // TODO: Implement addJobInstant
}

void WorldStreamer::addJobConvert(IsoChunk chunk, int var2, int var3, int int0, int int1) {
 // TODO: Implement addJobConvert
}

void WorldStreamer::addJobWipe(IsoChunk chunk, int var2, int var3, int int0, int int1) {
...
void WorldStreamer::compare(WorldStreamer.ChunkRequest chunkRequest, ByteBuffer byteBuffer, File file) {
...
void WorldStreamer::compareSquares(IsoGridSquare square1, IsoGridSquare square0) {
