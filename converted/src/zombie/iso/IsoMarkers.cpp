...
void IsoMarkers::renderIsoMarkers(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 // TODO: Implement renderIsoMarkers
}

void IsoMarkers::renderIsoMarkersDeferred(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
 // TODO: Implement renderIsoMarkersDeferred
}

void IsoMarkers::renderIsoMarkersOnSquare(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
...
void IsoMarkers::renderCircleIsoMarkers(IsoCell.PerPlayerRender perPlayerRender, int zLayer, int playerIndex) {
...
void IsoMarkers::init(KahluaTable textureTable, KahluaTable textureOverlayTable, int _x, int _y, int _z, IsoGridSquare gs) {
 // TODO: Implement init
}

void IsoMarkers::init(KahluaTable textureTable, KahluaTable textureOverlayTable, int _x, int _y, int _z, IsoGridSquare gs, bool doTempIsoObject) {
 // TODO: Implement init
}

void IsoMarkers::init(const std::string& spriteName, int _x, int _y, int _z, IsoGridSquare gs, bool doTempIsoObject) {
 // TODO: Implement init
}
