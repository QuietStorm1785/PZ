...
public SearchMode::PlayerSearchMode(int index, SearchMode sm) {
...
private SearchMode::SearchModeFloat(float float0, float float1, float float2) {
 // TODO: Implement SearchModeFloat
 return nullptr;
}

void SearchMode::set(float _exterior, float _targetExterior, float _interior, float _targetInterior) {
 // TODO: Implement set
}
