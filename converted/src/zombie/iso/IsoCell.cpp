...
public IsoCell::IsoCell(int _width, int _height) {
...
void IsoCell::CalculateVertColoursForTile(IsoGridSquare sqThis, int x, int y, int zz, int playerIndex) {
...
void IsoCell::recalculateAnyGridStacks(IsoCell.PerPlayerRender perPlayerRenderx, int int5, int int0, long long0) {
 // TODO: Implement recalculateAnyGridStacks
}

void IsoCell::flattenAnyFoliage(IsoCell.PerPlayerRender perPlayerRenderx, int int3) {
 // TODO: Implement flattenAnyFoliage
}

void IsoCell::performRenderTiles(IsoCell.PerPlayerRender perPlayerRenderx, int int1, int int3, long long0) {
...
void IsoCell::renderDebugLighting(IsoCell.PerPlayerRender perPlayerRenderx, int int1) {
 // TODO: Implement renderDebugLighting
}

void IsoCell::CullFullyOccludedSquares(IsoGridStack gridStack, boolean[][][] booleans1, boolean[][] booleans0) {
...
bool IsoCell::CanBuildingSquareOccludePlayer(IsoGridSquare square, int playerIndex) {
...
bool IsoCell::DoesSquareHaveValidCutaways(IsoGridSquare square6, IsoGridSquare square1, int int1, long long0) {
...
bool IsoCell::collapsibleBuildingSquareAlgorithm(BuildingDef buildingDef, IsoGridSquare square2, IsoGridSquare square0) {
...
int IsoCell::GetBuildingHeightAt(IsoBuilding building, int int2, int int3, int int1) {
...
void IsoCell::renderSnowTileBase(Texture texture, int int1, int int0, float float0, bool boolean0) {
...
IsoGridSquare IsoCell::ConnectNewSquare(IsoGridSquare square, bool var2, bool var3) {
 // TODO: Implement ConnectNewSquare
 return nullptr;
}

void IsoCell::DoGridNav(IsoGridSquare newSquare, IsoGridSquare.GetSquare getter) {
 // TODO: Implement DoGridNav
}

IsoGridSquare IsoCell::ConnectNewSquare(IsoGridSquare newSquare, bool bDoSurrounds) {
 // TODO: Implement ConnectNewSquare
 return nullptr;
}

void IsoCell::PlaceLot(const std::string& filename, int sx, int sy, int sz, bool bClearExisting) {
...
void IsoCell::PlaceLot(IsoLot lot, int sx, int sy, int sz, IsoChunk ch, int WX, int WY) {
 // TODO: Implement PlaceLot
}
...
IsoLightSource IsoCell::addLamppost(int x, int y, int z, float r, float g, float b, int rad) {
 // TODO: Implement addLamppost
 return nullptr;
}
...
void IsoCell::InsertAt(int int1, BuildingScore buildingScore, BuildingScore[] buildingScores) {
 // TODO: Implement InsertAt
}

void IsoCell::Place(BuildingScore buildingScore, BuildingScore[] buildingScores, IsoCell.BuildingSearchCriteria buildingSearchCriteria) {
 // TODO: Implement Place
}

bool IsoCell::blocked(Mover mover, int x, int y, int z, int lx, int ly, int lz) {
...
void IsoCell::setCacheGridSquareLocal(int x, int y, int z, IsoGridSquare square, int playerIndex) {
...
int IsoCell::CalculateColor(IsoGridSquare square1, IsoGridSquare square2, IsoGridSquare square3, IsoGridSquare square0, int int1, int int0) {
...
void IsoCell::GetBuildingsInFrontOfCharacter(ArrayList<IsoBuilding> arrayList, IsoGridSquare square, bool boolean0) {
 // TODO: Implement GetBuildingsInFrontOfCharacter
}

void IsoCell::GetBuildingsInFrontOfCharacterSquare(int int0, int int1, int int2, bool boolean0, ArrayList<IsoBuilding> arrayList0) {
 // TODO: Implement GetBuildingsInFrontOfCharacterSquare
}

IsoBuilding IsoCell::GetPeekedInBuilding(IsoGridSquare square0, IsoDirections directions) {
 // TODO: Implement GetPeekedInBuilding
 return nullptr;
}

void IsoCell::GetSquaresAroundPlayerSquare(IsoPlayer player, IsoGridSquare square0, ArrayList<IsoGridSquare> arrayList0, ArrayList<IsoGridSquare> arrayList1) {
...
IsoGridSquare IsoCell::createNewGridSquare(int x, int y, int z, bool recalcAll) {
 // TODO: Implement createNewGridSquare
 return nullptr;
}

IsoGridSquare IsoCell::getGridSquareDirect(int x, int y, int z, int playerIndex) {
...
float IsoCell::getHeatSourceHighestTemperature(float surroundingAirTemperature, int x, int y, int z) {
...
void IsoCell::AddUniqueToBuildingList(ArrayList<IsoBuilding> arrayList, IsoBuilding building) {
...
public IsoCell::SnowGrid(int arg1) {
...
public IsoCell::SnowGridTiles(uint8_t arg1) {
