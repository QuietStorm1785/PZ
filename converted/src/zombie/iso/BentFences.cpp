...
void BentFences::tableToTiles(KahluaTableImpl kahluaTableImpl, ArrayList<String> arrayList) {
 // TODO: Implement tableToTiles
}

void BentFences::tableToTiles(KahluaTable table, ArrayList<String> arrayList, const std::string& string) {
 // TODO: Implement tableToTiles
}
...
bool BentFences::isBentObject(IsoObject obj) {
 // TODO: Implement isBentObject
 return false;
}

bool BentFences::isUnbentObject(IsoObject obj) {
 // TODO: Implement isUnbentObject
 return false;
}

bool BentFences::isValidObject(IsoObject object, BentFences.Entry entry, bool boolean0) {
 // TODO: Implement isValidObject
 return false;
}

IsoObject BentFences::getObjectForEntry(IsoGridSquare square, ArrayList<String> arrayList, int int1) {
...
bool BentFences::isNorth() {
 // TODO: Implement isNorth
 return false;
}
