...
public IsoDirectionFrame::IsoDirectionFrame(Texture tex) {
...
public IsoDirectionFrame::IsoDirectionFrame(Texture nw, Texture n, Texture ne, Texture e, Texture se) {
 // TODO: Implement IsoDirectionFrame
 return nullptr;
}

public IsoDirectionFrame::IsoDirectionFrame(Texture n, Texture nw, Texture w, Texture sw, Texture s, Texture se, Texture e, Texture ne) {
 // TODO: Implement IsoDirectionFrame
 return nullptr;
}

public IsoDirectionFrame::IsoDirectionFrame(Texture n, Texture s, Texture e, Texture w) {
 // TODO: Implement IsoDirectionFrame
 return nullptr;
}
...
void IsoDirectionFrame::render(float sx, float sy, IsoDirections dir, ColorInfo info, bool Flip, Consumer<TextureDraw> texdModifier) {
