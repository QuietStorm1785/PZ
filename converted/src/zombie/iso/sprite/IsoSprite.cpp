...
public IsoSprite::IsoSprite(IsoSpriteManager manager) {
 // TODO: Implement IsoSprite
 return nullptr;
}
...
IsoSprite IsoSprite::CreateSpriteUsingCache(const std::string& objectName, const std::string& animName, int numFrames) {
...
IsoSprite IsoSprite::getSprite(IsoSpriteManager manager, IsoSprite spr, int offset) {
 // TODO: Implement getSprite
 return nullptr;
}

IsoSprite IsoSprite::getSprite(IsoSpriteManager manager, const std::string& _name, int offset) {
 // TODO: Implement getSprite
 return nullptr;
}
...
void IsoSprite::LoadFrames(const std::string& ObjectName, const std::string& AnimName, int nFrames) {
 // TODO: Implement LoadFrames
}

void IsoSprite::LoadFramesReverseAltName(const std::string& ObjectName, const std::string& AnimName, const std::string& AltName, int nFrames) {
 // TODO: Implement LoadFramesReverseAltName
}

void IsoSprite::LoadFramesNoDirPage(const std::string& ObjectName, const std::string& AnimName, int nFrames) {
 // TODO: Implement LoadFramesNoDirPage
}

void IsoSprite::LoadFramesNoDirPageDirect(const std::string& ObjectName, const std::string& AnimName, int nFrames) {
...
void IsoSprite::LoadFramesPageSimple(const std::string& NObjectName, const std::string& SObjectName, const std::string& EObjectName, const std::string& WObjectName) {
 // TODO: Implement LoadFramesPageSimple
}

void IsoSprite::LoadFramesPcx(const std::string& ObjectName, const std::string& AnimName, int nFrames) {
...
void IsoSprite::RenderGhostTileColor(int x, int y, int z, float r, float g, float b, float a) {
 // TODO: Implement RenderGhostTileColor
}

void IsoSprite::RenderGhostTileColor(int x, int y, int z, float offsetX, float offsetY, float r, float g, float b, float a) {
 // TODO: Implement RenderGhostTileColor
}
...
void IsoSprite::render(IsoObject obj, float x, float y, float z, IsoDirections dir, float offsetX, float offsetY, ColorInfo info2, bool bDoRenderPrep) {
...
void IsoSprite::renderSpriteOutline(float float0, float float1, Texture texture, float float3, float float2) {
...
void IsoSprite::renderObjectPicker(IsoSpriteInstance _def, IsoObject obj, IsoDirections dir) {
...
IsoSprite IsoSprite::setFromCache(const std::string& objectName, const std::string& animName, int numFrames) {
