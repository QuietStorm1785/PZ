...
public IsoSpriteInstance::IsoSpriteInstance(IsoSprite spr) {
 // TODO: Implement IsoSpriteInstance
 return nullptr;
}
...
void IsoSpriteInstance::RenderGhostTileColor(int x, int y, int z, float r, float g, float b, float a) {
...
void IsoSpriteInstance::scaleAspect(float texW, float texH, float width, float height) {
