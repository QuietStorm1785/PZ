...
void IsoMetaGrid::getRoomsIntersecting(int x, int y, int w, int h, ArrayList<RoomDef> roomDefs) {
...
void IsoMetaGrid::calculatePolylineOutlineBounds(TIntArrayList tIntArrayList, int int0, int[] ints) {
...
void IsoMetaGrid::registerRoomTone(const std::string& name, const std::string& type, int x, int y, int z, int _width, int _height, KahluaTable properties) {
 // TODO: Implement registerRoomTone
}

bool IsoMetaGrid::isZoneAbove(IsoMetaGrid.Zone zone1, IsoMetaGrid.Zone zone2, int x, int y, int z) {
...
RoomDef IsoMetaGrid::getRandomRoomBetweenRange(float x, float y, float min, float max) {
...
void IsoMetaGrid::getLotDirectories(const std::string& string0, ArrayList<String> arrayList) {
...
public IsoMetaGrid::Trigger(BuildingDef buildingDef, int int0, int int1, const std::string& string) {
...
public IsoMetaGrid::VehicleZone(const std::string& string0, const std::string& string1, int int0, int int1, int int2, int int3, int int4, KahluaTable table) {
...
public IsoMetaGrid::Zone(const std::string& string0, const std::string& string1, int int0, int int1, int int2, int int3, int int4) {
 // TODO: Implement Zone
 return nullptr;
}
...
bool IsoMetaGrid::difference(int int0, int int1, int int2, int int3, int int4, ArrayList<IsoMetaGrid.Zone> arrayList) {
...
int IsoMetaGrid::getClippedSegmentOfPolyline(int int7, int int6, int int5, int int4, double[] doubles) {
...
float IsoMetaGrid::isLeft(float float3, float float1, float float5, float float0, float float2, float float4) {
...
bool IsoMetaGrid::lineSegmentIntersects(float float3, float float1, float float2, float float0) {
 // TODO: Implement lineSegmentIntersects
 return false;
}

bool IsoMetaGrid::polylineOutlineRectIntersect(int int1, int int0, int int3, int int2) {
 // TODO: Implement polylineOutlineRectIntersect
 return false;
}

bool IsoMetaGrid::polylineOutlineSegmentIntersects(float float3, float float1, float float2, float float0) {
...
float IsoMetaGrid::triangleArea(float float4, float float2, float float3, float float1, float float7, float float6) {
