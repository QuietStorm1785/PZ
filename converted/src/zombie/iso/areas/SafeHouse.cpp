...
SafeHouse SafeHouse::addSafeHouse(int _x, int _y, int _w, int _h, const std::string& player, bool remote) {
...
SafeHouse SafeHouse::isSafeHouse(IsoGridSquare square, const std::string& username, bool doDisableSafehouse) {
 // TODO: Implement isSafeHouse
 return nullptr;
}
...
std::string SafeHouse::canBeSafehouse(IsoGridSquare clickedSquare, IsoPlayer player) {
...
public SafeHouse::SafeHouse(int _x, int _y, int _w, int _h, const std::string& player) {
