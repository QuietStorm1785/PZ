...
public NonPvpZone::NonPvpZone(const std::string& _title, int _x, int _y, int _x2, int _y2) {
 // TODO: Implement NonPvpZone
 return nullptr;
}

NonPvpZone NonPvpZone::addNonPvpZone(const std::string& _title, int _x, int _y, int _x2, int _y2) {
