...
void IsoRegionsRenderer::renderStringUI(float x, float y, const std::string& str, Color c) {
 // TODO: Implement renderStringUI
}

void IsoRegionsRenderer::renderStringUI(float x, float y, const std::string& str, double r, double g, double b, double a) {
 // TODO: Implement renderStringUI
}

void IsoRegionsRenderer::renderString(float x, float y, const std::string& str, double r, double g, double b, double a) {
 // TODO: Implement renderString
}

void IsoRegionsRenderer::renderRect(float x, float y, float w, float h, float r, float g, float b, float a) {
 // TODO: Implement renderRect
}

void IsoRegionsRenderer::renderLine(float x1, float y1, float x2, float y2, float r, float g, float b, float a) {
 // TODO: Implement renderLine
}

void IsoRegionsRenderer::outlineRect(float x, float y, float w, float h, float r, float g, float b, float a) {
 // TODO: Implement outlineRect
}

void IsoRegionsRenderer::renderCellInfo(int cellX, int cellY, int effectivePopulation, int targetPopulation, float lastRepopTime) {
 // TODO: Implement renderCellInfo
}

void IsoRegionsRenderer::renderZombie(float x, float y, float r, float g, float b) {
 // TODO: Implement renderZombie
}

void IsoRegionsRenderer::renderSquare(float x, float y, float r, float g, float b, float alpha) {
 // TODO: Implement renderSquare
}

void IsoRegionsRenderer::renderEntity(float size, float x, float y, float r, float g, float b, float a) {
 // TODO: Implement renderEntity
}

void IsoRegionsRenderer::render(UIElement ui, float _zoom, float _xPos, float _yPos) {
...
void IsoRegionsRenderer::_render(UIElement uIElement, float float2, float float0, float float1) {
...
ConfigOption IsoRegionsRenderer::getZLevelOptionByName(const std::string& name) {
...
public IsoRegionsRenderer::BooleanDebugOption(ArrayList<ConfigOption> optionList, const std::string& name, bool defaultValue, int _zLevel) {
 // TODO: Implement BooleanDebugOption
 return nullptr;
}

public IsoRegionsRenderer::BooleanDebugOption(ArrayList<ConfigOption> optionList, const std::string& name, bool defaultValue) {
 // TODO: Implement BooleanDebugOption
 return nullptr;
}
