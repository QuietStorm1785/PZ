...
protected DataChunk::DataChunk(int int1, int int2, DataCell dataCell, int int0) {
...
uint8_t DataChunk::setOrAddSquare(int int0, int int1, int int2, uint8_t byte0, bool boolean0) {
 // TODO: Implement setOrAddSquare
 return 0;
}
...
DataSquarePos DataChunk::getNeighbor(DataSquarePos dataSquarePos, uint8_t byte0) {
 // TODO: Implement getNeighbor
 return nullptr;
}

void DataChunk::link(DataChunk dataChunk1, DataChunk dataChunk2, DataChunk dataChunk3, DataChunk dataChunk4) {
 // TODO: Implement link
}

void DataChunk::linkRegionsOnSide(int int4, DataChunk dataChunk0, uint8_t byte0) {
...
void DataChunk::floodFillExpandWorldRegion(IsoChunkRegion chunkRegion0, IsoWorldRegion worldRegion) {
