...
public IsoChunk::IsoChunk(IsoCell cell) {
...
void IsoChunk::AddVehicles_OnZone(IsoMetaGrid.VehicleZone vehicleZone, const std::string& string) {
 // TODO: Implement AddVehicles_OnZone
}

void IsoChunk::AddVehicles_OnZonePolyline(IsoMetaGrid.VehicleZone vehicleZone, const std::string& string) {
...
void IsoChunk::spawnVehicleRandomAngle(IsoGridSquare square, IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement spawnVehicleRandomAngle
}

bool IsoChunk::RandomizeModel(BaseVehicle v, IsoMetaGrid.Zone zone, const std::string& name, VehicleType type) {
 // TODO: Implement RandomizeModel
 return false;
}

void IsoChunk::AddVehicles_TrafficJam_W(IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement AddVehicles_TrafficJam_W
}

void IsoChunk::AddVehicles_TrafficJam_E(IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement AddVehicles_TrafficJam_E
}

void IsoChunk::AddVehicles_TrafficJam_S(IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement AddVehicles_TrafficJam_S
}

void IsoChunk::AddVehicles_TrafficJam_N(IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement AddVehicles_TrafficJam_N
}

void IsoChunk::AddVehicles_TrafficJam_Polyline(IsoMetaGrid.Zone zone, const std::string& string) {
 // TODO: Implement AddVehicles_TrafficJam_Polyline
}

void IsoChunk::TryAddVehicle_TrafficJam(IsoMetaGrid.Zone zone, const std::string& string, float float1, float float0, Vector2 vector, float float6, float float7) {
...
void IsoChunk::calcPhysics(int int1, int int2, int int3, IsoChunk.PhysicsShapes[] physicsShapess) {
...
void IsoChunk::RecalcAllWithNeighbour(IsoGridSquare square0, IsoDirections directions, int int3) {
...
void IsoChunk::fixObjectAmbientEmittersOnAdjacentChunks(IsoChunk chunk1, IsoChunk chunk0) {
 // TODO: Implement fixObjectAmbientEmittersOnAdjacentChunks
}

void IsoChunk::fixObjectAmbientEmittersOnSquare(IsoGridSquare square, bool boolean0) {
...
void IsoChunk::SafeWrite(const std::string& _prefix, int _wx, int _wy, ByteBuffer bb) {
 // TODO: Implement SafeWrite
}

ByteBuffer IsoChunk::SafeRead(const std::string& _prefix, int _wx, int _wy, ByteBuffer bb) {
...
void IsoChunk::setRandomVehicleStoryToSpawnLater(VehicleStorySpawnData spawnData) {
...
void IsoChunk::addObjectAmbientEmitter(IsoObject object, ObjectAmbientEmitters.PerObjectLogic logic) {
...
public IsoChunk::ChunkLock(int int0, int int1) {
