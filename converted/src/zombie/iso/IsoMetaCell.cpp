...
public IsoMetaCell::IsoMetaCell(int _wx, int _wy) {
 // TODO: Implement IsoMetaCell
 return nullptr;
}

void IsoMetaCell::addTrigger(BuildingDef def, int triggerRange, int zombieExclusionRange, const std::string& type) {
...
void IsoMetaCell::getZonesIntersecting(int x, int y, int z, int w, int h, ArrayList<IsoMetaGrid.Zone> result) {
 // TODO: Implement getZonesIntersecting
}

void IsoMetaCell::getRoomsIntersecting(int x, int y, int w, int h, ArrayList<RoomDef> result) {
