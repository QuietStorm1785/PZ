...
void MultiStageBuilding::doStage(IsoGameCharacter chr, IsoThumpable item, bool removeItems) {
 // TODO: Implement doStage
}

bool MultiStageBuilding::canBeDone(IsoGameCharacter chr, IsoObject itemClicked, bool cheat) {
