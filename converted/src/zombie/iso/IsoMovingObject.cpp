...
public IsoMovingObject::IsoMovingObject(IsoCell cell) {
 // TODO: Implement IsoMovingObject
 return nullptr;
}

public IsoMovingObject::IsoMovingObject(IsoCell cell, bool bObjectListAdd) {
 // TODO: Implement IsoMovingObject
 return nullptr;
}

public IsoMovingObject::IsoMovingObject(IsoCell cell, IsoGridSquare square, IsoSprite spr, bool bObjectListAdd) {
 // TODO: Implement IsoMovingObject
 return nullptr;
}
...
Vector2 IsoMovingObject::getVectorFromDirection(Vector2 moveForwardVec, IsoDirections dir) {
 // TODO: Implement getVectorFromDirection
 return nullptr;
}
...
float IsoMovingObject::Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit, bool bIgnoreDamage, float modDelta) {
 // TODO: Implement Hit
 return 0;
}
...
void IsoMovingObject::load(ByteBuffer input, int WorldVersion, bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
float IsoMovingObject::getClosestListener(float float5, float float6, float float7) {
