...
Audio DummySoundManager::Start(Audio musicTrack, float f, const std::string& PrefMusic) {
...
void DummySoundManager::PlayWorldSoundWav(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, int choices, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
}

Audio DummySoundManager::PlayWorldSoundWav(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
 return nullptr;
}

Audio DummySoundManager::PlayWorldSoundWav(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundWav
 return nullptr;
}

Audio DummySoundManager::PlayWorldSound(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, int choices, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}

Audio DummySoundManager::PlayWorldSound(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}

Audio DummySoundManager::PlayWorldSoundImpl(const std::string& name, bool loop, int sx, int sy, int sz, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSoundImpl
 return nullptr;
}

Audio DummySoundManager::PlayWorldSound(const std::string& name, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
 // TODO: Implement PlayWorldSound
 return nullptr;
}
...
Audio DummySoundManager::PlaySoundWav(const std::string& name, int variations, bool loop, float maxGain) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}

Audio DummySoundManager::PlaySoundWav(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}

Audio DummySoundManager::PlaySoundWav(const std::string& name, bool loop, float maxGain, float pitchVar) {
 // TODO: Implement PlaySoundWav
 return nullptr;
}

Audio DummySoundManager::PlayJukeboxSound(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlayJukeboxSound
 return nullptr;
}

Audio DummySoundManager::PlaySoundEvenSilent(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlaySoundEvenSilent
 return nullptr;
}

Audio DummySoundManager::PlaySound(const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlaySound
 return nullptr;
}

Audio DummySoundManager::PlaySound(const std::string& name, bool loop, float pitchVar, float maxGain) {
 // TODO: Implement PlaySound
 return nullptr;
}

Audio DummySoundManager::PlayMusic(const std::string& n, const std::string& name, bool loop, float maxGain) {
 // TODO: Implement PlayMusic
 return nullptr;
}

void DummySoundManager::PlayAsMusic(const std::string& name, Audio musicTrack, bool loop, float volume) {
...
void DummySoundManager::setMusicWakeState(IsoPlayer player, const std::string& stateName) {
...
void DummySoundManager::playMusicNonTriggered(const std::string& name, float gain) {
...
void DummySoundManager::PlayAsMusic(const std::string& name, Audio musicTrack, float volume, bool bloop) {
 // TODO: Implement PlayAsMusic
}
...
Audio DummySoundManager::BlendThenStart(Audio musicTrack, float f, const std::string& PrefMusic) {
 // TODO: Implement BlendThenStart
 return nullptr;
}

void DummySoundManager::BlendVolume(Audio audio, float targetVolume, float blendSpeedAlpha) {
...
Audio DummySoundManager::PlayWorldSoundWavImpl(const std::string& name, bool loop, IsoGridSquare source, float pitchVar, float radius, float maxGain, bool ignoreOutside) {
