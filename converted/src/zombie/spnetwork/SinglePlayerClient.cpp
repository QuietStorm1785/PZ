...
void SinglePlayerClient::mainLoopDealWithNetData(ZomboidNetData zomboidNetData) {
...
void SinglePlayerClient::sendClientCommand(IsoPlayer player, const std::string& string0, const std::string& string1, KahluaTable table) {
