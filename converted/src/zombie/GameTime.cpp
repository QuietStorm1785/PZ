...
void GameTime::syncServerTime(long timeClientSend, long timeServer, long timeClientReceive) {
...
float GameTime::TimeLerp(float startVal, float endVal, float startTime, float endTime) {
...
void GameTime::updateCalendar(int year, int month, int dayOfMonth, int hourOfDay, int minute) {
