...
void CharacterSmartTexture::setBlood(BloodBodyPartType bodyPart, float intensity) {
 // TODO: Implement setBlood
}

void CharacterSmartTexture::setDirt(BloodBodyPartType bodyPart, float intensity) {
...
float CharacterSmartTexture::addBlood(BloodBodyPartType bodyPart, float intensity, IsoGameCharacter chr) {
 // TODO: Implement addBlood
 return 0;
}

float CharacterSmartTexture::addDirt(BloodBodyPartType bodyPart, float intensity, IsoGameCharacter chr) {
