...
void ItemInfo::save(ByteBuffer byteBuffer, List<String> list1, List<String> list0) {
 // TODO: Implement save
}

void ItemInfo::load(ByteBuffer byteBuffer, int var2, List<String> list1, List<String> list0) {
 // TODO: Implement load
}
