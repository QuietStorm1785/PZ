...
bool SGlobalObjects::receiveClientCommand(const std::string& systemName, const std::string& command, IsoPlayer playerObj, KahluaTable args) {
...
void SGlobalObjects::OnIsoObjectChangedItself(const std::string& systemName, IsoObject isoObject) {
