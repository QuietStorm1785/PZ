...
public CGlobalObjectSystem::CGlobalObjectSystem(const std::string& name) {
...
void CGlobalObjectSystem::sendCommand(const std::string& command, IsoPlayer player, KahluaTable args) {
 // TODO: Implement sendCommand
}

void CGlobalObjectSystem::receiveServerCommand(const std::string& command, KahluaTable args) {
 // TODO: Implement receiveServerCommand
}

void CGlobalObjectSystem::receiveNewLuaObjectAt(int x, int y, int z, KahluaTable args) {
...
void CGlobalObjectSystem::receiveUpdateLuaObjectAt(int x, int y, int z, KahluaTable args) {
