...
IFile FileSystemImpl::open(DeviceList deviceList, const std::string& string, int int0) {
 // TODO: Implement open
 return nullptr;
}
...
int FileSystemImpl::openAsync(DeviceList deviceList, const std::string& string, int int0, IFileTask2Callback iFileTask2Callback) {
 // TODO: Implement openAsync
 return 0;
}

void FileSystemImpl::closeAsync(IFile iFile, IFileTask2Callback iFileTask2Callback) {
...
InputStream FileSystemImpl::openStream(DeviceList deviceList, const std::string& string) {
...
void FileSystemImpl::mountTexturePack(const std::string& string, FileSystem.TexturePackTextures texturePackTextures, int int0) {
...
bool FileSystemImpl::getTexturePackAlpha(const std::string& string1, const std::string& string0) {
