...
public PngImage::PngImage(PngConfig pngConfig) {
 // TODO: Implement PngImage
 return nullptr;
}
...
BufferedImage PngImage::createImage(InputStream inputStream, Dimension dimension) {
...
void* PngImage::getProperty(const std::string& string, Class clazz, bool boolean0) {
 // TODO: Implement getProperty
 return nullptr;
}
