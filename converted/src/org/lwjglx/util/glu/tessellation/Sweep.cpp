...
bool Sweep::EdgeLeq(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion0, ActiveRegion activeRegion1) {
 // TODO: Implement EdgeLeq
 return false;
}

void Sweep::DeleteRegion(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion) {
...
ActiveRegion Sweep::AddRegionBelow(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1, GLUhalfEdge gLUhalfEdge) {
...
void Sweep::ComputeWinding(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion) {
 // TODO: Implement ComputeWinding
}

void Sweep::FinishRegion(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion) {
 // TODO: Implement FinishRegion
}

GLUhalfEdge Sweep::FinishLeftRegions(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1, ActiveRegion activeRegion2) {
 // TODO: Implement FinishLeftRegions
 return nullptr;
}

void Sweep::CallCombine(GLUtessellatorImpl gLUtessellatorImpl, GLUvertex gLUvertex, Object[] objects1, float[] floats, bool boolean0) {
 // TODO: Implement CallCombine
}

void Sweep::SpliceMergeVertices(GLUtessellatorImpl gLUtessellatorImpl, GLUhalfEdge gLUhalfEdge0, GLUhalfEdge gLUhalfEdge1) {
 // TODO: Implement SpliceMergeVertices
}

void Sweep::VertexWeights(GLUvertex gLUvertex1, GLUvertex gLUvertex0, GLUvertex gLUvertex2, float[] floats) {
 // TODO: Implement VertexWeights
}

bool Sweep::CheckForRightSplice(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1) {
 // TODO: Implement CheckForRightSplice
 return false;
}

bool Sweep::CheckForLeftSplice(GLUtessellatorImpl var0, ActiveRegion activeRegion1) {
 // TODO: Implement CheckForLeftSplice
 return false;
}

bool Sweep::CheckForIntersect(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1) {
 // TODO: Implement CheckForIntersect
 return false;
}

void Sweep::WalkDirtyRegions(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1) {
 // TODO: Implement WalkDirtyRegions
}

void Sweep::ConnectRightVertex(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion1, GLUhalfEdge gLUhalfEdge1) {
 // TODO: Implement ConnectRightVertex
}

void Sweep::ConnectLeftDegenerate(GLUtessellatorImpl gLUtessellatorImpl, ActiveRegion activeRegion0, GLUvertex gLUvertex) {
 // TODO: Implement ConnectLeftDegenerate
}

void Sweep::ConnectLeftVertex(GLUtessellatorImpl gLUtessellatorImpl, GLUvertex gLUvertex) {
 // TODO: Implement ConnectLeftVertex
}

void Sweep::SweepEvent(GLUtessellatorImpl gLUtessellatorImpl, GLUvertex gLUvertex) {
...
void Sweep::InitEdgeDict( GLUtessellatorImpl) {
