...
int FuncState::singlevaraux(const std::string& string, ExpDesc expDesc, int int1) {
...
void FuncState::codecomp(int int2, int int3, ExpDesc expDesc0, ExpDesc expDesc1) {
