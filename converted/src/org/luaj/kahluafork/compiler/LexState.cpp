...
Prototype LexState::compile(int int0, Reader reader, const std::string& string0, const std::string& string1) {
 // TODO: Implement compile
 return nullptr;
}

public LexState::LexState(Reader reader, int int0, const std::string& string) {
