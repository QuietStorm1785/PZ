...
public class DBSchema {
   ...
   public DBSchema(Connection var1) {
      try {
         ...
         ResultSet var4 = var2.getTables(null, null, null, var3);

         while (var4.next()) {
            String var5 = var4.getString(3);
            if (!var5.startsWith("SQLITE_")) {
               ResultSet var6 = var2.getColumns(null, null, var5, null);
               HashMap var7 = new HashMap();

               while (var6.next()) {
                  String var8 = var6.getString(4);
                  if (!var8.equals("world")
                     && !var8.equals("moderator")
                     && !var8.equals("admin")
                     && !var8.equals("password")
                     && !var8.equals("encryptedPwd")
                     && !var8.equals("pwdEncryptType")
                     && !var8.equals("transactionID")) {
