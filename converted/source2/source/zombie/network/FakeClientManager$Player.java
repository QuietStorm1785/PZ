...
class FakeClientManager$Player {
   ...
   private FakeClientManager$Player(Movement var1, Network var2, int var3, int var4) {
      ...
      this.client = new Client(this, var2, var3, var4);
   ...
   private Zombie getNearestZombie(RemotePlayer var1) {
      Zombie var2 = null;
   ...
   private RemotePlayer getNearestPlayer() {
      RemotePlayer var1 = null;
      float var2 = Float.POSITIVE_INFINITY;
