...
import zombie.network.ServerChunkLoader.GetSquare;
import zombie.network.ServerMap.ServerCell;

class ServerChunkLoader$RecalcAllThread extends Thread {
                     ...
                     for (int var14 = 0; var14 <= var12.maxLevel; var14++) {
                        ...
                        if (var14 == 0) {
                           if (var15 == null) {
                              ...
                              var15 = IsoGridSquare.getNew(IsoWorld.instance.CurrentCell, null, var16, var17, var14);
               ...
               if (var25 != null) {
                  for (int var27 = 0; var27 < var9; var27++) {
                     for (int var29 = 0; var29 <= var25.maxLevel; var29++) {
                        ...
                        if (var32 != null) {
                           if (var29 > 0 && !var32.getObjects().isEmpty()) {
               ...
               if (var26 != null) {
                  for (int var28 = 0; var28 < var9; var28++) {
                     for (int var30 = var26.maxLevel; var30 > 0; var30--) {
                        ...
                        if (var33 != null && var33.Is(IsoFlagType.solidfloor)) {
                           var30--;
   ...
   private boolean hasAnyBrandNewChunks(ServerCell var1) {
