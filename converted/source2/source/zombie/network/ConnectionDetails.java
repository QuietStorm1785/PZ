...
public class ConnectionDetails {
   public static void write(UdpConnection var0, LogonResult var1, ByteBuffer var2) {
      try {
   ...
   private static void writeServerDetails(ByteBuffer var0, UdpConnection var1, LogonResult var2) {
   ...
   private static void writeMods(ByteBuffer var0) {
      ...
      for (String var4 : GameServer.ServerMods) {
      ...
      for (Mod var9 : var1) {
         GameWindow.WriteString(var0, var9.getId());
   ...
   private static void writeServerOptions(ByteBuffer var0) {
      ...
      for (String var2 : ServerOptions.instance.getPublicOptions()) {
