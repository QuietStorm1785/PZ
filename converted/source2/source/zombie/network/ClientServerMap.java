         ...
         if (var1 != null && !var1.ignore) {
            ...
            for (int var21 = 0; var21 < IsoChunkMap.ChunkGridWidth; var21++) {
               for (int var22 = 0; var22 < IsoChunkMap.ChunkGridWidth; var22++) {
                  ...
                  if (var23 != null) {
                     boolean var13 = isLoaded[var22 + var21 * IsoChunkMap.ChunkGridWidth];
                     if (var13 && var9 != null) {
                        IsoChunk var14 = var1.getChunk(var22, var21 - 1);
                        if (var14 != null && !isLoaded[var22 + (var21 - 1) * IsoChunkMap.ChunkGridWidth]) {
                           for (int var15 = 0; var15 < var3; var15++) {
                              ...
                              SpriteRenderer.instance
                                 .render(var9, var16 - var9.getWidth() / 2, var17, var9.getWidth(), var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, null);
                           }
                        }

                        IsoChunk var25 = var1.getChunk(var22, var21 + 1);
                        if (var25 != null && !isLoaded[var22 + (var21 + 1) * IsoChunkMap.ChunkGridWidth]) {
                           for (int var27 = 0; var27 < var3; var27++) {
                              ...
                              SpriteRenderer.instance
                                 .render(var9, var30 - var9.getWidth() / 2, var18, var9.getWidth(), var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, null);
                           }
                        }

                        IsoChunk var28 = var1.getChunk(var22 - 1, var21);
                        if (var28 != null && !isLoaded[var22 - 1 + var21 * IsoChunkMap.ChunkGridWidth]) {
                           for (int var31 = 0; var31 < var3; var31++) {
                              ...
                              SpriteRenderer.instance
                                 .render(var9, var34 - var9.getWidth() / 2, var19, var9.getWidth(), var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, null);
                           }
                        }

                        IsoChunk var32 = var1.getChunk(var22 + 1, var21);
                        if (var32 != null && !isLoaded[var22 + 1 + var21 * IsoChunkMap.ChunkGridWidth]) {
                           for (int var35 = 0; var35 < var3; var35++) {
                              ...
                              SpriteRenderer.instance
                                 .render(var9, var36 - var9.getWidth() / 2, var20, var9.getWidth(), var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, null);
                           }
                        }
                     }
