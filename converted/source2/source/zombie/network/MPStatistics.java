...
public class MPStatistics {
   ...
   public static void setVOIPSource(VoiceDataSource var0, int var1) {
      clientVOIPSource = VoiceDataSource.Unknown.equals(var0) ? "" : var0.name();
      clientVOIPFreq = var1 == 0 ? "" : String.valueOf(var1 / 1000.0F);
   }
                  ...
                  if (var2 > 0L) {
                     ((NotificationEmitter)ManagementFactory.getMemoryMXBean())
                        .addNotificationListener(
                           ...
                           var0x -> "java.management.memory.threshold.exceeded".equals(var0x.getType()),
                           null
                        );
                  }
