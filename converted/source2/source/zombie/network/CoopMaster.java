...
import zombie.network.CoopMaster.1;
import zombie.network.CoopMaster.10;
import zombie.network.CoopMaster.11;
import zombie.network.CoopMaster.12;
import zombie.network.CoopMaster.2;
import zombie.network.CoopMaster.3;
import zombie.network.CoopMaster.4;
import zombie.network.CoopMaster.5;
import zombie.network.CoopMaster.6;
import zombie.network.CoopMaster.7;
import zombie.network.CoopMaster.8;
import zombie.network.CoopMaster.9;
import zombie.network.CoopMaster.ListenerOptions;
import zombie.network.CoopMaster.Pair;
import zombie.network.CoopMaster.TerminationReason;
...
public class CoopMaster {
   ...
   private void launchServer(String var1, String var2, int var3, boolean var4) throws IOException {
      ...
      var6.add("-Xms" + var3 + "m");
      var6.add("-Xmx" + var3 + "m");
      var6.add("-Djava.library.path=" + System.getProperty("java.library.path"));
      var6.add("-Djava.class.path=" + System.getProperty("java.class.path"));
      var6.add("-Duser.dir=" + System.getProperty("user.dir"));
      var6.add("-Duser.home=" + System.getProperty("user.home"));
      var6.add("-Dzomboid.znetlog=2");
   ...
   public void sendMessage(String var1, String var2) {
      this.sendMessage(var1, null, var2);
   }
   ...
   public synchronized void invokeServer(String var1, String var2, ICoopServerMessageListener var3) {
      ...
      this.addListener(var3, new ListenerOptions(this, var1, var4, true));
   ...
   public void register(Platform var1, KahluaTable var2) {
      ...
      var3.rawset("launch", new 1(this));
      var3.rawset("softreset", new 2(this));
      var3.rawset("isRunning", new 3(this));
      var3.rawset("sendMessage", new 4(this));
      var3.rawset("getAdminPassword", new 5(this));
      var3.rawset("getTerminationReason", new 6(this));
      var3.rawset("getSteamID", new 7(this));
      var3.rawset("getAddress", new 8(this));
      var3.rawset("getPort", new 9(this));
      var3.rawset("abort", new 10(this));
      var3.rawset("getServerSaveFolder", new 11(this));
      var3.rawset("getPlayerSaveFolder", new 12(this));
      var2.rawset("CoopServer", var3);
   }

   public void addListener(ICoopServerMessageListener var1, ListenerOptions var2) {
      synchronized (this.listeners) {
         this.listeners.add(new Pair(this, var1, var2));
      }
   }

   public void addListener(ICoopServerMessageListener var1) {
      this.addListener(var1, null);
   }
