...
import zombie.network.ServerMap.DistToCellComparator;
...
public class ServerMap {
   ...
   public Vector3 getStartLocation(LogonResult var1) {
      short var2 = 9412;
      short var3 = 10745;
      byte var4 = 0;
      return new Vector3(var3, var2, var4);
   }
   ...
   public void preupdate() {
      ...
      for (int var20 = 0; var20 < this.LoadedCells.size(); var20++) {
         ...
         if (var27.bCancelLoading) {
            ...
            this.cellMap[var36 + var40 * this.width] = null;
      ...
      for (int var21 = 0; var21 < ServerCell.loaded2.size(); var21++) {
         ...
         if (var28.bCancelLoading) {
            ...
            this.cellMap[var37 + var41 * this.width] = null;
   ...
   public boolean isInLoaded(float var1, float var2) {
      ...
      var3 -= this.getMinX();
      var4 -= this.getMinY();
      return this.ToLoad.contains(this.getCell(var3, var4)) ? false : this.getCell(var3, var4) != null;
   }
