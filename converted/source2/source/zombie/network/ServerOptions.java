...
public class ServerOptions {
   ...
   public IntegerServerOption PingLimit = new IntegerServerOption(this, "PingLimit", 100, Integer.MAX_VALUE, 400);
   public IntegerServerOption HoursForLootRespawn = new IntegerServerOption(this, "HoursForLootRespawn", 0, Integer.MAX_VALUE, 0);
   public IntegerServerOption MaxItemsForLootRespawn = new IntegerServerOption(this, "MaxItemsForLootRespawn", 1, Integer.MAX_VALUE, 4);
   ...
   public StringServerOption ClientCommandFilter = new StringServerOption(
   ...
   public DoubleServerOption AntiCheatProtectionType2ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType2ThresholdMultiplier", 1.0, 10.0, 3.0
   );
   public DoubleServerOption AntiCheatProtectionType3ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType3ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType4ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType4ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType9ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType9ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType15ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType15ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType20ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType20ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType22ThresholdMultiplier = new DoubleServerOption(
      this, "AntiCheatProtectionType22ThresholdMultiplier", 1.0, 10.0, 1.0
   );
   public DoubleServerOption AntiCheatProtectionType24ThresholdMultiplier = new DoubleServerOption(
   ...
   public void init() {
      this.initOptions();
      File var1 = new File(ZomboidFileSystem.instance.getCacheDir() + File.separator + "Server");
      if (!var1.exists()) {
         var1.mkdirs();
      }

      File var2 = new File(ZomboidFileSystem.instance.getCacheDir() + File.separator + "Server" + File.separator + GameServer.ServerName + ".ini");
      if (var2.exists()) {
         try {
   ...
   public void resetRegionFile() {
      File var1 = new File(ZomboidFileSystem.instance.getCacheDir() + File.separator + "Server" + File.separator + GameServer.ServerName + "_spawnregions.lua");
      var1.delete();
   ...
   private void initSpawnRegionsFile(File var1) {
      if (!var1.exists()) {
         ...
         try {
            ...
            var2.close();
            var2 = new FileWriter(var1.getParent() + File.separator + GameServer.ServerName + "_spawnpoints.lua");
   ...
   public static ArrayList<String> getClientCommandList(boolean var0) {
      ...
      while (var3.hasNext()) {
         ...
         var2.add("* " + var4 + " : " + clientOptionsList.get(var4) + (var3.hasNext() ? var1 : ""));
      }
   ...
   public boolean loadServerTextFile(String var1) {
      ...
      String var3 = ZomboidFileSystem.instance.getCacheDir() + File.separator + "Server" + File.separator + var1 + ".ini";
      if (var2.read(var3)) {
