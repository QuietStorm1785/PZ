...
public abstract class ChatBase {
   ...
   public void close() {
      synchronized (this.memberLock) {
         for (Short var4 : new ArrayList<>(this.members)) {
   ...
   public void syncMembersByUsernames(ArrayList<String> var1) {
      synchronized (this.memberLock) {
   ...
   private void syncMembers(ArrayList<Short> var1) {
      for (Short var3 : var1) {
         this.addMember(var3);
      }
      ...
      synchronized (this.memberLock) {
         ...
         for (Short var11 : var8) {
            this.leaveMember(var11);
         }
      }
   }
   ...
   public void sendToServer(ChatMessage var1, DeviceData var2) {
