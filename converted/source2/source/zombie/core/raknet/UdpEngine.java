...
public class UdpEngine {
   ...
   public void endPacketBroadcast(PacketType var1) {
      this.bb.flip();
      ...
      switch (var2) {
         ...
         case 134:
            ...
            if (GameServer.bServer) {
               ...
               if (var6 == null) {
                  DebugLog.Network.warn("GOT PACKET FROM UNKNOWN CONNECTION guid=%s packetId=%s", new Object[]{var4, Integer.valueOf(var8)});
                  return;
               }
            ...
            if (GameServer.bServer) {
               ...
               try {
                  if (ServerOptions.instance.AntiCheatProtectionType10.getValue() && PacketValidator.checkUser(var5)) {
                     PacketValidator.doKickUser(var5, String.valueOf(var2), "Type10", null);
                  }
   ...
   public UdpConnection getActiveConnection(long var1) {
      return !this.connectionMap.containsKey(var1) ? null : this.connectionMap.get(var1);
   }
