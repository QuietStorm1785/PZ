...
final class NonBlockingSetInt$NBSI {
   ...
   private final boolean CAS_new(NonBlockingSetInt$NBSI var1) {
      return NonBlockingSetInt._unsafe.compareAndSwapObject(this, _new_offset, null, var1);
   }
   ...
   private NonBlockingSetInt$NBSI(NonBlockingSetInt$NBSI var1, NonBlockingSetInt$NBSI var2, Counter var3, NonBlockingSetInt var4) {
      ...
      if (!has_bits(var1) && !has_bits(var2)) {
         ...
         if (!has_bits(var1)) {
            ...
            this._nbsi64 = new NonBlockingSetInt$NBSI(null, var2._nbsi64, null, null);
         } else if (!has_bits(var2)) {
            this._bits = new long[var1._bits.length];
            this._nbsi64 = new NonBlockingSetInt$NBSI(null, var1._nbsi64, null, null);
         } else {
            int var5 = var1._bits.length > var2._bits.length ? var1._bits.length : var2._bits.length;
            this._bits = new long[var5];
            this._nbsi64 = new NonBlockingSetInt$NBSI(var1._nbsi64, var2._nbsi64, null, null);
         }
