...
import zombie.core.Collections.NonBlockingHashtable.SnapshotE;

class NonBlockingHashtable$3 extends AbstractSet<Entry<TypeK, TypeV>> {
   NonBlockingHashtable$3(NonBlockingHashtable var1) {
      this.this$0 = var1;
   }
