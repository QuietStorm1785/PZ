...
import zombie.core.Collections.NonBlockingHashMapLong.SnapshotE;

class NonBlockingHashMapLong$3 extends AbstractSet<Entry<Long, TypeV>> {
   NonBlockingHashMapLong$3(NonBlockingHashMapLong var1) {
      this.this$0 = var1;
   }
