...
import zombie.core.Collections.NonBlockingHashtable.1;
import zombie.core.Collections.NonBlockingHashtable.2;
import zombie.core.Collections.NonBlockingHashtable.3;
import zombie.core.Collections.NonBlockingHashtable.CHM;
import zombie.core.Collections.NonBlockingHashtable.Prime;
import zombie.core.Collections.NonBlockingHashtable.SnapshotK;
...
public class NonBlockingHashtable<TypeK, TypeV> extends Dictionary<TypeK, TypeV> implements ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
   ...
   @Override
   public void clear() {
      Object[] var1 = (new NonBlockingHashtable(8))._kvs;
   ...
   private static final Object get_impl(NonBlockingHashtable var0, Object[] var1, Object var2, int var3) {
      int var4 = len(var1);
      CHM var5 = chm(var1);
   ...
   private static final Object putIfMatch(NonBlockingHashtable var0, Object[] var1, Object var2, Object var3, Object var4) {
      assert var3 != null;
      ...
      while (true) {
         ...
         if (var11 == null) {
            ...
            if (CAS_key(var1, var9, null, var2)) {
               var7._slots.add(1L);
               var8[var9] = var5;
               break;
            }
      ...
      if (var3 == var12) {
         ...
         if (var13 == null && (var12 == null && var7.tableFull(var10, var6) || var12 instanceof Prime)) {
            var13 = var7.resize(var0, var1);
         }
         ...
         if (var13 != null) {
            ...
            while ($assertionsDisabled || !(var12 instanceof Prime)) {
               if (var4 != NO_MATCH_OLD
                  && var12 != var4
                  && (var4 != MATCH_ANY || var12 == TOMBSTONE || var12 == null)
                  && (var12 != null || var4 != TOMBSTONE)
                  && (var4 == null || !var4.equals(var12))) {
                  return var12;
               }
