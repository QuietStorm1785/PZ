...
final class HelperFunctions$UnitTests$getRotationY {
   private HelperFunctions$UnitTests$getRotationY() {
   }
   ...
   public static void run() {
      ...
      for (int var1 = 0; var1 < 360; var1++) {
         ...
         var0.setFromAxisAngle(new Vector4f(0.0F, 1.0F, 0.0F, var2 * (float) (Math.PI / 180.0)));
         float var3 = HelperFunctions.getRotationY(var0) * (180.0F / (float)Math.PI);
