...
public final class Core {
   ...
   public void TakeScreenshot(int var1, int var2, int var3, int var4, int var5) {
      ...
      BufferedImage var16 = new BufferedImage(var3, var4, 2);
   ...
   public void TakeFullScreenshot(String var1) {
      RenderThread.invokeOnRenderContext(var1, var0 -> {
         ...
         File var14 = new File(ZomboidFileSystem.instance.getScreenshotDir() + File.separator + var0);
         ...
         BufferedImage var15 = new BufferedImage(var1x, var2, 2);
   ...
   public boolean loadOptions() throws IOException {
      ...
      File var1 = new File(ZomboidFileSystem.instance.getCacheDir() + File.separator + "options.ini");
      if (!var1.exists()) {
         this.saveFolder = getMyDocumentFolder();
         File var21 = new File(this.saveFolder);
         var21.mkdir();
         ...
         BufferedReader var20 = new BufferedReader(new FileReader(var1));

         try {
            String var3;
            while ((var3 = var20.readLine()) != null) {
               if (var3.startsWith("version=")) {
                  ...
                  String[] var28 = var3.replaceFirst("autozoom=", "").split(",");

                  for (int var35 = 0; var35 < var28.length; var35++) {
                     if (!var28[var35].isEmpty()) {
                        int var42 = Integer.parseInt(var28[var35]);
                        if (var42 >= 1 && var42 <= 4) {
                  ...
                  OptionVoiceAGCMode = Integer.parseInt(var3.replaceFirst("voiceAGCMode=", ""));
                  ...
                  OptionJumpScareVolume = Integer.parseInt(var3.replaceFirst("jumpScareVolume=", ""));
               } else if (var3.startsWith("musicActionStyle=")) {
                  OptionMusicActionStyle = Integer.parseInt(var3.replaceFirst("musicActionStyle=", ""));
                  ...
                  String var27 = var3.replaceFirst("controller=", "");
                  if (!var27.isEmpty()) {
                  ...
                  OptionMaxTextureSize = Integer.parseInt(var3.replaceFirst("maxTextureSize=", ""));
                  OptionMaxTextureSize = PZMath.clamp(OptionMaxTextureSize, 1, 4);
               } else if (var3.startsWith("maxVehicleTextureSize=")) {
                  OptionMaxVehicleTextureSize = Integer.parseInt(var3.replaceFirst("maxVehicleTextureSize=", ""));
                  ...
                  String[] var26 = var3.replaceFirst("mpTextColor=", "").split(",");
                  ...
                  this.mpTextColor = new ColorInfo(var34, var41, var49, 1.0F);
               } else if (var3.startsWith("objHighlightColor=")) {
                  String[] var25 = var3.replaceFirst("objHighlightColor=", "").split(",");
                  ...
                  String[] var24 = var3.replaceFirst("goodHighlightColor=", "").split(",");
                  ...
                  String[] var23 = var3.replaceFirst("badHighlightColor=", "").split(",");
                  ...
                  if (var3.startsWith("showFirstTimeSneakTutorial=")) {
                     ...
                     this.termsOfServiceVersion = Integer.parseInt(var3.replaceFirst("termsOfServiceVersion=", ""));
                     ...
                     OptionDoContainerOutline = Boolean.parseBoolean(var3.replaceFirst("doContainerOutline=", ""));
                     ...
                     OptionAutoWalkContainer = Boolean.parseBoolean(var3.replaceFirst("autoWalkContainer=", ""));
                     ...
                     OptionShowItemModInfo = Boolean.parseBoolean(var3.replaceFirst("showItemModInfo=", ""));
                  } else if (var3.startsWith("showSurvivalGuide=")) {
                     this.OptionShowSurvivalGuide = Boolean.parseBoolean(var3.replaceFirst("showSurvivalGuide=", ""));
                  } else if (var3.startsWith("enableLeftJoystickRadialMenu=")) {
                     OptionEnableLeftJoystickRadialMenu = Boolean.parseBoolean(var3.replaceFirst("enableLeftJoystickRadialMenu=", ""));
                  }
               } else {
                  if (this.version < 7) {
                     var3 = "mapOrder=";
            ...
            if (!this.doneNewSaveFolder) {
               File var29 = new File(ZomboidFileSystem.instance.getSaveDir());
               var29.mkdir();
               ArrayList var36 = new ArrayList();
               var36.add("Beginner");
               var36.add("Survival");
               var36.add("A Really CD DA");
               var36.add("LastStand");
               var36.add("Opening Hours");
               var36.add("Sandbox");
               var36.add("Tutorial");
               var36.add("Winter is Coming");
               var36.add("You Have One Day");
               Object var43 = null;
               File var50 = null;

               try {
                  for (String var9 : var36) {
                     var43 = new File(ZomboidFileSystem.instance.getCacheDir() + File.separator + var9);
                     var50 = new File(ZomboidFileSystem.instance.getSaveDir() + File.separator + var9);
                     if (var43.exists()) {
                        var50.mkdir();
   ...
   public void saveOptions() throws IOException {
      ...
      try {
         ...
         for (String var5 : JoypadManager.instance.ActiveControllerGUIDs) {
   ...
   public KahluaTable getScreenModes() {
      ...
      try {
         if (!var3.exists()) {
            ...
            String var14;
            for (var14 = null; (var14 = var11.readLine()) != null; var4++) {
   ...
   private void updateKeyboardAux(UITextBox2 var1, int var2) {
      ...
      if (var2 == 28 || var2 == 156) {
            ...
            if (var1.Lines.size() < var1.getMaxLines()) {
               if (var1.TextEntryCursorPos != var1.ToSelectionIndex) {
                  ...
                  if (var1.internalText.length() > 0) {
                     var1.internalText = var1.internalText.substring(0, var26) + "\n" + var1.internalText.substring(var8);
                  } else {
                     var1.internalText = "\n";
                  }
                  ...
                  String var28 = var1.internalText.substring(0, var27) + "\n" + var1.internalText.substring(var27);
                  var1.SetText(var28);
         ...
         if (var17 && (!GameClient.bClient || GameClient.connection.accessLevel != 1 || GameClient.connection != null && GameClient.connection.isCoopHost)) {
         ...
         if (var2 == 199) {
            ...
            if (var1.CursorLine > 0) {
               ...
               var1.CursorLine--;
               if (var16 > ((String)var1.Lines.get(var1.CursorLine)).length()) {
                  var16 = ((String)var1.Lines.get(var1.CursorLine)).length();
               }
            ...
            if (var1.Lines.size() - 1 > var1.CursorLine && var1.CursorLine + 1 < var1.getMaxLines()) {
               ...
               var1.CursorLine++;
               if (var15 > ((String)var1.Lines.get(var1.CursorLine)).length()) {
                  var15 = ((String)var1.Lines.get(var1.CursorLine)).length();
               }
                        ...
                        if (var2 != 184) {
                           if (var2 == 203) {
                              ...
                              if ((var2 == 211 || var2 == 14) && var1.TextEntryCursorPos != var1.ToSelectionIndex) {
                                 ...
                                 var1.internalText = var1.internalText.substring(0, var14) + var1.internalText.substring(var22);
                                 ...
                                 if (var1.internalText.length() != 0 && var1.TextEntryCursorPos < var1.internalText.length()) {
                                    if (var1.TextEntryCursorPos > 0) {
                                       var1.internalText = var1.internalText.substring(0, var1.TextEntryCursorPos)
                                          + var1.internalText.substring(var1.TextEntryCursorPos + 1);
                                    } else {
                                 ...
                                 if (var1.internalText.length() != 0 && var1.TextEntryCursorPos > 0) {
                                    if (var1.TextEntryCursorPos > var1.internalText.length()) {
                                       ...
                                       var1.internalText = var1.internalText.substring(0, var13 - 1) + var1.internalText.substring(var13);
                                    }
                                 ...
                                 if (var12 != null) {
                                    if (var1.TextEntryCursorPos != var1.ToSelectionIndex) {
                                       ...
                                       var1.internalText = var1.internalText.substring(0, var21) + var12 + var1.internalText.substring(var25);
                                       ...
                                       if (var1.TextEntryCursorPos < var1.internalText.length()) {
                                          var1.internalText = var1.internalText.substring(0, var1.TextEntryCursorPos)
                                             + var12
                                             + var1.internalText.substring(var1.TextEntryCursorPos);
                                       } else {
                                 ...
                                 if (var1.TextEntryCursorPos != var1.ToSelectionIndex) {
                                    ...
                                    String var24 = var1.Text.substring(var11, var20);
                                 ...
                                 if (var1.TextEntryCursorPos != var1.ToSelectionIndex) {
                                    ...
                                    String var23 = var1.Text.substring(var10, var19);
                                    if (var23 != null && var23.length() > 0) {
                                       Clipboard.setClipboard(var23);
                                    }

                                    var1.internalText = var1.internalText.substring(0, var10) + var1.internalText.substring(var19);
                                 ...
                                 if (var1.internalText.length() < var1.TextEntryMaxLength) {
                                    ...
                                    if (var5 != 0) {
                                       if (var1.isOnlyNumbers() && var5 != '.' && var5 != '-') {
                                          try {
                                             Double.parseDouble(String.valueOf(var5));
                                          } catch (Exception var9) {
                                             return;
                                          }
                                       }
                                       ...
                                       if (var1.TextEntryCursorPos == var1.ToSelectionIndex) {
                                          ...
                                          if (var6 < var1.internalText.length()) {
                                             var1.internalText = var1.internalText.substring(0, var6) + var5 + var1.internalText.substring(var6);
                                          } else {
                                          ...
                                          if (var1.internalText.length() > 0) {
                                             var1.internalText = var1.internalText.substring(0, var18) + var5 + var1.internalText.substring(var7);
                                          } else {
   ...
   public int getKey(String var1) {
      if (this.keyMaps == null) {
         ...
         return this.keyMaps.get(var1) != null ? this.keyMaps.get(var1) : 0;
      }
   }
   ...
   public float getZoom(int var1) {
      return this.OffscreenBuffer != null ? this.OffscreenBuffer.zoom[var1] * (TileScale / 2.0F) : 1.0F;
   }
   ...
   public int getXAngle(int var1, float var2) {
      ...
      return new Long(Math.round((Math.sqrt(2.0) * Math.cos(var3) + 1.0) * (var1 / 2))).intValue();
   }

   public int getYAngle(int var1, float var2) {
      double var3 = Math.toRadians(225.0F + var2);
      return new Long(Math.round((Math.sqrt(2.0) * Math.sin(var3) + 1.0) * (var1 / 2))).intValue();
   }
