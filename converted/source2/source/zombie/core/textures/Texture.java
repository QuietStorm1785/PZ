...
public class Texture extends Asset implements IDestroyable, ITexture, Serializable {
   ...
   public Texture(AssetPath var1, AssetManager var2, TextureAssetParams var3) {
      ...
      TextureIDAssetParams var9 = new TextureIDAssetParams();
   ...
   public Texture(String var1, BufferedInputStream var2, boolean var3, PZFileformat var4) {
   ...
   public Texture(int var1, int var2, int var3) {
      this(new TextureID(var1, var2, var3), null);
   }
   ...
   public static Texture getSharedTexture(String var0) {
      ...
      return getSharedTexture(var0, var1);
   }
      ...
      if (GameServer.bServer && !ServerGUI.isCreated()) {
         ...
         if (var1 == null) {
            ...
            if (!var3.equals(var2)) {
               ...
               TextureAssetParams var5 = new TextureAssetParams();
               var5.flags = var4;
      ...
      if (GameServer.bServer && !ServerGUI.isCreated()) {
         ...
         if (var2 != null) {
            ...
            if (!var0.endsWith(".txt")) {
               ...
               if (var5 != null) {
                  TextureAssetParams var17 = new TextureAssetParams();
                  var17.subTexture = var5;
                  String var18 = "@pack/" + var5.m_pack_name + "/" + var5.m_page_name + "/" + var5.m_info.name;
                  Texture var8 = (Texture)TextureAssetManager.instance.load(new AssetPath(var18), var17);
                  if (var8 == null) {
            ...
            if (TexturePackPage.subTextureMap.containsKey(var0)) {
               ...
               if (var10 != null) {
                  TextureAssetParams var13 = new TextureAssetParams();
                  var13.subTexture = var10;
                  String var15 = "@pack/" + var10.m_pack_name + "/" + var10.m_page_name + "/" + var10.m_info.name;
                  Texture var16 = (Texture)TextureAssetManager.instance.load(new AssetPath(var15), var13);
                  if (var16 == null) {
                     nullTextures.add(var0);
                  } else {
                  ...
                  String var11 = ZomboidFileSystem.instance.getString(var0);
                  boolean var14 = var11 != var0;
                  if (!var14 && !new File(var11).exists()) {
                     nullTextures.add(var0);
                     return null;
                  } else {
                     TextureAssetParams var6 = new TextureAssetParams();
                     var6.flags = var1;
                     Texture var7 = (Texture)TextureAssetManager.instance.load(new AssetPath(var11), var6);
   ...
   public void reloadFromFile(String var1) {
      if (this.dataid != null) {
         TextureIDAssetParams var5 = new TextureIDAssetParams();
   ...
   public boolean equals(Texture var1) {
      return var1.xStart == this.xStart
         ...
         && (
            this.dataid == null
               || var1.dataid == null
               || var1.dataid.pathFileName == null
               || this.dataid.pathFileName == null
               || var1.dataid.pathFileName.equals(this.dataid.pathFileName)
         );
   }
   ...
   public void render(float var1, float var2, float var3, float var4) {
      this.render(var1, var2, var3, var4, 1.0F, 1.0F, 1.0F, 1.0F, null);
   }

   public void render(float var1, float var2) {
      this.render(var1, var2, this.width, this.height, 1.0F, 1.0F, 1.0F, 1.0F, null);
   }

   public void render(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, Consumer<TextureDraw> var9) {
      var1 += this.offsetX;
      var2 += this.offsetY;
   ...
   public void renderdiamond(float var1, float var2, float var3, float var4, int var5, int var6, int var7, int var8) {
      SpriteRenderer.instance
         .render(null, var1, var2, var1 + var3 / 2.0F, var2 - var4 / 2.0F, var1 + var3, var2, var1 + var3 / 2.0F, var2 + var4 / 2.0F, var5, var6, var7, var8);
   }
   ...
   public void renderstrip(int var1, int var2, int var3, int var4, float var5, float var6, float var7, float var8, Consumer<TextureDraw> var9) {
      try {
         if (var8 <= 0.0F) {
            return;
         }
         ...
         bDoingQuad = false;
         Logger.getLogger(GameWindow.class.getName()).log(Level.SEVERE, null, var15);
      }
   }
   ...
   public void saveToZomboidDirectory(String var1) {
      if (!StringUtils.containsDoubleDot(var1)) {
         String var2 = ZomboidFileSystem.instance.getCacheDirSub(var1);
         RenderThread.invokeOnRenderContext(() -> this.saveOnRenderThread(var2));
      }
   }

   public void saveToCurrentSavefileDirectory(String var1) {
      if (!StringUtils.containsDoubleDot(var1)) {
         String var2 = ZomboidFileSystem.instance.getFileNameInCurrentSave(var1);
         RenderThread.invokeOnRenderContext(() -> this.saveOnRenderThread(var2));
      }
   }

   public void saveOnRenderThread(String var1) {
      if (this.getID() == -1) {
         ...
         MemoryUtil.memFree(var7);
         BufferedImage var16 = new BufferedImage(var2, var3, 2);
   ...
   public static void collectAllIcons(HashMap<String, String> var0, HashMap<String, String> var1) {
      for (Entry var3 : s_sharedTextureTable.entrySet()) {
         if (((String)var3.getKey()).startsWith("media/ui/Container_") || ((String)var3.getKey()).startsWith("Item_")) {
            String var4 = "";
            if (((String)var3.getKey()).startsWith("Item_")) {
               ...
               String var5 = ((String)var3.getKey()).replaceFirst("media/ui/Container_", "");
               var4 = var5.replaceAll("\\.png", "");
               DebugLog.log("Adding " + var4.toLowerCase() + ", value = " + (String)var3.getKey());
            }
