...
public final class TextureID extends Asset implements IDestroyable, Serializable {
   ...
   public TextureID(int var1, int var2, int var3) {
      ...
      if ((var3 & 16) != 0) {
         ...
         this.data = new ImageData(var1, var2, null);
      } else {
   ...
   public TextureID(BufferedInputStream var1, String var2, boolean var3, PZFileformat var4) {
      super(null, TextureIDAssetManager.instance);
      this.assetParams = null;
   ...
   public static TextureID createSteamAvatar(long var0) {
      ...
      return var2 == null ? null : new TextureID(var2);
   }
   ...
   private ImageData limitMaxSize(ImageData var1) {
      if (this.assetParams == null) {
         ...
         if ((var2 & var3) == 0) {
            ...
            if (var1.getWidth() <= var4 && var1.getHeight() <= var4) {
               ...
               ImageData var8 = new ImageData(var1.getWidth() >> var6, var1.getHeight() >> var6, var7);
