...
import zombie.core.textures.PNGDecoder.1;
...
public final class PNGDecoder {
   ...
   public Format decideTextureFormat(Format var1) {
   ...
   private void copyPALtoABGR(ByteBuffer var1, byte[] var2) {
      if (this.paletteA != null) {
         ...
         for (int var4 = var2.length; var3 < var4; var3++) {
            ...
            byte var6 = this.palette[var5 * 3 + 0];
            byte var7 = this.palette[var5 * 3 + 1];
            byte var8 = this.palette[var5 * 3 + 2];
            byte var9 = this.paletteA[var5];
         ...
         for (int var11 = var2.length; var10 < var11; var10++) {
            ...
            byte var13 = this.palette[var12 * 3 + 0];
            byte var14 = this.palette[var12 * 3 + 1];
            byte var15 = this.palette[var12 * 3 + 2];
            byte var16 = -1;
