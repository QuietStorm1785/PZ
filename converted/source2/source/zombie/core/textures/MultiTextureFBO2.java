...
public final class MultiTextureFBO2 {
         ...
         if (var2.length != 0) {
            ...
            for (int var14 = 0; var14 < var3.size(); var14++) {
               ...
               if (Core.getInstance().getOffscreenHeight(var15) > 1440) {
                  this.zoomLevels[var14] = ((Integer)var3.get(var14)).intValue() / 100.0F - 0.25F;
               } else {
                  this.zoomLevels[var14] = ((Integer)var3.get(var14)).intValue() / 100.0F;
               }
            }
         }
      }
   ...
   private TextureFBO createTexture(int var1, int var2, boolean var3) {
      if (var3) {
         Texture var6 = new Texture(var1, var2, 16);
         TextureFBO var5 = new TextureFBO(var6);
         var5.destroy();
         return null;
      } else {
         Texture var4 = new Texture(var1, var2, 19);
   ...
   public void render() {
      if (this.Current != null) {
         ...
         for (int var8 = 0; var8 <= var1; var8++) {
            ...
            if (IsoPlayer.players[var8] != null || GameServer.bServer && ServerGUI.isCreated()) {
               ((Texture)this.Current.getTexture()).rendershader2(var3, var4, var5, var6, var3, var4, var5, var6, 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
               SpriteRenderer.instance.renderi(null, var3, var4, var5, var6, 0.0F, 0.0F, 0.0F, 1.0F, null);
            }
         }
