...
import zombie.iso.IsoGridSquare.NoCircleStencilShader;
      ...
      if (this.style != null) {
         ...
         if (var1 > 0) {
            ...
            if (this.style != this.this$0.lastRenderedStyle) {
               if (this.this$0.lastRenderedStyle != null
                  && (
            ...
            if (this.this$0.lastRenderedTexture0 != null && this.this$0.lastRenderedTexture0.getID() != Texture.lastTextureID) {
            ...
            if (this.this$0.restoreBoundTextures) {
               ...
               this.this$0.lastRenderedTexture0 = null;
               this.this$0.lastRenderedTexture1 = null;
               this.this$0.restoreBoundTextures = false;
            }

            if (this.texture0 != this.this$0.lastRenderedTexture0) {
               if (this.texture0 != null) {
                  if (this.this$0.lastRenderedTexture0 == null) {
                     GL11.glEnable(3553);
                  }
