...
public final class Mouse {
   ...
   public static Cursor loadCursor(String var0) throws LWJGLException {
      ...
      try {
         ...
         byte var13 = 1;
         byte var14 = 1;
         return new Cursor(var3, var4, var13, var14, 1, var12, null);
      ...
      if (isCursorVisible()) {
         ...
         if (mouseCursorTexture != null && mouseCursorTexture.isReady()) {
            ...
            SpriteRenderer.instance
               .render(
                  mouseCursorTexture, var0 - var2, var1 - var3, mouseCursorTexture.getWidth(), mouseCursorTexture.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, null
               );
         }
      }
   }
