...
import zombie.gameStates.AnimationViewerState.BooleanDebugOption;
...
public final class AnimationViewerState extends GameState {
   ...
   private BooleanDebugOption DrawGrid = new BooleanDebugOption(this, "DrawGrid", false);
   private BooleanDebugOption Isometric = new BooleanDebugOption(this, "Isometric", false);
   private BooleanDebugOption UseDeferredMovement = new BooleanDebugOption(this, "UseDeferredMovement", false);
   ...
   public void save() {
      String var1 = ZomboidFileSystem.instance.getCacheDir() + File.separator + "animationViewerState-options.ini";
