...
import zombie.gameStates.IngameState.s_performance;
...
public final class IngameState extends GameState {
   ...
   public static void renderDebugOverhead(IsoCell var0, int var1, int var2, int var3, int var4) {
      ...
      var5 /= var2;
      var6 /= var2;
      SpriteRenderer.instance.renderi(null, var3, var4, var2 * var0.getWidthInTiles(), var2 * var0.getHeightInTiles(), 0.7F, 0.7F, 0.7F, 1.0F, null);
      ...
      if (var7 != null) {
         ...
         for (int var10 = 0; var10 < IsoFlagType.MAX.index(); var10++) {
            if (var7.Is(IsoFlagType.fromIndex(var10))) {
               TextManager.instance.DrawString(var9, var8, IsoFlagType.fromIndex(var10).toString(), 0.6, 0.6, 0.8, 1.0);
               var8 += 18;
            }
         }
         ...
         for (int var23 = 0; var23 < 64; var23++) {
            if (var7.getHasTypes().isSet(var23)) {
               TextManager.instance.DrawString(var20, var8, IsoObjectType.fromIndex(var23).toString(), 0.6, 0.6, 0.8, 1.0);
               var8 += 18;
            }
         }
      }
         ...
         for (int var22 = 0; var22 < var0.getHeightInTiles(); var22++) {
            ...
            if (var24 != null) {
               if (var24.getProperties().Is(IsoFlagType.solid) || var24.getProperties().Is(IsoFlagType.solidtrans)) {
                  SpriteRenderer.instance.renderi(null, var3 + var18 * var2, var4 + var22 * var2, var2, var2, 0.5F, 0.5F, 0.5F, 255.0F, null);
               } else if (!var24.getProperties().Is(IsoFlagType.exterior)) {
                  SpriteRenderer.instance.renderi(null, var3 + var18 * var2, var4 + var22 * var2, var2, var2, 0.8F, 0.8F, 0.8F, 1.0F, null);
               }

               if (var24.Has(IsoObjectType.tree)) {
                  SpriteRenderer.instance.renderi(null, var3 + var18 * var2, var4 + var22 * var2, var2, var2, 0.4F, 0.8F, 0.4F, 1.0F, null);
               }

               if (var24.getProperties().Is(IsoFlagType.collideN)) {
                  SpriteRenderer.instance.renderi(null, var3 + var18 * var2, var4 + var22 * var2, var2, 1, 0.2F, 0.2F, 0.2F, 1.0F, null);
               }

               if (var24.getProperties().Is(IsoFlagType.collideW)) {
                  SpriteRenderer.instance.renderi(null, var3 + var18 * var2, var4 + var22 * var2, 1, var2, 0.2F, 0.2F, 0.2F, 1.0F, null);
               }
            }
         }
      }
   ...
   public static void renderRect(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      if (!(var8 >= Core.getInstance().getScreenWidth()) && !(var10 < 0.0F) && !(var9 >= Core.getInstance().getScreenHeight()) && !(var11 < 0.0F)) {
         SpriteRenderer.instance.render(null, var8, var9, var2, var3, var4, var5, var6, var7, null);
      }
   }
   ...
   public static void renderLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      if ((!(var8 >= Core.getInstance().getScreenWidth()) || !(var10 >= Core.getInstance().getScreenWidth()))
         ...
         SpriteRenderer.instance.renderline(null, (int)var8, (int)var9, (int)var10, (int)var11, var4, var5, var6, var7);
      }
   }
   ...
   public static void copyWorld(String var0, String var1) {
      String var2 = ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator + var0 + File.separator;
         ...
         if (var4 >= 1.0F) {
            ...
            for (int var12 = 0; var12 < IsoWorld.instance.CurrentCell.ChunkMap.length; var12++) {
               ...
               for (int var17 = 0; var17 < IsoChunkMap.ChunkGridWidth * IsoChunkMap.ChunkGridWidth; var17++) {
                  ...
                  if (var7 != null && var7.refs.contains(var15)) {
   ...
   private void renderFrameTextInternal(int var1) {
      ...
      for (int var3 = 0; var3 < var2.size(); var3++) {
         ...
         if (!(var4 instanceof ActionProgressBar)
            && var4.isVisible()
   ...
   private void renderFrameInternal(int var1) {
      ...
      IndieGL.disableAlphaTest();
      IndieGL.glDisable(2929);
      if (IsoPlayer.getInstance() != null && !IsoPlayer.getInstance().isAsleep() || UIManager.getFadeAlpha(var1) < 1.0F) {
   ...
   private void renderInternal() {
      ...
      for (int var3 = 0; var3 < IsoPlayer.numPlayers; var3++) {
         if (IsoPlayer.players[var3] != null) {
   ...
   private StateAction updateInternal() {
      this.tickCount++;
               ...
               try {
                  if (IsoCamera.CamCharacter != null && IsoWorld.instance.bDoChunkMapUpdate) {
                     for (int var11 = 0; var11 < IsoPlayer.numPlayers; var11++) {
                        if (IsoPlayer.players[var11] != null && !IsoWorld.instance.CurrentCell.ChunkMap[var11].ignore) {
                           if (!GameServer.bServer) {
                  ...
                  if (!GameServer.bServer) {
                     ...
                     String var17 = Core.GameSaveWorld;
