...
public final class CollideWithObstaclesPoly$ChunkDataZ {
      ...
      for (int var8 = var7 - 2; var8 < var7 + 10 + 2; var8++) {
         for (int var9 = var6 - 2; var9 < var6 + 10 + 2; var9++) {
            ...
            if (var10 != null && !var10.getObjects().isEmpty()) {
               ...
               boolean var37 = var10.Is(IsoFlagType.collideN) || var10.hasBlockedDoor(true) || var10.HasStairsWest();
               ...
               if (var10.HasStairsNorth()) {
                  ...
                  if (var10.Has(IsoObjectType.stairsTN)) {
                     ...
                     if (var44 == null || !var44.Has(IsoObjectType.stairsTN)) {
               ...
               if (var10.HasStairsWest()) {
                  ...
                  if (var10.Has(IsoObjectType.stairsTW)) {
                     ...
                     if (var45 == null || !var45.Has(IsoObjectType.stairsTW)) {
   ...
   private void getEdgesFromBuffer(ByteBuffer var1, CCObstacle var2, boolean var3) {
      ...
      if (var4 < 3) {
         ...
         var5.add(CCEdge.alloc().init(var12, var14, var2));
      }
   }

   private void clipperToObstacles(Clipper var1, ByteBuffer var2, ArrayList<CCObstacle> var3) {
