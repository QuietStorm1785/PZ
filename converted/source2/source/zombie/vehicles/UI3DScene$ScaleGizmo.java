...
final class UI3DScene$ScaleGizmo extends Gizmo {
   ...
   void updateTracking(float var1, float var2) {
      ...
      if (this.m_currentPos.equals(var3)) {
         ...
         if (this.this$0.m_transformMode == TransformMode.Global) {
            Vector3f var6 = this.m_startInvXfrm.transformPosition(this.m_startPos, new Vector3f());
            Vector3f var7 = this.m_startInvXfrm.transformPosition(this.m_currentPos, new Vector3f());
            ...
            Vector3f var9 = this.m_startInvXfrm.transformPosition(this.m_startPos, new Vector3f());
            Vector3f var10 = this.m_startInvXfrm.transformPosition(this.m_currentPos, new Vector3f());
