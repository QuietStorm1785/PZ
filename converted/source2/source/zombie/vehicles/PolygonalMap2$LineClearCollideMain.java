...
final class PolygonalMap2$LineClearCollideMain {
   ...
   boolean canStandAtOld(PolygonalMap2 var1, float var2, float var3, float var4, BaseVehicle var5, int var6) {
      ...
      for (int var13 = var10; var13 < var12; var13++) {
         for (int var14 = var9; var14 < var11; var14++) {
            boolean var15 = var2 >= var14 && var3 >= var13 && var2 < var14 + 1 && var3 < var13 + 1;
      ...
      if (var13 != null && var13.HasStairs()) {
         ...
         if (var12) {
            for (int var48 = 0; var48 < this.pts.size(); var48++) {
               ...
               LineDrawer.addLine(var25.x, var25.y, var6, var25.x + 1.0F, var25.y + 1.0F, var6, 1.0F, 1.0F, 0.0F, null, false);
            }
         }
            ...
            if (var13 != null
               ...
               if (var13.Is(IsoFlagType.collideW) || !var9 && var13.hasBlockedDoor(false)) {
                  ...
                  if (this.LB
                     ...
                     LineDrawer.addLine(var26.x - var53, var26.y - var56, var6, var26.x + var59, var26.y + 1.0F + var62, var6, 1.0F, 0.0F, 0.0F, null, false);
                     var49 = true;
                  }
               }
               ...
               if (var13.Is(IsoFlagType.collideN) || !var9 && var13.hasBlockedDoor(true)) {
                  ...
                  if (this.LB
                     ...
                     LineDrawer.addLine(var26.x - var54, var26.y - var57, var6, var26.x + 1.0F + var60, var26.y + var63, var6, 1.0F, 0.0F, 0.0F, null, false);
                     var49 = true;
                  }
               }
            } else {
               ...
               if (this.LB
                  ...
                  LineDrawer.addLine(
                     var26.x - var27, var26.y - var28, var6, var26.x + 1.0F + var29, var26.y + 1.0F + var30, var6, 1.0F, 0.0F, 0.0F, null, false
                  );
                  var49 = true;
               }
            }
         ...
         if (var13 != null
            ...
            if (var13.Is(IsoFlagType.collideW) || !var9 && var13.hasBlockedDoor(false)) {
               ...
               if (this.LB.lineRectIntersect(var2, var3, var4 - var2, var5 - var3, var32.x - var33, var32.y - var35, var32.x + var37, var32.y + 1.0F + var39)) {
                  if (var12) {
                     LineDrawer.addLine(var32.x - var33, var32.y - var35, var6, var32.x + var37, var32.y + 1.0F + var39, var6, 1.0F, 0.0F, 0.0F, null, false);
                  }
            ...
            if (var13.Is(IsoFlagType.collideN) || !var9 && var13.hasBlockedDoor(true)) {
               ...
               if (this.LB.lineRectIntersect(var2, var3, var4 - var2, var5 - var3, var32.x - var34, var32.y - var36, var32.x + 1.0F + var38, var32.y + var40)) {
                  if (var12) {
                     LineDrawer.addLine(var32.x - var34, var32.y - var36, var6, var32.x + 1.0F + var38, var32.y + var40, var6, 1.0F, 0.0F, 0.0F, null, false);
                  }
            ...
            if (this.LB
               ...
               if (var12) {
                  LineDrawer.addLine(
                     var32.x - var26, var32.y - var27, var6, var32.x + 1.0F + var28, var32.y + 1.0F + var29, var6, 1.0F, 0.0F, 0.0F, null, false
                  );
               }
      ...
      for (int var4 = 0; var4 < 4; var4++) {
         ...
         for (int var7 = 0; var7 < 4; var7++) {
            ...
            if (Line2D.linesIntersect(var5.x, var5.y, var6.x, var6.y, var8.x, var8.y, var9.x, var9.y)) {
               if (var2) {
                  LineDrawer.addLine(var5.x, var5.y, 0.0F, var6.x, var6.y, 0.0F, 1.0F, 0.0F, 0.0F, null, true);
                  LineDrawer.addLine(var8.x, var8.y, 0.0F, var9.x, var9.y, 0.0F, 1.0F, 0.0F, 0.0F, null, true);
               }
