...
public final class VehiclePart implements ChatElementOwner, WaveSignalDevice {
   ...
   public void setScriptPart(Part var1) {
      this.scriptPart = var1;
   }

   public Part getScriptPart() {
   ...
   public void setInventoryItem(InventoryItem var1, int var2) {
      ...
      if (this.isSetAllModelsVisible()) {
         this.setAllModelsVisible(var1 != null);
      }
   ...
   public void setAllModelsVisible(boolean var1) {
   ...
   protected Model getScriptModelById(String var1) {
   ...
   public void repair() {
      ...
      if (this.isInventoryItemUninstalled()) {
         String var3 = this.getItemType().get(Rand.Next(this.getItemType().size()));
      ...
      if (this.isContainer() && this.getItemContainer() == null && var2 != this.getContainerCapacity()) {
