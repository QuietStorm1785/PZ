      ...
      if (var1 > 0) {
         if (this.isHittable()) {
            if (GameClient.bClient) {
               GameClient.instance
                  .sendClientCommandV(
                     null, "vehicle", "damageWindow", new Object[]{"vehicle", this.part.vehicle.getId(), "part", this.part.getId(), "amount", var1}
                  );
            } else {
               ...
               if (this.isDestroyed()) {
                  ...
                  WorldSoundManager.instance.addSound(null, var2.getX(), var2.getY(), var2.getZ(), 10, 20, true, 4.0F, 15.0F);
               }
