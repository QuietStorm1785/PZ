...
final class UI3DScene$OverlaysDrawer extends GenericDrawer {
   ...
   void init() {
      ...
      for (int var4 = 0; var4 < this.this$0.m_box3D.size(); var4++) {
         ...
         var1.m_box3D.add(((Box3D)UI3DScene.s_box3DPool.alloc()).set(var6));
      }
      ...
      for (int var5 = 0; var5 < this.this$0.m_axes.size(); var5++) {
         ...
         var1.m_axes.add(((PositionRotation)UI3DScene.s_posRotPool.alloc()).set(var7));
      }
   }
