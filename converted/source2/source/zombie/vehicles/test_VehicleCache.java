...
public class test_VehicleCache extends Assert {
   ...
   public void test_getInsertIndex() {
      ...
      assertNotEquals(null, VehicleCache.vehicleGet(1, 2));
      assertEquals(null, VehicleCache.vehicleGet(1, 3));
      assertNotEquals(null, VehicleCache.vehicleGet(10.0F, 20.0F));
      assertEquals(null, VehicleCache.vehicleGet(10.0F, 30.0F));
      ...
      assertNotEquals(null, VehicleCache.vehicleGet(10.0F, 20.0F));
      assertNotEquals(null, VehicleCache.vehicleGet(10.0F, 200.0F));
      assertNotEquals(null, VehicleCache.vehicleGet(10.0F, 210.0F));
      assertNotEquals(null, VehicleCache.vehicleGet(1020.0F, 1020.0F));
      assertNotEquals(null, VehicleCache.vehicleGet(2000.0F, 2030.0F));
      assertNotEquals(null, VehicleCache.vehicleGet(3010.0F, 3000.0F));
      ...
      assertEquals(3L, ((VehicleCache)VehicleCache.vehicleGet(10.0F, 20.0F).get(0)).id);
      assertEquals(1L, ((VehicleCache)VehicleCache.vehicleGet(10.0F, 200.0F).get(0)).id);
      assertEquals(2L, ((VehicleCache)VehicleCache.vehicleGet(10.0F, 210.0F).get(0)).id);
      assertEquals(4L, ((VehicleCache)VehicleCache.vehicleGet(1020.0F, 1020.0F).get(0)).id);
      assertEquals(5L, ((VehicleCache)VehicleCache.vehicleGet(2000.0F, 2030.0F).get(0)).id);
      assertEquals(6L, ((VehicleCache)VehicleCache.vehicleGet(3010.0F, 3000.0F).get(0)).id);
   }
}
