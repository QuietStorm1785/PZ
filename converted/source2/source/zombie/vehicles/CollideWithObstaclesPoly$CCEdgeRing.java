...
import zombie.vehicles.CollideWithObstaclesPoly.CCEdgeRing.1;

final class CollideWithObstaclesPoly$CCEdgeRing extends ArrayList<CCEdge> {
   static final ObjectPool<CollideWithObstaclesPoly$CCEdgeRing> pool = new 1(CollideWithObstaclesPoly$CCEdgeRing::new);
      ...
      for (int var7 = 0; var7 < this.size(); var7++) {
         ...
         if (!(var9 >= 0.0F)) {
            ...
            if (var6 && DebugOptions.instance.CollideWithObstaclesRenderNormals.getValue()) {
               LineDrawer.addLine(var14, var15, var8.node1.z, var14 + var8.normal.x, var15 + var8.normal.y, var8.node1.z, 0.0F, 0.0F, 1.0F, null, true);
            }
   ...
   void render(boolean var1) {
      if (!this.isEmpty()) {
         ...
         for (CCEdge var7 : this) {
            CCNode var8 = var7.node1;
            CCNode var9 = var7.node2;
            LineDrawer.addLine(var8.x, var8.y, var8.z, var9.x, var9.y, var9.z, var2, var3, var4, null, true);
            boolean var10 = false;
            if (var10) {
   ...
   static void releaseAll(ArrayList<CollideWithObstaclesPoly$CCEdgeRing> var0) {
