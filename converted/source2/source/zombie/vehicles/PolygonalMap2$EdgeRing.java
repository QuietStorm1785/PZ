...
import zombie.vehicles.PolygonalMap2.L_lineSegmentIntersects;
import zombie.vehicles.PolygonalMap2.Node;

final class PolygonalMap2$EdgeRing extends ArrayList<Edge> {
   ...
   static void releaseAll(ArrayList<PolygonalMap2$EdgeRing> var0) {
