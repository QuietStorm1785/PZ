...
public final class FixingManager {
   ...
   public static InventoryItem fixItem(InventoryItem var0, IsoGameCharacter var1, Fixing var2, Fixer var3) {
      if (Rand.Next(100) >= getChanceOfFail(var0, var1, var2, var3)) {
         ...
         Double var7 = new Double(var6 * (var4 / 100.0));
   ...
   private static void addXp(IsoGameCharacter var0, Fixer var1) {
   ...
   public static void useFixer(IsoGameCharacter var0, Fixer var1, InventoryItem var2) {
               ...
               if (var5 instanceof DrainableComboItem) {
                  ...
                  if (var5 instanceof HandWeapon) {
                     if (var0.getSecondaryHandItem() == var5) {
                        var0.setSecondaryHandItem(null);
                     }

                     if (var0.getPrimaryHandItem() == var5) {
                        var0.setPrimaryHandItem(null);
                     }
   ...
   public static double getChanceOfFail(InventoryItem var0, IsoGameCharacter var1, Fixing var2, Fixer var3) {
      double var4 = 3.0;
   ...
   public static double getCondRepaired(InventoryItem var0, IsoGameCharacter var1, Fixing var2, Fixer var3) {
      double var4 = 0.0;
