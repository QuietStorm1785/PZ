   ...
   protected String Command() throws SQLException {
      ...
      switch (var3) {
         ...
         default:
            ...
            LoggerManager.getLogger("admin").write(this.getExecutorUsername() + " banned user " + var1 + (this.reason != null ? this.reason : ""), "IMPORTANT");
            boolean var9 = false;
            ...
            for (int var5 = 0; var5 < GameServer.udpEngine.connections.size(); var5++) {
               ...
               if (var6.username.equals(var1)) {
                  ...
                  if (var2) {
                     LoggerManager.getLogger("admin")
                        .write(
                           this.getExecutorUsername() + " banned ip " + var6.ip + "(" + var6.username + ")" + (this.reason != null ? this.reason : ""),
                           "IMPORTANT"
                        );
                  ...
                  if ("".equals(this.reason)) {
                     GameServer.kick(var6, "UI_Policy_Ban", null);
                  } else {
                     GameServer.kick(var6, "You have been banned from this server for the following reason: " + this.reason, null);
                  }
