...
import zombie.debug.LineDrawer.DrawableLine;
...
public final class LineDrawer {
   ...
   static void DrawTexturedRect(Texture var0, float var1, float var2, float var3, float var4, int var5, float var6, float var7, float var8) {
      ...
      Vector2 var13 = new Vector2(IsoUtils.XToScreen(var9.x, var9.y, var5, 0), IsoUtils.YToScreen(var9.x, var9.y, var5, 0));
      Vector2 var14 = new Vector2(IsoUtils.XToScreen(var10.x, var10.y, var5, 0), IsoUtils.YToScreen(var10.x, var10.y, var5, 0));
      Vector2 var15 = new Vector2(IsoUtils.XToScreen(var11.x, var11.y, var5, 0), IsoUtils.YToScreen(var11.x, var11.y, var5, 0));
      Vector2 var16 = new Vector2(IsoUtils.XToScreen(var12.x, var12.y, var5, 0), IsoUtils.YToScreen(var12.x, var12.y, var5, 0));
   ...
   public static void DrawIsoRect(float var0, float var1, float var2, float var3, int var4, int var5, float var6, float var7, float var8) {
      if (var2 < 0.0F) {
         var2 = -var2;
         var0 -= var2;
      }
   ...
   static void drawLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6) {
      SpriteRenderer.instance.renderline(null, (int)var0, (int)var1, (int)var2, (int)var3, var4, var5, var6, 1.0F);
   }
   ...
   public static void drawLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, int var8) {
      SpriteRenderer.instance.renderline(null, (int)var0, (int)var1, (int)var2, (int)var3, var4, var5, var6, var7);
   }
   ...
   public static void drawRect(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, int var8) {
      SpriteRenderer.instance.render(null, var0, var1 + var8, var8, var3 - var8 * 2, var4, var5, var6, var7, null);
      SpriteRenderer.instance.render(null, var0, var1, var2, var8, var4, var5, var6, var7, null);
      SpriteRenderer.instance.render(null, var0 + var2 - var8, var1 + var8, 1.0F, var3 - var8 * 2, var4, var5, var6, var7, null);
      SpriteRenderer.instance.render(null, var0, var1 + var3 - var8, var2, var8, var4, var5, var6, var7, null);
   }
   ...
   public static void addLine(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9) {
      DrawableLine var10 = pool.isEmpty() ? new DrawableLine() : pool.pop();
   ...
   public static void addLine(
      float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, String var9, boolean var10
   ) {
      DrawableLine var11 = pool.isEmpty() ? new DrawableLine() : pool.pop();
   ...
   public static void addRect(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      DrawableLine var8 = pool.isEmpty() ? new DrawableLine() : pool.pop();
      lines.add(var8.init(var0, var1, var2, var0 + var3, var1 + var4, var2, var5, var6, var7, null, false));
   }

   public static void addRectYOffset(float var0, float var1, float var2, float var3, float var4, int var5, float var6, float var7, float var8) {
      DrawableLine var9 = pool.isEmpty() ? new DrawableLine() : pool.pop();
      lines.add(var9.init(var0, var1, var2, var0 + var3, var1 + var4, var2, var6, var7, var8, null, false));
   ...
   public void removeLine(String var1) {
      for (int var2 = 0; var2 < lines.size(); var2++) {
         if (lines.get(var2).name.equals(var1)) {
