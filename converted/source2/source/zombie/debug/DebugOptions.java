...
import zombie.debug.DebugOptions.Checks;
...
public final class DebugOptions implements IDebugOptionGroup {
   ...
   public final Checks Checks = this.newOptionGroup(new Checks());
   ...
   private void initMessaging() {
      ...
      for (BooleanDebugOption var3 : this.options) {
         var1.options.add(new OptionNode(var3.getName(), var3.getValue()));
      }

      String var4 = ZomboidFileSystem.instance.getMessagingDirSub("DebugOptions_list.xml");
      PZXmlUtil.tryWrite(var1, new File(var4));
   }
