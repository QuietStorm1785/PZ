...
import zombie.debug.DebugLogStream.1;
...
public final class DebugLogStream extends PrintStream {
   ...
   public static StackTraceElement tryGetCallerTraceElement(int var0) {
      ...
      return var1.length <= var0 ? null : var1[var0];
   }
   ...
   public void printStackTrace(int var1, String var2) {
      if (var2 != null) {
         this.println(var2);
      }
   ...
   public void error(String var1, Object... var2) {
      this.writeln(this.m_wrappedErrStream, LogSeverity.Error, "ERROR: ", generateCallerPrefix() + "> " + String.format(var1, var2));
   }
   ...
   public void warn(String var1, Object... var2) {
      this.writeln(this.m_wrappedWarnStream, LogSeverity.Warning, "WARN : ", generateCallerPrefix() + "> " + String.format(var1, var2));
   }
   ...
   public void printException(Throwable var1, String var2, String var3, LogSeverity var4) {
      if (var1 == null) {
         ...
         if (var2 != null) {
            this.writeln(
               var6, var4, var5, String.format("%s> Exception thrown %s at %s. Message: %s", var3, var1.toString(), getTopStackTraceString(var1), var2)
            );
         } else {
   ...
   public void noise(String var1) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var2 = generateCallerPrefix();
         String var3 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var2, 36) + "> ", "%s", var1);
         if (var3 != null) {
            this.m_wrappedStream.println(var3);
         }
      }
   ...
   public void noise(String var1, Object var2) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var3 = generateCallerPrefix();
         String var4 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var3, 36) + "> ", var1, var2);
         if (var4 != null) {
            this.m_wrappedStream.println(var4);
         }
      }
   ...
   public void noise(String var1, Object var2, Object var3) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var4 = generateCallerPrefix();
         String var5 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var4, 36) + "> ", var1, var2, var3);
         if (var5 != null) {
            this.m_wrappedStream.println(var5);
         }
      }
   ...
   public void noise(String var1, Object var2, Object var3, Object var4) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var5 = generateCallerPrefix();
         String var6 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var5, 36) + "> ", var1, var2, var3, var4);
         if (var6 != null) {
            this.m_wrappedStream.println(var6);
         }
      }
   ...
   public void noise(String var1, Object var2, Object var3, Object var4, Object var5) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var6 = generateCallerPrefix();
         String var7 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var6, 36) + "> ", var1, var2, var3, var4, var5);
         if (var7 != null) {
            this.m_wrappedStream.println(var7);
         }
      }
   ...
   public void noise(String var1, Object var2, Object var3, Object var4, Object var5, Object var6) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var7 = generateCallerPrefix();
         String var8 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var7, 36) + "> ", var1, var2, var3, var4, var5, var6);
         if (var8 != null) {
            this.m_wrappedStream.println(var8);
         }
      }
   ...
   public void noise(String var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var8 = generateCallerPrefix();
         String var9 = this.m_formatter
   ...
   public void trace(String var1) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var2 = generateCallerPrefix();
         String var3 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var2, 36) + "> ", "%s", var1);
         if (var3 != null) {
            this.m_wrappedStream.println(var3);
         }
      }
   ...
   public void trace(String var1, Object var2) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var3 = generateCallerPrefix();
         String var4 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var3, 36) + "> ", var1, var2);
         if (var4 != null) {
            this.m_wrappedStream.println(var4);
         }
      }
   ...
   public void trace(String var1, Object var2, Object var3) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var4 = generateCallerPrefix();
         String var5 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var4, 36) + "> ", var1, var2, var3);
         if (var5 != null) {
            this.m_wrappedStream.println(var5);
         }
      }
   ...
   public void trace(String var1, Object var2, Object var3, Object var4) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var5 = generateCallerPrefix();
         String var6 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var5, 36) + "> ", var1, var2, var3, var4);
         if (var6 != null) {
            this.m_wrappedStream.println(var6);
         }
      }
   ...
   public void trace(String var1, Object var2, Object var3, Object var4, Object var5) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var6 = generateCallerPrefix();
         String var7 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var6, 36) + "> ", var1, var2, var3, var4, var5);
         if (var7 != null) {
            this.m_wrappedStream.println(var7);
         }
      }
   ...
   public void trace(String var1, Object var2, Object var3, Object var4, Object var5, Object var6) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var7 = generateCallerPrefix();
         String var8 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var7, 36) + "> ", var1, var2, var3, var4, var5, var6);
         if (var8 != null) {
            this.m_wrappedStream.println(var8);
         }
      }
