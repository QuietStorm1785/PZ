...
import zombie.savefile.ClientPlayerDB.NetworkCharacterProfile;
   ...
   public void clientLoadNetworkCharacter(ByteBuffer var1, UdpConnection var2) {
      ...
      if (var3) {
         ...
         if (this.networkProfile != null) {
            ...
            this.networkProfile = new NetworkCharacterProfile(this);
   ...
   public void clientSendNetworkPlayerInt(IsoPlayer var1) {
      if (GameClient.connection != null) {
         try {
            ...
            String var7 = var1.getDescriptor().getForename() + " " + var1.getDescriptor().getSurname();
            var2.putUTF(var7);
