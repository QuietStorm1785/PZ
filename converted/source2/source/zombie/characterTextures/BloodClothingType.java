...
public enum BloodClothingType {
   ...
   public static ArrayList<BloodBodyPartType> getCoveredParts(ArrayList<BloodClothingType> var0) {
      return getCoveredParts(var0, new ArrayList<>());
   }

   public static ArrayList<BloodBodyPartType> getCoveredParts(ArrayList<BloodClothingType> var0, ArrayList<BloodBodyPartType> var1) {
      if (var0 == null) {
         return var1;
      } else {
         init();
   ...
   public static int getCoveredPartCount(ArrayList<BloodClothingType> var0) {
      if (var0 == null) {
         return 0;
      } else {
         init();
   ...
   public static void addBlood(int var0, HumanVisual var1, ArrayList<ItemVisual> var2, boolean var3) {
   ...
   public static void addBlood(BloodBodyPartType var0, HumanVisual var1, ArrayList<ItemVisual> var2, boolean var3) {
      init();
      float var4 = 0.0F;
   ...
   public static void addDirt(BloodBodyPartType var0, HumanVisual var1, ArrayList<ItemVisual> var2, boolean var3) {
      init();
      float var4 = 0.0F;
      if (SandboxOptions.instance.ClothingDegradation.getValue() > 1) {
         float var5 = 0.01F;
   ...
   public static void addHole(BloodBodyPartType var0, HumanVisual var1, ArrayList<ItemVisual> var2) {
      addHole(var0, var1, var2, false);
   }

   public static boolean addHole(BloodBodyPartType var0, HumanVisual var1, ArrayList<ItemVisual> var2, boolean var3) {
      init();
   ...
   public static void addBasicPatch(BloodBodyPartType var0, HumanVisual var1, ArrayList<ItemVisual> var2) {
      init();
   ...
   public static void addDirt(BloodBodyPartType var0, float var1, HumanVisual var2, ArrayList<ItemVisual> var3, boolean var4) {
      init();
      ...
      if (!var4) {
         ...
         if (Rand.NextBool(Math.abs(new Float(var17 * 100.0F).intValue() - 100))) {
            return;
         }
         ...
         for (int var18 = 0; var18 < var3.size(); var18++) {
            ...
            if (var20 != null) {
               ArrayList var21 = var20.getBloodClothingType();
               if (var21 != null) {
   ...
   public static void addBlood(BloodBodyPartType var0, float var1, HumanVisual var2, ArrayList<ItemVisual> var3, boolean var4) {
      init();
      ItemVisual var5 = null;
      if (!var4) {
         for (int var6 = var3.size() - 1; var6 >= 0; var6--) {
         ...
         if (OutfitRNG.NextBool(Math.abs(new Float(var17 * 100.0F).intValue() - 100))) {
            return;
         }
