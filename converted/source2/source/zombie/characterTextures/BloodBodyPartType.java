...
import zombie.characterTextures.BloodBodyPartType.1;
   ...
   public Part[] getCharacterMaskParts() {
      if (this.m_characterMaskParts != null) {
         ...
         switch (1.$SwitchMap$zombie$characterTextures$BloodBodyPartType[this.ordinal()]) {
            case 1:
               var1.add(Part.LeftHand);
               break;
            case 2:
               var1.add(Part.RightHand);
               break;
            case 3:
               var1.add(Part.LeftArm);
               break;
            case 4:
               var1.add(Part.RightArm);
               break;
            case 5:
               var1.add(Part.LeftArm);
               break;
            ...
            case 10:
               ...
               break;
            case 11:
               var1.add(Part.Crotch);
               break;
            case 12:
               var1.add(Part.LeftLeg);
               var1.add(Part.Pelvis);
               break;
            case 13:
               var1.add(Part.RightLeg);
               var1.add(Part.Pelvis);
               break;
            case 14:
               var1.add(Part.LeftLeg);
            ...
            case 15:
               ...
               break;
            case 16:
               var1.add(Part.LeftFoot);
               break;
            case 17:
               var1.add(Part.RightFoot);
               break;
            case 18:
               var1.add(Part.Torso);
         }
