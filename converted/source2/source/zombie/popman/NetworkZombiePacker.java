...
import zombie.popman.NetworkZombiePacker.DeletedZombie;
...
public class NetworkZombiePacker {
   ...
   public void deleteZombie(IsoZombie var1) {
      synchronized (this.zombiesDeleted) {
         this.zombiesDeleted.add(new DeletedZombie(this, var1.OnlineID, var1.x, var1.y));
      }
   }
   ...
   public int getZombieData(UdpConnection var1, ByteBuffer var2) {
      ...
      try {
         ...
         for (int var9 = 0; var9 < this.zombiesProcessing.size(); var9++) {
            ...
            if (var7.authOwner != null && var7.authOwner != var1 && var1.RelevantTo(var7.x, var7.y, (var1.ReleventRange - 2) * 10) && var7.OnlineID != -1) {
