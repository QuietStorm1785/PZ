...
import zombie.popman.ZombiePopulationRenderer.BooleanDebugOption;
...
public final class ZombiePopulationRenderer {
   ...
   private BooleanDebugOption CellGrid = new BooleanDebugOption(this, "CellGrid", true);
   private BooleanDebugOption MetaGridBuildings = new BooleanDebugOption(this, "MetaGrid.Buildings", true);
   private BooleanDebugOption ZombiesStanding = new BooleanDebugOption(this, "Zombies.Standing", true);
   private BooleanDebugOption ZombiesMoving = new BooleanDebugOption(this, "Zombies.Moving", true);
   private BooleanDebugOption MCDObstacles = new BooleanDebugOption(this, "MapCollisionData.Obstacles", true);
   private BooleanDebugOption MCDRegularChunkOutlines = new BooleanDebugOption(this, "MapCollisionData.RegularChunkOutlines", true);
   private BooleanDebugOption MCDRooms = new BooleanDebugOption(this, "MapCollisionData.Rooms", true);
   private BooleanDebugOption Vehicles = new BooleanDebugOption(this, "Vehicles", true);
   ...
   public void renderRect(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      if (!(var9 >= this.offx + this.draww) && !(var11 < this.offx) && !(var10 >= this.offy + this.drawh) && !(var12 < this.offy)) {
         SpriteRenderer.instance.render(null, var9, var10, var3, var4, var5, var6, var7, var8, null);
      }
   }
   ...
   public void renderLine(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      if ((!(var9 >= Core.getInstance().getScreenWidth()) || !(var11 >= Core.getInstance().getScreenWidth()))
         ...
         SpriteRenderer.instance.renderline(null, (int)var9, (int)var10, (int)var11, (int)var12, var5, var6, var7, var8);
      }
   }
   ...
   public void renderCircle(float var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      for (int var13 = 1; var13 <= var8; var13++) {
         ...
         SpriteRenderer.instance.renderline(null, var18, var19, var20, var21, var4, var5, var6, var7);
         var9 = var14;
         var11 = var16;
      }
   }
   ...
   public void renderVehicle(int var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.renderString(var2, var3, String.format("%d", var1), var4, var5, var6, 1.0);
   }
   ...
   public void save() {
      String var1 = ZomboidFileSystem.instance.getCacheDir() + File.separator + "popman-options.ini";
