...
import zombie.asset.AssetManager.AssetTable;
...
public abstract class AssetManager implements AssetStateObserver {
   ...
   public Asset load(AssetPath var1, AssetParams var2) {
      if (!var1.isValid()) {
         return null;
      } else {
   ...
   public void reload(Asset var1) {
      this.reload(var1, null);
   }

   public void reload(Asset var1, AssetParams var2) {
      this.doUnload(var1);
   ...
   private void doLoad(Asset var1, AssetParams var2) {
