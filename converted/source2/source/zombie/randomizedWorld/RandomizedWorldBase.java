...
public class RandomizedWorldBase {
   ...
   public BaseVehicle addVehicle(Zone var1, IsoGridSquare var2, IsoChunk var3, String var4, String var5, IsoDirections var6) {
      return this.addVehicle(var1, var2, var3, var4, var5, null, var6, null);
   }
   ...
   public static IsoDeadBody createRandomDeadBody(RoomDef var0, int var1) {
      if (IsoWorld.getZombiesDisabled()) {
         ...
         return var2 == null ? null : createRandomDeadBody(var2, null, var1, 0, null);
      }
   }
   ...
   public static IsoDeadBody createRandomDeadBody(int var0, int var1, int var2, IsoDirections var3, int var4, int var5) {
      ...
      return createRandomDeadBody(var6, var3, var4, var5, null);
   }
         ...
         if (var8 == null) {
            ...
            if (var10 == null) {
               ...
               for (int var11 = 0; var11 < var5; var11++) {
                  var10.addBlood(null, false, true, true);
               }
   ...
   public void addTraitOfBlood(IsoDirections var1, int var2, int var3, int var4, int var5) {
      for (int var6 = 0; var6 < var2; var6++) {
         ...
         new IsoZombieGiblets(GibletType.A, IsoCell.getInstance(), var3, var4, var5 + 0.2F, var7, var8);
      }
   }
   ...
   public void addTrailOfBlood(float var1, float var2, float var3, float var4, int var5) {
      ...
      for (int var7 = 0; var7 < var5; var7++) {
         ...
         new IsoZombieGiblets(GibletType.A, IsoCell.getInstance(), var1, var2, var3 + 0.2F, var6.x, var6.y);
      }
   }
   ...
   public BaseVehicle spawnCarOnNearestNav(String var1, BuildingDef var2) {
      ...
      if (var3 != null) {
         ...
         for (int var8 = var4; var8 > var4 - 20; var8--) {
            ...
            if (var11 != null && "Nav".equals(var11.getZoneType())) {
               var3 = var11;
               break;
            }
         }
         ...
         if (var3 != null) {
            ...
            for (int var9 = var5; var9 < var5 + 20; var9++) {
               ...
               if (var12 != null && "Nav".equals(var12.getZoneType())) {
                  var3 = var12;
                  break;
               }
            }
            ...
            if (var3 != null) {
               ...
               for (int var10 = var5; var10 > var5 - 20; var10--) {
                  ...
                  if (var13 != null && "Nav".equals(var13.getZoneType())) {
                     var3 = var13;
                     break;
                  }
               }
   ...
   public InventoryItem addItemOnGround(IsoGridSquare var1, String var2) {
      return var1 != null && !StringUtils.isNullOrWhitespace(var2)
   ...
   public InventoryItem addRandomItemOnGround(IsoGridSquare var1, ArrayList<String> var2) {
      if (var1 != null && !var2.isEmpty()) {
         String var3 = (String)PZArrayUtil.pickRandom(var2);
   ...
   public IsoObject addTileObject(IsoGridSquare var1, String var2) {
      if (var1 == null) {
         ...
         IsoObject var3 = IsoObject.getNew(var1, var2, null, false);
   ...
   public BaseVehicle addTrailer(BaseVehicle var1, Zone var2, IsoChunk var3, String var4, String var5, String var6) {
      ...
      BaseVehicle var11 = this.addVehicle(var2, this.getSq(var7.x + var9, var7.y + var10, var7.z), var3, var4, var6, null, var8, var5);
      if (var11 != null) {
