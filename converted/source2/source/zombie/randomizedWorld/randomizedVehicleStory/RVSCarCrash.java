   ...
   public void spawnElement(VehicleStorySpawner var1, Element var2) {
      ...
      if (var3 != null) {
         ...
         switch (var8) {
            case "vehicle1":
            case "vehicle2":
               BaseVehicle var10 = this.addVehicle(var5, var2.position.x, var2.position.y, var4, var2.direction, "bad", null, null, null);
               if (var10 != null) {
                  if (var6) {
                     String var11 = "Front";
                  ...
                  if ("vehicle1".equals(var2.id) && Rand.Next(10) < 4) {
                     this.addZombiesOnVehicle(Rand.Next(2, 5), null, null, var10);
                  }
               }
         }
      }
