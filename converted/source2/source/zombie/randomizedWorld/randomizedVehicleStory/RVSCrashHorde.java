         ...
         switch (var7) {
            case "vehicle1":
               BaseVehicle var9 = this.addVehicleFlipped(
                  var5, var2.position.x, var2.position.y, var4 + 0.25F, var2.direction, var6 ? "normalburnt" : "bad", null, null, null
               );
               if (var9 != null) {
                  ...
                  ArrayList var12 = this.addZombiesOnVehicle(Rand.Next(2, 4), null, null, var9);
                  if (var12 != null) {
                     ...
                     this.addZombiesOnVehicle(Rand.Next(12, 20), null, null, var9);
                  }
               }
         }
      }
