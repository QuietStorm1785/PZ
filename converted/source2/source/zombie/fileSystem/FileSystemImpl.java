...
import zombie.fileSystem.FileSystemImpl.AsyncItem;
import zombie.fileSystem.FileSystemImpl.CloseTask;
import zombie.fileSystem.FileSystemImpl.OpenTask;
...
public final class FileSystemImpl extends FileSystem {
   ...
   public int openAsync(DeviceList var1, String var2, int var3, IFileTask2Callback var4) {
      ...
      if (var5 != null) {
         OpenTask var6 = new OpenTask(this);
         var6.m_file = var5;
         var6.m_path = var2;
         var6.m_mode = var3;
         var6.m_cb = var4;
   ...
   public void closeAsync(IFile var1, IFileTask2Callback var2) {
      CloseTask var3 = new CloseTask(this);
      var3.m_file = var1;
      var3.m_cb = var2;
      this.runAsync(var3);
   }
   ...
   private int runAsync(AsyncItem var1) {
   ...
   public void mountTexturePack(String var1, TexturePackTextures var2, int var3) {
