...
public final class RadioTranslationData {
               ...
               while ((var4 = var3.readLine()) != null) {
                  ...
                  if (var4.equals("[Translations]")) {
                     ...
                     if (!var4.equals("[Collection]")) {
                        ...
                        String[] var16 = var4.split("=", 2);
                        if (var16.length == 2) {
                           String var18 = var16[0].trim();
                           String var20 = var16[1].trim();
                        ...
                        if (var7 != null && var6.size() > 0) {
                           for (String var19 : var6) {
                              this.translations.put(var19, var7);
                           }
                        }
   ...
   public String getTranslation(String var1) {
      return this.translations.containsKey(var1) ? this.translations.get(var1) : null;
   }
   ...
   public static RadioTranslationData ReadFile(String var0) {
            ...
            while ((var5 = var4.readLine()) != null) {
               ...
               if (var6.length > 1) {
                  ...
                  if (var7.equals("guid")) {
                     ...
                     String[] var23 = var8.split(",");
                     if (var23.length > 0) {
                        for (String var13 : var23) {
      ...
      if (var1.language != null) {
         for (Language var21 : Translator.getAvailableLanguage()) {
            if (var21.toString().equals(var1.language)) {
