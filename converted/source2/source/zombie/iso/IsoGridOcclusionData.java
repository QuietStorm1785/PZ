...
import zombie.iso.IsoGridOcclusionData.OcclusionFilter;
...
public class IsoGridOcclusionData {
   ...
   public boolean getCouldBeOccludedByOrphanStructures(OcclusionFilter var1) {
   ...
   public ArrayList<IsoBuilding> getBuildingsCouldBeOccluders(OcclusionFilter var1) {
      if (this._objectEpoch != _ObjectEpoch) {
         if (this._bSoftInitialized) {
            this.Reset();
         }
   ...
   private boolean GetBuildingFloorsProjectedOnSquare(THashSet<IsoBuilding> var1, int var2, int var3, int var4) {
      boolean var5 = false;
      int var6 = var2;
      int var7 = var3;
