...
import zombie.iso.BrokenFences.1;
import zombie.iso.BrokenFences.Tile;
...
public class BrokenFences {
   ...
   private ArrayList<String> tableToTiles(KahluaTableImpl var1) {
      if (var1 == null) {
         return null;
      } else {
         ArrayList var2 = null;
   ...
   private ArrayList<String> tableToTiles(KahluaTable var1, String var2) {
   ...
   private void addDebrisObject(IsoObject var1, IsoDirections var2) {
      if (this.isBreakableObject(var1)) {
         ...
         if (var4 != null && var5 != null && var5.TreatAsSolidFloor()) {
            IsoObject var6 = IsoObject.getNew(var5, var4, null, false);
