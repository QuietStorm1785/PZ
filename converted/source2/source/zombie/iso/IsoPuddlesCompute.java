...
public final class IsoPuddlesCompute {
   ...
   private static Vector3f floor(Vector3f var0) {
      return allocVector3f((float)Math.floor(var0.x), (float)Math.floor(var0.y), (float)Math.floor(var0.z));
   }
   ...
   private static float FuncHash(Vector3f var0) {
      ...
      return fract((float)(Math.sin(var1.x * 2.1 + 1.1) + Math.sin(var1.y * 2.5 + 1.5)));
   }
