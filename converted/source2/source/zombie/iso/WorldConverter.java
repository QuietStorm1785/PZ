...
public final class WorldConverter {
   ...
   private void convertchunks(String var1) throws IOException {
      ...
      for (String var9 : var5) {
         if (var9.contains(".bin")
            && !var9.equals("map.bin")
            && !var9.equals("map_p.bin")
            && !var9.matches("map_p[0-9]+\\.bin")
            && !var9.equals("map_t.bin")
            && !var9.equals("map_c.bin")
            && !var9.equals("map_ver.bin")
            && !var9.equals("map_sand.bin")
            && !var9.equals("map_mov.bin")
            && !var9.equals("map_meta.bin")
            && !var9.equals("map_cm.bin")
            && !var9.equals("pc.bin")
   ...
   private void convertchunks(String var1, int var2, int var3) throws IOException {
      ...
      for (String var11 : var7) {
         if (var11.contains(".bin")
            && !var11.equals("map.bin")
            && !var11.equals("map_p.bin")
            && !var11.matches("map_p[0-9]+\\.bin")
            && !var11.equals("map_t.bin")
            && !var11.equals("map_c.bin")
            && !var11.equals("map_ver.bin")
            && !var11.equals("map_sand.bin")
            && !var11.equals("map_mov.bin")
            && !var11.equals("map_meta.bin")
            && !var11.equals("map_cm.bin")
            && !var11.equals("pc.bin")
   ...
   public void softreset() throws WorldDictionaryException {
      ...
      if (CoopSlave.instance != null) {
         CoopSlave.instance.sendMessage("softreset-count", null, Integer.toString(var5.length));
      }
      ...
      for (String var10 : var5) {
         ...
         if (var10.startsWith("zpop_")) {
            ...
            deleteFile(var10);
         } else if (var10.equals("reanimated.bin")) {
            deleteFile(var10);
            ...
            if (CoopSlave.instance != null && var6 % 10 == 0) {
               CoopSlave.instance.sendMessage("softreset-remaining", null, Integer.toString(var6));
            }
         }
      }
   ...
   private static void deleteFile(String var0) {
      File var1 = new File(ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator + GameServer.ServerName + File.separator + var0);
      var1.delete();
   }
}
