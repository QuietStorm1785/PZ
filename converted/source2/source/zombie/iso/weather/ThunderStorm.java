...
import zombie.iso.weather.ThunderStorm.PlayerLightningInfo;
import zombie.iso.weather.ThunderStorm.ThunderCloud;
import zombie.iso.weather.ThunderStorm.ThunderEvent;
...
public class ThunderStorm {
   ...
   public ThunderStorm(ClimateManager var1) {
      ...
      for (int var2 = 0; var2 < this.events.length; var2++) {
         this.events[var2] = new ThunderEvent();
      }

      for (int var3 = 0; var3 < this.clouds.length; var3++) {
         this.clouds[var3] = new ThunderCloud();
      }

      for (int var4 = 0; var4 < 4; var4++) {
         this.lightningInfos[var4] = new PlayerLightningInfo(this);
      }
   }
   ...
   public ThunderCloud startThunderCloud(float var1, float var2, float var3, float var4, float var5, double var6, boolean var8, float var9) {
         ...
         if (var10 != null) {
            ...
            if (var8) {
               if (!GameServer.bServer) {
                  ...
                  ArrayList var19 = GameServer.getPlayers();

                  for (int var17 = var19.size() - 1; var17 >= 0; var17--) {
                     if (((IsoPlayer)var19.get(var17)).getCurrentSquare() == null) {
                        var19.remove(var17);
                     }
                  }
   ...
   public void update(double var1) {
      ...
      if (GameClient.bClient || !GameServer.bServer) {
         ...
         boolean var16 = SpeedControls.instance.getCurrentGameSpeed() > 1;
         boolean var18 = false;
         boolean var20 = false;
               ...
               if (var22.soundDelay.finished()) {
                  ...
                  if (var8 && !Core.SoundDisabled && FMODManager.instance.getNumListeners() > 0) {
                     if (var22.doStrike && (!var16 || !var18)) {
                        ...
                        GameSoundClip var10 = var9 == null ? null : var9.getRandomClip();
                     ...
                     if (var22.doRumble && (!var16 || !var20)) {
                        ...
                        GameSoundClip var24 = var23 == null ? null : var23.getRandomClip();
                        if (var24 != null && var24.eventDescription != null) {
   ...
   public void applyLightningForPlayer(PlayerRenderSettings var1, int var2, IsoPlayer var3) {
   ...
   public void triggerThunderEvent(int var1, int var2, boolean var3, boolean var4, boolean var5) {
      if (GameServer.bServer) {
         ...
         this.climateManager.transmitClimatePacket(ClimateNetAuth.ServerOnly, (byte)2, null);
            ...
            if (var11 != null) {
               ...
               if (var4) {
                  for (int var12 = 0; var12 < IsoPlayer.numPlayers; var12++) {
                     ...
                     if (var13 != null && this.lightningInfos[var12].distance < 7500.0F) {
