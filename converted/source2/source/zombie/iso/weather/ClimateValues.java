...
public class ClimateValues {
   ...
   private DayInfo testCurrentDay;
   private DayInfo testNextDay;
   ...
   public void pollDate(GregorianCalendar var1) {
      if (this.testCurrentDay == null) {
         this.testCurrentDay = new DayInfo();
      }

      if (this.testNextDay == null) {
         this.testNextDay = new DayInfo();
      }
   ...
   protected void updateValues(double var1, float var3, DayInfo var4, DayInfo var5) {
