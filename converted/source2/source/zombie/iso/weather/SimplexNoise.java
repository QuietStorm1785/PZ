...
import zombie.iso.weather.SimplexNoise.Grad;
...
public class SimplexNoise {
   ...
   private static double dot(Grad var0, double var1, double var3) {
      return var0.x * var1 + var0.y * var3;
   }

   private static double dot(Grad var0, double var1, double var3, double var5) {
      return var0.x * var1 + var0.y * var3 + var0.z * var5;
   }

   private static double dot(Grad var0, double var1, double var3, double var5, double var7) {
