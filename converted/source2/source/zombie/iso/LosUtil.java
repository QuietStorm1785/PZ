   ...
   public static boolean lineClearCollide(int var0, int var1, int var2, int var3, int var4, int var5, boolean var6) {
      ...
      if (Math.abs(var9) > Math.abs(var8) && Math.abs(var9) > Math.abs(var10)) {
         ...
         while (var3 != var0) {
            ...
            if (var44 != null && var16 != null) {
               boolean var46 = var44.CalculateCollide(var16, false, false, true, true);
         ...
         while (var4 != var1) {
            ...
            if (var43 != null && var16 != null) {
               boolean var45 = var43.CalculateCollide(var16, false, false, true, true);
         ...
         while (var5 != var2) {
            ...
            if (var19 != null && var16 != null) {
               boolean var20 = var19.CalculateCollide(var16, false, false, true, true);
               if (var20) {
                  return true;
               }
            }
   ...
   public static int lineClearCollideCount(IsoGameCharacter var0, IsoCell var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      if (Math.abs(var10) > Math.abs(var9) && Math.abs(var10) > Math.abs(var11)) {
         ...
         while (var5 != var2) {
            ...
            if (var45 != null && var17 != null) {
               boolean var47 = var17.testCollideAdjacent(var0, var45.getX() - var17.getX(), var45.getY() - var17.getY(), var45.getZ() - var17.getZ());
               if (var47) {
                  return var8;
               }
            }
         ...
         while (var6 != var3) {
            ...
            if (var44 != null && var17 != null) {
               boolean var46 = var17.testCollideAdjacent(var0, var44.getX() - var17.getX(), var44.getY() - var17.getY(), var44.getZ() - var17.getZ());
               if (var46) {
                  return var8;
               }
            }
         ...
         while (var7 != var4) {
            ...
            if (var20 != null && var17 != null) {
               boolean var21 = var17.testCollideAdjacent(var0, var20.getX() - var17.getX(), var20.getY() - var17.getY(), var20.getZ() - var17.getZ());
               if (var21) {
                  return var8;
               }
            }
