...
import zombie.iso.ContainerOverlays.ContainerOverlay;
...
public class ContainerOverlays {
   ...
   private void parseContainerOverlayMapV0(KahluaTableImpl var1) {
      for (Entry var3 : var1.delegate.entrySet()) {
         ...
         ContainerOverlay var5 = new ContainerOverlay();
         var5.name = var4;
         ...
         for (Entry var8 : var6.delegate.entrySet()) {
            ...
            if (var10.delegate.containsKey(1.0)) {
               var11 = var10.rawget(1.0).toString();
            }

            String var12 = null;
            if (var10.delegate.containsKey(2.0)) {
               var12 = var10.rawget(2.0).toString();
            }

            ContainerOverlayEntry var13 = new ContainerOverlayEntry();
   ...
   private void parseContainerOverlayMapV1(KahluaTableImpl var1) {
      ...
      while (var2.advance()) {
         ...
         if (!"VERSION".equalsIgnoreCase(var3)) {
            ContainerOverlay var4 = new ContainerOverlay();
            var4.name = var3;
            ...
            while (var6.advance()) {
               ...
               ContainerOverlayEntry var10 = new ContainerOverlayEntry();
