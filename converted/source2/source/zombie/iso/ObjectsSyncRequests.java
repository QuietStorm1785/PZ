...
import zombie.iso.ObjectsSyncRequests.SyncIsoChunk;
import zombie.iso.ObjectsSyncRequests.SyncIsoGridSquare;
import zombie.iso.ObjectsSyncRequests.SyncIsoObject;
...
public final class ObjectsSyncRequests {
   ...
   public void putRequestSyncIsoChunk(IsoChunk var1) {
      if (!GameClient.bClient || SystemDisabler.doWorldSyncEnable) {
         SyncIsoChunk var2 = new SyncIsoChunk(this);
         var2.x = var1.wx;
         var2.y = var1.wy;
   ...
   public void putRequestSyncIsoGridSquare(IsoGridSquare var1) {
      if (var1 != null) {
         SyncIsoGridSquare var2 = new SyncIsoGridSquare(this);
         var2.x = var1.x;
         var2.y = var1.y;
         var2.z = var1.z;
         var2.reqTime = 0L;
      ...
      for (int var3 = 0; var3 < var2; var3++) {
         ...
         for (int var9 = 0; var9 < var8; var9++) {
            ...
            if (var14 != null) {
               ...
               if (var15 != var13) {
                  SyncIsoGridSquare var16 = new SyncIsoGridSquare(this);
                  var16.x = var10;
                  var16.y = var11;
                  var16.z = var12;
                  var16.reqTime = 0L;
      ...
      for (int var3 = 0; var3 < var2; var3++) {
         ...
         try {
            ...
            for (int var24 = 0; var24 < var8; var24++) {
               if (var12[var24]) {
                  SyncIsoObject var25 = new SyncIsoObject(this);
                  var25.x = var4;
                  var25.y = var5;
                  var25.z = var6;
                  ...
                  var25.reqCount = 0;
                  synchronized (this.requestsSyncIsoObject) {
                     this.requestsSyncIsoObject.add(var25);
                  }
               }
            }
