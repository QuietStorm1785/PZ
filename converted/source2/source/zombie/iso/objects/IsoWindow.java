...
import zombie.iso.objects.IsoWindow.1;
import zombie.iso.objects.IsoWindow.WindowType;
...
public class IsoWindow extends IsoObject implements BarricadeAble, Thumpable {
   ...
   public boolean isExterior() {
      ...
      return var2 == null ? false : var1.isInARoom() != var2.isInARoom();
   }
      ...
      if (!this.destroyed) {
         ...
         if (this.getAttachedAnimSprite() != null) {
            ...
            for (int var3 = 0; var3 < this.getAttachedAnimSprite().size(); var3++) {
               ...
               if (var4 != null && var4.getProperties().Is("AttachedToGlass")) {
      ...
      if (var2 >= 64) {
         ...
         if (this.closedSprite != null) {
            if (this.destroyed && this.closedSprite.getProperties().Is("SmashedTileOffset")) {
               int var7 = Integer.parseInt(this.closedSprite.getProperties().Val("SmashedTileOffset"));
               this.closedSprite = IsoSprite.getSprite(IsoSpriteManager.instance, this.closedSprite, -var7);
            }

            if (this.closedSprite.getProperties().Is("GlassRemovedOffset")) {
               int var8 = Integer.parseInt(this.closedSprite.getProperties().Val("GlassRemovedOffset"));
   ...
   public void addSheet(IsoGameCharacter var1) {
      ...
      if (var2.getCurtain(var3) == null) {
         if (var2 != null) {
            ...
            var8 += 4;
            IsoCurtain var5 = new IsoCurtain(this.getCell(), var2, "fixtures_windows_curtains_01_" + var8, this.north);
      ...
      if (isTopOfSheetRopeHere(var0, var1)) {
         ...
         if (var0.TreatAsSolidFloor()) {
            if (var1) {
               ...
               if (var4 == null || var4.TreatAsSolidFloor() || isSheetRopeHere(var4) || !canClimbHere(var4)) {
                  return 0;
               }
   ...
   public static boolean removeSheetRope(IsoPlayer var0, IsoGridSquare var1, boolean var2) {
      if (var1 == null) {
         ...
         if (var2) {
            ...
            String var10 = "crafted_01_3";

            for (int var11 = 0; var11 < var6.getObjects().size(); var11++) {
               IsoObject var13 = (IsoObject)var6.getObjects().get(var11);
               if (var13.sprite != null && var13.sprite.getName() != null && var13.sprite.getName().equals(var10)) {
   ...
   public static boolean canClimbThroughHelper(IsoGameCharacter var0, IsoGridSquare var1, IsoGridSquare var2, boolean var3) {
      ...
      if (var4 == null) {
         ...
         return !var0.canClimbDownSheetRope(var4)
               && !var4.HasStairsBelow()
               && !PolygonalMap2.instance.canStandAt(var4.x + var5, var4.y + var6, var4.z, null, 19)
            ? !var4.TreatAsSolidFloor()
            : !GameClient.bClient
               || !(var0 instanceof IsoPlayer)
               || SafeHouse.isSafeHouse(var4, ((IsoPlayer)var0).getUsername(), true) == null
   ...
   public IsoBarricade addBarricadesDebug(int var1, boolean var2) {
      ...
      if (var5 != null) {
         for (int var6 = 0; var6 < var1; var6++) {
            if (var2) {
               var5.addMetalBar(null, null);
            } else {
               var5.addPlank(null, null);
            }
         }
      }
