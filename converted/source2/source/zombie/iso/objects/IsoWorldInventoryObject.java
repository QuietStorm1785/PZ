...
public class IsoWorldInventoryObject extends IsoObject {
      ...
      if (this.item == null) {
         ...
         if (!this.item.canStoreWater()) {
            ...
            if (this.item.hasReplaceType("WaterSource")) {
               ...
               if (var1 != null && var1.getType() == Type.Drainable) {
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      if (this.item == null) {
         var1.getDouble();
         if (var2 >= 193) {
            BitHeaderRead var13 = BitHeader.allocRead(HeaderSize.Byte, var1);
            var13.release();
         }
      } else {
         ...
         if (var2 >= 193) {
            BitHeaderRead var6 = BitHeader.allocRead(HeaderSize.Byte, var1);
            this.ignoreRemoveSandbox = var6.hasFlags(1);
            var6.release();
         }

         if (!GameServer.bServer || ServerGUI.isCreated()) {
            String var12 = this.item.getTex().getName();
            if (this.item.isUseWorldItem()) {
   ...
   public float getScreenPosY(int var1) {
      ...
      float var3 = var2 == null ? 0.0F : var2.getHeightOrig() * this.sprite.def.getScaleY() * 1.0F / 4.0F;
