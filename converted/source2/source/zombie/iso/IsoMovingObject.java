...
import zombie.iso.IsoMovingObject.1;
import zombie.iso.IsoMovingObject.L_postUpdate;
import zombie.iso.IsoMovingObject.L_slideAwayFromWalls;
import zombie.iso.IsoMovingObject.TreeSoundManager;
...
public class IsoMovingObject extends IsoObject implements Mover {
                           ...
                           if (!(var13 >= var11)) {
                              ...
                              if (var14 && !"charge".equals(var2.getAttackType())) {
                                 boolean var15 = !this.isOnFloor()
                                    && (var1.getBumpedChr() != null || (System.currentTimeMillis() - var2.getLastBump()) / 100L < 15L || var2.isSprinting())
                                    && (var10 == null || !var10.isNPC());
                                 if (var15) {
                                    var1.bumpNbr++;
                                 ...
                                 boolean var22 = var1.isBehind(var9);
                                 String var23 = var1.getBumpType();
                                 if (var22) {
   ...
   private boolean DoCollide(int var1) {
      ...
      if (this.current != this.last && this.last != null && this.current != null) {
         ...
         boolean var12 = false;
         if (this.last.testCollideAdjacent(this, var9, var10, var11) || this.current == null) {
            var12 = true;
         }
      ...
      if (var1 != null && !var1.bCrawling) {
         if (!var1.isCurrentState(AttackState.instance())
            ...
            if (this.collidedE && !this.collidedN && !this.collidedS) {
               ...
               if (var3 != null && var3.Is(IsoFlagType.HoppableW)) {
