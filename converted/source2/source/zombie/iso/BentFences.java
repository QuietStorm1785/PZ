...
import zombie.iso.BentFences.Entry;
...
public class BentFences {
   ...
   private void tableToTiles(KahluaTableImpl var1, ArrayList<String> var2) {
      if (var1 != null) {
   ...
   private void tableToTiles(KahluaTable var1, ArrayList<String> var2, String var3) {
   ...
   public void addFenceTiles(int var1, KahluaTableImpl var2) {
      ...
      while (var3.advance()) {
         ...
         if (!var5.unbent.isEmpty() && var5.unbent.size() == var5.bent.size()) {
            this.m_entries.add(var5);

            for (String var7 : var5.unbent) {
               ArrayList var8 = this.m_unbentMap.get(var7);
               if (var8 == null) {
                  var8 = new ArrayList();
            ...
            for (String var10 : var5.bent) {
               ArrayList var11 = this.m_bentMap.get(var10);
               if (var11 == null) {
                  var11 = new ArrayList();
   ...
   public boolean isBentObject(IsoObject var1) {
      return this.getEntryForObject(var1, null) != null;
   }
   ...
   private Entry getEntryForObject(IsoObject var1, IsoDirections var2) {
      if (var1 != null && var1.sprite != null && var1.sprite.name != null) {
         boolean var3 = var2 != null;
         ArrayList var4 = var3 ? this.m_unbentMap.get(var1.sprite.name) : this.m_bentMap.get(var1.sprite.name);
         if (var4 != null) {
   ...
   private boolean isValidObject(IsoObject var1, Entry var2, boolean var3) {
   ...
   IsoObject getObjectForEntry(IsoGridSquare var1, ArrayList<String> var2, int var3) {
