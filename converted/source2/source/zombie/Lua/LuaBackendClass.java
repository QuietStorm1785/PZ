...
public class LuaBackendClass implements KahluaTable {
   ...
   public boolean callBool(String var1) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), this.table)[1];
   }

   public boolean callBool(String var1, Object var2) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), new Object[]{this.table, var2})[1];
   }

   public boolean callBool(String var1, Object var2, Object var3) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), new Object[]{this.table, var2, var3})[1];
   }

   public boolean callBool(String var1, Object var2, Object var3, Object var4) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), new Object[]{this.table, var2, var3, var4})[1];
   }

   public boolean callBool(String var1, Object var2, Object var3, Object var4, Object var5) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), new Object[]{this.table, var2, var3, var4, var5})[1];
   }

   public boolean callBool(String var1, Object var2, Object var3, Object var4, Object var5, Object var6) {
      return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(var1), new Object[]{this.table, var2, var3, var4, var5, var6})[1];
   }
