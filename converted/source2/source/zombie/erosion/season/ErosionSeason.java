...
import zombie.erosion.season.ErosionSeason.YearData;
   ...
   private void setYearData(int var1) {
      if (this.yearData[1].year != var1) {
         for (int var2 = 0; var2 < 3; var2++) {
            ...
            this.yearData[var2].winterStartDay.add(5, (int)(-Math.floor(40.0F + 40.0F * this.winterMod + 20.0F * this.yearData[var2].winterS)));
            this.yearData[var2].winterEndDay.add(5, (int)Math.floor(40.0F + 40.0F * this.winterMod + 20.0F * this.yearData[var2].winterE));
            ...
            this.yearData[var2].summerStartDay.add(5, (int)(-Math.floor(40.0F + 40.0F * this.summerMod + 20.0F * this.yearData[var2].summerS)));
            this.yearData[var2].summerEndDay.add(5, (int)Math.floor(40.0F + 40.0F * this.summerMod + 20.0F * this.yearData[var2].summerE));
