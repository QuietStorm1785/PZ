...
import zombie.erosion.categories.NatureBush.BushInit;
import zombie.erosion.categories.NatureBush.CategoryData;
...
public final class NatureBush extends ErosionCategory {
   ...
   private BushInit[] bush = new BushInit[]{
      new BushInit(this, "Spicebush", 0.05F, 0.35F, false),
      new BushInit(this, "Ninebark", 0.65F, 0.75F, true),
      new BushInit(this, "Ninebark", 0.65F, 0.75F, true),
      new BushInit(this, "Blueberry", 0.4F, 0.5F, true),
      new BushInit(this, "Blackberry", 0.4F, 0.5F, true),
      new BushInit(this, "Piedmont azalea", 0.0F, 0.15F, true),
      new BushInit(this, "Piedmont azalea", 0.0F, 0.15F, true),
      new BushInit(this, "Arrowwood viburnum", 0.3F, 0.8F, true),
      new BushInit(this, "Red chokeberry", 0.9F, 1.0F, true),
      new BushInit(this, "Red chokeberry", 0.9F, 1.0F, true),
      new BushInit(this, "Beautyberry", 0.7F, 0.85F, true),
      new BushInit(this, "New jersey tea", 0.4F, 0.8F, true),
      new BushInit(this, "New jersey tea", 0.4F, 0.8F, true),
      new BushInit(this, "Wild hydrangea", 0.2F, 0.35F, true),
      new BushInit(this, "Wild hydrangea", 0.2F, 0.35F, true),
      new BushInit(this, "Shrubby St. John's wort", 0.35F, 0.75F, true)
   };
      ...
      for (int var8 = var6 - 1; var8 >= 1; var8--) {
         ...
         if (var10 != null && var10.getName() != null) {
            ...
            if (var10.getName().startsWith("f_bushes_1_")) {
               int var15 = Integer.parseInt(var10.getName().replace("f_bushes_1_", ""));
