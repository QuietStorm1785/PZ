...
import zombie.erosion.categories.Flowerbed.CategoryData;
      ...
      for (int var7 = var6 - 1; var7 >= 0; var7--) {
         ...
         if (var8 != null && var8.getName() != null) {
            if (var8.getName().startsWith("f_flowerbed_1")) {
               int var9 = Integer.parseInt(var8.getName().replace("f_flowerbed_1_", ""));
               if (var9 <= 23) {
                  if (var9 >= 12) {
                     var9 -= 12;
                  }
            ...
            if (var8.getName().startsWith("vegetation_ornamental_01")) {
               int var13 = Integer.parseInt(var8.getName().replace("vegetation_ornamental_01_", ""));
