...
import zombie.erosion.categories.NatureTrees.CategoryData;
import zombie.erosion.categories.NatureTrees.TreeInit;
...
public final class NatureTrees extends ErosionCategory {
   ...
   private final TreeInit[] trees = new TreeInit[]{
      new TreeInit(this, "American Holly", "e_americanholly_1", true),
      new TreeInit(this, "Canadian Hemlock", "e_canadianhemlock_1", true),
      new TreeInit(this, "Virginia Pine", "e_virginiapine_1", true),
      new TreeInit(this, "Riverbirch", "e_riverbirch_1", false),
      new TreeInit(this, "Cockspur Hawthorn", "e_cockspurhawthorn_1", false),
      new TreeInit(this, "Dogwood", "e_dogwood_1", false),
      new TreeInit(this, "Carolina Silverbell", "e_carolinasilverbell_1", false),
      new TreeInit(this, "Yellowwood", "e_yellowwood_1", false),
      new TreeInit(this, "Eastern Redbud", "e_easternredbud_1", false),
      new TreeInit(this, "Redmaple", "e_redmaple_1", false),
      new TreeInit(this, "American Linden", "e_americanlinden_1", false)
   };
