...
import zombie.erosion.categories.NaturePlants.CategoryData;
import zombie.erosion.categories.NaturePlants.PlantInit;
...
public final class NaturePlants extends ErosionCategory {
   ...
   private final PlantInit[] plants = new PlantInit[]{
      new PlantInit(this, "Butterfly Weed", true, 0.05F, 0.25F),
      new PlantInit(this, "Butterfly Weed", true, 0.05F, 0.25F),
      new PlantInit(this, "Swamp Sunflower", true, 0.2F, 0.45F),
      new PlantInit(this, "Swamp Sunflower", true, 0.2F, 0.45F),
      new PlantInit(this, "Purple Coneflower", true, 0.1F, 0.35F),
      new PlantInit(this, "Purple Coneflower", true, 0.1F, 0.35F),
      new PlantInit(this, "Joe-Pye Weed", true, 0.8F, 1.0F),
      new PlantInit(this, "Blazing Star", true, 0.25F, 0.65F),
      new PlantInit(this, "Wild Bergamot", true, 0.45F, 0.6F),
      new PlantInit(this, "Wild Bergamot", true, 0.45F, 0.6F),
      new PlantInit(this, "White Beard-tongue", true, 0.2F, 0.65F),
      new PlantInit(this, "White Beard-tongue", true, 0.2F, 0.65F),
      new PlantInit(this, "Ironweed", true, 0.75F, 0.85F),
      new PlantInit(this, "White Baneberry", true, 0.4F, 0.8F),
      new PlantInit(this, "Wild Columbine", true, 0.85F, 1.0F),
      new PlantInit(this, "Wild Columbine", true, 0.85F, 1.0F),
      new PlantInit(this, "Jack-in-the-pulpit", false, 0.0F, 0.0F),
      new PlantInit(this, "Wild Ginger", true, 0.1F, 0.9F),
      new PlantInit(this, "Wild Ginger", true, 0.1F, 0.9F),
      new PlantInit(this, "Wild Geranium", true, 0.65F, 0.9F),
      new PlantInit(this, "Alumroot", true, 0.35F, 0.75F),
      new PlantInit(this, "Wild Blue Phlox", true, 0.15F, 0.55F),
      new PlantInit(this, "Polemonium Reptans", true, 0.4F, 0.6F),
      new PlantInit(this, "Foamflower", true, 0.45F, 1.0F)
   };
      ...
      for (int var7 = var6 - 1; var7 >= 1; var7--) {
         ...
         if (var9 != null && var9.getName() != null) {
            if (var9.getName().startsWith("d_plants_1_")) {
               int var17 = Integer.parseInt(var9.getName().replace("d_plants_1_", ""));
            ...
            if (!"vegetation_groundcover_01_16".equals(var9.getName()) && !"vegetation_groundcover_01_17".equals(var9.getName())) {
               if (!"vegetation_groundcover_01_18".equals(var9.getName())
                  && !"vegetation_groundcover_01_19".equals(var9.getName())
                  && !"vegetation_groundcover_01_20".equals(var9.getName())
                  && !"vegetation_groundcover_01_21".equals(var9.getName())
                  && !"vegetation_groundcover_01_22".equals(var9.getName())
                  && !"vegetation_groundcover_01_23".equals(var9.getName())) {
                  continue;
               }
