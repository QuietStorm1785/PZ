...
public abstract class GlobalObjectSystem {
   ...
   public final ArrayList<GlobalObject> getObjectsInChunk(int var1, int var2) {
      return this.lookup.getObjectsInChunk(var1, var2, this.allocList());
   }

   public final ArrayList<GlobalObject> getObjectsAdjacentTo(int var1, int var2, int var3) {
   ...
   public final GlobalObject getObjectByIndex(int var1) {
      return var1 >= 0 && var1 < this.objects.size() ? this.objects.get(var1) : null;
   }
   ...
   public final void finishedWithList(ArrayList<GlobalObject> var1) {
