...
public final class WorldMapGridSquareMarker extends WorldMapMarker {
   ...
   void render(UIWorldMap var1) {
      ...
      if (this.m_texture1 != null && this.m_texture1.isReady()) {
         SpriteRenderer.instance.render(this.m_texture1, var3, var4, var5, var6, var7, var8, var9, var10, this.m_r, this.m_g, this.m_b, var11, null);
      }

      if (this.m_texture2 != null && this.m_texture2.isReady()) {
         SpriteRenderer.instance.render(this.m_texture2, var3, var4, var5, var6, var7, var8, var9, var10, this.m_r, this.m_g, this.m_b, var11, null);
      }
   }
}
