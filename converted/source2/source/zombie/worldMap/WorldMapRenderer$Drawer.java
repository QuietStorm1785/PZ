...
import zombie.worldMap.StrokeGeometry.Attrs;
import zombie.worldMap.StrokeGeometry.Point;
import zombie.worldMap.WorldMapGeometry.TrianglesPerZoom;
import zombie.worldMap.WorldMapGeometry.Type;
import zombie.worldMap.WorldMapRenderer.1;
import zombie.worldMap.WorldMapRenderer.PlayerRenderData;
...
public final class WorldMapRenderer$Drawer extends GenericDrawer {
   ...
   final FilterArgs m_filterArgs = new FilterArgs();
   final RenderArgs m_renderArgs = new RenderArgs();
         ...
         for (int var10 = 0; var10 < 4; var10++) {
            ...
            if (var4 != null && !var4.isDead() && var4.legsSprite.hasActiveModel()) {
               ...
               if (!(var7 < -100.0F) && !(var7 > this.m_width + 100) && !(var8 < -100.0F) && !(var8 > this.m_height + 100)) {
                  this.m_playerRenderData[var10].m_angle = var4.getVehicle() == null ? var4.getAnimationPlayer().getAngle() : (float) (Math.PI * 3.0 / 2.0);
   ...
   public void drawLineStringXXX(RenderArgs var1, WorldMapFeature var2, RGBAf var3, float var4) {
   ...
   // $VF: Unable to simplify switch on enum
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   public void drawLineStringYYY(RenderArgs var1, WorldMapFeature var2, RGBAf var3, float var4) {
      float var5 = this.m_renderCellX;
      float var6 = this.m_renderCellY;
      float var7 = this.m_worldScale;
      float var8 = var3.r;
   ...
   // $VF: Unable to simplify switch on enum
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   public void drawLineString(RenderArgs var1, WorldMapFeature var2, RGBAf var3, float var4) {
   ...
   public void drawLineStringTexture(RenderArgs var1, WorldMapFeature var2, RGBAf var3, float var4, Texture var5) {
   ...
   public void fillPolygon(RenderArgs var1, WorldMapFeature var2, RGBAf var3) {
      WorldMapRenderer.m_vboLinesUV.flush();
   ...
   public void fillPolygon(RenderArgs var1, WorldMapFeature var2, RGBAf var3, Texture var4, float var5) {
      WorldMapRenderer.m_vboLines.flush();
      float var6 = this.m_renderCellX;
      float var7 = this.m_renderCellY;
      float var8 = this.m_worldScale;
   ...
   public void drawTexture(Texture var1, RGBAf var2, int var3, int var4, int var5, int var6) {
   ...
   public void drawTextureTiled(Texture var1, RGBAf var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      if (var1 != null && var1.isReady()) {
   ...
   public void drawTextureTiled(Texture var1, RGBAf var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if (var1 != null && var1.isReady()) {
         WorldMapRenderer.m_vboLines.flush();
         WorldMapRenderer.m_vboLinesUV.flush();
