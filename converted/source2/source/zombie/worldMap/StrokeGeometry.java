   ...
   static void createTriangles(Point var0, Point var1, Point var2, ArrayList<Point> var3, float var4, String var5, float var6) {
      ...
      if (!(var11 > var16) && !(var11 > var19)) {
         ...
         if (var5.equals("round")) {
            ...
            if (var5.equals("bevel") || var5.equals("miter") && var13 >= var6) {
               var3.add(Point.Add(var1, var7));
               var3.add(Point.Add(var1, var8));
               var3.add(Point.Sub(var1, var10));
            }

            if (var5.equals("miter") && var13 < var6) {
               var3.add(var9);
               var3.add(Point.Add(var1, var7));
               var3.add(Point.Add(var1, var8));
            }
         ...
         } else if (!var5.equals("bevel") && (!var5.equals("miter") || !(var13 >= var6))) {
            if (var5.equals("miter") && var13 < var6 && var9 != null) {
               var3.add(Point.Add(var1, var7));
               var3.add(var1);
               var3.add(var9);
               var3.add(Point.Add(var1, var8));
