...
public class WorldMapSymbols {
   ...
   public WorldMapTextSymbol addText(
      String var1, boolean var2, UIFont var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12
   ) {
   ...
   public WorldMapTextureSymbol addTexture(
      String var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10
   ) {
            ...
            if (!(var7 + var6.widthScaled(var1) <= 0.0F)
               ...
               if (var4) {
                  var1.DrawTextureScaledColor(
                     null, (double)var7, (double)var8, (double)var6.widthScaled(var1), (double)var6.heightScaled(var1), 1.0, 1.0, 1.0, 0.3
                  );
               }
   ...
   void checkLayout(UIWorldMap var1) {
      ...
      if (this.m_layoutWorldScale == var1.getAPI().getWorldScale()
         ...
         && this.m_layoutRotation.equals(var2)) {
