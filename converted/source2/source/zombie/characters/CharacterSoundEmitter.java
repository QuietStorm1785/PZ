...
import zombie.characters.CharacterSoundEmitter.footstep;
...
public final class CharacterSoundEmitter extends BaseCharacterSoundEmitter implements ICommonSoundEmitter {
   ...
   public long playVocals(String var1) {
      if (GameServer.bServer) {
         ...
         if (var2 == null) {
            return this.vocals.playSoundImpl(var1, false, null);
         } else {
   ...
   public void playFootsteps(String var1, float var2) {
      if (!GameServer.bServer) {
         ...
         long var8 = this.footsteps.playSoundImpl(var1, false, null);
         if (!var3) {
            this.footstep1 = var8;
         } else {
            this.footstep2 = var8;
