...
import zombie.characters.NetworkCharacterAI.1;
import zombie.characters.NetworkCharacterAI.SpeedChecker;
...
public abstract class NetworkCharacterAI {
   ...
   public PredictionTypes predictionType;
   ...
   public NetworkTeleportDebug teleportDebug;
   public final HashMap<Integer, String> debugData = new 1(this);
   ...
   public NetworkTeleportDebug getTeleportDebug() {
   ...
   public void setTeleportDebug(NetworkTeleportDebug var1) {
   ...
   public boolean checkPosition(UdpConnection var1, IsoGameCharacter var2, float var3, float var4) {
      if (GameServer.bServer && var2.isAlive()) {
         ...
         boolean var5 = PacketValidator.checkSpeed(var1, this.speedChecker, var2.getClass().getSimpleName() + SpeedChecker.class.getSimpleName());
