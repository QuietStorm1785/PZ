...
public class NetworkPlayerAI extends NetworkCharacterAI {
   ...
   public boolean isNeedToUpdate() {
      ...
      byte var2 = (byte)(this.player.playerMoveDir.getDirection() * 10.0F);
   ...
   private void setUsingExtrapolation(PlayerPacket var1, int var2, int var3) {
      ...
      if (!this.player.isPlayerMoving()) {
         ...
         if (this.player.z == this.pfb2.getTargetZ()
            && !PolygonalMap2.instance.lineClearCollide(this.player.x, this.player.y, var5.x, var5.y, (int)this.player.z, null)) {
            var1.x = var5.x;
            var1.y = var5.y;
            var1.z = (byte)this.pfb2.getTargetZ();
         } else {
            Vector2 var7 = PolygonalMap2.instance.getCollidepoint(this.player.x, this.player.y, var5.x, var5.y, (int)this.player.z, null, 2);
   ...
   public boolean set(PlayerPacket var1) {
      ...
      boolean var4 = this.player.playerMoveDir.getLength() < 0.01 && this.lastPlayerMoveDirLen > 0.01F;
