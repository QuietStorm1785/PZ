...
import zombie.characters.action.ActionContext.s_performance;
...
public final class ActionContext {
   ...
   public ActionState getNextState() {
      ...
      for (int var8 = 0; var8 < this.childStateCount(); var8++) {
         ...
         if (var9 != this.m_currentState && var9 != null) {
            var1 = var9;
         }
      }
         ...
         if (var1.stateName == null) {
            ...
            if (PZArrayUtil.isNullOrEmpty(var1.childStateNames)) {
               ...
               for (int var3 = 0; var3 < this.childStateCount(); var3++) {
                  String var4 = this.getChildStateAt(var3).name;
               ...
               for (int var6 = 0; var6 < var1.childStateNames.length; var6++) {
                  String var7 = var1.childStateNames[var6];
