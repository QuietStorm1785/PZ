...
import zombie.characters.ZombiesZoneDefinition.PickDefinition;
import zombie.characters.ZombiesZoneDefinition.StringChance;
import zombie.characters.ZombiesZoneDefinition.ZZDOutfit;
import zombie.characters.ZombiesZoneDefinition.ZZDZone;
...
public final class ZombiesZoneDefinition {
   ...
   private static void init() {
      ...
      if (var0 != null) {
         ...
         while (var1.advance()) {
            ...
            if (var2 != null) {
               ZZDZone var3 = initZone(var1.getKey().toString(), var2);
               if (var3 != null) {
                  s_zoneList.add(var3);
   ...
   private static ZZDZone initZone(String var0, KahluaTableImpl var1) {
      ZZDZone var2 = new ZZDZone();
      var2.name = var0;
   ...
   private static ZZDOutfit initOutfit(KahluaTableImpl var0) {
      ZZDOutfit var1 = new ZZDOutfit();
   ...
   private static ArrayList<StringChance> initStringChance(String var0) {
      if (StringUtils.isNullOrWhitespace(var0)) {
         ...
         for (String var6 : var2) {
            ...
            StringChance var8 = new StringChance();
            var8.str = var7[0];
   ...
   public static PickDefinition pickDefinition(int var0, int var1, int var2, boolean var3) {
            ...
            if (var8 == null) {
               ...
               if (var6 == null) {
                  ...
                  for (int var13 = 0; var13 < var8.outfits.size(); var13++) {
                     ...
                     if ((var16 == null || var5 != null && var16.contains(var5))
   ...
   public static Outfit getRandomDefaultOutfit(boolean var0, String var1) {
      ...
      for (int var6 = 0; var6 < var5.outfits.size(); var6++) {
         ...
         if ((var8 == null || var1 != null && var8.contains(var1))
            && (var7 == null || "male".equalsIgnoreCase(var7) && !var0 || "female".equalsIgnoreCase(var7) && var0)) {
            var2.add(var3);
         }
      }
   ...
   public static ZZDOutfit getRandomOutfitInSetList(ArrayList<ZZDOutfit> var0, boolean var1) {
      float var2 = 0.0F;
   ...
   private static String getRandomHairOrBeard(ArrayList<StringChance> var0) {
   ...
   public static void registerCustomOutfits() {
      ...
      for (ZZDZone var1 : s_zoneList) {
         for (ZZDOutfit var3 : var1.outfits) {
   ...
   private static void ApplyCustomOutfit(int var0, String var1, IsoGameCharacter var2) {
      ...
      boolean var4 = (var0 & -2147483648) != 0;
   ...
   public static int pickPersistentOutfit(IsoGridSquare var0) {
      if (!GameServer.bServer) {
         ...
         Outfit var1;
         if (var3 == null) {
            String var4 = var0.getRoom() == null ? null : var0.getRoom().getName();
            var1 = getRandomDefaultOutfit(var2, var4);
         } else {
            var2 = var3.bFemale;
            String var6 = var3.table.name;
            if (var2) {
