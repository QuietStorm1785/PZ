...
public interface ILuaGameCharacter
   ...
   void LevelPerk(Perk var1, boolean var2);
   ...
   void addKnownMediaLine(String var1);

   void removeKnownMediaLine(String var1);

   void clearKnownMediaLines();

   boolean isKnownMediaLine(String var1);

   long playSound(String var1);

   long playSoundLocal(String var1);
