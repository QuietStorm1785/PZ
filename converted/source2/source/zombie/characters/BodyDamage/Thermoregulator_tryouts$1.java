...
// $VF: synthetic class
class Thermoregulator_tryouts$1 {
   static {
      try {
      ...
      $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier = new int[Multiplier.values().length];

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.MetabolicRateInc.ordinal()] = 1;
      } catch (NoSuchFieldError var28) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.MetabolicRateDec.ordinal()] = 2;
      } catch (NoSuchFieldError var27) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.BodyHeat.ordinal()] = 3;
      } catch (NoSuchFieldError var26) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.CoreHeatExpand.ordinal()] = 4;
      } catch (NoSuchFieldError var25) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.CoreHeatContract.ordinal()] = 5;
      } catch (NoSuchFieldError var24) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.SkinCelcius.ordinal()] = 6;
      } catch (NoSuchFieldError var23) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.SkinCelciusExpand.ordinal()] = 7;
      } catch (NoSuchFieldError var22) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.SkinCelciusContract.ordinal()] = 8;
      } catch (NoSuchFieldError var21) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.PrimaryDelta.ordinal()] = 9;
      } catch (NoSuchFieldError var20) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.SecondaryDelta.ordinal()] = 10;
      } catch (NoSuchFieldError var19) {
      }

      try {
         $SwitchMap$zombie$characters$BodyDamage$Thermoregulator_tryouts$Multiplier[Multiplier.Default.ordinal()] = 11;
