...
public final class BodyDamage {
   ...
   public void ReducePanic() {
      if (!(this.ParentChar.getStats().Panic <= 0.0F)) {
         ...
         int var2 = (int)Math.floor(new Double(GameTime.instance.getNightsSurvived()) / 30.0);
         if (var2 > 5) {
            var2 = 5;
         }
      ...
      if (GameServer.bServer) {
         ...
         if (Rand.Next(100) > var5) {
            ...
            if (var1.scratch) {
               ...
               boolean var17 = this.getParentChar().addHole(BloodBodyPartType.FromIndex(var4), true);
               if (var17) {
               ...
               boolean var30 = this.getParentChar().addHole(BloodBodyPartType.FromIndex(var4), true);
               if (var30) {
                  this.getParentChar().getEmitter().playSoundImpl("ZombieRipClothing", (IsoObject)null);
               }
               ...
               boolean var31 = this.getParentChar().addHole(BloodBodyPartType.FromIndex(var4), true);
               if (var31) {
                  this.getParentChar().getEmitter().playSoundImpl("ZombieRipClothing", (IsoObject)null);
               }
   ...
   public void DrawUntexturedQuad(int var1, int var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      SpriteRenderer.instance.renderi(null, var1, var2, var3, var4, var5, var6, var7, var8, null);
   }
   ...
   public void Update() {
      if (!(this.getParentChar() instanceof IsoZombie)) {
         if (GameServer.bServer) {
            this.RestoreToFullHealth();
            byte var13 = ((IsoPlayer)this.getParentChar()).bleedingLevel;
            if (var13 > 0) {
            ...
            if (this.getParentChar().isAlive()) {
               this.RestoreToFullHealth();
               byte var12 = ((IsoPlayer)this.getParentChar()).bleedingLevel;
               if (var12 > 0) {
