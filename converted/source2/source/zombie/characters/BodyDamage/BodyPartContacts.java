...
import zombie.characters.BodyDamage.BodyPartContacts.ContactNode;
...
public final class BodyPartContacts {
   ...
   private static ContactNode getNodeForBodyPart(BodyPartType var0) {
   ...
   private static void initNodes(ContactNode var0, int var1, ContactNode var2) {
      var0.parent = var2;
      var0.depth = var1;
   ...
   static {
      ...
      for (int var1 = 0; var1 < var0; var1++) {
         nodes[var1] = new ContactNode(BodyPartType.FromIndex(var1));
      }
