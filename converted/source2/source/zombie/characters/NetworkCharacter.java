...
import zombie.characters.NetworkCharacter.Point;
...
public class NetworkCharacter {
   ...
   public Transform predict(int var1, int var2, float var3, float var4, float var5, float var6) {
   ...
   public Transform reconstruct(int var1, float var2, float var3, float var4, float var5) {
      this.transform.moving = false;
      this.transform.operation = Operation.NONE;
      if (this.d2.t != 0) {
