...
import zombie.scripting.objects.Fixing.PredicateRequired;
...
public final class Fixing extends BaseScriptObject {
         ...
         if (!var2[var3].trim().isEmpty() && var2[var3].contains(":")) {
            ...
            if (var5.equals("Require")) {
               ...
               if (var5.equals("GlobalItem")) {
                  if (var6.contains("=")) {
                     this.setGlobalItem(new Fixer(var6.split("=")[0], null, Integer.parseInt(var6.split("=")[1])));
                  } else {
                     this.setGlobalItem(new Fixer(var6, null, 1));
                  }
               ...
               if (var6.contains("=")) {
                  this.fixers.add(new Fixer(var6.split("=")[0], null, Integer.parseInt(var6.split("=")[1])));
               } else {
                  this.fixers.add(new Fixer(var6, null, 1));
               }
            } else {
               ...
               for (int var9 = 1; var9 < var8.size(); var9++) {
                  ...
                  var7.add(new FixerSkill(var10[0].trim(), Integer.parseInt(var10[1].trim())));
               }

               if (var6.split(";")[0].trim().contains("=")) {
                  String[] var13 = var6.split(";")[0].trim().split("=");
                  this.fixers.add(new Fixer(var13[0], var7, Integer.parseInt(var13[1])));
               } else {
                  this.fixers.add(new Fixer(var6.split(";")[0].trim(), var7, 1));
               }
            }
         }
      }
   ...
   public InventoryItem haveGlobalItem(IsoGameCharacter var1) {
      ...
      ArrayList var2 = this.getRequiredFixerItems(var1, this.getGlobalItem(), null, s_InventoryItems);
      return var2 == null ? null : (InventoryItem)var2.get(0);
   }

   public InventoryItem haveThisFixer(IsoGameCharacter var1, Fixer var2, InventoryItem var3) {
      s_InventoryItems.clear();
      ArrayList var4 = this.getRequiredFixerItems(var1, var2, var3, s_InventoryItems);
      return var4 == null ? null : (InventoryItem)var4.get(0);
   }

   public int countUses(IsoGameCharacter var1, Fixer var2, InventoryItem var3) {
      s_InventoryItems.clear();
   ...
   public ArrayList<InventoryItem> getRequiredItems(IsoGameCharacter var1, Fixer var2, InventoryItem var3) {
   ...
   public void setGlobalItem(Fixer var1) {
