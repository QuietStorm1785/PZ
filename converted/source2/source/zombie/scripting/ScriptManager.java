...
import zombie.scripting.ScriptManager.1;
...
public final class ScriptManager implements IScriptObjectStore {
         ...
         if (this.CachedModules.containsKey(var1)) {
            ...
            if (var3 != null) {
               ...
               if (var3 != null) {
                  ...
                  return var2 ? this.ModuleMap.get("Base") : null;
               }
            }
         }
      }
   ...
   public boolean isDrainableItemType(String var1) {
      ...
      return var2 != null ? var2.getType() == Type.Drainable : false;
   }
   ...
   public ArrayList<Item> getItemsTag(String var1) {
      if (StringUtils.isNullOrWhitespace(var1)) {
         ...
         ArrayList var2 = this.tagToItemMap.get(var1);
         if (var2 != null) {
            return var2;
         } else {
            var2 = new ArrayList();
   ...
   public ArrayList<Item> getItemsByType(String var1) {
      if (StringUtils.isNullOrWhitespace(var1)) {
         ...
         ArrayList var2 = this.typeToItemMap.get(var1);
         if (var2 != null) {
            return var2;
         } else {
            var2 = new ArrayList();
   ...
   public void Load() {
      try {
         ...
         for (String var23 : var1) {
            if (!var21.contains(var23)) {
               var21.add(var23);
               String var24 = ZomboidFileSystem.instance.getAbsolutePath(var23);
   ...
   private void debugItems() {
      for (Item var3 : instance.getAllItems()) {
         if (var3.getType() == Type.Drainable && var3.getReplaceOnUse() != null) {
            DebugLog.Script.warn("%s ReplaceOnUse instead of ReplaceOnDeplete", new Object[]{var3.getFullName()});
         }

         if (var3.getType() == Type.Weapon && !var3.HitSound.equals(var3.hitFloorSound)) {
            boolean var4 = true;
         }
