...
import zombie.CollisionManager.Contact;
import zombie.CollisionManager.PolygonCollisionResult;
import zombie.CollisionManager.l_ResolveContacts;
import zombie.CollisionManager.s_performance;
...
public final class CollisionManager {
   ...
   public PolygonCollisionResult PolygonCollision(Vector2 var1) {
   ...
   public void initUpdate() {
      ...
      for (int var2 = 0; var2 < this.ContactMap.size(); var2++) {
         this.ContactMap.get(var2).a = null;
         this.ContactMap.get(var2).b = null;
   ...
   private void resolveContactsInternal() {
      ...
      List var3 = l_ResolveContacts.pushables;
            ...
            if (var1.x != 0.0F
               ...
               if (var18.WillIntersect) {
                  ...
                  if (var30.a instanceof IsoPushableObject) {
                     ArrayList var20 = ((IsoPushableObject)var30.a).connectList;
                     if (var20 != null) {
                  ...
                  if (var30.b instanceof IsoPushableObject) {
                     ArrayList var37 = ((IsoPushableObject)var30.b).connectList;
                     if (var37 != null) {
      ...
      ArrayList var28 = IsoWorld.instance.CurrentCell.getObjectList();
