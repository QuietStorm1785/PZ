...
public final class PlayerActionsState extends State {
   ...
   public void enter(IsoGameCharacter var1) {
      ...
      if (GameClient.bClient
         ...
         && var1.isLocal()
         && !var1.getCharacterActions().isEmpty()
         && var1.getNetworkCharacterAI().getAction() == null) {
         ...
         if (!var1.getCharacterActions().isEmpty()
            && (
               var1.getNetworkCharacterAI().getAction() != var1.getCharacterActions().get(0)
                  || var2 != null && !var2.equals(var1.getNetworkCharacterAI().getPerformingAction())
            )) {
   ...
   public void exit(IsoGameCharacter var1) {
      ...
      if (GameClient.bClient && var1 instanceof IsoPlayer && var1.isLocal() && var1.getNetworkCharacterAI().getAction() != null) {
         GameClient.sendAction(var1.getNetworkCharacterAI().getAction(), false);
         var1.getNetworkCharacterAI().setAction(null);
      }
   }
   ...
   public void animEvent(IsoGameCharacter var1, AnimEvent var2) {
      if (GameClient.bClient
         ...
         if ("original".equals(var2.m_ParameterValue)) {
            var1.getNetworkCharacterAI().setOverride(false, null, null);
         } else {
            var1.getNetworkCharacterAI().setOverride(true, var2.m_ParameterValue, null);
         }
      }
   }
}
