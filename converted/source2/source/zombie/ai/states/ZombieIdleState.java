   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (Core.bLastStand) {
         ...
         for (int var9 = 0; var9 < IsoPlayer.numPlayers; var9++) {
            if (IsoPlayer.players[var9] != null && IsoPlayer.players[var9].DistTo(var1) < var5 && !IsoPlayer.players[var9].isDead()) {
         ...
         if (!var2.bIndoorZombie) {
            if (!var2.isUseless()) {
               if (var2.getStateEventDelayTimer() <= 0.0F) {
                  ...
                  if (var1.getCell().getGridSquare(var6, var7, var1.getZ()) != null && var1.getCell().getGridSquare(var6, var7, var1.getZ()).isFree(true)) {
