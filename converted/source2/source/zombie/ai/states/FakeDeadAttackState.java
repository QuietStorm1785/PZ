...
public final class FakeDeadAttackState extends State {
   ...
   public void animEvent(IsoGameCharacter var1, AnimEvent var2) {
      ...
      if (var2.m_EventName.equalsIgnoreCase("AttackCollisionCheck")
         ...
         && var3.target instanceof IsoGameCharacter var4
         && (var4.getVehicle() == null || var4.getVehicle().couldCrawlerAttackPassenger(var4))) {
         var4.getBodyDamage().AddRandomDamageFromZombie((IsoZombie)var1, null);
      }
