...
import zombie.ai.states.ClimbThroughWindowState.1;
...
public final class ClimbThroughWindowState extends State {
      ...
      if (!this.isWindowClosing(var1)) {
         ...
         if (var1 instanceof IsoZombie) {
            ...
            if (!var1.isFallOnFront() && var5) {
               ...
               int var7 = (Integer)var2.get(PARAM_OPPOSITE_Y);
               int var8 = (Integer)var2.get(PARAM_Z);
         ...
         float var11 = ((Integer)var2.get(PARAM_START_X)).intValue() + 0.5F;
         float var12 = ((Integer)var2.get(PARAM_START_Y)).intValue() + 0.5F;
         ...
         if (var1 instanceof IsoPlayer && var4.equalsIgnoreCase("obstacle")) {
            float var13 = ((Integer)var2.get(PARAM_END_X)).intValue() + 0.5F;
            float var16 = ((Integer)var2.get(PARAM_END_Y)).intValue() + 0.5F;
         ...
         if (var1 instanceof IsoPlayer
            ...
            && !"fallfront".equals(var4)
            && !"back".equals(var4)
            && !"fallback".equals(var4)) {
            int var14 = (Integer)var2.get(PARAM_OPPOSITE_X);
            int var17 = (Integer)var2.get(PARAM_OPPOSITE_Y);
            int var19 = (Integer)var2.get(PARAM_Z);
         ...
         if (var1.getVariableBoolean("ClimbWindowStarted")
            ...
            && !"fallback".equals(var4)
            && !"lunge".equals(var4)
            && !"obstacle".equals(var4)
            && !"obstacleEnd".equals(var4)) {
            float var15 = ((Integer)var2.get(PARAM_START_X)).intValue();
            float var18 = ((Integer)var2.get(PARAM_START_Y)).intValue();
   ...
   public void animEvent(IsoGameCharacter var1, AnimEvent var2) {
      ...
      if (var2.m_EventName.equalsIgnoreCase("PlayWindowSound")) {
         ...
         long var8 = var1.getEmitter().playSoundImpl(var2.m_ParameterValue, null);
