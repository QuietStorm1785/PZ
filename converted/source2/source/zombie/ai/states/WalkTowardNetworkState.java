   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (var2.z != var2.networkAI.targetZ || var2.networkAI.predictionType != PredictionTypes.Thump && var2.networkAI.predictionType != PredictionTypes.Climb) {
         if (var2.z == var2.networkAI.targetZ
            && !PolygonalMap2.instance.lineClearCollide(var2.x, var2.y, var2.networkAI.targetX, var2.networkAI.targetY, var2.networkAI.targetZ, null)) {
      ...
      if (var2.target instanceof IsoGameCharacter
         && ((IsoGameCharacter)var2.target).getVehicle() != null
