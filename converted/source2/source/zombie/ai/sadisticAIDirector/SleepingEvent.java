...
public final class SleepingEvent {
                                 ...
                                 if (var7 != null) {
                                    ...
                                    if (var12) {
                                       for (int var13 = 0; var13 < var7.getObjects().size(); var13++) {
                                          ...
                                          if (var14.getContainer() != null
                                             && (var14.getContainer().getType().equals("fridge") || var14.getContainer().getType().equals("freezer"))) {
                                             var6 += 3;
                                          }
                                    ...
                                    if (var17 != null && var17.isExteriorDoor(null) && var17.IsOpen()) {
                                       var6 += 25;
                                       var3.openDoor = var17;
                                    }
                                 }
   ...
   private int checkWindowStatus(IsoWindow var1) {
      ...
      if (var4) {
         ...
         if (var9 != null && (var9.getNumPlanks() > 4 || var9.isMetal())) {
            var3 -= 20;
         }
         ...
         if (var8 != null && (var8.getNumPlanks() > 3 || var8.isMetal())) {
            var3 -= 5;
         }
   ...
   private boolean isExposedToPrecipitation(IsoGameCharacter var1) {
      if (var1.getCurrentSquare() == null) {
         ...
         return false;
      } else if (var1.getBed() != null && "Tent".equals(var1.getBed().getName())) {
         return false;
      } else {
         ...
         if (var2.weakestWindow != null && var2.weakestWindow.getZ() == 0.0F) {
            ...
            if (var4 != null) {
               ...
               if (var2.weakestWindow.HasCurtains() != null) {
                  var2.weakestWindow.removeSheet(null);
               }
