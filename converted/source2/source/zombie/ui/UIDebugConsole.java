...
import zombie.ui.UIDebugConsole.CommandEntry;
...
public final class UIDebugConsole extends NewWindow {
   ...
   public UIDebugConsole(int var1, int var2) {
      ...
      this.CommandLine = new CommandEntry(this, UIFont.DebugConsole, 5, (int)(this.OutputLog.getY() + this.OutputLog.getHeight()) + 15, 630, 24, "", true);
                  ...
                  if (var7.indexOf(")") > 0) {
                     ...
                     for (Method var9 : var5) {
                        if (var9.getName().equals(var7)) {
                           ...
                           for (Class var10 = var9.getReturnType(); var10 != null; var10 = var10.getSuperclass()) {
   ...
   Method SuggestionEngine(String var1, ArrayList<Method> var2) {
      int var3 = 0;
      int var4 = 0;
      Method var5 = null;
