...
import zombie.ui.UIManager.FadeInfo;
import zombie.ui.UIManager.Sync;
import zombie.util.list.PZArrayUtil;

public final class UIManager {
   public static int lastMouseX = 0;
   public static int lastMouseY = 0;
   public static ClickObject Picked = null;
   ...
   public static TextureFBO createTexture(float var0, float var1, boolean var2) throws Exception {
      if (var2) {
         Texture var5 = new Texture((int)var0, (int)var1, 16);
         TextureFBO var4 = new TextureFBO(var5);
         var4.destroy();
         return null;
      } else {
         Texture var3 = new Texture((int)var0, (int)var1, 16);
      ...
      if (IsoPlayer.getInstance() != null) {
         ...
         if (!GameServer.bServer) {
            ...
            for (int var4 = 0; var4 < 4; var4++) {
               ActionProgressBar var5 = new ActionProgressBar(0, 0);
      ...
      if (!useUIFBO || Core.getInstance().UIRenderThisFrame) {
         if (!bSuspend) {
            ...
            for (int var9 = 0; var9 < getUI().size(); var9++) {
               if ((UI.get(var9).isIgnoreLossControl() || !TutorialManager.instance.StealControl) && !UI.get(var9).isFollowGameWorld()) {
                  try {
                     ...
                     Logger.getLogger(GameWindow.class.getName()).log(Level.SEVERE, null, var8);
                  }
               }
            }
            ...
            if (isShowPausedMessage() && GameTime.isGamePaused() && (getModal() == null || !Modal.isVisible()) && VisibleAllUI) {
               String var10 = Translator.getText("IGUI_GamePaused");
            ...
            for (int var11 = 0; var11 < IsoPlayer.numPlayers; var11++) {
               if (IsoPlayer.players[var11] != null && !playerFadeInfo[var11].isFadeBeforeUI()) {
   ...
   public static void update() {
      if (!bSuspend) {
         ...
         for (int var16 = 0; var16 < tutorialStack.size(); var16++) {
            ...
            UI.add(0, tutorialStack.get(var16));
         }
         ...
         if (Mouse.isLeftPressed()) {
            ...
            for (int var17 = UI.size() - 1; var17 >= 0; var17--) {
               ...
               if ((getModal() == null || getModal() == var25 || !getModal().isVisible())
         ...
         if (Mouse.isLeftReleased()) {
            ...
            for (int var26 = UI.size() - 1; var26 >= 0; var26--) {
               ...
               if ((var34.isIgnoreLossControl() || !TutorialManager.instance.StealControl)
                  && var34.isVisible()
                  && (getModal() == null || getModal() == var34 || !getModal().isVisible())) {
                  if ((
                        !(var5 >= var34.getX())
                           || !(var6 >= var34.getY())
         ...
         if (Mouse.isRightPressed()) {
            for (int var19 = UI.size() - 1; var19 >= 0; var19--) {
               ...
               if (var27.isVisible() && (getModal() == null || getModal() == var27 || !getModal().isVisible())) {
                  if ((
                        !(var5 >= var27.getX())
                           || !(var6 >= var27.getY())
         ...
         if (Mouse.isRightReleased()) {
            ...
            for (int var21 = UI.size() - 1; var21 >= 0; var21--) {
               ...
               if ((var35.isIgnoreLossControl() || !TutorialManager.instance.StealControl)
                  && var35.isVisible()
                  && (getModal() == null || getModal() == var35 || !getModal().isVisible())) {
                  if ((
                        !(var5 >= var35.getX())
                           || !(var6 >= var35.getY())
   ...
   public static void setPicked(ClickObject var0) {
      Picked = var0;
   }
   ...
   public static Boolean isDoubleClick(double var0, double var2, double var4, double var6, double var8) {
      if (Math.abs(var4 - var0) > getDoubleClickDist()) {
         ...
         return System.currentTimeMillis() - var8 > getDoubleClickInterval() ? Boolean.FALSE : Boolean.TRUE;
      }
   }
