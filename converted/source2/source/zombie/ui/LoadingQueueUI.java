...
public class LoadingQueueUI extends UIElement {
   ...
   public void render() {
      ...
      double var5 = 0.4F;
      double var7 = 1.0;
      this.DrawTextureScaledColor(null, 0.0, 0.0, 1.0, (double)this.height, var1, var3, var5, var7);
      this.DrawTextureScaledColor(null, 1.0, 0.0, this.width - 2.0, 1.0, var1, var3, var5, var7);
      this.DrawTextureScaledColor(null, this.width - 1.0, 0.0, 1.0, (double)this.height, var1, var3, var5, var7);
      this.DrawTextureScaledColor(null, 1.0, this.height - 1.0, this.width - 2.0, 1.0, var1, var3, var5, var7);
      ...
      if (placeInQueue >= 0) {
         TextManager.instance
            .DrawStringCentre(UIFont.Medium, this.x + this.width / 2.0F, this.y + 180.0, String.format(this.strQueuePlace, placeInQueue), 1.0, 1.0, 1.0, 1.0);
      }
   }
