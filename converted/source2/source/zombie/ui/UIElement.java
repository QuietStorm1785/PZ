...
public class UIElement {
   ...
   public void DrawTexture(Texture var1, double var2, double var4, double var6) {
      if (this.isVisible()) {
         ...
         if (var12 + var1.getHeight() >= 0 && var12 <= 4096) {
            SpriteRenderer.instance
               .renderi(var1, (int)(var8 + this.xScroll), (int)(var10 + this.yScroll), var1.getWidth(), var1.getHeight(), 1.0F, 1.0F, 1.0F, (float)var6, null);
         }
      }
   }
   ...
   public void DrawTextureCol(Texture var1, double var2, double var4, Color var6) {
      if (this.isVisible()) {
         ...
         if (var13 + var12 >= 0 && var13 <= 4096) {
            SpriteRenderer.instance.renderi(var1, (int)(var7 + this.xScroll), (int)(var9 + this.yScroll), var11, var12, var6.r, var6.g, var6.b, var6.a, null);
         }
      }
   }
   ...
   public void DrawTextureScaled(Texture var1, double var2, double var4, double var6, double var8, double var10) {
      if (this.isVisible()) {
         ...
         SpriteRenderer.instance
            .renderi(var1, (int)(var12 + this.xScroll), (int)(var14 + this.yScroll), (int)var6, (int)var8, 1.0F, 1.0F, 1.0F, (float)var10, null);
      }
   }
   ...
   public void DrawTextureScaledCol(Texture var1, double var2, double var4, double var6, double var8, Color var10) {
      ...
      if (this.isVisible()) {
         ...
         SpriteRenderer.instance
            .render(var1, (int)(var15 + this.xScroll), (int)(var13 + this.yScroll), (int)var6, (int)var8, var10.r, var10.g, var10.b, var10.a, null);
      }
   }
   ...
   public void DrawSubTextureRGBA(
      ...
      if (var1 != null && this.isVisible() && !(var6 <= 0.0) && !(var8 <= 0.0) && !(var14 <= 0.0) && !(var16 <= 0.0)) {
   ...
   public void DrawTextureIgnoreOffset(Texture var1, double var2, double var4, int var6, int var7, Color var8) {
      if (this.isVisible()) {
         ...
         SpriteRenderer.instance.render(var1, (int)(var9 + this.xScroll), (int)(var11 + this.yScroll), var6, var7, var8.r, var8.g, var8.b, var8.a, null);
      }
   }
   ...
   public void DrawTexture_FlippedX(Texture var1, double var2, double var4, int var6, int var7, Color var8) {
      if (this.isVisible()) {
         ...
         double var11 = var4 + this.getAbsoluteY();
         SpriteRenderer.instance
            .renderflipped(var1, (float)(var9 + this.xScroll), (float)(var11 + this.yScroll), var6, var7, var8.r, var8.g, var8.b, var8.a, null);
      }
   }
   ...
   public Boolean onMouseDown(double var1, double var3) {
      if (this.clicked
         ...
         if (this.Parent != null && this.Parent.maxDrawHeight != -1 && this.Parent.maxDrawHeight <= var3) {
            ...
            if (this.getTable() != null) {
               if (var5) {
                  if (this.getTable().rawget("onMouseDownOutside") != null) {
                     Boolean var8 = LuaManager.caller
                  ...
                  Boolean var9 = LuaManager.caller
                     .protectedCallBoolean(
                        UIManager.getDefaultThread(),
   ...
   private Boolean onMouseDoubleClick(double var1, double var3) {
      if (this.Parent != null && this.Parent.maxDrawHeight != -1 && this.Parent.maxDrawHeight <= this.y) {
         ...
         if (this.getTable().rawget("onMouseDoubleClick") != null) {
            Boolean var5 = LuaManager.caller
               .protectedCallBoolean(
                  UIManager.getDefaultThread(),
      ...
      if (this.Parent != null && this.Parent.maxDrawHeight != -1 && this.Parent.maxDrawHeight <= var3) {
         ...
         if (this.getTable() != null) {
            if (var5) {
               ...
               Boolean var10 = LuaManager.caller
                  .protectedCallBoolean(
                     UIManager.getDefaultThread(),
   ...
   public Boolean onRightMouseDown(double var1, double var3) {
      if (!this.isVisible()) {
         return Boolean.FALSE;
      } else if (this.Parent != null && this.Parent.maxDrawHeight != -1 && this.Parent.maxDrawHeight <= var3) {
         return Boolean.FALSE;
      } else if (this.maxDrawHeight != -1 && this.maxDrawHeight <= var3) {
         return Boolean.FALSE;
      } else {
         ...
         if (this.isVisible()) {
            if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !(this.Parent.maxDrawHeight <= this.y)) {
               ...
               if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
                  ...
                  this.DrawTextureScaledColor(null, var9, var11, 1.0, var5, var3, 1.0, 1.0, 0.5);
                  this.DrawTextureScaledColor(null, var9 + 1.0, var11, this.width - 2.0, 1.0, var3, 1.0, 1.0, 0.5);
                  this.DrawTextureScaledColor(null, var9 + this.width - 1.0, var11, 1.0, var5, var3, 1.0, 1.0, 0.5);
                  this.DrawTextureScaledColor(null, var9 + 1.0, var11 + var5 - 1.0, this.width - 2.0, 1.0, var3, 1.0, 1.0, 0.5);
               }
            }
         }
      }
   ...
   public void setControls(Vector<UIElement> var1) {
   ...
   public Double getXScrolled(UIElement var1) {
      return var1 != null && var1.bScrollChildren && this.bScrollWithParent
   ...
   public void setStencilRect(double var1, double var3, double var5, double var7) {
      ...
      SpriteRenderer.instance.renderi(null, (int)var1, (int)var3, (int)var5, (int)var7, 1.0F, 0.0F, 0.0F, 1.0F, null);
   ...
   public Boolean isPointOver(double var1, double var3) {
      if (!this.isVisible()) {
         ...
         if (var6 < 0.0 || var6 >= this.getWidth() || var8 < 0.0 || var8 >= var5) {
            ...
            ArrayList var16 = UIManager.getUI();
   ...
   public boolean isKeyConsumed(int var1) {
      ...
      if (var2 == null) {
         ...
         Boolean var3 = LuaManager.caller.pcallBoolean(UIManager.getDefaultThread(), var2, this.getTable(), BoxedStaticValues.toDouble(var1));
         return var3 == null ? Boolean.FALSE : var3;
      }
   }
