...
function CoopUserName:prerender()
...
function CoopUserName:onJoypadDown(button, joypadData)
...
function CoopUserName:onJoypadDirDown(joypadData)
	self.joypadIndexY = 0
	self.entry:setJoypadFocused(false, joypadData)
end

function CoopUserName:onJoypadDirUp(joypadData)
	self.joypadIndexY = 1
	self.entry:setJoypadFocused(true, joypadData)
end
