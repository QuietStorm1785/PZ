...
ISCarMechanicsOverlay.PartList["BrakeFrontLeft"] = {img="brake_front_left", x=22,y=216,x2=53,y2=244, vehicles={}};
ISCarMechanicsOverlay.PartList["BrakeFrontRight"] = {img="brake_front_right", x=232,y=216,x2=263,y2=244, vehicles={}};
...
--
ISCarMechanicsOverlay.PartList["SuspensionFrontLeft"] = {img="suspension_front_left", x=21,y=181,x2=59,y2=212, vehicles={}};
ISCarMechanicsOverlay.PartList["SuspensionFrontRight"] = {img="suspension_front_right", x=228,y=181,x2=264,y2=212, vehicles={}};
...
for partName,partList in pairs(ISCarMechanicsOverlay.PartList) do
	if not partList.vehicles then
		print(string.format("adding PartList[%s].vehicles", partName))
		partList.vehicles = {}
	end
end
