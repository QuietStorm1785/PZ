...
function ISClothingInsPanel:setJoypadButtons()
...
function ISClothingInsPanel:onGainJoypadFocus(joypadData)
    ISPanelJoypad.onGainJoypadFocus(self, joypadData)
    self:setJoypadButtons()
end

function ISClothingInsPanel:onLoseJoypadFocus(joypadData)
    ISPanelJoypad.onLoseJoypadFocus(self, joypadData)
end

function ISClothingInsPanel:onJoypadDown(button, joypadData)
