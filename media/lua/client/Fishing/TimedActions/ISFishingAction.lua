...
function ISFishingAction:isValidStart()
    return self.tile ~= nil and IsoUtils.DistanceTo(self.tile:getX(), self.tile:getY(), self.character:getX(), self.character:getY()) < 10
end
