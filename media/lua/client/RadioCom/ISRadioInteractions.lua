...
Interactions.CMB = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Combat"), Perks.Combat); end
Interactions.SPE = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Spear"), Perks.Spear); end
...
function ISRadioInteractions:getInstance()
    ...
    function self.checkPlayer(player, _guid, _interactCodes, _x, _y, _z, _line, _source)
        ...
        if _interactCodes == nil or _interactCodes:len() == 0 or _line == nil then
            return;
        end
