...
function isForceDropHeavyItem(item)
    return (item ~= nil) and (item:getType() == "Generator" or item:getType() == "CorpseMale" or item:getType() == "CorpseFemale" or item:hasTag("HeavyItem"))
end
...
function ISEquipWeaponAction:perform()
	...
	if self.item:canBeActivated() and not self.item:hasTag("Lighter") then
