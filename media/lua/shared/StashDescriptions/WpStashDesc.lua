...
stashMap:addStamp("Gun", nil, 10889, 6743, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap13_Text1", 10836, 6749, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap13_Text2", 10836, 6772, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap13_Text3", 10837, 6793, 0, 0, 0)
stashMap.spawnTable = "GunCache1"
...
stashMap:addStamp("Boat", nil, 11288, 6571, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap14_Text1", 11297, 6562, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap14_Text11", 11296, 6587, 0, 0, 0)
stashMap.spawnTable = "FoodCache1"
stashMap:addContainer("FoodBox", "carpentry_01_16", nil, nil, nil, nil, nil)
...
stashMap:addStamp("Star", nil, 12058, 7367, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap15_Text1", 12078, 7344, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap15_Text11", 12078, 7370, 0, 0, 0)
stashMap.barricades = 80
stashMap.spawnTable = "SurvivorCache1"
...
stashMap:addStamp("ArrowEast", nil, 11118, 6860, 0, 0, 0)
stashMap:addStamp("ArrowNorth", nil, 11131, 6871, 0, 0, 0)
stashMap:addStamp("ArrowEast", nil, 11149, 6852, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text1", 11032, 6866, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text2", 11164, 6843, 0, 0, 0)
stashMap:addStamp("ArrowSouth", nil, 11187, 6874, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text21", 11161, 6881, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text3", 11079, 6910, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text31", 11103, 6931, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text32", 11103, 6954, 0, 0, 0)
stashMap:addStamp(nil, "Stash_WpMap16_Text4", 11077, 6987, 0, 0, 0)
stashMap.barricades = 80
stashMap.spawnTable = "SurvivorCache1"
