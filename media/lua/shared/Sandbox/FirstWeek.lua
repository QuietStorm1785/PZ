return {
    ...
    WorldItemRemovalList = "Base.Hat,Base.Glasses,Base.Maggots", -- please ensure that Base.Maggots stays in the list with any future changes due to corpse maggots,
