...
TakeInventoryActionOptions = {};
TakeInventoryActionOptions.ui =
{		
	render = function(elementData, element) 
		element:DrawTextRight("Item to grab:", 110, 7, 1,1,1,1);
	end,
	itemAData = {},
	...
	doCreation = function(self)
		...
		self.itemA = VirtualItemSlot.new("TakeInventoryActionPrimary", 130, 0, "ItemBackground_Blue", getPlayer());
