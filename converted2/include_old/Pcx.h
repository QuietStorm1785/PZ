...
public:
{
    ...
    public Pcx(std::string file)
    {
    }
    public Pcx(URL url)
    {
    }
    public Pcx(std::string url, int urlPal[])
    {
    }
    public Pcx(std::string url, std::string urlPal)
    {
    }
    ...
    int loadPCXminusPal(std::string url)
    {
    	 try
    	 /*     */     {
