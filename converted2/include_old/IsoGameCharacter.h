...
class IsoGameCharacter : public IsoMovingObject {
public:
    implements Talker
{
    class Stats
    ...
    class Wound
    {
        ...
        public bool infectedNormal;
        public bool infectedZombie;
        public BodyLocation loc;
        public bool tourniquet;
        public Wound()
        {
            bandaged = false;
            bleeding = 0.0F;
    ...
    class XP
    {
        public void AddXP(zombie.characters.skills.PerkFactory.Perks type, int amount)
        {
            ...
            if(UIManager.getLevelup() != nullptr && (chr instanceof IsoPlayer))
            ...
            throws IOException
        {
            ...
            for(int n = 0; n < chr.Traits.size(); n++)
                GameWindow.WriteString(output, (std::string)chr.Traits.get(n));
            output.writeInt(TotalXP);
            output.writeInt(level);
            output.writeInt(lastlevel);
            output.writeInt(XPMap.size());
            java.util.Map.Entry e;
            for(Iterator it = XPMap.entrySet().iterator(); it != nullptr && it.hasNext(); output.writeInt(((Integer)e.getValue()).intValue()))
            {
            ...
            throws IOException
        {
            ...
            java.util.Map.Entry e;
            for(Iterator it = XPMap.entrySet().iterator(); it != nullptr && it.hasNext(); output.putInt(((Integer)e.getValue()).intValue()))
            {
                e = (java.util.Map.Entry)it.next();
    ...
    public void DoDeath(HandWeapon weapon, IsoGameCharacter wielder)
    {
        ...
        if(Health < 0.0F)
        {
            if(bUseParts && weapon != nullptr && weapon.getType() == "Shotgun"))
                headSprite = nullptr;
            if(weapon != nullptr)
            {
    ...
    public bool isAllowConversation()
    {
        return AllowConversation;
    }
    public void setAllowConversation(bool AllowConversation)
    {
    ...
    public bool isReanim()
    {
        return Reanim;
    }
    public void setReanim(bool Reanim)
    {
        this.Reanim = Reanim;
    }
    public bool isVisibleToNPCs()
    {
        return VisibleToNPCs;
    }
    public void setVisibleToNPCs(bool VisibleToNPCs)
    {
    ...
    public bool isIgnoreStaggerBack()
    {
        return IgnoreStaggerBack;
    }
    public void setIgnoreStaggerBack(bool IgnoreStaggerBack)
    {
        this.IgnoreStaggerBack = IgnoreStaggerBack;
    }
    public bool isAttackWasSuperAttack()
    {
        return AttackWasSuperAttack;
    }
    public void setAttackWasSuperAttack(bool AttackWasSuperAttack)
    {
    ...
    public void setSuperAttack(bool superAttack)
    {
    ...
    public std::string getHurtSound()
    {
        return hurtSound;
    }
    public void setHurtSound(std::string hurtSound)
    {
        this.hurtSound = hurtSound;
    }
    public bool isIgnoreMovementForDirection()
    {
        return IgnoreMovementForDirection;
    }
    public void setIgnoreMovementForDirection(bool IgnoreMovementForDirection)
    {
    ...
    public std::string getSayLine()
    {
        return sayLine;
    }
    public void setSayLine(std::string sayLine)
    {
    ...
    public bool isbUseParts()
    {
        return bUseParts;
    }
    public void setbUseParts(bool bUseParts)
    {
    ...
    public bool isbOnBed()
    {
        return bOnBed;
    }
    public void setbOnBed(bool bOnBed)
    {
        this.bOnBed = bOnBed;
    }
    ...
    public void setPathing(bool pathing)
    {
    ...
    public bool isSpottedSinceAlphaZero()
    {
        return SpottedSinceAlphaZero;
    }
    public void setSpottedSinceAlphaZero(bool SpottedSinceAlphaZero)
    {
        this.SpottedSinceAlphaZero = SpottedSinceAlphaZero;
    }
    public bool isbDoDefer()
    {
        return bDoDefer;
    }
    public void setbDoDefer(bool bDoDefer)
    {
    ...
    public void setbClimbing(bool bClimbing)
    {
        this.bClimbing = bClimbing;
    }
    public bool isLastCollidedW()
    {
        return lastCollidedW;
    }
    public void setLastCollidedW(bool lastCollidedW)
    {
        this.lastCollidedW = lastCollidedW;
    }
    public bool isLastCollidedN()
    {
        return lastCollidedN;
    }
    public void setLastCollidedN(bool lastCollidedN)
    {
    ...
    public bool isbFalling()
    {
        return bFalling;
    }
    public void setbFalling(bool bFalling)
    {
    ...
    public void GiveOrder(Order order, bool bCancelOrderStack)
    {
    ...
    public Location getLastKnownLocationOf(std::string character)
    {
    ...
    public bool ReadLiterature(InventoryItem info)
    {
        if(info instanceof Literature)
        {
            Literature literature = (Literature)info;
            if(literature.requireInHandOrInventory != nullptr && literature.useOnConsume != nullptr)
            {
                InventoryItem item = nullptr;
                item = FindAndReturn(literature.requireInHandOrInventory, leftHandItem);
                if(item != nullptr && literature.useOnConsume == literature.requireInHandOrInventory))
    ...
    public bool IsArmed()
    {
        return inventory.getBestWeapon(descriptor) != nullptr;
    }
    ...
    public bool InBuildingWith(IsoGameCharacter chr)
    {
        if(getCurrentSquare() == nullptr)
            return false;
        if(chr.getCurrentSquare() == nullptr)
            return false;
        if(getCurrentSquare().getRoom() == nullptr)
            return false;
    ...
    public bool InRoomWith(IsoGameCharacter chr)
    {
        if(getCurrentSquare() == nullptr)
            return false;
        if(chr.getCurrentSquare() == nullptr)
    ...
    public bool IsInBuilding(IsoBuilding building)
    {
        if(getCurrentSquare() == nullptr)
            return false;
        if(getCurrentSquare().getRoom() == nullptr)
    ...
    public bool CanSee(IsoMovingObject obj)
    {
    ...
    public bool hasEquipped(std::string std::string)
    {
        if(leftHandItem != nullptr && leftHandItem.getType() == std::string))
            return true;
        return rightHandItem != nullptr && rightHandItem.getType() == std::string);
    }
    ...
    public void SetClothing(zombie.scripting.objects.Item.ClothingBodyLocation loc, std::string sprite, std::string palette)
    {
    ...
    public void DoCharacterPart(std::string partName, IsoSprite spr)
    {
    ...
    public void DoZombiePart(std::string partName, IsoSprite spr)
    {
    ...
    public void InitSpriteParts(std::string legs, std::string torso, std::string head, std::string top, std::string bottoms, std::string shoe, std::string skinpal, 
            std::string toppal, std::string bottomspal, std::string shoespal)
    {
        legsSprite = sprite;
    ...
    public void InitSpritePartsZombie(std::string SpriteName, std::string legs, std::string torso, std::string head, std::string top, std::string bottoms, std::string shoe, 
            std::string skinpal, std::string toppal, std::string bottomspal, std::string shoespal)
    {
        legsSprite = sprite;
    ...
    public bool HasTrait(std::string trait)
    {
        return Traits.contains(trait);
    }
    public void ApplyInBedOffset(bool apply)
    {
        if(apply)
        {
            if(!bOnBed)
    ...
    {
        InventoryItem bottoms = nullptr;
        InventoryItem top = nullptr;
        InventoryItem shoes = nullptr;
        if(desc.bottomspal != nullptr)
    ...
    public void PlayAnimNoReset(std::string string)
    {
        int n;
        if(this instanceof IsoPlayer)
            n = 0;
        ...
        if(sprite.CurrentAnim.name == "Die"))
            return;
        if(!bUseParts)
        {
    ...
    public void PlayAnim(std::string string)
    {
        int n;
        if(this instanceof IsoPlayer)
            n = 0;
    ...
    public void PlayAnimUnlooped(std::string string)
    {
        int n;
        if(this instanceof IsoPlayer)
            n = 0;
        if(sprite.CurrentAnim.name == "Die"))
            return;
        if((this instanceof IsoLivingCharacter) && sprite.CurrentAnim.name == "ZombieDeath"))
            return;
        if(!bUseParts)
        {
        ...
        } else
        {
            IsoAnim anim = legsSprite.CurrentAnim;
            def.Looped = false;
            if(anim.name == string) && (def.Finished || def.Frame != 0.0F))
                return;
    ...
    public void PlayAnimFrame(std::string string, int frame)
    {
        if(!bUseParts)
        {
            sprite.PlayAnim(string);
    ...
    public void DoFootstepSound(float dist)
    {
        ...
        if(footStepCounter <= 0 && vol > 0.0F)
        {
            ...
            std::string sound = "foottile";
            if(getCurrentSquare().getRoom() == nullptr && dist > 0.06F)
            {
                sound = "foottileecho";
                if(this == IsoCamera.CamCharacter)
                    vol *= 0.4F;
    ...
    public bool Eat(InventoryItem info)
    {
        if(info instanceof Food)
        {
            Food food = (Food)info;
            if(food.getRequireInHandOrInventory() != nullptr && food.getUseOnConsume() != nullptr)
            {
                InventoryItem item = nullptr;
                item = FindAndReturn(food.getRequireInHandOrInventory(), leftHandItem);
                if(item != nullptr && food.getUseOnConsume() == food.getRequireInHandOrInventory()))
    ...
    public void FireCheck()
    {
        if(OnFire)
            return;
        if(square != nullptr && square.getProperties().Is(IsoFlagType.burning) && (!(this instanceof IsoZombie) || (this instanceof IsoZombie) && !((IsoZombie)this).Ghost))
            SetOnFire();
    }
    ...
    public std::string getPrimaryHandType()
    {
        if(leftHandItem == nullptr)
            return nullptr;
        else
    ...
    public std::string getSecondaryHandType()
    {
        if(rightHandItem == nullptr)
            return nullptr;
        else
    ...
    public bool HasItem(std::string string)
    {
        if(string == nullptr)
            return true;
        return string == getSecondaryHandType()) || string == getPrimaryHandType()) || inventory.contains(string);
    }
    ...
    public void setLockStates(bool bVal)
    {
        stateMachine.Lock = bVal;
    }
    public void Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit, bool bIgnoreDamage, float modDelta)
    {
        if(noDamage)
            bIgnoreDamage = true;
        noDamage = false;
        ...
        bool bKnockdown = Rand.Next((int)KnockdownChance) == 0;
    ...
    public void inflictWound(BodyLocation loc, float bleeding, bool infectedZombie, float chanceOfInfect)
    {
    ...
    public bool IsAttackRange(float x, float y, float z)
    {
        float maxrange = 1.0F;
        float minrange = 0.0F;
        if(leftHandItem != nullptr)
    ...
    public bool IsAttackRange(HandWeapon we, float x, float y, float z)
    {
        float maxrange = 1.0F;
        float minrange = 0.0F;
    ...
    public void PathTo(int x, int y, int z, bool critical)
    {
    ...
    public void PathTo(int x, int y, int z, bool critical, int delay)
    {
        ...
        if(t.getRoom() != nullptr)
        {
            ...
            if(getCurrentSquare().getRoom() != nullptr && t.getRoom().building == getCurrentSquare().getRoom().building)
            {
                bOk = true;
            } else
            {
                for(int n = 0; n < c; n++)
                {
                    ...
                    if((o instanceof IsoSurvivor) && o.getCurrentSquare().getRoom() != nullptr && o.getCurrentSquare().getRoom().building == t.getRoom().building)
                        bOk = true;
                    if((o instanceof IsoPlayer) && o.getCurrentSquare().getRoom() != nullptr && o.getCurrentSquare().getRoom().building == t.getRoom().building)
                        bOk = true;
                }
            }
        }
    ...
    {
        InventoryItem attackItem = leftHandItem;
        if((attackItem instanceof HandWeapon) && attackItem.getSwingAnim() != nullptr)
            useHandWeapon = (HandWeapon)attackItem;
        if(useHandWeapon == nullptr)
            return true;
    ...
    public void render(float x, float y, float z, ColorInfo col, bool bDoChild)
    {
        ...
        lastRendered = this;
        if(sprite != nullptr && sprite.getProperties().Is(IsoFlagType.invisible))
            return;
        float mul = 2.0F;
        float div = 1.5F;
    ...
    public void SpreadFire()
    {
        if(!OnFire)
            return;
        if(square != nullptr && !square.getProperties().Is(IsoFlagType.burning) && Rand.Next(6000) < FireSpreadProbability)
            IsoFireManager.StartFire(getCell(), square, false, 50);
    }
    public void Throw(std::string physicsObject)
    {
        if(physicsObject == "MolotovCocktail"))
        {
    ...
    public void update()
    {
        ...
        if(!(this instanceof IsoZombie))
        {
            if(!FrameLoader.bClient)
            {
                if(HasTrait("Agoraphobic") && getCurrentSquare().getRoom() == nullptr)
                    stats.Panic += 0.5F;
                if(HasTrait("Claustophobic") && getCurrentSquare().getRoom() != nullptr)
                {
                    float del = 1.0F;
        ...
        if(!FrameLoader.bClient)
        {
            if(this == IsoPlayer.instance)
            {
                if(craftIngredient1 != nullptr && craftIngredient1.getUses() <= 0)
                    craftIngredient1 = nullptr;
                if(craftIngredient2 != nullptr && craftIngredient2.getUses() <= 0)
                    craftIngredient2 = nullptr;
                if(craftIngredient3 != nullptr && craftIngredient3.getUses() <= 0)
                    craftIngredient3 = nullptr;
                if(craftIngredient4 != nullptr && craftIngredient4.getUses() <= 0)
                    craftIngredient4 = nullptr;
                if(leftHandItem != nullptr && leftHandItem.getUses() <= 0)
                    leftHandItem = nullptr;
                if(rightHandItem != nullptr && rightHandItem.getUses() <= 0)
    ...
    public void DoFloorSplat(IsoGridSquare sq, std::string id, bool bFlip, float offZ, float alpha)
    {
        if(sq == nullptr)
            return;
        sq.DirtySlice();
        bool bDone = false;
        IsoObject best = nullptr;
        for(int i = 0; i < sq.getObjects().size(); i++)
        {
            IsoObject obj = (IsoObject)sq.getObjects().get(i);
            if(obj.sprite != nullptr && obj.sprite.getProperties().Is(IsoFlagType.solidfloor) && best == nullptr)
                best = obj;
        }
        if(best != nullptr && best.sprite != nullptr && (best.sprite.getProperties().Is(IsoFlagType.vegitation) || best.sprite.getProperties().Is(IsoFlagType.solidfloor)))
        {
    ...
    void DoSplat(IsoGridSquare sq, std::string id, bool bFlip, IsoFlagType prop, float offX, float offZ, float alpha)
    {
        if(sq == nullptr)
            return;
        bool bDone = false;
        ...
        {
            IsoObject obj = (IsoObject)sq.getObjects().get(i);
            if(obj.sprite == nullptr || !obj.sprite.getProperties().Is(prop))
                continue;
            IsoSprite spr1 = IsoSprite.getSprite(getCell().SpriteManager, id, 0);
            if(spr1 == nullptr)
                return;
    ...
    InventoryItem FindAndReturn(std::string require, InventoryItem item)
    {
        if(item == nullptr)
            return nullptr;
        if(require == nullptr)
            return item;
        if(require == item.getType()))
            return item;
        else
            return nullptr;
    }
    ...
    private void calculateStats()
    {
        ...
        } else
        {
            ...
            if(getCurrentSquare() != nullptr && getLastSquare() != nullptr && getCurrentSquare().getRoom() == getLastSquare().getRoom() && getCurrentSquare().getRoom() != nullptr)
            {
    ...
    public void splatBlood(int dist, float alpha)
    {
        ...
        for(int dUse = 0; dUse < dist; dUse++)
        {
            ...
            int endUse;
            float offZ;
            if(w != nullptr && w.testCollideAdjacent(nullptr, -1, 0, 0))
            {
                bLeft = false;
                bRight = false;
                min = 0;
                max = 0;
                if(w.getS() != nullptr && w.getS().testCollideAdjacent(nullptr, -1, 0, 0))
                    bLeft = true;
                if(w.getN() != nullptr && w.getN().testCollideAdjacent(nullptr, -1, 0, 0))
                    bRight = true;
                if(bLeft)
                    min = -1;
                if(bRight)
            ...
            if(n == nullptr || !n.testCollideAdjacent(nullptr, 0, -1, 0))
                continue;
            bLeft = false;
            bRight = false;
            min = 0;
            max = 0;
            if(n.getW() != nullptr && n.getW().testCollideAdjacent(nullptr, 0, -1, 0))
                bLeft = true;
            if(n.getE() != nullptr && n.getE().testCollideAdjacent(nullptr, 0, -1, 0))
                bRight = true;
            if(bLeft)
                min = -1;
            if(bRight)
    ...
    protected bool IgnoreStaggerBack;
    protected bool AttackWasSuperAttack;
    ...
    protected std::string hurtSound;
    protected bool IgnoreMovementForDirection;
    ...
    protected bool SpottedSinceAlphaZero;
    protected static ColorInfo inf = new ColorInfo();
    protected bool bDoDefer;
    protected Location LastHeardSound;
    protected float lrx;
    protected float lry;
    protected bool bClimbing;
    protected bool lastCollidedW;
    protected bool lastCollidedN;
