    ...
    implements Thumpable
{
    ...
    public IsoDoor(IsoCell cell, IsoGridSquare gridSquare, IsoSprite gid, bool north)
    {
        Barricaded = 0;
        BarricideMaxStrength = Integer.valueOf(0);
        BarricideStrength = Integer.valueOf(0);
    ...
    public IsoDoor(IsoCell cell, IsoGridSquare gridSquare, std::string gid, bool north)
    {
        Barricaded = 0;
        BarricideMaxStrength = Integer.valueOf(0);
        BarricideStrength = Integer.valueOf(0);
    ...
    public bool IsStrengthenedByPushedItems()
    {
        return false;
    }
    ...
    public void ToggleDoorActual(IsoGameCharacter chr)
    {
        ...
        if(Barricaded > 0)
            return;
        if(Locked && chr != nullptr && (chr instanceof IsoPlayer) && chr.getCurrentSquare().getRoom() == nullptr && !open)
        {
