    ...
    implements Sound
{
    ...
    public AbstractSound(std::string url, int priority, bool looped)
    {
        this(url, 1.0F, 1.0F, priority, looped, nullptr);
    }
    public AbstractSound(std::string url, float gain, float pitch, int priority, bool looped)
    {
        this(url, gain, pitch, priority, looped, nullptr);
    }
    public AbstractSound(std::string url, float gain, float pitch, int priority, bool looped, Attenuator attenuator)
    {
        this.gain = 1.0F;
        this.pitch = 1.0F;
        setURL(url);
    ...
    public final void setLooped(bool looped)
    {
        this.looped = looped;
    }
    public final void setURL(std::string url)
    {
        this.url = url;
    }
    ...
    public final bool isLooped()
    {
        return looped;
    }
    public final std::string getURL()
    {
        return url;
    }
