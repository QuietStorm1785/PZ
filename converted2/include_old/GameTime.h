...
public:
{
    ...
    public std::string getDeathString()
    {
        if(Core.bDebug)
            return "This was a debug run. No survival time for you!";
        std::string total = "You survived for ";
    ...
    public void Update(bool bSleeping)
    {
    ...
    public void setRainingToday(bool RainingToday)
    {
