...
public:
{
    private class StreamThread : public Thread
    {
        public void run()
        {
        }
    ...
    public void destroy()
    {
        ...
        monoSoundEffects = nullptr;
        stereoSoundEffects = nullptr;
        Source s;
    ...
    public void tick()
    {
        ...
        if(musicEffect != nullptr && !musicEffect.isActive())
        {
            music = nullptr;
            musicEffect = nullptr;
        }
    ...
    public SoundEffect play(Sound buf)
    {
        ...
        {
            SoundEffectImpl ret = new SoundEffectImpl(this, nullptr, nullptr);
            ret.deactivate();
            return ret;
        }
    }
    ...
    {
        if(defaultAttenuator == nullptr)
        {
            throw new IllegalArgumentException("defaultAttenuator cannot be nullptr");
        } else
        {
    ...
    public static SoundEngine instance = nullptr;
