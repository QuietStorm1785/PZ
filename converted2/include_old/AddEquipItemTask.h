...
// Source File Name:   AddEquipItemTask.java
namespace zombie {
namespace scripting {
namespace commands {
namespace quest {
...
class AddEquipItemTask : public BaseCommand {
public:
{
    public AddEquipItemTask()
    {
        num = 1;
    }
    ...
    public void begin()
    {
        QuestCreator.AddQuestTask_EquipItem(name, description, item);
    }
