...
public:
{
    public ModalDialog(std::string name, std::string help, bool bYesNo)
    {
    ...
    public void Clicked(std::string name)
    {
        if(Name == "Sleep") && name == "Yes"))
        {
            ...
            {
                Logger.getLogger(ModalDialog.class.getName()).log(Level.SEVERE, nullptr, ex);
            }
