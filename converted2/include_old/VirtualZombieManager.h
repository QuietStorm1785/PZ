...
public:
{
    ...
    public void update()
    {
        ...
        VirtualZombie z;
        for(it = RealifiedThisFrame.iterator(); it != nullptr && it.hasNext(); virtualZombies.remove(z))
        ...
        do
        {
            ...
            if(s != nullptr)
            {
                PathfindManager.instance.AddJob(z2, nullptr, z2.x, z2.y, 0, s.x, s.y, 0);
                z2.finding = true;
                z2.path = nullptr;
            }
        } while(true);
