...
/*  32 */   MAX;
    ...
    public static BodyPartType FromString(std::string str)
    {
        if(str == "Hand_L"))
            return Hand_L;
        if(str == "Hand_R"))
    ...
    public static std::string getDisplayName(BodyPartType BPT)
    {
        if(BPT == Hand_L)
            return "Left Hand";
        if(BPT == Hand_R)
    ...
    public static std::string ToString(BodyPartType BPT)
    {
        if(BPT == Hand_L)
            return "Hand_L";
        if(BPT == Hand_R)
