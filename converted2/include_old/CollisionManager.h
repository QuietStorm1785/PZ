...
public:
{
    ...
    public void initUpdate()
    {
        ...
        {
            ((Contact)ContactMap.get(n)).a = nullptr;
            ((Contact)ContactMap.get(n)).b = nullptr;
    ...
    Contact contact(IsoMovingObject a, IsoMovingObject b)
    {
        ...
        {
            for(int n = 0; n < 50; n++)
                contacts.push(new Contact(nullptr, nullptr));
        }
    ...
    public void ResolveContacts()
    {
                ...
                if(Math.abs(c.a.getZ() - c.b.getZ()) <= 0.3F)
                {
                    ...
                    if(vel.x != 0.0F || vel.y != 0.0F || vel2.x != 0.0F || vel2.y != 0.0F || c.a.getImpulsex() != 0.0F || c.a.getImpulsey() != 0.0F || c.b.getImpulsex() != 0.0F || c.b.getImpulsey() != 0.0F)
                    {
                        ...
                        if(result.WillIntersect)
                        {
                            ...
                            if((c.a instanceof IsoPushableObject) && ((IsoPushableObject)c.a).connectList != nullptr)
                            {
                                IsoPushableObject p;
                            ...
                            if((c.b instanceof IsoPushableObject) && ((IsoPushableObject)c.b).connectList != nullptr)
                            {
        ...
        IsoMovingObject o;
        for(Iterator it22 = IsoWorld.instance.CurrentCell.getObjectList().iterator(); it22 != nullptr && it22.hasNext(); o.postupdate())
