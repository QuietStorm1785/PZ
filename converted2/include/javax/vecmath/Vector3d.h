...
public
  Vector3d(double double0, double double1, double double2) {
    super(double0, double1, double2);
  }

public
  Vector3d(double[] doubles) { super(doubles); }

public
  Vector3d(Vector3d vector3d1) { super(vector3d1); }

public
  Vector3d(Vector3f vector3f) { super(vector3f); }

public
  Vector3d(Tuple3f tuple3f) { super(tuple3f); }

public
  Vector3d(Tuple3d tuple3d) { super(tuple3d); }
...
public
  ...
  void normalize(Vector3d vector3d0) {
    double double0 =
        1.0 / Math.sqrt(vector3d0.x * vector3d0.x + vector3d0.y * vector3d0.y +
                        vector3d0.z * vector3d0.z);
