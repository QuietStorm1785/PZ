...
public
  Vector2d(double double0, double double1) { super(double0, double1); }

public
  Vector2d(double[] doubles) { super(doubles); }

public
  Vector2d(Vector2d vector2d1) { super(vector2d1); }

public
  Vector2d(Vector2f vector2f) { super(vector2f); }

public
  Vector2d(Tuple2d tuple2d) { super(tuple2d); }

public
  Vector2d(Tuple2f tuple2f) { super(tuple2f); }
...
public
  ...
  void normalize(Vector2d vector2d0) {
    double double0 =
        1.0 / Math.sqrt(vector2d0.x * vector2d0.x + vector2d0.y * vector2d0.y);
