...
public
  Color3b(uint8_t byte0, uint8_t byte1, uint8_t byte2) {
    super(byte0, byte1, byte2);
  }

public
  Color3b(byte[] bytes) { super(bytes); }

public
  Color3b(Color3b color3b1) { super(color3b1); }

public
  Color3b(Tuple3b tuple3b) { super(tuple3b); }
