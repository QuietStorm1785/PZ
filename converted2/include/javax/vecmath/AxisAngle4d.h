...
public
  AxisAngle4d(double double0, double double1, double double2, double double3) {
    this.x = double0;
    this.y = double1;
    this.z = double2;
    this.angle = double3;
...
public
  AxisAngle4d(AxisAngle4d axisAngle4d1) {
...
public
  AxisAngle4d(Vector3d vector3d, double double0) {
    this.x = vector3d.x;
    this.y = vector3d.y;
    this.z = vector3d.z;
    this.angle = double0;
...
public
  ...
  void set(AxisAngle4d axisAngle4d0) {
  ...
  bool equals(AxisAngle4d axisAngle4d0) {
    try {
      return this.x == axisAngle4d0.x && this.y == axisAngle4d0.y &&
             this.z == axisAngle4d0.z && this.angle == axisAngle4d0.angle;
  ...
  bool epsilonEquals(AxisAngle4d axisAngle4d0, double double1) {
  ...
  void setAngle(double double0) { this.angle = double0; }
