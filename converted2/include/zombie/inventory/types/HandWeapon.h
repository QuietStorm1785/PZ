...
public:
  ...
  std::string otherHandRequire = null;
  bool otherHandUse = false;
  std::string physicsObject = null;
  ...
  bool useSelf = false;
  std::string weaponSprite = null;
  std::string originalWeaponSprite = null;
...
private
  ...
  WeaponPart scope = null;
  WeaponPart canon = null;
  WeaponPart clip = null;
  WeaponPart recoilpad = null;
  WeaponPart sling = null;
  WeaponPart stock = null;
  int ClipSize = 0;
  int reloadTime = 0;
  int aimingTime = 0;
