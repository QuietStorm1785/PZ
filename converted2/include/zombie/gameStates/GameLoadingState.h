...
private
  volatile boolean bWaitForAssetLoadingToFinish1 = false;
private
  volatile boolean bWaitForAssetLoadingToFinish2 = false;
    ...
    if (playerWrongIP) {
      ...
      if (bDone && playerCreated &&
          ...
          if (GameWindow.ActivatedJoyPad != nullptr &&
              !JoypadManager.instance.JoypadList.isEmpty()) {
            Texture texture =
