...
private
  final TISLogoState.LogoElement logoTIS = new TISLogoState.LogoElement(
      "media/ui/TheIndieStoneLogo_Lineart_White.png");
private
  final TISLogoState.LogoElement logoFMOD =
      new TISLogoState.LogoElement("media/ui/FMODLogo.png");
private
  final TISLogoState.LogoElement logoGA =
      new TISLogoState.LogoElement("media/ui/GA-1280-white.png");
private
  final TISLogoState.LogoElement logoNW =
...
private
  static final class LogoElement {
    Texture m_texture;
    int m_x;
    int m_y;
    int m_width;
