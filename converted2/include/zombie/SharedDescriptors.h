...
private
  static final byte[] DESCRIPTOR_MAGIC = new byte[]{68, 69, 83, 67};
...
public
  static final class Descriptor implements IHumanVisual {
    int ID = 0;
  ...
  private static final class DescriptorList extends
