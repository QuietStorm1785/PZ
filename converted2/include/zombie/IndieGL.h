...
public:
  static int nCount = 0;
private
  static final GLState.CIntValue tempInt = new GLState.CIntValue();
private
  static final GLState.C2IntsValue temp2Ints = new GLState.C2IntsValue();
private
  static final GLState.C3IntsValue temp3Ints = new GLState.C3IntsValue();
private
  static final GLState.C4IntsValue temp4Ints = new GLState.C4IntsValue();
private
  static final GLState.C4BooleansValue temp4Booleans =
      new GLState.C4BooleansValue();
private
  static final GLState.CIntFloatValue tempIntFloat =
      new GLState.CIntFloatValue();
private
  static final Stack<ShaderStackEntry> m_shaderStack =
      std::make_unique<Stack<>>();

  static void glBlendFunc(int int0, int int1) {
    if (SpriteRenderer.instance != nullptr &&
        SpriteRenderer.GL_BLENDFUNC_ENABLED) {
  ...
  static void EndShader() { SpriteRenderer.instance.EndShader(); }
  ...
  static void popShader(Shader shader) {
    if (m_shaderStack.isEmpty()) {
      throw new RuntimeException(
          "Push/PopShader mismatch. Cannot pop. Stack is empty.");
    } else if (m_shaderStack.peek().getShader() != shader) {
      throw new RuntimeException(
          "Push/PopShader mismatch. The popped shader != the pushed shader.");
    } else {
      ...
      if (m_shaderStack.isEmpty()) {
        ...
        StartShader(shaderStackEntry1.getShader(),
                    shaderStackEntry1.getPlayerIndex());
      }
    }
  }
...
public
  static<T1> void bindShader(Shader shader, T1 object,
                             Invokers.Params1.ICallback<T1> iCallback) {
    Lambda.capture(
        shader, object, iCallback,
        (genericStack, shaderx, objectx, iCallbackx)
            ->bindShader(shaderx, genericStack.invoker(objectx, iCallbackx)));
  }

public
  static<T1, T2> void bindShader(Shader shader, T1 object0, T2 object1,
                                 Invokers.Params2.ICallback<T1, T2> iCallback) {
    Lambda.capture(
        shader, object0, object1, iCallback,
        (genericStack, shaderx, object0x, object1x, iCallbackx)
            ->bindShader(shaderx,
...
public
  ...
  bindShader(Shader shader, T1 object0, T2 object1, T3 object2,
             Invokers.Params3.ICallback<T1, T2, T3> iCallback) {
    Lambda.capture(
        shader, object0, object1, object2, iCallback,
        (genericStack, shaderx, object0x, object1x, object2x, iCallbackx)
            ->bindShader(shaderx, genericStack.invoker(object0x, object1x,
                                                       object2x, iCallbackx)));
  }

public
  static<T1, T2, T3, T4> void
  bindShader(Shader shader, T1 object0, T2 object1, T3 object2, T4 object3,
             Invokers.Params4.ICallback<T1, T2, T3, T4> iCallback) {
    Lambda.capture(shader, object0, object1, object2, object3, iCallback,
                   (genericStack, shaderx, object0x, object1x, object2x,
                    object3x, iCallbackx)
                       ->bindShader(shaderx, genericStack.invoker(
                                                 object0x, object1x, object2x,
                                                 object3x, iCallbackx)));
  }

private
  static ShaderProgram.Uniform getShaderUniform(Shader shader, String string,
                                                int int0) {
    if (shader == nullptr) {
      return null;
    } else {
      ...
      return shaderProgram = =
                 null ? null : shaderProgram.getUniform(string, int0, false);
    }
  }
  ...
  static void shaderSetVector4(Shader shader, const std::string &string,
    ...
    if (uniform != nullptr) {
      ShaderUpdate4f(shader.getID(), uniform.loc, float0, float1, float2,
                     float3);
    }
  }
  ...
  static void ShaderUpdate3f(int int0, int int1, float float0, float float1,
                             float float2) {
    SpriteRenderer.instance.ShaderUpdate3f(int0, int1, float0, float1, float2);
  }

  static void ShaderUpdate4f(int int0, int int1, float float0, float float1,
                             float float2, float float3) {
    SpriteRenderer.instance.ShaderUpdate4f(int0, int1, float0, float1, float2,
                                           float3);
  }

  static void glBlendFuncA(int int0, int int1) { GL11.glBlendFunc(int0, int1); }

  static void glEnable(int int0) { SpriteRenderer.instance.glEnable(int0); }
  ...
  static void glDoEndFrame() { SpriteRenderer.instance.glDoEndFrame(); }

  static void glColorMask(bool boolean0, bool boolean1, bool boolean2,
                          bool boolean3) {
    GLState.ColorMask.set(
        temp4Booleans.set(boolean0, boolean1, boolean2, boolean3));
  }
  ...
  static void glEnableA(int int0) { GL11.glEnable(int0); }
  ...
  static void glStencilMaskA(int int0) { GL11.glStencilMask(int0); }

  static void glDisable(int int0) { SpriteRenderer.instance.glDisable(int0); }

  static void glClear(int int0) { SpriteRenderer.instance.glClear(int0); }

  static void glClearA(int int0) { GL11.glClear(int0); }

  static void glDisableA(int int0) { GL11.glDisable(int0); }

  static void glLoadIdentity() { SpriteRenderer.instance.glLoadIdentity(); }
