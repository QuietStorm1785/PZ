...
public:
  ...
  int ncclientH = 0;
  int ncclientW = 0;
  static MoodlesUI instance = null;
...
private
  int[] GoodBadNeutral = new int[MoodleType.ToIndex(MoodleType.MAX)];
private
  int[] MoodleLevel = new int[MoodleType.ToIndex(MoodleType.MAX)];
private
  float[] MoodleOscilationLevel = new float[MoodleType.ToIndex(MoodleType.MAX)];
private
  float[] MoodleSlotsDesiredPos = new float[MoodleType.ToIndex(MoodleType.MAX)];
private
  float[] MoodleSlotsPos = new float[MoodleType.ToIndex(MoodleType.MAX)];
private
  int[] MoodleTypeInSlot = new int[MoodleType.ToIndex(MoodleType.MAX)];
  ...
  IsoGameCharacter UseCharacter = null;
...
public
  MoodlesUI() {
    ...
    this.height = 500.0F;
    this.Back_Bad_1 =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Bkg_Bad_1.png");
    this.Back_Bad_2 =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Bkg_Bad_2.png");
    this.Back_Bad_3 =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Bkg_Bad_3.png");
    this.Back_Bad_4 =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Bkg_Bad_4.png");
    this.Back_Good_1 =
    ...
    this.Back_Neutral =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Bkg_Bad_1.png");
    this.Endurance =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Endurance.png");
    this.Tired =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Tired.png");
    this.Hungry =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Hungry.png");
    this.Panic =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Panic.png");
    this.Sick =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Sick.png");
    this.Bored =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Bored.png");
    this.Unhappy =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Unhappy.png");
    this.Bleeding =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Bleeding.png");
    this.Wet = Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Wet.png");
    this.HasACold =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Cold.png");
    this.Angry =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Angry.png");
    this.Stress =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Stressed.png");
    this.Thirst =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Thirsty.png");
    this.Injured =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Injured.png");
    this.Pain =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Pain.png");
    this.HeavyLoad =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_HeavyLoad.png");
    this.Drunk =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Drunk.png");
    this.Dead =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Dead.png");
    this.Zombie =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Zombie.png");
    this.FoodEaten =
        Texture.getSharedTexture("media/ui/Moodles/Moodle_Icon_Hungry.png");
    this.Hyperthermia =
        Texture.getSharedTexture("media/ui/weather/Moodle_Icon_TempHot.png");
    this.Hypothermia =
        Texture.getSharedTexture("media/ui/weather/Moodle_Icon_TempCold.png");
    this.Windchill =
        Texture.getSharedTexture("media/ui/Moodle_Icon_Windchill.png");
    this.CantSprint =
        Texture.getSharedTexture("media/ui/Moodle_Icon_CantSprint.png");
    plusRed = Texture.getSharedTexture("media/ui/Moodle_internal_plus_red.png");
    minusRed =
        Texture.getSharedTexture("media/ui/Moodle_internal_minus_red.png");
    plusGreen =
        Texture.getSharedTexture("media/ui/Moodle_internal_plus_green.png");
    minusGreen =
        Texture.getSharedTexture("media/ui/Moodle_internal_minus_green.png");
    chevronUp = Texture.getSharedTexture("media/ui/Moodle_chevron_up.png");
    chevronUpBorder =
        Texture.getSharedTexture("media/ui/Moodle_chevron_up_border.png");
    chevronDown = Texture.getSharedTexture("media/ui/Moodle_chevron_down.png");
    chevronDownBorder =
        Texture.getSharedTexture("media/ui/Moodle_chevron_down_border.png");
  ...
  bool onMouseMove(double dx, double dy) {
    if (!this.isVisible()) {
      ...
      this.MouseOverSlot =
          (int)((Mouse.getYA() - this.getY()) / this.MoodleDistY);
  ...
  void render() {
    if (this.UseCharacter != nullptr) {
      ...
      this.OscilatorStep =
          this.OscilatorStep + this.OscilatorRate * float0 * 0.5F;
      ...
      for (int int1 = 0; int1 < MoodleType.ToIndex(MoodleType.MAX); int1++) {
        if (this.MoodleSlotsPos[int1] != 10000.0F) {
          ...
          Texture texture0;
          Texture texture1;
          float1 = this.Oscilator * this.OscilatorScalar *
                   this.MoodleOscilationLevel[int1];
        ...
        label90:
          ...
          if (MoodleType.FromIndex(int1).name() ==
              Core.getInstance().getBlinkingMoodle())) {
              if (this.alphaIncrease) {
                this.alpha =
                    this.alpha +
                    0.1F *
                        (30.0F / PerformanceSettings.instance.getUIRenderFPS());
                if (this.alpha > 1.0F) {
                  this.alpha = 1.0F;
          ...
          this.DrawTexture(texture0, (int)float1,
                           (int)this.MoodleSlotsPos[int1], this.alpha);
          this.DrawTexture(texture1, (int)float1,
                           (int)this.MoodleSlotsPos[int1], this.alpha);
          if (this.UseCharacter.getMoodles().getMoodleChevronCount(int1) > 0) {
            bool boolean0 =
                this.UseCharacter.getMoodles().getMoodleChevronIsUp(int1);
            Color color =
                this.UseCharacter.getMoodles().getMoodleChevronColor(int1);
            color.a = this.alpha;

            for (int int2 = 0;
                 int2 <
                 this.UseCharacter.getMoodles().getMoodleChevronCount(int1);
                 int2++) {
              int int3 = int2 * 4;
              this.DrawTextureCol(
                  boolean0 ? chevronUp : chevronDown, (int)float1 + 16,
                  (int)this.MoodleSlotsPos[int1] + 20 - int3, color);
              this.DrawTextureCol(
                  boolean0 ? chevronUpBorder : chevronDownBorder,
                  (int)float1 + 16, (int)this.MoodleSlotsPos[int1] + 20 - int3,
                  color);
            }
          }
          ...
          if (this.MouseOver && int0 == this.MouseOverSlot) {
            std::string string0 =
                this.UseCharacter.getMoodles().getMoodleDisplayString(int1);
            std::string string1 =
                this.UseCharacter.getMoodles().getMoodleDescriptionString(int1);
            ...
            int int9 = (2 + int7) * 2;
            this.DrawTextureScaledColor(nullptr, -10.0 - int6 - 6.0, int8 - 2.0,
                                        int6 + 12.0, (double)int9, 0.0, 0.0,
                                        0.0, 0.6);
            this.DrawTextRight(string0, -10.0, int8, 1.0, 1.0, 1.0, 1.0);
            this.DrawTextRight(string1, -10.0, int8 + int7, 0.8F, 0.8F, 0.8F,
                               1.0);
          }
  ...
  void wiggle(MoodleType Moodle) {
    this.MoodleOscilationLevel[MoodleType.ToIndex(Moodle)] =
        this.OscilatorStartLevel;
  }
  ...
  void update() {
    ...
    if (this.UseCharacter != nullptr) {
      ...
      for (int int0 = 0; int0 < MoodleType.ToIndex(MoodleType.MAX); int0++) {
        this.MoodleOscilationLevel[int0] =
            this.MoodleOscilationLevel[int0] -
            this.MoodleOscilationLevel[int0] *
                (1.0F - this.OscilatorDecelerator) / float0;
      ...
      if (this.UseCharacter.getMoodles().UI_RefreshNeeded()) {
        ...
        for (int int2 = 0; int2 < MoodleType.ToIndex(MoodleType.MAX); int2++) {
          if (this.UseCharacter.getMoodles().getMoodleLevel(int2) > 0) {
            bool boolean0 = false;
            if (this.MoodleLevel[int2] !=
                this.UseCharacter.getMoodles().getMoodleLevel(int2)) {
              boolean0 = true;
              this.MoodleLevel[int2] =
                  this.UseCharacter.getMoodles().getMoodleLevel(int2);
            ...
            if (boolean0) {
              if (this.MoodleSlotsPos[int2] == 10000.0F) {
                this.MoodleSlotsPos[int2] =
                    this.MoodleSlotsDesiredPos[int2] + 500.0F;
                this.MoodleOscilationLevel[int2] = 0.0F;
              }

              this.GoodBadNeutral[int2] =
                  this.UseCharacter.getMoodles().getGoodBadNeutral(int2);
            } else {
              this.MoodleOscilationLevel[int2] = 0.0F;
            }
      ...
      for (int int3 = 0; int3 < MoodleType.ToIndex(MoodleType.MAX); int3++) {
        if (Math.abs(this.MoodleSlotsPos[int3] -
                     this.MoodleSlotsDesiredPos[int3]) > 0.8F) {
          this.MoodleSlotsPos[int3] =
              this.MoodleSlotsPos[int3] +
              (this.MoodleSlotsDesiredPos[int3] - this.MoodleSlotsPos[int3]) *
                  0.15F;
        } else {
  ...
  void setCharacter(IsoGameCharacter chr) {
    if (chr != this.UseCharacter) {
      ...
      if (this.UseCharacter != nullptr &&
          this.UseCharacter.getMoodles() != nullptr) {
        this.UseCharacter.getMoodles().setMoodlesStateChanged(true);
      }
    }
  }

  static MoodlesUI getInstance() { return instance; }
}
} // namespace ui
} // namespace zombie
