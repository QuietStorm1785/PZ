...
public:
private
  static final HashMap<String, WorldMapImages> s_filenameToImages =
  ...
  ImagePyramid getPyramid() { return this.m_pyramid; }

  int getMinX() { return this.m_pyramid.m_minX; }

  int getMinY() { return this.m_pyramid.m_minY; }

  int getMaxX() { return this.m_pyramid.m_maxX; }

  int getMaxY() { return this.m_pyramid.m_maxY; }
  ...
  float getResolution() { return this.m_pyramid.m_resolution; }

  void destroy() { this.m_pyramid.destroy(); }
