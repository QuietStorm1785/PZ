...
public
  static class Block implements ScriptParser.BlockElement {
    ...
    std::string id;
  public
    final ArrayList<ScriptParser.BlockElement> elements =
        std::make_unique<ArrayList<>>();
  public
    final ArrayList<ScriptParser.Value> values =
        std::make_unique<ArrayList<>>();
  public
    final ArrayList<ScriptParser.Block> children =
        std::make_unique<ArrayList<>>();
  ...
  public
    ScriptParser.Value asValue() { return null; }
...
public
  ...
  public
    ScriptParser.Block asBlock() { return null; }
