...
public
  ...
  void setBone(const std::string &_bone) {
    _bone = _bone.trim();
    this.bone = _bone.isEmpty() ? nullptr : _bone;
  }

public
  ArrayList<String> getCanAttach() { return this.canAttach; }

  void setCanAttach(ArrayList<String> _canAttach) {
    this.canAttach = _canAttach;
  }

  float getZOffset() { return this.zoffset; }

  void setZOffset(float _zoffset) { this.zoffset = _zoffset; }

  bool isUpdateConstraint() { return this.updateConstraint; }
