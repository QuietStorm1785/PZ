...
public:
  std::string clothingExtraSubmenu = null;
...
public
  final ArrayList<String> Categories = std::make_unique<ArrayList<>>();
public
  final ArrayList<String> Tags = std::make_unique<ArrayList<>>();
  ...
  std::string AmmoType = null;
  int maxAmmo = 0;
  std::string GunType = null;
  int DoorDamage = 1;
  ...
  std::string attachmentType = null;
  std::string makeUpType = null;
  std::string consolidateOption = null;
public
  ArrayList<String> RequireInHandOrInventory = nullptr;
  std::string DoorHitSound = "BaseballBatHit";
  std::string ReplaceOnUse = null;
  ...
  std::string ReplaceOnUseOn = null;
  std::string ReplaceTypes = null;
private
  HashMap<String, String> ReplaceTypesMap = nullptr;
  bool IsWaterSource = false;
public
  ArrayList<String> attachmentsProvided = nullptr;
  std::string FoodType = null;
  bool Poison = false;
  int PoisonDetectionLevel = null;
  int PoisonPower = 0;
  KahluaTable DefaultModData = null;
  ...
  std::string CustomContextMenu = null;
  std::string Tooltip = null;
public
  List<String> ReplaceOnCooked = nullptr;
  std::string DisplayCategory = null;
  bool Trap = false;
  bool OBSOLETE = false;
...
private
  ArrayList<String> mountOn = nullptr;
  ...
  std::string PutInSound = null;
  std::string PlaceOneSound = null;
  std::string PlaceMultipleSound = null;
  std::string OpenSound = null;
  std::string CloseSound = null;
  std::string breakSound = null;
  std::string customEatSound = null;
  std::string fillFromDispenserSound = null;
  std::string fillFromTapSound = null;
  std::string bulletOutSound = null;
  std::string ShellFallSound = null;
private
  HashMap<String, String> SoundMap = nullptr;
...
private
  ...
  std::string PlacedSprite = null;
  bool canBeReused = false;
  int sensorRange = 0;
  bool canBeRemote = false;
  bool remoteController = false;
  int remoteRange = 0;
  std::string countDownSound = null;
  std::string explosionSound = null;
  int fluReduction = 0;
  ...
  std::string evolvedRecipeName = null;
  std::string ReplaceOnRotten = null;
  float metalValue = 0.0F;
  std::string AlarmSound = null;
  std::string itemWhenDry = null;
  ...
  std::string ClothingItem = null;
  ClothingItem clothingItemAsset = null;
  std::string staticModel = null;
  std::string primaryAnimMask = null;
  std::string secondaryAnimMask = null;
  std::string primaryAnimMaskAttachment = null;
  std::string secondaryAnimMaskAttachment = null;
  std::string replaceInSecondHand = null;
  std::string replaceInPrimaryHand = null;
  std::string replaceWhenUnequip = null;
  ItemReplacement replacePrimaryHand = null;
  ItemReplacement replaceSecondHand = null;
  std::string worldObjectSprite = null;
  std::string ItemName;
  Texture NormalTexture;
public
  List<Texture> SpecialTextures = std::make_unique<ArrayList<>>();
public
  List<String> SpecialWorldTextureNames = std::make_unique<ArrayList<>>();
...
public
  ArrayList<String> clothingItemExtra;
public
  ArrayList<String> clothingItemExtraOption;
  bool removeOnBroken = false;
  bool canHaveHoles = true;
  bool cosmetic = false;
  std::string ammoBox = null;
  bool hairDye = false;
  std::string insertAmmoStartSound = null;
  std::string insertAmmoSound = null;
  std::string insertAmmoStopSound = null;
  std::string ejectAmmoStartSound = null;
  std::string ejectAmmoSound = null;
  std::string ejectAmmoStopSound = null;
  std::string rackSound = null;
  std::string clickSound = "Stormy9mmClick";
  std::string equipSound = null;
  std::string unequipSound = null;
  std::string bringToBearSound = null;
  std::string magazineType = null;
  std::string weaponReloadType = null;
...
private
  ...
  std::string LuaCreate = null;
private
  HashMap<String, String> soundParameterMap = nullptr;
  std::string HitSound = "BaseballBatHit";
  std::string hitFloorSound = "BatOnFloor";
  std::string BodyLocation = "";
public
  Stack<String> PaletteChoices = std::make_unique<Stack<>>();
  std::string SpriteName = null;
  std::string PalettesStart = "";
public
  static HashMap<Integer, String> NetIDToItem = std::make_unique<HashMap<>>();
public
  static HashMap<String, Integer> NetItemToID = std::make_unique<HashMap<>>();
  static int IDMax = 0;
public
  Item.Type type = Item.Type.Normal;
  bool Spice = false;
  int UseForPoison;
  ...
  Texture getNormalTexture() { return this.NormalTexture; }
   ...
   */
  float getActualWeight() { return this.ActualWeight; }
   ...
   */
  float getWeightEmpty() { return this.WeightEmpty; }

  /**
   *
   * @param weight the EmptyWeight to set
   */
  void setWeightEmpty(float weight) { this.WeightEmpty = weight; }

  /**
   * @return the HungerChange
   */
  float getHungerChange() { return this.HungerChange; }
  ...
  float getThirstChange() { return this.ThirstChange; }
   ...
   */
  int getDaysFresh() { return this.DaysFresh; }

  /**
   *
   * @param _DaysFresh the DaysFresh to set
   */
  void setDaysFresh(int _DaysFresh) { this.DaysFresh = _DaysFresh; }

  /**
   * @return the DaysTotallyRotten
   */
  int getDaysTotallyRotten() { return this.DaysTotallyRotten; }
   ...
   */
  int getMinutesToCook() { return this.MinutesToCook; }
   ...
   */
  int getMinutesToBurn() { return this.MinutesToBurn; }
  ...
  std::string getCookingSound() { return this.CookingSound; }
   ...
   */
  bool isAlwaysWelcomeGift() { return this.AlwaysWelcomeGift; }
  ...
  bool getCanStoreWater() { return this.CanStoreWater; }
...
public
   ...
   */
  float getSwingAmountBeforeImpact() { return this.SwingAmountBeforeImpact; }
   ...
   */
  bool isCanBandage() { return this.CanBandage; }

  /**
   *
   * @param _CanBandage the CanBandage to set
   */
  void setCanBandage(bool _CanBandage) { this.CanBandage = _CanBandage; }

  bool isCosmetic() { return this.cosmetic; }
  ...
  std::string getModuleName() { return this.module.name; }

  std::string getFullName() { return this.moduleDotType; }
   ...
   */
  std::string getSwingAnim() { return this.SwingAnim; }
   ...
   */
  float getWeaponWeight() { return this.WeaponWeight; }
   ...
   */
  float getEnduranceChange() { return this.EnduranceChange; }
  ...
  std::string getClothingItem() { return this.ClothingItem; }

  void setClothingItemAsset(ClothingItem asset) {
    this.clothingItemAsset = asset;
  }

  ClothingItem getClothingItemAsset() { return this.clothingItemAsset; }

public
  ArrayList<String> getClothingItemExtra() { return this.clothingItemExtra; }
...
public
  ...
  std::string getFabricType() { return this.fabricType; }
...
public
  ...
  std::string getFillFromTapSound() { return this.fillFromTapSound; }
  ...
  std::string getEjectAmmoStartSound() { return this.ejectAmmoStartSound; }

  std::string getEjectAmmoSound() { return this.ejectAmmoSound; }

  std::string getEjectAmmoStopSound() { return this.ejectAmmoStopSound; }

  std::string getInsertAmmoStartSound() { return this.insertAmmoStartSound; }

  std::string getInsertAmmoSound() { return this.insertAmmoSound; }

  std::string getInsertAmmoStopSound() { return this.insertAmmoStopSound; }

  std::string getEquipSound() { return this.equipSound; }

  std::string getUnequipSound() { return this.unequipSound; }

  std::string getExplosionSound() { return this.explosionSound; }

  std::string getStaticModel() { return this.staticModel; }

  std::string getOpenSound() { return this.OpenSound; }

  std::string getPutInSound() { return this.PutInSound; }

  std::string getPlaceOneSound() { return this.PlaceOneSound; }

  std::string getPlaceMultipleSound() { return this.PlaceMultipleSound; }

  std::string getShellFallSound() { return this.ShellFallSound; }

  std::string getSoundByID(const std::string &ID) {
    return this.SoundMap == nullptr ? nullptr
  ...
  bool isManuallyRemoveSpentRounds() { return this.manuallyRemoveSpentRounds; }

  float getRainFactor() { return this.rainFactor; }
...
public
   ...
   */
  bool isDangerousUncooked() { return this.DangerousUncooked; }
   ...
   */
  float getNPCSoundBoost() { return this.NPCSoundBoost; }
   ...
   */
  bool isCanBarricade() { return this.CanBarricade; }
   ...
   */
  bool isUseWhileEquipped() { return this.UseWhileEquipped; }
   ...
   */
  bool isUseWhileUnequipped() { return this.UseWhileUnequipped; }
  ...
  float getTicksPerEquipUse() { return this.TicksPerEquipUse; }

  /**
   * @return the DisappearOnUse
   */
  bool isDisappearOnUse() { return this.DisappearOnUse; }
   ...
   */
  void setUseDelta(float _UseDelta) { this.UseDelta = _UseDelta; }
   ...
   */
  std::string getBodyLocation() { return this.BodyLocation; }
   ...
   */
public
  Stack<String> getPaletteChoices() { return this.PaletteChoices; }
   ...
   */
  std::string getPalettesStart() { return this.PalettesStart; }
   ...
   */
public
  Item.Type getType() { return this.type; }

  /**
   *
   * @param _type the type to set
   */
  void setType(Item.Type _type) { this.type = _type; }

  std::string getTypeString() { return this.type.name(); }
...
InstanceItem(const std::string &param) {
  ...
  if (this.type == Item.Type.KeyRing) {
    object = new KeyRing(this.module.name, this.DisplayName, this.name,
                         "Item_" + this.Icon);
  }

  if (this.type == Item.Type.WeaponPart) {
    object = new WeaponPart(this.module.name, this.DisplayName, this.name,
                            "Item_" + this.Icon);
  ...
  if (this.type == Item.Type.Container) {
    object = new InventoryContainer(this.module.name, this.DisplayName,
                                    this.name, "Item_" + this.Icon);
    ...
    inventoryContainer.getInventory().setOnlyAcceptCategory(
        this.OnlyAcceptCategory);
    inventoryContainer.getInventory().setAcceptItemFunction(
        this.AcceptItemFunction);
  }
  ...
  if (this.type == Item.Type.Literature) {
    object =
        new Literature(this.module.name, this.DisplayName, this.name, this);
    ...
    object =
        new AlarmClock(this.module.name, this.DisplayName, this.name, this);
    ...
    if (!this.PaletteChoices.isEmpty() || param != nullptr) {
    ...
    object = new AlarmClockClothing(
        this.module.name, this.DisplayName, this.name,
        "Item_" + this.Icon.replace(".png", "") + string0, string1,
        this.SpriteName);
    ...
    object =
        new HandWeapon(this.module.name, this.DisplayName, this.name, this);
    ...
    object = new Clothing(this.module.name, this.DisplayName, this.name,
                          "Item_" + this.Icon.replace(".png", "") + string2,
                          string3, this.SpriteName);
    ...
    object = new DrainableComboItem(this.module.name, this.DisplayName,
                                    this.name, this);
    ...
    object = new Radio(this.module.name, this.DisplayName, this.name,
                       "Item_" + this.Icon);
    ...
    if (!StringUtils.isNullOrWhitespace(this.worldObjectSprite) &&
        !radio.ReadFromWorldSprite(this.worldObjectSprite)) {
      DebugLog.log("Item -> Radio item = " + (this.moduleDotType != nullptr
                                                  ? this.moduleDotType
                                                  : "unknown"));
    }
    ...
    MapItem mapItem =
        new MapItem(this.module.name, this.DisplayName, this.name, this);
  ...
  if (this.colorRed < 255 || this.colorGreen < 255 || this.colorBlue < 255) {
    ((InventoryItem)object)
        .setColor(new Color(this.colorRed / 255.0F, this.colorGreen / 255.0F,
                            this.colorBlue / 255.0F));
  }
  ...
  ((InventoryItem)object)
      .setRequireInHandOrInventory(this.RequireInHandOrInventory);
  ...
  ((InventoryItem)object).RequiresEquippedBothHands =
      this.RequiresEquippedBothHands;
  ...
  if (this.CustomContextMenu != nullptr) {
    ((InventoryItem)object)
        .setCustomMenuOption(
            Translator.getText("ContextMenu_" + this.CustomContextMenu));
  }

  if (this.IconsForTexture != nullptr && !this.IconsForTexture.isEmpty()) {
  ...
  if (str.trim().length() != 0) {
    try {
      ...
      if (string0.trim().equalsIgnoreCase("BodyLocation")) {
        ...
        this.DisplayName =
            Translator.getItemNameFromFullType(this.getFullName());
        ...
        this.WorldTextureName =
            this.ItemName.replace("Item_", "media/inventory/world/WItem_");
        ...
        if (this.type == Item.Type.Food) {
          ...
          std::string string2 =
              this.WorldTextureName.replace(".png", "Rotten.png");
          if (texture0 == nullptr) {
          ...
          this.SpecialTextures.add(
              Texture.trygetTexture(this.ItemName + "Cooked"));
          this.SpecialWorldTextureNames.add(
              this.WorldTextureName.replace(".png", "Cooked.png"));
          Texture texture1 = Texture.trygetTexture(this.ItemName + "Overdone");
          std::string string3 =
              this.WorldTextureName.replace(".png", "Overdone.png");
          if (texture1 == nullptr) {
      ...
      } else if (string0.trim().equalsIgnoreCase(
      ...
      if (strings6.length >= 2 && strings6.length <= 4) {
        ...
        modelWeaponPart0.attachmentNameSelf =
            strings6.length > 2 ? strings6[2] : nullptr;
        modelWeaponPart0.attachmentParent =
            strings6.length > 3 ? strings6[3] : nullptr;
        if (!modelWeaponPart0.partType.contains(".")) {
          modelWeaponPart0.partType =
              this.module.name + "." + modelWeaponPart0.partType;
        }

        if (!modelWeaponPart0.modelName.contains(".")) {
          modelWeaponPart0.modelName =
              this.module.name + "." + modelWeaponPart0.modelName;
        }
      ...
      this.RemoveNegativeEffectOnCooked =
          string1.trim().equalsIgnoreCase("true");
    }
      ...
      this.PlaceMultipleSound =
          StringUtils.discardNullOrWhitespace(string1.trim());
    }
      ...
      this.evolvedRecipeName =
          Translator.getItemEvolvedRecipeName(this.getFullName());
    }
      ...
      for (int int8 = 0; int8 < strings13.length; int8++) {
        ...
        ItemRecipe itemRecipe =
            new ItemRecipe(this.name, this.module.getName(), int9);
        EvolvedRecipe evolvedRecipe0 = null;

        for (EvolvedRecipe evolvedRecipe1 :
             ScriptManager.instance.ModuleMap.get("Base").EvolvedRecipeMap) {
        ...
        if (evolvedRecipe0 == nullptr) {
          ...
          ScriptManager.instance.ModuleMap.get("Base").EvolvedRecipeMap.add(
              evolvedRecipe0);
        }
      ...
      for (int int12 = 0; int12 < strings16.length; int12++) {
        this.bloodClothingType.add(
            BloodClothingType.fromString(strings16[int12].trim()));
      }
    }
      ...
      DebugLog.log("adding unknown item param \"" + string0.trim() + "\" = \"" +
                   string1.trim() + "\"");
    ...
    throw new InvalidParameterException(
        "Error: " + str.trim() +
        " is not a valid parameter in item: " + this.name);
  }
}
}

int getLevelSkillTrained() { return this.LvlSkillTrained; }

int getNumLevelsTrained() { return this.NumLevelsTrained; }

int getMaxLevelTrained() {
  return this.LvlSkillTrained == -1
             ? -1
             : this.LvlSkillTrained + this.NumLevelsTrained;
}
...
bool isConditionAffectsCapacity() { return this.ConditionAffectsCapacity; }

int getChanceToFall() { return this.chanceToFall; }

float getInsulation() { return this.insulation; }

void setInsulation(float f) { this.insulation = f; }

float getWindresist() { return this.windresist; }

void setWindresist(float w) { this.windresist = w; }

float getWaterresist() { return this.waterresist; }

void setWaterresist(float w) { this.waterresist = w; }

bool getObsolete() { return this.OBSOLETE; }
...
std::string toString() {
  return this.getClass().getSimpleName() +
         "{Module: " + (this.module != nullptr ? this.module.name : "nullptr") +
         ", Name:" + this.name + ", Type:" + this.type + "}";
}

std::string getReplaceWhenUnequip() { return this.replaceWhenUnequip; }

void resolveItemTypes() {
  this.AmmoType =
      ScriptManager.instance.resolveItemType(this.module, this.AmmoType);
  this.magazineType =
      ScriptManager.instance.resolveItemType(this.module, this.magazineType);
  ...
  if (this.ReplaceTypesMap != nullptr) {
    for (String string1 : this.ReplaceTypesMap.keySet()) {
      ...
      this.ReplaceTypesMap.replace(
          string1,
          ScriptManager.instance.resolveItemType(this.module, string2));
    }
  }
}
...
void resolveModelScripts() {
  this.staticModel =
      ScriptManager.instance.resolveModelScript(this.module, this.staticModel);
  this.worldStaticModel = ScriptManager.instance.resolveModelScript(
      this.module, this.worldStaticModel);
}
...
void setRegistry_id(short id) {
  if (this.registry_id != -1) {
    ...
    throw new RuntimeException(
        "Cannot override existing registry id (" + this.registry_id +
        ") to new id (" + id + "), item: " +
...
bool getExistsAsVanilla() { return this.existsAsVanilla; }
  ...
  if (GameClient.bClient) {
    if (this.modID == nullptr) {
      this.modID = modid;
        ...
        throw new RuntimeException("Cannot override modID. ModID=" +
                                   (modid != nullptr ? modid : "nullptr"));
      }
  }
}

std::string getRecordedMediaCat() { return this.recordedMediaCat; }

bool isWorldRender() { return this.worldRender; }

bool isCantEat() { return this.CantEat; }
...
std::string getSoundParameter(const std::string &parameterName) {
  return this.soundParameterMap == nullptr
             ? nullptr
