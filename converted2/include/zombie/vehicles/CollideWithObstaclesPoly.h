...
private
  final ArrayList<CollideWithObstaclesPoly.CCObstacle> obstacles =
      std::make_unique<ArrayList<>>();
private
  final ArrayList<CollideWithObstaclesPoly.CCNode> nodes =
      std::make_unique<ArrayList<>>();
private
  final CollideWithObstaclesPoly.ImmutableRectF moveBounds =
      new CollideWithObstaclesPoly.ImmutableRectF();
private
  final CollideWithObstaclesPoly.ImmutableRectF vehicleBounds =
      new CollideWithObstaclesPoly.ImmutableRectF();
...
private
  final CollideWithObstaclesPoly.ClosestPointOnEdge closestPointOnEdge =
  ...
  bool canStandAt(float float1, float float3, float float6, BaseVehicle vehicle,
    ...
    for (int int1 = 0; int1 < this.obstacles.size(); int1++) {
      ...
      if ((vehicle == nullptr || cCObstacle.vehicle != vehicle) &&
  ...
  boolean isNotClear(float float1, float float3, float float5, float float7,
    ...
    for (; int2 > 0; int2--) {
      ...
      if (chunk != nullptr) {
        ...
        std::vector arrayList = vehicle == null
...
private
  static final class CCEdge {
    ...
    static final ObjectPool<CollideWithObstaclesPoly.CCEdge> pool =
  ...
  private static final class CCEdgeRing extends
      ArrayList<CollideWithObstaclesPoly.CCEdge> {
    static final ObjectPool<CollideWithObstaclesPoly.CCEdgeRing> pool =
...
private
static final class CCNode {
  float x;
  float y;
  int z;
  final ArrayList<CollideWithObstaclesPoly.CCEdge> edges =
      std::make_unique<ArrayList<>>();
  static final ObjectPool<CollideWithObstaclesPoly.CCNode> pool =
...
private static final class CCObstacle {
  final CollideWithObstaclesPoly.CCEdgeRing outer =
      new CollideWithObstaclesPoly.CCEdgeRing();
  final ArrayList<CollideWithObstaclesPoly.CCEdgeRing> inner =
      std::make_unique<ArrayList<>>();
  BaseVehicle vehicle = null;
  CollideWithObstaclesPoly.ImmutableRectF bounds;
  static final ObjectPool<CollideWithObstaclesPoly.CCObstacle> pool =
...
static final class ChunkData {
  final CollideWithObstaclesPoly.ChunkDataZ[] data =
...
public
  final ArrayList<CollideWithObstaclesPoly.CCObstacle> worldVehicleUnion =
      std::make_unique<ArrayList<>>();
public
  final ArrayList<CollideWithObstaclesPoly.CCObstacle> worldVehicleSeparate =
      std::make_unique<ArrayList<>>();
public
  final ArrayList<CollideWithObstaclesPoly.CCNode> nodes =
      std::make_unique<ArrayList<>>();
  int z;
public
  static final ObjectPool<CollideWithObstaclesPoly.ChunkDataZ> pool =
...
private static final class ImmutableRectF {
  ...
  float w;
  float h;
  static final ArrayDeque<CollideWithObstaclesPoly.ImmutableRectF> pool =
  ...
  static CollideWithObstaclesPoly.ImmutableRectF alloc() {
    return pool.isEmpty() ? new CollideWithObstaclesPoly.ImmutableRectF()
                          : pool.pop();
  }
