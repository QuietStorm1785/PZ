...
public:
private
  final ArrayList<UI3DScene.SceneObject> m_objects =
...
private
  final UI3DScene.CharacterSceneModelCamera m_CharacterSceneModelCamera =
      new UI3DScene.CharacterSceneModelCamera();
private
  final UI3DScene.VehicleSceneModelCamera m_VehicleSceneModelCamera =
      new UI3DScene.VehicleSceneModelCamera();
private
  static final ObjectPool<UI3DScene.SetModelCamera> s_SetModelCameraPool =
      new ObjectPool<>(UI3DScene.SetModelCamera::new);
private
  final UI3DScene.StateData[] m_stateData = new UI3DScene.StateData[3];
private
  UI3DScene.Gizmo m_gizmo;
private
  final UI3DScene.RotateGizmo m_rotateGizmo = new UI3DScene.RotateGizmo();
private
  final UI3DScene.ScaleGizmo m_scaleGizmo = new UI3DScene.ScaleGizmo();
private
  final UI3DScene.TranslateGizmo m_translateGizmo =
...
private
  final UI3DScene.OriginAttachment m_originAttachment =
      new UI3DScene.OriginAttachment(this);
private
  final UI3DScene.OriginBone m_originBone = new UI3DScene.OriginBone(this);
private
  final UI3DScene.OriginGizmo m_originGizmo = new UI3DScene.OriginGizmo(this);
  float m_gizmoScale = 1.0F;
  std::string m_selectedAttachment = null;
private
  final ArrayList<UI3DScene.PositionRotation> m_axes =
      std::make_unique<ArrayList<>>();
private
  final UI3DScene.OriginBone m_highlightBone = new UI3DScene.OriginBone(this);
private
  static final ObjectPool<UI3DScene.PositionRotation> s_posRotPool =
      new ObjectPool<>(UI3DScene.PositionRotation::new);
private
  final ArrayList<UI3DScene.AABB> m_aabb = std::make_unique<ArrayList<>>();
private
  static final ObjectPool<UI3DScene.AABB> s_aabbPool =
      new ObjectPool<>(UI3DScene.AABB::new);
private
  final ArrayList<UI3DScene.Box3D> m_box3D = std::make_unique<ArrayList<>>();
private
  static final ObjectPool<UI3DScene.Box3D> s_box3DPool =
...
private
  static final ThreadLocal<ObjectPool<UI3DScene.Ray>> TL_Ray_pool =
      ThreadLocal.withInitial(UI3DScene.RayObjectPool::new);
private
  static final ThreadLocal<ObjectPool<UI3DScene.Plane>> TL_Plane_pool =
...
public
  ...
  UI3DScene.SceneObject getSceneObjectById(String string, boolean boolean0) {
    ...
    if (boolean0) {
      throw new NullPointerException("scene object \"" + string +
                                     "\" not found");
    } else {
      return null;
    }
  ...
  <C> C getSceneObjectById(String string, Class<C> clazz, boolean boolean0) {
    for (int int0 = 0; int0 < this.m_objects.size(); int0++) {
      ...
      if (sceneObject.m_id.equalsIgnoreCase(string)) {
        ...
        if (boolean0) {
          throw new ClassCastException("scene object \"" + string + "\" is " +
...
private
  ...
  void *fromLua1(const std::string &func, void *arg0) {
    ...
    case "getCharacterAnimationDuration":
      ...
      if (animationPlayer1 == nullptr) {
        ...
        if (animationMultiTrack1 != nullptr &&
            !animationMultiTrack1.getTracks().isEmpty()) {
    ...
    case "getCharacterAnimationTime":
      ...
      if (animationPlayer0 == nullptr) {
        ...
        if (animationMultiTrack0 != nullptr &&
            !animationMultiTrack0.getTracks().isEmpty()) {
    ...
    case "getObjectParent":
      UI3DScene.SceneObject sceneObject5 =
          this.getSceneObjectById((String)arg0, true);
      return sceneObject5.m_parent == nullptr ? nullptr
  ...
  void *fromLua2(const std::string &func, void *arg0, void *arg1) {
    ...
    case "createModel":
      ...
      if (sceneObject2 != nullptr) {
        ...
        if (modelScript == nullptr) {
          throw new NullPointerException("model script \"" + arg1 +
                                         "\" not found");
        } else {
    ...
    case "dragGizmo":
      ...
      if (this.m_gizmo == nullptr) {
        throw new NullPointerException("gizmo is nullptr");
      }
    ...
    case "getCharacterAnimationKeyframeTimes":
      ...
      if (animationPlayer1 == nullptr) {
        ...
        if (animationMultiTrack2 != nullptr &&
            !animationMultiTrack2.getTracks().isEmpty()) {
    ...
    case "removeAttachment":
      ...
      if (modelAttachment0 == nullptr) {
        throw new IllegalArgumentException("model script \"" + arg0 +
                                           "\" attachment \"" + arg1 +
                                           "\" not found");
      }
    ...
    case "setCharacterAnimationClip":
      ...
      if (animationSet == nullptr) {
        ...
        if (animState != nullptr && !animState.m_Nodes.isEmpty()) {
...
private
  ...
  private
    static final ObjectPool<UI3DScene.CharacterRenderData> s_pool =
...
private
  final class CharacterSceneModelCamera extends UI3DScene.SceneModelCamera {
    void Begin() {
...
private
  static final class ModelDrawer extends TextureDraw.GenericDrawer {
...
private
  ...
  private
    static final ObjectPool<UI3DScene.ModelRenderData> s_pool =
...
private
  static final class OriginAttachment extends UI3DScene.SceneObject {
    ...
    UI3DScene.SceneObjectRenderData renderMain() { return null; }
...
private
  static final class OriginBone extends UI3DScene.SceneObject {
    UI3DScene.SceneCharacter m_character;
...
private
  static final class OriginGizmo extends UI3DScene.SceneObject {
...
private
  final class OverlaysDrawer extends TextureDraw.GenericDrawer {
    void init() {
      UI3DScene.StateData stateData = UI3DScene.this.stateDataMain();
...
public
  ...
  public static final class PlaneObjectPool extends
...
private
  final class ScaleGizmo extends UI3DScene.Gizmo {
    const Matrix4f m_startXfrm = new Matrix4f();
    const Matrix4f m_startInvXfrm = new Matrix4f();
...
private
  static final class SceneCharacter extends UI3DScene.SceneObject {
    ...
    std::string pickBone(float float1, float float0) {
      if (this.m_animatedModel.getAnimationPlayer().modelTransforms ==
          nullptr) {
        return "";
      } else {
...
private
  static final class SceneModel extends UI3DScene.SceneObject {
...
private
  abstract class SceneModelCamera extends ModelCamera {
  ...
  private
    static final ObjectPool<UI3DScene.SceneObjectRenderData> s_pool =
...
private
  static final class SetModelCamera extends TextureDraw.GenericDrawer {
...
private
  static final class StateData {
    ...
    final ArrayList<UI3DScene.SceneObjectRenderData> m_objectData =
        std::make_unique<ArrayList<>>();
...
private
  static final class TranslateGizmoRenderData {
    bool m_hideX;
    bool m_hideY;
    bool m_hideZ;
  }
...
private
  static class VehicleRenderData extends UI3DScene.SceneObjectRenderData {
    final ArrayList<Model> m_models = std::make_unique<ArrayList<>>();
    final ArrayList<Matrix4f> m_transforms = std::make_unique<ArrayList<>>();
    final UI3DScene.VehicleDrawer m_drawer = new UI3DScene.VehicleDrawer();
  private
    static final ObjectPool<UI3DScene.VehicleRenderData> s_pool =
    ...
    void initWheelModel(UI3DScene.SceneVehicle sceneVehicle,
      ...
      if (wheel != nullptr && !part.models.isEmpty()) {
...
private
  final class VehicleSceneModelCamera extends UI3DScene.SceneModelCamera {
    void Begin() {
      UI3DScene.StateData stateData = UI3DScene.this.stateDataRender();
      GL11.glViewport(UI3DScene.this.getAbsoluteX().intValue(),
                      Core.getInstance().getScreenHeight() -
