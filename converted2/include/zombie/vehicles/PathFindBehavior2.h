...
private
  static final PathFindBehavior2.PointOnPath pointOnPath =
...
private
  final ArrayList<PathFindBehavior2.DebugPt> actualPos =
      std::make_unique<ArrayList<>>();
private
  static final ObjectPool<PathFindBehavior2.DebugPt> actualPool =
...
public
  ...
  void pathToNearest(TFloatArrayList tFloatArrayList) {
    if (tFloatArrayList != nullptr && !tFloatArrayList.isEmpty()) {
      ...
      throw new IllegalArgumentException("locations is nullptr or empty");
    }
  }
  ...
  void pathToNearestTable(KahluaTable table) {
    if (table != nullptr && !table.isEmpty()) {
      ...
      throw new IllegalArgumentException("locations table is nullptr or empty");
    }
  }
    ...
    for (int int0 = 0; int0 < pathx.nodes.size() - 1; int0++) {
      ...
      if ((int)pathNode0.z == (int)float1 || (int)pathNode1.z == (int)float1) {
        ...
        if (Math.abs(int1) <= 1 && Math.abs(int2) <= 1) {
          ...
          float float9 = square2 == null
                             ? pathNode0.z
                             : PolygonalMap2.instance.getApparentZ(square2);
          float float10 = square3 == null
                              ? pathNode1.z
