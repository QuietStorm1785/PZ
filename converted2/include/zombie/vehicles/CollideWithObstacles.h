...
private
  final ArrayList<CollideWithObstacles.CCObstacle> obstacles =
      std::make_unique<ArrayList<>>();
private
  final ArrayList<CollideWithObstacles.CCNode> nodes =
      std::make_unique<ArrayList<>>();
private
  final ArrayList<CollideWithObstacles.CCIntersection> intersections =
      std::make_unique<ArrayList<>>();
private
  final CollideWithObstacles.ImmutableRectF moveBounds =
      new CollideWithObstacles.ImmutableRectF();
private
  final CollideWithObstacles.ImmutableRectF vehicleBounds =
      new CollideWithObstacles.ImmutableRectF();
  const Vector2 move = new Vector2();
  const Vector2 closest = new Vector2();
  const Vector2 nodeNormal = new Vector2();
  const Vector2 edgeVec = new Vector2();
private
  final ArrayList<BaseVehicle> vehicles = std::make_unique<ArrayList<>>();
  CollideWithObstacles.CCObjectOutline[][] oo =
      new CollideWithObstacles.CCObjectOutline[5][5];
  ArrayList<CollideWithObstacles.CCNode> obstacleTraceNodes =
      std::make_unique<ArrayList<>>();
  CollideWithObstacles.CompareIntersection comparator =
      new CollideWithObstacles.CompareIntersection();
  ...
  void getObstaclesInRect(float float3, float float1, float float2,
                          float float0, int int4, int int6, int int0) {
    this.nodes.clear();
    this.obstacles.clear();
    this.moveBounds.init(float3 - 1.0F, float1 - 1.0F, float2 - float3 + 2.0F,
                         float0 - float1 + 2.0F);
    this.getVehiclesInRect(float3 - 1.0F - 4.0F, float1 - 1.0F - 4.0F,
                           float2 + 2.0F + 8.0F, float0 + 2.0F + 8.0F, int0);
    ...
    for (int int1 = 0; int1 < this.vehicles.size(); int1++) {
      ...
      if (this.moveBounds.intersects(this.vehicleBounds)) {
        ...
        CollideWithObstacles.CCNode cCNode0 =
            CollideWithObstacles.CCNode.alloc().init(vehiclePoly.x1,
                                                     vehiclePoly.y1, int2);
        CollideWithObstacles.CCNode cCNode1 =
            CollideWithObstacles.CCNode.alloc().init(vehiclePoly.x2,
                                                     vehiclePoly.y2, int2);
        CollideWithObstacles.CCNode cCNode2 =
            CollideWithObstacles.CCNode.alloc().init(vehiclePoly.x3,
                                                     vehiclePoly.y3, int2);
        CollideWithObstacles.CCNode cCNode3 =
            CollideWithObstacles.CCNode.alloc().init(vehiclePoly.x4,
                                                     vehiclePoly.y4, int2);
        CollideWithObstacles.CCObstacle cCObstacle0 =
            CollideWithObstacles.CCObstacle.alloc().init();
        CollideWithObstacles.CCEdge cCEdge0 =
            CollideWithObstacles.CCEdge.alloc().init(cCNode0, cCNode1,
                                                     cCObstacle0);
        CollideWithObstacles.CCEdge cCEdge1 =
            CollideWithObstacles.CCEdge.alloc().init(cCNode1, cCNode2,
                                                     cCObstacle0);
        CollideWithObstacles.CCEdge cCEdge2 =
            CollideWithObstacles.CCEdge.alloc().init(cCNode2, cCNode3,
                                                     cCObstacle0);
        CollideWithObstacles.CCEdge cCEdge3 =
            CollideWithObstacles.CCEdge.alloc().init(cCNode3, cCNode0,
                                                     cCObstacle0);
    ...
    if (!this.obstacles.isEmpty()) {
      ...
      for (int int9 = int5; int9 < int8; int9++) {
        for (int int10 = int3; int10 < int7; int10++) {
          CollideWithObstacles.CCObjectOutline
              .get(int10 - int3, int9 - int5, int0, this.oo)
              .init(int10 - int3, int9 - int5, int0);
        }
      }
      ...
      for (int int11 = int5; int11 < int8 - 1; int11++) {
        for (int int12 = int3; int12 < int7 - 1; int12++) {
          IsoGridSquare square =
              IsoWorld.instance.CurrentCell.getGridSquare(int12, int11, int0);
          if (square != nullptr) {
            if (square.isSolid() ||
              ...
              CollideWithObstacles.CCObjectOutline.setSolid(
                  int12 - int3, int11 - int5, int0, this.oo);
            }
            ...
            bool boolean1 = square.Is(IsoFlagType.collideN);
            if (square.Is(IsoFlagType.windowN) ||
                square.Is(IsoFlagType.WindowN)) {
              boolean1 = true;
            }
            ...
            if (boolean0 || square.hasBlockedDoor(false) ||
                square.Has(IsoObjectType.stairsBN)) {
              CollideWithObstacles.CCObjectOutline.setWest(
                  int12 - int3, int11 - int5, int0, this.oo);
            }

            if (boolean1 || square.hasBlockedDoor(true) ||
                square.Has(IsoObjectType.stairsBW)) {
              CollideWithObstacles.CCObjectOutline.setNorth(
                  int12 - int3, int11 - int5, int0, this.oo);
            }

            if (square.Has(IsoObjectType.stairsBN) && int12 != int7 - 2) {
              square = IsoWorld.instance.CurrentCell.getGridSquare(int12 + 1,
                                                                   int11, int0);
              if (square != nullptr) {
                CollideWithObstacles.CCObjectOutline.setWest(
                    int12 + 1 - int3, int11 - int5, int0, this.oo);
              }
              ...
              if (square != nullptr) {
                CollideWithObstacles.CCObjectOutline.setNorth(
                    int12 - int3, int11 + 1 - int5, int0, this.oo);
              }
            }
          }
        }
      ...
      for (int int13 = 0; int13 < int8 - int5; int13++) {
        for (int int14 = 0; int14 < int7 - int3; int14++) {
          CollideWithObstacles.CCObjectOutline cCObjectOutline =
              CollideWithObstacles.CCObjectOutline.get(int14, int13, int0,
                                                       this.oo);
          if (cCObjectOutline != nullptr && cCObjectOutline.nw &&
              cCObjectOutline.nw_w && cCObjectOutline.nw_n) {
            cCObjectOutline.trace(this.oo, this.obstacleTraceNodes);
            if (!cCObjectOutline.nodes.isEmpty()) {
              CollideWithObstacles.CCObstacle cCObstacle1 =
                  CollideWithObstacles.CCObstacle.alloc().init();
              CollideWithObstacles.CCNode cCNode4 =
                  cCObjectOutline.nodes.get(cCObjectOutline.nodes.size() - 1);

              for (int int15 = cCObjectOutline.nodes.size() - 1; int15 > 0;
                   int15--) {
                CollideWithObstacles.CCNode cCNode5 =
                    cCObjectOutline.nodes.get(int15);
                CollideWithObstacles.CCNode cCNode6 =
                    cCObjectOutline.nodes.get(int15 - 1);
                cCNode5.x += int3;
                cCNode5.y += int5;
                CollideWithObstacles.CCEdge cCEdge4 =
                    CollideWithObstacles.CCEdge.alloc().init(cCNode5, cCNode6,
                                                             cCObstacle1);
          ...
          for (int int2 = 0; int2 < cCObstacle0.edges.size(); int2++) {
            ...
            for (int int3 = 0; int3 < cCObstacle1.edges.size(); int3++) {
              ...
              CollideWithObstacles.CCIntersection cCIntersection0 =
                  this.getIntersection(cCEdge0, cCEdge1);
              if (cCIntersection0 != nullptr) {
                cCEdge0.intersections.add(cCIntersection0);
                cCEdge1.intersections.add(cCIntersection0);
                if (boolean0) {
                  LineDrawer.addLine(
                      cCIntersection0.nodeSplit.x - 0.1F,
                      cCIntersection0.nodeSplit.y - 0.1F, cCEdge0.node1.z,
                      cCIntersection0.nodeSplit.x + 0.1F,
                      cCIntersection0.nodeSplit.y + 0.1F, cCEdge0.node1.z, 1.0F,
                      0.0F, 0.0F, nullptr, false);
                }

                if (!cCEdge0.hasNode(cCIntersection0.nodeSplit) &&
                    !cCEdge1.hasNode(cCIntersection0.nodeSplit)) {
        ...
        if (!cCEdge2.intersections.isEmpty()) {
          ...
          for (int int6 = cCEdge2.intersections.size() - 1; int6 >= 0; int6--) {
            CollideWithObstacles.CCIntersection cCIntersection1 =
                cCEdge2.intersections.get(int6);
            CollideWithObstacles.CCEdge cCEdge3 =
                cCIntersection1.split(cCEdge2);
          }
        }
      }
    }
  ...
  bool collinear(float float4, float float2, float float6, float float1,
                 float float3, float float5) {
    float float0 = (float6 - float4) * (float5 - float2) -
                   (float3 - float4) * (float1 - float2);
    return float0 >= -0.05F && float0 < 0.05F;
  }

  bool within(float float1, float float0, float float2) {
    return float1 <= float0 && float0 <= float2 ||
           float2 <= float0 && float0 <= float1;
  }

  bool is_on(float float3, float float0, float float5, float float2,
             float float4, float float1) {
    return this.collinear(float3, float0, float5, float2, float4, float1) &&
           (float3 != float5 ? this.within(float3, float4, float5)
                             : this.within(float0, float1, float2));
  }

public
  CollideWithObstacles.CCIntersection
  getIntersection(CollideWithObstacles.CCEdge cCEdge0,
                  CollideWithObstacles.CCEdge cCEdge1) {
    ...
    if (double0 > -0.01 && double0 < 0.01) {
      ...
      if (double1 >= 0.0 && double1 <= 1.0 && double2 >= 0.0 &&
        ...
        CollideWithObstacles.CCNode cCNode0 = nullptr;
        CollideWithObstacles.CCNode cCNode1 = nullptr;
        if (double1 < 0.01F) {
        ...
        if (cCNode0 != nullptr && cCNode1 != nullptr) {
          CollideWithObstacles.CCIntersection cCIntersection =
              CollideWithObstacles.CCIntersection.alloc().init(
                  cCEdge0, cCEdge1, (float)double1, (float)double2, cCNode0);
          cCEdge0.intersections.add(cCIntersection);
          this.intersections.add(cCIntersection);
          cCIntersection = CollideWithObstacles.CCIntersection.alloc().init(
              cCEdge0, cCEdge1, (float)double1, (float)double2, cCNode1);
          cCEdge1.intersections.add(cCIntersection);
          this.intersections.add(cCIntersection);
          LineDrawer.addLine(cCIntersection.nodeSplit.x - 0.1F,
                             cCIntersection.nodeSplit.y - 0.1F, cCEdge0.node1.z,
                             cCIntersection.nodeSplit.x + 0.1F,
                             cCIntersection.nodeSplit.y + 0.1F, cCEdge0.node1.z,
                             1.0F, 0.0F, 0.0F, nullptr, false);
          return null;
        } else {
          return cCNode0 == nullptr && cCNode1 == nullptr
                     ? CollideWithObstacles.CCIntersection.alloc().init(
                           cCEdge0, cCEdge1, (float)double1, (float)double2,
                           float8, float9)
                     : CollideWithObstacles.CCIntersection.alloc().init(
                           cCEdge0, cCEdge1, (float)double1, (float)double2,
                           cCNode0 == nullptr ? cCNode1 : cCNode0);
        }
      } else {
        return null;
      }
    ...
    for (int int0 = 0; int0 < this.nodes.size(); int0++) {
      ...
      for (int int1 = 0; int1 < this.obstacles.size(); int1++) {
        ...
        for (int int2 = 0; int2 < this.intersections.size(); int2++) {
          CollideWithObstacles.CCIntersection cCIntersection =
              this.intersections.get(int2);
          if (cCIntersection.nodeSplit == cCNode) {
            if (cCIntersection.edge1.obstacle == cCObstacle ||
                cCIntersection.edge2.obstacle == cCObstacle) {
              boolean0 = true;
            }
            break;
          }
  ...
  bool isVisible(CollideWithObstacles.CCNode cCNode0,
                 CollideWithObstacles.CCNode cCNode1) {
    return cCNode0.sharesEdge(cCNode1)
               ? !cCNode0.onSameShapeButDoesNotShareAnEdge(cCNode1)
               : !cCNode0.sharesShape(cCNode1);
  }
  ...
  void calculateNodeVisibility() {
    for (int int0 = 0; int0 < this.obstacles.size(); int0++) {
      ...
      for (int int1 = 0; int1 < cCObstacle.edges.size(); int1++) {
        ...
        if (!cCEdge.node1.ignore && !cCEdge.node2.ignore &&
            this.isVisible(cCEdge.node1, cCEdge.node2)) {
  ...
  Vector2f resolveCollision(IsoGameCharacter character, float float0,
    ...
    if (character.getCurrentSquare() != nullptr &&
        character.getCurrentSquare().HasStairs()) {
      return vector2f;
    } else {
      bool boolean0 =
          Core.bDebug &&
      ...
      if (float2 == float0 && float3 == float1) {
        ...
        this.getObstaclesInRect(
            ...
            Math.max(float2, float0), Math.max(float3, float1),
            (int)character.x, (int)character.y, (int)character.z);
        ...
        if (boolean0) {
          for (CollideWithObstacles.CCNode cCNode0 : this.nodes) {
            for (CollideWithObstacles.CCNode cCNode1 : cCNode0.visible) {
              LineDrawer.addLine(cCNode0.x, cCNode0.y, cCNode0.z, cCNode1.x,
                                 cCNode1.y, cCNode1.z, 0.0F, 1.0F, 0.0F,
                                 nullptr, true);
            }

            if (DebugOptions.instance.CollideWithObstaclesRenderNormals
                    .getValue() &&
                cCNode0.getNormalAndEdgeVectors(this.nodeNormal,
                                                this.edgeVec)) {
              LineDrawer.addLine(cCNode0.x, cCNode0.y, cCNode0.z,
                                 cCNode0.x + this.nodeNormal.x,
                                 cCNode0.y + this.nodeNormal.y, cCNode0.z, 0.0F,
                                 0.0F, 1.0F, nullptr, true);
            }

            if (cCNode0.ignore) {
              LineDrawer.addLine(cCNode0.x - 0.05F, cCNode0.y - 0.05F,
                                 cCNode0.z, cCNode0.x + 0.05F,
                                 cCNode0.y + 0.05F, cCNode0.z, 1.0F, 1.0F, 0.0F,
                                 nullptr, false);
            }
          }
        }

        CollideWithObstacles.CCEdge cCEdge0 = nullptr;
        CollideWithObstacles.CCNode cCNode2 = nullptr;
        double double0 = Double.MAX_VALUE;

        for (int int4 = 0; int4 < this.obstacles.size(); int4++) {
          CollideWithObstacles.CCObstacle cCObstacle1 =
              this.obstacles.get(int4);
          uint8_t byte0 = 0;
          if (cCObstacle1.isPointInside(character.x, character.y, byte0)) {
            for (int int5 = 0; int5 < cCObstacle1.edges.size(); int5++) {
              ...
              if (cCEdge1.node1.visible.contains(cCEdge1.node2)) {
                CollideWithObstacles.CCNode cCNode3 = cCEdge1.closestPoint(
                    character.x, character.y, this.closest);
                double double1 = (character.x - this.closest.x) *
                                     (character.x - this.closest.x) +
                                 (character.y - this.closest.y) *
                                     (character.y - this.closest.y);
                if (double1 < double0) {
                  double0 = double1;
                  cCEdge0 = cCEdge1;
        ...
        if (cCNode2 != nullptr &&
            ...
            this.nodeNormal.dot(this.move) + 0.05F >=
                this.nodeNormal.dot(this.edgeVec)) {
          cCNode2 = nullptr;
          cCEdge0 = nullptr;
        }
        ...
        if (cCEdge0 == nullptr) {
          ...
          for (int int6 = 0; int6 < this.obstacles.size(); int6++) {
            CollideWithObstacles.CCObstacle cCObstacle2 =
                this.obstacles.get(int6);
            ...
            for (int int7 = 0; int7 < cCObstacle2.edges.size(); int7++) {
              ...
              if (cCEdge2.node1.visible.contains(cCEdge2.node2)) {
                ...
                if (boolean0 &&
                    DebugOptions.instance.CollideWithObstaclesRenderNormals
                        .getValue()) {
                  LineDrawer.addLine(
                      float11, float12, cCEdge2.node1.z,
                      float11 + cCEdge2.normal.x, float12 + cCEdge2.normal.y,
                      cCEdge2.node1.z, 0.0F, 0.0F, 1.0F, nullptr, true);
                }

                double double3 = (float10 - float8) * (float4 - float2) -
                                 (float9 - float7) * (float5 - float3);
                if (double3 != 0.0) {
                  double double4 = ((float9 - float7) * (float3 - float8) -
                                    (float10 - float8) * (float2 - float7)) /
                                   double3;
                  double double5 = ((float4 - float2) * (float3 - float8) -
                                    (float5 - float3) * (float2 - float7)) /
                                   double3;
                  float float13 = cCEdge2.normal.dot(this.move);
                  if (!(float13 >= 0.0F) && double4 >= 0.0 && double4 <= 1.0 &&
                      double5 >= 0.0 && double5 <= 1.0) {
                    if (double5 < 0.01 || double5 > 0.99) {
                      CollideWithObstacles.CCNode cCNode4 =
                          double5 < 0.01 ? cCEdge2.node1 : cCEdge2.node2;
                      if (cCNode4.getNormalAndEdgeVectors(this.nodeNormal,
                                                          this.edgeVec)) {
                        if (!(this.nodeNormal.dot(this.move) + 0.05F >=
                              this.nodeNormal.dot(this.edgeVec))) {
                          cCEdge0 = cCEdge2;
                          cCNode2 = cCNode4;
                          break;
                    ...
                    float float14 =
                        (float)(float2 + double4 * (float4 - float2));
                    float float15 =
                        (float)(float3 + double4 * (float5 - float3));
                    double double6 = IsoUtils.DistanceToSquared(
                        float2, float3, float14, float15);
                    if (double6 < double2) {
                      double2 = double6;
                      cCEdge0 = cCEdge2;
                    }
        ...
        if (cCNode2 != nullptr) {
          ...
          CollideWithObstacles.CCEdge cCEdge4 = nullptr;
          ...
          for (int int8 = 0; int8 < cCNode2.edges.size(); int8++) {
            ...
            if (cCEdge5.node1.visible.contains(cCEdge5.node2) &&
                ...
                (!cCEdge3.hasNode(cCEdge5.node1) ||
                 !cCEdge3.hasNode(cCEdge5.node2))) {
              cCEdge4 = cCEdge5;
            }
          }

          if (cCEdge3 != nullptr && cCEdge4 != nullptr) {
            if (cCEdge0 == cCEdge3) {
              CollideWithObstacles.CCNode cCNode5 =
                  cCNode2 == cCEdge4.node1 ? cCEdge4.node2 : cCEdge4.node1;
              ...
              CollideWithObstacles.CCNode cCNode6 =
                  cCNode2 == cCEdge3.node1 ? cCEdge3.node2 : cCEdge3.node1;
        ...
        if (cCEdge0 != nullptr) {
          ...
          if (boolean0) {
            LineDrawer.addLine(float16, float17, cCEdge0.node1.z, float18,
                               float19, cCEdge0.node1.z, 0.0F, 1.0F, 1.0F,
                               nullptr, true);
          }
...
private
  static final class CCEdge {
    ...
    static ArrayDeque<CollideWithObstacles.CCEdge> pool =
        std::make_unique<ArrayDeque<>>();

    CollideWithObstacles.CCEdge
    init(CollideWithObstacles.CCNode cCNode1,
         CollideWithObstacles.CCNode cCNode0,
    ...
    CollideWithObstacles.CCNode closestPoint(float float5, float float4,
                                             Vector2 vector) {
  ...
  private static final class CCIntersection {
    ...
    static ArrayDeque<CollideWithObstacles.CCIntersection> pool =
        std::make_unique<ArrayDeque<>>();

    CollideWithObstacles.CCIntersection
    init(CollideWithObstacles.CCEdge cCEdge0,
         CollideWithObstacles.CCEdge cCEdge1, float float0, float float1,
         float float2, float float3) {
      this.edge1 = cCEdge0;
      this.edge2 = cCEdge1;
      this.dist1 = float0;
      this.dist2 = float1;
      this.nodeSplit = CollideWithObstacles.CCNode.alloc().init(
          float2, float3, cCEdge0.node1.z);
      return this;
    }
    ...
    CollideWithObstacles.CCEdge split(CollideWithObstacles.CCEdge cCEdge) {
      if (cCEdge.hasNode(this.nodeSplit)) {
        return null;
      } else if (cCEdge.node1.x == this.nodeSplit.x &&
                 cCEdge.node1.y == this.nodeSplit.y) {
        return null;
      } else {
        return cCEdge.node2.x == this.nodeSplit.x &&
                       cCEdge.node2.y == this.nodeSplit.y
                   ? nullptr
                   : cCEdge.split(this.nodeSplit);
      }
    }

    static CollideWithObstacles.CCIntersection alloc() {
      return pool.isEmpty() ? new CollideWithObstacles.CCIntersection()
                            : pool.pop();
    }
  ...
  private static final class CCNode {
    ...
    int z;
    bool ignore;
    final ArrayList<CollideWithObstacles.CCEdge> edges =
        std::make_unique<ArrayList<>>();
    final ArrayList<CollideWithObstacles.CCNode> visible =
        std::make_unique<ArrayList<>>();
    static ArrayList<CollideWithObstacles.CCObstacle> tempObstacles =
        std::make_unique<ArrayList<>>();
    static ArrayDeque<CollideWithObstacles.CCNode> pool =
        std::make_unique<ArrayDeque<>>();
    ...
    bool sharesEdge(CollideWithObstacles.CCNode cCNode1) {
    ...
    bool sharesShape(CollideWithObstacles.CCNode cCNode1) {
      for (int int0 = 0; int0 < this.edges.size(); int0++) {
        ...
        for (int int1 = 0; int1 < cCNode1.edges.size(); int1++) {
          ...
          if (cCEdge0.obstacle != nullptr &&
              cCEdge0.obstacle == cCEdge1.obstacle) {
            return true;
          }
        }
      }
    ...
    bool onSameShapeButDoesNotShareAnEdge(CollideWithObstacles.CCNode cCNode1) {
      tempObstacles.clear();
      ...
      for (int int0 = 0; int0 < tempObstacles.size(); int0++) {
        ...
        if (cCObstacle.hasNode(cCNode1) &&
            !cCObstacle.hasAdjacentNodes(this, cCNode1)) {
          return true;
        }
      }
    ...
    bool getNormalAndEdgeVectors(Vector2 vector0, Vector2 vector1) {
      CollideWithObstacles.CCEdge cCEdge0 = nullptr;
      CollideWithObstacles.CCEdge cCEdge1 = nullptr;
  ...
  private static final class CCObjectOutline {
    ...
    static ArrayDeque<CollideWithObstacles.CCObjectOutline> pool =
        std::make_unique<ArrayDeque<>>();
    ...
    static void
    setSolid(int int0, int int1, int int2,
    ...
    static void
    setWest(int int0, int int1, int int2,
            CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines) {
      CollideWithObstacles.CCObjectOutline cCObjectOutline =
          get(int0, int1, int2, cCObjectOutlines);
    ...
    static void
    setNorth(int int0, int int1, int int2,
             CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines) {
      CollideWithObstacles.CCObjectOutline cCObjectOutline =
          get(int0, int1, int2, cCObjectOutlines);
      if (cCObjectOutline != nullptr) {
    ...
    void trace_NW_N(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                    CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x + 0.3F, this.y - 0.3F);
      } else {
        CollideWithObstacles.CCNode cCNode1 =
            CollideWithObstacles.CCNode.alloc().init(this.x + 0.3F,
                                                     this.y - 0.3F, this.z);
        this.nodes.add(cCNode1);
      }
      ...
      this.nw_n = false;
      if (this.nw_e) {
        this.trace_NW_E(cCObjectOutlines, nullptr);
      } else if (this.n_n) {
        this.trace_N_N(cCObjectOutlines, this.nodes.get(this.nodes.size() - 1));
      }
    }

    void trace_NW_S(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                    CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x - 0.3F, this.y + 0.3F);
      } else {
      ...
      if (this.nw_w) {
        ...
        CollideWithObstacles.CCObjectOutline cCObjectOutline1 =
            get(this.x - 1, this.y, this.z, cCObjectOutlines);
        ...
        if (cCObjectOutline1.n_s) {
          ...
          cCObjectOutline1.trace_N_S(cCObjectOutlines,
                                     this.nodes.get(this.nodes.size() - 1));
        }
      }
    }

    void trace_NW_W(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                    CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x - 0.3F, this.y - 0.3F);
      } else {
      ...
      if (this.nw_n) {
        ...
        CollideWithObstacles.CCObjectOutline cCObjectOutline1 =
            get(this.x, this.y - 1, this.z, cCObjectOutlines);
        if (cCObjectOutline1 == nullptr) {
          return;
        }
        ...
        if (cCObjectOutline1.w_w) {
          cCObjectOutline1.nodes = this.nodes;
          cCObjectOutline1.trace_W_W(cCObjectOutlines,
                                     this.nodes.get(this.nodes.size() - 1));
        }
      }
    }

    void trace_NW_E(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                    CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x + 0.3F, this.y + 0.3F);
      } else {
      ...
      this.nw_e = false;
      if (this.nw_s) {
        this.trace_NW_S(cCObjectOutlines, nullptr);
      } else if (this.w_e) {
        this.trace_W_E(cCObjectOutlines, this.nodes.get(this.nodes.size() - 1));
      }
    }

    void trace_W_E(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                   CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
      ...
      if (this.w_cutoff) {
        ...
        cCNode2 = CollideWithObstacles.CCNode.alloc().init(
        ...
        if (cCObjectOutline1 != nullptr) {
          if (cCObjectOutline1.nw && cCObjectOutline1.nw_e) {
            cCObjectOutline1.nodes = this.nodes;
            cCObjectOutline1.trace_NW_E(cCObjectOutlines,
                                        this.nodes.get(this.nodes.size() - 1));
          } else if (cCObjectOutline1.n_n) {
            cCObjectOutline1.nodes = this.nodes;
            cCObjectOutline1.trace_N_N(cCObjectOutlines, nullptr);
          }
        }
      }
    }

    void trace_W_W(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                   CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x - 0.3F, this.y + 0.3F);
      } else {
      ...
      this.w_w = false;
      if (this.nw_w) {
        this.trace_NW_W(cCObjectOutlines,
                        this.nodes.get(this.nodes.size() - 1));
      } else {
        CollideWithObstacles.CCObjectOutline cCObjectOutline1 =
            get(this.x - 1, this.y, this.z, cCObjectOutlines);
        ...
        if (cCObjectOutline1.n_s) {
          cCObjectOutline1.nodes = this.nodes;
          cCObjectOutline1.trace_N_S(cCObjectOutlines, nullptr);
        }
      }
    }

    void trace_N_N(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                   CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x + 1 - 0.3F, this.y - 0.3F);
      } else {
        CollideWithObstacles.CCNode cCNode1 =
            CollideWithObstacles.CCNode.alloc().init(this.x + 1 - 0.3F,
                                                     this.y - 0.3F, this.z);
        this.nodes.add(cCNode1);
      }
      ...
      if (this.n_cutoff) {
        ...
        if (cCObjectOutline1 != nullptr) {
          if (cCObjectOutline1.nw_n) {
            cCObjectOutline1.nodes = this.nodes;
            cCObjectOutline1.trace_NW_N(cCObjectOutlines,
                                        this.nodes.get(this.nodes.size() - 1));
          } else {
            cCObjectOutline1 =
                get(this.x + 1, this.y - 1, this.z, cCObjectOutlines);
            if (cCObjectOutline1 == nullptr) {
              return;
            }
            ...
            if (cCObjectOutline1.w_w) {
              cCObjectOutline1.nodes = this.nodes;
              cCObjectOutline1.trace_W_W(cCObjectOutlines, nullptr);
            }
          }
        }
      }
    ...
    void trace_N_S(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
                   CollideWithObstacles.CCNode cCNode0) {
      if (cCNode0 != nullptr) {
        cCNode0.setXY(this.x + 0.3F, this.y + 0.3F);
      } else {
      ...
      this.n_s = false;
      if (this.nw_s) {
        this.trace_NW_S(cCObjectOutlines,
                        this.nodes.get(this.nodes.size() - 1));
      } else if (this.w_e) {
        this.trace_W_E(cCObjectOutlines, nullptr);
      }
    }

    void trace(CollideWithObstacles.CCObjectOutline[][] cCObjectOutlines,
               ArrayList<CollideWithObstacles.CCNode> arrayList) {
      arrayList.clear();
      this.nodes = arrayList;
      CollideWithObstacles.CCNode cCNode =
          CollideWithObstacles.CCNode.alloc().init(this.x - 0.3F, this.y - 0.3F,
                                                   this.z);
      arrayList.add(cCNode);
      this.trace_NW_N(cCObjectOutlines, nullptr);
      if (arrayList.size() != 2 &&
          cCNode.x ==
              ((CollideWithObstacles.CCNode)arrayList.get(arrayList.size() - 1))
                  .x &&
          cCNode.y ==
              ((CollideWithObstacles.CCNode)arrayList.get(arrayList.size() - 1))
                  .y) {
    ...
    static CollideWithObstacles.CCObjectOutline alloc() {
      return pool.isEmpty() ? new CollideWithObstacles.CCObjectOutline()
                            : pool.pop();
    }
  ...
  private static final class CCObstacle {
    ...
    static ArrayDeque<CollideWithObstacles.CCObstacle> pool =
        std::make_unique<ArrayDeque<>>();
    ...
    bool hasAdjacentNodes(CollideWithObstacles.CCNode cCNode1,
                          CollideWithObstacles.CCNode cCNode0) {
      for (int int0 = 0; int0 < this.edges.size(); int0++) {
        CollideWithObstacles.CCEdge cCEdge = this.edges.get(int0);
    ...
    bool isPointInPolygon_CrossingNumber(float float2, float float0) {
      ...
      for (int int1 = 0; int1 < this.edges.size(); int1++) {
        ...
        if (cCEdge.node1.y <= float0 && cCEdge.node2.y > float0 ||
            cCEdge.node1.y > float0 && cCEdge.node2.y <= float0) {
          float float1 =
              (float0 - cCEdge.node1.y) / (cCEdge.node2.y - cCEdge.node1.y);
          if (float2 <
              cCEdge.node1.x + float1 * (cCEdge.node2.x - cCEdge.node1.x)) {
            int0++;
          }
        }
      }
    ...
    CollideWithObstacles.EdgeRingHit
    isPointInPolygon_WindingNumber(float float0, float float1, int int2) {
      ...
      return int0 = = 0 ? CollideWithObstacles.EdgeRingHit.Outside
                        : CollideWithObstacles.EdgeRingHit.Inside;
    }

    bool isPointInside(float float0, float float1, int int0) {
      return this.isPointInPolygon_WindingNumber(float0, float1, int0) ==
             CollideWithObstacles.EdgeRingHit.Inside;
    }

    bool isNodeInsideOf(CollideWithObstacles.CCNode cCNode) {
    ...
    CollideWithObstacles.CCNode
    getClosestPointOnEdge(float float2, float float3, Vector2 vector) {
      double double0 = Double.MAX_VALUE;
      CollideWithObstacles.CCNode cCNode0 = nullptr;
      ...
      for (int int0 = 0; int0 < this.edges.size(); int0++) {
        ...
        if (cCEdge.node1.visible.contains(cCEdge.node2)) {
          CollideWithObstacles.CCNode cCNode1 =
              cCEdge.closestPoint(float2, float3, vector);
          double double1 = (float2 - vector.x) * (float2 - vector.x) +
                           (float3 - vector.y) * (float3 - vector.y);
          if (double1 < double0) {
            float0 = vector.x;
            float1 = vector.y;
            cCNode0 = cCNode1;
    ...
    void calcBounds() {
      ...
      float float4 = 0.01F;
      this.bounds = CollideWithObstacles.ImmutableRectF.alloc().init(
    ...
    static CollideWithObstacles.CCObstacle alloc() {
      return pool.isEmpty() ? new CollideWithObstacles.CCObstacle()
                            : pool.pop();
    }
  ...
  static final class CompareIntersection implements
      Comparator<CollideWithObstacles.CCIntersection> {
    CollideWithObstacles.CCEdge edge;

    int compare(CollideWithObstacles.CCIntersection cCIntersection0,
                CollideWithObstacles.CCIntersection cCIntersection1) {
      float float0 = this.edge == cCIntersection0.edge1 ? cCIntersection0.dist1
                                                        : cCIntersection0.dist2;
      float float1 = this.edge == cCIntersection1.edge1 ? cCIntersection1.dist1
                                                        : cCIntersection1.dist2;
      if (float0 < float1) {
        return -1;
      } else {
  ...
  private static final class ImmutableRectF {
    ...
    float w;
    float h;
    static ArrayDeque<CollideWithObstacles.ImmutableRectF> pool =
        std::make_unique<ArrayDeque<>>();

    CollideWithObstacles.ImmutableRectF init(float float0, float float1,
                                             float float2, float float3) {
      this.x = float0;
      this.y = float1;
      this.w = float2;
    ...
    bool intersects(CollideWithObstacles.ImmutableRectF immutableRectF0) {
    ...
    static CollideWithObstacles.ImmutableRectF alloc() {
      return pool.isEmpty() ? new CollideWithObstacles.ImmutableRectF()
                            : pool.pop();
    }
