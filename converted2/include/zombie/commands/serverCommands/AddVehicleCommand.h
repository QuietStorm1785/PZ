...
class AddVehicleCommand : public CommandBase {
    ...
    public
      AddVehicleCommand(const std::string &string0, const std::string &string1,
      ...
      std::string Command() {
        ...
        VehicleScript vehicleScript =
            ScriptManager.instance.getVehicle(string0);
        if (vehicleScript == nullptr) {
          return "Unknown vehicle script \"" + string0 + "\"";
        } else {
          string0 = vehicleScript.getModule().getName() + "." +
                    vehicleScript.getName();
          int int0;
          int int1;
          int int2;
          if (this.argsName == "Script And Player")) {
              ...
              IsoPlayer player0 =
                  GameServer.getPlayerByUserNameForCommand(string1);
              if (player0 == nullptr) {
          ...
          if (int2 > 0) {
            ...
            if (square == nullptr) {
              ...
              if (IsoChunk.doSpawnedVehiclesInInvalidPosition(vehicle)) {
                ...
                return "ERROR: I can not spawn the vehicle. Invalid position. "
