...
public:
public
  final ErosionConfig.Seeds seeds = new ErosionConfig.Seeds();
public
  final ErosionConfig.Time time = new ErosionConfig.Time();
public
  final ErosionConfig.Debug debug = new ErosionConfig.Debug();
public
  final ErosionConfig.Season season = new ErosionConfig.Season();
