...
private
  final ArrayList<String> loadList = std::make_unique<ArrayList<>>();
private
  final Map<String, String> modIdToDir = std::make_unique<HashMap<>>();
private
  final Map<String, ChooseGameInfo.Mod> modDirToMod =
...
public
  final HashMap<String, String> ActiveFileMap = std::make_unique<HashMap<>>();
private
  final HashSet<String> AllAbsolutePaths = std::make_unique<HashSet<>>();
  File base;
  URI baseURI;
  File workdir;
  URI workdirURI;
  ...
  File cacheDir;
private
  final ConcurrentHashMap<String, String> RelativeMap =
      std::make_unique<ConcurrentHashMap<>>();
public
  final ThreadLocal<Boolean> IgnoreActiveFileMap =
      ThreadLocal.withInitial(()->Boolean.FALSE);
private
  final ConcurrentHashMap<String, URI> CanonicalURIMap =
      std::make_unique<ConcurrentHashMap<>>();
private
  final ArrayList<String> mods = std::make_unique<ArrayList<>>();
private
  final HashSet<String> LoadedPacks = std::make_unique<HashSet<>>();
...
private
  final HashSet<String> m_watchedModFolders = std::make_unique<HashSet<>>();
...
public
  synchronized String getString(String string0) {
...
public
  synchronized boolean isKnownFile(String string0) {
