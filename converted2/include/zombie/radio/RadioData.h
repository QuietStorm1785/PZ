...
private
  final ArrayList<RadioChannel> radioChannels = std::make_unique<ArrayList<>>();
private
  final ArrayList<RadioTranslationData> translationDataList =
      std::make_unique<ArrayList<>>();
  RadioTranslationData currentTranslation;
  Node rootNode;
private
  final Map<String, RadioScript> advertQue = std::make_unique<HashMap<>>();
