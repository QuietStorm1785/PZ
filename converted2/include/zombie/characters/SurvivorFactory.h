...
public:
public
  static final ArrayList<String> FemaleForenames =
      std::make_unique<ArrayList<>>();
public
  static final ArrayList<String> MaleForenames =
      std::make_unique<ArrayList<>>();
public
  static final ArrayList<String> Surnames = std::make_unique<ArrayList<>>();
