...
public
  static final ArrayList<Color> TrouserCommonColors =
      std::make_unique<ArrayList<>>();
public
  static final ArrayList<ImmutableColor> HairCommonColors =
      std::make_unique<ArrayList<>>();
private
  final HashMap<PerkFactory.Perk, Integer> xpBoostMap =
      std::make_unique<HashMap<>>();
  KahluaTable metaTable;
  std::string Profession = "";
  std::string forename = "None";
  int ID = 0;
  IsoGameCharacter Instance = null;
  bool bFemale = true;
  std::string surname = "None";
  std::string InventoryScript = null;
  std::string torso = "Base_Torso";
protected
  final HashMap<Integer, Integer> MetCount = std::make_unique<HashMap<>>();
  float bravery = 1.0F;
  float loner = 0.0F;
  ...
  float loyalty = 0.0F;
public
  final ArrayList<String> extra = std::make_unique<ArrayList<>>();
private
  final ArrayList<ObservationFactory.Observation> Observations =
      new ArrayList<>(0);
private
  SurvivorFactory.SurvivorType type = SurvivorFactory.SurvivorType.Neutral;
  bool bDead;
  ...
  SurvivorGroup getGroup() { return this.group; }

  bool isLeader() { return this.group.getLeader() == this; }
...
public
  HashMap<PerkFactory.Perk, Integer> getXPBoostMap() { return this.xpBoostMap; }

  KahluaTable getMeta() {
    if (this.metaTable == nullptr) {
      this.metaTable = (KahluaTable)LuaManager.caller.pcall(
          LuaManager.thread, LuaManager.env.rawget("createMetaSurvivor"),
          this)[1];
    }
  ...
  int getCalculatedToughness() {
    ...
    double double0 = (Double)LuaManager.caller.pcall(
        LuaManager.thread, table.rawget("getCalculatedToughness"),
        this.metaTable)[1];
...
private
  ...
  int getMetCount(SurvivorDesc descriptor) {
    return this.MetCount.containsKey(descriptor.ID)
               ? this.MetCount.get(descriptor.ID)
               : 0;
  }
   ...
   * @return the Instance
   */
  IsoGameCharacter getInstance() { return this.Instance; }

  /**
   *
   * @param _Instance the Instance to set
   */
  void setInstance(IsoGameCharacter _Instance) { this.Instance = _Instance; }
   ...
   */
  std::string getInventoryScript() { return this.InventoryScript; }
   ...
   * @return the torso
   */
  std::string getTorso() { return this.torso; }
...
public
   ...
   * @return the bravery
   */
  float getBravery() { return this.bravery; }

  /**
   *
   * @param _bravery the bravery to set
   */
  void setBravery(float _bravery) { this.bravery = _bravery; }

  /**
   * @return the loner
   */
  float getLoner() { return this.loner; }

  /**
   *
   * @param _loner the loner to set
   */
  void setLoner(float _loner) { this.loner = _loner; }

  /**
   * @return the aggressiveness
   */
  float getAggressiveness() { return this.aggressiveness; }
   ...
   */
  float getCompassion() { return this.compassion; }

  /**
   *
   * @param _compassion the compassion to set
   */
  void setCompassion(float _compassion) { this.compassion = _compassion; }

  /**
   * @return the temper
   */
  float getTemper() { return this.temper; }

  /**
   *
   * @param _temper the temper to set
   */
  void setTemper(float _temper) { this.temper = _temper; }

  /**
   * @return the friendliness
   */
  float getFriendliness() { return this.friendliness; }
   ...
   */
  float getFavourindoors() { return this.favourindoors; }
   ...
   * @return the loyalty
   */
  float getLoyalty() { return this.loyalty; }

  /**
   *
   * @param _loyalty the loyalty to set
   */
  void setLoyalty(float _loyalty) { this.loyalty = _loyalty; }

  /**
   * @return the Profession
   */
  std::string getProfession() { return this.Profession; }
...
public
  ArrayList<ObservationFactory.Observation> getObservations() {
...
public
  SurvivorFactory.SurvivorType getType() { return this.type; }

  void setType(SurvivorFactory.SurvivorType _type) { this.type = _type; }

  void setFemale(bool _bFemale) { this.bFemale = _bFemale; }

public
  ArrayList<String> getExtras() { return this.extra; }

public
  ArrayList<ImmutableColor> getCommonHairColor() { return HairCommonColors; }
  ...
  static Color getRandomSkinColor() {
    return OutfitRNG.Next(3) == 0 ? new Color(OutfitRNG.Next(0.5F, 0.6F),
                                              OutfitRNG.Next(0.3F, 0.4F),
                                              OutfitRNG.Next(0.15F, 0.23F))
                                  : new Color(OutfitRNG.Next(0.9F, 1.0F),
                                              OutfitRNG.Next(0.75F, 0.88F),
                                              OutfitRNG.Next(0.45F, 0.58F));
  }
}
} // namespace characters
} // namespace zombie
