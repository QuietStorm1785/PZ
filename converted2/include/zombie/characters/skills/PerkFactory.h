...
public:
public
  static final ArrayList<PerkFactory.Perk> PerkList =
      std::make_unique<ArrayList<>>();
private
  static final HashMap<String, PerkFactory.Perk> PerkById =
      std::make_unique<HashMap<>>();
private
  static final HashMap<String, PerkFactory.Perk> PerkByName =
      std::make_unique<HashMap<>>();
private
  static final PerkFactory.Perk[] PerkByIndex = new PerkFactory.Perk[256];
...
public
  ...
  public
    static final PerkFactory.Perk None = new PerkFactory.Perk("None");
  public
    static final PerkFactory.Perk Agility = new PerkFactory.Perk("Agility");
  public
    static final PerkFactory.Perk Cooking = new PerkFactory.Perk("Cooking");
  public
    static final PerkFactory.Perk Melee = new PerkFactory.Perk("Melee");
  public
    static final PerkFactory.Perk Crafting = new PerkFactory.Perk("Crafting");
  public
    static final PerkFactory.Perk Fitness = new PerkFactory.Perk("Fitness");
  public
    static final PerkFactory.Perk Strength = new PerkFactory.Perk("Strength");
  public
    static final PerkFactory.Perk Blunt = new PerkFactory.Perk("Blunt");
  public
    static final PerkFactory.Perk Axe = new PerkFactory.Perk("Axe");
  public
    static final PerkFactory.Perk Sprinting = new PerkFactory.Perk("Sprinting");
  public
    static final PerkFactory.Perk Lightfoot = new PerkFactory.Perk("Lightfoot");
  public
    static final PerkFactory.Perk Nimble = new PerkFactory.Perk("Nimble");
  public
    static final PerkFactory.Perk Sneak = new PerkFactory.Perk("Sneak");
  public
    static final PerkFactory.Perk Woodwork = new PerkFactory.Perk("Woodwork");
  public
    static final PerkFactory.Perk Aiming = new PerkFactory.Perk("Aiming");
  public
    static final PerkFactory.Perk Reloading = new PerkFactory.Perk("Reloading");
  public
    static final PerkFactory.Perk Farming = new PerkFactory.Perk("Farming");
  public
    static final PerkFactory.Perk Survivalist =
        new PerkFactory.Perk("Survivalist");
  public
    static final PerkFactory.Perk Fishing = new PerkFactory.Perk("Fishing");
  public
    static final PerkFactory.Perk Trapping = new PerkFactory.Perk("Trapping");
  public
    static final PerkFactory.Perk Passiv = new PerkFactory.Perk("Passiv");
  public
    static final PerkFactory.Perk Firearm = new PerkFactory.Perk("Firearm");
  public
    static final PerkFactory.Perk PlantScavenging =
        new PerkFactory.Perk("PlantScavenging");
  public
    static final PerkFactory.Perk Doctor = new PerkFactory.Perk("Doctor");
  public
    static final PerkFactory.Perk Electricity =
        new PerkFactory.Perk("Electricity");
  public
    static final PerkFactory.Perk Blacksmith =
        new PerkFactory.Perk("Blacksmith");
  public
    static final PerkFactory.Perk MetalWelding =
        new PerkFactory.Perk("MetalWelding");
  public
    static final PerkFactory.Perk Melting = new PerkFactory.Perk("Melting");
  public
    static final PerkFactory.Perk Mechanics = new PerkFactory.Perk("Mechanics");
  public
    static final PerkFactory.Perk Spear = new PerkFactory.Perk("Spear");
  public
    static final PerkFactory.Perk Maintenance =
        new PerkFactory.Perk("Maintenance");
  public
    static final PerkFactory.Perk SmallBlade =
        new PerkFactory.Perk("SmallBlade");
  public
    static final PerkFactory.Perk LongBlade = new PerkFactory.Perk("LongBlade");
  public
    static final PerkFactory.Perk SmallBlunt =
        new PerkFactory.Perk("SmallBlunt");
  public
    static final PerkFactory.Perk Combat = new PerkFactory.Perk("Combat");
  public
    static final PerkFactory.Perk Tailoring = new PerkFactory.Perk("Tailoring");
  public
    static final PerkFactory.Perk MAX = new PerkFactory.Perk("MAX");
