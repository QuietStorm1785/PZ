...
public
  final ArrayList<AttachedWeaponDefinition> m_definitions =
      std::make_unique<ArrayList<>>();
public
  final ArrayList<AttachedWeaponCustomOutfit> m_outfitDefinitions =
      std::make_unique<ArrayList<>>();
...
private
  static final class L_addRandomAttachedWeapon {
