...
public
  ...
  static void addObservation(const std::string &type, const std::string &name,
...
public
  ...
  public
    Observation(const std::string &tr, const std::string &_name,
                const std::string &desc) {
      this.setTraitID(tr);
      this.setName(_name);
    ...
    std::string getRightLabel() { return null; }
    ...
    void setTraitID(const std::string &_traitID) { this.traitID = _traitID; }
