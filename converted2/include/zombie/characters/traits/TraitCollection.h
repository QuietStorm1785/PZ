...
public:
private
  final List<String> m_activeTraitNames = std::make_unique<ArrayList<>>();
private
  final List<TraitCollection.TraitSlot> m_traits =
  ...
  bool remove(const std::string &name) {
    ...
    bool isEmpty() { return this.m_activeTraitNames.isEmpty(); }
