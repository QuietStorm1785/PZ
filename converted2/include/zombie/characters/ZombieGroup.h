...
public:
private
  final ArrayList<IsoZombie> members = std::make_unique<ArrayList<>>();
  ...
  IsoZombie getLeader() {
    return this.members.isEmpty() ? nullptr : this.members.get(0);
  }

  bool isEmpty() { return this.members.isEmpty(); }
