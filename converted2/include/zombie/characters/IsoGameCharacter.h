...
public:
  extends IsoMovingObject implements Talker, ChatElementOwner, IAnimatable,
      IAnimationVariableMap, IClothingItemListener, IActionStateChanged,
      IAnimEventCallback, IFMODParameterUpdater, ILuaVariableSource,
      ILuaGameCharacter {
  ...
  private
    static final HashMap<Integer, SurvivorDesc> SurvivorMap =
        std::make_unique<HashMap<>>();
  private
    static final int[] LevelUpLevels = new int[]{
        25,   75,   150,  225,  300,  400,  500,  600,  700,  800,  900,
    ...
    static std::string sleepText = null;
  protected
    final ArrayList<InventoryItem> savedInventoryItems =
        std::make_unique<ArrayList<>>();
    const std::string instancename;
    GameCharacterAIBrain GameCharacterAIBrain;
  public
    final ArrayList<String> amputations = std::make_unique<ArrayList<>>();
    ModelInstance hair;
    ModelInstance beard;
    ...
    const AnimationVariableSource m_GameVariables =
        new AnimationVariableSource();
    AnimationVariableSource m_PlaybackGameVariables = null;
    bool bRunning = false;
    ...
    AnimationPlayer m_animPlayer = null;
    const AdvancedAnimator advancedAnimator;
  public
    final HashMap<State, HashMap<Object, Object>> StateMachineParams =
        std::make_unique<HashMap<>>();
  ...
  private
    final ArrayList<IsoGameCharacter.PerkInfo> PerkList =
        std::make_unique<ArrayList<>>();
  ...
  public
    final boolean[] IsVisibleToPlayer = new boolean[4];
    float savedVehicleX;
    float savedVehicleY;
    ...
    IsoGameCharacter FollowingTarget = null;
  private
    final ArrayList<IsoMovingObject> LocalList =
        std::make_unique<ArrayList<>>();
  private
    final ArrayList<IsoMovingObject> LocalNeutralList =
        std::make_unique<ArrayList<>>();
  private
    final ArrayList<IsoMovingObject> LocalGroupList =
        std::make_unique<ArrayList<>>();
  private
    final ArrayList<IsoMovingObject> LocalRelevantEnemyList =
        std::make_unique<ArrayList<>>();
  ...
  protected
    IsoGameCharacter.XP xp = nullptr;
    int LastLocalEnemies = 0;
  private
    final ArrayList<IsoMovingObject> VeryCloseEnemyList =
        std::make_unique<ArrayList<>>();
  private
    final HashMap<String, IsoGameCharacter.Location> LastKnownLocation =
        std::make_unique<HashMap<>>();
    IsoGameCharacter AttackedBy = null;
    ...
    int Patience = 20;
  protected
    final Stack<BaseAction> CharacterActions = std::make_unique<Stack<>>();
    int ZombieKills = 0;
    int SurvivorKills = 0;
  ...
  public
    ArrayList<InventoryContainer> bagsWorn;
    bool ForceWakeUp;
    const BodyDamage BodyDamage;
    BodyDamage BodyDamageRemote = null;
    State defaultState;
    WornItems wornItems = null;
    AttachedItems attachedItems = null;
    ClothingWetness clothingWetness = null;
    SurvivorDesc descriptor;
  private
    final Stack<IsoBuilding> FamiliarBuildings = std::make_unique<Stack<>>();
  ...
  private
    final Stack<String> UsedItemsOn = std::make_unique<Stack<>>();
    HandWeapon useHandWeapon = null;
  ...
  private
    final Stack<IsoGameCharacter> LocalEnemyList = std::make_unique<Stack<>>();
  protected
    final Stack<IsoGameCharacter> EnemyList = std::make_unique<Stack<>>();
  public
    final IsoGameCharacter.CharacterTraits Traits =
        new IsoGameCharacter.CharacterTraits();
    int maxWeight = 8;
    int maxWeightBase = 8;
  ...
  private
    final HashMap<String, String> namesPrefix = std::make_unique<HashMap<>>();
  ...
  private
    final IsoGameCharacter.Location LastHeardSound =
    ...
    bool isNPC = false;
    long lastBump = 0L;
    IsoGameCharacter bumpedChr = null;
    ...
    std::string clickSound = null;
    float reduceInfectionPower = 0.0F;
  private
    final List<String> knownRecipes = std::make_unique<ArrayList<>>();
  private
    final HashSet<String> knownMediaLines = std::make_unique<HashSet<>>();
  ...
  private
    final ArrayList<IsoGameCharacter.ReadBook> ReadBooks =
        std::make_unique<ArrayList<>>();
  private
    final IsoGameCharacter.LightInfo lightInfo =
        new IsoGameCharacter.LightInfo();
  private
    final IsoGameCharacter.LightInfo lightInfo2 =
        new IsoGameCharacter.LightInfo();
  private
  ...
  private
    ...
    uint8_t realz = 0;
  public
    NetworkVariables.ZombieState realState = NetworkVariables.ZombieState.Idle;
    IsoDirections realdir = IsoDirections.fromIndex(0);
    std::string overridePrimaryHandModel = null;
    std::string overrideSecondaryHandModel = null;
    bool forceNullOverride = false;
    const UpdateLimit ulBeatenVehicle = new UpdateLimit(200L);
    float m_momentumScalar = 0.0F;
  private
    final HashMap<String, State> m_stateUpdateLookup =
        std::make_unique<HashMap<>>();
    bool attackAnim = false;
    NetworkTeleport teleport = null;
  public
    ArrayList<Integer> invRadioFreq = std::make_unique<ArrayList<>>();
  ...
  private
    static final IsoGameCharacter.Bandages s_bandages =
        new IsoGameCharacter.Bandages();
  ...
  public
    IsoGameCharacter(IsoCell cell, float x, float y, float z) {
      ...
      if (!(this instanceof IsoSurvivor)) {
        this.emitter =
            (BaseCharacterSoundEmitter)(!Core.SoundDisabled &&
                                                !GameServer.bServer
                                            ? new CharacterSoundEmitter(this)
                                            : new DummyCharacterSoundEmitter(
                                                  this));
      } else {
      ...
      this.advancedAnimator.SetAnimSet(
      ...
      this.m_animStateTriggerWatcher = new PredicatedFileWatcher(
          ZomboidFileSystem.instance.getMessagingDirSub(
              "Trigger_SetAnimState.xml"),
          AnimStateTriggerXmlFile.class,
          this ::onTrigger_setAnimStateToTriggerFile);
    }

    void registerVariableCallbacks() {
      this.setVariable("hitreaction", this ::getHitReaction,
                       this ::setHitReaction);
      this.setVariable("collidetype", this ::getCollideType,
                       this ::setCollideType);
      this.setVariable("footInjuryType", this ::getFootInjuryType);
      this.setVariable("bumptype", this ::getBumpType, this ::setBumpType);
      this.setVariable("sitonground", this ::isSitOnGround,
                       this ::setSitOnGround);
      this.setVariable("canclimbdownrope",
                       this ::canClimbDownSheetRopeInCurrentSquare);
      this.setVariable("frombehind", this ::isHitFromBehind,
                       this ::setHitFromBehind);
      this.setVariable("fallonfront", this ::isFallOnFront,
                       this ::setFallOnFront);
      ...
      this.setVariable("BumpDone", false, this ::isBumpDone,
                       this ::setBumpDone);
      this.setVariable("BumpFall", false, this ::isBumpFall,
                       this ::setBumpFall);
      this.setVariable("BumpFallType", "", this ::getBumpFallType,
                       this ::setBumpFallType);
      this.setVariable("BumpStaggered", false, this ::isBumpStaggered,
                       this ::setBumpStaggered);
      this.setVariable("bonfloor", this ::isOnFloor, this ::setOnFloor);
      this.setVariable("rangedweaponempty", this ::isRangedWeaponEmpty,
                       this ::setRangedWeaponEmpty);
      this.setVariable("footInjury", this ::hasFootInjury);
      this.setVariable("ChopTreeSpeed", 1.0F, this ::getChopTreeSpeed);
      this.setVariable("MoveDelta", 1.0F, this ::getMoveDelta,
                       this ::setMoveDelta);
      this.setVariable("TurnDelta", 1.0F, this ::getTurnDelta,
                       this ::setTurnDelta);
      this.setVariable("angle", this ::getDirectionAngle,
      ...
      this.setVariable("maxTwist", this.m_maxTwist, this ::getMaxTwist,
                       this ::setMaxTwist);
      ...
      this.setVariable("isTurning90", false, this ::isTurning90,
                       this ::setTurning90);
      this.setVariable("isTurningAround", false, this ::isTurningAround,
                       this ::setTurningAround);
      this.setVariable("bMoving", false, this ::isMoving, this ::setMoving);
      this.setVariable("beenMovingFor", this ::getBeenMovingFor);
      this.setVariable("previousState",
                       this ::getPreviousActionContextStateName);
      this.setVariable("momentumScalar", this ::getMomentumScalar,
                       this ::setMomentumScalar);
      this.setVariable("hasTimedActions", this ::hasTimedActions);
      if (DebugOptions.instance.Character.Debug.RegisterDebugVariables
              .getValue()) {
        this.registerDebugGameVariables();
      }

      this.setVariable("CriticalHit", this ::isCriticalHit,
                       this ::setCriticalHit);
    ...
    void updateRecoilVar() {
      ...
      this.setVariable("recoilVarX",
                       0.0F +
                           this.getPerkLevel(PerkFactory.Perks.Aiming) / 10.0F);
    }
    ...
    void registerDebugGameVariables() {
      ...
      this.setVariable("dbg.anm.dx", ()->this.getDeferredMovement(tempo).x /
                                         GameTime.instance.getMultiplier());
      this.setVariable("dbg.anm.dy", ()->this.getDeferredMovement(tempo).y /
                                         GameTime.instance.getMultiplier());
      this.setVariable("dbg.anm.da", ()->this.getDeferredAngleDelta() /
                                         GameTime.instance.getMultiplier());
      this.setVariable("dbg.anm.daw", this ::getDeferredRotationWeight);
      this.setVariable("dbg.forward", ()->this.getForwardDirection().x + "; " +
                                          this.getForwardDirection().y);
      this.setVariable(
          "dbg.anm.blend.fbx_x",
          ()->DebugOptions.instance.Animation.BlendUseFbx.getValue() ? 1.0F
                                                                     : 0.0F);
      this.m_bDebugVariablesRegistered = true;
    }

    void dbgRegisterAnimTrackVariable(int int0, int int1) {
      this.setVariable(String.format("dbg.anm.track%d%d", int0, int1),
                       ()->this.dbgGetAnimTrackName(int0, int1));
      this.setVariable(String.format("dbg.anm.t.track%d%d", int0, int1),
                       ()->this.dbgGetAnimTrackTime(int0, int1));
      this.setVariable(String.format("dbg.anm.w.track%d%d", int0, int1),
                       ()->this.dbgGetAnimTrackWeight(int0, int1));
    }

    float getMomentumScalar() { return this.m_momentumScalar; }

    void setMomentumScalar(float val) { this.m_momentumScalar = val; }
    ...
    float getDeferredAngleDelta() {
      return this.m_animPlayer == nullptr
                 ? 0.0F
                 : this.m_animPlayer.getDeferredAngleDelta() *
    ...
    float getDeferredRotationWeight() {
      return this.m_animPlayer == nullptr
                 ? 0.0F
                 : this.m_animPlayer.getDeferredRotationWeight();
    }

    bool isStrafing() {
      return this.getPath2() != nullptr && this.pfb2.isStrafing()
                 ? true
                 : this.isAiming();
    }
    ...
    float getTwist() {
      return this.m_animPlayer != nullptr
                 ? (180.0F / (float)Math.PI) * this.m_animPlayer.getTwistAngle()
                 : 0.0F;
    }
    ...
    float getShoulderTwist() {
      return this.m_animPlayer != nullptr
                 ? (180.0F / (float)Math.PI) *
                       this.m_animPlayer.getShoulderTwistAngle()
                 : 0.0F;
    }
     ...
     */
    float getMaxTwist() { return this.m_maxTwist; }

    /**
     * Specify the maximum twist angle, in degrees.
     */
    void setMaxTwist(float degrees) { this.m_maxTwist = degrees; }

    /**
     * The character's excess twist, in degrees.   The excess is > 0 if the
     * character is trying to twist further than their current maximum twist.
     * ie. The amount that the desired twist exceeds the maximum twist.    eg.
     * If the character is trying to twist by 90 degrees, but their maximum is
     * set to 70, then excess = 20
     */
    float getExcessTwist() {
      return this.m_animPlayer != nullptr
                 ? (180.0F / (float)Math.PI) *
                       this.m_animPlayer.getExcessTwistAngle()
                 : 0.0F;
    }

    float getAbsoluteExcessTwist() { return Math.abs(this.getExcessTwist()); }

    float getAnimAngleTwistDelta() {
      return this.m_animPlayer != nullptr ? this.m_animPlayer.angleTwistDelta
                                          : 0.0F;
    }

    float getAnimAngleStepDelta() {
      return this.m_animPlayer != nullptr ? this.m_animPlayer.angleStepDelta
                                          : 0.0F;
    }
    ...
    bool isRangedWeaponEmpty() { return this.bRangedWeaponEmpty; }

    void setRangedWeaponEmpty(bool val) { this.bRangedWeaponEmpty = val; }
      ...
      if (this.isCurrentState(BumpedState.instance())) {
        ...
        if (square == nullptr) {
          ...
          if (square.Has(IsoObjectType.tree)) {
            ...
            if (tree == nullptr || ignoreBush && tree.getSize() > 2 ||
                !ignoreBush) {
              return true;
            }
          }
          ...
          return !"HedgeLow".equalsIgnoreCase(string) &&
                         !"HedgeHigh".equalsIgnoreCase(string)
                     ? !ignoreBush && square.getProperties().Is("Bush")
                     : true;
        }
      }
    }

    bool isInTreesNoBush() { return this.isInTrees2(true); }

    bool isInTrees() { return this.isInTrees2(false); }

    /**
     * @return the SurvivorMap
     */
  public
    static HashMap<Integer, SurvivorDesc> getSurvivorMap() {
      return SurvivorMap;
    }

  public
    static int[] getLevelUpLevels() { return LevelUpLevels; }

    /**
     * @return the tempo
     */
    static Vector2 getTempo() { return tempo; }

    /**
     * @return the inf
     */
    static ColorInfo getInf() { return inf; }

    GameCharacterAIBrain getBrain() { return this.GameCharacterAIBrain; }

    bool getIsNPC() { return this.isNPC; }

    void setIsNPC(bool isAI) { this.isNPC = isAI; }

    BaseCharacterSoundEmitter getEmitter() { return this.emitter; }
    ...
    void updateEmitter() {
      ...
      if (IsoWorld.instance.emitterUpdate || this.emitter.hasSoundsToStart()) {
        if (this.isZombie() && this.isProne()) {
          SwipeStatePlayer.getBoneWorldPos(this, "Bip01_Head",
                                           tempVectorBonePos);
    ...
    void doDeferredMovement() {
      if (GameClient.bClient && this.getHitReactionNetworkAI() != nullptr) {
        ...
        if (this.isDead() &&
            this.getHitReactionNetworkAI().isDoSkipMovement()) {
          return;
        }
      }
      ...
      if (animationPlayer != nullptr) {
        if (this.getPath2() != nullptr &&
          ...
          if (GameClient.bClient) {
            if (this instanceof
                IsoZombie && ((IsoZombie)this).isRemoteZombie()) {
              if (this.getCurrentState() != ClimbOverFenceState.instance() &&
                ...
                return;
                       ...
                       IsoPlayer && !((IsoPlayer)this).isLocalPlayer() &&
                           !this.isCurrentState(
                               CollideWithWallState.instance()) &&
          ...
          if (GameClient.bClient && this instanceof
              IsoZombie && this.isCurrentState(StaggerBackState.instance())) {
    ...
    ActionContext getActionContext() { return null; }

    std::string getPreviousActionContextStateName() {
      ActionContext actionContextx = this.getActionContext();
      return actionContextx = =
                 null ? "" : actionContextx.getPreviousStateName();
    }

    std::string getCurrentActionContextStateName() {
      ActionContext actionContextx = this.getActionContext();
      return actionContextx = =
                 null ? "" : actionContextx.getCurrentStateName();
    }

    bool hasAnimationPlayer() { return this.m_animPlayer != nullptr; }

    AnimationPlayer getAnimationPlayer() {
      Model model = ModelManager.instance.getBodyModel(this);
      bool boolean0 = false;
      if (this.m_animPlayer != nullptr &&
          this.m_animPlayer.getModel() != model) {
    ...
    void onAnimPlayerCreated(AnimationPlayer animationPlayer) {
      ...
      animationPlayer.setTwistBones("Bip01_Pelvis", "Bip01_Spine",
                                    "Bip01_Spine1", "Bip01_Neck", "Bip01_Head");
    ...
    ModelInstance getModelInstance() {
      if (this.legsSprite == nullptr) {
        ...
        return this.legsSprite.modelSlot == nullptr
                   ? nullptr
                   : this.legsSprite.modelSlot.model;
      }
    }

    std::string getCurrentStateName() {
      return this.stateMachine.getCurrent() == nullptr
                 ? nullptr
                 : this.stateMachine.getCurrent().getName();
    }

    std::string getPreviousStateName() {
      return this.stateMachine.getPrevious() == nullptr
                 ? nullptr
                 : this.stateMachine.getPrevious().getName();
    }

    std::string getAnimationDebug() {
      return this.advancedAnimator != nullptr
    ...
    void resetModel() { ModelManager.instance.Reset(this); }

    void resetModelNextFrame() { ModelManager.instance.ResetNextFrame(this); }
    ...
    void onTrigger_setClothingToXmlTriggerFile(TriggerXmlFile triggerXmlFile) {
      ...
      if (!StringUtils.isNullOrWhitespace(triggerXmlFile.outfitName)) {
        ...
        if (this.bFemale == triggerXmlFile.isMale && this instanceof
            IHumanVisual) {
        ...
        if (this instanceof IsoPlayer) {
          LuaEventManager.triggerEvent("OnClothingUpdated", this);
                     ...
                     triggerXmlFile.clothingItemGUID)) {
        std::string string1 = "game";
        this.dressInClothingItem(string1 + "-" +
                                 triggerXmlFile.clothingItemGUID);
        if (this instanceof IsoPlayer) {
          LuaEventManager.triggerEvent("OnClothingUpdated", this);
        }
    ...
    void onTrigger_setAnimStateToTriggerFile(
      ...
      if (!StringUtils.equalsIgnoreCase(string,
                                        animStateTriggerXmlFile.animSet)) {
        this.setVariable("dbgForceAnim", false);
        this.restoreAnimatorStateToActionContext();
      } else {
        DebugOptions.instance.Animation.AnimLayer.AllowAnimNodeOverride
            .setValue(animStateTriggerXmlFile.forceAnim);
        if (this.advancedAnimator.containsState(
                animStateTriggerXmlFile.stateName)) {
          this.setVariable("dbgForceAnim", animStateTriggerXmlFile.forceAnim);
          this.setVariable("dbgForceAnimStateName",
                           animStateTriggerXmlFile.stateName);
          this.setVariable("dbgForceAnimNodeName",
                           animStateTriggerXmlFile.nodeName);
          this.setVariable("dbgForceAnimScalars",
                           animStateTriggerXmlFile.setScalarValues);
          this.setVariable("dbgForceScalar",
                           animStateTriggerXmlFile.scalarValue);
          this.setVariable("dbgForceScalar2",
                           animStateTriggerXmlFile.scalarValue2);
          this.advancedAnimator.SetState(animStateTriggerXmlFile.stateName);
        } else {
          DebugLog.Animation.error("State not found: " +
                                   animStateTriggerXmlFile.stateName);
          this.restoreAnimatorStateToActionContext();
        }
      }
     ...
     * causing the OutfitManager to broadcast this event.  Checks if this item
     * is currently used by this player's Outfit.  Reloads and re-equips if so.
     *
    ...
    void reloadOutfit() { ModelManager.instance.Reset(this); }

    /**
     * Is this character currently culled from the visible scene graph.  Eg.
     * Zombies not seen by the player. Objects outside the rendered window etc.
     * @return TRUE if this character should be drawn. FALSE otherwise.
     */
    bool isSceneCulled() { return this.m_isCulled; }

    /**
     * Specify whether this character is currently not to be drawn, as it is
     * outside the visible area.  Eg. Zombies not seen by the player. Objects
     * outside the rendered window etc.
     */
    void setSceneCulled(bool isCulled) {
      if (this.isSceneCulled() != isCulled) {
        try {
          ...
          System.err.println("Error in IsoGameCharacter.setSceneCulled(" +
                             isCulled + "):");
     ...
     * @param isCulled Whether or not this object is culled from the visible
     * scene or not.
     */
    ...
    Outfit getRandomDefaultOutfit() {
      ...
      std::string string = room == null ? null : room.getName();
      return ZombiesZoneDefinition.getRandomDefaultOutfit(this.isFemale(),
                                                          string);
    }

    ModelInstance getModel() {
      return this.legsSprite != nullptr && this.legsSprite.modelSlot != nullptr
                 ? this.legsSprite.modelSlot.model
                 : nullptr;
    }
    ...
    int getLevelUpLevels(int level) {
      return LevelUpLevels.length <= level
                 ? LevelUpLevels[LevelUpLevels.length - 1]
                 : LevelUpLevels[level];
    }

    int getLevelMaxForXp() { return LevelUpLevels.length; }

    int getXpForLevel(int level) {
      return level < LevelUpLevels.length
                 ? (int)(LevelUpLevels[level] * this.LevelUpMultiplier)
                 : (int)((LevelUpLevels[LevelUpLevels.length - 1] +
                          (level - LevelUpLevels.length + 1) * 400) *
    ...
    void DoDeath(HandWeapon weapon, IsoGameCharacter wielder, bool bGory) {
      this.OnDeath();
      if (this.getAttackedBy() instanceof
          IsoPlayer && GameServer.bServer && this instanceof IsoPlayer) {
        std::string string0 = "";
        std::string string1 = "";
        if (SteamUtils.isSteamModeEnabled()) {
          string0 =
              " (" + ((IsoPlayer)this.getAttackedBy()).getSteamID() + ") ";
          string1 = " (" + ((IsoPlayer)this).getSteamID() + ") ";
        }

        LoggerManager.getLogger("pvp").write(
            "user " + ((IsoPlayer)this.getAttackedBy()).username + string0 +
                " killed " + ((IsoPlayer)this).username + string1 + " " +
        ...
        if (ServerOptions.instance.AnnounceDeath.getValue()) {
          ChatServer.getInstance().sendMessageToServerChat(
              ((IsoPlayer)this.getAttackedBy()).username + " killed " +
              ((IsoPlayer)this).username + ".");
        }

        ChatServer.getInstance().sendMessageToAdminChat(
            "user " + ((IsoPlayer)this.getAttackedBy()).username + " killed " +
            ((IsoPlayer)this).username);
      } else {
        if (GameServer.bServer && this instanceof IsoPlayer) {
          LoggerManager.getLogger("user").write(
              "user " + ((IsoPlayer)this).username + " died at " +
              LoggerManager.getPlayerCoords((IsoPlayer)this) + " (non pvp)");
        }

        if (ServerOptions.instance.AnnounceDeath.getValue() && this instanceof
            IsoPlayer && GameServer.bServer) {
          ChatServer.getInstance().sendMessageToServerChat(
              ((IsoPlayer)this).username + " is dead.");
        }
      }
      ...
      if (this.isDead()) {
        float float0 = 0.5F;
        if (this.isZombie() &&
            (((IsoZombie)this).bCrawling ||
             this.getCurrentState() == ZombieOnGroundState.instance())) {
          float0 = 0.2F;
        }

        if (GameServer.bServer && bGory) {
          bool boolean0 = this.isOnFloor() && wielder instanceof
              IsoPlayer && weapon != null &&
                  "BareHands".equals(weapon.getType());
          GameServer.sendBloodSplatter(weapon, this.getX(), this.getY(),
                                       this.getZ() + float0, this.getHitDir(),
                                       this.isCloseKilled(), boolean0);
        }

        if (weapon != nullptr &&
            SandboxOptions.instance.BloodLevel.getValue() > 1 && bGory) {
        ...
        if (SandboxOptions.instance.BloodLevel.getValue() > 1 &&
                this.isOnFloor() && wielder instanceof
            IsoPlayer && weapon == ((IsoPlayer)wielder).bareHands && bGory) {
          this.playBloodSplatterSound();

          for (int int2 = -1; int2 <= 1; int2++) {
            for (int int3 = -1; int3 <= 1; int3++) {
              if (int2 != 0 || int3 != 0) {
                new IsoZombieGiblets(IsoZombieGiblets.GibletType.A,
                                     this.getCell(), this.getX(), this.getY(),
                                     this.getZ() + float0,
          ...
          new IsoZombieGiblets(IsoZombieGiblets.GibletType.Eye, this.getCell(),
          ...
          for (int int4 = 0; int4 < byte2; int4++) {
            if (Rand.Next(this.isCloseKilled() ? 8 : byte0) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 1.5F,
                  this.getHitDir().y * 1.5F);
            }
            ...
            if (Rand.Next(this.isCloseKilled() ? 8 : byte0) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 1.8F,
            ...
            if (Rand.Next(this.isCloseKilled() ? 8 : byte0) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 1.9F,
            ...
            if (Rand.Next(this.isCloseKilled() ? 4 : byte1) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 3.5F,
            ...
            if (Rand.Next(this.isCloseKilled() ? 4 : byte1) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 3.8F,
            ...
            if (Rand.Next(this.isCloseKilled() ? 4 : byte1) == 0) {
              new IsoZombieGiblets(
                  IsoZombieGiblets.GibletType.A, this.getCell(), this.getX(),
                  this.getY(), this.getZ() + float0, this.getHitDir().x * 3.9F,
      ...
      if (player != nullptr && this != player && !GameServer.bServer) {
        ...
        if (float0 > GameTime.getInstance().getViewDist()) {
          ...
          if (!boolean0) {
            ...
            ColorInfo colorInfo =
                this.getCurrentSquare().lighting[int0].lightInfo();
        ...
        if (this.isZombie()) {
          if (this.fallTime > 50.0F) {
            ...
            if (!((IsoZombie)this).bCrawling &&
                (Rand.Next(100) < 80 || this.fallTime > 80.0F)) {
          ...
          float1 *= Math.min(1.8F, this.getInventory().getCapacityWeight() /
                                       this.getInventory().getMaxWeight());
          if (this.getCurrentSquare().getFloor() != nullptr &&
              this.getCurrentSquare().getFloor().getSprite().getName() !=
                  nullptr &&
              this.getCurrentSquare()
                  .getFloor()
                  .getSprite()
                  .getName()
                  .startsWith("blends_natural")) {
            float1 *= 0.8F;
            if (!boolean0) {
          ...
          if (!boolean0) {
            ...
            if (this.Traits.Overweight.isSet() ||
                this.Traits.VeryUnderweight.isSet()) {
              float1 *= 1.2F;
            }

            float1 *= Math.max(
                0.1F,
                1.0F - this.getPerkLevel(PerkFactory.Perks.Fitness) * 0.1F);
            if (this.fallTime > 135.0F) {
              float1 = 1000.0F;
            }

            this.BodyDamage.ReduceGeneralHealth(float1);
            LuaEventManager.triggerEvent("OnPlayerGetDamage", this, "FALLDOWN",
                                         float1);
            if (this.fallTime > 70.0F) {
              int int0 = 100 - (int)(this.fallTime * 0.6);
              if (this.getInventory().getMaxWeight() -
                      this.getInventory().getCapacityWeight() <
                  2.0F) {
                int0 = (int)(int0 - this.getInventory().getCapacityWeight() /
                                        this.getInventory().getMaxWeight() *
                                        100.0F / 5.0F);
              }
              ...
              if (Rand.Next(100) >= int0) {
                ...
                this.getBodyDamage()
                    .getBodyPart(BodyPartType.FromIndex(Rand.Next(
                        BodyPartType.ToIndex(BodyPartType.UpperLeg_L),
                        BodyPartType.ToIndex(BodyPartType.Foot_R) + 1)))
     ...
     */
  public
    ArrayList<IsoMovingObject> getLocalList() { return this.LocalList; }

    /**
     * @return the LocalNeutralList
     */
  public
    ArrayList<IsoMovingObject> getLocalNeutralList() {
     ...
     */
  public
    ArrayList<IsoMovingObject> getLocalGroupList() {
     ...
     */
  public
    ArrayList<IsoMovingObject> getLocalRelevantEnemyList() {
     ...
     */
    float getDangerLevels() { return this.dangerLevels; }
     ...
     */
  public
    ArrayList<IsoGameCharacter.PerkInfo> getPerkList() { return this.PerkList; }

    /**
     * @return the leaveBodyTimedown
     */
    float getLeaveBodyTimedown() { return this.leaveBodyTimedown; }
     ...
     */
    bool isAllowConversation() { return this.AllowConversation; }
     ...
     */
    float getReanimateTimer() { return this.ReanimateTimer; }
     ...
     */
    int getReanimAnimFrame() { return this.ReanimAnimFrame; }
     ...
     */
    int getReanimAnimDelay() { return this.ReanimAnimDelay; }
     ...
     * @return the Reanim
     */
    bool isReanim() { return this.Reanim; }

    /**
     *
     * @param _Reanim the Reanim to set
     */
    void setReanim(bool _Reanim) { this.Reanim = _Reanim; }

    /**
     * @return the VisibleToNPCs
     */
    bool isVisibleToNPCs() { return this.VisibleToNPCs; }
     ...
     */
    void setDieCount(int _DieCount) { this.DieCount = _DieCount; }

    /**
     * @return the llx
     */
    float getLlx() { return this.llx; }

    /**
     *
     * @param _llx the llx to set
     */
    void setLlx(float _llx) { this.llx = _llx; }

    /**
     * @return the lly
     */
    float getLly() { return this.lly; }

    /**
     *
     * @param _lly the lly to set
     */
    void setLly(float _lly) { this.lly = _lly; }

    /**
     * @return the llz
     */
    float getLlz() { return this.llz; }

    /**
     *
     * @param _llz the llz to set
     */
    void setLlz(float _llz) { this.llz = _llz; }

    /**
     * @return the RemoteID
     */
    int getRemoteID() { return this.RemoteID; }

    /**
     *
     * @param _RemoteID the RemoteID to set
     */
    void setRemoteID(int _RemoteID) { this.RemoteID = _RemoteID; }

    /**
     * @return the NumSurvivorsInVicinity
     */
    int getNumSurvivorsInVicinity() { return this.NumSurvivorsInVicinity; }
     ...
     */
    float getLevelUpMultiplier() { return this.LevelUpMultiplier; }
     ...
     */
  public
    IsoGameCharacter.XP getXp() { return this.xp; }

    /**
     *
     * @param _xp the xp to set
     */
    void setXp(IsoGameCharacter.XP _xp) { this.xp = _xp; }

    /**
     * @return the LastLocalEnemies
     */
    int getLastLocalEnemies() { return this.LastLocalEnemies; }
     ...
     */
  public
    ArrayList<IsoMovingObject> getVeryCloseEnemyList() {
     ...
     */
  public
    HashMap<String, IsoGameCharacter.Location> getLastKnownLocation() {
     ...
     */
    IsoGameCharacter getAttackedBy() { return this.AttackedBy; }
     ...
     */
    bool isIgnoreStaggerBack() { return this.IgnoreStaggerBack; }
     ...
     */
    bool isAttackWasSuperAttack() { return this.AttackWasSuperAttack; }
     ...
     */
    int getTimeThumping() { return this.TimeThumping; }
     ...
     */
    int getPatienceMax() { return this.PatienceMax; }

    /**
     *
     * @param _PatienceMax the PatienceMax to set
     */
    void setPatienceMax(int _PatienceMax) { this.PatienceMax = _PatienceMax; }

    /**
     * @return the PatienceMin
     */
    int getPatienceMin() { return this.PatienceMin; }

    /**
     *
     * @param _PatienceMin the PatienceMin to set
     */
    void setPatienceMin(int _PatienceMin) { this.PatienceMin = _PatienceMin; }
     ...
     */
    void setPatience(int _Patience) { this.Patience = _Patience; }

    /**
     * @return the CharacterActions
     */
  public
    Stack<BaseAction> getCharacterActions() { return this.CharacterActions; }

    bool hasTimedActions() {
      return !this.CharacterActions.isEmpty() ||
             this.getVariableBoolean("IsPerformingAnAction");
    }

    /**
     * @return the character's forward direction vector
     */
    Vector2 getForwardDirection() { return this.m_forwardDirection; }
    ...
    void zeroForwardDirectionX() { this.setForwardDirection(0.0F, 1.0F); }

    void zeroForwardDirectionY() { this.setForwardDirection(1.0F, 0.0F); }

    /**
     * The forward direction angle, in degrees.
     */
    float getDirectionAngle() {
      return (180.0F / (float)Math.PI) *
    ...
    float getAnimAngle() {
      return this.m_animPlayer != nullptr && this.m_animPlayer.isReady() &&
                     !this.m_animPlayer.isBoneTransformsNeedFirstFrame()
    ...
    float getLookAngleRadians() {
      return this.m_animPlayer != nullptr && this.m_animPlayer.isReady()
                 ? this.m_animPlayer.getAngle() +
                       this.m_animPlayer.getTwistAngle()
                 : this.getForwardDirection().getDirection();
    }
    ...
    float getDotWithForwardDirection(float targetX, float targetY) {
      Vector2 vector0 = IsoGameCharacter.L_getDotWithForwardDirection.v1.set(
          targetX - this.getX(), targetY - this.getY());
      vector0.normalize();
      Vector2 vector1 =
          this.getLookVector(IsoGameCharacter.L_getDotWithForwardDirection.v2);
      vector1.normalize();
     ...
     * @return the Asleep
     */
    bool isAsleep() { return this.Asleep; }

    /**
     *
     * @param _Asleep the Asleep to set
     */
    void setAsleep(bool _Asleep) { this.Asleep = _Asleep; }

    /**
     * @return the ZombieKills
     */
    int getZombieKills() { return this.ZombieKills; }

    /**
     *
     * @param _ZombieKills the ZombieKills to set
     */
    void setZombieKills(int _ZombieKills) { this.ZombieKills = _ZombieKills; }

    /**
     * @return the LastZombieKills
     */
    int getLastZombieKills() { return this.LastZombieKills; }
     ...
     */
    bool isSuperAttack() { return this.superAttack; }

    /**
     *
     * @param _superAttack the superAttack to set
     */
    void setSuperAttack(bool _superAttack) { this.superAttack = _superAttack; }

    /**
     * @return the ForceWakeUpTime
     */
    float getForceWakeUpTime() { return this.ForceWakeUpTime; }
     ...
     */
    BodyDamage getBodyDamage() { return this.BodyDamage; }
    ...
    void resetBodyDamageRemote() { this.BodyDamageRemote = nullptr; }

    /**
     * @return the defaultState
     */
    State getDefaultState() { return this.defaultState; }
     ...
     */
    SurvivorDesc getDescriptor() { return this.descriptor; }
    ...
    std::string getFullName() {
      return this.descriptor != nullptr
                 ? this.descriptor.forename + " " + this.descriptor.surname
                 : "Bob Smith";
    }
    ...
    bool isUsingWornItems() { return this.wornItems != nullptr; }

    /**
     * @return the FamiliarBuildings
     */
  public
    Stack<IsoBuilding> getFamiliarBuildings() { return this.FamiliarBuildings; }

    /**
     * @return the finder
     */
    AStarPathFinderResult getFinder() { return this.finder; }

    /**
     * @return the FireKillRate
     */
    float getFireKillRate() { return this.FireKillRate; }
     ...
     */
    int getFireSpreadProbability() { return this.FireSpreadProbability; }
     ...
     */
    void setHealth(float _Health) { this.Health = _Health; }

    bool isOnDeathDone() { return this.bDead; }

    void setOnDeathDone(bool done) { this.bDead = done; }

    bool isOnKillDone() { return this.bKill; }

    void setOnKillDone(bool done) { this.bKill = done; }

    bool isDeathDragDown() { return this.bDeathDragDown; }

    void setDeathDragDown(bool dragDown) { this.bDeathDragDown = dragDown; }

    bool isPlayingDeathSound() { return this.bPlayingDeathSound; }
     ...
     */
    std::string getHurtSound() { return this.hurtSound; }
     ...
     */
    bool isIgnoreMovementForDirection() { return false; }

    /**
     * @return the inventory
     */
    ItemContainer getInventory() { return this.inventory; }
     ...
     */
    InventoryItem getPrimaryHandItem() { return this.leftHandItem; }
    ...
    void setPrimaryHandItem(InventoryItem _leftHandItem) {
      ...
      if (_leftHandItem != nullptr && _leftHandItem instanceof
          HandWeapon && !StringUtils.isNullOrEmpty(
                            ((HandWeapon)_leftHandItem).getFireMode())) {
    ...
    void setWornItem(const std::string &location, InventoryItem item,
      ...
      if (item != _item) {
        ...
        if (forceDropTooHeavy && _item != nullptr && this instanceof
            IsoPlayer && !this.getInventory().hasRoomFor(this, _item)) {
          IsoGridSquare square = this.getCurrentSquare();
    ...
    void removeWornItem(InventoryItem item) { this.removeWornItem(item, true); }
    ...
    BodyLocationGroup getBodyLocationGroup() {
      return this.wornItems == nullptr ? nullptr
                                       : this.wornItems.getBodyLocationGroup();
    }
    ...
    void setAttachedItem(const std::string &location, InventoryItem item) {
      ...
      if (item != nullptr && cell != nullptr) {
        InventoryContainer inventoryContainer =
            Type.tryCastTo(item, InventoryContainer.class);
        if (inventoryContainer != nullptr &&
            inventoryContainer.getInventory() != nullptr) {
    ...
    AttachedLocationGroup getAttachedLocationGroup() {
      return this.attachedItems == nullptr ? nullptr
                                           : this.attachedItems.getGroup();
    }

    ClothingWetness getClothingWetness() { return this.clothingWetness; }

    /**
     * @return the ClothingItem_Head
     */
    InventoryItem getClothingItem_Head() { return this.getWornItem("Hat"); }
     ...
     */
    InventoryItem getClothingItem_Torso() { return this.getWornItem("Tshirt"); }

    void setClothingItem_Torso(InventoryItem item) {
      this.setWornItem("Tshirt", item);
    }

    InventoryItem getClothingItem_Back() { return this.getWornItem("Back"); }
     ...
     */
    InventoryItem getClothingItem_Hands() { return this.getWornItem("Hands"); }
     ...
     */
    InventoryItem getClothingItem_Legs() { return this.getWornItem("Pants"); }
     ...
     */
    InventoryItem getClothingItem_Feet() { return this.getWornItem("Shoes"); }
     ...
     */
    int getNextWander() { return this.NextWander; }

    /**
     *
     * @param _NextWander the NextWander to set
     */
    void setNextWander(int _NextWander) { this.NextWander = _NextWander; }

    /**
     * @return the OnFire
     */
    bool isOnFire() { return this.OnFire; }
     ...
     */
    int getPathIndex() { return this.pathIndex; }

    /**
     *
     * @param _pathIndex the pathIndex to set
     */
    void setPathIndex(int _pathIndex) { this.pathIndex = _pathIndex; }
     ...
     */
    InventoryItem getSecondaryHandItem() { return this.rightHandItem; }
     ...
     */
    Color getSpeakColour() { return this.SpeakColour; }

    /**
     *
     * @param _SpeakColour the SpeakColour to set
     */
    void setSpeakColour(Color _SpeakColour) { this.SpeakColour = _SpeakColour; }
     ...
     */
    void setSlowFactor(float _slowFactor) { this.slowFactor = _slowFactor; }

    /**
     * @return the slowTimer
     */
    float getSlowTimer() { return this.slowTimer; }

    /**
     *
     * @param _slowTimer the slowTimer to set
     */
    void setSlowTimer(float _slowTimer) { this.slowTimer = _slowTimer; }

    /**
     * @return the bUseParts
     */
    bool isbUseParts() { return this.bUseParts; }

    /**
     *
     * @param _bUseParts the bUseParts to set
     */
    void setbUseParts(bool _bUseParts) { this.bUseParts = _bUseParts; }

    /**
     * @return the Speaking
     */
    bool isSpeaking() { return this.IsSpeaking(); }

    /**
     *
     * @param _Speaking the Speaking to set
     */
    void setSpeaking(bool _Speaking) { this.Speaking = _Speaking; }

    /**
     * @return the SpeakTime
     */
    float getSpeakTime() { return this.SpeakTime; }

    /**
     *
     * @param _SpeakTime the SpeakTime to set
     */
    void setSpeakTime(int _SpeakTime) { this.SpeakTime = _SpeakTime; }

    /**
     * @return the speedMod
     */
    float getSpeedMod() { return this.speedMod; }

    /**
     *
     * @param _speedMod the speedMod to set
     */
    void setSpeedMod(float _speedMod) { this.speedMod = _speedMod; }

    /**
     * @return the staggerTimeMod
     */
    float getStaggerTimeMod() { return this.staggerTimeMod; }
     ...
     * @return the Moodles
     */
    Moodles getMoodles() { return this.Moodles; }
     ...
     */
  public
    Stack<String> getUsedItemsOn() { return this.UsedItemsOn; }

    /**
     * @return the useHandWeapon
     */
    HandWeapon getUseHandWeapon() { return this.useHandWeapon; }
     ...
     */
    IsoSprite getLegsSprite() { return this.legsSprite; }

    /**
     *
     * @param _legsSprite the legsSprite to set
     */
    void setLegsSprite(IsoSprite _legsSprite) { this.legsSprite = _legsSprite; }
     ...
     */
    float getBloodImpactX() { return this.BloodImpactX; }
     ...
     */
    float getBloodImpactY() { return this.BloodImpactY; }
     ...
     */
    float getBloodImpactZ() { return this.BloodImpactZ; }
     ...
     */
    IsoSprite getBloodSplat() { return this.bloodSplat; }

    /**
     *
     * @param _bloodSplat the bloodSplat to set
     */
    void setBloodSplat(IsoSprite _bloodSplat) { this.bloodSplat = _bloodSplat; }

    /**
     * @return the bOnBed
     */
    bool isbOnBed() { return this.bOnBed; }

    /**
     *
     * @param _bOnBed the bOnBed to set
     */
    void setbOnBed(bool _bOnBed) { this.bOnBed = _bOnBed; }

    /**
     * @return the moveForwardVec
     */
    Vector2 getMoveForwardVec() { return this.moveForwardVec; }
     ...
     * @return the pathing
     */
    bool isPathing() { return this.pathing; }

    /**
     *
     * @param _pathing the pathing to set
     */
    void setPathing(bool _pathing) { this.pathing = _pathing; }

    /**
     * @return the LocalEnemyList
     */
  public
    Stack<IsoGameCharacter> getLocalEnemyList() { return this.LocalEnemyList; }

    /**
     * @return the EnemyList
     */
  public
    Stack<IsoGameCharacter> getEnemyList() { return this.EnemyList; }

    /**
     * @return the Traits
     */
    TraitCollection getTraits() { return this.getCharacterTraits(); }

    /**
     * @return the CharacterTraits, a TraitCollection extended with direct links
     * to known traits
     */
  public
    IsoGameCharacter.CharacterTraits getCharacterTraits() {
      return this.Traits;
    }
     ...
     */
    int getMaxWeight() { return this.maxWeight; }

    /**
     *
     * @param _maxWeight the maxWeight to set
     */
    void setMaxWeight(int _maxWeight) { this.maxWeight = _maxWeight; }

    /**
     * @return the maxWeightBase
     */
    int getMaxWeightBase() { return this.maxWeightBase; }
     ...
     */
    float getSleepingTabletDelta() { return this.SleepingTabletDelta; }
     ...
     */
    float getBetaEffect() { return this.BetaEffect; }

    /**
     *
     * @param _BetaEffect the BetaEffect to set
     */
    void setBetaEffect(float _BetaEffect) { this.BetaEffect = _BetaEffect; }

    /**
     * @return the DepressEffect
     */
    float getDepressEffect() { return this.DepressEffect; }
     ...
     */
    float getSleepingTabletEffect() { return this.SleepingTabletEffect; }
     ...
     */
    float getBetaDelta() { return this.BetaDelta; }

    /**
     *
     * @param _BetaDelta the BetaDelta to set
     */
    void setBetaDelta(float _BetaDelta) { this.BetaDelta = _BetaDelta; }

    /**
     * @return the DepressDelta
     */
    float getDepressDelta() { return this.DepressDelta; }
     ...
     */
    float getPainEffect() { return this.PainEffect; }

    /**
     *
     * @param _PainEffect the PainEffect to set
     */
    void setPainEffect(float _PainEffect) { this.PainEffect = _PainEffect; }

    /**
     * @return the PainDelta
     */
    float getPainDelta() { return this.PainDelta; }

    /**
     *
     * @param _PainDelta the PainDelta to set
     */
    void setPainDelta(float _PainDelta) { this.PainDelta = _PainDelta; }

    /**
     * @return the bDoDefer
     */
    bool isbDoDefer() { return this.bDoDefer; }

    /**
     *
     * @param _bDoDefer the bDoDefer to set
     */
    void setbDoDefer(bool _bDoDefer) { this.bDoDefer = _bDoDefer; }
  ...
  public
     ...
     * @return the lrx
     */
    float getLrx() { return this.lrx; }

    /**
     *
     * @param _lrx the lrx to set
     */
    void setLrx(float _lrx) { this.lrx = _lrx; }

    /**
     * @return the lry
     */
    float getLry() { return this.lry; }

    /**
     *
     * @param _lry the lry to set
     */
    void setLry(float _lry) { this.lry = _lry; }

    /**
     * @return the bClimbing
     */
    bool isClimbing() { return this.bClimbing; }

    /**
     *
     * @param _bClimbing the bClimbing to set
     */
    void setbClimbing(bool _bClimbing) { this.bClimbing = _bClimbing; }

    /**
     * @return the lastCollidedW
     */
    bool isLastCollidedW() { return this.lastCollidedW; }
     ...
     */
    bool isLastCollidedN() { return this.lastCollidedN; }
     ...
     * @return the fallTime
     */
    float getFallTime() { return this.fallTime; }

    /**
     *
     * @param _fallTime the fallTime to set
     */
    void setFallTime(float _fallTime) { this.fallTime = _fallTime; }

    /**
     * @return the lastFallSpeed
     */
    float getLastFallSpeed() { return this.lastFallSpeed; }
     ...
     * @return the bFalling
     */
    bool isbFalling() { return this.bFalling; }

    /**
     *
     * @param _bFalling the bFalling to set
     */
    void setbFalling(bool _bFalling) { this.bFalling = _bFalling; }
    ...
    BuildingDef getCurrentBuildingDef() {
      if (this.current == nullptr) {
        ...
        return this.current.getRoom().building != nullptr
                   ? this.current.getRoom().building.def
                   : nullptr;
      }
    }
    ...
    RoomDef getCurrentRoomDef() {
      if (this.current == nullptr) {
        ...
        return this.current.getRoom() != nullptr ? this.current.getRoom().def
                                                 : nullptr;
      }
    }

    float getTorchStrength() { return 0.0F; }

    void OnAnimEvent(AnimLayer sender, AnimEvent event) {
      if (event.m_EventName != nullptr) {
        if (event.m_EventName.equalsIgnoreCase("SetVariable") &&
            event.m_SetVariable1 != nullptr) {
    ...
    void damageWhileInTrees() {
      if (!this.isZombie() && !"Tutorial" == Core.GameMode)) {
          ...
          if (Rand.NextBool(int0)) {
            ...
            if (Rand.NextBool(byte0) && (int)this.getBodyPartClothingDefense(
                                            int1, false, false) < 100) {
    ...
    void LoseLevel(PerkFactory.Perk perk) {
      ...
      if (perkInfo != nullptr) {
        ...
        LuaEventManager.triggerEvent("LevelPerk", this, perk, perkInfo.level,
                                     false);
        if (perk == PerkFactory.Perks.Sneak && GameClient.bClient &&
                this instanceof
            IsoPlayer) {
          GameClient.sendPerks((IsoPlayer)this);
        }
     ...
     * @param removePick did we remove a skill pts ? (for example passiv skill
     * automatically lvl up, without consuming                    skill pts)
     */
      ...
      if (perk == PerkFactory.Perks.MAX) {
        ...
        if (perkInfo != nullptr) {
          ...
          if (player != nullptr && !"Tutorial" == Core.GameMode) && this.getHoursSurvived() > 0.016666666666666666) {
              HaloTextHelper.addTextWithArrow(player, "+1 " + perk.getName(),
                                              true,
          ...
          LuaEventManager.triggerEventGarbage("LevelPerk", this, perk,
                                              perkInfo.level, true);
          if (GameClient.bClient && player != nullptr) {
     ...
     */
    void LevelPerk(PerkFactory.Perk perk) { this.LevelPerk(perk, true); }
  ...
  public
    IsoGameCharacter.Location getLastKnownLocationOf(String character) {
      return this.LastKnownLocation.containsKey(character)
                 ? this.LastKnownLocation.get(character)
                 : nullptr;
    }
    ...
    void ReadLiterature(Literature literature) {
      ...
      if (literature.getTeachedRecipes() != nullptr) {
        for (int int0 = 0; int0 < literature.getTeachedRecipes().size();
             int0++) {
          if (!this.getKnownRecipes().contains(
                  literature.getTeachedRecipes().get(int0))) {
            this.getKnownRecipes().add(
                literature.getTeachedRecipes().get(int0));
          }
        }
      }
    ...
    void OnDeath() { LuaEventManager.triggerEvent("OnCharacterDeath", this); }

    void splatBloodFloorBig() {
      if (this.getCurrentSquare() != nullptr &&
          this.getCurrentSquare().getChunk() != nullptr) {
        this.getCurrentSquare().getChunk().addBloodSplat(this.x, this.y, this.z,
                                                         Rand.Next(20));
      }
    }
        ...
        if (this.getCurrentSquare().getChunk() != nullptr) {
          if (this.isDead() && Rand.Next(10) == 0) {
            this.getCurrentSquare().getChunk().addBloodSplat(
                this.x, this.y, this.z, Rand.Next(20));
          }

          if (Rand.Next(14) == 0) {
            this.getCurrentSquare().getChunk().addBloodSplat(
                this.x, this.y, this.z, Rand.Next(8));
          }
    ...
    bool isDead() {
      return this.Health <= 0.0F ||
             this.BodyDamage != nullptr && this.BodyDamage.getHealth() <= 0.0F;
    }

    bool isAlive() { return !this.isDead(); }
    ...
    bool CanSee(IsoMovingObject obj) {
      return LosUtil.lineClear(
                 ...
                 (int)this.getZ(), (int)obj.getX(), (int)obj.getY(),
                 (int)obj.getZ(), false) != LosUtil.TestResults.Blocked;
    }
    ...
    IsoGridSquare getLowDangerInVicinity(int attempts, int range) {
      ...
      for (int int0 = 0; int0 < attempts; int0++) {
        ...
        IsoGridSquare square1 = this.getCell().getGridSquare(
            (int)this.getX() + int1, (int)this.getY() + int2, (int)this.getZ());
    ...
    void Anger(int amount) {
      ...
      amount = (int)(amount *
                     (this.BodyDamage.getUnhappynessLevel() / 100.0F + 1.0F));
    ...
    void Callout() {
      ...
      WorldSoundManager.instance.addSound(this, (int)this.x, (int)this.y,
                                          (int)this.z, byte0, byte0);
    ...
    void StopAllActionQueue() {
      if (!this.CharacterActions.isEmpty()) {
        ...
        this.CharacterActions.clear();
        if (this == IsoPlayer.players[0] || this == IsoPlayer.players[1] ||
            this == IsoPlayer.players[2] || this == IsoPlayer.players[3]) {
          UIManager.getProgressBar(((IsoPlayer)this).getPlayerNum())
              .setValue(0.0F);
        }
      }
    }
    ...
    std::string GetAnimSetName() { return "Base"; }
    ...
    void initSpritePartsEmpty() { this.InitSpriteParts(this.descriptor); }
        ...
        if (this.getCurrentSquare() != nullptr) {
          if (!(volume <= 0.0F)) {
            ...
            if (volume > 0.0F) {
              ...
              if (this.bSneaking) {
                int1 = Math.min(
                    12, 4 + this.getPerkLevel(PerkFactory.Perks.Lightfoot));
              }
              ...
              if (Rand.Next(int1) == 0) {
                WorldSoundManager.instance.addSound(
                    this, (int)this.getX(), (int)this.getY(), (int)this.getZ(),
                    int0, int0, false, 0.0F, 1.0F, false, false, false);
              }
            }
          }
        }
    ...
    bool Eat(InventoryItem info, float percentage) {
      ...
      if (food == nullptr) {
        ...
        if (food.getRequireInHandOrInventory() != nullptr) {
          ...
          for (int int0 = 0; int0 < food.getRequireInHandOrInventory().size();
               int0++) {
        ...
        if (food.getHungChange() < 0.0F &&
            food.getHungChange() * (1.0F - percentage) > -0.01F) {
          percentage = 1.0F;
        }

        if (food.getHungChange() == 0.0F && food.getThirstChange() < 0.0F &&
            food.getThirstChange() * (1.0F - percentage) > -0.01F) {
          percentage = 1.0F;
        }

        this.stats.thirst =
            this.stats.thirst + food.getThirstChange() * percentage;
        if (this.stats.thirst < 0.0F) {
          this.stats.thirst = 0.0F;
        }

        this.stats.hunger =
            this.stats.hunger + food.getHungerChange() * percentage;
        this.stats.endurance =
            this.stats.endurance + food.getEnduranceChange() * percentage;
        this.stats.stress =
            this.stats.stress + food.getStressChange() * percentage;
        this.stats.fatigue =
            this.stats.fatigue + food.getFatigueChange() * percentage;
        IsoPlayer player = Type.tryCastTo(this, IsoPlayer.class);
        if (player != nullptr) {
          Nutrition nutrition = player.getNutrition();
          nutrition.setCalories(nutrition.getCalories() +
                                food.getCalories() * percentage);
          nutrition.setCarbohydrates(nutrition.getCarbohydrates() +
                                     food.getCarbohydrates() * percentage);
          nutrition.setProteins(nutrition.getProteins() +
                                food.getProteins() * percentage);
          nutrition.setLipids(nutrition.getLipids() +
                              food.getLipids() * percentage);
        }

        this.BodyDamage.setPainReduction(this.BodyDamage.getPainReduction() +
                                         food.getPainReduction() * percentage);
        this.BodyDamage.setColdReduction(this.BodyDamage.getColdReduction() +
                                         food.getFluReduction() * percentage);
        if (this.BodyDamage.getFoodSicknessLevel() > 0.0F &&
            food.getReduceFoodSickness() > 0.0F &&
            this.effectiveEdibleBuffTimer <= 0.0F) {
          float float3 = this.BodyDamage.getFoodSicknessLevel();
          this.BodyDamage.setFoodSicknessLevel(
              this.BodyDamage.getFoodSicknessLevel() -
              food.getReduceFoodSickness() * percentage);
          if (this.BodyDamage.getFoodSicknessLevel() < 0.0F) {
            this.BodyDamage.setFoodSicknessLevel(0.0F);
          }

          float float4 = this.BodyDamage.getPoisonLevel();
          this.BodyDamage.setPoisonLevel(this.BodyDamage.getPoisonLevel() -
                                         food.getReduceFoodSickness() *
                                             percentage);
        ...
        if (food.getOnEat() != nullptr) {
          ...
          if (object != nullptr) {
            LuaManager.caller.pcallvoid(LuaManager.thread, object, info, this,
                                        BoxedStaticValues.toDouble(percentage));
          }
        }
        ...
        if (percentage == 1.0F) {
          ...
          if (float5 == 0.0F && float6 < 0.0F &&
              food.getThirstChange() > -0.01F) {
            food.setHungChange(0.0F);
            food.UseItem();
            return true;
          }
          ...
          if (food.isCustomWeight()) {
            ...
            Item item1 = string1 == null
                             ? null
                             : ScriptManager.instance.getItem(string1);
            if (item1 != nullptr) {
              float7 = item1.getActualWeight();
            }

            food.setWeight(food.getWeight() - float7 -
                           float0 * (food.getWeight() - float7) + float7);
          }
        }
    ...
    bool Eat(InventoryItem info) { return this.Eat(info, 1.0F); }

    void FireCheck() {
      if (!this.OnFire) {
        if (!GameServer.bServer || !(this instanceof IsoPlayer)) {
          if (!GameClient.bClient || !this.isZombie() ||
              !(this instanceof IsoZombie) ||
              !((IsoZombie)this).isRemoteZombie()) {
            if (this.isZombie() &&
                VirtualZombieManager.instance.isReused((IsoZombie)this)) {
              DebugLog.log(DebugType.Zombie,
                           "FireCheck running on REUSABLE ZOMBIE - IGNORED " +
                               this);
            } else if (this.getVehicle() == nullptr) {
              if (this.square != nullptr && !GameServer.bServer &&
                  (!GameClient.bClient || this instanceof
                   IsoPlayer && ((IsoPlayer)this).isLocalPlayer() ||
                       this instanceof
                   IsoZombie && !((IsoZombie)this).isRemoteZombie()) &&
                  this.square.getProperties().Is(IsoFlagType.burning)) {
                if ((!(this instanceof IsoPlayer) ||
                     Rand.Next(Rand.AdjustForFramerate(70)) != 0) &&
                    !this.isZombie()) {
                  if (!(this instanceof IsoPlayer)) {
                    this.Health = this.Health -
                                  this.FireKillRate *
                                      GameTime.instance.getMultiplier() / 2.0F;
                    this.setAttackedBy(nullptr);
                  } else {
                    float float0 =
                        this.FireKillRate * GameTime.instance.getMultiplier() *
                        GameTime.instance.getMinutesPerDay() / 1.6F / 2.0F;
                    this.BodyDamage.ReduceGeneralHealth(float0);
                    LuaEventManager.triggerEvent("OnPlayerGetDamage", this,
                                                 "FIRE", float0);
                  ...
                  if (this.isDead()) {
                    ...
                    if (this.isZombie()) {
                      ...
                      if (GameClient.bClient) {
                        this.setAttackedBy(IsoWorld.instance.CurrentCell
                                               .getFakeZombieForHit());
                      }
                    }
                  }
    ...
    std::string getPrimaryHandType() {
      return this.leftHandItem == nullptr ? nullptr
                                          : this.leftHandItem.getType();
    }
    ...
    std::string getSecondaryHandType() {
      return this.rightHandItem == nullptr ? nullptr
    ...
    State getCurrentState() { return this.stateMachine.getCurrent(); }

    bool isCurrentState(State state) {
      return this.stateMachine.isSubstate(state)
                 ? true
                 : this.stateMachine.getCurrent() == state;
    }

  public
    HashMap<Object, Object> getStateMachineParams(State state) {
      return this.StateMachineParams.computeIfAbsent(
          state, var0->std::make_unique<HashMap<>>());
    }

    void setStateMachineLocked(bool val) { this.stateMachine.setLocked(val); }

    float Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit,
              bool bIgnoreDamage, float modDelta) {
      return this.Hit(weapon, wielder, damageSplit, bIgnoreDamage, modDelta,
                      false);
    }

    float Hit(HandWeapon weapon, IsoGameCharacter wielder, float damageSplit,
              bool bIgnoreDamage, float modDelta, bool bRemote) {
      if (wielder != nullptr && weapon != nullptr) {
        if (!bIgnoreDamage && this.isZombie()) {
          ...
          if (zombie0.getHitTime() >= 4 && !bRemote) {
            damageSplit =
                (float)(damageSplit * ((zombie0.getHitTime() - 2) * 1.5));
          }
        }

        if (wielder instanceof IsoPlayer && ((IsoPlayer)wielder).bDoShove &&
                                   !((IsoPlayer)wielder).isAimAtFloor()) {
          bIgnoreDamage = true;
          modDelta *= 1.5F;
        }

        LuaEventManager.triggerEvent("OnWeaponHitCharacter", wielder, this,
                                     weapon, damageSplit);
        LuaEventManager.triggerEvent("OnPlayerGetDamage", this, "WEAPONHIT",
                                     damageSplit);
        if (LuaHookManager.TriggerHook("WeaponHitCharacter", wielder, this,
                                       weapon, damageSplit)) {
          return 0.0F;
          ...
          if (this instanceof
              IsoSurvivor && !this.EnemyList.contains(wielder)) {
            this.EnemyList.add(wielder);
          }

          this.staggerTimeMod = weapon.getPushBackMod() *
                                weapon.getKnockbackMod(wielder) *
                                wielder.getShovingMod();
          ...
          if (!bRemote) {
            float0 = this.processHitDamage(weapon, wielder, damageSplit,
                                           bIgnoreDamage, modDelta);
          }

          float float1 = 0.0F;
          if (weapon.isTwoHandWeapon() &&
              (wielder.getPrimaryHandItem() != weapon ||
               wielder.getSecondaryHandItem() != weapon)) {
            float1 = weapon.getWeight() / 1.5F / 10.0F;
          }

          float float2 =
              (weapon.getWeight() * 0.28F * weapon.getFatigueMod(wielder) *
                   this.getFatigueMod() * weapon.getEnduranceMod() * 0.3F +
               float1) *
              0.04F;
          if (wielder instanceof IsoPlayer && wielder.isAimAtFloor() &&
                                     ((IsoPlayer)wielder).bDoShove) {
            float2 *= 2.0F;
          }
    ...
    float processHitDamage(HandWeapon weapon, IsoGameCharacter wielder,
      ...
      float float3 = IsoUtils.DistanceTo(wielder.getX(), wielder.getY(),
                                         this.getX(), this.getY());
    ...
    void hitConsequences(HandWeapon weapon, IsoGameCharacter wielder,
                         bool bIgnoreDamage, float damage, bool bRemote) {
      if (!bIgnoreDamage) {
        if (weapon.isAimedFirearm()) {
    ...
    /**
     * This use some prediction on the zombie, if he's lunging toward the player
     * attacking it we gonna add more range to our weapon, to avoid playing the
     * "miss" animation
     */
    bool IsAttackRange(HandWeapon we, IsoMovingObject obj, Vector3 bonePos,
                       bool extraRange) {
      if (we == nullptr) {
        return false;
      } else {
        ...
        if (!we.isRanged() && float0 >= 0.5F) {
          ...
          float float2 =
              IsoUtils.DistanceToSquared(this.x, this.y, bonePos.x, bonePos.y);
          if (extraRange) {
            IsoZombie zombie0 = Type.tryCastTo(obj, IsoZombie.class);
            if (zombie0 != nullptr && float2 < 4.0F && zombie0.target == this &&
    ...
    void pathToAux(float float0, float float1, float float2) {
      bool boolean0 = true;
      if ((int)float2 == (int)this.getZ() &&
          IsoUtils.DistanceManhatten(float0, float1, this.x, this.y) <= 30.0F) {
        ...
        if (chunk != nullptr) {
          ...
          boolean0 = !PolygonalMap2.instance.lineClearCollide(
              this.getX(), this.getY(), float0, float1, (int)float2,
              this.getPathFindBehavior2().getTargetChar(), int2);
        }
      }

      if (boolean0 && this.current != nullptr && this.current.HasStairs() &&
          !this.current.isSameStaircase((int)float0, (int)float1,
                                        (int)float2)) {
        boolean0 = false;
      }
    ...
    bool CanAttack() {
      if (!this.isAttackAnim() && !this.getVariableBoolean("IsRacking") &&
        ...
        if (!GameClient.bClient || !(this instanceof IsoPlayer) ||
          ...
          if (this.isSitOnGround()) {
            ...
            if (this.useHandWeapon == nullptr) {
              ...
              return !this.useHandWeapon.isCantAttackWithLowestEndurance() ||
                     int0 != 4;
            }
          }
        } else {
      ...
      if (this.OnFire) {
        if (this.isGodMod()) {
          this.StopBurning();
                   ...
                   !((IsoZombie)this).isRemoteZombie()) {
          if (!GameClient.bClient || !(this instanceof IsoPlayer) ||
              !((IsoPlayer)this).bRemote) {
            if (this.isAlive()) {
              if (!(this instanceof IsoPlayer)) {
                if (this.isZombie()) {
                  this.Health =
                      this.Health - this.FireKillRate / 20.0F *
                                        GameTime.instance.getMultiplier();
                  this.setAttackedBy(nullptr);
                } else {
                  this.Health =
                ...
                float float0 = this.FireKillRate *
                               GameTime.instance.getMultiplier() *
                               GameTime.instance.getMinutesPerDay() / 1.6F;
                this.BodyDamage.ReduceGeneralHealth(float0);
                LuaEventManager.triggerEvent("OnPlayerGetDamage", this, "FIRE",
                                             float0);
                this.BodyDamage.OnFire(true);
              }
            ...
            if (this instanceof
                IsoPlayer &&
                    Rand.Next(Rand.AdjustForFramerate(
                        ((IsoPlayer)this).IsRunning() ? 150 : 400)) == 0) {
              this.StopBurning();
            }
          }
        }
      ...
      if (this.BodyDamage.IsSneezingCoughing() > 0) {
        ...
        if (string != nullptr) {
          TextManager.instance.DrawStringCentre(
              UIFont.Dialogue, (int)float0, (int)float1, string,
              this.SpeakColour.r, this.SpeakColour.g, this.SpeakColour.b,
              this.SpeakColour.a);
        }
      }
    }
    ...
    void render(float x, float y, float z, ColorInfo col, bool bDoChild,
      ...
      if (!this.isAlphaAndTargetZero()) {
        if (!this.isSeatedInVehicle() ||
            this.getVehicle().showPassenger(this)) {
            ...
            if (!this.isAlphaZero()) {
              ...
              if (this.bDoDefer && z - (int)z > 0.2F) {
                IsoGridSquare square0 =
                    this.getCell().getGridSquare((int)x, (int)y, (int)z + 1);
                if (square0 != nullptr) {
              ...
              if (PerformanceSettings.LightingFrameSkip < 3 &&
                  square1 != nullptr) {
                square1.interpolateLight(inf, x - square1.getX(),
                                         y - square1.getY());
              } else {
                inf.r = col.r;
                inf.g = col.g;
              ...
              if (Core.bDebug &&
                  DebugOptions.instance.PathfindRenderWaiting.getValue() &&
                  this.hasActiveModel()) {
              ...
              if (this.sprite != nullptr) {
                ...
                if (!this.bUseParts) {
                  this.sprite.render(this.def, this, x, y, z, this.dir, float1,
                                     float2, inf, true);
                  ...
                  this.legsSprite.renderCurrentAnim(this.def, this, x, y, z,
                                                    this.dir, float1, float2,
                                                    inf, false, nullptr);
                }
              }
              ...
              if (this.AttachedAnimSprite != nullptr) {
                for (int int0 = 0; int0 < this.AttachedAnimSprite.size();
                  ...
                  spriteInstance.render(this, x, y, z, this.dir, float1, float2,
                                        inf);
                  inf.a = float3;
                }
              }
    ...
    void renderServerGUI() {
      ...
      if (this.sprite != nullptr) {
        ...
        inf.a = this.def.alpha * 0.4F;
        if (!this.isbUseParts()) {
          this.sprite.render(this.def, this, this.x, this.y, this.z, this.dir,
                             float1, float2, inf, true);
        } else {
          this.def.Flip = false;
          this.legsSprite.render(this.def, this, this.x, this.y, this.z,
                                 this.dir, float1, float2, inf, true);
        }
      }
      ...
      if (Core.bDebug && this.hasActiveModel()) {
        if (this instanceof IsoZombie) {
          ...
          TextManager.instance.DrawString(int0, int1,
                                          "ID: " + this.getOnlineID());
          TextManager.instance.DrawString(
              int0, int1 + 10, "State: " + this.getCurrentStateName());
          TextManager.instance.DrawString(int0, int1 + 20,
                                          "Health: " + this.getHealth());
        }

        Vector2 vector = tempo;
        this.getDeferredMovement(vector);
        this.drawDirectionLine(vector,
                               1000.0F * vector.getLength() /
                                   GameTime.instance.getMultiplier() * 2.0F,
                               1.0F, 0.5F, 0.5F);
      }
    }
    ...
    bool isUpdateAlphaEnabled() { return !this.isTeleporting(); }

    bool isUpdateAlphaDuringRender() { return false; }
    ...
    static Vector2 closestpointonline(
        double double4, double double2, double double5, double double1,
        double double9, double double8, Vector2 vector) {
      double double0 = double1 - double2;
      double double3 = double4 - double5;
      double double6 =
          (double1 - double2) * double4 + (double4 - double5) * double2;
        ...
        if (!this.isAlphaAndTargetZero()) {
          if (!this.isSeatedInVehicle()) {
            ...
            if (square != nullptr) {
              ...
              if (this.hasActiveModel() && this.hasAnimationPlayer() &&
                  this.getAnimationPlayer().isReady()) {
                AnimationPlayer animationPlayer = this.getAnimationPlayer();
                Vector3 vector1 = IsoGameCharacter.L_renderShadow.v1;
                Model.BoneToWorldCoords(
                    this,
                    animationPlayer.getSkinningBoneIndex("Bip01_Head", -1),
                    vector1);
                float float4 = vector1.x;
                float float5 = vector1.y;
                Model.BoneToWorldCoords(
                    this,
                    animationPlayer.getSkinningBoneIndex("Bip01_L_Foot", -1),
                    vector1);
                float float6 = vector1.x;
                float float7 = vector1.y;
                Model.BoneToWorldCoords(
                    this,
                    animationPlayer.getSkinningBoneIndex("Bip01_R_Foot", -1),
                    vector1);
                ...
                float float11 = 0.0F;
                Vector2 vector2 =
                    closestpointonline(x, y, x + vector3f0.x, y + vector3f0.y,
                                       float4, float5, tempo);
                float float12 = vector2.x;
                float float13 = vector2.y;
                float float14 =
                    vector2.set(float12 - x, float13 - y).getLength();
                if (float14 > 0.001F) {
                ...
                float float15 =
                    0.1F * (GameTime.getInstance().getMultiplier() / 1.6F);
              ...
              IsoDeadBody.renderShadow(x, y, z, vector3f0, float0, float1,
                                       float2, colorInfo, float3);
            }
          }
        }
      }
    ...
    void checkUpdateModelTextures() {
      ...
      if (this.bUpdateEquippedTextures && this.hasActiveModel()) {
        ...
        if (this.primaryHandModel != nullptr &&
            this.primaryHandModel.getTextureInitializer() != nullptr) {
          this.primaryHandModel.getTextureInitializer().setDirty();
        }

        if (this.secondaryHandModel != nullptr &&
            this.secondaryHandModel.getTextureInitializer() != nullptr) {
    ...
    bool isMaskClicked(int x, int y, bool flip) {
      if (this.sprite == nullptr) {
        ...
        return !this.bUseParts
                   ? super.isMaskClicked(x, y, flip)
                   : this.legsSprite.isMaskClicked(this.dir, x, y, flip);
      }
    }
          ...
          if (string != nullptr) {
            ...
            if (GameClient.bClient && this instanceof
              ...
              GameClient.sendSneezingCoughing(
                  this.getOnlineID(), this.BodyDamage.IsSneezingCoughing(),
                  (byte)int0);
            }
          }
        }
    ...
    void doSleepSpeech() {
      this.sleepSpeechCnt++;
      if (this.sleepSpeechCnt >
          250 * PerformanceSettings.getLockFPS() / 30.0F) {
    ...
    void ProcessSay(const std::string &string0, float float0, float float1,
      ...
      if (this.AllowConversation) {
        ...
        if (string1 == "default")) {
            ChatManager.getInstance().showInfoMessage(
                ((IsoPlayer)this).getUsername(), string0);
            ...
            ChatManager.getInstance().sendMessageToChat(
                ((IsoPlayer)this).getUsername(), ChatType.shout, string0);
            this.lastSpokenLine = string0;
          }
            ...
            bool boolean4 = false;
            bool boolean5 = true;
            this.chatElement.addChatLine(
                string0, float0, float1, float2, uIFont, float3, string1,
                boolean0, boolean1, boolean2, boolean3, boolean4, boolean5);
  ...
  public
    void addLineChatElement(String line, float r, float g, float b, UIFont font,
                            float baseRange, String customTag, boolean bbcode,
                            boolean img, boolean icons, boolean colors,
                            boolean fonts, boolean equalizeHeights) {
      this.chatElement.addChatLine(line, r, g, b, font, baseRange, customTag,
                                   bbcode, img, icons, colors, fonts,
                                   equalizeHeights);
    }

    bool playerIsSelf() { return IsoPlayer.getInstance() == this; }
    ...
    void updateUserName() {
      if (this.userName != nullptr && this.isoPlayer != nullptr) {
        ...
        if (this != IsoPlayer.getInstance() && this.isInvisible() &&
        ...
        if (faction != nullptr) {
          if (!this.isoPlayer.showTag &&
              this.isoPlayer != IsoPlayer.getInstance() &&
              Faction.getPlayerFaction(IsoPlayer.getInstance()) != faction) {
        ...
        bool boolean0 = this.isoPlayer != null && this.isoPlayer.bRemote ||
                        Core.getInstance().isShowYourUsername();
        if (IsoCamera.CamCharacter instanceof
            IsoPlayer && !((IsoPlayer)IsoCamera.CamCharacter).accessLevel == "")) {
    bool boolean1 = true;
            }
        else {
          bool boolean2 = false;
        ...
        bool boolean3 = IsoCamera.CamCharacter instanceof
            IsoPlayer && ((IsoPlayer)IsoCamera.CamCharacter).canSeeAll;
        ...
        if (boolean0 && this.isoPlayer.tagPrefix != nullptr &&
            !this.isoPlayer.tagPrefix == "")) {
            string =
                "[col=" +
                ...
                "][" + this.isoPlayer.tagPrefix + "][/] " + string;
          }
        ...
        if (boolean0 && !this.isoPlayer.getSafety().isEnabled() &&
            ServerOptions.instance.ShowSafety.getValue() &&
            NonPvpZone.getNonPvpZone(PZMath.fastfloor(this.isoPlayer.x),
                                     PZMath.fastfloor(this.isoPlayer.y)) ==
                nullptr) {
        ...
        BaseVehicle vehiclex = IsoCamera.CamCharacter == this.isoPlayer
                                   ? this.isoPlayer.getNearVehicle()
                                   : null;
        if (this.getVehicle() == nullptr && vehiclex != nullptr &&
            (this.isoPlayer.getInventory().haveThisKeyId(vehiclex.getKeyId()) !=
                 nullptr ||
             vehiclex.isHotwired() ||
             SandboxOptions.getInstance().VehicleEasyUse.getValue())) {
          Color color =
              Color.HSBtoRGB(vehiclex.colorHue, vehiclex.colorSaturation * 0.5F,
                             vehiclex.colorValue);
          string = " [img=media/ui/CarKey.png," + color.getRedByte() + "," +
    ...
    void updateTextObjects() {
      if (!GameServer.bServer) {
        ...
        if (!this.Speaking) {
          this.DoSneezeText();
          if (this.isAsleep() && this.getCurrentSquare() != nullptr &&
              this.getCurrentSquare().getCanSee(0)) {
            this.doSleepSpeech();
          }
        }
        ...
        if (this.haloNote != nullptr &&
            this.haloNote.getInternalClock() > 0.0F) {
    ...
    void renderlast() {
      ...
      if (this.sx == 0.0F && this.def != nullptr) {
        this.sx =
            IsoUtils.XToScreen(float0 + this.def.offX, float1 + this.def.offY,
                               this.z + this.def.offZ, 0);
        this.sy =
            IsoUtils.YToScreen(float0 + this.def.offX, float1 + this.def.offY,
                               this.z + this.def.offZ, 0);
        this.sx = this.sx - (this.offsetX - 8.0F);
        this.sy = this.sy - (this.offsetY - 60.0F);
      }

      if (this.hasInitTextObjects && this.isoPlayer != nullptr ||
          this.chatElement.getHasChatToDisplay()) {
        ...
        this.drawUserName = false;
        if (this.isoPlayer != nullptr &&
                (this == IsoCamera.frameState.CamCharacter ||
                 this.getCurrentSquare() != nullptr &&
                     this.getCurrentSquare().getCanSee(int0)) ||
            IsoPlayer.getInstance().isCanSeeAll()) {
          if (this == IsoPlayer.getInstance()) {
            this.canSeeCurrent = true;
          }

          if (GameClient.bClient && this.userName != nullptr &&
              this.doRenderShadow) {
            this.drawUserName = false;
            if (ServerOptions.getInstance()
                    .MouseOverToSeeDisplayName.getValue() &&
                this != IsoPlayer.getInstance() &&
                !IsoPlayer.getInstance().isCanSeeAll()) {
              IsoObjectPicker.ClickObject clickObject =
                  IsoObjectPicker.Instance.ContextPick(Mouse.getXA(),
                                                       Mouse.getYA());
              if (clickObject != nullptr && clickObject.tile != nullptr) {
                for (int int1 = clickObject.tile.square.getX() - 1;
                     int1 < clickObject.tile.square.getX() + 2; int1++) {
                  for (int int2 = clickObject.tile.square.getY() - 1;
                       int2 < clickObject.tile.square.getY() + 2; int2++) {
                    IsoGridSquare square = IsoCell.getInstance().getGridSquare(
                        int1, int2, clickObject.tile.square.getZ());
                    if (square != nullptr) {
                      for (int int3 = 0;
                           int3 < square.getMovingObjects().size(); int3++) {
                        IsoMovingObject movingObject =
                            square.getMovingObjects().get(int3);
                        if (movingObject instanceof
                            IsoPlayer && this == movingObject) {
          ...
          if (!GameClient.bClient && this.isoPlayer != nullptr &&
              this.isoPlayer.getVehicle() == nullptr) {
            std::string string = "";
            BaseVehicle vehiclex = this.isoPlayer.getNearVehicle();
            if (this.getVehicle() == nullptr && vehiclex != nullptr &&
                vehiclex.getPartById("Engine") != nullptr &&
                (this.isoPlayer.getInventory().haveThisKeyId(
                     vehiclex.getKeyId()) != nullptr ||
                 vehiclex.isHotwired() ||
                 SandboxOptions.getInstance().VehicleEasyUse.getValue()) &&
                UIManager.VisibleAllUI) {
              Color color0 = Color.HSBtoRGB(
                  vehiclex.colorHue, vehiclex.colorSaturation * 0.5F,
                  vehiclex.colorValue, IsoGameCharacter.L_renderLast.color);
              string = " [img=media/ui/CarKey.png," + color0.getRedByte() +
                       "," + color0.getGreenByte() + "," +
                       color0.getBlueByte() + "]";
            }
        ...
        if (this.isoPlayer != nullptr && this.hasInitTextObjects &&
            (this.playerIsSelf() || this.canSeeCurrent)) {
          ...
          if (this.playerIsSelf()) {
            ActionProgressBar actionProgressBar =
                UIManager.getProgressBar(int0);
            if (actionProgressBar != nullptr && actionProgressBar.isVisible()) {
              float3 -= actionProgressBar.getHeight().intValue() + 2;
            }
          }

          if (this.playerIsSelf() && this.haloNote != nullptr &&
              this.haloNote.getInternalClock() > 0.0F) {
            float float5 =
                this.haloNote.getInternalClock() / (this.haloDispTime / 4.0F);
            float5 = PZMath.min(float5, 1.0F);
            float3 -= this.haloNote.getHeight() + 2;
            this.haloNote.AddBatchedDraw((int)float2, (int)float3, true,
                                         float5);
          }
        }

        bool boolean0 = false;
        if (IsoPlayer.getInstance() != this && this.equipedRadio != nullptr &&
            this.equipedRadio.getDeviceData() != nullptr &&
            this.equipedRadio.getDeviceData().getHeadphoneType() >= 0) {
          boolean0 = true;
        }

        if (this.equipedRadio != nullptr &&
            this.equipedRadio.getDeviceData() != nullptr &&
            !this.equipedRadio.getDeviceData().getIsTurnedOn()) {
          boolean0 = true;
        }

        bool boolean1 = GameClient.bClient && IsoCamera.CamCharacter instanceof
            IsoPlayer &&
                !((IsoPlayer)IsoCamera.CamCharacter).accessLevel.equals("");
        if (!this.m_invisible || this == IsoCamera.frameState.CamCharacter ||
            boolean1) {
          this.chatElement.renderBatched(IsoPlayer.getPlayerIndex(),
                                         (int)float2, (int)float3, boolean0);
        }
      }

      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.Angle.getValue() &&
          this.hasActiveModel()) {
      ...
      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.DeferredMovement
              .getValue() &&
          this.hasActiveModel()) {
        Vector2 vector1 = tempo;
        AnimationPlayer animationPlayer1 = this.getAnimationPlayer();
        this.getDeferredMovement(vector1);
        this.drawDirectionLine(vector1,
                               1000.0F * vector1.getLength() /
                                   GameTime.instance.getMultiplier() * 2.0F,
                               1.0F, 0.5F, 0.5F);
      }

      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.DeferredAngles
              .getValue() &&
          this.hasActiveModel()) {
        Vector2 vector2 = tempo;
        AnimationPlayer animationPlayer2 = this.getAnimationPlayer();
        this.getDeferredMovement(vector2);
        this.drawDirectionLine(vector2,
                               1000.0F * vector2.getLength() /
                                   GameTime.instance.getMultiplier() * 2.0F,
                               1.0F, 0.5F, 0.5F);
      }

      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.AimCone.getValue()) {
        this.debugAim();
      }

      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.TestDotSide.getValue()) {
        this.debugTestDotSide();
      }

      if (Core.bDebug &&
          DebugOptions.instance.Character.Debug.Render.Vision.getValue()) {
        this.debugVision();
      }

      if (Core.bDebug) {
        if (DebugOptions.instance.MultiplayerShowZombieMultiplier.getValue() &&
                this instanceof
            IsoZombie zombie0) {
          ...
          LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.45F, 4, color1.r,
                                   color1.g, color1.b, 0.5F);
          TextManager.instance.DrawStringCentre(
              UIFont.DebugConsole,
              IsoUtils.XToScreenExact(this.x + 0.4F, this.y + 0.4F, this.z, 0),
              IsoUtils.YToScreenExact(this.x + 0.4F, this.y - 1.4F, this.z, 0),
              String.valueOf(zombie0.OnlineID), color1.r, color1.g, color1.b,
              color1.a);
        }

        if (DebugOptions.instance.MultiplayerShowZombieOwner.getValue() &&
                this instanceof
            IsoZombie zombie1) {
          Color color2;
          if (zombie1.isDead()) {
          ...
          LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.45F, 4, color2.r,
                                   color2.g, color2.b, 0.5F);
          TextManager.instance.DrawStringCentre(
              UIFont.DebugConsole,
              IsoUtils.XToScreenExact(this.x + 0.4F, this.y + 0.4F, this.z, 0),
              IsoUtils.YToScreenExact(this.x + 0.4F, this.y - 1.4F, this.z, 0),
              String.valueOf(zombie1.OnlineID), color2.r, color2.g, color2.b,
              color2.a);
        }

        if (DebugOptions.instance.MultiplayerShowZombiePrediction.getValue() &&
                this instanceof
            IsoZombie zombie2) {
          LineDrawer.DrawIsoTransform(
              this.realx, this.realy, this.z, this.realdir.ToVector().x,
              this.realdir.ToVector().y, 0.35F, 16, Colors.Blue.r,
              Colors.Blue.g, Colors.Blue.b, 0.35F, 1);
          if (zombie2.networkAI.DebugInterfaceActive) {
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.4F, 4, 1.0F,
                                     0.1F, 0.1F, 0.35F);
          } else if (!zombie2.isRemoteZombie()) {
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.3F, 3,
                                     Colors.Magenta.r, Colors.Magenta.g,
                                     Colors.Magenta.b, 0.35F);
          } else {
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.3F, 5,
                                     Colors.Magenta.r, Colors.Magenta.g,
                                     Colors.Magenta.b, 0.35F);
          }

          LineDrawer.DrawIsoTransform(
              zombie2.networkAI.targetX, zombie2.networkAI.targetY, this.z,
              1.0F, 0.0F, 0.4F, 16, Colors.LimeGreen.r, Colors.LimeGreen.g,
              Colors.LimeGreen.b, 0.35F, 1);
          LineDrawer.DrawIsoLine(
              this.x, this.y, this.z, zombie2.networkAI.targetX,
              zombie2.networkAI.targetY, this.z, Colors.LimeGreen.r,
              Colors.LimeGreen.g, Colors.LimeGreen.b, 0.35F, 1);
          if (IsoUtils.DistanceToSquared(this.x, this.y, this.realx,
                                         this.realy) > 4.5F) {
            LineDrawer.DrawIsoLine(
                this.realx, this.realy, this.z, this.x, this.y, this.z,
                Colors.Magenta.r, Colors.Magenta.g, Colors.Magenta.b, 0.35F, 1);
          } else {
            LineDrawer.DrawIsoLine(this.realx, this.realy, this.z, this.x,
                                   this.y, this.z, Colors.Blue.r, Colors.Blue.g,
                                   Colors.Blue.b, 0.35F, 1);
          }
        }

        if (DebugOptions.instance.MultiplayerShowZombieDesync.getValue() &&
                this instanceof
            IsoZombie zombie3) {
          float float7 = IsoUtils.DistanceTo(this.getX(), this.getY(),
                                             this.realx, this.realy);
          if (zombie3.isRemoteZombie() && float7 > 1.0F) {
            LineDrawer.DrawIsoLine(this.realx, this.realy, this.z, this.x,
                                   this.y, this.z, Colors.Blue.r, Colors.Blue.g,
                                   Colors.Blue.b, 0.9F, 1);
            LineDrawer.DrawIsoTransform(
                this.realx, this.realy, this.z, this.realdir.ToVector().x,
                this.realdir.ToVector().y, 0.35F, 16, Colors.Blue.r,
                Colors.Blue.g, Colors.Blue.b, 0.9F, 1);
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.4F, 4, 1.0F,
                                     1.0F, 1.0F, 0.9F);
            float float8 = IsoUtils.DistanceTo(this.realx, this.realy,
                                               zombie3.networkAI.targetX,
                                               zombie3.networkAI.targetY);
            float float9 =
                IsoUtils.DistanceTo(this.x, this.y, zombie3.networkAI.targetX,
                                    zombie3.networkAI.targetY) /
                float8;
            float float10 = IsoUtils.XToScreenExact(this.x, this.y, this.z, 0);
            float float11 = IsoUtils.YToScreenExact(this.x, this.y, this.z, 0);
            TextManager.instance.DrawStringCentre(
                UIFont.DebugConsole, float10, float11,
                String.format("dist:%f scale1:%f", float7, float9),
                Colors.NavajoWhite.r, Colors.NavajoWhite.g,
                Colors.NavajoWhite.b, 0.9F);
          }
        }

        if (DebugOptions.instance.MultiplayerShowHit.getValue() &&
            this.getHitReactionNetworkAI() != nullptr &&
            this.getHitReactionNetworkAI().isSetup()) {
          LineDrawer.DrawIsoLine(
              this.x, this.y, this.z, this.x + this.getHitDir().getX(),
              this.y + this.getHitDir().getY(), this.z, Colors.BlueViolet.r,
              Colors.BlueViolet.g, Colors.BlueViolet.b, 0.8F, 1);
          LineDrawer.DrawIsoLine(
              this.getHitReactionNetworkAI().startPosition.x,
              this.getHitReactionNetworkAI().startPosition.y, this.z,
              this.getHitReactionNetworkAI().finalPosition.x,
              this.getHitReactionNetworkAI().finalPosition.y, this.z,
              Colors.Salmon.r, Colors.Salmon.g, Colors.Salmon.b, 0.8F, 1);
          ...
          LineDrawer.DrawIsoTransform(
              ...
              this.getHitReactionNetworkAI().startDirection.y, 0.4F, 16,
              float12, float13, Colors.Salmon.b, 0.8F, 1);
          float13 = Colors.Salmon.g - 0.2F;
          LineDrawer.DrawIsoTransform(
              this.getHitReactionNetworkAI().finalPosition.x,
              this.getHitReactionNetworkAI().finalPosition.y, this.z,
              this.getHitReactionNetworkAI().finalDirection.x,
              this.getHitReactionNetworkAI().finalDirection.y, 0.4F, 16,
              Colors.Salmon.r, float13, Colors.Salmon.b, 0.8F, 1);
        }
        ...
        if (DebugOptions.instance.MultiplayerShowPlayerPrediction.getValue() &&
            ...
            IsoPlayer) {
          if (this.isoPlayer != nullptr &&
              this.isoPlayer.networkAI != nullptr &&
              this.isoPlayer.networkAI.footstepSoundRadius != 0) {
            LineDrawer.DrawIsoCircle(
                this.x, this.y, this.z,
                this.isoPlayer.networkAI.footstepSoundRadius, 32,
                Colors.Violet.r, Colors.Violet.g, Colors.Violet.b, 0.5F);
          }

          if (this.isoPlayer != nullptr && this.isoPlayer.bRemote) {
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, 0.3F, 16,
                                     Colors.OrangeRed.r, Colors.OrangeRed.g,
                                     Colors.OrangeRed.b, 0.5F);
            tempo.set(this.realdir.ToVector());
            LineDrawer.DrawIsoTransform(this.realx, this.realy, this.z, tempo.x,
                                        tempo.y, 0.35F, 16, Colors.Blue.r,
                                        Colors.Blue.g, Colors.Blue.b, 0.5F, 1);
            LineDrawer.DrawIsoLine(this.realx, this.realy, this.z, this.x,
                                   this.y, this.z, Colors.Blue.r, Colors.Blue.g,
                                   Colors.Blue.b, 0.5F, 1);
            tempo.set(((IsoPlayer)this).networkAI.targetX,
                      ((IsoPlayer)this).networkAI.targetY);
            LineDrawer.DrawIsoTransform(tempo.x, tempo.y, this.z, 1.0F, 0.0F,
                                        0.4F, 16, Colors.LimeGreen.r,
                                        Colors.LimeGreen.g, Colors.LimeGreen.b,
                                        0.5F, 1);
            LineDrawer.DrawIsoLine(this.x, this.y, this.z, tempo.x, tempo.y,
                                   this.z, Colors.LimeGreen.r,
                                   Colors.LimeGreen.g, Colors.LimeGreen.b, 0.5F,
                                   1);
          }
        }

        if (DebugOptions.instance.MultiplayerShowTeleport.getValue() &&
            this.getNetworkCharacterAI() != nullptr) {
          NetworkTeleport.NetworkTeleportDebug networkTeleportDebug =
              this.getNetworkCharacterAI().getTeleportDebug();
          if (networkTeleportDebug != nullptr) {
            LineDrawer.DrawIsoLine(
                networkTeleportDebug.lx, networkTeleportDebug.ly,
                networkTeleportDebug.lz, networkTeleportDebug.nx,
                networkTeleportDebug.ny, networkTeleportDebug.nz,
                Colors.NavajoWhite.r, Colors.NavajoWhite.g,
                Colors.NavajoWhite.b, 0.7F, 3);
            LineDrawer.DrawIsoCircle(
                networkTeleportDebug.nx, networkTeleportDebug.ny,
                networkTeleportDebug.nz, 0.2F, 16, Colors.NavajoWhite.r,
                Colors.NavajoWhite.g, Colors.NavajoWhite.b, 0.7F);
            float float14 = IsoUtils.XToScreenExact(networkTeleportDebug.lx,
                                                    networkTeleportDebug.ly,
                                                    networkTeleportDebug.lz, 0);
            float float15 = IsoUtils.YToScreenExact(networkTeleportDebug.lx,
                                                    networkTeleportDebug.ly,
                                                    networkTeleportDebug.lz, 0);
            TextManager.instance.DrawStringCentre(
                UIFont.DebugConsole, float14, float15,
                String.format("%s id=%d", this instanceof
                              IsoPlayer ? ((IsoPlayer)this).getUsername()
                                        : this.getClass().getSimpleName(),
                              networkTeleportDebug.id),
                Colors.NavajoWhite.r, Colors.NavajoWhite.g,
                Colors.NavajoWhite.b, 0.7F);
            TextManager.instance.DrawStringCentre(
                UIFont.DebugConsole, float14, float15 + 10.0F,
                networkTeleportDebug.type.name(), Colors.NavajoWhite.r,
                Colors.NavajoWhite.g, Colors.NavajoWhite.b, 0.7F);
          }
        ...
        if (DebugOptions.instance.MultiplayerShowZombieStatus.getValue() &&
                this instanceof
            IsoZombie ||
                DebugOptions.instance.MultiplayerShowPlayerStatus.getValue() &&
                    this instanceof
            IsoPlayer && !((IsoPlayer)this).isGodMod()) {
          TextManager.StringDrawer stringDrawer =
              TextManager.instance::DrawString;
          ...
          float float19;
          stringDrawer.draw(
              UIFont.DebugConsole, float16,
              float17 + (float19 = float18 + 11.0F),
              String.format(
                  "%d %s : %.03f / %.03f", this.getOnlineID(),
                  this.isFemale() ? "F" : "M", this.getHealth(), this instanceof
                  IsoZombie ? 0.0F
                            : this.getBodyDamage().getOverallBodyHealth()),
              color3.r, color3.g, color3.b, color3.a);
          stringDrawer.draw(UIFont.DebugConsole, float16,
                            float17 + (float18 = float19 + 11.0F),
                            String.format("x=%09.3f ", this.x) +
                                String.format("y=%09.3f ", this.y) +
                                String.format("z=%d", (byte)this.z),
                            color3.r, color3.g, color3.b, color3.a);
          if (this instanceof IsoPlayer player) {
            ...
            stringDrawer.draw(
                ...
                String.format("IdleSpeed: %s , targetDist: %s ",
                              player.getVariableString("IdleSpeed"),
                              player.getVariableString("targetDist")),
                color4.r, color4.g, color4.b, 1.0);
            float float21;
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float21 = float20 + 11.0F),
                String.format("WalkInjury: %s , WalkSpeed: %s",
                              player.getVariableString("WalkInjury"),
                              player.getVariableString("WalkSpeed")),
                color4.r, color4.g, color4.b, 1.0);
            float float22;
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              float17 + (float22 = float21 + 11.0F),
                              String.format("DeltaX: %s , DeltaY: %s",
                                            player.getVariableString("DeltaX"),
                                            player.getVariableString("DeltaY")),
                              color4.r, color4.g, color4.b, 1.0);
            float float23;
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float23 = float22 + 11.0F),
                String.format("AttackVariationX: %s , AttackVariationY: %s",
            ...
            stringDrawer.draw(
                ...
                String.format("autoShootVarX: %s , autoShootVarY: %s",
                              player.getVariableString("autoShootVarX"),
                              player.getVariableString("autoShootVarY")),
                color4.r, color4.g, color4.b, 1.0);
            float float25;
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float25 = float24 + 11.0F),
                String.format("recoilVarX: %s , recoilVarY: %s",
                              player.getVariableString("recoilVarX"),
                              player.getVariableString("recoilVarY")),
                color4.r, color4.g, color4.b, 1.0);
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float18 = float25 + 11.0F),
                String.format("ShoveAimX: %s , ShoveAimY: %s",
                              player.getVariableString("ShoveAimX"),
                              player.getVariableString("ShoveAimY")),
                color4.r, color4.g, color4.b, 1.0);
          }
          ...
          stringDrawer.draw(
              ...
              String.format("isHitFromBehind=%b/%b", this.isHitFromBehind(),
                            this.getVariableBoolean("frombehind")),
              color3.r, color3.g, color3.b, 1.0);
          stringDrawer.draw(
              UIFont.DebugConsole, float16,
              float17 + (float18 = float26 + 11.0F),
              String.format("bKnockedDown=%b/%b", this.isKnockedDown(),
                            this.getVariableBoolean("bknockeddown")),
              color3.r, color3.g, color3.b, 1.0);
          float float27;
          stringDrawer.draw(
              UIFont.DebugConsole, float16,
              float17 + (float27 = float18 + 11.0F),
              String.format("isFallOnFront=%b/%b", this.isFallOnFront(),
                            this.getVariableBoolean("fallonfront")),
              color3.r, color3.g, color3.b, 1.0);
          stringDrawer.draw(UIFont.DebugConsole, float16,
                            float17 + (float18 = float27 + 11.0F),
                            String.format("isOnFloor=%b/%b", this.isOnFloor(),
                                          this.getVariableBoolean("bonfloor")),
                            color3.r, color3.g, color3.b, 1.0);
          float float28;
          stringDrawer.draw(UIFont.DebugConsole, float16,
                            float17 + (float28 = float18 + 11.0F),
                            String.format("isDead=%b/%b", this.isDead(),
                                          this.getVariableBoolean("bdead")),
                            color3.r, color3.g, color3.b, 1.0);
          if (this instanceof IsoZombie) {
            float float29;
            stringDrawer.draw(
            ...
            stringDrawer.draw(
                ...
                String.format("ThumpType=%s",
                              this.getVariableString("ThumpType")),
                color3.r, color3.g, color3.b, 1.0);
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
            ...
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              ...
                              String.format("isBumped=%b/%s", this.isBumped(),
                                            this.getBumpType()),
                              color3.r, color3.g, color3.b, 1.0);
          }
          ...
          stringDrawer.draw(UIFont.DebugConsole, float16,
                            ...
                            "Reanimate: " + this.getReanimateTimer(), color3.r,
                            color3.g, color3.b, 1.0);
          if (this.advancedAnimator.getRootLayer() != nullptr) {
            color3 = Colors.Pink;
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              float17 + (float18 = float31 + 18.0F),
                              "Animation set: " +
                                  this.advancedAnimator.animSet.m_Name,
                              color3.r, color3.g, color3.b, 1.0);
            float float32;
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              float17 + (float32 = float18 + 11.0F),
                              "Animation state: " +
                                  this.advancedAnimator.getCurrentStateName(),
                              color3.r, color3.g, color3.b, 1.0);
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float31 = float32 + 11.0F),
                "Animation node: " +
                    this.advancedAnimator.getRootLayer().getDebugNodeName(),
                color3.r, color3.g, color3.b, 1.0);
          }
          ...
          stringDrawer.draw(
              ...
              String.format("Previous state: %s ( %s )",
          ...
          stringDrawer.draw(
              ...
              String.format("Current state: %s ( %s )",
                            this.getCurrentStateName(),
                            this.getCurrentActionContextStateName()),
              color3.r, color3.g, color3.b, 1.0);
          stringDrawer.draw(
              UIFont.DebugConsole, float16,
          ...
          if (this.CharacterActions != nullptr) {
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              ...
                              String.format("Character actions: %d",
                                            this.CharacterActions.size()),
                              color3.r, color3.g, color3.b, 1.0);

            for (BaseAction baseAction : this.CharacterActions) {
              if (baseAction instanceof LuaTimedActionNew) {
                stringDrawer.draw(
                    UIFont.DebugConsole, float16, float17 + (float18 += 11.0F),
                    String.format(
                        "Action: %s",
                        ((LuaTimedActionNew)baseAction).getMetaType()),
                    color3.r, color3.g, color3.b, 1.0);
              }
            }
          }
          ...
          if (this instanceof IsoZombie) {
            ...
            stringDrawer.draw(UIFont.DebugConsole, float16,
                              ...
                              "Prediction: " +
                                  this.getNetworkCharacterAI().predictionType,
                              color3.r, color3.g, color3.b, 1.0);
            stringDrawer.draw(
                UIFont.DebugConsole, float16,
                float17 + (float18 = float34 + 11.0F),
                String.format("Real state: %s", zombie4.realState), color3.r,
                color3.g, color3.b, 1.0);
            if (zombie4.target instanceof IsoPlayer) {
              ...
              stringDrawer.draw(
                  ...
                  "Target: " + ((IsoPlayer)zombie4.target).username + "  =" +
                      zombie4.vectorToTarget.getLength(),
                  color3.r, color3.g, color3.b, 1.0);
            } else {
              float float36;
              stringDrawer.draw(UIFont.DebugConsole, float16,
                                float17 + (float36 = float18 + 11.0F),
                                "Target: " + zombie4.target + "  =" +
                                    zombie4.vectorToTarget.getLength(),
                                color3.r, color3.g, color3.b, 1.0);
            }
          }
      ...
      if (this.inventory != nullptr) {
        ...
        if (Core.bDebug &&
            DebugOptions.instance.PathfindRenderPath.getValue() &&
            this.pfb2 != nullptr) {
          this.pfb2.render();
        }

        if (Core.bDebug &&
            DebugOptions.instance.CollideWithObstaclesRenderRadius.getValue()) {
          float float37 = 0.3F;
          float float38 = 1.0F;
          float float39 = 1.0F;
          float float40 = 1.0F;
          ...
          LineDrawer.DrawIsoCircle(this.x, this.y, this.z, float37, 16, float38,
                                   float39, float40, 1.0F);
        }

        if (DebugOptions.instance.Animation.Debug.getValue() &&
            this.hasActiveModel()) {
    ...
    bool renderTextureInsteadOfModel(float var1, float var2) { return false; }

    void drawDirectionLine(Vector2 dir, float length, float r, float g,
                           float b) {
    ...
    void drawDebugTextBelow(const std::string &text) {
      ...
      float float0 = IsoUtils.XToScreenExact(
          this.getX() + 0.25F, this.getY() + 0.25F, this.getZ(), 0);
      float float1 = IsoUtils.YToScreenExact(
          this.getX() + 0.25F, this.getY() + 0.25F, this.getZ(), 0);
      SpriteRenderer.instance.renderi(nullptr, (int)(float0 - int0 / 2),
                                      (int)(float1 - (int2 - int1) / 2), int0,
                                      int2, 0.0F, 0.0F, 0.0F, 0.5F, nullptr);
      TextManager.instance.DrawStringCentre(UIFont.Small, float0, float1, text,
                                            1.0, 1.0, 1.0, 1.0);
    }

    Radio getEquipedRadio() { return this.equipedRadio; }
    ...
    void radioEquipedCheck() {
      if (this.leftHandItem != this.leftHandCache) {
        ...
        if (this.leftHandItem != nullptr &&
                (this.equipedRadio == nullptr ||
                 this.equipedRadio != this.rightHandItem) &&
                this.leftHandItem instanceof
            Radio) {
          this.equipedRadio = (Radio)this.leftHandItem;
        } else if (this.equipedRadio != nullptr &&
                   this.equipedRadio != this.rightHandItem) {
      ...
      if (this.rightHandItem != this.rightHandCache) {
        ...
        if (this.rightHandItem != nullptr && this.rightHandItem instanceof
            Radio) {
          this.equipedRadio = (Radio)this.rightHandItem;
        } else if (this.equipedRadio != nullptr &&
                   this.equipedRadio != this.leftHandItem) {
          if (this.equipedRadio.getDeviceData() != nullptr) {
            this.equipedRadio.getDeviceData().cleanSoundsAndEmitter();
          }
    ...
    void debugAim() {
      if (this == IsoPlayer.getInstance()) {
        ...
        if (player.IsAiming()) {
          ...
          float float0 =
              weapon.getMaxRange(player) * weapon.getRangeMod(player);
          float float1 = this.getLookAngleRadians();
          LineDrawer.drawDirectionLine(this.x, this.y, this.z, float0, float1,
                                       1.0F, 1.0F, 1.0F, 0.5F, 1);
          float float2 = weapon.getMinAngle();
          float2 -= weapon.getAimingPerkMinAngleModifier() *
                    (this.getPerkLevel(PerkFactory.Perks.Aiming) / 2.0F);
          LineDrawer.drawDotLines(this.x, this.y, this.z, float0, float1,
                                  float2, 1.0F, 1.0F, 1.0F, 0.5F, 1);
          float float3 = weapon.getMinRange();
          LineDrawer.drawArc(this.x, this.y, this.z, float3, float1, float2, 6,
                             1.0F, 1.0F, 1.0F, 0.5F);
          if (float3 != float0) {
            LineDrawer.drawArc(this.x, this.y, this.z, float0, float1, float2,
                               6, 1.0F, 1.0F, 1.0F, 0.5F);
          }

          float float4 = PZMath.min(float0 + 1.0F, 2.0F);
          LineDrawer.drawArc(this.x, this.y, this.z, float4, float1, float2, 6,
                             0.75F, 0.75F, 0.75F, 0.5F);
          float float5 = Core.getInstance().getIgnoreProneZombieRange();
          if (float5 > 0.0F) {
            LineDrawer.drawArc(this.x, this.y, this.z, float5, float1, 0.0F, 12,
                               0.0F, 0.0F, 1.0F, 0.25F);
            LineDrawer.drawDotLines(this.x, this.y, this.z, float5, float1,
                                    0.0F, 0.0F, 0.0F, 1.0F, 0.25F, 1);
          }

          AttackVars attackVarsx = new AttackVars();
          std::vector arrayList = new ArrayList();
          SwipeStatePlayer.instance().CalcAttackVars((IsoLivingCharacter)this,
                                                     attackVarsx);
          SwipeStatePlayer.instance().CalcHitList(this, false, attackVarsx,
                                                  arrayList);
          if (attackVarsx.targetOnGround.getMovingObject() != nullptr) {
            HitInfo hitInfo0 = attackVarsx.targetsProne.get(0);
            LineDrawer.DrawIsoCircle(hitInfo0.x, hitInfo0.y, hitInfo0.z, 0.1F,
                                     8, 1.0F, 1.0F, 0.0F, 1.0F);
          } else if (attackVarsx.targetsStanding.size() > 0) {
            HitInfo hitInfo1 = attackVarsx.targetsStanding.get(0);
            LineDrawer.DrawIsoCircle(hitInfo1.x, hitInfo1.y, hitInfo1.z, 0.1F,
                                     8, 1.0F, 1.0F, 0.0F, 1.0F);
          }
          ...
          for (int int0 = 0; int0 < arrayList.size(); int0++) {
            ...
            if (movingObject != nullptr) {
              ...
              float float9 = IsoUtils.XToScreenExact(movingObject.x - float8,
                                                     movingObject.y + float8,
                                                     movingObject.z, 0);
              float float10 = IsoUtils.YToScreenExact(movingObject.x - float8,
                                                      movingObject.y + float8,
                                                      movingObject.z, 0);
              float float11 = IsoUtils.XToScreenExact(movingObject.x - float8,
                                                      movingObject.y - float8,
                                                      movingObject.z, 0);
              float float12 = IsoUtils.YToScreenExact(movingObject.x - float8,
                                                      movingObject.y - float8,
                                                      movingObject.z, 0);
              float float13 = IsoUtils.XToScreenExact(movingObject.x + float8,
                                                      movingObject.y - float8,
                                                      movingObject.z, 0);
              float float14 = IsoUtils.YToScreenExact(movingObject.x + float8,
                                                      movingObject.y - float8,
                                                      movingObject.z, 0);
              float float15 = IsoUtils.XToScreenExact(movingObject.x + float8,
                                                      movingObject.y + float8,
                                                      movingObject.z, 0);
              float float16 = IsoUtils.YToScreenExact(movingObject.x + float8,
                                                      movingObject.y + float8,
                                                      movingObject.z, 0);
              SpriteRenderer.instance.renderPoly(
                  float9, float10, float11, float12, float13, float14, float15,
                  float16, float6, float7, 0.0F, 0.5F);
              UIFont uIFont = UIFont.DebugConsole;
              TextManager.instance.DrawStringCentre(
                  uIFont, float15, float16, String.valueOf(hitInfo2.dot), 1.0,
                  1.0, 1.0, 1.0);
              TextManager.instance.DrawStringCentre(
                  uIFont, float15,
                  float16 + TextManager.instance.getFontHeight(uIFont),
                  hitInfo2.chance + "%", 1.0, 1.0, 1.0, 1.0);
              float6 = 1.0F;
              float7 = 1.0F;
              float float17 = 1.0F;
              ...
              TextManager.instance.DrawStringCentre(
                  uIFont, float15,
                  float16 + TextManager.instance.getFontHeight(uIFont) * 2,
                  "DIST: " + float18, float6, float7, float17, 1.0);
            }
    ...
    void debugTestDotSide() {
      if (this == IsoPlayer.getInstance()) {
        ...
        float float1 = 2.0F;
        float float2 = 0.7F;
        LineDrawer.drawDotLines(this.x, this.y, this.z, float1, float0, float2,
                                1.0F, 1.0F, 1.0F, 0.5F, 1);
        float2 = -0.5F;
        LineDrawer.drawDotLines(this.x, this.y, this.z, float1, float0, float2,
                                1.0F, 1.0F, 1.0F, 0.5F, 1);
        LineDrawer.drawArc(this.x, this.y, this.z, float1, float0, -1.0F, 16,
                           1.0F, 1.0F, 1.0F, 0.5F);
        ...
        for (int int0 = 0; int0 < arrayList.size(); int0++) {
          ...
          if (this.DistToSquared(movingObject) < float1 * float1) {
            LineDrawer.DrawIsoCircle(movingObject.x, movingObject.y,
                                     movingObject.z, 0.3F, 1.0F, 1.0F, 1.0F,
                                     1.0F);
            float float3 = 0.2F;
            float float4 = IsoUtils.XToScreenExact(movingObject.x + float3,
                                                   movingObject.y + float3,
                                                   movingObject.z, 0);
            float float5 = IsoUtils.YToScreenExact(movingObject.x + float3,
                                                   movingObject.y + float3,
                                                   movingObject.z, 0);
            UIFont uIFont = UIFont.DebugConsole;
            int int1 = TextManager.instance.getFontHeight(uIFont);
            TextManager.instance.DrawStringCentre(
                uIFont, float4, float5 + int1,
                "SIDE: " + this.testDotSide(movingObject), 1.0, 1.0, 1.0, 1.0);
            Vector2 vector0 = this.getLookVector(tempo2);
            Vector2 vector1 =
                tempo.set(movingObject.x - this.x, movingObject.y - this.y);
            vector1.normalize();
            float float6 =
                PZMath.wrap(vector1.getDirection() - vector0.getDirection(),
                            0.0F, (float)(Math.PI * 2));
            TextManager.instance.DrawStringCentre(
                uIFont, float4, float5 + int1 * 2,
                "ANGLE (0-360): " + PZMath.radToDeg(float6), 1.0, 1.0, 1.0,
                1.0);
            float6 = (float)Math.acos(this.getDotWithForwardDirection(
                movingObject.x, movingObject.y));
            TextManager.instance.DrawStringCentre(
                uIFont, float4, float5 + int1 * 3,
                "ANGLE (0-180): " + PZMath.radToDeg(float6), 1.0, 1.0, 1.0,
                1.0);
          }
        }
      }
    ...
    void debugVision() {
      if (this == IsoPlayer.getInstance()) {
        ...
        LineDrawer.drawDotLines(
            this.x, this.y, this.z, GameTime.getInstance().getViewDist(),
            this.getLookAngleRadians(), -float0, 1.0F, 1.0F, 1.0F, 0.5F, 1);
        LineDrawer.drawArc(
            this.x, this.y, this.z, GameTime.getInstance().getViewDist(),
            this.getLookAngleRadians(), -float0, 16, 1.0F, 1.0F, 1.0F, 0.5F);
        float float1 = 3.5F - this.stats.getFatigue();
        LineDrawer.drawArc(this.x, this.y, this.z, float1,
                           this.getLookAngleRadians(), -1.0F, 32, 1.0F, 1.0F,
                           1.0F, 0.5F);
      }
    }
    ...
    void SetOnFire() {
      if (!this.OnFire) {
        ...
        this.AttachAnim("Fire", "01", 4, IsoFireManager.FireAnimDelay,
                        (int)(-(this.offsetX + 1.0F * float0)) +
                            (8 - Rand.Next(16)),
                        (int)(-(this.offsetY + -89.0F * float0)) +
                            (int)((10 + Rand.Next(20)) * float0),
                        true, 0, false, 0.7F, IsoFireManager.FireTintMod);
        IsoFireManager.AddBurningCharacter(this);
        int int0 = Rand.Next(BodyPartType.ToIndex(BodyPartType.Hand_L),
                             BodyPartType.ToIndex(BodyPartType.MAX));
        if (this instanceof IsoPlayer) {
    ...
    void SpreadFireMP() {
      if (this.OnFire && GameServer.bServer &&
        ...
        if (square != nullptr &&
            !square.getProperties().Is(IsoFlagType.burning) &&
            Rand.Next(Rand.AdjustForFramerate(3000)) <
                this.FireSpreadProbability) {
    ...
    void SpreadFire() {
      if (this.OnFire && !GameServer.bServer && !GameClient.bClient &&
          SandboxOptions.instance.FireSpread.getValue()) {
    ...
    void Throw(HandWeapon weapon) {
      if (this instanceof
          IsoPlayer && ((IsoPlayer)this).getJoypadBind() != -1) {
        Vector2 vector = tempo.set(this.m_forwardDirection);
        vector.setLength(weapon.getMaxRange());
        this.attackTargetSquare = this.getCell().getGridSquare(
            (double)(this.getX() + vector.getX()),
            (double)(this.getY() + vector.getY()), (double)this.getZ());
        if (this.attackTargetSquare == nullptr) {
          this.attackTargetSquare = this.getCell().getGridSquare(
              (double)(this.getX() + vector.getX()),
              (double)(this.getY() + vector.getY()), 0.0);
        }
      }

      float float0 = this.attackTargetSquare.getX() - this.getX();
      if (float0 > 0.0F) {
        if (this.attackTargetSquare.getX() - this.getX() >
            weapon.getMaxRange()) {
          float0 = weapon.getMaxRange();
        }
      } else if (this.attackTargetSquare.getX() - this.getX() <
                 -weapon.getMaxRange()) {
        float0 = -weapon.getMaxRange();
      }
      ...
      if (float1 > 0.0F) {
        if (this.attackTargetSquare.getY() - this.getY() >
            weapon.getMaxRange()) {
          float1 = weapon.getMaxRange();
        }
      } else if (this.attackTargetSquare.getY() - this.getY() <
                 -weapon.getMaxRange()) {
        float1 = -weapon.getMaxRange();
      }
    ...
    bool helmetFall(bool hitHead, const std::string &forcedItem) {
      ...
      if (zombie0 != nullptr && !zombie0.isUsingWornItems()) {
        ...
        for (int int0 = 0; int0 < tempItemVisuals.size(); int0++) {
          ...
          if (item1 != nullptr && item1.getType() == Item.Type.Clothing &&
              item1.getChanceToFall() > 0) {
            ...
            if (Rand.Next(100) > int1) {
              InventoryItem item2 =
                  InventoryItemFactory.CreateItem(item1.getFullName());
              if (item2 != nullptr) {
      ...
      } else if (this.getWornItems() != nullptr &&
                 !this.getWornItems().isEmpty()) {
        for (int int2 = 0; int2 < this.getWornItems().size(); int2++) {
          ...
          if (item3 instanceof Clothing) {
            ...
            if (((Clothing)item3).getChanceToFall() > 0 &&
                Rand.Next(100) <= int3) {
              IsoFallingClothing fallingClothing1 = new IsoFallingClothing(
                  this.getCell(), this.getX(), this.getY(),
                  PZMath.min(this.getZ() + 0.4F, (int)this.getZ() + 0.95F),
                  Rand.Next(-0.2F, 0.2F), Rand.Next(-0.2F, 0.2F), item3);
              if (!StringUtils.isNullOrEmpty(forcedItem)) {
              ...
              if (GameClient.bClient && player != nullptr &&
                  ...
                  StringUtils.isNullOrEmpty(forcedItem)) {
      ...
      if (boolean0 && GameClient.bClient &&
          StringUtils.isNullOrEmpty(forcedItem) &&
          IsoPlayer.getInstance().isLocalPlayer()) {
    ...
    void smashCarWindow(VehiclePart part) {
      std::unordered_map hashMap =
          this.getStateMachineParams(SmashWindowState.instance());
      hashMap.clear();
    ...
    void closeWindow(IsoWindow w) {
      if (!w.isInvincible()) {
        std::unordered_map hashMap =
            this.getStateMachineParams(CloseWindowState.instance());
        hashMap.clear();
        hashMap.put(0, w);
    ...
    bool isClosingWindow(IsoWindow window) {
      if (window == nullptr) {
        ...
        return !this.isCurrentState(CloseWindowState.instance())
                   ? false
                   : CloseWindowState.instance().getWindow(this) == window;
      }
    }
    ...
    bool isClimbingThroughWindow(IsoWindow window) {
      if (window == nullptr) {
        ...
        return !this.getVariableBoolean("BlockWindow")
                   ? false
                   : ClimbThroughWindowState.instance().getWindow(this) ==
                         window;
      }
    }
    ...
    void climbSheetRope() {
      if (this.canClimbSheetRope(this.current)) {
        std::unordered_map hashMap =
            this.getStateMachineParams(ClimbSheetRopeState.instance());
        hashMap.clear();
    ...
    void climbDownSheetRope() {
      if (this.canClimbDownSheetRope(this.current)) {
        this.dropHeavyItems();
        std::unordered_map hashMap =
            this.getStateMachineParams(ClimbDownSheetRopeState.instance());
        hashMap.clear();
    ...
    bool canClimbSheetRope(IsoGridSquare sq) {
      if (sq == nullptr) {
        ...
        while (sq != nullptr) {
          ...
          sq =
              this.getCell().getGridSquare(sq.getX(), sq.getY(), sq.getZ() + 1);
        }
    ...
    void climbOverFence(IsoDirections dir) {
      if (this.current != nullptr) {
        ...
        if (IsoWindow.canClimbThroughHelper(this, this.current, square,
                                            dir == IsoDirections.N ||
                                                dir == IsoDirections.S)) {
    ...
    bool isAboveTopOfStairs() {
      if (this.z != 0.0F && !(this.z - (int)this.z > 0.01) &&
          (this.current == nullptr || !this.current.TreatAsSolidFloor())) {
        IsoGridSquare square = this.getCell().getGridSquare(
            (double)this.x, (double)this.y, (double)(this.z - 1.0F));
        return square != nullptr && (square.Has(IsoObjectType.stairsTN) ||
    ...
    void preupdate() {
      super.preupdate();
      if (!this.m_bDebugVariablesRegistered &&
          DebugOptions.instance.Character.Debug.RegisterDebugVariables
              .getValue()) {
        this.registerDebugGameVariables();
      }
    ...
    void setTeleport(NetworkTeleport _teleport) { this.teleport = _teleport; }

    NetworkTeleport getTeleport() { return this.teleport; }

    bool isTeleporting() { return this.teleport != nullptr; }

    void update() {
      IsoGameCharacter.s_performance.update.invokeAndMeasure(
          this, IsoGameCharacter::updateInternal);
    }
    ...
    void updateInternal() {
      if (this.current != nullptr) {
        ...
        if (!this.isDead() ||
          ...
          if (!GameClient.bClient && !this.m_invisible &&
          ...
          if (this.getBodyDamage() != nullptr &&
            ...
            if (this.getStats().getFatigue() < 1.0F) {
              this.getStats().setFatigue(this.getStats().getFatigue() +
                                         1.0E-4F * float0);
            }

            if (this.getStats().getFatigue() > 0.8) {
              this.getBodyDamage()
                  .getBodyPart(BodyPartType.Head)
                  .ReduceHealth(0.1F * float0);
            }

            this.getBodyDamage()
                .getBodyPart(BodyPartType.Torso_Upper)
                .ReduceHealth(0.1F * float0);
          }

          if (this.lungeFallTimer > 0.0F) {
            this.lungeFallTimer = this.lungeFallTimer -
                                  GameTime.getInstance().getMultiplier() / 1.6F;
          }

          if (this.getMeleeDelay() > 0.0F) {
            this.setMeleeDelay(this.getMeleeDelay() -
                               0.625F * GameTime.getInstance().getMultiplier());
          }

          if (this.getRecoilDelay() > 0.0F) {
            this.setRecoilDelay(this.getRecoilDelay() -
                                0.625F *
          ...
          if (this.current.getRoom() != nullptr &&
              ...
              (!this.isZombie() || Core.bTutorial) && !GameClient.bClient) {
            bool boolean0 = false;
            if (this instanceof
                IsoPlayer && (((IsoPlayer)this).isInvisible() ||
                              ((IsoPlayer)this).isGhostMode())) {
              boolean0 = true;
            }
          ...
          if (!this.isZombie()) {
            if (this.Traits.Agoraphobic.isSet() &&
                !this.getCurrentSquare().isInARoom()) {
              this.stats.Panic =
                  this.stats.Panic +
                  0.5F * (GameTime.getInstance().getMultiplier() / 1.6F);
            }

            if (this.Traits.Claustophobic.isSet() &&
                this.getCurrentSquare().isInARoom()) {
            ...
            if (this.BetaEffect > 0.0F) {
              this.BetaEffect = this.BetaEffect -
                                GameTime.getInstance().getMultiplier() / 1.6F;
              this.stats.Panic =
                  this.stats.Panic -
                  0.6F * (GameTime.getInstance().getMultiplier() / 1.6F);
            ...
            if (this.DepressFirstTakeTime > 0.0F || this.DepressEffect > 0.0F) {
              ...
              if (this.DepressFirstTakeTime < 0.0F) {
                ...
                this.DepressEffect =
                    this.DepressEffect -
                    GameTime.getInstance().getMultiplier() / 1.6F;
                this.getBodyDamage().setUnhappynessLevel(
                    this.getBodyDamage().getUnhappynessLevel() -
                    0.03F * (GameTime.getInstance().getMultiplier() / 1.6F));
            ...
            if (this.SleepingTabletEffect > 0.0F) {
              this.SleepingTabletEffect =
                  this.SleepingTabletEffect -
                  GameTime.getInstance().getMultiplier() / 1.6F;
              this.stats.fatigue =
                  this.stats.fatigue +
                  0.0016666667F * this.SleepingTabletDelta *
                      (GameTime.getInstance().getMultiplier() / 1.6F);
            } else {
          ...
          if (!this.CharacterActions.isEmpty()) {
            ...
            } else if (boolean1 && !baseAction.finished() &&
                       !baseAction.forceComplete && !baseAction.forceStop) {
              baseAction.update();
            }

            if (!boolean1 || baseAction.finished() ||
                baseAction.forceComplete || baseAction.forceStop) {
              ...
              if (baseAction.finished() && !baseAction.loopAction ||
                  baseAction.forceComplete || baseAction.forceStop ||
                  !boolean1) {
                if (baseAction.bStarted &&
                    (baseAction.forceStop || !boolean1)) {
                  baseAction.stop();
                }

                this.CharacterActions.removeElement(baseAction);
                if (this == IsoPlayer.players[0] ||
                    this == IsoPlayer.players[1] ||
                    this == IsoPlayer.players[2] ||
                    this == IsoPlayer.players[3]) {
                  UIManager.getProgressBar(((IsoPlayer)this).getPlayerNum())
                      .setValue(0.0F);
                }
              }
          ...
          if (this == IsoPlayer.getInstance()) {
            if (this.leftHandItem != nullptr &&
                this.leftHandItem.getUses() <= 0) {
              this.leftHandItem = nullptr;
            }

            if (this.rightHandItem != nullptr &&
                this.rightHandItem.getUses() <= 0) {
              this.rightHandItem = nullptr;
            }
          }
          ...
          if (this.isZombie() &&
            ...
            if ((this instanceof IsoPlayer || this instanceof IsoSurvivor) &&
                    this.RemoteID == -1 && this instanceof
                IsoPlayer && ((IsoPlayer)this).isLocalPlayer()) {
              RainManager.SetPlayerLocation(((IsoPlayer)this).getPlayerNum(),
                                            this.getCurrentSquare());
            }
            ...
            if (this.AttachedAnimSprite != nullptr) {
              ...
              for (int int5 = 0; int5 < int4; int5++) {
                IsoSpriteInstance spriteInstance =
                    this.AttachedAnimSprite.get(int5);
                IsoSprite sprite = spriteInstance.parentSprite;
                spriteInstance.update();
                spriteInstance.Frame =
                    spriteInstance.Frame +
                    spriteInstance.AnimFrameIncrease *
                        (GameTime.instance
                             .getMultipliedSecondsSinceLastUpdate() *
                         60.0F);
                if ((int)spriteInstance.Frame >=
                        sprite.CurrentAnim.Frames.size() &&
            ...
            if (this.effectiveEdibleBuffTimer > 0.0F) {
              this.effectiveEdibleBuffTimer =
                  this.effectiveEdibleBuffTimer -
                  GameTime.getInstance().getMultiplier() * 0.015F;
              if (this.effectiveEdibleBuffTimer < 0.0F) {
                this.effectiveEdibleBuffTimer = 0.0F;
              }
            }
    ...
    void recursiveItemUpdater(InventoryContainer inventoryContainer) {
      for (int int0 = 0;
           int0 < inventoryContainer.getInventory().getItems().size(); int0++) {
        InventoryItem item =
            inventoryContainer.getInventory().getItems().get(int0);
        if (item instanceof InventoryContainer) {
          this.recursiveItemUpdater((InventoryContainer)item);
        }
    ...
    void updateDirt() {
      if (!this.isZombie() && this.getBodyDamage() != nullptr) {
        ...
        if (this.isSprinting() &&
            Rand.NextBool(Rand.AdjustForFramerate(2500))) {
          int0 += Rand.Next(1, 3);
        }

        if (this.getBodyDamage().getTemperature() > 37.0F &&
            Rand.NextBool(Rand.AdjustForFramerate(5000))) {
          int0++;
        }

        if (this.getBodyDamage().getTemperature() > 38.0F &&
            Rand.NextBool(Rand.AdjustForFramerate(3000))) {
          int0++;
        }

        float float0 =
            this.square == null ? 0.0F : this.square.getPuddlesInGround();
        if (this.isMoving() && float0 > 0.09F &&
            Rand.NextBool(Rand.AdjustForFramerate(1500))) {
          int0++;
        }
        ...
        IsoPlayer player = Type.tryCastTo(this, IsoPlayer.class);
        if (player != nullptr && player.isPlayerMoving() ||
            player == nullptr && this.isMoving()) {
          int0 = 0;
    ...
    double getHoursSurvived() { return GameTime.instance.getWorldAgeHours(); }
        ...
        if (!(this instanceof IsoPlayer) || ((IsoPlayer)this).isLocalPlayer()) {
          ...
          boolean boolean0 = !GameClient.bClient && !GameServer.bServer ||
                             ServerOptions.instance.SleepAllowed.getValue() &&
                                 ServerOptions.instance.SleepNeeded.getValue();
          bool boolean1 = false;
          if ((this.isAsleep() || !boolean0) &&
              float0 - this.beardGrowTiming > 120.0F) {
            this.beardGrowTiming = float0;
            BeardStyle beardStyle = BeardStyles.instance.FindStyle(
                ((HumanVisual)this.getVisual()).getBeardModel());
            int int0 = 1;
            ...
            for (int int1 = 0; int1 < arrayList0.size(); int1++) {
              if (((BeardStyle)arrayList0.get(int1)).growReference &&
                  ((BeardStyle)arrayList0.get(int1)).level == int0 + 1) {
                ((HumanVisual)this.getVisual())
                    .setBeardModel(((BeardStyle)arrayList0.get(int1)).name);
                boolean1 = true;
                break;
              }
            }
          ...
          if ((this.isAsleep() || !boolean0) &&
              float0 - this.hairGrowTiming > 480.0F) {
            this.hairGrowTiming = float0;
            HairStyle hairStyle0 = HairStyles.instance.FindMaleStyle(
                ((HumanVisual)this.getVisual()).getHairModel());
            if (this.isFemale()) {
              hairStyle0 = HairStyles.instance.FindFemaleStyle(
                  ((HumanVisual)this.getVisual()).getHairModel());
            }
      ...
      if (this.isSeatedInVehicle()) {
        ...
        if (this.z > 0.0F) {
          ...
          if (!this.isZombie() && this.isClimbing()) {
            if (this.current.Is(IsoFlagType.climbSheetW) ||
                this.current.Is(IsoFlagType.climbSheetTopW)) {
              directions = IsoDirections.W;
            }

            if (this.current.Is(IsoFlagType.climbSheetE) ||
                this.current.Is(IsoFlagType.climbSheetTopE)) {
              directions = IsoDirections.E;
            }

            if (this.current.Is(IsoFlagType.climbSheetN) ||
                this.current.Is(IsoFlagType.climbSheetTopN)) {
              directions = IsoDirections.N;
            }

            if (this.current.Is(IsoFlagType.climbSheetS) ||
                this.current.Is(IsoFlagType.climbSheetTopS)) {
              directions = IsoDirections.S;
            }
          }

          float float0 =
              0.125F * (GameTime.getInstance().getMultiplier() / 1.6F);
          if (this.bClimbing) {
            float0 = 0.0F;
          }
          ...
          if (!this.current.TreatAsSolidFloor()) {
            ...
            float float1 =
                6.0F * (GameTime.getInstance().getMultiplier() / 1.6F);
    ...
    float getHeightAboveFloor() {
      if (this.current == nullptr) {
        ...
        if (this.current.HasStairs()) {
          float float0 = this.current.getApparentZ(this.x - (int)this.x,
                                                   this.y - (int)this.y);
          if (this.getZ() >= float0) {
        ...
        if (this.current.TreatAsSolidFloor()) {
          ...
          IsoGridSquare square = this.getCell().getGridSquare(
              this.current.x, this.current.y, this.current.z - 1);
          if (square != nullptr && square.HasStairs()) {
            float float1 =
                square.getApparentZ(this.x - (int)this.x, this.y - (int)this.y);
    ...
    float calculateBaseSpeed() {
      ...
      if (this.getMoodles() != nullptr) {
        float0 -=
            this.getMoodles().getMoodleLevel(MoodleType.Endurance) * 0.15F;
        float0 -=
            this.getMoodles().getMoodleLevel(MoodleType.HeavyLoad) * 0.15F;
      }

      if (this.getMoodles().getMoodleLevel(MoodleType.Panic) >= 3 &&
          this.Traits.AdrenalineJunkie.isSet()) {
        int int0 = this.getMoodles().getMoodleLevel(MoodleType.Panic) + 1;
        float0 += int0 / 20.0F;
      }

      for (int int1 = BodyPartType.ToIndex(BodyPartType.Torso_Upper);
           int1 < BodyPartType.ToIndex(BodyPartType.Neck) + 1; int1++) {
        BodyPart bodyPart0 =
            this.getBodyDamage().getBodyPart(BodyPartType.FromIndex(int1));
      ...
      BodyPart bodyPart1 =
          this.getBodyDamage().getBodyPart(BodyPartType.UpperLeg_L);
      ...
      if (this.getPrimaryHandItem() != nullptr && this.getPrimaryHandItem()
              instanceof InventoryContainer) {
        float1 += this.calcRunSpeedModByBag(
            (InventoryContainer)this.getPrimaryHandItem());
      }

      if (this.getSecondaryHandItem() != nullptr && this.getSecondaryHandItem()
              instanceof InventoryContainer) {
        float1 += this.calcRunSpeedModByBag(
            (InventoryContainer)this.getSecondaryHandItem());
      }
    ...
    float calcRunSpeedModByClothing() {
      ...
      for (int int1 = 0; int1 < this.wornItems.size(); int1++) {
        ...
        if (item instanceof
            Clothing && ((Clothing)item).getRunSpeedModifier() != 1.0F) {
    ...
    float calcRunSpeedModByBag(InventoryContainer inventoryContainer) {
      ...
      float float1 = inventoryContainer.getContentsWeight() /
                     inventoryContainer.getEffectiveCapacity(this);
    ...
    float calculateCombatSpeed() {
      ...
      if (weapon != nullptr && weapon.isTwoHandWeapon() &&
          this.getSecondaryHandItem() != weapon) {
        float0 *= 0.77F;
      }

      if (weapon != nullptr && this.Traits.Axeman.isSet() &&
          weapon.getCategories().contains("Axe")) {
      ...
      if (this.getBodyDamage() != nullptr &&
          this.getBodyDamage().getThermoregulator() != nullptr) {
      ...
      if (weapon != nullptr && weapon.isTwoHandWeapon() &&
          weaponType.type.equalsIgnoreCase("heavy")) {
        float0 *= 1.2F;
      }
    ...
    float getFootInjurySpeedModifier() {
      ...
      for (int int0 = BodyPartType.ToIndex(BodyPartType.Groin);
           int0 < BodyPartType.ToIndex(BodyPartType.MAX); int0++) {
        float0 = this.calculateInjurySpeed(
            this.getBodyDamage().getBodyPart(BodyPartType.FromIndex(int0)),
            false);
        if (boolean0) {
          float1 += float0;
        } else {
    ...
    float calculateInjurySpeed(BodyPart bodyPart, bool boolean0) {
      ...
      float float4 = 0.0F;
      if ((bodyPart.getType() == BodyPartType.Foot_L ||
           bodyPart.getType() == BodyPartType.Foot_R) &&
          (bodyPart.getBurnTime() > 5.0F || bodyPart.getBiteTime() > 0.0F ||
           bodyPart.deepWounded() || bodyPart.isSplint() ||
           bodyPart.getFractureTime() > 0.0F || bodyPart.haveGlass())) {
        float4 = 1.0F;
      ...
      if (bodyPart.haveBullet()) {
        ...
        if (bodyPart.getScratchTime() > 2.0F || bodyPart.getCutTime() > 5.0F ||
            bodyPart.getBurnTime() > 0.0F ||
            bodyPart.getDeepWoundTime() > 0.0F || bodyPart.isSplint() ||
    ...
    void calculateWalkSpeed() {
      if (!(this instanceof IsoPlayer) || ((IsoPlayer)this).isLocalPlayer()) {
        ...
        if (this.getBodyDamage() != nullptr &&
            this.getBodyDamage().getThermoregulator() != nullptr) {
          float0 *=
              this.getBodyDamage().getThermoregulator().getMovementModifier();
        }

        if (this.isAiming()) {
          float float2 = Math.min(
              0.9F + this.getPerkLevel(PerkFactory.Perks.Nimble) / 10.0F, 1.5F);
    ...
    void updateSpeedModifiers() {
      ...
      for (int int0 = 0; int0 < this.getWornItems().size(); int0++) {
        ...
        if (item0 instanceof Clothing clothing) {
          this.combatSpeedModifier = this.combatSpeedModifier +
                                     (clothing.getCombatSpeedModifier() - 1.0F);
        }

        if (item0 instanceof InventoryContainer inventoryContainer) {
          this.combatSpeedModifier =
              this.combatSpeedModifier +
              (inventoryContainer.getScriptItem().combatSpeedModifier - 1.0F);
      ...
      if (sq != nullptr) {
        ...
        for (int int0 = 0; int0 < sq.getObjects().size(); int0++) {
          ...
          if (object1.sprite != nullptr &&
              object1.sprite.getProperties().Is(IsoFlagType.solidfloor) &&
              object0 == nullptr) {
            object0 = object1;
          }
        }

        if (object0 != nullptr && object0.sprite != nullptr &&
            (object0.sprite.getProperties().Is(IsoFlagType.vegitation) ||
             object0.sprite.getProperties().Is(IsoFlagType.solidfloor))) {
          IsoSprite sprite =
              IsoSprite.getSprite(IsoSpriteManager.instance, id, 0);
          if (sprite == nullptr) {
            return;
          }
          ...
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .Flip = bFlip;
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .tintr = 0.5F + Rand.Next(100) / 2000.0F;
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .tintg = 0.7F + Rand.Next(300) / 1000.0F;
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .tintb = 0.7F + Rand.Next(300) / 1000.0F;
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .SetAlpha(0.4F * alpha * 0.6F);
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .SetTargetAlpha(0.4F * alpha * 0.6F);
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .offZ = -offZ;
          object0.AttachedAnimSprite.get(object0.AttachedAnimSprite.size() - 1)
              .offX = 0.0F;
    ...
    void updateStats_Awake() {
      this.stats.stress =
          (float)(this.stats.stress -
                  ZomboidGlobals.StressReduction *
                      GameTime.instance.getMultiplier() *
      ...
      if ((!(this instanceof IsoPlayer) || !((IsoPlayer)this).IsRunning() ||
        ...
        this.stats.hunger =
            (float)(this.stats.hunger +
                    ZomboidGlobals.HungerIncreaseWhenExercise / 3.0 *
                        SandboxOptions.instance.getStatsDecreaseMultiplier() *
                        float2 * GameTime.instance.getMultiplier() *
                        GameTime.instance.getDeltaMinutesPerDay() *
                        this.getHungerMultiplier());
      ...
      if (this.getCurrentSquare() == this.getLastSquare() &&
          !this.isReading()) {
        this.stats.idleboredom = this.stats.idleboredom +
                                 5.0E-5F * GameTime.instance.getMultiplier() *
                                     GameTime.instance.getDeltaMinutesPerDay();
        this.stats.idleboredom = this.stats.idleboredom +
                                 0.00125F * GameTime.instance.getMultiplier() *
                                     GameTime.instance.getDeltaMinutesPerDay();
      }
      ...
      if (this.getCurrentSquare() != nullptr &&
          ...
          this.getCurrentSquare().getRoom() != nullptr && !this.isReading()) {
        this.stats.idleboredom = this.stats.idleboredom +
                                 1.0E-4F * GameTime.instance.getMultiplier() *
                                     GameTime.instance.getDeltaMinutesPerDay();
        this.stats.idleboredom = this.stats.idleboredom +
                                 0.00125F * GameTime.instance.getMultiplier() *
                                     GameTime.instance.getDeltaMinutesPerDay();
    ...
    void updateFitness() {
      this.stats.fitness =
          this.getPerkLevel(PerkFactory.Perks.Fitness) / 5.0F - 1.0F;
    ...
    void updateStress() {
      ...
      if (this.Traits.Hemophobic.isSet()) {
        this.stats.stress =
            (float)(this.stats.stress +
                    this.getTotalBlood() * ZomboidGlobals.StressFromHemophobic *
    ...
    void updateThirst() {
      ...
      if (IsoPlayer.getInstance() == this &&
        ...
        if (this.Asleep) {
          this.stats.thirst =
              (float)(this.stats.thirst +
                      ZomboidGlobals.ThirstSleepingIncrease *
                          SandboxOptions.instance.getStatsDecreaseMultiplier() *
                          GameTime.instance.getMultiplier() *
                          GameTime.instance.getDeltaMinutesPerDay() * float0);
        } else {
          this.stats.thirst =
              (float)(this.stats.thirst +
    ...
    double getRunningThirstReduction() {
      return this = =
                 IsoPlayer.getInstance() && IsoPlayer.getInstance().IsRunning()
                     ? 1.2
                     : 1.0;
    }
    ...
    bool isFacingLocation(float x, float y, float dot) {
      Vector2 vector0 =
          BaseVehicle.allocVector2().set(x - this.getX(), y - this.getY());
      vector0.normalize();
    ...
    void checkDrawWeaponPre(float var1, float var2, float var3,
                            ColorInfo var4) {
      if (this.sprite != nullptr) {
        if (this.sprite.CurrentAnim != nullptr) {
          if (this.sprite.CurrentAnim.name != nullptr) {
            if (this.dir != IsoDirections.S && this.dir != IsoDirections.SE &&
                this.dir != IsoDirections.E && this.dir != IsoDirections.NE &&
    ...
    bool isOutside() {
      return this.getCurrentSquare() == nullptr
                 ? false
                 : this.getCurrentSquare().isOutside();
    }

    bool isFemale() { return this.bFemale; }

    void setFemale(bool isFemale) { this.bFemale = isFemale; }
    ...
    int getSurvivorKills() { return this.SurvivorKills; }
  ...
  public
    ...
    void faceThisObject(IsoObject object) {
      if (object != nullptr) {
        ...
        BarricadeAble barricadeAble =
            Type.tryCastTo(object, BarricadeAble.class);
        if (vehiclex != nullptr) {
        ...
        } else if (barricadeAble != nullptr &&
                   this.current == barricadeAble.getSquare()) {
          this.dir =
              barricadeAble.getNorth() ? IsoDirections.N : IsoDirections.W;
          this.getVectorFromDirection(this.m_forwardDirection);
        } else if (barricadeAble != nullptr &&
                   this.current == barricadeAble.getOppositeSquare()) {
          this.dir =
              barricadeAble.getNorth() ? IsoDirections.S : IsoDirections.E;
          this.getVectorFromDirection(this.m_forwardDirection);
        } else {
          object.getFacingPosition(vector);
          vector.x = vector.x - this.getX();
    ...
    void setAnimated(bool b) { this.legsSprite.Animate = true; }

    void playHurtSound() { this.getEmitter().playVocals(this.getHurtSound()); }
    ...
    void playDeadSound() {
      ...
      if (this.isZombie()) {
        ((IsoZombie)this)
            .parameterZombieState.setState(ParameterZombieState.State.Death);
      }
    }
    ...
    void saveChange(const std::string &change, KahluaTable tbl, ByteBuffer bb) {
      ...
      if ("addItem" == change)) {
          ...
          if ("DamageFromWeapon" == change)) {
              ...
              if (tbl != nullptr && tbl.rawget("hitDirX") instanceof
                  Double && tbl.rawget("hitDirY") instanceof
                  Double && tbl.rawget("force") instanceof Double) {
              ...
              if (tbl != nullptr && tbl.rawget("perk") instanceof
                  Double && tbl.rawget("xp") instanceof Double) {
      ...
      if ("addItem" == change)) {
          ...
          if ("StopBurning" == change)) {
              ...
              if (this.isAsleep()) {
                ...
                if (this instanceof
                    IsoPlayer && ((IsoPlayer)this).isLocalPlayer()) {
                  UIManager.setFadeBeforeUI(((IsoPlayer)this).getPlayerNum(),
                                            true);
              ...
              LuaEventManager.triggerEvent("OnMechanicActionDone", this,
                                           boolean1, int5, string5, long0,
                                           boolean2);
            }
        ...
        if (!this.isZombie()) {
          synchronized(this.lightInfo) {
            ...
            if (this.lightInfo.square == nullptr) {
              this.lightInfo.square = this.getCell().getGridSquare(
                  (int)this.x, (int)this.y, (int)this.z);
            }
  ...
  public
    IsoGameCharacter.LightInfo initLightInfo2() {
      synchronized(this.lightInfo) {
  ...
  public
    IsoGameCharacter.LightInfo getLightInfo2() { return this.lightInfo2; }

    void postupdate() {
      IsoGameCharacter.s_performance.postUpdate.invokeAndMeasure(
          this, IsoGameCharacter::postUpdateInternal);
    }
    ...
    void postUpdateInternal() {
      ...
      if (animationPlayer != nullptr) {
        MoveDeltaModifiers moveDeltaModifiers =
            IsoGameCharacter.L_postUpdate.moveDeltas;
        ...
        if (boolean2 && boolean1 && this.isRunning()) {
          moveDeltaModifiers.turnDelta =
              Math.max(moveDeltaModifiers.turnDelta, 2.0F);
        }
        ...
        float float0 =
            Math.max(1.0F - moveDeltaModifiers.moveDelta / 2.0F, 0.0F);
        animationPlayer.angleStepDelta = float0 * moveDeltaModifiers.turnDelta;
        animationPlayer.angleTwistDelta =
            float0 * moveDeltaModifiers.twistDelta;
        animationPlayer.setMaxTwistAngle((float)(Math.PI / 180.0) *
                                         this.getMaxTwist());
      }
    ...
    bool isTurning() { return this.m_isTurning; }

    void setTurning(bool boolean0) { this.m_isTurning = boolean0; }

    bool isTurningAround() { return this.m_isTurningAround; }

    void setTurningAround(bool boolean0) { this.m_isTurningAround = boolean0; }

    bool isTurning90() { return this.m_isTurning90; }

    void setTurning90(bool boolean0) { this.m_isTurning90 = boolean0; }

    bool hasPath() { return this.getPath2() != nullptr; }

    bool isAnimationRecorderActive() {
      return this.m_animationRecorder != nullptr &&
             this.m_animationRecorder.isRecording();
    }
    ...
    float getMeleeDelay() { return this.meleeDelay; }

    void setMeleeDelay(float delay) { this.meleeDelay = Math.max(delay, 0.0F); }
    ...
    float getBeenMovingFor() { return this.BeenMovingFor; }
    ...
    bool isForceShove() { return this.forceShove; }

    void setForceShove(bool _forceShove) { this.forceShove = _forceShove; }
    ...
    int getWeaponLevel() {
      ...
      if (weaponType != nullptr && weaponType != WeaponType.barehand) {
        if (((HandWeapon)this.getPrimaryHandItem())
                .getCategories()
                .contains("Axe")) {
    ...
    void setVehicle(BaseVehicle v) { this.vehicle = v; }
        ...
        for (int int5 = int0; int5 < int2; int5++) {
          ...
          if (chunk != nullptr) {
            for (int int6 = 0; int6 < chunk.vehicles.size(); int6++) {
              ...
              Vector2 vector1 =
                  vehiclex.testCollisionWithCharacter(this, 0.3F, vector0);
    ...
    bool isProne() { return this.isOnFloor(); }
      ...
      if (!this.isOnFloor()) {
        ...
        for (int int0 = -1; int0 <= 1; int0++) {
          for (int int1 = -1; int1 <= 1; int1++) {
            IsoGridSquare square = this.getCell().getGridSquare(
                (int)this.x + int1, (int)this.y + int0, (int)this.z);
            if (square != nullptr) {
              std::vector arrayList = square.getMovingObjects();

              for (int int2 = 0; int2 < arrayList.size(); int2++) {
                IsoMovingObject movingObject =
                    (IsoMovingObject)arrayList.get(int2);
                if (movingObject != this) {
                  ...
                  if (character1 != nullptr &&
                      ...
                      ZombieOnGroundState.isCharacterStandingOnOther(character1,
                                                                     this)) {
                    return true;
                  }
                }
    ...
    float getTemperature() { return this.getBodyDamage().getTemperature(); }

    void setTemperature(float t) { this.getBodyDamage().setTemperature(t); }
            ...
            if (square != nullptr) {
              ...
              if (item0 != nullptr || item1 != nullptr) {
                ...
                if (square != nullptr) {
                  ...
                  float float1 = Rand.Next(0.1F, 0.9F);
                  float float2 =
                      square.getApparentZ(float0, float1) - square.getZ();
                  bool boolean0 = false;
                  if (item1 == item0) {
                    boolean0 = true;
                  }
                  ...
                  if (item1 != nullptr) {
                    ...
                    if (!boolean0) {
                      ...
                      square.AddWorldInventoryItem(item1, float0, float1,
                                                   float2);
                      LuaEventManager.triggerEvent("OnContainerUpdate");
    ...
    bool shouldBecomeZombieAfterDeath() {
      ...
      case 1:
        return !this.getBodyDamage().IsFakeInfected() &&
               this.getBodyDamage().getInfectionLevel() >= 0.001F;
      case 2:
        return !this.getBodyDamage().IsFakeInfected() &&
               this.getBodyDamage().getInfectionLevel() >= 0.001F;
      case 3:
    ...
    void createKeyRing() {
      ...
      if (item0 != nullptr && item0 instanceof
          InventoryContainer inventoryContainer) {
        inventoryContainer.setName(Translator.getText(
            "IGUI_KeyRingName", this.getDescriptor().getForename(),
            this.getDescriptor().getSurname()));
        if (Rand.Next(100) < 40) {
          ...
          if (roomDef != nullptr && roomDef.getBuilding() != nullptr) {
            ...
            InventoryItem item1 =
                inventoryContainer.getInventory().AddItem(string);
          ...
          if (Core.getInstance().getOptionAutoDrink()) {
            if (!LuaHookManager.TriggerHook("AutoDrink", this)) {
              if (!(this.stats.thirst <= 0.1F)) {
                InventoryItem item =
                    this.getWaterSource(this.getInventory().getItems());
                if (item != nullptr) {
    ...
    InventoryItem getWaterSource(ArrayList<InventoryItem> items) {
      ...
      for (int int0 = 0; int0 < items.size(); int0++) {
        ...
        if (item1.isWaterSource() && !item1.isBeingFilled() &&
            !item1.isTaintedWater()) {
  ...
  public
    List<String> getKnownRecipes() { return this.knownRecipes; }

    bool isRecipeKnown(Recipe recipe) {
      return DebugOptions.instance.CheatRecipeKnowAll.getValue()
                 ? true
                 : !recipe.needToBeLearn() || this.getKnownRecipes().contains(
    ...
    bool isMoving() {
      return this instanceof
          IsoPlayer && !((IsoPlayer)this).isAttackAnimThrowTimeOut()
              ? false
              : this.m_isMoving;
    }
    ...
    bool isPlayerMoving() { return false; }

    void setMoving(bool val) {
      this.m_isMoving = val;
      if (GameClient.bClient && this instanceof
          IsoPlayer && ((IsoPlayer)this).bRemote) {
    ...
    bool isFacingNorthWesterly() {
      return this.dir == IsoDirections.W || this.dir == IsoDirections.NW ||
             this.dir == IsoDirections.N || this.dir == IsoDirections.NE;
    }

    bool isAttacking() { return false; }

    bool isZombieAttacking() { return false; }

    bool isZombieAttacking(IsoMovingObject other) { return false; }
    ...
    int compareMovePriority(IsoGameCharacter other) {
      if (other == nullptr) {
        ...
        return -1;
      } else if (this.isFacingNorthWesterly() &&
                 !other.isFacingNorthWesterly()) {
        return 1;
      } else {
        return !this.isFacingNorthWesterly() && other.isFacingNorthWesterly()
                   ? -1
                   : 0;
      }
    }
    ...
    void addWorldSoundUnlessInvisible(int radius, int volume,
                                      bool bStressHumans) {
      if (!this.isInvisible()) {
        WorldSoundManager.instance.addSound(this, (int)this.getX(),
                                            (int)this.getY(), (int)this.getZ(),
                                            radius, volume, bStressHumans);
      }
    }
    ...
    bool isKnownPoison(InventoryItem item) {
      if (item.hasTag("NoDetect")) {
        ...
        if (food.getPoisonPower() <= 0) {
          return false;
        } else if (food.getHerbalistType() != nullptr &&
                   !food.getHerbalistType().isEmpty()) {
          return this.isRecipeKnown("Herbalist");
        } else {
          return food.getPoisonDetectionLevel() >= 0 &&
                         this.getPerkLevel(PerkFactory.Perks.Cooking) >=
                             10 - food.getPoisonDetectionLevel()
                     ? true
    ...
    int getLastHourSleeped() { return this.lastHourSleeped; }

    void setLastHourSleeped(int _lastHourSleeped) {
      this.lastHourSleeped = _lastHourSleeped;
    }

    void setTimeOfSleep(float _timeOfSleep) { this.timeOfSleep = _timeOfSleep; }

    void setDelayToSleep(float delay) { this.delayToActuallySleep = delay; }
    ...
    float Hit(BaseVehicle _vehicle, float speed, bool isHitFromBehind,
              float hitDirX, float hitDirY) {
      this.setHitFromBehind(isHitFromBehind);
      if (GameClient.bClient) {
        this.setAttackedBy(
            GameClient.IDToPlayerMap.get(_vehicle.getNetPlayerId()));
      } else if (GameServer.bServer) {
        this.setAttackedBy(
            GameServer.IDToPlayerMap.get(_vehicle.getNetPlayerId()));
      } else {
      ...
      DebugLog.Damage.noise(
          "Vehicle id=%d hit %s id=%d: speed=%f force=%f hitDir=%s",
          _vehicle.getId(), this.getClass().getSimpleName(), this.getOnlineID(),
          speed, this.getHitForce(), this.getHitDir());
      return this.getHealth();
    }

  public
    PolygonalMap2.Path getPath2() { return this.path2; }

    void setPath2(PolygonalMap2.Path path) { this.path2 = path; }

    PathFindBehavior2 getPathFindBehavior2() { return this.pfb2; }

    MapKnowledge getMapKnowledge() { return this.mapKnowledge; }

    IsoObject getBed() { return this.isAsleep() ? this.bed : nullptr; }

    void setBed(IsoObject _bed) { this.bed = _bed; }

    bool avoidDamage() { return this.m_avoidDamage; }

    void setAvoidDamage(bool avoid) { this.m_avoidDamage = avoid; }

    bool isReading() { return this.isReading; }

    void setReading(bool _isReading) { this.isReading = _isReading; }

    float getTimeSinceLastSmoke() { return this.timeSinceLastSmoke; }

    void setTimeSinceLastSmoke(float _timeSinceLastSmoke) {
      this.timeSinceLastSmoke = PZMath.clamp(_timeSinceLastSmoke, 0.0F, 10.0F);
    }

    bool isInvisible() { return this.m_invisible; }

    void setInvisible(bool b) { this.m_invisible = b; }

    bool isDriving() {
      return this.getVehicle() != nullptr &&
    ...
    bool isGodMod() { return this.m_godMod; }
    ...
    bool isUnlimitedCarry() { return this.unlimitedCarry; }

    void setUnlimitedCarry(bool _unlimitedCarry) {
      this.unlimitedCarry = _unlimitedCarry;
    }

    bool isBuildCheat() { return this.buildCheat; }

    void setBuildCheat(bool _buildCheat) { this.buildCheat = _buildCheat; }

    bool isFarmingCheat() { return this.farmingCheat; }

    void setFarmingCheat(bool b) { this.farmingCheat = b; }

    bool isHealthCheat() { return this.healthCheat; }

    void setHealthCheat(bool _healthCheat) { this.healthCheat = _healthCheat; }

    bool isMechanicsCheat() { return this.mechanicsCheat; }

    void setMechanicsCheat(bool _mechanicsCheat) {
      this.mechanicsCheat = _mechanicsCheat;
    }

    bool isMovablesCheat() { return this.movablesCheat; }

    void setMovablesCheat(bool b) { this.movablesCheat = b; }

    bool isTimedActionInstantCheat() { return this.timedActionInstantCheat; }
    ...
    bool isTimedActionInstant() {
      return Core.bDebug &&
                     DebugOptions.instance.CheatTimedActionInstant.getValue()
                 ? true
                 : this.isTimedActionInstantCheat();
    }

    bool isShowAdminTag() { return this.showAdminTag; }
  ...
  protected
    void setVariable(String string,
      ...
      this.getGameVariablesInternal().setVariable(
  ...
  public
    ...
    void clearVariables() { this.getGameVariablesInternal().clearVariables(); }
    ...
    std::string getFootInjuryType() {
      if (!(this instanceof IsoPlayer)) {
        ...
        BodyPart bodyPart0 =
            this.getBodyDamage().getBodyPart(BodyPartType.Foot_L);
        BodyPart bodyPart1 =
            this.getBodyDamage().getBodyPart(BodyPartType.Foot_R);
        if (!this.bRunning) {
          if (bodyPart0.haveBullet() || bodyPart0.getBurnTime() > 5.0F ||
              bodyPart0.bitten() || bodyPart0.deepWounded() ||
              bodyPart0.isSplint() || bodyPart0.getFractureTime() > 0.0F ||
              bodyPart0.haveGlass()) {
            return "leftheavy";
          }

          if (bodyPart1.haveBullet() || bodyPart1.getBurnTime() > 5.0F ||
              bodyPart1.bitten() || bodyPart1.deepWounded() ||
              bodyPart1.isSplint() || bodyPart1.getFractureTime() > 0.0F ||
              bodyPart1.haveGlass()) {
            return "rightheavy";
          }
        }

        if (bodyPart0.getScratchTime() > 5.0F ||
            bodyPart0.getCutTime() > 7.0F || bodyPart0.getBurnTime() > 0.0F) {
          return "leftlight";
        } else {
          return !(bodyPart1.getScratchTime() > 5.0F) &&
                         !(bodyPart1.getCutTime() > 7.0F) &&
                         !(bodyPart1.getBurnTime() > 0.0F)
                     ? ""
                     : "rightlight";
        }
      }
  ...
  public
    ...
    AnimationVariableSource getGameVariablesInternal() {
      return this.m_PlaybackGameVariables != nullptr
                 ? this.m_PlaybackGameVariables
                 : this.m_GameVariables;
    }

    AnimationVariableSource startPlaybackGameVariables() {
      if (this.m_PlaybackGameVariables != nullptr) {
        DebugLog.General.error(
            "Error! PlaybackGameVariables is already active.");
        return this.m_PlaybackGameVariables;
      } else {
        AnimationVariableSource animationVariableSource =
            new AnimationVariableSource();

        for (IAnimationVariableSlot iAnimationVariableSlot :
             this.getGameVariables()) {
          AnimationVariableType animationVariableType =
              iAnimationVariableSlot.getType();
          switch (animationVariableType) {
          case String:
            animationVariableSource.setVariable(
                iAnimationVariableSlot.getKey(),
          ...
          case Void:
            break;
          default:
            DebugLog.General.error("Error! Variable type not handled: %s",
                                   animationVariableType.toString());
          }
        }
    ...
    ActionStateSnapshot playbackRecordCurrentStateSnapshot() {
      return this.actionContext == nullptr
                 ? nullptr
    ...
    void actionStateChanged(ActionContext sender) {
      ...
      PZArrayUtil.listConvert(sender.getChildStates(), arrayList0,
                              actionState->actionState.name);
      this.advancedAnimator.SetState(sender.getCurrentStateName(), arrayList0);

      try {
        this.stateMachine.activeStateChanged++;
        State state = this.m_stateUpdateLookup.get(
            sender.getCurrentStateName().toLowerCase());
        if (state == nullptr) {
        ...
        PZArrayUtil.listConvert(
            sender.getChildStates(), arrayList1, this.m_stateUpdateLookup,
            (actionState, hashMap)
                ->hashMap.get(actionState.name.toLowerCase()));
    ...
    void setFallOnFront(bool _fallOnFront) { this.fallOnFront = _fallOnFront; }

    bool isHitFromBehind() { return this.hitFromBehind; }
    ...
    InventoryItem GetPrimaryEquippedCache() {
      return this.cacheEquiped[0] != nullptr &&
                     this.inventory.contains(this.cacheEquiped[0])
                 ? this.cacheEquiped[0]
                 : nullptr;
    }

    InventoryItem GetSecondaryEquippedCache() {
      return this.cacheEquiped[1] != nullptr &&
                     this.inventory.contains(this.cacheEquiped[1])
                 ? this.cacheEquiped[1]
                 : nullptr;
    }
    ...
    bool isAimAtFloor() { return this.bAimAtFloor; }

    void setAimAtFloor(bool b) { this.bAimAtFloor = b; }

    std::string testDotSide(IsoMovingObject target) {
      Vector2 vector0 = this.getLookVector(IsoGameCharacter.l_testDotSide.v1);
      Vector2 vector1 =
          IsoGameCharacter.l_testDotSide.v2.set(this.getX(), this.getY());
      Vector2 vector2 = IsoGameCharacter.l_testDotSide.v3.set(
          target.x - vector1.x, target.y - vector1.y);
      vector2.normalize();
      ...
      if (float0 > 0.7) {
        ...
        float float7 = (float1 - float3) * (float6 - float4) -
                       (float2 - float4) * (float5 - float3);
    ...
    void addBasicPatch(BloodBodyPartType part) {
      if (this instanceof IHumanVisual) {
        if (part == nullptr) {
          part = BloodBodyPartType.FromIndex(
              Rand.Next(0, BloodBodyPartType.MAX.index()));
        }
        ...
        if (!GameServer.bServer && this instanceof
            IsoPlayer && ((IsoPlayer)this).isLocalPlayer()) {
          LuaEventManager.triggerEvent("OnClothingUpdated", this);
        }
      }
    ...
    bool addHole(BloodBodyPartType part) { return this.addHole(part, false); }
    ...
    bool addHole(BloodBodyPartType part, bool allLayers) {
      if (!(this instanceof IHumanVisual)) {
        ...
        HumanVisual humanVisual = ((IHumanVisual)this).getHumanVisual();
        this.getItemVisuals(tempItemVisuals);
        bool boolean0 = BloodClothingType.addHole(part, humanVisual,
                                                  tempItemVisuals, allLayers);
        this.bUpdateModelTextures = true;
        if (!GameServer.bServer && this instanceof
            IsoPlayer && ((IsoPlayer)this).isLocalPlayer()) {
          LuaEventManager.triggerEvent("OnClothingUpdated", this);
    ...
    void addDirt(BloodBodyPartType part, int nbr, bool allLayers) {
      ...
      for (int int0 = 0; int0 < nbr; int0++) {
        ...
        BloodClothingType.addDirt(part, humanVisual, tempItemVisuals,
                                  allLayers);
      }
    ...
    void addBlood(BloodBodyPartType part, bool scratched, bool bitten,
                  bool allLayers) {
      HumanVisual humanVisual = ((IHumanVisual)this).getHumanVisual();
      int int0 = 1;
      bool boolean0 = false;
      ...
      for (int int1 = 0; int1 < int0; int1++) {
        ...
        BloodClothingType.addBlood(part, humanVisual, tempItemVisuals,
                                   allLayers);
      }
        ...
        if (item0 != nullptr) {
          ...
          if (arrayList0 != nullptr) {
            std::vector arrayList1 =
                BloodClothingType.getCoveredParts(arrayList0);
            if (arrayList1 != nullptr) {
              InventoryItem item1 = itemVisual.getInventoryItem();
              if (item1 == nullptr) {
                item1 =
                    InventoryItemFactory.CreateItem(itemVisual.getItemType());
                if (item1 == nullptr) {
                  continue;
                }
              }
              ...
              for (int int1 = 0; int1 < arrayList1.size(); int1++) {
                if (item1 instanceof
                    Clothing &&
                        ((BloodBodyPartType)arrayList1.get(int1)).index() ==
                            part &&
                        itemVisual.getHole(
                            (BloodBodyPartType)arrayList1.get(int1)) == 0.0F) {
                  Clothing clothing = (Clothing)item1;
                  float0 += clothing.getDefForPart(
                      (BloodBodyPartType)arrayList1.get(int1), bite, bullet);
                  break;
                }
              }
            }
    ...
    bool isBumpDone() { return this.m_isBumpDone; }

    void setBumpDone(bool val) { this.m_isBumpDone = val; }

    bool isBumpFall() { return this.m_bumpFall; }

    void setBumpFall(bool val) { this.m_bumpFall = val; }

    bool isBumpStaggered() { return this.m_bumpStaggered; }

    void setBumpStaggered(bool val) { this.m_bumpStaggered = val; }
    ...
    long getLastBump() { return this.lastBump; }

    void setLastBump(long _lastBump) { this.lastBump = _lastBump; }

    bool isSitOnGround() { return this.sitOnGround; }

    void setSitOnGround(bool _sitOnGround) { this.sitOnGround = _sitOnGround; }

    std::string getUID() { return this.m_UID; }

  protected
    HashMap<String, State> getStateUpdateLookup() {
      return this.m_stateUpdateLookup;
    }

    bool isRunning() {
      return this.getMoodles() != nullptr &&
                     this.getMoodles().getMoodleLevel(MoodleType.Endurance) >= 3
                 ? false
                 : this.bRunning;
    }

    void setRunning(bool _bRunning) { this.bRunning = _bRunning; }

    bool isSprinting() {
      return this.bSprinting && !this.canSprint() ? false : this.bSprinting;
    }

    void setSprinting(bool _bSprinting) { this.bSprinting = _bSprinting; }
    ...
    return true;
        ...
        if (item != nullptr && item.isEquippedNoSprint()) {
          ...
          return item != nullptr && item.isEquippedNoSprint()
                     ? false
                     : this.getMoodles() == nullptr ||
                           this.getMoodles().getMoodleLevel(
                               MoodleType.Endurance) < 2;
        }
      }
    }

    void postUpdateModelTextures() { this.bUpdateModelTextures = true; }
    ...
    void postUpdateEquippedTextures() { this.bUpdateEquippedTextures = true; }

  public
    ArrayList<ModelInstance> getReadyModelData() { return this.readyModelData; }

    bool getIgnoreMovement() { return this.ignoreMovement; }
    ...
    bool isAutoWalk() { return this.bAutoWalk; }

    void setAutoWalk(bool b) { this.bAutoWalk = b; }

    void setAutoWalkDirection(Vector2 v) { this.autoWalkDirection.set(v); }

    Vector2 getAutoWalkDirection() { return this.autoWalkDirection; }

    bool isSneaking() {
      return this.getVariableFloat("WalkInjury", 0.0F) > 0.5F ? false
                                                              : this.bSneaking;
    }

    void setSneaking(bool _bSneaking) { this.bSneaking = _bSneaking; }

    GameCharacterAIBrain getGameCharacterAIBrain() {
      return this.GameCharacterAIBrain;
    }

    float getMoveDelta() { return this.m_moveDelta; }

    void setMoveDelta(float moveDelta) { this.m_moveDelta = moveDelta; }

    float getTurnDelta() {
      if (this.isSprinting()) {
        return this.m_turnDeltaSprinting;
      } else {
        return this.isRunning() ? this.m_turnDeltaRunning
                                : this.m_turnDeltaNormal;
      }
    }
    ...
    float getChopTreeSpeed() {
      return (this.Traits.Axeman.isSet() ? 1.25F : 1.0F) *
             GameTime.getAnimSpeedFix();
    }

    /**
     * Test if we're able to defend a zombie bite  Can only happen if zombie is
     * attacking from front  Calcul include current weapon skills, fitness &
     * strength
     */
    bool testDefense(IsoZombie zomb) {
      if (this.testDotSide(zomb) == "FRONT") && !zomb.bCrawling && this.getSurroundingAttackingZombies() <= 3) {
          ...
          if (Rand.Next(100) < int0) {
            ...
            this.setHitReaction(zomb.getVariableString("PlayerHitReaction") +
                                "Defended");
            return true;
          } else {
            return false;
    ...
    int getSurroundingAttackingZombies() {
      ...
      if (square == nullptr) {
        ...
        for (int int1 = 0; int1 < movingStatic.size(); int1++) {
          IsoZombie zombie0 =
              Type.tryCastTo(movingStatic.get(int1), IsoZombie.class);
          if (zombie0 != nullptr && zombie0.target == this &&
    ...
    float checkIsNearWall() {
      if (this.bSneaking && this.getCurrentSquare() != nullptr) {
        IsoGridSquare square0 =
            this.getCurrentSquare().nav[IsoDirections.N.index()];
        IsoGridSquare square1 =
            this.getCurrentSquare().nav[IsoDirections.S.index()];
        IsoGridSquare square2 =
            this.getCurrentSquare().nav[IsoDirections.E.index()];
        IsoGridSquare square3 =
            this.getCurrentSquare().nav[IsoDirections.W.index()];
        float float0 = 0.0F;
        float float1 = 0.0F;
        if (square0 != nullptr) {
        ...
        if (float0 > 1.0F) {
          ...
          return float0;
                   ...
                   IsoPlayer && ((IsoPlayer)this).isNearVehicle()) {
          this.setVariable("nearWallCrouching", true);
          return 6.0F;
        } else {
    ...
    float getBeenSprintingFor() { return this.BeenSprintingFor; }
    ...
    bool isHideWeaponModel() { return this.hideWeaponModel; }
    ...
    void setIsAiming(bool aIsAiming) {
      ...
      if (this instanceof
          IsoPlayer && !((IsoPlayer)this).isAttackAnimThrowTimeOut() ||
              this.isAttackAnim() || this.getVariableBoolean("ShoveAnim")) {
        aIsAiming = true;
      }
    ...
    bool isAiming() {
      if (GameClient.bClient && this instanceof
          IsoPlayer && ((IsoPlayer)this).isLocalPlayer() &&
              DebugOptions.instance.MultiplayerAttackPlayer.getValue()) {
        return false;
      } else {
      ...
      if (!(this instanceof IsoPlayer) || ((IsoPlayer)this).isLocalPlayer()) {
        if (!this.isInvincible()) {
          ...
          BloodBodyPartType bloodBodyPartType0 = BloodBodyPartType.FromIndex(
              Rand.Next(BloodBodyPartType.Hand_L.index(),
                        BloodBodyPartType.Torso_Upper.index()));
          if (Rand.NextBool(2)) {
            bloodBodyPartType0 = BloodBodyPartType.FromIndex(
                Rand.Next(BloodBodyPartType.UpperLeg_L.index(),
                          BloodBodyPartType.Back.index()));
          }
          ...
          for (int int0 = 0; int0 < 4; int0++) {
            BloodBodyPartType bloodBodyPartType1 = BloodBodyPartType.FromIndex(
                Rand.Next(BloodBodyPartType.Hand_L.index(),
                          BloodBodyPartType.Torso_Upper.index()));
            if (Rand.NextBool(2)) {
              bloodBodyPartType1 = BloodBodyPartType.FromIndex(
                  Rand.Next(BloodBodyPartType.UpperLeg_L.index(),
                            BloodBodyPartType.Back.index()));
            }
          ...
          if (Rand.NextBool(2)) {
            ...
            BodyPart bodyPart = this.getBodyDamage().getBodyPart(
                BodyPartType.FromIndex(bloodBodyPartType0.index()));
    ...
    ItemVisual addBodyVisualFromItemType(const std::string &string) {
      ...
      return item != nullptr &&
                 ...
                 ? this.addBodyVisualFromClothingItemName(
    ...
    ItemVisual addBodyVisualFromClothingItemName(const std::string &string1) {
      ...
      if (iHumanVisual == nullptr) {
        ...
        std::string string0 =
            ScriptManager.instance.getItemTypeForClothingItem(string1);
        if (string0 == nullptr) {
          return null;
        } else {
            ...
            if (clothingItem == nullptr) {
              ...
              if (!this.isDuplicateBodyVisual(itemVisual)) {
                ItemVisuals itemVisuals =
                    iHumanVisual.getHumanVisual().getBodyVisuals();
    ...
    bool isDuplicateBodyVisual(ItemVisual itemVisual1) {
      ...
      if (iHumanVisual == nullptr) {
        ...
        for (int int0 = 0; int0 < itemVisuals.size(); int0++) {
          ...
          if (itemVisual1.getClothingItemName() ==
              itemVisual0.getClothingItemName())
    ...
    bool isCriticalHit() { return this.isCrit; }

    void setCriticalHit(bool _isCrit) { this.isCrit = _isCrit; }
    ...
    void startMuzzleFlash() {
      ...
      IsoLightSource lightSource = new IsoLightSource(
          (int)this.getX(), (int)this.getY(), (int)this.getZ(), 0.8F * float0,
          0.8F * float0, 0.6F * float0, 18, 6);
    ...
    bool isMuzzleFlash() {
      return Core.bDebug &&
                     DebugOptions.instance.ModelRenderMuzzleflash.getValue()
                 ? true
                 : this.m_muzzleFlash > System.currentTimeMillis() - 50L;
    }

    bool isNPC() { return this.isNPC; }
    ...
    double getThirstMultiplier() {
      return this.getBodyDamage() != nullptr &&
                     this.getBodyDamage().getThermoregulator() != nullptr
                 ? this.getBodyDamage()
                       .getThermoregulator()
                       .getFluidsMultiplier()
    ...
    double getHungerMultiplier() { return 1.0; }
    ...
    float getTimedActionTimeModifier() { return 1.0F; }
    ...
    bool addHoleFromZombieAttacks(BloodBodyPartType part, bool scratch) {
          ...
          if (arrayList0 != nullptr) {
            ...
            for (int int1 = 0; int1 < arrayList1.size(); int1++) {
              BloodBodyPartType bloodBodyPartType =
                  (BloodBodyPartType)arrayList1.get(int1);
      ...
      float float0 = 0.0F;
      bool boolean0 = false;
      if (itemVisual0 != nullptr && itemVisual0.getInventoryItem() != nullptr &&
              itemVisual0.getInventoryItem()
              instanceof Clothing) {
        Clothing clothing = (Clothing)itemVisual0.getInventoryItem();
        Clothing.ClothingPatch clothingPatch = clothing.getPatchType(part);
        float0 = Math.max(
            30.0F,
            100.0F - clothing.getDefForPart(part, !scratch, false) / 1.5F);
      }

      if (Rand.Next(100) < float0) {
        bool boolean1 = this.addHole(part);
        if (boolean1) {
          this.getEmitter().playSoundImpl("ZombieRipClothing",
                                          (IsoObject) nullptr);
        }
    ...
    void updateBandages() { s_bandages.update(this); }
    ...
    void attackFromWindowsLunge(IsoZombie zombie) {
      if (!(this.lungeFallTimer > 0.0F) &&
          (int)this.getZ() == (int)zombie.getZ() && !zombie.isDead() &&
          this.getCurrentSquare() != nullptr &&
        ...
        if (this.getVehicle() == nullptr) {
          bool boolean0 = this.DoSwingCollisionBoneCheck(
              zombie,
              zombie.getAnimationPlayer().getSkinningBoneIndex("Bip01_R_Hand",
                                                               -1),
              1.0F);
          if (boolean0) {
            ...
            int0 -= this.getPerkLevel(PerkFactory.Perks.Fitness) * 2;
            BodyPart bodyPart =
                this.getBodyDamage().getBodyPart(BodyPartType.Torso_Lower);
            if (bodyPart.getAdditionalPain(true) > 20.0F) {
              int0 = (int)(int0 +
                           (bodyPart.getAdditionalPain(true) - 20.0F) / 10.0F);
            }
    ...
    bool DoSwingCollisionBoneCheck(IsoGameCharacter zombie, int bone,
                                   float tempoLengthTest) {
      Model.BoneToWorldCoords(zombie, bone, tempVectorBonePos);
      float float0 = IsoUtils.DistanceToSquared(
          tempVectorBonePos.x, tempVectorBonePos.y, this.x, this.y);
        ...
        for (int int4 = int1; int4 < int3; int4++) {
          for (int int5 = int0; int5 < int2; int5++) {
            IsoChunk chunk =
                GameServer.bServer
                    ? ServerMap.instance.getChunk(int5, int4)
                    : IsoWorld.instance.CurrentCell.getChunk(int5, int4);
            if (chunk != nullptr) {
              for (int int6 = 0; int6 < chunk.vehicles.size(); int6++) {
                BaseVehicle vehiclex = chunk.vehicles.get(int6);
                if (vehiclex.getScript() != nullptr &&
                    ...
                    (!(this instanceof IsoPlayer) ||
                     !((IsoPlayer)this).isLocalPlayer() ||
                     vehiclex.getTargetAlpha(((IsoPlayer)this).PlayerIndex) !=
                         0.0F) &&
                    !(this.DistToSquared((int)vehiclex.x, (int)vehiclex.y) >=
                      16.0F)) {
                  return vehiclex;
                }
              }
          ...
          if (square != nullptr) {
            ...
            if (this.isHeavyItem(item1)) {
              ...
              if (!boolean0) {
                ...
                float float5 =
                    square.getApparentZ(float3, float4) - square.getZ();
                this.getInventory().DoRemoveItem(item1);
    ...
    bool isCanShout() { return this.canShout; }

    void setCanShout(bool _canShout) { this.canShout = _canShout; }

    bool isUnlimitedEndurance() { return this.unlimitedEndurance; }

    void setUnlimitedEndurance(bool _unlimitedEndurance) {
      this.unlimitedEndurance = _unlimitedEndurance;
    }

    void addActiveLightItem(InventoryItem item,
                            ArrayList<InventoryItem> arrayList) {
      if (item != nullptr && item.isEmittingLight() &&
  ...
  public
    ArrayList<InventoryItem> getActiveLightItems(
    ...
    bool shouldWaitToStartTimedAction() {
      if (this.isSitOnGround()) {
        ...
        if (advancedAnimatorx.getRootLayer() == nullptr) {
          return false;
        } else if (advancedAnimatorx.animSet != nullptr &&
                   advancedAnimatorx.animSet.containsState("sitonground")) {
          AnimState animState =
              advancedAnimatorx.animSet.GetState("sitonground");
          if (!PZArrayUtil.contains(
                  animState.m_Nodes,
                  animNode->"sit_action".equalsIgnoreCase(animNode.m_Name))) {
            return false;
          } else {
            LiveAnimNode liveAnimNode = PZArrayUtil.find(
                advancedAnimatorx.getRootLayer().getLiveAnimNodes(),
                liveAnimNodex->liveAnimNodex.isActive() &&
                    "sit_action".equalsIgnoreCase(liveAnimNodex.getName()));
    ...
    int getPersistentOutfitID() { return this.m_persistentOutfitId; }

    bool isPersistentOutfitInit() { return this.m_bPersistentOutfitInit; }

    bool isDoingActionThatCanBeCancelled() { return false; }

    bool isDoDeathSound() { return this.doDeathSound; }
    ...
    void updateEquippedRadioFreq() {
      ...
      for (int int0 = 0; int0 < this.getInventory().getItems().size(); int0++) {
        ...
        if (item instanceof Radio radio && radio.getDeviceData() != nullptr &&
                                radio.getDeviceData().getIsTurnedOn() &&
                                !radio.getDeviceData().getMicIsMuted() &&
                                !this.invRadioFreq.contains(
                                    radio.getDeviceData().getChannel())) {
    ...
    void startEvent(long eventInstance, GameSoundClip clip,
                    BitSet parameterSet) {
    ...
    void stopEvent(long eventInstance, GameSoundClip clip,
                   BitSet parameterSet) {
      FMODParameterList fMODParameterList = this.getFMODParameters();
      std::vector arrayList = clip.eventDescription.parameters;
    ...
    void setIgnoreAimingInput(bool b) { this.ignoreAimingInput = b; }
    ...
    bool isKnockedDown() { return this.bKnockedDown; }
    ...
    void writeInventory(ByteBuffer b) {
      std::string string =
          this.isFemale() ? "inventoryfemale" : "inventorymale";
      ...
      if (this.getInventory() != nullptr) {
        ...
        try {
          ...
          DebugLog.Multiplayer.printException(
              iOException,
              "WriteInventory error for character " + this.getOnlineID(),
              LogSeverity.Error);
        }
      } else {
        b.put((byte)0);
      ...
      if (boolean0) {
        try {
          std::vector arrayList =
              this.getInventory().load(b, IsoWorld.getWorldVersion());
          uint8_t byte0 = b.get();
          ...
          for (int int0 = 0; int0 < byte0; int0++) {
            ...
            if (short0 >= 0 && short0 < arrayList.size() &&
                this.getBodyLocationGroup().getLocation(string1) != nullptr) {
              this.getWornItems().setItem(string1,
          ...
          for (int int1 = 0; int1 < byte1; int1++) {
            ...
            if (short1 >= 0 && short1 < arrayList.size() &&
                this.getAttachedLocationGroup().getLocation(string2) !=
                    nullptr) {
          ...
          DebugLog.Multiplayer.printException(
              iOException,
              "ReadInventory error for character " + this.getOnlineID(),
              LogSeverity.Error);
        }
      }
    ...
    bool shouldDoInventory() { return true; }
    ...
    bool shouldBecomeCorpse() {
      if (GameClient.bClient || GameServer.bServer) {
        if (this.getHitReactionNetworkAI().isSetup() ||
            this.getHitReactionNetworkAI().isStarted()) {
          return false;
        }
        ...
        if (GameClient.bClient) {
          return this.isCurrentState(ZombieOnGroundState.instance()) ||
    ...
    HitReactionNetworkAI getHitReactionNetworkAI() { return null; }

    NetworkCharacterAI getNetworkCharacterAI() { return null; }

    bool isLocal() { return !GameClient.bClient && !GameServer.bServer; }
    ...
    bool isVehicleCollisionActive(BaseVehicle testVehicle) {
      if (!GameClient.bClient) {
        ...
        return false;
      } else if (testVehicle.isNetPlayerAuthorization(
                     BaseVehicle.Authorization.Server)) {
        return false;
      } else if (testVehicle.isEngineRunning() ||
                 testVehicle.getVehicleTowing() != nullptr &&
                     testVehicle.getVehicleTowing().isEngineRunning() ||
                 testVehicle.getVehicleTowedBy() != nullptr &&
                     testVehicle.getVehicleTowedBy().isEngineRunning()) {
        if (testVehicle.getDriver() != nullptr ||
            testVehicle.getVehicleTowing() != nullptr &&
                testVehicle.getVehicleTowing().getDriver() != nullptr ||
            testVehicle.getVehicleTowedBy() != nullptr &&
                testVehicle.getVehicleTowedBy().getDriver() != nullptr) {
          return Math.abs(testVehicle.x - this.x) < 0.01F ||
                         Math.abs(testVehicle.y - this.y) < 0.01F
                     ? false
    ...
    void doHitByVehicle(BaseVehicle baseVehicle, BaseVehicle.HitVars hitVars) {
      if (GameClient.bClient) {
        IsoPlayer player =
            GameClient.IDToPlayerMap.get(baseVehicle.getNetPlayerId());
        if (player != nullptr) {
          if (player.isLocal()) {
            SoundManager.instance.PlayWorldSound("VehicleHitCharacter",
                                                 this.getCurrentSquare(), 0.0F,
                                                 20.0F, 0.9F, true);
            float float0 = this.Hit(
                baseVehicle, hitVars.hitSpeed, hitVars.isTargetHitFromBehind,
                -hitVars.targetImpulse.x, -hitVars.targetImpulse.z);
            GameClient.sendHitVehicle(player, this, baseVehicle, float0,
                                      hitVars.isTargetHitFromBehind,
                                      hitVars.vehicleDamage, hitVars.hitSpeed,
        ...
        BaseSoundEmitter baseSoundEmitter =
            IsoWorld.instance.getFreeEmitter(this.x, this.y, this.z);
        ...
        baseSoundEmitter.setParameterValue(
            ...
            baseVehicle.getCurrentSpeedKmHour());
        this.Hit(baseVehicle, hitVars.hitSpeed, hitVars.isTargetHitFromBehind,
                 -hitVars.targetImpulse.x, -hitVars.targetImpulse.z);
      }
    }
    ...
    bool isAttackAnim() { return this.attackAnim; }

    void setAttackAnim(bool _attackAnim) { this.attackAnim = _attackAnim; }

    float getNextAnimationTranslationLength() {
      if (this.getActionContext() != nullptr &&
          this.getAnimationPlayer() != nullptr &&
          this.getAdvancedAnimator() != nullptr) {
        ActionState actionState = this.getActionContext().getNextState();
        if (actionState != nullptr &&
            !StringUtils.isNullOrEmpty(actionState.getName())) {
          std::vector arrayList = new ArrayList();
          this.getAdvancedAnimator()
              .animSet.GetState(actionState.getName())
              .getAnimNodes(this, arrayList);

          for (auto &animNode : arrayList)
            if (!StringUtils.isNullOrEmpty(animNode.m_AnimName)) {
              AnimationClip animationClip =
                  this.getAnimationPlayer()
                      .getSkinningData()
                      .AnimationClips.get(animNode.m_AnimName);
              if (animationClip != nullptr) {
                return animationClip.getTranslationLength(
                    animNode.m_deferredBoneAxis);
              }
            }
        }
      }
  ...
  float calcHitDir(IsoGameCharacter wielder, HandWeapon weapon, Vector2 out) {
    ...
    out.set(this.getX() - wielder.getX(), this.getY() - wielder.getY())
        .normalize();
    if (float0 == nullptr) {
  ...
  Safety getSafety() { return this.safety; }

  void setSafety(Safety _safety) { this.safety.copyFrom(_safety); }
...
private
  static final class Bandages {
    ...
    void update(IsoGameCharacter character) {
      if (!GameServer.bServer) {
        ...
        if (bodyDamage != nullptr && wornItems != nullptr) {
          ...
          for (int int1 = 0; int1 < BodyPartType.ToIndex(BodyPartType.MAX);
               int1++) {
            BodyPart bodyPart =
                bodyDamage.getBodyPart(BodyPartType.FromIndex(int1));
            BodyPartLast bodyPartLast =
                bodyDamage.getBodyPartsLastState(BodyPartType.FromIndex(int1));
            ...
            if (!StringUtils.isNullOrWhitespace(string0)) {
              ...
              if (bodyPart.bitten() != bodyPartLast.bitten()) {
                if (bodyPart.bitten()) {
                  std::string string2 = bodyPart.getType().getBiteWoundModel(
                      character.isFemale());
                  ...
                  this.removeBandageModel(character,
                                          bodyPart.getType().getBiteWoundModel(
                                              character.isFemale()));
                }
              }
              ...
              if (bodyPart.scratched() != bodyPartLast.scratched()) {
                if (bodyPart.scratched()) {
                  std::string string3 = bodyPart.getType().getScratchWoundModel(
                      character.isFemale());
                  ...
                  this.removeBandageModel(
                      character, bodyPart.getType().getScratchWoundModel(
                                     character.isFemale()));
                }
              }
              ...
              if (bodyPart.isCut() != bodyPartLast.isCut()) {
                if (bodyPart.isCut()) {
                  std::string string4 =
                      bodyPart.getType().getCutWoundModel(character.isFemale());
                  if (!StringUtils.isNullOrWhitespace(string4)) {
                    this.addBandageModel(character, string4);
                  }
                } else {
                  this.removeBandageModel(character,
                                          bodyPart.getType().getCutWoundModel(
                                              character.isFemale()));
                }
              }
            }
    ...
    void removeBandageModel(IsoGameCharacter character,
      ...
      if (item != nullptr) {
        ...
        if (GameClient.bClient && character instanceof
            IsoPlayer && ((IsoPlayer)character).isLocalPlayer()) {
          GameClient.instance.sendClothing((IsoPlayer)character,
                                           item.getBodyLocation(), item);
        }
      }
    }
  }
  ...
  public static enum BodyLocation {
    Head, Leg, Arm, Chest, Stomach, Foot, Hand;
  }

  public class CharacterTraits extends TraitCollection {
  public
    final TraitCollection.TraitSlot Obese = this.getTraitSlot("Obese");
  public
    final TraitCollection.TraitSlot Athletic = this.getTraitSlot("Athletic");
  public
    final TraitCollection.TraitSlot Overweight =
        this.getTraitSlot("Overweight");
  public
    final TraitCollection.TraitSlot Unfit = this.getTraitSlot("Unfit");
  public
    final TraitCollection.TraitSlot Emaciated = this.getTraitSlot("Emaciated");
  public
    final TraitCollection.TraitSlot Graceful = this.getTraitSlot("Graceful");
  public
    final TraitCollection.TraitSlot Clumsy = this.getTraitSlot("Clumsy");
  public
    final TraitCollection.TraitSlot Strong = this.getTraitSlot("Strong");
  public
    final TraitCollection.TraitSlot Weak = this.getTraitSlot("Weak");
  public
    final TraitCollection.TraitSlot VeryUnderweight =
        this.getTraitSlot("Very Underweight");
  public
    final TraitCollection.TraitSlot Underweight =
        this.getTraitSlot("Underweight");
  public
    final TraitCollection.TraitSlot FastHealer =
        this.getTraitSlot("FastHealer");
  public
    final TraitCollection.TraitSlot SlowHealer =
        this.getTraitSlot("SlowHealer");
  public
    final TraitCollection.TraitSlot ShortSighted =
        this.getTraitSlot("ShortSighted");
  public
    final TraitCollection.TraitSlot EagleEyed = this.getTraitSlot("EagleEyed");
  public
    final TraitCollection.TraitSlot Agoraphobic =
        this.getTraitSlot("Agoraphobic");
  public
    final TraitCollection.TraitSlot Claustophobic =
        this.getTraitSlot("Claustophobic");
  public
    final TraitCollection.TraitSlot AdrenalineJunkie =
        this.getTraitSlot("AdrenalineJunkie");
  public
    final TraitCollection.TraitSlot OutOfShape =
        this.getTraitSlot("Out of Shape");
  public
    final TraitCollection.TraitSlot HighThirst =
        this.getTraitSlot("HighThirst");
  public
    final TraitCollection.TraitSlot LowThirst = this.getTraitSlot("LowThirst");
  public
    final TraitCollection.TraitSlot HeartyAppitite =
        this.getTraitSlot("HeartyAppitite");
  public
    final TraitCollection.TraitSlot LightEater =
        this.getTraitSlot("LightEater");
  public
    final TraitCollection.TraitSlot Cowardly = this.getTraitSlot("Cowardly");
  public
    final TraitCollection.TraitSlot Brave = this.getTraitSlot("Brave");
  public
    final TraitCollection.TraitSlot Brooding = this.getTraitSlot("Brooding");
  public
    final TraitCollection.TraitSlot Insomniac = this.getTraitSlot("Insomniac");
  public
    final TraitCollection.TraitSlot NeedsLessSleep =
        this.getTraitSlot("NeedsLessSleep");
  public
    final TraitCollection.TraitSlot NeedsMoreSleep =
        this.getTraitSlot("NeedsMoreSleep");
  public
    final TraitCollection.TraitSlot Asthmatic = this.getTraitSlot("Asthmatic");
  public
    final TraitCollection.TraitSlot PlaysFootball =
        this.getTraitSlot("PlaysFootball");
  public
    final TraitCollection.TraitSlot Jogger = this.getTraitSlot("Jogger");
  public
    final TraitCollection.TraitSlot NightVision =
        this.getTraitSlot("NightVision");
  public
    final TraitCollection.TraitSlot FastLearner =
        this.getTraitSlot("FastLearner");
  public
    final TraitCollection.TraitSlot SlowLearner =
        this.getTraitSlot("SlowLearner");
  public
    final TraitCollection.TraitSlot Pacifist = this.getTraitSlot("Pacifist");
  public
    final TraitCollection.TraitSlot Feeble = this.getTraitSlot("Feeble");
  public
    final TraitCollection.TraitSlot Stout = this.getTraitSlot("Stout");
  public
    final TraitCollection.TraitSlot ShortTemper =
        this.getTraitSlot("ShortTemper");
  public
    final TraitCollection.TraitSlot Patient = this.getTraitSlot("Patient");
  public
    final TraitCollection.TraitSlot Injured = this.getTraitSlot("Injured");
  public
    final TraitCollection.TraitSlot Inconspicuous =
        this.getTraitSlot("Inconspicuous");
  public
    final TraitCollection.TraitSlot Conspicuous =
        this.getTraitSlot("Conspicuous");
  public
    final TraitCollection.TraitSlot Desensitized =
        this.getTraitSlot("Desensitized");
  public
    final TraitCollection.TraitSlot NightOwl = this.getTraitSlot("NightOwl");
  public
    final TraitCollection.TraitSlot Hemophobic =
        this.getTraitSlot("Hemophobic");
  public
    final TraitCollection.TraitSlot Burglar = this.getTraitSlot("Burglar");
  public
    final TraitCollection.TraitSlot KeenHearing =
        this.getTraitSlot("KeenHearing");
  public
    final TraitCollection.TraitSlot Deaf = this.getTraitSlot("Deaf");
  public
    final TraitCollection.TraitSlot HardOfHearing =
        this.getTraitSlot("HardOfHearing");
  public
    final TraitCollection.TraitSlot ThinSkinned =
        this.getTraitSlot("ThinSkinned");
  public
    final TraitCollection.TraitSlot ThickSkinned =
        this.getTraitSlot("ThickSkinned");
  public
    final TraitCollection.TraitSlot Marksman = this.getTraitSlot("Marksman");
  public
    final TraitCollection.TraitSlot Outdoorsman =
        this.getTraitSlot("Outdoorsman");
  public
    final TraitCollection.TraitSlot Lucky = this.getTraitSlot("Lucky");
  public
    final TraitCollection.TraitSlot Unlucky = this.getTraitSlot("Unlucky");
  public
    final TraitCollection.TraitSlot Nutritionist =
        this.getTraitSlot("Nutritionist");
  public
    final TraitCollection.TraitSlot Nutritionist2 =
        this.getTraitSlot("Nutritionist2");
  public
    final TraitCollection.TraitSlot Organized = this.getTraitSlot("Organized");
  public
    final TraitCollection.TraitSlot Disorganized =
        this.getTraitSlot("Disorganized");
  public
    final TraitCollection.TraitSlot Axeman = this.getTraitSlot("Axeman");
  public
    final TraitCollection.TraitSlot IronGut = this.getTraitSlot("IronGut");
  public
    final TraitCollection.TraitSlot WeakStomach =
        this.getTraitSlot("WeakStomach");
  public
    final TraitCollection.TraitSlot HeavyDrinker =
        this.getTraitSlot("HeavyDrinker");
  public
    final TraitCollection.TraitSlot LightDrinker =
        this.getTraitSlot("LightDrinker");
  public
    final TraitCollection.TraitSlot Resilient = this.getTraitSlot("Resilient");
  public
    final TraitCollection.TraitSlot ProneToIllness =
        this.getTraitSlot("ProneToIllness");
  public
    final TraitCollection.TraitSlot SpeedDemon =
        this.getTraitSlot("SpeedDemon");
  public
    final TraitCollection.TraitSlot SundayDriver =
        this.getTraitSlot("SundayDriver");
  public
    final TraitCollection.TraitSlot Smoker = this.getTraitSlot("Smoker");
  public
    final TraitCollection.TraitSlot Hypercondriac =
        this.getTraitSlot("Hypercondriac");
  public
    final TraitCollection.TraitSlot Illiterate =
        this.getTraitSlot("Illiterate");

    bool isIlliterate() { return this.Illiterate.isSet(); }
  }

  private static final class L_actionStateChanged {
    static final ArrayList<String> stateNames = std::make_unique<ArrayList<>>();
    static final ArrayList<State> states = std::make_unique<ArrayList<>>();
  }
  ...
  public static class LightInfo {
    ...
    float angleY;
  public
    ArrayList<IsoGameCharacter.TorchInfo> torches =
        std::make_unique<ArrayList<>>();
    long time;
    float night;
    float rmod;
  ...
  public
    IsoGameCharacter.Location set(int _x, int _y, int _z) {
      this.x = _x;
      this.y = _y;
      this.z = _z;
      return this;
    ...
    bool equals(void *other) {
      return !(other instanceof IsoGameCharacter.Location location)
                 ? false
  ...
  private
    static final ObjectPool<IsoGameCharacter.TorchInfo> TorchInfoPool =
        new ObjectPool<>(IsoGameCharacter.TorchInfo::new);
  ...
  public
    static IsoGameCharacter.TorchInfo alloc() { return TorchInfoPool.alloc(); }
  ...
  public
    IsoGameCharacter.TorchInfo set(IsoPlayer player, InventoryItem item) {
      this.x = player.getX();
      this.y = player.getY();
      this.z = player.getZ();
  ...
  public
    IsoGameCharacter.TorchInfo set(VehiclePart part) {
      ...
      vector3f.set(vehicleLight.offset.x * vehicleScript.getExtents().x / 2.0F,
                   0.0F,
                   vehicleLight.offset.y * vehicleScript.getExtents().z / 2.0F);
  ...
  public class XP {
    ...
    float TotalXP = 0.0F;
  public
    HashMap<PerkFactory.Perk, Float> XPMap = std::make_unique<HashMap<>>();
  ...
  public
    HashMap<PerkFactory.Perk, IsoGameCharacter.XPMultiplier> XPMapMultiplier =
        std::make_unique<HashMap<>>();
    IsoGameCharacter chr = null;

  public
    XP(IsoGameCharacter character1) { this.chr = character1; }
      ...
      if (GameServer.bServer && this.chr instanceof IsoPlayer) {
        if (System.currentTimeMillis() - this.lastXPTime > 60000L) {
          ...
          if (this.lastXPGrowthRate >
              1000.0 * SandboxOptions.instance.XpMultiplier.getValue() *
                  ServerOptions.instance
                      .AntiCheatProtectionType9ThresholdMultiplier.getValue()) {
            UdpConnection udpConnection =
                GameServer.getConnectionFromPlayer((IsoPlayer)this.chr);
            if (ServerOptions.instance.AntiCheatProtectionType9.getValue() &&
              ...
              PacketValidator.doKickUser(udpConnection,
                       ...
                       1000.0 *
                           ...
                           ServerOptions.instance
                               ...
                               .getValue() /
                           2.0) {
              PacketValidator.doLogUser(
                  udpConnection, Userlog.UserlogType.SuspiciousActivity,
                  this.getClass().getSimpleName(), "Type9");
            }
          }
        }
      }
    ...
    void addXpMultiplier(PerkFactory.Perk perks, float multiplier, int minLevel,
                         int maxLevel) {
      IsoGameCharacter.XPMultiplier xPMultiplier =
          this.XPMapMultiplier.get(perks);
  ...
  public
    ...
    float getMultiplier(PerkFactory.Perk perk) {
      IsoGameCharacter.XPMultiplier xPMultiplier =
          this.XPMapMultiplier.get(perk);
      return xPMultiplier = = null ? 0.0F : xPMultiplier.multiplier;
    }

    int getPerkBoost(PerkFactory.Perk type) {
      return IsoGameCharacter.this.getDescriptor().getXPBoostMap().get(type) !=
                     nullptr
                 ? IsoGameCharacter.this.getDescriptor().getXPBoostMap().get(
                       type)
                 : 0;
    }
    ...
    void setPerkBoost(PerkFactory.Perk perk, int _level) {
      if (perk != nullptr && perk != PerkFactory.Perks.None &&
        ...
        if (_level == 0) {
          ...
          IsoGameCharacter.this.getDescriptor().getXPBoostMap().put(perk,
                                                                    _level);
        }
      }
    }
    ...
    float getTotalXp() { return this.TotalXP; }
    ...
    void AddXPNoMultiplier(PerkFactory.Perk type, float amount) {
      IsoGameCharacter.XPMultiplier xPMultiplier =
          this.getMultiplierMap().remove(type);
    ...
    void AddXP(PerkFactory.Perk type, float amount, bool callLua,
      ...
      if (perk0.getType() != PerkFactory.Perks.Fitness ||
          !(this.chr instanceof IsoPlayer) ||
          ((IsoPlayer)this.chr).getNutrition().canAddFitnessXp()) {
        if (perk0.getType() == PerkFactory.Perks.Strength && this.chr instanceof
            IsoPlayer) {
          if (((IsoPlayer)this.chr).getNutrition().getProteins() > 50.0F &&
              ((IsoPlayer)this.chr).getNutrition().getProteins() < 300.0F) {
        ...
        if (!(amount >= 0.0F) || !(float0 >= float1)) {
          ...
          if (doXPBoost) {
            ...
            for (Entry entry : IsoGameCharacter.this.getDescriptor()
                                   .getXPBoostMap()
                                   .entrySet()) {
              if (entry.getKey() == perk0.getType()) {
                boolean0 = true;
                if ((Integer)entry.getValue() == 0 &&
                    !this.isSkillExcludedFromSpeedReduction(
                        (PerkFactory.Perk)entry.getKey())) {
                  float2 *= 0.25F;
                } else if ((Integer)entry.getValue() == 1 &&
                           entry.getKey() == PerkFactory.Perks.Sprinting) {
                  float2 = (float)(float2 * 1.25);
                } else if ((Integer)entry.getValue() == 1) {
                  float2 = (float)(float2 * 1.0);
                } else if ((Integer)entry.getValue() == 2 &&
                           !this.isSkillExcludedFromSpeedIncrease(
                               (PerkFactory.Perk)entry.getKey())) {
                  float2 = (float)(float2 * 1.33);
                } else if ((Integer)entry.getValue() >= 3 &&
                           !this.isSkillExcludedFromSpeedIncrease(
                               (PerkFactory.Perk)entry.getKey())) {
            ...
            if (!boolean0 &&
                !this.isSkillExcludedFromSpeedReduction(perk0.getType())) {
              float2 = 0.25F;
            }

            if (IsoGameCharacter.this.Traits.FastLearner.isSet() &&
                !this.isSkillExcludedFromSpeedIncrease(perk0.getType())) {
              float2 *= 1.3F;
            }

            if (IsoGameCharacter.this.Traits.SlowLearner.isSet() &&
                !this.isSkillExcludedFromSpeedReduction(perk0.getType())) {
              float2 *= 0.7F;
            }
            ...
            if (!perk0.isPassiv()) {
              amount = (float)(amount *
                               SandboxOptions.instance.XpMultiplier.getValue());
            } else if (perk0.isPassiv() &&
                       SandboxOptions.instance.XpMultiplierAffectsPassive
                           .getValue()) {
              amount = (float)(amount *
                               SandboxOptions.instance.XpMultiplier.getValue());
            }
          ...
          for (float float5 =
                   perk0.getTotalXpForLevel(this.chr.getPerkLevel(perk0) + 1);
            ...
            if (this.chr instanceof
              ...
              this.chr.getEmitter().playSoundImpl("GainExperienceLevel",
                                                  (IsoObject) nullptr);
            }
    ...
    bool isSkillExcludedFromSpeedReduction(PerkFactory.Perk perk) {
      if (perk == PerkFactory.Perks.Sprinting) {
        ...
        return perk = = PerkFactory.Perks.Fitness
                            ? true
                            : perk == PerkFactory.Perks.Strength;
      }
    }
    ...
    void setTotalXP(float xp) { this.TotalXP = xp; }

    void savePerk(ByteBuffer byteBuffer, PerkFactory.Perk perk) {
      GameWindow.WriteStringUTF(byteBuffer,
                                perk == nullptr ? "" : perk.getId());
    }

  private
    PerkFactory.Perk loadPerk(ByteBuffer byteBuffer,
                              int int0) throws IOException {
      if (int0 >= 152) {
        std::string string = GameWindow.ReadStringUTF(byteBuffer);
    ...
    void load(ByteBuffer input, int WorldVersion) {
      ...
      for (int int7 = 0; int7 < int6; int7++) {
        ...
        if (perk2 != nullptr) {
          IsoGameCharacter.PerkInfo perkInfo =
              IsoGameCharacter.this.std::make_unique<PerkInfo>();
          perkInfo.perk = perk2;
          perkInfo.level = int8;
      ...
      if (this.TotalXP >
          IsoGameCharacter.this.getXpForLevel(this.getLevel() + 1)) {
    ...
    void save(ByteBuffer output) {
      ...
      for (int int1 = 0; int1 < IsoGameCharacter.this.PerkList.size(); int1++) {
        IsoGameCharacter.PerkInfo perkInfo =
            IsoGameCharacter.this.PerkList.get(int1);
      ...
      while (iterator1 != nullptr && iterator1.hasNext()) {
        ...
        output.putFloat(
            ((IsoGameCharacter.XPMultiplier)entry1.getValue()).multiplier);
        output.put(
            (byte)((IsoGameCharacter.XPMultiplier)entry1.getValue()).minLevel);
        output.put(
            (byte)((IsoGameCharacter.XPMultiplier)entry1.getValue()).maxLevel);
      }
    }
  ...
  private static class s_performance {
    static const PerformanceProfileProbe postUpdate =
        new PerformanceProfileProbe("IsoGameCharacter.postUpdate");
    static PerformanceProfileProbe update =
        new PerformanceProfileProbe("IsoGameCharacter.update");
  }
}
} // namespace characters
} // namespace zombie
