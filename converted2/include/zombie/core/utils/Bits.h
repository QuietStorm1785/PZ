...
public:
    ...
    if (float0 < 0.0F || float0 > 1.0F) {
      if (Core.bDebug) {
        throw new RuntimeException(
            "UtilsIO Cannot pack float units out of the range 0.0 to 1.0");
      }
  ...
  static uint8_t addFlags(uint8_t byte1, int int0) {
    if (int0 >= 0 && int0 <= 64) {
      ...
      throw new RuntimeException("Cannot add flags, exceeding byte bounds or "
  ...
  static short addFlags(short short1, int int0) {
    if (int0 >= 0 && int0 <= 16384) {
      ...
      throw new RuntimeException("Cannot add flags, exceeding short bounds or "
                                 "negative number flags. (" +
                                 int0 + ")");
    }
  }
  ...
  static int addFlags(int int0, long long0) {
    if (long0 >= 0L && long0 <= 1073741824L) {
      ...
      throw new RuntimeException("Cannot add flags, exceeding integer bounds "
                                 "or negative number flags. (" +
                                 long0 + ")");
    }
  }
  ...
  static long addFlags(long long1, int int0) {
    if (int0 >= 0 && int0 <= 4611686018427387904L) {
      ...
      throw new RuntimeException("Cannot add flags, exceeding long bounds or "
                                 "negative number flags. (" +
                                 int0 + ")");
    }
  }
  ...
  static bool hasFlags(uint8_t byte0, int int0) { return checkFlags(); }

  static bool hasFlags(uint8_t byte0, long long0) { return checkFlags(); }

  static bool hasEitherFlags(uint8_t byte0, int int0) { return checkFlags(); }

  static bool hasEitherFlags(uint8_t byte0, long long0) { return checkFlags(); }

  static bool notHasFlags(uint8_t byte0, int int0) { return checkFlags(); }

  static bool notHasFlags(uint8_t byte0, long long0) { return checkFlags(); }

  static bool hasFlags(short short0, int int0) { return checkFlags(); }

  static bool hasFlags(short short0, long long0) { return checkFlags(); }

  static bool hasEitherFlags(short short0, int int0) { return checkFlags(); }

  static bool hasEitherFlags(short short0, long long0) { return checkFlags(); }

  static bool notHasFlags(short short0, int int0) { return checkFlags(); }

  static bool notHasFlags(short short0, long long0) { return checkFlags(); }

  static bool hasFlags(int int0, int int1) { return checkFlags(); }

  static bool hasFlags(int int0, long long0) { return checkFlags(); }

  static bool hasEitherFlags(int int0, int int1) { return checkFlags(); }

  static bool hasEitherFlags(int int0, long long0) { return checkFlags(); }

  static bool notHasFlags(int int0, int int1) { return checkFlags(); }

  static bool notHasFlags(int int0, long long0) { return checkFlags(); }

  static bool hasFlags(long long0, int int0) { return checkFlags(); }

  static bool hasFlags(long long0, long long1) { return checkFlags(); }

  static bool hasEitherFlags(long long0, int int0) { return checkFlags(); }

  static bool hasEitherFlags(long long0, long long1) { return checkFlags(); }

  static bool notHasFlags(long long0, int int0) { return checkFlags(); }

  static bool notHasFlags(long long0, long long1) { return checkFlags(); }

  static bool checkFlags(int int2, int int0, int int1,
                         Bits.CompareOption compareOption) {
    if (int0 < 0 || int0 > int1) {
      throw new RuntimeException("Cannot check for flags, exceeding byte "
                                 "bounds or negative number flags. (" +
                                 int0 + ")");
  ...
  static bool checkFlags(long long2, long long0, long long1,
                         Bits.CompareOption compareOption) {
  ...
  static int getLen(uint8_t var0) { return 1; }

  static int getLen(short var0) { return 2; }

  static int getLen(int var0) { return 4; }

  static int getLen(long var0) { return 8; }
  ...
  static std::string getBitsString(uint8_t byte0) { return getBitsString(); }

  static std::string getBitsString(short short0) { return getBitsString(); }

  static std::string getBitsString(int int0) { return getBitsString(); }

  static std::string getBitsString(long long0) { return getBitsString(); }
...
public
  static enum CompareOption { ContainsAll, HasEither, NotHas; }
}
} // namespace utils
} // namespace core
} // namespace zombie
