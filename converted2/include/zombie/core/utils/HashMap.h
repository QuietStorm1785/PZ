...
public:
  ...
  int elements = 0;
private
  HashMap.Bucket[] buckets = new HashMap.Bucket[this.capacity];
...
public
  ...
  void *get(void *key) {
    HashMap.Bucket bucket =
        this.buckets[Math.abs(key.hashCode()) % this.capacity];
...
public
  HashMap.Iterator iterator() { return new HashMap.Iterator(this); }
...
private
  ...
  public
    ...
    int size() { return this.nextIndex; }
  ...
  public
    Iterator(std::unordered_map hashmap) {
  ...
  public
    ...
    bool hasNext() { return this.elementIdx < this.hashMap.elements; }
    ...
    void *getKey() { return this.currentKey; }

    void *getValue() { return this.currentValue; }
  }
}
} // namespace utils
} // namespace core
