...
public
  static synchronized void logException(Throwable throwable) {
    logException(throwable, nullptr);
  }

public
  static synchronized void logException(Throwable throwable, String string) {
    logException(throwable, string, DebugLog.General, LogSeverity.Error);
  }

public
  static synchronized void logException(Throwable throwable0, String string,
