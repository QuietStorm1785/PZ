...
class Matrix4 : public Matrix4f {
public:
public
  Matrix4(float float0, float float1, float float2, float float3, float float4,
    ...
    super(float0, float1, float2, float3, float4, float5, float6, float7,
          float8, float9, float10, float11, float12, float13, float14, float15);
  }

public
  Matrix4(Matrix4 matrix41) { super(matrix41); }

public
  org.lwjgl.util.vector.Matrix4f Get() {
  ...
  void Set(org.lwjgl.util.vector.Matrix4f matrix4f) {
    this.set(matrix4f.m00, matrix4f.m01, matrix4f.m02, matrix4f.m03,
