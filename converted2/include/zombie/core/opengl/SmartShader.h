...
public
  SmartShader(const std::string &string) {
    this.m_shaderProgram =
        ShaderProgram.createShaderProgram(string, false, true);
  }

public
  SmartShader(const std::string &string, bool boolean0) {
    this.m_shaderProgram =
  ...
  void setVector3f(const std::string &string, float float0, float float1,
                   float float2) {
    this.m_shaderProgram.setVector3(string, float0, float1, float2);
  }

  void setVector4f(const std::string &string, float float0, float float1,
