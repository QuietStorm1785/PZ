...
private
  final GLVertexBufferObject[] vbo = new GLVertexBufferObject[48];
private
  final GLVertexBufferObject[] ibo = new GLVertexBufferObject[48];
...
public
  SharedVertexBufferObjects(int BYTES_PER_VERTEX) {
