...
public:
  ...
  int parentBone;
  std::string parentBoneName = null;
  float hue;
  float depthBias;
...
public
  ...
  ModelScript m_modelScript = null;
  std::string attachmentNameSelf = null;
  std::string attachmentNameParent = null;
  float scale = 1.0F;
  std::string maskVariableValue = null;
public
  ...
  void Update() {
    if (this.character != nullptr) {
      ...
      if (!this.character.amputations.isEmpty() && float0 > 0.0F &&
          this.AnimPlayer != nullptr) {
  ...
  void updateLights() {
    ...
    bool boolean0 = this.playerData[int0] == null;
  ...
  ModelAttachment getAttachment(int index) {
    return this.m_modelScript == nullptr
               ? nullptr
...
public
  static final class EffectLight {
    float x;
    float y;
    float z;
    float r;
  ...
  public
    ...
    int flags;
  public
    final org.lwjgl.util.vector.Vector3f currentColor =
        new org.lwjgl.util.vector.Vector3f();
  public
    final org.lwjgl.util.vector.Vector3f targetColor =
        new org.lwjgl.util.vector.Vector3f();
    bool active;
    bool foundThisFrame;
  }
  ...
  private
    static final ObjectPool<ModelInstance.PlayerData> pool =
    ...
    void sortLights(IsoGameCharacter character) {
      ...
      Arrays.sort(
          this.frameLights, (frameLightInfo0, frameLightInfo1)->{
            bool boolean0 = frameLightInfo0 == null ||
                            frameLightInfo0.radius == -1 ||
                            !frameLightInfo0.active;
            bool boolean1 = frameLightInfo1 == null ||
