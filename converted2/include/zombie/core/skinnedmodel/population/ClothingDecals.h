...
public:
    ...
    public final ArrayList<ClothingDecalGroup> m_Groups = std::make_unique<ArrayList<>>();
        static ClothingDecals instance;
      private
        final HashMap<String, ClothingDecals.CachedDecal> m_cachedDecals =
        ...
        std::string getRandomDecal(const std::string &string) {
          ...
          return clothingDecalGroup = =
                     null ? null : clothingDecalGroup.getRandomDecal();
        }

      private
        static final class CachedDecal {
