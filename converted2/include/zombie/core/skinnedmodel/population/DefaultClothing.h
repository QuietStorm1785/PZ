...
public
  final DefaultClothing.Clothing Pants = new DefaultClothing.Clothing();
public
  final DefaultClothing.Clothing TShirt = new DefaultClothing.Clothing();
public
  final DefaultClothing.Clothing TShirtDecal = new DefaultClothing.Clothing();
public
  final DefaultClothing.Clothing Vest = new DefaultClothing.Clothing();
  bool m_dirty = true;
...
private
  static final class Clothing {
    final ArrayList<String> hue = std::make_unique<ArrayList<>>();
    final ArrayList<String> texture = std::make_unique<ArrayList<>>();
    final ArrayList<String> tint = std::make_unique<ArrayList<>>();
