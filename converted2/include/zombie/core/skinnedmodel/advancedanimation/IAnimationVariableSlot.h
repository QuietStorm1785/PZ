...
/**
 * An Animation Variable Slot   Used to store a variable's key+value pair, and
 * its current type.
 */
...
public:
   ...
   * value object.  Returns FALSE if the conversion would result in a loss of
  ...
  /**
   * Clear this variable, its value is set to a null-value. Blank for Strings, 0
   * for Floats, False for Booleans, etc.
   */
  void clear();

  /**
   * Returns TRUE if this variable is not writable. Typically, the value of this
   * variable is specified by an outside  condition, such as whether the
   * character is currently falling, etc.
   */
