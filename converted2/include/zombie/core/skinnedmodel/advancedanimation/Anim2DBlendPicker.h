...
public:
private
  List<Anim2DBlendTriangle> m_tris;
private
  List<Anim2DBlend> m_hull;
private
  Anim2DBlendPicker.HullComparer m_hullComparer;
  ...
  void BuildHull() {
    ...
    for (Anim2DBlendTriangle anim2DBlendTriangle : this.m_tris) {
      Anim2DBlendPicker.Counter counter1 = hashMap.putIfAbsent(
          new Anim2DBlendPicker.Edge(anim2DBlendTriangle.node1,
                                     anim2DBlendTriangle.node2),
          counter0);
      if (counter1 == nullptr) {
        counter1 = counter0;
      ...
      counter1.Increment();
      counter1 = hashMap.putIfAbsent(
          new Anim2DBlendPicker.Edge(anim2DBlendTriangle.node2,
                                     anim2DBlendTriangle.node3),
          counter0);
      if (counter1 == nullptr) {
        counter1 = counter0;
        counter0 = new Anim2DBlendPicker.Counter();
      ...
      counter1.Increment();
      counter1 = hashMap.putIfAbsent(
          new Anim2DBlendPicker.Edge(anim2DBlendTriangle.node3,
                                     anim2DBlendTriangle.node1),
          counter0);
      if (counter1 == nullptr) {
        counter1 = counter0;
        counter0 = new Anim2DBlendPicker.Counter();
    ...
    for (auto &anim2DBlend : arrayList)
  ...
  this.m_hull = arrayList;
    ...
    static float ProjectPointToLine(float float1, float float4, float float2,
                                    float float5, float float7, float float9) {
      float float0 = float1 - float2;
      float float3 = float4 - float5;
      float float6 = float7 - float2;
      float float8 = float9 - float5;
      return (float6 * float0 + float8 * float3) /
             (float6 * float6 + float8 * float8);
    }

  public
    Anim2DBlendPicker.PickResults Pick(float x, float y) {
      Anim2DBlendPicker.PickResults pickResults =
          new Anim2DBlendPicker.PickResults();
      ...
      for (Anim2DBlendTriangle anim2DBlendTriangle : this.m_tris) {
        if (anim2DBlendTriangle.Contains(x, y)) {
          ...
          pickResults.scale1 = ((float3 - float5) * (x - float4) +
                                (float4 - float2) * (y - float5)) /
                               ((float3 - float5) * (float0 - float4) +
                                (float4 - float2) * (float1 - float5));
          pickResults.scale2 = ((float5 - float1) * (x - float4) +
                                (float0 - float4) * (y - float5)) /
                               ((float3 - float5) * (float0 - float4) +
                                (float4 - float2) * (float1 - float5));
      ...
      float float6 =
          ProjectPointToLine(x, y, anim2DBlend1.m_XPos, anim2DBlend1.m_YPos,
                             anim2DBlend2.m_XPos, anim2DBlend2.m_YPos);
      if (float6 < 0.0F) {
    ...
    void render(float float1, float float2) {
      ...
      SpriteRenderer.instance.renderi(nullptr, int0 - 20, int1 - 20,
                                      short0 + 40, short0 + 40, 1.0F, 1.0F,
                                      1.0F, 1.0F, nullptr);
      ...
      for (int int2 = 0; int2 < this.m_tris.size(); int2++) {
        ...
        SpriteRenderer.instance.renderline(
            nullptr,
            (int)(int0 + short0 / 2 +
                  anim2DBlendTriangle.node1.m_XPos * short0 / 2.0F),
            (int)(int1 + short0 / 2 -
                  anim2DBlendTriangle.node1.m_YPos * short0 / 2.0F),
            (int)(int0 + short0 / 2 +
                  anim2DBlendTriangle.node2.m_XPos * short0 / 2.0F),
            (int)(int1 + short0 / 2 -
                  anim2DBlendTriangle.node2.m_YPos * short0 / 2.0F),
            0.5F, 0.5F, 0.5F, 1.0F);
        SpriteRenderer.instance.renderline(
            nullptr,
            (int)(int0 + short0 / 2 +
            ...
            (int)(int1 + short0 / 2 -
                  anim2DBlendTriangle.node2.m_YPos * short0 / 2.0F),
            (int)(int0 + short0 / 2 +
                  anim2DBlendTriangle.node3.m_XPos * short0 / 2.0F),
            (int)(int1 + short0 / 2 -
                  anim2DBlendTriangle.node3.m_YPos * short0 / 2.0F),
            0.5F, 0.5F, 0.5F, 1.0F);
        SpriteRenderer.instance.renderline(
            nullptr,
            (int)(int0 + short0 / 2 +
      ...
      if (pickResults.node1 != nullptr) {
        SpriteRenderer.instance.render(
            nullptr,
            int0 + short0 / 2 + pickResults.node1.m_XPos * short0 / 2.0F -
                float0 / 2.0F,
            int1 + short0 / 2 - pickResults.node1.m_YPos * short0 / 2.0F -
                float0 / 2.0F,
            float0, float0, 0.0F, 1.0F, 0.0F, 1.0F, nullptr);
      }

      if (pickResults.node2 != nullptr) {
        SpriteRenderer.instance.render(
            nullptr,
            int0 + short0 / 2 + pickResults.node2.m_XPos * short0 / 2.0F -
                float0 / 2.0F,
            int1 + short0 / 2 - pickResults.node2.m_YPos * short0 / 2.0F -
                float0 / 2.0F,
            float0, float0, 0.0F, 1.0F, 0.0F, 1.0F, nullptr);
      }
      ...
      if (pickResults.node3 != nullptr) {
        SpriteRenderer.instance.render(
            nullptr,
            int0 + short0 / 2 + pickResults.node3.m_XPos * short0 / 2.0F -
                float0 / 2.0F,
            int1 + short0 / 2 - pickResults.node3.m_YPos * short0 / 2.0F -
                float0 / 2.0F,
            float0, float0, 0.0F, 1.0F, 0.0F, 1.0F, nullptr);
      }
      ...
      float0 = 4.0F;
      SpriteRenderer.instance.render(
          nullptr, int0 + short0 / 2 + float1 * short0 / 2.0F - float0 / 2.0F,
          int1 + short0 / 2 - float2 * short0 / 2.0F - float0 / 2.0F, float0,
          float0, 0.0F, 0.0F, 1.0F, 1.0F, nullptr);
    }
    ...
    public
      Edge(Anim2DBlend anim2DBlend1, Anim2DBlend anim2DBlend0) {
        bool boolean0;
      ...
      bool equals(void *object) {
        return !(object instanceof Anim2DBlendPicker.Edge)
                   ? false
                   : this.a == ((Anim2DBlendPicker.Edge)object).a &&
                         this.b == ((Anim2DBlendPicker.Edge)object).b;
      }
    }
    ...
    public
      HullComparer(float arg0, float arg1) {
