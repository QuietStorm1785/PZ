...
private
  final HelperFunctions.TransformResult_QPS m_transformResult =
...
private
  static final Pool<BoneTransform> s_pool = new Pool<>(BoneTransform::new);
...
protected
  ...
  void validateInternal() {
    if (!this.m_prsValid && !this.m_matrixValid) {
      throw new RuntimeException("Neither the matrix nor the PosRotScale "
