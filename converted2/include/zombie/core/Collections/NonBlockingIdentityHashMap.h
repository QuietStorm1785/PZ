...
private
  static final NonBlockingIdentityHashMap.Prime TOMBPRIME;
private
...
private
  static final NonBlockingIdentityHashMap.CHM chm(Object[] objects) {
...
public
  ...
  private
    static final Object putIfMatch(
...
private
  final AtomicReferenceFieldUpdater<NonBlockingIdentityHashMap.CHM, Object[]>
      _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
          NonBlockingIdentityHashMap.CHM.class, Object[].class, "_newkvs");
  volatile long _resizers;
private
  static final AtomicLongFieldUpdater<NonBlockingIdentityHashMap.CHM>
...
private
  final Object[] resize(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
                        Object[] objects0) {
...
private
  final Object[] copy_slot_and_check(
    ...
    return object = =
               null ? objects1 : nonBlockingIdentityHashMap.help_copy(objects1);
  }
