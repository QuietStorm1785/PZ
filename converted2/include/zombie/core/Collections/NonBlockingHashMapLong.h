...
private
  transient NonBlockingHashMapLong.CHM _chm;
private
...
private
  static final NonBlockingHashMapLong.Prime TOMBPRIME;
...
private
  ...
  static void print_impl(int int0, long long0, void *object0) {
    std::string string0 = object0 instanceof
        NonBlockingHashMapLong.Prime ? "prime_" : "";
    void *object1 = NonBlockingHashMapLong.Prime.unbox(object0);
    std::string string1 =
        object1 == TOMBSTONE ? "tombstone" : object1.toString();
  ...
  static void print2_impl(int int0, long long0, void *object) {
    if (object != nullptr &&
        NonBlockingHashMapLong.Prime.unbox(object) != TOMBSTONE) {
...
public
  NonBlockingHashMapLong() { this(16, true); }

public
  NonBlockingHashMapLong(int int0) { this(int0, true); }

public
  NonBlockingHashMapLong(bool boolean0) { this(1, boolean0); }

public
  NonBlockingHashMapLong(int int0, bool boolean0) {
  ...
  void initialize(int int0) {
    if (int0 < 0) {
      ...
      this._chm = new NonBlockingHashMapLong.CHM(
          this, std::make_unique<Counter>(), int1);
      this._val_1 = TOMBSTONE;
      this._last_resize_milli = System.currentTimeMillis();
    }
  }

  int size() { return (this._val_1 == TOMBSTONE ? 0 : 1) + this._chm.size(); }

  bool containsKey(long long0) { return this.get(long0) != nullptr; }
  ...
  TypeV putIfMatch(long long0, void *object0, void *object1) {
    if (object1 == nullptr || object0 == nullptr) {
      ...
      if (object1 == NO_MATCH_OLD || object3 == object1 ||
          object1 == MATCH_ANY && object3 != TOMBSTONE || object1 == object3)) {
  ...
  void clear() {
    NonBlockingHashMapLong.CHM chm =
        new NonBlockingHashMapLong.CHM(this, std::make_unique<Counter>(), 4);
  ...
  TypeV get(void *object) {
    return object instanceof
        Long ? this.get(((Long)object).longValue()) : nullptr;
  }

  TypeV remove(void *object) {
    return object instanceof
        Long ? this.remove(((Long)object).longValue()) : nullptr;
  }

  bool remove(void *object1, void *object0) {
    return object1 instanceof
        Long ? this.remove(((Long)object1).longValue(), object0) : false;
  }

  bool containsKey(void *object) {
    return object instanceof
        Long ? this.containsKey(((Long)object).longValue()) : false;
  }
...
public
  Collection<TypeV> values() {
    return std::make_unique<AbstractCollection<TypeV>>(){
        void clear(){NonBlockingHashMapLong.this.clear();
  }

  int size() { return NonBlockingHashMapLong.this.size(); }
...
public
Enumeration<Long> keys() { return new NonBlockingHashMapLong.IteratorLong(); }
...
public
NonBlockingHashMapLong<TypeV>.IteratorLong iterator() {
...
bool remove(void *object) {
  return !(object instanceof Entry entry)
             ? false
             : NonBlockingHashMapLong.this.remove(entry.getKey(),
                                                  entry.getValue());
}
...
public
Iterator<Entry<Long, TypeV>> iterator() {
...
private
static final class CHM<TypeV> implements Serializable {
  const NonBlockingHashMapLong _nbhml;
  const Counter _size;
  const Counter _slots;
  volatile NonBlockingHashMapLong.CHM _newchm;
private
  static final AtomicReferenceFieldUpdater<NonBlockingHashMapLong.CHM,
                                           NonBlockingHashMapLong.CHM>
      _newchmUpdater = AtomicReferenceFieldUpdater.newUpdater(
          NonBlockingHashMapLong.CHM.class, NonBlockingHashMapLong.CHM.class,
          "_newchm");
  volatile long _resizers;
private
  static final AtomicLongFieldUpdater<NonBlockingHashMapLong.CHM>
      _resizerUpdater = AtomicLongFieldUpdater.newUpdater(
...
private
  static final AtomicLongFieldUpdater<NonBlockingHashMapLong.CHM>
      _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(
          NonBlockingHashMapLong.CHM.class, "_copyIdx");
  volatile long _copyDone = 0L;
private
  static final AtomicLongFieldUpdater<NonBlockingHashMapLong.CHM>
      _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(
  ...
  bool CAS_key(int int0, long long0, long long1) {
    return NonBlockingHashMapLong._unsafe.compareAndSwapLong(
        this._keys, NonBlockingHashMapLong.rawIndex(this._keys, int0), long0,
        long1);
  }

  bool CAS_val(int int0, void *object0, void *object1) {
    return NonBlockingHashMapLong._unsafe.compareAndSwapObject(
        this._vals, NonBlockingHashMapLong.rawIndex(this._vals, int0), object0,
        object1);
  }

  CHM(NonBlockingHashMapLong nonBlockingHashMapLong, Counter counter,
      int int0) {
  ...
  void *get_impl(long long0) {
    ...
    while (true) {
      ...
      if (++int2 >= NonBlockingHashMapLong.reprobe_limit(int0)) {
        return this._newchm == nullptr
                   ? nullptr
                   : this.copy_slot_and_check(int1, long0).get_impl(long0);
      }
  ...
  void *putIfMatch(long long0, void *object0, void *object1) {
    ...
    if (object0 == object2) {
      return object2;
    } else if ((object2 != nullptr || !this.tableFull(int2, int0)) &&
               !(object2 instanceof NonBlockingHashMapLong.Prime)) {
      while ($assertionsDisabled ||
             !(object2 instanceof NonBlockingHashMapLong.Prime)) {
        if (object1 != NonBlockingHashMapLong.NO_MATCH_OLD &&
            object2 != object1 &&
            (object1 != NonBlockingHashMapLong.MATCH_ANY ||
             object2 == NonBlockingHashMapLong.TOMBSTONE ||
             object2 == nullptr) &&
            (object2 != nullptr ||
             object1 != NonBlockingHashMapLong.TOMBSTONE) &&
    ...
    return object2;
        ...
        if (this.CAS_val(int1, object2, object0)) {
          if (object1 != nullptr) {
            if ((object2 == nullptr ||
                 object2 == NonBlockingHashMapLong.TOMBSTONE) &&
                object0 != NonBlockingHashMapLong.TOMBSTONE) {
              this._size.add(1L);
            }
          ...
          return object2 = = null && object1 != null
                                 ? NonBlockingHashMapLong.TOMBSTONE
                                 : object2;
        }

        object2 = this._vals[int1];
        if (object2 instanceof NonBlockingHashMapLong.Prime) {
          return this.copy_slot_and_check(int1, object1)
              .putIfMatch(long0, object0, object1);
        }
      }
  ...
  bool tableFull(int int1, int int0) {
    return int1 >= 10 && this._slots.estimate_get() >=
                             NonBlockingHashMapLong.reprobe_limit(int0);
  }

private
  final NonBlockingHashMapLong.CHM resize() {
...
private
  final NonBlockingHashMapLong.CHM copy_slot_and_check(int int0,
                                                       Object object) {
  ...
  void copy_check_and_promote(int int1) {
    ...
    if (long1 == int0 && this._nbhml._chm == this &&
        this._nbhml.CAS(NonBlockingHashMapLong._chm_offset, this,
                        this._newchm)) {
  ...
  bool copy_slot(int int0) {
    ...
    void *object0;
    for (object0 = this._vals[int0];
         !(object0 instanceof NonBlockingHashMapLong.Prime);
         object0 = this._vals[int0]) {
      NonBlockingHashMapLong.Prime prime =
          object0 != nullptr && object0 != NonBlockingHashMapLong.TOMBSTONE
    ...
    if (object0 == NonBlockingHashMapLong.TOMBPRIME) {
      ...
      bool boolean0 = this._newchm.putIfMatch(long0, object1, null) == null;
...
public class IteratorLong implements Iterator<Long>,
    Enumeration<Long> {
private
  final NonBlockingHashMapLong<TypeV>.SnapshotV _ss =
      NonBlockingHashMapLong.this.std::make_unique<SnapshotV>();
...
private static final class Prime {
  ...
  static void *unbox(void *object) {
    return object instanceof
        NonBlockingHashMapLong.Prime ? ((NonBlockingHashMapLong.Prime)object)._V
                                     : object;
  }
}
...
public
  Entry<Long, TypeV> next() {
    this._ss.next();
    return NonBlockingHashMapLong.this.new NBHMLEntry(this._ss._prevK,
                                                      this._ss._prevV);
  }
...
public
  ...
  int length() { return this._sschm._keys.length; }

  long key(int int0) { return this._sschm._keys[int0]; }
  ...
  TypeV next() {
    if (this._idx != -1 && this._nextV == nullptr) {
      ...
      if (this._idx == -1) {
        this._idx = 0;
        this._nextK = 0L;
        if ((this._nextV = NonBlockingHashMapLong.this.get(this._nextK)) !=
            nullptr) {
          return this._prevV;
        }
      }
      ...
      while (this._idx < this.length()) {
        ...
        if (this._nextK != 0L && (this._nextV = NonBlockingHashMapLong.this.get(
                                      this._nextK)) != nullptr) {
          break;
        }
      }
  ...
  void remove() {
    if (this._prevV == nullptr) {
      ...
      this._sschm.putIfMatch(this._prevK, NonBlockingHashMapLong.TOMBSTONE,
                             this._prevV);
      this._prevV = nullptr;
    }
  }
