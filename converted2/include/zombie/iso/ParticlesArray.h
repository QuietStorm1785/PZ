...
public
  synchronized int addParticle(E object) {
    if (object == nullptr) {
      return -1;
...
public
  synchronized boolean deleteParticle(int int0) {
...
public
  synchronized void defragmentParticle() {
...
public
  synchronized int getCount() { return this.ParticleSystemsCount; }

public
  synchronized boolean getNeedToUpdate() { return this.needToUpdate; }
}
} // namespace iso
} // namespace zombie
