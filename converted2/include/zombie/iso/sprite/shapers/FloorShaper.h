...
protected
  ...
  bool isShore = false;
protected
  final float[] waterDepth = new float[4];
  ...
  void setShore(bool boolean0) { this.isShore = boolean0; }
  ...
  void setTintColor(int int0) { this.colTint = int0; }
  ...
  void accept(TextureDraw textureDraw) {
    ...
    if (this.isShore && DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare
                            .ShoreFade.getValue()) {
      textureDraw.col0 = Color.setAlphaChannelToABGR(textureDraw.col0,
                                                     1.0F - this.waterDepth[0]);
      textureDraw.col1 = Color.setAlphaChannelToABGR(textureDraw.col1,
                                                     1.0F - this.waterDepth[1]);
      textureDraw.col2 = Color.setAlphaChannelToABGR(textureDraw.col2,
                                                     1.0F - this.waterDepth[2]);
      textureDraw.col3 = Color.setAlphaChannelToABGR(textureDraw.col3,
                                                     1.0F - this.waterDepth[3]);
    }
...
private
  SpritePadding.IsoPaddingSettings getIsoPaddingSettings() {
