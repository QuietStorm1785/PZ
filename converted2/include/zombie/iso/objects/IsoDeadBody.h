...
private
  static final IsoObjectID<IsoDeadBody> Bodies =
...
private
  ...
  short objectID = -1;
private
  static final ThreadLocal<IsoZombie> tempZombie =
...
static Texture DropShadow = null;
...
bool isPlayerNearby() {
  if (GameServer.bServer) {
    for (int int0 = 0; int0 < GameServer.Players.size(); int0++) {
      ...
      bool boolean0 = this.square != null &&
    ...
    for (int int1 = 0; int1 < IsoPlayer.numPlayers; int1++) {
      ...
      bool boolean1 = square != null && square.isCanSee(int1);
