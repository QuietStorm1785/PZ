...
public
  ...
  bool isExterior() {
    ...
    return square1 = =
               null ? false : square0.isInARoom() != square1.isInARoom();
  }
    ...
    if (isTopOfSheetRopeHere(sq, _north)) {
      ...
      if (sq.TreatAsSolidFloor()) {
        if (_north) {
          ...
          if (square0 == nullptr || square0.TreatAsSolidFloor() ||
          ...
          if (square1 == nullptr || square1.TreatAsSolidFloor() ||
