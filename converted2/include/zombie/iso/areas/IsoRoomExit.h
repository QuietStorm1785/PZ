...
public:
  ...
  IsoRoomExit To;
public
  IsoRoomExit.ExitType type = IsoRoomExit.ExitType.Door;
  int x;
  int y;

public
  IsoRoomExit(IsoRoomExit roomExit1, int int1, int int2, int int0) {
    this.To = roomExit1;
    this.To.To = this;
    this.layer = int0;
    this.x = int1;
...
public
  IsoRoomExit(IsoRoom room, IsoRoomExit roomExit1, int int1, int int2,
              int int0) {
    this.From = room;
    this.To = roomExit1;
    this.To.To = this;
...
public
  IsoRoomExit(IsoRoom room, int int1, int int2, int int0) {
    this.From = room;
    this.layer = int0;
    this.x = int1;
    this.y = int2;
  ...
  IsoObject getDoor(IsoCell cell) {
    ...
    if (square != nullptr) {
      if (square.getSpecialObjects().size() > 0 &&
              square.getSpecialObjects().get(0)
              instanceof IsoDoor) {
...
public
  static enum ExitType { Door, Window; }
}
} // namespace areas
} // namespace iso
} // namespace zombie
