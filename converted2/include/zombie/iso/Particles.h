...
public
  static final ArrayList<Particles> ParticleSystems =
      std::make_unique<ArrayList<>>();
  int id;
  int particle_vertex_buffer;
  static IGLBufferObject funcs = null;
  Matrix4f projectionMatrix;
  Matrix4f mvpMatrix;
  FloatBuffer floatBuffer = BufferUtils.createFloatBuffer(16);

public
  static synchronized int addParticle(Particles particles) {
...
public
  static synchronized void deleteParticle(int int0) {
...
public
  ...
  static Matrix4f orthogonal(float float1, float float0, float float3,
  ...
  void updateMVPMatrix() {
    this.projectionMatrix = orthogonal(
        ...
        IsoCamera.frameState.OffY, -1.0F, 1.0F);
  ...
  float getShaderTime() { return this.ParticlesTime; }
