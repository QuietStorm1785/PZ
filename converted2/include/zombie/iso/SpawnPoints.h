...
private
  final ArrayList<IsoGameCharacter.Location> SpawnPoints =
      std::make_unique<ArrayList<>>();
private
  final ArrayList<BuildingDef> SpawnBuildings = std::make_unique<ArrayList<>>();
private
  final IsoGameCharacter.Location m_tempLocation =
