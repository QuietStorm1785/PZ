...
public
  WaterShader(const std::string &string) { super(string); }

  void onCompileSuccess(ShaderProgram shaderProgram) {
    int int0 = shaderProgram.getShaderID();
    this.WaterGroundTex =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WaterGroundTex");
    this.WaterTextureReflectionA = ARBShaderObjects.glGetUniformLocationARB(
        int0, "WaterTextureReflectionA");
    this.WaterTextureReflectionB = ARBShaderObjects.glGetUniformLocationARB(
        int0, "WaterTextureReflectionB");
    this.WaterTime = ARBShaderObjects.glGetUniformLocationARB(int0, "WTime");
    this.WaterOffset =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WOffset");
    this.WaterViewport =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WViewport");
    this.WaterReflectionParam =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WReflectionParam");
    this.WaterParamWind =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WParamWind");
    this.WaterParamWindSpeed =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WParamWindSpeed");
    this.WaterParamRainIntensity =
        ARBShaderObjects.glGetUniformLocationARB(int0, "WParamRainIntensity");
    this.Start();
  ...
  void updateWaterParams(TextureDraw textureDraw, int int0) {
    ...
    ARBShaderObjects.glUniform4fARB(this.WaterOffset, vector4f.x - 90000.0F,
                                    vector4f.y - 640000.0F, vector4f.z,
                                    vector4f.w);
    ARBShaderObjects.glUniform4fARB(
        this.WaterViewport, IsoCamera.getOffscreenLeft(int0),
    ...
    ARBShaderObjects.glUniform2fARB(this.WaterParamWind, textureDraw.u0,
                                    textureDraw.u1);
    ARBShaderObjects.glUniform1fARB(this.WaterParamWindSpeed, textureDraw.u2);
    ARBShaderObjects.glUniform1fARB(this.WaterParamRainIntensity,
                                    textureDraw.u3);
  }
}
} // namespace iso
