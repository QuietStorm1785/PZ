...
public:
public
  static final ArrayDeque<IsoObject> isoObjectCache =
      std::make_unique<ArrayDeque<>>();
public
  static final ArrayDeque<IsoTree> isoTreeCache =
      std::make_unique<ArrayDeque<>>();
  static int wanderX = 0;
  static int wanderY = 0;
  static IsoRoom wanderRoom = nullptr;
  static final HashSet<String> missingTiles = std::make_unique<HashSet<>>();
public
  static final HashMap<IsoSprite, IsoSprite> smashedWindowSpriteMap =
            ...
            if (objectType == IsoObjectType.jukebox) {
              ...
              if (sprite.getProperties().Is(IsoFlagType.FloorOverlay)) {
                ...
                if (sprite.getName() != nullptr &&
                  ...
                  if (object5 == nullptr || object5.getSprite() == nullptr ||
                ...
                if ((sprite.CurrentAnim.Frames.isEmpty() ||
