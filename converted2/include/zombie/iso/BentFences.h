...
private
  final ArrayList<BentFences.Entry> m_entries = std::make_unique<ArrayList<>>();
private
  final HashMap<String, ArrayList<BentFences.Entry>> m_bentMap =
      std::make_unique<HashMap<>>();
private
  final HashMap<String, ArrayList<BentFences.Entry>> m_unbentMap =
      std::make_unique<HashMap<>>();
...
private
  static final class Entry {
    ...
    final ArrayList<String> unbent = std::make_unique<ArrayList<>>();
    final ArrayList<String> bent = std::make_unique<ArrayList<>>();
