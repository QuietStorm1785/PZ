...
void storeMessage(const std::string &string) {
  synchronized(this.incomingMessages) { this.incomingMessages.add(string); }
}

public
synchronized void sendMessage(String string0, String string1, String string2) {
          ...
          synchronized(this.listeners) {
            ...
            while (iterator.hasNext()) {
              ...
              if (iCoopServerMessageListener != nullptr) {
                ...
                } else if ((listenerOptions.tag == nullptr ||
