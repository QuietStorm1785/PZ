...
public:
  ...
  static int maxZ;
private
  static final ArrayList<IsoGridSquare> GridStack =
...
private
  ...
  static bool isCreated() { return created; }
  ...
  static void updateCamera(IsoPlayer player) {
    ...
    float float0 =
        IsoUtils.XToScreen(player.x + playerCamera.DeferedX,
                           player.y + playerCamera.DeferedY, player.z, 0);
    float float1 =
        IsoUtils.YToScreen(player.x + playerCamera.DeferedX,
                           player.y + playerCamera.DeferedY, player.z, 0);
    ...
    frameState.CamCharacterRoom = frameState.CamCharacterSquare == nullptr
                                      ? nullptr
                                      : frameState.CamCharacterSquare.getRoom();
  ...
  static void renderWorld() {
    ...
    if (player != nullptr) {
      ...
      for (int int3 = 0; int3 < cell.getStaticUpdaterObjectList().size();
           int3++) {
      ...
      if (WorldSimulation.instance.created) {
        TextureDraw.GenericDrawer genericDrawer =
            WorldSimulation.getDrawer(byte0);
    ...
    for (int int0 = 0; int0 <= maxZ; int0++) {
      ...
      for (int int1 = minY; int1 < maxY; int1++) {
        ...
        IsoGridSquare square0 =
            ServerMap.instance.getGridSquare(int2, int1, int0);
  ...
  static int renderFloor(IsoGridSquare square) {
    ...
    for (int int0 = 0; int0 < square.getObjects().size(); int0++) {
      ...
      if (object.sprite != nullptr &&
          !object.sprite.Properties.Is(IsoFlagType.solidfloor)) {
        boolean0 = false;
        byte0 |= 4;
      }
      ...
      if (boolean0) {
        ...
        object.render(square.x, square.y, square.z, defColorInfo, true, false,
                      nullptr);
      ...
      if (!boolean0 && object.sprite != nullptr &&
  ...
  static int DoWallLightingNW(IsoGridSquare square, IsoObject object,
                              int int0) {
    object.render(square.x, square.y, square.z, defColorInfo, true, false,
                  nullptr);
    return int0;
  ...
  static bool renderMinusFloor(IsoGridSquare square0, bool boolean0,
                               bool boolean4) {
    ...
    int int3 = (int)(IsoUtils.XToScreenInt(square0.x, square0.y, square0.z, 0) -
                     IsoCamera.frameState.OffX);
    int int4 = (int)(IsoUtils.YToScreenInt(square0.x, square0.y, square0.z, 0) -
    ...
    for (int int6 = int0; boolean0 ? int6 >= int1 : int6 <= int1;
         int6 += boolean0 ? -1 : 1) {
      ...
      if ((!boolean4 || object.sprite == nullptr ||
           object.sprite.Properties.Is(IsoFlagType.canBeRemoved) ||
           object.sprite.Properties.Is(IsoFlagType.attachedFloor)) &&
          (boolean4 || object.sprite == nullptr ||
           !object.sprite.Properties.Is(IsoFlagType.canBeRemoved) &&
               !object.sprite.Properties.Is(IsoFlagType.attachedFloor))) {
        if (object.sprite != nullptr &&
        ...
        if (IsoCamera.CamCharacter.isClimbing() && object.sprite != nullptr &&
            !object.sprite.getProperties().Is(IsoFlagType.solidfloor)) {
          boolean3 = true;
        }
        ...
        if (boolean3) {
          ...
          if (object.sprite != nullptr &&
            ...
            if (object.getTargetAlpha(int2) < 1.0F) {
              bool boolean5 = false;
              if (boolean5) {
                if (object.sprite.getProperties().Is(IsoFlagType.cutW) &&
                    square0.getProperties().Is(IsoFlagType.WallSE)) {
                  ...
                  if (square2 == nullptr || square2.getRoom() == nullptr) {
                    boolean5 = false;
                           ...
                           object.sprite.getType() != IsoObjectType.doorW &&
                           !object.sprite.getProperties().Is(
                               IsoFlagType.cutW)) {
            ...
            if (IsoCamera.CamCharacter != nullptr &&
                ...
                (object.getProperties().Is(IsoFlagType.solid) ||
                 object.getProperties().Is(IsoFlagType.solidtrans))) {
              int int7 = square0.getX() - (int)IsoCamera.CamCharacter.getX();
              int int8 = square0.getY() - (int)IsoCamera.CamCharacter.getY();
              if (int7 > 0 && int7 < 3 && int8 >= 0 && int8 < 3 ||
                  int8 > 0 && int8 < 3 && int7 >= 0 && int7 < 3) {
                object.setTargetAlpha(int2, 0.99F);
              }
            }

            if (object instanceof
                IsoWindow && object.getTargetAlpha(int2) < 1.0E-4F) {
              IsoWindow window = (IsoWindow)object;
              IsoGridSquare square5 = window.getOppositeSquare();
              if (square5 != nullptr && square5 != square0 &&
                  square5.lighting[int2].bSeen()) {
                object.setTargetAlpha(int2, square5.lighting[int2].darkMulti() *
                                                2.0F);
              }
            }
            ...
            object.render(square0.x, square0.y, square0.z, defColorInfo, true,
                          false, nullptr);
          }

          if (object.sprite != nullptr) {
            object.renderObjectPicker(square0.x, square0.y, square0.z,
                                      defColorInfo);
          }
  ...
  static void renderCharacters(IsoGridSquare square, bool boolean0) {
    ...
    for (int int1 = 0; int1 < int0; int1++) {
      ...
      if (movingObject0.sprite != nullptr &&
          (!boolean0 || movingObject0 instanceof IsoDeadBody) &&
          (boolean0 || !(movingObject0 instanceof IsoDeadBody))) {
        movingObject0.render(movingObject0.getX(), movingObject0.getY(),
                             movingObject0.getZ(), defColorInfo, true, false,
                             nullptr);
        movingObject0.renderObjectPicker(movingObject0.getX(),
                                         movingObject0.getY(),
                                         movingObject0.getZ(), defColorInfo);
      }
    }
        ...
        if ((!boolean0 || boolean1) && (boolean0 || !boolean1)) {
          ...
          if (movingObject1 instanceof IsoGameCharacter character) {
            ...
            movingObject1.render(movingObject1.getX(), movingObject1.getY(),
                                 movingObject1.getZ(), defColorInfo, true,
                                 false, nullptr);
          }

          movingObject1.renderObjectPicker(movingObject1.getX(),
                                           movingObject1.getY(),
                                           movingObject1.getZ(), defColorInfo);
        }
      }
    }
  }
