...
public
  ...
  void randomizeBuilding(BuildingDef def) {
    ...
    std::vector arrayList =
        this.addZombiesOnSquare(1, "Kate", 100, this.getSq(10746, 9412, 1));
    if (arrayList != nullptr && !arrayList.isEmpty()) {
      ...
      arrayList =
          this.addZombiesOnSquare(1, "Bob", 0, this.getSq(10747, 9412, 1));
      if (arrayList != nullptr && !arrayList.isEmpty()) {
        ...
        zombie1.addItemToSpawnAtDeath(
            InventoryItemFactory.CreateItem("KatePic"));
        zombie1.addItemToSpawnAtDeath(
            InventoryItemFactory.CreateItem("RippedSheets"));
        ...
        arrayList =
            this.addZombiesOnSquare(1, "Raider", 0, this.getSq(10745, 9411, 0));
        if (arrayList != nullptr && !arrayList.isEmpty()) {
          ...
          for (int int2 = 0; int2 < zombie2.getItemVisuals().size(); int2++) {
            ...
            if (itemVisual2.getClothingItemName() ==
                "Trousers_DefaultTEXTURE_TINT")) {
          ...
          zombie2.addItemToSpawnAtDeath(
              InventoryItemFactory.CreateItem("ShotgunShells"));
          zombie2.resetModelNextFrame();
          this.addItemOnGround(this.getSq(10747, 9412, 1),
                               InventoryItemFactory.CreateItem("Pillow"));
          ...
          for (int int3 = 0; int3 < square1.getObjects().size(); int3++) {
            ...
            if (object.getContainer() != nullptr) {
              InventoryItem item3 =
                  InventoryItemFactory.CreateItem("PotOfSoup");
