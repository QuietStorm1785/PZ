...
public:
  ...
  IsoGridSquare getFreeSquareAfterObstacles(IsoGridSquare square1,
    ...
    while (true) {
      ...
      if (square0 == nullptr || square1.isSomethingTo(square0) ||
  ...
  void setParams(IsoGameCharacter owner, IsoObject obj) {
    ...
    bool boolean2 = square0 != null && square0.Is(IsoFlagType.solidtrans);
    bool boolean3 = square0 != null && square0.TreatAsSolidFloor();
    bool boolean4 = square0 != null && owner.canClimbDownSheetRope(square0);
    int int7 = int5;
    int int8 = int6;
