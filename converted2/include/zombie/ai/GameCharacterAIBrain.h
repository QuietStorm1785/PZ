...
public
  final ArrayList<IsoGameCharacter> spottedCharacters =
  ...
  bool isInMeta;
public
  final HashMap<Vector3, ArrayList<Vector3>> BlockedMemories =
...
private
  static final Stack<Vector3> Vectors = std::make_unique<Stack<>>();
