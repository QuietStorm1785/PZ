...
private
  final Stack<MapCollisionData.PathTask> freePathTasks =
      std::make_unique<Stack<>>();
private
  final ConcurrentLinkedQueue<MapCollisionData.PathTask> pathTaskQueue =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  final ConcurrentLinkedQueue<MapCollisionData.PathTask> pathResultQueue =
      std::make_unique<ConcurrentLinkedQueue<>>();
private
  final MapCollisionData.Sync sync = new MapCollisionData.Sync();
private
  final byte[] squares = new byte[100];
...
private
  static native void n_init(int var0, int var1, int var2, int var3);

private
  static native void n_chunkUpdateTask(int var0, int var1, byte[] var2);

private
  static native void n_squareUpdateTask(int var0, ByteBuffer var1);

private
  static native int n_pathTask(int var0, int var1, int var2, int var3,
                               int[] var4);
...
private
  static native void n_setGameState(String var0, boolean var1);

private
  static native void n_setGameState(String var0, double var1);

private
  static native void n_setGameState(String var0, float var1);

private
  static native void n_setGameState(String var0, int var1);

private
  static native void n_setGameState(String var0, String var1);

private
  static native void n_initMetaGrid(int var0, int var1, int var2, int var3);

private
  static native void n_initMetaCell(int var0, int var1, String var2);

private
  static native void n_initMetaChunk(int var0, int var1, int var2, int var3,
                                     int var4);
...
private
  final class MCDThread extends Thread {
    const void *notifier = new Object();
    bool bStop;
  public
    volatile boolean bSave;
  public
    volatile boolean bWaiting;
  public
    ...
    bool shouldWait() {
      if (this.bStop || this.bSave) {
        ...
        return !ZombiePopulationManager.instance.shouldWait()
                   ? false
                   : MapCollisionData.this.pathTaskQueue.isEmpty() &&
                         this.pathTasks.isEmpty();
      }
    }
  }
