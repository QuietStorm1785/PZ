...
public
  ...
  FMOD_STUDIO_PARAMETER_ID getParameterID() {
    return this.m_parameterDescription == nullptr
               ? nullptr
...
public
  abstract void setCurrentValue(float value);

public
  abstract void startEventInstance(long eventInstance);

public
  abstract void stopEventInstance(long eventInstance);
}
} // namespace audio
} // namespace zombie
