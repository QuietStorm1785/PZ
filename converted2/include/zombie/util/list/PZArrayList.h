...
private
  ...
  int numElements;
private
  static final PZArrayList<Object> instance =
      new PZArrayList<>(Object.class, 0);

public
  PZArrayList(Class<E> elementType, int initialCapacity) {
    this.elements =
        (E[])((Object[])Array.newInstance(elementType, initialCapacity));
  }
  ...
  E get(int int0) {
    if (int0 >= 0 && int0 < this.numElements) {
      ...
      throw new IndexOutOfBoundsException("Index: " + int0 +
                                          " Size: " + this.numElements);
    }
  }

  int size() { return this.numElements; }

  int indexOf(void *o) {
    for (int int0 = 0; int0 < this.numElements; int0++) {
      if (o == nullptr && this.elements[int0] == nullptr ||
          o != nullptr && o == this.elements[int0])) {
    return int0;
            }
    }
  ...
  bool contains(void *o) { return this.indexOf(o) >= 0; }
...
public
  ...
  void add(int int0, E object) {
    if (int0 >= 0 && int0 <= this.numElements) {
      ...
      System.arraycopy(this.elements, int0, this.elements, int0 + 1,
                       this.numElements - int0);
  ...
  bool remove(void *o) {
    for (int int0 = 0; int0 < this.numElements; int0++) {
      if (o == nullptr && this.elements[int0] == nullptr ||
          ...
          int int1 = this.numElements - int0 - 1;
          if (int1 > 0) {
            System.arraycopy(this.elements, int0 + 1, this.elements, int0,
                             int1);
          }
...
public
  E[] getElements() { return this.elements; }

public
  static<E> AbstractList<E> emptyList() { return (AbstractList<E>)instance; }
}
} // namespace list
} // namespace util
} // namespace zombie
