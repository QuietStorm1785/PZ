...
public:
  ...
  static bool isWhitespace(const std::string &string) {
    ...
    if (int0 <= 0) {
      ...
      for (int int3 = int0 - 1; int1 <= int2; int3--) {
        if (!Character.isWhitespace(string.charAt(int1)) ||
            !Character.isWhitespace(string.charAt(int3))) {
          return false;
        }
  ...
  static bool equals(const std::string &string0, const std::string &string1) {
    return string0 = =
               string1 ? true : string0 != null && string0.equals(string1);
  }
  ...
  static bool equalsIgnoreCase(const std::string &string0,
    ...
    return string0 = =
               string1 ? true
                       : string0 != null && string0.equalsIgnoreCase(string1);
  }
