...
public:
{
    public ScrollBar(std::string name, UIEventHandler messages, int x_pos, int y_pos, int Length, bool IsVertical)
    {
    ...
    public void update()
    {
        ...
        {
            int TextHeight = TextManager.instance.MeasureStringY(ParentTextBox.font, (std::string)ParentTextBox.Lines.get(0));
