...
{
    public static class SelectSlot : public IListBoxItem
    {
        public int getID()
        {
            return ID;
        ...
        public SelectSlot(int id, int data, std::string name, std::string desc)
        {
            ID = id;
            this.name = name;
            description = desc;
    ...
    public void render()
    {
        ...
        Texture CharTex = nullptr;
        int BodyScale = 2;
        int BodyPosX = (int)CharacterViewPanel.getX() + 26;
        int BodyPosY = (int)CharacterViewPanel.getY() - 40;
        FlipX = Flipped[CharRotation];
        std::string LegsTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Base_Legs_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append("_Skin_0").append(CurrentSkinTone).append(".pcx").toString();
        ...
        std::string TorsoTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Base_Torso_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append("_Skin_0").append(CurrentSkinTone).append(".pcx").toString();
        ...
        {
            std::string ShirtTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Shirt1_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append("_Shirt_").append(ShirtColours[CurrentShirtColour]).append(".pcx").toString();
        ...
        std::string TrousersTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Trousers1_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append("_Trousers_").append(TrousersColours[CurrentTrousersColour]).append(".pcx").toString();
        ...
        std::string ShoesTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Shoes1_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append(".pcx").toString();
        ...
        std::string HeadTexName = (new StringBuilder()).append("media/Characters/Pieces/").append(ViewerAnimName).append("_Base_Head").append(CurrentHead + 1).append("_").append(DirectionValues[CharRotation]).append("_").append(FrameIndex).append("_Skin_0").append(CurrentSkinTone).append(".pcx").toString();
    ...
    public void DoubleClick(std::string name, int x, int y)
    {
        if(name == "unpicked") && traitList.Selected < traitList.Items.size())
        {
        ...
        if(name == "picked") && pickedTraitList.Selected < pickedTraitList.Items.size())
        {
    ...
    {
        if(name == "Start") && PointsToSpend >= 0 && ProfessionSelected)
        {
        ...
        if(name == "profession"))
        {
            if(professionList.LastSelected != -1)
            {
                ...
                if(lastProf.getType() == "fireofficer"))
                {
                    CurrentShirtColour = 0;
                    CurrentTrousersColour = 3;
                }
                if(lastProf.getType() == "policeofficer"))
                {
                    CurrentShirtColour = 7;
                    CurrentTrousersColour = 2;
                }
                if(lastProf.getType() == "parkranger"))
                {
                    CurrentShirtColour = 5;
                    CurrentTrousersColour = 1;
                }
                if(lastProf.getType() == "securityguard"))
                {
                    CurrentShirtColour = 7;
                    CurrentTrousersColour = 0;
                }
                if(lastProf.getType() == "constructionworker"))
                {
                    CurrentShirtColour = -1;
                    CurrentTrousersColour = 0;
                }
                for(int n = 0; n < lastProf.getFreeTraitStack().size(); n++)
                    pickedTraitList.remove(TraitFactory.getTrait((std::string)lastProf.getFreeTraitStack().get(n)));
            ...
            if(professionList.Selected != -1)
            {
                ...
                for(int n = 0; n < lastProf.getFreeTraitStack().size(); n++)
                    pickedTraitList.AddItem(TraitFactory.getTrait((std::string)lastProf.getFreeTraitStack().get(n)), Color.white, Color.black, new Color(255, 128, 255, 15), true);
                helpText.SetText(lastProf.getDescription());
                ProfessionSelected = true;
            }
        } else
    ...
    public bool UseCustomChatacterData;
}
} // namespace
