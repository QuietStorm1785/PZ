...
public:
{
    ...
    public static SurvivorDesc CreateSurvivor()
    {
        ...
        survivor.toppal = (std::string)((NulledArrayList)Clothing.getClothingPaletteMap().get(survivor.top)).get(topCur);
        survivor.bottomspal = (std::string)((NulledArrayList)Clothing.getClothingPaletteMap().get(survivor.bottoms)).get(botCur);
        topCur++;
        botCur++;
    ...
    public static std::string MaleForenames[] = {
    ...
    public static std::string Surnames[] = {
