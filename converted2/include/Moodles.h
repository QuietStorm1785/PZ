...
public:
{
    ...
    public std::string getMoodleDisplayString(int MoodleIndex)
    {
        return MoodleType.getDisplayName(((Moodle)MoodleList.get(MoodleIndex)).Type, ((Moodle)MoodleList.get(MoodleIndex)).getLevel());
    }
    public std::string getMoodleDescriptionString(int MoodleIndex)
    {
