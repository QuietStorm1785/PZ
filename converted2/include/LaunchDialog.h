...
class LaunchDialog : public JDialog {
public:
{
    public LaunchDialog(Frame parent, bool modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setAlwaysOnTop(true);
        setResizable(false);
        jComboBox1.setModel(new DefaultComboBoxModel(new std::string[] {
            "Low", "Medium", "High"
        }));
        jComboBox1.setSelectedIndex(2);
        jLabel1.setText("Graphics:");
        jComboBox2.setModel(new DefaultComboBoxModel(new std::string[] {
    ...
    private void jButton2ActionPerformed(ActionEvent evt)
    {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run()
            {
                std::string split[] = LaunchDialog.d.jComboBox2.getSelectedItem().toString().split("x");
                dispose();
    ...
    public static void main(std::string args[])
    {
        ...
        {
            Logger.getLogger(LaunchDialog.class.getName()).log(Level.SEVERE, nullptr, ex);
        }
    ...
    private static std::string lev;
    static LaunchDialog d;
    public static std::string split[] = nullptr;
