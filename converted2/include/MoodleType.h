...
/*  46 */   MAX;
    ...
    public static MoodleType FromString(std::string str)
    {
        if(str == "Endurance"))
            return Endurance;
        if(str == "Tired"))
    ...
    public static std::string getDisplayName(MoodleType MT, int Level)
    {
        if(Level > 4)
            Level = 4;
        if(Level == 0)
    ...
    public static std::string getDescriptionText(MoodleType MT, int Level)
    {
        if(Level > 4)
            Level = 4;
        if(Level == 0)
