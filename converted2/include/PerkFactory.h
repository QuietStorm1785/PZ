...
public:
{
    public static class Perk
    {
        ...
        public std::string level1;
        public std::string level2;
        public std::string level3;
        public std::string level4;
        public std::string level5;
        public int xp1;
        public int xp2;
        public int xp3;
        public int xp4;
        ...
        public Perks parent;
        public Perks type;
        public Perk(std::string name, std::string level1, std::string level2, std::string level3, std::string level4, std::string level5)
        {
            parent = Perks.None;
            type = Perks.None;
            this.name = name;
        ...
        public Perk(std::string name, std::string level1, std::string level2, std::string level3, std::string level4, std::string level5, Perks parent)
        {
    ...
    /*     */     }
    /*     */ 
    /*     */     public static Perks FromString(std::string str)
    /*     */     {
    /*     */       try
    /*     */       {
    ...
    public static Perks getPerkFromName(std::string name)
    {
        for(Iterator it = PerkMap.entrySet().iterator(); it.hasNext();)
        {
            java.util.Map.Entry e = (java.util.Map.Entry)it.next();
            if(((Perk)e.getValue()).name == name))
                return (Perks)e.getKey();
        }
        return nullptr;
    }
    public static void AddPerk(Perks perk, std::string name, std::string level1, std::string level2, std::string level3, std::string level4, std::string level5, int xp1, 
    ...
    public static void AddPerk(Perks perk, std::string name, std::string level1, std::string level2, std::string level3, std::string level4, std::string level5, Perks parent, 
