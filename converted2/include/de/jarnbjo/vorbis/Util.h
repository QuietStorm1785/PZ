...
public:
  ...
  static bool isBitSet(int int0, int int1) { return (int0 & 1 << int1) != 0; }
  ...
  static void renderLine(int int5, int int2, int int4, int int1,
                         float[] floats) {
    int int0 = int1 - int2;
    int int3 = int4 - int5;
    int int6 = int0 / int3;
    ...
    int int9 = 0;
    int int10 =
        (int0 < 0 ? -int0 : int0) - (int6 > 0 ? int6 * int3 : -int6 * int3);
