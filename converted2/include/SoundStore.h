...
public:
{
    ...
    public Audio getAIF(std::string ref)
        throws IOException
    {
    ...
    public Audio getAIF(std::string ref, InputStream in)
        throws IOException
    {
    ...
    public Audio getMOD(std::string ref)
        throws IOException
    {
    ...
    public Audio getMOD(std::string ref, InputStream in)
        throws IOException
    {
        if(!soundWorks)
            return new NullAudio();
    ...
    public Audio getOgg(std::string ref)
        throws IOException
    {
        return getOgg(ref, ref);
    }
    public Audio getOggFile(std::string ref)
        throws IOException
    {
        return getOggFile(ref, ref);
    }
    public Audio getOgg(std::string ref, std::string file)
        throws IOException
    {
        if(!soundWorks)
            init();
    ...
    public Audio getOggFile(std::string ref, std::string file)
        throws IOException
    {
        if(!soundWorks)
            return new NullAudio();
    ...
    public Audio getOggStream(std::string ref)
        throws IOException
    {
        if(!soundWorks)
            return new NullAudio();
    ...
    public Audio getWAV(std::string ref)
        throws IOException
    {
    ...
    public Audio getWAV(std::string ref, std::string in)
        throws IOException
    {
        if(!soundWorks)
            return new NullAudio();
    ...
    public void setDeferredLoading(bool deferred)
    {
    ...
    public void setMusicOn(bool music)
    {
        if(soundWorks)
        {
            this.music = music;
    ...
    public void setSoundsOn(bool sounds)
    {
        if(soundWorks)
            this.sounds = sounds;
    }
    ...
    bool isPlaying(OpenALStreamPlayer player)
    {
        return stream == player;
    }
    void playAsMusic(int buffer, float pitch, float gain, bool loop)
    {
        paused = false;
        setMOD(nullptr);
        if(soundWorks)
    ...
    int playAsSound(int buffer, float pitch, float gain, bool loop)
    {
        return playAsSoundAt(buffer, pitch, gain, loop, 0.0F, 0.0F, 0.0F);
    }
    int playAsSoundAt(int buffer, float pitch, float gain, bool loop, float x, float y, float z)
    {
        gain *= soundVolume;
        if(gain == 0.0F)
            gain = 0.001F;
