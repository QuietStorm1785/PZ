...
public:
  ...
  Vector4f unproject(float var1, float var2, float var3, int[] var4,
                     Vector4f var5);

  Vector3f unproject(float var1, float var2, float var3, int[] var4,
                     Vector3f var5);
  ...
  Matrix4f unprojectRay(float var1, float var2, int[] var3, Vector3f var4,
                        Vector3f var5);

  Matrix4f unprojectRay(Vector2fc var1, int[] var2, Vector3f var3,
                        Vector3f var4);

  Vector4f unprojectInv(Vector3fc var1, int[] var2, Vector4f var3);

  Vector4f unprojectInv(float var1, float var2, float var3, int[] var4,
                        Vector4f var5);

  Matrix4f unprojectInvRay(Vector2fc var1, int[] var2, Vector3f var3,
                           Vector3f var4);

  Matrix4f unprojectInvRay(float var1, float var2, int[] var3, Vector3f var4,
                           Vector3f var5);

  Vector3f unprojectInv(Vector3fc var1, int[] var2, Vector3f var3);

  Vector3f unprojectInv(float var1, float var2, float var3, int[] var4,
                        Vector3f var5);

  Vector4f project(float var1, float var2, float var3, int[] var4,
                   Vector4f var5);

  Vector3f project(float var1, float var2, float var3, int[] var4,
                   Vector3f var5);
  ...
  Matrix4f pick(float var1, float var2, float var3, float var4, int[] var5,
                Matrix4f var6);
