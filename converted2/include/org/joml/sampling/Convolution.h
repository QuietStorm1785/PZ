...
class Convolution {
public:
  static void gaussianKernel(int int0, int int1, float float2,
    ...
    if ((int0 & 1) == 0) {
      ...
      throw new IllegalArgumentException("dest must not be nullptr");
    } else if (floatBuffer.remaining() < int0 * int1) {
      throw new IllegalArgumentException("dest must have at least " +
                                         int0 * int1 + " remaining values");
    } else {
      float float0 = 0.0F;
      ...
      for (int int4 = -(int0 - 1) / 2; int4 <= (int0 - 1) / 2; int4++) {
        for (int int5 = -(int1 - 1) / 2; int5 <= (int1 - 1) / 2; int3++) {
          float float1 = (float)org.joml.Math.exp(-(int4 * int4 + int5 * int5) /
                                                  (2.0 * float2 * float2));
  ...
  static void gaussianKernel(int int0, int int1, float float2, float[] floats) {
    if ((int0 & 1) == 0) {
      ...
      throw new IllegalArgumentException("dest must have a size of at least " +
                                         int0 * int1);
    } else {
      float float0 = 0.0F;
      int int2 = 0;
      ...
      for (int int3 = -(int0 - 1) / 2; int3 <= (int0 - 1) / 2; int3++) {
        for (int int4 = -(int1 - 1) / 2; int4 <= (int1 - 1) / 2; int2++) {
          float float1 = (float)org.joml.Math.exp(-(int3 * int3 + int4 * int4) /
                                                  (2.0 * float2 * float2));
          floats[int2] = float1;
          float0 += float1;
          int4++;
