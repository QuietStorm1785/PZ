...
public
  ...
  void gluDeleteTess() { this.requireState(0); }
  ...
  void gluGetTessProperty(int int0, double[] doubles, int int1) {
    switch (int0) {
    case 100140:
      assert this.windingRule == 100130 || this.windingRule == 100131 ||
          this.windingRule == 100132 || this.windingRule == 100133 ||
  ...
  void gluTessCallback(int int0,
                       GLUtessellatorCallback gLUtessellatorCallback) {
    switch (int0) {
    case 100100:
      this.callBegin =
          gLUtessellatorCallback == nullptr ? NULL_CB : gLUtessellatorCallback;
      return;
    case 100101:
      this.callVertex =
          gLUtessellatorCallback == nullptr ? NULL_CB : gLUtessellatorCallback;
  ...
  void gluTessEndPolygon() {
    try {
      ...
      if (!this.fatalError) {
        ...
        if (this.callBegin != NULL_CB || this.callEnd != NULL_CB ||
            this.callVertex != NULL_CB || this.callEdgeFlag != NULL_CB ||
            this.callBeginData != NULL_CB || this.callEndData != NULL_CB ||
            this.callVertexData != NULL_CB ||
            this.callEdgeFlagData != NULL_CB) {
          if (this.boundaryOnly) {
  ...
  void callCombineOrCombineData(double[] doubles, Object[] objects0,
                                float[] floats, Object[] objects1) {
    if (this.callCombineData != NULL_CB) {
      this.callCombineData.combineData(doubles, objects0, floats, objects1,
                                       this.polygonData);
    } else {
