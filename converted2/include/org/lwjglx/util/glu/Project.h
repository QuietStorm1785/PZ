...
class Project : public Util {
public:
private
  static final float[] IDENTITY_MATRIX =
      new float[]{1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F,
                  0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F};
  static const FloatBuffer matrix = BufferUtils.createFloatBuffer(16);
  static const FloatBuffer finalMatrix = BufferUtils.createFloatBuffer(16);
  static const FloatBuffer tempMatrix = BufferUtils.createFloatBuffer(16);
private
  static final float[] in = new float[4];
private
  static final float[] out = new float[4];
private
  static final float[] forward = new float[3];
private
  static final float[] side = new float[3];
private
  static final float[] up = new float[3];

  static void __gluMakeIdentityf(FloatBuffer floatBuffer) {
    int int0 = floatBuffer.position();
    floatBuffer.put(IDENTITY_MATRIX);
    floatBuffer.position(int0);
  }

  static void __gluMultMatrixVecf(FloatBuffer floatBuffer, float[] floats0,
                                  float[] floats1) {
    for (int int0 = 0; int0 < 4; int0++) {
      floats1[int0] =
          floats0[0] * floatBuffer.get(floatBuffer.position() + 0 + int0) +
  ...
  static bool __gluInvertMatrixf(FloatBuffer floatBuffer1,
    ...
    for (int int1 = 0; int1 < 4; int1++) {
      ...
      for (int int3 = int1 + 1; int3 < 4; int3++) {
        if (Math.abs(floatBuffer0.get(int3 * 4 + int1)) >
            Math.abs(floatBuffer0.get(int1 * 4 + int1))) {
          int2 = int3;
        }
      }
      ...
      for (int int5 = 0; int5 < 4; int5++) {
        floatBuffer0.put(int1 * 4 + int5,
                         floatBuffer0.get(int1 * 4 + int5) / float1);
        floatBuffer2.put(int1 * 4 + int5,
                         floatBuffer2.get(int1 * 4 + int5) / float1);
      }
      ...
      for (int int6 = 0; int6 < 4; int6++) {
        if (int6 != int1) {
          ...
          for (int int7 = 0; int7 < 4; int7++) {
            floatBuffer0.put(int6 * 4 + int7,
                             floatBuffer0.get(int6 * 4 + int7) -
                                 floatBuffer0.get(int1 * 4 + int7) * float1);
            floatBuffer2.put(int6 * 4 + int7,
                             floatBuffer2.get(int6 * 4 + int7) -
                                 floatBuffer2.get(int1 * 4 + int7) * float1);
          }
        }
      }
    }
  ...
  static void __gluMultMatricesf(FloatBuffer floatBuffer2,
    ...
    for (int int0 = 0; int0 < 4; int0++) {
      for (int int1 = 0; int1 < 4; int1++) {
        floatBuffer0.put(
            ...
            floatBuffer2.get(floatBuffer2.position() + int0 * 4 + 0) *
                    floatBuffer1.get(floatBuffer1.position() + 0 + int1) +
                floatBuffer2.get(floatBuffer2.position() + int0 * 4 + 1) *
                    floatBuffer1.get(floatBuffer1.position() + 4 + int1) +
                floatBuffer2.get(floatBuffer2.position() + int0 * 4 + 2) *
                    floatBuffer1.get(floatBuffer1.position() + 8 + int1) +
                floatBuffer2.get(floatBuffer2.position() + int0 * 4 + 3) *
                    floatBuffer1.get(floatBuffer1.position() + 12 + int1));
      }
    }
  }

  static void gluPerspective(float float1, float float6, float float4,
                             float float3) {
  ...
  static void gluLookAt(float float1, float float3, float float5, float float0,
                        float float2, float float4, float float6, float float7,
                        float float8) {
...
public
  static boolean gluProject(float float0, float float1, float float2,
    ...
    if (floats0[3] == 0.0) {
      ...
      floatBuffer2.put(0, floats0[0] * intBuffer.get(intBuffer.position() + 2) +
                              intBuffer.get(intBuffer.position() + 0));
      floatBuffer2.put(1, floats0[1] * intBuffer.get(intBuffer.position() + 3) +
                              intBuffer.get(intBuffer.position() + 1));
...
public
  static boolean gluUnProject(float float0, float float1, float float2,
    ...
    if (!__gluInvertMatrixf(finalMatrix, finalMatrix)) {
      ...
      floats0[2] = float2;
      floats0[3] = 1.0F;
      floats0[0] = (floats0[0] - intBuffer.get(intBuffer.position() + 0)) /
                   intBuffer.get(intBuffer.position() + 2);
      floats0[1] = (floats0[1] - intBuffer.get(intBuffer.position() + 1)) /
                   intBuffer.get(intBuffer.position() + 3);
  ...
  static void gluPickMatrix(float float3, float float2, float float1,
                            float float0, IntBuffer intBuffer) {
    if (!(float1 <= 0.0F) && !(float0 <= 0.0F)) {
      GL11.glTranslatef(
          (intBuffer.get(intBuffer.position() + 2) -
           2.0F * (float3 - intBuffer.get(intBuffer.position() + 0))) /
              float1,
          (intBuffer.get(intBuffer.position() + 3) -
           2.0F * (float2 - intBuffer.get(intBuffer.position() + 1))) /
              float0,
          0.0F);
      GL11.glScalef(intBuffer.get(intBuffer.position() + 2) / float1,
                    intBuffer.get(intBuffer.position() + 3) / float0, 1.0F);
    }
  }
}
} // namespace glu
