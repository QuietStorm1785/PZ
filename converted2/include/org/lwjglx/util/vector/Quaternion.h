...
public
  Quaternion() { this.setIdentity(); }

public
  Quaternion(ReadableVector4f readableVector4f) { this.set(readableVector4f); }

public
  Quaternion(float float0, float float1, float float2, float float3) {
  ...
  Quaternion setIdentity() { return setIdentity(); }
  ...
  static Quaternion normalise(Quaternion quaternion0, Quaternion quaternion1) {
    ...
    quaternion1.set(quaternion0.x * float0, quaternion0.y * float0,
                    quaternion0.z * float0, quaternion0.w * float0);
    return quaternion1;
  }

  Quaternion normalise(Quaternion quaternion1) { return normalise(); }

  static float dot(Quaternion quaternion1, Quaternion quaternion0) {
    return quaternion1.x * quaternion0.x + quaternion1.y * quaternion0.y +
           quaternion1.z * quaternion0.z + quaternion1.w * quaternion0.w;
  }

  Quaternion negate(Quaternion quaternion1) { return negate(); }
  ...
  Vector scale(float float0) { return scale(); }

  static Quaternion scale(float float0, Quaternion quaternion1,
  ...
  static Quaternion mul(Quaternion quaternion2, Quaternion quaternion1,
                        Quaternion quaternion0) {
    if (quaternion0 == nullptr) {
      quaternion0 = std::make_unique<Quaternion>();
    }
    ...
    quaternion0.set(
        quaternion2.x * quaternion1.w + quaternion2.w * quaternion1.x +
            quaternion2.y * quaternion1.z - quaternion2.z * quaternion1.y,
        quaternion2.y * quaternion1.w + quaternion2.w * quaternion1.y +
            quaternion2.z * quaternion1.x - quaternion2.x * quaternion1.z,
        quaternion2.z * quaternion1.w + quaternion2.w * quaternion1.z +
            quaternion2.x * quaternion1.y - quaternion2.y * quaternion1.x,
        quaternion2.w * quaternion1.w - quaternion2.x * quaternion1.x -
            quaternion2.y * quaternion1.y - quaternion2.z * quaternion1.z);
    return quaternion0;
  }

  static Quaternion mulInverse(Quaternion quaternion2, Quaternion quaternion0,
    ...
    quaternion1.set(
        (quaternion2.x * quaternion0.w - quaternion2.w * quaternion0.x -
         quaternion2.y * quaternion0.z + quaternion2.z * quaternion0.y) *
            float0,
        (quaternion2.y * quaternion0.w - quaternion2.w * quaternion0.y -
         quaternion2.z * quaternion0.x + quaternion2.x * quaternion0.z) *
            float0,
        (quaternion2.z * quaternion0.w - quaternion2.w * quaternion0.z -
         quaternion2.x * quaternion0.y + quaternion2.y * quaternion0.x) *
            float0,
        (quaternion2.w * quaternion0.w + quaternion2.x * quaternion0.x +
         quaternion2.y * quaternion0.y + quaternion2.z * quaternion0.z) *
            float0);
    return quaternion1;
  }
  ...
  Quaternion setFromMatrix(Matrix4f matrix4f) { return setFromMatrix(); }

  static Quaternion setFromMatrix(Matrix4f matrix4f, Quaternion quaternion) {
    return quaternion.setFromMat(matrix4f.m00, matrix4f.m01, matrix4f.m02,
                                 matrix4f.m10, matrix4f.m11, matrix4f.m12,
                                 matrix4f.m20, matrix4f.m21, matrix4f.m22);
  }

  Quaternion setFromMatrix(Matrix3f matrix3f) { return setFromMatrix(); }

  static Quaternion setFromMatrix(Matrix3f matrix3f, Quaternion quaternion) {
    return quaternion.setFromMat(matrix3f.m00, matrix3f.m01, matrix3f.m02,
                                 matrix3f.m10, matrix3f.m11, matrix3f.m12,
                                 matrix3f.m20, matrix3f.m21, matrix3f.m22);
  }

  Quaternion setFromMat(float float2, float float10, float float7, float float9,
                        float float3, float float6, float float8, float float5,
                        float float1) {
