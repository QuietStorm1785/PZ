...
public
  Matrix3f() { this.setIdentity(); }

  Matrix3f load(Matrix3f matrix3f0) { return load(); }
  ...
  static Matrix3f add(Matrix3f matrix3f2, Matrix3f matrix3f1,
                      Matrix3f matrix3f0) {
    if (matrix3f0 == nullptr) {
      matrix3f0 = std::make_unique<Matrix3f>();
    }
  ...
  static Matrix3f sub(Matrix3f matrix3f2, Matrix3f matrix3f1,
                      Matrix3f matrix3f0) {
    if (matrix3f0 == nullptr) {
      matrix3f0 = std::make_unique<Matrix3f>();
    }
  ...
  static Matrix3f mul(Matrix3f matrix3f2, Matrix3f matrix3f1,
                      Matrix3f matrix3f0) {
    if (matrix3f0 == nullptr) {
      matrix3f0 = std::make_unique<Matrix3f>();
    }
    ...
    float float1 = matrix3f2.m01 * matrix3f1.m00 +
                   matrix3f2.m11 * matrix3f1.m01 +
                   matrix3f2.m21 * matrix3f1.m02;
    float float2 = matrix3f2.m02 * matrix3f1.m00 +
                   matrix3f2.m12 * matrix3f1.m01 +
                   matrix3f2.m22 * matrix3f1.m02;
    float float3 = matrix3f2.m00 * matrix3f1.m10 +
    ...
    float float5 = matrix3f2.m02 * matrix3f1.m10 +
                   matrix3f2.m12 * matrix3f1.m11 +
                   matrix3f2.m22 * matrix3f1.m12;
    float float6 = matrix3f2.m00 * matrix3f1.m20 +
                   matrix3f2.m10 * matrix3f1.m21 +
                   matrix3f2.m20 * matrix3f1.m22;
    float float7 = matrix3f2.m01 * matrix3f1.m20 +
  ...
  static Vector3f transform(Matrix3f matrix3f, Vector3f vector3f1,
                            Vector3f vector3f0) {
    if (vector3f0 == nullptr) {
      vector3f0 = std::make_unique<Vector3f>();
    }

    float float0 = matrix3f.m00 * vector3f1.x + matrix3f.m10 * vector3f1.y +
                   matrix3f.m20 * vector3f1.z;
    float float1 = matrix3f.m01 * vector3f1.x + matrix3f.m11 * vector3f1.y +
                   matrix3f.m21 * vector3f1.z;
    float float2 = matrix3f.m02 * vector3f1.x + matrix3f.m12 * vector3f1.y +
                   matrix3f.m22 * vector3f1.z;
    vector3f0.x = float0;
    vector3f0.y = float1;
    vector3f0.z = float2;
    return vector3f0;
  ...
  Matrix transpose() { return transpose(); }

  Matrix3f transpose(Matrix3f matrix3f1) { return transpose(); }
  ...
  static Matrix3f invert(Matrix3f matrix3f0, Matrix3f matrix3f1) {
    ...
    if (float0 != 0.0F) {
      ...
      float float2 =
          matrix3f0.m11 * matrix3f0.m22 - matrix3f0.m12 * matrix3f0.m21;
      float float3 =
          -matrix3f0.m10 * matrix3f0.m22 + matrix3f0.m12 * matrix3f0.m20;
      float float4 =
          matrix3f0.m10 * matrix3f0.m21 - matrix3f0.m11 * matrix3f0.m20;
      float float5 =
          -matrix3f0.m01 * matrix3f0.m22 + matrix3f0.m02 * matrix3f0.m21;
      float float6 =
          matrix3f0.m00 * matrix3f0.m22 - matrix3f0.m02 * matrix3f0.m20;
      float float7 =
          -matrix3f0.m00 * matrix3f0.m21 + matrix3f0.m01 * matrix3f0.m20;
      float float8 =
          matrix3f0.m01 * matrix3f0.m12 - matrix3f0.m02 * matrix3f0.m11;
      float float9 =
          -matrix3f0.m00 * matrix3f0.m12 + matrix3f0.m02 * matrix3f0.m10;
      float float10 =
          matrix3f0.m00 * matrix3f0.m11 - matrix3f0.m01 * matrix3f0.m10;
  ...
  Matrix3f negate(Matrix3f matrix3f1) { return negate(); }
