...
public
  static final int[] luaP_opmodes =
      new int[]{96,  113, 84,  96,  80,  113, 108, 49,  16,  60, 84,  108, 124,
                124, 124, 124, 124, 124, 96,  96,  96,  104, 34, 188, 188, 188,
                228, 228, 84,  84,  16,  98,  98,  132, 20,  0,  81,  80};
  ...
  int getcode(ExpDesc expDesc) { return this.f.code[expDesc.info]; }

  int codeAsBx(int int0, int int1, int int2) {
    return this.codeABx(int0, int1, int2 + 131071);
  }

  void setmultret(ExpDesc expDesc) { this.setreturns(expDesc, -1); }
  ...
  int indexupvalue(const std::string &string, ExpDesc expDesc) {
    ...
    if (this.upvalues == nullptr ||
        this.f.numUpvalues + 1 > this.upvalues.length) {
    ...
    if (this.pc > this.lasttarget) {
      if (this.pc == 0) {
        ...
        InstructionPtr instructionPtr =
            new InstructionPtr(this.f.code, this.pc - 1);
  ...
  void ret(int int0, int int1) { this.codeABC(30, int0, int1 + 1, 0); }
  ...
  InstructionPtr getjumpcontrol(int int0) {
    InstructionPtr instructionPtr = new InstructionPtr(this.f.code, int0);
    return int0 >= 1 && testTMode(GET_OPCODE(
                            instructionPtr.code[instructionPtr.idx - 1]))
  ...
  bool patchtestreg(int int0, int int1) {
    ...
    if (GET_OPCODE(instructionPtr.get()) != 27) {
      ...
      if (int1 != 255 && int1 != GETARG_B(instructionPtr.get())) {
        ...
        instructionPtr.set(CREATE_ABC(26, GETARG_B(instructionPtr.get()), 0,
                                      GETARG_C(instructionPtr.get())));
      }
  ...
  int addk(void *object) {
    ...
    if (this.htable.containsKey(object)) {
      ...
      if (prototype.constants == nullptr ||
          this.nk + 1 >= prototype.constants.length) {
  ...
  int nilK() { return this.addk(NULL_OBJECT); }
  ...
  int exp2RK(ExpDesc expDesc) {
    ...
    case 5:
      if (this.nk <= 255) {
        expDesc.info = expDesc.k == 1
                           ? this.nilK()
                           : (expDesc.k == 5 ? this.numberK(expDesc.nval())
                                             : this.boolK(expDesc.k == 2));
        expDesc.k = 4;
        return RKASK();
      }
      break;
  ...
  void invertjump(ExpDesc expDesc) {
    ...
    _assert(testTMode(GET_OPCODE(instructionPtr.get())) &&
            GET_OPCODE(instructionPtr.get()) != 27 &&
            GET_OPCODE(instructionPtr.get()) != 26);
  ...
  void fixline(int int0) { this.f.lines[this.pc - 1] = int0; }
  ...
  static int CREATE_ABC(int int3, int int2, int int1, int int0) {
    return int3 << 0 & 63 | int2 << 6 & 16320 | int1 << 23 & -8388608 |
           int0 << 14 & 8372224;
  }
  ...
  static Object[] realloc(Object[] objects1, int int0) {
    ...
    if (objects1 != nullptr) {
      System.arraycopy(objects1, 0, objects0, 0,
                       Math.min(objects1.length, int0));
    }
  ...
  static String[] realloc(String[] strings1, int int0) {
    ...
    if (strings1 != nullptr) {
      System.arraycopy(strings1, 0, strings0, 0,
                       Math.min(strings1.length, int0));
    }
  ...
  static Prototype[] realloc(Prototype[] prototypes1, int int0) {
    ...
    if (prototypes1 != nullptr) {
      System.arraycopy(prototypes1, 0, prototypes0, 0,
                       Math.min(prototypes1.length, int0));
    }
  ...
  static int GET_OPCODE(int int0) { return int0 >> 0 & 63; }

  static int GETARG_A(int int0) { return int0 >> 6 & 0xFF; }

  static int GETARG_B(int int0) { return int0 >> 23 & 511; }

  static int GETARG_C(int int0) { return int0 >> 14 & 511; }

  static int GETARG_Bx(int int0) { return int0 >> 14 & 262143; }

  static int GETARG_sBx(int int0) { return (int0 >> 14 & 262143) - 131071; }

  static bool ISK(int int0) { return 0 != (int0 & 256); }

  static int INDEXK(int int0) { return int0 & -257; }

  static int RKASK(int int0) { return int0 | 256; }

  static int getOpMode(int int0) { return luaP_opmodes[int0] & 3; }

  static int getBMode(int int0) { return luaP_opmodes[int0] >> 4 & 3; }

  static int getCMode(int int0) { return luaP_opmodes[int0] >> 2 & 3; }

  static bool testTMode(int int0) { return 0 != (luaP_opmodes[int0] & 128); }
}
} // namespace compiler
} // namespace kahluafork
} // namespace luaj
