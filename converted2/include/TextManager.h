...
public:
{
    ...
    public void DrawString(int x, int y, std::string str)
    {
        font.drawString(x, y, str, new Color(255, 255, 255, 255));
    }
    public void DrawString(int x, int y, std::string str, float r, float g, float b, float a)
    {
        font.drawString(x, y, str, new Color(r, g, b, a));
    }
    public void DrawString(UIFont font, int x, int y, std::string str, float r, float g, float b, 
            float a)
    {
    ...
    public void DrawStringCentre(int x, int y, std::string str, float r, float g, float b, float a)
    {
        x -= font.getWidth(str) / 2;
        font.drawString(x, y, str, new Color(r, g, b, a));
    }
    public void DrawStringCentre(UIFont font, int x, int y, std::string str, float r, float g, float b, 
            float a)
    {
        AngelCodeFont toUse = this.font;
        if(font == UIFont.Medium)
    ...
    public void DrawStringRight(int x, int y, std::string str, float r, float g, float b, float a)
    {
        x -= font.getWidth(str);
        font.drawString(x, y, str, new Color(r, g, b, a));
    }
    public void DrawStringRight(UIFont font, int x, int y, std::string str, float r, float g, float b, 
            float a)
    {
        AngelCodeFont toUse = this.font;
        if(font == UIFont.Medium)
    ...
    public int MeasureStringX(UIFont font, std::string str)
    {
    ...
    public int MeasureStringY(UIFont font, std::string str)
    {
        if(font == UIFont.Small)
