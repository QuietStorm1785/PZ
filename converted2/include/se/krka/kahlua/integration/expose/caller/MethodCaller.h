...
public
  MethodCaller(Method methodx, void *object, bool boolean0) {
    ...
    methodx.setAccessible(true);
        ...
        if (this.hasReturnValue && this.needsMultipleReturnValues()) {
          throw new IllegalArgumentException(
              "Must have a void return type if first argument is a "
              "ReturnValues: got: " +
              methodx.getReturnType());
        }
  }
  ...
  bool hasSelf() { return this.hasSelf; }
  ...
  bool equals(void *object) {
    ...
    return false;
        ...
        return this.owner != nullptr ? this.owner ==
                                           methodCaller1.owner)
            : methodCaller1.owner == nullptr;
      }
    } else {
      return false;
    }
