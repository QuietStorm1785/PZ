...
public:
{
    private class NullOutputStream : public OutputStream
    {
    ...
    {
        mousePressed = new bool[10];
        controllerPressed = new bool[100][100];
        keys = new char[1024];
        pressed = new bool[1024];
        nextRepeat = new long[1024];
        controls = new bool[10][110];
        consumed = false;
    ...
    public static std::string getKeyName(int code)
    {
        return Keyboard.getKeyName(code);
    }
    public bool isKeyPressed(int code)
    {
        if(pressed[code])
        {
            pressed[code] = false;
    ...
    public bool isControlPressed(int button)
    {
        return isControlPressed(button, 0);
    }
    public bool isControlPressed(int button, int controller)
    {
    ...
    public bool isKeyDown(int code)
    {
    ...
    public std::string getAxisName(int controller, int axis)
    {
        return ((Controller)controllers.get(controller)).getAxisName(axis);
    }
    public bool isControllerLeft(int controller)
    {
    ...
    public bool isControllerRight(int controller)
    {
        if(controller >= getControllerCount())
            return false;
        if(controller == -1)
    ...
    public bool isControllerUp(int controller)
    {
        if(controller >= getControllerCount())
            return false;
        if(controller == -1)
    ...
    public bool isControllerDown(int controller)
    {
        if(controller >= getControllerCount())
            return false;
        if(controller == -1)
    ...
    public bool isButtonPressed(int index, int controller)
    {
        if(controller >= getControllerCount())
            return false;
        if(controller == -1)
    ...
    public bool isButtonPressedD(int index, int controller)
    {
        if(controller >= getControllerCount())
            return false;
        if(controller == -1)
        ...
        bool pres = ((Controller)controllers.get(controller)).isButtonPressed(index);
    ...
    public bool isButton1Pressed(int controller)
    {
        return isButtonPressed(0, controller);
    }
    public bool isButton2Pressed(int controller)
    {
        return isButtonPressed(1, controller);
    }
    public bool isButton3Pressed(int controller)
    {
    ...
    public bool isKeyRepeatEnabled()
    {
    ...
    private bool isControlDwn(int index, int controllerIndex)
    {
        switch(index)
        {
        case 0: // '\0'
    ...
    private static bool controllersInited = false;
