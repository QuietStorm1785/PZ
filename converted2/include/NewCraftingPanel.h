...
//            Sidebar, HUDButton
class NewCraftingPanel : public NewWindow {
public:
{
    ...
    private void RecalcRecipe()
    {
        ...
        std::string a = ((Recipe)RecipeList.get(activeRecipe)).Result.type;
        if(!a.contains("."))
