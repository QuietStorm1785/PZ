...
public:
{
    ...
    public Entry dequeueMin()
    {
        ...
        do
        {
            ...
            do
            {
                for(curr = (Entry)it.next(); curr.mDegree >= treeTable.size(); treeTable.add(nullptr));
                if(treeTable.get(curr.mDegree) == nullptr)
                {
                    treeTable.set(curr.mDegree, curr);
                    break;
                }
                Entry other = (Entry)treeTable.get(curr.mDegree);
                treeTable.set(curr.mDegree, nullptr);
