...
//            UIManager, UIFont
class QuestHUD : public UIElement {
public:
...
label0:
        {
            ...
            super.render();
            Iterator i$;
            if(QuestPanel.instance.ActiveQuest == nullptr || QuestPanel.instance.ActiveQuest.Failed || QuestPanel.instance.ActiveQuest.Complete)
            {
            ...
            if(QuestPanel.instance.ActiveQuest == nullptr)
                break label0;
