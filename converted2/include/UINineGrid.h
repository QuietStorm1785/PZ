...
public:
{
    public UINineGrid(int x, int y, int width, int height, int TopWidth, int LeftWidth, int RightWidth, 
            int BottomWidth, std::string TL_Tex, std::string T_Tex, std::string TR_Tex, std::string L_Tex, std::string C_Tex, std::string R_Tex, 
            std::string BL_Tex, std::string B_Tex, std::string BR_Tex)
    {
        alpha = 1.0F;
        GridTopLeft = nullptr;
        GridTop = nullptr;
        GridTopRight = nullptr;
        GridLeft = nullptr;
        GridCenter = nullptr;
        GridRight = nullptr;
        GridBottomLeft = nullptr;
        GridBottom = nullptr;
        GridBottomRight = nullptr;
        this.TopWidth = 10;
        this.LeftWidth = 10;
        this.RightWidth = 10;
        this.BottomWidth = 10;
