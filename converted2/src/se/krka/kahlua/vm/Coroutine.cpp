...
public
Coroutine::Coroutine(Platform arg0, KahluaTable arg1, KahluaThread arg2) {
  // TODO: Implement Coroutine
  return nullptr;
}

public
Coroutine::Coroutine(Platform arg0, KahluaTable arg1) {
  // TODO: Implement Coroutine
  return nullptr;
}

LuaCallFrame Coroutine::pushNewCallFrame(LuaClosure arg0, JavaFunction arg1,
