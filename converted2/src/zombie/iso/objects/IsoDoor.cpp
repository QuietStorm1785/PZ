...
void IsoDoor::render(float x, float y, float z, ColorInfo info,
                     bool bDoAttached, bool bWallLightingPass, Shader shader) {
...
void IsoDoor::prerender(float float0, float float1, float float2,
                        ColorInfo colorInfo, bool boolean0, bool boolean1,
                        IsoDirections directions) {
  // TODO: Implement prerender
}

void IsoDoor::postrender(float float0, float float1, float float2,
                         ColorInfo colorInfo, bool boolean0, bool boolean1,
                         IsoDirections directions) {
  // TODO: Implement postrender
}

void IsoDoor::prerender1xN(float float0, float float2, float float1,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender1xN
}

void IsoDoor::postrender1xN(float float0, float float1, float float2,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender1xN
}

void IsoDoor::prerender1xS(float float0, float float1, float float2,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender1xS
}

void IsoDoor::postrender1xS(float float0, float float2, float float1,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender1xS
}

void IsoDoor::prerender1xW(float float2, float float0, float float1,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender1xW
}

void IsoDoor::postrender1xW(float float0, float float1, float float2,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender1xW
}

void IsoDoor::prerender1xE(float float0, float float1, float float2,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender1xE
}

void IsoDoor::postrender1xE(float float2, float float0, float float1,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender1xE
}

void IsoDoor::prerender2xN(float float0, float float2, float float1,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender2xN
}

void IsoDoor::postrender2xN(float float0, float float1, float float2,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender2xN
}

void IsoDoor::prerender2xS(float float0, float float1, float float2,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender2xS
}

void IsoDoor::postrender2xS(float float0, float float2, float float1,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender2xS
}

void IsoDoor::prerender2xW(float float2, float float0, float float1,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender2xW
}

void IsoDoor::postrender2xW(float float0, float float1, float float2,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
  // TODO: Implement postrender2xW
}

void IsoDoor::prerender2xE(float float0, float float1, float float2,
                           ColorInfo colorInfo, bool var5, bool var6,
                           Shader var7) {
  // TODO: Implement prerender2xE
}

void IsoDoor::postrender2xE(float float2, float float0, float float1,
                            ColorInfo colorInfo, bool var5, bool var6,
                            Shader var7) {
...
public
IsoDoor::IsoDoor(IsoCell cell, IsoGridSquare gridSquare, IsoSprite _gid,
                 bool _north) {
  // TODO: Implement IsoDoor
  return nullptr;
}
...
public
IsoDoor::IsoDoor(IsoCell cell, IsoGridSquare gridSquare,
                 const std::string &_gid, bool _north) {
  // TODO: Implement IsoDoor
  return nullptr;
}
...
public
IsoDoor::IsoDoor(IsoCell cell, IsoGridSquare gridSquare,
                 const std::string &_gid, bool _north, KahluaTable _table) {
  // TODO: Implement IsoDoor
  return nullptr;
}
...
bool IsoDoor::TestPathfindCollide(IsoMovingObject obj, IsoGridSquare from,
                                  IsoGridSquare to) {
  // TODO: Implement TestPathfindCollide
  return false;
}

bool IsoDoor::TestCollide(IsoMovingObject obj, IsoGridSquare from,
                          IsoGridSquare to) {
...
void IsoDoor::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source,
                            ByteBuffer bb) {
...
void IsoDoor::saveChange(const std::string &change, KahluaTable tbl,
                         ByteBuffer bb) {
...
bool IsoDoor::hasSomething4x4(int int0, int int1, int int3, int int4,
                              int int2) {
...
void IsoDoor::playDoorSound(BaseCharacterSoundEmitter baseCharacterSoundEmitter,
