...
public
IsoMannequin::IsoMannequin(IsoCell cell) {
  // TODO: Implement IsoMannequin
  return nullptr;
}

public
IsoMannequin::IsoMannequin(IsoCell cell, IsoGridSquare square,
                           IsoSprite sprite) {
  // TODO: Implement IsoMannequin
  return nullptr;
}
...
bool IsoMannequin::isItemAllowedInContainer(ItemContainer container,
                                            InventoryItem item) {
...
void IsoMannequin::saveChange(const std::string &change, KahluaTable tbl,
                              ByteBuffer bb) {
...
void IsoMannequin::load(ByteBuffer input, int WorldVersion,
                        bool IS_DEBUG_SAVE) {
  // TODO: Implement load
}
...
void IsoMannequin::render(float x, float y, float z, ColorInfo col,
...
void IsoMannequin::renderMoveableItem(Moveable item, int x, int y, int z,
                                      IsoDirections dir) {
  // TODO: Implement renderMoveableItem
}

void IsoMannequin::renderMoveableObject(IsoMannequin mannequin, int x, int y,
                                        int z, IsoDirections dir) {
  // TODO: Implement renderMoveableObject
}

IsoDirections IsoMannequin::getDirectionFromItem(Moveable item,
                                                 int playerIndex) {
...
public
IsoMannequin::MannequinZone(const std::string &string0,
                            const std::string &string1, int int0, int int1,
                            int int2, int int3, int int4, KahluaTable table) {
  // TODO: Implement MannequinZone
  return nullptr;
}

void IsoMannequin::renderMoveableItem(Moveable moveable, int int0, int int1,
                                      int int2, IsoDirections directions) {
  // TODO: Implement renderMoveableItem
}
