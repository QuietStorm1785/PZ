...
public
IsoFireplace::IsoFireplace(IsoCell cell) {
  // TODO: Implement IsoFireplace
  return nullptr;
}

public
IsoFireplace::IsoFireplace(IsoCell cell, IsoGridSquare sq, IsoSprite gid) {
  // TODO: Implement IsoFireplace
  return nullptr;
}
...
void IsoFireplace::load(ByteBuffer input, int WorldVersion,
                        bool IS_DEBUG_SAVE) {
  // TODO: Implement load
}
...
void IsoFireplace::render(float x, float y, float z, ColorInfo col,
                          bool bDoChild, bool bWallLightingPass,
                          Shader shader) {
  // TODO: Implement render
}

void IsoFireplace::saveChange(const std::string &change, KahluaTable tbl,
                              ByteBuffer bb) {
