...
public
IsoBuilding::IsoBuilding(IsoCell cell) {
  // TODO: Implement IsoBuilding
  return nullptr;
}
...
float IsoBuilding::ScoreBuildingPersonSpecific(SurvivorDesc desc,
                                               bool bFarGood) {
...
void IsoBuilding::addWindow(IsoWindow obj, bool bOtherTile, IsoGridSquare from,
...
void IsoBuilding::addDoor(IsoDoor obj, bool bOtherTile, IsoGridSquare from,
                          IsoBuilding building) {
