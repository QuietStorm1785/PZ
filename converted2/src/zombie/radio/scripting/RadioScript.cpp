...
public
RadioScript::RadioScript(const std::string &n, int loopmin, int loopmax) {
...
void RadioScript::AddExitOption(const std::string &scriptname, int chance,
                                int startdelay) {
...
public
RadioScript::ExitOption(const std::string &name, int rollchance,
                        int startdelay) {
