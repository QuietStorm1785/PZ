...
void AnimatedModel::setOutfitName(const std::string &name, bool female,
                                  bool zombie) {
...
void AnimatedModel::setAttachedModelNames(
    AttachedModelNames _attachedModelNames) {
  // TODO: Implement setAttachedModelNames
}

void AnimatedModel::setModelData(HumanVisual _baseVisual,
...
void AnimatedModel::setLights(IsoGridSquare.ResultLight[] resultLights,
...
void AnimatedModel::addHeadHairItem(const std::string &string0,
                                    const std::string &string1,
                                    ImmutableColor immutableColor) {
  // TODO: Implement addHeadHairItem
}

void AnimatedModel::addClothingItem(ItemVisual itemVisual,
                                    ClothingItem clothingItem) {
  // TODO: Implement addClothingItem
}

bool AnimatedModel::isItemModelHidden(ItemVisuals itemVisualsx,
...
void AnimatedModel::postProcessNewItemInstance(ModelInstance modelInstance1,
...
ModelInstance AnimatedModel::addStatic(const std::string &string1,
                                       const std::string &string4) {
  // TODO: Implement addStatic
  return nullptr;
}

ModelInstance AnimatedModel::addStatic(const std::string &string0,
                                       const std::string &string1,
...
void AnimatedModel::doneWithTextureCreator(
    ModelInstanceTextureCreator modelInstanceTextureCreator) {
  // TODO: Implement doneWithTextureCreator
}

void AnimatedModel::release(
    ArrayList<AnimatedModel.AnimatedModelInstanceRenderData> arrayList) {
...
void AnimatedModel::DoRender(int x, int y, int w, int h, float sizeV,
                             float animPlayerAngle) {
  // TODO: Implement DoRender
}

void AnimatedModel::DoRenderToWorld(float x, float y, float z,
                                    float animPlayerAngle) {
...
void AnimatedModel::DrawChar(AnimatedModel.AnimatedModelInstanceRenderData
