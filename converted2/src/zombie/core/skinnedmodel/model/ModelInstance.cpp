...
ModelInstance ModelInstance::init(Model _model, IsoGameCharacter _character,
...
Matrix4f ModelInstance::getAttachmentMatrix(ModelAttachment attachment,
                                            Matrix4f out) {
...
Matrix4f ModelInstance::getAttachmentMatrixById(const std::string &id,
                                                Matrix4f out) {
...
void ModelInstance::setTextureInitializer(
...
void ModelInstance::set(float _x, float _y, float _z, float _r, float _g,
