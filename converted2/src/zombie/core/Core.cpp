...
void Core::TakeScreenshot(int x, int y, int _width, int _height,
                          int readBuffer) {
  // TODO: Implement TakeScreenshot
}
...
void Core::DoStartFrameStuffInternal(int int2, int int3, float float0, int int4,
                                     bool boolean2, bool boolean0,
                                     bool boolean1) {
  // TODO: Implement DoStartFrameStuffInternal
}

void Core::DoPushIsoStuff(float ox, float oy, float oz, float useangle,
                          bool vehicle) {
...
void Core::DelayResetLua(const std::string &activeMods,
