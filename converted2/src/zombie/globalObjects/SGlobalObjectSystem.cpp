...
public
SGlobalObjectSystem::SGlobalObjectSystem(const std::string &name) {
...
void SGlobalObjectSystem::sendCommand(const std::string &command,
                                      KahluaTable args) {
  // TODO: Implement sendCommand
}

void SGlobalObjectSystem::receiveClientCommand(const std::string &command,
                                               IsoPlayer playerObj,
                                               KahluaTable args) {
...
void SGlobalObjectSystem::removeGlobalObjectOnClient(
    SGlobalObject globalObject) {
  // TODO: Implement removeGlobalObjectOnClient
}

void SGlobalObjectSystem::updateGlobalObjectOnClient(
    SGlobalObject globalObject) {
