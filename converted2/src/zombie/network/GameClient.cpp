...
void GameClient::mainLoopHandlePacketInternal(ZomboidNetData zomboidNetData,
...
void GameClient::receivePlayerDamageFromCarCrash(ByteBuffer byteBuffer,
                                                 short var1) {
...
void GameClient::invMngRequestItem(int itemId, const std::string &itemType,
                                   IsoPlayer player) {
...
void GameClient::receivePlaySoundEveryPlayer(ByteBuffer byteBuffer,
                                             short var1) {
...
void GameClient::sendAddXp(IsoPlayer otherPlayer, PerkFactory.Perk perk,
                           int amount) {
...
void GameClient::receiveWorldMapPlayerPosition(ByteBuffer byteBuffer,
                                               short var1) {
...
void GameClient::receiveRemoveContestedItemsFromInventory(ByteBuffer byteBuffer,
                                                          short var1) {
...
void GameClient::receiveRemoveItemFromSquare(ByteBuffer byteBuffer,
                                             short var1) {
...
void GameClient::receiveRemoveInventoryItemFromContainer(ByteBuffer byteBuffer,
                                                         short var1) {
  // TODO: Implement receiveRemoveInventoryItemFromContainer
}

void GameClient::receiveAddInventoryItemToContainer(ByteBuffer byteBuffer,
                                                    short var1) {
...
void GameClient::sendWeaponHit(IsoPlayer player, HandWeapon weapon,
                               IsoObject object) {
  // TODO: Implement sendWeaponHit
}

void GameClient::receiveSyncCustomLightSettings(ByteBuffer bb,
                                                short packetType) {
...
void GameClient::convertGameSaveWorldDirectory(const std::string &string0,
                                               const std::string &string1) {
  // TODO: Implement convertGameSaveWorldDirectory
}

void GameClient::doConnect(const std::string &string0,
                           const std::string &string1,
...
void GameClient::sendWorldSound(void *source, int x, int y, int z, int radius,
                                int volume, bool stressHumans,
...
void GameClient::sendClientCommand(IsoPlayer player, const std::string &module,
                                   const std::string &command,
                                   KahluaTable args) {
  // TODO: Implement sendClientCommand
}

void GameClient::sendClientCommandV(IsoPlayer player, const std::string &module,
                                    const std::string &command,
                                    Object... objects) {
  // TODO: Implement sendClientCommandV
}

void GameClient::sendClothing(IsoPlayer player, const std::string &location,
                              InventoryItem item) {
...
void GameClient::sendAttachedItem(IsoPlayer player, const std::string &location,
                                  InventoryItem item) {
...
void GameClient::sendBandage(int onlineID, int i, bool bandaged,
                             float bandageLife, bool isAlcoholic,
                             const std::string &bandageType) {
  // TODO: Implement sendBandage
}

void GameClient::sendStitch(IsoGameCharacter wielder, IsoGameCharacter target,
...
void GameClient::sendDisinfect(IsoGameCharacter wielder,
                               IsoGameCharacter target, BodyPart bodyPart,
                               InventoryItem alcohol) {
  // TODO: Implement sendDisinfect
}

void GameClient::sendSplint(int onlineID, int i, bool doIt, float factor,
...
void GameClient::sendRemoveGlass(IsoGameCharacter wielder,
                                 IsoGameCharacter target, BodyPart bodyPart,
                                 bool handPain) {
  // TODO: Implement sendRemoveGlass
}

void GameClient::sendRemoveBullet(IsoGameCharacter wielder,
                                  IsoGameCharacter target, BodyPart bodyPart) {
  // TODO: Implement sendRemoveBullet
}

void GameClient::sendCleanBurn(IsoGameCharacter _wielder,
                               IsoGameCharacter _target, BodyPart bodyPart,
                               InventoryItem _bandage) {
...
void GameClient::addToItemSendBuffer(IsoObject parent, ItemContainer container,
                                     InventoryItem item) {
  // TODO: Implement addToItemSendBuffer
}

void GameClient::addToItemRemoveSendBuffer(IsoObject parent,
...
void GameClient::writeItemStats(ByteBufferWriter byteBufferWriter,
                                InventoryItem item) {
...
void GameClient::PlayWorldSound(const std::string &name, int x, int y,
                                uint8_t z) {
  // TODO: Implement PlayWorldSound
}

void GameClient::PlaySound(const std::string &name, bool loop,
                           IsoMovingObject object) {
  // TODO: Implement PlaySound
}

void GameClient::StopSound(IsoMovingObject object, const std::string &soundName,
                           bool trigger) {
...
void GameClient::receiveVehicleAuthorization(ByteBuffer byteBuffer,
                                             short var1) {
...
void GameClient::sendCataplasm(int onlineID, int i, float plantainFactor,
...
void GameClient::sendPlayerListensChannel(int channel, bool listenmode,
                                          bool isTV) {
...
void GameClient::addUserlog(const std::string &user, const std::string &type,
                            const std::string &text) {
  // TODO: Implement addUserlog
}

void GameClient::removeUserlog(const std::string &user, const std::string &type,
                               const std::string &text) {
  // TODO: Implement removeUserlog
}

void GameClient::addWarningPoint(const std::string &user,
...
void GameClient::getTableResult(const std::string &tableName,
                                int numberPerPages) {
...
void GameClient::sendFactionInvite(Faction faction, IsoPlayer host,
...
void GameClient::receiveAcceptedFactionInvite(ByteBuffer byteBuffer,
                                              short var1) {
  // TODO: Implement receiveAcceptedFactionInvite
}

void GameClient::addTicket(const std::string &author,
...
bool GameClient::sendItemListNet(IsoPlayer sender,
...
void GameClient::tradingUISendAddItem(IsoPlayer you, IsoPlayer other,
                                      InventoryItem item) {
...
void GameClient::tradingUISendRemoveItem(IsoPlayer you, IsoPlayer other,
                                         int index) {
...
void GameClient::tradingUISendUpdateState(IsoPlayer you, IsoPlayer other,
                                          int state) {
  // TODO: Implement tradingUISendUpdateState
}

void GameClient::receiveTradingUIUpdateState(ByteBuffer byteBuffer,
                                             short var1) {
...
int GameClient::sendInventoryPutItems(ByteBufferWriter byteBufferWriter,
                                      InventoryItem > linkedHashMap0,
                                      long long0) {
...
void GameClient::receiveClimateManagerPacket(ByteBuffer byteBuffer,
                                             short var1) {
...
void GameClient::receiveIsoRegionServerPacket(ByteBuffer byteBuffer,
                                              short var1) {
...
void GameClient::sendZombieHelmetFall(IsoPlayer player, IsoGameCharacter zombie,
                                      InventoryItem item) {
...
void GameClient::sendSafehouseInvite(SafeHouse safehouse, IsoPlayer host,
                                     const std::string &invited) {
...
void GameClient::acceptSafehouseInvite(SafeHouse safehouse,
                                       const std::string &host) {
  // TODO: Implement acceptSafehouseInvite
}

void GameClient::receiveAcceptedSafehouseInvite(ByteBuffer byteBuffer,
                                                short var1) {
...
void GameClient::receiveSyncEquippedRadioFreq(ByteBuffer byteBuffer,
                                              short var1) {
  // TODO: Implement receiveSyncEquippedRadioFreq
}

void GameClient::sendSneezingCoughing(short playerId, int sneezingCoughing,
                                      uint8_t sneezeVar) {
...
void GameClient::rememberPlayerPosition(IsoPlayer player, float float0,
                                        float float1) {
