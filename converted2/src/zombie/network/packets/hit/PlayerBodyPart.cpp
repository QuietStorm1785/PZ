...
void PlayerBodyPart::set(BodyPart bodyPartx) {
  // TODO: Implement set
}

void PlayerBodyPart::parse(ByteBuffer byteBuffer, IsoGameCharacter character) {
...
void PlayerBodyPart::write(ByteBufferWriter byteBufferWriter) {
