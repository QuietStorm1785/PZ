...
void NetworkAIParams::setShowConnectionInfo(bool enabled) {
...
void NetworkAIParams::setShowServerInfo(bool enabled) {
...
void NetworkAIParams::setShowPingInfo(bool enabled) {
