...
void ChatServer::sendPlayerNotFoundMessage(UdpConnection udpConnection,
...
void ChatServer::syncFactionChatMembers(const std::string &string0,
                                        const std::string &string1,
                                        ArrayList<String> arrayList0) {
  // TODO: Implement syncFactionChatMembers
}

void ChatServer::syncSafehouseChatMembers(const std::string &string0,
                                          const std::string &string1,
                                          ArrayList<String> arrayList0) {
  // TODO: Implement syncSafehouseChatMembers
}

void ChatServer::addMemberToSafehouseChat(const std::string &string,
                                          short short0) {
  // TODO: Implement addMemberToSafehouseChat
}

void ChatServer::addMemberToFactionChat(const std::string &string,
                                        short short0) {
  // TODO: Implement addMemberToFactionChat
}

void ChatServer::sendServerAlertMessageToServerChat(
...
ChatMessage ChatServer::createRadiostationMessage(const std::string &string,
                                                  int int0) {
  // TODO: Implement createRadiostationMessage
  return nullptr;
}

void ChatServer::sendMessageToServerChat(UdpConnection udpConnection,
                                         const std::string &string) {
...
void ChatServer::sendMessageFromDiscordToGeneralChat(
