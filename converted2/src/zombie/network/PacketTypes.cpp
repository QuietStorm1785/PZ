...
void PacketTypes::call(ByteBuffer bb, UdpConnection connection,
                       short packetType) {
  // TODO: Implement call
}

void PacketTypes::unauthorizedPacketPolicyLogUser(UdpConnection udpConnection,
                                                  const std::string &string) {
  // TODO: Implement unauthorizedPacketPolicyLogUser
}

void PacketTypes::unauthorizedPacketPolicyKickUser(UdpConnection udpConnection,
                                                   const std::string &string) {
  // TODO: Implement unauthorizedPacketPolicyKickUser
}

void PacketTypes::unauthorizedPacketPolicyBanUser(UdpConnection udpConnection,
                                                  const std::string &string) {
  // TODO: Implement unauthorizedPacketPolicyBanUser
}

bool PacketTypes::isAuthorized(UdpConnection udpConnection,
...
private
PacketTypes::Policy(PacketTypes.PacketAuthorization
                        .UnauthorizedPacketPolicy unauthorizedPacketPolicy) {
  // TODO: Implement Policy
  return nullptr;
}

void PacketTypes::apply(UdpConnection udpConnection,
                        const std::string &string) {
