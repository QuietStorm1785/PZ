...
public
UIElement::UIElement(KahluaTable _table) {
  // TODO: Implement UIElement
  return nullptr;
}
...
void UIElement::DrawText(UIFont font, const std::string &text, double _x,
                         double _y, double zoom, double r, double g, double b,
                         double alpha) {
  // TODO: Implement DrawText
}

void UIElement::DrawText(const std::string &text, double _x, double _y,
                         double r, double g, double b, double alpha) {
  // TODO: Implement DrawText
}

void UIElement::DrawText(const std::string &text, double _x, double _y,
                         double _width, double _height, double r, double g,
...
void UIElement::DrawTextUntrimmed(UIFont font, const std::string &text,
                                  double _x, double _y, double r, double g,
                                  double b, double alpha) {
  // TODO: Implement DrawTextUntrimmed
}

void UIElement::DrawTextCentre(const std::string &text, double _x, double _y,
                               double r, double g, double b, double alpha) {
  // TODO: Implement DrawTextCentre
}

void UIElement::DrawTextCentre(UIFont font, const std::string &text, double _x,
                               double _y, double r, double g, double b,
                               double alpha) {
  // TODO: Implement DrawTextCentre
}

void UIElement::DrawTextRight(const std::string &text, double _x, double _y,
                              double r, double g, double b, double alpha) {
  // TODO: Implement DrawTextRight
}

void UIElement::DrawTextRight(UIFont font, const std::string &text, double _x,
                              double _y, double r, double g, double b,
                              double alpha) {
  // TODO: Implement DrawTextRight
}

void UIElement::DrawTextureAngle(Texture tex, double centerX, double centerY,
                                 double angle, double r, double g, double b,
                                 double a) {
...
void UIElement::DrawTextureScaled(Texture tex, double _x, double _y,
                                  double _width, double _height, double alpha) {
  // TODO: Implement DrawTextureScaled
}

void UIElement::DrawTextureScaledUniform(Texture tex, double _x, double _y,
                                         double scale, double r, double g,
                                         double b, double alpha) {
  // TODO: Implement DrawTextureScaledUniform
}

void UIElement::DrawTextureScaledAspect(Texture tex, double _x, double _y,
                                        double _width, double _height, double r,
                                        double g, double b, double alpha) {
  // TODO: Implement DrawTextureScaledAspect
}

void UIElement::DrawTextureScaledAspect2(Texture tex, double _x, double _y,
...
void UIElement::DrawTextureScaledCol(Texture tex, double _x, double _y,
                                     double _width, double _height, double r,
...
void UIElement::DrawTextureScaledCol(Texture tex, double _x, double _y,
                                     double _width, double _height, Color col) {
  // TODO: Implement DrawTextureScaledCol
}

void UIElement::DrawTextureScaledColor(Texture tex, double _x, double _y,
                                       double _width, double _height, double r,
                                       double g, double b, double a) {
  // TODO: Implement DrawTextureScaledColor
}

void UIElement::DrawTextureColor(Texture tex, double _x, double _y, double r,
                                 double g, double b, double a) {
  // TODO: Implement DrawTextureColor
}

void UIElement::DrawTextureTiled(Texture tex, double _x, double _y, double w,
                                 double h, double r, double g, double b,
                                 double a) {
  // TODO: Implement DrawTextureTiled
}

void UIElement::DrawTextureTiledX(Texture tex, double _x, double _y, double w,
                                  double h, double r, double g, double b,
                                  double a) {
  // TODO: Implement DrawTextureTiledX
}

void UIElement::DrawTextureTiledY(Texture tex, double _x, double _y, double w,
                                  double h, double r, double g, double b,
                                  double a) {
  // TODO: Implement DrawTextureTiledY
}

void UIElement::DrawTextureIgnoreOffset(Texture tex, double _x, double _y,
                                        int _width, int _height, Color col) {
  // TODO: Implement DrawTextureIgnoreOffset
}

void UIElement::DrawTexture_FlippedX(Texture tex, double _x, double _y,
                                     int _width, int _height, Color col) {
  // TODO: Implement DrawTexture_FlippedX
}

void UIElement::DrawTexture_FlippedXIgnoreOffset(Texture tex, double _x,
                                                 double _y, int _width,
...
void UIElement::setStencilRect(double _x, double _y, double _width,
                               double _height) {
...
void UIElement::repaintStencilRect(double _x, double _y, double _width,
                                   double _height) {
