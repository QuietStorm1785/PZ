...
public
TextDrawObject::TextDrawObject(int r, int g, int b, bool _allowBBcode) {
  // TODO: Implement TextDrawObject
  return nullptr;
}
...
int TextDrawObject::readTag(char[] chars, int int0,
...
void TextDrawObject::ReadString(UIFont font, const std::string &str,
                                int maxLineWidth) {
  // TODO: Implement ReadString
}
...
void TextDrawObject::Draw(double x, double y, double r, double g, double b,
                          double a, bool drawOutlines) {
  // TODO: Implement Draw
}

void TextDrawObject::Draw(TextDrawHorizontal horz, double x, double y, double r,
...
void TextDrawObject::AddBatchedDraw(double x, double y, double r, double g,
                                    double b, double a, bool drawOutlines) {
  // TODO: Implement AddBatchedDraw
}

void TextDrawObject::AddBatchedDraw(TextDrawHorizontal horz, double x, double y,
...
void TextDrawObject::DrawRaw(TextDrawHorizontal horz, double x, double y,
