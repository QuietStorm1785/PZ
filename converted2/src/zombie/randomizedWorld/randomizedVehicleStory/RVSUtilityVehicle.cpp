...
void RVSUtilityVehicle::randomizeVehicleStory(IsoMetaGrid.Zone zone,
                                              IsoChunk chunk) {
  // TODO: Implement randomizeVehicleStory
}

bool RVSUtilityVehicle::initVehicleStorySpawner(IsoMetaGrid.Zone zone,
                                                IsoChunk chunk, bool debug) {
  // TODO: Implement initVehicleStorySpawner
  return false;
}

void RVSUtilityVehicle::spawnElement(VehicleStorySpawner spawner,
