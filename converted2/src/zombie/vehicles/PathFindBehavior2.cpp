...
public
PathFindBehavior2::PathFindBehavior2(IsoGameCharacter character) {
...
void PathFindBehavior2::pathToCharacter(IsoGameCharacter character) {
  // TODO: Implement pathToCharacter
}

void PathFindBehavior2::pathToLocation(int int2, int int1, int int0) {
  // TODO: Implement pathToLocation
}

void PathFindBehavior2::pathToLocationF(float float0, float float1,
                                        float float2) {
  // TODO: Implement pathToLocationF
}

void PathFindBehavior2::pathToSound(int int2, int int1, int int0) {
  // TODO: Implement pathToSound
}

void PathFindBehavior2::pathToNearest(TFloatArrayList tFloatArrayList) {
  // TODO: Implement pathToNearest
}

void PathFindBehavior2::pathToNearestTable(KahluaTable table) {
  // TODO: Implement pathToNearestTable
}

void PathFindBehavior2::pathToVehicleAdjacent(BaseVehicle vehicle) {
  // TODO: Implement pathToVehicleAdjacent
}

void PathFindBehavior2::pathToVehicleArea(BaseVehicle vehicle,
                                          const std::string &string) {
  // TODO: Implement pathToVehicleArea
}

void PathFindBehavior2::pathToVehicleSeat(BaseVehicle vehicle, int int0) {
...
void PathFindBehavior2::setData(float float0, float float1, float float2) {
...
bool PathFindBehavior2::isTargetLocation(float float2, float float1,
                                         float float0) {
...
void PathFindBehavior2::moveToPoint(float float1, float float0, float float3) {
  // TODO: Implement moveToPoint
}

void PathFindBehavior2::moveToDir(IsoMovingObject movingObject, float float1) {
  // TODO: Implement moveToDir
}

bool PathFindBehavior2::checkDoorHoppableWindow(float float2, float float1,
                                                float float0) {
  // TODO: Implement checkDoorHoppableWindow
  return false;
}

void PathFindBehavior2::checkCrawlingTransition(
    PolygonalMap2.PathNode pathNode0, PolygonalMap2.PathNode pathNode1,
    float float0) {
...
void PathFindBehavior2::advanceAlongPath(
...
void PathFindBehavior2::Succeeded(PolygonalMap2.Path pathx, Mover var2) {
