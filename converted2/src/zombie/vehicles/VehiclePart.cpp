...
public
VehiclePart::VehiclePart(BaseVehicle _vehicle) {
...
void VehiclePart::doInventoryItemStats(InventoryItem newItem,
                                       int mechanicSkill) {
...
void VehiclePart::setGeneralCondition(InventoryItem _item, float baseQuality,
...
void VehiclePart::setContainerContentAmount(float amount, bool force,
                                            bool noUpdateMass) {
  // TODO: Implement setContainerContentAmount
}
...
void VehiclePart::createSpotLight(float xOffset, float yOffset, float dist,
...
void VehiclePart::AddDeviceText(const std::string &line, float r, float g,
...
void VehiclePart::callLuaVoid(const std::string &string, void *object1,
                              void *object2) {
