...
public
IsoZombie::IsoZombie(IsoCell cell) {
  // TODO: Implement IsoZombie
  return nullptr;
}

public
IsoZombie::IsoZombie(IsoCell cell, SurvivorDesc desc, int _palette) {
  // TODO: Implement IsoZombie
  return nullptr;
}
...
float IsoZombie::Hit(HandWeapon weapon, IsoGameCharacter wielder,
                     float damageSplit, bool bIgnoreDamage, float modDelta,
                     bool _bRemote) {
  // TODO: Implement Hit
  return 0;
}
...
void IsoZombie::render(float x, float y, float z, ColorInfo col, bool bDoChild,
...
void IsoZombie::getZombieWalkTowardSpeed(float speed, float dist,
                                         Vector2 temp) {
...
float IsoZombie::Hit(BaseVehicle vehicle, float speed, bool isHitFromBehind,
                     Vector2 hitDir) {
  // TODO: Implement Hit
  return 0;
}
...
void IsoZombie::processHitDirection(HandWeapon weapon,
                                    IsoGameCharacter character) {
  // TODO: Implement processHitDirection
}

void IsoZombie::hitConsequences(HandWeapon weapon, IsoGameCharacter wielder,
...
void IsoZombie::setPlayerAttackPosition(
    const std::string &_playerAttackPosition) {
...
float IsoZombie::calcHitDir(IsoGameCharacter wielder, HandWeapon weapon,
                            Vector2 out) {
...
public
IsoZombie::Aggro(IsoMovingObject arg0, float arg1) {
...
private
IsoZombie::ZombieSound(int int1) {
