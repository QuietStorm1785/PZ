...
public
NetworkTeleport::NetworkTeleport(IsoGameCharacter chr,
                                 NetworkTeleport.Type type, float x, float y,
                                 uint8_t z, float _duration) {
...
bool NetworkTeleport::teleport(IsoGameCharacter chr, NetworkTeleport.Type type,
                               float x, float y, uint8_t z, float _duration) {
...
bool NetworkTeleport::teleport(IsoGameCharacter chr, PlayerPacket packet,
                               float _duration) {
  // TODO: Implement teleport
  return false;
}
