...
public CommentHeader::CommentHeader(BitInputStream var1) {
    // TODO: Implement CommentHeader
    return nullptr;
}

void CommentHeader::addComment(const std::string& var1, const std::string& var2) {
...
std::string CommentHeader::getComment(const std::string& var1) {
...
std::string CommentHeader::getString(BitInputStream var1) {
