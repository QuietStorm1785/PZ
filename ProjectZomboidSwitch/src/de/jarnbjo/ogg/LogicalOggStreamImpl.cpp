...
public LogicalOggStreamImpl::LogicalOggStreamImpl(PhysicalOggStream var1, int var2) {
    // TODO: Implement LogicalOggStreamImpl
    return nullptr;
}

void LogicalOggStreamImpl::addPageNumberMapping(int var1) {
    // TODO: Implement addPageNumberMapping
}

void LogicalOggStreamImpl::addGranulePosition(long var1) {
...
void LogicalOggStreamImpl::checkFormat(OggPage var1) {
