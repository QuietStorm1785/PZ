...
public RadioBroadCast::RadioBroadCast(const std::string& var1, int var2, int var3) {
...
void RadioBroadCast::resetLineCounter(bool var1) {
    // TODO: Implement resetLineCounter
}

void RadioBroadCast::setPreSegment(RadioBroadCast var1) {
    // TODO: Implement setPreSegment
}

void RadioBroadCast::setPostSegment(RadioBroadCast var1) {
...
RadioLine RadioBroadCast::getNextLine(bool var1) {
    // TODO: Implement getNextLine
    return nullptr;
}
...
void RadioBroadCast::setCurrentLineNumber(int var1) {
...
void RadioBroadCast::AddRadioLine(RadioLine var1) {
