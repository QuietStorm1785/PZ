...
public MediaData::MediaData(const std::string& var1, const std::string& var2, int var3) {
    // TODO: Implement MediaData
    return nullptr;
}

void MediaData::addLine(const std::string& var1, float var2, float var3, float var4, const std::string& var5) {
...
void MediaData::setTitle(const std::string& var1) {
...
void MediaData::setSubtitle(const std::string& var1) {
...
void MediaData::setAuthor(const std::string& var1) {
...
void MediaData::setExtra(const std::string& var1) {
...
void MediaData::setIndex(short var1) {
...
void MediaData::setCategory(const std::string& var1) {
...
MediaLineData MediaData::getLine(int var1) {
