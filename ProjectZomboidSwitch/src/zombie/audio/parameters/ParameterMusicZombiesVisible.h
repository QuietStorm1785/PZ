...
class ParameterMusicZombiesVisible : public zombie::audio::OpenALParameterStub {
public:
    int m_playerIndex = -1;
    ...
    IsoPlayer var1 = this.choosePlayer();
      return var1 != nullptr ? PZMath.clamp(var1.getStats().MusicZombiesVisible, 0, 50) : 0.0F;
   }
