...
public BooleanConfigOption::BooleanConfigOption(const std::string& var1, bool var2) {
...
void BooleanConfigOption::parse(const std::string& var1) {
...
void BooleanConfigOption::setValueFromObject(void* var1) {
...
bool BooleanConfigOption::isValidString(const std::string& var1) {
...
void BooleanConfigOption::setValue(bool var1) {
