...
public DoubleConfigOption::DoubleConfigOption(const std::string& var1, double var2, double var4, double var6) {
...
void DoubleConfigOption::parse(const std::string& var1) {
...
void DoubleConfigOption::setValueFromObject(void* var1) {
...
bool DoubleConfigOption::isValidString(const std::string& var1) {
    // TODO: Implement isValidString
    return false;
}

void DoubleConfigOption::setValue(double var1) {
