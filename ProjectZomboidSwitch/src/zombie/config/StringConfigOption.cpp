...
public StringConfigOption::StringConfigOption(const std::string& var1, const std::string& var2, int var3) {
...
void StringConfigOption::parse(const std::string& var1) {
...
void StringConfigOption::setValueFromObject(void* var1) {
...
bool StringConfigOption::isValidString(const std::string& var1) {
    // TODO: Implement isValidString
    return false;
}

void StringConfigOption::setValue(const std::string& var1) {
