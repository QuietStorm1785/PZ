...
public IntegerConfigOption::IntegerConfigOption(const std::string& var1, int var2, int var3, int var4) {
...
void IntegerConfigOption::parse(const std::string& var1) {
...
void IntegerConfigOption::setValueFromObject(void* var1) {
...
bool IntegerConfigOption::isValidString(const std::string& var1) {
    // TODO: Implement isValidString
    return false;
}

void IntegerConfigOption::setValue(int var1) {
