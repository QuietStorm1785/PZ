...
public:
    ...
    static Point newPoint(double var0, double var2) {
      if (s_firstPoint == nullptr) {
         return std::make_shared<Point>(var0, var2);
      } else {
    ...
    static void release(std::vector<Point> var0) {
      for (int var1 = 0; var1 < var0.size(); var1++) {
         release((Point)var0.get(var1));
      }
   }

   static std::vector<Point> getStrokeGeometry(Point[] var0, Attrs var1) {
      if (var0.length < 2) {
    return nullptr;
      } else {
    ...
    bool var8 = false;
         if (var0.length == 2) {
            ...
            for (int var9 = 0; var9 < var0.length - 1; var9++) {
               if (var9 == 0) {
                  var7.push_back(var0[0]);
               } else if (var9 == var0.length - 2) {
                  var7.push_back(var0[var0.length - 1]);
               } else {
                  var7.push_back(Point.Middle(var0[var9], var0[var9 + 1]));
               }
            }
    ...
    static void createSquareCap(Point var0, Point var1, Point var2, std::vector<Point> var3) {
      var3.push_back(var0);
      var3.push_back(Point.Add(var0, var2));
      var3.push_back(Point.Add(var1, var2));
      var3.push_back(var1);
      var3.push_back(Point.Add(var1, var2));
      var3.push_back(var0);
   }

    static void createRoundCap(Point var0, Point var1, Point var2, Point var3, std::vector<Point> var4) {
    ...
    double var16 = var13 / var19;
      ...
      for (int var18 = 0; var18 < var19; var18++) {
         var4.push_back(newPoint(var0.x, var0.y));
         var4.push_back(newPoint(var0.x + var5 * Math.cos(var11 + var16 * var18), var0.y + var5 * Math.sin(var11 + var16 * var18)));
         var4.push_back(newPoint(var0.x + var5 * Math.cos(var11 + var16 * (1 + var18)), var0.y + var5 * Math.sin(var11 + var16 * (1 + var18))));
      }
   }
    ...
    static void createTriangles(Point var0, Point var1, Point var2, std::vector<Point> var3, float var4, const std::string& var5, float var6) {
    ...
    double var19 = var18.length();
      if (!(var11 > var16) && !(var11 > var19)) {
         var3.push_back(Point.Add(var0, var7));
         var3.push_back(Point.Sub(var0, var7));
         var3.push_back(Point.Sub(var1, var10));
         var3.push_back(Point.Add(var0, var7));
         var3.push_back(Point.Sub(var1, var10));
         var3.push_back(Point.Add(var1, var7));
         if (var5 == "round")) {
    Point var21 = Point.Add(var1, var7);
    Point var22 = Point.Add(var1, var8);
    Point var23 = Point.Sub(var1, var10);
            var3.push_back(var21);
            var3.push_back(var1);
            var3.push_back(var23);
            createRoundCap(var1, var21, var22, var23, var3);
            var3.push_back(var1);
            var3.push_back(var22);
            var3.push_back(var23);
         } else {
            if (var5 == "bevel") || var5 == "miter") && var13 >= var6) {
               var3.push_back(Point.Add(var1, var7));
               var3.push_back(Point.Add(var1, var8));
               var3.push_back(Point.Sub(var1, var10));
            }
         ...
         var3.push_back(Point.Add(var2, var8));
         var3.push_back(Point.Sub(var1, var10));
         var3.push_back(Point.Add(var1, var8));
         var3.push_back(Point.Add(var2, var8));
         var3.push_back(Point.Sub(var1, var10));
         var3.push_back(Point.Sub(var2, var8));
      } else {
         var3.push_back(Point.Add(var0, var7));
         var3.push_back(Point.Sub(var0, var7));
         var3.push_back(Point.Add(var1, var7));
         var3.push_back(Point.Sub(var0, var7));
         var3.push_back(Point.Add(var1, var7));
         var3.push_back(Point.Sub(var1, var7));
         if (var5 == "round")) {
         ...
         var3.push_back(Point.Add(var2, var8));
         var3.push_back(Point.Sub(var1, var8));
         var3.push_back(Point.Add(var1, var8));
         var3.push_back(Point.Add(var2, var8));
         var3.push_back(Point.Sub(var1, var8));
         var3.push_back(Point.Sub(var2, var8));
