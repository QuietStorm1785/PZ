...
public UIWorldMapV1::UIWorldMapV1(UIWorldMap var1) {
    // TODO: Implement UIWorldMapV1
    return nullptr;
}

void UIWorldMapV1::setMapItem(MapItem var1) {
...
void UIWorldMapV1::addData(const std::string& var1) {
...
std::string UIWorldMapV1::getDataFileByIndex(int var1) {
...
void UIWorldMapV1::addImages(const std::string& var1) {
...
void UIWorldMapV1::setBoundsInCells(int var1, int var2, int var3, int var4) {
    // TODO: Implement setBoundsInCells
}

void UIWorldMapV1::setBoundsInSquares(int var1, int var2, int var3, int var4) {
...
float UIWorldMapV1::uiToWorldX(float var1, float var2, float var3, float var4, float var5) {
    // TODO: Implement uiToWorldX
    return 0;
}

float UIWorldMapV1::uiToWorldY(float var1, float var2, float var3, float var4, float var5) {
    // TODO: Implement uiToWorldY
    return 0;
}

float UIWorldMapV1::worldToUIX(float var1, float var2, float var3, float var4, float var5, Matrix4f var6, Matrix4f var7) {
    // TODO: Implement worldToUIX
    return 0;
}

float UIWorldMapV1::worldToUIY(float var1, float var2, float var3, float var4, float var5, Matrix4f var6, Matrix4f var7) {
    // TODO: Implement worldToUIY
    return 0;
}

float UIWorldMapV1::worldOriginUIX(float var1, float var2) {
    // TODO: Implement worldOriginUIX
    return 0;
}

float UIWorldMapV1::worldOriginUIY(float var1, float var2) {
...
float UIWorldMapV1::getWorldScale(float var1) {
...
float UIWorldMapV1::uiToWorldX(float var1, float var2) {
    // TODO: Implement uiToWorldX
    return 0;
}

float UIWorldMapV1::uiToWorldY(float var1, float var2) {
    // TODO: Implement uiToWorldY
    return 0;
}

float UIWorldMapV1::worldToUIX(float var1, float var2) {
    // TODO: Implement worldToUIX
    return 0;
}

float UIWorldMapV1::worldToUIY(float var1, float var2) {
    // TODO: Implement worldToUIY
    return 0;
}

void UIWorldMapV1::centerOn(float var1, float var2) {
    // TODO: Implement centerOn
}

void UIWorldMapV1::moveView(float var1, float var2) {
    // TODO: Implement moveView
}

void UIWorldMapV1::zoomAt(float var1, float var2, float var3) {
    // TODO: Implement zoomAt
}

void UIWorldMapV1::setZoom(float var1) {
...
void UIWorldMapV1::setBackgroundRGBA(float var1, float var2, float var3, float var4) {
    // TODO: Implement setBackgroundRGBA
}

void UIWorldMapV1::setDropShadowWidth(int var1) {
    // TODO: Implement setDropShadowWidth
}

void UIWorldMapV1::setUnvisitedRGBA(float var1, float var2, float var3, float var4) {
    // TODO: Implement setUnvisitedRGBA
}

void UIWorldMapV1::setUnvisitedGridRGBA(float var1, float var2, float var3, float var4) {
...
ConfigOption UIWorldMapV1::getOptionByIndex(int var1) {
    // TODO: Implement getOptionByIndex
    return nullptr;
}

void UIWorldMapV1::setBoolean(const std::string& var1, bool var2) {
    // TODO: Implement setBoolean
}

bool UIWorldMapV1::getBoolean(const std::string& var1) {
    // TODO: Implement getBoolean
    return false;
}

void UIWorldMapV1::setDouble(const std::string& var1, double var2) {
    // TODO: Implement setDouble
}

double UIWorldMapV1::getDouble(const std::string& var1, double var2) {
