...
void WorldMap::setBoundsInCells(int var1, int var2, int var3, int var4) {
    // TODO: Implement setBoundsInCells
}

void WorldMap::setBoundsInSquares(int var1, int var2, int var3, int var4) {
...
void WorldMap::addData(const std::string& var1) {
...
WorldMapData WorldMap::getDataByIndex(int var1) {
...
bool WorldMap::isLastDataInDirectory(WorldMapData var1) {
...
void WorldMap::addImages(const std::string& var1) {
...
WorldMapImages WorldMap::getImagesByIndex(int var1) {
...
WorldMapCell WorldMap::getCell(int var1, int var2) {
...
void WorldMap::onStateChanged(State var1, State var2, Asset var3) {
