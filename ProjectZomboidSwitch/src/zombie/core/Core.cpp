...
void Core::setChallenge(bool var1) {
...
void Core::setOptionTieredZombieUpdates(bool var1) {
    // TODO: Implement setOptionTieredZombieUpdates
}

void Core::setFramerate(int var1) {
    // TODO: Implement setFramerate
}

void Core::setMultiThread(bool var1) {
...
void Core::setPerfSkybox(int var1) {
...
void Core::setPerfReflections(bool var1) {
...
void Core::setPerfPuddles(int var1) {
...
void Core::setVidMem(int var1) {
    // TODO: Implement setVidMem
}

void Core::setUseShaders(bool var1) {
...
void Core::setFullScreen(bool var0) {
...
void Core::TakeScreenshot(int var1, int var2, int var3) {
    // TODO: Implement TakeScreenshot
}

void Core::TakeScreenshot(int var1, int var2, int var3, int var4, int var5) {
    // TODO: Implement TakeScreenshot
}

void Core::TakeFullScreenshot(const std::string& var1) {
...
void Core::EndFrameText(int var1) {
    // TODO: Implement EndFrameText
}

void Core::EndFrame(int var1) {
...
int Core::getOffscreenWidth(int var1) {
    // TODO: Implement getOffscreenWidth
    return 0;
}

int Core::getOffscreenHeight(int var1) {
...
void Core::setResolutionAndFullScreen(int var1, int var2, bool var3) {
    // TODO: Implement setResolutionAndFullScreen
}

void Core::setResolution(const std::string& var1) {
...
void Core::copyPasteFolders(const std::string& var1) {
    // TODO: Implement copyPasteFolders
}

void Core::searchFolders(File var1, const std::string& var2) {
    // TODO: Implement searchFolders
}

void Core::copyPasteFile(File var1, const std::string& var2) {
...
void Core::setWindowed(bool var1) {
...
void Core::setDisplayMode(int var0, int var1, bool var2) {
    // TODO: Implement setDisplayMode
}

bool Core::isFunctionKey(int var1) {
...
void Core::updateKeyboardAux(UITextBox2 var1, int var2) {
...
bool Core::supportRes(int var1, int var2) {
    // TODO: Implement supportRes
    return false;
}

void Core::init(int var1, int var2) {
    // TODO: Implement init
}
...
void Core::setScreenSize(int var1, int var2) {
...
void Core::StartFrame(int var1, bool var2) {
    // TODO: Implement StartFrame
}
...
TextureFBO Core::getOffscreenBuffer(int var1) {
    // TODO: Implement getOffscreenBuffer
    return nullptr;
}

void Core::setLastRenderedFBO(TextureFBO var1) {
    // TODO: Implement setLastRenderedFBO
}

void Core::DoStartFrameStuff(int var1, int var2, float var3, int var4) {
    // TODO: Implement DoStartFrameStuff
}

void Core::DoStartFrameStuff(int var1, int var2, float var3, int var4, bool var5) {
    // TODO: Implement DoStartFrameStuff
}

void Core::DoEndFrameStuffFx(int var1, int var2, int var3) {
    // TODO: Implement DoEndFrameStuffFx
}

void Core::DoStartFrameStuffSmartTextureFx(int var1, int var2, int var3) {
    // TODO: Implement DoStartFrameStuffSmartTextureFx
}

void Core::DoStartFrameStuffInternal(int var1, int var2, float var3, int var4, bool var5, bool var6, bool var7) {
    // TODO: Implement DoStartFrameStuffInternal
}

void Core::DoPushIsoStuff(float var1, float var2, float var3, float var4, bool var5) {
    // TODO: Implement DoPushIsoStuff
}

void Core::DoPushIsoParticleStuff(float var1, float var2, float var3) {
...
void Core::DoEndFrameStuff(int var1, int var2) {
...
void Core::StartFrameText(int var1) {
...
int Core::getKey(const std::string& var1) {
    // TODO: Implement getKey
    return 0;
}

void Core::addKeyBinding(const std::string& var1, int var2) {
...
float Core::getZoom(int var1) {
    // TODO: Implement getZoom
    return 0;
}

float Core::getNextZoom(int var1, int var2) {
...
void Core::doZoomScroll(int var1, int var2) {
...
void Core::setOptionZoom(bool var1) {
    // TODO: Implement setOptionZoom
}

void Core::zoomOptionChanged(bool var1) {
...
bool Core::getAutoZoom(int var1) {
    // TODO: Implement getAutoZoom
    return false;
}

void Core::setAutoZoom(int var1, bool var2) {
...
void Core::setOptionVSync(bool var1) {
...
void Core::setOptionSoundVolume(int var1) {
...
void Core::setOptionMusicVolume(int var1) {
...
void Core::setOptionAmbientVolume(int var1) {
...
void Core::setOptionJumpScareVolume(int var1) {
...
void Core::setOptionMusicActionStyle(int var1) {
...
void Core::setOptionMusicLibrary(int var1) {
...
void Core::setOptionVehicleEngineVolume(int var1) {
...
void Core::setOptionVoiceEnable(bool var1) {
...
void Core::setOptionVoiceMode(int var1) {
...
void Core::setOptionVoiceVADMode(int var1) {
...
void Core::setOptionVoiceAGCMode(int var1) {
...
void Core::setOptionVoiceVolumeMic(int var1) {
...
void Core::setOptionVoiceVolumePlayers(int var1) {
...
void Core::setOptionVoiceRecordDeviceName(const std::string& var1) {
...
void Core::setOptionVoiceRecordDevice(int var1) {
...
void Core::setTestingMicrophone(bool var1) {
...
void Core::setOptionReloadDifficulty(int var1) {
...
void Core::setOptionRackProgress(bool var1) {
...
void Core::setOptionFontSize(int var1) {
...
void Core::setOptionContextMenuFont(const std::string& var1) {
...
void Core::setOptionInventoryFont(const std::string& var1) {
...
void Core::setOptionInventoryContainerSize(int var1) {
...
void Core::setOptionTooltipFont(const std::string& var1) {
...
void Core::setOptionMeasurementFormat(const std::string& var1) {
...
void Core::setOptionClockFormat(int var1) {
    // TODO: Implement setOptionClockFormat
}

void Core::setOptionClockSize(int var1) {
...
void Core::setOptionClock24Hour(bool var1) {
...
void Core::setOptionModsEnabled(bool var1) {
...
void Core::setOptionBloodDecals(int var1) {
...
void Core::setOptionBorderlessWindow(bool var1) {
...
void Core::setOptionLockCursorToWindow(bool var1) {
...
void Core::setOptionTextureCompression(bool var1) {
...
void Core::setOptionTexture2x(bool var1) {
...
void Core::setOptionMaxTextureSize(int var1) {
...
void Core::setOptionMaxVehicleTextureSize(int var1) {
    // TODO: Implement setOptionMaxVehicleTextureSize
}

int Core::getMaxTextureSizeFromFlags(int var1) {
    // TODO: Implement getMaxTextureSizeFromFlags
    return 0;
}

int Core::getMaxTextureSizeFromOption(int var1) {
...
void Core::setOptionModelTextureMipmaps(bool var1) {
...
void Core::setOptionZoomLevels1x(const std::string& var1) {
...
void Core::setOptionZoomLevels2x(const std::string& var1) {
    // TODO: Implement setOptionZoomLevels2x
}

void Core::setOptionActiveController(int var1, bool var2) {
    // TODO: Implement setOptionActiveController
}

bool Core::getOptionActiveController(const std::string& var1) {
...
void Core::setOptionShowChatTimestamp(bool var1) {
...
void Core::setOptionChatFontSize(const std::string& var1) {
    // TODO: Implement setOptionChatFontSize
}

void Core::setOptionShowChatTitle(bool var1) {
...
void Core::setOptionMinChatOpaque(float var1) {
...
void Core::setOptionMaxChatOpaque(float var1) {
...
void Core::setOptionChatFadeTime(float var1) {
...
void Core::setOptionChatOpaqueOnFocus(bool var1) {
...
void Core::setOptionUIFBO(bool var1) {
...
void Core::setOptionAimOutline(int var1) {
...
void Core::setOptionUIRenderFPS(int var1) {
    // TODO: Implement setOptionUIRenderFPS
}

void Core::setOptionRadialMenuKeyToggle(bool var1) {
...
void Core::setOptionReloadRadialInstant(bool var1) {
...
void Core::setOptionPanCameraWhileAiming(bool var1) {
...
void Core::setOptionPanCameraWhileDriving(bool var1) {
...
void Core::setOptionCycleContainerKey(const std::string& var1) {
...
void Core::setOptionDropItemsOnSquareCenter(bool var1) {
...
void Core::setOptionTimedActionGameSpeedReset(bool var1) {
...
void Core::setOptionShoulderButtonContainerSwitch(int var1) {
    // TODO: Implement setOptionShoulderButtonContainerSwitch
}

bool Core::getOptionSingleContextMenu(int var1) {
    // TODO: Implement getOptionSingleContextMenu
    return false;
}

void Core::setOptionSingleContextMenu(int var1, bool var2) {
...
void Core::setOptionAutoDrink(bool var1) {
...
void Core::setOptionAutoWalkContainer(bool var1) {
...
void Core::setOptionCorpseShadows(bool var1) {
...
void Core::setOptionLeaveKeyInIgnition(bool var1) {
...
void Core::setOptionSearchModeOverlayEffect(int var1) {
...
void Core::setOptionSimpleClothingTextures(int var1) {
    // TODO: Implement setOptionSimpleClothingTextures
}

bool Core::isOptionSimpleClothingTextures(bool var1) {
...
void Core::setOptionSimpleWeaponTextures(bool var1) {
...
void Core::setOptionIgnoreProneZombieRange(int var1) {
...
void Core::readPerPlayerBoolean(const std::string& var1, boolean[] var2) {
    // TODO: Implement readPerPlayerBoolean
}

std::string Core::getPerPlayerBooleanString(boolean[] var1) {
    // TODO: Implement getPerPlayerBooleanString
    return "";
}

void Core::ResetLua(bool var1, const std::string& var2) {
    // TODO: Implement ResetLua
}

void Core::ResetLua(const std::string& var1, const std::string& var2) {
    // TODO: Implement ResetLua
}

void Core::DelayResetLua(const std::string& var1, const std::string& var2) {
...
void Core::setShowPing(bool var1) {
...
void Core::setForceSnow(bool var1) {
...
void Core::setZombieGroupSound(bool var1) {
...
void Core::setBlinkingMoodle(const std::string& var1) {
...
void Core::setTutorialDone(bool var1) {
...
void Core::setVehiclesWarningShow(bool var1) {
...
void Core::setPoisonousBerry(const std::string& var1) {
...
void Core::setPoisonousMushroom(const std::string& var1) {
...
void Core::setDifficulty(const std::string& var0) {
...
void Core::setDoneNewSaveFolder(bool var1) {
...
void Core::setIsSelectingAll(bool var1) {
...
void Core::setContentTranslationsEnabled(bool var1) {
...
void Core::setShowYourUsername(bool var1) {
...
void Core::setMpTextColor(ColorInfo var1) {
...
void Core::setObjectHighlitedColor(ColorInfo var1) {
...
void Core::setGoodHighlitedColor(ColorInfo var1) {
...
void Core::setBadHighlitedColor(ColorInfo var1) {
...
void Core::setSeenUpdateText(const std::string& var1) {
...
void Core::setToggleToAim(bool var1) {
...
void Core::setToggleToRun(bool var1) {
    // TODO: Implement setToggleToRun
}

int Core::getXAngle(int var1, float var2) {
    // TODO: Implement getXAngle
    return 0;
}

int Core::getYAngle(int var1, float var2) {
...
void Core::setCelsius(bool var1) {
...
void Core::setRiversideDone(bool var1) {
...
void Core::setShowFirstTimeVehicleTutorial(bool var1) {
...
void Core::setOptionDisplayAsCelsius(bool var1) {
...
void Core::setShowFirstTimeWeatherTutorial(bool var1) {
...
void Core::setOptionDoWindSpriteEffects(bool var1) {
...
void Core::setOptionDoDoorSpriteEffects(bool var1) {
...
void Core::setOptionDoContainerOutline(bool var1) {
    // TODO: Implement setOptionDoContainerOutline
}

void Core::setOptionUpdateSneakButton(bool var1) {
...
void Core::setNewReloading(bool var1) {
...
void Core::setShowFirstTimeSneakTutorial(bool var1) {
...
void Core::setShowFirstTimeSearchTutorial(bool var1) {
...
void Core::setTermsOfServiceVersion(int var1) {
    // TODO: Implement setTermsOfServiceVersion
}

void Core::setOptiondblTapJogToSprint(bool var1) {
...
void Core::setToggleToSprint(bool var1) {
...
void Core::setIsoCursorVisibility(int var1) {
...
void Core::setOptionShowCursorWhileAiming(bool var1) {
...
void Core::setGotNewBelt(bool var1) {
    // TODO: Implement setGotNewBelt
}

void Core::setAnimPopupDone(bool var1) {
...
void Core::setModsPopupDone(bool var1) {
...
void Core::setRenderPrecipIndoors(bool var1) {
...
void Core::setCollideZombies(bool var1) {
...
void Core::setFlashIsoCursor(bool var1) {
...
void Core::setOptionProgressBar(bool var1) {
    // TODO: Implement setOptionProgressBar
}

void Core::setOptionLanguageName(const std::string& var1) {
...
void Core::setOptionRenderPrecipitation(int var1) {
    // TODO: Implement setOptionRenderPrecipitation
}

void Core::setOptionAutoProneAtk(bool var1) {
...
void Core::setOption3DGroundItem(bool var1) {
...
void* Core::getOptionOnStartup(const std::string& var1) {
    // TODO: Implement getOptionOnStartup
    return nullptr;
}

void Core::setOptionOnStartup(const std::string& var1, void* var2) {
...
void Core::setOptionShowItemModInfo(bool var1) {
...
void Core::setOptionShowSurvivalGuide(bool var1) {
...
void Core::setOptionEnableLeftJoystickRadialMenu(bool var1) {
