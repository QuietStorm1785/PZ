...
public:
   ...
   private BoneTrack[] m_boneTracks;
    ...
    void set(AnimTrackSampler var1, float var2) {
    float var3 = var1.getTotalTime();
    bool var4 = var1.isLooped();
    int var5 = var1.getNumBones();
      this.m_totalTime = var3;
      this.m_numFrames = PZMath.max((int)(var3 * var2 + 0.99F), 1);
      this.m_isLooped = var4;
      this.m_boneTracks = new BoneTrack[var5];

      for (int var6 = 0; var6 < var5; var6++) {
         this.m_boneTracks[var6] = std::make_unique<BoneTrack>();
         this.m_boneTracks[var6].m_animationData = new float[this.m_numFrames * 16];
      }

    Matrix4f var14 = std::make_shared<Matrix4f>();
    float var7 = var3 / (this.m_numFrames - 1);
    ...
    int var11 = var8 * 16;
    BoneTrack var12 = this.m_boneTracks[var10];
    ...
    void sampleAtTime_NonLooped(Matrix4f var1, int var2, float var3) {
    int var4 = (int)var3;
    float var5 = var3 - var4;
    int var6 = PZMath.clamp(var4, 0, this.m_numFrames - 1);
    int var7 = PZMath.clamp(var6 + 1, 0, this.m_numFrames - 1);
    bool var8 = DebugOptions.instance.Animation.SharedSkeles.AllowLerping.getValue();
      this.sampleBoneData(var2, var6, var7, var5, var8, var1);
   }

    void sampleAtTime_Looped(Matrix4f var1, int var2, float var3) {
    int var4 = (int)var3;
    float var5 = var3 - var4;
    ...
    void sampleBoneData(int var1, int var2, int var3, float var4, bool var5, Matrix4f var6) {
    int var7 = var2 * 16;
    BoneTrack var8 = this.m_boneTracks[var1];
