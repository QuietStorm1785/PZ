...
public:
    ...
    static Matrix4 Identity = std::make_shared<Matrix4>();
    FloatBuffer direct;
    ...
    Matrix4 clearToOrtho(float var1, float var2, float var3, float var4, float var5, float var6) {
      return this.clear()
         .put(0, 2.0F / (var2 - var1))
         .put(5, 2.0F / (var4 - var3))
         .put(10, -2.0F / (var6 - var5))
         .put(12, -(var2 + var1) / (var2 - var1))
         .put(13, -(var4 + var3) / (var4 - var3))
         .put(14, -(var6 + var5) / (var6 - var5))
         .put(15, 1.0F);
   }

    Matrix4 clearToPerspective(float var1, float var2, float var3, float var4, float var5) {
    float var6 = 1.0F / (float)Math.tan(var1 / 2.0F);
      return this.clear()
         .put(0, var6 / (var2 / var3))
         .put(5, var6)
         .put(10, (var5 + var4) / (var4 - var5))
         .put(14, 2.0F * var5 * var4 / (var4 - var5))
         .put(11, -1.0F);
   }
    ...
    Matrix4 put(int var1, float var2) {
      this.matrix.put(var1, var2);
    return this;
   }

    Matrix4 put(int var1, Vector3 var2, float var3) {
    ...
    Matrix4 mult(float[] var1) {
      float[] var2 = new float[16];

      for (byte var3 = 0; var3 < 16; var3 += 4) {
    ...
    Matrix4 mult(Matrix4 var1) {
      float[] var2 = new float[16];

      for (byte var3 = 0; var3 < 16; var3 += 4) {
         var2[var3 + 0] = this.get(0) * var1.get(var3)
            + this.get(4) * var1.get(var3 + 1)
            + this.get(8) * var1.get(var3 + 2)
            + this.get(12) * var1.get(var3 + 3);
         var2[var3 + 1] = this.get(1) * var1.get(var3)
            + this.get(5) * var1.get(var3 + 1)
            + this.get(9) * var1.get(var3 + 2)
            + this.get(13) * var1.get(var3 + 3);
         var2[var3 + 2] = this.get(2) * var1.get(var3)
            + this.get(6) * var1.get(var3 + 1)
            + this.get(10) * var1.get(var3 + 2)
            + this.get(14) * var1.get(var3 + 3);
         var2[var3 + 3] = this.get(3) * var1.get(var3)
            + this.get(7) * var1.get(var3 + 1)
            + this.get(11) * var1.get(var3 + 2)
            + this.get(15) * var1.get(var3 + 3);
      }
    ...
    Matrix4 translate(float var1, float var2, float var3) {
    ...
    Matrix4 translate(Vector3 var1) {
      return this.translate(var1.x(), var1.y(), var1.z());
   }

    Matrix4 scale(float var1, float var2, float var3) {
      float[] var4 = new float[16];
      var4[0] = var1;
      var4[5] = var2;
      var4[10] = var3;
    ...
    Matrix4 scale(Vector3 var1) {
      return this.scale(var1.x(), var1.y(), var1.z());
   }

    Matrix4 rotate(float var1, float var2, float var3, float var4) {
    float var5 = (float)Math.cos(var1);
    float var6 = (float)Math.sin(var1);
    float var7 = 1.0F - var5;
    Vector3 var8 = std::make_shared<Vector3>(var2, var3, var4).normalize();
    ...
    Matrix4 rotate(float var1, Vector3 var2) {
