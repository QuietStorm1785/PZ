...
public ClothingItem::ClothingItem(AssetPath var1, AssetManager var2) {
...
void ClothingItem::getCombinedMask(CharacterMask var1) {
...
std::string ClothingItem::getModel(bool var1) {
...
void ClothingItem::tryGetCombinedMask(ClothingItemReference var0, CharacterMask var1) {
    // TODO: Implement tryGetCombinedMask
}

void ClothingItem::tryGetCombinedMask(ClothingItem var0, CharacterMask var1) {
    // TODO: Implement tryGetCombinedMask
}
