...
AnimNode AnimNode::Parse(const std::string& var0) {
    // TODO: Implement Parse
    return nullptr;
}

bool AnimNode::checkConditions(IAnimationVariableSource var1) {
    // TODO: Implement checkConditions
    return false;
}

float AnimNode::getSpeedScale(IAnimationVariableSource var1) {
...
AnimTransition AnimNode::findTransitionTo(IAnimationVariableSource var1, const std::string& var2) {
