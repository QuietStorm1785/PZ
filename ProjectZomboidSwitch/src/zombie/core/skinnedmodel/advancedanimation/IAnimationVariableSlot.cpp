...
void IAnimationVariableSlot::setValue(const std::string& var1) {
    // TODO: Implement setValue
}

void IAnimationVariableSlot::setValue(float var1) {
    // TODO: Implement setValue
}

void IAnimationVariableSlot::setValue(bool var1) {
    // TODO: Implement setValue
}
...
bool IAnimationVariableSlot::canConvertFrom(const std::string& var1) {
