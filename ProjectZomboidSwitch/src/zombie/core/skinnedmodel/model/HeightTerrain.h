...
public:
    ...
    OpenSimplexNoise noise = std::make_shared<OpenSimplexNoise>(Rand.Next(10000000));
   ...
   static float[] diffuse = new float[]{1.0F, 1.0F, 1.0F, 1.0F};
    ...
    Vector2 var10 = std::make_shared<Vector2>(2.0F, 0.0F);
    int var11 = 0;
    ...
    float var14 = (float)this.calc(var12, var13);
            var14 *= 1.0F;
            var14++;
    VertexPositionNormalTangentTextureSkin var15 = nullptr;
            var15 = std::make_unique<VertexPositionNormalTangentTextureSkin>();
            ...
            var15.TextureCoordinates = std::make_shared<Vector2>((float)var12 / (var7 - 1) * 16.0F, (float)var13 / (var8 - 1) * 16.0F);
            var5.push_back(var15);
         }
      }
    ...
    Vector3 var16 = std::make_shared<Vector3>();
    Vector3 var17 = std::make_shared<Vector3>();
      ...
      for (int var33 = 0; var33 < var8 - 1; var33++) {
         if ((var33 & 1) == 0) {
            for (int var37 = 0; var37 < var7; var37++) {
               var9.push_back(var37 + (var33 + 1) * var7);
               var9.push_back(var37 + var33 * var7);
               var11++;
               var11++;
            }
         } else {
            for (int var36 = var7 - 1; var36 > 0; var36--) {
               var9.push_back(var36 - 1 + var33 * var7);
               var9.push_back(var36 + (var33 + 1) * var7);
               var11++;
               var11++;
            }
         }
    ...
    int var53 = (int)var9.get(var9.size() - 1 - var48);
         var39[var48] = var53;
      }
    ...
    void doLighting() {
      ...
      lightDiffuse[2] = 0.5F;
      lightDiffuse[3] = 1.0F;
    Vector3 var1 = std::make_shared<Vector3>(1.0F, 1.0F, 1.0F);
      var1.normalize();
