...
void IGLFramebufferObject::glBindFramebuffer(int var1, int var2) {
    // TODO: Implement glBindFramebuffer
}

void IGLFramebufferObject::glFramebufferTexture2D(int var1, int var2, int var3, int var4, int var5) {
...
void IGLFramebufferObject::glBindRenderbuffer(int var1, int var2) {
    // TODO: Implement glBindRenderbuffer
}

void IGLFramebufferObject::glRenderbufferStorage(int var1, int var2, int var3, int var4) {
    // TODO: Implement glRenderbufferStorage
}

void IGLFramebufferObject::glFramebufferRenderbuffer(int var1, int var2, int var3, int var4) {
    // TODO: Implement glFramebufferRenderbuffer
}

int IGLFramebufferObject::glCheckFramebufferStatus(int var1) {
    // TODO: Implement glCheckFramebufferStatus
    return 0;
}

void IGLFramebufferObject::glDeleteFramebuffers(int var1) {
    // TODO: Implement glDeleteFramebuffers
}

void IGLFramebufferObject::glDeleteRenderbuffers(int var1) {
