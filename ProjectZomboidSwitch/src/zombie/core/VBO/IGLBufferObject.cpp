...
void IGLBufferObject::glBindBuffer(int var1, int var2) {
    // TODO: Implement glBindBuffer
}

void IGLBufferObject::glDeleteBuffers(int var1) {
    // TODO: Implement glDeleteBuffers
}

void IGLBufferObject::glBufferData(int var1, ByteBuffer var2, int var3) {
    // TODO: Implement glBufferData
}

void IGLBufferObject::glBufferData(int var1, long var2, int var4) {
    // TODO: Implement glBufferData
}

ByteBuffer IGLBufferObject::glMapBuffer(int var1, int var2, long var3, ByteBuffer var5) {
    // TODO: Implement glMapBuffer
    return nullptr;
}

bool IGLBufferObject::glUnmapBuffer(int var1) {
    // TODO: Implement glUnmapBuffer
    return false;
}

void IGLBufferObject::glGetBufferParameter(int var1, int var2, IntBuffer var3) {
