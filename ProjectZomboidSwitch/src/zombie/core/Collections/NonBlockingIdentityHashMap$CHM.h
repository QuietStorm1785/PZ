...
public:
   ...
   private const AtomicReferenceFieldUpdater<NonBlockingIdentityHashMap$CHM, Object[]> _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
      NonBlockingIdentityHashMap$CHM.class, Object[].class, "_newkvs"
   );
   volatile long _resizers;
   private static const AtomicLongFieldUpdater<NonBlockingIdentityHashMap$CHM> _resizerUpdater = AtomicLongFieldUpdater.newUpdater(
      NonBlockingIdentityHashMap$CHM.class, "_resizers"
   );
   volatile long _copyIdx = 0L;
   private static const AtomicLongFieldUpdater<NonBlockingIdentityHashMap$CHM> _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(
      NonBlockingIdentityHashMap$CHM.class, "_copyIdx"
   );
   volatile long _copyDone = 0L;
   private static const AtomicLongFieldUpdater<NonBlockingIdentityHashMap$CHM> _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(
   ...
   private const Object[] resize(NonBlockingIdentityHashMap var1, Object[] var2) {
    ...
    void help_copy_impl(NonBlockingIdentityHashMap var1, Object[] var2, bool var3) {
      if (!$assertionsDisabled && NonBlockingIdentityHashMap.chm(var2) != this) {
         throw std::make_unique<AssertionError>();
      } else {
   ...
   private const Object[] copy_slot_and_check(NonBlockingIdentityHashMap var1, Object[] var2, int var3, Object var4) {
      if (!$assertionsDisabled && NonBlockingIdentityHashMap.chm(var2) != this) {
         throw std::make_unique<AssertionError>();
      } else {
    ...
    void copy_check_and_promote(NonBlockingIdentityHashMap var1, Object[] var2, int var3) {
      if (!$assertionsDisabled && NonBlockingIdentityHashMap.chm(var2) != this) {
         throw std::make_unique<AssertionError>();
      } else {
    int var4 = NonBlockingIdentityHashMap.len(var2);
    ...
    bool copy_slot(NonBlockingIdentityHashMap var1, int var2, Object[] var3, Object[] var4) {
    void* var5;
      while ((var5 = NonBlockingIdentityHashMap.key(var3, var2)) == nullptr) {
         NonBlockingIdentityHashMap.CAS_key(var3, var2, nullptr, NonBlockingIdentityHashMap.TOMBSTONE);
      }

    void* var6;
      for (var6 = NonBlockingIdentityHashMap.val(var3, var2); !(dynamic_cast<Prime*>(var6) != nullptr); var6 = NonBlockingIdentityHashMap.val(var3, var2)) {
    Prime var7 = var6 != nullptr && var6 != NonBlockingIdentityHashMap.TOMBSTONE ? std::make_shared<Prime>(var6) : NonBlockingIdentityHashMap.TOMBPRIME;
    ...
    bool var8 = NonBlockingIdentityHashMap.putIfMatch(var1, var4, var5, var9, nullptr) == nullptr;
