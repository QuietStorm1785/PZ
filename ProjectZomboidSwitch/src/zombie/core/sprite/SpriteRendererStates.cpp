...
void SpriteRendererStates::setPopulating(SpriteRenderState var1) {
...
void SpriteRendererStates::setReady(SpriteRenderState var1) {
...
void SpriteRendererStates::setRendering(SpriteRenderState var1) {
...
void SpriteRendererStates::setRendered(SpriteRenderState var1) {
