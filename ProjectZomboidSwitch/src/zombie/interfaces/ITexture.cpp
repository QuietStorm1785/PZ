...
void ITexture::makeTransp(int var1, int var2, int var3) {
    // TODO: Implement makeTransp
}

void ITexture::setAlphaForeach(int var1, int var2, int var3, int var4) {
    // TODO: Implement setAlphaForeach
}

void ITexture::setData(ByteBuffer var1) {
    // TODO: Implement setData
}

void ITexture::setMask(Mask var1) {
    // TODO: Implement setMask
}

void ITexture::setRegion(int var1, int var2, int var3, int var4) {
