...
void ClientPlayerDB::setAllow(bool var0) {
...
void ClientPlayerDB::clientLoadNetworkCharacter(ByteBuffer var1, UdpConnection var2) {
...
void ClientPlayerDB::clientSendNetworkPlayerInt(IsoPlayer var1) {
...
bool ClientPlayerDB::loadNetworkPlayerInfo(int var1) {
    // TODO: Implement loadNetworkPlayerInfo
    return false;
}

void ClientPlayerDB::forgetPlayer(int var1) {
