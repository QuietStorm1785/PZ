...
public:
   ...
   private static byte[] gradients4D = new byte[]{
    ...
    double eval(double var1, double var3, double var5) {
    ...
    uint8_t var138 = (byte)(var60 | var63);
            if ((var138 & 1) == 0) {
               var52 = var15;
               var55 = var15 - 1;
    ...
    uint8_t var68 = var64 > var61 ? var63 : var60;
            if ((var68 & 1) == 0) {
               var52 = var15 - 1;
               var55 = var15;
               var40 = var34 + 1.0;
    ...
    uint8_t var142 = (byte)(var125 & var132);
            if ((var142 & 1) != 0) {
               var52 = var15 + 1;
               var55 = var15 + 2;
    ...
    uint8_t var141 = var134 < var129 ? var132 : var125;
            if ((var141 & 1) != 0) {
               var52 = var15 + 2;
               var55 = var15 + 1;
               var40 = var34 - 2.0 - 1.0;
    ...
    double var151 = 1.0 - var148;
         ...
         if (var133 == var67) {
            if (var133) {
               ...
               var53 = var16 + 1;
               var54 = var17 + 1;
    uint8_t var153 = (byte)(var62 & var137);
               if ((var153 & 1) != 0) {
                  var46 = var34 - 2.0 - 0.6666666666666666;
                  var48 = var36 - 0.6666666666666666;
                  var50 = var38 - 0.6666666666666666;
               ...
               var53 = var16;
               var54 = var17;
    uint8_t var154 = (byte)(var62 | var137);
               if ((var154 & 1) == 0) {
                  var46 = var34 + 1.0 - 0.3333333333333333;
                  var48 = var36 - 1.0 - 0.3333333333333333;
                  var50 = var38 - 1.0 - 0.3333333333333333;
    ...
    double eval(double var1, double var3, double var5, double var7) {
    ...
    uint8_t var230 = (byte)(var89 | var92);
            if ((var230 & 1) == 0) {
               var83 = var19;
               var75 = var19;
               var79 = var19 - 1;
    ...
    uint8_t var97 = var93 > var90 ? var92 : var89;
            if ((var97 & 1) == 0) {
               var75 = var19 - 1;
               var83 = var19;
               var79 = var19;
    ...
    uint8_t var234 = (byte)(var209 & var218);
            if ((var234 & 1) != 0) {
               var75 = var83 = var19 + 1;
               var79 = var19 + 2;
               var51 = var43 - 1.0 - 0.618033988749894;
    ...
    uint8_t var233 = var221 < var214 ? var218 : var209;
            if ((var233 & 1) != 0) {
               var75 = var19 + 2;
               var79 = var83 = var19 + 1;
    ...
    double var249 = 2.0 - var41 + var39;
         ...
         if (var219 == var96) {
            if (var219) {
    uint8_t var253 = (byte)(var91 | var227);
    uint8_t var106 = (byte)(var91 & var227);
               if ((var253 & 1) == 0) {
                  var75 = var19;
                  var79 = var19 - 1;
               ...
               var71 = var47;
               var73 = var49;
    uint8_t var254 = (byte)(var91 | var227);
               if ((var254 & 1) == 0) {
                  var75 = var19 - 1;
                  var79 = var19;
    ...
    double var250 = 3.0 - var41 + var39;
         ...
         if (var220 == var229) {
            if (var220) {
    uint8_t var257 = (byte)(var215 & var228);
    uint8_t var262 = (byte)(var215 | var228);
               var79 = var19;
               var75 = var19;
               var80 = var20;
               var76 = var20;
    ...
    uint8_t var258 = (byte)(var215 & var228);
               if ((var258 & 1) != 0) {
                  var75 = var19 + 2;
                  var79 = var19 + 1;
    ...
    double extrapolate(int var1, int var2, double var3, double var5) {
    int var7 = this.perm[this.perm[var1 & 0xFF] + var2 & 0xFF] & 14;
      return gradients2D[var7] * var3 + gradients2D[var7 + 1] * var5;
   }

    double extrapolate(int var1, int var2, int var3, double var4, double var6, double var8) {
    ...
    double extrapolate(int var1, int var2, int var3, int var4, double var5, double var7, double var9, double var11) {
    ...
    double evalOct(float var1, float var2, int var3) {
    bool var4 = true;
