...
public LuaTimedActionNew::LuaTimedActionNew(KahluaTable var1, IsoGameCharacter var2) {
...
void LuaTimedActionNew::Failed(Mover var1) {
    // TODO: Implement Failed
}

void LuaTimedActionNew::Succeeded(Path var1, Mover var2) {
    // TODO: Implement Succeeded
}

void LuaTimedActionNew::Pathfind(IsoGameCharacter var1, int var2, int var3, int var4) {
...
void LuaTimedActionNew::setCurrentTime(float var1) {
    // TODO: Implement setCurrentTime
}

void LuaTimedActionNew::setTime(int var1) {
    // TODO: Implement setTime
}

void LuaTimedActionNew::OnAnimEvent(AnimEvent var1) {
