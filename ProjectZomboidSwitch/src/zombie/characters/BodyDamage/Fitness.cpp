...
public Fitness::Fitness(IsoGameCharacter var1) {
...
void Fitness::increasePain(const std::string& var1) {
    // TODO: Implement increasePain
}

void Fitness::setCurrentExercise(const std::string& var1) {
...
void Fitness::removeStiffnessValue(const std::string& var1) {
    // TODO: Implement removeStiffnessValue
}

void Fitness::save(ByteBuffer var1) {
    // TODO: Implement save
}

void Fitness::load(ByteBuffer var1, int var2) {
    // TODO: Implement load
}
...
int Fitness::getCurrentExeStiffnessTimer(const std::string& var1) {
    // TODO: Implement getCurrentExeStiffnessTimer
    return 0;
}

float Fitness::getCurrentExeStiffnessInc(const std::string& var1) {
...
void Fitness::setParent(IsoGameCharacter var1) {
    // TODO: Implement setParent
}

float Fitness::getRegularity(const std::string& var1) {
    // TODO: Implement getRegularity
    return 0;
}

void Fitness::setRegularityMap(float> var1) {
