...
public Nutrition::Nutrition(IsoPlayer var1) {
...
void Nutrition::save(ByteBuffer var1) {
    // TODO: Implement save
}

void Nutrition::load(ByteBuffer var1) {
    // TODO: Implement load
}
...
void Nutrition::setCarbohydrates(float var1) {
...
void Nutrition::setProteins(float var1) {
...
void Nutrition::setCalories(float var1) {
...
void Nutrition::setLipids(float var1) {
...
void Nutrition::setWeight(double var1) {
...
void Nutrition::setIncWeight(bool var1) {
...
void Nutrition::setIncWeightLot(bool var1) {
...
void Nutrition::setDecWeight(bool var1) {
