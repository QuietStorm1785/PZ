...
void ZombieVocalsManager::addCharacter(IsoZombie var1) {
...
bool ZombieVocalsManager::shouldPlay(IsoZombie var1) {
    // TODO: Implement shouldPlay
    return false;
}

int ZombieVocalsManager::getExistingSlot(IsoZombie var1) {
...
float ZombieVocalsManager::getClosestListener(float var1, float var2, float var3) {
