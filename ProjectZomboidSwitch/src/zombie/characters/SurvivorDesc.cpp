...
void SurvivorDesc::getItemVisuals(ItemVisuals var1) {
...
void SurvivorDesc::setWornItem(const std::string& var1, InventoryItem var2) {
    // TODO: Implement setWornItem
}

InventoryItem SurvivorDesc::getWornItem(const std::string& var1) {
    // TODO: Implement getWornItem
    return nullptr;
}

void SurvivorDesc::dressInNamedOutfit(const std::string& var1) {
...
void SurvivorDesc::setProfessionSkills(Profession var1) {
...
void SurvivorDesc::setIDCount(int var0) {
...
public SurvivorDesc::SurvivorDesc() {
    // TODO: Implement SurvivorDesc
    return nullptr;
}

public SurvivorDesc::SurvivorDesc(bool var1) {
    // TODO: Implement SurvivorDesc
    return nullptr;
}

public SurvivorDesc::SurvivorDesc(SurvivorDesc var1) {
    // TODO: Implement SurvivorDesc
    return nullptr;
}

void SurvivorDesc::meet(SurvivorDesc var1) {
    // TODO: Implement meet
}

bool SurvivorDesc::hasObservation(const std::string& var1) {
    // TODO: Implement hasObservation
    return false;
}

void SurvivorDesc::savePerk(ByteBuffer var1, Perk var2) {
    // TODO: Implement savePerk
}

Perk SurvivorDesc::loadPerk(ByteBuffer var1, int var2) {
    // TODO: Implement loadPerk
    return nullptr;
}

void SurvivorDesc::load(ByteBuffer var1, int var2, IsoGameCharacter var3) {
    // TODO: Implement load
}

void SurvivorDesc::save(ByteBuffer var1) {
    // TODO: Implement save
}

void SurvivorDesc::loadCompact(ByteBuffer var1) {
    // TODO: Implement loadCompact
}

void SurvivorDesc::saveCompact(ByteBuffer var1) {
    // TODO: Implement saveCompact
}

void SurvivorDesc::addObservation(const std::string& var1) {
...
int SurvivorDesc::getMetCount(SurvivorDesc var1) {
...
void SurvivorDesc::setForename(const std::string& var1) {
...
void SurvivorDesc::setID(int var1) {
...
void SurvivorDesc::setInstance(IsoGameCharacter var1) {
...
void SurvivorDesc::setSurname(const std::string& var1) {
...
void SurvivorDesc::setInventoryScript(const std::string& var1) {
...
void SurvivorDesc::setTorso(const std::string& var1) {
...
void SurvivorDesc::setBravery(float var1) {
...
void SurvivorDesc::setLoner(float var1) {
...
void SurvivorDesc::setAggressiveness(float var1) {
...
void SurvivorDesc::setCompassion(float var1) {
...
void SurvivorDesc::setTemper(float var1) {
...
void SurvivorDesc::setFriendliness(float var1) {
...
void SurvivorDesc::setFavourindoors(float var1) {
...
void SurvivorDesc::setLoyalty(float var1) {
...
void SurvivorDesc::setProfession(const std::string& var1) {
...
SurvivorType SurvivorDesc::getType() {
    // TODO: Implement getType
    return nullptr;
}

void SurvivorDesc::setType(SurvivorType var1) {
    // TODO: Implement setType
}

void SurvivorDesc::setFemale(bool var1) {
    // TODO: Implement setFemale
}

void SurvivorDesc::addTrouserColor(ColorInfo var0) {
    // TODO: Implement addTrouserColor
}

void SurvivorDesc::addHairColor(ColorInfo var0) {
