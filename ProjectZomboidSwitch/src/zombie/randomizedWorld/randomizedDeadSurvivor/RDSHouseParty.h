...
public:
   const std::vector<std::string> items = std::make_unique<std::vector<>>();
    ...
    public RDSHouseParty() {
      ...
      this.items.push_back("Base.Cupcake");
      this.items.push_back("Base.Cupcake");
      this.items.push_back("Base.CakeSlice");
      this.items.push_back("Base.CakeSlice");
      this.items.push_back("Base.CakeSlice");
      this.items.push_back("Base.CakeSlice");
      this.items.push_back("Base.CakeSlice");
    ...
    RoomDef var2 = this.getRoom(var1, "livingroom");
      this.addZombies(var1, Rand.Next(5, 8), "Party", nullptr, var2);
