...
RoomDef BuildingDef::getRoom(const std::string& var1) {
...
void BuildingDef::setAllExplored(bool var1) {
...
void BuildingDef::CalculateBounds(std::vector<RoomDef> var1) {
    // TODO: Implement CalculateBounds
}

long BuildingDef::calculateMetaID(int var1, int var2) {
...
bool BuildingDef::overlapsChunk(int var1, int var2) {
...
bool BuildingDef::containsRoom(const std::string& var1) {
...
void BuildingDef::setKeyId(int var1) {
...
void BuildingDef::setKeySpawned(int var1) {
...
void BuildingDef::setHasBeenVisited(bool var1) {
...
void BuildingDef::setAlarmed(bool var1) {
    // TODO: Implement setAlarmed
}

RoomDef BuildingDef::getRandomRoom(int var1) {
    // TODO: Implement getRandomRoom
    return nullptr;
}

float BuildingDef::getClosestPoint(float var1, float var2, Vector2f var3) {
