...
public PlayerCamera::PlayerCamera(int var1) {
...
void PlayerCamera::returnToCenter(float var1) {
...
float PlayerCamera::XToIso(float var1, float var2, float var3) {
    // TODO: Implement XToIso
    return 0;
}

float PlayerCamera::YToIso(float var1, float var2, float var3) {
    // TODO: Implement YToIso
    return 0;
}

float PlayerCamera::YToScreenExact(float var1, float var2, float var3, int var4) {
    // TODO: Implement YToScreenExact
    return 0;
}

float PlayerCamera::XToScreenExact(float var1, float var2, float var3, int var4) {
    // TODO: Implement XToScreenExact
    return 0;
}

void PlayerCamera::copyFrom(PlayerCamera var1) {
    // TODO: Implement copyFrom
}

void PlayerCamera::initFromIsoCamera(int var1) {
