...
IsoBarricade BarricadeAble::getBarricadeForCharacter(IsoGameCharacter var1) {
    // TODO: Implement getBarricadeForCharacter
    return nullptr;
}

IsoBarricade BarricadeAble::getBarricadeOppositeCharacter(IsoGameCharacter var1) {
