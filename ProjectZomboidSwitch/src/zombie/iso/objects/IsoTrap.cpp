...
public IsoTrap::IsoTrap(IsoCell var1) {
    // TODO: Implement IsoTrap
    return nullptr;
}

public IsoTrap::IsoTrap(HandWeapon var1, IsoCell var2, IsoGridSquare var3) {
    // TODO: Implement IsoTrap
    return nullptr;
}

void IsoTrap::initSprite(HandWeapon var1) {
...
void IsoTrap::render(float var1, float var2, float var3, ColorInfo var4, bool var5, bool var6, Shader var7) {
    // TODO: Implement render
}

void IsoTrap::triggerExplosion(bool var1) {
...
void IsoTrap::load(ByteBuffer var1, int var2, bool var3) {
    // TODO: Implement load
}

void IsoTrap::save(ByteBuffer var1, bool var2) {
    // TODO: Implement save
}
...
void IsoTrap::setTimerBeforeExplosion(int var1) {
...
void IsoTrap::setSensorRange(int var1) {
...
void IsoTrap::setFireRange(int var1) {
...
void IsoTrap::setFirePower(int var1) {
...
void IsoTrap::setExplosionPower(int var1) {
...
void IsoTrap::setNoiseDuration(int var1) {
...
void IsoTrap::setNoiseRange(int var1) {
...
void IsoTrap::setExplosionRange(int var1) {
...
void IsoTrap::setSmokeRange(int var1) {
...
void IsoTrap::setExtraDamage(float var1) {
...
void IsoTrap::setRemoteControlID(int var1) {
...
void IsoTrap::setCountDownSound(const std::string& var1) {
...
void IsoTrap::setExplosionSound(const std::string& var1) {
...
void IsoTrap::triggerRemote(IsoPlayer var0, int var1, int var2) {
