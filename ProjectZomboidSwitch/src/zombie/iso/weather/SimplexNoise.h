...
public:
   ...
   private static short[] permMod12 = new short[512];
    ...
    static double dot(Grad var0, double var1, double var3) {
      return var0.x * var1 + var0.y * var3;
   }

    static double dot(Grad var0, double var1, double var3, double var5) {
      return var0.x * var1 + var0.y * var3 + var0.z * var5;
   }

    static double dot(Grad var0, double var1, double var3, double var5, double var7) {
      return var0.x * var1 + var0.y * var3 + var0.z * var5 + var0.w * var7;
   }

    static double noise(double var0, double var2) {
    double var10 = (var0 + var2) * F2;
    int var12 = fastfloor(var0 + var10);
    int var13 = fastfloor(var2 + var10);
    double var14 = (var12 + var13) * G2;
    double var16 = var12 - var14;
    double var18 = var13 - var14;
    ...
    double var26 = var20 - var24 + G2;
    double var28 = var22 - var25 + G2;
    double var30 = var20 - 1.0 + 2.0 * G2;
    double var32 = var22 - 1.0 + 2.0 * G2;
    int var34 = var12 & 0xFF;
    int var35 = var13 & 0xFF;
    ...
    double var39 = 0.5 - var20 * var20 - var22 * var22;
    double var4;
      if (var39 < 0.0) {
         var4 = 0.0;
      } else {
    ...
    double var41 = 0.5 - var26 * var26 - var28 * var28;
    double var6;
      if (var41 < 0.0) {
         var6 = 0.0;
      } else {
    ...
    double var43 = 0.5 - var30 * var30 - var32 * var32;
    double var8;
      if (var43 < 0.0) {
         var8 = 0.0;
      } else {
    ...
    double var39 = var27 - var33 + 0.16666666666666666;
    double var41 = var29 - var34 + 0.16666666666666666;
    double var43 = var31 - var35 + 0.16666666666666666;
    double var45 = var27 - var36 + 0.3333333333333333;
    double var47 = var29 - var37 + 0.3333333333333333;
    double var49 = var31 - var38 + 0.3333333333333333;
    double var51 = var27 - 1.0 + 0.5;
    double var53 = var29 - 1.0 + 0.5;
    double var55 = var31 - 1.0 + 0.5;
    int var57 = var16 & 0xFF;
    int var58 = var17 & 0xFF;
    int var59 = var18 & 0xFF;
    ...
    double var64 = 0.6 - var27 * var27 - var29 * var29 - var31 * var31;
    double var6;
      if (var64 < 0.0) {
         var6 = 0.0;
      } else {
    ...
    double var66 = 0.6 - var39 * var39 - var41 * var41 - var43 * var43;
    double var8;
      if (var66 < 0.0) {
         var8 = 0.0;
      } else {
    ...
    double var68 = 0.6 - var45 * var45 - var47 * var47 - var49 * var49;
    double var10;
      if (var68 < 0.0) {
         var10 = 0.0;
      } else {
    ...
    double var70 = 0.6 - var51 * var51 - var53 * var53 - var55 * var55;
    double var12;
      if (var70 < 0.0) {
         var12 = 0.0;
      } else {
      ...
      return 32.0 * (var6 + var8 + var10 + var12);
   }

    static double noise(double var0, double var2, double var4, double var6) {
    ...
    double var24 = (var20 + var21 + var22 + var23) * G4;
    double var26 = var20 - var24;
    double var28 = var21 - var24;
    double var30 = var22 - var24;
    double var32 = var23 - var24;
    ...
    double var58 = var34 - var46 + G4;
    double var60 = var36 - var47 + G4;
    double var62 = var38 - var48 + G4;
    double var64 = var40 - var49 + G4;
    double var66 = var34 - var50 + 2.0 * G4;
    double var68 = var36 - var51 + 2.0 * G4;
    double var70 = var38 - var52 + 2.0 * G4;
    double var72 = var40 - var53 + 2.0 * G4;
    double var74 = var34 - var54 + 3.0 * G4;
    double var76 = var36 - var55 + 3.0 * G4;
    double var78 = var38 - var56 + 3.0 * G4;
    double var80 = var40 - var57 + 3.0 * G4;
    double var82 = var34 - 1.0 + 4.0 * G4;
    double var84 = var36 - 1.0 + 4.0 * G4;
    double var86 = var38 - 1.0 + 4.0 * G4;
    double var88 = var40 - 1.0 + 4.0 * G4;
    int var90 = var20 & 0xFF;
    int var91 = var21 & 0xFF;
    int var92 = var22 & 0xFF;
    int var93 = var23 & 0xFF;
    ...
    double var99 = 0.6 - var34 * var34 - var36 * var36 - var38 * var38 - var40 * var40;
    double var8;
      if (var99 < 0.0) {
         var8 = 0.0;
      } else {
    ...
    double var101 = 0.6 - var58 * var58 - var60 * var60 - var62 * var62 - var64 * var64;
    double var10;
      if (var101 < 0.0) {
         var10 = 0.0;
      } else {
    ...
    double var103 = 0.6 - var66 * var66 - var68 * var68 - var70 * var70 - var72 * var72;
    double var12;
      if (var103 < 0.0) {
         var12 = 0.0;
      } else {
    ...
    double var105 = 0.6 - var74 * var74 - var76 * var76 - var78 * var78 - var80 * var80;
    double var14;
      if (var105 < 0.0) {
         var14 = 0.0;
      } else {
    ...
    double var107 = 0.6 - var82 * var82 - var84 * var84 - var86 * var86 - var88 * var88;
    double var16;
      if (var107 < 0.0) {
         var16 = 0.0;
      } else {
      ...
      return 27.0 * (var8 + var10 + var12 + var14 + var16);
   }

   static {
      for (int var0 = 0; var0 < 512; var0++) {
         perm[var0] = p[var0 & 0xFF];
