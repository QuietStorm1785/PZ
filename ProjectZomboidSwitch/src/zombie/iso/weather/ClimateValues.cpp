...
public ClimateValues::ClimateValues(ClimateManager var1) {
...
void ClimateValues::CopyValues(ClimateValues var1) {
...
void ClimateValues::pollDate(int var1, int var2, int var3) {
    // TODO: Implement pollDate
}

void ClimateValues::pollDate(int var1, int var2, int var3, int var4) {
    // TODO: Implement pollDate
}

void ClimateValues::pollDate(int var1, int var2, int var3, int var4, int var5) {
    // TODO: Implement pollDate
}

void ClimateValues::pollDate(GregorianCalendar var1) {
    // TODO: Implement pollDate
}

void ClimateValues::updateValues(double var1, float var3, DayInfo var4, DayInfo var5) {
