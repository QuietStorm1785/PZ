...
IsoSpriteInstance IsoSpriteInstance::get(IsoSprite var0) {
    // TODO: Implement get
    return nullptr;
}
...
public IsoSpriteInstance::IsoSpriteInstance() {
    // TODO: Implement IsoSpriteInstance
    return nullptr;
}

void IsoSpriteInstance::setFrameSpeedPerFrame(float var1) {
...
public IsoSpriteInstance::IsoSpriteInstance(IsoSprite var1) {
    // TODO: Implement IsoSpriteInstance
    return nullptr;
}
...
void IsoSpriteInstance::render(IsoObject var1, float var2, float var3, float var4, IsoDirections var5, float var6, float var7, ColorInfo var8) {
    // TODO: Implement render
}

void IsoSpriteInstance::SetAlpha(float var1) {
    // TODO: Implement SetAlpha
}

void IsoSpriteInstance::SetTargetAlpha(float var1) {
...
void IsoSpriteInstance::renderprep(IsoObject var1) {
...
void IsoSpriteInstance::RenderGhostTileColor(int var1, int var2, int var3, float var4, float var5, float var6, float var7) {
    // TODO: Implement RenderGhostTileColor
}

void IsoSpriteInstance::setScale(float var1, float var2) {
...
void IsoSpriteInstance::scaleAspect(float var1, float var2, float var3, float var4) {
    // TODO: Implement scaleAspect
}

void IsoSpriteInstance::add(IsoSpriteInstance var0) {
    // TODO: Implement add
}
