...
bool Mouse::isButtonDown(int var0) {
    // TODO: Implement isButtonDown
    return false;
}

void Mouse::UIBlockButtonDown(int var0) {
    // TODO: Implement UIBlockButtonDown
}

bool Mouse::isButtonDownUICheck(int var0) {
...
Cursor Mouse::loadCursor(const std::string& var0) {
...
void Mouse::setCursorVisible(bool var0) {
