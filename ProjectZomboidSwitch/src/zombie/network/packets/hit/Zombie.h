...
public:
    ...
    void set(IsoZombie var1, bool var2) {
      super.set(var1);
      this.zombie = var1;
      this.zombieFlags = 0;
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isStaggerBack() ? 1 : 0));
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isFakeDead() ? 2 : 0));
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isBecomeCrawler() ? 4 : 0));
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isCrawling() ? 8 : 0));
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isKnifeDeath() ? 16 : 0));
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.isJawStabAttach() ? 32 : 0));
      this.zombieFlags |= (short)(var2 ? 64 : 0);
      this.zombieFlags = (short)(this.zombieFlags | (short)(var1.getVariableBoolean("AttackDidDamage") ? 128 : 0));
    ...
    bool isConsistent() {
      return super.isConsistent() && this.zombie != nullptr;
   }
