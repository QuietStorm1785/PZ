...
public:
    ...
    PlayerItem bandage = std::make_shared<PlayerItem>();
    ...
    int var1 = this.wielder.getCharacter().getPerkLevel(Perks.Doctor);
      ...
      this.wielder.getCharacter().getXp().AddXP(Perks.Doctor, 10.0F);
    int var2 = 60 - var1 * 1;
    ...
    bool isConsistent() {
      return this.wielder.getCharacter() != nullptr && this.target.getCharacter() != nullptr && this.bodyPart.getBodyPart() != nullptr && this.bandage.getItem() != nullptr;
   }
    ...
    std::string var1 = "\n\t" + this.getClass().getSimpleName() + " [";
      ...
      return var1 + "bandage=" + this.bandage + "] ";
   }
}
} // namespace packets
} // namespace network
