...
public:
   ...
   public AmbientStreamManager$Ambient(std::string var1, float var2, float var3, float var4, float var5) {
      this(var1, var2, var3, var4, var5, false);
   }

   public AmbientStreamManager$Ambient(std::string var1, float var2, float var3, float var4, float var5, boolean var6) {
      this.name = var1;
      this.x = var2;
      this.y = var3;
      this.radius = var4;
    ...
    void repeatWorldSounds(int var1, int var2) {
      this.worldSoundRadius = var1;
      this.worldSoundVolume = var2;
   }

    IsoGameCharacter getClosestListener(float var1, float var2) {
