...
#include "zombie/erosion/categories/NatureGeneric/CategoryData.h"
...
public:
   ...
   private int[] spawnChance = new int[100];
    ...
    IsoSprite var9 = var8.getSprite();
         if (var9 != nullptr && var9.getName() != nullptr && var9.getName().startsWith("blends_grassoverlays")) {
    float var10 = 0.3F;
    float var11 = 12.0F;
            if ("Forest" == var1.getZoneType())) {
               var10 = 0.5F;
               var11 = 6.0F;
            } else if ("DeepForest" == var1.getZoneType())) {
               var10 = 0.7F;
               var11 = 3.0F;
            }

    CategoryData var12 = (CategoryData)this.setCatModData(var2);
    std::vector var13 = this.objsRef.get(0);
    ...
    int var15 = var2.rand(var1.x, var1.y, 101);
            ...
            var12.gameObj = (int)var13.get(var2.rand(var1.x, var1.y, var13.size()));
    ...
    std::vector var11 = this.objsRef.get(0);
    int var12 = var2.rand(var1.x, var1.y, 101);
            ...
            var10.gameObj = (int)var11.get(var2.rand(var1.x, var1.y, var11.size()));
            var10.stage = 0;
    ...
    ErosionObjSprites var4 = std::make_shared<ErosionObjSprites>(3, "Grass", false, false, false);
    ...
    ErosionObj var14 = std::make_shared<ErosionObj>(var4, 60, 0.0F, 0.0F, false);
         this.objs.push_back(var14);
         this.objsRef.get(0).push_back(this.objs.size() - 1);
      }

      for (int var10 = 0; var10 <= 15; var10++) {
    ErosionObjSprites var12 = std::make_shared<ErosionObjSprites>(2, "Generic", false, false, false);
    ...
    ErosionObj var16 = std::make_shared<ErosionObj>(var12, 60, 0.0F, 0.0F, true);
         this.objs.push_back(var16);
         this.objsRef.get(2).push_back(this.objs.size() - 1);
      }

    ErosionIceQueen var11 = ErosionIceQueen.instance;

      for (int var13 = 0; var13 <= 7; var13++) {
    ErosionObjSprites var17 = std::make_shared<ErosionObjSprites>(2, "Fern", true, false, false);
    ...
    ErosionObj var20 = std::make_shared<ErosionObj>(var17, 60, 0.0F, 0.0F, true);
         this.objs.push_back(var20);
         this.objsRef.get(1).push_back(this.objs.size() - 1);
      }
   }
    ...
    int getGroundGrassType(IsoGridSquare var1) {
    IsoObject var2 = var1.getFloor();
      if (var2 == nullptr) {
    return 0;
      } else {
    IsoSprite var3 = var2.getSprite();
         if (var3 != nullptr && var3.getName() != nullptr && var3.getName().startsWith("blends_natural_01_")) {
    int var4 = 0;
