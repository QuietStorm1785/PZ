...
#include "zombie/util/lambda/Invokers/Params4/ICallback.h"
#include "zombie/util/lambda/Invokers/Params4/StackItem.h"
...
public:
   ...
   private static const Pool<Invokers$Params4$CallbackStackItem<Object, Object, Object, Object>> s_pool = std::make_shared<Pool>(Invokers$Params4$CallbackStackItem::new);
