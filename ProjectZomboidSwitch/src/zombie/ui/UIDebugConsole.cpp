...
public UIDebugConsole::UIDebugConsole(int var1, int var2) {
...
void UIDebugConsole::onOtherKey(int var1) {
...
void UIDebugConsole::SpoolText(const std::string& var1) {
    // TODO: Implement SpoolText
}

Method UIDebugConsole::SuggestionEngine(const std::string& var1) {
    // TODO: Implement SuggestionEngine
    return nullptr;
}

Method UIDebugConsole::SuggestionEngine(const std::string& var1, std::vector<Method> var2) {
    // TODO: Implement SuggestionEngine
    return nullptr;
}
...
int UIDebugConsole::levenshteinDistance(CharSequence var1, CharSequence var2) {
    // TODO: Implement levenshteinDistance
    return 0;
}

void UIDebugConsole::setSuggestWidth(int var1) {
    // TODO: Implement setSuggestWidth
}

void UIDebugConsole::addOutput(byte[] var1, int var2, int var3) {
