...
public Clothing::Clothing(const std::string& var1, const std::string& var2, const std::string& var3, const std::string& var4, const std::string& var5, const std::string& var6) {
    // TODO: Implement Clothing
    return nullptr;
}

public Clothing::Clothing(const std::string& var1, const std::string& var2, const std::string& var3, Item var4, const std::string& var5, const std::string& var6) {
    // TODO: Implement Clothing
    return nullptr;
}
...
void Clothing::DoTooltip(ObjectTooltip var1, Layout var2) {
...
void Clothing::updateWetness(bool var1) {
    // TODO: Implement updateWetness
}
...
void Clothing::setBulletDefense(float var1) {
    // TODO: Implement setBulletDefense
}

WetDryState Clothing::getWetDryState() {
    // TODO: Implement getWetDryState
    return nullptr;
}
...
void Clothing::Use(bool var1, bool var2) {
    // TODO: Implement Use
}

bool Clothing::CanStack(InventoryItem var1) {
    // TODO: Implement CanStack
    return false;
}

Clothing Clothing::CreateFromSprite(const std::string& var0) {
    // TODO: Implement CreateFromSprite
    return nullptr;
}

void Clothing::save(ByteBuffer var1, bool var2) {
    // TODO: Implement save
}

void Clothing::load(ByteBuffer var1, int var2) {
    // TODO: Implement load
}
...
void Clothing::setSpriteName(const std::string& var1) {
...
void Clothing::setPalette(const std::string& var1) {
...
void Clothing::setTemperature(float var1) {
    // TODO: Implement setTemperature
}

void Clothing::setDirtyness(float var1) {
    // TODO: Implement setDirtyness
}

void Clothing::setBloodLevel(float var1) {
...
float Clothing::getBloodlevelForPart(BloodBodyPartType var1) {
...
void Clothing::setWetness(float var1) {
...
void Clothing::setWeightWet(float var1) {
...
void Clothing::setConditionLowerChance(int var1) {
    // TODO: Implement setConditionLowerChance
}

void Clothing::setCondition(int var1) {
...
void Clothing::setInsulation(float var1) {
...
void Clothing::setStompPower(float var1) {
...
void Clothing::setRunSpeedModifier(float var1) {
...
void Clothing::setCombatSpeedModifier(float var1) {
...
void Clothing::setRemoveOnBroken(bool var1) {
...
void Clothing::setCanHaveHoles(bool var1) {
...
void Clothing::setBiteDefense(float var1) {
...
void Clothing::setScratchDefense(float var1) {
...
void Clothing::setNeckProtectionModifier(float var1) {
...
void Clothing::setChanceToFall(int var1) {
...
void Clothing::setWindresistance(float var1) {
...
void Clothing::setWaterResistance(float var1) {
...
float Clothing::getDefForPart(BloodBodyPartType var1, bool var2, bool var3) {
    // TODO: Implement getDefForPart
    return 0;
}

int Clothing::getBiteDefenseFromItem(IsoGameCharacter var0, InventoryItem var1) {
    // TODO: Implement getBiteDefenseFromItem
    return 0;
}

int Clothing::getScratchDefenseFromItem(IsoGameCharacter var0, InventoryItem var1) {
    // TODO: Implement getScratchDefenseFromItem
    return 0;
}

ClothingPatch Clothing::getPatchType(BloodBodyPartType var1) {
    // TODO: Implement getPatchType
    return nullptr;
}

void Clothing::removePatch(BloodBodyPartType var1) {
    // TODO: Implement removePatch
}

bool Clothing::canFullyRestore(IsoGameCharacter var1, BloodBodyPartType var2, InventoryItem var3) {
    // TODO: Implement canFullyRestore
    return false;
}

void Clothing::addPatch(IsoGameCharacter var1, BloodBodyPartType var2, InventoryItem var3) {
...
void Clothing::copyPatchesTo(Clothing var1) {
