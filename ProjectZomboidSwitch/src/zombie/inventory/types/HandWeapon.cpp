...
bool HandWeapon::CanStack(InventoryItem var1) {
...
public HandWeapon::HandWeapon(const std::string& var1, const std::string& var2, const std::string& var3, const std::string& var4) {
    // TODO: Implement HandWeapon
    return nullptr;
}

public HandWeapon::HandWeapon(const std::string& var1, const std::string& var2, const std::string& var3, Item var4) {
    // TODO: Implement HandWeapon
    return nullptr;
}
...
float HandWeapon::getScore(SurvivorDesc var1) {
...
void HandWeapon::DoTooltip(ObjectTooltip var1, Layout var2) {
    // TODO: Implement DoTooltip
}

float HandWeapon::getDamageMod(IsoGameCharacter var1) {
    // TODO: Implement getDamageMod
    return 0;
}

float HandWeapon::getRangeMod(IsoGameCharacter var1) {
    // TODO: Implement getRangeMod
    return 0;
}

float HandWeapon::getFatigueMod(IsoGameCharacter var1) {
    // TODO: Implement getFatigueMod
    return 0;
}

float HandWeapon::getKnockbackMod(IsoGameCharacter var1) {
    // TODO: Implement getKnockbackMod
    return 0;
}

float HandWeapon::getSpeedMod(IsoGameCharacter var1) {
    // TODO: Implement getSpeedMod
    return 0;
}

float HandWeapon::getToHitMod(IsoGameCharacter var1) {
...
void HandWeapon::setAngleFalloff(bool var1) {
...
void HandWeapon::setCanBarracade(bool var1) {
...
void HandWeapon::setDoSwingBeforeImpact(float var1) {
...
void HandWeapon::setImpactSound(const std::string& var1) {
...
void HandWeapon::setKnockBackOnNoDeath(bool var1) {
...
void HandWeapon::setMaxAngle(float var1) {
...
void HandWeapon::setMaxDamage(float var1) {
...
void HandWeapon::setMaxHitCount(int var1) {
...
float HandWeapon::getMaxRange(IsoGameCharacter var1) {
    // TODO: Implement getMaxRange
    return 0;
}

void HandWeapon::setMaxRange(float var1) {
...
void HandWeapon::setRanged(bool var1) {
...
void HandWeapon::setMinAngle(float var1) {
...
void HandWeapon::setMinDamage(float var1) {
...
void HandWeapon::setMinimumSwingTime(float var1) {
...
void HandWeapon::setMinRange(float var1) {
...
void HandWeapon::setNoiseFactor(float var1) {
...
void HandWeapon::setOtherHandRequire(const std::string& var1) {
...
void HandWeapon::setOtherHandUse(bool var1) {
...
void HandWeapon::setPhysicsObject(const std::string& var1) {
...
void HandWeapon::setPushBackMod(float var1) {
...
void HandWeapon::setRangeFalloff(bool var1) {
...
void HandWeapon::setShareDamage(bool var1) {
...
void HandWeapon::setSoundRadius(int var1) {
...
void HandWeapon::setSoundVolume(int var1) {
...
void HandWeapon::setSplatBloodOnNoDeath(bool var1) {
...
void HandWeapon::setSplatNumber(int var1) {
...
void HandWeapon::setSwingSound(const std::string& var1) {
...
void HandWeapon::setSwingTime(float var1) {
...
void HandWeapon::setToHitModifier(float var1) {
...
void HandWeapon::setUseEndurance(bool var1) {
...
void HandWeapon::setUseSelf(bool var1) {
...
void HandWeapon::setWeaponSprite(const std::string& var1) {
...
void HandWeapon::setOtherBoost(float var1) {
...
void HandWeapon::setDoorDamage(int var1) {
...
void HandWeapon::setDoorHitSound(const std::string& var1) {
...
void HandWeapon::setConditionLowerChance(int var1) {
...
void HandWeapon::setMultipleHitConditionAffected(bool var1) {
...
void HandWeapon::setShareEndurance(bool var1) {
...
void HandWeapon::setAlwaysKnockdown(bool var1) {
...
void HandWeapon::setEnduranceMod(float var1) {
...
void HandWeapon::setKnockdownMod(float var1) {
...
void HandWeapon::setCantAttackWithLowestEndurance(bool var1) {
...
void HandWeapon::setProjectileCount(int var1) {
...
void HandWeapon::setCriticalChance(float var1) {
...
void HandWeapon::setSubCategory(const std::string& var1) {
...
void HandWeapon::setZombieHitSound(const std::string& var1) {
...
void HandWeapon::setCategories(std::vector<std::string> var1) {
...
void HandWeapon::setAimingPerkCritModifier(int var1) {
...
void HandWeapon::setAimingPerkRangeModifier(float var1) {
...
void HandWeapon::setHitChance(int var1) {
...
void HandWeapon::setAimingPerkHitChanceModifier(float var1) {
...
void HandWeapon::setAimingPerkMinAngleModifier(float var1) {
...
void HandWeapon::setRecoilDelay(int var1) {
...
void HandWeapon::setPiercingBullets(bool var1) {
...
void HandWeapon::setSoundGain(float var1) {
...
void HandWeapon::setScope(WeaponPart var1) {
...
void HandWeapon::setClip(WeaponPart var1) {
...
void HandWeapon::setCanon(WeaponPart var1) {
...
void HandWeapon::setRecoilpad(WeaponPart var1) {
...
void HandWeapon::setClipSize(int var1) {
    // TODO: Implement setClipSize
}

void HandWeapon::save(ByteBuffer var1, bool var2) {
    // TODO: Implement save
}

void HandWeapon::load(ByteBuffer var1, int var2) {
    // TODO: Implement load
}
...
void HandWeapon::setMinRangeRanged(float var1) {
...
void HandWeapon::setReloadTime(int var1) {
...
void HandWeapon::setSling(WeaponPart var1) {
...
void HandWeapon::setAimingTime(int var1) {
...
void HandWeapon::setStock(WeaponPart var1) {
...
void HandWeapon::setTreeDamage(int var1) {
...
void HandWeapon::setBulletOutSound(const std::string& var1) {
...
void HandWeapon::setShellFallSound(const std::string& var1) {
    // TODO: Implement setShellFallSound
}

void HandWeapon::addPartToList(const std::string& var1, std::vector<WeaponPart> var2) {
    // TODO: Implement addPartToList
}

void HandWeapon::setWeaponPart(const std::string& var1, WeaponPart var2) {
    // TODO: Implement setWeaponPart
}

WeaponPart HandWeapon::getWeaponPart(const std::string& var1) {
    // TODO: Implement getWeaponPart
    return nullptr;
}

float HandWeapon::getWeaponPartWeightModifier(const std::string& var1) {
    // TODO: Implement getWeaponPartWeightModifier
    return 0;
}

float HandWeapon::getWeaponPartWeightModifier(WeaponPart var1) {
    // TODO: Implement getWeaponPartWeightModifier
    return 0;
}

void HandWeapon::attachWeaponPart(WeaponPart var1) {
    // TODO: Implement attachWeaponPart
}

void HandWeapon::attachWeaponPart(WeaponPart var1, bool var2) {
    // TODO: Implement attachWeaponPart
}

void HandWeapon::detachWeaponPart(WeaponPart var1) {
...
void HandWeapon::setTriggerExplosionTimer(int var1) {
...
void HandWeapon::setCanBePlaced(bool var1) {
...
void HandWeapon::setExplosionRange(int var1) {
...
void HandWeapon::setExplosionPower(int var1) {
...
void HandWeapon::setFireRange(int var1) {
...
void HandWeapon::setSmokeRange(int var1) {
...
void HandWeapon::setFirePower(int var1) {
...
void HandWeapon::setNoiseRange(int var1) {
...
void HandWeapon::setExtraDamage(float var1) {
...
void HandWeapon::setExplosionTimer(int var1) {
...
void HandWeapon::setPlacedSprite(const std::string& var1) {
...
void HandWeapon::setCanBeReused(bool var1) {
...
void HandWeapon::setSensorRange(int var1) {
...
void HandWeapon::setCritDmgMultiplier(float var1) {
...
void HandWeapon::setBaseSpeed(float var1) {
...
void HandWeapon::setBloodLevel(float var1) {
    // TODO: Implement setBloodLevel
}

void HandWeapon::setWeaponLength(float var1) {
...
void HandWeapon::setAmmoBox(const std::string& var1) {
...
void HandWeapon::setMagazineType(const std::string& var1) {
...
void HandWeapon::setRackSound(const std::string& var1) {
    // TODO: Implement setRackSound
}

bool HandWeapon::isReloadable(IsoGameCharacter var1) {
...
void HandWeapon::setContainsClip(bool var1) {
    // TODO: Implement setContainsClip
}

InventoryItem HandWeapon::getBestMagazine(IsoGameCharacter var1) {
...
void HandWeapon::setWeaponReloadType(const std::string& var1) {
...
void HandWeapon::setRackAfterShoot(bool var1) {
...
void HandWeapon::setRoundChambered(bool var1) {
...
void HandWeapon::setSpentRoundChambered(bool var1) {
...
void HandWeapon::setSpentRoundCount(int var1) {
...
void HandWeapon::setAmmoPerShoot(int var1) {
...
void HandWeapon::setJamGunChance(float var1) {
...
void HandWeapon::setJammed(bool var1) {
...
void HandWeapon::setClickSound(const std::string& var1) {
    // TODO: Implement setClickSound
}

void HandWeapon::setModelWeaponPart(std::vector<ModelWeaponPart> var1) {
...
void HandWeapon::setOriginalWeaponSprite(const std::string& var1) {
...
void HandWeapon::setHaveChamber(bool var1) {
...
void HandWeapon::setDamageCategory(const std::string& var1) {
...
void HandWeapon::setDamageMakeHole(bool var1) {
...
void HandWeapon::setHitFloorSound(const std::string& var1) {
...
void HandWeapon::setInsertAllBulletsReload(bool var1) {
...
void HandWeapon::setFireMode(const std::string& var1) {
    // TODO: Implement setFireMode
}

void HandWeapon::setFireModePossibilities(std::vector<std::string> var1) {
