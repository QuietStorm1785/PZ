...
public:
    ...
    public AlarmClock(const std::string& var1, const std::string& var2, const std::string& var3, const std::string& var4) {
      super(var1, var2, var3, var4);
      if (var2.contains("Classic")) {
    ...
    public AlarmClock(const std::string& var1, const std::string& var2, const std::string& var3, Item var4) {
      super(var1, var2, var3, var4);
      if (var2.contains("Classic")) {
         this.isDigital = false;
      }
    ...
    IsoGridSquare var1 = this.getAlarmSquare();
         if (var1 != nullptr) {
    BaseSoundEmitter var2 = IsoWorld.instance.getFreeEmitter(var1.x + 0.5F, var1.y + 0.5F, var1.z);
