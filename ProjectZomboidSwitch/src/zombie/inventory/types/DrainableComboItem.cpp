...
public DrainableComboItem::DrainableComboItem(const std::string& var1, const std::string& var2, const std::string& var3, const std::string& var4) {
    // TODO: Implement DrainableComboItem
    return nullptr;
}

public DrainableComboItem::DrainableComboItem(const std::string& var1, const std::string& var2, const std::string& var3, Item var4) {
    // TODO: Implement DrainableComboItem
    return nullptr;
}
...
bool DrainableComboItem::CanStack(InventoryItem var1) {
...
void DrainableComboItem::setUsedDelta(float var1) {
...
void DrainableComboItem::setWeightEmpty(float var1) {
...
void DrainableComboItem::setUseWhileEquiped(bool var1) {
...
void DrainableComboItem::setUseWhileUnequiped(bool var1) {
...
void DrainableComboItem::setTicksPerEquipUse(int var1) {
...
void DrainableComboItem::setUseDelta(float var1) {
...
void DrainableComboItem::setDelta(float var1) {
...
void DrainableComboItem::setTicks(float var1) {
    // TODO: Implement setTicks
}

void DrainableComboItem::setReplaceOnDeplete(const std::string& var1) {
...
void DrainableComboItem::setHeat(float var1) {
...
void DrainableComboItem::setRainFactor(float var1) {
...
void DrainableComboItem::setCanConsolidate(bool var1) {
    // TODO: Implement setCanConsolidate
}

void DrainableComboItem::setReplaceOnCooked(List<std::string> var1) {
...
void DrainableComboItem::setOnCooked(const std::string& var1) {
