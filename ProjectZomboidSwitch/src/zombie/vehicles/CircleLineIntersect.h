...
public:
    static Collideresult checkforcecirclescollidetime(List<ForceCircle> var0, std::vector<StaticLine> var1, double[] var2, boolean[] var3, bool var4) {
      ...
      for (int var10 = var0.size() - 1; var10 >= 0; var10--) {
         var7[var10] = -1.0;
         var8[var10] = std::make_unique<Collideclassindex>();
    ...
    double var29 = (var5.getY() - var20.getY()) / var25;
                        ...
                        if (var7[var11] == -1.0) {
                           var6[var11] = std::make_shared<PointVector>(var16, var18);
                        } else {
    ...
    RectVector var63 = nullptr;
                           if (!var8[var11].collided() || var7[var11] != var61) {
                              for (int var123 = 0; var123 < var8[var11].size(); var123++) {
                                 if (var8[var11].collided()
                                    ...
                                    && var7[var11] > var61) {
                                    var6[((Collider)var8[var11].getColliders().get(var123)).getCollidewith()] = std::make_shared<PointVector>(
                           ...
                           if (Point.distanceSq(var45, var47, var5.getX(), var5.getY()) < 1.0E-8) {
                              ...
                              var63 = std::make_shared<RectVector>(
                              ...
                              var63 = std::make_shared<RectVector>(var63.getvx() * var5.getLength(), var63.getvy() * var5.getLength());
                           } else {
                              var63 = std::make_shared<RectVector>(var5.getX() - 2.0 * (var45 - var30) - var30, var5.getY() - 2.0 * (var47 - var32) - var32);
                              var63 = (RectVector)var63.getUnitVector();
                              var63 = std::make_shared<RectVector>(var63.getvx() * var5.getLength(), var63.getvy() * var5.getLength());
                           }
                           ...
                           var63 = std::make_shared<RectVector>(var63.getvx() * var5.getLength(), var63.getvy() * var5.getLength());
                           if (var7[var11] == -1.0) {
                              var6[var11] = std::make_shared<PointVector>(var30, var32);
                           } else {
    ...
    RectVector var73 = nullptr;
                           if (!var8[var11].collided() || var7[var11] != var71) {
                              for (int var74 = 0; var74 < var8[var11].size(); var74++) {
                                 if (var8[var11].collided()
                                    ...
                                    && var7[var11] > var71) {
                                    var6[((Collider)var8[var11].getColliders().get(var74)).getCollidewith()] = std::make_shared<PointVector>(
                           ...
                           var73 = std::make_shared<RectVector>(var30 - (var45 - var30) - var30, var32 - (var47 - var32) - var32);
                           var73 = (RectVector)var73.getUnitVector();
                           var73 = std::make_shared<RectVector>(var73.getvx() * var5.getLength(), var73.getvy() * var5.getLength());
                           if (var7[var11] == -1.0) {
                              var6[var11] = std::make_shared<PointVector>(var30, var32);
                           } else {
                              var6[var11].setPoint(var30, var32);
    ...
    std::vector var77 = new std::vector((int)Math.ceil(var0.size() / 10));
    ...
    void* var97 = ((Collider)var8[var78].getColliders().get(var96)).getCollideobj();
                  var90 += ((ForceCircle)var0.get(var78)).getRestitution(((Collider)var8[var78].getColliders().get(var96)).getCollideobj());
                  if (dynamic_cast<StaticLine*>(var97) != nullptr && ((Collider)var8[var78].getColliders().get(var96)).getCollideforce() != nullptr) {
               ...
               if (var7[var78] == -1.0) {
                  var6[var78] = std::make_shared<PointVector>(var6[var78].getX(), var6[var78].getY());
               }

               var6[var78].setRect(var79 * var90, var15 * var90);
               var77.push_back(var78);
      ...
      return std::make_shared<Collideresult>(var6, var8, var77, var2, var9, var3);
   }

    static Collideresult checkforcecirclescollide(List<ForceCircle> var0, std::vector<StaticLine> var1, double[] var2, boolean[] var3, bool var4) {
    ...
    static Collideresult checkforcecirclescollide(List<ForceCircle> var0, std::vector<StaticLine> var1) {
    ...
    static bool TEST(Vector3f var0, float var1, float var2, float var3, float var4, CarController var5) {
    Vector3f var6 = std::make_shared<Vector3f>();
      var0.cross(std::make_shared<Vector3f>(0.0F, 1.0F, 0.0F), var6);
      var0.x *= var4;
      var0.z *= var4;
      var6.x *= var3;
      var6.z *= var3;
    ...
    StaticLine var22;
      var19.push_back(var22 = std::make_shared<StaticLine>(var11, var17, var12, var18));
    StaticLine var21;
      var19.push_back(var21 = std::make_shared<StaticLine>(var12, var18, var14, var16));
    StaticLine var23;
      var19.push_back(var23 = std::make_shared<StaticLine>(var14, var16, var13, var15));
    StaticLine var20;
      var19.push_back(var20 = std::make_shared<StaticLine>(var13, var15, var11, var17));
    IsoPlayer var24 = IsoPlayer.getInstance();
    std::vector var25 = new std::vector();
    uint8_t var26 = 8;
    ForceCircle var27 = std::make_shared<ForceCircle>(var24.x, var24.y, var24.nx - var24.x, var24.ny - var24.y, 0.295);
      if (var5 != nullptr) {
         var5.drawCircle((float)var27.getX2(), (float)var27.getY2(), 0.3F);
      }

      var25.push_back(var27);
    Collideresult var28 = checkforcecirclescollide(var25, var19);
      ...
      if (var28.collidelist.empty()) {
    return false;
      } else {
    int var30 = var28.collideinto.length;
    Vector2f var31 = std::make_shared<Vector2f>(var24.nx - var24.x, var24.ny - var24.y);
