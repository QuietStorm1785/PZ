...
public:
    ...
    float w;
    float h;
   static const ArrayDeque<CollideWithObstaclesPoly$ImmutableRectF> pool = std::make_unique<ArrayDeque<>>();

   private CollideWithObstaclesPoly$ImmutableRectF() {
   }
   ...
   CollideWithObstaclesPoly$ImmutableRectF init(float var1, float var2, float var3, float var4) {
    ...
    bool intersects(CollideWithObstaclesPoly$ImmutableRectF var1) {
