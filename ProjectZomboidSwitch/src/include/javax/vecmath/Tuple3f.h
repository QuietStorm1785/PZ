...
public:
    ...
    void get(Tuple3f var1) {
      var1.x = this.x;
      var1.y = this.y;
      var1.z = this.z;
   }

    void add(Tuple3f var1, Tuple3f var2) {
      this.x = var1.x + var2.x;
      this.y = var1.y + var2.y;
      this.z = var1.z + var2.z;
   }

    void add(Tuple3f var1) {
      this.x = this.x + var1.x;
      this.y = this.y + var1.y;
      this.z = this.z + var1.z;
   }

    void sub(Tuple3f var1, Tuple3f var2) {
      this.x = var1.x - var2.x;
      this.y = var1.y - var2.y;
      this.z = var1.z - var2.z;
   }

    void sub(Tuple3f var1) {
      this.x = this.x - var1.x;
      this.y = this.y - var1.y;
      this.z = this.z - var1.z;
   }

    void negate(Tuple3f var1) {
      this.x = -var1.x;
      this.y = -var1.y;
      this.z = -var1.z;
   }
    ...
    void scale(float var1, Tuple3f var2) {
      this.x = var1 * var2.x;
      this.y = var1 * var2.y;
      this.z = var1 * var2.z;
   }
    ...
    bool epsilonEquals(Tuple3f var1, float var2) {
    ...
    void clamp(float var1, float var2, Tuple3f var3) {
      if (var3.x > var2) {
         this.x = var2;
      } else if (var3.x < var1) {
         this.x = var1;
    ...
    void clampMin(float var1, Tuple3f var2) {
      if (var2.x < var1) {
         this.x = var1;
      } else {
         this.x = var2.x;
    ...
    void clampMax(float var1, Tuple3f var2) {
      if (var2.x > var1) {
         this.x = var1;
      } else {
         this.x = var2.x;
