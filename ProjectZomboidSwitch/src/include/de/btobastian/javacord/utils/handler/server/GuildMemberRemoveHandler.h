...
#include "de/btobastian/javacord/utils/handler/server/GuildMemberRemoveHandler/1.h"
...
class GuildMemberRemoveHandler : public PacketHandler {
public:
    static const Logger logger = LoggerUtil.getLogger(GuildMemberRemoveHandler.class);
