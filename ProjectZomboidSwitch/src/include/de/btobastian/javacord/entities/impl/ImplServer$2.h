...
#include "de/btobastian/javacord/entities/impl/ImplServer/2/1.h"
...
class ImplServer {
public:
   ImplServer$2(ImplServer var1) {
      this.this$0 = var1;
   }

    Void call() {
      ImplServer.access$000().debug("Trying to leave server {}", this.this$0);
      HttpResponse<JsonNode> response = Unirest.delete("https://discordapp.com/api/v6/users/@me/guilds/" + ImplServer.access$200(this.this$0))
      ...
      ImplServer.access$000().info("Left server {}", this.this$0);
