...
public:
   ...
   private int[] submapResidues;
    ...
    int var7 = var2.getInt(8) + 1;
         ...
         for (int var8 = 0; var8 < var7; var8++) {
            ...
            if (this.magnitudes[var8] == this.angles[var8] || this.magnitudes[var8] >= var5 || this.angles[var8] >= var5) {
               ...
               throw VorbisFormatException("The channel magnitude and/or angle mismatch.");
            }
         }
      } else {
      ...
      if (var2.getInt(2) != 0) {
         throw VorbisFormatException("A reserved mapping field has an invalid value.");
      } else {
         this.mux = new int[var5];
         if (var4 > 1) {
            for (int var10 = 0; var10 < var5; var10++) {
               this.mux[var10] = var2.getInt(4);
               if (this.mux[var10] > var4) {
                  throw VorbisFormatException("A mapping mux value is higher than the number of submaps");
               }
            }
         } else {
    ...
    int var12 = var3.getFloors().length;
    int var13 = var3.getResidues().length;

         for (int var9 = 0; var9 < var4; var9++) {
            var2.getInt(8);
            this.submapFloors[var9] = var2.getInt(8);
            this.submapResidues[var9] = var2.getInt(8);
            if (this.submapFloors[var9] > var12) {
               throw VorbisFormatException("A mapping floor value is higher than the number of floors.");
            }

            if (this.submapResidues[var9] > var13) {
               throw VorbisFormatException("A mapping residue value is higher than the number of residues.");
            }
         }
      }
   }
