...
#include "gnu/trove/set/hash/THashSet/1.h"
#include "gnu/trove/set/hash/THashSet/HashProcedure.h"
#include <algorithm>
#include <fstream>
#include <iostream>
#include <iterator>
...
public:
    ...
    public THashSet(Collection<? extends) {
    ...
    int hashCode() {
      THashSet<E>.HashProcedure p = std::make_shared<HashProcedure>(this, nullptr);
      this.forEach(p);
