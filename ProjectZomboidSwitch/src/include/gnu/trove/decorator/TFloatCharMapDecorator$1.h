...
#include <cstdint>
#include "gnu/trove/decorator/TFloatCharMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TFloatCharMapDecorator {
public:
   TFloatCharMapDecorator$1(TFloatCharMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<float, char>> iterator() {
