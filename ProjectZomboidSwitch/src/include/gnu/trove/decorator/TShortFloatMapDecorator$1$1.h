...
public:
    const TShortFloatIterator it;

   TShortFloatMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<int16_t, float> next() {
      this.it.advance();
    ...
    float v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TShortFloatMapDecorator.1.1.1(this, v, key);
   }
