...
#include <cstdint>
#include "gnu/trove/decorator/TByteLongMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TByteLongMapDecorator$1(TByteLongMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, int64_t>> iterator() {
