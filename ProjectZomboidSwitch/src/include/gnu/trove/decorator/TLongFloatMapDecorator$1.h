...
#include <cstdint>
#include "gnu/trove/decorator/TLongFloatMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TLongFloatMapDecorator {
public:
   TLongFloatMapDecorator$1(TLongFloatMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int64_t, float>> iterator() {
