...
#include <cstdint>
#include "gnu/trove/decorator/TLongObjectMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TLongObjectMapDecorator$1(TLongObjectMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int64_t, V>> iterator() {
