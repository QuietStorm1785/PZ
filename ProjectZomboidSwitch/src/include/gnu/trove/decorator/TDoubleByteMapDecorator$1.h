...
#include <cstdint>
#include "gnu/trove/decorator/TDoubleByteMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TDoubleByteMapDecorator$1(TDoubleByteMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<double, uint8_t>> iterator() {
