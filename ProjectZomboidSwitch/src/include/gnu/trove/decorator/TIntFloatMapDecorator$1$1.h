...
public:
    const TIntFloatIterator it;

   TIntFloatMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<int, float> next() {
      this.it.advance();
    int ik = this.it.key();
    ...
    float v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TIntFloatMapDecorator.1.1.1(this, v, key);
   }
