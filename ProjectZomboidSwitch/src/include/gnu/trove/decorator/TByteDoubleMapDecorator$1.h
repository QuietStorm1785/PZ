...
#include <cstdint>
#include "gnu/trove/decorator/TByteDoubleMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TByteDoubleMapDecorator$1(TByteDoubleMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, double>> iterator() {
