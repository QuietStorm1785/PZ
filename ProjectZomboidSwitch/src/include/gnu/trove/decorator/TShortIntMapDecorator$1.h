...
#include <cstdint>
#include "gnu/trove/decorator/TShortIntMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TShortIntMapDecorator {
public:
   TShortIntMapDecorator$1(TShortIntMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, int>> iterator() {
