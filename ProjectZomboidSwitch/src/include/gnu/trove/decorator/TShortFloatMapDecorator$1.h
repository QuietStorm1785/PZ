...
#include <cstdint>
#include "gnu/trove/decorator/TShortFloatMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TShortFloatMapDecorator$1(TShortFloatMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, float>> iterator() {
    ...
    bool addAll(Collection<? extends, float>> c) {
      throw std::make_unique<UnsupportedOperationException>();
   }
