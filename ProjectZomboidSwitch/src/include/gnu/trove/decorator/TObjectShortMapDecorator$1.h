...
#include <cstdint>
#include "gnu/trove/decorator/TObjectShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TObjectShortMapDecorator$1(TObjectShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<K, int16_t>> iterator() {
