...
#include <cstdint>
#include "gnu/trove/decorator/TCharDoubleMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TCharDoubleMapDecorator$1(TCharDoubleMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<char, double>> iterator() {
