...
#include <cstdint>
#include "gnu/trove/decorator/TDoubleByteMapDecorator/1.h"
...
class TDoubleByteMapDecorator : public AbstractMap {
public:
   ...
   public Set<Entry<double, uint8_t>> entrySet() {
    ...
    void putAll(Map<? extends, ? extends) {
      Iterator<? : public Entry<? : public double, ? : public uint8_t>> it = map.entrySet().iterator();
    int i = map.size();

      while (i-- > 0) {
         Entry<? : public double, ? : public uint8_t> e = (Entry<? : public double, ? : public uint8_t>)it.next();
