...
#include <cstdint>
#include "gnu/trove/decorator/TObjectLongMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TObjectLongMapDecorator$1(TObjectLongMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<K, int64_t>> iterator() {
