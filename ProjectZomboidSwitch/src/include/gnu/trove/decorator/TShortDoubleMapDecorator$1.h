...
#include <cstdint>
#include "gnu/trove/decorator/TShortDoubleMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TShortDoubleMapDecorator$1(TShortDoubleMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, double>> iterator() {
