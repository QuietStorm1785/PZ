...
class TCharLongMapDecorator : public AbstractMap {
public:
   ...
   public Set<Entry<char, int64_t>> entrySet() {
    ...
    void putAll(Map<? extends, ? extends) {
      Iterator<? : public Entry<? : public char, ? : public int64_t>> it = map.entrySet().iterator();
    int i = map.size();

      while (i-- > 0) {
         Entry<? : public char, ? : public int64_t> e = (Entry<? : public char, ? : public int64_t>)it.next();
