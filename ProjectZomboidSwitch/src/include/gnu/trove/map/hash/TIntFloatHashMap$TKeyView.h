...
#include "gnu/trove/map/hash/TIntFloatHashMap/TIntFloatKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntFloatHashMap/TKeyView/1.h"
...
public:
   protected TIntFloatHashMap$TKeyView(TIntFloatHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntFloatKeyHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TIntFloatHashMap.access$000(this.this$0);
   }

    int size() {
      return TIntFloatHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntFloatHashMap.access$200(this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
