...
#include "gnu/trove/map/hash/TLongShortHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongShortHashMap/TLongShortKeyHashIterator.h"
...
public:
   protected TLongShortHashMap$TKeyView(TLongShortHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongShortKeyHashIterator>(this.this$0, this.this$0);
   }

    long getNoEntryValue() {
      return TLongShortHashMap.access$000(this.this$0);
   }

    int size() {
      return TLongShortHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongShortHashMap.access$200(this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongShortHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
