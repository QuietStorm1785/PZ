...
#include "gnu/trove/map/hash/TDoubleShortHashMap/TDoubleShortKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleShortHashMap/TKeyView/1.h"
...
public:
   protected TDoubleShortHashMap$TKeyView(TDoubleShortHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleShortKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleShortHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
