...
#include "gnu/trove/impl/hash/TShortIntHash.h"
#include "gnu/trove/iterator/TShortIntIterator.h"
#include "gnu/trove/map/TShortIntMap.h"
#include "gnu/trove/map/hash/TShortIntHashMap/1.h"
#include "gnu/trove/map/hash/TShortIntHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TShortIntHashMap/TShortIntHashIterator.h"
#include "gnu/trove/map/hash/TShortIntHashMap/TValueView.h"
...
class TShortIntHashMap : public TShortIntHash {
public:
   ...
   protected transient int[] _values;
    ...
    public TShortIntHashMap(TShortIntMap map) {
      super(map.size());
      if (dynamic_cast<TShortIntHashMap*>(map) != nullptr) {
    ...
    int doPut(short key, int value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int16_t, ? : public int> entry : map.entrySet()) {
   ...
   public int[] values(int[] array) {
    ...
    TShortIntIterator iterator() {
      return std::make_shared<TShortIntHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TShortIntMap*>(other) != nullptr)) {
    return false;
      } else {
