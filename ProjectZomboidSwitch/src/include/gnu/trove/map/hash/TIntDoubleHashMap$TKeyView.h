...
#include "gnu/trove/map/hash/TIntDoubleHashMap/TIntDoubleKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntDoubleHashMap/TKeyView/1.h"
...
public:
   protected TIntDoubleHashMap$TKeyView(TIntDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntDoubleKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
