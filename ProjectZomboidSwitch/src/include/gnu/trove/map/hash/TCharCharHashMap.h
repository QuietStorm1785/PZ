...
#include "gnu/trove/impl/hash/TCharCharHash.h"
#include "gnu/trove/iterator/TCharCharIterator.h"
#include "gnu/trove/map/TCharCharMap.h"
#include "gnu/trove/map/hash/TCharCharHashMap/1.h"
#include "gnu/trove/map/hash/TCharCharHashMap/TCharCharHashIterator.h"
#include "gnu/trove/map/hash/TCharCharHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TCharCharHashMap/TValueView.h"
...
class TCharCharHashMap : public TCharCharHash {
public:
   ...
   protected transient char[] _values;
    ...
    public TCharCharHashMap(TCharCharMap map) {
      super(map.size());
      if (dynamic_cast<TCharCharHashMap*>(map) != nullptr) {
    ...
    char doPut(char key, char value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public char, ? : public char> entry : map.entrySet()) {
   ...
   public char[] values(char[] array) {
    ...
    TCharCharIterator iterator() {
      return std::make_shared<TCharCharHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TCharCharMap*>(other) != nullptr)) {
    return false;
      } else {
