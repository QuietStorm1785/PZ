...
#include "gnu/trove/map/hash/TShortLongHashMap/TShortLongValueHashIterator.h"
#include "gnu/trove/map/hash/TShortLongHashMap/TValueView/1.h"
...
public:
   protected TShortLongHashMap$TValueView(TShortLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TShortLongValueHashIterator>(this.this$0, this.this$0);
   }
