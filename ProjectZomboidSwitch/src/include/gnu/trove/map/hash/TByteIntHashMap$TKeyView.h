...
#include "gnu/trove/map/hash/TByteIntHashMap/TByteIntKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteIntHashMap/TKeyView/1.h"
...
public:
   protected TByteIntHashMap$TKeyView(TByteIntHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteIntKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
