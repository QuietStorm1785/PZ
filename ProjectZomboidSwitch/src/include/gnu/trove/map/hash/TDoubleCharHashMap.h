...
#include "gnu/trove/impl/hash/TDoubleCharHash.h"
#include "gnu/trove/iterator/TDoubleCharIterator.h"
#include "gnu/trove/map/TDoubleCharMap.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/1.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/TDoubleCharHashIterator.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/TValueView.h"
...
class TDoubleCharHashMap : public TDoubleCharHash {
public:
   ...
   protected transient char[] _values;
    ...
    public TDoubleCharHashMap(TDoubleCharMap map) {
      super(map.size());
      if (dynamic_cast<TDoubleCharHashMap*>(map) != nullptr) {
    ...
    char doPut(double key, char value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public double, ? : public char> entry : map.entrySet()) {
   ...
   public char[] values(char[] array) {
    ...
    TDoubleCharIterator iterator() {
      return std::make_shared<TDoubleCharHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TDoubleCharMap*>(other) != nullptr)) {
    return false;
      } else {
