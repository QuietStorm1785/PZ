...
#include "gnu/trove/impl/hash/TByteDoubleHash.h"
#include "gnu/trove/iterator/TByteDoubleIterator.h"
#include "gnu/trove/map/TByteDoubleMap.h"
#include "gnu/trove/map/hash/TByteDoubleHashMap/1.h"
#include "gnu/trove/map/hash/TByteDoubleHashMap/TByteDoubleHashIterator.h"
#include "gnu/trove/map/hash/TByteDoubleHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TByteDoubleHashMap/TValueView.h"
...
class TByteDoubleHashMap : public TByteDoubleHash {
public:
   ...
   protected transient double[] _values;
    ...
    public TByteDoubleHashMap(int initialCapacity, float loadFactor, uint8_t noEntryKey, double noEntryValue) {
    ...
    public TByteDoubleHashMap(TByteDoubleMap map) {
      super(map.size());
      if (dynamic_cast<TByteDoubleHashMap*>(map) != nullptr) {
    ...
    double doPut(uint8_t key, double value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public uint8_t, ? : public double> entry : map.entrySet()) {
   ...
   public double[] values(double[] array) {
    ...
    TByteDoubleIterator iterator() {
      return std::make_shared<TByteDoubleHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TByteDoubleMap*>(other) != nullptr)) {
    return false;
      } else {
