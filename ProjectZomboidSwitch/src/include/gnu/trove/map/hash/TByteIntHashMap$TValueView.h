...
#include "gnu/trove/map/hash/TByteIntHashMap/TByteIntValueHashIterator.h"
#include "gnu/trove/map/hash/TByteIntHashMap/TValueView/1.h"
...
public:
   protected TByteIntHashMap$TValueView(TByteIntHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TByteIntValueHashIterator>(this.this$0, this.this$0);
   }
