...
#include "gnu/trove/map/hash/TByteFloatHashMap/TByteFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TByteFloatHashMap/TValueView/1.h"
...
public:
   protected TByteFloatHashMap$TValueView(TByteFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TByteFloatValueHashIterator>(this.this$0, this.this$0);
   }

    float getNoEntryValue() {
      return TByteFloatHashMap.access$400(this.this$0);
   }

    int size() {
      return TByteFloatHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteFloatHashMap.access$600(this.this$0);
   }
