...
#include "gnu/trove/impl/hash/TDoubleIntHash.h"
#include "gnu/trove/iterator/TDoubleIntIterator.h"
#include "gnu/trove/map/TDoubleIntMap.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/1.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/TDoubleIntHashIterator.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/TValueView.h"
...
class TDoubleIntHashMap : public TDoubleIntHash {
public:
   ...
   protected transient int[] _values;
    ...
    public TDoubleIntHashMap(TDoubleIntMap map) {
      super(map.size());
      if (dynamic_cast<TDoubleIntHashMap*>(map) != nullptr) {
    ...
    int doPut(double key, int value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public double, ? : public int> entry : map.entrySet()) {
   ...
   public int[] values(int[] array) {
    ...
    TDoubleIntIterator iterator() {
      return std::make_shared<TDoubleIntHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TDoubleIntMap*>(other) != nullptr)) {
    return false;
      } else {
