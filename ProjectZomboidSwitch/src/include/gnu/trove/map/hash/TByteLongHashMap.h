...
#include "gnu/trove/impl/hash/TByteLongHash.h"
#include "gnu/trove/iterator/TByteLongIterator.h"
#include "gnu/trove/map/TByteLongMap.h"
#include "gnu/trove/map/hash/TByteLongHashMap/1.h"
#include "gnu/trove/map/hash/TByteLongHashMap/TByteLongHashIterator.h"
#include "gnu/trove/map/hash/TByteLongHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TByteLongHashMap/TValueView.h"
...
class TByteLongHashMap : public TByteLongHash {
public:
   ...
   protected transient long[] _values;
    ...
    public TByteLongHashMap(int initialCapacity, float loadFactor, uint8_t noEntryKey, long noEntryValue) {
    ...
    public TByteLongHashMap(TByteLongMap map) {
      super(map.size());
      if (dynamic_cast<TByteLongHashMap*>(map) != nullptr) {
    ...
    long doPut(uint8_t key, long value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public uint8_t, ? : public int64_t> entry : map.entrySet()) {
   ...
   public long[] values(long[] array) {
    ...
    TByteLongIterator iterator() {
      return std::make_shared<TByteLongHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TByteLongMap*>(other) != nullptr)) {
    return false;
      } else {
