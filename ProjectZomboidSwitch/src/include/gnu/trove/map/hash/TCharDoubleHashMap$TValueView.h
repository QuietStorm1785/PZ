...
#include "gnu/trove/map/hash/TCharDoubleHashMap/TCharDoubleValueHashIterator.h"
#include "gnu/trove/map/hash/TCharDoubleHashMap/TValueView/1.h"
...
public:
   protected TCharDoubleHashMap$TValueView(TCharDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TCharDoubleValueHashIterator>(this.this$0, this.this$0);
   }
