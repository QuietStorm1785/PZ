...
#include "gnu/trove/map/hash/TIntByteHashMap/TIntByteKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntByteHashMap/TKeyView/1.h"
...
public:
   protected TIntByteHashMap$TKeyView(TIntByteHashMap var1) {
    ...
    TIntIterator iterator() {
      return std::make_shared<TIntByteKeyHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TIntByteHashMap.access$000(this.this$0);
   }

    int size() {
      return TIntByteHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntByteHashMap.access$200(this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntByteHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
