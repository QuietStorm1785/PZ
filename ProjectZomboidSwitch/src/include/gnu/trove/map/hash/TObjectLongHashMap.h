...
#include "gnu/trove/map/hash/TObjectLongHashMap/1.h"
#include "gnu/trove/map/hash/TObjectLongHashMap/2.h"
#include "gnu/trove/map/hash/TObjectLongHashMap/KeyView.h"
#include "gnu/trove/map/hash/TObjectLongHashMap/TLongValueCollection.h"
#include "gnu/trove/map/hash/TObjectLongHashMap/TObjectLongHashIterator.h"
...
public:
   ...
   protected transient long[] _values;
    ...
    public TObjectLongHashMap(TObjectLongMap<? extends) {
      this(map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectLongHashMap*>(map) != nullptr) {
