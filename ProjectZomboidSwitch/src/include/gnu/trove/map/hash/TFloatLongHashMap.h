...
#include "gnu/trove/impl/hash/TFloatLongHash.h"
#include "gnu/trove/iterator/TFloatLongIterator.h"
#include "gnu/trove/map/TFloatLongMap.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/1.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/TFloatLongHashIterator.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/TValueView.h"
...
class TFloatLongHashMap : public TFloatLongHash {
public:
   ...
   protected transient long[] _values;
    ...
    public TFloatLongHashMap(TFloatLongMap map) {
      super(map.size());
      if (dynamic_cast<TFloatLongHashMap*>(map) != nullptr) {
    ...
    long doPut(float key, long value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public float, ? : public int64_t> entry : map.entrySet()) {
   ...
   public long[] values(long[] array) {
    ...
    TFloatLongIterator iterator() {
      return std::make_shared<TFloatLongHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TFloatLongMap*>(other) != nullptr)) {
    return false;
      } else {
