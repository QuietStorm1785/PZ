...
#include "gnu/trove/map/hash/TFloatFloatHashMap/TFloatFloatKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatFloatHashMap/TKeyView/1.h"
...
public:
   protected TFloatFloatHashMap$TKeyView(TFloatFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TFloatFloatKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
