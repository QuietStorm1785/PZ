...
#include "gnu/trove/map/hash/TObjectByteHashMap/TByteValueCollection/1.h"
#include "gnu/trove/map/hash/TObjectByteHashMap/TByteValueCollection/TObjectByteValueHashIterator.h"
...
public:
   TObjectByteHashMap$TByteValueCollection(TObjectByteHashMap var1) {
    ...
    int size() {
      return TObjectByteHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TObjectByteHashMap.access$200(this.this$0);
   }
