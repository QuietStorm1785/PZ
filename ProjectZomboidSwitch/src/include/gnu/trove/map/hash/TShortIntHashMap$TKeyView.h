...
#include "gnu/trove/map/hash/TShortIntHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortIntHashMap/TShortIntKeyHashIterator.h"
...
public:
   protected TShortIntHashMap$TKeyView(TShortIntHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortIntKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
