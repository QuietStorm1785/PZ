...
#include "gnu/trove/map/hash/TFloatByteHashMap/TFloatByteKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatByteHashMap/TKeyView/1.h"
...
public:
   protected TFloatByteHashMap$TKeyView(TFloatByteHashMap var1) {
    ...
    TFloatIterator iterator() {
      return std::make_shared<TFloatByteKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatByteHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
