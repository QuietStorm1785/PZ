...
#include "gnu/trove/map/hash/TIntShortHashMap/TIntShortValueHashIterator.h"
#include "gnu/trove/map/hash/TIntShortHashMap/TValueView/1.h"
...
public:
   protected TIntShortHashMap$TValueView(TIntShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TIntShortValueHashIterator>(this.this$0, this.this$0);
   }
