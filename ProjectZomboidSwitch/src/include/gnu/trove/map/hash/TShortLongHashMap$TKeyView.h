...
#include "gnu/trove/map/hash/TShortLongHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortLongHashMap/TShortLongKeyHashIterator.h"
...
public:
   protected TShortLongHashMap$TKeyView(TShortLongHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
