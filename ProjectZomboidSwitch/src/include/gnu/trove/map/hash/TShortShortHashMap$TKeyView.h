...
#include "gnu/trove/map/hash/TShortShortHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortShortHashMap/TShortShortKeyHashIterator.h"
...
public:
   protected TShortShortHashMap$TKeyView(TShortShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortShortKeyHashIterator>(this.this$0, this.this$0);
   }

    short getNoEntryValue() {
      return TShortShortHashMap.access$000(this.this$0);
   }

    int size() {
      return TShortShortHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TShortShortHashMap.access$200(this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortShortHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
