...
#include "gnu/trove/map/hash/TDoubleLongHashMap/TDoubleLongKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleLongHashMap/TKeyView/1.h"
...
public:
   protected TDoubleLongHashMap$TKeyView(TDoubleLongHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
