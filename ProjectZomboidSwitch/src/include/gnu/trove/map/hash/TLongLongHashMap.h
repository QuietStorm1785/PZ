...
#include "gnu/trove/map/hash/TLongLongHashMap/1.h"
#include "gnu/trove/map/hash/TLongLongHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TLongLongHashMap/TLongLongHashIterator.h"
#include "gnu/trove/map/hash/TLongLongHashMap/TValueView.h"
...
class TLongLongHashMap : public TLongLongHash {
public:
   ...
   protected transient long[] _values;
    ...
    public TLongLongHashMap(TLongLongMap map) {
      super(map.size());
      if (dynamic_cast<TLongLongHashMap*>(map) != nullptr) {
    ...
    long doPut(long key, long value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int64_t, ? : public int64_t> entry : map.entrySet()) {
   ...
   public long[] values(long[] array) {
    ...
    TLongLongIterator iterator() {
      return std::make_shared<TLongLongHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TLongLongMap*>(other) != nullptr)) {
    return false;
      } else {
