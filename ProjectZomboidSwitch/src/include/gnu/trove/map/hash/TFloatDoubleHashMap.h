...
#include "gnu/trove/impl/hash/TFloatDoubleHash.h"
#include "gnu/trove/iterator/TFloatDoubleIterator.h"
#include "gnu/trove/map/TFloatDoubleMap.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/1.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TFloatDoubleHashIterator.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TValueView.h"
...
class TFloatDoubleHashMap : public TFloatDoubleHash {
public:
   ...
   protected transient double[] _values;
    ...
    public TFloatDoubleHashMap(TFloatDoubleMap map) {
      super(map.size());
      if (dynamic_cast<TFloatDoubleHashMap*>(map) != nullptr) {
    ...
    double doPut(float key, double value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public float, ? : public double> entry : map.entrySet()) {
         this.put(entry.getKey(), entry.getValue());
      }
   }

    void putAll(TFloatDoubleMap map) {
      this.ensureCapacity(map.size());
   ...
   public double[] values(double[] array) {
    ...
    TFloatDoubleIterator iterator() {
      return std::make_shared<TFloatDoubleHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TFloatDoubleMap*>(other) != nullptr)) {
    return false;
      } else {
