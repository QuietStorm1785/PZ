...
#include "gnu/trove/impl/hash/TFloatCharHash.h"
#include "gnu/trove/iterator/TFloatCharIterator.h"
#include "gnu/trove/map/TFloatCharMap.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/1.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/TFloatCharHashIterator.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/TValueView.h"
...
class TFloatCharHashMap : public TFloatCharHash {
public:
   ...
   protected transient char[] _values;
    ...
    public TFloatCharHashMap(TFloatCharMap map) {
      super(map.size());
      if (dynamic_cast<TFloatCharHashMap*>(map) != nullptr) {
    ...
    char doPut(float key, char value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public float, ? : public char> entry : map.entrySet()) {
   ...
   public char[] values(char[] array) {
    ...
    TFloatCharIterator iterator() {
      return std::make_shared<TFloatCharHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TFloatCharMap*>(other) != nullptr)) {
    return false;
      } else {
