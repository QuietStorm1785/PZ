...
#include "gnu/trove/impl/hash/TCharLongHash.h"
#include "gnu/trove/iterator/TCharLongIterator.h"
#include "gnu/trove/map/TCharLongMap.h"
#include "gnu/trove/map/hash/TCharLongHashMap/1.h"
#include "gnu/trove/map/hash/TCharLongHashMap/TCharLongHashIterator.h"
#include "gnu/trove/map/hash/TCharLongHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TCharLongHashMap/TValueView.h"
...
class TCharLongHashMap : public TCharLongHash {
public:
   ...
   protected transient long[] _values;
    ...
    public TCharLongHashMap(TCharLongMap map) {
      super(map.size());
      if (dynamic_cast<TCharLongHashMap*>(map) != nullptr) {
    ...
    long doPut(char key, long value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public char, ? : public int64_t> entry : map.entrySet()) {
   ...
   public long[] values(long[] array) {
    ...
    TCharLongIterator iterator() {
      return std::make_shared<TCharLongHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TCharLongMap*>(other) != nullptr)) {
    return false;
      } else {
