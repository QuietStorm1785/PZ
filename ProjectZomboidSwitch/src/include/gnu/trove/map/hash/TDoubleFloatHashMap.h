...
#include "gnu/trove/impl/hash/TDoubleFloatHash.h"
#include "gnu/trove/iterator/TDoubleFloatIterator.h"
#include "gnu/trove/map/TDoubleFloatMap.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/1.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TDoubleFloatHashIterator.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TValueView.h"
...
class TDoubleFloatHashMap : public TDoubleFloatHash {
public:
   ...
   protected transient float[] _values;
    ...
    public TDoubleFloatHashMap(TDoubleFloatMap map) {
      super(map.size());
      if (dynamic_cast<TDoubleFloatHashMap*>(map) != nullptr) {
    ...
    float doPut(double key, float value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public double, ? : public float> entry : map.entrySet()) {
         this.put(entry.getKey(), entry.getValue());
      }
   }

    void putAll(TDoubleFloatMap map) {
      this.ensureCapacity(map.size());
   ...
   public float[] values(float[] array) {
    ...
    TDoubleFloatIterator iterator() {
      return std::make_shared<TDoubleFloatHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TDoubleFloatMap*>(other) != nullptr)) {
    return false;
      } else {
