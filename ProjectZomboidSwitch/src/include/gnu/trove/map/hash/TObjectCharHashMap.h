...
#include "gnu/trove/map/hash/TObjectCharHashMap/1.h"
#include "gnu/trove/map/hash/TObjectCharHashMap/2.h"
#include "gnu/trove/map/hash/TObjectCharHashMap/KeyView.h"
#include "gnu/trove/map/hash/TObjectCharHashMap/TCharValueCollection.h"
#include "gnu/trove/map/hash/TObjectCharHashMap/TObjectCharHashIterator.h"
...
public:
   ...
   protected transient char[] _values;
    ...
    public TObjectCharHashMap(TObjectCharMap<? extends) {
      this(map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectCharHashMap*>(map) != nullptr) {
