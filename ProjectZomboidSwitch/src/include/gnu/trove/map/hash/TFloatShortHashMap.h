...
#include "gnu/trove/impl/hash/TFloatShortHash.h"
#include "gnu/trove/iterator/TFloatShortIterator.h"
#include "gnu/trove/map/TFloatShortMap.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/1.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/TFloatShortHashIterator.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/TValueView.h"
...
class TFloatShortHashMap : public TFloatShortHash {
public:
   ...
   protected transient short[] _values;
    ...
    public TFloatShortHashMap(TFloatShortMap map) {
      super(map.size());
      if (dynamic_cast<TFloatShortHashMap*>(map) != nullptr) {
    ...
    short doPut(float key, short value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public float, ? : public int16_t> entry : map.entrySet()) {
   ...
   public short[] values(short[] array) {
    ...
    TFloatShortIterator iterator() {
      return std::make_shared<TFloatShortHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TFloatShortMap*>(other) != nullptr)) {
    return false;
      } else {
