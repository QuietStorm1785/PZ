...
#include "gnu/trove/map/hash/TIntCharHashMap/TIntCharValueHashIterator.h"
#include "gnu/trove/map/hash/TIntCharHashMap/TValueView/1.h"
...
public:
   protected TIntCharHashMap$TValueView(TIntCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TIntCharValueHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TIntCharHashMap.access$400(this.this$0);
   }

    int size() {
      return TIntCharHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntCharHashMap.access$600(this.this$0);
   }
