...
#include "gnu/trove/map/hash/TCharCharHashMap/TCharCharValueHashIterator.h"
#include "gnu/trove/map/hash/TCharCharHashMap/TValueView/1.h"
...
public:
   protected TCharCharHashMap$TValueView(TCharCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharCharValueHashIterator>(this.this$0, this.this$0);
   }
