...
#include "gnu/trove/map/hash/TDoubleCharHashMap/TDoubleCharKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/TKeyView/1.h"
...
class TDoubleCharHashMap {
public:
   protected TDoubleCharHashMap$TKeyView(TDoubleCharHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleCharKeyHashIterator>(this.this$0, this.this$0);
   }

    double getNoEntryValue() {
      return TDoubleCharHashMap.access$000(this.this$0);
   }

    int size() {
      return TDoubleCharHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TDoubleCharHashMap.access$200(this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
