...
#include "gnu/trove/impl/hash/TFloatIntHash.h"
#include "gnu/trove/iterator/TFloatIntIterator.h"
#include "gnu/trove/map/TFloatIntMap.h"
#include "gnu/trove/map/hash/TFloatIntHashMap/1.h"
#include "gnu/trove/map/hash/TFloatIntHashMap/TFloatIntHashIterator.h"
#include "gnu/trove/map/hash/TFloatIntHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TFloatIntHashMap/TValueView.h"
...
class TFloatIntHashMap : public TFloatIntHash {
public:
   ...
   protected transient int[] _values;
    ...
    public TFloatIntHashMap(TFloatIntMap map) {
      super(map.size());
      if (dynamic_cast<TFloatIntHashMap*>(map) != nullptr) {
    ...
    int doPut(float key, int value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public float, ? : public int> entry : map.entrySet()) {
         this.put(entry.getKey(), entry.getValue());
      }
   }

    void putAll(TFloatIntMap map) {
      this.ensureCapacity(map.size());
   ...
   public int[] values(int[] array) {
    ...
    TFloatIntIterator iterator() {
      return std::make_shared<TFloatIntHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TFloatIntMap*>(other) != nullptr)) {
    return false;
      } else {
