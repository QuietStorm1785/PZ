...
#include "gnu/trove/map/hash/TDoubleByteHashMap/TDoubleByteValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleByteHashMap/TValueView/1.h"
...
public:
   protected TDoubleByteHashMap$TValueView(TDoubleByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TDoubleByteValueHashIterator>(this.this$0, this.this$0);
   }
