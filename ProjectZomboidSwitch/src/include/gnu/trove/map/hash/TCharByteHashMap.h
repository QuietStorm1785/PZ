...
#include "gnu/trove/impl/hash/TCharByteHash.h"
#include "gnu/trove/iterator/TCharByteIterator.h"
#include "gnu/trove/map/TCharByteMap.h"
#include "gnu/trove/map/hash/TCharByteHashMap/1.h"
#include "gnu/trove/map/hash/TCharByteHashMap/TCharByteHashIterator.h"
#include "gnu/trove/map/hash/TCharByteHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TCharByteHashMap/TValueView.h"
...
class TCharByteHashMap : public TCharByteHash {
public:
   ...
   protected transient byte[] _values;
    ...
    public TCharByteHashMap(int initialCapacity, float loadFactor, char noEntryKey, uint8_t noEntryValue) {
    ...
    public TCharByteHashMap(TCharByteMap map) {
      super(map.size());
      if (dynamic_cast<TCharByteHashMap*>(map) != nullptr) {
    ...
    uint8_t doPut(char key, uint8_t value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public char, ? : public uint8_t> entry : map.entrySet()) {
   ...
   public byte[] values(byte[] array) {
    ...
    TCharByteIterator iterator() {
      return std::make_shared<TCharByteHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TCharByteMap*>(other) != nullptr)) {
    return false;
      } else {
