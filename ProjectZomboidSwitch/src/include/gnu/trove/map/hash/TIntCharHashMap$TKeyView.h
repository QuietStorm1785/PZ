...
#include "gnu/trove/map/hash/TIntCharHashMap/TIntCharKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntCharHashMap/TKeyView/1.h"
...
class TIntCharHashMap {
public:
   protected TIntCharHashMap$TKeyView(TIntCharHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntCharKeyHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TIntCharHashMap.access$000(this.this$0);
   }

    int size() {
      return TIntCharHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntCharHashMap.access$200(this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
