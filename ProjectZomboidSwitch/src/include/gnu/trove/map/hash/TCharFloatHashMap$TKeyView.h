...
#include "gnu/trove/map/hash/TCharFloatHashMap/TCharFloatKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharFloatHashMap/TKeyView/1.h"
...
public:
   protected TCharFloatHashMap$TKeyView(TCharFloatHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharFloatKeyHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TCharFloatHashMap.access$000(this.this$0);
   }

    int size() {
      return TCharFloatHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharFloatHashMap.access$200(this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
