...
#include "gnu/trove/map/hash/TFloatByteHashMap/TFloatByteValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatByteHashMap/TValueView/1.h"
...
public:
   protected TFloatByteHashMap$TValueView(TFloatByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TFloatByteValueHashIterator>(this.this$0, this.this$0);
   }
