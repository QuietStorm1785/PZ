...
#include "gnu/trove/map/hash/TByteLongHashMap/TByteLongKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteLongHashMap/TKeyView/1.h"
...
public:
   protected TByteLongHashMap$TKeyView(TByteLongHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
