...
#include "gnu/trove/map/hash/TLongCharHashMap/TLongCharValueHashIterator.h"
#include "gnu/trove/map/hash/TLongCharHashMap/TValueView/1.h"
...
public:
   protected TLongCharHashMap$TValueView(TLongCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TLongCharValueHashIterator>(this.this$0, this.this$0);
   }
