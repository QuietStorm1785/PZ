...
#include "gnu/trove/map/hash/TShortFloatHashMap/TShortFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/TValueView/1.h"
...
public:
   protected TShortFloatHashMap$TValueView(TShortFloatHashMap var1) {
    ...
    TFloatIterator iterator() {
      return std::make_shared<TShortFloatValueHashIterator>(this.this$0, this.this$0);
   }
