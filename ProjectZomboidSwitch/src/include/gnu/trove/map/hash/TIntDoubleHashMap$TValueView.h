...
#include "gnu/trove/map/hash/TIntDoubleHashMap/TIntDoubleValueHashIterator.h"
#include "gnu/trove/map/hash/TIntDoubleHashMap/TValueView/1.h"
...
public:
   protected TIntDoubleHashMap$TValueView(TIntDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TIntDoubleValueHashIterator>(this.this$0, this.this$0);
   }
