...
#include "gnu/trove/map/hash/TLongIntHashMap/TLongIntValueHashIterator.h"
#include "gnu/trove/map/hash/TLongIntHashMap/TValueView/1.h"
...
public:
   protected TLongIntHashMap$TValueView(TLongIntHashMap var1) {
    ...
    TIntIterator iterator() {
      return std::make_shared<TLongIntValueHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TLongIntHashMap.access$400(this.this$0);
   }

    int size() {
      return TLongIntHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongIntHashMap.access$600(this.this$0);
   }
