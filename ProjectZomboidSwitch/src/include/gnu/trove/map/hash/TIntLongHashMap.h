...
#include "gnu/trove/map/hash/TIntLongHashMap/1.h"
#include "gnu/trove/map/hash/TIntLongHashMap/TIntLongHashIterator.h"
#include "gnu/trove/map/hash/TIntLongHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TIntLongHashMap/TValueView.h"
...
class TIntLongHashMap : public TIntLongHash {
public:
   ...
   protected transient long[] _values;
    ...
    public TIntLongHashMap(TIntLongMap map) {
      super(map.size());
      if (dynamic_cast<TIntLongHashMap*>(map) != nullptr) {
    ...
    long doPut(int key, long value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int, ? : public int64_t> entry : map.entrySet()) {
   ...
   public long[] values(long[] array) {
    ...
    TIntLongIterator iterator() {
      return std::make_shared<TIntLongHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TIntLongMap*>(other) != nullptr)) {
    return false;
      } else {
