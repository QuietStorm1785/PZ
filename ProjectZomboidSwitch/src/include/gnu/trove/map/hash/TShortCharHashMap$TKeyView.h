...
#include "gnu/trove/map/hash/TShortCharHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortCharHashMap/TShortCharKeyHashIterator.h"
...
public:
   protected TShortCharHashMap$TKeyView(TShortCharHashMap var1) {
    ...
    TShortIterator iterator() {
      return std::make_shared<TShortCharKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
