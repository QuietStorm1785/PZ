...
#include "gnu/trove/map/hash/TIntFloatHashMap/TIntFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TIntFloatHashMap/TValueView/1.h"
...
public:
   protected TIntFloatHashMap$TValueView(TIntFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TIntFloatValueHashIterator>(this.this$0, this.this$0);
   }

    float getNoEntryValue() {
      return TIntFloatHashMap.access$400(this.this$0);
   }

    int size() {
      return TIntFloatHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntFloatHashMap.access$600(this.this$0);
   }
