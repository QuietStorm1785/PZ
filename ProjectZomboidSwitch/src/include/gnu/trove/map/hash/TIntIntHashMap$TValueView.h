...
#include "gnu/trove/map/hash/TIntIntHashMap/TIntIntValueHashIterator.h"
#include "gnu/trove/map/hash/TIntIntHashMap/TValueView/1.h"
...
public:
   protected TIntIntHashMap$TValueView(TIntIntHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntIntValueHashIterator>(this.this$0, this.this$0);
   }
