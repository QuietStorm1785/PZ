...
#include "gnu/trove/impl/hash/TLongFloatHash.h"
#include "gnu/trove/iterator/TLongFloatIterator.h"
#include "gnu/trove/map/TLongFloatMap.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/1.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/TLongFloatHashIterator.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/TValueView.h"
...
class TLongFloatHashMap : public TLongFloatHash {
public:
   ...
   protected transient float[] _values;
    ...
    public TLongFloatHashMap(TLongFloatMap map) {
      super(map.size());
      if (dynamic_cast<TLongFloatHashMap*>(map) != nullptr) {
    ...
    float doPut(long key, float value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int64_t, ? : public float> entry : map.entrySet()) {
   ...
   public float[] values(float[] array) {
    ...
    TLongFloatIterator iterator() {
      return std::make_shared<TLongFloatHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TLongFloatMap*>(other) != nullptr)) {
    return false;
      } else {
