...
#include "gnu/trove/map/hash/TShortDoubleHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/TShortDoubleKeyHashIterator.h"
...
public:
   protected TShortDoubleHashMap$TKeyView(TShortDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortDoubleKeyHashIterator>(this.this$0, this.this$0);
   }

    short getNoEntryValue() {
      return TShortDoubleHashMap.access$000(this.this$0);
   }

    int size() {
      return TShortDoubleHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TShortDoubleHashMap.access$200(this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
