...
#include "gnu/trove/map/hash/TCharShortHashMap/TCharShortValueHashIterator.h"
#include "gnu/trove/map/hash/TCharShortHashMap/TValueView/1.h"
...
public:
   protected TCharShortHashMap$TValueView(TCharShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TCharShortValueHashIterator>(this.this$0, this.this$0);
   }

    short getNoEntryValue() {
      return TCharShortHashMap.access$400(this.this$0);
   }

    int size() {
      return TCharShortHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharShortHashMap.access$600(this.this$0);
   }
