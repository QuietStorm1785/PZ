...
#include "gnu/trove/map/hash/TDoubleIntHashMap/TDoubleIntKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/TKeyView/1.h"
...
public:
   protected TDoubleIntHashMap$TKeyView(TDoubleIntHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleIntKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
