...
#include "gnu/trove/map/hash/TShortDoubleHashMap/TShortDoubleValueHashIterator.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/TValueView/1.h"
...
public:
   protected TShortDoubleHashMap$TValueView(TShortDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TShortDoubleValueHashIterator>(this.this$0, this.this$0);
   }

    double getNoEntryValue() {
      return TShortDoubleHashMap.access$400(this.this$0);
   }

    int size() {
      return TShortDoubleHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TShortDoubleHashMap.access$600(this.this$0);
   }
