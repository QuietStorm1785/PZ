...
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TDoubleFloatKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TKeyView/1.h"
...
public:
   protected TDoubleFloatHashMap$TKeyView(TDoubleFloatHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleFloatKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
