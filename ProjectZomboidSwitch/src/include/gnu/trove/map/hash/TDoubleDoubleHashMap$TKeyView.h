...
#include "gnu/trove/map/hash/TDoubleDoubleHashMap/TDoubleDoubleKeyHashIterator.h"
#include "gnu/trove/map/hash/TDoubleDoubleHashMap/TKeyView/1.h"
...
public:
   protected TDoubleDoubleHashMap$TKeyView(TDoubleDoubleHashMap var1) {
    ...
    TDoubleIterator iterator() {
      return std::make_shared<TDoubleDoubleKeyHashIterator>(this.this$0, this.this$0);
   }

    double getNoEntryValue() {
      return TDoubleDoubleHashMap.access$000(this.this$0);
   }

    int size() {
      return TDoubleDoubleHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TDoubleDoubleHashMap.access$200(this.this$0);
   }
   ...
   public double[] toArray(double[] dest) {
    ...
    bool remove(double entry) {
      return TDoubleDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
