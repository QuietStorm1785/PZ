...
#include "gnu/trove/map/hash/TLongIntHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongIntHashMap/TLongIntKeyHashIterator.h"
...
public:
   protected TLongIntHashMap$TKeyView(TLongIntHashMap var1) {
    ...
    TLongIterator iterator() {
      return std::make_shared<TLongIntKeyHashIterator>(this.this$0, this.this$0);
   }

    long getNoEntryValue() {
      return TLongIntHashMap.access$000(this.this$0);
   }

    int size() {
      return TLongIntHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongIntHashMap.access$200(this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
