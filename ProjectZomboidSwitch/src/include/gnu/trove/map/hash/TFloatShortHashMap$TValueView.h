...
#include "gnu/trove/map/hash/TFloatShortHashMap/TFloatShortValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/TValueView/1.h"
...
public:
   protected TFloatShortHashMap$TValueView(TFloatShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TFloatShortValueHashIterator>(this.this$0, this.this$0);
   }
