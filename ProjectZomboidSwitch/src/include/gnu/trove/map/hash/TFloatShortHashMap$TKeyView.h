...
#include "gnu/trove/map/hash/TFloatShortHashMap/TFloatShortKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatShortHashMap/TKeyView/1.h"
...
public:
   protected TFloatShortHashMap$TKeyView(TFloatShortHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TFloatShortKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatShortHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
