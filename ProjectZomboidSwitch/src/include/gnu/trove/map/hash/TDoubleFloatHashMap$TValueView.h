...
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TDoubleFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleFloatHashMap/TValueView/1.h"
...
public:
   protected TDoubleFloatHashMap$TValueView(TDoubleFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TDoubleFloatValueHashIterator>(this.this$0, this.this$0);
   }
