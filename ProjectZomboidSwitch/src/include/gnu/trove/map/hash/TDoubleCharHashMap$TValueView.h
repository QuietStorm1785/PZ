...
#include "gnu/trove/map/hash/TDoubleCharHashMap/TDoubleCharValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleCharHashMap/TValueView/1.h"
...
public:
   protected TDoubleCharHashMap$TValueView(TDoubleCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TDoubleCharValueHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TDoubleCharHashMap.access$400(this.this$0);
   }

    int size() {
      return TDoubleCharHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TDoubleCharHashMap.access$600(this.this$0);
   }
