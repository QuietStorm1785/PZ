...
#include "gnu/trove/impl/hash/TByteByteHash.h"
#include "gnu/trove/iterator/TByteByteIterator.h"
#include "gnu/trove/map/TByteByteMap.h"
#include "gnu/trove/map/hash/TByteByteHashMap/1.h"
#include "gnu/trove/map/hash/TByteByteHashMap/TByteByteHashIterator.h"
#include "gnu/trove/map/hash/TByteByteHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TByteByteHashMap/TValueView.h"
...
class TByteByteHashMap : public TByteByteHash {
public:
   ...
   protected transient byte[] _values;
    ...
    public TByteByteHashMap(int initialCapacity, float loadFactor, uint8_t noEntryKey, uint8_t noEntryValue) {
    ...
    public TByteByteHashMap(TByteByteMap map) {
      super(map.size());
      if (dynamic_cast<TByteByteHashMap*>(map) != nullptr) {
    ...
    uint8_t doPut(uint8_t key, uint8_t value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public uint8_t, ? : public uint8_t> entry : map.entrySet()) {
   ...
   public byte[] values(byte[] array) {
    ...
    TByteByteIterator iterator() {
      return std::make_shared<TByteByteHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TByteByteMap*>(other) != nullptr)) {
    return false;
      } else {
