...
public:
   private const TObjectByteCustomHashMap<K> _map;

   public TObjectByteCustomHashMap$TObjectByteHashIterator(TObjectByteCustomHashMap<K> var1, TObjectByteCustomHashMap map) {
      super(map);
      this.this$0 = var1;
      this._map = map;
   }
