...
#include "gnu/trove/map/custom_hash/TObjectShortCustomHashMap/TShortValueCollection/1.h"
#include "gnu/trove/map/custom_hash/TObjectShortCustomHashMap/TShortValueCollection/TObjectShortValueHashIterator.h"
...
public:
   TObjectShortCustomHashMap$TShortValueCollection(TObjectShortCustomHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TObjectShortValueHashIterator>(this);
   }
    ...
    int size() {
      return TObjectShortCustomHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TObjectShortCustomHashMap.access$200(this.this$0);
   }
