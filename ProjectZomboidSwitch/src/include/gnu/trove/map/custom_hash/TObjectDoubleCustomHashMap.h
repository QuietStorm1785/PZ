...
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/1.h"
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/2.h"
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/KeyView.h"
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/TDoubleValueCollection.h"
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/TObjectDoubleHashIterator.h"
...
public:
   ...
   protected transient double[] _values;
    ...
    public TObjectDoubleCustomHashMap(HashingStrategy<? super) {
      super(strategy);
      this.no_entry_value = Constants.DEFAULT_DOUBLE_NO_ENTRY_VALUE;
   }

    public TObjectDoubleCustomHashMap(HashingStrategy<? super, int initialCapacity) {
      super(strategy, initialCapacity);
      this.no_entry_value = Constants.DEFAULT_DOUBLE_NO_ENTRY_VALUE;
   }

    public TObjectDoubleCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor) {
      super(strategy, initialCapacity, loadFactor);
      this.no_entry_value = Constants.DEFAULT_DOUBLE_NO_ENTRY_VALUE;
   }

    public TObjectDoubleCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor, double noEntryValue) {
      super(strategy, initialCapacity, loadFactor);
    ...
    public TObjectDoubleCustomHashMap(HashingStrategy<? super, TObjectDoubleMap<? extends) {
      this(strategy, map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectDoubleCustomHashMap*>(map) != nullptr) {
