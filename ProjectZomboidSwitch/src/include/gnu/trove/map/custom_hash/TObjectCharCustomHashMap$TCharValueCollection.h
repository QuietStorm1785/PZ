...
#include "gnu/trove/map/custom_hash/TObjectCharCustomHashMap/TCharValueCollection/1.h"
#include "gnu/trove/map/custom_hash/TObjectCharCustomHashMap/TCharValueCollection/TObjectCharValueHashIterator.h"
...
public:
   TObjectCharCustomHashMap$TCharValueCollection(TObjectCharCustomHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TObjectCharValueHashIterator>(this);
   }
    ...
    int size() {
      return TObjectCharCustomHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TObjectCharCustomHashMap.access$200(this.this$0);
   }
