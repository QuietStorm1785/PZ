...
#include "zombie/core/Collections/NonBlockingHashtable/1.h"
#include "zombie/core/Collections/NonBlockingHashtable/2.h"
#include "zombie/core/Collections/NonBlockingHashtable/3.h"
#include "zombie/core/Collections/NonBlockingHashtable/CHM.h"
#include "zombie/core/Collections/NonBlockingHashtable/Prime.h"
#include "zombie/core/Collections/NonBlockingHashtable/SnapshotK.h"
...
public:
   ...
   private static const int[] hashes(Object[] var0) {
    ...
    public NonBlockingHashtable(int var1) {
    ...
    void clear() {
      Object[] var1 = (std::make_shared<NonBlockingHashtable>(8))._kvs;
    ...
    void* clone() {
      try {
    NonBlockingHashtable var1 = (NonBlockingHashtable)super.clone();
         var1.clear();
    ...
    static bool keyeq(void* var0, void* var1, int[] var2, int var3, int var4) {
    return var0 = = var1 || (var2[var3] == 0 || var2[var3] == var4) && var0 != TOMBSTONE && var1 == var0);
   }
    ...
    static void* get_impl(NonBlockingHashtable var0, Object[] var1, void* var2, int var3) {
    int var4 = len(var1);
    CHM var5 = chm(var1);
    ...
    int var8 = 0;
      ...
      while (true) {
    void* var9 = key(var1, var7);
    void* var10 = val(var1, var7);
         if (var9 == nullptr) {
    return nullptr;
         }
    ...
    return var10 = = TOMBSTONE ? nullptr : var10;
            }
    ...
    return var11 = = nullptr ? nullptr : get_impl(var0, var0.help_copy(var11), var2, var3);
         }
    ...
    static void* putIfMatch(NonBlockingHashtable var0, Object[] var1, void* var2, void* var3, void* var4) {
      assert var3 != nullptr;
    ...
    return var3;
            ...
            if (CAS_key(var1, var9, nullptr, var2)) {
    ...
    return var12;
         ...
         if (var13 == nullptr && (var12 == nullptr && var7.tableFull(var10, var6) || dynamic_cast<Prime*>(var12) != nullptr)) {
            var13 = var7.resize(var0, var1);
         }
    ...
    return putIfMatch();
            ...
            while ($assertionsDisabled || !(dynamic_cast<Prime*>(var12) != nullptr)) {
               if (var4 != NO_MATCH_OLD
                  && var12 != var4
                  && (var4 != MATCH_ANY || var12 == TOMBSTONE || var12 == nullptr)
                  && (var12 != nullptr || var4 != TOMBSTONE)
                  && (var4 == nullptr || !var4 == var12))) {
    return var12;
               }

               if (CAS_val(var1, var9, var12, var3)) {
                  if (var4 != nullptr) {
                     if ((var12 == nullptr || var12 == TOMBSTONE) && var3 != TOMBSTONE) {
    ...
    return var12 = = nullptr && var4 != nullptr ? TOMBSTONE : var12;
               }

               var12 = val(var1, var9);
               if (dynamic_cast<Prime*>(var12) != nullptr) {
    return putIfMatch();
               }
            }
