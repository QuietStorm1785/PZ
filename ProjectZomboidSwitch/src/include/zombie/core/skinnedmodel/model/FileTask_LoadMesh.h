...
public:
    ...
    std::string var1 = this.mesh.getPath().getPath();
    int var2 = var1.indexOf(124);
      return var2 != -1 ? var1.substr(0, var2) : var1;
   }

    std::string getMeshName() {
    std::string var1 = this.mesh.getPath().getPath();
    int var2 = var1.indexOf(124);
      return var2 != -1 ? var1.substr(var2 + 1) : nullptr;
   }
    ...
    AiScene var2 = Jassimp.importFile(this.m_fileName, var1);
      zombie.core.skinnedmodel.model.jassimp.JAssImpImporter.LoadMode var3 = this.mesh.assetParams.bStatic
         ? zombie.core.skinnedmodel.model.jassimp.JAssImpImporter.LoadMode.StaticMesh
         : zombie.core.skinnedmodel.model.jassimp.JAssImpImporter.LoadMode.Normal;
    ...
    ModelTxt loadTxt() {
    bool var1 = this.mesh.assetParams.bStatic;
    bool var2 = false;
