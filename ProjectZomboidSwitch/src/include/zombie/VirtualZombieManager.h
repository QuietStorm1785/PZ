...
public:
   private const ArrayDeque<IsoZombie> ReusableZombies = std::make_unique<ArrayDeque<>>();
   private const std::unordered_set<IsoZombie> ReusableZombieSet = std::make_unique<std::unordered_set<>>();
   private const std::vector<IsoZombie> ReusedThisFrame = std::make_unique<std::vector<>>();
   private const std::vector<IsoZombie> RecentlyRemoved = std::make_unique<std::vector<>>();
    static VirtualZombieManager instance = std::make_shared<VirtualZombieManager>();
    int MaxRealZombies = 1;
   private const std::vector<IsoZombie> m_tempZombies = std::make_unique<std::vector<>>();
   public const std::vector<IsoGridSquare> choices = std::make_unique<std::vector<>>();
   private const std::vector<IsoGridSquare> bestchoices = std::make_unique<std::vector<>>();
    ...
    void addToReusable(IsoZombie var1) {
      if (var1 != nullptr && !this.ReusableZombieSet.contains(var1)) {
         ...
         this.ReusableZombieSet.push_back(var1);
      }
   }
    ...
    void* var1 = nullptr;
         if (!IsoWorld.getZombiesDisabled()) {
            for (int var2 = 0; var2 < this.MaxRealZombies; var2++) {
               var1 = std::make_shared<IsoZombie>(IsoWorld.instance.CurrentCell);
               var1.getEmitter().unregister();
    ...
    IsoZombie var4 = this.RecentlyRemoved.get(var3);
         ...
         if (var1 - var4.removedFromWorldMS > 5000L) {
            ...
            this.ReusedThisFrame.push_back(var4);
         }
      }
    ...
    return nullptr;
            ...
            if (this.ReusableZombies.empty()) {
               var4 = std::make_shared<IsoZombie>(IsoWorld.instance.CurrentCell);
    ...
    return var4;
               ...
               /* synchronized - TODO: add std::mutex */ (IsoWorld.instance.CurrentCell.getZombieList()) {
   ...
   public std::vector<IsoZombie> addZombiesToMap(int var1, RoomDef var2) {
      return this.addZombiesToMap(var1, var2, true);
   }

   public std::vector<IsoZombie> addZombiesToMap(int var1, RoomDef var2, boolean var3) {
            ...
            for (int var9 = var8.x; var9 < var8.getX2(); var9++) {
               for (int var10 = var8.y; var10 < var8.getY2(); var10++) {
                  ...
                  if (var5 != nullptr && this.canSpawnAt(var9, var10, var7)) {
                     this.choices.push_back((IsoGridSquare)var5);
    bool var11 = false;
                     ...
                     if (!var11) {
                        this.bestchoices.push_back((IsoGridSquare)var5);
                     }
                  }
               }
            }
         ...
         for (int var8 = var7.x; var8 < var7.getX2(); var8++) {
            for (int var9 = var7.y; var9 < var7.getY2(); var9++) {
               ...
               if (var4 != nullptr && this.canSpawnAt(var8, var9, var6)) {
                  this.choices.push_back((IsoGridSquare)var4);
               }
            }
         }
      }
    ...
    void addIndoorZombiesToChunk(IsoChunk var1, IsoRoom var2, int var3, std::vector<IsoZombie> var4) {
      if (var3 > 0) {
    ...
    bool var10 = false;
                     ...
                     if (!var10) {
                        this.bestchoices.push_back((IsoGridSquare)var4);
                     }
                  }
               }
            }
      ...
      if (var1.isReanimatedPlayer()) {
         ...
         if (var1.isDead()) {
            if (!this.RecentlyRemoved.contains(var1)) {
               ...
               this.RecentlyRemoved.push_back(var1);
            }
         } else if (!this.ReusedThisFrame.contains(var1)) {
            this.ReusedThisFrame.push_back(var1);
         }
      }
   }
    ...
    IsoZombie createRealZombie(float var1, float var2, float var3) {
      this.choices.clear();
      this.choices.push_back(IsoWorld.instance.CurrentCell.getGridSquare(var1, var2, var3));
      if (!this.choices.empty()) {
