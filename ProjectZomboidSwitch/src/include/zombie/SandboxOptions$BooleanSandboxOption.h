...
public:
   ...
   public SandboxOptions$BooleanSandboxOption(SandboxOptions var1, std::string var2, boolean var3) {
      super(var2, var3);
      std::string[] var4 = SandboxOptions.parseName(var2);
   ...
   void toTable(lua_State* L, int index) {
      ...
      lua_pushboolean(L, this.getValueAsObject());
