...
public:
    ...
    void set(IsoPlayer var1, IsoPlayer var2, BaseVehicle var3, float var4, bool var5, int var6, float var7, bool var8) {
    ...
    return false;
         ...
         return !PacketValidator.checkShortDistance(var1, this.wielder, this.target, VehicleHitPlayerPacket.class.getSimpleName())
            ? false
            : PacketValidator.checkDamage(var1, this.vehicleHit, VehicleHitPlayerPacket.class.getSimpleName());
      }
   }
}
} // namespace hit
