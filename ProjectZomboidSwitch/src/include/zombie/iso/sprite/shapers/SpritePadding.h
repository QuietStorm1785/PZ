...
class SpritePadding {
public:
    static void applyPadding(TextureDraw var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
    float var9 = var0.x0;
    float var10 = var0.y0;
    float var11 = var0.x1;
    float var12 = var0.y1;
    ...
    static void applyPaddingBorder(TextureDraw var0, float var1, float var2) {
    ...
    static void applyIsoPadding(TextureDraw var0, IsoPaddingSettings var1) {
      if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.IsoPadding.getValue()) {
    IsoBorderSetting var2 = var1.getCurrentZoomSetting();
