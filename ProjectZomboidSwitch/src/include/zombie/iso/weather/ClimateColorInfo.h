...
public:
    Color interior = std::make_shared<Color>(0, 0, 0, 1);
    Color exterior = std::make_shared<Color>(0, 0, 0, 1);
    ...
    void setInterior(Color var1) {
      this.interior.set(var1);
   }

    void setInterior(float var1, float var2, float var3, float var4) {
      this.interior.r = var1;
      this.interior.g = var2;
      this.interior.b = var3;
      this.interior.a = var4;
    ...
    void setExterior(Color var1) {
      this.exterior.set(var1);
   }

    void setExterior(float var1, float var2, float var3, float var4) {
    ...
    void setTo(ClimateColorInfo var1) {
      this.interior.set(var1.interior);
      this.exterior.set(var1.exterior);
   }

    ClimateColorInfo interp(ClimateColorInfo var1, float var2, ClimateColorInfo var3) {
    ...
    static ClimateColorInfo interp(ClimateColorInfo var0, ClimateColorInfo var1, float var2, ClimateColorInfo var3) {
    ...
    bool var0 = false;
      ...
      try {
    std::string var1 = std::make_shared<SimpleDateFormat>("yyyyMMdd_HHmmss").format(std::make_shared<Date>());
    std::string var2 = "ClimateMain_" + var1;
    std::string var3 = ZomboidFileSystem.instance.getCacheDir() + File.separator + var2 + ".lua";
         DebugLog.log("Attempting to save color config to: " + var3);
    File var4 = std::make_shared<File>(var3);

         try (BufferedWriter var5 = std::make_shared<BufferedWriter>(std::make_shared<FileWriter>(var4, false))) {
            writer = var5;
    ...
    WeatherPeriod var8 = var6.getWeatherPeriod();
            ...
            var5.newLine();
            std::string[] var9 = new std::string[]{"Dawn", "Day", "Dusk"};
            std::string[] var10 = new std::string[]{"SUMMER", "FALL", "WINTER", "SPRING"};
            std::string[] var11 = new std::string[]{"WARM", "NORMAL", "CLOUDY"};
    ...
    static void writeSeasonColor(int var0, ClimateColorInfo var1, const std::string& var2, const std::string& var3, const std::string& var4) {
    Color var5 = var1.exterior;
      write(var0, "_clim:setSeasonColor" + var2 + "(" + var4 + "," + var3 + "," + var5.r + "," + var5.g + "," + var5.b + "," + var5.a + ",true);\t\t--exterior");
      var5 = var1.interior;
      write(
         var0, "_clim:setSeasonColor" + var2 + "(" + var4 + "," + var3 + "," + var5.r + "," + var5.g + "," + var5.b + "," + var5.a + ",false);\t\t--interior"
      );
   }

    static void writeColor(int var0, ClimateColorInfo var1) {
    ...
    static void write(int var0, const std::string& var1) {
    std::string var2 = new std::string(new char[var0]).replace("\u0000", "\t");
      writer.write(var2);
      writer.write(var1);
      writer.newLine();
   }

    static void write(const std::string& var0) {
      writer.write(var0);
      writer.newLine();
   }
}
