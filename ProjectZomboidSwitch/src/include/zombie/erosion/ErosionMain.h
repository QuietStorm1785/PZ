...
public:
    ...
    int year = 0;
    int epoch = 0;
   private static const int[][] soilTable = new int[][]{
      {1, 1, 1, 1, 1, 4, 4, 4, 4, 4},
      {1, 1, 1, 1, 2, 5, 4, 4, 4, 4},
      {1, 1, 1, 2, 2, 5, 5, 4, 4, 4},
      {1, 1, 2, 2, 3, 6, 5, 5, 4, 4},
   ...
   private int[] snowFracOnDay;
    ...
    public ErosionMain(IsoSpriteManager var1, bool var2) {
      instance = this;
      this.sprMngr = var1;
      this.debug = var2;
      this.start();
    ...
    return true;
         ...
         this.cfgPath = ZomboidFileSystem.instance.getFileNameInCurrentSave(var1);
    File var2 = std::make_shared<File>(this.cfgPath);
         if (var2.exists()) {
    ...
    return true;
         ...
         var2 = std::make_shared<File>(ZomboidFileSystem.instance.getCacheDir() + File.separator + var1);
    ...
    int var3 = var1.tempMax;
         ...
         this.IceQueen = std::make_shared<ErosionIceQueen>(this.sprMngr);
