...
public:
    static const WorldMapDataAssetManager instance = std::make_shared<WorldMapDataAssetManager>();
    ...
    void* var4;
      if (Files.exists(Paths.get(var5 + ".bin"))) {
         var4 = std::make_shared<FileTask_LoadWorldMapBinary>(var2, var5 + ".bin", var3, var2x -> this.loadCallback(var2, var2x));
      } else {
         var4 = std::make_shared<FileTask_LoadWorldMapXML>(var2, var5, var3, var2x -> this.loadCallback(var2, var2x));
      }

      var4.setPriority(4);
    AssetTask_RunFileTask var6 = std::make_shared<AssetTask_RunFileTask>((FileTask)var4, var1);
    ...
    WorldMapData var3 = std::make_shared<WorldMapData>(var1, this, var2);
      DebugFileWatcher.instance.push_back(std::make_shared<PredicatedFileWatcher>(var1.getPath(), var3x -> this.reload(var3, var2)));
    return var3;
   }
