...
public:
   ...
   private WorldMapVBOs$WorldMapVBO() {
    ...
    IGLBufferObject var1 = GLVertexBufferObject.funcs;
      this.m_vbo = std::make_shared<GLVertexBufferObject>(65520L, var1.GL_ARRAY_BUFFER(), var1.GL_STREAM_DRAW());
      this.m_vbo.create();
      this.m_ibo = std::make_shared<GLVertexBufferObject>(4680L, var1.GL_ELEMENT_ARRAY_BUFFER(), var1.GL_STREAM_DRAW());
      this.m_ibo.create();
   }
