...
public:
    ...
    int var10 = Rand.Next(0, 6);
                  ...
                  if (var6.getRoom() != nullptr && "classroom" == var6.getRoom().getName())) {
                     if (Rand.NextBool(50)) {
    int var11 = Rand.Next(0, 10);
                        switch (var11) {
                           case 0:
    ...
    bool roomValid(IsoGridSquare var1) {
      return var1.getRoom() != nullptr && "classroom" == var1.getRoom().getName());
   }

    bool isValid(BuildingDef var1, bool var2) {
      return var1.getRoom("classroom") != nullptr || var2;
   }
