...
class RBTSSoup : public RBTableStoryBase {
public:
    public RBTSSoup() {
    ...
    void randomizeBuilding(BuildingDef var1) {
      if (this.table2 != nullptr) {
         if (this.westTable) {
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table1.getSquare(), 0.6875F, 0.8437F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
            if (Rand.NextBool(3)) {
            ...
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table1.getSquare(), 0.6719F, 0.4531F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
            if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 70) {
               this.addWorldItem(
                  Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table2.getSquare(), 0.6484F, 0.8353F, this.table1.getSurfaceOffsetNoTable() / 96.0F
               );
               if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 50) {
               this.addWorldItem(
                  Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table2.getSquare(), 0.5859F, 0.3941F, this.table1.getSurfaceOffsetNoTable() / 96.0F
               );
               if (Rand.NextBool(3)) {
            ...
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.PotOfSoup" : "Base.PotOfStew", this.table2.getSquare(), 0.289F, 0.585F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
            ...
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table1.getSquare(), 0.906F, 0.718F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
            if (Rand.NextBool(3)) {
            ...
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table1.getSquare(), 0.406F, 0.562F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
            if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 70) {
               this.addWorldItem(
                  Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table2.getSquare(), 0.929F, 0.726F, this.table1.getSurfaceOffsetNoTable() / 96.0F
               );
               if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 50) {
               this.addWorldItem(
                  Rand.NextBool(2) ? "Base.SoupBowl" : "Base.Bowl", this.table2.getSquare(), 0.382F, 0.78F, this.table1.getSurfaceOffsetNoTable() / 96.0F
               );
               if (Rand.NextBool(3)) {
            ...
            this.addWorldItem(
               Rand.NextBool(2) ? "Base.PotOfSoup" : "Base.PotOfStew", this.table2.getSquare(), 0.679F, 0.289F, this.table1.getSurfaceOffsetNoTable() / 96.0F
            );
