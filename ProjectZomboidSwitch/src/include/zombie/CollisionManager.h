...
public:
    ...
    static Vector2 axis = std::make_shared<Vector2>();
    static Polygon polygonA = std::make_shared<Polygon>();
    static Polygon polygonB = std::make_shared<Polygon>();
    float minA = 0.0F;
    float minB = 0.0F;
    float maxA = 0.0F;
    float maxB = 0.0F;
    PolygonCollisionResult result = std::make_shared<PolygonCollisionResult>(this);
   public std::vector<Contact> ContactMap = std::make_unique<std::vector<>>();
   int64_t[] longArray = new int64_t[1000];
   std::stack<Contact> contacts = std::make_unique<std::stack<>>();
    static const CollisionManager instance = std::make_shared<CollisionManager>();
    ...
    Vector2 var5 = std::make_shared<Vector2>();
    ...
    void initUpdate() {
      if (this.longArray[0] == nullptr) {
         for (int var1 = 0; var1 < this.longArray.length; var1++) {
            this.longArray[var1] = std::make_shared<int64_t>(0L);
         }
      }
    ...
    void AddContact(IsoMovingObject var1, IsoMovingObject var2) {
      if (!(dynamic_cast<IsoSurvivor*>(var1) != nullptr) && !(dynamic_cast<IsoSurvivor*>(var2) != nullptr) || !(dynamic_cast<IsoPushableObject*>(var1) != nullptr) && !(dynamic_cast<IsoPushableObject*>(var2) != nullptr)) {
         if (var1.getID() < var2.getID()) {
            this.ContactMap.push_back(this.contact(var1, var2));
         }
      }
   }
    ...
    Contact contact(IsoMovingObject var1, IsoMovingObject var2) {
      if (this.contacts.empty()) {
         for (int var3 = 0; var3 < 50; var3++) {
            this.contacts.push(std::make_shared<Contact>(this, nullptr, nullptr));
         }
      }
    ...
    PolygonCollisionResult var18 = this.PolygonCollision(var1);
               if (var18.WillIntersect) {
                  ...
                  if (var30.dynamic_cast<IsoPushableObject*>(a) != nullptr && var30.dynamic_cast<IsoSurvivor*>(b) != nullptr) {
                     ((IsoSurvivor)var30.b).bCollidedWithPushable = true;
                     ((IsoSurvivor)var30.b).collidePushable = (IsoPushableObject)var30.a;
                  } else if (var30.dynamic_cast<IsoPushableObject*>(b) != nullptr && var30.dynamic_cast<IsoSurvivor*>(a) != nullptr) {
                     ((IsoSurvivor)var30.a).bCollidedWithPushable = true;
                     ((IsoSurvivor)var30.a).collidePushable = (IsoPushableObject)var30.b;
                  }

                  if (var30.dynamic_cast<IsoPushableObject*>(a) != nullptr) {
    ...
    IsoPushableObject var23 = (IsoPushableObject)var20.get(var22);
                  ...
                  if (var30.dynamic_cast<IsoPushableObject*>(b) != nullptr) {
