...
public:
    static Vector2 deferredMovement = std::make_shared<Vector2>();

    static int getBooleanVariables(IsoPlayer var0) {
    int var1 = 0;
      var1 |= var0.isSneaking() ? 1 : 0;
      var1 |= var0.isOnFire() ? 2 : 0;
      var1 |= var0.isAsleep() ? 4 : 0;
      var1 |= FishingState.instance() == var0.getCurrentState()) ? 8 : 0;
      ...
      return var1 | ("fall" == var0.getVariableString("ClimbFenceOutcome")) ? 262144 : 0);
   }

    static void setBooleanVariables(IsoPlayer var0, int var1) {
    ...
    bool var2 = (var1 & 8) != 0;
      if (FishingState.instance() == var0.getCurrentState()) && !var2) {
