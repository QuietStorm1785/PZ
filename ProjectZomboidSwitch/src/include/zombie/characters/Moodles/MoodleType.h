...
#include <cstdint>
#include "zombie/characters/Moodles/MoodleType/1.h"
...
enum class MoodleType {
   ...
   MAX;
    ...
    static MoodleType FromIndex(int var0) {
      switch (var0) {
         case 0:
    return Endurance;
         case 1:
    ...
    static MoodleType FromString(const std::string& var0) {
      if (var0 == "Endurance")) {
    return Endurance;
      } else if (var0 == "Tired")) {
    return Tired;
    ...
    return Hyperthermia;
      } else if (var0 == "Hypothermia")) {
    return Hypothermia;
      } else {
         return var0 == "CantSprint") ? CantSprint : MAX;
      }
   }

    static std::string getDisplayName(MoodleType var0, int var1) {
      if (var1 > 4) {
         var1 = 4;
      }
    ...
    static std::string getDescriptionText(MoodleType var0, int var1) {
      if (var1 > 4) {
         var1 = 4;
      }
    ...
    static int GoodBadNeutral(MoodleType var0) {
      if (var0 == Endurance) {
    return 2;
      } else if (var0 == Tired) {
    return 2;
   ...
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
    static int ToIndex(MoodleType var0) {
      if (var0 == nullptr) {
    return 0;
      } else {
         switch (1.$SwitchMap$zombie$characters$Moodles$MoodleType[var0.ordinal()]) {
            case 1:
    return 0;
            case 2:
    return 1;
