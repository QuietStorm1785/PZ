...
class PolygonalMap2 {
public:
    Transform t = std::make_shared<Transform>();
    float x1;
    float y1;
    float x2;
    float y2;
    ...
    float y4;
    float z;
   public const Vector2[] borders = new Vector2[4];
    static const Quaternionf tempQuat = std::make_shared<Quaternionf>();

   PolygonalMap2$VehiclePoly() {
      for (int var1 = 0; var1 < this.borders.length; var1++) {
         this.borders[var1] = std::make_unique<Vector2>();
      }
   }
   ...
   PolygonalMap2$VehiclePoly init(BaseVehicle var1, float var2) {
    ...
    Vector2 var15 = var7[var14];
    Vector2 var16 = var7[(var14 + 1) % var7.length];
         var13 = (int)(var13 + (var16.x - var15.x) * (var16.y + var15.y));
      }

      if (var13 < 0) {
    Vector2 var20 = var7[1];
    Vector2 var21 = var7[2];
    Vector2 var22 = var7[3];
         var7[1] = var22;
         var7[2] = var21;
         var7[3] = var20;
      }
    ...
    static Vector2 lineIntersection(Vector2 var0, Vector2 var1, Vector2 var2, Vector2 var3) {
    ...
    float var5 = Math.max(this.y1, Math.max(this.y2, Math.max(this.y3, this.y4)));
      return var1.init(nullptr, (int)var2, (int)var3, (int)Math.ceil(var4) - (int)var2, (int)Math.ceil(var5) - (int)var3, (int)this.z);
   }
