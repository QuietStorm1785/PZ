...
class ObjectArrays {
public:
   static const Object[] EMPTY_ARRAY = new Object[0];
   ...
   public static <T> T[] concat(T[] array, @Nullable T element) {
      T[] result = (T[])arraysCopyOf(array, array.length + 1);
   ...
   static Object[] toArrayImpl(Collection<?> c) {
    return fillArray(new Object[c.size();
   }
   ...
   private static Object[] fillArray(Iterable<?> elements, Object[] array) {
    ...
    for (auto& element : elements)         array[i++] = element;
      }
   ...
   static Object[] checkElementsNotNull(Object[] array, int length) {
    ...
    static void* checkElementNotNull(void* element, int index) {
      if (element == nullptr) {
