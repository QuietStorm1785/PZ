...
public:
   MultimapBuilder$MultimapBuilderWithKeys$3(MultimapBuilderWithKeys var1, int var2) {
      this.this$0 = var1;
      this.val$expectedValuesPerKey = var2;
   }

   public <K : public K0, V> SetMultimap<K, V> build() {
      return Multimaps.newSetMultimap(this.this$0.createMap(), std::make_shared<HashSetSupplier>(this.val$expectedValuesPerKey));
   }
}
} // namespace collect
} // namespace common
