...
public:
   ServiceManager$ServiceManagerState$StoppedGuard(ServiceManagerState var1) {
      super(var1.monitor);
      this.this$0 = var1;
   }

    bool isSatisfied() {
      return this.this$0.states.count(State.TERMINATED) + this.this$0.states.count(State.FAILED) == this.this$0.numberOfServices;
   }
}
} // namespace concurrent
} // namespace util
