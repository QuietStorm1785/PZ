...
#include "com/google/common/util/concurrent/AbstractIdleService/ThreadNameSupplier.h"
...
public:
   private const Supplier<std::string> threadNameSupplier = std::make_shared<ThreadNameSupplier>(this, nullptr);
    const Service delegate = std::make_shared<DelegateService>(this, nullptr);
