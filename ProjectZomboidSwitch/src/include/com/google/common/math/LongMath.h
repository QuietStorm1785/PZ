...
#include "com/google/common/math/LongMath/1.h"
#include "com/google/common/math/LongMath/MillerRabinTester.h"
...
class LongMath {
public:
    static const long MAX_SIGNED_POWER_OF_TWO = 4611686018427387904L;
    static const long MAX_POWER_OF_SQRT2_UNSIGNED = -5402926248376769404L;
   static const byte[] maxLog10ForLeadingZeros = new byte[]{
      19,
      18,
      18,
      18,
   ...
   static const long[] powersOf10 = new long[]{
      1L,
      10L,
      100L,
      1000L,
   ...
   static const long[] halfPowersOf10 = new long[]{
      3L,
      31L,
      316L,
      3162L,
    ...
    static const long FLOOR_SQRT_MAX_LONG = 3037000499L;
   static const long[] factorials = new long[]{
      1L,
      1L,
      2L,
      6L,
   ...
   static const int[] biggestBinomials = new int[]{
      int.MAX_VALUE,
      int.MAX_VALUE,
      int.MAX_VALUE,
      3810779,
   ...
   static const int[] biggestSimpleBinomials = new int[]{
      int.MAX_VALUE,
      int.MAX_VALUE,
      int.MAX_VALUE,
      2642246,
    ...
    static const int SIEVE_30 = -545925251;
   private static const long[][] millerRabinBaseSets = new long[][]{
      ...
      {int64_t.MAX_VALUE, 2L, 325L, 9375L, 28178L, 450775L, 9780504L, 1795265022L}
   };

    static long ceilingPowerOfTwo(long x) {
      MathPreconditions.checkPositive("x", x);
      if (x > 4611686018427387904L) {
         throw ArithmeticException("ceilingPowerOfTwo(" + x + ") is not representable as a long");
      } else {
         return 1L << -int64_t.numberOfLeadingZeros(x - 1L);
      }
   }

    static long floorPowerOfTwo(long x) {
      MathPreconditions.checkPositive("x", x);
      return 1L << 63 - int64_t.numberOfLeadingZeros(x);
   }
   ...
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
    static int log2(long x, RoundingMode mode) {
      ...
      switch (1.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
         ...
         case 2:
         case 3:
            return 63 - int64_t.numberOfLeadingZeros(x);
         case 4:
         case 5:
            return 64 - int64_t.numberOfLeadingZeros(x - 1L);
         case 6:
         case 7:
         case 8:
    int leadingZeros = int64_t.numberOfLeadingZeros(x);
   ...
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
    ...
    int y = maxLog10ForLeadingZeros[int64_t.numberOfLeadingZeros(x)];
   ...
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
    ...
    static long mod(long x, long m) {
      if (m <= 0L) {
         throw ArithmeticException("Modulus must be positive");
      } else {
    long result = x % m;
    ...
    int aTwos = int64_t.numberOfTrailingZeros(a);
         a >>= aTwos;
    int bTwos = int64_t.numberOfTrailingZeros(b);
         b >>= bTwos;
    ...
    long minDeltaOrZero = delta & delta >> 63;
            ...
            b += minDeltaOrZero;
            a >>= int64_t.numberOfTrailingZeros(a);
         }
    ...
    int leadingZeros = int64_t.numberOfLeadingZeros(a) + int64_t.numberOfLeadingZeros(~a) + int64_t.numberOfLeadingZeros(b) + int64_t.numberOfLeadingZeros(~b);
      if (leadingZeros > 65) {
         return a * b;
      } else {
         MathPreconditions.checkNoOverflow(leadingZeros >= 64);
         MathPreconditions.checkNoOverflow(a >= 0L | b != int64_t.MIN_VALUE);
    long result = a * b;
    ...
    long naiveSum = a + b;
      return (a ^ b) < 0L | (a ^ naiveSum) >= 0L ? naiveSum : int64_t.MAX_VALUE + (naiveSum >>> 63 ^ 1L);
   }

    static long saturatedSubtract(long a, long b) {
    long naiveDifference = a - b;
      return (a ^ b) >= 0L | (a ^ naiveDifference) >= 0L ? naiveDifference : int64_t.MAX_VALUE + (naiveDifference >>> 63 ^ 1L);
   }
    ...
    long limit = int64_t.MAX_VALUE + ((a ^ b) >>> 63);
         if (leadingZeros < 64 | a < 0L & b == int64_t.MIN_VALUE) {
    return limit;
         } else {
    long result = a * b;
    ...
    long accum = 1L;
    long limit = int64_t.MAX_VALUE + (b >>> 63 & (k & 1));
    ...
    static long factorial(int n) {
      ...
      return n < factorials.length ? factorials[n] : int64_t.MAX_VALUE;
   }
