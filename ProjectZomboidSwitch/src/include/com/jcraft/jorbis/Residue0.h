...
#include "com/jcraft/jorbis/Residue0/LookResidue0.h"
...
public:
   ...
   static /* synchronized - TODO: add std::mutex */ int _01inverse(Block var0, Object var1, float[][] var2, int var3, int var4) {
    ...
    int var16 = (var15 + var13 - 1) / var13;
      ...
      for (int var6 = 0; var6 < var3; var6++) {
         if (_01inverse_partword[var6] == nullptr || _01inverse_partword[var6].length < var16) {
    ...
    int var17 = var10.phrasebook.decode(var0.opb);
                  if (var17 == -1) {
    return 0;
                  }

                  _01inverse_partword[var20][var8] = var10.decodemap[var17];
                  if (_01inverse_partword[var20][var8] == nullptr) {
    return 0;
                  }
               }
            }
    ...
    CodeBook var19 = var10.fullbooks[var10.partbooks[var18][var9]];
                     if (var19 != nullptr) {
                        if (var4 == 0) {
                           if (var19.decodevs_add(var2[var21], var22, var0.opb, var12) == -1) {
    return 0;
                           }
                        } else if (var4 == 1 && var19.decodev_add(var2[var21], var22, var0.opb, var12) == -1) {
    return 0;
                        }
                     }
                  }
   ...
   static /* synchronized - TODO: add std::mutex */ int _2inverse(Block var0, Object var1, float[][] var2, int var3) {
    ...
    int var14 = (var13 + var11 - 1) / var11;
      if (_2inverse_partword == nullptr || _2inverse_partword.length < var14) {
    ...
    int var4 = 0;
         ...
         for (int var6 = 0; var4 < var13; var6++) {
            if (var7 == 0) {
    int var15 = var8.phrasebook.decode(var0.opb);
               if (var15 == -1) {
    return 0;
               }

               _2inverse_partword[var6] = var8.decodemap[var15];
               if (_2inverse_partword[var6] == nullptr) {
    return 0;
               }
            }
    ...
    CodeBook var17 = var8.fullbooks[var8.partbooks[var16][var7]];
                  if (var17 != nullptr && var17.decodevv_add(var2, var18, var3, var0.opb, var10) == -1) {
    return 0;
                  }
               }
    ...
    int var6 = 0;
      ...
      return var6 != 0 ? _01inverse(var1, var2, var3, var6, 0) : 0;
   }

    void* look(DspState var1, InfoMode var2, void* var3) {
    InfoResidue0 var4 = (InfoResidue0)var3;
    LookResidue0 var5 = std::make_shared<LookResidue0>(this);
    int var6 = 0;
    int var8 = 0;
      var5.info = var4;
    ...
    int var11 = Util.ilog(var10);
      ...
      var5.partvals = (int)Math.rint(Math.pow(var5.parts, var7));
      var5.stages = var8;
    ...
    int var6 = var3.secondstages[var5];
      ...
      for (int var7 = 0; var7 < var4; var7++) {
         var2.write(var3.booklist[var7], 8);
      }
   }

    void* unpack(Info var1, Buffer var2) {
    int var3 = 0;
    InfoResidue0 var4 = std::make_shared<InfoResidue0>(this);
    ...
    int var6 = var2.read(3);
      ...
      for (int var7 = 0; var7 < var3; var7++) {
         var4.booklist[var7] = var2.read(8);
      }
    ...
    return nullptr;
         ...
         for (int var8 = 0; var8 < var3; var8++) {
            if (var4.booklist[var8] >= var1.books) {
               this.free_info(var4);
    return nullptr;
            }
         }
