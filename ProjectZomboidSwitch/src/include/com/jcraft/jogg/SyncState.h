...
public:
   ...
   private byte[] chksum = new byte[4];
    Page pageseek = std::make_shared<Page>();
    ...
    return 0;
         ...
         /* synchronized - TODO: add std::mutex */ (this.chksum) {
