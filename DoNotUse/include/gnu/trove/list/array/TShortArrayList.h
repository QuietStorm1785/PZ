...
#include "gnu/trove/list/array/TShortArrayList/1.h"
#include "gnu/trove/list/array/TShortArrayList/TShortArrayIterator.h"
...
public:
   ...
   protected short[] _data;
    ...
    protected TShortArrayList(short[] values, short no_entry_value, bool wrap) {
      if (!wrap) {
    ...
    static TShortArrayList wrap(short[] values) {
    return wrap();
   }

    static TShortArrayList wrap(short[] values, short no_entry_value) {
    ...
    void setQuick(int offset, short val) {
      this._data[offset] = val;
   }
    ...
    TShortIterator iterator() {
      return std::make_shared<TShortArrayIterator>(this, 0);
   }
    ...
    for (auto& element : collection)    short e = element;
         if (this.push_back(e)) {
            changed = true;
         }
      }
    ...
    TShortArrayList list = std::make_shared<TShortArrayList>(end - begin);
   ...
   public short[] toArray(short[] dest, int source_pos, int dest_pos, int len) {
    ...
    bool equals(void* other) {
      if (other == this) {
    return true;
      } else if (dynamic_cast<TShortArrayList*>(other) != nullptr) {
    ...
    TShortArrayList list = std::make_shared<TShortArrayList>();
