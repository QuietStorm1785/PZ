...
#include <cstdint>
#include "gnu/trove/decorator/TLongCharMapDecorator/1.h"
...
class TLongCharMapDecorator : public AbstractMap {
public:
   ...
   public Set<Entry<int64_t, char>> entrySet() {
    ...
    void putAll(Map<? extends, ? extends) {
      Iterator<? : public Entry<? : public int64_t, ? : public char>> it = map.entrySet().iterator();
    int i = map.size();

      while (i-- > 0) {
         Entry<? : public int64_t, ? : public char> e = (Entry<? : public int64_t, ? : public char>)it.next();
