...
#include <cstdint>
#include "gnu/trove/decorator/TByteFloatMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TByteFloatMapDecorator$1(TByteFloatMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, float>> iterator() {
