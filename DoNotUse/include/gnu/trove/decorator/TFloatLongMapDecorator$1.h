...
#include <cstdint>
#include "gnu/trove/decorator/TFloatLongMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TFloatLongMapDecorator$1(TFloatLongMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<float, int64_t>> iterator() {
