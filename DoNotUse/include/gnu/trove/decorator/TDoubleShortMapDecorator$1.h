...
#include <cstdint>
#include "gnu/trove/decorator/TDoubleShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TDoubleShortMapDecorator$1(TDoubleShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<double, int16_t>> iterator() {
