...
#include <cstdint>
#include "gnu/trove/decorator/TDoubleLongMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TDoubleLongMapDecorator$1(TDoubleLongMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<double, int64_t>> iterator() {
