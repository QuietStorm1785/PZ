...
#include <cstdint>
#include "gnu/trove/decorator/TDoubleCharMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TDoubleCharMapDecorator$1(TDoubleCharMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<double, char>> iterator() {
