...
#include <cstdint>
#include "gnu/trove/decorator/TShortLongMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TShortLongMapDecorator {
public:
   TShortLongMapDecorator$1(TShortLongMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, int64_t>> iterator() {
