...
public:
    const TCharByteIterator it;

   TCharByteMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<char, uint8_t> next() {
      this.it.advance();
    char ik = this.it.key();
    ...
    uint8_t v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TCharByteMapDecorator.1.1.1(this, v, key);
   }
