...
#include <cstdint>
#include "gnu/trove/decorator/TCharShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TCharShortMapDecorator$1(TCharShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<char, int16_t>> iterator() {
