...
class TIntDoubleMapDecorator : public AbstractMap {
public:
   ...
   public Set<Entry<int, double>> entrySet() {
    ...
    void putAll(Map<? extends, ? extends) {
      Iterator<? : public Entry<? : public int, ? : public double>> it = map.entrySet().iterator();
    int i = map.size();

      while (i-- > 0) {
         Entry<? : public int, ? : public double> e = (Entry<? : public int, ? : public double>)it.next();
