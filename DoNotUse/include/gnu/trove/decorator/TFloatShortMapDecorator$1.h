...
#include <cstdint>
#include "gnu/trove/decorator/TFloatShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TFloatShortMapDecorator {
public:
   TFloatShortMapDecorator$1(TFloatShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<float, int16_t>> iterator() {
