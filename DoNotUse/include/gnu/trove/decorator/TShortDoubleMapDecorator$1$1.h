...
public:
    const TShortDoubleIterator it;

   TShortDoubleMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<int16_t, double> next() {
      this.it.advance();
    ...
    double v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TShortDoubleMapDecorator.1.1.1(this, v, key);
   }
