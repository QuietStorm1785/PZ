...
#include <cstdint>
#include "gnu/trove/decorator/TByteByteMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TByteByteMapDecorator$1(TByteByteMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, uint8_t>> iterator() {
