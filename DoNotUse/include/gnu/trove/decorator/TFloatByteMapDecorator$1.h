...
#include <cstdint>
#include "gnu/trove/decorator/TFloatByteMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TFloatByteMapDecorator$1(TFloatByteMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<float, uint8_t>> iterator() {
