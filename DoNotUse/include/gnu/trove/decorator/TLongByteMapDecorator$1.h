...
#include <cstdint>
#include "gnu/trove/decorator/TLongByteMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TLongByteMapDecorator$1(TLongByteMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int64_t, uint8_t>> iterator() {
