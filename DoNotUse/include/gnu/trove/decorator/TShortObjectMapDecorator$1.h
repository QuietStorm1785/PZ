...
#include <cstdint>
#include "gnu/trove/decorator/TShortObjectMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TShortObjectMapDecorator$1(TShortObjectMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, V>> iterator() {
    ...
    bool addAll(Collection<? extends, V>> c) {
      throw std::make_unique<UnsupportedOperationException>();
   }
