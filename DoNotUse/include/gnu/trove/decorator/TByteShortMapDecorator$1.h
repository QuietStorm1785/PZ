...
#include <cstdint>
#include "gnu/trove/decorator/TByteShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
class TByteShortMapDecorator {
public:
   TByteShortMapDecorator$1(TByteShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, int16_t>> iterator() {
