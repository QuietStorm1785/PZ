...
public:
    const TLongIntIterator it;

   TLongIntMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<int64_t, int> next() {
      this.it.advance();
    long ik = this.it.key();
    ...
    int v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TLongIntMapDecorator.1.1.1(this, v, key);
   }
