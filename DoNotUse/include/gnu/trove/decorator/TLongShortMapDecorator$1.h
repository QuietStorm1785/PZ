...
#include <cstdint>
#include "gnu/trove/decorator/TLongShortMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TLongShortMapDecorator$1(TLongShortMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int64_t, int16_t>> iterator() {
