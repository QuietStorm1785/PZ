...
#include <cstdint>
#include "gnu/trove/decorator/TShortByteMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TShortByteMapDecorator$1(TShortByteMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<int16_t, uint8_t>> iterator() {
