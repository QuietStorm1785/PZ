...
public:
    const TShortCharIterator it;

   TShortCharMapDecorator$1$1(1 var1) {
      this.this$1 = var1;
      this.it = this.this$1.this$0._map.iterator();
   }

   public Entry<int16_t, char> next() {
      this.it.advance();
    ...
    char v = iv == this.this$1.this$0._map.getNoEntryValue() ? nullptr : this.this$1.this$0.wrapValue(iv);
      return new gnu.trove.decorator.TShortCharMapDecorator.1.1.1(this, v, key);
   }
