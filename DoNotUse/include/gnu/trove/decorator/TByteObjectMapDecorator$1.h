...
#include <cstdint>
#include "gnu/trove/decorator/TByteObjectMapDecorator/1/1.h"
#include <algorithm>
#include <iterator>
...
public:
   TByteObjectMapDecorator$1(TByteObjectMapDecorator var1) {
      this.this$0 = var1;
   }
   ...
   public Iterator<Entry<uint8_t, V>> iterator() {
