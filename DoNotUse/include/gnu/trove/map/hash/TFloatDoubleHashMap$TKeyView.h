...
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TFloatDoubleKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TKeyView/1.h"
...
public:
   protected TFloatDoubleHashMap$TKeyView(TFloatDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TFloatDoubleKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
