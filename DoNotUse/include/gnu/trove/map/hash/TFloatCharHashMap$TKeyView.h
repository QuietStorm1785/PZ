...
#include "gnu/trove/map/hash/TFloatCharHashMap/TFloatCharKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/TKeyView/1.h"
...
public:
   protected TFloatCharHashMap$TKeyView(TFloatCharHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TFloatCharKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
