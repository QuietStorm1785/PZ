...
#include "gnu/trove/map/hash/TFloatCharHashMap/TFloatCharValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatCharHashMap/TValueView/1.h"
...
public:
   protected TFloatCharHashMap$TValueView(TFloatCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TFloatCharValueHashIterator>(this.this$0, this.this$0);
   }
