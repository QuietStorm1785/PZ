...
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TFloatDoubleValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatDoubleHashMap/TValueView/1.h"
...
public:
   protected TFloatDoubleHashMap$TValueView(TFloatDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TFloatDoubleValueHashIterator>(this.this$0, this.this$0);
   }
