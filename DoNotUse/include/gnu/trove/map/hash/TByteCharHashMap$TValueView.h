...
#include "gnu/trove/map/hash/TByteCharHashMap/TByteCharValueHashIterator.h"
#include "gnu/trove/map/hash/TByteCharHashMap/TValueView/1.h"
...
public:
   protected TByteCharHashMap$TValueView(TByteCharHashMap var1) {
    ...
    TCharIterator iterator() {
      return std::make_shared<TByteCharValueHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TByteCharHashMap.access$400(this.this$0);
   }

    int size() {
      return TByteCharHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteCharHashMap.access$600(this.this$0);
   }
