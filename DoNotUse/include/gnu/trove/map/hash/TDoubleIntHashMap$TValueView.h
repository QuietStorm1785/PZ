...
#include "gnu/trove/map/hash/TDoubleIntHashMap/TDoubleIntValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleIntHashMap/TValueView/1.h"
...
public:
   protected TDoubleIntHashMap$TValueView(TDoubleIntHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TDoubleIntValueHashIterator>(this.this$0, this.this$0);
   }
