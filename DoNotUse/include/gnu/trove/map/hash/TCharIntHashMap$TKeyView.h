...
#include "gnu/trove/map/hash/TCharIntHashMap/TCharIntKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharIntHashMap/TKeyView/1.h"
...
public:
   protected TCharIntHashMap$TKeyView(TCharIntHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharIntKeyHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TCharIntHashMap.access$000(this.this$0);
   }

    int size() {
      return TCharIntHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharIntHashMap.access$200(this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
