...
#include "gnu/trove/map/hash/TLongLongHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongLongHashMap/TLongLongKeyHashIterator.h"
...
public:
   protected TLongLongHashMap$TKeyView(TLongLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
