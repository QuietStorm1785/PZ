...
#include "gnu/trove/map/hash/TCharCharHashMap/TCharCharKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharCharHashMap/TKeyView/1.h"
...
public:
   protected TCharCharHashMap$TKeyView(TCharCharHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharCharKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
