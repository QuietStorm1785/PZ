...
#include "gnu/trove/map/hash/TCharByteHashMap/TCharByteValueHashIterator.h"
#include "gnu/trove/map/hash/TCharByteHashMap/TValueView/1.h"
...
public:
   protected TCharByteHashMap$TValueView(TCharByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TCharByteValueHashIterator>(this.this$0, this.this$0);
   }

    uint8_t getNoEntryValue() {
      return TCharByteHashMap.access$400(this.this$0);
   }

    int size() {
      return TCharByteHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharByteHashMap.access$600(this.this$0);
   }
