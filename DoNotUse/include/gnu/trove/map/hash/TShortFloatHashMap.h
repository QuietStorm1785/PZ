...
#include "gnu/trove/impl/hash/TShortFloatHash.h"
#include "gnu/trove/iterator/TShortFloatIterator.h"
#include "gnu/trove/map/TShortFloatMap.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/1.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/TShortFloatHashIterator.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/TValueView.h"
...
class TShortFloatHashMap : public TShortFloatHash {
public:
   ...
   protected transient float[] _values;
    ...
    public TShortFloatHashMap(TShortFloatMap map) {
      super(map.size());
      if (dynamic_cast<TShortFloatHashMap*>(map) != nullptr) {
    ...
    float doPut(short key, float value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int16_t, ? : public float> entry : map.entrySet()) {
   ...
   public float[] values(float[] array) {
    ...
    TShortFloatIterator iterator() {
      return std::make_shared<TShortFloatHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TShortFloatMap*>(other) != nullptr)) {
    return false;
      } else {
