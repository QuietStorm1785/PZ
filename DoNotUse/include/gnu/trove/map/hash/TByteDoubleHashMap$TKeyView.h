...
#include "gnu/trove/map/hash/TByteDoubleHashMap/TByteDoubleKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteDoubleHashMap/TKeyView/1.h"
...
public:
   protected TByteDoubleHashMap$TKeyView(TByteDoubleHashMap var1) {
    ...
    TByteIterator iterator() {
      return std::make_shared<TByteDoubleKeyHashIterator>(this.this$0, this.this$0);
   }

    uint8_t getNoEntryValue() {
      return TByteDoubleHashMap.access$000(this.this$0);
   }

    int size() {
      return TByteDoubleHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteDoubleHashMap.access$200(this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
