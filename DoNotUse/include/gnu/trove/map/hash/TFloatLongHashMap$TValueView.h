...
#include "gnu/trove/map/hash/TFloatLongHashMap/TFloatLongValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/TValueView/1.h"
...
public:
   protected TFloatLongHashMap$TValueView(TFloatLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TFloatLongValueHashIterator>(this.this$0, this.this$0);
   }
