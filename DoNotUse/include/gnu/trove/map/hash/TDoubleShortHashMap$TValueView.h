...
#include "gnu/trove/map/hash/TDoubleShortHashMap/TDoubleShortValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleShortHashMap/TValueView/1.h"
...
public:
   protected TDoubleShortHashMap$TValueView(TDoubleShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TDoubleShortValueHashIterator>(this.this$0, this.this$0);
   }
