...
#include "gnu/trove/map/hash/TIntIntHashMap/1.h"
#include "gnu/trove/map/hash/TIntIntHashMap/TIntIntHashIterator.h"
#include "gnu/trove/map/hash/TIntIntHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TIntIntHashMap/TValueView.h"
...
class TIntIntHashMap : public TIntIntHash {
public:
   ...
   protected transient int[] _values;
    ...
    public TIntIntHashMap(TIntIntMap map) {
      super(map.size());
      if (dynamic_cast<TIntIntHashMap*>(map) != nullptr) {
    ...
    int doPut(int key, int value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int, ? : public int> entry : map.entrySet()) {
   ...
   public int[] values(int[] array) {
    ...
    TIntIntIterator iterator() {
      return std::make_shared<TIntIntHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TIntIntMap*>(other) != nullptr)) {
    return false;
      } else {
