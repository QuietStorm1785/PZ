...
#include "gnu/trove/map/hash/TByteLongHashMap/TByteLongValueHashIterator.h"
#include "gnu/trove/map/hash/TByteLongHashMap/TValueView/1.h"
...
public:
   protected TByteLongHashMap$TValueView(TByteLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TByteLongValueHashIterator>(this.this$0, this.this$0);
   }
