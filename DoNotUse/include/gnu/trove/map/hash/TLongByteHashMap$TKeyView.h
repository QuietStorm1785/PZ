...
#include "gnu/trove/map/hash/TLongByteHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongByteHashMap/TLongByteKeyHashIterator.h"
...
public:
   protected TLongByteHashMap$TKeyView(TLongByteHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongByteKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongByteHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
