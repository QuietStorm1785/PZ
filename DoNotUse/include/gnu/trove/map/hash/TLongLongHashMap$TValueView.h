...
#include "gnu/trove/map/hash/TLongLongHashMap/TLongLongValueHashIterator.h"
#include "gnu/trove/map/hash/TLongLongHashMap/TValueView/1.h"
...
public:
   protected TLongLongHashMap$TValueView(TLongLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongLongValueHashIterator>(this.this$0, this.this$0);
   }
