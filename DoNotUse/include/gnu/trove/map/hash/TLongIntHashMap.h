...
#include "gnu/trove/map/hash/TLongIntHashMap/1.h"
#include "gnu/trove/map/hash/TLongIntHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TLongIntHashMap/TLongIntHashIterator.h"
#include "gnu/trove/map/hash/TLongIntHashMap/TValueView.h"
...
class TLongIntHashMap : public TLongIntHash {
public:
   ...
   protected transient int[] _values;
    ...
    public TLongIntHashMap(TLongIntMap map) {
      super(map.size());
      if (dynamic_cast<TLongIntHashMap*>(map) != nullptr) {
    ...
    int doPut(long key, int value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int64_t, ? : public int> entry : map.entrySet()) {
   ...
   public int[] values(int[] array) {
    ...
    TLongIntIterator iterator() {
      return std::make_shared<TLongIntHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TLongIntMap*>(other) != nullptr)) {
    return false;
      } else {
