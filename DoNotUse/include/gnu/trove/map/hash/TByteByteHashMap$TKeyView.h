...
#include "gnu/trove/map/hash/TByteByteHashMap/TByteByteKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteByteHashMap/TKeyView/1.h"
...
public:
   protected TByteByteHashMap$TKeyView(TByteByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteByteKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteByteHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
