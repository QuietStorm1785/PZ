...
#include "gnu/trove/map/hash/TShortIntHashMap/TShortIntValueHashIterator.h"
#include "gnu/trove/map/hash/TShortIntHashMap/TValueView/1.h"
...
public:
   protected TShortIntHashMap$TValueView(TShortIntHashMap var1) {
    ...
    TIntIterator iterator() {
      return std::make_shared<TShortIntValueHashIterator>(this.this$0, this.this$0);
   }
