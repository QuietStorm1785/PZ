...
#include "gnu/trove/map/hash/TCharFloatHashMap/TCharFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TCharFloatHashMap/TValueView/1.h"
...
public:
   protected TCharFloatHashMap$TValueView(TCharFloatHashMap var1) {
    ...
    TFloatIterator iterator() {
      return std::make_shared<TCharFloatValueHashIterator>(this.this$0, this.this$0);
   }

    float getNoEntryValue() {
      return TCharFloatHashMap.access$400(this.this$0);
   }

    int size() {
      return TCharFloatHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharFloatHashMap.access$600(this.this$0);
   }
