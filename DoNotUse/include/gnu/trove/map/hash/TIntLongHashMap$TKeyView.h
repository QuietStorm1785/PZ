...
#include "gnu/trove/map/hash/TIntLongHashMap/TIntLongKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntLongHashMap/TKeyView/1.h"
...
public:
   protected TIntLongHashMap$TKeyView(TIntLongHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntLongKeyHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TIntLongHashMap.access$000(this.this$0);
   }

    int size() {
      return TIntLongHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntLongHashMap.access$200(this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
