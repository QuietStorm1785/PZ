...
#include "gnu/trove/map/hash/TShortByteHashMap/TShortByteValueHashIterator.h"
#include "gnu/trove/map/hash/TShortByteHashMap/TValueView/1.h"
...
public:
   protected TShortByteHashMap$TValueView(TShortByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TShortByteValueHashIterator>(this.this$0, this.this$0);
   }
