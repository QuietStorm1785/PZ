...
#include "gnu/trove/map/hash/TShortFloatHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TShortFloatHashMap/TShortFloatKeyHashIterator.h"
...
public:
   protected TShortFloatHashMap$TKeyView(TShortFloatHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortFloatKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public short[] toArray(short[] dest) {
    ...
    bool remove(short entry) {
      return TShortFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
