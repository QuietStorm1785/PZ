...
#include "gnu/trove/map/hash/TCharLongHashMap/TCharLongKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharLongHashMap/TKeyView/1.h"
...
public:
   protected TCharLongHashMap$TKeyView(TCharLongHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
