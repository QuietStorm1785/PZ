...
#include "gnu/trove/map/hash/TIntIntHashMap/TIntIntKeyHashIterator.h"
#include "gnu/trove/map/hash/TIntIntHashMap/TKeyView/1.h"
...
public:
   protected TIntIntHashMap$TKeyView(TIntIntHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TIntIntKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public int[] toArray(int[] dest) {
    ...
    bool remove(int entry) {
      return TIntIntHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
