...
#include "gnu/trove/map/hash/TCharObjectHashMap/KeyView/TCharHashIterator.h"
...
public:
   TCharObjectHashMap$KeyView(TCharObjectHashMap var1) {
      this.this$0 = var1;
   }
    ...
    TCharIterator iterator() {
      return std::make_shared<TCharHashIterator>(this, this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    for (auto& element : collection)         if (!this.this$0.containsKey((char)element)) {
    return false;
         }
      }
