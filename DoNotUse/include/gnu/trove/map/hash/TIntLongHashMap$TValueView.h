...
#include "gnu/trove/map/hash/TIntLongHashMap/TIntLongValueHashIterator.h"
#include "gnu/trove/map/hash/TIntLongHashMap/TValueView/1.h"
...
public:
   protected TIntLongHashMap$TValueView(TIntLongHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TIntLongValueHashIterator>(this.this$0, this.this$0);
   }

    long getNoEntryValue() {
      return TIntLongHashMap.access$400(this.this$0);
   }

    int size() {
      return TIntLongHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntLongHashMap.access$600(this.this$0);
   }
