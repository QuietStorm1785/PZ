...
#include "gnu/trove/map/hash/TIntByteHashMap/TIntByteValueHashIterator.h"
#include "gnu/trove/map/hash/TIntByteHashMap/TValueView/1.h"
...
public:
   protected TIntByteHashMap$TValueView(TIntByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TIntByteValueHashIterator>(this.this$0, this.this$0);
   }

    uint8_t getNoEntryValue() {
      return TIntByteHashMap.access$400(this.this$0);
   }

    int size() {
      return TIntByteHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TIntByteHashMap.access$600(this.this$0);
   }
