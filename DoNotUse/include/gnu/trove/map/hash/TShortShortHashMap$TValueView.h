...
#include "gnu/trove/map/hash/TShortShortHashMap/TShortShortValueHashIterator.h"
#include "gnu/trove/map/hash/TShortShortHashMap/TValueView/1.h"
...
public:
   protected TShortShortHashMap$TValueView(TShortShortHashMap var1) {
      this.this$0 = var1;
   }

    TShortIterator iterator() {
      return std::make_shared<TShortShortValueHashIterator>(this.this$0, this.this$0);
   }

    short getNoEntryValue() {
      return TShortShortHashMap.access$400(this.this$0);
   }

    int size() {
      return TShortShortHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TShortShortHashMap.access$600(this.this$0);
   }
