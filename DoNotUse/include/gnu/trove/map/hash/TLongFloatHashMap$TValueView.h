...
#include "gnu/trove/map/hash/TLongFloatHashMap/TLongFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/TValueView/1.h"
...
public:
   protected TLongFloatHashMap$TValueView(TLongFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TLongFloatValueHashIterator>(this.this$0, this.this$0);
   }

    float getNoEntryValue() {
      return TLongFloatHashMap.access$400(this.this$0);
   }

    int size() {
      return TLongFloatHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongFloatHashMap.access$600(this.this$0);
   }
