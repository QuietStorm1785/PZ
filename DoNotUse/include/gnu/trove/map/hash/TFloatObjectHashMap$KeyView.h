...
#include "gnu/trove/map/hash/TFloatObjectHashMap/KeyView/TFloatHashIterator.h"
...
public:
   TFloatObjectHashMap$KeyView(TFloatObjectHashMap var1) {
    ...
    int size() {
      return TFloatObjectHashMap.access$000(this.this$0);
   }

    bool isEmpty() {
      return TFloatObjectHashMap.access$100(this.this$0) == 0;
   }
    ...
    TFloatIterator iterator() {
      return std::make_shared<TFloatHashIterator>(this, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    for (auto& element : collection)         if (!this.this$0.containsKey((float)element)) {
    return false;
         }
      }
