...
#include "gnu/trove/map/hash/TObjectFloatHashMap/TFloatValueCollection/1.h"
#include "gnu/trove/map/hash/TObjectFloatHashMap/TFloatValueCollection/TObjectFloatValueHashIterator.h"
...
public:
   TObjectFloatHashMap$TFloatValueCollection(TObjectFloatHashMap var1) {
    ...
    int size() {
      return TObjectFloatHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TObjectFloatHashMap.access$200(this.this$0);
   }
