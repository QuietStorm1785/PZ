...
#include "gnu/trove/map/hash/TCharShortHashMap/TCharShortKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharShortHashMap/TKeyView/1.h"
...
public:
   protected TCharShortHashMap$TKeyView(TCharShortHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharShortKeyHashIterator>(this.this$0, this.this$0);
   }

    char getNoEntryValue() {
      return TCharShortHashMap.access$000(this.this$0);
   }

    int size() {
      return TCharShortHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharShortHashMap.access$200(this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharShortHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
