...
#include "gnu/trove/map/hash/TFloatLongHashMap/TFloatLongKeyHashIterator.h"
#include "gnu/trove/map/hash/TFloatLongHashMap/TKeyView/1.h"
...
public:
   protected TFloatLongHashMap$TKeyView(TFloatLongHashMap var1) {
    ...
    TFloatIterator iterator() {
      return std::make_shared<TFloatLongKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public float[] toArray(float[] dest) {
    ...
    bool remove(float entry) {
      return TFloatLongHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
