...
#include "gnu/trove/map/hash/TByteCharHashMap/TByteCharKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteCharHashMap/TKeyView/1.h"
...
public:
   protected TByteCharHashMap$TKeyView(TByteCharHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteCharKeyHashIterator>(this.this$0, this.this$0);
   }

    uint8_t getNoEntryValue() {
      return TByteCharHashMap.access$000(this.this$0);
   }

    int size() {
      return TByteCharHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteCharHashMap.access$200(this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteCharHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
