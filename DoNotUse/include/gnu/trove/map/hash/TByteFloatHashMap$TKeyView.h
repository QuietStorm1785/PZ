...
#include "gnu/trove/map/hash/TByteFloatHashMap/TByteFloatKeyHashIterator.h"
#include "gnu/trove/map/hash/TByteFloatHashMap/TKeyView/1.h"
...
public:
   protected TByteFloatHashMap$TKeyView(TByteFloatHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteFloatKeyHashIterator>(this.this$0, this.this$0);
   }

    uint8_t getNoEntryValue() {
      return TByteFloatHashMap.access$000(this.this$0);
   }

    int size() {
      return TByteFloatHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteFloatHashMap.access$200(this.this$0);
   }
   ...
   public byte[] toArray(byte[] dest) {
    ...
    bool remove(uint8_t entry) {
      return TByteFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
