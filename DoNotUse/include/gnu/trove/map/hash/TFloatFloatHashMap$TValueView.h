...
#include "gnu/trove/map/hash/TFloatFloatHashMap/TFloatFloatValueHashIterator.h"
#include "gnu/trove/map/hash/TFloatFloatHashMap/TValueView/1.h"
...
public:
   protected TFloatFloatHashMap$TValueView(TFloatFloatHashMap var1) {
      this.this$0 = var1;
   }

    TFloatIterator iterator() {
      return std::make_shared<TFloatFloatValueHashIterator>(this.this$0, this.this$0);
   }
