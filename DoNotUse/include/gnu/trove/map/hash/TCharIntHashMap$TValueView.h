...
#include "gnu/trove/map/hash/TCharIntHashMap/TCharIntValueHashIterator.h"
#include "gnu/trove/map/hash/TCharIntHashMap/TValueView/1.h"
...
public:
   protected TCharIntHashMap$TValueView(TCharIntHashMap var1) {
      this.this$0 = var1;
   }

    TIntIterator iterator() {
      return std::make_shared<TCharIntValueHashIterator>(this.this$0, this.this$0);
   }

    int getNoEntryValue() {
      return TCharIntHashMap.access$400(this.this$0);
   }

    int size() {
      return TCharIntHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TCharIntHashMap.access$600(this.this$0);
   }
