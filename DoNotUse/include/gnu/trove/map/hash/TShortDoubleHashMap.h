...
#include "gnu/trove/impl/hash/TShortDoubleHash.h"
#include "gnu/trove/iterator/TShortDoubleIterator.h"
#include "gnu/trove/map/TShortDoubleMap.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/1.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/TKeyView.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/TShortDoubleHashIterator.h"
#include "gnu/trove/map/hash/TShortDoubleHashMap/TValueView.h"
...
class TShortDoubleHashMap : public TShortDoubleHash {
public:
   ...
   protected transient double[] _values;
    ...
    public TShortDoubleHashMap(TShortDoubleMap map) {
      super(map.size());
      if (dynamic_cast<TShortDoubleHashMap*>(map) != nullptr) {
    ...
    double doPut(short key, double value, int index) {
    ...
    void putAll(Map<? extends, ? extends) {
      ...
      for (Entry<? : public int16_t, ? : public double> entry : map.entrySet()) {
   ...
   public double[] values(double[] array) {
    ...
    TShortDoubleIterator iterator() {
      return std::make_shared<TShortDoubleHashIterator>(this, this);
   }
    ...
    bool equals(void* other) {
      if (!(dynamic_cast<TShortDoubleMap*>(other) != nullptr)) {
    return false;
      } else {
