...
#include "gnu/trove/map/hash/TDoubleDoubleHashMap/TDoubleDoubleValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleDoubleHashMap/TValueView/1.h"
...
public:
   protected TDoubleDoubleHashMap$TValueView(TDoubleDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TDoubleDoubleValueHashIterator>(this.this$0, this.this$0);
   }

    double getNoEntryValue() {
      return TDoubleDoubleHashMap.access$400(this.this$0);
   }

    int size() {
      return TDoubleDoubleHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TDoubleDoubleHashMap.access$600(this.this$0);
   }
