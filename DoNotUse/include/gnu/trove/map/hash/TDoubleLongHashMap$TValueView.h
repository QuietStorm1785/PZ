...
#include "gnu/trove/map/hash/TDoubleLongHashMap/TDoubleLongValueHashIterator.h"
#include "gnu/trove/map/hash/TDoubleLongHashMap/TValueView/1.h"
...
public:
   protected TDoubleLongHashMap$TValueView(TDoubleLongHashMap var1) {
    ...
    TLongIterator iterator() {
      return std::make_shared<TDoubleLongValueHashIterator>(this.this$0, this.this$0);
   }
