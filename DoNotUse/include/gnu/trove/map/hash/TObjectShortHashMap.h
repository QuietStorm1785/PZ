...
#include "gnu/trove/map/hash/TObjectShortHashMap/1.h"
#include "gnu/trove/map/hash/TObjectShortHashMap/2.h"
#include "gnu/trove/map/hash/TObjectShortHashMap/KeyView.h"
#include "gnu/trove/map/hash/TObjectShortHashMap/TObjectShortHashIterator.h"
#include "gnu/trove/map/hash/TObjectShortHashMap/TShortValueCollection.h"
...
public:
   ...
   protected transient short[] _values;
    ...
    public TObjectShortHashMap(TObjectShortMap<? extends) {
      this(map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectShortHashMap*>(map) != nullptr) {
