...
#include "gnu/trove/map/hash/TCharDoubleHashMap/TCharDoubleKeyHashIterator.h"
#include "gnu/trove/map/hash/TCharDoubleHashMap/TKeyView/1.h"
...
public:
   protected TCharDoubleHashMap$TKeyView(TCharDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TCharIterator iterator() {
      return std::make_shared<TCharDoubleKeyHashIterator>(this.this$0, this.this$0);
   }
   ...
   public char[] toArray(char[] dest) {
    ...
    bool remove(char entry) {
      return TCharDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
