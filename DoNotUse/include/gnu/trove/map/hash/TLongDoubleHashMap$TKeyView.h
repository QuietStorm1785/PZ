...
#include "gnu/trove/map/hash/TLongDoubleHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongDoubleHashMap/TLongDoubleKeyHashIterator.h"
...
public:
   protected TLongDoubleHashMap$TKeyView(TLongDoubleHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongDoubleKeyHashIterator>(this.this$0, this.this$0);
   }

    long getNoEntryValue() {
      return TLongDoubleHashMap.access$000(this.this$0);
   }

    int size() {
      return TLongDoubleHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongDoubleHashMap.access$200(this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongDoubleHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
