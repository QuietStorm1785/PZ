...
#include "gnu/trove/map/hash/TByteByteHashMap/TByteByteValueHashIterator.h"
#include "gnu/trove/map/hash/TByteByteHashMap/TValueView/1.h"
...
public:
   protected TByteByteHashMap$TValueView(TByteByteHashMap var1) {
      this.this$0 = var1;
   }

    TByteIterator iterator() {
      return std::make_shared<TByteByteValueHashIterator>(this.this$0, this.this$0);
   }
