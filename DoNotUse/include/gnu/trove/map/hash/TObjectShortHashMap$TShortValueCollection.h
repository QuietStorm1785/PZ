...
#include "gnu/trove/map/hash/TObjectShortHashMap/TShortValueCollection/1.h"
#include "gnu/trove/map/hash/TObjectShortHashMap/TShortValueCollection/TObjectShortValueHashIterator.h"
...
public:
   TObjectShortHashMap$TShortValueCollection(TObjectShortHashMap var1) {
      this.this$0 = var1;
   }
