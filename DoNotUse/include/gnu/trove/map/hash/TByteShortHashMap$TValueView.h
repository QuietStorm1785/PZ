...
#include "gnu/trove/map/hash/TByteShortHashMap/TByteShortValueHashIterator.h"
#include "gnu/trove/map/hash/TByteShortHashMap/TValueView/1.h"
...
public:
   protected TByteShortHashMap$TValueView(TByteShortHashMap var1) {
    ...
    TShortIterator iterator() {
      return std::make_shared<TByteShortValueHashIterator>(this.this$0, this.this$0);
   }

    short getNoEntryValue() {
      return TByteShortHashMap.access$400(this.this$0);
   }

    int size() {
      return TByteShortHashMap.access$500(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TByteShortHashMap.access$600(this.this$0);
   }
