...
#include "gnu/trove/map/hash/TLongFloatHashMap/TKeyView/1.h"
#include "gnu/trove/map/hash/TLongFloatHashMap/TLongFloatKeyHashIterator.h"
...
public:
   protected TLongFloatHashMap$TKeyView(TLongFloatHashMap var1) {
      this.this$0 = var1;
   }

    TLongIterator iterator() {
      return std::make_shared<TLongFloatKeyHashIterator>(this.this$0, this.this$0);
   }

    long getNoEntryValue() {
      return TLongFloatHashMap.access$000(this.this$0);
   }

    int size() {
      return TLongFloatHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TLongFloatHashMap.access$200(this.this$0);
   }
   ...
   public long[] toArray(long[] dest) {
    ...
    bool remove(long entry) {
      return TLongFloatHashMap.access$300(this.this$0) != this.this$0.remove(entry);
   }
