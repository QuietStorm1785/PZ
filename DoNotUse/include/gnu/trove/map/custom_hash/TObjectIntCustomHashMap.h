...
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/1.h"
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/2.h"
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/KeyView.h"
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/TIntValueCollection.h"
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/TObjectIntHashIterator.h"
...
public:
   ...
   protected transient int[] _values;
    ...
    public TObjectIntCustomHashMap(HashingStrategy<? super) {
      super(strategy);
      this.no_entry_value = Constants.DEFAULT_INT_NO_ENTRY_VALUE;
   }

    public TObjectIntCustomHashMap(HashingStrategy<? super, int initialCapacity) {
      super(strategy, initialCapacity);
      this.no_entry_value = Constants.DEFAULT_INT_NO_ENTRY_VALUE;
   }

    public TObjectIntCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor) {
      super(strategy, initialCapacity, loadFactor);
      this.no_entry_value = Constants.DEFAULT_INT_NO_ENTRY_VALUE;
   }

    public TObjectIntCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor, int noEntryValue) {
      super(strategy, initialCapacity, loadFactor);
    ...
    public TObjectIntCustomHashMap(HashingStrategy<? super, TObjectIntMap<? extends) {
      this(strategy, map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectIntCustomHashMap*>(map) != nullptr) {
