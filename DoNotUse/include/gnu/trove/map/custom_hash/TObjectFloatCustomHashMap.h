...
#include "gnu/trove/map/custom_hash/TObjectFloatCustomHashMap/1.h"
#include "gnu/trove/map/custom_hash/TObjectFloatCustomHashMap/2.h"
#include "gnu/trove/map/custom_hash/TObjectFloatCustomHashMap/KeyView.h"
#include "gnu/trove/map/custom_hash/TObjectFloatCustomHashMap/TFloatValueCollection.h"
#include "gnu/trove/map/custom_hash/TObjectFloatCustomHashMap/TObjectFloatHashIterator.h"
...
public:
   ...
   protected transient float[] _values;
    ...
    public TObjectFloatCustomHashMap(HashingStrategy<? super) {
      super(strategy);
      this.no_entry_value = Constants.DEFAULT_FLOAT_NO_ENTRY_VALUE;
   }

    public TObjectFloatCustomHashMap(HashingStrategy<? super, int initialCapacity) {
      super(strategy, initialCapacity);
      this.no_entry_value = Constants.DEFAULT_FLOAT_NO_ENTRY_VALUE;
   }

    public TObjectFloatCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor) {
      super(strategy, initialCapacity, loadFactor);
      this.no_entry_value = Constants.DEFAULT_FLOAT_NO_ENTRY_VALUE;
   }

    public TObjectFloatCustomHashMap(HashingStrategy<? super, int initialCapacity, float loadFactor, float noEntryValue) {
      super(strategy, initialCapacity, loadFactor);
    ...
    public TObjectFloatCustomHashMap(HashingStrategy<? super, TObjectFloatMap<? extends) {
      this(strategy, map.size(), 0.5F, map.getNoEntryValue());
      if (dynamic_cast<TObjectFloatCustomHashMap*>(map) != nullptr) {
