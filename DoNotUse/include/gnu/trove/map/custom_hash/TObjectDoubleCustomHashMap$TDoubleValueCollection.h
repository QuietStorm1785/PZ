...
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/TDoubleValueCollection/1.h"
#include "gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap/TDoubleValueCollection/TObjectDoubleValueHashIterator.h"
...
public:
   TObjectDoubleCustomHashMap$TDoubleValueCollection(TObjectDoubleCustomHashMap var1) {
      this.this$0 = var1;
   }

    TDoubleIterator iterator() {
      return std::make_shared<TObjectDoubleValueHashIterator>(this);
   }
    ...
    int size() {
      return TObjectDoubleCustomHashMap.access$100(this.this$0);
   }

    bool isEmpty() {
    return 0 = = TObjectDoubleCustomHashMap.access$200(this.this$0);
   }
