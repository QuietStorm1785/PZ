...
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/TIntValueCollection/1.h"
#include "gnu/trove/map/custom_hash/TObjectIntCustomHashMap/TIntValueCollection/TObjectIntValueHashIterator.h"
...
public:
   TObjectIntCustomHashMap$TIntValueCollection(TObjectIntCustomHashMap var1) {
      this.this$0 = var1;
   }
