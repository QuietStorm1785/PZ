...
class TByteDoubleHash : public TPrimitiveHash {
public:
   ...
   public transient byte[] _set;
    ...
    public TByteDoubleHash(int initialCapacity, float loadFactor, uint8_t no_entry_key, double no_entry_value) {
      super(initialCapacity, loadFactor);
