...
public:
   ...
   private static const std::vector<IsoGridSquare> VegetationCorpses = new std::vector<>(5000);
    ...
    static void init() {
      ...
      try {
         lwjglx::opengl::Display::setFullscreen(false);
         lwjglx::opengl::Display::setResizable(false);
         lwjglx::opengl::Display::setVSyncEnabled(false);
         lwjglx::opengl::Display::setTitle("Project Zomboid Server");
         System.setProperty("org.lwjgl.opengl.Window.undecorated", "false");
         Core.width = 1366;
         Core.height = 768;
         lwjglx::opengl::Display::setDisplayMode(nullptr); // Stub
         lwjglx::opengl::Display::create(nullptr); // Stub
         lwjglx::opengl::Display::setIcon(nullptr); // Stub
         GLVertexBufferObject.init();
         lwjglx::opengl::Display::makeCurrent();
    ...
    uint8_t var0 = 2;
         ...
         lwjglx::opengl::Display::releaseContext();
