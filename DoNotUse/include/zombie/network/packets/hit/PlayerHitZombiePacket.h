...
public:
    ...
    void set(IsoPlayer var1, IsoZombie var2, HandWeapon var3, float var4, bool var5, float var6, bool var7, bool var8, bool var9) {
    ...
    bool validate(UdpConnection var1) {
      return !PacketValidator.checkLongDistance(var1, this.wielder, this.target, PlayerHitZombiePacket.class.getSimpleName())
         ? false
         : PacketValidator.checkDamage(var1, this.hit, PlayerHitZombiePacket.class.getSimpleName());
   }
}
} // namespace hit
} // namespace packets
