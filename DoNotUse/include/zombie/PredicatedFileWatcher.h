...
public:
   ...
   private const Predicate<std::string> m_predicate;
    const IPredicatedFileWatcherCallback m_callback;

    public PredicatedFileWatcher(Predicate<std::string> var1, IPredicatedFileWatcherCallback var2) {
   ...
   public <T> PredicatedFileWatcher(std::string var1, Class<T> var2, IPredicatedDataPacketFileWatcherCallback<T> var3) {
      this(var1, nullptr, std::make_shared<GenericPredicatedFileWatcherCallback>(var2, var3));
   }

    public PredicatedFileWatcher(const std::string& var1, Predicate<std::string> var2, IPredicatedFileWatcherCallback var3) {
