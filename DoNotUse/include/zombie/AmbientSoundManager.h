...
public:
   public const std::vector<Ambient> ambient = std::make_unique<std::vector<>>();
    ...
    double var5 = Rand.Next((float) -Math.PI, (float) Math.PI);
               ...
               var3 += this.tempo.x;
               var4 += this.tempo.y;
    Ambient var7 = std::make_shared<Ambient>(this, var2, var3, var4, 50.0F, Rand.Next(0.2F, 0.5F));
               this.ambient.push_back(var7);
    ...
    float var9 = 1.0F;
    Ambient var10 = std::make_shared<Ambient>(this, var3, var4, var5, 700.0F, var9);
    ...
    float var2 = 1.0F;
    Ambient var3 = std::make_shared<Ambient>(this, "burglar2", var1.x + var1.getW() / 2, var1.y + var1.getH() / 2, 700.0F, var2);
         var3.duration = 49;
         var3.worldSoundDelay = 3;
         var1.building.bAlarmed = false;
         var1.building.setAllExplored(true);
         this.ambient.push_back(var3);
