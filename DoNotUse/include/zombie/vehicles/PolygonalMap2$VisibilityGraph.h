...
#include "zombie/vehicles/PolygonalMap2/ClusterOutlineGrid.h"
...
public:
   ...
   const std::vector<Node> nodes = std::make_unique<std::vector<>>();
   const std::vector<Edge> edges = std::make_unique<std::vector<>>();
   const std::vector<Obstacle> obstacles = std::make_unique<std::vector<>>();
   const std::vector<Node> intersectNodes = std::make_unique<std::vector<>>();
   const std::vector<Node> perimeterNodes = std::make_unique<std::vector<>>();
   const std::vector<Edge> perimeterEdges = std::make_unique<std::vector<>>();
   const std::vector<Node> obstacleTraceNodes = std::make_unique<std::vector<>>();
    const TIntArrayList splitXY = std::make_shared<TIntArrayList>();
    static const CompareIntersection comparator = std::make_shared<CompareIntersection>();
    static const ClusterOutlineGrid clusterOutlineGrid = std::make_shared<ClusterOutlineGrid>();
   private static const ArrayDeque<PolygonalMap2$VisibilityGraph> pool = std::make_unique<ArrayDeque<>>();
   ...
   PolygonalMap2$VisibilityGraph init(VehicleCluster var1) {
    ...
    Edge var12 = Edge.alloc().init(var7, var4, var8, var8.outer);
      ...
      this.edges.push_back(var9);
      this.edges.push_back(var10);
      this.edges.push_back(var11);
      this.edges.push_back(var12);
      if (!(var1.upVectorDot < 0.95F)) {
         ...
         this.nodes.push_back(var8.nodeCrawlFront);
         this.nodes.push_back(var8.nodeCrawlRear);
    Edge var13 = var9.split(var8.nodeCrawlFront);
    Edge var14 = var11.split(var8.nodeCrawlRear);
         this.edges.push_back(var13);
         this.edges.push_back(var14);
    ...
    float var19 = var1.crawlOffsets.get(var18);
            ...
            var17.sub(var16).mul(var19).push_back(var16);
    ...
    Node var22 = Node.alloc().init((var20.x + var21.x) / 2.0F, (var20.y + var21.y) / 2.0F, var3);
            var22.flags |= 3;
            var8.crawlNodes.push_back(var20);
            var8.crawlNodes.push_back(var22);
            var8.crawlNodes.push_back(var21);
            this.nodes.push_back(var20);
            this.nodes.push_back(var22);
            this.nodes.push_back(var21);
    Edge var23 = var10.split(var20);
            var12 = var12.split(var21);
            this.edges.push_back(var23);
            this.edges.push_back(var12);
         }
    ...
    bool isVisible(Node var1, Node var2) {
    ...
    bool intersects(Node var1, Node var2, Edge var3) {
    ...
    Intersection getIntersection(Edge var1, Edge var2) {
    ...
    float var18 = (float)(var4 + var13 * (var6 - var4));
            return std::make_shared<Intersection>(var1, var2, (float)var13, (float)var15, var17, var18);
         } else {
    return nullptr;
         }
      }
    ...
    Square var6 = PolygonalMap2.instance.getSquare(var5, var4, var3);
            if (var6 != nullptr && this.contains(var6, 1)) {
    ...
    ObjectOutline var16 = ObjectOutline.get(var14, var12, var3, var2);
            if (var16 != nullptr && var16.nw && var16.nw_w && var16.nw_n) {
               var16.trace(var2, this.obstacleTraceNodes);
               if (!var16.nodes.empty()) {
    Obstacle var7 = Obstacle.alloc().init((IsoGridSquare)nullptr);
    ...
    Edge var11 = Edge.alloc().init(var9, var10, var7, var7.outer);
                     var7.outer.push_back(var11);
                     this.nodes.push_back(var9);
                  }

                  var7.calcBounds();
                  this.obstacles.push_back(var7);
    ...
    short var8 = var10.getShort();
         ...
         for (int var13 = 0; var13 < var7.inner.size(); var13++) {
            this.edges.addAll((Collection<? : public Edge>)var7.inner.get(var13));
         }
      }
   }

    void getEdgesFromBuffer(ByteBuffer var1, Obstacle var2, bool var3, int var4) {
    ...
    Edge var17 = var3.split(var14);
                     this.nodes.push_back(var14);
                     this.edges.push_back(var17);
                  }
               } else {
    ...
    Edge var16 = var3.split(var13);
                     this.nodes.push_back(var13);
                     this.edges.push_back(var16);
                  }
               }
    ...
    Edge var15 = var3.split(var12);
                  this.nodes.push_back(var12);
                  this.edges.push_back(var15);
               }
            } else {
    ...
    void getStairSquares(std::vector<Square> var1) {
    ...
    Square var5 = PolygonalMap2.instance.getSquare(var4, var3, this.cluster.z);
            if (var5 != nullptr && var5.has(72) && !var1.contains(var5)) {
               var1.push_back(var5);
            }
         }
      }
    ...
    void getCanPathSquares(std::vector<Square> var1) {
    VehicleRect var2 = this.cluster.bounds();
      var2.x--;
      var2.w += 2;
      var2.y--;
      ...
      for (int var3 = var2.top(); var3 < var2.bottom(); var3++) {
         for (int var4 = var2.left(); var4 < var2.right(); var4++) {
    Square var5 = PolygonalMap2.instance.getSquare(var4, var3, this.cluster.z);
            if (var5 != nullptr && (var5.isCanPathW() || var5.isCanPathN()) && !var1.contains(var5)) {
               var1.push_back(var5);
            }
         }
      }
    ...
    Obstacle var2 = this.obstacles.get(var1);
         if (var2.vehicle != nullptr && var2.nodeCrawlFront != nullptr) {
    ...
    Square var10 = PolygonalMap2.instance.getSquare(var9, var8, this.cluster.z);
                     if (var10 != nullptr && var2.isPointInside(var9 + 0.5F, var8 + 0.5F)) {
    ...
    Node var34 = Node.alloc().init(var32, var33, this.cluster.z);
                                       var34.flags |= 1;
    bool var35 = var17.node1.isConnectedTo(var17.node2);
    Edge var36 = var17.split(var34);
                                       ...
                                       this.edges.push_back(var36);
                                       this.nodes.push_back(var34);
    ...
    Obstacle var44 = this.obstacles.get(var40);
               if (var44.vehicle != nullptr && var44.nodeCrawlFront != nullptr) {
    ...
    Intersection var7 = this.getIntersection(var4, var6);
               if (var7 != nullptr) {
                  var4.intersections.push_back(var7);
                  var6.intersections.push_back(var7);
                  this.nodes.push_back(var7.nodeSplit);
                  this.intersectNodes.push_back(var7.nodeSplit);
               }
            }
         }
      }
    ...
    ClusterOutline var18 = var2.get(var16, var13, var3);
            if (var18 != nullptr && (var18.w || var18.n || var18.e || var18.s || var18.innerCorner)) {
    Square var19 = PolygonalMap2.instance.getSquare(var1.x + var16, var1.y + var13, var3);
               if (var19 != nullptr && !var19.isNonThumpableSolid() && !var19.has(504)) {
    Node var8 = PolygonalMap2.instance.getNodeForSquare(var19);
                  var8.flags |= 8;
                  var8.addGraph(this);
                  this.perimeterNodes.push_back(var8);
               }
            }

            if (var18 != nullptr && var18.n && var18.w && var18.inner && !(var18.tw | var18.tn | var18.te | var18.ts)) {
    std::vector var20 = var2.trace(var18);
               if (!var20.empty()) {
    ...
    Node var10 = (Node)var20.get(var21 + 1);
                     var9.x = var9.x + var1.left();
                     var9.y = var9.y + var1.top();
    Edge var11 = Edge.alloc().init(var9, var10, nullptr, nullptr);
                     this.perimeterEdges.push_back(var11);
                  }
    ...
    Node var3 = (Node)var1.get(var2);
         if (!var3.ignore && (var3.square == nullptr || !var3.square.has(504))) {
            for (int var4 = var2 + 1; var4 < var1.size(); var4++) {
    Node var5 = (Node)var1.get(var4);
               if (!var5.ignore && (var5.square == nullptr || !var5.square.has(504)) && (!var3.hasFlag(8) || !var5.hasFlag(8))) {
                  if (var3.isConnectedTo(var5)) {
                     if ((var3.square == nullptr || !var3.square.isCanPathW() && !var3.square.isCanPathN())
                        && (var5.square == nullptr || !var5.square.isCanPathW() && !var5.square.isCanPathN())
                        && !$assertionsDisabled) {
    ...
    bool contains(float var1, float var2, int var3) {
      for (int var4 = 0; var4 < this.cluster.rects.size(); var4++) {
    VehicleRect var5 = (VehicleRect)this.cluster.rects.get(var4);
    ...
    bool contains(float var1, float var2, int var3, int var4) {
    ...
    bool contains(Square var1, int var2) {
    ...
    int getPointOutsideObstacles(float var1, float var2, float var3, AdjustStartEndNodeData var4) {
    ...
    Obstacle var13 = this.obstacles.get(var12);
         if (var13.bounds.containsPoint(var1, var2) && var13.isPointInside(var1, var2)) {
            ...
            if (var5.edge != nullptr && var5.distSq < var6) {
               var6 = var5.distSq;
               var8 = var5.edge;
               var9 = var5.node;
               var10 = var5.point.x;
      ...
      if (var8 != nullptr) {
         ...
         if (var8.obstacle.splitEdgeAtNearestPoint(var5, (int)var3, var4)) {
            var4.graph = this;
            if (var4.isNodeNew) {
               this.edges.push_back(var4.newEdge);
   ...
   static PolygonalMap2$VisibilityGraph alloc() {
    ...
    float var1 = 1.0F;
      ...
      for (Edge var3 : this.perimeterEdges) {
         LineDrawer.addLine(var3.node1.x, var3.node1.y, this.cluster.z, var3.node2.x, var3.node2.y, this.cluster.z, var1, 0.5F, 0.5F, nullptr, true);
         var1 = 1.0F - var1;
      }
      ...
      for (Obstacle var14 : this.obstacles) {
         ...
         for (Edge var5 : var14.outer) {
            LineDrawer.addLine(var5.node1.x, var5.node1.y, this.cluster.z, var5.node2.x, var5.node2.y, this.cluster.z, var1, 0.5F, 0.5F, nullptr, true);
            var1 = 1.0F - var1;
         }

         for (EdgeRing var23 : var14.inner) {
    for (auto& var7 : var23)               LineDrawer.addLine(var7.node1.x, var7.node1.y, this.cluster.z, var7.node2.x, var7.node2.y, this.cluster.z, var1, 0.5F, 0.5F, nullptr, true);
               var1 = 1.0F - var1;
            }
         }
         ...
         if (DebugOptions.instance.PolymapRenderCrawling.getValue()) {
            for (Node var24 : var14.crawlNodes) {
               LineDrawer.addLine(
                  var24.x - 0.05F, var24.y - 0.05F, this.cluster.z, var24.x + 0.05F, var24.y + 0.05F, this.cluster.z, 0.5F, 1.0F, 0.5F, nullptr, false
               );

               for (Connection var32 : var24.visible) {
    Node var8 = var32.otherNode(var24);
                  if (var8.hasFlag(1)) {
                     LineDrawer.addLine(var24.x, var24.y, this.cluster.z, var8.x, var8.y, this.cluster.z, 0.5F, 1.0F, 0.5F, nullptr, true);
                  }
               }
            }
         }
    ...
    Node var29 = var25.otherNode(var15);
               LineDrawer.addLine(var15.x, var15.y, this.cluster.z, var29.x, var29.y, this.cluster.z, 0.0F, 0.25F, 0.0F, nullptr, true);
            }
         }
    ...
    float var30 = 0.0F;
            ...
            LineDrawer.addLine(
               var15.x - 0.05F, var15.y - 0.05F, this.cluster.z, var15.x + 0.05F, var15.y + 0.05F, this.cluster.z, var21, var26, var30, nullptr, false
            );
         }
      }
    ...
    Node var31 = var27.otherNode(var16);
               if (this.nodes.contains(var31)) {
                  LineDrawer.addLine(var16.x, var16.y, this.cluster.z, var31.x, var31.y, this.cluster.z, 0.0F, 1.0F, 0.0F, nullptr, true);
               }
            }
         }
         ...
         if (DebugOptions.instance.PolymapRenderNodes.getValue() || var16.ignore) {
            LineDrawer.addLine(
               var16.x - 0.05F, var16.y - 0.05F, this.cluster.z, var16.x + 0.05F, var16.y + 0.05F, this.cluster.z, 1.0F, 1.0F, 0.0F, nullptr, false
            );
         }
      }

      for (Node var17 : this.intersectNodes) {
         LineDrawer.addLine(var17.x - 0.1F, var17.y - 0.1F, this.cluster.z, var17.x + 0.1F, var17.y + 0.1F, this.cluster.z, 1.0F, 0.0F, 0.0F, nullptr, false);
      }
   }
}
} // namespace vehicles
