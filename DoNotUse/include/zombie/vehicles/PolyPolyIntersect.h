...
public:
    static Vector2f tempVector2f_1 = std::make_shared<Vector2f>();
    static Vector2f tempVector2f_2 = std::make_shared<Vector2f>();
    static Vector2f tempVector2f_3 = std::make_shared<Vector2f>();

    static bool intersects(VehiclePoly var0, VehiclePoly var1) {
    ...
    double var15 = var8.x * var14.x + var8.y * var14.y;
               if (var15 < var9) {
                  var9 = var15;
               }
    ...
    double var22 = double.NEGATIVE_INFINITY;

            for (int var17 = 0; var17 < 4; var17++) {
    Vector2f var18 = getPoint(var1, var17, tempVector2f_1);
    double var19 = var8.x * var18.x + var8.y * var18.y;
               if (var19 < var21) {
                  var21 = var19;
               }
    ...
    static Vector2f getPoint(VehiclePoly var0, int var1, Vector2f var2) {
      if (var1 == 0) {
    ...
    return var1 = = 3 ? var2.set(var0.x4, var0.y4) : nullptr;
      }
   }
}
} // namespace vehicles
