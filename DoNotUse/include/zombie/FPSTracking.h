...
class FPSTracking {
public:
   private const double[] lastFPS = new double[20];
    int lastFPSCount = 0;
    long timeAtLastUpdate;
   private const long[] last10 = new long[10];
    int last10index = 0;

    void init() {
      for (int var1 = 0; var1 < 20; var1++) {
         this.lastFPS[var1] = PerformanceSettings.getLockFPS();
      }
    ...
    double var8 = 1.0 / var6;
         ...
         for (int var10 = 0; var10 < 5; var10++) {
            var5 = (float)(var5 + this.lastFPS[var10]);
         }

         var5 /= 5.0F;
         GameWindow.averageFPS = var5;
         GameTime.instance.FPSMultiplier = (float)(60.0 / var8);
