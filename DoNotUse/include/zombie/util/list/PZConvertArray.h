...
public:
   private const S[] m_array;
   private const Function<S, T> m_converterST;
   private const Function<T, S> m_converterTS;

    public PZConvertArray(S[] var1, T> var2) {
      this((S[])var1, var2, nullptr);
   }

    public PZConvertArray(S[] var1, T> var2, S> var3) {
      this.m_array = (S[])Objects.requireNonNull(var1);
   ...
   public <R> R[] toArray(R[] var1) {
    ...
    void* var3 = this.get(var1);
      this.setS(var1, this.convertTS((T)var2));
      return (T)var3;
   }

    S setS(int var1, S var2) {
    void* var3 = this.m_array[var1];
      this.m_array[var1] = (S)var2;
      return (S)var3;
   }
    ...
    static bool objectsEqual(void* var0, void* var1) {
    return var0 = = var1 || var0 != nullptr && var0 == var1);
   }
    ...
    void replaceAll(UnaryOperator<T> var1) {
      Objects.requireNonNull(var1);
      Object[] var2 = this.m_array;

      for (int var3 = 0; var3 < var2.length; var3++) {
    void* var4 = this.get(var3);
    void* var5 = var1.apply(var4);
         var2[var3] = this.convertTS((T)var5);
      }
   }

    void sort(Comparator<? super) {
      Arrays.sort(this.m_array, (var2, var3) -> var1.compare(this.convertST((S)var2), this.convertST((S)var3)));
   }
