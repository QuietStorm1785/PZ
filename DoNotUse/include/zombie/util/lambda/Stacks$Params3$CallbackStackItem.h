...
#include "zombie/util/lambda/Stacks/Params3/ICallback.h"
#include "zombie/util/lambda/Stacks/Params3/StackItem.h"
...
public:
   ...
   private static const Pool<Stacks$Params3$CallbackStackItem<Object, Object, Object>> s_pool = std::make_shared<Pool>(Stacks$Params3$CallbackStackItem::new);
