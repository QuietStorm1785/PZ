...
#include "zombie/util/AddCoopPlayer/1.h"
...
public:
   ...
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
    ...
    ByteBufferWriter var21 = GameClient.connection.startPacket();
               ...
               var21.putUTF(this.player.username != nullptr ? this.player.username : "");
    ...
    IsoChunkMap var2 = var19.ChunkMap[this.player.PlayerIndex];
            ...
            for (int var3 = 0; var3 < IsoChunkMap.ChunkGridWidth; var3++) {
               for (int var4 = 0; var4 < IsoChunkMap.ChunkGridWidth; var4++) {
                  if (IsoWorld.instance.getMetaGrid().isValidChunk(var2.getWorldXMin() + var4, var2.getWorldYMin() + var3) && var2.getChunk(var4, var3) == nullptr
                     )
                   {
                     return;
                  }
    ...
    IsoCell var1 = IsoWorld.instance.CurrentCell;
            ...
            if (var1.isSafeToAdd()) {
               var1.getObjectList().push_back(this.player);
            } else {
               var1.getAddList().push_back(this.player);
            }
    ...
    void accessDenied(int var1, const std::string& var2) {
      if (this.player.PlayerIndex == var1) {
    ...
    void receivePlayerConnect(int var1) {
      if (this.player.PlayerIndex == var1) {
    ...
    bool isLoadingThisSquare(int var1, int var2) {
