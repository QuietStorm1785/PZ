...
public:
    ...
    static void calcDistanceOnThisChunkOnly(IsoChunk var0) {
    ...
    int var6 = var5 * 4 + var3 * 40 + var2 * 10 * 40;
               var1[var6 + 0] = var4 == -1 ? -1 : (byte)(var5 - var4);
               var1[var6 + 1] = -1;
    IsoGridSquare var7 = var0.getGridSquare(var5, var3, var2);
               if (var7 != nullptr
                  && (var7.Is(IsoFlagType.WallW) || var7.Is(IsoFlagType.DoorWallW) || var7.Is(IsoFlagType.WallNW) || var7.Is(IsoFlagType.WindowW))) {
                  var4 = (byte)var5;
                  var1[var6 + 0] = 0;
    ...
    int var13 = var9 * 4 + var11 * 40 + var2 * 10 * 40;
               var1[var13 + 2] = var10 == -1 ? -1 : (byte)(var11 - var10);
               var1[var13 + 3] = -1;
    IsoGridSquare var15 = var0.getGridSquare(var9, var11, var2);
               if (var15 != nullptr
                  && (var15.Is(IsoFlagType.WallN) || var15.Is(IsoFlagType.DoorWallN) || var15.Is(IsoFlagType.WallNW) || var15.Is(IsoFlagType.WindowN))) {
                  var10 = (byte)var11;
                  var1[var13 + 2] = 0;

                  for (int var16 = var11 - 1; var16 >= 0; var16--) {
                     var13 = var9 * 4 + var16 * 40 + var2 * 10 * 40;
                     if (var1[var13 + 3] != -1) {
                        break;
                     }

                     var1[var13 + 3] = (byte)(var10 - var16);
                  }
               }
            }
         }
    ...
    static int getIndex(IsoChunk var0, int var1, int var2, int var3) {
      return (var1 - var0.wx * 10) * 4 + (var2 - var0.wy * 10) * 40 + var3 * 10 * 40;
   }

    static int getNearestWallOnSameChunk(IsoChunk var0, int var1, int var2, int var3, int var4) {
    ChunkData var5 = var0.nearestWalls;
    ...
    static bool hasWall(IsoChunk var0, int var1, int var2, int var3, int var4) {
    return getNearestWallOnSameChunk();
   }

    static int getNearestWallWest(IsoChunk var0, int var1, int var2, int var3) {
    uint8_t var4 = 0;
    uint8_t var5 = -1;
    uint8_t var6 = 0;
    ...
    static int getNearestWallEast(IsoChunk var0, int var1, int var2, int var3) {
    uint8_t var4 = 1;
    uint8_t var5 = 1;
    uint8_t var6 = 0;
    int var7 = getNearestWallOnSameChunk(var0, var1, var2, var3, var4);
    ...
    static int getNearestWallNorth(IsoChunk var0, int var1, int var2, int var3) {
    uint8_t var4 = 2;
    uint8_t var5 = 0;
    uint8_t var6 = -1;
    int var7 = getNearestWallOnSameChunk(var0, var1, var2, var3, var4);
    ...
    static int getNearestWallSouth(IsoChunk var0, int var1, int var2, int var3) {
    uint8_t var4 = 3;
    uint8_t var5 = 0;
    uint8_t var6 = 1;
    int var7 = getNearestWallOnSameChunk(var0, var1, var2, var3, var4);
    ...
    IsoChunk var3 = IsoWorld.instance.CurrentCell.getChunkForGridSquare(var0, var1, var2);
      if (var3 != nullptr) {
         if (renderX != var0 || renderY != var1 || renderZ != var2) {
            ...
            renderY = var1;
            renderZ = var2;
            System.out.println("ClosestWallDistance=" + ClosestWallDistance(var3, var0, var1, var2));
         }

    int var4 = getNearestWallWest(var3, var0, var1, var2);
         if (var4 != -1) {
            DrawIsoLine(var4, var1 + 0.5F, var0 + 0.5F, var1 + 0.5F, var2, 1.0F, 1.0F, 1.0F, 1.0F, 1);
            DrawIsoLine(var4, var1, var4, var1 + 1, var2, 1.0F, 1.0F, 1.0F, 1.0F, 1);
         }
    ...
    int var5 = getNearestWallNorth(var3, var0, var1, var2);
         if (var5 != -1) {
            DrawIsoLine(var0 + 0.5F, var5, var0 + 0.5F, var1 + 0.5F, var2, 1.0F, 1.0F, 1.0F, 1.0F, 1);
            DrawIsoLine(var0, var5, var0 + 1, var5, var2, 1.0F, 1.0F, 1.0F, 1.0F, 1);
         }
    ...
    static int ClosestWallDistance(IsoGridSquare var0) {
      return var0 != nullptr && var0.chunk != nullptr ? ClosestWallDistance(var0.chunk, var0.x, var0.y, var0.z) : 127;
   }

    static int ClosestWallDistance(IsoChunk var0, int var1, int var2, int var3) {
      if (var0 == nullptr) {
    return 127;
      } else {
    ChunkData var4 = var0.nearestWalls;
    ...
    IsoGridSquare var14 = var0.getGridSquare(var1 - var0.wx * 10, var2 - var0.wy * 10, var3);
                  if (var14 != nullptr && var14.isOutside()) {
