...
public:
    ...
    AirFront frontCache = std::make_shared<AirFront>();
    double startTime;
    double duration;
    double currentTime;
    WeatherStage currentStage;
   private std::vector<WeatherStage> weatherStages = new std::vector<>(20);
    int weatherStageIndex = 0;
   private std::stack<WeatherStage> stagesPool = std::make_unique<std::stack<>>();
    ...
    ClimateColorInfo cloudColor = std::make_shared<ClimateColorInfo>(0.4F, 0.2F, 0.2F, 0.4F);
    ClimateColorInfo cloudColorReddish = std::make_shared<ClimateColorInfo>(0.66F, 0.12F, 0.12F, 0.4F);
    ClimateColorInfo cloudColorGreenish = std::make_shared<ClimateColorInfo>(0.32F, 0.48F, 0.12F, 0.4F);
    ClimateColorInfo cloudColorBlueish = std::make_shared<ClimateColorInfo>(0.16F, 0.48F, 0.48F, 0.4F);
    ClimateColorInfo cloudColorPurplish = std::make_shared<ClimateColorInfo>(0.66F, 0.12F, 0.66F, 0.4F);
    ClimateColorInfo cloudColorTropical = std::make_shared<ClimateColorInfo>(0.4F, 0.2F, 0.2F, 0.4F);
    ClimateColorInfo cloudColorBlizzard = std::make_shared<ClimateColorInfo>(0.12F, 0.13F, 0.21F, 0.5F, 0.38F, 0.4F, 0.5F, 0.8F);
   ...
   private static const std::unordered_map<int, StrLerpVal> cache = std::make_unique<std::unordered_map<>>();
    ...
    public WeatherPeriod(ClimateManager var1, ThunderStorm var2) {
      ...
      for (int var3 = 0; var3 < 30; var3++) {
         this.stagesPool.push(std::make_unique<WeatherStage>());
      }
    ...
    void setDummy(bool var1) {
      this.isDummy = var1;
   }

    static float getMaxTemperatureInfluence() {
    return maxTemperatureInfluence;
   }

    void setKateBobStormProgress(float var1) {
      kateBobStormProgress = PZMath.clamp_01(var1);
   }

    void setKateBobStormCoords(int var1, int var2) {
      this.kateBobStormX = var1;
      this.kateBobStormY = var2;
   }

    ClimateColorInfo getCloudColorReddish() {
      return this.cloudColorReddish;
   }

    ClimateColorInfo getCloudColorGreenish() {
      return this.cloudColorGreenish;
   }

    ClimateColorInfo getCloudColorBlueish() {
      return this.cloudColorBlueish;
   }

    ClimateColorInfo getCloudColorPurplish() {
      return this.cloudColorPurplish;
   }

    ClimateColorInfo getCloudColorTropical() {
      return this.cloudColorTropical;
   }

    ClimateColorInfo getCloudColorBlizzard() {
    ...
    WeatherStage getCurrentStage() {
      return this.currentStage;
   }

    double getWeatherNoise() {
    ...
    float getPrecipitationFinal() {
      return this.precipitationFinal;
   }

    ClimateColorInfo getCloudColor() {
      return this.cloudColor;
   }

    void setCloudColor(ClimateColorInfo var1) {
    ...
    WeatherStage getStageForWorldAge(double var1) {
    ...
    void initSimulationDebug(AirFront var1, double var2) {
    GameTime var4 = GameTime.getInstance();
      this.init(var1, var2, var4.getYear(), var4.getMonth(), var4.getDayPlusOne(), -1, -1.0F);
   }

    void initSimulationDebug(AirFront var1, double var2, int var4, float var5) {
    GameTime var6 = GameTime.getInstance();
      this.init(var1, var2, var6.getYear(), var6.getMonth(), var6.getDayPlusOne(), var4, var5);
   }

    void init(AirFront var1, double var2, int var4, int var5, int var6) {
      this.init(var1, var2, var4, var5, var6, -1, -1.0F);
   }

    void init(AirFront var1, double var2, int var4, int var5, int var6, int var7, float var8) {
    ...
    void reseed(int var1, int var2, int var3) {
    ...
    float RandNext(float var1, float var2) {
      if (var1 == var2) {
    return var1;
      } else {
         if (var1 > var2) {
    ...
    float RandNext(float var1) {
      return this.seededRandom.nextFloat() * var1;
   }

    int RandNext(int var1, int var2) {
      if (var1 == var2) {
    return var1;
      } else {
         if (var1 > var2) {
    ...
    int RandNext(int var1) {
      return this.seededRandom.nextInt(var1);
   }

    bool startCreateModdedPeriod(bool var1, float var2, float var3) {
    double var4 = GameTime.getInstance().getWorldAgeHours();
    AirFront var6 = std::make_shared<AirFront>();
    ...
    bool startInit(AirFront var1, double var2) {
    ...
    bool endInit() {
      if (this.hasStartedInit && !this.isRunning && !GameClient.bClient && this.weatherStages.size() > 0) {
         ...
         if (GameServer.bServer && !this.isDummy) {
            this.climateManager.transmitClimatePacket(ClimateNetAuth.ServerOnly, (byte)1, nullptr);
         }
    ...
    void writeNetWeatherData(ByteBuffer var1) {
    ...
    void readNetWeatherData(ByteBuffer var1) {
   ...
   public std::vector<WeatherStage> getWeatherStages() {
      return this.weatherStages;
   }

    void linkWeatherStages() {
    WeatherStage var1 = nullptr;
    void* var2 = nullptr;
    WeatherStage var3 = nullptr;
    ...
    void createSingleStage(int var1, float var2) {
    ...
    bool var9 = IsoWorld.instance.getGameMode() == "Winter is Coming");
      if (var9) {
         var8 = 5;
      }
    ...
    float var16 = 0.0F;
         if (var13) {
            var10.push_back(this.createStage(8, 8.0F + this.RandNext(0.0F, 16.0F * this.frontCache.getStrength())));
            this.cloudColor = this.cloudColorTropical;
            if (this.RandNext(0.0F, 100.0F) < 60.0F * this.frontCache.getStrength()) {
               var10.push_back(this.createStage(3, 5.0F + this.RandNext(0.0F, 5.0F * this.frontCache.getStrength())));
            }
            ...
            var10.push_back(this.createStage(7, 24.0F + this.RandNext(0.0F, 24.0F * this.frontCache.getStrength())));
            this.cloudColor = this.cloudColorBlizzard;
         } else if (var14) {
            var10.push_back(this.createStage(3, 5.0F + this.RandNext(0.0F, 5.0F * this.frontCache.getStrength())));
            if (this.RandNext(0.0F, 100.0F) < 70.0F * this.frontCache.getStrength()) {
               var10.push_back(this.createStage(3, 4.0F + this.RandNext(0.0F, 4.0F * this.frontCache.getStrength())));
            }
            ...
            if (this.RandNext(0.0F, 100.0F) < 25.0F * this.frontCache.getStrength()) {
               var10.push_back(this.createStage(3, 4.0F + this.RandNext(0.0F, 3.0F * this.frontCache.getStrength())));
            }

            if (this.RandNext(0.0F, 100.0F) < 12.5F * this.frontCache.getStrength()) {
               var10.push_back(this.createStage(3, 4.0F + this.RandNext(0.0F, 2.0F * this.frontCache.getStrength())));
            }
         }
    ...
    float var24 = this.RandNext(30.0F, 60.0F);
      this.weatherStages.push_back(this.createStage(0, 1.0F + this.RandNext(0.0F, 2.0F * this.frontCache.getStrength())));

      for (int var26 = 0; var26 < var10.size(); var26++) {
         this.weatherStages.push_back((WeatherStage)var10.get(var26));
         if (var26 < var10.size() - 1 && this.RandNext(0.0F, 100.0F) < var24) {
            this.weatherStages.push_back(this.createStage(4, 1.0F + this.RandNext(0.0F, 2.0F * this.frontCache.getStrength())));
            this.weatherStages.push_back(this.createStage(9, 1.0F + this.RandNext(0.0F, 3.0F * this.frontCache.getStrength())));
            var24 = this.RandNext(30.0F, 60.0F);
         }
      }

      if (this.weatherStages.get(this.weatherStages.size() - 1).getStageID() != 9) {
         this.weatherStages.push_back(this.createStage(4, 2.0F + this.RandNext(0.0F, 3.0F * this.frontCache.getStrength())));
      }
    ...
    WeatherStage createAndAddModdedStage(const std::string& var1, double var2) {
      return this.createAndAddStage(10, var2, var1);
   }

    WeatherStage createAndAddStage(int var1, double var2) {
      return this.createAndAddStage(var1, var2, nullptr);
   }

    WeatherStage createAndAddStage(int var1, double var2, const std::string& var4) {
      if (!this.isRunning && this.hasStartedInit && (var1 != 10 || var4 != nullptr)) {
    WeatherStage var5 = this.createStage(var1, var2, var4);
         this.weatherStages.push_back(var5);
    return var5;
      } else {
    return nullptr;
      }
    ...
    WeatherStage createStage(int var1, double var2) {
      return this.createStage(var1, var2, nullptr);
   }

    WeatherStage createStage(int var1, double var2, const std::string& var4) {
    WeatherStage var5 = nullptr;
      if (!this.stagesPool.empty()) {
         var5 = this.stagesPool.pop();
      } else {
         var5 = std::make_unique<WeatherStage>();
      }
    ...
    int var11 = Rand.Next(1, 3);
                  ...
                  for (int var12 = 0; var12 < var11; var12++) {
                     ...
                     if (this.currentStage.stageID == 11 && var10 && var13 != nullptr) {
    ...
    void update(double var1) {
      if (!GameClient.bClient && !this.isDummy) {
         if (this.isRunning && this.currentStage != nullptr && this.weatherStageIndex >= 0 && this.weatherStages.size() != 0) {
    ...
    WeatherStage var9 = !this.stagesPool.empty() ? this.stagesPool.pop() : std::make_shared<WeatherStage>();
               var9.stageID = var6;
               var9.setStageDuration(var7);
               var9.load(var1, var2);
               this.weatherStages.push_back(var9);
            }
