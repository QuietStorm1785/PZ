...
public:
    ...
    NetworkCharacter var1 = std::make_shared<NetworkCharacter>();
    short var2 = 10000;
    short var3 = 250;
    float var4 = 100.0F;
    float var5 = 200.0F;
    ...
    NetworkCharacter var1 = std::make_shared<NetworkCharacter>(0.0F, 100.0F, 0L);
    ...
    Transform var1 = std::make_shared<Transform>();
      var1.position = std::make_unique<Vector2>();
      var1.rotation = std::make_unique<Vector2>();
    NetworkCharacter var2 = std::make_shared<NetworkCharacter>(0.0F, 100.0F, 0L);
    ...
    NetworkCharacter var3 = std::make_shared<NetworkCharacter>(0.0F, 100.0F, 0L);
    ...
    for (auto& var9 : var2)         var4 = var3.reconstruct((int)var9, var4.position.x, var4.position.y, var4.rotation.x, var4.rotation.y);
         System.out
            .print(
               "transform:("
                  + var4.position.x
