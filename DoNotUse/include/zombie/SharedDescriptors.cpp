...
public:
   ...
   private static const byte[] DESCRIPTOR_MAGIC = new byte[]{68, 69, 83, 67};
   ...
   private static Descriptor[] PlayerZombieDescriptors = new Descriptor[10];
    ...
    Descriptor var3 = std::make_shared<Descriptor>();
    ...
    ItemVisual var6 = std::make_shared<ItemVisual>((ItemVisual)var4.get(var5));
                  var3.itemVisuals.push_back(var6);
               }
