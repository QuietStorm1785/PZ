...
public:
    public ThunderCommand(const std::string& var1, const std::string& var2, const std::string& var3, UdpConnection var4) {
    ...
    int var4 = PZMath.fastfloor(var2.getY());
         ClimateManager.getInstance().transmitServerTriggerLightning(var3, var4, false, false, true);
