...
class ErosionConfig {
public:
    const Seeds seeds = std::make_shared<Seeds>();
    const Time time = std::make_shared<Time>();
    const Debug debug = std::make_shared<Debug>();
    const Season season = std::make_shared<Season>();
    ...
    FileWriter var3 = std::make_shared<FileWriter>(var2, false);
    ...
    BufferedReader var3 = std::make_shared<BufferedReader>(std::make_shared<FileReader>(var2));
    ...
    std::string var7 = var5[1].trim();
                        if (var6.startsWith("seeds.")) {
                           if ("seeds.seedMain_0" == var6)) {
                              this.seeds.seedMain_0 = int.parseInt(var7);
                           } else if ("seeds.seedMain_1" == var6)) {
                              this.seeds.seedMain_1 = int.parseInt(var7);
                           } else if ("seeds.seedMain_2" == var6)) {
                              this.seeds.seedMain_2 = int.parseInt(var7);
                           } else if ("seeds.seedMoisture_0" == var6)) {
                              this.seeds.seedMoisture_0 = int.parseInt(var7);
                           } else if ("seeds.seedMoisture_1" == var6)) {
                              this.seeds.seedMoisture_1 = int.parseInt(var7);
                           } else if ("seeds.seedMoisture_2" == var6)) {
                              this.seeds.seedMoisture_2 = int.parseInt(var7);
                           } else if ("seeds.seedMinerals_0" == var6)) {
                              this.seeds.seedMinerals_0 = int.parseInt(var7);
                           } else if ("seeds.seedMinerals_1" == var6)) {
                              this.seeds.seedMinerals_1 = int.parseInt(var7);
                           } else if ("seeds.seedMinerals_2" == var6)) {
                              this.seeds.seedMinerals_2 = int.parseInt(var7);
                           } else if ("seeds.seedKudzu_0" == var6)) {
                              this.seeds.seedKudzu_0 = int.parseInt(var7);
                           } else if ("seeds.seedKudzu_1" == var6)) {
                              this.seeds.seedKudzu_1 = int.parseInt(var7);
                           } else if ("seeds.seedKudzu_2" == var6)) {
                              this.seeds.seedKudzu_2 = int.parseInt(var7);
                           } else {
                              DebugLog.log("ErosionConfig: unknown \"" + var4 + "\"");
                           }
                        } else if (var6.startsWith("time.")) {
                           if ("time.tickunit" == var6)) {
                              this.time.tickunit = int.parseInt(var7);
                           } else if ("time.ticks" == var6)) {
                              this.time.ticks = int.parseInt(var7);
                           } else if ("time.eticks" == var6)) {
                              this.time.eticks = int.parseInt(var7);
                           } else if ("time.epoch" == var6)) {
                              this.time.epoch = int.parseInt(var7);
                           } else {
                              DebugLog.log("ErosionConfig: unknown \"" + var4 + "\"");
                           }
                        } else if (var6.startsWith("season.")) {
                           if ("season.lat" == var6)) {
                              this.season.lat = int.parseInt(var7);
                           } else if ("season.tempMax" == var6)) {
                              this.season.tempMax = int.parseInt(var7);
                           } else if ("season.tempMin" == var6)) {
                              this.season.tempMin = int.parseInt(var7);
                           } else if ("season.tempDiff" == var6)) {
                              this.season.tempDiff = int.parseInt(var7);
                           } else if ("season.seasonLag" == var6)) {
                              this.season.seasonLag = int.parseInt(var7);
                           } else if ("season.noon" == var6)) {
                              this.season.noon = float.parseFloat(var7);
                           } else if ("season.seedA" == var6)) {
                              this.season.seedA = int.parseInt(var7);
                           } else if ("season.seedB" == var6)) {
                              this.season.seedB = int.parseInt(var7);
                           } else if ("season.seedC" == var6)) {
                              this.season.seedC = int.parseInt(var7);
                           ...
                           if ("debug.enabled" == var6)) {
                              this.debug.enabled = bool.parseBoolean(var7);
                           } else if ("debug.startday" == var6)) {
                              this.debug.startday = int.parseInt(var7);
                           } else if ("debug.startmonth" == var6)) {
                              this.debug.startmonth = int.parseInt(var7);
                           }
                        } else {
                           DebugLog.log("ErosionConfig: unknown \"" + var4 + "\"");
                        }
