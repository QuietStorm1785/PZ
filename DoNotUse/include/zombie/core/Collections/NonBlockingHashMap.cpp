...
#include "zombie/core/Collections/NonBlockingHashMap/1.h"
#include "zombie/core/Collections/NonBlockingHashMap/2.h"
#include "zombie/core/Collections/NonBlockingHashMap/3.h"
#include "zombie/core/Collections/NonBlockingHashMap/CHM.h"
...
public:
   ...
   private static const int[] hashes(Object[] var0) {
    ...
    void* var3 = this.putIfMatch(var1, TOMBSTONE, var2);
    return var2 = = nullptr ? var3 == var2 : var2 == var3);
   }
    ...
    void* var4 = this.putIfMatch(var1, var3, var2);
    return var2 = = nullptr ? var4 == var2 : var2 == var4);
   }
    ...
    void clear() {
      Object[] var1 = (std::make_shared<NonBlockingHashMap>(8))._kvs;
    ...
    static void* get_impl(NonBlockingHashMap var0, Object[] var1, void* var2, int var3) {
    int var4 = len(var1);
    CHM var5 = chm(var1);
    ...
    static void* putIfMatch(NonBlockingHashMap var0, Object[] var1, void* var2, void* var3, void* var4) {
      assert var3 != nullptr;
