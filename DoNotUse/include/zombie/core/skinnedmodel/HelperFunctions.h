...
#include "zombie/core/skinnedmodel/HelperFunctions/UnitTests.h"
...
public:
    static const Vector3f s_zero3 = std::make_shared<Vector3f>(0.0F, 0.0F, 0.0F);
    static const Quaternion s_identityQ = std::make_shared<Quaternion>();
   private static const std::stack<Matrix4f> MatrixStack = std::make_unique<std::stack<>>();
    static const AtomicBoolean MatrixLock = std::make_shared<AtomicBoolean>(false);
   private static const ObjectPool<Vector3f> VectorPool = std::make_shared<ObjectPool>(Vector3f::new);

    static int ToRgba(Color var0) {
      return (int)var0.a << 24 | (int)var0.b << 16 | (int)var0.g << 8 | (int)var0.r;
   }

    static void returnMatrix(Matrix4f var0) {
    ...
    static Matrix4f getMatrix(Matrix4f var0) {
    ...
    static void returnVector3f(Vector3f var0) {
      while (!MatrixLock.compareAndSet(false, true)) {
         Thread.onSpinWait();
      }
    ...
    static Matrix4f CreateFromQuaternion(Quaternion var0) {
    Matrix4f var1 = getMatrix();
      CreateFromQuaternion(var0, var1);
    return var1;
   }

    static Matrix4f CreateFromQuaternion(Quaternion var0, Matrix4f var1) {
      var1.setIdentity();
    ...
    static Matrix4f CreateFromQuaternionPositionScale(Vector3f var0, Quaternion var1, Vector3f var2, Matrix4f var3) {
    ...
    static void CreateFromQuaternionPositionScale(Vector3f var0, Quaternion var1, Vector3f var2, TransformResult_QPS var3) {
   ...
   private static void CreateFromQuaternionPositionScale(
    ...
    static void TransformVertices(VertexPositionNormalTangentTextureSkin[] var0, List<Matrix4f> var1) {
    Vector3 var2 = std::make_shared<Vector3>();
    Vector3 var3 = std::make_shared<Vector3>();
    Vector4f var4 = std::make_shared<Vector4f>();

    for (auto& var8 : var0)         var2.reset();
         var3.reset();
    ...
    static void ApplyBlendBone(float var0, Matrix4f var1, Vector3 var2, Vector3 var3, Vector4f var4, Vector3 var5, Vector3 var6) {
      if (var0 > 0.0F) {
    float var10 = var2.x();
    float var11 = var2.y();
    float var12 = var2.z();
    ...
    float var9 = var1.m20 * var10 + var1.m21 * var11 + var1.m22 * var12 + var1.m23;
         var5.push_back(var7 * var0, var8 * var0, var9 * var0);
         var10 = var3.x();
         var11 = var3.y();
         var12 = var3.z();
         ...
         var6.push_back(var7 * var0, var8 * var0, var9 * var0);
      }
   }

    static Vector3f getPosition(Matrix4f var0, Vector3f var1) {
      var1.set(var0.m03, var0.m13, var0.m23);
    return var1;
   }

    static void setPosition(Matrix4f var0, Vector3f var1) {
      var0.m03 = var1.x;
      var0.m13 = var1.y;
      var0.m23 = var1.z;
   }

    static Quaternion getRotation(Matrix4f var0, Quaternion var1) {
      return Quaternion.setFromMatrix(var0, var1);
   }

    static void transform(Quaternion var0, Vector3f var1, Vector3f var2) {
      var0.normalise();
    float var3 = var0.w;
    float var4 = var0.x;
    float var5 = var0.y;
    ...
    static Vector4f transform(Matrix4f var0, Vector4f var1, Vector4f var2) {
    ...
    static float getRotationY(Quaternion var0) {
      var0.normalise();
    float var1 = var0.w;
    float var2 = var0.x;
    float var3 = var0.y;
    ...
    static float getRotationZ(Quaternion var0) {
    float var1 = var0.w;
    float var2 = var0.x;
    float var3 = var0.y;
    float var4 = var0.z;
    ...
    static Vector3f ToEulerAngles(Quaternion var0, Vector3f var1) {
    ...
    static Quaternion ToQuaternion(double var0, double var2, double var4, Quaternion var6) {
