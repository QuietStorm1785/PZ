...
class KeyframeUtil {
public:
    static const Quaternion end = std::make_shared<Quaternion>();

    static Vector3f GetKeyFramePosition(Keyframe[] var0, float var1, double var2) {
    ...
    int var5 = 0;
         ...
         while (var5 < var0.length - 1 && !(var1 < var0[var5 + 1].Time)) {
            var5++;
         }
    ...
    static Quaternion GetKeyFrameRotation(Keyframe[] var0, float var1, double var2) {
    ...
    double var15 = var13.getX() * var14.getX() + var13.getY() * var14.getY() + var13.getZ() * var14.getZ() + var13.getW() * var14.getW();
            end.set(var14);
            if (var15 < 0.0) {
               var15 *= -1.0;
               end.setX(-end.getX());
    ...
    double var23 = Math.sin(var21);
               var17 = Math.sin((1.0 - var12) * var21) / var23;
               var19 = Math.sin(var12 * var21) / var23;
            } else {
               var17 = 1.0 - var12;
               var19 = var12;
            }
            ...
            var4.set(
               (float)(var17 * var13.getX() + var19 * end.getX()),
               (float)(var17 * var13.getY() + var19 * end.getY()),
               (float)(var17 * var13.getZ() + var19 * end.getZ()),
               (float)(var17 * var13.getW() + var19 * end.getW())
            );
         } else {
