...
public:
    ...
    static const Matrix4f boneMat = std::make_shared<Matrix4f>();
    static const Matrix4f rotMat = std::make_shared<Matrix4f>();
    static const Vector3f rotAxis = std::make_shared<Vector3f>(1.0F, 0.0F, 0.0F);
    static const Quaternion crRot = std::make_shared<Quaternion>();
    static const Vector4f crRotAA = std::make_shared<Vector4f>();
    static const Matrix4f crMat = std::make_shared<Matrix4f>();
