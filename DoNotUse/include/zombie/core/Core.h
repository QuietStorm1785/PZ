...
public:
   ...
   public static int[] flipPixels(int[] var0, int var1, int var2) {
    ...
    int var37 = 0;
               ...
               width = var30;
               height = var37;
            } catch (GLUSException& var16) {
               std::cerr << var16.what() << std::endl;
            }
         }
    ...
    for (auto& var10 : var4)                        if (var10.getWidth() == var0 && var10.getHeight() == var1 && var10.isFullscreenCapable()) {
               ...
               } catch (GLUSException& var11) {
                  DebugLog.log(std::string("Unable to setup mode ") + std::to_string(var0) + "x" + std::to_string(var1) + " fullscreen=" + std::to_string(var2) + var11.what());
               }
            }
         }
      );
