   ...
   private const std::vector<WorldMapProperties> m_sharedProperties = std::make_unique<std::vector<>>();
    ...
    int var2 = this.readShort(var1);
      if (!this.m_stringTable.containsKey(var2)) {
         ...
         return (std::string)this.m_stringTable.get(var2);
      }
   }
    ...
    WorldMapCell var4 = std::make_shared<WorldMapCell>();
         var4.m_x = var2;
         var4.m_y = var3;
    ...
    WorldMapFeature var7 = this.parseFeature(var4, var1);
            var4.m_features.push_back(var7);
         }
    ...
    WorldMapGeometry var4 = this.parseGeometry(var2);
      var3.m_geometries.push_back(var4);
    ...
    WorldMapProperties var3 = std::make_shared<WorldMapProperties>();
      var3.putAll(var1);
      this.m_sharedProperties.push_back(var3);
    return var3;
   }
    ...
    int var3 = this.readByte(var1);
      ...
      for (int var4 = 0; var4 < var3; var4++) {
    WorldMapPoints var5 = std::make_shared<WorldMapPoints>();
         this.parseGeometryCoordinates(var1, var5);
         var2.m_points.push_back(var5);
      }
    ...
    int var3 = this.readShort(var1);
      ...
      for (int var4 = 0; var4 < var3; var4++) {
         var2.push_back(this.readShort(var1));
         var2.push_back(this.readShort(var1));
      }
   }
}
