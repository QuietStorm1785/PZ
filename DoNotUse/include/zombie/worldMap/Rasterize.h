...
class Rasterize {
public:
    const Edge edge1 = std::make_shared<Edge>();
    const Edge edge2 = std::make_shared<Edge>();
    const Edge edge3 = std::make_shared<Edge>();

    void scanLine(int var1, int var2, int var3, int> var4) {
      for (int var5 = var1; var5 < var2; var5++) {
         var4.accept(var5, var3);
      }
   }

    void scanSpan(Edge var1, Edge var2, int var3, int var4, int> var5) {
    ...
    void scanTriangle(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int> var9) {
