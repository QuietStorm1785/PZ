...
public:
    ...
    public FileTask_LoadWorldMapBinary(WorldMapData var1, const std::string& var2, FileSystem var3, IFileTaskCallback var4) {
      super(var3, var4);
    ...
    void* call() {
    WorldMapBinary var1 = std::make_shared<WorldMapBinary>();
