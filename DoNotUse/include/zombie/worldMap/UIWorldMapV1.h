...
public:
    ...
    WorldMapMarkersV1 getMarkersAPI() {
      if (this.m_markersV1 == nullptr) {
         this.m_markersV1 = std::make_shared<WorldMapMarkersV1>(this.m_ui);
      }
    ...
    WorldMapStyleV1 getStyleAPI() {
      if (this.m_styleV1 == nullptr) {
         this.m_styleV1 = std::make_shared<WorldMapStyleV1>(this.m_ui);
      }
    ...
    WorldMapSymbolsV1 getSymbolsAPI() {
      if (this.m_symbolsV1 == nullptr) {
         this.m_symbolsV1 = std::make_shared<WorldMapSymbolsV1>(this.m_ui, this.m_symbols);
      }
