...
class ActiveMods {
public:
   private static const std::vector<ActiveMods> s_activeMods = std::make_unique<std::vector<>>();
    static const ActiveMods s_loaded = std::make_shared<ActiveMods>("loaded");
    const std::string id;
   private const std::vector<std::string> mods = std::make_unique<std::vector<>>();
   private const std::vector<std::string> mapOrder = std::make_unique<std::vector<>>();
    ...
    ActiveMods var1 = std::make_shared<ActiveMods>(var0);
         s_activeMods.push_back(var1);
    return var1;
      }
   }
   ...
   public std::vector<std::string> getMods() {
      return this.mods;
   }

   public std::vector<std::string> getMapOrder() {
