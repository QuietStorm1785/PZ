...
public:
    ...
    bool roomValid(IsoGridSquare var1) {
      return var1.getRoom() != nullptr && ("pizzawhirled" == var1.getRoom().getName()) || "italianrestaurant" == var1.getRoom().getName()));
   }

    bool isValid(BuildingDef var1, bool var2) {
      return var1.getRoom("pizzawhirled") != nullptr || var1.getRoom("italianrestaurant") != nullptr || var2;
   }
