...
public:
    ...
    bool roomValid(IsoGridSquare var1) {
      return var1.getRoom() != nullptr && ("pileocrepe" == var1.getRoom().getName()) || "kitchen_crepe" == var1.getRoom().getName()));
   }

    bool isValid(BuildingDef var1, bool var2) {
      return var1.getRoom("pileocrepe") != nullptr || var1.getRoom("kitchen_crepe") != nullptr || var2;
   }
