...
public:
    ...
    void randomizeBuilding(BuildingDef var1) {
      if (this.table2 != nullptr) {
         if (this.westTable) {
    std::string var2 = this.getBowlOrMug();
            ...
            if (Rand.Next(100) < 70) {
               var2 = this.getBowlOrMug();
               this.addWorldItem(var2, this.table2.getSquare(), 0.6484F, 0.7353F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
               if (Rand.NextBool(3)) {
    ...
    std::string var7 = this.getBowlOrMug();
            this.addWorldItem(var7, this.table1.getSquare(), 0.906F, 0.718F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
            if (Rand.NextBool(3)) {
            ...
            var7 = this.getBowlOrMug();
            this.addWorldItem(var7, this.table1.getSquare(), 0.406F, 0.562F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
            if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 70) {
               var7 = this.getBowlOrMug();
               this.addWorldItem(var7, this.table2.getSquare(), 0.929F, 0.726F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
               if (Rand.NextBool(3)) {
            ...
            if (Rand.Next(100) < 50) {
               var7 = this.getBowlOrMug();
               this.addWorldItem(var7, this.table2.getSquare(), 0.382F, 0.78F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
               if (Rand.NextBool(3)) {
