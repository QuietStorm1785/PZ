      ...
      if (this.table2 != nullptr) {
         if (this.westTable) {
            ...
            if (Rand.Next(100) < 50) {
               ...
               this.addWorldItem(
                     this.foodType, this.table2.getSquare(), 0.5859F, 0.3941F, this.table1.getSurfaceOffsetNoTable() / 96.0F + 0.01F, Rand.Next(240, 285)
                  )
                  .setCooked(this.foodCooked);
               this.addWorldItem(
                  Rand.NextBool(2) ? "Base.GlassWine" : "Base.GlassTumbler",
    ...
    int var5 = Rand.Next(0, 5);
            ...
            if (Rand.NextBool(3)) {
               ...
               switch (var5) {
                  ...
                  case 2:
                     this.addWorldItem(
                        "Base.WaterBottleEmpty", this.table2.getSquare(), 0.851F, 0.15F, this.table1.getSurfaceOffsetNoTable() / 96.0F, Rand.Next(0, 360)
                     );
                     break;
                  case 3:
                     this.addWorldItem(
