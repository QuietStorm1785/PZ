...
public:
    static const Vector2 s_tempVector2 = std::make_shared<Vector2>();
    int minimumDays = 0;
    int maximumDays = 0;
    int minimumRooms = 0;
    bool unique = false;
    ...
    BaseVehicle var13 = std::make_shared<BaseVehicle>(IsoWorld.instance.CurrentCell);
    ...
    float var15 = var5 - (float) (Math.PI / 2);
         ...
         if (IsoChunk.doSpawnedVehiclesInInvalidPosition(var13)) {
            ...
            var10.chunk.vehicles.push_back(var13);
   ...
   public std::vector<IsoZombie> addZombiesOnVehicle(int var1, std::string var2, int var3, BaseVehicle var4) {
    ...
    IsoGridSquare var8 = var7.getCell().getGridSquare(Rand.Next(var7.x - 4, var7.x + 4), Rand.Next(var7.y - 4, var7.y + 4), var7.z);
            ...
            if (!this.rvsVehicleKeyAddedToZombie && !var5.empty()) {
   ...
   public std::vector<IsoZombie> addZombiesOnSquare(int var1, std::string var2, int var3, IsoGridSquare var4) {
    ...
    IsoDeadBody var12 = std::make_shared<IsoDeadBody>(var10, true);
    ...
    return nullptr;
         ...
         return std::make_shared<IsoDeadBody>(var0, true);
      }
   }

    static IsoGameCharacter createRandomZombie(int var0, int var1, int var2) {
    HumanCorpse var3 = std::make_shared<HumanCorpse>(IsoWorld.instance.getCell(), var0, var1, var2);
    ...
    BaseVehicle var3 = std::make_shared<BaseVehicle>(IsoWorld.instance.CurrentCell);
      ...
      if (IsoChunk.doSpawnedVehiclesInInvalidPosition(var3)) {
         var3.keySpawned = 1;
         var3.setSquare(var2);
         var3.square.chunk.vehicles.push_back(var3);
    ...
    void addRandomItemsOnGround(RoomDef var1, std::vector<std::string> var2, int var3) {
      for (int var4 = 0; var4 < var3; var4++) {
    IsoGridSquare var5 = getRandomSpawnSquare(var1);
    ...
    InventoryItem addRandomItemOnGround(IsoGridSquare var1, std::vector<std::string> var2) {
      if (var1 != nullptr && !var2.empty()) {
    std::string var3 = (std::string)PZArrayUtil.pickRandom(var2);
    ...
    return nullptr;
            ...
            VirtualZombieManager.instance.choices.clear();
            VirtualZombieManager.instance.choices.push_back(var2);
    ...
    return nullptr;
               ...
               return std::make_shared<IsoDeadBody>(var3, true);
            }
         }
      }
   }
