...
private
 static boolean[] SPECIALS = new boolean[256];
...
public
 ...
 case 'w':
 default:
 throw RuntimeException("invalid option '%" + char0 +
 "' to 'format'");
 case 'G':
 boolean6 = true;
 break;
...
private
 ...
 StringLib.StringPointer stringPointer1) {
 int int0 =
 matchState.level == 0 && stringPointer0 != nullptr ? 1 : matchState.level;
...
private
 ...
 if (!(dynamic_cast<Double*>(object) != nullptr) && !(dynamic_cast<String*>(object) != nullptr) &&
 !(dynamic_cast<LuaClosure*>(object) != nullptr) && !(dynamic_cast<JavaFunction*>(object) != nullptr) &&
 !(dynamic_cast<KahluaTable*>(object) != nullptr) {
...
private
 ...
 if (dynamic_cast<KahluaTable*>(object0) != nullptr) {
...
public
 ...
 public
 StringLib.StringPointer src_init;
 const int endIndex;
 public
 StringLib.MatchState.Capture[] capture;
 int level;
