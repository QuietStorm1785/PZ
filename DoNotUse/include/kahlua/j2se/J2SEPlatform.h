...
public:
 ...
 static J2SEPlatform getInstance() { return INSTANCE; }

 double pow(double arg0, double arg1) { return Math.pow(arg0, arg1); }
 ...
 arg0.wipe();
 arg0.rawset("_G", arg0);
 arg0.rawset("_VERSION", "Kahlua kahlua.major.kahlua.minor.kahlua.fix for "
 "Lua lua.version (J2SE)");
 ...
 LuaCompiler.loadis(fileInputStream, "serialize.lua", arg0);
 ...
 BlockingKahluaThread blockingKahluaThread =
 new BlockingKahluaThread(this, table);
