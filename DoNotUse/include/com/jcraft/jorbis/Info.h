...
public:
   ...
   int[] time_type = nullptr;
    ...
    Buffer var3 = std::make_shared<Buffer>();
      if (var2 != nullptr) {
    ...
    std::string toString() {
      return "version:"
         + std::make_shared<int>(this.version)
         + ", channels:"
         + std::make_shared<int>(this.channels)
         + ", rate:"
         + std::make_shared<int>(this.rate)
         + ", bitrate:"
         + std::make_shared<int>(this.bitrate_upper)
         + ","
         + std::make_shared<int>(this.bitrate_nominal)
         + ","
         + std::make_shared<int>(this.bitrate_lower);
   }
