...
class VorbisFile {
public:
    static const int CHUNKSIZE = 8500;
    static const int SEEK_SET = 0;
    static const int SEEK_CUR = 1;
    static const int SEEK_END = 2;
    static const int OV_FALSE = -1;
    static const int OV_EOF = -2;
    static const int OV_HOLE = -3;
    static const int OV_EREAD = -128;
    static const int OV_EFAULT = -129;
    static const int OV_EIMPL = -130;
    static const int OV_EINVAL = -131;
    static const int OV_ENOTVORBIS = -132;
    static const int OV_EBADHEADER = -133;
    static const int OV_EVERSION = -134;
    static const int OV_ENOTAUDIO = -135;
    static const int OV_EBADPACKET = -136;
    static const int OV_EBADLINK = -137;
    static const int OV_ENOSEEK = -138;
    float bittrack;
    int current_link;
   ...
   long[] dataoffsets;
    ...
    long offset;
   long[] offsets;
    StreamState os = std::make_shared<StreamState>();
    SyncState oy = std::make_shared<SyncState>();
    long pcm_offset;
   long[] pcmlengths;
    float samptrack;
    bool seekable = false;
   int[] serialnos;
   Comment[] vc;
    DspState vd = std::make_shared<DspState>();
    Block vb = std::make_shared<Block>(this.vd);
   Info[] vi;
    ...
    SeekableInputStream var2 = nullptr;
      ...
      try {
         var2 = std::make_shared<SeekableInputStream>(this, var1);
    int var3 = this.open(var2, nullptr, 0);
         if (var3 == -1) {
            throw JOrbisException("VorbisFile: open return -1");
         }
      } catch (Exception var11) {
         throw JOrbisException("VorbisFile: " + var11);
      } finally {
         if (var2 != nullptr) {
            try {
               var2.close();
    ...
    public VorbisFile(InputStream var1, byte[] var2, int var3) {
    ...
    static int fseek(InputStream var0, long var1, int var3) {
      if (dynamic_cast<SeekableInputStream*>(var0) != nullptr var4) {
         try {
            if (var3 == 0) {
               var4.seek(var1);
            } else if (var3 == 2) {
    ...
    static long ftell(InputStream var0) {
      try {
         if (dynamic_cast<SeekableInputStream*>(var0) != nullptr var1) {
            return var1.tell();
         }
    ...
    int bitrate(int var1) {
      if (var1 >= this.links) {
         ...
         if (this.seekable) {
            return (int)Math.rint((float)((this.offsets[var1 + 1] - this.dataoffsets[var1]) * 8L) / this.time_total(var1));
    ...
    long var2 = 0L;
         ...
         return (int)Math.rint((float)var2 / this.time_total(-1));
      }
   }
    ...
    int var2 = (int)(this.bittrack / this.samptrack * this.vi[var1].rate + 0.5);
         this.bittrack = 0.0F;
         this.samptrack = 0.0F;
    return var2;
      }
   ...
   public Comment[] getComment() {
    ...
    Comment getComment(int var1) {
      if (this.seekable) {
         if (var1 < 0) {
            return this.decode_ready ? this.vc[this.current_link] : nullptr;
         } else {
            return var1 >= this.links ? nullptr : this.vc[var1];
         }
      } else {
         return this.decode_ready ? this.vc[0] : nullptr;
      }
   }
   ...
   public Info[] getInfo() {
    ...
    Info getInfo(int var1) {
      if (this.seekable) {
         if (var1 < 0) {
            return this.decode_ready ? this.vi[this.current_link] : nullptr;
         } else {
            return var1 >= this.links ? nullptr : this.vi[var1];
         }
      } else {
         return this.decode_ready ? this.vi[0] : nullptr;
      }
   }

    int pcm_seek(long var1) {
    int var3 = -1;
    long var4 = this.pcm_total(-1);
      if (!this.seekable) {
         return -1;
      } else if (var1 >= 0L && var1 <= var4) {
         for (var3 = this.links - 1; var3 >= 0; var3--) {
            var4 -= this.pcmlengths[var3];
            if (var1 >= var4) {
               break;
            }
         }
    ...
    int var12 = (int)var10;
    Page var13 = std::make_shared<Page>();
    ...
    int raw_seek(int var1) {
      if (!this.seekable) {
         return -1;
      } else if (var1 >= 0 && var1 <= this.offsets[this.links]) {
         this.pcm_offset = -1L;
         this.decode_clear();
         this.seek_helper(var1);
    ...
    float var4 = 0.0F;
      ...
      return var4 + (float)(this.pcm_offset - var2) / this.vi[var1].rate;
   }

    float time_total(int var1) {
      if (!this.seekable || var1 >= this.links) {
         return -1.0F;
      } else if (var1 >= 0) {
         return (float)this.pcmlengths[var1] / this.vi[var1].rate;
      } else {
    float var2 = 0.0F;
    ...
    int var14 = this.get_next_page(var13, -1L);
         if (var14 == -128) {
            return -128;
         }

         if (var14 >= 0 && var13.serialno() == var7) {
            var3 = var14 + var13.header_len + var13.body_len;
         } else {
            var9 = var15;
            if (var14 >= 0) {
               var11 = var14;
    ...
    int var17 = this.get_next_page(var13, -1L);
      if (var17 == -128) {
         return -128;
      } else {
         if (var3 < var5 && var17 != -1) {
            var17 = this.bisect_forward_serialno(var11, this.offset, var5, var13.serialno(), var8 + 1);
            if (var17 == -128) {
               return -128;
            }
         } else {
    ...
    int clear() {
      ...
      this.vd.clear();
      this.os.clear();
      if (this.vi != nullptr && this.links != 0) {
      ...
      if (this.dataoffsets != nullptr) {
         this.dataoffsets = nullptr;
      }

      if (this.pcmlengths != nullptr) {
         this.pcmlengths = nullptr;
      }

      if (this.serialnos != nullptr) {
         this.serialnos = nullptr;
      }
    ...
    Page var5 = std::make_shared<Page>();
    Packet var6 = std::make_shared<Packet>();
      if (var4 == nullptr) {
    ...
    int var9 = this.os.packetout(var6);
         ...
         if (var8 < 3 && this.get_next_page(var4, 1L) < 0) {
            var1.clear();
            var2.clear();
            this.os.clear();
            return -1;
    ...
    int open(InputStream var1, byte[] var2, int var3) {
      return this.open_callbacks(var1, var2, var3);
   }

    int open_callbacks(InputStream var1, byte[] var2, int var3) {
    ...
    int var4;
      if (dynamic_cast<SeekableInputStream*>(var1) != nullptr) {
    ...
    int open_seekable() {
    Info var1 = std::make_shared<Info>();
    Comment var2 = std::make_shared<Comment>();
    Page var8 = std::make_shared<Page>();
      int[] var9 = new int[1];
    int var6 = this.fetch_headers(var1, var2, var9, nullptr);
    int var3 = var9[0];
    ...
    Page var4 = std::make_shared<Page>();
      this.vi = new Info[this.links];
      this.vc = new Comment[this.links];
      ...
      for (int var6 = 0; var6 < this.links; var6++) {
         if (var1 != nullptr && var2 != nullptr && var6 == 0) {
            this.vi[var6] = var1;
            this.vc[var6] = var2;
            this.dataoffsets[var6] = var3;
         } else {
            this.seek_helper(this.offsets[var6]);
            this.vi[var6] = std::make_unique<Info>();
            this.vc[var6] = std::make_unique<Comment>();
            if (this.fetch_headers(this.vi[var6], this.vc[var6], nullptr, nullptr) == -1) {
    ...
    Packet var3 = std::make_shared<Packet>();
    int var4 = this.os.packetout(var3);
            if (var4 > 0) {
    long var5 = var3.granulepos;
               if (this.vb.synthesis(var3) == 0) {
    int var7 = this.vd.synthesis_pcmout(nullptr, nullptr);
                  this.vd.synthesis_blockin(this.vb);
                  this.samptrack = this.samptrack + (this.vd.synthesis_pcmout(nullptr, nullptr) - var7);
                  this.bittrack = this.bittrack + var3.bytes * 8;
                  if (var5 != -1L && var3.e_o_s == 0) {
                     var7 = this.seekable ? this.current_link : 0;
    int var8 = this.vd.synthesis_pcmout(nullptr, nullptr);
                     var5 -= var8;
    ...
    return 0;
         ...
         this.bittrack = this.bittrack + var2.header_len * 8;
    ...
    int var10 = 0;
               ...
               while (var10 < this.links && this.serialnos[var10] != this.current_serialno) {
                  var10++;
               }
    ...
    int var14 = var4 * var13;
               ...
               if (var4 == 1) {
    int var16 = var5 != 0 ? 0 : 128;

                  for (int var17 = 0; var17 < var12; var17++) {
                     for (int var18 = 0; var18 < var13; var18++) {
    int var15 = (int)(var9[var18][var11[var18] + var17] * 128.0 + 0.5);
                        if (var15 > 127) {
                           var15 = 127;
                        } else if (var15 < -128) {
                           var15 = -128;
    ...
    int var23 = (int)(var9[var30][var34 + var20] * 32768.0 + 0.5);
                              if (var23 > 32767) {
                                 var23 = 32767;
                              } else if (var23 < -32768) {
                                 var23 = -32768;
                              ...
                              var1[var19] = (byte)(var23 >>> 8);
                              var1[var19 + 1] = (byte)var23;
                              var19 += var13 * 2;
                           }
                        }
                     } else {
    ...
    int var24 = (int)(var35[var39] * 32768.0 + 0.5);
                              if (var24 > 32767) {
                                 var24 = 32767;
                              } else if (var24 < -32768) {
                                 var24 = -32768;
                              ...
                              var1[var38] = (byte)(var24 + var29 >>> 8);
                              var1[var38 + 1] = (byte)(var24 + var29);
                              var38 += var13 * 2;
                           }
                        }
                     }
    ...
    int var25 = (int)(var9[var36][var32] * 32768.0 + 0.5);
                           if (var25 > 32767) {
                              var25 = 32767;
                           } else if (var25 < -32768) {
                              var25 = -32768;
                           ...
                           var25 += var29;
                           var1[var8++] = (byte)(var25 >>> 8);
                           var1[var8++] = (byte)var25;
                        }
                     }
                  } else {
                     for (int var33 = 0; var33 < var12; var33++) {
                        for (int var37 = 0; var37 < var13; var37++) {
    int var27 = (int)(var9[var37][var33] * 32768.0 + 0.5);
                           if (var27 > 32767) {
                              var27 = 32767;
                           } else if (var27 < -32768) {
                              var27 = -32768;
                           ...
                           var27 += var29;
                           var1[var8++] = (byte)var27;
                           var1[var8++] = (byte)(var27 >>> 8);
                        }
                     }
                  }
               }
    ...
    float var5 = this.time_total(-1);
      if (!this.seekable) {
         ...
         for (var2 = this.links - 1; var2 >= 0; var2--) {
            var3 -= this.pcmlengths[var2];
            var5 -= this.time_total(var2);
            if (var1 >= var5) {
               break;
            }
         }

    long var6 = (long)((float)var3 + (var1 - var5) * this.vi[var2].rate);
    ...
    int get_next_page(Page var1, long var2) {
      if (var2 > 0L) {
         var2 += this.offset;
      }
    ...
    int var4 = this.get_next_page(var1, var2 + 8500L - this.offset);
            if (var4 == -128) {
               return -128;
            }
            ...
            if (var4 < 0) {
               if (var5 == -1) {
                  throw std::make_unique<JOrbisException>();
               }
               break;
            }
      ...
      this.seek_helper(var5);
    int var6 = this.get_next_page(var1, 8500L);
      return var6 < 0 ? -129 : var5;
   }
