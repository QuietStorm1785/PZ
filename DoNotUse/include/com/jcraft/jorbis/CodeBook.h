...
class CodeBook {
public:
    StaticCodeBook c = std::make_shared<StaticCodeBook>();
   int[] codelist;
   ...
   /* synchronized - TODO: add std::mutex */ int decodevs_add(float[] var1, int var2, Buffer var3, int var4) {
    ...
    int var1 = 0;
    DecodeAux var2 = std::make_shared<DecodeAux>(this);
