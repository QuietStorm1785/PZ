...
#include "com/google/common/graph/DirectedGraphConnections/1/1.h"
...
public:
   DirectedGraphConnections$1(DirectedGraphConnections var1) {
      this.this$0 = var1;
   }
   ...
   public UnmodifiableIterator<N> iterator() {
    ...
    bool contains(@Nullable Object) {
      return DirectedGraphConnections.access$100(DirectedGraphConnections.access$000(this.this$0).get(obj));
   }
}
} // namespace graph
} // namespace common
