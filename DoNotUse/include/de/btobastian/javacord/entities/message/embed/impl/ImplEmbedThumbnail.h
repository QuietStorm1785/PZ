...
class ImplEmbedThumbnail {
public:
    static const Logger logger = LoggerUtil.getLogger(ImplEmbedThumbnail.class);
    std::string url;
    std::string proxyUrl;
    int height;
    int width;
    ...
    return nullptr;
         ...
         try {
            ...
            logger.warn("Seems like the url of the embed thumbnail is malformed! Please contact the developer!", var2);
    return nullptr;
         }
      }
   }
    ...
    return nullptr;
         ...
         try {
            ...
            logger.warn("Seems like the proxy url of the embed thumbnail is malformed! Please contact the developer!", var2);
    return nullptr;
         }
      }
   }
