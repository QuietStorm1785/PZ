...
#include "de/btobastian/javacord/utils/handler/server/GuildBanAddHandler/1.h"
...
class GuildBanAddHandler : public PacketHandler {
public:
    static const Logger logger = LoggerUtil.getLogger(GuildBanAddHandler.class);
