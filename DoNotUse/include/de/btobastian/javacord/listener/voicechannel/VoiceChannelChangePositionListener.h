...
class VoiceChannelChangePositionListener {
public:
    virtual ~VoiceChannelChangePositionListener() = default;
    void onVoiceChannelChangePosition(DiscordAPI var1, VoiceChannel var2, int var3);
}
} // namespace voicechannel
} // namespace listener
} // namespace javacord
