...
public
Matrix3d::Matrix3d(double[] doubles) {
...
public
Matrix3d::Matrix3d(Matrix3f matrix3f) {
 // TODO: Implement Matrix3d
 return nullptr;
}
...
void Matrix3d::setRow(int int0, double double0, double double1,
 double double2) {
...
void Matrix3d::setColumn(int int0, double double0, double double1,
 double double2) {
...
void Matrix3d::luBacksubstitution(double[] doubles1, int[] ints,
 double[] doubles0) {
...
void Matrix3d::compute_svd(double[] doubles7, double[] doubles8,
 double[] doubles9) {
 // TODO: Implement compute_svd
}

void Matrix3d::svdReorder(double[] doubles7, double[] doubles4,
 double[] doubles3, double[] doubles2,
 double[] doubles5, double[] doubles6) {
 // TODO: Implement svdReorder
}

int Matrix3d::compute_qr(double[] doubles6, double[] doubles5,
 double[] doubles7, double[] doubles8) {
...
double Matrix3d::compute_rot(double double4, double double3, double[] doubles0,
...
void Matrix3d::mat_mul(double[] doubles2, double[] doubles1,
 double[] doubles3) {
