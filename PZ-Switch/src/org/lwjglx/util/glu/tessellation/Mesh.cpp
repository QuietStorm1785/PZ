...
void Mesh::MakeVertex(GLUvertex gLUvertex1, GLUhalfEdge gLUhalfEdge0,
 GLUvertex gLUvertex3) {
 // TODO: Implement MakeVertex
}

void Mesh::MakeFace(GLUface gLUface1, GLUhalfEdge gLUhalfEdge0,
 GLUface gLUface3) {
...
GLUhalfEdge Mesh::__gl_meshConnect(GLUhalfEdge gLUhalfEdge1,
