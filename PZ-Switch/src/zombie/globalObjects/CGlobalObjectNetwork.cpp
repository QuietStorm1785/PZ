...
void CGlobalObjectNetwork::sendClientCommand(IsoPlayer player,
...
void CGlobalObjectNetwork::writeClientCommand(
 IsoPlayer player, const std::string &string0, const std::string &string1,
 KahluaTable table, ByteBufferWriter byteBufferWriter) {
