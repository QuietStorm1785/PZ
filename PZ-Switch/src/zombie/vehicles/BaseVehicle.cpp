...
public
BaseVehicle::BaseVehicle(IsoCell cell) {
...
void BaseVehicle::setNetPlayerAuthorization(
 BaseVehicle.Authorization _netPlayerAuthorization, int _netPlayerId) {
 // TODO: Implement setNetPlayerAuthorization
}

bool BaseVehicle::isNetPlayerAuthorization(
 BaseVehicle.Authorization _netPlayerAuthorization) {
...
void BaseVehicle::putKeyToContainer(ItemContainer container, IsoGridSquare sq,
 IsoObject obj) {
...
void BaseVehicle::toggleLockedDoor(VehiclePart part, IsoGameCharacter chr,
 bool locked) {
...
void BaseVehicle::setGeneralPartCondition(float _baseQuality,
...
bool BaseVehicle::setPassenger(int seat, IsoGameCharacter chr,
 Vector3f offset) {
...
Vector3f BaseVehicle::getWorldPos(float localX, float localY, float localZ,
...
Vector3f BaseVehicle::getLocalPos(float worldX, float worldY, float worldZ,
 Vector3f localPos) {
 // TODO: Implement getLocalPos
 return nullptr;
}
...
Vector3f BaseVehicle::getPassengerPositionWorldPos(VehicleScript.Position posn,
 Vector3f out) {
 // TODO: Implement getPassengerPositionWorldPos
 return nullptr;
}

Vector3f BaseVehicle::getPassengerPositionWorldPos(float x, float y, float z,
 Vector3f out) {
 // TODO: Implement getPassengerPositionWorldPos
 return nullptr;
}
...
void BaseVehicle::playActorAnim(VehiclePart part, const std::string &animId,
 IsoGameCharacter chr) {
 // TODO: Implement playActorAnim
}

void BaseVehicle::playCharacterAnim(IsoGameCharacter character,
 VehicleScript.Anim anim, bool boolean0) {
 // TODO: Implement playCharacterAnim
}

void BaseVehicle::playPartSound(VehiclePart part, IsoPlayer player,
 const std::string &animId) {
 // TODO: Implement playPartSound
}

void BaseVehicle::setCharacterPosition(IsoGameCharacter chr, int seat,
 const std::string &positionId) {
 // TODO: Implement setCharacterPosition
}

void BaseVehicle::transmitCharacterPosition(int seat,
 const std::string &positionId) {
 // TODO: Implement transmitCharacterPosition
}

void BaseVehicle::setCharacterPositionToAnim(IsoGameCharacter chr, int seat,
 const std::string &animId) {
...
void BaseVehicle::checkCollisionWithPlant(IsoGridSquare square,
 IsoObject object, Vector2 vector1) {
...
bool BaseVehicle::isInvalidChunkAround(bool moveW, bool moveE, bool moveN,
 bool moveS) {
 // TODO: Implement isInvalidChunkAround
 return false;
}
...
void BaseVehicle::updateAnimationPlayer(AnimationPlayer animationPlayer,
 VehiclePart part) {
 // TODO: Implement updateAnimationPlayer
}

void BaseVehicle::saveChange(const std::string &change, KahluaTable tbl,
 ByteBuffer bb) {
...
void BaseVehicle::netPlayerFromServerUpdate(
 BaseVehicle.Authorization authorization, short authorizationPlayer) {
...
Vector2 BaseVehicle::testCollisionWithCharacter(IsoGameCharacter chr,
 float circleRadius,
 Vector2 out) {
...
int BaseVehicle::testCollisionWithProneCharacter(IsoGameCharacter chr,
 bool doSound) {
...
int BaseVehicle::testCollisionWithProneCharacter(IsoMovingObject chr,
...
Vector2 BaseVehicle::testCollisionWithObject(IsoObject obj, float circleRadius,
 Vector2 out) {
...
void BaseVehicle::fixLightbarModelLighting(IsoLightSource ls,
 Vector3f lightPos) {
...
void BaseVehicle::doBloodOverlayAux(float[] floats0, float[] floats1,
 float float0) {
 // TODO: Implement doBloodOverlayAux
}

void BaseVehicle::doBloodOverlayFront(float[] floats0, float[] floats1,
 float float0) {
 // TODO: Implement doBloodOverlayFront
}

void BaseVehicle::doBloodOverlayRear(float[] floats0, float[] floats1,
 float float0) {
 // TODO: Implement doBloodOverlayRear
}

void BaseVehicle::doBloodOverlayLeft(float[] floats, float[] var2,
 float float0) {
 // TODO: Implement doBloodOverlayLeft
}

void BaseVehicle::doBloodOverlayRight(float[] floats, float[] var2,
 float float0) {
 // TODO: Implement doBloodOverlayRight
}

void BaseVehicle::render(float x, float y, float z, ColorInfo col,
...
float BaseVehicle::getAreaDist(const std::string &areaId,
 IsoGameCharacter chr) {
...
void BaseVehicle::callLuaVoid(const std::string &string, void *object1,
 void *object2) {
...
bool BaseVehicle::callLuaBoolean(const std::string &string, void *object1,
 void *object2) {
...
Vector3f BaseVehicle::chooseBestAttackPosition(IsoGameCharacter target,
...
void BaseVehicle::syncKeyInIgnition(bool inIgnition, bool onDoor,
 InventoryItem key) {
...
void BaseVehicle::randomizeContainer(
 VehiclePart part, ItemPickerJava.ItemPickerRoom itemPickerRoom) {
...
void BaseVehicle::updateBulletStatsWheel(int int1, float[] floats,
 Vector3f vector3f1, float float0,
 int int2, double double1,
 double double0) {
...
void BaseVehicle::setVehicleTowing(BaseVehicle vehicleB,
 const std::string &attachmentA,
 const std::string &attachmentB) {
 // TODO: Implement setVehicleTowing
}

void BaseVehicle::setVehicleTowedBy(BaseVehicle vehicleA,
 const std::string &attachmentA,
 const std::string &attachmentB) {
...
Vector3f BaseVehicle::getAttachmentLocalPos(const std::string &attachmentName,
 Vector3f v) {
 // TODO: Implement getAttachmentLocalPos
 return nullptr;
}

Vector3f BaseVehicle::getAttachmentWorldPos(const std::string &attachmentName,
 Vector3f v) {
...
Vector3f BaseVehicle::getTowingLocalPos(const std::string &attachmentName,
 Vector3f v) {
 // TODO: Implement getTowingLocalPos
 return nullptr;
}

Vector3f BaseVehicle::getTowedByLocalPos(const std::string &attachmentName,
 Vector3f v) {
 // TODO: Implement getTowedByLocalPos
 return nullptr;
}

Vector3f BaseVehicle::getTowingWorldPos(const std::string &attachmentName,
 Vector3f v) {
 // TODO: Implement getTowingWorldPos
 return nullptr;
}

Vector3f BaseVehicle::getTowedByWorldPos(const std::string &attachmentName,
 Vector3f v) {
...
Vector3f
BaseVehicle::getPlayerTrailerLocalPos(const std::string &attachmentName,
...
Vector3f
BaseVehicle::getPlayerTrailerWorldPos(const std::string &attachmentName,
 bool left, Vector3f v) {
...
void BaseVehicle::drawDirectionLine(Vector2 dir, float length, float r, float g,
 float b) {
 // TODO: Implement drawDirectionLine
}

void BaseVehicle::addPointConstraint(IsoPlayer player, BaseVehicle vehicleB,
 const std::string &attachmentA,
 const std::string &attachmentB) {
...
bool BaseVehicle::canAttachTrailer(BaseVehicle vehicleB,
 const std::string &attachmentA,
 const std::string &attachmentB) {
...
void BaseVehicle::startEvent(long eventInstance, GameSoundClip clip,
 BitSet parameterSet) {
...
void BaseVehicle::stopEvent(long eventInstance, GameSoundClip clip,
 BitSet parameterSet) {
...
void BaseVehicle::hitCharacter(IsoGameCharacter character,
 BaseVehicle.HitVars vars) {
 // TODO: Implement hitCharacter
}
