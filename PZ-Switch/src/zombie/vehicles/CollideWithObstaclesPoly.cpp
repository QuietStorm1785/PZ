...
void CollideWithObstaclesPoly::getVehiclesInRect(float float0, float float1,
 float float2, float float3,
 int int7) {
 // TODO: Implement getVehiclesInRect
}

void CollideWithObstaclesPoly::getObstaclesInRect(float float3, float float1,
 float float2, float float0,
 int int4, int int5, int int8,
 bool boolean0) {
 // TODO: Implement getObstaclesInRect
}

Vector2f CollideWithObstaclesPoly::resolveCollision(IsoGameCharacter character,
...
bool CollideWithObstaclesPoly::canStandAt(float float1, float float3,
 float float6, BaseVehicle vehicle,
 int int0) {
 // TODO: Implement canStandAt
 return false;
}

void CollideWithObstaclesPoly::vehicleMoved(
 PolygonalMap2.VehiclePoly vehiclePoly) {
 // TODO: Implement vehicleMoved
}

void CollideWithObstaclesPoly::vehicleMoved(
 PolygonalMap2.VehiclePoly vehiclePoly0,
...
void CollideWithObstaclesPoly::getClosestPointOnEdge(
...
void CollideWithObstaclesPoly::releaseAll(
 ArrayList<CollideWithObstaclesPoly.CCEdge> arrayList) {
 // TODO: Implement releaseAll
}

void CollideWithObstaclesPoly::release(
 CollideWithObstaclesPoly.CCEdgeRing cCEdgeRing) {
 // TODO: Implement release
}

float CollideWithObstaclesPoly::isLeft(float float3, float float1, float float5,
...
bool CollideWithObstaclesPoly::lineSegmentIntersects(float float3, float float1,
 float float2, float float0,
 bool boolean0,
 bool boolean1) {
...
void CollideWithObstaclesPoly::releaseAll(
 ArrayList<CollideWithObstaclesPoly.CCEdgeRing> arrayList) {
 // TODO: Implement releaseAll
}

bool CollideWithObstaclesPoly::getNormalAndEdgeVectors(Vector2 vector0,
 Vector2 vector1) {
...
void CollideWithObstaclesPoly::releaseAll(
 ArrayList<CollideWithObstaclesPoly.CCNode> arrayList) {
 // TODO: Implement releaseAll
}
...
bool CollideWithObstaclesPoly::isPointInside(float float0, float float1,
 int int0) {
 // TODO: Implement isPointInside
 return false;
}

bool CollideWithObstaclesPoly::lineSegmentIntersects(float float0, float float1,
 float float2, float float3,
 bool boolean0) {
 // TODO: Implement lineSegmentIntersects
 return false;
...
void CollideWithObstaclesPoly::init(
 IsoChunk chunk, int int0,
 CollideWithObstaclesPoly collideWithObstaclesPoly) {
 // TODO: Implement init
}

void CollideWithObstaclesPoly::getEdgesFromBuffer(
 ByteBuffer byteBuffer, CollideWithObstaclesPoly.CCObstacle cCObstacle,
 bool boolean0) {
 // TODO: Implement getEdgesFromBuffer
}

void CollideWithObstaclesPoly::clipperToObstacles(
 Clipper clipper, ByteBuffer byteBuffer,
 ArrayList<CollideWithObstaclesPoly.CCObstacle> arrayList) {
...
bool CollideWithObstaclesPoly::isOpenDoorAt(int int0, int int1, int int2,
 bool boolean0) {
...
bool CollideWithObstaclesPoly::intersects(
 CollideWithObstaclesPoly.ImmutableRectF immutableRectF0) {
