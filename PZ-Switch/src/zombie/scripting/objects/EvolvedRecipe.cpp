...
public
EvolvedRecipe::EvolvedRecipe(const std::string &_name) {
...
void EvolvedRecipe::checkItemCanBeUse(ItemContainer container,
 const std::string &string,
 InventoryItem item1, int int1,
 ArrayList<InventoryItem> arrayList1) {
 // TODO: Implement checkItemCanBeUse
}

InventoryItem EvolvedRecipe::addItem(InventoryItem _baseItem,
...
void EvolvedRecipe::addPoison(InventoryItem item0, InventoryItem item1,
...
bool EvolvedRecipe::isSpiceAdded(InventoryItem _baseItem,
