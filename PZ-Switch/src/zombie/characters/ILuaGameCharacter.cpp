...
void ILuaGameCharacter::PlayAnimWithSpeed(const std::string &string,
...
void ILuaGameCharacter::Say(const std::string &line, float r, float g, float b,
...
void ILuaGameCharacter::setHaloNote(const std::string &str, int r, int g, int b,
 float dispTime) {
 // TODO: Implement setHaloNote
}
...
void ILuaGameCharacter::setAlreadyReadPages(const std::string &fullType,
 int pages) {
...
void ILuaGameCharacter::addWorldSoundUnlessInvisible(int radius, int volume,
 bool bStressHumans) {
