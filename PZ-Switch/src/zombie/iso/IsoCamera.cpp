...
void IsoCamera::SetCharacterToFollow(IsoGameCharacter GameChar) {
...
void IsoCamera::setOffX(float aOffX) {
...
void IsoCamera::setOffY(float aOffY) {
...
void IsoCamera::setLastOffX(float aLastOffX) {
...
void IsoCamera::setLastOffY(float aLastOffY) {
...
void IsoCamera::setCamCharacter(IsoGameCharacter aCamCharacter) {
...
void IsoCamera::setFakePos(Vector2 aFakePos) {
...
void IsoCamera::setFakePosVec(Vector2 aFakePosVec) {
...
void IsoCamera::setTargetTileX(int aTargetTileX) {
...
void IsoCamera::setTargetTileY(int aTargetTileY) {
 // TODO: Implement setTargetTileY
}

int IsoCamera::getScreenLeft(int playerIndex) {
 // TODO: Implement getScreenLeft
 return 0;
}

int IsoCamera::getScreenWidth(int playerIndex) {
 // TODO: Implement getScreenWidth
 return 0;
}

int IsoCamera::getScreenTop(int playerIndex) {
 // TODO: Implement getScreenTop
 return 0;
}

int IsoCamera::getScreenHeight(int playerIndex) {
 // TODO: Implement getScreenHeight
 return 0;
}

int IsoCamera::getOffscreenLeft(int playerIndex) {
 // TODO: Implement getOffscreenLeft
 return 0;
}

int IsoCamera::getOffscreenWidth(int playerIndex) {
 // TODO: Implement getOffscreenWidth
 return 0;
}

int IsoCamera::getOffscreenTop(int playerIndex) {
 // TODO: Implement getOffscreenTop
 return 0;
}

int IsoCamera::getOffscreenHeight(int playerIndex) {
 // TODO: Implement getOffscreenHeight
 return 0;
}

void IsoCamera::set(int _playerIndex) {
 // TODO: Implement set
}
