...
public
ClimateColorInfo::ClimateColorInfo(float r, float g, float b, float a) {
 // TODO: Implement ClimateColorInfo
 return nullptr;
}

public
ClimateColorInfo::ClimateColorInfo(float r, float g, float b, float a, float r2,
...
ClimateColorInfo ClimateColorInfo::interp(ClimateColorInfo to, float t,
...
ClimateColorInfo ClimateColorInfo::interp(ClimateColorInfo source,
...
void ClimateColorInfo::writeSeasonColor(int int0,
 ClimateColorInfo climateColorInfo,
