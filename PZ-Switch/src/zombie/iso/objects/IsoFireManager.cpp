...
void IsoFireManager::Fire_LightCalc(IsoGridSquare FireSquare,
 IsoGridSquare TestSquare, int playerIndex) {
...
void IsoFireManager::explode(IsoCell cell, IsoGridSquare gridSquare,
 int power) {
...
void IsoFireManager::StartFire(IsoCell cell, IsoGridSquare gridSquare,
 bool IgniteOnAny, int FireStartingEnergy,
 int Life) {
 // TODO: Implement StartFire
}

void IsoFireManager::StartSmoke(IsoCell cell, IsoGridSquare gridSquare,
 bool IgniteOnAny, int FireStartingEnergy,
 int Life) {
...
float IsoFireManager::getClosestListener(float float5, float float6,
 float float7) {
