...
public
IsoLightSwitch::IsoLightSwitch(IsoCell cell) {
 // TODO: Implement IsoLightSwitch
 return nullptr;
}

public
IsoLightSwitch::IsoLightSwitch(IsoCell cell, IsoGridSquare sq, IsoSprite gid,
 int _RoomID) {
 // TODO: Implement IsoLightSwitch
 return nullptr;
}
...
void IsoLightSwitch::load(ByteBuffer input, int WorldVersion,
 bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoLightSwitch::writeCustomizedSettingsPacket(
...
void IsoLightSwitch::receiveSyncCustomizedSettings(ByteBuffer bb,
 UdpConnection connection) {
 // TODO: Implement receiveSyncCustomizedSettings
}

void IsoLightSwitch::writeLightSwitchObjectHeader(
 ByteBufferWriter byteBufferWriter, uint8_t byte0) {
...
void IsoLightSwitch::syncIsoObject(bool bRemote, uint8_t val,
