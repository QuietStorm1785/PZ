...
public
IsoGenerator::IsoGenerator(IsoCell cell) {
 // TODO: Implement IsoGenerator
 return nullptr;
}

public
IsoGenerator::IsoGenerator(InventoryItem item, IsoCell cell, IsoGridSquare sq) {
 // TODO: Implement IsoGenerator
 return nullptr;
}
...
void IsoGenerator::load(ByteBuffer input, int WorldVersion,
 bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoGenerator::syncIsoObject(bool bRemote, uint8_t val,
 UdpConnection source, ByteBuffer bb) {
 // TODO: Implement syncIsoObject
}

void IsoGenerator::sync(float _fuel, int _condition, bool _connected,
 bool _activated) {
 // TODO: Implement sync
}
...
bool IsoGenerator::isPoweringSquare(int generatorX, int generatorY,
 int generatorZ, int x, int y, int z) {
