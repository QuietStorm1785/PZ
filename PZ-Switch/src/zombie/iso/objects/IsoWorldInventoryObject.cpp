...
public
IsoWorldInventoryObject::IsoWorldInventoryObject(InventoryItem _item,
 IsoGridSquare sq, float _xoff,
...
public
IsoWorldInventoryObject::IsoWorldInventoryObject(IsoCell cell) {
 // TODO: Implement IsoWorldInventoryObject
 return nullptr;
}
...
void IsoWorldInventoryObject::saveChange(const std::string &change,
 KahluaTable tbl, ByteBuffer bb) {
 // TODO: Implement saveChange
}

void IsoWorldInventoryObject::loadChange(const std::string &change,
 ByteBuffer bb) {
...
void IsoWorldInventoryObject::load(ByteBuffer input, int WorldVersion,
 bool IS_DEBUG_SAVE) {
 // TODO: Implement load
}
...
void IsoWorldInventoryObject::debugDrawLocation(float float0, float float1,
 float float2) {
...
void IsoWorldInventoryObject::render(float x, float y, float z, ColorInfo col,
 bool bDoChild, bool bWallLightingPass,
 Shader shader) {
 // TODO: Implement render
}

void IsoWorldInventoryObject::renderObjectPicker(float x, float y, float z,
 ColorInfo lightInfo) {
...
float IsoWorldInventoryObject::getSurfaceAlpha(IsoGridSquare square,
 float _zoff) {
