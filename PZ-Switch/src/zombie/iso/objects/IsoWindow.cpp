...
public
IsoWindow::IsoWindow(IsoCell cell) {
...
public
IsoWindow::IsoWindow(IsoCell cell, IsoGridSquare gridSquare, IsoSprite gid,
 bool _north) {
 // TODO: Implement IsoWindow
 return nullptr;
}
...
bool IsoWindow::TestCollide(IsoMovingObject obj, IsoGridSquare from,
 IsoGridSquare to) {
...
void IsoWindow::render(float x, float y, float z, ColorInfo col,
...
void IsoWindow::syncIsoObject(bool bRemote, uint8_t val, UdpConnection source,
 ByteBuffer bb) {
...
bool IsoWindow::addSheetRope(IsoPlayer player, IsoGridSquare sq, bool _north,
...
bool IsoWindow::removeSheetRope(IsoPlayer player, IsoGridSquare square,
 bool _north) {
 // TODO: Implement removeSheetRope
 return false;
}
...
bool IsoWindow::canClimbThroughHelper(IsoGameCharacter chr, IsoGridSquare sq,
...
IsoGameCharacter
IsoWindow::getFirstCharacterClimbingThrough(IsoGridSquare square) {
 // TODO: Implement getFirstCharacterClimbingThrough
 return nullptr;
}
