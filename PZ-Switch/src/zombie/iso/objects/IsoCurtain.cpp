...
public
IsoCurtain::IsoCurtain(IsoCell cell, IsoGridSquare gridSquare, IsoSprite gid,
 bool _north, bool spriteclosed) {
 // TODO: Implement IsoCurtain
 return nullptr;
}

public
IsoCurtain::IsoCurtain(IsoCell cell, IsoGridSquare gridSquare,
 const std::string &gid, bool _north) {
 // TODO: Implement IsoCurtain
 return nullptr;
}

public
IsoCurtain::IsoCurtain(IsoCell cell) {
 // TODO: Implement IsoCurtain
 return nullptr;
}
...
bool IsoCurtain::isAdjacentToSquare(IsoGridSquare square1,
...
void IsoCurtain::syncIsoObject(bool bRemote, uint8_t val,
