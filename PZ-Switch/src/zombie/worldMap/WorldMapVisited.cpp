...
void WorldMapVisited::clearKnownInCells(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement clearKnownInCells
}

void WorldMapVisited::setVisitedInCells(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement setVisitedInCells
}

void WorldMapVisited::clearVisitedInCells(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement clearVisitedInCells
}

void WorldMapVisited::setKnownInSquares(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement setKnownInSquares
}

void WorldMapVisited::clearKnownInSquares(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement clearKnownInSquares
}

void WorldMapVisited::setVisitedInSquares(int minX, int minY, int maxX,
 int maxY) {
 // TODO: Implement setVisitedInSquares
}

void WorldMapVisited::clearVisitedInSquares(int minX, int minY, int maxX,
 int maxY) {
...
void WorldMapVisited::render(float renderX, float renderY, int minX, int minY,
 int maxX, int maxY, float worldScale, bool blur) {
 // TODO: Implement render
}

void WorldMapVisited::renderGrid(float renderX, float renderY, int minX,
 int minY, int maxX, int maxY, float worldScale,
 float zoomF) {
...
void WorldMapVisited::setFlags(int int0, int int1, int int2, int int3,
 int int13) {
 // TODO: Implement setFlags
}

void WorldMapVisited::clearFlags(int int0, int int1, int int2, int int3,
 int int13) {
...
void WorldMapVisited::setUnvisitedRGBA(float float0, float float1, float float2,
 float float3) {
 // TODO: Implement setUnvisitedRGBA
}

void WorldMapVisited::setUnvisitedGridRGBA(float float0, float float1,
 float float2, float float3) {
 // TODO: Implement setUnvisitedGridRGBA
}

bool WorldMapVisited::hasFlags(int int0, int int1, int int2, int int3,
 int int13, bool boolean0) {
