...
public
WorldMapTextureSymbol::WorldMapTextureSymbol(WorldMapSymbols owner) {
...
void WorldMapTextureSymbol::layout(UIWorldMap ui,
...
void WorldMapTextureSymbol::load(ByteBuffer input, int WorldVersion,
 int SymbolsVersion) {
 // TODO: Implement load
}
