...
public
WorldMapBaseSymbol::WorldMapBaseSymbol(WorldMapSymbols owner) {
...
void WorldMapBaseSymbol::layout(UIWorldMap ui,
 WorldMapSymbolCollisions collisions, float rox,
 float roy) {
...
void WorldMapBaseSymbol::load(ByteBuffer input, int WorldVersion,
 int SymbolsVersion) {
 // TODO: Implement load
}

void WorldMapBaseSymbol::renderCollided(UIWorldMap uIWorldMap, float float1,
 float float3) {
