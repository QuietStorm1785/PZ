...
void RVSFlippedCrash::randomizeVehicleStory(IsoMetaGrid.Zone zone,
 IsoChunk chunk) {
 // TODO: Implement randomizeVehicleStory
}

bool RVSFlippedCrash::initVehicleStorySpawner(IsoMetaGrid.Zone zone,
 IsoChunk chunk, bool debug) {
 // TODO: Implement initVehicleStorySpawner
 return false;
}

void RVSFlippedCrash::spawnElement(VehicleStorySpawner spawner,
