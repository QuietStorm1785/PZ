...
void RVSTrailerCrash::randomizeVehicleStory(IsoMetaGrid.Zone zone,
 IsoChunk chunk) {
 // TODO: Implement randomizeVehicleStory
}

bool RVSTrailerCrash::initVehicleStorySpawner(IsoMetaGrid.Zone zone,
 IsoChunk chunk, bool debug) {
 // TODO: Implement initVehicleStorySpawner
 return false;
}

void RVSTrailerCrash::spawnElement(VehicleStorySpawner spawner,
