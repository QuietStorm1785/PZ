...
public
ServerSettings::ServerSettings(const std::string &_name) {
...
void ServerSettings::addSpawnRegion(const std::string &_name,
...
bool ServerSettings::saveSpawnPointsFile(const std::string &file,
