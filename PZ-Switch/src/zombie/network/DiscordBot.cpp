...
public
DiscordBot::DiscordBot(const std::string &string, DiscordSender discordSender) {
 // TODO: Implement DiscordBot
 return nullptr;
}

void DiscordBot::connect(bool boolean0, const std::string &string0,
 const std::string &string1,
 const std::string &string2) {
 // TODO: Implement connect
}

void DiscordBot::setChannel(const std::string &string0,
 const std::string &string1) {
 // TODO: Implement setChannel
}

void DiscordBot::sendMessage(const std::string &string1,
...
std::string DiscordBot::replaceChannelIDByItsName(DiscordAPI discordAPI,
 Message message) {
