...
void NetChecksum::addFile(const std::string &string1,
...
void NetChecksum::sendFileMismatch(UdpConnection udpConnection, short short0,
 const std::string &string, uint8_t byte0) {
 // TODO: Implement sendFileMismatch
}

void NetChecksum::sendError(UdpConnection udpConnection,
 const std::string &string) {
 // TODO: Implement sendError
}

void NetChecksum::serverPacket(ByteBuffer byteBuffer,
...
void NetChecksum::addFile(const std::string &string0,
