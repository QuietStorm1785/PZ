...
public
VehicleHitPacket::VehicleHitPacket(HitCharacterPacket.HitType hitType) {
 // TODO: Implement VehicleHitPacket
 return nullptr;
}

void VehicleHitPacket::set(IsoPlayer player, BaseVehicle vehiclex,
 bool boolean0) {
 // TODO: Implement set
}

void VehicleHitPacket::parse(ByteBuffer byteBuffer,
