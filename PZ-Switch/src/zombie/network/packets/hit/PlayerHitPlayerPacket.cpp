...
void PlayerHitPlayerPacket::set(IsoPlayer player0, IsoPlayer player1,
 HandWeapon weapon, float float0, bool boolean1,
 float float1, bool boolean0, bool boolean2) {
 // TODO: Implement set
}

void PlayerHitPlayerPacket::parse(ByteBuffer byteBuffer,
