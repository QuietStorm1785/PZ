...
void VehicleHit::set(bool boolean0, float float0, float float1, float float2,
 float float3, int int0, float float4, bool boolean1,
 bool boolean2) {
 // TODO: Implement set
}
...
void VehicleHit::process(IsoGameCharacter character0,
 IsoGameCharacter character1, BaseVehicle vehicle) {
