...
int TextureCombiner::getResultingHeight(
 ArrayList<TextureCombinerCommand> arrayList) {
 // TODO: Implement getResultingHeight
 return 0;
}

int TextureCombiner::getResultingWidth(
 ArrayList<TextureCombinerCommand> arrayList) {
 // TODO: Implement getResultingWidth
 return 0;
}

TextureCombinerCommand TextureCombiner::findDominantCommand(
 ArrayList<TextureCombinerCommand> arrayList,
