...
void AdvancedAnimator::onActionGroupsRefreshTriggered(
...
void AdvancedAnimator::updateSpeedScale(const std::string &variable,
 float newSpeed) {
...
public
AdvancedAnimator::SubLayerSlot(AnimLayer animLayerx, IAnimatable iAnimatable,
