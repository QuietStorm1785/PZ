...
void ModelManager::loadAdditionalModel(const std::string &meshName,
 const std::string &tex, bool bStatic,
 const std::string &shaderName) {
 // TODO: Implement loadAdditionalModel
}

ModelInstance ModelManager::newAdditionalModelInstance(
 const std::string &meshName, const std::string &tex, IsoGameCharacter chr,
 AnimationPlayer animPlayer, const std::string &shaderName) {
 // TODO: Implement newAdditionalModelInstance
 return nullptr;
}

void ModelManager::loadAnimsFromDir(const std::string &string,
 ModelMesh modelMesh) {
 // TODO: Implement loadAnimsFromDir
}

void ModelManager::loadAnimsFromDir(URI uri0, URI uri1, File file0,
 ModelMesh modelMesh,
 ModelManager.ModAnimations modAnimations) {
 // TODO: Implement loadAnimsFromDir
}

void ModelManager::RenderSkyBox(TextureDraw texd, int shaderID, int userId,
 int apiId, int bufferId) {
 // TODO: Implement RenderSkyBox
}

void ModelManager::RenderWater(TextureDraw texd, int shaderID, int userId,
 bool bShore) {
...
void ModelManager::DoCharacterModelEquipped(IsoGameCharacter character,
 ModelManager.ModelSlot modelSlot) {
 // TODO: Implement DoCharacterModelEquipped
}

void ModelManager::addWeaponPartModels(ModelManager.ModelSlot modelSlot,
 HandWeapon weapon,
 ModelInstance modelInstance1) {
 // TODO: Implement addWeaponPartModels
}

void ModelManager::resetModelInstance(ModelInstance modelInstance,
 void *expectedOwner) {
 // TODO: Implement resetModelInstance
}

void ModelManager::resetModelInstanceRecurse(ModelInstance modelInstance,
 void *expectedOwner) {
 // TODO: Implement resetModelInstanceRecurse
}

void ModelManager::resetModelInstancesRecurse(
 ArrayList<ModelInstance> modelInstances, void *expectedOwner) {
...
void ModelManager::derefModelInstances(
 ArrayList<ModelInstance> modelInstances) {
 // TODO: Implement derefModelInstances
}

void ModelManager::DoCharacterModelParts(IsoGameCharacter character,
 ModelManager.ModelSlot modelSlot) {
...
void ModelManager::getClosestThreeLights(IsoMovingObject movingObject,
...
ModelInstance ModelManager::addStatic(ModelManager.ModelSlot slot,
...
ModelInstance ModelManager::newStaticInstance(ModelManager.ModelSlot slot,
 const std::string &meshName,
 const std::string &texName,
 const std::string &boneName,
 const std::string &shaderName) {
...
ModelInstance ModelManager::addStatic(ModelManager.ModelSlot modelSlot,
...
ModelInstance ModelManager::addStaticForcedTex(ModelManager.ModelSlot modelSlot,
 const std::string &string1,
...
ModelInstance ModelManager::addStatic(ModelInstance parentInst,
...
ModelInstance ModelManager::addStaticForcedTex(
 ModelInstance parentInst, const std::string &modelName,
 const std::string &attachNameSelf, const std::string &attachNameParent,
...
Model ModelManager::loadModelInternal(const std::string &string1,
 const std::string &string2,
 const std::string &string0,
 ModelMesh modelMesh, bool boolean0) {
...
void ModelManager::setModelMetaData(const std::string &meshName,
 const std::string &texName,
 const std::string &shaderName,
 bool bStatic) {
...
void ModelManager::setModelMetaData(const std::string &modelId,
 const std::string &meshName,
 const std::string &texName,
 const std::string &shaderName,
 bool bStatic) {
...
Model ModelManager::loadStaticModel(const std::string &meshName,
...
Model ModelManager::loadModel(const std::string &string0,
 const std::string &string1, ModelMesh modelMesh) {
...
Model ModelManager::getLoadedModel(const std::string &meshName,
 const std::string &tex, bool isStatic,
 const std::string &shaderName) {
 // TODO: Implement getLoadedModel
 return nullptr;
}

Model ModelManager::tryGetLoadedModel(const std::string &meshName,
 const std::string &tex, bool isStatic,
 const std::string &shaderName,
 bool logError) {
...
void ModelManager::putLoadedModel(const std::string &name,
 const std::string &tex, bool isStatic,
 const std::string &shaderName, Model model) {
 // TODO: Implement putLoadedModel
}

std::string ModelManager::createModelKey(const std::string &string0,
 const std::string &string2,
 bool boolean0,
 const std::string &string1) {
...
std::string ModelManager::createModelKey2(const std::string &string0,
...
AnimationAsset
ModelManager::loadAnim(const std::string &string, ModelMesh modelMesh,
 ModelManager.ModAnimations modAnimations) {
 // TODO: Implement loadAnim
 return {};
}

void ModelManager::putAnimationAsset(const std::string &string1,
...
AnimationAsset
ModelManager::getAnimationAssetRequired(const std::string &string) {
 // TODO: Implement getAnimationAssetRequired
 return {};
}

void ModelManager::addAnimationClip(const std::string &name,
 AnimationClip clip) {
...
ModelInstance ModelManager::newInstance(Model model, IsoGameCharacter chr,
...
void ModelManager::loadHumanAnimations(
 ChooseGameInfo.Mod mod, ModelManager.ModAnimations modAnimations) {
...
public
ModelManager::AnimDirReloader(URI uri0, URI uri1, const std::string &string,
 ModelMesh modelMesh,
 ModelManager.ModAnimations modAnimations) {
...
public
ModelManager::ModAnimations(const std::string &modID) {
...
public
ModelManager::ModelSlot(int _ID, ModelInstance _model,
