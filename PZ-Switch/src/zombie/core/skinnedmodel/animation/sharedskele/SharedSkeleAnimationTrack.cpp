...
void SharedSkeleAnimationTrack::getBoneMatrix(int boneIdx,
 Matrix4f out_matrix) {
...
void SharedSkeleAnimationTrack::sampleAtTime_NonLooped(Matrix4f matrix4f,
 int int3, float float0) {
 // TODO: Implement sampleAtTime_NonLooped
}

void SharedSkeleAnimationTrack::sampleAtTime_Looped(Matrix4f matrix4f, int int3,
 float float0) {
 // TODO: Implement sampleAtTime_Looped
}

void SharedSkeleAnimationTrack::sampleBoneData(int int2, int int1, int int3,
