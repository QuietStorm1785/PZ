...
GameServerDetails ServerBrowser::GetServerDetails(const std::string &string,
 int int0) {
 // TODO: Implement GetServerDetails
 return nullptr;
}
...
GameServerDetails ServerBrowser::GetServerDetailsSync(const std::string &string,
 int int0) {
...
void ServerBrowser::setCallbackInterface(
 IServerBrowserCallback iServerBrowserCallback) {
...
void ServerBrowser::onServerRespondedCallback(const std::string &string,
 int int0) {
 // TODO: Implement onServerRespondedCallback
}

void ServerBrowser::onServerFailedToRespondCallback(const std::string &string,
 int int0) {
 // TODO: Implement onServerFailedToRespondCallback
}

void ServerBrowser::onRulesRefreshComplete(const std::string &string, int int0,
 String[] strings) {
