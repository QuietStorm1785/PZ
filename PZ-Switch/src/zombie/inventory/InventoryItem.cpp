...
public
InventoryItem::InventoryItem(const std::string &_module,
...
void InventoryItem::setEvolvedRecipeName(
 const std::string &_evolvedRecipeName) {
...
void InventoryItem::setRequireInHandOrInventory(
 ArrayList<String> _requireInHandOrInventory) {
...
void InventoryItem::setBloodClothingType(
...
void InventoryItem::setAttachmentsProvided(
 ArrayList<String> _attachmentsProvided) {
...
void InventoryItem::setAttachmentReplacement(
 const std::string &attachementReplacement) {
