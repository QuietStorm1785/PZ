...
public
Clothing::Clothing(const std::string &module, const std::string &name,
 const std::string &itemType, const std::string &texName,
 const std::string &_palette,
...
int Clothing::getBiteDefenseFromItem(IsoGameCharacter chr,
 InventoryItem fabric) {
 // TODO: Implement getBiteDefenseFromItem
 return 0;
}

int Clothing::getScratchDefenseFromItem(IsoGameCharacter chr,
 InventoryItem fabric) {
...
bool Clothing::canFullyRestore(IsoGameCharacter chr, BloodBodyPartType part,
 InventoryItem fabric) {
 // TODO: Implement canFullyRestore
 return false;
}

void Clothing::addPatch(IsoGameCharacter chr, BloodBodyPartType part,
 InventoryItem fabric) {
...
public
Clothing::ClothingPatch(int int0, int int1, bool boolean0) {
 // TODO: Implement ClothingPatch
 return nullptr;
}
...
private
Clothing::ClothingPatchFabricType(int int1, const std::string &string1,
 int int2, int int3) {
