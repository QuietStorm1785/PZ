...
public
KahluaThread::KahluaThread(Platform arg0, KahluaTable arg1) {
 // TODO: Implement KahluaThread
 return nullptr;
}

public
KahluaThread::KahluaThread(PrintStream arg0, Platform arg1, KahluaTable arg2) {
 // TODO: Implement KahluaThread
 return nullptr;
}
...
int KahluaThread::callJava(JavaFunction javaFunction, int int0, int int1,
 int int2) {
...
void KahluaThread::DoProfileTiming(const std::string &string, long long1,
 long long0) {
...
void *KahluaThread::getCompMetaOp(void *object0, void *object1,
 const std::string &string) {
 // TODO: Implement getCompMetaOp
 return nullptr;
}

void *KahluaThread::getBinMetaOp(void *object1, void *object2,
 const std::string &string) {
 // TODO: Implement getBinMetaOp
 return nullptr;
}

void *KahluaThread::getRegisterOrConstant(LuaCallFrame luaCallFrame, int int1,
 Prototype prototype) {
...
public
KahluaThread::ProfileEntryComparitor() {
 // TODO: Implement ProfileEntryComparitor
 return nullptr;
}

int KahluaThread::compare(KahluaThread.Entry entry0,
 KahluaThread.Entry entry1) {
