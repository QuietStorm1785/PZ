...
public:
 ...
 static bool isAncillary(int int0) { return (int0 & 536870912) != 0; }

 static bool isPrivate(int int0) { return (int0 & 2097152) != 0; }

 static bool isReserved(int int0) { return (int0 & 8192) != 0; }

 static bool isSafeToCopy(int int0) { return (int0 & 32) != 0; }

 static std::string getChunkName(int int0) {
 return "" + (char)(int0 >>> 24 & 0xFF) + (char)(int0 >>> 16 & 0xFF) +
