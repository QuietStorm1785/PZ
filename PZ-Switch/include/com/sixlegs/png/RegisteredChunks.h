...
public:
 ...
 if (int4 != 0) {
 throw PngException("Unrecognized compression method: " + int4,
 true);
 } else {
 ...
 return;
 default:
 throw PngException("Unrecognized interlace method: " + int6,
 true);
 }
 }
 }
 ...
 throw PngException("PLTE chunk length indivisible by 3: " + int0,
 true);
 } else {
 int int1 = int0 / 3;
 if (int1 > 256) {
 ...
 3;
 if (int0 > int1) {
 throw PngException("Too many transparency palette entries (" +
 int0 + " > " + int1 + ")",
 true);
 }
 ...
 throw PngException("tIME " + string + " value " + int0 +
 ...
 boolean1 = false;
 if (byte1 != 0) {
 throw PngException("Unrecognized " +
 PngConstants.getChunkName(int1) +
 " compression method: " + byte1,
 false);
 }
 } else if (byte0 != 0) {
 throw PngException("Illegal " +
 PngConstants.getChunkName(int1) +
 ...
 throw PngException("sCAL measurements must be >= 0",
 false);
 }
 }
 }
 ...
 throw PngException("Error reading compressed data",
