...
public
 ...
 System.arraycopy(this->lacing_vals, int0, this->lacing_vals, 0,
 this->lacing_fill * 4);
 System.arraycopy(this->granule_vals, int0, this->granule_vals, 0,
 this->lacing_fill * 8);
 ...
 if (this->body_fill != 0) {
 System.arraycopy(this->body_data, this->body_returned, this->body_data, 0,
 this->body_fill);
 }
 ...
 System.arraycopy(packet.packet_base, packet.packet, this->body_data,
 ...
 this->granulepos = this->granule_vals[this->lacing_fill + int1] =
 packet.granulepos;
 this->lacing_vals[this->lacing_fill] =
 ...
 if (this->body_fill != 0) {
 System.arraycopy(this->body_data, int12, this->body_data, 0,
 this->body_fill);
 }
 ...
 System.arraycopy(this->lacing_vals, int11, this->lacing_vals, 0,
 this->lacing_fill - int11);
 System.arraycopy(this->granule_vals, int11, this->granule_vals, 0,
 this->lacing_fill - int11);
 }
 ...
 if (int9 != this->pageno) {
 for (int int13 = this->lacing_packet; int13 < this->lacing_fill;
 int13++) {
 ...
 this->lacing_vals[this->lacing_fill - 1] =
 ...
 System.arraycopy(this->granule_vals, 0, longs, 0,
 this->granule_vals.length);
