...
public:
 ...
 long offset;
 long[] offsets;
 StreamState os = std::make_unique<StreamState>();
 SyncState oy = std::make_unique<SyncState>();
 long pcm_offset;
 long[] pcmlengths;
 float samptrack;
 bool seekable = false;
 int[] serialnos;
 Comment[] vc;
 DspState vd = std::make_unique<DspState>();
...
public
 ...
 int int0 = this->open(seekableInputStream, nullptr, 0);
 if (int0 == -1) {
 throw JOrbisException("VorbisFile: open return -1");
 }
 } catch (Exception exception) {
 throw JOrbisException("VorbisFile: " + exception.toString());
 } finally {
 if (seekableInputStream != nullptr) {
 try {
...
public
 VorbisFile(InputStream inputStream, byte[] bytes, int int1) {
 ...
 VorbisFile.SeekableInputStream seekableInputStream) {
 try {
 if (int0 == 0) {
 ...
 (float)((this->offsets[int0 + 1] - this->dataoffsets[int0]) * 8L) /
 this->time_total(int0);
 } else if (this->vi[int0].bitrate_nominal > 0) {
 return this->vi[int0].bitrate_nominal;
 } else if (this->vi[int0].bitrate_upper > 0) {
 return this->vi[int0].bitrate_lower > 0 ? (this->vi[int0].bitrate_upper +
 this->vi[int0].bitrate_lower) /
 2
 : this->vi[int0].bitrate_upper;
 } else {
 return -1;
 }
 } else {
 ...
 int int1 =
 (int)(this->bittrack / this->samptrack * this->vi[int0].rate + 0.5);
 this->bittrack = 0.0F;
 this->samptrack = 0.0F;
 return int1;
 }
 ...
 void close() { this->datasource.close(); }

public
 Comment[] getComment() { return this->vc; }

 Comment getComment(int int0) {
 if (this->seekable) {
 if (int0 < 0) {
 return this->decode_ready ? this->vc[this->current_link] : nullptr;
 } else {
 return int0 >= this->links ? nullptr : this->vc[int0];
 }
 } else {
...
public
 Info[] getInfo() { return this->vi; }

 Info getInfo(int int0) {
 if (this->seekable) {
 if (int0 < 0) {
 return this->decode_ready ? this->vi[this->current_link] : nullptr;
 } else {
 return int0 >= this->links ? nullptr : this->vi[int0];
 }
 } else {
 ...
 long pcm_tell() { return this->pcm_offset; }

 long pcm_total(int int0) {
 ...
 long raw_tell() { return this->offset; }

 long raw_total(int int0) {
 if (!this->seekable || int0 >= this->links) {
 return -1L;
 } else if (int0 >= 0) {
 ...
 bool seekable() { return this->seekable; }

 int serialnumber(int int0) {
 if (int0 >= this->links) {
 return -1;
 } else if (!this->seekable && int0 >= 0) {
 ...
 int bisect_forward_serialno(long long5, long long3, long long1, int int1,
 int int3) {
 long long0 = long1;
 long long2 = long1;
 Page page = new Page();
 ...
 int2 = this->bisect_forward_serialno(long2, this->offset, long1,
 page.serialno(), int3 + 1);
 if (int2 == -128) {
 return -128;
 }
 } else {
 ...
 int host_is_big_endian() { return 1; }

 int open(InputStream inputStream, byte[] bytes, int int0) {
 return this->open_callbacks(inputStream, bytes, int0);
 }

 int open_callbacks(InputStream inputStream, byte[] bytes, int int1) {
 ...
 int[] ints = new int[1];
 if (this->fetch_headers(this->vi[0], this->vc[0], ints, nullptr) == -1) {
 return -1;
 } else {
 ...
 Page page = new Page();
 int[] ints = new int[1];
 int int0 = this->fetch_headers(info, comment, ints, nullptr);
 int int1 = ints[0];
 ...
 } else if (this->bisect_forward_serialno(0L, long0, long0 + 1L, int1, 0) <
 0) {
 this->clear();
 return -128;
 }
 ...
 void prefetch_all_headers(Info info, Comment comment, int int1) {
 Page page = new Page();
 this->vi = new Info[this->links];
 this->vc = new Comment[this->links];
 ...
 label38:
 for (int int0 = 0; int0 < this->links; int0++) {
 if (info != nullptr && comment != nullptr && int0 == 0) {
 this->vi[int0] = info;
 this->vc[int0] = comment;
 this->dataoffsets[int0] = int1;
 } else {
 this->seek_helper(this->offsets[int0]);
 this->vi[int0] = std::make_unique<Info>();
 this->vc[int0] = std::make_unique<Comment>();
 if (this->fetch_headers(this->vi[int0], this->vc[int0], nullptr,
 nullptr) == -1) {
 ...
 int int1 = this->vd.synthesis_pcmout(nullptr, nullptr);
 this->vd.synthesis_blockin(this->vb);
 this->samptrack =
 this->samptrack +
 (this->vd.synthesis_pcmout(nullptr, nullptr) - int1);
 this->bittrack = this->bittrack + packet.bytes * 8;
 if (long0 != -1L && packet.e_o_s == 0) {
 int1 = this->seekable ? this->current_link : 0;
 int int2 = this->vd.synthesis_pcmout(nullptr, nullptr);
 long0 -= int2;
 ...
 while (int6 < this->links &&
 this->serialnos[int6] != this->current_serialno) {
 int6++;
 }
 ...
 int int11 =
 (int)(floats1[int10][ints0[int10] + int9] * 128.0 + 0.5);
 if (int11 > 127) {
 int11 = 127;
 } else if (int11 < -128) {
 int11 = -128;
 ...
 int int18 =
 (int)(floats1[int14][int15 + int17] * 32768.0 + 0.5);
 if (int18 > 32767) {
 int18 = 32767;
 } else if (int18 < -32768) {
 int18 = -32768;
 ...
 long long1 =
 (long)((float)long0 + (float1 - float0) * this->vi[int0].rate);
 ...
 int get_next_page(Page page, long long0) {
 if (long0 > 0L) {
 long0 += this->offset;
 }
 ...
 void close() { this->raf.close(); }

 long getLength() { return this->raf.length(); }
 ...
 int read() { return this->raf.read(); }

 int read(byte[] bytes) { return this->raf.read(bytes); }
 ...
 void seek(long long0) { this->raf.seek(long0); }

 long skip(long long0) { return this->raf.skipBytes((int)long0); }

 long tell() { return this->raf.getFilePointer(); }
 }
}
} // namespace jorbis
} // namespace jcraft
