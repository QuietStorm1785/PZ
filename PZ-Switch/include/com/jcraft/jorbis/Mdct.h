...
public:
 ...
 void backward(float[] floats2, float[] floats4) {
 ...
 int5 -= 2;
 floats0[int4++] = -floats2[int3 + 2] * this->trig[int5 + 1] -
 floats2[int3] * this->trig[int5];
 floats0[int4++] = floats2[int3] * this->trig[int5 + 1] -
 floats2[int3 + 2] * this->trig[int5];
 int3 += 4;
 }
 ...
 floats0[int4++] = floats2[int3] * this->trig[int5 + 1] +
 floats2[int3 + 2] * this->trig[int5];
 floats0[int4++] = floats2[int3] * this->trig[int5] -
 floats2[int3 + 2] * this->trig[int5 + 1];
 int3 -= 4;
 }

 float[] floats3 =
 this->mdct_kernel(floats0, floats1, this->n, int0, int1, int2);
 uint8_t byte0 = 0;
 int5 = int0;
 int int8 = int1;
 int int9 = int1 - 1;
 ...
 float float0 = floats3[byte0] * this->trig[int5 + 1] -
 floats3[byte0 + 1] * this->trig[int5];
 float float1 = -(floats3[byte0] * this->trig[int5] +
 floats3[byte0 + 1] * this->trig[int5 + 1]);
 floats4[int8] = -float0;
 floats4[int9] = float0;
 ...
 this->trig[byte0 + int5 * 2] =
 (float)Math.cos(Math.PI / int0 * (4 * int5);
 this->trig[byte1 + int5 * 2] =
 (float)(-Math.sin(Math.PI / int0 * (4 * int5));
 this->trig[int1 + int5 * 2] =
 (float)Math.cos(Math.PI / (2 * int0) * (2 * int5 + 1);
 this->trig[int2 + int5 * 2] =
 (float)Math.sin(Math.PI / (2 * int0) * (2 * int5 + 1);
 }

 for (int int6 = 0; int6 < int0 / 8; int6++) {
 this->trig[int3 + int6 * 2] =
 (float)Math.cos(Math.PI / int0 * (4 * int6 + 2);
 this->trig[int4 + int6 * 2] =
 (float)(-Math.sin(Math.PI / int0 * (4 * int6 + 2));
 }
...
private
 float[] mdct_kernel(float[] floats0, float[] floats1, int int9, int int5,
 int int1, int int20) {
 int int0 = int1;
 int int2 = 0;
 int int3 = int1;
