...
public
 Point4f(float float0, float float1, float float2, float float3) {
 super(float0, float1, float2, float3);
 }

public
 Point4f(float[] floats) { super(floats); }

public
 Point4f(Point4f point4f1) { super(point4f1); }

public
 Point4f(Point4d point4d) { super(point4d); }

public
 Point4f(Tuple4f tuple4f) { super(tuple4f); }

public
 Point4f(Tuple4d tuple4d) { super(tuple4d); }

public
 Point4f(Tuple3f tuple3f) { super(tuple3f.x, tuple3f.y, tuple3f.z, 1.0F); }
...
public
 ...
 float2 * float2 + float3 * float3);
 }

 float distanceL1(Point4f point4f0) {
 return Math.abs(this->x - point4f0.x) + Math.abs(this->y - point4f0.y) +
 Math.abs(this->z - point4f0.z) + Math.abs(this->w - point4f0.w);
 }

 float distanceLinf(Point4f point4f0) {
 float float0 =
 Math.max(Math.abs(this->x - point4f0.x), Math.abs(this->y - point4f0.y);
 float float1 =
 Math.max(Math.abs(this->z - point4f0.z), Math.abs(this->w - point4f0.w);
