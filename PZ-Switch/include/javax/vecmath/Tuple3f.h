...
public
 Tuple3f(float float0, float float1, float float2) {
 this->x = float0;
 this->y = float1;
 this->z = float2;
 }
...
public
 ...
 try {
 return this->x == tuple3f0.x && this->y == tuple3f0.y &&
 this->z == tuple3f0.z;
