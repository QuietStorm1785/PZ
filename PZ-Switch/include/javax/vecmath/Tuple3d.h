...
public
 Tuple3d(double double0, double double1, double double2) {
 this->x = double0;
 this->y = double1;
 this->z = double2;
 }
...
public
 ...
 try {
 return this->x == tuple3d0.x && this->y == tuple3d0.y &&
 this->z == tuple3d0.z;
