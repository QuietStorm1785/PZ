...
public
 Matrix3d(double double0, double double1, double double2, double double3,
...
public
 ...
 VecMathI18N.getString("Matrix3d0"));
 }
 case 1:
 switch (int1) {
 case 0:
 ...
 default:
 throw ArrayIndexOutOfBoundsException(
 VecMathI18N.getString("Matrix3d1"));
 }
 case 1:
 switch (int1) {
 case 0:
 ...
 void getRow(int int0, Vector3d vector3d) {
 if (int0 == 0) {
 vector3d.x = this->m00;
 vector3d.y = this->m01;
 vector3d.z = this->m02;
 ...
 if (int0 != 2) {
 throw ArrayIndexOutOfBoundsException(
 VecMathI18N.getString("Matrix3d2"));
 }
 ...
 void getColumn(int int0, Vector3d vector3d) {
 if (int0 == 0) {
 vector3d.x = this->m00;
 vector3d.y = this->m10;
 vector3d.z = this->m20;
 ...
 if (int0 != 2) {
 throw ArrayIndexOutOfBoundsException(
 VecMathI18N.getString("Matrix3d4"));
 }
 ...
 default:
 throw ArrayIndexOutOfBoundsException(
 VecMathI18N.getString("Matrix3d6"));
 }
 }

 void setRow(int int0, Vector3d vector3d) {
 switch (int0) {
 case 0:
 this->m00 = vector3d.x;
 this->m01 = vector3d.y;
 ...
 default:
 throw ArrayIndexOutOfBoundsException(
 VecMathI18N.getString("Matrix3d9"));
 }
 }

 void setColumn(int int0, Vector3d vector3d) {
 switch (int0) {
 case 0:
 this->m00 = vector3d.x;
 this->m10 = vector3d.y;
 ...
 void add(double double0, Matrix3d matrix3d0) {
 ...
 void add(Matrix3d matrix3d1, Matrix3d matrix3d0) {
 ...
 void sub(Matrix3d matrix3d1, Matrix3d matrix3d0) {
 this->m00 = matrix3d1.m00 - matrix3d0.m00;
 this->m01 = matrix3d1.m01 - matrix3d0.m01;
 this->m02 = matrix3d1.m02 - matrix3d0.m02;
 this->m10 = matrix3d1.m10 - matrix3d0.m10;
 ...
 void transpose(Matrix3d matrix3d1) {
 if (this != matrix3d1) {
 this->m00 = matrix3d1.m00;
 ...
 void invert(Matrix3d matrix3d1) { this->invertGeneral(matrix3d1); }

 void invert() { this->invertGeneral(this); }

 void invertGeneral(Matrix3d matrix3d0) {
 double[] doubles0 = new double[9];
 int[] ints = new int[3];
 double[] doubles1 =
 new double[]{matrix3d0.m00, matrix3d0.m01, matrix3d0.m02,
 matrix3d0.m10, matrix3d0.m11, matrix3d0.m12,
 matrix3d0.m20, matrix3d0.m21, matrix3d0.m22};
 ...
 void mul(double double0, Matrix3d matrix3d0) {
 ...
 void mul(Matrix3d matrix3d0) {
 double double0 = this->m00 * matrix3d0.m00 + this->m01 * matrix3d0.m10 +
 this->m02 * matrix3d0.m20;
 double double1 = this->m00 * matrix3d0.m01 + this->m01 * matrix3d0.m11 +
 this->m02 * matrix3d0.m21;
 double double2 = this->m00 * matrix3d0.m02 + this->m01 * matrix3d0.m12 +
 this->m02 * matrix3d0.m22;
 double double3 = this->m10 * matrix3d0.m00 + this->m11 * matrix3d0.m10 +
 this->m12 * matrix3d0.m20;
 double double4 = this->m10 * matrix3d0.m01 + this->m11 * matrix3d0.m11 +
 this->m12 * matrix3d0.m21;
 double double5 = this->m10 * matrix3d0.m02 + this->m11 * matrix3d0.m12 +
 this->m12 * matrix3d0.m22;
 double double6 = this->m20 * matrix3d0.m00 + this->m21 * matrix3d0.m10 +
 this->m22 * matrix3d0.m20;
 double double7 = this->m20 * matrix3d0.m01 + this->m21 * matrix3d0.m11 +
 this->m22 * matrix3d0.m21;
 double double8 = this->m20 * matrix3d0.m02 + this->m21 * matrix3d0.m12 +
 this->m22 * matrix3d0.m22;
 this->m00 = double0;
 this->m01 = double1;
 this->m02 = double2;
 ...
 void mul(Matrix3d matrix3d2, Matrix3d matrix3d1) {
 if (this != matrix3d2 && this != matrix3d1) {
 this->m00 = matrix3d2.m00 * matrix3d1.m00 + matrix3d2.m01 * matrix3d1.m10 +
 matrix3d2.m02 * matrix3d1.m20;
 this->m01 = matrix3d2.m00 * matrix3d1.m01 + matrix3d2.m01 * matrix3d1.m11 +
 matrix3d2.m02 * matrix3d1.m21;
 this->m02 = matrix3d2.m00 * matrix3d1.m02 + matrix3d2.m01 * matrix3d1.m12 +
 matrix3d2.m02 * matrix3d1.m22;
 this->m10 = matrix3d2.m10 * matrix3d1.m00 + matrix3d2.m11 * matrix3d1.m10 +
 matrix3d2.m12 * matrix3d1.m20;
 this->m11 = matrix3d2.m10 * matrix3d1.m01 + matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m12 * matrix3d1.m21;
 this->m12 = matrix3d2.m10 * matrix3d1.m02 + matrix3d2.m11 * matrix3d1.m12 +
 matrix3d2.m12 * matrix3d1.m22;
 this->m20 = matrix3d2.m20 * matrix3d1.m00 + matrix3d2.m21 * matrix3d1.m10 +
 matrix3d2.m22 * matrix3d1.m20;
 this->m21 = matrix3d2.m20 * matrix3d1.m01 + matrix3d2.m21 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m21;
 this->m22 = matrix3d2.m20 * matrix3d1.m02 + matrix3d2.m21 * matrix3d1.m12 +
 matrix3d2.m22 * matrix3d1.m22;
 } else {
 double double0 = matrix3d2.m00 * matrix3d1.m00 +
 matrix3d2.m01 * matrix3d1.m10 +
 matrix3d2.m02 * matrix3d1.m20;
 double double1 = matrix3d2.m00 * matrix3d1.m01 +
 matrix3d2.m01 * matrix3d1.m11 +
 matrix3d2.m02 * matrix3d1.m21;
 double double2 = matrix3d2.m00 * matrix3d1.m02 +
 matrix3d2.m01 * matrix3d1.m12 +
 matrix3d2.m02 * matrix3d1.m22;
 double double3 = matrix3d2.m10 * matrix3d1.m00 +
 matrix3d2.m11 * matrix3d1.m10 +
 matrix3d2.m12 * matrix3d1.m20;
 double double4 = matrix3d2.m10 * matrix3d1.m01 +
 matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m12 * matrix3d1.m21;
 double double5 = matrix3d2.m10 * matrix3d1.m02 +
 matrix3d2.m11 * matrix3d1.m12 +
 matrix3d2.m12 * matrix3d1.m22;
 double double6 = matrix3d2.m20 * matrix3d1.m00 +
 matrix3d2.m21 * matrix3d1.m10 +
 matrix3d2.m22 * matrix3d1.m20;
 double double7 = matrix3d2.m20 * matrix3d1.m01 +
 matrix3d2.m21 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m21;
 double double8 = matrix3d2.m20 * matrix3d1.m02 +
 matrix3d2.m21 * matrix3d1.m12 +
 matrix3d2.m22 * matrix3d1.m22;
 this->m00 = double0;
 this->m01 = double1;
 this->m02 = double2;
 ...
 void mulNormalize(Matrix3d matrix3d0) {
 double[] doubles0 = new double[9];
 double[] doubles1 = new double[9];
 double[] doubles2 = new double[3];
 doubles0[0] = this->m00 * matrix3d0.m00 + this->m01 * matrix3d0.m10 +
 this->m02 * matrix3d0.m20;
 doubles0[1] = this->m00 * matrix3d0.m01 + this->m01 * matrix3d0.m11 +
 this->m02 * matrix3d0.m21;
 doubles0[2] = this->m00 * matrix3d0.m02 + this->m01 * matrix3d0.m12 +
 this->m02 * matrix3d0.m22;
 doubles0[3] = this->m10 * matrix3d0.m00 + this->m11 * matrix3d0.m10 +
 this->m12 * matrix3d0.m20;
 doubles0[4] = this->m10 * matrix3d0.m01 + this->m11 * matrix3d0.m11 +
 this->m12 * matrix3d0.m21;
 doubles0[5] = this->m10 * matrix3d0.m02 + this->m11 * matrix3d0.m12 +
 this->m12 * matrix3d0.m22;
 doubles0[6] = this->m20 * matrix3d0.m00 + this->m21 * matrix3d0.m10 +
 this->m22 * matrix3d0.m20;
 doubles0[7] = this->m20 * matrix3d0.m01 + this->m21 * matrix3d0.m11 +
 this->m22 * matrix3d0.m21;
 doubles0[8] = this->m20 * matrix3d0.m02 + this->m21 * matrix3d0.m12 +
 this->m22 * matrix3d0.m22;
 ...
 void mulNormalize(Matrix3d matrix3d1, Matrix3d matrix3d0) {
 double[] doubles0 = new double[9];
 double[] doubles1 = new double[9];
 double[] doubles2 = new double[3];
 doubles0[0] = matrix3d1.m00 * matrix3d0.m00 +
 matrix3d1.m01 * matrix3d0.m10 + matrix3d1.m02 * matrix3d0.m20;
 doubles0[1] = matrix3d1.m00 * matrix3d0.m01 +
 matrix3d1.m01 * matrix3d0.m11 + matrix3d1.m02 * matrix3d0.m21;
 doubles0[2] = matrix3d1.m00 * matrix3d0.m02 +
 matrix3d1.m01 * matrix3d0.m12 + matrix3d1.m02 * matrix3d0.m22;
 doubles0[3] = matrix3d1.m10 * matrix3d0.m00 +
 matrix3d1.m11 * matrix3d0.m10 + matrix3d1.m12 * matrix3d0.m20;
 doubles0[4] = matrix3d1.m10 * matrix3d0.m01 +
 matrix3d1.m11 * matrix3d0.m11 + matrix3d1.m12 * matrix3d0.m21;
 doubles0[5] = matrix3d1.m10 * matrix3d0.m02 +
 matrix3d1.m11 * matrix3d0.m12 + matrix3d1.m12 * matrix3d0.m22;
 doubles0[6] = matrix3d1.m20 * matrix3d0.m00 +
 matrix3d1.m21 * matrix3d0.m10 + matrix3d1.m22 * matrix3d0.m20;
 doubles0[7] = matrix3d1.m20 * matrix3d0.m01 +
 matrix3d1.m21 * matrix3d0.m11 + matrix3d1.m22 * matrix3d0.m21;
 doubles0[8] = matrix3d1.m20 * matrix3d0.m02 +
 matrix3d1.m21 * matrix3d0.m12 + matrix3d1.m22 * matrix3d0.m22;
 compute_svd(doubles0, doubles2, doubles1);
 this->m00 = doubles1[0];
 this->m01 = doubles1[1];
 this->m02 = doubles1[2];
 ...
 void mulTransposeBoth(Matrix3d matrix3d2, Matrix3d matrix3d1) {
 if (this != matrix3d2 && this != matrix3d1) {
 this->m00 = matrix3d2.m00 * matrix3d1.m00 + matrix3d2.m10 * matrix3d1.m01 +
 matrix3d2.m20 * matrix3d1.m02;
 this->m01 = matrix3d2.m00 * matrix3d1.m10 + matrix3d2.m10 * matrix3d1.m11 +
 matrix3d2.m20 * matrix3d1.m12;
 this->m02 = matrix3d2.m00 * matrix3d1.m20 + matrix3d2.m10 * matrix3d1.m21 +
 matrix3d2.m20 * matrix3d1.m22;
 this->m10 = matrix3d2.m01 * matrix3d1.m00 + matrix3d2.m11 * matrix3d1.m01 +
 matrix3d2.m21 * matrix3d1.m02;
 this->m11 = matrix3d2.m01 * matrix3d1.m10 + matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m21 * matrix3d1.m12;
 this->m12 = matrix3d2.m01 * matrix3d1.m20 + matrix3d2.m11 * matrix3d1.m21 +
 matrix3d2.m21 * matrix3d1.m22;
 this->m20 = matrix3d2.m02 * matrix3d1.m00 + matrix3d2.m12 * matrix3d1.m01 +
 matrix3d2.m22 * matrix3d1.m02;
 this->m21 = matrix3d2.m02 * matrix3d1.m10 + matrix3d2.m12 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m12;
 this->m22 = matrix3d2.m02 * matrix3d1.m20 + matrix3d2.m12 * matrix3d1.m21 +
 matrix3d2.m22 * matrix3d1.m22;
 } else {
 double double0 = matrix3d2.m00 * matrix3d1.m00 +
 matrix3d2.m10 * matrix3d1.m01 +
 matrix3d2.m20 * matrix3d1.m02;
 double double1 = matrix3d2.m00 * matrix3d1.m10 +
 matrix3d2.m10 * matrix3d1.m11 +
 matrix3d2.m20 * matrix3d1.m12;
 double double2 = matrix3d2.m00 * matrix3d1.m20 +
 matrix3d2.m10 * matrix3d1.m21 +
 matrix3d2.m20 * matrix3d1.m22;
 double double3 = matrix3d2.m01 * matrix3d1.m00 +
 matrix3d2.m11 * matrix3d1.m01 +
 matrix3d2.m21 * matrix3d1.m02;
 double double4 = matrix3d2.m01 * matrix3d1.m10 +
 matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m21 * matrix3d1.m12;
 double double5 = matrix3d2.m01 * matrix3d1.m20 +
 matrix3d2.m11 * matrix3d1.m21 +
 matrix3d2.m21 * matrix3d1.m22;
 double double6 = matrix3d2.m02 * matrix3d1.m00 +
 matrix3d2.m12 * matrix3d1.m01 +
 matrix3d2.m22 * matrix3d1.m02;
 double double7 = matrix3d2.m02 * matrix3d1.m10 +
 matrix3d2.m12 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m12;
 double double8 = matrix3d2.m02 * matrix3d1.m20 +
 matrix3d2.m12 * matrix3d1.m21 +
 matrix3d2.m22 * matrix3d1.m22;
 this->m00 = double0;
 this->m01 = double1;
 ...
 void mulTransposeRight(Matrix3d matrix3d2, Matrix3d matrix3d1) {
 if (this != matrix3d2 && this != matrix3d1) {
 this->m00 = matrix3d2.m00 * matrix3d1.m00 + matrix3d2.m01 * matrix3d1.m01 +
 matrix3d2.m02 * matrix3d1.m02;
 this->m01 = matrix3d2.m00 * matrix3d1.m10 + matrix3d2.m01 * matrix3d1.m11 +
 matrix3d2.m02 * matrix3d1.m12;
 this->m02 = matrix3d2.m00 * matrix3d1.m20 + matrix3d2.m01 * matrix3d1.m21 +
 matrix3d2.m02 * matrix3d1.m22;
 this->m10 = matrix3d2.m10 * matrix3d1.m00 + matrix3d2.m11 * matrix3d1.m01 +
 matrix3d2.m12 * matrix3d1.m02;
 this->m11 = matrix3d2.m10 * matrix3d1.m10 + matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m12 * matrix3d1.m12;
 this->m12 = matrix3d2.m10 * matrix3d1.m20 + matrix3d2.m11 * matrix3d1.m21 +
 matrix3d2.m12 * matrix3d1.m22;
 this->m20 = matrix3d2.m20 * matrix3d1.m00 + matrix3d2.m21 * matrix3d1.m01 +
 matrix3d2.m22 * matrix3d1.m02;
 this->m21 = matrix3d2.m20 * matrix3d1.m10 + matrix3d2.m21 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m12;
 this->m22 = matrix3d2.m20 * matrix3d1.m20 + matrix3d2.m21 * matrix3d1.m21 +
 matrix3d2.m22 * matrix3d1.m22;
 } else {
 double double0 = matrix3d2.m00 * matrix3d1.m00 +
 matrix3d2.m01 * matrix3d1.m01 +
 matrix3d2.m02 * matrix3d1.m02;
 double double1 = matrix3d2.m00 * matrix3d1.m10 +
 matrix3d2.m01 * matrix3d1.m11 +
 matrix3d2.m02 * matrix3d1.m12;
 double double2 = matrix3d2.m00 * matrix3d1.m20 +
 matrix3d2.m01 * matrix3d1.m21 +
 matrix3d2.m02 * matrix3d1.m22;
 double double3 = matrix3d2.m10 * matrix3d1.m00 +
 matrix3d2.m11 * matrix3d1.m01 +
 matrix3d2.m12 * matrix3d1.m02;
 double double4 = matrix3d2.m10 * matrix3d1.m10 +
 matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m12 * matrix3d1.m12;
 double double5 = matrix3d2.m10 * matrix3d1.m20 +
 matrix3d2.m11 * matrix3d1.m21 +
 matrix3d2.m12 * matrix3d1.m22;
 double double6 = matrix3d2.m20 * matrix3d1.m00 +
 matrix3d2.m21 * matrix3d1.m01 +
 matrix3d2.m22 * matrix3d1.m02;
 double double7 = matrix3d2.m20 * matrix3d1.m10 +
 matrix3d2.m21 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m12;
 double double8 = matrix3d2.m20 * matrix3d1.m20 +
 matrix3d2.m21 * matrix3d1.m21 +
 matrix3d2.m22 * matrix3d1.m22;
 this->m00 = double0;
 this->m01 = double1;
 this->m02 = double2;
 ...
 void mulTransposeLeft(Matrix3d matrix3d2, Matrix3d matrix3d1) {
 if (this != matrix3d2 && this != matrix3d1) {
 this->m00 = matrix3d2.m00 * matrix3d1.m00 + matrix3d2.m10 * matrix3d1.m10 +
 matrix3d2.m20 * matrix3d1.m20;
 this->m01 = matrix3d2.m00 * matrix3d1.m01 + matrix3d2.m10 * matrix3d1.m11 +
 matrix3d2.m20 * matrix3d1.m21;
 this->m02 = matrix3d2.m00 * matrix3d1.m02 + matrix3d2.m10 * matrix3d1.m12 +
 matrix3d2.m20 * matrix3d1.m22;
 this->m10 = matrix3d2.m01 * matrix3d1.m00 + matrix3d2.m11 * matrix3d1.m10 +
 matrix3d2.m21 * matrix3d1.m20;
 this->m11 = matrix3d2.m01 * matrix3d1.m01 + matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m21 * matrix3d1.m21;
 this->m12 = matrix3d2.m01 * matrix3d1.m02 + matrix3d2.m11 * matrix3d1.m12 +
 matrix3d2.m21 * matrix3d1.m22;
 this->m20 = matrix3d2.m02 * matrix3d1.m00 + matrix3d2.m12 * matrix3d1.m10 +
 matrix3d2.m22 * matrix3d1.m20;
 this->m21 = matrix3d2.m02 * matrix3d1.m01 + matrix3d2.m12 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m21;
 this->m22 = matrix3d2.m02 * matrix3d1.m02 + matrix3d2.m12 * matrix3d1.m12 +
 matrix3d2.m22 * matrix3d1.m22;
 } else {
 double double0 = matrix3d2.m00 * matrix3d1.m00 +
 matrix3d2.m10 * matrix3d1.m10 +
 matrix3d2.m20 * matrix3d1.m20;
 double double1 = matrix3d2.m00 * matrix3d1.m01 +
 matrix3d2.m10 * matrix3d1.m11 +
 matrix3d2.m20 * matrix3d1.m21;
 double double2 = matrix3d2.m00 * matrix3d1.m02 +
 matrix3d2.m10 * matrix3d1.m12 +
 matrix3d2.m20 * matrix3d1.m22;
 double double3 = matrix3d2.m01 * matrix3d1.m00 +
 matrix3d2.m11 * matrix3d1.m10 +
 matrix3d2.m21 * matrix3d1.m20;
 double double4 = matrix3d2.m01 * matrix3d1.m01 +
 matrix3d2.m11 * matrix3d1.m11 +
 matrix3d2.m21 * matrix3d1.m21;
 double double5 = matrix3d2.m01 * matrix3d1.m02 +
 matrix3d2.m11 * matrix3d1.m12 +
 matrix3d2.m21 * matrix3d1.m22;
 double double6 = matrix3d2.m02 * matrix3d1.m00 +
 matrix3d2.m12 * matrix3d1.m10 +
 matrix3d2.m22 * matrix3d1.m20;
 double double7 = matrix3d2.m02 * matrix3d1.m01 +
 matrix3d2.m12 * matrix3d1.m11 +
 matrix3d2.m22 * matrix3d1.m21;
 double double8 = matrix3d2.m02 * matrix3d1.m02 +
 matrix3d2.m12 * matrix3d1.m12 +
 matrix3d2.m22 * matrix3d1.m22;
 this->m00 = double0;
 this->m01 = double1;
 ...
 void normalize(Matrix3d matrix3d0) {
 double[] doubles0 = new double[9];
 double[] doubles1 = new double[9];
 double[] doubles2 = new double[3];
 ...
 void normalizeCP() {
 double double0 = 1.0 / Math.sqrt(this->m00 * this->m00 + this->m10 * this->m10 +
 this->m20 * this->m20);
 this->m00 *= double0;
 this->m10 *= double0;
 this->m20 *= double0;
 double0 = 1.0 / Math.sqrt(this->m01 * this->m01 + this->m11 * this->m11 +
 this->m21 * this->m21);
 this->m01 *= double0;
 this->m11 *= double0;
 this->m21 *= double0;
 ...
 void normalizeCP(Matrix3d matrix3d0) {
 double double0 = 1.0 / Math.sqrt(matrix3d0.m00 * matrix3d0.m00 +
 matrix3d0.m10 * matrix3d0.m10 +
 matrix3d0.m20 * matrix3d0.m20);
 this->m00 = matrix3d0.m00 * double0;
 this->m10 = matrix3d0.m10 * double0;
 this->m20 = matrix3d0.m20 * double0;
 double0 = 1.0 / Math.sqrt(matrix3d0.m01 * matrix3d0.m01 +
 matrix3d0.m11 * matrix3d0.m11 +
 matrix3d0.m21 * matrix3d0.m21);
 this->m01 = matrix3d0.m01 * double0;
 this->m11 = matrix3d0.m11 * double0;
 this->m21 = matrix3d0.m21 * double0;
 this->m02 = this->m10 * this->m21 - this->m11 * this->m20;
 ...
 bool equals(Matrix3d matrix3d0) {
 try {
 return this->m00 == matrix3d0.m00 && this->m01 == matrix3d0.m01 &&
 this->m02 == matrix3d0.m02 && this->m10 == matrix3d0.m10 &&
 this->m11 == matrix3d0.m11 && this->m12 == matrix3d0.m12 &&
 this->m20 == matrix3d0.m20 && this->m21 == matrix3d0.m21 &&
 this->m22 == matrix3d0.m22;
 ...
 bool epsilonEquals(Matrix3d matrix3d0, double double1) {
 ...
 void negate(Matrix3d matrix3d0) {
 this->m00 = -matrix3d0.m00;
 this->m01 = -matrix3d0.m01;
 this->m02 = -matrix3d0.m02;
 this->m10 = -matrix3d0.m10;
 ...
 void transform(Tuple3d tuple3d) {
 double double0 =
 this->m00 * tuple3d.x + this->m01 * tuple3d.y + this->m02 * tuple3d.z;
 double double1 =
 this->m10 * tuple3d.x + this->m11 * tuple3d.y + this->m12 * tuple3d.z;
 double double2 =
 this->m20 * tuple3d.x + this->m21 * tuple3d.y + this->m22 * tuple3d.z;
 tuple3d.set(double0, double1, double2);
 }

 void transform(Tuple3d tuple3d0, Tuple3d tuple3d1) {
 double double0 =
 this->m00 * tuple3d0.x + this->m01 * tuple3d0.y + this->m02 * tuple3d0.z;
 double double1 =
 this->m10 * tuple3d0.x + this->m11 * tuple3d0.y + this->m12 * tuple3d0.z;
 tuple3d1.z =
 this->m20 * tuple3d0.x + this->m21 * tuple3d0.y + this->m22 * tuple3d0.z;
 tuple3d1.x = double0;
 tuple3d1.y = double1;
 }
 ...
 static void compute_svd(double[] doubles7, double[] doubles8,
 double[] doubles9) {
 double[] doubles0 = new double[9];
 double[] doubles1 = new double[9];
 ...
 double double0 = 1.0 / Math.sqrt(doubles7[0] * doubles7[0] +
 doubles7[3] * doubles7[3]);
 ...
 double double3 = 1.0 / Math.sqrt(doubles7[0] * doubles7[0] +
 doubles7[6] * doubles7[6]);
 ...
 double double6 = 1.0 / Math.sqrt(doubles7[1] * doubles7[1] +
 doubles7[2] * doubles7[2]);
 ...
 double double9 = 1.0 / Math.sqrt(doubles7[4] * doubles7[4] +
 doubles7[7] * doubles7[7]);
 ...
 if (!(doubles5[0] * doubles5[0] < 1.110223024E-16) ||
 !(doubles5[1] * doubles5[1] < 1.110223024E-16) {
 ...
 if (almostEqual(Math.abs(doubles6[0]), 1.0) &&
 almostEqual(Math.abs(doubles6[1]), 1.0) &&
 almostEqual(Math.abs(doubles6[2]), 1.0) {
 ...
 static void svdReorder(double[] doubles7, double[] doubles4,
 double[] doubles3, double[] doubles2,
 double[] doubles5, double[] doubles6) {
 int[] ints0 = new int[3];
 int[] ints1 = new int[3];
 double[] doubles0 = new double[3];
 double[] doubles1 = new double[9];
 ...
 if (almostEqual(Math.abs(doubles2[0]), Math.abs(doubles2[1])) &&
 almostEqual(Math.abs(doubles2[1]), Math.abs(doubles2[2]))) {
 for (int int0 = 0; int0 < 9; int0++) {
 ...
 doubles0[0] = doubles7[0] * doubles7[0] + doubles7[1] * doubles7[1] +
 doubles7[2] * doubles7[2];
 doubles0[1] = doubles7[3] * doubles7[3] + doubles7[4] * doubles7[4] +
 doubles7[5] * doubles7[5];
 doubles0[2] = doubles7[6] * doubles7[6] + doubles7[7] * doubles7[7] +
 doubles7[8] * doubles7[8];
 uint8_t byte0;
 uint8_t byte1;
 uint8_t byte2;
 ...
 static int compute_qr(double[] doubles6, double[] doubles5, double[] doubles7,
 double[] doubles8) {
 ...
 double double3 = (Math.abs(doubles6[0]) - double2) *
 (d_sign(double0, doubles6[0]) + double2 / doubles6[0]);
 double double4 = doubles5[0];
 double double5 =
 compute_rot(double3, double4, doubles3, doubles1, 0, byte0);
 ...
 Math.abs(doubles5[0]) < 4.89E-15) {
 boolean0 = true;
 }
 }

 if (Math.abs(doubles5[1]) < 4.89E-15) {
 compute_2X2(doubles6[0], doubles5[0], doubles6[1], doubles6, doubles2,
 doubles0, doubles3, doubles1, 0);
 ...
 compute_2X2(doubles6[1], doubles5[1], doubles6[2], doubles6, doubles2,
 doubles0, doubles3, doubles1, 1);
 ...
 double[] doubles1, int int4, int var7) {
 double double0;
 double double1;
 double double2;
 if (double3 == 0.0) {
 ...
 for (int int0 = 0; int0 < 3; int0++) {
 System.out.println(doubles[int0 * 3 + 0] + " " + doubles[int0 * 3 + 1] +
 " " + doubles[int0 * 3 + 2] + "\n");
 }
 }
 ...
 double[] doubles0 =
 new double[]{doubles2[0] * doubles1[0] + doubles2[1] * doubles1[3] +
 doubles2[2] * doubles1[6],
 doubles2[0] * doubles1[1] + doubles2[1] * doubles1[4] +
 doubles2[2] * doubles1[7],
 doubles2[0] * doubles1[2] + doubles2[1] * doubles1[5] +
 doubles2[2] * doubles1[8],
 doubles2[3] * doubles1[0] + doubles2[4] * doubles1[3] +
 doubles2[5] * doubles1[6],
 doubles2[3] * doubles1[1] + doubles2[4] * doubles1[4] +
 doubles2[5] * doubles1[7],
 doubles2[3] * doubles1[2] + doubles2[4] * doubles1[5] +
 doubles2[5] * doubles1[8],
 doubles2[6] * doubles1[0] + doubles2[7] * doubles1[3] +
 doubles2[8] * doubles1[6],
 doubles2[6] * doubles1[1] + doubles2[7] * doubles1[4] +
 doubles2[8] * doubles1[7],
 doubles2[6] * doubles1[2] + doubles2[7] * doubles1[5] +
 doubles2[8] * doubles1[8]};
 ...
 static bool almostEqual(double double0, double double1) {
 if (double0 == double1) {
 return true;
 } else {
