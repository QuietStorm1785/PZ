...
public
 Color4b(uint8_t byte0, uint8_t byte1, uint8_t byte2, uint8_t byte3) {
 super(byte0, byte1, byte2, byte3);
 }

public
 Color4b(byte[] bytes) { super(bytes); }

public
 Color4b(Color4b color4b1) { super(color4b1); }

public
 Color4b(Tuple4b tuple4b) { super(tuple4b); }
