...
:
   ...
   private TreeMap<String, Data> m_outfitToData = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
   private TreeMap<String, Data> m_outfitToFemale = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
   private TreeMap<String, Data> m_outfitToMale = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    ...
    ArrayList<String> getOutfitNames() {
