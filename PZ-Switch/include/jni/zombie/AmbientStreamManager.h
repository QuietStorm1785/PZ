...
:
   ...
   private ArrayList<Alarm> alarmList = std::make_unique<ArrayList<>>();
    ...
    ArrayList<WorldSoundEmitter> worldEmitters = std::make_unique<ArrayList<>>();
    ArrayDeque<WorldSoundEmitter> freeEmitters = std::make_unique<ArrayDeque<>>();
    ArrayList<AmbientLoop> allAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> nightAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> dayAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> rainAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> indoorAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> outdoorAmbient = std::make_unique<ArrayList<>>();
    ArrayList<AmbientLoop> windAmbient = std::make_unique<ArrayList<>>();
    ...
    static BaseAmbientStreamManager getInstance() const {
    return instance;
   }
