...
:
   ...
   private static ThreadLocal<StringUTF> stringUTF = ThreadLocal.withInitial(StringUTF::new);
    ...
    static std::atomic boolean closeRequested;
    ...
    static ArrayList<TexturePack> texturePacks = std::make_unique<ArrayList<>>();
    ...
    std::string var2 = String.format("Unhandled %s thrown by thread %s.", var1.getClass().getName(), var0.getName());
    ...
    static std::string getCoopServerHome() const {
