...
:
    ...
    bool isExterior;
    bool hasWall;
    ArrayList<ErosionCategory> categories = std::make_unique<ArrayList<>>();

    ErosionRegions$Region(int var1, String var2, boolean var3, boolean var4, boolean var5) {
      this.ID = var1;
    ...
    ErosionRegions$Region addCategory(int var1, ErosionCategory var2) {
      var2.ID = var1;
      var2.region = this;
