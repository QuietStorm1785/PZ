...
:
    ...
    AmbientStreamManager$Ambient(String var1, float var2, float var3, float var4, float var5) {
      this(var1, var2, var3, var4, var5, false);
   }

    AmbientStreamManager$Ambient(String var1, float var2, float var3, float var4, float var5, boolean var6) {
      this.name = var1;
      this.x = var2;
      this.y = var3;
      this.radius = var4;
