...
:
    static ArrayList<String> FemaleForenames = std::make_unique<ArrayList<>>();
    static ArrayList<String> MaleForenames = std::make_unique<ArrayList<>>();
    ...
    static SurvivorDesc[] CreateFamily(int var0) {
    ...
    static SurvivorDesc[] CreateSurvivorGroup(int var0) {
      SurvivorDesc[] var1 = new SurvivorDesc[var0];
    ...
    static std::string getRandomSurname() const {
