...
:
   private static ObjectPool<IsoGameCharacter$TorchInfo> TorchInfoPool = new ObjectPool(IsoGameCharacter$TorchInfo::new);
    ...
    static IsoGameCharacter$TorchInfo alloc() {
    ...
    IsoGameCharacter$TorchInfo set(IsoPlayer var1, InventoryItem var2) {
      this.x = var1.getX();
      this.y = var1.getY();
      this.z = var1.getZ();
    ...
    IsoGameCharacter$TorchInfo set(VehiclePart var1) {
