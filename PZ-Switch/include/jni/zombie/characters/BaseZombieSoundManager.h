...
:
   protected ArrayList<IsoZombie> characters = std::make_unique<ArrayList<>>();
   private long[] soundTime;
    const int staleSlotMS;
   private Comparator<IsoZombie> comp = new 1(this);

     BaseZombieSoundManager(int var1, int var2) {
