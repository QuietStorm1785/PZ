...
:
   ...
   private PlayerRenderData[] m_playerRenderData = new PlayerRenderData[4];
   ...
   ArrayList<Zone> m_zones = std::make_unique<ArrayList<>>();
   HashSet<Zone> m_zoneSet = std::make_unique<HashSet<>>();
    RGBAf m_fill;
   ...
   WorldMapRenderer$Drawer() {
    ...
    void renderCell(int var1, int var2, ArrayList<WorldMapFeature> var3) {
