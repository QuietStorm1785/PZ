...
:
   ...
   private ArrayList<WorldMapRemotePlayer> playerList = std::make_unique<ArrayList<>>();
   private HashMap<Short, WorldMapRemotePlayer> playerLookup = std::make_unique<HashMap<>>();
    ...
    ArrayList<WorldMapRemotePlayer> getPlayers() {
