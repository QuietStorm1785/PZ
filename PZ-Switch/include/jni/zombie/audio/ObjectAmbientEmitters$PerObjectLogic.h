...
:
    ...
    ObjectAmbientEmitters$PerObjectLogic init(IsoObject var1) {
      this.object = var1;
    return this;
   }
    ...
    abstract void startPlaying(BaseSoundEmitter var1, long var2);

    abstract void stopPlaying(BaseSoundEmitter var1, long var2);

    abstract void checkParameters(BaseSoundEmitter var1, long var2);
}
} // namespace audio
} // namespace zombie
