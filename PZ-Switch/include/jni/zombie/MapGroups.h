...
class MapGroups {
:
   private ArrayList<MapGroup> groups = std::make_unique<ArrayList<>>();
   private ArrayList<MapDirectory> realDirectories = std::make_unique<ArrayList<>>();
   ...
   private static ArrayList<String> getVanillaMapDirectories(boolean var0) {
    ...
    ArrayList<String> getMapDirectoriesInGroup(int var1) {
   ...
   private ArrayList<String> getLotDirectories(String var1) {
    ...
    ArrayList<String> getMapConflicts(String var1) {
      for (MapGroup var3 : this.groups) {
