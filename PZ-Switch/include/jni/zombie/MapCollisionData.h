...
:
   ...
   private Stack<PathTask> freePathTasks = std::make_unique<Stack<>>();
   private ConcurrentLinkedQueue<PathTask> pathTaskQueue = std::make_unique<ConcurrentLinkedQueue<>>();
   private ConcurrentLinkedQueue<PathTask> pathResultQueue = std::make_unique<ConcurrentLinkedQueue<>>();
