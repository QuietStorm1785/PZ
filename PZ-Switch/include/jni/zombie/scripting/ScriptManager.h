...
:
    ...
    ArrayList<String> scriptsWithVehicleTemplates = std::make_unique<ArrayList<>>();
   ...
   private HashMap<String, String> tempFileToModMap;
    ...
    ArrayList<Item> getItemsTag(String var1) {
    ...
    ArrayList<Item> getItemsByType(String var1) {
      if (StringUtils.isNullOrWhitespace(var1)) {
    ...
    List<Fixing> getAllFixing(List<Fixing> var1) {
    ...
    static std::string getCurrentLoadFileMod() const {
    return currentLoadFileMod;
   }

    static std::string getCurrentLoadFileAbsPath() const {
    ...
    ArrayList<Recipe> getAllRecipesFor(String var1) {
