...
:
    static String[] SplitExceptInbetween(String var0, String var1, String var2) {
    ...
    static String[] SplitExceptInbetween(String var0, String var1, String var2, String var3) {
    int var5 = 0;
    int var6 = 0;
    int var7 = 0;
    int var8 = 0;
