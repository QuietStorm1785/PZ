...
:
    ...
    SandboxOptions$EnumSandboxOption(SandboxOptions var1, String var2, int var3, int var4) {
    ...
    SandboxOptions$EnumSandboxOption setValueTranslation(String var1) {
      this.valueTranslation = var1;
    return this;
   }

    std::string getValueTranslation() const {
