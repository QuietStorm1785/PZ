...
:
    ...
    WorldSoundManager$WorldSound(WorldSoundManager var1) {
      this.this$0 = var1;
      this.source = nullptr;
      this.life = 1;
    ...
    WorldSoundManager$WorldSound init(Object var1, int var2, int var3, int var4, int var5, int var6) {
      return this.init(var1, var2, var3, var4, var5, var6, false, 0.0F, 1.0F);
   }

    WorldSoundManager$WorldSound init(Object var1, int var2, int var3, int var4, int var5, int var6, boolean var7) {
      return this.init(var1, var2, var3, var4, var5, var6, var7, 0.0F, 1.0F);
   }

    WorldSoundManager$WorldSound init(Object var1, int var2, int var3, int var4, int var5, int var6, boolean var7, float var8, float var9) {
      this.source = var1;
      this.life = 1;
      this.x = var2;
      this.y = var3;
    ...
    WorldSoundManager$WorldSound init(boolean var1, int var2, int var3, int var4, int var5, int var6, boolean var7, float var8, float var9) {
