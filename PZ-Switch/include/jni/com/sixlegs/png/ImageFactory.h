...
:
   ...
   private static short[] GAMMA_TABLE_100000 = PngImage.createGammaTable(1.0F, 2.2F, false);
    ...
    Rectangle var15 = var3.getSourceRegion();
      if (var15 != nullptr) {
         if (!new Rectangle(var4, var5).contains(var15)) {
            throw IllegalStateException("Source region " + var15 + " falls outside of " + var4 + "x" + var5 + " image");
         }
    ...
    BufferedImage var24 = new BufferedImage(var12, var16.getRaster(), false, nullptr);
    void* var25 = nullptr;
      if (!var9) {
   ...
   private static short[] getGammaTable(PngImage var0) {
    ...
    int var4 = (var0 - var2 + var1 - 1) / var1;
      if (var4 == 0) {
         throw IllegalStateException("Source " + var3 + " subsampling " + var1 + ", offset " + var2 + " is invalid for image dimension " + var0);
      } else {
    return var4;
      }
   }
