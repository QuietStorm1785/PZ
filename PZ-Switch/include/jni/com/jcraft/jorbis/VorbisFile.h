...
:
   ...
   Info[] vi;
    ...
    SeekableInputStream var2 = nullptr;
      ...
      try {
         var2 = new SeekableInputStream(this, var1);
    int var3 = this.open(var2, nullptr, 0);
         if (var3 == -1) {
            throw JOrbisException("VorbisFile: open return -1");
         }
      } catch (Exception var11) {
         throw JOrbisException("VorbisFile: " + var11.toString());
      } finally {
         if (var2 != nullptr) {
            try {
               var2.close();
     ...
     VorbisFile(InputStream var1, byte[] var2, int var3) {
    ...
    static int fseek(InputStream var0, long var1, int var3) {
      if (var0 instanceof SeekableInputStream var4) {
         try {
            if (var3 == 0) {
               var4.seek(var1);
            } else if (var3 == 2) {
    ...
    int var4;
      if (var1 instanceof SeekableInputStream) {
