...
:
   ...
   private ArrayList<ISearchNode> successorNodes = std::make_unique<ArrayList<>>();
    ...
    ArrayList<ISearchNode> shortestPath(ISearchNode var1, IGoalNode var2) {
    ISearchNode var3 = this.search(var1, var2);
    return var3 = = nullptr ? nullptr : path(var3);
   }

    ISearchNode search(ISearchNode var1, IGoalNode var2) {
    bool var3 = var1.keyCode() != nullptr;
      var1.setDepth(0);
      this.openSet.clear();
    ...
    static ArrayList<ISearchNode> path(ISearchNode var0) {
