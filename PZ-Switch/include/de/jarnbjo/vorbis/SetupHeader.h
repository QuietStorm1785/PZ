...
public
 SetupHeader(VorbisStream vorbisStream, BitInputStream bitInputStream) {
 ...
 this->mappings[int9] =
 Mapping.createInstance(vorbisStream, bitInputStream, this);
 }
...
public
 CodeBook[] getCodeBooks() { return this->codeBooks; }

public
 Floor[] getFloors() { return this->floors; }

public
 Residue[] getResidues() { return this->residues; }

public
 Mapping[] getMappings() { return this->mappings; }

public
 Mode[] getModes() { return this->modes; }
}
} // namespace vorbis
} // namespace jarnbjo
} // namespace de
