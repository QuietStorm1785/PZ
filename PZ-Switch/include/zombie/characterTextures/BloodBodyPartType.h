...
enum class BloodBodyPartType {
 ...
 LowerLeg_R, Foot_L, Foot_R, Back, MAX;
...
public
CharacterMask.Part[] getCharacterMaskParts() {
...
std::string getDisplayName() { return getDisplayName(); }
...
static std::string getDisplayName(BloodBodyPartType BPT) {
 ...
 return BPT = = Back ? Translator.getText("IGUI_health_Back")
