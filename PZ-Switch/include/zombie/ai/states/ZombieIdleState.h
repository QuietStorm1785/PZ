...
public:
 ...
 static ZombieIdleState instance() { return _instance; }
 ...
 IsoPlayer.players[int0].DistTo(owner) < float0 &&
 ...
 if (owner.getCell().getGridSquare((double)int1, (double)int2,
 (double)owner.getZ()) !=
 nullptr &&
 owner.getCell()
 .getGridSquare((double)int1, (double)int2,
 (double)owner.getZ())
 .isFree(true) {
