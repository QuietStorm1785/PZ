...
public:
 ...
 static ZombieGetDownState instance() { return _instance; }
 ...
 IsoZombie zombie0 = (IsoZombie)owner;
 if (event.m_EventName.equalsIgnoreCase("StartCrawling") &&
 !zombie0.isCrawling()) {
 ...
 return float0 != nullptr && float1 != nullptr
 ? owner.DistToSquared(float0, float1) <= 0.25F
 : false;
 }
