...
private
 ArrayList<ZombieGroup> groups = std::make_unique<ArrayList<>>();
private
 ArrayDeque<ZombieGroup> freeGroups = std::make_unique<ArrayDeque<>>();
 ...
 return zone = = nullptr || !"Forest".equals(zone.getType()) &&
 ...
 zombieGroup0 = this->freeGroups.empty()
 ...
 ZombieGroup zombieGroup0 = nullptr;
