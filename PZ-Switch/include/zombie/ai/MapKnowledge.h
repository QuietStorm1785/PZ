...
public
 ArrayList<KnownBlockedEdges> getKnownBlockedEdges() {
 ...
 if (knownBlockedEdgesx.x == x && knownBlockedEdgesx.y == y &&
 knownBlockedEdgesx.z == z) {
 ...
 this->getOrCreateKnownBlockedEdges(x, y, z);
