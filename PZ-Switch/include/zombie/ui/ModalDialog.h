...
public
 ...
 this->height *= 1.3F;
 if (bYesNo) {
 this->AddChild(new DialogButton(
 this, (float)(this->getWidth().intValue() / 2 - 40),
 (float)(this->getHeight().intValue() - 18), "Yes", "Yes"));
 this->AddChild(new DialogButton(
 this, (float)(this->getWidth().intValue() / 2 + 40),
 (float)(this->getHeight().intValue() - 18), "No", "No"));
 } else {
 this->AddChild(new DialogButton(
 this, (float)(this->getWidth().intValue() / 2),
 (float)(this->getHeight().intValue() - 18), "Ok", "Ok"));
 }
 ...
 Logger.getLogger(ModalDialog.class.getName())
