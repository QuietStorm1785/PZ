...
public
 UITransition() { this->duration = 100.0F; }
 ...
 float fraction() { return this->fadeOut ? 1.0F - this->frac : this->frac; }
 ...
 void reset() { this->elapsed = 0.0F; }

 void setIgnoreUpdateTime(bool ignore) { this->bIgnoreUpdateTime = ignore; }

 float getElapsed() { return this->elapsed; }

 void setElapsed(float _elapsed) { this->elapsed = _elapsed; }
}
} // namespace ui
} // namespace zombie
