...
public
 ...
 this->DrawTextureScaled(this->texture, 0.0, int0, this->getWidth(),
 this->getHeight(), this->notclickedAlpha);
 }
 else {
 this->DrawTextureScaled(this->highlight, 0.0, int0, this->getWidth(),
 this->getHeight(), this->clickedalpha);
 }

 if (this->overicon != nullptr) {
 this->DrawTextureScaled(this->overicon, 0.0, int0, this->overicon.getWidth(),
