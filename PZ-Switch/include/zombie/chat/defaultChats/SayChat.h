...
public:
public
 SayChat(ByteBuffer byteBuffer, ChatTab chatTab, IsoPlayer player) {
...
public
 SayChat(int int0, ChatTab chatTab) {
...
public
 ...
 return this->getMessagePrefix(chatMessage) + " " +
 ChatUtility.parseStringForChatLog(
 chatMessage.getTextWithReplacedParentheses());
 }
}
} // namespace defaultChats
} // namespace chat
