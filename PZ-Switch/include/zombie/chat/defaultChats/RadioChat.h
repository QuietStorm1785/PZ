...
public:
public
 RadioChat(ByteBuffer byteBuffer, ChatTab chatTab, IsoPlayer player) {
...
public
 RadioChat(int int0, ChatTab chatTab) {
...
public
 ...
 this->getSpeechBubble().addChatLine(
 chatMessage.getText(), color.r, color.g, color.b, UIFont.Dialogue,
 ...
 ZomboidRadio.getInstance().SendTransmission(int0, int1, chatMessage,
 int2);
 }
 }
 ...
 if (this->isShowAuthor() && chatMessage.getAuthor() != nullptr &&
 ...
 stringBuilder.append(" (")
 .append(this->getRadioChannelStr(chatMessage)
 .append("): ");
