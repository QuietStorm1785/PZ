...
private
 static ThreadLocal<GameWindow.StringUTF> stringUTF =
...
public
 static ArrayList<GameWindow.TexturePack> texturePacks =
 std::make_unique<ArrayList<>>();
public
 static FileSystem.TexturePackTextures texturePackTextures =
 ...
 throw RuntimeException("Rebuild Tiles.pack with \"1 Include This in "
...
public
 ...
 std::string fileName;
 std::string modID;
 FileSystem.TexturePackTextures textures =
 new FileSystem.TexturePackTextures();
 }
