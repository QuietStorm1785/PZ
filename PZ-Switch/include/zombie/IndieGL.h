...
public:
 static int nCount = 0;
private
 static GLState.CIntValue tempInt = new GLState.CIntValue();
private
 static GLState.C2IntsValue temp2Ints = new GLState.C2IntsValue();
private
 static GLState.C3IntsValue temp3Ints = new GLState.C3IntsValue();
private
 static GLState.C4IntsValue temp4Ints = new GLState.C4IntsValue();
private
 static GLState.C4BooleansValue temp4Booleans =
 new GLState.C4BooleansValue();
private
 static GLState.CIntFloatValue tempIntFloat =
 new GLState.CIntFloatValue();
private
 static Stack<ShaderStackEntry> m_shaderStack =
...
private
 ...
 nullptr ? nullptr : shaderProgram.getUniform(string, int0, false);
 }
 }
