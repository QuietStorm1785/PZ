...
public:
 ...
 int Speed = 3;
public
 SandboxOptions.EnumSandboxOption Zombies;
public
 SandboxOptions.EnumSandboxOption Distribution;
public
 SandboxOptions.EnumSandboxOption DayLength;
public
 SandboxOptions.EnumSandboxOption StartYear;
public
 SandboxOptions.EnumSandboxOption StartMonth;
public
 SandboxOptions.EnumSandboxOption StartDay;
public
 SandboxOptions.EnumSandboxOption StartTime;
public
 SandboxOptions.EnumSandboxOption WaterShut;
public
 SandboxOptions.EnumSandboxOption ElecShut;
public
 SandboxOptions.IntegerSandboxOption WaterShutModifier;
public
 SandboxOptions.IntegerSandboxOption ElecShutModifier;
public
 SandboxOptions.EnumSandboxOption FoodLoot;
public
 SandboxOptions.EnumSandboxOption LiteratureLoot;
public
 SandboxOptions.EnumSandboxOption MedicalLoot;
public
 SandboxOptions.EnumSandboxOption SurvivalGearsLoot;
public
 SandboxOptions.EnumSandboxOption CannedFoodLoot;
public
 SandboxOptions.EnumSandboxOption WeaponLoot;
public
 SandboxOptions.EnumSandboxOption RangedWeaponLoot;
public
 SandboxOptions.EnumSandboxOption AmmoLoot;
public
 SandboxOptions.EnumSandboxOption MechanicsLoot;
public
 SandboxOptions.EnumSandboxOption OtherLoot;
public
 SandboxOptions.EnumSandboxOption Temperature;
public
 SandboxOptions.EnumSandboxOption Rain;
public
 SandboxOptions.EnumSandboxOption ErosionSpeed;
public
 SandboxOptions.IntegerSandboxOption ErosionDays;
public
 SandboxOptions.DoubleSandboxOption XpMultiplier;
public
 SandboxOptions.BooleanSandboxOption XpMultiplierAffectsPassive;
public
 SandboxOptions.EnumSandboxOption Farming;
public
 SandboxOptions.EnumSandboxOption CompostTime;
public
 SandboxOptions.EnumSandboxOption StatsDecrease;
public
 SandboxOptions.EnumSandboxOption NatureAbundance;
public
 SandboxOptions.EnumSandboxOption Alarm;
public
 SandboxOptions.EnumSandboxOption LockedHouses;
public
 SandboxOptions.BooleanSandboxOption StarterKit;
public
 SandboxOptions.BooleanSandboxOption Nutrition;
public
 SandboxOptions.EnumSandboxOption FoodRotSpeed;
public
 SandboxOptions.EnumSandboxOption FridgeFactor;
public
 SandboxOptions.EnumSandboxOption LootRespawn;
public
 SandboxOptions.IntegerSandboxOption SeenHoursPreventLootRespawn;
public
 SandboxOptions.StringSandboxOption WorldItemRemovalList;
public
 SandboxOptions.DoubleSandboxOption HoursForWorldItemRemoval;
public
 SandboxOptions.BooleanSandboxOption ItemRemovalListBlacklistToggle;
public
 SandboxOptions.EnumSandboxOption TimeSinceApo;
public
 SandboxOptions.EnumSandboxOption PlantResilience;
public
 SandboxOptions.EnumSandboxOption PlantAbundance;
public
 SandboxOptions.EnumSandboxOption EndRegen;
public
 SandboxOptions.EnumSandboxOption Helicopter;
public
 SandboxOptions.EnumSandboxOption MetaEvent;
public
 SandboxOptions.EnumSandboxOption SleepingEvent;
public
 SandboxOptions.DoubleSandboxOption GeneratorFuelConsumption;
public
 SandboxOptions.EnumSandboxOption GeneratorSpawning;
public
 SandboxOptions.EnumSandboxOption SurvivorHouseChance;
public
 SandboxOptions.EnumSandboxOption AnnotatedMapChance;
public
 SandboxOptions.IntegerSandboxOption CharacterFreePoints;
public
 SandboxOptions.EnumSandboxOption ConstructionBonusPoints;
public
 SandboxOptions.EnumSandboxOption NightDarkness;
public
 SandboxOptions.EnumSandboxOption NightLength;
public
 SandboxOptions.BooleanSandboxOption BoneFracture;
public
 SandboxOptions.EnumSandboxOption InjurySeverity;
public
 SandboxOptions.DoubleSandboxOption HoursForCorpseRemoval;
public
 SandboxOptions.EnumSandboxOption DecayingCorpseHealthImpact;
public
 SandboxOptions.EnumSandboxOption BloodLevel;
public
 SandboxOptions.EnumSandboxOption ClothingDegradation;
public
 SandboxOptions.BooleanSandboxOption FireSpread;
public
 SandboxOptions.IntegerSandboxOption DaysForRottenFoodRemoval;
public
 SandboxOptions.BooleanSandboxOption AllowExteriorGenerator;
public
 SandboxOptions.EnumSandboxOption MaxFogIntensity;
public
 SandboxOptions.EnumSandboxOption MaxRainFxIntensity;
public
 SandboxOptions.BooleanSandboxOption EnableSnowOnGround;
public
 SandboxOptions.BooleanSandboxOption AttackBlockMovements;
public
 SandboxOptions.EnumSandboxOption VehicleStoryChance;
public
 SandboxOptions.EnumSandboxOption ZoneStoryChance;
public
 SandboxOptions.BooleanSandboxOption AllClothesUnlocked;
public
 SandboxOptions.BooleanSandboxOption EnableTaintedWaterText;
public
 SandboxOptions.BooleanSandboxOption EnableVehicles;
public
 SandboxOptions.EnumSandboxOption CarSpawnRate;
public
 SandboxOptions.DoubleSandboxOption ZombieAttractionMultiplier;
public
 SandboxOptions.BooleanSandboxOption VehicleEasyUse;
public
 SandboxOptions.EnumSandboxOption InitialGas;
public
 SandboxOptions.EnumSandboxOption FuelStationGas;
public
 SandboxOptions.EnumSandboxOption LockedCar;
public
 SandboxOptions.DoubleSandboxOption CarGasConsumption;
public
 SandboxOptions.EnumSandboxOption CarGeneralCondition;
public
 SandboxOptions.EnumSandboxOption CarDamageOnImpact;
public
 SandboxOptions.EnumSandboxOption DamageToPlayerFromHitByACar;
public
 SandboxOptions.BooleanSandboxOption TrafficJam;
public
 SandboxOptions.EnumSandboxOption CarAlarm;
public
 SandboxOptions.BooleanSandboxOption PlayerDamageFromCrash;
public
 SandboxOptions.DoubleSandboxOption SirenShutoffHours;
public
 SandboxOptions.EnumSandboxOption ChanceHasGas;
public
 SandboxOptions.EnumSandboxOption RecentlySurvivorVehicles;
public
 SandboxOptions.BooleanSandboxOption MultiHitZombies;
public
 SandboxOptions.EnumSandboxOption RearVulnerability;
public
 SandboxOptions.EnumSandboxOption EnablePoisoning;
public
 SandboxOptions.EnumSandboxOption MaggotSpawn;
public
 SandboxOptions.DoubleSandboxOption LightBulbLifespan;
protected
 ArrayList<SandboxOptions.SandboxOption> options =
 std::make_unique<ArrayList<>>();
protected
 HashMap<String, SandboxOptions.SandboxOption> optionByName =
 std::make_unique<HashMap<>>();
public
 SandboxOptions.Map Map = new SandboxOptions.Map();
public
 SandboxOptions.ZombieLore Lore = new SandboxOptions.ZombieLore();
public
...
private
 ArrayList<SandboxOptions.SandboxOption> m_customOptions =
 std::make_unique<ArrayList<>>();
...
public
 ...
 presetName + ".lua");
 if (!file.exists()) {
 throw RuntimeException("media/lua/shared/Sandbox/" + presetName +
 ".lua not found");
 } else {
 try {
 ...
 throw RuntimeException(file.getName() +
...
public
 ...
 return Translator.getText("Sandbox_" + (this->translation.empty()
 ? this->getShortName()
 : this->translation);
 }
 ...
 "Sandbox_" +
 (this->translation.empty() ? this->getShortName() : this->translation) +
 "_tooltip");
 }

 void fromTable(KahluaTable table) {
 if (this->tableName.empty() || tablex.rawget(this->tableName) instanceof
 KahluaTable tablex) {
...
public
 ...
 std::string string2 =
 string1 == nullptr ? nullptr : Translator.getText("Sandbox_Default", string1);
 if (string0.empty()) {
 return string2;
 } else {
...
public
 ...
 : (this->translation.empty() ? this->getShortName()
 : this->translation);
 }
...
class Map {
public
 SandboxOptions.BooleanSandboxOption AllowMiniMap =
 SandboxOptions.this->newBooleanOption("Map.AllowMiniMap", false);
public
 SandboxOptions.BooleanSandboxOption AllowWorldMap =
 SandboxOptions.this->newBooleanOption("Map.AllowWorldMap", true);
public
 SandboxOptions.BooleanSandboxOption MapAllKnown =
