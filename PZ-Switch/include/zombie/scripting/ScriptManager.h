...
public
 ArrayList<String> scriptsWithVehicles = std::make_unique<ArrayList<>>();
public
 ArrayList<String> scriptsWithVehicleTemplates =
 std::make_unique<ArrayList<>>();
public
 HashMap<String, ScriptModule> ModuleMap = std::make_unique<HashMap<>>();
public
 ArrayList<ScriptModule> ModuleList = std::make_unique<ArrayList<>>();
private
 HashMap<String, Item> FullTypeToItemMap = std::make_unique<HashMap<>>();
private
 HashMap<String, SoundTimelineScript> SoundTimelineMap =
 std::make_unique<HashMap<>>();
 ScriptModule CurrentLoadingModule = nullptr;
private
 HashMap<String, String> ModuleAliases = std::make_unique<HashMap<>>();
 const StringBuilder buf = new StringBuilder();
private
 HashMap<String, ScriptModule> CachedModules =
 std::make_unique<HashMap<>>();
private
 ArrayList<Recipe> recipesTempList = std::make_unique<ArrayList<>>();
private
 Stack<EvolvedRecipe> evolvedRecipesTempList =
 std::make_unique<Stack<>>();
private
 Stack<UniqueRecipe> uniqueRecipesTempList = std::make_unique<Stack<>>();
private
 ArrayList<Item> itemTempList = std::make_unique<ArrayList<>>();
private
 HashMap<String, ArrayList<Item>> tagToItemMap =
 std::make_unique<HashMap<>>();
private
 HashMap<String, ArrayList<Item>> typeToItemMap =
 std::make_unique<HashMap<>>();
private
 ArrayList<AnimationsMesh> animationsMeshTempList =
 std::make_unique<ArrayList<>>();
private
 ArrayList<MannequinScript> mannequinScriptTempList =
 std::make_unique<ArrayList<>>();
private
 ArrayList<ModelScript> modelScriptTempList =
 std::make_unique<ArrayList<>>();
private
 ArrayList<VehicleScript> vehicleScriptTempList =
 std::make_unique<ArrayList<>>();
private
 HashMap<String, String> clothingToItemMap =
 std::make_unique<HashMap<>>();
private
 ArrayList<String> visualDamagesList = std::make_unique<ArrayList<>>();
...
private
 ...
 return scriptModule = =
 nullptr ? nullptr : scriptModule.getItem(getItemName(name);
 }
 }
...
Item getSpecificItem(std::string_view name) {
 ...
 name);
 if (Core.bDebug) {
 throw RuntimeException("ScriptManager.getSpecificItem requires a "
