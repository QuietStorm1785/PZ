...
public
 ArrayList<String> Categories = std::make_unique<ArrayList<>>();
public
 ArrayList<String> Tags = std::make_unique<ArrayList<>>();
...
void setModID(const std::string &modid) {
 ...
 throw RuntimeException("Cannot override modID. ModID=" +
