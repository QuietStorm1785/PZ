...
private
 LinkedList<Fixing.Fixer> fixers = std::make_unique<LinkedList<>>();
private
 Fixing.Fixer globalItem = nullptr;
 float conditionModifier = 1.0F;
private
 static Fixing.PredicateRequired s_PredicateRequired =
...
public
 ...
 chr, this->getGlobalItem(), nullptr, s_InventoryItems);
...
public
 ...
 private static class PredicateRequired implements
