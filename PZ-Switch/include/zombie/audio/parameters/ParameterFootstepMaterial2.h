...
public
 ParameterFootstepMaterial2(IsoGameCharacter _character) {
...
private
 ParameterFootstepMaterial2.FootstepMaterial2 getMaterial() {
 ...
 this->character.getCurrentSquare().getBrokenGlass();
 ...
 return float0 > 0.1F
 ? ParameterFootstepMaterial2.FootstepMaterial2
 .PuddleShallow
 : ParameterFootstepMaterial2.FootstepMaterial2.None;
 }
 }
 }
 }
 ...
 None(0), BrokenGlass(1), PuddleShallow(2), PuddleDeep(3);

 const int label;

 private FootstepMaterial2(int int1){this->label = int1;}
}
} // namespace parameters
} // namespace audio
} // namespace zombie
