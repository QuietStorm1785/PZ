...
public:
private
 HashMap<String, ObjectAmbientEmitters.PowerPolicy> powerPolicyMap =
 std::make_unique<HashMap<>>();
 static ObjectAmbientEmitters instance = nullptr;
 static const Vector2 tempVector2 = new Vector2();
private
 HashMap<IsoObject, ObjectAmbientEmitters.ObjectWithDistance> m_added =
 std::make_unique<HashMap<>>();
private
 ObjectPool<ObjectAmbientEmitters.ObjectWithDistance> m_objectPool =
 new ObjectPool<>(ObjectAmbientEmitters.ObjectWithDistance::new);
private
 ArrayList<ObjectAmbientEmitters.ObjectWithDistance> m_objects =
 std::make_unique<ArrayList<>>();
private
 ObjectAmbientEmitters.Slot[] m_slots;
private
 Comparator<ObjectAmbientEmitters.ObjectWithDistance> comp =
...
public
static class AmbientSoundLogic extends
...
public
 ...
 this->object.square.getRoom() != nullptr;
 if (!boolean0) {
 return false;
 }
 }
...
static class ChunkData {
 HashMap<IsoObject, ObjectAmbientEmitters.PerObjectLogic> m_objects =
 std::make_unique<HashMap<>>();
...
public static class DoorLogic extends
 ObjectAmbientEmitters.PerObjectLogic {
...
public
static class FridgeHumLogic extends ObjectAmbientEmitters.PerObjectLogic {
 bool shouldPlaySound() {
...
public
 void startPlaying(BaseSoundEmitter emitter, long instance);

public
 void stopPlaying(BaseSoundEmitter emitter, long instance);

public
 void checkParameters(BaseSoundEmitter emitter, long instance);
}
...
public static class TentAmbianceLogic extends
 ObjectAmbientEmitters.PerObjectLogic {
 bool shouldPlaySound() {
...
public
static class TreeAmbianceLogic extends
 ObjectAmbientEmitters.PerObjectLogic {
 bool shouldPlaySound() { return true; }
...
public
static class WaterDripLogic extends ObjectAmbientEmitters.PerObjectLogic {
 bool shouldPlaySound() {
 return this->object.sprite != nullptr &&
