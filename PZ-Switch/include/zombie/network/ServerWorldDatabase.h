...
public
 ...
 databaseMetaData.getColumns(nullptr, nullptr, string1, nullptr);
 ...
 for (string0 = scanner.nextLine(); string0.empty() || "" == string0)
 ...
 string1.empty() || "" == string1) || !string0 == string1); string1 = scanner.nextLine()) {
 ...
 !this->CommandLineAdminPassword.empty()) {
 std::string string2 =
