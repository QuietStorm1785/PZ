...
public
 void set(int int0, int int1, int int2, String string0, String string1,
 String string2, float float0, float float1, float float2, int int3,
 boolean boolean0) {
 this->sourceX = int0;
 this->sourceY = int1;
 this->channel = int2;
 ...
 udpConnection.getConnectedGUID(), this->sourceX, this->sourceY,
 this->channel, this->msg, this->guid, this->codes, this->r, this->g, this->b,
 this->signalStrength, this->isTV);
 } else {
 ZomboidRadio.getInstance().ReceiveTransmission(
 this->sourceX, this->sourceY, this->channel, this->msg, this->guid,
 this->codes, this->r, this->g, this->b, this->signalStrength, this->isTV);
 }
 }
}
} // namespace packets
