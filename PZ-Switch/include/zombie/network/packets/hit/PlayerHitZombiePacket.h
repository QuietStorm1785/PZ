...
public
 PlayerHitZombiePacket() { super(HitCharacterPacket.HitType.PlayerHitZombie); }

public
 void set(IsoPlayer player, IsoZombie zombie0, HandWeapon weapon, float float0,
 boolean boolean2, float float1, boolean boolean0, boolean boolean1,
 boolean boolean3) {
 super.set(player, weapon, boolean0);
 this->target.set(zombie0, boolean1);
 this->hit.set(boolean2, float0, float1, zombie0.getHitForce(),
 zombie0.getHitDir().x, zombie0.getHitDir().y, boolean3);
