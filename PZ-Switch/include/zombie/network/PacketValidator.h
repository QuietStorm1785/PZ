...
public
 HashMap<String, PacketValidator.RecipeDetails> details =
 std::make_unique<HashMap<>>();
public
 HashMap<String, PacketValidator.RecipeDetails> detailsFromClient =
 std::make_unique<HashMap<>>();
 bool failed = false;
...
public
 ...
 private
 ArrayList<PacketValidator.RecipeDetails.Skill> skills =
