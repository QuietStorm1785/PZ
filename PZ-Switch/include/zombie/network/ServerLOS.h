...
private
 ...
 { std::lock_guard<std::mutex> __sync_lock__(playersMain_mutex);
...
class LOSThread extends Thread {
 ...
 { std::lock_guard<std::mutex> __sync_lock__(ServerLOS.this->playersMain_mutex);
 ...
 public static class ServerLighting implements IsoGridSquare.ILighting {
