...
public:
private
 static HashMap<String, ChooseGameInfo.Map> Maps =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, ChooseGameInfo.Mod> Mods =
 std::make_unique<HashMap<>>();
private
 static HashSet<String> MissingMods = std::make_unique<HashSet<>>();
private
 static ArrayList<String> tempStrings = std::make_unique<ArrayList<>>();
...
public
 ...
 private
 ArrayList<String> posters = std::make_unique<ArrayList<>>();
 Texture tex;
 private
 ...
 private
 ArrayList<ChooseGameInfo.PackFile> packs =
 std::make_unique<ArrayList<>>();
 private
 ArrayList<ChooseGameInfo.TileDef> tileDefs =
 std::make_unique<ArrayList<>>();
 bool bRead = false;
 bool bValid = false;
 ...
 if (this->tex.empty()) {
 std::string string =
 this->posters.empty() ? nullptr : this->posters.get(0);
