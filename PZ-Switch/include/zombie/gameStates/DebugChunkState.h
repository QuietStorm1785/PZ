...
public
 ...
 IsoObject object =
 UIManager.getPicked() == nullptr ? nullptr : UIManager.getPicked().tile;
 ...
 if (square0.empty() || square0.getX() != int5 ||
 ...
 if (square0 != nullptr) {
 IsoGridSquare square1 = square0.testPathFindAdjacent(nullptr, -1, 0, 0)
 ? nullptr
 : square0.nav[IsoDirections.W.index()];
 IsoGridSquare square2 = square0.testPathFindAdjacent(nullptr, 0, -1, 0)
 ? nullptr
 : square0.nav[IsoDirections.N.index()];
 IsoGridSquare square3 = square0.testPathFindAdjacent(nullptr, 1, 0, 0)
 ? nullptr
 : square0.nav[IsoDirections.E.index()];
 IsoGridSquare square4 = square0.testPathFindAdjacent(nullptr, 0, 1, 0)
 ? nullptr
 : square0.nav[IsoDirections.S.index()];
 IsoGridSquare square5 =
 square0.testPathFindAdjacent(nullptr, -1, -1, 0)
 ? nullptr
 : square0.nav[IsoDirections.NW.index()];
 IsoGridSquare square6 = square0.testPathFindAdjacent(nullptr, 1, -1, 0)
 ? nullptr
 : square0.nav[IsoDirections.NE.index()];
 IsoGridSquare square7 = square0.testPathFindAdjacent(nullptr, -1, 1, 0)
 ? nullptr
 : square0.nav[IsoDirections.SW.index()];
 IsoGridSquare square8 = square0.testPathFindAdjacent(nullptr, 1, 1, 0)
 ? nullptr
