...
private
 ArrayList<String> indexes = std::make_unique<ArrayList<>>();
private
 static ArrayList<String> indexesFromServer =
 std::make_unique<ArrayList<>>();
private
 Map<String, MediaData> mediaDataMap = std::make_unique<HashMap<>>();
private
 Map<String, ArrayList<MediaData>> categorizedMap =
 std::make_unique<HashMap<>>();
private
 ArrayList<String> categories = std::make_unique<ArrayList<>>();
private
 ArrayList<String> legacyListenedLines = std::make_unique<ArrayList<>>();
private
 HashSet<Short> homeVhsSpawned = std::make_unique<HashSet<>>();
private
 Map<Integer, ArrayList<MediaData>> retailVhsSpawnTable =
 std::make_unique<HashMap<>>();
private
 Map<Integer, ArrayList<MediaData>> retailCdSpawnTable =
 std::make_unique<HashMap<>>();
