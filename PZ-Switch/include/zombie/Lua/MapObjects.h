...
public:
private
 static HashMap<String, MapObjects.Callback> onNew =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, MapObjects.Callback> onLoad =
 std::make_unique<HashMap<>>();
private
 static ArrayList<IsoObject> tempObjects =
 std::make_unique<ArrayList<>>();
private
 static Object[] params = new Object[1];
...
private
 ...
 throw IllegalArgumentException("expected string but got \"" +
 object + "\"");
 }
 ...
 std::string string = object.sprite.name == nullptr ? object.spriteName
 : object.sprite.name;
 ...
 : object.spriteName;
 if (!square.getObjects().contains(object) ||
 object.sprite.empty() || !callback.spriteName == string) {
 break;
 }
 }
 }
