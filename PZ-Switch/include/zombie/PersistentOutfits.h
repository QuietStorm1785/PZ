...
private
 static byte[] FILE_MAGIC = new byte[]{80, 83, 84, 90};
 static const int NUM_SEEDS = 500;
private
 long[] m_seeds = new long[500];
private
 ArrayList<String> m_outfitNames = std::make_unique<ArrayList<>>();
private
 PersistentOutfits.DataList m_all = new PersistentOutfits.DataList();
private
 PersistentOutfits.DataList m_female = new PersistentOutfits.DataList();
private
 PersistentOutfits.DataList m_male = new PersistentOutfits.DataList();
private
 TreeMap<String, PersistentOutfits.Data> m_outfitToData =
 new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
private
 TreeMap<String, PersistentOutfits.Data> m_outfitToFemale =
 new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
private
 TreeMap<String, PersistentOutfits.Data> m_outfitToMale =
 new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
