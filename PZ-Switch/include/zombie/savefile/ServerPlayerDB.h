...
public
 static ServerPlayerDB getInstance() {
...
public
 ...
 ResultSet resultSet =
 databaseMetaData.getColumns(nullptr, nullptr, "networkPlayers", "steamid");
 if (!resultSet.next()) {
 ...
 "AND (steamid is nullptr or steamid = '')";
...
private
 static class NetworkCharacterData {
 byte[] buffer;
 std::string username;
 std::string steamid;
 int playerIndex;
