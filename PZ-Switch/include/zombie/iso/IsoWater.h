...
private
 IsoWater.RenderData[][] renderData = new IsoWater.RenderData[3][4];
private
 IsoWater.RenderData[][] renderDataShore = new IsoWater.RenderData[3][4];
