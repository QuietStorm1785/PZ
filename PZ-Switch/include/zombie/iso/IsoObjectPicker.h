...
public:
 ...
 static ArrayList<IsoObjectPicker.ClickObject> choices =
 std::make_unique<ArrayList<>>();
 static const Vector2 tempo = new Vector2();
 static const Vector2 tempo2 = new Vector2();
 static Comparator<IsoObjectPicker.ClickObject> comp =
...
int maxcount = 0;
public
 ArrayList<IsoObjectPicker.ClickObject> ThisFrame =
 std::make_unique<ArrayList<>>();
bool dirty = true;
