...
public:
public
 ArrayList<IsoMetaGrid.VehicleZone> vehicleZones =
 std::make_unique<ArrayList<>>();
public
 IsoMetaChunk[] ChunkMap = new IsoMetaChunk[900];
 LotHeader info = nullptr;
public
 ArrayList<IsoMetaGrid.Trigger> triggers =
 std::make_unique<ArrayList<>>();
 int wx = 0;
 int wy = 0;
public
 ArrayList<IsoMannequin.MannequinZone> mannequinZones =
 std::make_unique<ArrayList<>>();
public
 ArrayList<IsoMetaGrid.RoomTone> roomTones =
 std::make_unique<ArrayList<>>();
