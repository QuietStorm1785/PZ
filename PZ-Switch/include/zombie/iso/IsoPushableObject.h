...
public
 ArrayList<IsoPushableObject> connectList = nullptr;
 float ox = 0.0F;
 float oy = 0.0F;
...
public
 ...
 std::string getObjectName() { return "Pushable"; }
 ...
 return float0 > 1.0F ? this->getWeight() * 8.0F
 : this->getWeight() * float0 + this->emptyWeight;
 }
 }
