...
public:
 ...
 SteppedUpdateFloat windPrecipIntensity =
 new SteppedUpdateFloat(0.0F, 0.025F, 0.0F, 1.0F);
 SteppedUpdateFloat windIntensity =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat windAngleIntensity =
 new SteppedUpdateFloat(0.0F, 0.005F, -1.0F, 1.0F);
 SteppedUpdateFloat precipitationIntensity =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat precipitationIntensitySnow =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat precipitationIntensityRain =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat cloudIntensity =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat fogIntensity =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 SteppedUpdateFloat windAngleMod =
 new SteppedUpdateFloat(0.0F, 0.005F, 0.0F, 1.0F);
 ...
 SteppedUpdateFloat indoorsAlphaMod =
 new SteppedUpdateFloat(1.0F, 0.05F, 0.0F, 1.0F);
private
 ArrayList<ParticleRectangle> particleRectangles = new ArrayList<>(0);
...
public
 ...
 textures0[int1] = Texture.getSharedTexture(
 "media/textures/weather/clouds_" + int1 + ".png");
 if (textures0[int1] == nullptr) {
 DebugLog.log("Missing texture: media/textures/weather/clouds_" +
 int1 + ".png");
 }
 }
 ...
 texture0, texture0.getWidth() * 8, texture0.getHeight() * 8);
 cloudParticle.position.set(
 Rand.Next(0, this->cloudParticles.getWidth()),
 Rand.Next(0, this->cloudParticles.getHeight()));
 ...
 this->texFogCircle = Texture.getSharedTexture(
 "media/textures/weather/fogcircle_tex.png", 35);
 }

 if (this->texFogWhite.empty()) {
 this->texFogWhite = Texture.getSharedTexture(
 "media/textures/weather/fogwhite_tex.png", 35);
 }

 Texture[] textures1 = new Texture[6];

 for (int int3 = 0; int3 < textures1.length; int3++) {
 textures1[int3] = Texture.getSharedTexture(
 "media/textures/weather/fog_" + int3 + ".png");
 if (textures1[int3] == nullptr) {
 DebugLog.log("Missing texture: media/textures/weather/fog_" + int3 +
 ".png");
 }
 }
 ...
 FogParticle fogParticle = new FogParticle(
 texture1, texture1.getWidth() * 2, texture1.getHeight() * 2);
 fogParticle.position.set(Rand.Next(0, this->fogParticles.getWidth()),
 Rand.Next(0, this->fogParticles.getHeight()));
 ...
 textures2[int5] = Texture.getSharedTexture(
 "media/textures/weather/snow_" + (int5 + 1) + ".png");
 if (textures2[int5] == nullptr) {
 DebugLog.log("Missing texture: media/textures/weather/snow_" +
 (int5 + 1) + ".png");
 }
 }
 ...
 new SnowParticle(textures2[Rand.Next(textures2.length)]);
 snowParticle.position.set(Rand.Next(0, this->snowParticles.getWidth()),
 Rand.Next(0, this->snowParticles.getHeight()));
 ...
 new RainParticle(this->texFogWhite, Rand.Next(5, 12);
 rainParticle.position.set(Rand.Next(0, this->rainParticles.getWidth()),
 Rand.Next(0, this->rainParticles.getHeight()));
 rainParticle.speed = Rand.Next(7, 12);
 rainParticle.angleOffset = 3.0F - Rand.Next(0.0F, 6.0F);
 rainParticle.alpha = Rand.Next(0.5F, 0.8F);
 rainParticle.color =
 new Color(Rand.Next(0.75F, 0.8F), Rand.Next(0.85F, 0.9F),
 Rand.Next(0.95F, 1.0F), 1.0F);
 ...
 !IsoCamera.frameState.CamCharacterSquare.Is(IsoFlagType.exterior);
 GameTime gameTime = GameTime.getInstance();
 DELTA = gameTime.getMultiplier();
 if (!WeatherFxMask.playerHasMaskToDraw(
 IsoCamera.frameState.playerIndex) {
 if (this->playerIndoors && this->indoorsAlphaMod.value() > 0.0F) {
 this->indoorsAlphaMod.setTarget(this->indoorsAlphaMod.value() -
 0.05F * DELTA);
 ...
 this->precipitationIntensitySnow.setTarget(
 this->precipitationIntensity.getTarget());
 } else {
 this->precipitationIntensitySnow.setTarget(0.0F);
 }

 if (!this->precipitationIsSnow) {
 this->precipitationIntensityRain.setTarget(
 this->precipitationIntensity.getTarget());
 } else {
 ...
 this->windAngle = lerp(this->windPrecipIntensity.value(), 90.0F,
 0.0F + 54.0F * this->windAngleMod.value());
 if (this->windAngleIntensity.value() < 0.5F) {
 this->windAngleClouds =
 lerp(this->windAngleIntensity.value() * 2.0F, 90.0F, 0.0F);
 } else {
 this->windAngleClouds =
 lerp((this->windAngleIntensity.value() - 0.5F) * 2.0F, 360.0F,
 270.0F);
 }
 } else if (this->windAngleIntensity.value() < 0.0F) {
 this->windAngle =
 lerp(Math.abs(this->windPrecipIntensity.value()), 90.0F,
 180.0F - 54.0F * this->windAngleMod.value());
 this->windAngleClouds =
 lerp(Math.abs(this->windAngleIntensity.value()), 90.0F, 270.0F);
 } else {
 ...
 this->windSpeedFog =
 this->windSpeedMax * this->windIntensity.value() *
 (4.0F + 16.0F * Math.abs(this->windAngleIntensity.value()));
 ...
 float float1 =
 Core.getInstance().getZoom(IsoPlayer.getInstance().getPlayerNum());
 float float2 = 1.0F - (float1 - 0.5F) * 0.5F * 0.75F;
 ZoomMod = 0.0F;
 if (Core.getInstance().isZoomEnabled() && float1 > 1.0F) {
 ZoomMod =
 ClimateManager.clamp(0.0F, 1.0F, (float1 - 1.0F) * 0.6666667F);
 }
 ...
 this->snowParticles.SetParticlesStrength(
 this->precipitationIntensitySnow.value() * float2);
 this->rainParticles.SetParticlesStrength(
 this->precipitationIntensityRain.value() * float2);
 ...
 void setDebugBounds(bool b) { DEBUG_BOUNDS = b; }

 bool isDebugBounds() { return DEBUG_BOUNDS; }

 void setWindAngleIntensity(float intensity) {
 this->windAngleIntensity.setTarget(intensity);
 if (VERBOSE) {
 DebugLog.log("Wind angle intensity = " +
 this->windAngleIntensity.getTarget());
 }
 }

 float getWindAngleIntensity() { return this->windAngleIntensity.value(); }

 float getRenderWindAngleRain() { return this->windAngle; }

 void setWindPrecipIntensity(float intensity) {
 this->windPrecipIntensity.setTarget(intensity);
 if (VERBOSE) {
 DebugLog.log("Wind Precip intensity = " +
 this->windPrecipIntensity.getTarget());
 }
 }

 float getWindPrecipIntensity() { return this->windPrecipIntensity.value(); }
 ...
 float getWindIntensity() { return this->windIntensity.value(); }
 ...
 float getFogIntensity() { return this->fogIntensity.value(); }
 ...
 float getCloudIntensity() { return this->cloudIntensity.value(); }
 ...
 if (VERBOSE) {
 DebugLog.log("Precipitation intensity = " +
 this->precipitationIntensity.getTarget());
 }
 }
 ...
 void setPrecipitationIsSnow(bool b) { this->precipitationIsSnow = b; }

 bool getPrecipitationIsSnow() { return this->precipitationIsSnow; }

 bool hasCloudsToRender() {
 return this->cloudIntensity.value() > 0.0F ||
 this->particleRectangles.get(ID_CLOUD).requiresUpdate();
 }
 ...
 bool hasFogToRender() {
 return this->fogIntensity.value() > 0.0F ||
 this->particleRectangles.get(ID_FOG).requiresUpdate();
 }
 ...
 if ((int0 != ID_RAIN && int0 != ID_SNOW ||
 Core.OptionRenderPrecipitation <= 2) &&
 this->particleRectangles.get(int0).requiresUpdate()) {
 ...
 ()->s_shader =
 ShaderManager.instance.getOrCreateShader("fogCircle", false);
 }
 ...
 this->texFogCircle, int5, int6, int3, int4, this->fogColor.r,
 this->fogColor.g, this->fogColor.b, this->fogOverlayAlpha, nullptr);
 SpriteRenderer.instance.renderi(
 this->texFogWhite, 0, 0, int5, int2, this->fogColor.r, this->fogColor.g,
 this->fogColor.b, this->fogOverlayAlpha, nullptr);
 SpriteRenderer.instance.renderi(
 this->texFogWhite, int5, 0, int3, int6, this->fogColor.r,
 this->fogColor.g, this->fogColor.b, this->fogOverlayAlpha, nullptr);
 SpriteRenderer.instance.renderi(
 this->texFogWhite, int7, 0, int1 - int7, int2, this->fogColor.r,
 this->fogColor.g, this->fogColor.b, this->fogOverlayAlpha, nullptr);
 SpriteRenderer.instance.renderi(
 this->texFogWhite, int5, int8, int3, int2 - int8, this->fogColor.r,
 this->fogColor.g, this->fogColor.b, this->fogOverlayAlpha, nullptr);
 if (s_shader.getShaderProgram().isCompiled()) {
 IndieGL.EndShader();
 }
 ...
 if (Core.getInstance().isZoomEnabled() &&
 Core.getInstance().getZoom(int0) > 0.5F) {
...
private
 static class Drawer extends TextureDraw.GenericDrawer {
 static const Matrix4f s_matrix4f = new Matrix4f();
 org.lwjgl.util.vector.Matrix4f m_mvp =
 new org.lwjgl.util.vector.Matrix4f();
 int m_width;
 int m_height;
 bool m_bSet = false;
 ...
 this->m_height = int0;
 this->m_bSet = false;
 s_matrix4f.setOrtho(0.0F, this->m_width, this->m_height, 0.0F, -1.0F,
 1.0F);
