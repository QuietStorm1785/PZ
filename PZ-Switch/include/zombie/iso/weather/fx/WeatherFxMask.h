...
public:
 ...
 bool enabled;
private
 static WeatherFxMask.PlayerFxMask[] playerMasks =
 new WeatherFxMask.PlayerFxMask[4];
...
private
 static IsoGameCharacter.TorchInfo tmpTorch = new IsoGameCharacter.TorchInfo();
 static ColorInfo tmpColInfo = new ColorInfo();
private
 static int[] test =
 new int[]{0, 1, 768, 769, 774, 775, 770, 771, 772, 773,
 32769, 32770, 32771, 32772, 776, 35065, 35066, 34185, 35067};
private
 static String[] testNames = new String[]{"GL_ZERO",
 "GL_ONE",
 "GL_SRC_COLOR",
 ...
 static TextureFBO getFboMask() { return fboMask; }

 static TextureFBO getFboParticles() { return fboParticles; }
 ...
 playerMasks[0].init();
 initGlIds();
 floorSprite = IsoSpriteManager.instance.getSprite(
 "floors_interior_tilesandwood_01_16");
 wallNSprite =
 IsoSpriteManager.instance.getSprite("walls_interior_house_01_21");
 wallWSprite =
 IsoSpriteManager.instance.getSprite("walls_interior_house_01_20");
 wallNWSprite =
 IsoSpriteManager.instance.getSprite("walls_interior_house_01_22");
 wallSESprite =
 IsoSpriteManager.instance.getSprite("walls_interior_house_01_23");
 texWhite =
 Texture.getSharedTexture("media/textures/weather/fogwhite.png");
 }
 }
 ...
 if (fboMask != nullptr && fboParticles != nullptr &&
 fboMask.getTexture().getWidth() == int0 &&
 fboMask.getTexture().getHeight() == int1) {
 ...
 IsoCamera.frameState.OffscreenHeight);
 }
 }
 ...
 return square != nullptr && (square.Has(IsoObjectType.stairsBN) ||
 ...
 (square.Is(IsoFlagType.cutN) ||
 square.Is(IsoFlagType.cutW) &&
 ...
 static void addMaskLocation(IsoGridSquare square0, int int1, int int2,
 int int0) {
 if (!GameServer.bServer) {
 ...
 IsoGridSquare square1 = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int1, int2 - 1, int0);
 bool boolean0 = !isInPlayerBuilding(square1, int1, int2 - 1, int0);
 square1 = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int1 - 1, int2, int0);
 bool boolean1 = !isInPlayerBuilding(square1, int1 - 1, int2, int0);
 square1 = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int1 - 1, int2 - 1, int0);
 bool boolean2 =
 !isInPlayerBuilding(square1, int1 - 1, int2 - 1, int0);
 uint8_t byte0 = 0;
 if (boolean0) {
 byte0 |= 1;
 }
 ...
 uint8_t byte1 = 24;
 if (boolean0 && !square0.getProperties().Is(IsoFlagType.WallN) &&
 ...
 playerFxMask.addMask(int1 + 1, int2, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1 + 2, int2, int0, nullptr, 8, false);
 playerFxMask.addMask(int1, int2 + 1, int0, nullptr, 8, false);
 playerFxMask.addMask(int1 + 1, int2 + 1, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1 + 2, int2 + 1, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1 + 2, int2 + 2, int0, nullptr, 16,
 false);
 playerFxMask.addMask(int1 + 3, int2 + 2, int0, nullptr, 16,
 false);
 boolean3 = true;
 }

 if (boolean1 && !square0.getProperties().Is(IsoFlagType.WallW) &&
 !square0.getProperties().Is(IsoFlagType.WallNW) {
 playerFxMask.addMask(int1, int2 - 1, int0, nullptr, 8, false);
 playerFxMask.addMask(int1, int2, int0, square0, byte1);
 playerFxMask.addMask(int1, int2 + 1, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1, int2 + 2, int0, nullptr, 8, false);
 playerFxMask.addMask(int1 + 1, int2, int0, nullptr, 8, false);
 playerFxMask.addMask(int1 + 1, int2 + 1, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1 + 1, int2 + 2, int0, nullptr, byte1,
 false);
 playerFxMask.addMask(int1 + 2, int2 + 2, int0, nullptr, 16,
 false);
 playerFxMask.addMask(int1 + 2, int2 + 3, int0, nullptr, 16,
 false);
 boolean3 = true;
 }
 ...
 IsoGridSquare square2 = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int1, int2 - 1, int0);
 bool boolean5 = isInPlayerBuilding(square2, int1, int2 - 1, int0);
 square2 = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int1 - 1, int2, int0);
 ...
 static bool isInPlayerBuilding(IsoGridSquare square, int int0, int int1,
 int int2) {
 WeatherFxMask.PlayerFxMask playerFxMask = playerMasks[curPlayerIndex];
 if (square != nullptr && square.Is(IsoFlagType.solidfloor) {
 if (square.getBuilding() != nullptr &&
 square.getBuilding() == playerFxMask.player.getBuilding()) {
 return true;
 }
 ...
 (square.getIsoWorldRegion() == playerFxMask.curIsoWorldRegion ||
 playerFxMask.curConnectedRegions.contains(
 square.getIsoWorldRegion()));
 }
 } else {
 ...
 IsoRegions.getIsoWorldRegion(int0, int1, int2);
 return iWorldRegion != nullptr && iWorldRegion.isFogMask() &&
 (iWorldRegion == playerFxMask.curIsoWorldRegion ||
 playerFxMask.curConnectedRegions.contains(iWorldRegion);
 }
 }
 ...
 IsoGridSquare square = IsoWorld.instance.getCell()
 .getChunkMap(curPlayerIndex)
 .getGridSquare(int2, int3, int0);
 if (square != nullptr) {
 if (square.getBuilding() != nullptr &&
 square.getBuilding() == playerFxMask.player.getBuilding()) {
 return true;
 ...
 if (vector2i != nullptr) {
 IsoGridSquare square = chunkMap.getGridSquare(
 vector2i.x + int6, vector2i.y + int4, int1);
 if (square.empty()) {
 addMaskLocation(nullptr, vector2i.x + int6, vector2i.y + int4,
 int1);
 } else {
 IsoChunk chunk = square.getChunk();
 if (chunk != nullptr && square.IsOnScreen()) {
 addMaskLocation(square, vector2i.x + int6, vector2i.y + int4,
 int1);
 }
 }
 }
 ...
 floorSprite.render(nullptr, int2, int1, int0, IsoDirections.N, offsetX,
 offsetY, defColorInfo, false);
 }

 static void renderMaskWall(IsoGridSquare square0, int var1x, int var2x,
 int var3x, bool boolean3, bool boolean4,
 int int0) {
 if (square0 != nullptr) {
 ...
 bool boolean0 =
 square1 != nullptr && square1.getPlayerCutawayFlag(int0, long0);
 bool boolean1 = square0.getPlayerCutawayFlag(int0, long0);
 bool boolean2 =
 square2 != nullptr && square2.getPlayerCutawayFlag(int0, long0);
 IsoSprite sprite;
 ...
 square0.DoCutawayShaderSprite(sprite, directions, boolean0, boolean1,
 boolean2);
 }
 }

 static void renderMaskWallNoCuts(int int2, int int1, int int0, bool boolean0,
 bool boolean1) {
 if (boolean0 && boolean1) {
 wallNWSprite.render(nullptr, int2, int1, int0, IsoDirections.N, offsetX,
 offsetY, defColorInfo, false);
 } else if (boolean0) {
 wallNSprite.render(nullptr, int2, int1, int0, IsoDirections.N, offsetX,
 offsetY, defColorInfo, false);
 } else if (boolean1) {
 wallWSprite.render(nullptr, int2, int1, int0, IsoDirections.N, offsetX,
 offsetY, defColorInfo, false);
 } else {
 wallSESprite.render(nullptr, int2, int1, int0, IsoDirections.N, offsetX,
 offsetY, defColorInfo, false);
 }
 }
 ...
 WeatherFxMask.PlayerFxMask playerFxMask =
 playerMasks[curPlayerIndex];
 ...
 SpriteRenderer.instance.glBlendFunc(SCR_MASK_SUB,
 DST_MASK_SUB);
 ...
 renderMaskWall(weatherFxMask.gs, weatherFxMask.x,
 weatherFxMask.y, weatherFxMask.z,
 boolean2, boolean3, int0);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 ...
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 SpriteRenderer.instance.glBlendFunc(SCR_MASK_ADD,
 DST_MASK_ADD);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = false;
 ...
 DST_MASK_ADD);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = false;
 renderMaskFloor(weatherFxMask.x, weatherFxMask.y,
 weatherFxMask.z);
 ...
 renderMaskWall(weatherFxMask.gs,
 weatherFxMask.x, weatherFxMask.y,
 weatherFxMask.z, false, false,
 int0);
 }
 } else {
 renderMaskWall(weatherFxMask.gs, weatherFxMask.x,
 weatherFxMask.y, weatherFxMask.z,
 boolean6, boolean7, int0);
 }
 }

 if (boolean1 && weatherFxMask.gs != nullptr) {
 weatherFxMask.gs.RenderMinusFloorFxMask(
 weatherFxMask.z + 1, false, false);
 }

 if (boolean5 && weatherFxMask.gs != nullptr) {
 weatherFxMask.gs.renderCharacters(
 weatherFxMask.z + 1, false, false);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 SpriteRenderer.instance.glBlendFunc(SCR_MASK_ADD,
 DST_MASK_ADD);
 ...
 if (!RenderSettings.getInstance()
 .getPlayerSettings(int0)
 .isExterior()) {
 ...
 PerformanceSettings.FogQuality == 2) {
 drawFxLayered(int0, false, true, false);
 }

 if (Core.OptionRenderPrecipitation == 1 &&
 IsoWeatherFX.instance.hasPrecipitationToRender()) {
 ...
 if (IsoWorld.instance.getCell() != nullptr &&
 IsoWorld.instance.getCell().getWeatherFX() != nullptr) {
 SpriteRenderer.instance.glIgnoreStyles(true);
 SpriteRenderer.instance.glBlendFunc(770, 771);
 ...
 static void drawFxLayered(int int1, bool boolean2, bool boolean1,
 bool boolean0) {
 ...
 Color color =
 RenderSettings.getInstance().getMaskClearColorForPlayer(int1);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 SpriteRenderer.instance.glBlendFuncSeparate(SCR_PARTICLES, DST_PARTICLES,
 1, 771);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = false;
 SpriteRenderer.instance.renderi(texWhite, 0, 0, int3, int4, color.r,
 color.g, color.b, color.a, nullptr);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 } else if (IsoWorld.instance.getCell() != nullptr &&
 IsoWorld.instance.getCell().getWeatherFX() != nullptr) {
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 SpriteRenderer.instance.glBlendFuncSeparate(SCR_PARTICLES, DST_PARTICLES,
 1, 771);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = false;
 IsoWorld.instance.getCell().getWeatherFX().renderLayered(
 boolean2, boolean1, boolean0);
 SpriteRenderer.GL_BLENDFUNC_ENABLED = true;
 }
 ...
 SpriteRenderer.instance.glBlendEquation(32779);
 ((Texture)fboMask.getTexture())
 .rendershader2(0.0F, 0.0F, int3, int4, int5, int6, int7, int8, 1.0F,
 1.0F, 1.0F, 1.0F);
 SpriteRenderer.instance.glBlendEquation(32774);
 }
 ...
 texture, 0.0F, 0.0F, int3, int4, float0, float1, float2, float3, float4,
 float7, float6, float7, float6, float5, float4, float5);
 }
 ...
 DebugLog.log("DEBUG_MASK_AND_PARTICLES = " +
 DEBUG_MASK_AND_PARTICLES);
 } else if (boolean4) {
 ...
 DebugLog.log("Blendmode = " + testNames[var1] + " -> " +
 testNames[var2]);
 }
...
public
 ...
 private
 ArrayList<IWorldRegion> curConnectedRegions =
 std::make_unique<ArrayList<>>();
 private
 ArrayList<IWorldRegion> isoWorldRegionTemp =
 std::make_unique<ArrayList<>>();
 ...
 if (this->isFirstSquare || this->plrSquare.empty() ||
 ...
 if (this->curIsoWorldRegion != nullptr &&
 this->player.getMasterRegion().isFogMask()) {
 ...
 if ((this->player.getSquare() == nullptr ||
 this->player.getSquare().getBuilding() == nullptr &&
 this->player.getSquare().Is(IsoFlagType.exterior) &&
 (this->curIsoWorldRegion.empty() ||
 !this->curIsoWorldRegion.isFogMask())) {
 this->hasMaskToDraw = false;
 } else {
 this->hasMaskToDraw = true;
 }
 ...
 weatherFxMask0.enabled =
 weatherFxMask0.enabled ? weatherFxMask0.enabled : boolean0;
 ...
 int int0 = this->maskPointer - 1 -
 (WeatherFxMask.DIAMOND_ROWS + this->DISABLED_MASKS);
 if (int0 < 0) {
 int0 = 0;
 }
