...
public
 ...
 RenderSettings.getInstance().getPlayerSettings(int0);
 IsoPlayer player = IsoPlayer.players[int0];
 bool boolean0 = playerRenderSettings.isExterior();
 float float0 = GameTime.instance.TimeOfDay / 12.0F - 1.0F;
 if (Math.abs(float0) > 0.8F && player != nullptr &&
 player.Traits.NightVision.isSet() &&
 !player.isWearingNightVisionGoggles()) {
 float0 *= 0.8F;
 }
 ...
 textureDraw.vars[5] =
 playerRenderSettings.isApplyNightVisionGoggles() ? 1.0F : 0.0F;
 SearchMode.PlayerSearchMode playerSearchMode =
 SearchMode.getInstance().getSearchModeForPlayer(int0);
 ...
 textureDraw.vars[16] = playerSearchMode.getShaderGradientWidth() *
 textureDraw.vars[15] / 2.0F;
 ...
 Core.getInstance().getZoom(int0) < 2.0 &&
 Core.getInstance().getZoom(int0) >= 1.75F;
 }
 }
 ...
 ARBShaderObjects.glUniform3fARB(this->Light, textureDraw.vars[0],
 textureDraw.vars[1], textureDraw.vars[2]);
 ...
 ARBShaderObjects.glUniform1fARB(this->NightVisionGoggles,
 textureDraw.vars[5]);
 ...
 ARBShaderObjects.glUniform4fARB(this->SearchModeID, textureDraw.vars[6],
 textureDraw.vars[7], textureDraw.vars[8],
 textureDraw.vars[9]);
 ARBShaderObjects.glUniform4fARB(this->ScreenInfo, textureDraw.vars[10],
 textureDraw.vars[11], textureDraw.vars[12],
 textureDraw.vars[13]);
 ARBShaderObjects.glUniform4fARB(this->ParamInfo, textureDraw.vars[14],
 textureDraw.vars[15], textureDraw.vars[16],
 textureDraw.vars[17]);
 ARBShaderObjects.glUniform4fARB(this->VarInfo, textureDraw.vars[18],
 textureDraw.vars[19], textureDraw.vars[20],
 textureDraw.vars[21]);
 }
 ...
 int int0 = this->getID();
 this->timeOfDay =
 ARBShaderObjects.glGetUniformLocationARB(int0, "TimeOfDay");
 this->bloom = ARBShaderObjects.glGetUniformLocationARB(int0, "BloomVal");
 this->PixelOffset =
 ARBShaderObjects.glGetUniformLocationARB(int0, "PixelOffset");
 this->PixelSize =
 ARBShaderObjects.glGetUniformLocationARB(int0, "PixelSize");
 this->BlurStrength =
 ARBShaderObjects.glGetUniformLocationARB(int0, "BlurStrength");
 this->width = ARBShaderObjects.glGetUniformLocationARB(
 int0, "bgl_RenderedTextureWidth");
 this->height = ARBShaderObjects.glGetUniformLocationARB(
 int0, "bgl_RenderedTextureHeight");
 this->timer = ARBShaderObjects.glGetUniformLocationARB(int0, "timer");
 this->TextureSize =
 ARBShaderObjects.glGetUniformLocationARB(int0, "TextureSize");
 ...
 this->LightIntensity =
 ARBShaderObjects.glGetUniformLocationARB(int0, "LightIntensity");
 this->NightValue =
 ARBShaderObjects.glGetUniformLocationARB(int0, "NightValue");
 this->Exterior = ARBShaderObjects.glGetUniformLocationARB(int0, "Exterior");
 this->NightVisionGoggles =
 ARBShaderObjects.glGetUniformLocationARB(int0, "NightVisionGoggles");
 this->DesaturationVal =
 ARBShaderObjects.glGetUniformLocationARB(int0, "DesaturationVal");
 this->FogMod = ARBShaderObjects.glGetUniformLocationARB(int0, "FogMod");
 this->SearchModeID =
 ARBShaderObjects.glGetUniformLocationARB(int0, "SearchMode");
 this->ScreenInfo =
 ARBShaderObjects.glGetUniformLocationARB(int0, "ScreenInfo");
 this->ParamInfo =
 ARBShaderObjects.glGetUniformLocationARB(int0, "ParamInfo");
...
private
 static float[] getFreeFloatArray() {
