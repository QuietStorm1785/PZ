...
public:
 ...
 int version = 0;
public
 HashMap<Integer, RoomDef> Rooms = std::make_unique<HashMap<>>();
public
 TLongObjectHashMap<RoomDef> RoomByMetaID =
 std::make_unique<TLongObjectHashMap<>>();
public
 ArrayList<RoomDef> RoomList = std::make_unique<ArrayList<>>();
public
 ArrayList<BuildingDef> Buildings = std::make_unique<ArrayList<>>();
public
 TLongObjectHashMap<BuildingDef> BuildingByMetaID =
 std::make_unique<TLongObjectHashMap<>>();
public
 HashMap<Integer, IsoRoom> isoRooms = std::make_unique<HashMap<>>();
public
 HashMap<Integer, IsoBuilding> isoBuildings =
 std::make_unique<HashMap<>>();
 bool bFixed2x;
protected
 ArrayList<String> tilesUsed = std::make_unique<ArrayList<>>();
