...
private
 static ArrayList<ContainerOverlays.ContainerOverlayEntry> tempEntries =
 std::make_unique<ArrayList<>>();
private
 THashMap<String, ContainerOverlays.ContainerOverlay> overlayMap =
...
private
 static class ContainerOverlay {
 std::string name;
 public
 ArrayList<ContainerOverlays.ContainerOverlayEntry> entries =
 std::make_unique<ArrayList<>>();
