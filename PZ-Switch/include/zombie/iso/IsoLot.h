...
public:
public
 static HashMap<String, LotHeader> InfoHeaders =
 std::make_unique<HashMap<>>();
public
 static ArrayList<String> InfoHeaderNames =
 std::make_unique<ArrayList<>>();
public
 static HashMap<String, String> InfoFileNames =
 std::make_unique<HashMap<>>();
public
 static ObjectPool<IsoLot> pool = new ObjectPool<>(IsoLot::new);
...
public
 static IsoLot get(Integer cX, Integer cY, Integer wX, Integer wY,
 IsoChunk ch) {
