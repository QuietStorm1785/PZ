...
public
 ...
 this->PuddlesHM =
 ARBShaderObjects.glGetUniformLocationARB(int0, "PuddlesHM");
 ...
 this->PuddlesParams =
 ARBShaderObjects.glGetUniformLocationARB(int0, "PuddlesParams");
 this->Start();
 ...
 ARBShaderObjects.glUniform1fARB(this->WaterReflectionParam,
 skyBox.getTextureShift());
 ARBShaderObjects.glUniformMatrix4fvARB(this->PuddlesParams, true,
 puddles.getPuddlesParams(int1);
 }
}
} // namespace iso
} // namespace zombie
