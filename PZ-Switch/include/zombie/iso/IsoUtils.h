...
public:
 ...
 return (float)Math.sqrt(Math.pow(toX - fromX, 2.0) +
 ...
 static float DistanceTo(float fromX, float fromY, float fromZ, float toX,
 float toY, float toZ) {
 return (float)Math.sqrt(Math.pow(toX - fromX, 2.0) +
 Math.pow(toY - fromY, 2.0) +
 Math.pow(toZ - fromZ, 2.0);
 }

 static float DistanceToSquared(float fromX, float fromY, float fromZ,
 float toX, float toY, float toZ) {
 return (float)(Math.pow(toX - fromX, 2.0) + Math.pow(toY - fromY, 2.0) +
 Math.pow(toZ - fromZ, 2.0);
 }

 static float DistanceToSquared(float fromX, float fromY, float toX,
 float toY) {
 return (float)(Math.pow(toX - fromX, 2.0) + Math.pow(toY - fromY, 2.0);
 }

 static float DistanceManhatten(float fromX, float fromY, float toX,
 float toY) {
 ...
 return Math.abs(toX - fromX) + Math.abs(toY - fromY) +
 Math.abs(toZ - fromZ) * 2.0F;
 }

 static float DistanceManhattenSquare(float fromX, float fromY, float toX,
 float toY) {
 ...
 float float0 =
 screenX + (int)IsoCamera.cameras[IsoPlayer.getPlayerIndex()].OffX;
 float float1 =
 screenY + (int)IsoCamera.cameras[IsoPlayer.getPlayerIndex()].OffY;
 float float2 = (float0 + 2.0F * float1) / (64.0F * Core.TileScale);
 float float3 = (float0 - 2.0F * float1) / (-64.0F * Core.TileScale);
 float2 += 3 * floor;
 float3 += 3 * floor;
 ...
 static float XToScreen(float objectX, float objectY, float objectZ,
 int screenZ) {
 float float0 = 0.0F;
 ...
 static float XToScreenInt(int objectX, int objectY, int objectZ,
 int screenZ) {
 return XToScreen();
 }

 static float YToScreenExact(float objectX, float objectY, float objectZ,
 int screenZ) {
 float float0 = YToScreen(objectX, objectY, objectZ, screenZ);
 return float0 - IsoCamera.getOffY();
 }

 static float XToScreenExact(float objectX, float objectY, float objectZ,
 int screenZ) {
 ...
 static float YToScreen(float objectX, float objectY, float objectZ,
 int screenZ) {
 float float0 = 0.0F;
 ...
 static float YToScreenInt(int objectX, int objectY, int objectZ,
 int screenZ) {
 return YToScreen();
 }

 static bool isSimilarDirection(IsoGameCharacter chr, float xA, float yA,
