...
private
 static ThreadLocal<IsoGameCharacter.Location> TL_Location =
 ThreadLocal.withInitial(IsoGameCharacter.Location::new);
private
 static ThreadLocal<ArrayList<IsoMetaGrid.Zone>> TL_ZoneList =
...
private
 ArrayList<IsoMetaGrid.Zone> tempZones1 =
 std::make_unique<ArrayList<>>();
private
 ArrayList<IsoMetaGrid.Zone> tempZones2 =
 std::make_unique<ArrayList<>>();
private
 IsoMetaGrid.MetaGridLoaderThread[] threads =
 ...
 int maxY = -10000000;
public
 ArrayList<IsoMetaGrid.Zone> Zones = std::make_unique<ArrayList<>>();
public
 ArrayList<BuildingDef> Buildings = std::make_unique<ArrayList<>>();
public
 ArrayList<IsoMetaGrid.VehicleZone> VehiclesZones =
 std::make_unique<ArrayList<>>();
public
 IsoMetaCell[][] Grid;
public
 ArrayList<IsoGameCharacter> MetaCharacters =
 std::make_unique<ArrayList<>>();
...
public
 ...
 double0.empty() ? 0 : double0.intValue());
 tIntArrayList.clear();
 return zone0;
 }
 else {
 ...
 return metaCell = = nullptr ? nullptr
...
Vector2 getRandomIndoorCoord() { return nullptr; }
...
RoomDef getRandomRoomBetweenRange(float x, float y, float min, float max) {
 ...
 return !roomChoices.empty() ? roomChoices.get(Rand.Next(roomChoices.size()))
 : nullptr;
}
...
public
 HashMap<String, Integer> spawnedZombies = std::make_unique<HashMap<>>();
...
public
 ...
 static PolygonalMap2.LiangBarsky LIANG_BARSKY =
...
public
 ...
 IsoGridSquare getRandomUnseenSquareInZone() { return nullptr; }

 void addSquare(IsoGridSquare var1) {}

public
 ArrayList<IsoGridSquare> getSquares() { return nullptr; }
