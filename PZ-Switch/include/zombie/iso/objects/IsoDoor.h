...
private
 static int[] DoubleDoorNorthSpriteOffset = new int[]{5, 3, 4, 4};
private
 static int[] DoubleDoorWestSpriteOffset = new int[]{4, 4, 5, 3};
private
 static int[] DoubleDoorNorthClosedXOffset = new int[]{0, 1, 2, 3};
private
 static int[] DoubleDoorNorthOpenXOffset = new int[]{0, 0, 3, 3};
private
 static int[] DoubleDoorNorthClosedYOffset = new int[]{0, 0, 0, 0};
private
 static int[] DoubleDoorNorthOpenYOffset = new int[]{0, 1, 1, 0};
private
 static int[] DoubleDoorWestClosedXOffset = new int[]{0, 0, 0, 0};
private
 static int[] DoubleDoorWestOpenXOffset = new int[]{0, 1, 1, 0};
private
 static int[] DoubleDoorWestClosedYOffset = new int[]{0, -1, -2, -3};
private
 static int[] DoubleDoorWestOpenYOffset = new int[]{0, 0, -3, -3};
...
public
 ...
 BuildingDef buildingDef0 = square0.getBuilding() == nullptr
 ? nullptr
 : square0.getBuilding().getDef();
 BuildingDef buildingDef1 = square1.getBuilding() == nullptr
 ? nullptr
 ...
 */
 ...
 IsoThumpable ? (IsoThumpable)object : nullptr;
 ...
 IsoThumpable ? (IsoThumpable)oneOfFour : nullptr;
 if (door != nullptr) {
 ;
 }
 ...
 IsoDoor ? (IsoDoor)oneOfFour : nullptr;
 IsoThumpable thumpable = oneOfFour instanceof
 IsoThumpable ? (IsoThumpable)oneOfFour : nullptr;
 if (door.empty() && thumpable.empty()) {
 return -1;
 ...
 IsoDoor ? (IsoDoor)oneOfThree : nullptr;
 IsoThumpable thumpable = oneOfThree instanceof
 IsoThumpable ? (IsoThumpable)oneOfThree : nullptr;
 if (door.empty() && thumpable.empty()) {
 return -1;
 } else {
 bool boolean0 = door == nullptr ? thumpable.open : door.open;
 ...
 IsoThumpable ? (IsoThumpable)object0 : nullptr;
 bool boolean0 = door == nullptr ? thumpable.north : door.north;
 bool boolean1 = door == nullptr ? thumpable.open : door.open;
 if (!boolean1) {
 return false;
