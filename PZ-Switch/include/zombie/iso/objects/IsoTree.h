...
public:
 ...
 float fadeAlpha;
private
 static IsoGameCharacter.Location[] s_chopTreeLocation =
 new IsoGameCharacter.Location[4];
private
 static ArrayList<IsoGridSquare> s_chopTreeIndicators =
...
public
 ...
 public
 static IsoTree.TreeShader instance = new IsoTree.TreeShader();
