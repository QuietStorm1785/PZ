...
private
 static ObjectRenderEffects[][] WIND_EFFECTS =
 new ObjectRenderEffects[3][15];
private
 static ObjectRenderEffects[][] WIND_EFFECTS_TREES =
 new ObjectRenderEffects[3][15];
private
 static ArrayList<ObjectRenderEffects> DYNAMIC_EFFECTS =
