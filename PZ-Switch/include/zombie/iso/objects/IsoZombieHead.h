...
public
 IsoZombieHead(IsoCell cell) { super(cell); }

 bool Serialize() { return false; }

 std::string getObjectName() { return "ZombieHead"; }
...
public
 IsoZombieHead(IsoZombieHead.GibletType gibletType, IsoCell cell, float float0,
