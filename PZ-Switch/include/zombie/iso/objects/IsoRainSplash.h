...
public
 ...
 short short0 =
 (short)(IsoUtils.XToScreen(float0, float1, 0.0F, 0) - byte0 / 2);
 short short1 =
 (short)(IsoUtils.YToScreen(float0, float1, 0.0F, 0) - byte1 / 2);
 this->AttachAnim("RainSplash", "00", 4,
 RainManager.RainSplashAnimDelay, -short0, -short1,
 true, 0, false, 0.7F, RainManager.RainSplashTintMod);
 this->AttachedAnimSprite.get(int1).Frame = (short)Rand.Next(4);
 this->AttachedAnimSprite.get(int1).setScale(Core.TileScale,
 Core.TileScale);
 }
 ...
 std::string getObjectName() { return "RainSplashes"; }
