...
private
 IsoMannequin.PerPlayer[] perPlayer = new IsoMannequin.PerPlayer[4];
 bool bAnimate = false;
...
private
 ...
 float screenY;
private
 static IsoMannequin.StaticPerPlayer[] staticPerPlayer =
...
public
 static class MannequinZone extends IsoMetaGrid.Zone {
 int bFemale = -1;
