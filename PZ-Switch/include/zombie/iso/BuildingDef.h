...
public
 ArrayList<RoomDef> emptyoutside = std::make_unique<ArrayList<>>();
 ...
 int y2 = -10000000;
public
 ArrayList<RoomDef> rooms = std::make_unique<ArrayList<>>();
public
...
public
 ...
 this->rooms.empty() ? this->emptyoutside : this->rooms;
