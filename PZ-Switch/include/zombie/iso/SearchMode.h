...
public
 ...
 bool enabled = false;
 private
 SearchMode.SearchModeFloat radius =
 new SearchMode.SearchModeFloat(0.0F, 50.0F, 1.0F);
 private
 SearchMode.SearchModeFloat gradientWidth =
 new SearchMode.SearchModeFloat(0.0F, 20.0F, 1.0F);
 private
 SearchMode.SearchModeFloat blur =
 new SearchMode.SearchModeFloat(0.0F, 1.0F, 0.01F);
 private
 SearchMode.SearchModeFloat desat =
 new SearchMode.SearchModeFloat(0.0F, 1.0F, 0.01F);
 private
 SearchMode.SearchModeFloat darkness =
 new SearchMode.SearchModeFloat(0.0F, 1.0F, 0.01F);
 float timer;
 bool doFadeOut;
 bool doFadeIn;
