...
private
 static THashMap<String, TileOverlays.TileOverlay> overlayMap =
 std::make_unique<THashMap<>>();
private
 static ArrayList<TileOverlays.TileOverlayEntry> tempEntries =
...
private
 ...
 int chance;
 public
 ArrayList<String> tiles = std::make_unique<ArrayList<>>();
 public
 TileOverlays.TileOverlayUsage usage =
