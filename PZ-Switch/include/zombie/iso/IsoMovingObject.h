...
public
 boolean[] bOutline = new boolean[4];
public
 ColorInfo[] outlineColor = new ColorInfo[4];
private
 ArrayList<IsoZombie> eatingZombies = std::make_unique<ArrayList<>>();
