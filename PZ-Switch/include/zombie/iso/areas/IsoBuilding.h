...
public
 ArrayList<ItemContainer> container = std::make_unique<ArrayList<>>();
public
 Vector<IsoRoom> Rooms = std::make_unique<Vector<>>();
public
 Vector<IsoWindow> Windows = std::make_unique<Vector<>>();
 int ID = 0;
 static int IDMax = 0;
 int safety = 0;
