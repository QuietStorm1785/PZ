...
public:
private
 ConcurrentLinkedQueue<IsoRegionsLogger.IsoRegionLog> pool =
 std::make_unique<ConcurrentLinkedQueue<>>();
private
 ConcurrentLinkedQueue<IsoRegionsLogger.IsoRegionLog> loggerQueue =
 std::make_unique<ConcurrentLinkedQueue<>>();
 const bool consolePrint;
private
 ArrayList<IsoRegionsLogger.IsoRegionLog> logs =
