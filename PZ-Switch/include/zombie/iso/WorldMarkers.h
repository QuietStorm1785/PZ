...
private
 List<WorldMarkers.GridSquareMarker> gridSquareMarkers =
 std::make_unique<ArrayList<>>();
private
 WorldMarkers.PlayerHomingPointList[] homingPoints =
 new WorldMarkers.PlayerHomingPointList[4];
private
 WorldMarkers.DirectionArrowList[] directionArrows =
 new WorldMarkers.DirectionArrowList[4];
 static const ColorInfo stCol = new ColorInfo();
private
 WorldMarkers.PlayerScreen playerScreen =
