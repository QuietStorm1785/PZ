...
private
 Thermoregulator_tryouts.ThermalNode core;
private
 Thermoregulator_tryouts.ThermalNode[] nodes;
...
public
 Thermoregulator_tryouts(BodyDamage bodyDamagex) {
 ...
 Thermoregulator_tryouts.ThermalNode thermalNode =
 ...
 case Torso_Upper:
 thermalNode0 = new Thermoregulator_tryouts.ThermalNode(true, 37.0F,
 bodyPart, 0.25F);
 this->core = thermalNode0;
 break;
 case Head:
 thermalNode0 =
 new Thermoregulator_tryouts.ThermalNode(37.0F, bodyPart, 1.0F);
 break;
 case Neck:
 thermalNode0 =
 new Thermoregulator_tryouts.ThermalNode(37.0F, bodyPart, 0.5F);
 break;
 case Torso_Lower:
 thermalNode0 =
 new Thermoregulator_tryouts.ThermalNode(37.0F, bodyPart, 0.25F);
 break;
 case Groin:
 thermalNode0 =
 new Thermoregulator_tryouts.ThermalNode(37.0F, bodyPart, 0.5F);
 ...
 new Thermoregulator_tryouts.ThermalNode[bodyPartTypes.length];
...
public
 ...
 getNodeForType(BodyPartType bodyPartType) {
 for (int int0 = 0; int0 < this->nodes.length; int0++) {
...
public
 Thermoregulator_tryouts.ThermalNode
 getNodeForBloodType(BloodBodyPartType bloodBodyPartType) {
 for (int int0 = 0; int0 < this->nodes.length; int0++) {
 ...
 Thermoregulator_tryouts.Multiplier.Default);
 }

 float getMetabolicRateIncMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.MetabolicRateInc);
 }

 float getMetabolicRateDecMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.MetabolicRateDec);
 }

 float getBodyHeatMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.BodyHeat);
 }

 float getCoreHeatExpandMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.CoreHeatExpand);
 }

 float getCoreHeatContractMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.CoreHeatContract);
 }

 float getSkinCelciusMultiplier() {
 return this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.SkinCelcius);
 }
 ...
 float1 -= (this->airTemperature - this->airAndWindTemp) /
 (1.0F + thermalNode.windresist);
 }

 thermalNode.heatDelta = float1 - thermalNode.skinCelcius;
 thermalNode.heatDelta =
 thermalNode.heatDelta / (1.0F + thermalNode.insulation);
 ...
 if (thermalNode.skinCelcius < 33.0F && float7 < 0.0F ||
 thermalNode.skinCelcius > 33.0F && float7 > 0.0F) {
 float8 = 2.5E-4F;
 }
 ...
 if (this->airAndWindTemp < this->airTemperature) {
 float2 -= (this->airTemperature - this->airAndWindTemp) /
 (1.0F + thermalNode.windresist);
 }
 ...
 float float9 = 0.0025F;
 if (thermalNode.skinCelcius < 33.0F && float8 < 0.0F ||
 thermalNode.skinCelcius > 33.0F && float8 > 0.0F) {
 float9 = 2.5E-4F;
 }
 ...
 if (this->airAndWindTemp < this->airTemperature) {
 float0 -= (this->airTemperature - this->airAndWindTemp) /
 (1.0F + thermalNode.windresist);
 }
 ...
 thermalNode.skinCelcius =
 thermalNode.skinCelcius +
 float6 * this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.SkinCelcius);
 }
 }
 ...
 if (this->airAndWindTemp < this->airTemperature) {
 float0 = (this->airTemperature - this->airAndWindTemp) /
 (1.0F + thermalNode0.windresist);
 }

 float float1 = float0 - 27.0F;
 thermalNode0.heatDelta = float1;
 thermalNode0.heatDelta =
 thermalNode0.heatDelta / (1.0F + thermalNode0.insulation);
 ...
 thermalNode0.primaryDelta =
 thermalNode0.primaryDelta +
 float5 * this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.PrimaryDelta);
 thermalNode0.primaryDelta =
 PZMath.clamp(thermalNode0.primaryDelta, -1.0F, 1.0F);
 }
 ...
 thermalNode1.skinCelcius =
 thermalNode1.skinCelcius +
 float9 * this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.SkinCelcius);
 ...
 thermalNode1.skinCelcius =
 thermalNode1.skinCelcius +
 float7 * this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.SkinCelcius);
 ...
 thermalNode.skinSurface / thermalNode.insulation;
 ...
 float float14 = Metabolics.Default.getMet() * 1.0F *
 thermalNode.primaryDelta * thermalNode.skinSurface /
 float11;
 ...
 float float16 = Metabolics.Default.getMet() * 1.0F *
 PZMath.abs(thermalNode.primaryDelta) *
 thermalNode.skinSurface;
 float16 *= float15;
 ...
 float float18 = Metabolics.MAX.getMet() * 0.75F *
 thermalNode.secondaryDelta * thermalNode.skinSurface /
 float11;
 float18 *= float17;
 ...
 float float20 = Metabolics.Default.getMet() * 1.0F *
 PZMath.abs(thermalNode.secondaryDelta) *
 thermalNode.skinSurface;
 float20 *= float19;
 ...
 this->coreHeatDelta =
 this->totalHeat * this->getSimulationMultiplier(
 Thermoregulator_tryouts.Multiplier.BodyHeat);
...
private
 ...
 private
 Thermoregulator_tryouts.ThermalNode upstream;
 private
 Thermoregulator_tryouts.ThermalNode[] downstream;
 float insulation;
 float windresist;
 float celcius = 37.0F;
