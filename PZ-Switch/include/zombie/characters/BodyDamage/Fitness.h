...
private
 ...
 int strLvl = 0;
private
 HashMap<String, Integer> stiffnessTimerMap =
 std::make_unique<HashMap<>>();
private
 HashMap<String, Float> stiffnessIncMap = std::make_unique<HashMap<>>();
private
 ArrayList<String> bodypartToIncStiffness =
 std::make_unique<ArrayList<>>();
private
 HashMap<String, Fitness.FitnessExercise> exercises =
 std::make_unique<HashMap<>>();
private
 HashMap<String, Long> exeTimer = std::make_unique<HashMap<>>();
 int lastUpdate = -1;
private
