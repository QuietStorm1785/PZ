...
public:
 ...
 int minWorldAge;
public
 ArrayList<HairOutfitDefinitions.HaircutDefinition> m_haircutDefinition =
 std::make_unique<ArrayList<>>();
public
 ArrayList<HairOutfitDefinitions.HaircutOutfitDefinition>
 m_outfitDefinition = std::make_unique<ArrayList<>>();
private
 ThreadLocal<ArrayList<HairStyle>> m_tempHairStyles =
