...
public
 static ArrayList<Color> TrouserCommonColors =
 std::make_unique<ArrayList<>>();
public
 static ArrayList<ImmutableColor> HairCommonColors =
 std::make_unique<ArrayList<>>();
private
...
protected
 HashMap<Integer, Integer> MetCount = std::make_unique<HashMap<>>();
 float bravery = 1.0F;
 float loner = 0.0F;
 ...
 float loyalty = 0.0F;
public
 ArrayList<String> extra = std::make_unique<ArrayList<>>();
private
 ArrayList<ObservationFactory.Observation> Observations =
 new ArrayList<>(0);
private
