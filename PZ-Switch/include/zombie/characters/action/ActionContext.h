...
private
 ArrayList<ActionState> m_childStates = std::make_unique<ArrayList<>>();
 std::string m_previousStateName = nullptr;
 bool m_statesChanged = false;
public
 ArrayList<IActionStateChanged> onStateChanged =
...
public
 ...
 return this->m_currentState.empty()
 ? false
 ...
 this->m_currentState.empty() ? "" : this->m_currentState.getName();
 ...
 std::string string =
 this->m_currentState == nullptr ? nullptr : this->m_currentState.name;
