...
public:
 ...
 static std::mutex LocalList_mutex;

 std::mutex lightInfo_mutex;
 ...
 private
 static HashMap<Integer, SurvivorDesc> SurvivorMap =
 std::make_unique<HashMap<>>();
 private
 static int[] LevelUpLevels = new int[]{
 ...
 protected
 ArrayList<InventoryItem> savedInventoryItems =
 std::make_unique<ArrayList<>>();
 const std::string instancename;
 GameCharacterAIBrain GameCharacterAIBrain;
 public
 ArrayList<String> amputations = std::make_unique<ArrayList<>>();
 ModelInstance hair;
 ModelInstance beard;
 ...
 public
 HashMap<State, HashMap<Object, Object>> StateMachineParams =
 std::make_unique<HashMap<>>();
 ...
 private
 ArrayList<IsoGameCharacter.PerkInfo> PerkList =
 std::make_unique<ArrayList<>>();
 ...
 public
 boolean[] IsVisibleToPlayer = new boolean[4];
 float savedVehicleX;
 float savedVehicleY;
 ...
 private
 ArrayList<IsoMovingObject> LocalList =
 std::make_unique<ArrayList<>>();
 private
 ArrayList<IsoMovingObject> LocalNeutralList =
 std::make_unique<ArrayList<>>();
 private
 ArrayList<IsoMovingObject> LocalGroupList =
 std::make_unique<ArrayList<>>();
 private
 ArrayList<IsoMovingObject> LocalRelevantEnemyList =
 std::make_unique<ArrayList<>>();
 ...
 private
 ArrayList<IsoMovingObject> VeryCloseEnemyList =
 std::make_unique<ArrayList<>>();
 private
 HashMap<String, IsoGameCharacter.Location> LastKnownLocation =
 std::make_unique<HashMap<>>();
 ...
 int Patience = 20;
 protected
 Stack<BaseAction> CharacterActions = std::make_unique<Stack<>>();
 int ZombieKills = 0;
 int SurvivorKills = 0;
 ...
 private
 Stack<IsoBuilding> FamiliarBuildings = std::make_unique<Stack<>>();
 ...
 private
 Stack<String> UsedItemsOn = std::make_unique<Stack<>>();
 ...
 private
 Stack<IsoGameCharacter> LocalEnemyList = std::make_unique<Stack<>>();
 protected
 Stack<IsoGameCharacter> EnemyList = std::make_unique<Stack<>>();
 public
 IsoGameCharacter.CharacterTraits Traits =
 ...
 private
 HashMap<String, String> namesPrefix = std::make_unique<HashMap<>>();
 ...
 private
 List<String> knownRecipes = std::make_unique<ArrayList<>>();
 private
 HashSet<String> knownMediaLines = std::make_unique<HashSet<>>();
 ...
 private
 ArrayList<IsoGameCharacter.ReadBook> ReadBooks =
 std::make_unique<ArrayList<>>();
 private
 ...
 private
 InventoryItem[] cacheEquiped = new InventoryItem[2];
 ...
 private
 ArrayList<ModelInstance> readyModelData =
 std::make_unique<ArrayList<>>();
 ...
 private
 HashMap<String, State> m_stateUpdateLookup =
 std::make_unique<HashMap<>>();
 ...
 private
 static ArrayList<IsoMovingObject> movingStatic =
 std::make_unique<ArrayList<>>();
 long m_muzzleFlash = -1L;
 private
 static IsoGameCharacter.Bandages s_bandages =
 ...
 return this->m_animPlayer.empty()
 ? 0.0F
 ...
 */
 ...
 if (tree.empty() || ignoreBush && tree.getSize() > 2 ||
 !ignoreBush) {
 return true;
 }
 }
 ...
 */
 ...
 return this->legsSprite.modelSlot.empty()
 ? nullptr
 ...
 */
 ...
 return !this->CharacterActions.empty() ||
 ...
 */
 ...
 return this->wornItems.empty() ? nullptr
 ...
 return this->attachedItems.empty() ? nullptr
 ...
 */
 ...
 { std::lock_guard<std::mutex> __sync_lock__(LocalList_mutex);
 ...
 */
 ...
 if (player.empty() || !player.isGhostMode() ||
 ...
 return this->leftHandItem.empty() ? nullptr
 ...
 return this->rightHandItem.empty() ? nullptr
 ...
 */
 ...
 bool boolean0 = this->isoPlayer != nullptr && this->isoPlayer.bRemote ||
 ...
 (this->current.empty() || !this->current.TreatAsSolidFloor())) {
 ...
 float float0 =
 this->square == nullptr ? 0.0F : this->square.getPuddlesInGround();
 ...
 if (GameServer.bServer) {
 if (!this->isZombie()) {
 { std::lock_guard<std::mutex> __sync_lock__(lightInfo_mutex);
 ...
 */
 ...
 return this->actionContext.empty()
 ? nullptr
 ...
 */
 ...
 HitReactionNetworkAI getHitReactionNetworkAI() { return nullptr; }

 NetworkCharacterAI getNetworkCharacterAI() { return nullptr; }
...
private
 static class Bandages {
 HashMap<String, String> bandageTypeMap =
 std::make_unique<HashMap<>>();
 ...
 public
 TraitCollection.TraitSlot Obese = this->getTraitSlot("Obese");
 public
 TraitCollection.TraitSlot Athletic = this->getTraitSlot("Athletic");
 public
 TraitCollection.TraitSlot Overweight =
 this->getTraitSlot("Overweight");
 public
 TraitCollection.TraitSlot Unfit = this->getTraitSlot("Unfit");
 public
 TraitCollection.TraitSlot Emaciated = this->getTraitSlot("Emaciated");
 public
 TraitCollection.TraitSlot Graceful = this->getTraitSlot("Graceful");
 public
 TraitCollection.TraitSlot Clumsy = this->getTraitSlot("Clumsy");
 public
 TraitCollection.TraitSlot Strong = this->getTraitSlot("Strong");
 public
 TraitCollection.TraitSlot Weak = this->getTraitSlot("Weak");
 public
 TraitCollection.TraitSlot VeryUnderweight =
 this->getTraitSlot("Very Underweight");
 public
 TraitCollection.TraitSlot Underweight =
 this->getTraitSlot("Underweight");
 public
 TraitCollection.TraitSlot FastHealer =
 this->getTraitSlot("FastHealer");
 public
 TraitCollection.TraitSlot SlowHealer =
 this->getTraitSlot("SlowHealer");
 public
 TraitCollection.TraitSlot ShortSighted =
 this->getTraitSlot("ShortSighted");
 public
 TraitCollection.TraitSlot EagleEyed = this->getTraitSlot("EagleEyed");
 public
 TraitCollection.TraitSlot Agoraphobic =
 this->getTraitSlot("Agoraphobic");
 public
 TraitCollection.TraitSlot Claustophobic =
 this->getTraitSlot("Claustophobic");
 public
 TraitCollection.TraitSlot AdrenalineJunkie =
 this->getTraitSlot("AdrenalineJunkie");
 public
 TraitCollection.TraitSlot OutOfShape =
 this->getTraitSlot("Out of Shape");
 public
 TraitCollection.TraitSlot HighThirst =
 this->getTraitSlot("HighThirst");
 public
 TraitCollection.TraitSlot LowThirst = this->getTraitSlot("LowThirst");
 public
 TraitCollection.TraitSlot HeartyAppitite =
 this->getTraitSlot("HeartyAppitite");
 public
 TraitCollection.TraitSlot LightEater =
 this->getTraitSlot("LightEater");
 public
 TraitCollection.TraitSlot Cowardly = this->getTraitSlot("Cowardly");
 public
 TraitCollection.TraitSlot Brave = this->getTraitSlot("Brave");
 public
 TraitCollection.TraitSlot Brooding = this->getTraitSlot("Brooding");
 public
 TraitCollection.TraitSlot Insomniac = this->getTraitSlot("Insomniac");
 public
 TraitCollection.TraitSlot NeedsLessSleep =
 this->getTraitSlot("NeedsLessSleep");
 public
 TraitCollection.TraitSlot NeedsMoreSleep =
 this->getTraitSlot("NeedsMoreSleep");
 public
 TraitCollection.TraitSlot Asthmatic = this->getTraitSlot("Asthmatic");
 public
 TraitCollection.TraitSlot PlaysFootball =
 this->getTraitSlot("PlaysFootball");
 public
 TraitCollection.TraitSlot Jogger = this->getTraitSlot("Jogger");
 public
 TraitCollection.TraitSlot NightVision =
 this->getTraitSlot("NightVision");
 public
 TraitCollection.TraitSlot FastLearner =
 this->getTraitSlot("FastLearner");
 public
 TraitCollection.TraitSlot SlowLearner =
 this->getTraitSlot("SlowLearner");
 public
 TraitCollection.TraitSlot Pacifist = this->getTraitSlot("Pacifist");
 public
 TraitCollection.TraitSlot Feeble = this->getTraitSlot("Feeble");
 public
 TraitCollection.TraitSlot Stout = this->getTraitSlot("Stout");
 public
 TraitCollection.TraitSlot ShortTemper =
 this->getTraitSlot("ShortTemper");
 public
 TraitCollection.TraitSlot Patient = this->getTraitSlot("Patient");
 public
 TraitCollection.TraitSlot Injured = this->getTraitSlot("Injured");
 public
 TraitCollection.TraitSlot Inconspicuous =
 this->getTraitSlot("Inconspicuous");
 public
 TraitCollection.TraitSlot Conspicuous =
 this->getTraitSlot("Conspicuous");
 public
 TraitCollection.TraitSlot Desensitized =
 this->getTraitSlot("Desensitized");
 public
 TraitCollection.TraitSlot NightOwl = this->getTraitSlot("NightOwl");
 public
 TraitCollection.TraitSlot Hemophobic =
 this->getTraitSlot("Hemophobic");
 public
 TraitCollection.TraitSlot Burglar = this->getTraitSlot("Burglar");
 public
 TraitCollection.TraitSlot KeenHearing =
 this->getTraitSlot("KeenHearing");
 public
 TraitCollection.TraitSlot Deaf = this->getTraitSlot("Deaf");
 public
 TraitCollection.TraitSlot HardOfHearing =
 this->getTraitSlot("HardOfHearing");
 public
 TraitCollection.TraitSlot ThinSkinned =
 this->getTraitSlot("ThinSkinned");
 public
 TraitCollection.TraitSlot ThickSkinned =
 this->getTraitSlot("ThickSkinned");
 public
 TraitCollection.TraitSlot Marksman = this->getTraitSlot("Marksman");
 public
 TraitCollection.TraitSlot Outdoorsman =
 this->getTraitSlot("Outdoorsman");
 public
 TraitCollection.TraitSlot Lucky = this->getTraitSlot("Lucky");
 public
 TraitCollection.TraitSlot Unlucky = this->getTraitSlot("Unlucky");
 public
 TraitCollection.TraitSlot Nutritionist =
 this->getTraitSlot("Nutritionist");
 public
 TraitCollection.TraitSlot Nutritionist2 =
 this->getTraitSlot("Nutritionist2");
 public
 TraitCollection.TraitSlot Organized = this->getTraitSlot("Organized");
 public
 TraitCollection.TraitSlot Disorganized =
 this->getTraitSlot("Disorganized");
 public
 TraitCollection.TraitSlot Axeman = this->getTraitSlot("Axeman");
 public
 TraitCollection.TraitSlot IronGut = this->getTraitSlot("IronGut");
 public
 TraitCollection.TraitSlot WeakStomach =
 this->getTraitSlot("WeakStomach");
 public
 TraitCollection.TraitSlot HeavyDrinker =
 this->getTraitSlot("HeavyDrinker");
 public
 TraitCollection.TraitSlot LightDrinker =
 this->getTraitSlot("LightDrinker");
 public
 TraitCollection.TraitSlot Resilient = this->getTraitSlot("Resilient");
 public
 TraitCollection.TraitSlot ProneToIllness =
 this->getTraitSlot("ProneToIllness");
 public
 TraitCollection.TraitSlot SpeedDemon =
 this->getTraitSlot("SpeedDemon");
 public
 TraitCollection.TraitSlot SundayDriver =
 this->getTraitSlot("SundayDriver");
 public
 TraitCollection.TraitSlot Smoker = this->getTraitSlot("Smoker");
 public
 TraitCollection.TraitSlot Hypercondriac =
 this->getTraitSlot("Hypercondriac");
 public
 TraitCollection.TraitSlot Illiterate =
 ...
 private
 static ObjectPool<IsoGameCharacter.TorchInfo> TorchInfoPool =
