...
public:
 ...
 int getNumVisibleZombies() { return this->NumVisibleZombies; }

 int getNumChasingZombies() { return this->LastNumChasingZombies; }

 int getNumVeryCloseZombies() { return this->LastVeryCloseZombies; }
 ...
 * @return the Anger
 */
 float getAnger() { return this->Anger; }

 /**
 *
 * @param _Anger the Anger to set
 */
 void setAnger(float _Anger) { this->Anger = _Anger; }

 /**
 * @return the boredom
 */
 float getBoredom() { return this->boredom; }

 /**
 *
 * @param _boredom the boredom to set
 */
 void setBoredom(float _boredom) { this->boredom = _boredom; }

 /**
 * @return the endurance
 */
 float getEndurance() { return this->endurance; }

 /**
 *
 * @param _endurance the endurance to set
 */
 void setEndurance(float _endurance) { this->endurance = _endurance; }

 /**
 * @return the endurancelast
 */
 float getEndurancelast() { return this->endurancelast; }
 ...
 */
 float getEndurancedanger() { return this->endurancedanger; }
 ...
 */
 float getEndurancewarn() { return this->endurancewarn; }
 ...
 */
 ...
 bool getEnduranceRecharging() { return this->enduranceRecharging; }
 ...
 */
 void setFatigue(float _fatigue) { this->fatigue = _fatigue; }
 ...
 */
 void setFitness(float _fitness) { this->fitness = _fitness; }

 /**
 * @return the hunger
 */
 float getHunger() { return this->hunger; }

 /**
 *
 * @param _hunger the hunger to set
 */
 void setHunger(float _hunger) { this->hunger = _hunger; }

 /**
 * @return the idleboredom
 */
 float getIdleboredom() { return this->idleboredom; }

 /**
 *
 * @param _idleboredom the idleboredom to set
 */
 void setIdleboredom(float _idleboredom) { this->idleboredom = _idleboredom; }

 /**
 * @return the morale
 */
 float getMorale() { return this->morale; }

 /**
 *
 * @param _morale the morale to set
 */
 void setMorale(float _morale) { this->morale = _morale; }

 /**
 * @return the stress
 */
 float getStress() { return this->stress + this->getStressFromCigarettes(); }

 /**
 *
 * @param _stress the stress to set
 */
 void setStress(float _stress) { this->stress = _stress; }

 float getStressFromCigarettes() { return this->stressFromCigarettes; }

 void setStressFromCigarettes(float _stressFromCigarettes) {
 this->stressFromCigarettes = PZMath.clamp(_stressFromCigarettes, 0.0F,
 this->getMaxStressFromCigarettes());
 }

 float getMaxStressFromCigarettes() { return 0.51F; }

 /**
 * @return the Fear
 */
 float getFear() { return this->Fear; }

 /**
 *
 * @param _Fear the Fear to set
 */
 void setFear(float _Fear) { this->Fear = _Fear; }

 /**
 * @return the Panic
 */
 float getPanic() { return this->Panic; }

 /**
 *
 * @param _Panic the Panic to set
 */
 void setPanic(float _Panic) { this->Panic = _Panic; }

 /**
 * @return the Sanity
 */
 float getSanity() { return this->Sanity; }

 /**
 *
 * @param _Sanity the Sanity to set
 */
 void setSanity(float _Sanity) { this->Sanity = _Sanity; }

 /**
 * @return the Sickness
 */
 float getSickness() { return this->Sickness; }

 /**
 *
 * @param _Sickness the Sickness to set
 */
 void setSickness(float _Sickness) { this->Sickness = _Sickness; }

 /**
 * @return the Pain
 */
 float getPain() { return this->Pain; }

 /**
 *
 * @param _Pain the Pain to set
 */
 void setPain(float _Pain) { this->Pain = _Pain; }

 /**
 * @return the Drunkenness
 */
 float getDrunkenness() { return this->Drunkenness; }

 /**
 *
 * @param _Drunkenness the Drunkenness to set
 */
 void setDrunkenness(float _Drunkenness) { this->Drunkenness = _Drunkenness; }

 /**
 * @return the NumVisibleZombies
 */
 int getVisibleZombies() { return this->NumVisibleZombies; }
 ...
 * @return the Tripping
 */
 bool isTripping() { return this->Tripping; }

 /**
 *
 * @param _Tripping the Tripping to set
 */
 void setTripping(bool _Tripping) { this->Tripping = _Tripping; }

 /**
 * @return the TrippingRotAngle
 */
 float getTrippingRotAngle() { return this->TrippingRotAngle; }
 ...
 * @return the thirst
 */
 float getThirst() { return this->thirst; }

 /**
 *
 * @param _thirst the thirst to set
 */
 void setThirst(float _thirst) { this->thirst = _thirst; }
