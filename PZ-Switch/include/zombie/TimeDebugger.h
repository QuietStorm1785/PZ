...
public
 ...
 this->recordStrings.add(string + "|" +
 timeDebugger0.recordStrings.get(int0);
 }
 ...
 DebugLog.log("RECORD " + int0 + " " + string +
 " A:" + (long2 - long0) + " D:" + (long2 - long1);
 }

 DebugLog.log("=== END " + this->name + " (" +
 (this->records.get(this->records.size() - 1) - long0) +
 ") ===");
 } else {
 ...
 ? 0L
 : System.currentTimeMillis() - this->records.get(0);
 }
}
} // namespace zombie
