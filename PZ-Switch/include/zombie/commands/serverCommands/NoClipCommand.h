...
class NoClipCommand : public CommandBase {
 public:
 public
 NoClipCommand(const std::string &string0, const std::string &string1,
 ...
 this->getExecutorUsername() + " enabled noclip on " + string0);
 return "User " + string0 + " won't collide.";
 } else {
 LoggerManager.getLogger("admin").write(
 this->getExecutorUsername() + " disabled noclip on " + string0);
