...
private
 SoundManager.Music music = new SoundManager.Music();
public
...
private
 HashSet<BaseSoundEmitter> emitters = std::make_unique<HashSet<>>();
private
...
public
static class AmbientSoundEffect implements Audio {
 std::string name;
 long eventInstance;
 float gain;
 GameSoundClip clip;
