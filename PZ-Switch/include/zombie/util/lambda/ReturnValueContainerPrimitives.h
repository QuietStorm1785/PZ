...
public:
public
 static class RVBoolean extends PooledObject {
 bool ReturnVal;
 private
 static Pool<ReturnValueContainerPrimitives.RVBoolean> s_pool =
 ...
 float ReturnVal;
 private
 static Pool<ReturnValueContainerPrimitives.RVFloat> s_pool =
 ...
 int ReturnVal;
 private
 static Pool<ReturnValueContainerPrimitives.RVInt> s_pool =
