...
public:
private
 static ConcurrentLinkedDeque<BitHeader.BitHeaderByte> pool_byte =
 std::make_unique<ConcurrentLinkedDeque<>>();
private
 static ConcurrentLinkedDeque<BitHeader.BitHeaderShort> pool_short =
 std::make_unique<ConcurrentLinkedDeque<>>();
private
 static ConcurrentLinkedDeque<BitHeader.BitHeaderInt> pool_int =
 std::make_unique<ConcurrentLinkedDeque<>>();
private
 static ConcurrentLinkedDeque<BitHeader.BitHeaderLong> pool_long =
 std::make_unique<ConcurrentLinkedDeque<>>();
...
public
 static class BitHeaderBase implements BitHeaderRead, BitHeaderWrite {
 bool isWrite;
 ByteBuffer buffer;
 int start_pos = -1;
 ...
 protected
 boolean hasflags_header(int var1);

 protected
 boolean hasflags_header(long var1);

 protected
 boolean equals_header(int var1);

 protected
 boolean equals_header(long var1);
