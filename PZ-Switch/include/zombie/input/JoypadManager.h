...
public
 JoypadManager.Joypad[] Joypads = new JoypadManager.Joypad[4];
public
 JoypadManager.Joypad[] JoypadsController = new JoypadManager.Joypad[16];
public
 ArrayList<JoypadManager.Joypad> JoypadList =
 std::make_unique<ArrayList<>>();
public
 HashSet<String> ActiveControllerGUIDs = std::make_unique<HashSet<>>();
