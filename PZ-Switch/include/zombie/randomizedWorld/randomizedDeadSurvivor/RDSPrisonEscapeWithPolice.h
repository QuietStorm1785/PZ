 ...
 * duct tape, etc. Cops in the house too with a police car waiting outside.
 */
...
public
 ...
 this->addZombies(def, Rand.Next(2, 4), "Police", nullptr, roomDef);
 BaseVehicle vehicle =
 ...
 this->addZombiesOnSquare(3, "Police", nullptr, square);
 if (!arrayList0.empty()) {
