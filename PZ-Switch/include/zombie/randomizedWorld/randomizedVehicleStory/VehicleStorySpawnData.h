...
public
 VehicleStorySpawnData(RandomizedVehicleStoryBase story, IsoMetaGrid.Zone zone,
 float spawnX, float spawnY, float direction, int x1,
 ...
 if (zone != this->m_zone) {
 return false;
 } else if (!this->m_story.isFullyStreamedIn(this->m_x1, this->m_y1, this->m_x2,
 this->m_y2) {
 return false;
 } else {
