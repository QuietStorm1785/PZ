...
private
 static ObjectPool<VehicleStorySpawner.Element> s_elementPool =
 new ObjectPool<>(VehicleStorySpawner.Element::new);
private
 static int[] s_AABB = new int[4];
public
 ArrayList<VehicleStorySpawner.Element> m_elements =
 std::make_unique<ArrayList<>>();
public
 HashMap<String, Object> m_storyParams = std::make_unique<HashMap<>>();
