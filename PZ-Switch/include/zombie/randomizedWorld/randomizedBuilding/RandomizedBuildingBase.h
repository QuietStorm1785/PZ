...
public
 ...
 sq.getRoom() == nullptr ? sq : ((IsoDoor)object).getOppositeSquare();
 ...
 sq.getRoom() == nullptr ? sq : ((IsoWindow)object).getOppositeSquare();
...
public
 static class HumanCorpse extends IsoGameCharacter implements
 IHumanVisual {
