...
public:
private
 ArrayList<String> specificProfessionDistribution =
 std::make_unique<ArrayList<>>();
private
 Map<String, String> specificProfessionRoomDistribution =
 std::make_unique<HashMap<>>();
private
 static HashMap<Integer, String> kitchenSinkItems =
 std::make_unique<HashMap<>>();
private
 static HashMap<Integer, String> kitchenCounterItems =
 std::make_unique<HashMap<>>();
private
 static HashMap<Integer, String> kitchenStoveItems =
 std::make_unique<HashMap<>>();
private
 static HashMap<Integer, String> bathroomSinkItems =
 std::make_unique<HashMap<>>();
private
 ArrayList<String> coldFood = std::make_unique<ArrayList<>>();
private
 Map<String, String> plankStash = std::make_unique<HashMap<>>();
private
 ArrayList<RandomizedDeadSurvivorBase> deadSurvivorsStory =
 std::make_unique<ArrayList<>>();
 int totalChanceRDS = 0;
private
 static HashMap<RandomizedDeadSurvivorBase, Integer> rdsMap =
 std::make_unique<HashMap<>>();
private
 static ArrayList<String> uniqueRDSSpawned =
 std::make_unique<ArrayList<>>();
private
