...
public:
 ...
 (object.getSprite().getName() == "recreational_01_6") ||
 object.getSprite().getName() == "recreational_01_7"))) {
 if (Rand.NextBool(3) {
 ...
 if (Rand.NextBool(20) && square.getRoom() != nullptr &&
 ...
 */
 ...
 return def.getRoom("bar") != nullptr &&
 def.getRoom("stripclub") == nullptr ||
 force;
 }
