...
/**
 * This building will be 60% burnt (no fire started tho) Add some burnt
 * skeleton in it
 */
...
public:
 ...
 if (square != nullptr && Rand.Next(100) < 60) {
 square.Burn(false);
 }
 }
 }
 ...
 this->addZombies(def, Rand.Next(3, 7), nullptr, nullptr, nullptr);
