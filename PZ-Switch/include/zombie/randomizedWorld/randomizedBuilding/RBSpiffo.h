...
public:
 ...
 System.out.println("adding item on table " +
 ...
 return sq.getRoom() != nullptr && ("spiffo_dining" == sq.getRoom().getName()) || "burgerkitchen" == sq.getRoom().getName()));
 }
 ...
 */
 ...
 return def.getRoom("spiffo_dining") != nullptr ||
 def.getRoom("burgerkitchen") != nullptr || force;
 }
