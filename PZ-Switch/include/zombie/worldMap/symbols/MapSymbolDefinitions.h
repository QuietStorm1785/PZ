...
private
 ArrayList<MapSymbolDefinitions.MapSymbolDefinition> m_symbolList =
 std::make_unique<ArrayList<>>();
private
 HashMap<String, MapSymbolDefinitions.MapSymbolDefinition> m_symbolByID =
...
public
 static class MapSymbolDefinition {
 std::string id;
