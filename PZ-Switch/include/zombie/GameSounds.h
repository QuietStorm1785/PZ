...
protected
 static HashMap<String, GameSound> soundByName =
 std::make_unique<HashMap<>>();
protected
 static ArrayList<GameSound> sounds = std::make_unique<ArrayList<>>();
private
 static GameSounds.BankPreviewSound previewBank =
 new GameSounds.BankPreviewSound();
private
 static GameSounds.FilePreviewSound previewFile =
...
private
 ...
 gameSoundClip.eventDescription.empty()) {
...
private
static class BankPreviewSound implements GameSounds.IPreviewSound {
 long instance;
 GameSoundClip clip;
 float effectiveGain;
...
private
static class FilePreviewSound implements GameSounds.IPreviewSound {
 long channel;
 GameSoundClip clip;
 float effectiveGain;
