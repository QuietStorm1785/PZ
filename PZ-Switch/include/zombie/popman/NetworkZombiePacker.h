...
public:
 ...
 std::mutex zombiesDeleted_mutex;
 std::mutex zombiesReceived_mutex;
 static const NetworkZombiePacker instance = new NetworkZombiePacker();
private
 ArrayList<NetworkZombiePacker.DeletedZombie> zombiesDeleted =
 std::make_unique<ArrayList<>>();
private
 ArrayList<NetworkZombiePacker.DeletedZombie> zombiesDeletedForSending =
 std::make_unique<ArrayList<>>();
private
 HashSet<IsoZombie> zombiesReceived = std::make_unique<HashSet<>>();
private
 ArrayList<IsoZombie> zombiesProcessing =
 std::make_unique<ArrayList<>>();
...
private
 ...
 { std::lock_guard<std::mutex> __sync_lock__(zombiesDeleted_mutex);
 ...
 { std::lock_guard<std::mutex> __sync_lock__(zombiesReceived_mutex);
