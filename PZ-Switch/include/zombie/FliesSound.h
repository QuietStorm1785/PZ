...
private
 static IsoGridSquare[] tempSquares = new IsoGridSquare[100];
private
 FliesSound.PlayerData[] playerData = new FliesSound.PlayerData[4];
private
 ArrayList<FliesSound.FadeEmitter> fadeEmitters =
...
class ChunkData {
 ...
 int wy;
 private
 FliesSound.ChunkLevelData[] levelData =
 ...
 if (square != nullptr &&
 !square.getStaticMovingObjects().empty() &&
