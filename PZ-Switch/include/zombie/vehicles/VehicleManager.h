...
private
 ArrayList<BaseVehicle> sendReliable = std::make_unique<ArrayList<>>();
private
 ArrayList<BaseVehicle> sendUnreliable = std::make_unique<ArrayList<>>();
...
public
 UdpConnection[] connected = new UdpConnection[512];
private
 float[] tempFloats = new float[27];
private
 float[] engineSound = new float[2];
private
 VehicleManager.PosUpdateVars posUpdateVars =
...
private
 ArrayList<BaseVehicle.ModelInfo> oldModels =
 std::make_unique<ArrayList<>>();
private
 ArrayList<BaseVehicle.ModelInfo> curModels =
 std::make_unique<ArrayList<>>();
