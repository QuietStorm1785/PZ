...
private
 ArrayList<CollideWithObstacles.CCObstacle> obstacles =
 std::make_unique<ArrayList<>>();
private
 ArrayList<CollideWithObstacles.CCNode> nodes =
 std::make_unique<ArrayList<>>();
private
 ArrayList<CollideWithObstacles.CCIntersection> intersections =
 std::make_unique<ArrayList<>>();
private
 CollideWithObstacles.ImmutableRectF moveBounds =
 new CollideWithObstacles.ImmutableRectF();
private
 CollideWithObstacles.ImmutableRectF vehicleBounds =
 new CollideWithObstacles.ImmutableRectF();
...
private
 ...
 if (!cCObjectOutline.nodes.empty()) {
 ...
 if (!cCEdge2.intersections.empty()) {
...
private
 ...
 return pool.empty() ? new CollideWithObstacles.CCIntersection()
 : pool.pop();
 }
 ...
 int z;
 bool ignore;
 ArrayList<CollideWithObstacles.CCEdge> edges =
 std::make_unique<ArrayList<>>();
 ArrayList<CollideWithObstacles.CCNode> visible =
 std::make_unique<ArrayList<>>();
 ...
 return pool.empty() ? new CollideWithObstacles.CCObjectOutline()
 : pool.pop();
 }
 ...
 return pool.empty() ? new CollideWithObstacles.CCObstacle()
 : pool.pop();
 }
 ...
 return pool.empty() ? new CollideWithObstacles.ImmutableRectF()
 : pool.pop();
 }
