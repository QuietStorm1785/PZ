...
public:
 static Vector2f tempVector2f_1 = new Vector2f();
 static Vector2f tempVector2f_2 = new Vector2f();
 static Vector2f tempVector2f_3 = new Vector2f();

 static bool intersects(PolygonalMap2.VehiclePoly vehiclePoly1,
 PolygonalMap2.VehiclePoly vehiclePoly2) {
 for (int int0 = 0; int0 < 2; int0++) {
 PolygonalMap2.VehiclePoly vehiclePoly0 =
 int0 == 0 ? vehiclePoly1 : vehiclePoly2;
 ...
 Vector2f vector2f2 = tempVector2f_3.set(vector2f1.y - vector2f0.y,
 vector2f0.x - vector2f1.x);
 ...
 double double2 =
 vector2f2.x * vector2f3.x + vector2f2.y * vector2f3.y;
 if (double2 < double0) {
 double0 = double2;
 }
 ...
 double double5 =
 vector2f2.x * vector2f4.x + vector2f2.y * vector2f4.y;
 if (double5 < double3) {
 double3 = double5;
 }
 ...
 static Vector2f getPoint(PolygonalMap2.VehiclePoly vehiclePoly, int int0,
 Vector2f vector2f) {
 if (int0 == 0) {
 ...
 return int0 = = 3 ? vector2f.set(vehiclePoly.x4, vehiclePoly.y4) : nullptr;
 }
 }
}
} // namespace vehicles
