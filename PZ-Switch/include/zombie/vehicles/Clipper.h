...
public
 void addPath(int numPoints, ByteBuffer points, boolean bClip);

public
 void addLine(float x1, float y1, float x2, float y2);

public
 void addAABB(float x1, float y1, float x2, float y2);
...
public
 void addPolygon(float x1, float y1, float x2, float y2, float x3,
 float y3, float x4, float y4);

public
 void clipAABB(float x1, float y1, float x2, float y2);

 int generatePolygons() { return this->generatePolygons(0.0); }

public
 int generatePolygons(double delta);

public
 int getPolygon(int index, ByteBuffer vertices);

public
 int generateTriangulatePolygons(int wx, int wy);

public
 int triangulate(int index, ByteBuffer vertices);
