...
private
 VehiclesDB2.MainThread m_main = new VehiclesDB2.MainThread();
private
 VehiclesDB2.WorldStreamerThread m_worldStreamer =
...
private
 ...
 ConcurrentLinkedQueue<VehiclesDB2.QueueItem> m_queue =
 ...
 TIntObjectHashMap<VehiclesDB2.VehicleBuffer> m_IDToVehicle =
 std::make_unique<TIntObjectHashMap<>>();
 TIntObjectHashMap<ArrayList<VehiclesDB2.VehicleBuffer>>
 ...
 { std::lock_guard<std::mutex> __sync_lock__(VehiclesDB2.instance.m_main.m_usedIDs_mutex);
...
private
 static class QueueAddVehicle extends VehiclesDB2.QueueItem {
 static Pool<VehiclesDB2.QueueAddVehicle> s_pool =
 new Pool<>(VehiclesDB2.QueueAddVehicle::new);
 VehiclesDB2.VehicleBuffer m_vehicleBuffer =
...
private
 static class QueueItem extends PooledObject {
 void processMain();
 ...
 static Pool<VehiclesDB2.QueueLoadChunk> s_pool =
...
private
 ...
 static Pool<VehiclesDB2.QueueRemoveVehicle> s_pool =
...
private
 static class QueueUpdateVehicle extends VehiclesDB2.QueueItem {
 static Pool<VehiclesDB2.QueueUpdateVehicle> s_pool =
...
private
 static class SQLStore extends VehiclesDB2.IVehicleStore {
