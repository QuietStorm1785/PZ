...
private
 ArrayList<String> m_actionSubStateNames =
 std::make_unique<ArrayList<>>();
 std::string m_aiStateName;
 std::string m_animStateName;
private
 ArrayList<String> m_animSubStateNames = std::make_unique<ArrayList<>>();
private
 ArrayList<String> m_aiSubStateNames = std::make_unique<ArrayList<>>();
...
public
 ...
 substateSlot->!substateSlot.empty()
