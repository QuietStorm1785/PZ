...
public
 ArrayList<String> m_MaleSkins = std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_FemaleSkins = std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_MaleSkins_Zombie1 = std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_FemaleSkins_Zombie1 =
 std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_MaleSkins_Zombie2 = std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_FemaleSkins_Zombie2 =
 std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_MaleSkins_Zombie3 = std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_FemaleSkins_Zombie3 =
 std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_SkeletonMaleSkins_Zombie =
 std::make_unique<ArrayList<>>();
public
 ArrayList<String> m_SkeletonFemaleSkins_Zombie =
 std::make_unique<ArrayList<>>();
 ...
 string0, string1, character, modelSlot.model.AnimPlayer, nullptr);
