...
private
 ModelInstanceTextureInitializer.RenderData[] m_renderData =
 new ModelInstanceTextureInitializer.RenderData[3];
private
 static ObjectPool<ModelInstanceTextureInitializer> pool =
 ...
 return renderData.m_textureCreator.empty() ? true
