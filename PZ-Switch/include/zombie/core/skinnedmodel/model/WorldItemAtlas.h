...
private
 HashMap<String, WorldItemAtlas.ItemTexture> itemTextureMap =
 std::make_unique<HashMap<>>();
private
 ArrayList<WorldItemAtlas.Atlas> AtlasList =
 std::make_unique<ArrayList<>>();
private
 WorldItemAtlas.ItemParams itemParams = new WorldItemAtlas.ItemParams();
private
 WorldItemAtlas.Checksummer checksummer =
 new WorldItemAtlas.Checksummer();
private
 static Stack<WorldItemAtlas.RenderJob> JobPool =
 std::make_unique<Stack<>>();
private
 ArrayList<WorldItemAtlas.RenderJob> RenderJobs =
 std::make_unique<ArrayList<>>();
private
 ObjectPool<WorldItemAtlas.ItemTextureDrawer> itemTextureDrawerPool =
 new ObjectPool<>(WorldItemAtlas.ItemTextureDrawer::new);
private
 ObjectPool<WorldItemAtlas.WeaponPartParams> weaponPartParamPool =
...
class Atlas {
 ...
 Texture tex;
 public
 ArrayList<WorldItemAtlas.AtlasEntry> EntryList =
 std::make_unique<ArrayList<>>();
 bool clear = true;
...
private
 ...
 WorldItemAtlas.ItemParams itemParams =
 ...
 private static class ItemTextureDrawer extends
 TextureDraw.GenericDrawer {
...
private
 ...
 return WorldItemAtlas.JobPool.empty() ? new WorldItemAtlas.RenderJob()
 ...
 !this->itemParams.m_weaponParts.empty()) {
 ...
 if (shader.empty() || model.Mesh.empty() ||
 !model.Mesh.isReady()) {
 return false;
