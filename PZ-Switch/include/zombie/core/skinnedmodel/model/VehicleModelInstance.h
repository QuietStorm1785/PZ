...
public
 float[] textureUninstall1 = new float[16];
public
 float[] textureUninstall2 = new float[16];
public
 float[] textureLightsEnables1 = new float[16];
public
 float[] textureLightsEnables2 = new float[16];
public
 float[] textureDamage1Enables1 = new float[16];
public
 float[] textureDamage1Enables2 = new float[16];
public
 float[] textureDamage2Enables1 = new float[16];
public
 float[] textureDamage2Enables2 = new float[16];
public
 float[] matrixBlood1Enables1 = new float[16];
public
 float[] matrixBlood1Enables2 = new float[16];
public
 float[] matrixBlood2Enables1 = new float[16];
public
 float[] matrixBlood2Enables2 = new float[16];
...
public
 ...
 void UpdateLights() {
 { std::lock_guard<std::mutex> __sync_lock__(m_lightsLock_mutex);
