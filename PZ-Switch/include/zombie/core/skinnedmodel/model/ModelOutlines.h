...
private
 ObjectPool<ModelOutlines.Drawer> m_drawerPool =
 new ObjectPool<>(ModelOutlines.Drawer::new);
 ...
 void checkFBOs() {
 if (this->m_fboA != nullptr && (this->m_fboA.getWidth() != Core.width ||
 this->m_fboB.getHeight() != Core.height) {
 this->m_fboA.destroy();
 this->m_fboB.destroy();
 this->m_fboC.destroy();
 this->m_fboA = nullptr;
 ...
 this->m_thickenHShader =
 ShaderProgram.createShaderProgram("aim_outline_h", false, true);
 this->m_thickenVShader =
 ShaderProgram.createShaderProgram("aim_outline_v", false, true);
 this->m_blitShader =
 ShaderProgram.createShaderProgram("aim_outline_blit", false, true);
 }
 ...
 this->m_thickenHShader.setVector4(
 "u_color", this->m_outlineColor.r, this->m_outlineColor.g,
 this->m_outlineColor.b, this->m_outlineColor.a);
 ...
 this->m_thickenVShader.setVector4(
 "u_color", this->m_outlineColor.r, this->m_outlineColor.g,
 this->m_outlineColor.b, this->m_outlineColor.a);
 ...
 CharacterModelCamera.instance.m_bInVehicle =
 this->m_playerRenderData.bInVehicle;
 CharacterModelCamera.instance.m_useAngle =
 this->m_playerRenderData.animPlayerAngle;
 ...
 void renderTexture(ITexture iTexture, int int0, int int1, int int2,
 int int3) {
 iTexture.bind();
...
public
 ...
 void postRender() { ModelOutlines.instance.m_drawerPool.release(this); }
 }
}
} // namespace model
} // namespace skinnedmodel
