...
public
 static Color[] debugDrawColours = new Color[] {
 new Color();
 new Color();
 new Color();
 new Color();
...
public
 ...
 meshAssetParams.animationsMesh = this->assetParams.empty()
 ? nullptr
...
public
 static class ModelAssetParams extends AssetManager.AssetParams {
 std::string meshName;
