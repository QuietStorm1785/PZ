...
private
 HashMap<String, DeadBodyAtlas.BodyTexture> EntryMap =
 std::make_unique<HashMap<>>();
private
 ArrayList<DeadBodyAtlas.Atlas> AtlasList =
 std::make_unique<ArrayList<>>();
private
 DeadBodyAtlas.BodyParams bodyParams = new DeadBodyAtlas.BodyParams();
 int updateCounter = -1;
private
 DeadBodyAtlas.Checksummer checksummer = new DeadBodyAtlas.Checksummer();
private
 static Stack<DeadBodyAtlas.RenderJob> JobPool =
 std::make_unique<Stack<>>();
private
 DeadBodyAtlas.DebugDrawInWorld[] debugDrawInWorld =
 new DeadBodyAtlas.DebugDrawInWorld[3];
 long debugDrawTime;
private
 ArrayList<DeadBodyAtlas.RenderJob> RenderJobs =
 std::make_unique<ArrayList<>>();
private
 DeadBodyAtlas.CharacterTextureVisual characterTextureVisualFemale =
 new DeadBodyAtlas.CharacterTextureVisual(true);
private
 DeadBodyAtlas.CharacterTextureVisual characterTextureVisualMale =
...
private
 ObjectPool<DeadBodyAtlas.BodyTextureDrawer> bodyTextureDrawerPool =
...
class Atlas {
 ...
 Texture tex;
 public
 ArrayList<DeadBodyAtlas.AtlasEntry> EntryList =
 std::make_unique<ArrayList<>>();
 bool clear = true;
 ...
 private static class BodyTextureDrawer extends
...
private
 static class CharacterTextureVisual implements IHumanVisual {
 ...
 private static class ClearAtlasTexture extends
 TextureDraw.GenericDrawer {
...
private
 static class DebugDrawInWorld extends TextureDraw.GenericDrawer {
...
private
 static class RenderJob extends TextureDraw.GenericDrawer {
 static float SIZEV = 42.75F;
 public
 DeadBodyAtlas.BodyParams body = new DeadBodyAtlas.BodyParams();
 public
 DeadBodyAtlas.AtlasEntry entry;
 ...
 return DeadBodyAtlas.JobPool.empty() ? new DeadBodyAtlas.RenderJob()
