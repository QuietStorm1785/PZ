...
private
 List<AnimNode> m_reusableAnimNodes = std::make_unique<ArrayList<>>();
private
 List<LiveAnimNode> m_liveAnimNodes = std::make_unique<ArrayList<>>();
...
public
 ...
 bool isStateless() { return this->m_State.empty(); }
 ...
 float float1 = animationTrack0 != nullptr
 ...
 iAnimatable.getVariableBoolean("dbgForceAnimScalars");
 std::string string0 =
 boolean0 ? iAnimatable.getVariableString("dbgForceAnimNodeName") : nullptr;
 int int0 = 0;
...
private
 ...
 private
 static Pool<AnimLayer.StartAnimTrackParameters> s_pool =
