...
public:
 ...
 static int getLockFPS() { return s_lockFPS; }

 static void setLockFPS(int lockFPS) { s_lockFPS = lockFPS; }

 static bool isUncappedFPS() { return s_uncappedFPS; }

 static void setUncappedFPS(bool uncappedFPS) { s_uncappedFPS = uncappedFPS; }

 int getFramerate() { return getLockFPS(); }

 void setFramerate(int framerate) { setLockFPS(framerate); }

 bool isFramerateUncapped() { return isUncappedFPS(); }

 void setFramerateUncapped(bool val) { setUncappedFPS(val); }

 void setLightingQuality(int lighting) { LightingFrameSkip = lighting; }

 int getLightingQuality() { return LightingFrameSkip; }
 ...
 int getWaterQuality() { return WaterQuality; }
 ...
 int getPuddlesQuality() { return PuddlesQuality; }

 void setNewRoofHiding(bool enabled) { NewRoofHiding = enabled; }

 bool getNewRoofHiding() { return NewRoofHiding; }
 ...
 int getLightingFPS() { return LightingFPS; }

 int getUIRenderFPS() {
 return UIManager.useUIFBO ? Core.OptionUIRenderFPS : s_lockFPS;
 }

 int getFogQuality() { return FogQuality; }
