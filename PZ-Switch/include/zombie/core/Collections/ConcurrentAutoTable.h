...
public:
private
 ConcurrentAutoTable.CAT _cat =
 new ConcurrentAutoTable.CAT(nullptr, 4, 0L);
private
 static AtomicReferenceFieldUpdater<ConcurrentAutoTable, ConcurrentAutoTable.CAT>
