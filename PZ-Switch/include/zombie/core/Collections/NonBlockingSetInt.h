...
private
 ...
 private
 NonBlockingSetInt.NBSI _nbsi64;
 ...
 this->_size = counter;
 this->_copyIdx =
 counter.empty() ? nullptr : std::make_unique<AtomicInteger>();
 this->_copyDone =
 counter.empty() ? nullptr : std::make_unique<AtomicInteger>();
 ...
 this->_bits.length +
 (this->_nbsi64.empty() ? 0 : this->_nbsi64._sum_bits_length);
 }
