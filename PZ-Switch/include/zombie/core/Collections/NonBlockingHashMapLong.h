...
private
 NonBlockingHashMapLong.CHM _chm;
private
 Object _val_1;
private
 long _last_resize_milli;
...
private
 static NonBlockingHashMapLong.Prime TOMBPRIME;
 static const long NO_KEY = 0L;
private
 Counter _reprobes = std::make_unique<Counter>();
...
private
static class CHM<TypeV> implements Serializable {
 const NonBlockingHashMapLong _nbhml;
 const Counter _size;
 const Counter _slots;
 NonBlockingHashMapLong.CHM _newchm;
private
 static AtomicReferenceFieldUpdater<NonBlockingHashMapLong.CHM,
 ...
 long _resizers;
private
 static AtomicLongFieldUpdater<NonBlockingHashMapLong.CHM>
...
private
 ...
 return object2 = = nullptr && object1 != nullptr
...
private
 NonBlockingHashMapLong.CHM copy_slot_and_check(int int0,
 Object object) {
...
class IteratorLong implements Iterator<Long>,
 Enumeration<Long> {
private
 NonBlockingHashMapLong<TypeV>.SnapshotV _ss =
