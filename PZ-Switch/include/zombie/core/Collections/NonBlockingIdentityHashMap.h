...
private
 static NonBlockingIdentityHashMap.Prime TOMBPRIME;
private
...
private
 static NonBlockingIdentityHashMap.CHM chm(Object[] objects) {
 return (NonBlockingIdentityHashMap.CHM)objects[0];
 }

private
 static int[] hashes(Object[] objects) { return (int[])objects[1]; }
...
public
 NonBlockingIdentityHashMap() { this(8); }

public
 NonBlockingIdentityHashMap(int int0) { this->initialize(int0); }
 ...
 this->_kvs[0] =
 new NonBlockingIdentityHashMap.CHM(std::make_unique<Counter>());
 ...
 void *clone() {
 try {
 NonBlockingIdentityHashMap nonBlockingIdentityHashMap0 =
 (NonBlockingIdentityHashMap)super.clone();
 ...
 static void *get_impl(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 ...
 private
 static Object putIfMatch(
 NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 Object[] objects0, Object object2, Object object0, Object object1) {
 ...
 if (objects1.empty() &&
 (object4.empty() && chm.tableFull(int3, int1) ||
 object4 instanceof
 ...
 if (objects1 != nullptr) {
 return putIfMatch(nonBlockingIdentityHashMap,
 chm.copy_slot_and_check(nonBlockingIdentityHashMap,
 objects0, int2, object1),
 object2, object0, object1);
 } else {
 while ($assertionsDisabled ||
 !(object4 instanceof NonBlockingIdentityHashMap.Prime) {
 ...
 if (object1 != nullptr) {
 if ((object4.empty() || object4 == TOMBSTONE) &&
 object0 != TOMBSTONE) {
 chm._size.add(1L);
 }
 ...
 return putIfMatch(
 nonBlockingIdentityHashMap,
 chm.copy_slot_and_check(nonBlockingIdentityHashMap, objects0,
 int2, object1),
 object2, object0, object1);
 }
 }
 ...
 private
 Object[] help_copy(Object[] objects1) {
 ...
 void clear(){NonBlockingIdentityHashMap.this->clear();
 }

 int size() { return NonBlockingIdentityHashMap.this->size(); }
...
public
Enumeration<TypeK> keys() { return new NonBlockingIdentityHashMap.SnapshotK(); }
...
bool remove(void *object) {
 ...
 ? false
 : NonBlockingIdentityHashMap.this->remove(entry.getKey(),
 entry.getValue());
}
...
private
static class CHM<TypeK, TypeV> {
 const Counter _size;
 const Counter _slots;
 Object[] _newkvs;
private
 AtomicReferenceFieldUpdater<NonBlockingIdentityHashMap.CHM, Object[]>
 _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
 NonBlockingIdentityHashMap.CHM.class, Object[].class, "_newkvs");
 long _resizers;
private
 static AtomicLongFieldUpdater<NonBlockingIdentityHashMap.CHM>
...
private
 ...
 NonBlockingIdentityHashMap.reprobe_limit(int0);
 }

private
 Object[] resize(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 Object[] objects0) {
 ...
 long long1 = 0L;
 if (int2 <= int0 &&
 long0 <= nonBlockingIdentityHashMap._last_resize_milli + 10000L &&
 ...
 void help_copy_impl(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 ...
 if (this->copy_slot(nonBlockingIdentityHashMap, int3 + int5 & int0 - 1,
 objects0, objects1) {
 int4++;
 }
 }
...
private
 Object[] copy_slot_and_check(
 NonBlockingIdentityHashMap nonBlockingIdentityHashMap, Object[] objects0,
 int int0, Object object) {
 assert NonBlockingIdentityHashMap.chm(objects0) == this;
 ...
 if (this->copy_slot(nonBlockingIdentityHashMap, int0, objects0,
 this->_newkvs) {
 this->copy_check_and_promote(nonBlockingIdentityHashMap, objects0, 1);
 }

 return object = =
 nullptr ? objects1 : nonBlockingIdentityHashMap.help_copy(objects1);
 }

 void
 copy_check_and_promote(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 ...
 if (long0 + int1 == int0 && nonBlockingIdentityHashMap._kvs == objects &&
 nonBlockingIdentityHashMap.CAS_kvs(objects, this->_newkvs) {
 nonBlockingIdentityHashMap._last_resize_milli =
 System.currentTimeMillis();
 }
 }

 bool copy_slot(NonBlockingIdentityHashMap nonBlockingIdentityHashMap,
 int int0, Object[] objects0, Object[] objects1) {
 void *object0;
 while ((object0 = NonBlockingIdentityHashMap.key(objects0, int0) ==
 nullptr) {
 NonBlockingIdentityHashMap.CAS_key(objects0, int0, nullptr,
 NonBlockingIdentityHashMap.TOMBSTONE);
 }
 ...
 NonBlockingIdentityHashMap.Prime prime =
 object1 != nullptr && object1 != NonBlockingIdentityHashMap.TOMBSTONE
 ...
 bool boolean0 = NonBlockingIdentityHashMap.putIfMatch(
 nonBlockingIdentityHashMap, objects1, object0,
 object2, nullptr) == nullptr;

 while (!NonBlockingIdentityHashMap.CAS_val(
 objects0, int0, object1, NonBlockingIdentityHashMap.TOMBPRIME) {
 object1 = NonBlockingIdentityHashMap.val(objects0, int0);
 }
...
private static class Prime {
 ...
 NonBlockingIdentityHashMap.Prime
 ? ((NonBlockingIdentityHashMap.Prime)object)._V
 : object;
 }
}

class SnapshotE implements Iterator<Entry<TypeK, TypeV>> {
 NonBlockingIdentityHashMap<TypeK, TypeV>.SnapshotV _ss =
 NonBlockingIdentityHashMap.this->std::make_unique<SnapshotV>();
...
public
 ...
 this->_ss.next();
 return NonBlockingIdentityHashMap.this->new NBHMEntry(this->_ss._prevK,
 this->_ss._prevV);
 }
...
public
 ...
 NonBlockingIdentityHashMap.CHM chm =
 NonBlockingIdentityHashMap.chm(objects);
 if (chm._newkvs.empty()) {
 this->_sskvs = objects;
 this->next();
 return;
 ...
 int length() { return NonBlockingIdentityHashMap.len(this->_sskvs); }
 ...
 (this->_nextV = NonBlockingIdentityHashMap.this->get(this->_nextK) !=
 nullptr) {
 break;
 }
 }
 ...
 NonBlockingIdentityHashMap.this, this->_sskvs, this->_prevK,
 NonBlockingIdentityHashMap.TOMBSTONE, this->_prevV);
 this->_prevV = nullptr;
 }
 }
