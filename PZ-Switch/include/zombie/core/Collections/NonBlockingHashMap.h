...
private
 static NonBlockingHashMap.Prime TOMBPRIME;
private
...
private
 static NonBlockingHashMap.CHM chm(Object[] objects) {
...
static class CHM<TypeK, TypeV> {
 ...
 Object[] _newkvs;
private
 AtomicReferenceFieldUpdater<NonBlockingHashMap.CHM, Object[]>
 _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
 NonBlockingHashMap.CHM.class, Object[].class, "_newkvs");
 long _resizers;
private
 static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _resizerUpdater =
 AtomicLongFieldUpdater.newUpdater(NonBlockingHashMap.CHM.class,
 "_resizers");
 long _copyIdx = 0L;
private
 static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _copyIdxUpdater =
 AtomicLongFieldUpdater.newUpdater(NonBlockingHashMap.CHM.class,
 "_copyIdx");
 long _copyDone = 0L;
private
 static AtomicLongFieldUpdater<NonBlockingHashMap.CHM> _copyDoneUpdater =
 AtomicLongFieldUpdater.newUpdater(NonBlockingHashMap.CHM.class,
 "_copyDone");
...
private
 Object[] resize(NonBlockingHashMap nonBlockingHashMap,
 Object[] objects0) {
...
private
 Object[] copy_slot_and_check(NonBlockingHashMap nonBlockingHashMap,
...
class SnapshotE implements Iterator<Entry<TypeK, TypeV>> {
 NonBlockingHashMap<TypeK, TypeV>.SnapshotV _ss =
