...
private
 boolean m_waitingForRenderState = false;
...
public
 ...
 { std::lock_guard<std::mutex> __sync_lock__(m_states_mutex); this->m_states.notifyAll(); }
 }
 ...
 void pushFrameDown() {
 { std::lock_guard<std::mutex> __sync_lock__(m_states_mutex);
