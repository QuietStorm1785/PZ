...
private
 static boolean[] OptionSingleContextMenu = new boolean[4];
...
private
 static HashMap<String, Object> optionsOnStartup =
...
private
 ...
 static int zz = 0;
public
 HashMap<Integer, Float> FloatParamMap = std::make_unique<HashMap<>>();
