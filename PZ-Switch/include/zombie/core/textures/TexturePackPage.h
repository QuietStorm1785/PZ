...
public
 static HashMap<String, Texture> subTextureMap =
 std::make_unique<HashMap<>>();
public
 static HashMap<String, Texture> subTextureMap2 =
 std::make_unique<HashMap<>>();
public
 static HashMap<String, TexturePackPage> texturePackPageMap =
 std::make_unique<HashMap<>>();
public
 static HashMap<String, String> TexturePackPageNameMap =
 std::make_unique<HashMap<>>();
public
 HashMap<String, Texture> subTextures = std::make_unique<HashMap<>>();
 Texture tex = nullptr;
