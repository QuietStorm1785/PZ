...
private
 ArrayList<TextureCombiner.CombinerFBO> fboPool =
...
private
 ...
 texture = combinerFBO.textures.empty() ? new Texture(int0, int1, 16)
 ...
 GL13.glActiveTexture(33984);
 GL11.glEnable(3553);
 Texture texture1 = textureCombinerCommand.tex == nullptr
