...
public
 ArrayList<TextureCombinerCommand> commands =
...
private
 HashMap<Integer, ArrayList<Integer>> categoryMap =
 std::make_unique<HashMap<>>();
 static SmartShader bodyMask;
 static SmartShader bodyMaskTint;
 static SmartShader bodyMaskHue;
private
 static ArrayList<TextureCombinerShaderParam> bodyMaskParams =
 std::make_unique<ArrayList<>>();
 static SmartShader addHole;
private
 static ArrayList<TextureCombinerShaderParam> addHoleParams =
 std::make_unique<ArrayList<>>();
 static SmartShader removeHole;
private
 static ArrayList<TextureCombinerShaderParam> removeHoleParams =
 std::make_unique<ArrayList<>>();
