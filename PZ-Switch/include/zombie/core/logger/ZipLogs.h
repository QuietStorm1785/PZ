...
public:
 ...
 addToZip(fileSystem, "/addition/translationProblems.txt",
 "translationProblems.txt");
 addToZip(fileSystem, "/addition/gamepadBinding.config",
 "gamepadBinding.config");
 ...
 addSaveOldToZip(fileSystem, "/save_old/reanimated.bin",
 "reanimated.bin");
 ...
 addSaveOldToZip(fileSystem, "/save_old/players.db-journal",
 "players.db-journal");
 addSaveOldToZip(fileSystem, "/save_old/vehicles.db", "vehicles.db");
 addSaveOldToZip(fileSystem, "/save_old/vehicles.db-journal",
 "vehicles.db-journal");
 putTextFile(fileSystem, "/save_old/description.txt",
 getLastSaveDescription());
 } else {
 ...
 addSaveToZip(fileSystem, "/save/players.db-journal",
 "players.db-journal");
 addSaveToZip(fileSystem, "/save/vehicles.db", "vehicles.db");
 addSaveToZip(fileSystem, "/save/vehicles.db-journal",
 "vehicles.db-journal");
 putTextFile(fileSystem, "/save/description.txt",
 getCurrentSaveDescription());
 }
 ...
 .getPath(ZomboidFileSystem.instance.getCacheDir() +
 File.separator + string1)
 .toAbsolutePath();
 ...
 new FileReader(new File(ZomboidFileSystem.instance.getCacheDir() +
 ...
 Files.createDirectories(path0.getParent());
 Path path1 = FileSystems.getDefault()
 .getPath(ZomboidFileSystem.instance.getSaveDir() +
 File.separator + string1 + File.separator +
 string0 + File.separator + string3)
 .toAbsolutePath();
 Files.deleteIfExists(path0);
 if (Files.exists(path1) {
 Files.copy(path1, path0, StandardCopyOption.REPLACE_EXISTING);
 ...
 try {
 if (!path0x.endsWith("ServerList.txt") &&
 !path0x.endsWith("ServerListSteam.txt")) {
...
static void addLogToZip(FileSystem fileSystem, std::string_view string1,
 ...
 ZomboidFileSystem.instance.getCacheDir() + File.separator + string0);
 ...
 Path path2 =
 fileSystem.getPath("/" + string1 + "/log_" + (int0 + 1) + ".txt");
...
static void addDebugLogToZip(FileSystem fileSystem, std::string_view string2,
 ...
 Path path1 =
 fileSystem.getPath("/" + string2 + "/log_" + int1 + ".txt");
 Path path2 =
 fileSystem.getPath("/" + string2 + "/log_" + (int1 + 1) + ".txt");
