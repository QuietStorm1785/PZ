...
public
 IntHypercube(int int0, int int1, int int2, int int3) {
 this->width = int0;
 this->height = int1;
 this->depth = int2;
 this->quanta = int3;
 ...
 IntHypercube clone() {
 IntHypercube intHypercube0 =
 new IntHypercube(this->width, this->height, this->depth, this->quanta);
 ...
 void fill(int int0) { Arrays.fill(this->value, int0); }
