...
public:
 ...
 throw RuntimeException("Cannot add flags, exceeding byte bounds or "
 ...
 throw RuntimeException("Cannot add flags, exceeding short bounds or "
 "negative number flags. (" +
 int0 + ")");
 }
 }
 ...
 throw RuntimeException("Cannot add flags, exceeding integer bounds "
 ...
 throw RuntimeException("Cannot add flags, exceeding long bounds or "
 "negative number flags. (" +
 int0 + ")");
 }
 }
 ...
 if (int0 < 0 || int0 > int1) {
 throw RuntimeException("Cannot check for flags, exceeding byte "
