...
public
 static long GetFriendByIndex(int var0);

public
 static String GetFriendPersonaName(long var0);

public
 static int GetFriendPersonaState(long var0);

public
 static boolean InviteUserToGame(long var0, String var2);

public
 static void ActivateGameOverlay(String var0);

public
 static void ActivateGameOverlayToUser(String var0, long var1);

public
 static void ActivateGameOverlayToWebPage(String var0);

public
 static void SetPlayedWith(long var0);

public
 static void UpdateRichPresenceConnectionInfo(String var0, String var1);
...
public
 static int CreateSteamAvatar(long var0, ByteBuffer var2);
