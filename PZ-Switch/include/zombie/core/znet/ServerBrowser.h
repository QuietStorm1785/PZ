...
private
 static void n_Release();

private
 static boolean n_IsRefreshing();

private
 static boolean n_QueryServer(String var0, int var1);

private
 static GameServerDetails n_GetServerDetails(String var0, int var1);

private
 static void n_ReleaseServerQuery(String var0, int var1);

private
 static boolean n_RequestServerRules(String var0, int var1);
