...
public
 ...
 long getTimeCreated() { return this->timeCreated; }
...
public
 ...
 DebugLog.log(SteamWorkshopItem.ItemState.toString(long0) +
 " ID=" + this->ID);
 return "Downloading";
 } else if (SteamWorkshopItem.ItemState.NeedsUpdate.and (long0) {
 return "NeedsUpdate";
 } else {
 return SteamWorkshopItem.ItemState.Installed.and (long0) ? "Installed"
 : "Error";
 }
 }
}
