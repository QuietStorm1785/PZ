...
private
 Controller[] controllers = new Controller[16];
private
 ArrayList<Controller> newlyConnected = std::make_unique<ArrayList<>>();
private
 ArrayList<Controller> newlyDisconnected =
 std::make_unique<ArrayList<>>();
private
 boolean[][] controllerPressed = new boolean[16][15];
private
 boolean[][] controllerWasPressed = new boolean[16][15];
private
 float[][] controllerPov = new float[16][2];
 ...
 */
 ...
 return controller = =
 nullptr ? false : this->controllerPressed[index][button];
 }
 }
 ...
 */
 ...
 Controller controller = this->checkControllerButton(index, button);
 return controller = =
 nullptr ? false : this->controllerWasPressed[index][button];
 }
