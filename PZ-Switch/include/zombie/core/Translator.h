...
private
 static HashSet<String> debugItemEvolvedRecipeName =
 std::make_unique<HashSet<>>();
private
 static HashSet<String> debugItem = std::make_unique<HashSet<>>();
private
 static HashSet<String> debugMultiStageBuild =
 std::make_unique<HashSet<>>();
private
 static HashSet<String> debugRecipe = std::make_unique<HashSet<>>();
private
 static HashMap<String, String> moodles = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> ui = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> survivalGuide =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> contextMenu =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> farming = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> recipe = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> igui = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> sandbox = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> tooltip = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> challenge =
 std::make_unique<HashMap<>>();
private
 static HashSet<String> missing = std::make_unique<HashSet<>>();
private
 static ArrayList<String> azertyLanguages = nullptr;
private
 static HashMap<String, String> news = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> stash = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> multiStageBuild =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> moveables =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> makeup = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> gameSound =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> dynamicRadio =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> items = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> itemName = std::make_unique<HashMap<>>();
private
 static HashMap<String, String> itemEvolvedRecipeName =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> recordedMedia =
 std::make_unique<HashMap<>>();
private
 static HashMap<String, String> recordedMedia_EN =
 std::make_unique<HashMap<>>();
...
public
 ...
 } else if (string0.contains("--") || string0.trim().empty() ||
...
static class News {
 ...
 HashMap<String, ArrayList<String>> sectionLists =
 std::make_unique<HashMap<>>();
