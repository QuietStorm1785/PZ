...
public
 void Init(boolean steamMode);

private
 int Startup(int var1, String var2);
...
public
 void SetServerPort(int port, int UDPPort);

public
 void SetClientPort(int port);

public
 int Connect(String var1, int var2, String var3, boolean var4);

public
 int ConnectToSteamServer(long var1, String var3, boolean var4);
...
public
 void SetMaximumIncomingConnections(int num);

public
 void SetOccasionalPing(boolean bPing);

public
 void SetUnreliableTimeout(int timeout);

private
 boolean TryReceive();

private
 int nativeGetData(ByteBuffer var1);
...
private
 int sendNative(ByteBuffer var1, int var2, int var3, int var4,
 byte var5, long var6, boolean var8);

public
 long getGuidFromIndex(int id);

public
 long getGuidOfPacket();

public
 String getIPFromGUID(long guid);
...
public
 ZNetStatistics GetNetStatistics(long guid);

public
 int GetAveragePing(long guid);

public
 int GetLastPing(long guid);

public
 int GetLowestPing(long guid);

public
 int GetMTUSize(long guid);

public
 int GetConnectionsNumber();

public
 byte GetConnectionType(long guid);
}
} // namespace raknet
} // namespace core
} // namespace zombie
