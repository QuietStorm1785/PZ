...
public
 CarController.ClientControls clientControls =
 new CarController.ClientControls();
 bool engineStartingFromKeyboard;
private
 static CarController.BulletVariables bulletVariables =
...
public
 ...
 bool boolean0 = character != nullptr && character.Traits.SpeedDemon.isSet();
 bool boolean1 =
 character != nullptr && character.Traits.SundayDriver.isSet();
