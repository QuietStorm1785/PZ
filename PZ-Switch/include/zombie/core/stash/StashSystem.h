...
private
 static ArrayList<String> possibleTrap = std::make_unique<ArrayList<>>();
private
 ...
 */
 ...
 !stashContainer.containerItem.empty()) {
 ...
 stashContainer.containerSprite, false, nullptr);
