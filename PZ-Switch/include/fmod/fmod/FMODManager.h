...
private
 HashMap<String, FMOD_STUDIO_PARAMETER_DESCRIPTION>
 parameterDescriptionMap = std::make_unique<HashMap<>>();
private
 HashMap<String, FMOD_STUDIO_EVENT_DESCRIPTION> eventDescriptionMap =
 ...
 int numListeners = 1;
private
 HashMap<String, Long> fileToSoundMap = std::make_unique<HashMap<>>();
private
 int[] reverbPreset = new int[]{-1, -1, -1, -1};
