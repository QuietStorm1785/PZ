...
public
 Map<String, MethodParameterInformation> methods =
...
public ClassParameterInformation(Class<?> clazz) {
 ...
 this->methods.put(DescriptorUtil.getDescriptor(constructor),
 MethodParameterInformation.EMPTY);
 }

 for (Method method : clazz.getMethods()) {
 this->methods.put(DescriptorUtil.getDescriptor(method),
 MethodParameterInformation.EMPTY);
 }
 }

 std::string getPackageName() { return this->packageName; }

 std::string getSimpleClassName() { return this->simpleClassName; }
 ...
 getSimpleName(clazz) + ".luadebugdata";
 }

 static std::string getSimpleName(Class<?> clazz) {
 return clazz.getEnclosingClass() != nullptr
 ? getSimpleName(clazz.getEnclosingClass()) + "_" +
 clazz.getSimpleName()
 : clazz.getSimpleName();
 }
