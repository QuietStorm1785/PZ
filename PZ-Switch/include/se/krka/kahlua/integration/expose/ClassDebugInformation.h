...
public:
private
 Map<String, MethodDebugInformation> methods =
...
public ClassDebugInformation(Class<?> clazz, ClassParameterInformation classParameterInformation) {
 ...
 this->addMethod(classParameterInformation, types, string1, type,
 annotations, getName(luaMethod, string0),
 !isGlobal(luaMethod, isStatic(int0), desc);
 }
 }
 }
 ...
 LuaConstructor luaConstructor =
 constructor.getAnnotation(LuaConstructor.class);
 ...
 this->addMethod(classParameterInformation, types, string1, clazz,
 annotations, getName(luaConstructor, string0), true,
 desc);
 }
 }

 private
 void addMethod(ClassParameterInformation classParameterInformation,
 Type[] types, String string0, Type type1,
 Annotation[][] annotations, String string6, boolean boolean0,
 Desc desc) {
 MethodParameterInformation methodParameterInformation =
 classParameterInformation.methods.get(string0);
 ...
 new MethodDebugInformation(string6, boolean0, arrayList, string4,
 string5);
 ...
 if (annotation != nullptr && dynamic_cast<Desc*>(annotation) != nullptr) {
...
static bool isStatic(int int0) { return (int0 & 8) != 0; }
...
public
Map<String, MethodDebugInformation> getMethods() { return this->methods; }
}
} // namespace expose
} // namespace integration
} // namespace kahlua
