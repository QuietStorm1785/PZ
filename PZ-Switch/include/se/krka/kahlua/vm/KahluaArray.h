...
private
 ...
 return dynamic_cast<Double*>(object) != nullptr double0 ? double0.intValue() : -1;
 }
 ...
 void setMetatable(KahluaTable table) { this->metatable = table; }

public
 Class < ? > getJavaClass() { return nullptr; }
