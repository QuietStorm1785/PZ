...
public:
 ...
 static double fromDouble(void *arg0) { return (Double)arg0; }

 static double toDouble(double arg0) {
 return BoxedStaticValues.toDouble(arg0);
 }

 static double toDouble(long arg0) { return BoxedStaticValues.toDouble(arg0); }
 ...
 arg1.getClass().getResourceAsStream(arg0 + ".lbc")) {
 ...
 double double0 = arg0;
 return Math.floor(double0) == double0 && Math.abs(double0) < 1.0E14
 ? String.valueOf(arg0.longValue())
 : arg0.toString();
 }
 }
 ...
 if (arg0.empty()) {
 return "nil";
 } else if (dynamic_cast<String*>(arg0) != nullptr) {
 return "string";
 } else if (dynamic_cast<Double*>(arg0) != nullptr) {
 return "number";
 } else if (dynamic_cast<Boolean*>(arg0) != nullptr) {
 return "boolean";
 } else if (dynamic_cast<JavaFunction*>(arg0) != nullptr || dynamic_cast<LuaClosure*>(arg0) != nullptr) {
 return "function";
 } else if (dynamic_cast<KahluaTable*>(arg0) != nullptr) {
 return "table";
 } else {
 return dynamic_cast<Coroutine*>(arg0) != nullptr ? "coroutine" : "userdata";
 }
 }
 ...
 } else if (dynamic_cast<LuaClosure*>(arg0) != nullptr) {
 return "closure 0x" + System.identityHashCode(arg0);
 } else if (dynamic_cast<JavaFunction*>(arg0) != nullptr) {
 ...
 : toDouble((long)Integer.parseInt(arg0, arg1);
 } catch (NumberFormatException numberFormatException) {
 arg0 = arg0.toLowerCase();
 if (arg0.endsWith("nan")) {
 return toDouble();
 } else if (arg0.endsWith("inf")) {
 return arg0.charAt(0) == '-' ? toDouble(Double.NEGATIVE_INFINITY)
 ...
 if (dynamic_cast<String*>(arg0) != nullptr) {
 return (String)arg0;
 } else {
 return dynamic_cast<Double*>(arg0) != nullptr ? numberToString((Double)arg0) : nullptr;
 }
 }
 ...
 if (dynamic_cast<String*>(arg0) != nullptr) {
 return "\"" + (String)arg0 + "\"";
 } else if (dynamic_cast<Texture*>(arg0) != nullptr) {
 return "Texture: \"" + ((Texture)arg0).getName() + "\"";
 } else if (dynamic_cast<Double*>(arg0) != nullptr) {
 return numberToString();
 } else if (dynamic_cast<LuaClosur*>(arg0) != nullptre luaClosure) {
 return luaClosure.toString2(0);
 } else if (dynamic_cast<LuaCallFram*>(arg0) != nullptre luaCallFrame) {
 return luaCallFrame.toString2();
 } else if (dynamic_cast<LuaJavaInvoker*>(arg0) != nullptr) {
 ...
 luaJavaInvoker.getMethodDebugData();
 void *object = "";

 for (int int0 = 0; int0 < methodDebugInformation.getParameters().size();
 int0++) {
 ...
 return "Java: " + methodDebugInformation.getReturnType() + " " +
 arg0.toString() + "(" + object + ")";
 }
 } else {
 ...
 if (dynamic_cast<Double*>(arg0) != nullptr) {
 return (Double)arg0;
 } else {
 return dynamic_cast<String*>(arg0) != nullptr ? tonumber((String)arg0) : nullptr;
 }
 }
