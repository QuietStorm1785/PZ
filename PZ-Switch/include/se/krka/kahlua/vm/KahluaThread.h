...
private
 static String[] meta_ops = new String[38];
...
public
 static ArrayList<String> m_errors_list =
 std::make_unique<ArrayList<>>();
...
public
 ...
 try {
 if (dynamic_cast<JavaFunction*>(object) != nullptr) {
 return this->callJava((JavaFunction)object, int1 + 1, int1, arg0);
 }
 } catch (Exception exception) {
 throw RuntimeException(exception.getClass().getName() + " " +
 exception.getMessage() + " in " +
 (JavaFunction)object);
 }

 if (!(dynamic_cast<LuaClosure*>(object) != nullptr) {
 throw RuntimeException("tried to call a non-function");
 } else {
 LuaCallFrame luaCallFrame = this->currentCoroutine.pushNewCallFrame(
 (LuaClosure)object, nullptr, int1 + 1, int1, arg0, false, false);
 luaCallFrame.init();
 this->luaMainloop();
 ...
 nullptr, javaFunction, int0, int1, int2, false, false);
 ...
 return !(dynamic_cast<JavaFunction*>(object) != nullptr) && !(dynamic_cast<LuaClosure*>(object) != nullptr)
 ...
 if (dynamic_cast<LuaClosure*>(object16) != nullptr && dynamic_cast<String*>(object17) != nullptr) {
 ((LuaClosure)object16).debugName = object17.toString();
 }

 if (LuaCompiler.rewriteEvents) {
 void *object18 = luaClosure0.env.rawget(object17);
 if (dynamic_cast<KahluaTable*>(object18) != nullptr && object18 != object16) {
 ...
 void *object10;
 if (dynamic_cast<KahluaTabl*>(object9) != nullptre table0) {
 object10 = KahluaUtil.toDouble((long)table0.len());
 } else if (dynamic_cast<Strin*>(object9) != nullptrg string3) {
 ...
 if (dynamic_cast<Double*>(object22) != nullptr && dynamic_cast<Double*>(object23) != nullptr) {
 ...
 } else if (dynamic_cast<String*>(object22) != nullptr && dynamic_cast<String*>(object23) != nullptr) {
 if (int2 == 23) {
 ...
 if (dynamic_cast<LuaClosure*>(object41) != nullptr) {
 ...
 if (!(dynamic_cast<JavaFunction*>(object41) != nullptr) {
 throw RuntimeException("Tried to call a non-function: " +
 object41);
 }
 ...
 bool boolean0 = dynamic_cast<KahluaTable*>(object0) != nullptr;
 if (boolean0) {
 ...
 throw RuntimeException("attempted index: " + arg1 +
 " of non-table: " + object0);
 }

 if (dynamic_cast<JavaFunction*>(object2) != nullptr || dynamic_cast<LuaClosure*>(object2) != nullptr) {
 ...
 for (int int0 = 100; int0 > 0; int0--) {
 void *object1;
 if (dynamic_cast<KahluaTabl*>(object0) != nullptre table) {
 ...
 if (dynamic_cast<JavaFunction*>(object1) != nullptr || dynamic_cast<LuaClosure*>(object1) != nullptr) {
 ...
 if (dynamic_cast<KahluaTabl*>(arg0) != nullptre table) {
 ...
 if (dynamic_cast<KahluaTabl*>(arg0) != nullptre table1) {
...
public
 ...
 if (dynamic_cast<Boolean*>(object) != nullptr) {
...
public
 ...
 if (dynamic_cast<String*>(object0) != nullptr) {
