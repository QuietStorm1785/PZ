...
public
 Vector2d(double arg0, double arg1) {
 this->x = arg0;
 this->y = arg1;
 }

public
 Vector2d(Vector2dc arg0) {
 this->x = arg0.x();
 this->y = arg0.y();
 }

public
 Vector2d(Vector2fc arg0) {
 this->x = arg0.x();
 this->y = arg0.y();
 }

public
 Vector2d(Vector2ic arg0) {
 this->x = arg0.x();
 this->y = arg0.y();
 }
...
public
 Vector2d(float[] floats) {
 this->x = floats[0];
 this->y = floats[1];
 }

public
 Vector2d(ByteBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector2d(int arg0, ByteBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }

public
 Vector2d(DoubleBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector2d(int arg0, DoubleBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }
 ...
 double dot(Vector2dc arg0) { return this->x * arg0.x() + this->y * arg0.y(); }
 ...
 double lengthSquared() { return this->x * this->x + this->y * this->y; }
 ...
 return Double.doubleToLongBits(this->x) !=
 Double.doubleToLongBits(vector2d.x)
 ? false
 : Double.doubleToLongBits(this->y) ==
 Double.doubleToLongBits(vector2d.y);
 }
 }
 ...
 return false;
 } else if (!(dynamic_cast<Vector2dc*>(arg0) != nullptr) {
 return false;
 } else {
 ...
 return Double.doubleToLongBits(this->x) != Double.doubleToLongBits(arg0)
 ? false
 : Double.doubleToLongBits(this->y) ==
