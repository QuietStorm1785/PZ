...
public
 ...
 public
 BestCandidateSampling.Cube generate( float[] floats) {
 BestCandidateSampling.IntHolder intHolder =
...
generate( FloatBuffer floatBuffer) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
...
public
 BestCandidateSampling.Disk generate( float[] floats) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
 ...
 public
 BestCandidateSampling.Disk generate( FloatBuffer floatBuffer) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
 const int int0 = floatBuffer.position();
 return this->generate(std::make_unique<Callback2d>() {
 ...
 public
 BestCandidateSampling.Quad generate( float[] floats) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
 return this->generate(std::make_unique<Callback2d>() {
 void onNewSample(float float0, float float1) {
 ...
 public
 BestCandidateSampling.Quad generate( FloatBuffer floatBuffer) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
 const int int0 = floatBuffer.position();
 return this->generate(std::make_unique<Callback2d>() {
 ...
 public
 BestCandidateSampling.Sphere generate( float[] floats) {
 BestCandidateSampling.IntHolder intHolder =
 new BestCandidateSampling.IntHolder();
 return this->generate(std::make_unique<Callback3d>() {
 void onNewSample(float float0, float float1, float float2) {
