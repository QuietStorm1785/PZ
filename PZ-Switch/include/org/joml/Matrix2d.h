...
public
 Matrix2d(Matrix2dc arg0) {
 if (dynamic_cast<Matrix2d*>(arg0) != nullptr) {
...
public
 Matrix2d(Matrix3dc arg0) {
 if (dynamic_cast<Matrix3d*>(arg0) != nullptr) {
...
public
 Matrix2d(double arg0, double arg1, double arg2, double arg3) {
 this->m00 = arg0;
 this->m01 = arg1;
 this->m10 = arg2;
 this->m11 = arg3;
...
public
 Matrix2d(DoubleBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Matrix2d(Vector2dc arg0, Vector2dc arg1) {
 this->m00 = arg0.x();
 this->m01 = arg0.y();
 this->m10 = arg1.x();
 this->m11 = arg1.y();
 ...
 if (dynamic_cast<Matrix3x2d*>(arg0) != nullptr) {
 ...
 Matrix2d mul(Matrix2dc arg0) { return this->mul(arg0, this); }
 ...
 Matrix2d mul(Matrix2fc arg0) { return this->mul(arg0, this); }
 ...
 Matrix2d mulLocal(Matrix2dc arg0) { return this->mulLocal(arg0, this); }
 ...
 double determinant() { return this->m00 * this->m11 - this->m10 * this->m01; }

 Matrix2d invert() { return this->invert(this); }
 ...
 Matrix2d transpose() { return this->transpose(this); }
 ...
 Matrix2d get(Matrix2d arg0) { return arg0.set(this); }

 Matrix3x2d get(Matrix3x2d arg0) { return arg0.set(this); }

 Matrix3d get(Matrix3d arg0) { return arg0.set(this); }

 double getRotation() { return Math.atan2(this->m01, this->m11); }
...
public
 ...
 Matrix2d scale(double arg0) { return this->scale(arg0, arg0); }
 ...
 Matrix2d scaling(Vector2dc arg0) { return this->scaling(arg0.x(), arg0.y()); }
 ...
 Vector2d transform(Vector2d arg0) { return arg0.mul(this); }
 ...
 Vector2d transformTranspose(Vector2d arg0) { return arg0.mulTranspose(this); }
 ...
 Matrix2d rotate(double arg0) { return this->rotate(arg0, this); }
 ...
 Matrix2d rotateLocal(double arg0) { return this->rotateLocal(arg0, this); }
 ...
 Matrix2d normal() { return this->normal(this); }
 ...
 Double.doubleToLongBits(matrix2d.m00) {
 return false;
 } else if (Double.doubleToLongBits(this->m01) !=
 Double.doubleToLongBits(matrix2d.m01) {
 return false;
 } else {
 return Double.doubleToLongBits(this->m10) !=
 Double.doubleToLongBits(matrix2d.m10)
 ? false
 : Double.doubleToLongBits(this->m11) ==
 Double.doubleToLongBits(matrix2d.m11);
 }
 }
 }
 ...
 return false;
 } else if (!(dynamic_cast<Matrix2d*>(arg0) != nullptr) {
 return false;
 ...
 Matrix2d add(Matrix2dc arg0) { return this->add(arg0, this); }
 ...
 Matrix2d sub(Matrix2dc arg0) { return this->sub(arg0, this); }
 ...
 Matrix2d mulComponentWise(Matrix2dc arg0) { return this->sub(arg0, this); }
