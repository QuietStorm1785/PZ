...
public:
private
 QuaterniondInterpolator.SvdDecomposition3d svdDecomposition3d =
 new QuaterniondInterpolator.SvdDecomposition3d();
private
 double[] m = new double[9];
 const Matrix3d u = new Matrix3d();
 const Matrix3d v = new Matrix3d();

 Quaterniond computeWeightedAverage(Quaterniond[] quaternionds,
 double[] doubles, int int1,
 Quaterniond quaterniond1) {
 double double0 = 0.0;
 double double1 = 0.0;
 double double2 = 0.0;
 double double3 = 0.0;
...
private
 static class SvdDecomposition3d {
 private
 ...
 void svd(double[] doubles, int int31, Matrix3d matrix3d0,
 Matrix3d matrix3d1) {
 int int0 = 0;
 int int1 = 0;
 double double0 = 0.0;
 ...
 doubles[int7 + 3 * int5] = doubles[int7 + 3 * int5] +
 double4 * doubles[int7 + 3 * int2];
 }
 }
 }
 ...
 double3 +=
 doubles[int12 + 3 * int13] * doubles[int2 + 3 * int13];
 }

 for (int int14 = int0; int14 < 3; int14++) {
 doubles[int12 + 3 * int14] =
 doubles[int12 + 3 * int14] + double3 * this->rv1[int14];
 }
 }
 }
 ...
 double0 = Math.max(double0,
 Math.abs(this->w[int2]) + Math.abs(this->rv1[int2]));
 }
 ...
 this->v[int17 + 3 * int16] = doubles[int16 + 3 * int17] /
 doubles[int16 + 3 * int0] / double1;
 }
 ...
 double9 +=
 doubles[int26 + 3 * int22] * doubles[int26 + 3 * int25];
 }

 double double10 = double9 / doubles[int22 + 3 * int22] * double1;

 for (int int27 = int22; int27 < 3; int27++) {
 doubles[int27 + 3 * int25] =
 doubles[int27 + 3 * int25] +
 double10 * doubles[int27 + 3 * int22];
 }
 }
 }
 ...
 doubles[int33 + 3 * int1] =
 double15 * double11 + double16 * double12;
 doubles[int33 + 3 * int32] =
 double16 * double11 - double15 * double12;
 }
 }
 }
 }
 ...
 if (int30 == int31 - 1) {
 throw RuntimeException("No convergence after " + int31 +
 " iterations");
 }
 ...
 double double21 = ((double19 - double17) * (double19 + double17) +
 (double1 - double20) * (double1 + double20) /
 (2.0 * double20 * double19);
 double1 = PYTHAG(double21, 1.0);
 double21 =
 ((double18 - double17) * (double18 + double17) +
 double20 *
 (double19 / (double21 + this->SIGN(double1, double21) -
 double20) /
 double18;
 double double22 = 1.0;
 double double23 = 1.0;
 ...
 this->v[int37 + 3 * int35] =
 double18 * double23 + double17 * double22;
 this->v[int37 + 3 * int36] =
 double17 * double23 - double18 * double22;
 }
 ...
 doubles[int38 + 3 * int35] =
 double19 * double23 + double17 * double22;
 doubles[int38 + 3 * int36] =
 double17 * double23 - double19 * double22;
 }
 }
