...
public:
 ...
 try {
 java.lang.Math.class.getDeclaredMethod("fma", float.class, float.class,
 float.class);
 return true;
...
private
 ...
 return HAS_floatToRawIntBits ? floatToIntBits1_3(float0)
 : floatToIntBits1_2(float0);
 }
 ...
 return HAS_doubleToRawLongBits ? doubleToLongBits1_3(double0)
 : doubleToLongBits1_2(double0);
 }
 ...
 return Double.isInfinite(double0)
 ? padLeft(numberFormat, double0 > 0.0 ? " +Inf" : " -Inf")
 : numberFormat.format(double0);
 }
 }
