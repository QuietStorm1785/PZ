...
public
 Vector4d(Vector3dc arg0, double arg1) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg1;
...
public
 Vector4d(Vector3ic arg0, double arg1) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg1;
...
public
 Vector4d(Vector2dc arg0, double arg1, double arg2) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg1;
 this->w = arg2;
...
public
 Vector4d(Vector2ic arg0, double arg1, double arg2) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg1;
 this->w = arg2;
...
public
 Vector4d(Vector3fc arg0, double arg1) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg1;
...
public
 Vector4d(Vector2fc arg0, double arg1, double arg2) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg1;
 this->w = arg2;
...
public
 Vector4d(double arg0, double arg1, double arg2, double arg3) {
 this->x = arg0;
 this->y = arg1;
 this->z = arg2;
 this->w = arg3;
...
public
 Vector4d(ByteBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector4d(int arg0, ByteBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }

public
 Vector4d(DoubleBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector4d(int arg0, DoubleBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }
 ...
 return (arg0.properties() & 2) != 0 ? this->mulAffine(arg0, this)
 : this->mulGeneric(arg0, this);
 }

 Vector4d mul(Matrix4dc arg0, Vector4d arg1) {
 return (arg0.properties() & 2) != 0 ? this->mulAffine(arg0, arg1)
 : this->mulGeneric(arg0, arg1);
 }

 Vector4d mulTranspose(Matrix4dc arg0) {
 return (arg0.properties() & 2) != 0 ? this->mulAffineTranspose(arg0, this)
 : this->mulGenericTranspose(arg0, this);
 }

 Vector4d mulTranspose(Matrix4dc arg0, Vector4d arg1) {
 return (arg0.properties() & 2) != 0 ? this->mulAffineTranspose(arg0, arg1)
 : this->mulGenericTranspose(arg0, arg1);
 }

 Vector4d mulAffine(Matrix4dc arg0, Vector4d arg1) {
 double double0 =
 Math.fma(arg0.m00(), this->x,
 Math.fma(arg0.m10(), this->y,
 Math.fma(arg0.m20(), this->z, arg0.m30() * this->w));
 double double1 =
 Math.fma(arg0.m01(), this->x,
 Math.fma(arg0.m11(), this->y,
 Math.fma(arg0.m21(), this->z, arg0.m31() * this->w));
 double double2 =
 Math.fma(arg0.m02(), this->x,
 Math.fma(arg0.m12(), this->y,
 Math.fma(arg0.m22(), this->z, arg0.m32() * this->w));
 arg1.x = double0;
 arg1.y = double1;
 arg1.z = double2;
 arg1.w = this->w;
 ...
 matrix4dc.m00(), this->x,
 Math.fma(matrix4dc.m10(), this->y,
 Math.fma(matrix4dc.m20(), this->z, matrix4dc.m30() * this->w));
 double double1 = Math.fma(
 matrix4dc.m01(), this->x,
 Math.fma(matrix4dc.m11(), this->y,
 Math.fma(matrix4dc.m21(), this->z, matrix4dc.m31() * this->w));
 double double2 = Math.fma(
 matrix4dc.m02(), this->x,
 Math.fma(matrix4dc.m12(), this->y,
 Math.fma(matrix4dc.m22(), this->z, matrix4dc.m32() * this->w));
 double double3 = Math.fma(
 matrix4dc.m03(), this->x,
 Math.fma(matrix4dc.m13(), this->y,
 Math.fma(matrix4dc.m23(), this->z, matrix4dc.m33() * this->w));
 vector4d1.x = double0;
 vector4d1.y = double1;
 vector4d1.z = double2;
 vector4d1.w = double3;
 ...
 arg1.x = Math.fma(arg0.m00(), double0,
 Math.fma(arg0.m01(), double1, arg0.m02() * double2);
 arg1.y = Math.fma(arg0.m10(), double0,
 Math.fma(arg0.m11(), double1, arg0.m12() * double2);
 arg1.z = Math.fma(arg0.m20(), double0,
 Math.fma(arg0.m21(), double1, arg0.m22() * double2);
 arg1.w =
 Math.fma(arg0.m30(), double0,
 Math.fma(arg0.m31(), double1, arg0.m32() * double2 + double3);
 return arg1;
 }
 ...
 double double2 = this->z;
 double double3 = this->w;
 vector4d1.x = Math.fma(matrix4dc.m00(), double0,
 Math.fma(matrix4dc.m01(), double1,
 Math.fma(matrix4dc.m02(), double2,
 matrix4dc.m03() * double3));
 vector4d1.y = Math.fma(matrix4dc.m10(), double0,
 Math.fma(matrix4dc.m11(), double1,
 Math.fma(matrix4dc.m12(), double2,
 matrix4dc.m13() * double3));
 vector4d1.z = Math.fma(matrix4dc.m20(), double0,
 Math.fma(matrix4dc.m21(), double1,
 Math.fma(matrix4dc.m22(), double2,
 matrix4dc.m23() * double3));
 vector4d1.w = Math.fma(matrix4dc.m30(), double0,
 Math.fma(matrix4dc.m31(), double1,
 Math.fma(matrix4dc.m32(), double2,
 matrix4dc.m33() * double3));
 return vector4d1;
 }
 ...
 double double0 = Math.fma(
 (double)arg0.m00(), this->x,
 Math.fma((double)arg0.m10(), this->y,
 Math.fma((double)arg0.m20(), this->z, arg0.m30() * this->w));
 double double1 = Math.fma(
 (double)arg0.m01(), this->x,
 Math.fma((double)arg0.m11(), this->y,
 Math.fma((double)arg0.m21(), this->z, arg0.m31() * this->w));
 double double2 = Math.fma(
 (double)arg0.m02(), this->x,
 Math.fma((double)arg0.m12(), this->y,
 Math.fma((double)arg0.m22(), this->z, arg0.m32() * this->w));
 this->x = double0;
 this->y = double1;
 this->z = double2;
 return this;
 ...
 double double0 = Math.fma((double)matrix4fc.m00(), this->x,
 Math.fma((double)matrix4fc.m10(), this->y,
 Math.fma((double)matrix4fc.m20(), this->z,
 matrix4fc.m30() * this->w));
 double double1 = Math.fma((double)matrix4fc.m01(), this->x,
 Math.fma((double)matrix4fc.m11(), this->y,
 Math.fma((double)matrix4fc.m21(), this->z,
 matrix4fc.m31() * this->w));
 double double2 = Math.fma((double)matrix4fc.m02(), this->x,
 Math.fma((double)matrix4fc.m12(), this->y,
 Math.fma((double)matrix4fc.m22(), this->z,
 matrix4fc.m32() * this->w));
 vector4d1.x = double0;
 vector4d1.y = double1;
 vector4d1.z = double2;
 vector4d1.w = this->w;
 ...
 Math.fma((double)matrix4fc.m22(), this->z,
 matrix4fc.m32() * this->w));
 double double3 = Math.fma((double)matrix4fc.m03(), this->x,
 Math.fma((double)matrix4fc.m13(), this->y,
 Math.fma((double)matrix4fc.m23(), this->z,
 matrix4fc.m33() * this->w));
 vector4d1.x = double0;
 vector4d1.y = double1;
 vector4d1.z = double2;
 vector4d1.w = double3;
 ...
 double double0 =
 1.0 /
 Math.fma(arg0.m03(), this->x,
 Math.fma(arg0.m13(), this->y,
 Math.fma(arg0.m23(), this->z, arg0.m33() * this->w));
 double double1 =
 Math.fma(arg0.m00(), this->x,
 Math.fma(arg0.m10(), this->y,
 Math.fma(arg0.m20(), this->z, arg0.m30() * this->w)) *
 ...
 Vector4d rotateAxisInternal(double double1, double double4, double double6,
 double double8, Vector4d vector4d1) {
 ...
 double arg3) {
 return Math.fma(arg0, arg0,
 Math.fma(arg1, arg1, Math.fma(arg2, arg2, arg3 * arg3));
 }

 double length() {
 return Math.sqrt(Math.fma(
 this->x, this->x,
 Math.fma(this->y, this->y, Math.fma(this->z, this->z, this->w * this->w)));
 }
 ...
 return Math.sqrt(Math.fma(
 arg0, arg0, Math.fma(arg1, arg1, Math.fma(arg2, arg2, arg3 * arg3)));
 }
 ...
 double double2 = this->z - arg0.z();
 double double3 = this->w - arg0.w();
 return Math.fma(double0, double0,
 Math.fma(double1, double1,
 Math.fma(double2, double2, double3 * double3));
 }
 ...
 static double distanceSquared(double arg0, double arg1, double arg2,
 ...
 return Math.fma(
 this->x, arg0,
 Math.fma(this->y, arg1, Math.fma(this->z, arg2, this->w * arg3));
 }
 ...
 Double.doubleToLongBits(vector4d.w) {
 return false;
 } else if (Double.doubleToLongBits(this->x) !=
 Double.doubleToLongBits(vector4d.x) {
 return false;
 } else {
 return Double.doubleToLongBits(this->y) !=
 Double.doubleToLongBits(vector4d.y)
 ? false
 : Double.doubleToLongBits(this->z) ==
 Double.doubleToLongBits(vector4d.z);
 }
 }
 }
 ...
 return false;
 } else if (!(dynamic_cast<Vector4dc*>(arg0) != nullptr) {
 return false;
 ...
 arg2.x = (this->x + this->x - arg0.x() - arg0.x()) * double1 +
 (3.0 * arg0.x() - 3.0 * this->x) * double0 + this->x * arg1 + this->x;
 arg2.y = (this->y + this->y - arg0.y() - arg0.y()) * double1 +
 (3.0 * arg0.y() - 3.0 * this->y) * double0 + this->y * arg1 + this->y;
 arg2.z = (this->z + this->z - arg0.z() - arg0.z()) * double1 +
 (3.0 * arg0.z() - 3.0 * this->z) * double0 + this->z * arg1 + this->z;
 arg2.w = (this->w + this->w - arg0.w() - arg0.w()) * double1 +
 (3.0 * arg0.w() - 3.0 * this->w) * double0 + this->w * arg1 + this->w;
 return arg2;
 }
 ...
 arg4.x = (this->x + this->x - arg1.x() - arg1.x() + arg2.x() + arg0.x()) *
 double1 +
 (3.0 * arg1.x() - 3.0 * this->x - arg0.x() - arg0.x() - arg2.x()) *
 double0 +
 this->x * arg3 + this->x;
 arg4.y = (this->y + this->y - arg1.y() - arg1.y() + arg2.y() + arg0.y()) *
 double1 +
 (3.0 * arg1.y() - 3.0 * this->y - arg0.y() - arg0.y() - arg2.y()) *
 double0 +
 this->y * arg3 + this->y;
 arg4.z = (this->z + this->z - arg1.z() - arg1.z() + arg2.z() + arg0.z()) *
 double1 +
 (3.0 * arg1.z() - 3.0 * this->z - arg0.z() - arg0.z() - arg2.z()) *
 double0 +
 this->z * arg3 + this->z;
 arg4.w = (this->w + this->w - arg1.w() - arg1.w() + arg2.w() + arg0.w()) *
 double1 +
 (3.0 * arg1.w() - 3.0 * this->w - arg0.w() - arg0.w() - arg2.w()) *
 double0 +
 this->w * arg3 + this->w;
 return arg4;
 }
