...
public
 Vector4f() { this->w = 1.0F; }

public
 Vector4f(Vector4fc arg0) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg0.w();
...
public
 Vector4f(Vector3fc arg0, float arg1) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg1;
...
public
 Vector4f(Vector3ic arg0, float arg1) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg0.z();
 this->w = arg1;
...
public
 Vector4f(Vector2fc arg0, float arg1, float arg2) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg1;
 this->w = arg2;
...
public
 Vector4f(Vector2ic arg0, float arg1, float arg2) {
 this->x = arg0.x();
 this->y = arg0.y();
 this->z = arg1;
 this->w = arg2;
...
public
 Vector4f(float arg0, float arg1, float arg2, float arg3) {
 this->x = arg0;
 this->y = arg1;
 this->z = arg2;
 this->w = arg3;
...
public
 Vector4f(ByteBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector4f(int arg0, ByteBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }

public
 Vector4f(FloatBuffer arg0) {
 MemUtil.INSTANCE.get(this, arg0.position(), arg0);
 }

public
 Vector4f(int arg0, FloatBuffer arg1) {
 MemUtil.INSTANCE.get(this, arg0, arg1);
 }
 ...
 Math.fma(arg0.m20(), float2, arg0.m30() * float3));
 arg1.y =
 Math.fma(arg0.m01(), float0,
 Math.fma(arg0.m11(), float1,
 Math.fma(arg0.m21(), float2, arg0.m31() * float3));
 arg1.z =
 Math.fma(arg0.m02(), float0,
 Math.fma(arg0.m12(), float1,
 Math.fma(arg0.m22(), float2, arg0.m32() * float3));
 arg1.w = float3;
 return arg1;
 }
 ...
 float float2 = this->z;
 float float3 = this->w;
 vector4f1.x = Math.fma(
 matrix4fc.m00(), float0,
 Math.fma(matrix4fc.m10(), float1,
 Math.fma(matrix4fc.m20(), float2, matrix4fc.m30() * float3));
 vector4f1.y = Math.fma(
 matrix4fc.m01(), float0,
 Math.fma(matrix4fc.m11(), float1,
 Math.fma(matrix4fc.m21(), float2, matrix4fc.m31() * float3));
 vector4f1.z = Math.fma(
 matrix4fc.m02(), float0,
 Math.fma(matrix4fc.m12(), float1,
 Math.fma(matrix4fc.m22(), float2, matrix4fc.m32() * float3));
 vector4f1.w = Math.fma(
 matrix4fc.m03(), float0,
 Math.fma(matrix4fc.m13(), float1,
 Math.fma(matrix4fc.m23(), float2, matrix4fc.m33() * float3));
 return vector4f1;
 }
 ...
 arg1.w =
 Math.fma(arg0.m30(), float0,
 Math.fma(arg0.m31(), float1, arg0.m32() * float2 + float3);
 return arg1;
 }
 ...
 vector4f1.x = Math.fma(
 matrix4fc.m00(), float0,
 Math.fma(matrix4fc.m01(), float1,
 Math.fma(matrix4fc.m02(), float2, matrix4fc.m03() * float3));
 vector4f1.y = Math.fma(
 matrix4fc.m10(), float0,
 Math.fma(matrix4fc.m11(), float1,
 Math.fma(matrix4fc.m12(), float2, matrix4fc.m13() * float3));
 vector4f1.z = Math.fma(
 matrix4fc.m20(), float0,
 Math.fma(matrix4fc.m21(), float1,
 Math.fma(matrix4fc.m22(), float2, matrix4fc.m23() * float3));
 vector4f1.w = Math.fma(
 matrix4fc.m30(), float0,
 Math.fma(matrix4fc.m31(), float1,
 Math.fma(matrix4fc.m32(), float2, matrix4fc.m33() * float3));
 return vector4f1;
 }
 ...
 Math.fma(arg0.m23(), float2, arg0.m33() * float3));
 arg1.x =
 Math.fma(arg0.m00(), float0,
 Math.fma(arg0.m10(), float1,
 Math.fma(arg0.m20(), float2, arg0.m30() * float3)) *
 ...
 Vector4f rotate(Quaternionfc arg0) { return arg0.transform(this, this); }
 ...
 Vector4f rotateAxisInternal(float float1, float float4, float float6,
 ...
 Math.fma((float)arg1, (float)arg1,
 Math.fma((float)arg2, (float)arg2, (float)(arg3 * arg3)));
 }
 ...
 float float6 =
 Math.fma(float0, arg0.x(),
 Math.fma(float1, arg0.y(),
 Math.fma(float2, arg0.z(), float3 * arg0.w())));
 ...
 return false;
 } else if (!(dynamic_cast<Vector4fc*>(arg0) != nullptr) {
 return false;
 ...
 float float4 = this->z;
 float float5 = this->w;
 arg2.x = (float2 + float2 - arg0.x() - arg0.x()) * float1 +
 (3.0F * arg0.x() - 3.0F * float2) * float0 + float2 * arg1 +
 float2;
 arg2.y = (float3 + float3 - arg0.y() - arg0.y()) * float1 +
 (3.0F * arg0.y() - 3.0F * float3) * float0 + float3 * arg1 +
 float3;
 arg2.z = (float4 + float4 - arg0.z() - arg0.z()) * float1 +
 (3.0F * arg0.z() - 3.0F * float4) * float0 + float4 * arg1 +
 float4;
 arg2.w = (float5 + float5 - arg0.w() - arg0.w()) * float1 +
 (3.0F * arg0.w() - 3.0F * float5) * float0 + float5 * arg1 +
 float5;
 return arg2;
 }
 ...
 float float5 = this->w;
 arg4.x =
 (float2 + float2 - arg1.x() - arg1.x() + arg2.x() + arg0.x()) * float1 +
 (3.0F * arg1.x() - 3.0F * float2 - arg0.x() - arg0.x() - arg2.x()) *
 float0 +
 float2 * arg3 + float2;
 arg4.y =
 (float3 + float3 - arg1.y() - arg1.y() + arg2.y() + arg0.y()) * float1 +
 (3.0F * arg1.y() - 3.0F * float3 - arg0.y() - arg0.y() - arg2.y()) *
 float0 +
 float3 * arg3 + float3;
 arg4.z =
 (float4 + float4 - arg1.z() - arg1.z() + arg2.z() + arg0.z()) * float1 +
 (3.0F * arg1.z() - 3.0F * float4 - arg0.z() - arg0.z() - arg2.z()) *
 float0 +
 float4 * arg3 + float4;
 arg4.w =
 (float5 + float5 - arg1.w() - arg1.w() + arg2.w() + arg0.w()) * float1 +
 (3.0F * arg1.w() - 3.0F * float5 - arg0.w() - arg0.w() - arg2.w()) *
 float0 +
 float5 * arg3 + float5;
 return arg4;
 }
