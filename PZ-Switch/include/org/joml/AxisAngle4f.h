...
public
 AxisAngle4f() { this->z = 1.0F; }

public
 AxisAngle4f(AxisAngle4f arg0) {
 this->x = arg0.x;
 this->y = arg0.y;
 this->z = arg0.z;
 this->angle =
 (float)((arg0.angle < 0.0 ? (java.lang.Math.PI * 2) +
...
public
 AxisAngle4f(float arg0, float arg1, float arg2, float arg3) {
 this->x = arg1;
 this->y = arg2;
 this->z = arg3;
 this->angle = (float)((arg0 < 0.0 ? (java.lang.Math.PI * 2) +
 arg0 % (java.lang.Math.PI * 2)
 : arg0) %
 (java.lang.Math.PI * 2);
 }

public
 AxisAngle4f(float arg0, Vector3fc arg1) {
 ...
 this->angle =
 (float)((this->angle < 0.0 ? (java.lang.Math.PI * 2) +
 ...
 if (!(Math.abs(float3 - float1) < float12) ||
 !(Math.abs(float6 - float2) < float12) ||
 !(Math.abs(float7 - float5) < float12) {
 float float14 = Math.sqrt((float5 - float7) * (float5 - float7) +
 (float6 - float2) * (float6 - float2) +
 (float1 - float3) * (float1 - float3);
 ...
 this->angle =
 (float)Math.safeAcos((double0 + double4 + double8 - 1.0) / 2.0);
 ...
 (java.lang.Math.PI * 2);
 float float1 =
 (float)((axisAngle4f.angle < 0.0
 ? (java.lang.Math.PI * 2) +
 axisAngle4f.angle % (java.lang.Math.PI * 2)
 : axisAngle4f.angle) %
 (java.lang.Math.PI * 2);
 if (Float.floatToIntBits(float0) != Float.floatToIntBits(float1) {
 return false;
 } else if (Float.floatToIntBits(this->x) !=
 Float.floatToIntBits(axisAngle4f.x) {
 return false;
 } else {
 return Float.floatToIntBits(this->y) !=
 Float.floatToIntBits(axisAngle4f.y)
 ? false
 : Float.floatToIntBits(this->z) ==
 Float.floatToIntBits(axisAngle4f.z);
 }
 }
 }
}
