...
class PartialDisk : public Quadric {
public:
 static const int CACHE_SIZE = 240;

 void draw(float arg0, float arg1, int arg2, int arg3, float arg4,
 float arg5) {
 ...
 if (arg2 >= 2 && arg3 >= 1 && !(arg1 <= 0.0F) && !(arg0 < 0.0F) &&
 !(arg0 > arg1) {
 if (arg5 < -360.0F) {
 arg5 = 360.0F;
 }
 ...
 GL11.glTexCoord2f(float0 * floats0[int11] + 0.5F,
 float0 * floats1[int11] + 0.5F);
 }
 ...
 if (super.textureFlag) {
 GL11.glTexCoord2f(floats0[int6] / 2.0F + 0.5F,
 floats1[int6] / 2.0F + 0.5F);
 }
 ...
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int8] + 0.5F,
 float0 * floats1[int8] + 0.5F);
 }

 GL11.glVertex3f(float9 * floats0[int8], float9 * floats1[int8],
 0.0F);
 }
 ...
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int9] + 0.5F,
 float0 * floats1[int9] + 0.5F);
 }
 ...
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int14] + 0.5F,
 float0 * floats1[int14] + 0.5F);
 }

 GL11.glVertex3f(float16 * floats0[int14],
 float16 * floats1[int14], 0.0F);
 }
 } else {
 for (int int15 = 0; int15 <= arg2; int15++) {
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int15] + 0.5F,
 float0 * floats1[int15] + 0.5F);
 }

 GL11.glVertex3f(float16 * floats0[int15],
 float16 * floats1[int15], 0.0F);
 }
 }
 ...
 if (super.orientation == 100020) {
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int17] + 0.5F,
 float0 * floats1[int17] + 0.5F);
 }

 GL11.glVertex3f(float17 * floats0[int17],
 float17 * floats1[int17], 0.0F);
 if (super.textureFlag) {
 GL11.glTexCoord2f(float1 * floats0[int17] + 0.5F,
 float1 * floats1[int17] + 0.5F);
 }

 GL11.glVertex3f(float18 * floats0[int17],
 float18 * floats1[int17], 0.0F);
 } else {
 if (super.textureFlag) {
 GL11.glTexCoord2f(float1 * floats0[int17] + 0.5F,
 float1 * floats1[int17] + 0.5F);
 ...
 GL11.glTexCoord2f(float0 * floats0[int2] + 0.5F,
 float0 * floats1[int2] + 0.5F);
 }
 ...
 if (super.textureFlag) {
 GL11.glTexCoord2f(float0 * floats0[int5] + 0.5F,
 float0 * floats1[int5] + 0.5F);
 }

 GL11.glVertex3f(float8 * floats0[int5], float8 * floats1[int5],
 0.0F);
 }
