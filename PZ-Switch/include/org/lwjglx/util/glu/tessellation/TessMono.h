...
class TessMono {
public:
 static bool __gl_meshTessellateMonoRegion(GLUface gLUface) {
 GLUhalfEdge gLUhalfEdge0 = gLUface.anEdge;

 assert gLUhalfEdge0.Lnext != gLUhalfEdge0 &&gLUhalfEdge0.Lnext.Lnext !=
 gLUhalfEdge0;
 ...
 while (gLUhalfEdge1.Lnext != gLUhalfEdge0 &&
 (Geom.EdgeGoesLeft(gLUhalfEdge1.Lnext) ||
 Geom.EdgeSign(gLUhalfEdge1.Org, gLUhalfEdge1.Sym.Org,
 gLUhalfEdge1.Lnext.Sym.Org) <= 0.0) {
 GLUhalfEdge gLUhalfEdge2 =
 Mesh.__gl_meshConnect(gLUhalfEdge1.Lnext, gLUhalfEdge1);
 ...
 Geom.EdgeSign(gLUhalfEdge0.Sym.Org, gLUhalfEdge0.Org,
 gLUhalfEdge0.Onext.Sym.Org) >= 0.0) {
 GLUhalfEdge gLUhalfEdge3 =
 Mesh.__gl_meshConnect(gLUhalfEdge0, gLUhalfEdge0.Onext.Sym);
 ...
 static bool __gl_meshTessellateInterior(GLUmesh gLUmesh) {
 ...
 static void __gl_meshDiscardExterior(GLUmesh gLUmesh) {
 GLUface gLUface0 = gLUmesh.fHead.next;
 ...
 static bool __gl_meshSetWindingNumber(GLUmesh gLUmesh, int int0,
 bool boolean0) {
